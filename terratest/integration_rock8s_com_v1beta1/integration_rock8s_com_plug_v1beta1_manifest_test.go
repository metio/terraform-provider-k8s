...
func TestIntegrationRock8SComPlugV1Beta1Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_integration_rock8s_com_plug_v1beta1_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_integration_rock8s_com_plug_v1beta1_manifest", key))
	}
}
