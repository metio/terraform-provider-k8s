...
func TestForkliftKonveyorIoHookV1Beta1Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_forklift_konveyor_io_hook_v1beta1_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_forklift_konveyor_io_hook_v1beta1_manifest", key))
	}
}
