...
func TestAppTerraformIoModuleV1Alpha2Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_app_terraform_io_module_v1alpha2_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_app_terraform_io_module_v1alpha2_manifest", key))
	}
}
