...
func TestChainsawKyvernoIoTestV1Alpha2Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_chainsaw_kyverno_io_test_v1alpha2_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_chainsaw_kyverno_io_test_v1alpha2_manifest", key))
	}
}
