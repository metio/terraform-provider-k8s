...
func TestLonghornIoEngineV1Beta2Resource(t *testing.T) {
	path := "../examples/resources/k8s_longhorn_io_engine_v1beta2"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("resource %s.%s did not produce an output", "k8s_longhorn_io_engine_v1beta2", key))
	}
}
