...
func TestV2EdpEpamComGitServerV1Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_v2_edp_epam_com_git_server_v1_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_v2_edp_epam_com_git_server_v1_manifest", key))
	}
}
