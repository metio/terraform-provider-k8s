...
func TestClusterXK8SIoClusterV1Beta2Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_cluster_x_k8s_io_cluster_v1beta2_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_cluster_x_k8s_io_cluster_v1beta2_manifest", key))
	}
}
