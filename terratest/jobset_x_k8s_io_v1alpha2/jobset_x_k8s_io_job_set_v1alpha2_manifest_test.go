...
func TestJobsetXK8SIoJobSetV1Alpha2Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_jobset_x_k8s_io_job_set_v1alpha2_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_jobset_x_k8s_io_job_set_v1alpha2_manifest", key))
	}
}
