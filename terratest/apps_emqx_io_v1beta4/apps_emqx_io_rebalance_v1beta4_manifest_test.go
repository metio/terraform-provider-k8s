...
func TestAppsEmqxIoRebalanceV1Beta4Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_apps_emqx_io_rebalance_v1beta4_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_apps_emqx_io_rebalance_v1beta4_manifest", key))
	}
}
