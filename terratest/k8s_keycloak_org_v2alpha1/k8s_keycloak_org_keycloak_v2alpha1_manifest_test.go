...
func TestK8SKeycloakOrgKeycloakV2Alpha1Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_k8s_keycloak_org_keycloak_v2alpha1_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_k8s_keycloak_org_keycloak_v2alpha1_manifest", key))
	}
}
