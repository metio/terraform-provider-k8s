...
func TestLonghornIoEngineImageV1Beta2Manifest(t *testing.T) {
	path := "../../examples/data-sources/k8s_longhorn_io_engine_image_v1beta2_manifest"
	...
	for key, value := range outputMap {
		assert.NotEmpty(t, value, fmt.Sprintf("data %s.%s did not produce an output", "k8s_longhorn_io_engine_image_v1beta2_manifest", key))
	}
}
