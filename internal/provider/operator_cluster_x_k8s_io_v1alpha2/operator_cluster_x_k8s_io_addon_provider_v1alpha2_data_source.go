...
var (
	_ datasource.DataSource              = &OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource{}
)

func NewOperatorClusterXK8SIoAddonProviderV1Alpha2DataSource() datasource.DataSource {
	return &OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource{}
}

type OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorClusterXK8SIoAddonProviderV1Alpha2DataSourceData struct {
...
func (r *OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_addon_provider_v1alpha2"
}

func (r *OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorClusterXK8SIoAddonProviderV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_cluster_x_k8s_io_addon_provider_v1alpha2")

	var data OperatorClusterXK8SIoAddonProviderV1Alpha2DataSourceData
	...
	var readResponse OperatorClusterXK8SIoAddonProviderV1Alpha2DataSourceData
	...
	data.Kind = pointer.String("AddonProvider")
