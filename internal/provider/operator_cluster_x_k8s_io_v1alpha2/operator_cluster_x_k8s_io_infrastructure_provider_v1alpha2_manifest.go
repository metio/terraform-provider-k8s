			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"additional_deployments": schema.SingleNestedAttribute{
						Description:         "AdditionalDeployments is a map of additional deployments that the providershould manage. The key is the name of the deployment and the value is theDeploymentSpec.",
						MarkdownDescription: "AdditionalDeployments is a map of additional deployments that the providershould manage. The key is the name of the deployment and the value is theDeploymentSpec.",
						Attributes: map[string]schema.Attribute{
