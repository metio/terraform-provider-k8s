...
var (
	_ datasource.DataSource = &OperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest{}
)

func NewOperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest() datasource.DataSource {
	return &OperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest{}
}

type OperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest struct{}

type OperatorClusterXK8SIoInfrastructureProviderV1Alpha2ManifestData struct {
	...
	Spec *struct {
		AdditionalDeployments *struct {
			...
			Manager *struct {
				AdditionalArgs *map[string]string `tfsdk:"additional_args" json:"additionalArgs,omitempty"`
		...
		} `tfsdk:"additional_deployments" json:"additionalDeployments,omitempty"`
		...
		FetchConfig *struct {
			Oci      *string `tfsdk:"oci" json:"oci,omitempty"`
			Selector *struct {
				MatchExpressions *[]struct {
					Key      *string   `tfsdk:"key" json:"key,omitempty"`
					Operator *string   `tfsdk:"operator" json:"operator,omitempty"`
...
func (r *OperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_infrastructure_provider_v1alpha2_manifest"
}

func (r *OperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"additional_deployments": schema.SingleNestedAttribute{
						Description:         "AdditionalDeployments is a map of additional deployments that the provider should manage. The key is the name of the deployment and the value is the DeploymentSpec.",
						MarkdownDescription: "AdditionalDeployments is a map of additional deployments that the provider should manage. The key is the name of the deployment and the value is the DeploymentSpec.",
						Attributes: map[string]schema.Attribute{
							"deployment": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Deployment defines the properties that can be enabled on the deployment for the additional provider deployment.",
								Attributes: map[string]schema.Attribute{
							...
							"manager": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Manager defines the properties that can be enabled on the controller manager for the additional provider deployment.",
								Attributes: map[string]schema.Attribute{
									"additional_args": schema.MapAttribute{
										Description:         "AdditionalArgs is a map of additional options that will be passed in as container args to the provider's controller manager.",
										MarkdownDescription: "AdditionalArgs is a map of additional options that will be passed in as container args to the provider's controller manager.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"metrics": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Metrics contains the controller metrics configuration",
										Attributes: map[string]schema.Attribute{
...
func (r *OperatorClusterXK8SIoInfrastructureProviderV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_cluster_x_k8s_io_infrastructure_provider_v1alpha2_manifest")

	var model OperatorClusterXK8SIoInfrastructureProviderV1Alpha2ManifestData
