...
var (
	_ datasource.DataSource = &OperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest{}
)

func NewOperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest() datasource.DataSource {
	return &OperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest{}
}

type OperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest struct{}

type OperatorClusterXK8SIoControlPlaneProviderV1Alpha2ManifestData struct {
...
func (r *OperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_control_plane_provider_v1alpha2_manifest"
}

func (r *OperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorClusterXK8SIoControlPlaneProviderV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_cluster_x_k8s_io_control_plane_provider_v1alpha2_manifest")

	var model OperatorClusterXK8SIoControlPlaneProviderV1Alpha2ManifestData
