...
func TestAcidZalanDoPostgresTeamV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_acid_zalan_do_postgres_team_v1", testCase)
		})
	}
}
