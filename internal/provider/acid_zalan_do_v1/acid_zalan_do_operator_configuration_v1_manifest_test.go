...
func TestAcidZalanDoOperatorConfigurationV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_acid_zalan_do_operator_configuration_v1_manifest", testCase)
		})
	}
}
