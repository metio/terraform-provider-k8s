...
var (
	_ datasource.DataSource = &MutationsGatekeeperShModifySetV1Alpha1Manifest{}
)

func NewMutationsGatekeeperShModifySetV1Alpha1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShModifySetV1Alpha1Manifest{}
}
...
func (r *MutationsGatekeeperShModifySetV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_modify_set_v1alpha1_manifest"
}
...
func (r *MutationsGatekeeperShModifySetV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_modify_set_v1alpha1_manifest")

	var model MutationsGatekeeperShModifySetV1Alpha1ManifestData
