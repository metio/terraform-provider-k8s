...
var (
	_ datasource.DataSource              = &MutationsGatekeeperShAssignV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MutationsGatekeeperShAssignV1Alpha1DataSource{}
)

func NewMutationsGatekeeperShAssignV1Alpha1DataSource() datasource.DataSource {
	return &MutationsGatekeeperShAssignV1Alpha1DataSource{}
}

type MutationsGatekeeperShAssignV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MutationsGatekeeperShAssignV1Alpha1DataSourceData struct {
...
func (r *MutationsGatekeeperShAssignV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_v1alpha1"
}

func (r *MutationsGatekeeperShAssignV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MutationsGatekeeperShAssignV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mutations_gatekeeper_sh_assign_v1alpha1")

	var data MutationsGatekeeperShAssignV1Alpha1DataSourceData
	...
	var readResponse MutationsGatekeeperShAssignV1Alpha1DataSourceData
