...
var (
	_ datasource.DataSource = &MutationsGatekeeperShAssignMetadataV1Alpha1Manifest{}
)

func NewMutationsGatekeeperShAssignMetadataV1Alpha1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShAssignMetadataV1Alpha1Manifest{}
}
...
func (r *MutationsGatekeeperShAssignMetadataV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_metadata_v1alpha1_manifest"
}

func (r *MutationsGatekeeperShAssignMetadataV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignMetadataV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_metadata_v1alpha1_manifest")

	var model MutationsGatekeeperShAssignMetadataV1Alpha1ManifestData
