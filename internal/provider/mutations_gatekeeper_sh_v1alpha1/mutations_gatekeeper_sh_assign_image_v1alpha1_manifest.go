...
var (
	_ datasource.DataSource = &MutationsGatekeeperShAssignImageV1Alpha1Manifest{}
)

func NewMutationsGatekeeperShAssignImageV1Alpha1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShAssignImageV1Alpha1Manifest{}
}
...
func (r *MutationsGatekeeperShAssignImageV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_image_v1alpha1_manifest"
}

func (r *MutationsGatekeeperShAssignImageV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
					...
					"parameters": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"assign_domain": schema.StringAttribute{
								Description:         "AssignDomain sets the domain component on an image string. The trailingslash should not be included.",
								MarkdownDescription: "AssignDomain sets the domain component on an image string. The trailingslash should not be included.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"assign_tag": schema.StringAttribute{
								Description:         "AssignImage sets the image component on an image string. It must startwith a ':' or '@'.",
								MarkdownDescription: "AssignImage sets the image component on an image string. It must startwith a ':' or '@'.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *MutationsGatekeeperShAssignImageV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_image_v1alpha1_manifest")

	var model MutationsGatekeeperShAssignImageV1Alpha1ManifestData
