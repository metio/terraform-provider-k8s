...
var (
	_ datasource.DataSource              = &MutationsGatekeeperShAssignMetadataV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MutationsGatekeeperShAssignMetadataV1Alpha1DataSource{}
)

func NewMutationsGatekeeperShAssignMetadataV1Alpha1DataSource() datasource.DataSource {
	return &MutationsGatekeeperShAssignMetadataV1Alpha1DataSource{}
}

type MutationsGatekeeperShAssignMetadataV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MutationsGatekeeperShAssignMetadataV1Alpha1DataSourceData struct {
...
func (r *MutationsGatekeeperShAssignMetadataV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_metadata_v1alpha1"
}

func (r *MutationsGatekeeperShAssignMetadataV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignMetadataV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MutationsGatekeeperShAssignMetadataV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mutations_gatekeeper_sh_assign_metadata_v1alpha1")

	var data MutationsGatekeeperShAssignMetadataV1Alpha1DataSourceData
	...
	var readResponse MutationsGatekeeperShAssignMetadataV1Alpha1DataSourceData
