...
var (
	_ resource.Resource = (*GetambassadorIoLogServiceV2Resource)(nil)
)

type GetambassadorIoLogServiceV2TerraformModel struct {
...
type GetambassadorIoLogServiceV2GoModel struct {
	...
	Spec *struct {
		...
		V3ProtocolVersion *string `tfsdk:"v3_protocol_version" yaml:"v3ProtocolVersion,omitempty"`
...
func (r *GetambassadorIoLogServiceV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_getambassador_io_log_service_v2"
}

func (r *GetambassadorIoLogServiceV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *GetambassadorIoLogServiceV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_getambassador_io_log_service_v2")

	var state GetambassadorIoLogServiceV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GetambassadorIoLogServiceV2GoModel
...
func (r *GetambassadorIoLogServiceV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_log_service_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *GetambassadorIoLogServiceV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GetambassadorIoLogServiceV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
