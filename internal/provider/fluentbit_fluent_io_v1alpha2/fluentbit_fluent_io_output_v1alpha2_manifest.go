...
var (
	_ datasource.DataSource = &FluentbitFluentIoOutputV1Alpha2Manifest{}
)

func NewFluentbitFluentIoOutputV1Alpha2Manifest() datasource.DataSource {
	return &FluentbitFluentIoOutputV1Alpha2Manifest{}
}

type FluentbitFluentIoOutputV1Alpha2Manifest struct{}

type FluentbitFluentIoOutputV1Alpha2ManifestData struct {
...
func (r *FluentbitFluentIoOutputV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentbit_fluent_io_output_v1alpha2_manifest"
}

func (r *FluentbitFluentIoOutputV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Output is the schema for namespace level output API",
		MarkdownDescription: "Output is the schema for namespace level output API",
					...
					"s3": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"workers": schema.Int64Attribute{
								...
								MarkdownDescription: "Specify number of worker threads to use to output to S3",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *FluentbitFluentIoOutputV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentbit_fluent_io_output_v1alpha2_manifest")

	var model FluentbitFluentIoOutputV1Alpha2ManifestData
