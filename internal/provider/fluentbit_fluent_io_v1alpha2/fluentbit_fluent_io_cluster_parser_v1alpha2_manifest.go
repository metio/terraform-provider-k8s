...
var (
	_ datasource.DataSource = &FluentbitFluentIoClusterParserV1Alpha2Manifest{}
)

func NewFluentbitFluentIoClusterParserV1Alpha2Manifest() datasource.DataSource {
	return &FluentbitFluentIoClusterParserV1Alpha2Manifest{}
}

type FluentbitFluentIoClusterParserV1Alpha2Manifest struct{}

type FluentbitFluentIoClusterParserV1Alpha2ManifestData struct {
...
func (r *FluentbitFluentIoClusterParserV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentbit_fluent_io_cluster_parser_v1alpha2_manifest"
}

func (r *FluentbitFluentIoClusterParserV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ClusterParser is the Schema for the cluster-level parsers API",
		MarkdownDescription: "ClusterParser is the Schema for the cluster-level parsers API",
...
func (r *FluentbitFluentIoClusterParserV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentbit_fluent_io_cluster_parser_v1alpha2_manifest")

	var model FluentbitFluentIoClusterParserV1Alpha2ManifestData
	...
	model.Kind = pointer.String("ClusterParser")
