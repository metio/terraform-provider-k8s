...
var (
	_ datasource.DataSource = &FluentbitFluentIoFluentBitV1Alpha2Manifest{}
)

func NewFluentbitFluentIoFluentBitV1Alpha2Manifest() datasource.DataSource {
	return &FluentbitFluentIoFluentBitV1Alpha2Manifest{}
}

type FluentbitFluentIoFluentBitV1Alpha2Manifest struct{}

type FluentbitFluentIoFluentBitV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		ContainerLogRealPath     *string            `tfsdk:"container_log_real_path" json:"containerLogRealPath,omitempty"`
		...
		DisableLogVolumes *bool   `tfsdk:"disable_log_volumes" json:"disableLogVolumes,omitempty"`
		...
		InternalMountPropagation *string            `tfsdk:"internal_mount_propagation" json:"internalMountPropagation,omitempty"`
		Labels                   *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		LivenessProbe            *struct {
			Exec *struct {
				Command *[]string `tfsdk:"command" json:"command,omitempty"`
		...
		NamespaceFluentBitCfgSelector *struct {
			MatchExpressions *[]struct {
				Key      *string   `tfsdk:"key" json:"key,omitempty"`
				Operator *string   `tfsdk:"operator" json:"operator,omitempty"`
				Values   *[]string `tfsdk:"values" json:"values,omitempty"`
			...
			MatchLabels *map[string]string `tfsdk:"match_labels" json:"matchLabels,omitempty"`
		} `tfsdk:"namespace_fluent_bit_cfg_selector" json:"namespaceFluentBitCfgSelector,omitempty"`
		...
		VolumesMounts *[]struct {
			...
			SubPath          *string `tfsdk:"sub_path" json:"subPath,omitempty"`
			SubPathExpr      *string `tfsdk:"sub_path_expr" json:"subPathExpr,omitempty"`
		} `tfsdk:"volumes_mounts" json:"volumesMounts,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *FluentbitFluentIoFluentBitV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentbit_fluent_io_fluent_bit_v1alpha2_manifest"
}

func (r *FluentbitFluentIoFluentBitV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "FluentBit is the Schema for the fluentbits API",
		MarkdownDescription: "FluentBit is the Schema for the fluentbits API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "FluentBitSpec defines the desired state of FluentBit",
				Attributes: map[string]schema.Attribute{
					"affinity": schema.SingleNestedAttribute{
						Description:         "Pod's scheduling constraints.",
						MarkdownDescription: "Pod's scheduling constraints.",
						Attributes: map[string]schema.Attribute{
					...
					"annotations": schema.MapAttribute{
						...
						MarkdownDescription: "Annotations to add to each Fluentbit pod.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"args": schema.ListAttribute{
						...
						MarkdownDescription: "Fluent Bit Watcher command line arguments.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"command": schema.ListAttribute{
						...
						MarkdownDescription: "Fluent Bit Watcher command.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"container_log_real_path": schema.StringAttribute{
						Description:         "Container log path",
						MarkdownDescription: "Container log path",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"container_security_context": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ContainerSecurityContext holds container-level security attributes.",
						Attributes: map[string]schema.Attribute{
					...
					"disable_log_volumes": schema.BoolAttribute{
						Description:         "DisableLogVolumes removes the hostPath mounts for varlibcontainers, varlogs and systemd.",
						MarkdownDescription: "DisableLogVolumes removes the hostPath mounts for varlibcontainers, varlogs and systemd.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"disable_service": schema.BoolAttribute{
						Description:         "DisableService tells if the fluentbit service should be deployed.",
						MarkdownDescription: "DisableService tells if the fluentbit service should be deployed.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"dns_policy": schema.StringAttribute{
						Description:         "Set DNS policy for the pod. Defaults to 'ClusterFirst'. Valid values are'ClusterFirstWithHostNet', 'ClusterFirst', 'Default' or 'None'.",
						MarkdownDescription: "Set DNS policy for the pod. Defaults to 'ClusterFirst'. Valid values are'ClusterFirstWithHostNet', 'ClusterFirst', 'Default' or 'None'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"env_vars": schema.ListNestedAttribute{
						...
						MarkdownDescription: "EnvVars represent environment variables that can be passed to fluentbit pods.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
					...
					"fluent_bit_config_name": schema.StringAttribute{
						Description:         "Fluentbitconfig object associated with this Fluentbit",
						MarkdownDescription: "Fluentbitconfig object associated with this Fluentbit",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"host_network": schema.BoolAttribute{
						...
						MarkdownDescription: "Host networking is requested for this pod. Use the host's network namespace. If this option is set, the ports that will be used must be specified. Default to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"image": schema.StringAttribute{
						...
						MarkdownDescription: "Fluent Bit image.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"image_pull_policy": schema.StringAttribute{
						...
						MarkdownDescription: "Fluent Bit image pull policy.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"image_pull_secrets": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Fluent Bit image pull secret",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Name of the referent.More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#namesTODO: Add other useful fields. apiVersion, kind, uid?",
					...
					"init_containers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "InitContainers represents the pod's init containers.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"args": schema.ListAttribute{
					...
					"internal_mount_propagation": schema.StringAttribute{
						Description:         "MountPropagation option for internal mounts",
						MarkdownDescription: "MountPropagation option for internal mounts",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"labels": schema.MapAttribute{
						...
						MarkdownDescription: "Labels to add to each FluentBit pod",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"liveness_probe": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "LivenessProbe represents the pod's liveness probe.",
						Attributes: map[string]schema.Attribute{
							"exec": schema.SingleNestedAttribute{
								Description:         "Exec specifies the action to take.",
								MarkdownDescription: "Exec specifies the action to take.",
					...
					"metrics_port": schema.Int64Attribute{
						...
						MarkdownDescription: "MetricsPort is the port used by the metrics server. If this option is set, HttpPort from ClusterFluentBitConfig needs to match this value. Default is 2020.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"namespace_fluent_bit_cfg_selector": schema.SingleNestedAttribute{
						Description:         "NamespacedFluentBitCfgSelector selects the namespace FluentBitConfig associated with this FluentBit",
						MarkdownDescription: "NamespacedFluentBitCfgSelector selects the namespace FluentBitConfig associated with this FluentBit",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"ports": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Ports represents the pod's ports.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"container_port": schema.Int64Attribute{
									Description:         "Number of port to expose on the pod's IP address.This must be a valid port number, 0 < x < 65536.",
					...
					"position_db": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Storage for position db. You will use it if tail input is enabled.",
						Attributes: map[string]schema.Attribute{
					...
					"priority_class_name": schema.StringAttribute{
						...
						MarkdownDescription: "PriorityClassName represents the pod's priority class.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"rbac_rules": schema.ListNestedAttribute{
						Description:         "RBACRules represents additional rbac rules which will be applied to the fluent-bit clusterrole.",
						MarkdownDescription: "RBACRules represents additional rbac rules which will be applied to the fluent-bit clusterrole.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"api_groups": schema.ListAttribute{
									Description:         "APIGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one ofthe enumerated resources in any API group will be allowed. '' represents the core API group and '*' represents all API groups.",
									MarkdownDescription: "APIGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one ofthe enumerated resources in any API group will be allowed. '' represents the core API group and '*' represents all API groups.",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
					...
					"readiness_probe": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ReadinessProbe represents the pod's readiness probe.",
						Attributes: map[string]schema.Attribute{
							"exec": schema.SingleNestedAttribute{
								Description:         "Exec specifies the action to take.",
								MarkdownDescription: "Exec specifies the action to take.",
					...
					"resources": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Compute Resources required by container.",
						Attributes: map[string]schema.Attribute{
							"claims": schema.ListNestedAttribute{
								Description:         "Claims lists the names of resources, defined in spec.resourceClaims,that are used by this container.This is an alpha field and requires enabling theDynamicResourceAllocation feature gate.This field is immutable. It can only be set for containers.",
								MarkdownDescription: "Claims lists the names of resources, defined in spec.resourceClaims,that are used by this container.This is an alpha field and requires enabling theDynamicResourceAllocation feature gate.This field is immutable. It can only be set for containers.",
					...
					"runtime_class_name": schema.StringAttribute{
						...
						MarkdownDescription: "RuntimeClassName represents the container runtime configuration.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"scheduler_name": schema.StringAttribute{
						...
						MarkdownDescription: "SchedulerName represents the desired scheduler for fluent-bit pods.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"secrets": schema.ListAttribute{
						...
						MarkdownDescription: "The Secrets are mounted into /fluent-bit/secrets/<secret-name>.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"service": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Service represents configurations on the fluent-bit service.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations to add to each Fluentbit service.",
								MarkdownDescription: "Annotations to add to each Fluentbit service.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"labels": schema.MapAttribute{
								...
								MarkdownDescription: "Labels to add to each FluentBit service",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"name": schema.StringAttribute{
								...
								MarkdownDescription: "Name is the name of the FluentBit service.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"volumes": schema.ListNestedAttribute{
						...
						MarkdownDescription: "List of volumes that can be mounted by containers belonging to the pod.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"aws_elastic_block_store": schema.SingleNestedAttribute{
									Description:         "awsElasticBlockStore represents an AWS Disk resource that is attached to akubelet's host machine and then exposed to the pod.More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore",
					...
					"volumes_mounts": schema.ListNestedAttribute{
...
func (r *FluentbitFluentIoFluentBitV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentbit_fluent_io_fluent_bit_v1alpha2_manifest")

	var model FluentbitFluentIoFluentBitV1Alpha2ManifestData
	...
	model.Kind = pointer.String("FluentBit")
