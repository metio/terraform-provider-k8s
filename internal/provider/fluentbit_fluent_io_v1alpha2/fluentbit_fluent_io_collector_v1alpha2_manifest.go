...
var (
	_ datasource.DataSource = &FluentbitFluentIoCollectorV1Alpha2Manifest{}
)

func NewFluentbitFluentIoCollectorV1Alpha2Manifest() datasource.DataSource {
	return &FluentbitFluentIoCollectorV1Alpha2Manifest{}
}

type FluentbitFluentIoCollectorV1Alpha2Manifest struct{}

type FluentbitFluentIoCollectorV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		BufferPath          *string            `tfsdk:"buffer_path" json:"bufferPath,omitempty"`
...
func (r *FluentbitFluentIoCollectorV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentbit_fluent_io_collector_v1alpha2_manifest"
}

func (r *FluentbitFluentIoCollectorV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Collector is the Schema for the fluentbits API",
		MarkdownDescription: "Collector is the Schema for the fluentbits API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "CollectorSpec defines the desired state of FluentBit",
				Attributes: map[string]schema.Attribute{
					...
					"buffer_path": schema.StringAttribute{
						Description:         "The path where buffer chunks are stored.",
						MarkdownDescription: "The path where buffer chunks are stored.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"scheduler_name": schema.StringAttribute{
						...
						MarkdownDescription: "SchedulerName represents the desired scheduler for the Fluentbit collector pods",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *FluentbitFluentIoCollectorV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentbit_fluent_io_collector_v1alpha2_manifest")

	var model FluentbitFluentIoCollectorV1Alpha2ManifestData
	...
	model.Kind = pointer.String("Collector")
