...
var (
	_ datasource.DataSource              = &ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource{}
)

func NewElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource() datasource.DataSource {
	return &ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource{}
}

type ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSourceData struct {
...
func (r *ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_elasticache_services_k8s_aws_cache_subnet_group_v1alpha1"
}

func (r *ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_elasticache_services_k8s_aws_cache_subnet_group_v1alpha1")

	var data ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSourceData
	...
	var readResponse ElasticacheServicesK8SAwsCacheSubnetGroupV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("CacheSubnetGroup")
