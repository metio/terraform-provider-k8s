...
func TestSchemasSchemaheroIoDataTypeV1Alpha4Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_schemas_schemahero_io_data_type_v1alpha4", testCase)
		})
	}
}
