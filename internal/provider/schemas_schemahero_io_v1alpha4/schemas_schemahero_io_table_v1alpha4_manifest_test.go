...
func TestSchemasSchemaheroIoTableV1Alpha4Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_schemas_schemahero_io_table_v1alpha4_manifest", testCase)
		})
	}
}
