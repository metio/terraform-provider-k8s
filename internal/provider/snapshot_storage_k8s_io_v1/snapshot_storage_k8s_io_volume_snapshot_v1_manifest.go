...
var (
	_ datasource.DataSource = &SnapshotStorageK8SIoVolumeSnapshotV1Manifest{}
)

func NewSnapshotStorageK8SIoVolumeSnapshotV1Manifest() datasource.DataSource {
	return &SnapshotStorageK8SIoVolumeSnapshotV1Manifest{}
}
...
func (r *SnapshotStorageK8SIoVolumeSnapshotV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_snapshot_storage_k8s_io_volume_snapshot_v1_manifest"
}
...
func (r *SnapshotStorageK8SIoVolumeSnapshotV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_snapshot_storage_k8s_io_volume_snapshot_v1_manifest")

	var model SnapshotStorageK8SIoVolumeSnapshotV1ManifestData
