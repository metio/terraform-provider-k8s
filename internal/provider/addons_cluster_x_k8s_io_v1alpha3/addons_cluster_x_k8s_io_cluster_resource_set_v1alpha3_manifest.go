...
var (
	_ datasource.DataSource = &AddonsClusterXK8SIoClusterResourceSetV1Alpha3Manifest{}
)

func NewAddonsClusterXK8SIoClusterResourceSetV1Alpha3Manifest() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetV1Alpha3Manifest{}
}
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_v1alpha3_manifest"
}

func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cluster_selector": schema.SingleNestedAttribute{
						Description:         "clusterSelector is the label selector for Clusters. The Clusters that are selected by this will be the ones affected by this ClusterResourceSet. It must match the Cluster labels. This field is immutable.",
						MarkdownDescription: "clusterSelector is the label selector for Clusters. The Clusters that are selected by this will be the ones affected by this ClusterResourceSet. It must match the Cluster labels. This field is immutable.",
						Attributes: map[string]schema.Attribute{
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_addons_cluster_x_k8s_io_cluster_resource_set_v1alpha3_manifest")

	var model AddonsClusterXK8SIoClusterResourceSetV1Alpha3ManifestData
