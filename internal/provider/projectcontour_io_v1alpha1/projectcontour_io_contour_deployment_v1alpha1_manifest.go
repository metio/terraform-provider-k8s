...
type ProjectcontourIoContourDeploymentV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Envoy *struct {
			...
			OverloadMaxDownstreamConnections *int64             `tfsdk:"overload_max_downstream_connections" json:"overloadMaxDownstreamConnections,omitempty"`
