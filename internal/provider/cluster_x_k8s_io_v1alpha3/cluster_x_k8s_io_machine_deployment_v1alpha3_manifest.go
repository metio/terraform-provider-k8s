...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineDeploymentV1Alpha3Manifest{}
)

func NewClusterXK8SIoMachineDeploymentV1Alpha3Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineDeploymentV1Alpha3Manifest{}
}
...
func (r *ClusterXK8SIoMachineDeploymentV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_deployment_v1alpha3_manifest"
}

func (r *ClusterXK8SIoMachineDeploymentV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachineDeploymentV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_deployment_v1alpha3_manifest")

	var model ClusterXK8SIoMachineDeploymentV1Alpha3ManifestData
