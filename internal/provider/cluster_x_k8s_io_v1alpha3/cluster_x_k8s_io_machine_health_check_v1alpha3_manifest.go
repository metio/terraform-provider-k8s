...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineHealthCheckV1Alpha3Manifest{}
)

func NewClusterXK8SIoMachineHealthCheckV1Alpha3Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineHealthCheckV1Alpha3Manifest{}
}
...
func (r *ClusterXK8SIoMachineHealthCheckV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_health_check_v1alpha3_manifest"
}

func (r *ClusterXK8SIoMachineHealthCheckV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"node_startup_timeout": schema.StringAttribute{
						Description:         "Machines older than this duration without a node will be considered to havefailed and will be remediated.",
						MarkdownDescription: "Machines older than this duration without a node will be considered to havefailed and will be remediated.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ClusterXK8SIoMachineHealthCheckV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_health_check_v1alpha3_manifest")

	var model ClusterXK8SIoMachineHealthCheckV1Alpha3ManifestData
