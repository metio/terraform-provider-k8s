			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"strategy": schema.SingleNestedAttribute{
						Description:         "The deployment strategy to use to replace existing machine instances withnew ones.",
						MarkdownDescription: "The deployment strategy to use to replace existing machine instances withnew ones.",
						Attributes: map[string]schema.Attribute{
