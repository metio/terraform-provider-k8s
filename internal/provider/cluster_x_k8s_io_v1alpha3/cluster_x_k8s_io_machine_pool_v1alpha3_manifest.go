...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachinePoolV1Alpha3Manifest{}
)

func NewClusterXK8SIoMachinePoolV1Alpha3Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachinePoolV1Alpha3Manifest{}
}
...
func (r *ClusterXK8SIoMachinePoolV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_pool_v1alpha3_manifest"
}

func (r *ClusterXK8SIoMachinePoolV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"min_ready_seconds": schema.Int64Attribute{
						...
						MarkdownDescription: "minReadySeconds is the minimum number of seconds for which a newly created machine instances should be ready. Defaults to 0 (machine instance will be considered available as soon as it is ready)",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"strategy": schema.SingleNestedAttribute{
						Description:         "strategy is the deployment strategy to use to replace existing machine instances with new ones.",
						MarkdownDescription: "strategy is the deployment strategy to use to replace existing machine instances with new ones.",
						Attributes: map[string]schema.Attribute{
							...
							"type": schema.StringAttribute{
								...
								MarkdownDescription: "type of deployment. Currently the only supported strategy is 'RollingUpdate'. Default is RollingUpdate.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"metadata": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"owner_references": schema.ListNestedAttribute{
										Description:         "ownerReferences is the list of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. Deprecated: This field has no function and is going to be removed in a next release.",
										MarkdownDescription: "ownerReferences is the list of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. Deprecated: This field has no function and is going to be removed in a next release.",
...
func (r *ClusterXK8SIoMachinePoolV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_pool_v1alpha3_manifest")

	var model ClusterXK8SIoMachinePoolV1Alpha3ManifestData
