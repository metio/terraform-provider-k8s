...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineV1Alpha3Manifest{}
)

func NewClusterXK8SIoMachineV1Alpha3Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineV1Alpha3Manifest{}
}
...
func (r *ClusterXK8SIoMachineV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_v1alpha3_manifest"
}

func (r *ClusterXK8SIoMachineV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachineV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_v1alpha3_manifest")

	var model ClusterXK8SIoMachineV1Alpha3ManifestData
