...
var (
	_ datasource.DataSource              = &SchedulingVolcanoShPodGroupV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &SchedulingVolcanoShPodGroupV1Beta1DataSource{}
)

func NewSchedulingVolcanoShPodGroupV1Beta1DataSource() datasource.DataSource {
	return &SchedulingVolcanoShPodGroupV1Beta1DataSource{}
}

type SchedulingVolcanoShPodGroupV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SchedulingVolcanoShPodGroupV1Beta1DataSourceData struct {
...
func (r *SchedulingVolcanoShPodGroupV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_scheduling_volcano_sh_pod_group_v1beta1"
}

func (r *SchedulingVolcanoShPodGroupV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SchedulingVolcanoShPodGroupV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SchedulingVolcanoShPodGroupV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_scheduling_volcano_sh_pod_group_v1beta1")

	var data SchedulingVolcanoShPodGroupV1Beta1DataSourceData
	...
	var readResponse SchedulingVolcanoShPodGroupV1Beta1DataSourceData
