...
package infra_contrib_fluxcd_io_v1alpha1
...
var (
	_ datasource.DataSource = &InfraContribFluxcdIoTerraformV1Alpha1Manifest{}
)

func NewInfraContribFluxcdIoTerraformV1Alpha1Manifest() datasource.DataSource {
	return &InfraContribFluxcdIoTerraformV1Alpha1Manifest{}
}

type InfraContribFluxcdIoTerraformV1Alpha1Manifest struct{}

type InfraContribFluxcdIoTerraformV1Alpha1ManifestData struct {
...
func (r *InfraContribFluxcdIoTerraformV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infra_contrib_fluxcd_io_terraform_v1alpha1_manifest"
}

func (r *InfraContribFluxcdIoTerraformV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfraContribFluxcdIoTerraformV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infra_contrib_fluxcd_io_terraform_v1alpha1_manifest")

	var model InfraContribFluxcdIoTerraformV1Alpha1ManifestData
	...
	model.ApiVersion = pointer.String("infra.contrib.fluxcd.io/v1alpha1")
