...
var (
	_ datasource.DataSource = &RocketmqApacheOrgConsoleV1Alpha1Manifest{}
)

func NewRocketmqApacheOrgConsoleV1Alpha1Manifest() datasource.DataSource {
	return &RocketmqApacheOrgConsoleV1Alpha1Manifest{}
}

type RocketmqApacheOrgConsoleV1Alpha1Manifest struct{}

type RocketmqApacheOrgConsoleV1Alpha1ManifestData struct {
...
func (r *RocketmqApacheOrgConsoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rocketmq_apache_org_console_v1alpha1_manifest"
}

func (r *RocketmqApacheOrgConsoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RocketmqApacheOrgConsoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rocketmq_apache_org_console_v1alpha1_manifest")

	var model RocketmqApacheOrgConsoleV1Alpha1ManifestData
