...
var (
	_ datasource.DataSource              = &RocketmqApacheOrgNameServiceV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &RocketmqApacheOrgNameServiceV1Alpha1DataSource{}
)

func NewRocketmqApacheOrgNameServiceV1Alpha1DataSource() datasource.DataSource {
	return &RocketmqApacheOrgNameServiceV1Alpha1DataSource{}
}

type RocketmqApacheOrgNameServiceV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type RocketmqApacheOrgNameServiceV1Alpha1DataSourceData struct {
...
func (r *RocketmqApacheOrgNameServiceV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rocketmq_apache_org_name_service_v1alpha1"
}

func (r *RocketmqApacheOrgNameServiceV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RocketmqApacheOrgNameServiceV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *RocketmqApacheOrgNameServiceV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_rocketmq_apache_org_name_service_v1alpha1")

	var data RocketmqApacheOrgNameServiceV1Alpha1DataSourceData
	...
	var readResponse RocketmqApacheOrgNameServiceV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("NameService")
