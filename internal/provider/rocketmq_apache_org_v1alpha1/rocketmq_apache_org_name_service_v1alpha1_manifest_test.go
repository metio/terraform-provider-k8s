...
func TestRocketmqApacheOrgNameServiceV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_rocketmq_apache_org_name_service_v1alpha1_manifest", testCase)
		})
	}
}
