...
var (
	_ datasource.DataSource = &RocketmqApacheOrgNameServiceV1Alpha1Manifest{}
)

func NewRocketmqApacheOrgNameServiceV1Alpha1Manifest() datasource.DataSource {
	return &RocketmqApacheOrgNameServiceV1Alpha1Manifest{}
}

type RocketmqApacheOrgNameServiceV1Alpha1Manifest struct{}

type RocketmqApacheOrgNameServiceV1Alpha1ManifestData struct {
...
func (r *RocketmqApacheOrgNameServiceV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rocketmq_apache_org_name_service_v1alpha1_manifest"
}

func (r *RocketmqApacheOrgNameServiceV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"env": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Env defines custom env, e.g. JAVA_OPT_EXT",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
...
func (r *RocketmqApacheOrgNameServiceV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rocketmq_apache_org_name_service_v1alpha1_manifest")

	var model RocketmqApacheOrgNameServiceV1Alpha1ManifestData
