...
var (
	_ datasource.DataSource              = &RocketmqApacheOrgConsoleV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &RocketmqApacheOrgConsoleV1Alpha1DataSource{}
)

func NewRocketmqApacheOrgConsoleV1Alpha1DataSource() datasource.DataSource {
	return &RocketmqApacheOrgConsoleV1Alpha1DataSource{}
}

type RocketmqApacheOrgConsoleV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type RocketmqApacheOrgConsoleV1Alpha1DataSourceData struct {
...
func (r *RocketmqApacheOrgConsoleV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rocketmq_apache_org_console_v1alpha1"
}

func (r *RocketmqApacheOrgConsoleV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RocketmqApacheOrgConsoleV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *RocketmqApacheOrgConsoleV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_rocketmq_apache_org_console_v1alpha1")

	var data RocketmqApacheOrgConsoleV1Alpha1DataSourceData
	...
	var readResponse RocketmqApacheOrgConsoleV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Console")
