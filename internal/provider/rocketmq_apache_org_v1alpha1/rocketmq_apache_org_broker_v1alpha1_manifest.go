...
var (
	_ datasource.DataSource = &RocketmqApacheOrgBrokerV1Alpha1Manifest{}
)

func NewRocketmqApacheOrgBrokerV1Alpha1Manifest() datasource.DataSource {
	return &RocketmqApacheOrgBrokerV1Alpha1Manifest{}
}

type RocketmqApacheOrgBrokerV1Alpha1Manifest struct{}

type RocketmqApacheOrgBrokerV1Alpha1ManifestData struct {
...
func (r *RocketmqApacheOrgBrokerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rocketmq_apache_org_broker_v1alpha1_manifest"
}

func (r *RocketmqApacheOrgBrokerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RocketmqApacheOrgBrokerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rocketmq_apache_org_broker_v1alpha1_manifest")

	var model RocketmqApacheOrgBrokerV1Alpha1ManifestData
