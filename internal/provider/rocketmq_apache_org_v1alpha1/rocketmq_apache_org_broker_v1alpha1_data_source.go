...
var (
	_ datasource.DataSource              = &RocketmqApacheOrgBrokerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &RocketmqApacheOrgBrokerV1Alpha1DataSource{}
)

func NewRocketmqApacheOrgBrokerV1Alpha1DataSource() datasource.DataSource {
	return &RocketmqApacheOrgBrokerV1Alpha1DataSource{}
}

type RocketmqApacheOrgBrokerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type RocketmqApacheOrgBrokerV1Alpha1DataSourceData struct {
...
func (r *RocketmqApacheOrgBrokerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rocketmq_apache_org_broker_v1alpha1"
}

func (r *RocketmqApacheOrgBrokerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RocketmqApacheOrgBrokerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *RocketmqApacheOrgBrokerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_rocketmq_apache_org_broker_v1alpha1")

	var data RocketmqApacheOrgBrokerV1Alpha1DataSourceData
	...
	var readResponse RocketmqApacheOrgBrokerV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("rocketmq.apache.org/v1alpha1")
