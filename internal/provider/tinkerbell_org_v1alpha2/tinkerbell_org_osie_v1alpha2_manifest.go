...
var (
	_ datasource.DataSource = &TinkerbellOrgOsieV1Alpha2Manifest{}
)

func NewTinkerbellOrgOsieV1Alpha2Manifest() datasource.DataSource {
	return &TinkerbellOrgOsieV1Alpha2Manifest{}
}

type TinkerbellOrgOsieV1Alpha2Manifest struct{}

type TinkerbellOrgOsieV1Alpha2ManifestData struct {
	...
	Spec *struct {
		InitrdUrl *string `tfsdk:"initrd_url" json:"initrdUrl,omitempty"`
		KernelUrl *string `tfsdk:"kernel_url" json:"kernelUrl,omitempty"`
...
func (r *TinkerbellOrgOsieV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tinkerbell_org_osie_v1alpha2_manifest"
}
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"initrd_url": schema.StringAttribute{
						...
						MarkdownDescription: "InitrdURL is a URL to an initrd image.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"kernel_url": schema.StringAttribute{
						...
						MarkdownDescription: "KernelURL is a URL to a kernel image.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *TinkerbellOrgOsieV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tinkerbell_org_osie_v1alpha2_manifest")

	var model TinkerbellOrgOsieV1Alpha2ManifestData
	...
	model.Kind = pointer.String("OSIE")
