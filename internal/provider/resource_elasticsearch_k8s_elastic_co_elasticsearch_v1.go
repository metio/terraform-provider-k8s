...
var (
	_ resource.Resource = (*ElasticsearchK8SElasticCoElasticsearchV1Resource)(nil)
)

type ElasticsearchK8SElasticCoElasticsearchV1TerraformModel struct {
...
type ElasticsearchK8SElasticCoElasticsearchV1GoModel struct {
	...
	Spec *struct {
		Auth *struct {
			...
			} `tfsdk:"file_realm" yaml:"fileRealm,omitempty"`
		...
		Transport *struct {
			...
			Tls *struct {
				...
				OtherNameSuffix *string `tfsdk:"other_name_suffix" yaml:"otherNameSuffix,omitempty"`
		...
		} `tfsdk:"transport" yaml:"transport,omitempty"`
		...
		VolumeClaimDeletePolicy *string `tfsdk:"volume_claim_delete_policy" yaml:"volumeClaimDeletePolicy,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_elasticsearch_k8s_elastic_co_elasticsearch_v1"
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1")

	var state ElasticsearchK8SElasticCoElasticsearchV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ElasticsearchK8SElasticCoElasticsearchV1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("elasticsearch.k8s.elastic.co/v1")
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
