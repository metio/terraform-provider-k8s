...
var (
	_ resource.Resource = (*GetambassadorIoTracingServiceV3Alpha1Resource)(nil)
)

type GetambassadorIoTracingServiceV3Alpha1TerraformModel struct {
...
type GetambassadorIoTracingServiceV3Alpha1GoModel struct {
	...
	Spec *struct {
		...
		Config *struct {
			...
			Propagation_modes *[]string `tfsdk:"propagation_modes" yaml:"propagation_modes,omitempty"`
		...
		} `tfsdk:"custom_tags" yaml:"custom_tags,omitempty"`
...
func (r *GetambassadorIoTracingServiceV3Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_getambassador_io_tracing_service_v3alpha1"
}

func (r *GetambassadorIoTracingServiceV3Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *GetambassadorIoTracingServiceV3Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_getambassador_io_tracing_service_v3alpha1")

	var state GetambassadorIoTracingServiceV3Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GetambassadorIoTracingServiceV3Alpha1GoModel
...
func (r *GetambassadorIoTracingServiceV3Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_tracing_service_v3alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *GetambassadorIoTracingServiceV3Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GetambassadorIoTracingServiceV3Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
