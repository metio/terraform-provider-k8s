...
func TestNetworkingK8SIoNetworkPolicyV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_networking_k8s_io_network_policy_v1_manifest", testCase)
		})
	}
}
