...
var (
	_ datasource.DataSource              = &NetworkingK8SIoIngressV1DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingK8SIoIngressV1DataSource{}
)

func NewNetworkingK8SIoIngressV1DataSource() datasource.DataSource {
	return &NetworkingK8SIoIngressV1DataSource{}
}

type NetworkingK8SIoIngressV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingK8SIoIngressV1DataSourceData struct {
...
func (r *NetworkingK8SIoIngressV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_k8s_io_ingress_v1"
}

func (r *NetworkingK8SIoIngressV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingK8SIoIngressV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingK8SIoIngressV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_k8s_io_ingress_v1")

	var data NetworkingK8SIoIngressV1DataSourceData
	...
	var readResponse NetworkingK8SIoIngressV1DataSourceData
	...
	data.Kind = pointer.String("Ingress")
