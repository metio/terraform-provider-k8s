...
var (
	_ datasource.DataSource = &K8SNginxOrgTransportServerV1Alpha1Manifest{}
)

func NewK8SNginxOrgTransportServerV1Alpha1Manifest() datasource.DataSource {
	return &K8SNginxOrgTransportServerV1Alpha1Manifest{}
}
...
func (r *K8SNginxOrgTransportServerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8s_nginx_org_transport_server_v1alpha1_manifest"
}

func (r *K8SNginxOrgTransportServerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *K8SNginxOrgTransportServerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8s_nginx_org_transport_server_v1alpha1_manifest")

	var model K8SNginxOrgTransportServerV1Alpha1ManifestData
