...
var (
	_ datasource.DataSource              = &InferenceKubedlIoElasticBatchJobV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &InferenceKubedlIoElasticBatchJobV1Alpha1DataSource{}
)

func NewInferenceKubedlIoElasticBatchJobV1Alpha1DataSource() datasource.DataSource {
	return &InferenceKubedlIoElasticBatchJobV1Alpha1DataSource{}
}

type InferenceKubedlIoElasticBatchJobV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type InferenceKubedlIoElasticBatchJobV1Alpha1DataSourceData struct {
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_inference_kubedl_io_elastic_batch_job_v1alpha1"
}

func (r *InferenceKubedlIoElasticBatchJobV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_inference_kubedl_io_elastic_batch_job_v1alpha1")

	var data InferenceKubedlIoElasticBatchJobV1Alpha1DataSourceData
	...
	var readResponse InferenceKubedlIoElasticBatchJobV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("inference.kubedl.io/v1alpha1")
	data.Kind = pointer.String("ElasticBatchJob")
