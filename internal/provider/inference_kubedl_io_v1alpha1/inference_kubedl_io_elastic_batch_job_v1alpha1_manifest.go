...
var (
	_ datasource.DataSource = &InferenceKubedlIoElasticBatchJobV1Alpha1Manifest{}
)

func NewInferenceKubedlIoElasticBatchJobV1Alpha1Manifest() datasource.DataSource {
	return &InferenceKubedlIoElasticBatchJobV1Alpha1Manifest{}
}

type InferenceKubedlIoElasticBatchJobV1Alpha1Manifest struct{}

type InferenceKubedlIoElasticBatchJobV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"elastic_batch_replica_specs" json:"elasticBatchReplicaSpecs,omitempty"`
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_inference_kubedl_io_elastic_batch_job_v1alpha1_manifest"
}

func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"elastic_batch_replica_specs": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_inference_kubedl_io_elastic_batch_job_v1alpha1_manifest")

	var model InferenceKubedlIoElasticBatchJobV1Alpha1ManifestData
	...
	model.ApiVersion = pointer.String("inference.kubedl.io/v1alpha1")
	model.Kind = pointer.String("ElasticBatchJob")
