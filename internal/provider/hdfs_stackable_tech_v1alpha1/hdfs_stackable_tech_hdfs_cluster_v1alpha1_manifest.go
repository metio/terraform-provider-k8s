...
var (
	_ datasource.DataSource = &HdfsStackableTechHdfsClusterV1Alpha1Manifest{}
)

func NewHdfsStackableTechHdfsClusterV1Alpha1Manifest() datasource.DataSource {
	return &HdfsStackableTechHdfsClusterV1Alpha1Manifest{}
}
...
func (r *HdfsStackableTechHdfsClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hdfs_stackable_tech_hdfs_cluster_v1alpha1_manifest"
}
...
func (r *HdfsStackableTechHdfsClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Auto-generated derived type for HdfsClusterSpec via 'CustomResource'",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "An HDFS cluster stacklet. This resource is managed by the Stackable operator for Apache Hadoop HDFS. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/hdfs/). The CRD contains three roles: 'nameNodes', 'dataNodes' and 'journalNodes'.",
				MarkdownDescription: "An HDFS cluster stacklet. This resource is managed by the Stackable operator for Apache Hadoop HDFS. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/hdfs/). The CRD contains three roles: 'nameNodes', 'dataNodes' and 'journalNodes'.",
				Attributes: map[string]schema.Attribute{
					"cluster_config": schema.SingleNestedAttribute{
						Description:         "Configuration that applies to all roles and role groups. This includes settings for authentication, logging and the ZooKeeper cluster to use.",
						MarkdownDescription: "Configuration that applies to all roles and role groups. This includes settings for authentication, logging and the ZooKeeper cluster to use.",
						Attributes: map[string]schema.Attribute{
									...
									"kerberos": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"secret_class": schema.StringAttribute{
												...
												MarkdownDescription: "Name of the SecretClass providing the keytab for the HDFS services.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
							...
							"authorization": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Authorization options for HDFS. Learn more in the [HDFS authorization usage guide](https://docs.stackable.tech/home/nightly/hdfs/usage-guide/security#authorization).",
								Attributes: map[string]schema.Attribute{
							...
							"dfs_replication": schema.Int64Attribute{
								...
								MarkdownDescription: "'dfsReplication' is the factor of how many times a file will be replicated to different data nodes. The default is 3. You need at least the same amount of data nodes so each file can be replicated correctly, otherwise a warning will be printed.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"listener_class": schema.StringAttribute{
								Description:         "Deprecated, please use '.spec.nameNodes.config.listenerClass' and '.spec.dataNodes.config.listenerClass' instead.",
								MarkdownDescription: "Deprecated, please use '.spec.nameNodes.config.listenerClass' and '.spec.dataNodes.config.listenerClass' instead.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("cluster-internal"),
								},
							},

							"rack_awareness": schema.ListNestedAttribute{
								Description:         "Configuration to control HDFS topology (rack) awareness feature",
								MarkdownDescription: "Configuration to control HDFS topology (rack) awareness feature",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"node_label": schema.StringAttribute{
											...
											MarkdownDescription: "Name of the label on the Kubernetes Node (where the Pod is placed on) used to resolve a datanode to a topology zone.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"pod_label": schema.StringAttribute{
											Description:         "Name of the label on the Kubernetes Pod used to resolve a datanode to a topology zone.",
											MarkdownDescription: "Name of the label on the Kubernetes Pod used to resolve a datanode to a topology zone.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"data_nodes": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"config": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Configuration options that are available for all roles.",
								Attributes: map[string]schema.Attribute{
									...
									"listener_class": schema.StringAttribute{
										...
										MarkdownDescription: "This field controls which [ListenerClass](https://docs.stackable.tech/home/nightly/listener-operator/listenerclass.html) is used to expose this rolegroup. DataNodes should have a direct ListenerClass, such as 'cluster-internal' or 'external-unstable'.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
										...
										Attributes: map[string]schema.Attribute{
											...
											"storage": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													...
													"hdfs_storage_type": schema.StringAttribute{
														Description:         "",
														MarkdownDescription: "",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.String{
															stringvalidator.OneOf("Archive", "Disk", "SSD", "RAMDisk"),
														},
													},
					...
					"journal_nodes": schema.SingleNestedAttribute{
						Description:         "This struct represents a role - e.g. HDFS datanodes or Trino workers. It has a key-value-map containing all the roleGroups that are part of this role. Additionally, there is a 'config', which is configurable at the role *and* roleGroup level. Everything at roleGroup level is merged on top of what is configured on role level. There is also a second form of config, which can only be configured at role level, the 'roleConfig'. You can learn more about this in the [Roles and role group concept documentation](https://docs.stackable.tech/home/nightly/concepts/roles-and-role-groups).",
						MarkdownDescription: "This struct represents a role - e.g. HDFS datanodes or Trino workers. It has a key-value-map containing all the roleGroups that are part of this role. Additionally, there is a 'config', which is configurable at the role *and* roleGroup level. Everything at roleGroup level is merged on top of what is configured on role level. There is also a second form of config, which can only be configured at role level, the 'roleConfig'. You can learn more about this in the [Roles and role group concept documentation](https://docs.stackable.tech/home/nightly/concepts/roles-and-role-groups).",
						Attributes: map[string]schema.Attribute{
							"cli_overrides": schema.MapAttribute{
					...
					"name_nodes": schema.SingleNestedAttribute{
						Description:         "This struct represents a role - e.g. HDFS datanodes or Trino workers. It has a key-value-map containing all the roleGroups that are part of this role. Additionally, there is a 'config', which is configurable at the role *and* roleGroup level. Everything at roleGroup level is merged on top of what is configured on role level. There is also a second form of config, which can only be configured at role level, the 'roleConfig'. You can learn more about this in the [Roles and role group concept documentation](https://docs.stackable.tech/home/nightly/concepts/roles-and-role-groups).",
						MarkdownDescription: "This struct represents a role - e.g. HDFS datanodes or Trino workers. It has a key-value-map containing all the roleGroups that are part of this role. Additionally, there is a 'config', which is configurable at the role *and* roleGroup level. Everything at roleGroup level is merged on top of what is configured on role level. There is also a second form of config, which can only be configured at role level, the 'roleConfig'. You can learn more about this in the [Roles and role group concept documentation](https://docs.stackable.tech/home/nightly/concepts/roles-and-role-groups).",
						Attributes: map[string]schema.Attribute{
							"cli_overrides": schema.MapAttribute{
							...
							"config": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"listener_class": schema.StringAttribute{
										...
										MarkdownDescription: "This field controls which [ListenerClass](https://docs.stackable.tech/home/nightly/listener-operator/listenerclass.html) is used to expose this rolegroup. NameNodes should have a stable ListenerClass, such as 'cluster-internal' or 'external-stable'.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
...
func (r *HdfsStackableTechHdfsClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hdfs_stackable_tech_hdfs_cluster_v1alpha1_manifest")

	var model HdfsStackableTechHdfsClusterV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("hdfs.stackable.tech/v1alpha1")
	model.Kind = pointer.String("HdfsCluster")
