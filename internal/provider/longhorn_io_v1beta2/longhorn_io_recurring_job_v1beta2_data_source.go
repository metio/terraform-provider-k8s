...
var (
	_ datasource.DataSource              = &LonghornIoRecurringJobV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &LonghornIoRecurringJobV1Beta2DataSource{}
)

func NewLonghornIoRecurringJobV1Beta2DataSource() datasource.DataSource {
	return &LonghornIoRecurringJobV1Beta2DataSource{}
}

type LonghornIoRecurringJobV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type LonghornIoRecurringJobV1Beta2DataSourceData struct {
...
func (r *LonghornIoRecurringJobV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_longhorn_io_recurring_job_v1beta2"
}

func (r *LonghornIoRecurringJobV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LonghornIoRecurringJobV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LonghornIoRecurringJobV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_longhorn_io_recurring_job_v1beta2")

	var data LonghornIoRecurringJobV1Beta2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "longhorn.io", Version: "v1beta2", Resource: "recurringjobs"}).
	...
	var readResponse LonghornIoRecurringJobV1Beta2DataSourceData
