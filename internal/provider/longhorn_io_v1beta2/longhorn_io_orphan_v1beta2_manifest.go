...
var (
	_ datasource.DataSource = &LonghornIoOrphanV1Beta2Manifest{}
)

func NewLonghornIoOrphanV1Beta2Manifest() datasource.DataSource {
	return &LonghornIoOrphanV1Beta2Manifest{}
}

type LonghornIoOrphanV1Beta2Manifest struct{}

type LonghornIoOrphanV1Beta2ManifestData struct {
...
func (r *LonghornIoOrphanV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_longhorn_io_orphan_v1beta2_manifest"
}

func (r *LonghornIoOrphanV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LonghornIoOrphanV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_longhorn_io_orphan_v1beta2_manifest")

	var model LonghornIoOrphanV1Beta2ManifestData
