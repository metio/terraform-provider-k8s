			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"parameters": schema.MapAttribute{
						Description:         "The parameters of the snapshot/backup. Support parameters: 'full-backup-interval', 'volume-backup-policy'.",
						MarkdownDescription: "The parameters of the snapshot/backup. Support parameters: 'full-backup-interval', 'volume-backup-policy'.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"task": schema.StringAttribute{
						Description:         "The recurring job task. Can be 'snapshot', 'snapshot-force-create', 'snapshot-cleanup', 'snapshot-delete', 'backup', 'backup-force-create', 'filesystem-trim' or 'system-backup'.",
						MarkdownDescription: "The recurring job task. Can be 'snapshot', 'snapshot-force-create', 'snapshot-cleanup', 'snapshot-delete', 'backup', 'backup-force-create', 'filesystem-trim' or 'system-backup'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("snapshot", "snapshot-force-create", "snapshot-cleanup", "snapshot-delete", "backup", "backup-force-create", "filesystem-trim", "system-backup"),
						},
					},
				},
				Required: false,
