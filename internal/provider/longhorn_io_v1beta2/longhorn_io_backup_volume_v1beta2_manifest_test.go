...
func TestLonghornIoBackupVolumeV1Beta2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_longhorn_io_backup_volume_v1beta2_manifest", testCase)
		})
	}
}
