...
type OperatorKnativeDevKnativeEventingV1Beta1Resource struct{}

var (
	_ resource.Resource = (*OperatorKnativeDevKnativeEventingV1Beta1Resource)(nil)
)

type OperatorKnativeDevKnativeEventingV1Beta1TerraformModel struct {
...
type OperatorKnativeDevKnativeEventingV1Beta1GoModel struct {
	...
	Spec *struct {
		...
		DefaultBrokerClass *string `tfsdk:"default_broker_class" yaml:"defaultBrokerClass,omitempty"`
		...
		Deployments *[]struct {
			...
			} `tfsdk:"liveness_probes" yaml:"livenessProbes,omitempty"`
			...
			ReadinessProbes *[]struct {
				...
				TimeoutSeconds *int64 `tfsdk:"timeout_seconds" yaml:"timeoutSeconds,omitempty"`
			} `tfsdk:"readiness_probes" yaml:"readinessProbes,omitempty"`
		...
		High_availability *struct {
			Replicas *int64 `tfsdk:"replicas" yaml:"replicas,omitempty"`
		} `tfsdk:"high_availability" yaml:"high-availability,omitempty"`
		...
		SinkBindingSelectionMode *string `tfsdk:"sink_binding_selection_mode" yaml:"sinkBindingSelectionMode,omitempty"`

		Source *struct {
			Ceph *struct {
				Enabled *bool `tfsdk:"enabled" yaml:"enabled,omitempty"`
			} `tfsdk:"ceph" yaml:"ceph,omitempty"`
			...
			Rabbitmq *struct {
				Enabled *bool `tfsdk:"enabled" yaml:"enabled,omitempty"`
			} `tfsdk:"rabbitmq" yaml:"rabbitmq,omitempty"`
		...
		} `tfsdk:"workloads" yaml:"workloads,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewOperatorKnativeDevKnativeEventingV1Beta1Resource() resource.Resource {
	return &OperatorKnativeDevKnativeEventingV1Beta1Resource{}
}

func (r *OperatorKnativeDevKnativeEventingV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_knative_dev_knative_eventing_v1beta1"
}

func (r *OperatorKnativeDevKnativeEventingV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				...
				MarkdownDescription: "Spec defines the desired state of KnativeEventing",

				Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{

					"additional_manifests": {
						Description:         "A list of the additional eventing manifests, which will be installed by the operator",
						MarkdownDescription: "A list of the additional eventing manifests, which will be installed by the operator",
					...
					"default_broker_class": {
						...
						MarkdownDescription: "The default broker type to use for the brokers Knative creates. If no value is provided, MTChannelBasedBroker will be used.",
					...
					"manifests": {
						...
						MarkdownDescription: "A list of eventing manifests, which will be installed by the operator",
					...
					"registry": {
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"image_pull_secrets": {
								...
								MarkdownDescription: "A list of secrets to be used when pulling the knative images. The secret must be created in the same namespace as the knative-eventing deployments, and not the namespace of this resource.",
					...
					"sink_binding_selection_mode": {
						...
						MarkdownDescription: "Specifies the selection mode for the sinkbinding webhook. If the value is 'inclusion', only namespaces/objects labelled as 'bindings.knative.dev/include:true' will be considered. If 'exclusion' is selected, only 'bindings.knative.dev/exclude:true' label is checked and these will NOT be considered. The default is 'exclusion'.",
					...
					"source": {
						...
						MarkdownDescription: "The source configuration for Knative Eventing",

						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{

							"ceph": {
								Description:         "Ceph settings",
								MarkdownDescription: "Ceph settings",
							...
							"github": {
								...
								MarkdownDescription: "GitHub settings",
							...
							"gitlab": {
								...
								MarkdownDescription: "GitLab settings",
							...
							"kafka": {
								...
								MarkdownDescription: "Apache Kafka settings",
							...
							"rabbitmq": {
								...
								MarkdownDescription: "RabbitMQ settings",
							...
							"redis": {
								...
								MarkdownDescription: "Redis settings",
					...
					"version": {
						...
						MarkdownDescription: "The version of Knative Eventing to be installed",
...
func (r *OperatorKnativeDevKnativeEventingV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_knative_dev_knative_eventing_v1beta1")

	var state OperatorKnativeDevKnativeEventingV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorKnativeDevKnativeEventingV1Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("operator.knative.dev/v1beta1")
	goModel.Kind = utilities.Ptr("KnativeEventing")
...
func (r *OperatorKnativeDevKnativeEventingV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_knative_dev_knative_eventing_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorKnativeDevKnativeEventingV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_operator_knative_dev_knative_eventing_v1beta1")
...
func (r *OperatorKnativeDevKnativeEventingV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_operator_knative_dev_knative_eventing_v1beta1")
