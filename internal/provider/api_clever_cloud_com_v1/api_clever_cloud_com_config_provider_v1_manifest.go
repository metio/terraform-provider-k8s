...
var (
	_ datasource.DataSource = &ApiCleverCloudComConfigProviderV1Manifest{}
)

func NewApiCleverCloudComConfigProviderV1Manifest() datasource.DataSource {
	return &ApiCleverCloudComConfigProviderV1Manifest{}
}
...
func (r *ApiCleverCloudComConfigProviderV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_api_clever_cloud_com_config_provider_v1_manifest"
}
...
func (r *ApiCleverCloudComConfigProviderV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_api_clever_cloud_com_config_provider_v1_manifest")

	var model ApiCleverCloudComConfigProviderV1ManifestData
	...
	model.Kind = pointer.String("ConfigProvider")
