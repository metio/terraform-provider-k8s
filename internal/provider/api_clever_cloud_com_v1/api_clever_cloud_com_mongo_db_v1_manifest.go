...
var (
	_ datasource.DataSource = &ApiCleverCloudComMongoDbV1Manifest{}
)

func NewApiCleverCloudComMongoDbV1Manifest() datasource.DataSource {
	return &ApiCleverCloudComMongoDbV1Manifest{}
}
...
func (r *ApiCleverCloudComMongoDbV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_api_clever_cloud_com_mongo_db_v1_manifest"
}
...
func (r *ApiCleverCloudComMongoDbV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_api_clever_cloud_com_mongo_db_v1_manifest")

	var model ApiCleverCloudComMongoDbV1ManifestData
	...
	model.Kind = pointer.String("MongoDb")
