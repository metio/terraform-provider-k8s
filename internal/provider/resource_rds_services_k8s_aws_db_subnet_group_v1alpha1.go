...
var (
	_ resource.Resource = (*RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource)(nil)
)

type RdsServicesK8SAwsDBSubnetGroupV1Alpha1TerraformModel struct {
...
type RdsServicesK8SAwsDBSubnetGroupV1Alpha1GoModel struct {
...
func (r *RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_rds_services_k8s_aws_db_subnet_group_v1alpha1"
}

func (r *RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_rds_services_k8s_aws_db_subnet_group_v1alpha1")

	var state RdsServicesK8SAwsDBSubnetGroupV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel RdsServicesK8SAwsDBSubnetGroupV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("DBSubnetGroup")
...
func (r *RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rds_services_k8s_aws_db_subnet_group_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *RdsServicesK8SAwsDBSubnetGroupV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
