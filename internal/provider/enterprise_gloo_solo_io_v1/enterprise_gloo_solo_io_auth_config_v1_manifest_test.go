...
func TestEnterpriseGlooSoloIoAuthConfigV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_enterprise_gloo_solo_io_auth_config_v1_manifest", testCase)
		})
	}
}
