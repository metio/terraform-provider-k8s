			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"force_overwrite_replica_secret": schema.BoolAttribute{
						Description:         "Specifies whether to overwrite a secret with the same name in the destinationRegion. By default, secrets aren't overwritten.",
						MarkdownDescription: "Specifies whether to overwrite a secret with the same name in the destinationRegion. By default, secrets aren't overwritten.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
