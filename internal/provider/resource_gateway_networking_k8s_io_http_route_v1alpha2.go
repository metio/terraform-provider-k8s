...
var (
	_ resource.Resource = (*GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource)(nil)
)

type GatewayNetworkingK8SIoHTTPRouteV1Alpha2TerraformModel struct {
...
type GatewayNetworkingK8SIoHTTPRouteV1Alpha2GoModel struct {
...
func (r *GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_networking_k8s_io_http_route_v1alpha2"
}

func (r *GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_gateway_networking_k8s_io_http_route_v1alpha2")

	var state GatewayNetworkingK8SIoHTTPRouteV1Alpha2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GatewayNetworkingK8SIoHTTPRouteV1Alpha2GoModel
...
func (r *GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_networking_k8s_io_http_route_v1alpha2")
	// NO-OP: All data is already in Terraform state
}

func (r *GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GatewayNetworkingK8SIoHTTPRouteV1Alpha2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
