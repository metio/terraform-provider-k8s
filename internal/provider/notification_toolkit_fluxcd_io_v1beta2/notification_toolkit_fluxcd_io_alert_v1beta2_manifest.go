...
var (
	_ datasource.DataSource = &NotificationToolkitFluxcdIoAlertV1Beta2Manifest{}
)

func NewNotificationToolkitFluxcdIoAlertV1Beta2Manifest() datasource.DataSource {
	return &NotificationToolkitFluxcdIoAlertV1Beta2Manifest{}
}

type NotificationToolkitFluxcdIoAlertV1Beta2Manifest struct{}

type NotificationToolkitFluxcdIoAlertV1Beta2ManifestData struct {
...
func (r *NotificationToolkitFluxcdIoAlertV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_alert_v1beta2_manifest"
}

func (r *NotificationToolkitFluxcdIoAlertV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotificationToolkitFluxcdIoAlertV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_notification_toolkit_fluxcd_io_alert_v1beta2_manifest")

	var model NotificationToolkitFluxcdIoAlertV1Beta2ManifestData
