...
var (
	_ datasource.DataSource = &NotificationToolkitFluxcdIoReceiverV1Beta2Manifest{}
)

func NewNotificationToolkitFluxcdIoReceiverV1Beta2Manifest() datasource.DataSource {
	return &NotificationToolkitFluxcdIoReceiverV1Beta2Manifest{}
}
...
func (r *NotificationToolkitFluxcdIoReceiverV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_receiver_v1beta2_manifest"
}

func (r *NotificationToolkitFluxcdIoReceiverV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotificationToolkitFluxcdIoReceiverV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_notification_toolkit_fluxcd_io_receiver_v1beta2_manifest")

	var model NotificationToolkitFluxcdIoReceiverV1Beta2ManifestData
