...
var (
	_ datasource.DataSource              = &NotificationToolkitFluxcdIoProviderV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &NotificationToolkitFluxcdIoProviderV1Beta2DataSource{}
)

func NewNotificationToolkitFluxcdIoProviderV1Beta2DataSource() datasource.DataSource {
	return &NotificationToolkitFluxcdIoProviderV1Beta2DataSource{}
}

type NotificationToolkitFluxcdIoProviderV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type NotificationToolkitFluxcdIoProviderV1Beta2DataSourceData struct {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_provider_v1beta2"
}

func (r *NotificationToolkitFluxcdIoProviderV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_notification_toolkit_fluxcd_io_provider_v1beta2")

	var data NotificationToolkitFluxcdIoProviderV1Beta2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "notification.toolkit.fluxcd.io", Version: "v1beta2", Resource: "providers"}).
	...
	var readResponse NotificationToolkitFluxcdIoProviderV1Beta2DataSourceData
