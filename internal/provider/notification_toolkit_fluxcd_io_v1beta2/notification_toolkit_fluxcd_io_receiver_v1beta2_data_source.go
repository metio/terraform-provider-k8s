...
var (
	_ datasource.DataSource              = &NotificationToolkitFluxcdIoReceiverV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &NotificationToolkitFluxcdIoReceiverV1Beta2DataSource{}
)

func NewNotificationToolkitFluxcdIoReceiverV1Beta2DataSource() datasource.DataSource {
	return &NotificationToolkitFluxcdIoReceiverV1Beta2DataSource{}
}

type NotificationToolkitFluxcdIoReceiverV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type NotificationToolkitFluxcdIoReceiverV1Beta2DataSourceData struct {
...
func (r *NotificationToolkitFluxcdIoReceiverV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_receiver_v1beta2"
}

func (r *NotificationToolkitFluxcdIoReceiverV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotificationToolkitFluxcdIoReceiverV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NotificationToolkitFluxcdIoReceiverV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_notification_toolkit_fluxcd_io_receiver_v1beta2")

	var data NotificationToolkitFluxcdIoReceiverV1Beta2DataSourceData
	...
	var readResponse NotificationToolkitFluxcdIoReceiverV1Beta2DataSourceData
