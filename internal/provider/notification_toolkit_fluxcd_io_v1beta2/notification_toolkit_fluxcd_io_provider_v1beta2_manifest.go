...
var (
	_ datasource.DataSource = &NotificationToolkitFluxcdIoProviderV1Beta2Manifest{}
)

func NewNotificationToolkitFluxcdIoProviderV1Beta2Manifest() datasource.DataSource {
	return &NotificationToolkitFluxcdIoProviderV1Beta2Manifest{}
}

type NotificationToolkitFluxcdIoProviderV1Beta2Manifest struct{}

type NotificationToolkitFluxcdIoProviderV1Beta2ManifestData struct {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_provider_v1beta2_manifest"
}

func (r *NotificationToolkitFluxcdIoProviderV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"type": schema.StringAttribute{
						...
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("slack", "discord", "msteams", "rocket", "generic", "generic-hmac", "github", "gitlab", "gitea", "bitbucketserver", "bitbucket", "azuredevops", "googlechat", "googlepubsub", "webex", "sentry", "azureeventhub", "telegram", "lark", "matrix", "opsgenie", "alertmanager", "grafana", "githubdispatch", "pagerduty", "datadog"),
						},
					},
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_notification_toolkit_fluxcd_io_provider_v1beta2_manifest")

	var model NotificationToolkitFluxcdIoProviderV1Beta2ManifestData
