...
func TestNotificationToolkitFluxcdIoProviderV1Beta2Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_notification_toolkit_fluxcd_io_provider_v1beta2", testCase)
		})
	}
}
