...
var (
	_ datasource.DataSource              = &OperatorKnativeDevKnativeEventingV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorKnativeDevKnativeEventingV1Beta1DataSource{}
)

func NewOperatorKnativeDevKnativeEventingV1Beta1DataSource() datasource.DataSource {
	return &OperatorKnativeDevKnativeEventingV1Beta1DataSource{}
}

type OperatorKnativeDevKnativeEventingV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorKnativeDevKnativeEventingV1Beta1DataSourceData struct {
	...
	Spec *struct {
		...
		DefaultBrokerClass *string                       `tfsdk:"default_broker_class" json:"defaultBrokerClass,omitempty"`
		Deployments        *[]struct {
			Affinity *struct {
				NodeAffinity *struct {
		...
		SinkBindingSelectionMode *string `tfsdk:"sink_binding_selection_mode" json:"sinkBindingSelectionMode,omitempty"`
		Source                   *struct {
			Ceph *struct {
				Enabled *bool `tfsdk:"enabled" json:"enabled,omitempty"`
			} `tfsdk:"ceph" json:"ceph,omitempty"`
			Github *struct {
				Enabled *bool `tfsdk:"enabled" json:"enabled,omitempty"`
...
func (r *OperatorKnativeDevKnativeEventingV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_knative_dev_knative_eventing_v1beta1"
}

func (r *OperatorKnativeDevKnativeEventingV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"default_broker_class": schema.StringAttribute{
					...
					"sink_binding_selection_mode": schema.StringAttribute{
					...
					"source": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"ceph": schema.SingleNestedAttribute{
...
func (r *OperatorKnativeDevKnativeEventingV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorKnativeDevKnativeEventingV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_knative_dev_knative_eventing_v1beta1")

	var data OperatorKnativeDevKnativeEventingV1Beta1DataSourceData
	...
	var readResponse OperatorKnativeDevKnativeEventingV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("operator.knative.dev/v1beta1")
	data.Kind = pointer.String("KnativeEventing")
