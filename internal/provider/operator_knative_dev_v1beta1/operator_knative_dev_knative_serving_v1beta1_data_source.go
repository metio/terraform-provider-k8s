...
var (
	_ datasource.DataSource              = &OperatorKnativeDevKnativeServingV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorKnativeDevKnativeServingV1Beta1DataSource{}
)

func NewOperatorKnativeDevKnativeServingV1Beta1DataSource() datasource.DataSource {
	return &OperatorKnativeDevKnativeServingV1Beta1DataSource{}
}

type OperatorKnativeDevKnativeServingV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorKnativeDevKnativeServingV1Beta1DataSourceData struct {
...
func (r *OperatorKnativeDevKnativeServingV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_knative_dev_knative_serving_v1beta1"
}

func (r *OperatorKnativeDevKnativeServingV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorKnativeDevKnativeServingV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorKnativeDevKnativeServingV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_knative_dev_knative_serving_v1beta1")

	var data OperatorKnativeDevKnativeServingV1Beta1DataSourceData
	...
	var readResponse OperatorKnativeDevKnativeServingV1Beta1DataSourceData
	...
	data.Kind = pointer.String("KnativeServing")
