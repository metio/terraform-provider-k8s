...
var (
	_ resource.Resource = (*OperatorAquasecComAquaEnforcerV1Alpha1Resource)(nil)
)

type OperatorAquasecComAquaEnforcerV1Alpha1TerraformModel struct {
...
type OperatorAquasecComAquaEnforcerV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		RhcosVersion *string `tfsdk:"rhcos_version" yaml:"rhcosVersion,omitempty"`
		...
		Aqua_express_mode *bool `tfsdk:"aqua_express_mode" yaml:"aqua_express_mode,omitempty"`
		...
		Common *struct {
			AdminPassword *struct {
				...
				Name *string `tfsdk:"name" yaml:"name,omitempty"`
			} `tfsdk:"admin_password" yaml:"adminPassword,omitempty"`

			DatabaseSecret *struct {
				Key *string `tfsdk:"key" yaml:"key,omitempty"`

				Name *string `tfsdk:"name" yaml:"name,omitempty"`
			} `tfsdk:"database_secret" yaml:"databaseSecret,omitempty"`

			DbDiskSize *int64 `tfsdk:"db_disk_size" yaml:"dbDiskSize,omitempty"`
			...
			License *struct {
				...
				Name *string `tfsdk:"name" yaml:"name,omitempty"`
			} `tfsdk:"license" yaml:"license,omitempty"`

			SplitDB *bool `tfsdk:"split_db" yaml:"splitDB,omitempty"`

			Storageclass *string `tfsdk:"storageclass" yaml:"storageclass,omitempty"`

			ActiveActive *bool `tfsdk:"active_active" yaml:"activeActive,omitempty"`

			AllowAnyVersion *bool `tfsdk:"allow_any_version" yaml:"allowAnyVersion,omitempty"`

			CybercenterAddress *string `tfsdk:"cybercenter_address" yaml:"cybercenterAddress,omitempty"`
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_aquasec_com_aqua_enforcer_v1alpha1"
}

func (r *OperatorAquasecComAquaEnforcerV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_aquasec_com_aqua_enforcer_v1alpha1")

	var state OperatorAquasecComAquaEnforcerV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorAquasecComAquaEnforcerV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("operator.aquasec.com/v1alpha1")
	goModel.Kind = utilities.Ptr("AquaEnforcer")
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_enforcer_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorAquasecComAquaEnforcerV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
