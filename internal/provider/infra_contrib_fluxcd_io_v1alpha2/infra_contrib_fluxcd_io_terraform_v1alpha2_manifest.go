...
var (
	_ datasource.DataSource = &InfraContribFluxcdIoTerraformV1Alpha2Manifest{}
)

func NewInfraContribFluxcdIoTerraformV1Alpha2Manifest() datasource.DataSource {
	return &InfraContribFluxcdIoTerraformV1Alpha2Manifest{}
}
...
type InfraContribFluxcdIoTerraformV1Alpha2ManifestData struct {
	...
	Spec *struct {
		AlwaysCleanupRunnerPod *bool   `tfsdk:"always_cleanup_runner_pod" json:"alwaysCleanupRunnerPod,omitempty"`
		ApprovePlan            *string `tfsdk:"approve_plan" json:"approvePlan,omitempty"`
		BackendConfig          *struct {
			ConfigPath          *string            `tfsdk:"config_path" json:"configPath,omitempty"`
			CustomConfiguration *string            `tfsdk:"custom_configuration" json:"customConfiguration,omitempty"`
			Disable             *bool              `tfsdk:"disable" json:"disable,omitempty"`
			InClusterConfig     *bool              `tfsdk:"in_cluster_config" json:"inClusterConfig,omitempty"`
			Labels              *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
			SecretSuffix        *string            `tfsdk:"secret_suffix" json:"secretSuffix,omitempty"`
		} `tfsdk:"backend_config" json:"backendConfig,omitempty"`
		BackendConfigsFrom *[]struct {
			Keys     *[]string `tfsdk:"keys" json:"keys,omitempty"`
			Kind     *string   `tfsdk:"kind" json:"kind,omitempty"`
			Name     *string   `tfsdk:"name" json:"name,omitempty"`
			Optional *bool     `tfsdk:"optional" json:"optional,omitempty"`
		} `tfsdk:"backend_configs_from" json:"backendConfigsFrom,omitempty"`
		BranchPlanner *struct {
			EnablePathScope *bool `tfsdk:"enable_path_scope" json:"enablePathScope,omitempty"`
		} `tfsdk:"branch_planner" json:"branchPlanner,omitempty"`
		BreakTheGlass      *bool `tfsdk:"break_the_glass" json:"breakTheGlass,omitempty"`
		CliConfigSecretRef *struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
		} `tfsdk:"cli_config_secret_ref" json:"cliConfigSecretRef,omitempty"`
		Cloud *struct {
		...
		Destroy                    *bool              `tfsdk:"destroy" json:"destroy,omitempty"`
		DestroyResourcesOnDeletion *bool              `tfsdk:"destroy_resources_on_deletion" json:"destroyResourcesOnDeletion,omitempty"`
		DisableDriftDetection      *bool              `tfsdk:"disable_drift_detection" json:"disableDriftDetection,omitempty"`
		EnableInventory            *bool              `tfsdk:"enable_inventory" json:"enableInventory,omitempty"`
		Enterprise                 *map[string]string `tfsdk:"enterprise" json:"enterprise,omitempty"`
		FileMappings               *[]struct {
		...
		} `tfsdk:"file_mappings" json:"fileMappings,omitempty"`
		...
		ReadInputsFromSecrets *[]struct {
			As   *string `tfsdk:"as" json:"as,omitempty"`
			Name *string `tfsdk:"name" json:"name,omitempty"`
		} `tfsdk:"read_inputs_from_secrets" json:"readInputsFromSecrets,omitempty"`
		RefreshBeforeApply *bool `tfsdk:"refresh_before_apply" json:"refreshBeforeApply,omitempty"`
		Remediation        *struct {
		...
		} `tfsdk:"runner_pod_template" json:"runnerPodTemplate,omitempty"`
		RunnerTerminationGracePeriodSeconds *int64  `tfsdk:"runner_termination_grace_period_seconds" json:"runnerTerminationGracePeriodSeconds,omitempty"`
		...
		StoreReadablePlan *string   `tfsdk:"store_readable_plan" json:"storeReadablePlan,omitempty"`
		Suspend           *bool     `tfsdk:"suspend" json:"suspend,omitempty"`
		Targets           *[]string `tfsdk:"targets" json:"targets,omitempty"`
		TfVarsFiles       *[]string `tfsdk:"tf_vars_files" json:"tfVarsFiles,omitempty"`
		Tfstate           *struct {
			ForceUnlock    *string `tfsdk:"force_unlock" json:"forceUnlock,omitempty"`
			LockIdentifier *string `tfsdk:"lock_identifier" json:"lockIdentifier,omitempty"`
			LockTimeout    *string `tfsdk:"lock_timeout" json:"lockTimeout,omitempty"`
		} `tfsdk:"tfstate" json:"tfstate,omitempty"`
		...
		VarsFrom *[]struct {
			...
			Name     *string   `tfsdk:"name" json:"name,omitempty"`
			Optional *bool     `tfsdk:"optional" json:"optional,omitempty"`
			VarsKeys *[]string `tfsdk:"vars_keys" json:"varsKeys,omitempty"`
		} `tfsdk:"vars_from" json:"varsFrom,omitempty"`
		Webhooks *[]struct {
			Enabled              *bool   `tfsdk:"enabled" json:"enabled,omitempty"`
			ErrorMessageTemplate *string `tfsdk:"error_message_template" json:"errorMessageTemplate,omitempty"`
			PayloadType          *string `tfsdk:"payload_type" json:"payloadType,omitempty"`
			Stage                *string `tfsdk:"stage" json:"stage,omitempty"`
			TestExpression       *string `tfsdk:"test_expression" json:"testExpression,omitempty"`
			Url                  *string `tfsdk:"url" json:"url,omitempty"`
		} `tfsdk:"webhooks" json:"webhooks,omitempty"`
		Workspace            *string `tfsdk:"workspace" json:"workspace,omitempty"`
		WriteOutputsToSecret *struct {
			Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			Labels      *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
			Name        *string            `tfsdk:"name" json:"name,omitempty"`
			Outputs     *[]string          `tfsdk:"outputs" json:"outputs,omitempty"`
		} `tfsdk:"write_outputs_to_secret" json:"writeOutputsToSecret,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *InfraContribFluxcdIoTerraformV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infra_contrib_fluxcd_io_terraform_v1alpha2_manifest"
}

func (r *InfraContribFluxcdIoTerraformV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TerraformSpec defines the desired state of Terraform",
				Attributes: map[string]schema.Attribute{
					"always_cleanup_runner_pod": schema.BoolAttribute{
						Description:         "Clean the runner pod up after each reconciliation cycle",
						MarkdownDescription: "Clean the runner pod up after each reconciliation cycle",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"approve_plan": schema.StringAttribute{
						Description:         "ApprovePlan specifies name of a plan wanted to approve.If its value is 'auto', the controller will automatically approve every plan.",
						MarkdownDescription: "ApprovePlan specifies name of a plan wanted to approve.If its value is 'auto', the controller will automatically approve every plan.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"backend_config": schema.SingleNestedAttribute{
						Description:         "BackendConfigSpec is for specifying configuration for Terraform's Kubernetes backend",
						MarkdownDescription: "BackendConfigSpec is for specifying configuration for Terraform's Kubernetes backend",
						Attributes: map[string]schema.Attribute{
							...
							"disable": schema.BoolAttribute{
								...
								MarkdownDescription: "Disable is to completely disable the backend configuration.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"in_cluster_config": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
					...
					"backend_configs_from": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"keys": schema.ListAttribute{
									Description:         "Keys is the data key where a specific value can be found at. Defaults to all keys.",
									MarkdownDescription: "Keys is the data key where a specific value can be found at. Defaults to all keys.",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
								...
								"name": schema.StringAttribute{
									Description:         "Name of the configs referent. Should reside in the same namespace as thereferring resource.",
									MarkdownDescription: "Name of the configs referent. Should reside in the same namespace as thereferring resource.",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"optional": schema.BoolAttribute{
									Description:         "Optional marks this BackendConfigsReference as optional. When set, a not found errorfor the values reference is ignored, but any Key ortransient error will still result in a reconciliation failure.",
									MarkdownDescription: "Optional marks this BackendConfigsReference as optional. When set, a not found errorfor the values reference is ignored, but any Key ortransient error will still result in a reconciliation failure.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"branch_planner": schema.SingleNestedAttribute{
						Description:         "BranchPlanner configuration.",
						MarkdownDescription: "BranchPlanner configuration.",
						Attributes: map[string]schema.Attribute{
							"enable_path_scope": schema.BoolAttribute{
								Description:         "EnablePathScope specifies if the Branch Planner should or shouldn't checkif a Pull Request has changes under '.spec.path'. If enabled extraresources will be created only if there are any changes in terraform files.",
								MarkdownDescription: "EnablePathScope specifies if the Branch Planner should or shouldn't checkif a Pull Request has changes under '.spec.path'. If enabled extraresources will be created only if there are any changes in terraform files.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"break_the_glass": schema.BoolAttribute{
						Description:         "BreakTheGlass specifies if the reconciliation should stopand allow interactive shell in case of emergency.",
						MarkdownDescription: "BreakTheGlass specifies if the reconciliation should stopand allow interactive shell in case of emergency.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"cli_config_secret_ref": schema.SingleNestedAttribute{
					...
					"cloud": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"workspaces": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
					...
					"destroy": schema.BoolAttribute{
						Description:         "Destroy produces a destroy plan. Applying the plan will destroy all resources.",
						MarkdownDescription: "Destroy produces a destroy plan. Applying the plan will destroy all resources.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"destroy_resources_on_deletion": schema.BoolAttribute{
						Description:         "Create destroy plan and apply it to destroy terraform resourcesupon deletion of this object. Defaults to false.",
						MarkdownDescription: "Create destroy plan and apply it to destroy terraform resourcesupon deletion of this object. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"disable_drift_detection": schema.BoolAttribute{
						Description:         "Disable automatic drift detection. Drift detection may be resource intensive inthe context of a large cluster or complex Terraform statefile. Defaults to false.",
						MarkdownDescription: "Disable automatic drift detection. Drift detection may be resource intensive inthe context of a large cluster or complex Terraform statefile. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"enable_inventory": schema.BoolAttribute{
						Description:         "EnableInventory enables the object to store resource entries as the inventory for external use.",
						MarkdownDescription: "EnableInventory enables the object to store resource entries as the inventory for external use.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"enterprise": schema.MapAttribute{
						Description:         "Enterprise is the enterprise configuration placeholder.",
						MarkdownDescription: "Enterprise is the enterprise configuration placeholder.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"file_mappings": schema.ListNestedAttribute{
						Description:         "List of all configuration files to be created in initialization.",
						MarkdownDescription: "List of all configuration files to be created in initialization.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"location": schema.StringAttribute{
									Description:         "Location can be either user's home directory or the Terraform workspace",
									MarkdownDescription: "Location can be either user's home directory or the Terraform workspace",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
										stringvalidator.OneOf("home", "workspace"),
									},
								},

								"path": schema.StringAttribute{
									Description:         "Path of the file - relative to the 'location'",
									MarkdownDescription: "Path of the file - relative to the 'location'",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
										stringvalidator.RegexMatches(regexp.MustCompile(`^(.?[/_a-zA-Z0-9]{1,})*$`), ""),
									},
								},

								"secret_ref": schema.SingleNestedAttribute{
									Description:         "Reference to a Secret that contains the file content",
									MarkdownDescription: "Reference to a Secret that contains the file content",
									Attributes: map[string]schema.Attribute{
					...
					"force": schema.BoolAttribute{
						Description:         "Force instructs the controller to unconditionallyre-plan and re-apply TF resources. Defaults to false.",
						MarkdownDescription: "Force instructs the controller to unconditionallyre-plan and re-apply TF resources. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"health_checks": schema.ListNestedAttribute{
						...
						MarkdownDescription: "List of health checks to be performed.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"address": schema.StringAttribute{
									Description:         "Address to perform tcp health check on. Required when tcp type is specified.Go template can be used to reference values from the terraform output(e.g. 127.0.0.1:8080, {{.address}}:{{.port}}).",
									MarkdownDescription: "Address to perform tcp health check on. Required when tcp type is specified.Go template can be used to reference values from the terraform output(e.g. 127.0.0.1:8080, {{.address}}:{{.port}}).",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"timeout": schema.StringAttribute{
									Description:         "The timeout period at which the connection should timeout if unable tocomplete the request.When not specified, default 20s timeout is used.",
									MarkdownDescription: "The timeout period at which the connection should timeout if unable tocomplete the request.When not specified, default 20s timeout is used.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"type": schema.StringAttribute{
									Description:         "Type of the health check, valid values are ('tcp', 'http').If tcp is specified, address is required.If http is specified, url is required.",
									MarkdownDescription: "Type of the health check, valid values are ('tcp', 'http').If tcp is specified, address is required.If http is specified, url is required.",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"url": schema.StringAttribute{
									Description:         "URL to perform http health check on. Required when http type is specified.Go template can be used to reference values from the terraform output(e.g. https://example.org, {{.output_url}}).",
									MarkdownDescription: "URL to perform http health check on. Required when http type is specified.Go template can be used to reference values from the terraform output(e.g. https://example.org, {{.output_url}}).",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"interval": schema.StringAttribute{
						...
						MarkdownDescription: "The interval at which to reconcile the Terraform.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"path": schema.StringAttribute{
						Description:         "Path to the directory containing Terraform (.tf) files.Defaults to 'None', which translates to the root path of the SourceRef.",
						MarkdownDescription: "Path to the directory containing Terraform (.tf) files.Defaults to 'None', which translates to the root path of the SourceRef.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"plan_only": schema.BoolAttribute{
						Description:         "PlanOnly specifies if the reconciliation should or should not stop at planphase.",
						MarkdownDescription: "PlanOnly specifies if the reconciliation should or should not stop at planphase.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"read_inputs_from_secrets": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"refresh_before_apply": schema.BoolAttribute{
						Description:         "RefreshBeforeApply forces refreshing of the state before the apply step.",
						MarkdownDescription: "RefreshBeforeApply forces refreshing of the state before the apply step.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"remediation": schema.SingleNestedAttribute{
						Description:         "Remediation specifies what the controller should do when reconciliationfails. The default is to not perform any action.",
						MarkdownDescription: "Remediation specifies what the controller should do when reconciliationfails. The default is to not perform any action.",
						Attributes: map[string]schema.Attribute{
							"retries": schema.Int64Attribute{
								Description:         "Retries is the number of retries that should be attempted on failuresbefore bailing. Defaults to '0', a negative integer denotes unlimitedretries.",
								MarkdownDescription: "Retries is the number of retries that should be attempted on failuresbefore bailing. Defaults to '0', a negative integer denotes unlimitedretries.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"retry_interval": schema.StringAttribute{
						...
						MarkdownDescription: "The interval at which to retry a previously failed reconciliation.The default value is 15 when not specified.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
							...
							"metadata": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"annotations": schema.MapAttribute{
										...
										MarkdownDescription: "Annotations to add to the runner pod",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"labels": schema.MapAttribute{
										...
										MarkdownDescription: "Labels to add to the runner pod",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
							...
							"spec": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"affinity": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Set the Affinity for the Runner Pod",
										Attributes: map[string]schema.Attribute{
									...
									"host_aliases": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set host aliases for the Runner Pod",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"image": schema.StringAttribute{
										...
										MarkdownDescription: "Runner pod image to use other than default",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"init_containers": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set up Init Containers for the Runner",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"node_selector": schema.MapAttribute{
										...
										MarkdownDescription: "Set the NodeSelector for the Runner Pod",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"priority_class_name": schema.StringAttribute{
										Description:         "Set PriorityClassName for the Runner Pod container",
										MarkdownDescription: "Set PriorityClassName for the Runner Pod container",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"resources": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Set Resources for the Runner Pod container",
										Attributes: map[string]schema.Attribute{
											"claims": schema.ListNestedAttribute{
												Description:         "Claims lists the names of resources, defined in spec.resourceClaims,that are used by this container.This is an alpha field and requires enabling theDynamicResourceAllocation feature gate.This field is immutable. It can only be set for containers.",
												MarkdownDescription: "Claims lists the names of resources, defined in spec.resourceClaims,that are used by this container.This is an alpha field and requires enabling theDynamicResourceAllocation feature gate.This field is immutable. It can only be set for containers.",
									...
									"security_context": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Set SecurityContext for the Runner Pod container",
										Attributes: map[string]schema.Attribute{
											"allow_privilege_escalation": schema.BoolAttribute{
												Description:         "AllowPrivilegeEscalation controls whether a process can gain moreprivileges than its parent process. This bool directly controls ifthe no_new_privs flag will be set on the container process.AllowPrivilegeEscalation is true always when the container is:1) run as Privileged2) has CAP_SYS_ADMINNote that this field cannot be set when spec.os.name is windows.",
												MarkdownDescription: "AllowPrivilegeEscalation controls whether a process can gain moreprivileges than its parent process. This bool directly controls ifthe no_new_privs flag will be set on the container process.AllowPrivilegeEscalation is true always when the container is:1) run as Privileged2) has CAP_SYS_ADMINNote that this field cannot be set when spec.os.name is windows.",
									...
									"tolerations": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set the Tolerations for the Runner Pod",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"volume_mounts": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set Volume Mounts for the Runner Pod",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"mount_path": schema.StringAttribute{
													Description:         "Path within the container at which the volume should be mounted.  Mustnot contain ':'.",
									...
									"volumes": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set Volumes for the Runner Pod",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
					...
					"runner_termination_grace_period_seconds": schema.Int64Attribute{
						Description:         "Configure the termination grace period for the runner pod. Use this parameterto allow the Terraform process to gracefully shutdown. Consider increasing forlarge, complex or slow-moving Terraform managed resources.",
						MarkdownDescription: "Configure the termination grace period for the runner pod. Use this parameterto allow the Terraform process to gracefully shutdown. Consider increasing forlarge, complex or slow-moving Terraform managed resources.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"service_account_name": schema.StringAttribute{
						Description:         "Name of a ServiceAccount for the runner Pod to provision Terraform resources.Default to tf-runner.",
						MarkdownDescription: "Name of a ServiceAccount for the runner Pod to provision Terraform resources.Default to tf-runner.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"source_ref": schema.SingleNestedAttribute{
						Description:         "SourceRef is the reference of the source where the Terraform files are stored.",
						MarkdownDescription: "SourceRef is the reference of the source where the Terraform files are stored.",
						Attributes: map[string]schema.Attribute{
							"api_version": schema.StringAttribute{
							...
							"kind": schema.StringAttribute{
								...
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("GitRepository", "Bucket", "OCIRepository"),
								},
							},
					...
					"store_readable_plan": schema.StringAttribute{
						Description:         "StoreReadablePlan enables storing the plan in a readable format.",
						MarkdownDescription: "StoreReadablePlan enables storing the plan in a readable format.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("none", "json", "human"),
						},
					},

					"suspend": schema.BoolAttribute{
						Description:         "Suspend is to tell the controller to suspend subsequent TF executions,it does not apply to already started executions. Defaults to false.",
						MarkdownDescription: "Suspend is to tell the controller to suspend subsequent TF executions,it does not apply to already started executions. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"targets": schema.ListAttribute{
						Description:         "Targets specify the resource, module or collection of resources to target.",
						MarkdownDescription: "Targets specify the resource, module or collection of resources to target.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"tf_vars_files": schema.ListAttribute{
						Description:         "TfVarsFiles loads all given .tfvars files. It copycats the -var-file functionality.",
						MarkdownDescription: "TfVarsFiles loads all given .tfvars files. It copycats the -var-file functionality.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"tfstate": schema.SingleNestedAttribute{
						Description:         "TFStateSpec allows the user to set ForceUnlock",
						MarkdownDescription: "TFStateSpec allows the user to set ForceUnlock",
						Attributes: map[string]schema.Attribute{
							"force_unlock": schema.StringAttribute{
								Description:         "ForceUnlock a Terraform state if it has become locked for any reason. Defaults to 'no'.This is an Enum and has the expected values of:- auto- yes- noWARNING: Only use 'auto' in the cases where you are absolutely certain thatno other system is using this state, you could otherwise end up in a bad placeSee https://www.terraform.io/language/state/locking#force-unlock for moreinformation on the terraform state lock and force unlock.",
								MarkdownDescription: "ForceUnlock a Terraform state if it has become locked for any reason. Defaults to 'no'.This is an Enum and has the expected values of:- auto- yes- noWARNING: Only use 'auto' in the cases where you are absolutely certain thatno other system is using this state, you could otherwise end up in a bad placeSee https://www.terraform.io/language/state/locking#force-unlock for moreinformation on the terraform state lock and force unlock.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("yes", "no", "auto"),
								},
							},

							"lock_identifier": schema.StringAttribute{
								Description:         "LockIdentifier holds the Identifier required by Terraform to unlock the stateif it ever gets into a locked state.You'll need to put the Lock Identifier in here while setting ForceUnlock toeither 'yes' or 'auto'.Leave this empty to do nothing, set this to the value of the 'Lock Info: ID: [value]',e.g. 'f2ab685b-f84d-ac0b-a125-378a22877e8d', to force unlock the state.",
								MarkdownDescription: "LockIdentifier holds the Identifier required by Terraform to unlock the stateif it ever gets into a locked state.You'll need to put the Lock Identifier in here while setting ForceUnlock toeither 'yes' or 'auto'.Leave this empty to do nothing, set this to the value of the 'Lock Info: ID: [value]',e.g. 'f2ab685b-f84d-ac0b-a125-378a22877e8d', to force unlock the state.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"lock_timeout": schema.StringAttribute{
								Description:         "LockTimeout is a Duration string that instructs Terraform to retry acquiring a lock for the specified period oftime before returning an error. The duration syntax is a number followed by a time unit letter, such as '3s' forthree seconds.Defaults to '0s' which will behave as though 'LockTimeout' was not set",
								MarkdownDescription: "LockTimeout is a Duration string that instructs Terraform to retry acquiring a lock for the specified period oftime before returning an error. The duration syntax is a number followed by a time unit letter, such as '3s' forthree seconds.Defaults to '0s' which will behave as though 'LockTimeout' was not set",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"values": schema.MapAttribute{
						Description:         "Values map to the Terraform variable 'values', which is an object of arbitrary values.It is a convenient way to pass values to Terraform resources without having to definea variable for each value. To use this feature, your Terraform file must define the variable 'values'.",
						MarkdownDescription: "Values map to the Terraform variable 'values', which is an object of arbitrary values.It is a convenient way to pass values to Terraform resources without having to definea variable for each value. To use this feature, your Terraform file must define the variable 'values'.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"vars": schema.ListNestedAttribute{
						...
						MarkdownDescription: "List of input variables to set for the Terraform program.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Name is the name of the variable",
									MarkdownDescription: "Name is the name of the variable",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
					...
					"vars_from": schema.ListNestedAttribute{
						Description:         "List of references to a Secret or a ConfigMap to generate variables forTerraform resources based on its data, selectively by varsKey. Values of the laterSecret / ConfigMap with the same keys will override those of the former.",
						MarkdownDescription: "List of references to a Secret or a ConfigMap to generate variables forTerraform resources based on its data, selectively by varsKey. Values of the laterSecret / ConfigMap with the same keys will override those of the former.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"kind": schema.StringAttribute{
									Description:         "Kind of the values referent, valid values are ('Secret', 'ConfigMap').",
								...
								"optional": schema.BoolAttribute{
									Description:         "Optional marks this VarsReference as optional. When set, a not found errorfor the values reference is ignored, but any VarsKey ortransient error will still result in a reconciliation failure.",
									MarkdownDescription: "Optional marks this VarsReference as optional. When set, a not found errorfor the values reference is ignored, but any VarsKey ortransient error will still result in a reconciliation failure.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"vars_keys": schema.ListAttribute{
									Description:         "VarsKeys is the data key at which a specific value can be found. Defaults to all keys.",
									MarkdownDescription: "VarsKeys is the data key at which a specific value can be found. Defaults to all keys.",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"stage": schema.StringAttribute{
									...
									Computed:            false,
									Validators: []validator.String{
										stringvalidator.OneOf("post-planning"),
									},
								},

								"test_expression": schema.StringAttribute{
									Description:         "",
									MarkdownDescription: "",
									Required:            false,
									Optional:            true,
					...
					"write_outputs_to_secret": schema.SingleNestedAttribute{
						Description:         "A list of target secrets for the outputs to be written as.",
						MarkdownDescription: "A list of target secrets for the outputs to be written as.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations to add to the outputted secret",
								MarkdownDescription: "Annotations to add to the outputted secret",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"labels": schema.MapAttribute{
								Description:         "Labels to add to the outputted secret",
								MarkdownDescription: "Labels to add to the outputted secret",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"name": schema.StringAttribute{
								...
								MarkdownDescription: "Name is the name of the Secret to be written",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"outputs": schema.ListAttribute{
								Description:         "Outputs contain the selected names of outputs to be writtento the secret. Empty array means writing all outputs, which is default.",
								MarkdownDescription: "Outputs contain the selected names of outputs to be writtento the secret. Empty array means writing all outputs, which is default.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
...
func (r *InfraContribFluxcdIoTerraformV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infra_contrib_fluxcd_io_terraform_v1alpha2_manifest")

	var model InfraContribFluxcdIoTerraformV1Alpha2ManifestData
