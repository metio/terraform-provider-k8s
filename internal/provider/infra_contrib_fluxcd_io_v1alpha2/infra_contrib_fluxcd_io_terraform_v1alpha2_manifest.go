...
type InfraContribFluxcdIoTerraformV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		UpgradeOnInit *bool              `tfsdk:"upgrade_on_init" json:"upgradeOnInit,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"backend_configs_from": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"name": schema.StringAttribute{
									Description:         "Name of the configs referent. Should reside in the same namespace as the referring resource.",
									MarkdownDescription: "Name of the configs referent. Should reside in the same namespace as the referring resource.",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"optional": schema.BoolAttribute{
									Description:         "Optional marks this BackendConfigsReference as optional. When set, a not found error for the values reference is ignored, but any Key or transient error will still result in a reconciliation failure.",
									MarkdownDescription: "Optional marks this BackendConfigsReference as optional. When set, a not found error for the values reference is ignored, but any Key or transient error will still result in a reconciliation failure.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"branch_planner": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"enable_path_scope": schema.BoolAttribute{
								Description:         "EnablePathScope specifies if the Branch Planner should or shouldn't check if a Pull Request has changes under '.spec.path'. If enabled extra resources will be created only if there are any changes in terraform files.",
								MarkdownDescription: "EnablePathScope specifies if the Branch Planner should or shouldn't check if a Pull Request has changes under '.spec.path'. If enabled extra resources will be created only if there are any changes in terraform files.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"break_the_glass": schema.BoolAttribute{
						Description:         "BreakTheGlass specifies if the reconciliation should stop and allow interactive shell in case of emergency.",
						MarkdownDescription: "BreakTheGlass specifies if the reconciliation should stop and allow interactive shell in case of emergency.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"destroy_resources_on_deletion": schema.BoolAttribute{
						Description:         "Create destroy plan and apply it to destroy terraform resources upon deletion of this object. Defaults to false.",
						MarkdownDescription: "Create destroy plan and apply it to destroy terraform resources upon deletion of this object. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"disable_drift_detection": schema.BoolAttribute{
						Description:         "Disable automatic drift detection. Drift detection may be resource intensive in the context of a large cluster or complex Terraform statefile. Defaults to false.",
						MarkdownDescription: "Disable automatic drift detection. Drift detection may be resource intensive in the context of a large cluster or complex Terraform statefile. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"force": schema.BoolAttribute{
						Description:         "Force instructs the controller to unconditionally re-plan and re-apply TF resources. Defaults to false.",
						MarkdownDescription: "Force instructs the controller to unconditionally re-plan and re-apply TF resources. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"timeout": schema.StringAttribute{
									Description:         "The timeout period at which the connection should timeout if unable to complete the request. When not specified, default 20s timeout is used.",
									MarkdownDescription: "The timeout period at which the connection should timeout if unable to complete the request. When not specified, default 20s timeout is used.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"plan_only": schema.BoolAttribute{
						Description:         "PlanOnly specifies if the reconciliation should or should not stop at plan phase.",
						MarkdownDescription: "PlanOnly specifies if the reconciliation should or should not stop at plan phase.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"remediation": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Remediation specifies what the controller should do when reconciliation fails. The default is to not perform any action.",
						Attributes: map[string]schema.Attribute{
							"retries": schema.Int64Attribute{
								...
								MarkdownDescription: "Retries is the number of retries that should be attempted on failures before bailing. Defaults to '0', a negative integer denotes unlimited retries.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"runner_termination_grace_period_seconds": schema.Int64Attribute{
						Description:         "Configure the termination grace period for the runner pod. Use this parameter to allow the Terraform process to gracefully shutdown. Consider increasing for large, complex or slow-moving Terraform managed resources.",
						MarkdownDescription: "Configure the termination grace period for the runner pod. Use this parameter to allow the Terraform process to gracefully shutdown. Consider increasing for large, complex or slow-moving Terraform managed resources.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"tfstate": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"lock_identifier": schema.StringAttribute{
								Description:         "LockIdentifier holds the Identifier required by Terraform to unlock the state if it ever gets into a locked state. You'll need to put the Lock Identifier in here while setting ForceUnlock to either 'yes' or 'auto'. Leave this empty to do nothing, set this to the value of the 'Lock Info: ID: [value]', e.g. 'f2ab685b-f84d-ac0b-a125-378a22877e8d', to force unlock the state.",
								MarkdownDescription: "LockIdentifier holds the Identifier required by Terraform to unlock the state if it ever gets into a locked state. You'll need to put the Lock Identifier in here while setting ForceUnlock to either 'yes' or 'auto'. Leave this empty to do nothing, set this to the value of the 'Lock Info: ID: [value]', e.g. 'f2ab685b-f84d-ac0b-a125-378a22877e8d', to force unlock the state.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"lock_timeout": schema.StringAttribute{
								Description:         "LockTimeout is a Duration string that instructs Terraform to retry acquiring a lock for the specified period of time before returning an error. The duration syntax is a number followed by a time unit letter, such as '3s' for three seconds. Defaults to '0s' which will behave as though 'LockTimeout' was not set",
								MarkdownDescription: "LockTimeout is a Duration string that instructs Terraform to retry acquiring a lock for the specified period of time before returning an error. The duration syntax is a number followed by a time unit letter, such as '3s' for three seconds. Defaults to '0s' which will behave as though 'LockTimeout' was not set",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"upgrade_on_init": schema.BoolAttribute{
						Description:         "UpgradeOnInit configures to upgrade modules and providers on initialization of a stack",
						MarkdownDescription: "UpgradeOnInit configures to upgrade modules and providers on initialization of a stack",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"values": schema.MapAttribute{
						Description:         "Values map to the Terraform variable 'values', which is an object of arbitrary values. It is a convenient way to pass values to Terraform resources without having to define a variable for each value. To use this feature, your Terraform file must define the variable 'values'.",
						MarkdownDescription: "Values map to the Terraform variable 'values', which is an object of arbitrary values. It is a convenient way to pass values to Terraform resources without having to define a variable for each value. To use this feature, your Terraform file must define the variable 'values'.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"vars_from": schema.ListNestedAttribute{
						Description:         "List of references to a Secret or a ConfigMap to generate variables for Terraform resources based on its data, selectively by varsKey. Values of the later Secret / ConfigMap with the same keys will override those of the former.",
						MarkdownDescription: "List of references to a Secret or a ConfigMap to generate variables for Terraform resources based on its data, selectively by varsKey. Values of the later Secret / ConfigMap with the same keys will override those of the former.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"kind": schema.StringAttribute{
									Description:         "Kind of the values referent, valid values are ('Secret', 'ConfigMap').",
								...
								"optional": schema.BoolAttribute{
									Description:         "Optional marks this VarsReference as optional. When set, a not found error for the values reference is ignored, but any VarsKey or transient error will still result in a reconciliation failure.",
									MarkdownDescription: "Optional marks this VarsReference as optional. When set, a not found error for the values reference is ignored, but any VarsKey or transient error will still result in a reconciliation failure.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"write_outputs_to_secret": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"outputs": schema.ListAttribute{
								Description:         "Outputs contain the selected names of outputs to be written to the secret. Empty array means writing all outputs, which is default.",
								MarkdownDescription: "Outputs contain the selected names of outputs to be written to the secret. Empty array means writing all outputs, which is default.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
