...
var (
	_ datasource.DataSource              = &ApmK8SElasticCoApmServerV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ApmK8SElasticCoApmServerV1Beta1DataSource{}
)

func NewApmK8SElasticCoApmServerV1Beta1DataSource() datasource.DataSource {
	return &ApmK8SElasticCoApmServerV1Beta1DataSource{}
}

type ApmK8SElasticCoApmServerV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ApmK8SElasticCoApmServerV1Beta1DataSourceData struct {
...
func (r *ApmK8SElasticCoApmServerV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apm_k8s_elastic_co_apm_server_v1beta1"
}

func (r *ApmK8SElasticCoApmServerV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApmK8SElasticCoApmServerV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ApmK8SElasticCoApmServerV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apm_k8s_elastic_co_apm_server_v1beta1")

	var data ApmK8SElasticCoApmServerV1Beta1DataSourceData
	...
	var readResponse ApmK8SElasticCoApmServerV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("apm.k8s.elastic.co/v1beta1")
	data.Kind = pointer.String("ApmServer")
