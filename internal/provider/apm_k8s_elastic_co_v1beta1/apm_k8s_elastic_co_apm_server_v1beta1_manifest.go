...
var (
	_ datasource.DataSource = &ApmK8SElasticCoApmServerV1Beta1Manifest{}
)

func NewApmK8SElasticCoApmServerV1Beta1Manifest() datasource.DataSource {
	return &ApmK8SElasticCoApmServerV1Beta1Manifest{}
}

type ApmK8SElasticCoApmServerV1Beta1Manifest struct{}

type ApmK8SElasticCoApmServerV1Beta1ManifestData struct {
...
func (r *ApmK8SElasticCoApmServerV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apm_k8s_elastic_co_apm_server_v1beta1_manifest"
}

func (r *ApmK8SElasticCoApmServerV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApmK8SElasticCoApmServerV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apm_k8s_elastic_co_apm_server_v1beta1_manifest")

	var model ApmK8SElasticCoApmServerV1Beta1ManifestData
