...
var (
	_ resource.Resource = (*DataFluidIoAlluxioRuntimeV1Alpha1Resource)(nil)
)

type DataFluidIoAlluxioRuntimeV1Alpha1TerraformModel struct {
...
type DataFluidIoAlluxioRuntimeV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"alluxio_version" yaml:"alluxioVersion,omitempty"`
...
func (r *DataFluidIoAlluxioRuntimeV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_data_fluid_io_alluxio_runtime_v1alpha1"
}

func (r *DataFluidIoAlluxioRuntimeV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *DataFluidIoAlluxioRuntimeV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_data_fluid_io_alluxio_runtime_v1alpha1")

	var state DataFluidIoAlluxioRuntimeV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel DataFluidIoAlluxioRuntimeV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("AlluxioRuntime")
...
func (r *DataFluidIoAlluxioRuntimeV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_alluxio_runtime_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *DataFluidIoAlluxioRuntimeV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *DataFluidIoAlluxioRuntimeV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
