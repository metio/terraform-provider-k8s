...
var (
	_ datasource.DataSource = &AppsEmqxIoEmqxBrokerV1Beta4Manifest{}
)

func NewAppsEmqxIoEmqxBrokerV1Beta4Manifest() datasource.DataSource {
	return &AppsEmqxIoEmqxBrokerV1Beta4Manifest{}
}

type AppsEmqxIoEmqxBrokerV1Beta4Manifest struct{}

type AppsEmqxIoEmqxBrokerV1Beta4ManifestData struct {
...
func (r *AppsEmqxIoEmqxBrokerV1Beta4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_emqx_io_emqx_broker_v1beta4_manifest"
}

func (r *AppsEmqxIoEmqxBrokerV1Beta4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsEmqxIoEmqxBrokerV1Beta4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_emqx_io_emqx_broker_v1beta4_manifest")

	var model AppsEmqxIoEmqxBrokerV1Beta4ManifestData
	...
	model.Kind = pointer.String("EmqxBroker")
