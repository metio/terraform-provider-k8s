...
var (
	_ datasource.DataSource = &AppsEmqxIoEmqxEnterpriseV1Beta4Manifest{}
)

func NewAppsEmqxIoEmqxEnterpriseV1Beta4Manifest() datasource.DataSource {
	return &AppsEmqxIoEmqxEnterpriseV1Beta4Manifest{}
}

type AppsEmqxIoEmqxEnterpriseV1Beta4Manifest struct{}

type AppsEmqxIoEmqxEnterpriseV1Beta4ManifestData struct {
	...
	Spec *struct {
		BlueGreenUpdate *struct {
			EvacuationStrategy *struct {
			...
			} `tfsdk:"evacuation_strategy" json:"evacuationStrategy,omitempty"`
			InitialDelaySeconds *int64 `tfsdk:"initial_delay_seconds" json:"initialDelaySeconds,omitempty"`
		} `tfsdk:"blue_green_update" json:"blueGreenUpdate,omitempty"`
		...
		License       *struct {
			...
			StringData *string `tfsdk:"string_data" json:"stringData,omitempty"`
		...
		Template *struct {
			...
			Spec *struct {
				...
				EmqxContainer *struct {
					Args             *[]string `tfsdk:"args" json:"args,omitempty"`
					BootstrapAPIKeys *[]struct {
						Key    *string `tfsdk:"key" json:"key,omitempty"`
						Secret *string `tfsdk:"secret" json:"secret,omitempty"`
					} `tfsdk:"bootstrap_api_keys" json:"bootstrapAPIKeys,omitempty"`
					Command    *[]string          `tfsdk:"command" json:"command,omitempty"`
					EmqxACL    *[]string          `tfsdk:"emqx_acl" json:"emqxACL,omitempty"`
					EmqxConfig *map[string]string `tfsdk:"emqx_config" json:"emqxConfig,omitempty"`
					Env        *[]struct {
						Name      *string `tfsdk:"name" json:"name,omitempty"`
				...
				} `tfsdk:"emqx_container" json:"emqxContainer,omitempty"`
				...
				ExtraContainers *[]struct {
					...
					WorkingDir *string `tfsdk:"working_dir" json:"workingDir,omitempty"`
				} `tfsdk:"extra_containers" json:"extraContainers,omitempty"`
				...
				ReloaderImage      *string `tfsdk:"reloader_image" json:"reloaderImage,omitempty"`
...
func (r *AppsEmqxIoEmqxEnterpriseV1Beta4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_emqx_io_emqx_enterprise_v1beta4_manifest"
}

func (r *AppsEmqxIoEmqxEnterpriseV1Beta4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "",
				Attributes: map[string]schema.Attribute{
					"blue_green_update": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"evacuation_strategy": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
					...
					"license": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"string_data": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
						...
						Attributes: map[string]schema.Attribute{
							...
							"spec": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"emqx_container": schema.SingleNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										Attributes: map[string]schema.Attribute{
											...
											"bootstrap_api_keys": schema.ListNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"key": schema.StringAttribute{
															...
															Computed:            false,
															Validators: []validator.String{
																stringvalidator.RegexMatches(regexp.MustCompile(`^[a-zA-Z\d_]+$`), ""),
															},
														},
											...
											"emqx_config": schema.MapAttribute{
												Description:         "",
												MarkdownDescription: "",
												ElementType:         types.StringType,
												Required:            false,
									...
									"extra_containers": schema.ListNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"reloader_image": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
...
func (r *AppsEmqxIoEmqxEnterpriseV1Beta4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_emqx_io_emqx_enterprise_v1beta4_manifest")

	var model AppsEmqxIoEmqxEnterpriseV1Beta4ManifestData
	...
	model.Kind = pointer.String("EmqxEnterprise")
