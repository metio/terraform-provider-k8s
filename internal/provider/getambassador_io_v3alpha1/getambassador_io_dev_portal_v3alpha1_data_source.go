...
var (
	_ datasource.DataSource              = &GetambassadorIoDevPortalV3Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoDevPortalV3Alpha1DataSource{}
)

func NewGetambassadorIoDevPortalV3Alpha1DataSource() datasource.DataSource {
	return &GetambassadorIoDevPortalV3Alpha1DataSource{}
}

type GetambassadorIoDevPortalV3Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoDevPortalV3Alpha1DataSourceData struct {
...
func (r *GetambassadorIoDevPortalV3Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_dev_portal_v3alpha1"
}

func (r *GetambassadorIoDevPortalV3Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoDevPortalV3Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoDevPortalV3Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_dev_portal_v3alpha1")

	var data GetambassadorIoDevPortalV3Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "getambassador.io", Version: "v3alpha1", Resource: "devportals"}).
	...
	var readResponse GetambassadorIoDevPortalV3Alpha1DataSourceData
