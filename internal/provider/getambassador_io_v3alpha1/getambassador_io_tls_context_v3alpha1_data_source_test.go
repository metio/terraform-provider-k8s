...
func TestGetambassadorIoTLSContextV3Alpha1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_getambassador_io_tls_context_v3alpha1", testCase)
		})
	}
}
...
func TestGetambassadorIoTLSContextV3Alpha1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_getambassador_io_tls_context_v3alpha1", configuration)
}
