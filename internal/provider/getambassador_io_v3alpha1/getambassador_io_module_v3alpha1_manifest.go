...
var (
	_ datasource.DataSource = &GetambassadorIoModuleV3Alpha1Manifest{}
)

func NewGetambassadorIoModuleV3Alpha1Manifest() datasource.DataSource {
	return &GetambassadorIoModuleV3Alpha1Manifest{}
}
...
func (r *GetambassadorIoModuleV3Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_module_v3alpha1_manifest"
}
...
func (r *GetambassadorIoModuleV3Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_module_v3alpha1_manifest")

	var model GetambassadorIoModuleV3Alpha1ManifestData
