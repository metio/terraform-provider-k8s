...
var (
	_ datasource.DataSource = &GetambassadorIoTracingServiceV3Alpha1Manifest{}
)

func NewGetambassadorIoTracingServiceV3Alpha1Manifest() datasource.DataSource {
	return &GetambassadorIoTracingServiceV3Alpha1Manifest{}
}
...
func (r *GetambassadorIoTracingServiceV3Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_tracing_service_v3alpha1_manifest"
}

func (r *GetambassadorIoTracingServiceV3Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoTracingServiceV3Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_tracing_service_v3alpha1_manifest")

	var model GetambassadorIoTracingServiceV3Alpha1ManifestData
