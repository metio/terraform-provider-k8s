...
var (
	_ datasource.DataSource = &GetambassadorIoDevPortalV3Alpha1Manifest{}
)

func NewGetambassadorIoDevPortalV3Alpha1Manifest() datasource.DataSource {
	return &GetambassadorIoDevPortalV3Alpha1Manifest{}
}
...
func (r *GetambassadorIoDevPortalV3Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_dev_portal_v3alpha1_manifest"
}

func (r *GetambassadorIoDevPortalV3Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoDevPortalV3Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_dev_portal_v3alpha1_manifest")

	var model GetambassadorIoDevPortalV3Alpha1ManifestData
