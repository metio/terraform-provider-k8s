...
var (
	_ datasource.DataSource              = &GetambassadorIoMappingV3Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoMappingV3Alpha1DataSource{}
)

func NewGetambassadorIoMappingV3Alpha1DataSource() datasource.DataSource {
	return &GetambassadorIoMappingV3Alpha1DataSource{}
}

type GetambassadorIoMappingV3Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoMappingV3Alpha1DataSourceData struct {
...
func (r *GetambassadorIoMappingV3Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_mapping_v3alpha1"
}

func (r *GetambassadorIoMappingV3Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoMappingV3Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoMappingV3Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_mapping_v3alpha1")

	var data GetambassadorIoMappingV3Alpha1DataSourceData
	...
	var readResponse GetambassadorIoMappingV3Alpha1DataSourceData
