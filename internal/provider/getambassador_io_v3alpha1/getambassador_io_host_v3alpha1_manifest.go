...
var (
	_ datasource.DataSource = &GetambassadorIoHostV3Alpha1Manifest{}
)

func NewGetambassadorIoHostV3Alpha1Manifest() datasource.DataSource {
	return &GetambassadorIoHostV3Alpha1Manifest{}
}
...
func (r *GetambassadorIoHostV3Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_host_v3alpha1_manifest"
}

func (r *GetambassadorIoHostV3Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoHostV3Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_host_v3alpha1_manifest")

	var model GetambassadorIoHostV3Alpha1ManifestData
