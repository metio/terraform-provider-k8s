...
var (
	_ datasource.DataSource = &GetambassadorIoKubernetesEndpointResolverV3Alpha1Manifest{}
)

func NewGetambassadorIoKubernetesEndpointResolverV3Alpha1Manifest() datasource.DataSource {
	return &GetambassadorIoKubernetesEndpointResolverV3Alpha1Manifest{}
}
...
func (r *GetambassadorIoKubernetesEndpointResolverV3Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_kubernetes_endpoint_resolver_v3alpha1_manifest"
}

func (r *GetambassadorIoKubernetesEndpointResolverV3Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoKubernetesEndpointResolverV3Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_kubernetes_endpoint_resolver_v3alpha1_manifest")

	var model GetambassadorIoKubernetesEndpointResolverV3Alpha1ManifestData
