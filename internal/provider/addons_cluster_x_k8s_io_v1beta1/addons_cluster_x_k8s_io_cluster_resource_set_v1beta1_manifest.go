...
var (
	_ datasource.DataSource = &AddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest{}
)

func NewAddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest{}
}

type AddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest struct{}

type AddonsClusterXK8SIoClusterResourceSetV1Beta1ManifestData struct {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_v1beta1_manifest"
}

func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "ClusterResourceSet is the Schema for the clusterresourcesets API. For advanced use cases an add-on provider should be used instead.",
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_addons_cluster_x_k8s_io_cluster_resource_set_v1beta1_manifest")

	var model AddonsClusterXK8SIoClusterResourceSetV1Beta1ManifestData
