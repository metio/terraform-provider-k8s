...
var (
	_ datasource.DataSource              = &AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource{}
)

func NewAddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource{}
}

type AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSourceData struct {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_v1beta1"
}

func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_addons_cluster_x_k8s_io_cluster_resource_set_v1beta1")

	var data AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSourceData
	...
	var readResponse AddonsClusterXK8SIoClusterResourceSetV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("addons.cluster.x-k8s.io/v1beta1")
	data.Kind = pointer.String("ClusterResourceSet")
