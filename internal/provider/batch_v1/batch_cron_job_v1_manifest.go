...
var (
	_ datasource.DataSource = &BatchCronJobV1Manifest{}
)

func NewBatchCronJobV1Manifest() datasource.DataSource {
	return &BatchCronJobV1Manifest{}
}

type BatchCronJobV1Manifest struct{}

type BatchCronJobV1ManifestData struct {
...
func (r *BatchCronJobV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_batch_cron_job_v1_manifest"
}

func (r *BatchCronJobV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BatchCronJobV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_batch_cron_job_v1_manifest")

	var model BatchCronJobV1ManifestData
