...
var (
	_ datasource.DataSource              = &BatchJobV1DataSource{}
	_ datasource.DataSourceWithConfigure = &BatchJobV1DataSource{}
)

func NewBatchJobV1DataSource() datasource.DataSource {
	return &BatchJobV1DataSource{}
}

type BatchJobV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type BatchJobV1DataSourceData struct {
...
func (r *BatchJobV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_batch_job_v1"
}

func (r *BatchJobV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BatchJobV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *BatchJobV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_batch_job_v1")

	var data BatchJobV1DataSourceData
	...
	var readResponse BatchJobV1DataSourceData
