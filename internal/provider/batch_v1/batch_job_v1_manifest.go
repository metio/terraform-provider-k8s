...
var (
	_ datasource.DataSource = &BatchJobV1Manifest{}
)

func NewBatchJobV1Manifest() datasource.DataSource {
	return &BatchJobV1Manifest{}
}

type BatchJobV1Manifest struct{}

type BatchJobV1ManifestData struct {
...
func (r *BatchJobV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_batch_job_v1_manifest"
}

func (r *BatchJobV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BatchJobV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_batch_job_v1_manifest")

	var model BatchJobV1ManifestData
