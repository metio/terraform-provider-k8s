...
var (
	_ datasource.DataSource              = &BatchCronJobV1DataSource{}
	_ datasource.DataSourceWithConfigure = &BatchCronJobV1DataSource{}
)

func NewBatchCronJobV1DataSource() datasource.DataSource {
	return &BatchCronJobV1DataSource{}
}

type BatchCronJobV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type BatchCronJobV1DataSourceData struct {
...
func (r *BatchCronJobV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_batch_cron_job_v1"
}

func (r *BatchCronJobV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BatchCronJobV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *BatchCronJobV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_batch_cron_job_v1")

	var data BatchCronJobV1DataSourceData
	...
	var readResponse BatchCronJobV1DataSourceData
	...
	data.ApiVersion = pointer.String("batch/v1")
	data.Kind = pointer.String("CronJob")
