...
var (
	_ datasource.DataSource = &StunnerL7MpIoDataplaneV1Alpha1Manifest{}
)

func NewStunnerL7MpIoDataplaneV1Alpha1Manifest() datasource.DataSource {
	return &StunnerL7MpIoDataplaneV1Alpha1Manifest{}
}

type StunnerL7MpIoDataplaneV1Alpha1Manifest struct{}

type StunnerL7MpIoDataplaneV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		HealthCheckPort *int64  `tfsdk:"health_check_port" json:"healthCheckPort,omitempty"`
...
func (r *StunnerL7MpIoDataplaneV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_stunner_l7mp_io_dataplane_v1alpha1_manifest"
}

func (r *StunnerL7MpIoDataplaneV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"health_check_port": schema.Int64Attribute{
						...
						MarkdownDescription: "If specified, the health-check port.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"replicas": schema.Int64Attribute{
						Description:         "Number of desired pods. This is a pointer to distinguish between explicit zero and notspecified. Defaults to 1.",
						MarkdownDescription: "Number of desired pods. This is a pointer to distinguish between explicit zero and notspecified. Defaults to 1.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *StunnerL7MpIoDataplaneV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_stunner_l7mp_io_dataplane_v1alpha1_manifest")

	var model StunnerL7MpIoDataplaneV1Alpha1ManifestData
