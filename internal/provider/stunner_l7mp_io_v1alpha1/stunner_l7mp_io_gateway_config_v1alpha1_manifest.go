...
var (
	_ datasource.DataSource = &StunnerL7MpIoGatewayConfigV1Alpha1Manifest{}
)

func NewStunnerL7MpIoGatewayConfigV1Alpha1Manifest() datasource.DataSource {
	return &StunnerL7MpIoGatewayConfigV1Alpha1Manifest{}
}

type StunnerL7MpIoGatewayConfigV1Alpha1Manifest struct{}

type StunnerL7MpIoGatewayConfigV1Alpha1ManifestData struct {
...
func (r *StunnerL7MpIoGatewayConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_stunner_l7mp_io_gateway_config_v1alpha1_manifest"
}

func (r *StunnerL7MpIoGatewayConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *StunnerL7MpIoGatewayConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_stunner_l7mp_io_gateway_config_v1alpha1_manifest")

	var model StunnerL7MpIoGatewayConfigV1Alpha1ManifestData
