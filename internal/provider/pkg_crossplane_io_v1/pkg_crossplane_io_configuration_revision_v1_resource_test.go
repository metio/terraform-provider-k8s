...
func TestPkgCrossplaneIoConfigurationRevisionV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_pkg_crossplane_io_configuration_revision_v1", testCase)
		})
	}
}
