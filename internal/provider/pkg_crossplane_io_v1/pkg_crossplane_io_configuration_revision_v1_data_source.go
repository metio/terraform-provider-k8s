...
var (
	_ datasource.DataSource              = &PkgCrossplaneIoConfigurationRevisionV1DataSource{}
	_ datasource.DataSourceWithConfigure = &PkgCrossplaneIoConfigurationRevisionV1DataSource{}
)

func NewPkgCrossplaneIoConfigurationRevisionV1DataSource() datasource.DataSource {
	return &PkgCrossplaneIoConfigurationRevisionV1DataSource{}
}

type PkgCrossplaneIoConfigurationRevisionV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PkgCrossplaneIoConfigurationRevisionV1DataSourceData struct {
...
func (r *PkgCrossplaneIoConfigurationRevisionV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_pkg_crossplane_io_configuration_revision_v1"
}

func (r *PkgCrossplaneIoConfigurationRevisionV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PkgCrossplaneIoConfigurationRevisionV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PkgCrossplaneIoConfigurationRevisionV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_pkg_crossplane_io_configuration_revision_v1")

	var data PkgCrossplaneIoConfigurationRevisionV1DataSourceData
	...
	var readResponse PkgCrossplaneIoConfigurationRevisionV1DataSourceData
	...
	data.Kind = pointer.String("ConfigurationRevision")
