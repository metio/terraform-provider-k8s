...
func TestLonghornIoEngineV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_longhorn_io_engine_v1beta1", testCase)
		})
	}
}
