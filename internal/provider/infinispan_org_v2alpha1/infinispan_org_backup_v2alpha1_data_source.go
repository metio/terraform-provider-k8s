...
var (
	_ datasource.DataSource              = &InfinispanOrgBackupV2Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &InfinispanOrgBackupV2Alpha1DataSource{}
)

func NewInfinispanOrgBackupV2Alpha1DataSource() datasource.DataSource {
	return &InfinispanOrgBackupV2Alpha1DataSource{}
}

type InfinispanOrgBackupV2Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type InfinispanOrgBackupV2Alpha1DataSourceData struct {
...
func (r *InfinispanOrgBackupV2Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infinispan_org_backup_v2alpha1"
}

func (r *InfinispanOrgBackupV2Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfinispanOrgBackupV2Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InfinispanOrgBackupV2Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_infinispan_org_backup_v2alpha1")

	var data InfinispanOrgBackupV2Alpha1DataSourceData
	...
	var readResponse InfinispanOrgBackupV2Alpha1DataSourceData
