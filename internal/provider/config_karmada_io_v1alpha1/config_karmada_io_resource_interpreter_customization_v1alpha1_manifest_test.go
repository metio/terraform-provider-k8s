...
func TestConfigKarmadaIoResourceInterpreterCustomizationV1Alpha1Manifest_ValidateSchema(t *testing.T) {
	ctx := context.Background()
	schemaRequest := fwdatasource.SchemaRequest{}
	schemaResponse := &fwdatasource.SchemaResponse{}

	config_karmada_io_v1alpha1.NewConfigKarmadaIoResourceInterpreterCustomizationV1Alpha1Manifest().Schema(ctx, schemaRequest, schemaResponse)
