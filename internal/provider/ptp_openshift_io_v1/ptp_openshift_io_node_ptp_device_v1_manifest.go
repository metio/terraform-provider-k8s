...
var (
	_ datasource.DataSource = &PtpOpenshiftIoNodePtpDeviceV1Manifest{}
)

func NewPtpOpenshiftIoNodePtpDeviceV1Manifest() datasource.DataSource {
	return &PtpOpenshiftIoNodePtpDeviceV1Manifest{}
}

type PtpOpenshiftIoNodePtpDeviceV1Manifest struct{}

type PtpOpenshiftIoNodePtpDeviceV1ManifestData struct {
...
func (r *PtpOpenshiftIoNodePtpDeviceV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ptp_openshift_io_node_ptp_device_v1_manifest"
}
...
func (r *PtpOpenshiftIoNodePtpDeviceV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "NodePtpDevice is the Schema for the nodeptpdevices API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.MapAttribute{
				...
				MarkdownDescription: "NodePtpDeviceSpec defines the desired state of NodePtpDevice",
				ElementType:         types.StringType,
				Required:            false,
				Optional:            true,
				Computed:            false,
...
func (r *PtpOpenshiftIoNodePtpDeviceV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ptp_openshift_io_node_ptp_device_v1_manifest")

	var model PtpOpenshiftIoNodePtpDeviceV1ManifestData
	...
	model.Kind = pointer.String("NodePtpDevice")
