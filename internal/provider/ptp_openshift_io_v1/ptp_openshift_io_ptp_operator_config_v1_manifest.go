			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"daemon_node_selector": schema.MapAttribute{
						Description:         "DaemonNodeSelector specifies the node selector for the linuxptp daemon.This is a map of key-value pairs used to select the nodes where thelinuxptp daemon will run.If empty {}, the linuxptp daemon will be deployed on each node of the cluster.",
						MarkdownDescription: "DaemonNodeSelector specifies the node selector for the linuxptp daemon.This is a map of key-value pairs used to select the nodes where thelinuxptp daemon will run.If empty {}, the linuxptp daemon will be deployed on each node of the cluster.",
						ElementType:         types.StringType,
						Required:            true,
						Optional:            false,
						Computed:            false,
					...
					"ptp_event_config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"api_version": schema.StringAttribute{
								Description:         "ApiVersion is used to determine which API is used for the event service1.0: default version. event service is mapped to internal REST-API.2.x: event service is mapped to O-RAN v3.0 Compliant O-Cloud Notification REST-API.",
								MarkdownDescription: "ApiVersion is used to determine which API is used for the event service1.0: default version. event service is mapped to internal REST-API.2.x: event service is mapped to O-RAN v3.0 Compliant O-Cloud Notification REST-API.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
