...
var (
	_ datasource.DataSource = &ChiselOperatorIoExitNodeV2Manifest{}
)

func NewChiselOperatorIoExitNodeV2Manifest() datasource.DataSource {
	return &ChiselOperatorIoExitNodeV2Manifest{}
}
...
func (r *ChiselOperatorIoExitNodeV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chisel_operator_io_exit_node_v2_manifest"
}
...
func (r *ChiselOperatorIoExitNodeV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Auto-generated derived type for ExitNodeSpec via 'CustomResource'",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ExitNode is a custom resource that represents a Chisel exit node. It will be used as the reverse proxy for all services in the cluster.",
				Attributes: map[string]schema.Attribute{
					"auth": schema.StringAttribute{
						Description:         "Optional authentication secret name to connect to the control plane",
						MarkdownDescription: "Optional authentication secret name to connect to the control plane",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"chisel_image": schema.StringAttribute{
						...
						MarkdownDescription: "Optional value for the chisel client image used to connect to the chisel server If not provided, jpillora/chisel:latest is used",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"default_route": schema.BoolAttribute{
						...
						MarkdownDescription: "Optional boolean value for whether to make the exit node the default route for the cluster If true, the exit node will be the default route for the cluster default value is false",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"fingerprint": schema.StringAttribute{
						...
						MarkdownDescription: "Optional but highly recommended fingerprint to perform host-key validation against the server's public key",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"host": schema.StringAttribute{
						...
						MarkdownDescription: "Hostname or IP address of the chisel server",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"port": schema.Int64Attribute{
						...
						MarkdownDescription: "Control plane port of the chisel server",
						Required:            true,
						Optional:            false,
						Computed:            false,
...
func (r *ChiselOperatorIoExitNodeV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_chisel_operator_io_exit_node_v2_manifest")

	var model ChiselOperatorIoExitNodeV2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("chisel-operator.io/v2")
	model.Kind = pointer.String("ExitNode")
