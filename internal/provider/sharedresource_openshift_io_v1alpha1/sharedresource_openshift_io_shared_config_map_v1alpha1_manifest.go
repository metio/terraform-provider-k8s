...
var (
	_ datasource.DataSource = &SharedresourceOpenshiftIoSharedConfigMapV1Alpha1Manifest{}
)

func NewSharedresourceOpenshiftIoSharedConfigMapV1Alpha1Manifest() datasource.DataSource {
	return &SharedresourceOpenshiftIoSharedConfigMapV1Alpha1Manifest{}
}
...
func (r *SharedresourceOpenshiftIoSharedConfigMapV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_sharedresource_openshift_io_shared_config_map_v1alpha1_manifest"
}

func (r *SharedresourceOpenshiftIoSharedConfigMapV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "spec is the specification of the desired shared configmap",
				Attributes: map[string]schema.Attribute{
					"config_map_ref": schema.SingleNestedAttribute{
						Description:         "configMapRef is a reference to the ConfigMap to share",
						MarkdownDescription: "configMapRef is a reference to the ConfigMap to share",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
								Description:         "name represents the name of the ConfigMap that is being referenced.",
								MarkdownDescription: "name represents the name of the ConfigMap that is being referenced.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"namespace": schema.StringAttribute{
								...
								MarkdownDescription: "namespace represents the namespace where the referenced ConfigMap is located.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
...
func (r *SharedresourceOpenshiftIoSharedConfigMapV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sharedresource_openshift_io_shared_config_map_v1alpha1_manifest")

	var model SharedresourceOpenshiftIoSharedConfigMapV1Alpha1ManifestData
