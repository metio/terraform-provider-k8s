...
func TestAppsClusternetIoLocalizationV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_apps_clusternet_io_localization_v1alpha1", testCase)
		})
	}
}
