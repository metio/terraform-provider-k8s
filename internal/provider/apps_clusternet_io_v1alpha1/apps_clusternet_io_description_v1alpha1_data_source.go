...
var (
	_ datasource.DataSource              = &AppsClusternetIoDescriptionV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsClusternetIoDescriptionV1Alpha1DataSource{}
)

func NewAppsClusternetIoDescriptionV1Alpha1DataSource() datasource.DataSource {
	return &AppsClusternetIoDescriptionV1Alpha1DataSource{}
}

type AppsClusternetIoDescriptionV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsClusternetIoDescriptionV1Alpha1DataSourceData struct {
...
func (r *AppsClusternetIoDescriptionV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_clusternet_io_description_v1alpha1"
}

func (r *AppsClusternetIoDescriptionV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsClusternetIoDescriptionV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsClusternetIoDescriptionV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_clusternet_io_description_v1alpha1")

	var data AppsClusternetIoDescriptionV1Alpha1DataSourceData
	...
	var readResponse AppsClusternetIoDescriptionV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Description")
