...
var (
	_ datasource.DataSource = &AppsClusternetIoHelmReleaseV1Alpha1Manifest{}
)

func NewAppsClusternetIoHelmReleaseV1Alpha1Manifest() datasource.DataSource {
	return &AppsClusternetIoHelmReleaseV1Alpha1Manifest{}
}
...
func (r *AppsClusternetIoHelmReleaseV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_clusternet_io_helm_release_v1alpha1_manifest"
}

func (r *AppsClusternetIoHelmReleaseV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsClusternetIoHelmReleaseV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_clusternet_io_helm_release_v1alpha1_manifest")

	var model AppsClusternetIoHelmReleaseV1Alpha1ManifestData
