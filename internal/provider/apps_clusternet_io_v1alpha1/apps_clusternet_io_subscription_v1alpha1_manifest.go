			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"priority": schema.Int64Attribute{
						Description:         "The priority value. clusternet-scheduler use this field to find the priority of the subscription. The higher the value, the higher the priority.",
						MarkdownDescription: "The priority value. clusternet-scheduler use this field to find the priority of the subscription. The higher the value, the higher the priority.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
