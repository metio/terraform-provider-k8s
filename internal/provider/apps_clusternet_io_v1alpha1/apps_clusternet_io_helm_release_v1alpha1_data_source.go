...
var (
	_ datasource.DataSource              = &AppsClusternetIoHelmReleaseV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsClusternetIoHelmReleaseV1Alpha1DataSource{}
)

func NewAppsClusternetIoHelmReleaseV1Alpha1DataSource() datasource.DataSource {
	return &AppsClusternetIoHelmReleaseV1Alpha1DataSource{}
}

type AppsClusternetIoHelmReleaseV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsClusternetIoHelmReleaseV1Alpha1DataSourceData struct {
...
func (r *AppsClusternetIoHelmReleaseV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_clusternet_io_helm_release_v1alpha1"
}

func (r *AppsClusternetIoHelmReleaseV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsClusternetIoHelmReleaseV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsClusternetIoHelmReleaseV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_clusternet_io_helm_release_v1alpha1")

	var data AppsClusternetIoHelmReleaseV1Alpha1DataSourceData
	...
	var readResponse AppsClusternetIoHelmReleaseV1Alpha1DataSourceData
