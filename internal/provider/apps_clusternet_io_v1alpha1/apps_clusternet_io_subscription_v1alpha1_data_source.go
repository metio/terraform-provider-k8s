...
var (
	_ datasource.DataSource              = &AppsClusternetIoSubscriptionV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsClusternetIoSubscriptionV1Alpha1DataSource{}
)

func NewAppsClusternetIoSubscriptionV1Alpha1DataSource() datasource.DataSource {
	return &AppsClusternetIoSubscriptionV1Alpha1DataSource{}
}

type AppsClusternetIoSubscriptionV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsClusternetIoSubscriptionV1Alpha1DataSourceData struct {
...
func (r *AppsClusternetIoSubscriptionV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_clusternet_io_subscription_v1alpha1"
}

func (r *AppsClusternetIoSubscriptionV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsClusternetIoSubscriptionV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsClusternetIoSubscriptionV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_clusternet_io_subscription_v1alpha1")

	var data AppsClusternetIoSubscriptionV1Alpha1DataSourceData
	...
	var readResponse AppsClusternetIoSubscriptionV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Subscription")
