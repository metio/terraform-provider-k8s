...
var (
	_ datasource.DataSource = &AzureMicrosoftComMySqlaaduserV1Alpha1Manifest{}
)

func NewAzureMicrosoftComMySqlaaduserV1Alpha1Manifest() datasource.DataSource {
	return &AzureMicrosoftComMySqlaaduserV1Alpha1Manifest{}
}

type AzureMicrosoftComMySqlaaduserV1Alpha1Manifest struct{}

type AzureMicrosoftComMySqlaaduserV1Alpha1ManifestData struct {
...
func (r *AzureMicrosoftComMySqlaaduserV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_azure_microsoft_com_my_sqlaad_user_v1alpha1_manifest"
}

func (r *AzureMicrosoftComMySqlaaduserV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"roles": schema.ListAttribute{
						...
						MarkdownDescription: "The roles assigned to the user. A user must have at least one role.",
						ElementType:         types.StringType,
						Required:            true,
						Optional:            false,
						Computed:            false,
...
func (r *AzureMicrosoftComMySqlaaduserV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_azure_microsoft_com_my_sqlaad_user_v1alpha1_manifest")

	var model AzureMicrosoftComMySqlaaduserV1Alpha1ManifestData
