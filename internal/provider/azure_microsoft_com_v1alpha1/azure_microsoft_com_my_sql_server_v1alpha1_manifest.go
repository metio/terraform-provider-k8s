...
var (
	_ datasource.DataSource = &AzureMicrosoftComMySqlserverV1Alpha1Manifest{}
)

func NewAzureMicrosoftComMySqlserverV1Alpha1Manifest() datasource.DataSource {
	return &AzureMicrosoftComMySqlserverV1Alpha1Manifest{}
}

type AzureMicrosoftComMySqlserverV1Alpha1Manifest struct{}

type AzureMicrosoftComMySqlserverV1Alpha1ManifestData struct {
...
func (r *AzureMicrosoftComMySqlserverV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_azure_microsoft_com_my_sql_server_v1alpha1_manifest"
}

func (r *AzureMicrosoftComMySqlserverV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "MySQLServer is the Schema for the mysqlservers API",
		MarkdownDescription: "MySQLServer is the Schema for the mysqlservers API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "MySQLServerSpec defines the desired state of MySQLServer",
				Attributes: map[string]schema.Attribute{
...
func (r *AzureMicrosoftComMySqlserverV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_azure_microsoft_com_my_sql_server_v1alpha1_manifest")

	var model AzureMicrosoftComMySqlserverV1Alpha1ManifestData
	...
	model.Kind = pointer.String("MySQLServer")
