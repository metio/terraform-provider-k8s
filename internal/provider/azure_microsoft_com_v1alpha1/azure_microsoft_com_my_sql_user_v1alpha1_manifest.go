...
var (
	_ datasource.DataSource = &AzureMicrosoftComMySqluserV1Alpha1Manifest{}
)

func NewAzureMicrosoftComMySqluserV1Alpha1Manifest() datasource.DataSource {
	return &AzureMicrosoftComMySqluserV1Alpha1Manifest{}
}

type AzureMicrosoftComMySqluserV1Alpha1Manifest struct{}

type AzureMicrosoftComMySqluserV1Alpha1ManifestData struct {
...
func (r *AzureMicrosoftComMySqluserV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_azure_microsoft_com_my_sql_user_v1alpha1_manifest"
}

func (r *AzureMicrosoftComMySqluserV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AzureMicrosoftComMySqluserV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_azure_microsoft_com_my_sql_user_v1alpha1_manifest")

	var model AzureMicrosoftComMySqluserV1Alpha1ManifestData
