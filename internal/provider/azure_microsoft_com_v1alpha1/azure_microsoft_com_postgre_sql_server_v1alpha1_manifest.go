...
var (
	_ datasource.DataSource = &AzureMicrosoftComPostgreSqlserverV1Alpha1Manifest{}
)

func NewAzureMicrosoftComPostgreSqlserverV1Alpha1Manifest() datasource.DataSource {
	return &AzureMicrosoftComPostgreSqlserverV1Alpha1Manifest{}
}

type AzureMicrosoftComPostgreSqlserverV1Alpha1Manifest struct{}

type AzureMicrosoftComPostgreSqlserverV1Alpha1ManifestData struct {
...
func (r *AzureMicrosoftComPostgreSqlserverV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_azure_microsoft_com_postgre_sql_server_v1alpha1_manifest"
}

func (r *AzureMicrosoftComPostgreSqlserverV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AzureMicrosoftComPostgreSqlserverV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_azure_microsoft_com_postgre_sql_server_v1alpha1_manifest")

	var model AzureMicrosoftComPostgreSqlserverV1Alpha1ManifestData
