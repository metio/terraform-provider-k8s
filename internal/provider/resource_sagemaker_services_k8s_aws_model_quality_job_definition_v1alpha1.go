...
var (
	_ resource.Resource = (*SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource)(nil)
)

type SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1TerraformModel struct {
...
type SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		ModelQualityAppSpecification *struct {
			...
			ProblemType *string `tfsdk:"problem_type" yaml:"problemType,omitempty"`

			RecordPreprocessorSourceURI *string `tfsdk:"record_preprocessor_source_uri" yaml:"recordPreprocessorSourceURI,omitempty"`
		} `tfsdk:"model_quality_app_specification" yaml:"modelQualityAppSpecification,omitempty"`
		...
		} `tfsdk:"model_quality_baseline_config" yaml:"modelQualityBaselineConfig,omitempty"`
		...
		ModelQualityJobInput *struct {
			...
			GroundTruthS3Input *struct {
				S3URI *string `tfsdk:"s3_uri" yaml:"s3URI,omitempty"`
			} `tfsdk:"ground_truth_s3_input" yaml:"groundTruthS3Input,omitempty"`
		} `tfsdk:"model_quality_job_input" yaml:"modelQualityJobInput,omitempty"`
		...
		} `tfsdk:"model_quality_job_output_config" yaml:"modelQualityJobOutputConfig,omitempty"`
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sagemaker_services_k8s_aws_model_quality_job_definition_v1alpha1"
}

func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_sagemaker_services_k8s_aws_model_quality_job_definition_v1alpha1")

	var state SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("ModelQualityJobDefinition")
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sagemaker_services_k8s_aws_model_quality_job_definition_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
