			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"policy_name": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the scaling policy. You cannot change the name of a scaling policy, but you can delete the original scaling policy and create a new scaling policy with the same settings and a different name.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
