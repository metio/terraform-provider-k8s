...
var (
	_ datasource.DataSource              = &ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource{}
)

func NewApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource() datasource.DataSource {
	return &ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource{}
}

type ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSourceData struct {
...
func (r *ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_applicationautoscaling_services_k8s_aws_scalable_target_v1alpha1"
}

func (r *ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_applicationautoscaling_services_k8s_aws_scalable_target_v1alpha1")

	var data ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "applicationautoscaling.services.k8s.aws", Version: "v1alpha1", Resource: "ScalableTarget"}).
	...
	var readResponse ApplicationautoscalingServicesK8SAwsScalableTargetV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ScalableTarget")
