...
func TestSecretgeneratorMittwaldDeSSHKeyPairV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_secretgenerator_mittwald_de_ssh_key_pair_v1alpha1_manifest", testCase)
		})
	}
}
