...
var (
	_ datasource.DataSource = &KuadrantIoRateLimitPolicyV1Manifest{}
)

func NewKuadrantIoRateLimitPolicyV1Manifest() datasource.DataSource {
	return &KuadrantIoRateLimitPolicyV1Manifest{}
}

type KuadrantIoRateLimitPolicyV1Manifest struct{}

type KuadrantIoRateLimitPolicyV1ManifestData struct {
...
func (r *KuadrantIoRateLimitPolicyV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuadrant_io_rate_limit_policy_v1_manifest"
}

func (r *KuadrantIoRateLimitPolicyV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
							...
							"limits": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"counters": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Counters defines additional rate limit counters based on CEL expressions which can reference well known selectors",
...
func (r *KuadrantIoRateLimitPolicyV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuadrant_io_rate_limit_policy_v1_manifest")

	var model KuadrantIoRateLimitPolicyV1ManifestData
