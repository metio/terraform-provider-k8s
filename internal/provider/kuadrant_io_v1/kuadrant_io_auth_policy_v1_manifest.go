...
var (
	_ datasource.DataSource = &KuadrantIoAuthPolicyV1Manifest{}
)

func NewKuadrantIoAuthPolicyV1Manifest() datasource.DataSource {
	return &KuadrantIoAuthPolicyV1Manifest{}
}

type KuadrantIoAuthPolicyV1Manifest struct{}

type KuadrantIoAuthPolicyV1ManifestData struct {
	...
	Spec *struct {
		Defaults *struct {
			Patterns *struct {
				...
				} `tfsdk:"all_of" json:"allOf,omitempty"`
				...
				Authorization *struct {
					...
					KubernetesSubjectAccessReview *struct {
						AuthorizationGroups *struct {
							...
							Selector   *string            `tfsdk:"selector" json:"selector,omitempty"`
							Value      *map[string]string `tfsdk:"value" json:"value,omitempty"`
						} `tfsdk:"authorization_groups" json:"authorizationGroups,omitempty"`
					...
					Opa     *struct {
						...
						ExternalPolicy *struct {
							...
							UrlExpression *string `tfsdk:"url_expression" json:"urlExpression,omitempty"`
...
func (r *KuadrantIoAuthPolicyV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuadrant_io_auth_policy_v1_manifest"
}

func (r *KuadrantIoAuthPolicyV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"defaults": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"patterns": schema.SingleNestedAttribute{
									...
									"authentication": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
													...
													"key": schema.SingleNestedAttribute{
														...
														Attributes: map[string]schema.Attribute{
															"expression": schema.StringAttribute{
																Description:         "A Common Expression Language (CEL) expression that evaluates to a value. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
																MarkdownDescription: "A Common Expression Language (CEL) expression that evaluates to a value. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
											...
											"plain": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													"expression": schema.StringAttribute{
														Description:         "A Common Expression Language (CEL) expression that evaluates to a value that represents an identity. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
														MarkdownDescription: "A Common Expression Language (CEL) expression that evaluates to a value that represents an identity. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
												...
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														...
														"predicate": schema.StringAttribute{
															Description:         "A Common Expression Language (CEL) expression that evaluates to a boolean. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
															MarkdownDescription: "A Common Expression Language (CEL) expression that evaluates to a boolean. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
															Required:            false,
															Optional:            true,
															Computed:            false,
														},
									...
									"authorization": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"kubernetes_subject_access_review": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													"authorization_groups": schema.SingleNestedAttribute{
														...
														MarkdownDescription: "Groups to check for existing permission in the Kubernetes RBAC alternatively to a specific user. This is typically obtained from a list of groups the user is a member of. Must be a static list of group names or dynamically resolve to one from the Authorization JSON.",
														Attributes: map[string]schema.Attribute{
															"expression": schema.StringAttribute{
																Description:         "A Common Expression Language (CEL) expression that evaluates to a value. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
																MarkdownDescription: "A Common Expression Language (CEL) expression that evaluates to a value. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
													...
													"groups": schema.ListAttribute{
														Description:         "Groups the user must be a member of or, if 'user' is omitted, the groups to check for authorization in the Kubernetes RBAC. Deprecated: Use authorizationGroups instead.",
														MarkdownDescription: "Groups the user must be a member of or, if 'user' is omitted, the groups to check for authorization in the Kubernetes RBAC. Deprecated: Use authorizationGroups instead.",
														ElementType:         types.StringType,
														Required:            false,
														Optional:            true,
														Computed:            false,
													...
													"external_policy": schema.SingleNestedAttribute{
														...
														Attributes: map[string]schema.Attribute{
															...
															"url_expression": schema.StringAttribute{
																Description:         "A Common Expression Language (CEL) expression that evaluates to a string endpoint URL of the HTTP service to call. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
																MarkdownDescription: "A Common Expression Language (CEL) expression that evaluates to a string endpoint URL of the HTTP service to call. String expressions are supported (https://pkg.go.dev/github.com/google/cel-go/ext#Strings).",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
											...
											"success": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													"filters": schema.SingleNestedAttribute{
														Description:         "Custom data made available to other filters managed by Kuadrant (i.e. Rate Limit)",
														MarkdownDescription: "Custom data made available to other filters managed by Kuadrant (i.e. Rate Limit)",
														Attributes: map[string]schema.Attribute{
															"cache": schema.SingleNestedAttribute{
																Description:         "Caching options for the resolved object returned when applying this config. Omit it to avoid caching objects for this config.",
																MarkdownDescription: "Caching options for the resolved object returned when applying this config. Omit it to avoid caching objects for this config.",
													...
													"headers": schema.SingleNestedAttribute{
														...
														MarkdownDescription: "Custom headers to inject in the request.",
														Attributes: map[string]schema.Attribute{
															"cache": schema.SingleNestedAttribute{
																Description:         "Caching options for the resolved object returned when applying this config. Omit it to avoid caching objects for this config.",
																MarkdownDescription: "Caching options for the resolved object returned when applying this config. Omit it to avoid caching objects for this config.",
...
func (r *KuadrantIoAuthPolicyV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuadrant_io_auth_policy_v1_manifest")

	var model KuadrantIoAuthPolicyV1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("kuadrant.io/v1")
