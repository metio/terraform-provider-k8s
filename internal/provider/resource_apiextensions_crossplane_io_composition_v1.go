...
var (
	_ resource.Resource = (*ApiextensionsCrossplaneIoCompositionV1Resource)(nil)
)

type ApiextensionsCrossplaneIoCompositionV1TerraformModel struct {
...
type ApiextensionsCrossplaneIoCompositionV1GoModel struct {
		...
		PatchSets *[]struct {
			...
			Patches *[]struct {
				...
				Policy *struct {
					...
					MergeOptions *struct {
						AppendSlice *bool `tfsdk:"append_slice" yaml:"appendSlice,omitempty"`

						KeepMapValues *bool `tfsdk:"keep_map_values" yaml:"keepMapValues,omitempty"`
					} `tfsdk:"merge_options" yaml:"mergeOptions,omitempty"`
...
func (r *ApiextensionsCrossplaneIoCompositionV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_apiextensions_crossplane_io_composition_v1"
}

func (r *ApiextensionsCrossplaneIoCompositionV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ApiextensionsCrossplaneIoCompositionV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_apiextensions_crossplane_io_composition_v1")

	var state ApiextensionsCrossplaneIoCompositionV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ApiextensionsCrossplaneIoCompositionV1GoModel
	...
	goModel.Kind = utilities.Ptr("Composition")
...
func (r *ApiextensionsCrossplaneIoCompositionV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apiextensions_crossplane_io_composition_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *ApiextensionsCrossplaneIoCompositionV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
