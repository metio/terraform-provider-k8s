...
func TestExecutionFurikoIoJobV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_execution_furiko_io_job_v1alpha1_manifest", testCase)
		})
	}
}
