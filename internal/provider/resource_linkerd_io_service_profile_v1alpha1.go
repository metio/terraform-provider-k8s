...
type LinkerdIoServiceProfileV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*LinkerdIoServiceProfileV1Alpha1Resource)(nil)
)

type LinkerdIoServiceProfileV1Alpha1TerraformModel struct {
...
type LinkerdIoServiceProfileV1Alpha1GoModel struct {
...
func NewLinkerdIoServiceProfileV1Alpha1Resource() resource.Resource {
	return &LinkerdIoServiceProfileV1Alpha1Resource{}
}

func (r *LinkerdIoServiceProfileV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_linkerd_io_service_profile_v1alpha1"
}

func (r *LinkerdIoServiceProfileV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *LinkerdIoServiceProfileV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_linkerd_io_service_profile_v1alpha1")

	var state LinkerdIoServiceProfileV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel LinkerdIoServiceProfileV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("linkerd.io/v1alpha1")
...
func (r *LinkerdIoServiceProfileV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_linkerd_io_service_profile_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *LinkerdIoServiceProfileV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_linkerd_io_service_profile_v1alpha1")
...
func (r *LinkerdIoServiceProfileV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_linkerd_io_service_profile_v1alpha1")
