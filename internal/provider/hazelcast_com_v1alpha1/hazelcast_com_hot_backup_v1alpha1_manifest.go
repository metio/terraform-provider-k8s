...
var (
	_ datasource.DataSource = &HazelcastComHotBackupV1Alpha1Manifest{}
)

func NewHazelcastComHotBackupV1Alpha1Manifest() datasource.DataSource {
	return &HazelcastComHotBackupV1Alpha1Manifest{}
}
...
func (r *HazelcastComHotBackupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hazelcast_com_hot_backup_v1alpha1_manifest"
}

func (r *HazelcastComHotBackupV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HazelcastComHotBackupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hazelcast_com_hot_backup_v1alpha1_manifest")

	var model HazelcastComHotBackupV1Alpha1ManifestData
