...
var (
	_ datasource.DataSource = &HazelcastComManagementCenterV1Alpha1Manifest{}
)

func NewHazelcastComManagementCenterV1Alpha1Manifest() datasource.DataSource {
	return &HazelcastComManagementCenterV1Alpha1Manifest{}
}
...
func (r *HazelcastComManagementCenterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hazelcast_com_management_center_v1alpha1_manifest"
}

func (r *HazelcastComManagementCenterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HazelcastComManagementCenterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hazelcast_com_management_center_v1alpha1_manifest")

	var model HazelcastComManagementCenterV1Alpha1ManifestData
