...
var (
	_ datasource.DataSource              = &HazelcastComHazelcastV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &HazelcastComHazelcastV1Alpha1DataSource{}
)

func NewHazelcastComHazelcastV1Alpha1DataSource() datasource.DataSource {
	return &HazelcastComHazelcastV1Alpha1DataSource{}
}

type HazelcastComHazelcastV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type HazelcastComHazelcastV1Alpha1DataSourceData struct {
...
func (r *HazelcastComHazelcastV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hazelcast_com_hazelcast_v1alpha1"
}

func (r *HazelcastComHazelcastV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HazelcastComHazelcastV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HazelcastComHazelcastV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_hazelcast_com_hazelcast_v1alpha1")

	var data HazelcastComHazelcastV1Alpha1DataSourceData
	...
	var readResponse HazelcastComHazelcastV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Hazelcast")
