...
var (
	_ datasource.DataSource              = &HazelcastComManagementCenterV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &HazelcastComManagementCenterV1Alpha1DataSource{}
)

func NewHazelcastComManagementCenterV1Alpha1DataSource() datasource.DataSource {
	return &HazelcastComManagementCenterV1Alpha1DataSource{}
}

type HazelcastComManagementCenterV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type HazelcastComManagementCenterV1Alpha1DataSourceData struct {
...
func (r *HazelcastComManagementCenterV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hazelcast_com_management_center_v1alpha1"
}

func (r *HazelcastComManagementCenterV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HazelcastComManagementCenterV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HazelcastComManagementCenterV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_hazelcast_com_management_center_v1alpha1")

	var data HazelcastComManagementCenterV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "hazelcast.com", Version: "v1alpha1", Resource: "ManagementCenter"}).
	...
	var readResponse HazelcastComManagementCenterV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ManagementCenter")
