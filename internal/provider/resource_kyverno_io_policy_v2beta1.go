...
var (
	_ resource.Resource = (*KyvernoIoPolicyV2Beta1Resource)(nil)
)

type KyvernoIoPolicyV2Beta1TerraformModel struct {
...
type KyvernoIoPolicyV2Beta1GoModel struct {
...
func (r *KyvernoIoPolicyV2Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kyverno_io_policy_v2beta1"
}

func (r *KyvernoIoPolicyV2Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *KyvernoIoPolicyV2Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kyverno_io_policy_v2beta1")

	var state KyvernoIoPolicyV2Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KyvernoIoPolicyV2Beta1GoModel
...
func (r *KyvernoIoPolicyV2Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_policy_v2beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *KyvernoIoPolicyV2Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *KyvernoIoPolicyV2Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
