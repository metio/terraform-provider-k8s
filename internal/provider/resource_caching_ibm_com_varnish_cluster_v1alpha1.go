...
type CachingIbmComVarnishClusterV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*CachingIbmComVarnishClusterV1Alpha1Resource)(nil)
)

type CachingIbmComVarnishClusterV1Alpha1TerraformModel struct {
...
type CachingIbmComVarnishClusterV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		Backend *struct {
			...
			OnlyReady *bool `tfsdk:"only_ready" yaml:"onlyReady,omitempty"`
			...
			ZoneBalancing *struct {
				Thresholds *[]struct {
					Local *int64 `tfsdk:"local" yaml:"local,omitempty"`

					Remote *int64 `tfsdk:"remote" yaml:"remote,omitempty"`

					Threshold *int64 `tfsdk:"threshold" yaml:"threshold,omitempty"`
				} `tfsdk:"thresholds" yaml:"thresholds,omitempty"`

				Type *string `tfsdk:"type" yaml:"type,omitempty"`
			} `tfsdk:"zone_balancing" yaml:"zoneBalancing,omitempty"`
		...
		Monitoring *struct {
			...
			} `tfsdk:"grafana_dashboard" yaml:"grafanaDashboard,omitempty"`
			...
			} `tfsdk:"prometheus_service_monitor" yaml:"prometheusServiceMonitor,omitempty"`
		...
		Service *struct {
			...
			ControllerMetricsNodePort *int64 `tfsdk:"controller_metrics_node_port" yaml:"controllerMetricsNodePort,omitempty"`

			MetricsNodePort *int64 `tfsdk:"metrics_node_port" yaml:"metricsNodePort,omitempty"`
		...
		UpdateStrategy *struct {
			DelayedRollingUpdate *struct {
				DelaySeconds *int64 `tfsdk:"delay_seconds" yaml:"delaySeconds,omitempty"`
			} `tfsdk:"delayed_rolling_update" yaml:"delayedRollingUpdate,omitempty"`
		...
		Varnish *struct {
			...
			} `tfsdk:"adm_auth" yaml:"admAuth,omitempty"`
			...
			} `tfsdk:"extra_init_containers" yaml:"extraInitContainers,omitempty"`
			...
			} `tfsdk:"extra_volume_claim_templates" yaml:"extraVolumeClaimTemplates,omitempty"`
			...
			} `tfsdk:"metrics_exporter" yaml:"metricsExporter,omitempty"`
		...
		} `tfsdk:"varnish" yaml:"varnish,omitempty"`

		Vcl *struct {
			ConfigMapName *string `tfsdk:"config_map_name" yaml:"configMapName,omitempty"`

			EntrypointFileName *string `tfsdk:"entrypoint_file_name" yaml:"entrypointFileName,omitempty"`
		} `tfsdk:"vcl" yaml:"vcl,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewCachingIbmComVarnishClusterV1Alpha1Resource() resource.Resource {
	return &CachingIbmComVarnishClusterV1Alpha1Resource{}
}

func (r *CachingIbmComVarnishClusterV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_caching_ibm_com_varnish_cluster_v1alpha1"
}

func (r *CachingIbmComVarnishClusterV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
								...
								Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
									...
									"type": {
										...
										Validators: []tfsdk.AttributeValidator{
											...
											stringvalidator.OneOf("auto", "thresholds", "disabled"),
										},
									},
								}),
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"type": {
								...
								Validators: []tfsdk.AttributeValidator{
									...
									stringvalidator.OneOf("OnDelete", "RollingUpdate", "DelayedRollingUpdate"),
								},
							},
						}),
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"entrypoint_file_name": {
								...
								Validators: []tfsdk.AttributeValidator{
									...
									stringvalidator.RegexMatches(regexp.MustCompile(`^.+\.vcl$`), ""),
								},
							},
						}),
...
func (r *CachingIbmComVarnishClusterV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_caching_ibm_com_varnish_cluster_v1alpha1")

	var state CachingIbmComVarnishClusterV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CachingIbmComVarnishClusterV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("caching.ibm.com/v1alpha1")
	goModel.Kind = utilities.Ptr("VarnishCluster")
...
func (r *CachingIbmComVarnishClusterV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_caching_ibm_com_varnish_cluster_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *CachingIbmComVarnishClusterV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_caching_ibm_com_varnish_cluster_v1alpha1")
...
func (r *CachingIbmComVarnishClusterV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_caching_ibm_com_varnish_cluster_v1alpha1")
