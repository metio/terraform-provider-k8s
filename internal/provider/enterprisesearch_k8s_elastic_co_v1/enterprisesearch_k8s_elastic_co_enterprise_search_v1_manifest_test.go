...
func TestEnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1_manifest", testCase)
		})
	}
}
