...
func TestEnterprisesearchK8SElasticCoEnterpriseSearchV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1", testCase)
		})
	}
}
