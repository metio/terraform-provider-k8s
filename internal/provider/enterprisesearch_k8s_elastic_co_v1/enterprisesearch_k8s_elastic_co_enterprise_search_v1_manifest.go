...
var (
	_ datasource.DataSource = &EnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest{}
)

func NewEnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest() datasource.DataSource {
	return &EnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest{}
}

type EnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest struct{}

type EnterprisesearchK8SElasticCoEnterpriseSearchV1ManifestData struct {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_enterprisesearch_k8s_elastic_co_enterprise_search_v1_manifest"
}

func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "EnterpriseSearch is a Kubernetes CRD to represent Enterprise Search.",
		MarkdownDescription: "EnterpriseSearch is a Kubernetes CRD to represent Enterprise Search.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "EnterpriseSearchSpec holds the specification of an Enterprise Search resource.",
				Attributes: map[string]schema.Attribute{
					"config": schema.MapAttribute{
						Description:         "Config holds the Enterprise Search configuration.",
						MarkdownDescription: "Config holds the Enterprise Search configuration.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"config_ref": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ConfigRef contains a reference to an existing Kubernetes Secret holding the Enterprise Search configuration.Configuration settings are merged and have precedence over settings specified in 'config'.",
						Attributes: map[string]schema.Attribute{
					...
					"count": schema.Int64Attribute{
						...
						MarkdownDescription: "Count of Enterprise Search instances to deploy.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"elasticsearch_ref": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ElasticsearchRef is a reference to the Elasticsearch cluster running in the same Kubernetes cluster.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
							...
							"service_name": schema.StringAttribute{
								Description:         "ServiceName is the name of an existing Kubernetes service which is used to make requests to the referencedobject. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service ofthe referenced resource is used.",
								MarkdownDescription: "ServiceName is the name of an existing Kubernetes service which is used to make requests to the referencedobject. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service ofthe referenced resource is used.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"http": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "HTTP holds the HTTP layer configuration for Enterprise Search resource.",
						Attributes: map[string]schema.Attribute{
					...
					"image": schema.StringAttribute{
						...
						MarkdownDescription: "Image is the Enterprise Search Docker image to deploy.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"pod_template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "PodTemplate provides customisation options (labels, annotations, affinity rules, resource requests, and so on)for the Enterprise Search pods.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
					...
					"version": schema.StringAttribute{
						...
						MarkdownDescription: "Version of Enterprise Search.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1_manifest")

	var model EnterprisesearchK8SElasticCoEnterpriseSearchV1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("enterprisesearch.k8s.elastic.co/v1")
	model.Kind = pointer.String("EnterpriseSearch")
