...
type KyvernoIoClusterPolicyV2Beta1Resource struct{}

var (
	_ resource.Resource = (*KyvernoIoClusterPolicyV2Beta1Resource)(nil)
)

type KyvernoIoClusterPolicyV2Beta1TerraformModel struct {
...
type KyvernoIoClusterPolicyV2Beta1GoModel struct {
...
func NewKyvernoIoClusterPolicyV2Beta1Resource() resource.Resource {
	return &KyvernoIoClusterPolicyV2Beta1Resource{}
}

func (r *KyvernoIoClusterPolicyV2Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kyverno_io_cluster_policy_v2beta1"
}

func (r *KyvernoIoClusterPolicyV2Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
									...
									"deny": {
										...
										Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
											...
											"conditions": {
												...
												MarkdownDescription: "Multiple conditions can be declared under an 'any' or 'all' statement. A direct list of conditions (without 'any' or 'all' statements) is also supported for backwards compatibility See: https://kyverno.io/docs/writing-policies/validate/#deny-rules",
...
func (r *KyvernoIoClusterPolicyV2Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kyverno_io_cluster_policy_v2beta1")

	var state KyvernoIoClusterPolicyV2Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KyvernoIoClusterPolicyV2Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("kyverno.io/v2beta1")
	goModel.Kind = utilities.Ptr("ClusterPolicy")
...
func (r *KyvernoIoClusterPolicyV2Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_policy_v2beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *KyvernoIoClusterPolicyV2Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_kyverno_io_cluster_policy_v2beta1")
...
func (r *KyvernoIoClusterPolicyV2Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_kyverno_io_cluster_policy_v2beta1")
