...
func TestResourcesTeleportDevTeleportSamlconnectorV2DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_resources_teleport_dev_teleport_saml_connector_v2", testCase)
		})
	}
}
...
func TestResourcesTeleportDevTeleportSamlconnectorV2DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_resources_teleport_dev_teleport_saml_connector_v2", configuration)
}
