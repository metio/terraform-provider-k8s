...
func TestResourcesTeleportDevTeleportProvisionTokenV2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_resources_teleport_dev_teleport_provision_token_v2_manifest", testCase)
		})
	}
}
