...
type ResourcesTeleportDevTeleportProvisionTokenV2ManifestData struct {
	...
	Spec *struct {
		...
		Kubernetes  *struct {
			...
			Oidc *struct {
				Insecure_allow_http_issuer *bool   `tfsdk:"insecure_allow_http_issuer" json:"insecure_allow_http_issuer,omitempty"`
		...
		Spacelift *struct {
			...
			Enable_glob_matching *bool   `tfsdk:"enable_glob_matching" json:"enable_glob_matching,omitempty"`
				...
				Attributes: map[string]schema.Attribute{
					...
					"kubernetes": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"oidc": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "OIDCConfig configures the 'oidc' type.",
								Attributes: map[string]schema.Attribute{
									"insecure_allow_http_issuer": schema.BoolAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
							...
							"type": schema.StringAttribute{
								...
								MarkdownDescription: "Type controls which behavior should be used for validating the Kubernetes Service Account token. Support values: - 'in_cluster' - 'static_jwks' - 'oidc' If unset, this defaults to 'in_cluster'.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"spacelift": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"enable_glob_matching": schema.BoolAttribute{
								Description:         "EnableGlobMatching enables glob-style matching for the space_id and caller_id fields in the rules.",
								MarkdownDescription: "EnableGlobMatching enables glob-style matching for the space_id and caller_id fields in the rules.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
