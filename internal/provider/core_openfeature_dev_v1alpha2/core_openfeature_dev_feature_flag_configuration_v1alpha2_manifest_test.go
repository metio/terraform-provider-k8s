...
func TestCoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_core_openfeature_dev_feature_flag_configuration_v1alpha2_manifest", testCase)
		})
	}
}
