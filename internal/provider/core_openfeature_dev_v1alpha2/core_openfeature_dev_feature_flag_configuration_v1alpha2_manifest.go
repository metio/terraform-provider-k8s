...
var (
	_ datasource.DataSource = &CoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest{}
)

func NewCoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest() datasource.DataSource {
	return &CoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest{}
}
...
func (r *CoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_core_openfeature_dev_feature_flag_configuration_v1alpha2_manifest"
}

func (r *CoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_core_openfeature_dev_feature_flag_configuration_v1alpha2_manifest")

	var model CoreOpenfeatureDevFeatureFlagConfigurationV1Alpha2ManifestData
