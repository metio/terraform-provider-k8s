...
var (
	_ resource.Resource = (*CiliumIoCiliumNetworkPolicyV2Resource)(nil)
)

type CiliumIoCiliumNetworkPolicyV2TerraformModel struct {
...
type CiliumIoCiliumNetworkPolicyV2GoModel struct {
...
func (r *CiliumIoCiliumNetworkPolicyV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cilium_io_cilium_network_policy_v2"
}

func (r *CiliumIoCiliumNetworkPolicyV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *CiliumIoCiliumNetworkPolicyV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_cilium_io_cilium_network_policy_v2")

	var state CiliumIoCiliumNetworkPolicyV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CiliumIoCiliumNetworkPolicyV2GoModel
	...
	goModel.Kind = utilities.Ptr("CiliumNetworkPolicy")
...
func (r *CiliumIoCiliumNetworkPolicyV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_network_policy_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *CiliumIoCiliumNetworkPolicyV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CiliumIoCiliumNetworkPolicyV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
