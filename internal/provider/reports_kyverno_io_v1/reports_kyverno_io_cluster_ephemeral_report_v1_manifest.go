...
var (
	_ datasource.DataSource = &ReportsKyvernoIoClusterEphemeralReportV1Manifest{}
)

func NewReportsKyvernoIoClusterEphemeralReportV1Manifest() datasource.DataSource {
	return &ReportsKyvernoIoClusterEphemeralReportV1Manifest{}
}
...
func (r *ReportsKyvernoIoClusterEphemeralReportV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_reports_kyverno_io_cluster_ephemeral_report_v1_manifest"
}

func (r *ReportsKyvernoIoClusterEphemeralReportV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ClusterEphemeralReport is the Schema for the ClusterEphemeralReports API",
		MarkdownDescription: "ClusterEphemeralReport is the Schema for the ClusterEphemeralReports API",
...
func (r *ReportsKyvernoIoClusterEphemeralReportV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_reports_kyverno_io_cluster_ephemeral_report_v1_manifest")

	var model ReportsKyvernoIoClusterEphemeralReportV1ManifestData
	...
	model.Kind = pointer.String("ClusterEphemeralReport")
