...
var (
	_ datasource.DataSource = &KyvernoIoClusterAdmissionReportV2Manifest{}
)

func NewKyvernoIoClusterAdmissionReportV2Manifest() datasource.DataSource {
	return &KyvernoIoClusterAdmissionReportV2Manifest{}
}

type KyvernoIoClusterAdmissionReportV2Manifest struct{}

type KyvernoIoClusterAdmissionReportV2ManifestData struct {
...
func (r *KyvernoIoClusterAdmissionReportV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_admission_report_v2_manifest"
}

func (r *KyvernoIoClusterAdmissionReportV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterAdmissionReportV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_admission_report_v2_manifest")

	var model KyvernoIoClusterAdmissionReportV2ManifestData
