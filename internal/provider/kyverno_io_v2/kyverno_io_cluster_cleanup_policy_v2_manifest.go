...
var (
	_ datasource.DataSource = &KyvernoIoClusterCleanupPolicyV2Manifest{}
)

func NewKyvernoIoClusterCleanupPolicyV2Manifest() datasource.DataSource {
	return &KyvernoIoClusterCleanupPolicyV2Manifest{}
}

type KyvernoIoClusterCleanupPolicyV2Manifest struct{}

type KyvernoIoClusterCleanupPolicyV2ManifestData struct {
...
func (r *KyvernoIoClusterCleanupPolicyV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_cleanup_policy_v2_manifest"
}

func (r *KyvernoIoClusterCleanupPolicyV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterCleanupPolicyV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_cleanup_policy_v2_manifest")

	var model KyvernoIoClusterCleanupPolicyV2ManifestData
