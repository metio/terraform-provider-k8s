...
var (
	_ datasource.DataSource = &KyvernoIoUpdateRequestV2Manifest{}
)

func NewKyvernoIoUpdateRequestV2Manifest() datasource.DataSource {
	return &KyvernoIoUpdateRequestV2Manifest{}
}

type KyvernoIoUpdateRequestV2Manifest struct{}

type KyvernoIoUpdateRequestV2ManifestData struct {
...
func (r *KyvernoIoUpdateRequestV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_update_request_v2_manifest"
}

func (r *KyvernoIoUpdateRequestV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"synchronize": schema.BoolAttribute{
						Description:         "Synchronize represents the sync behavior of the corresponding rule Optional. Defaults to 'false' if not specified. Deprecated, will be removed in 1.14.",
						MarkdownDescription: "Synchronize represents the sync behavior of the corresponding rule Optional. Defaults to 'false' if not specified. Deprecated, will be removed in 1.14.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *KyvernoIoUpdateRequestV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_update_request_v2_manifest")

	var model KyvernoIoUpdateRequestV2ManifestData
