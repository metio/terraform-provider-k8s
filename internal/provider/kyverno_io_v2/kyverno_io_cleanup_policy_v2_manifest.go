...
var (
	_ datasource.DataSource = &KyvernoIoCleanupPolicyV2Manifest{}
)

func NewKyvernoIoCleanupPolicyV2Manifest() datasource.DataSource {
	return &KyvernoIoCleanupPolicyV2Manifest{}
}

type KyvernoIoCleanupPolicyV2Manifest struct{}

type KyvernoIoCleanupPolicyV2ManifestData struct {
...
func (r *KyvernoIoCleanupPolicyV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cleanup_policy_v2_manifest"
}

func (r *KyvernoIoCleanupPolicyV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoCleanupPolicyV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cleanup_policy_v2_manifest")

	var model KyvernoIoCleanupPolicyV2ManifestData
