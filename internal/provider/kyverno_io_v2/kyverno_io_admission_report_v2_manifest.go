...
var (
	_ datasource.DataSource = &KyvernoIoAdmissionReportV2Manifest{}
)

func NewKyvernoIoAdmissionReportV2Manifest() datasource.DataSource {
	return &KyvernoIoAdmissionReportV2Manifest{}
}

type KyvernoIoAdmissionReportV2Manifest struct{}

type KyvernoIoAdmissionReportV2ManifestData struct {
...
func (r *KyvernoIoAdmissionReportV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_admission_report_v2_manifest"
}

func (r *KyvernoIoAdmissionReportV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoAdmissionReportV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_admission_report_v2_manifest")

	var model KyvernoIoAdmissionReportV2ManifestData
