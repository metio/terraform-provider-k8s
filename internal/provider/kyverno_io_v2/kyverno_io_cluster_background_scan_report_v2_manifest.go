...
var (
	_ datasource.DataSource = &KyvernoIoClusterBackgroundScanReportV2Manifest{}
)

func NewKyvernoIoClusterBackgroundScanReportV2Manifest() datasource.DataSource {
	return &KyvernoIoClusterBackgroundScanReportV2Manifest{}
}
...
func (r *KyvernoIoClusterBackgroundScanReportV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_background_scan_report_v2_manifest"
}

func (r *KyvernoIoClusterBackgroundScanReportV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterBackgroundScanReportV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_background_scan_report_v2_manifest")

	var model KyvernoIoClusterBackgroundScanReportV2ManifestData
