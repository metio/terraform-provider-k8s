...
var (
	_ datasource.DataSource = &KyvernoIoBackgroundScanReportV2Manifest{}
)

func NewKyvernoIoBackgroundScanReportV2Manifest() datasource.DataSource {
	return &KyvernoIoBackgroundScanReportV2Manifest{}
}

type KyvernoIoBackgroundScanReportV2Manifest struct{}

type KyvernoIoBackgroundScanReportV2ManifestData struct {
...
func (r *KyvernoIoBackgroundScanReportV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_background_scan_report_v2_manifest"
}

func (r *KyvernoIoBackgroundScanReportV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoBackgroundScanReportV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_background_scan_report_v2_manifest")

	var model KyvernoIoBackgroundScanReportV2ManifestData
