...
var (
	_ datasource.DataSource = &MariadbMmontesIoSqlJobV1Alpha1Manifest{}
)

func NewMariadbMmontesIoSqlJobV1Alpha1Manifest() datasource.DataSource {
	return &MariadbMmontesIoSqlJobV1Alpha1Manifest{}
}

type MariadbMmontesIoSqlJobV1Alpha1Manifest struct{}

type MariadbMmontesIoSqlJobV1Alpha1ManifestData struct {
...
func (r *MariadbMmontesIoSqlJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_sql_job_v1alpha1_manifest"
}
...
func (r *MariadbMmontesIoSqlJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mariadb_mmontes_io_sql_job_v1alpha1_manifest")

	var model MariadbMmontesIoSqlJobV1Alpha1ManifestData
