...
var (
	_ datasource.DataSource              = &MariadbMmontesIoBackupV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MariadbMmontesIoBackupV1Alpha1DataSource{}
)

func NewMariadbMmontesIoBackupV1Alpha1DataSource() datasource.DataSource {
	return &MariadbMmontesIoBackupV1Alpha1DataSource{}
}

type MariadbMmontesIoBackupV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MariadbMmontesIoBackupV1Alpha1DataSourceData struct {
...
func (r *MariadbMmontesIoBackupV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_backup_v1alpha1"
}

func (r *MariadbMmontesIoBackupV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MariadbMmontesIoBackupV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MariadbMmontesIoBackupV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mariadb_mmontes_io_backup_v1alpha1")

	var data MariadbMmontesIoBackupV1Alpha1DataSourceData
	...
	var readResponse MariadbMmontesIoBackupV1Alpha1DataSourceData
