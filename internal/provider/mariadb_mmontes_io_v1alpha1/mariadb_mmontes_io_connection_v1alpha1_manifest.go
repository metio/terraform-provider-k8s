...
var (
	_ datasource.DataSource = &MariadbMmontesIoConnectionV1Alpha1Manifest{}
)

func NewMariadbMmontesIoConnectionV1Alpha1Manifest() datasource.DataSource {
	return &MariadbMmontesIoConnectionV1Alpha1Manifest{}
}

type MariadbMmontesIoConnectionV1Alpha1Manifest struct{}

type MariadbMmontesIoConnectionV1Alpha1ManifestData struct {
...
func (r *MariadbMmontesIoConnectionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_connection_v1alpha1_manifest"
}
...
func (r *MariadbMmontesIoConnectionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mariadb_mmontes_io_connection_v1alpha1_manifest")

	var model MariadbMmontesIoConnectionV1Alpha1ManifestData
