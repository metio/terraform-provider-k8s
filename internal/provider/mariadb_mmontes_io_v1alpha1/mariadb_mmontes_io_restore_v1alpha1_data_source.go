...
var (
	_ datasource.DataSource              = &MariadbMmontesIoRestoreV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MariadbMmontesIoRestoreV1Alpha1DataSource{}
)

func NewMariadbMmontesIoRestoreV1Alpha1DataSource() datasource.DataSource {
	return &MariadbMmontesIoRestoreV1Alpha1DataSource{}
}

type MariadbMmontesIoRestoreV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MariadbMmontesIoRestoreV1Alpha1DataSourceData struct {
...
func (r *MariadbMmontesIoRestoreV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_restore_v1alpha1"
}

func (r *MariadbMmontesIoRestoreV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MariadbMmontesIoRestoreV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MariadbMmontesIoRestoreV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mariadb_mmontes_io_restore_v1alpha1")

	var data MariadbMmontesIoRestoreV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "mariadb.mmontes.io", Version: "v1alpha1", Resource: "restores"}).
	...
	var readResponse MariadbMmontesIoRestoreV1Alpha1DataSourceData
