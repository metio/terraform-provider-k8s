...
var (
	_ datasource.DataSource = &MariadbMmontesIoUserV1Alpha1Manifest{}
)

func NewMariadbMmontesIoUserV1Alpha1Manifest() datasource.DataSource {
	return &MariadbMmontesIoUserV1Alpha1Manifest{}
}

type MariadbMmontesIoUserV1Alpha1Manifest struct{}

type MariadbMmontesIoUserV1Alpha1ManifestData struct {
...
func (r *MariadbMmontesIoUserV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_user_v1alpha1_manifest"
}
...
func (r *MariadbMmontesIoUserV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mariadb_mmontes_io_user_v1alpha1_manifest")

	var model MariadbMmontesIoUserV1Alpha1ManifestData
