...
var (
	_ datasource.DataSource = &MariadbMmontesIoBackupV1Alpha1Manifest{}
)

func NewMariadbMmontesIoBackupV1Alpha1Manifest() datasource.DataSource {
	return &MariadbMmontesIoBackupV1Alpha1Manifest{}
}

type MariadbMmontesIoBackupV1Alpha1Manifest struct{}

type MariadbMmontesIoBackupV1Alpha1ManifestData struct {
...
func (r *MariadbMmontesIoBackupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_backup_v1alpha1_manifest"
}
...
func (r *MariadbMmontesIoBackupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mariadb_mmontes_io_backup_v1alpha1_manifest")

	var model MariadbMmontesIoBackupV1Alpha1ManifestData
