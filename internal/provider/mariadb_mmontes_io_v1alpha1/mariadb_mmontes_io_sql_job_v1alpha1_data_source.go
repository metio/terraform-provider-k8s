...
var (
	_ datasource.DataSource              = &MariadbMmontesIoSqlJobV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MariadbMmontesIoSqlJobV1Alpha1DataSource{}
)

func NewMariadbMmontesIoSqlJobV1Alpha1DataSource() datasource.DataSource {
	return &MariadbMmontesIoSqlJobV1Alpha1DataSource{}
}

type MariadbMmontesIoSqlJobV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MariadbMmontesIoSqlJobV1Alpha1DataSourceData struct {
...
func (r *MariadbMmontesIoSqlJobV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_sql_job_v1alpha1"
}

func (r *MariadbMmontesIoSqlJobV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MariadbMmontesIoSqlJobV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MariadbMmontesIoSqlJobV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mariadb_mmontes_io_sql_job_v1alpha1")

	var data MariadbMmontesIoSqlJobV1Alpha1DataSourceData
	...
	var readResponse MariadbMmontesIoSqlJobV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("SqlJob")
