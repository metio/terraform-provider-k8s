...
var (
	_ datasource.DataSource = &MariadbMmontesIoGrantV1Alpha1Manifest{}
)

func NewMariadbMmontesIoGrantV1Alpha1Manifest() datasource.DataSource {
	return &MariadbMmontesIoGrantV1Alpha1Manifest{}
}
...
func (r *MariadbMmontesIoGrantV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_grant_v1alpha1_manifest"
}
...
func (r *MariadbMmontesIoGrantV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mariadb_mmontes_io_grant_v1alpha1_manifest")

	var model MariadbMmontesIoGrantV1Alpha1ManifestData
