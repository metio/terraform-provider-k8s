...
var (
	_ datasource.DataSource              = &MariadbMmontesIoConnectionV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MariadbMmontesIoConnectionV1Alpha1DataSource{}
)

func NewMariadbMmontesIoConnectionV1Alpha1DataSource() datasource.DataSource {
	return &MariadbMmontesIoConnectionV1Alpha1DataSource{}
}

type MariadbMmontesIoConnectionV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MariadbMmontesIoConnectionV1Alpha1DataSourceData struct {
...
func (r *MariadbMmontesIoConnectionV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mariadb_mmontes_io_connection_v1alpha1"
}

func (r *MariadbMmontesIoConnectionV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MariadbMmontesIoConnectionV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MariadbMmontesIoConnectionV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mariadb_mmontes_io_connection_v1alpha1")

	var data MariadbMmontesIoConnectionV1Alpha1DataSourceData
	...
	var readResponse MariadbMmontesIoConnectionV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Connection")
