					...
					"autoscaling": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"target_workspaces": schema.ListNestedAttribute{
								Description:         "TargetWorkspaces is a list of HCP Terraform Workspaces which the agent pool should scale up to meet demand. When this field is ommited the autoscaler will target all workspaces that are associated with the AgentPool.",
								MarkdownDescription: "TargetWorkspaces is a list of HCP Terraform Workspaces which the agent pool should scale up to meet demand. When this field is ommited the autoscaler will target all workspaces that are associated with the AgentPool.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"id": schema.StringAttribute{
