...
var (
	_ datasource.DataSource = &AppTerraformIoAgentPoolV1Alpha2Manifest{}
)

func NewAppTerraformIoAgentPoolV1Alpha2Manifest() datasource.DataSource {
	return &AppTerraformIoAgentPoolV1Alpha2Manifest{}
}

type AppTerraformIoAgentPoolV1Alpha2Manifest struct{}

type AppTerraformIoAgentPoolV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"agent_deployment" json:"agentDeployment,omitempty"`
		AgentTokens *[]struct {
			CreatedAt  *int64  `tfsdk:"created_at" json:"createdAt,omitempty"`
			Id         *string `tfsdk:"id" json:"id,omitempty"`
			LastUsedAt *int64  `tfsdk:"last_used_at" json:"lastUsedAt,omitempty"`
			Name       *string `tfsdk:"name" json:"name,omitempty"`
		...
		Autoscaling *struct {
			...
			TargetWorkspaces      *[]struct {
				Id           *string `tfsdk:"id" json:"id,omitempty"`
				Name         *string `tfsdk:"name" json:"name,omitempty"`
				WildcardName *string `tfsdk:"wildcard_name" json:"wildcardName,omitempty"`
			} `tfsdk:"target_workspaces" json:"targetWorkspaces,omitempty"`
...
func (r *AppTerraformIoAgentPoolV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_terraform_io_agent_pool_v1alpha2_manifest"
}

func (r *AppTerraformIoAgentPoolV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AgentPool manages HCP Terraform Agent Pools, HCP Terraform Agent Tokens and can perform HCP Terraform Agent scaling. More infromation: - https://developer.hashicorp.com/terraform/cloud-docs/agents/agent-pools - https://developer.hashicorp.com/terraform/cloud-docs/users-teams-organizations/api-tokens#agent-api-tokens - https://developer.hashicorp.com/terraform/cloud-docs/agents",
		MarkdownDescription: "AgentPool manages HCP Terraform Agent Pools, HCP Terraform Agent Tokens and can perform HCP Terraform Agent scaling. More infromation: - https://developer.hashicorp.com/terraform/cloud-docs/agents/agent-pools - https://developer.hashicorp.com/terraform/cloud-docs/users-teams-organizations/api-tokens#agent-api-tokens - https://developer.hashicorp.com/terraform/cloud-docs/agents",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"agent_deployment": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "The annotations that the operator will apply to the pod template in the deployment.",
								MarkdownDescription: "The annotations that the operator will apply to the pod template in the deployment.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"labels": schema.MapAttribute{
								Description:         "The labels that the operator will apply to the pod template in the deployment.",
								MarkdownDescription: "The labels that the operator will apply to the pod template in the deployment.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"agent_tokens": schema.ListNestedAttribute{
						Description:         "List of the agent tokens to generate.",
						MarkdownDescription: "List of the agent tokens to generate.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"created_at": schema.Int64Attribute{
									Description:         "Timestamp of when the agent token was created.",
									MarkdownDescription: "Timestamp of when the agent token was created.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"id": schema.StringAttribute{
									...
									MarkdownDescription: "Agent Token ID.",
									Required:            false,
									Optional:            true,
									Computed:            false,
									Validators: []validator.String{
										stringvalidator.RegexMatches(regexp.MustCompile(`^at-[a-zA-Z0-9]+$`), ""),
									},
								},

								"last_used_at": schema.Int64Attribute{
									Description:         "Timestamp of when the agent token was last used.",
									MarkdownDescription: "Timestamp of when the agent token was last used.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"autoscaling": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"max_replicas": schema.Int64Attribute{
								Description:         "MaxReplicas is the maximum number of replicas for the Agent deployment.",
								MarkdownDescription: "MaxReplicas is the maximum number of replicas for the Agent deployment.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"min_replicas": schema.Int64Attribute{
								Description:         "MinReplicas is the minimum number of replicas for the Agent deployment.",
								MarkdownDescription: "MinReplicas is the minimum number of replicas for the Agent deployment.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"target_workspaces": schema.ListNestedAttribute{
								Description:         "DEPRECATED: This field has been deprecated since 2.9.0 and will be removed in future versions. TargetWorkspaces is a list of HCP Terraform Workspaces which the agent pool should scale up to meet demand. When this field is ommited the autoscaler will target all workspaces that are associated with the AgentPool.",
								MarkdownDescription: "DEPRECATED: This field has been deprecated since 2.9.0 and will be removed in future versions. TargetWorkspaces is a list of HCP Terraform Workspaces which the agent pool should scale up to meet demand. When this field is ommited the autoscaler will target all workspaces that are associated with the AgentPool.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"id": schema.StringAttribute{
										...
										"wildcard_name": schema.StringAttribute{
											Description:         "Wildcard Name to match match workspace names using '*' on name suffix, prefix, or both.",
											MarkdownDescription: "Wildcard Name to match match workspace names using '*' on name suffix, prefix, or both.",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.String{
					...
					"name": schema.StringAttribute{
						Description:         "Agent Pool name. More information: - https://developer.hashicorp.com/terraform/cloud-docs/agents/agent-pools",
						MarkdownDescription: "Agent Pool name. More information: - https://developer.hashicorp.com/terraform/cloud-docs/agents/agent-pools",
						Required:            true,
						Optional:            false,
						Computed:            false,
						Validators: []validator.String{
...
func (r *AppTerraformIoAgentPoolV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_app_terraform_io_agent_pool_v1alpha2_manifest")

	var model AppTerraformIoAgentPoolV1Alpha2ManifestData
	...
	model.Kind = pointer.String("AgentPool")
