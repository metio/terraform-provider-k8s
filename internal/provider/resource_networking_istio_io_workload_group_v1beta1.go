...
type NetworkingIstioIoWorkloadGroupV1Beta1Resource struct{}

var (
	_ resource.Resource = (*NetworkingIstioIoWorkloadGroupV1Beta1Resource)(nil)
)

type NetworkingIstioIoWorkloadGroupV1Beta1TerraformModel struct {
...
type NetworkingIstioIoWorkloadGroupV1Beta1GoModel struct {
...
func NewNetworkingIstioIoWorkloadGroupV1Beta1Resource() resource.Resource {
	return &NetworkingIstioIoWorkloadGroupV1Beta1Resource{}
}

func (r *NetworkingIstioIoWorkloadGroupV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_networking_istio_io_workload_group_v1beta1"
}

func (r *NetworkingIstioIoWorkloadGroupV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_networking_istio_io_workload_group_v1beta1")

	var state NetworkingIstioIoWorkloadGroupV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel NetworkingIstioIoWorkloadGroupV1Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("networking.istio.io/v1beta1")
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_workload_group_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *NetworkingIstioIoWorkloadGroupV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_networking_istio_io_workload_group_v1beta1")
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_networking_istio_io_workload_group_v1beta1")
