...
var (
	_ resource.Resource = (*CertManagerIoIssuerV1Resource)(nil)
)

type CertManagerIoIssuerV1TerraformModel struct {
...
type CertManagerIoIssuerV1GoModel struct {
...
func (r *CertManagerIoIssuerV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cert_manager_io_issuer_v1"
}

func (r *CertManagerIoIssuerV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *CertManagerIoIssuerV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_cert_manager_io_issuer_v1")

	var state CertManagerIoIssuerV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CertManagerIoIssuerV1GoModel
	...
	goModel.Kind = utilities.Ptr("Issuer")
...
func (r *CertManagerIoIssuerV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cert_manager_io_issuer_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *CertManagerIoIssuerV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CertManagerIoIssuerV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
