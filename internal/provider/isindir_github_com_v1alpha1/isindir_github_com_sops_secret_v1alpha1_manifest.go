...
var (
	_ datasource.DataSource = &IsindirGithubComSopsSecretV1Alpha1Manifest{}
)

func NewIsindirGithubComSopsSecretV1Alpha1Manifest() datasource.DataSource {
	return &IsindirGithubComSopsSecretV1Alpha1Manifest{}
}
...
func (r *IsindirGithubComSopsSecretV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_isindir_github_com_sops_secret_v1alpha1_manifest"
}

func (r *IsindirGithubComSopsSecretV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *IsindirGithubComSopsSecretV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_isindir_github_com_sops_secret_v1alpha1_manifest")

	var model IsindirGithubComSopsSecretV1Alpha1ManifestData
