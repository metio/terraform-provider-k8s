...
var (
	_ datasource.DataSource = &KueueXK8SIoCohortV1Beta1Manifest{}
)

func NewKueueXK8SIoCohortV1Beta1Manifest() datasource.DataSource {
	return &KueueXK8SIoCohortV1Beta1Manifest{}
}

type KueueXK8SIoCohortV1Beta1Manifest struct{}

type KueueXK8SIoCohortV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		ParentName     *string `tfsdk:"parent_name" json:"parentName,omitempty"`
...
func (r *KueueXK8SIoCohortV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kueue_x_k8s_io_cohort_v1beta1_manifest"
}

func (r *KueueXK8SIoCohortV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KueueXK8SIoCohortV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kueue_x_k8s_io_cohort_v1beta1_manifest")

	var model KueueXK8SIoCohortV1Beta1ManifestData
