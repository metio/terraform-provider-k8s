...
var (
	_ datasource.DataSource = &KueueXK8SIoWorkloadV1Beta1Manifest{}
)

func NewKueueXK8SIoWorkloadV1Beta1Manifest() datasource.DataSource {
	return &KueueXK8SIoWorkloadV1Beta1Manifest{}
}

type KueueXK8SIoWorkloadV1Beta1Manifest struct{}

type KueueXK8SIoWorkloadV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		MaximumExecutionTimeSeconds *int64 `tfsdk:"maximum_execution_time_seconds" json:"maximumExecutionTimeSeconds,omitempty"`
		PodSets                     *[]struct {
			...
			TopologyRequest *struct {
				PodIndexLabel               *string `tfsdk:"pod_index_label" json:"podIndexLabel,omitempty"`
				PodSetGroupName             *string `tfsdk:"pod_set_group_name" json:"podSetGroupName,omitempty"`
				PodSetSliceRequiredTopology *string `tfsdk:"pod_set_slice_required_topology" json:"podSetSliceRequiredTopology,omitempty"`
				PodSetSliceSize             *int64  `tfsdk:"pod_set_slice_size" json:"podSetSliceSize,omitempty"`
				...
				SubGroupIndexLabel          *string `tfsdk:"sub_group_index_label" json:"subGroupIndexLabel,omitempty"`
				Unconstrained               *bool   `tfsdk:"unconstrained" json:"unconstrained,omitempty"`
...
func (r *KueueXK8SIoWorkloadV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kueue_x_k8s_io_workload_v1beta1_manifest"
}

func (r *KueueXK8SIoWorkloadV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"active": schema.BoolAttribute{
						Description:         "Active determines if a workload can be admitted into a queue. Changing active from true to false will evict any running workloads. Possible values are: - false: indicates that a workload should never be admitted and evicts running workloads - true: indicates that a workload can be evaluated for admission into it's respective queue. Defaults to true",
						MarkdownDescription: "Active determines if a workload can be admitted into a queue. Changing active from true to false will evict any running workloads. Possible values are: - false: indicates that a workload should never be admitted and evicts running workloads - true: indicates that a workload can be evaluated for admission into it's respective queue. Defaults to true",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"maximum_execution_time_seconds": schema.Int64Attribute{
						Description:         "maximumExecutionTimeSeconds if provided, determines the maximum time, in seconds, the workload can be admitted before it's automatically deactivated. If unspecified, no execution time limit is enforced on the Workload.",
						MarkdownDescription: "maximumExecutionTimeSeconds if provided, determines the maximum time, in seconds, the workload can be admitted before it's automatically deactivated. If unspecified, no execution time limit is enforced on the Workload.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"topology_request": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										"pod_index_label": schema.StringAttribute{
											Description:         "PodIndexLabel indicates the name of the label indexing the pods. For example, in the context of - kubernetes job this is: kubernetes.io/job-completion-index - JobSet: kubernetes.io/job-completion-index (inherited from Job) - Kubeflow: training.kubeflow.org/replica-index",
											MarkdownDescription: "PodIndexLabel indicates the name of the label indexing the pods. For example, in the context of - kubernetes job this is: kubernetes.io/job-completion-index - JobSet: kubernetes.io/job-completion-index (inherited from Job) - Kubeflow: training.kubeflow.org/replica-index",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"pod_set_group_name": schema.StringAttribute{
											Description:         "PodSetGroupName indicates the name of the group of PodSets to which this PodSet belongs to. PodSets with the same 'PodSetGroupName' should be assigned the same ResourceFlavor",
											MarkdownDescription: "PodSetGroupName indicates the name of the group of PodSets to which this PodSet belongs to. PodSets with the same 'PodSetGroupName' should be assigned the same ResourceFlavor",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"pod_set_slice_required_topology": schema.StringAttribute{
											Description:         "PodSetSliceRequiredTopology indicates the topology level required by the PodSet slice, as indicated by the 'kueue.x-k8s.io/podset-slice-required-topology' annotation.",
											MarkdownDescription: "PodSetSliceRequiredTopology indicates the topology level required by the PodSet slice, as indicated by the 'kueue.x-k8s.io/podset-slice-required-topology' annotation.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"pod_set_slice_size": schema.Int64Attribute{
											Description:         "PodSetSliceSize indicates the size of a subgroup of pods in a PodSet for which Kueue finds a requested topology domain on a level defined in 'kueue.x-k8s.io/podset-slice-required-topology' annotation.",
											MarkdownDescription: "PodSetSliceSize indicates the size of a subgroup of pods in a PodSet for which Kueue finds a requested topology domain on a level defined in 'kueue.x-k8s.io/podset-slice-required-topology' annotation.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"sub_group_count": schema.Int64Attribute{
											...
											MarkdownDescription: "SubGroupIndexLabel indicates the count of replicated Jobs (groups) within a PodSet. For example, in the context of JobSet this value is read from jobset.sigs.k8s.io/replicatedjob-replicas.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"sub_group_index_label": schema.StringAttribute{
											Description:         "SubGroupIndexLabel indicates the name of the label indexing the instances of replicated Jobs (groups) within a PodSet. For example, in the context of JobSet this is jobset.sigs.k8s.io/job-index.",
											MarkdownDescription: "SubGroupIndexLabel indicates the name of the label indexing the instances of replicated Jobs (groups) within a PodSet. For example, in the context of JobSet this is jobset.sigs.k8s.io/job-index.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"unconstrained": schema.BoolAttribute{
											Description:         "unconstrained indicates that Kueue has the freedom to schedule the PodSet within the entire available capacity, without constraints on the compactness of the placement. This is indicated by the 'kueue.x-k8s.io/podset-unconstrained-topology' PodSet annotation.",
											MarkdownDescription: "unconstrained indicates that Kueue has the freedom to schedule the PodSet within the entire available capacity, without constraints on the compactness of the placement. This is indicated by the 'kueue.x-k8s.io/podset-unconstrained-topology' PodSet annotation.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"priority_class_source": schema.StringAttribute{
						Description:         "priorityClassSource determines whether the priorityClass field refers to a pod PriorityClass or kueue.x-k8s.io/workloadpriorityclass. Workload's PriorityClass can accept the name of a pod priorityClass or a workloadPriorityClass. When using pod PriorityClass, a priorityClassSource field has the scheduling.k8s.io/priorityclass value.",
						MarkdownDescription: "priorityClassSource determines whether the priorityClass field refers to a pod PriorityClass or kueue.x-k8s.io/workloadpriorityclass. Workload's PriorityClass can accept the name of a pod priorityClass or a workloadPriorityClass. When using pod PriorityClass, a priorityClassSource field has the scheduling.k8s.io/priorityclass value.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("kueue.x-k8s.io/workloadpriorityclass", "scheduling.k8s.io/priorityclass", ""),
						},
					},
...
func (r *KueueXK8SIoWorkloadV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kueue_x_k8s_io_workload_v1beta1_manifest")

	var model KueueXK8SIoWorkloadV1Beta1ManifestData
