...
var (
	_ datasource.DataSource              = &KueueXK8SIoWorkloadV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &KueueXK8SIoWorkloadV1Beta1DataSource{}
)

func NewKueueXK8SIoWorkloadV1Beta1DataSource() datasource.DataSource {
	return &KueueXK8SIoWorkloadV1Beta1DataSource{}
}

type KueueXK8SIoWorkloadV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KueueXK8SIoWorkloadV1Beta1DataSourceData struct {
...
func (r *KueueXK8SIoWorkloadV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kueue_x_k8s_io_workload_v1beta1"
}

func (r *KueueXK8SIoWorkloadV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KueueXK8SIoWorkloadV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KueueXK8SIoWorkloadV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kueue_x_k8s_io_workload_v1beta1")

	var data KueueXK8SIoWorkloadV1Beta1DataSourceData
	...
	var readResponse KueueXK8SIoWorkloadV1Beta1DataSourceData
