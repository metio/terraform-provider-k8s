...
type KueueXK8SIoProvisioningRequestConfigV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		PodSetMergePolicy *string            `tfsdk:"pod_set_merge_policy" json:"podSetMergePolicy,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"pod_set_merge_policy": schema.StringAttribute{
						Description:         "podSetMergePolicy specifies the policy for merging PodSets before being passed to the cluster autoscaler.",
						MarkdownDescription: "podSetMergePolicy specifies the policy for merging PodSets before being passed to the cluster autoscaler.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("IdenticalPodTemplates", "IdenticalWorkloadSchedulingRequirements"),
						},
					},
