...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineV1Alpha4Manifest{}
)

func NewClusterXK8SIoMachineV1Alpha4Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineV1Alpha4Manifest{}
}

type ClusterXK8SIoMachineV1Alpha4Manifest struct{}

type ClusterXK8SIoMachineV1Alpha4ManifestData struct {
...
func (r *ClusterXK8SIoMachineV1Alpha4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_v1alpha4_manifest"
}

func (r *ClusterXK8SIoMachineV1Alpha4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachineV1Alpha4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_v1alpha4_manifest")

	var model ClusterXK8SIoMachineV1Alpha4ManifestData
