...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineHealthCheckV1Alpha4Manifest{}
)

func NewClusterXK8SIoMachineHealthCheckV1Alpha4Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineHealthCheckV1Alpha4Manifest{}
}

type ClusterXK8SIoMachineHealthCheckV1Alpha4Manifest struct{}

type ClusterXK8SIoMachineHealthCheckV1Alpha4ManifestData struct {
...
func (r *ClusterXK8SIoMachineHealthCheckV1Alpha4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_health_check_v1alpha4_manifest"
}

func (r *ClusterXK8SIoMachineHealthCheckV1Alpha4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"node_startup_timeout": schema.StringAttribute{
						Description:         "nodeStartupTimeout is the duration after which machines without a node will be considered to have failed and will be remediated. If not set, this value is defaulted to 10 minutes. If you wish to disable this feature, set the value explicitly to 0.",
						MarkdownDescription: "nodeStartupTimeout is the duration after which machines without a node will be considered to have failed and will be remediated. If not set, this value is defaulted to 10 minutes. If you wish to disable this feature, set the value explicitly to 0.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ClusterXK8SIoMachineHealthCheckV1Alpha4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_health_check_v1alpha4_manifest")

	var model ClusterXK8SIoMachineHealthCheckV1Alpha4ManifestData
