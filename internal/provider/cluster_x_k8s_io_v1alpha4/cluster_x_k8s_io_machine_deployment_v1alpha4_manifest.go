...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineDeploymentV1Alpha4Manifest{}
)

func NewClusterXK8SIoMachineDeploymentV1Alpha4Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineDeploymentV1Alpha4Manifest{}
}

type ClusterXK8SIoMachineDeploymentV1Alpha4Manifest struct{}

type ClusterXK8SIoMachineDeploymentV1Alpha4ManifestData struct {
...
func (r *ClusterXK8SIoMachineDeploymentV1Alpha4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_deployment_v1alpha4_manifest"
}

func (r *ClusterXK8SIoMachineDeploymentV1Alpha4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"selector": schema.SingleNestedAttribute{
						Description:         "Label selector for machines. Existing MachineSets whose machines areselected by this will be the ones affected by this deployment.It must match the machine template's labels.",
						MarkdownDescription: "Label selector for machines. Existing MachineSets whose machines areselected by this will be the ones affected by this deployment.It must match the machine template's labels.",
						Attributes: map[string]schema.Attribute{
...
func (r *ClusterXK8SIoMachineDeploymentV1Alpha4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_deployment_v1alpha4_manifest")

	var model ClusterXK8SIoMachineDeploymentV1Alpha4ManifestData
