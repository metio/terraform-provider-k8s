...
var (
	_ datasource.DataSource              = &ClusterXK8SIoMachinePoolV1Alpha4DataSource{}
	_ datasource.DataSourceWithConfigure = &ClusterXK8SIoMachinePoolV1Alpha4DataSource{}
)

func NewClusterXK8SIoMachinePoolV1Alpha4DataSource() datasource.DataSource {
	return &ClusterXK8SIoMachinePoolV1Alpha4DataSource{}
}

type ClusterXK8SIoMachinePoolV1Alpha4DataSource struct {
	kubernetesClient dynamic.Interface
}

type ClusterXK8SIoMachinePoolV1Alpha4DataSourceData struct {
...
func (r *ClusterXK8SIoMachinePoolV1Alpha4DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_pool_v1alpha4"
}

func (r *ClusterXK8SIoMachinePoolV1Alpha4DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachinePoolV1Alpha4DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ClusterXK8SIoMachinePoolV1Alpha4DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cluster_x_k8s_io_machine_pool_v1alpha4")

	var data ClusterXK8SIoMachinePoolV1Alpha4DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "cluster.x-k8s.io", Version: "v1alpha4", Resource: "machinepools"}).
	...
	var readResponse ClusterXK8SIoMachinePoolV1Alpha4DataSourceData
