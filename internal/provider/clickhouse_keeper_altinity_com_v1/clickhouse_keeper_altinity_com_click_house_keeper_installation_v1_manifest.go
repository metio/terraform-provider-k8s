			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"suspend": schema.StringAttribute{
						Description:         "Suspend reconciliation of resources managed by a ClickHouse Keeper. Works as the following: - When 'suspend' is 'true' operator stops reconciling all keeper resources. - When 'suspend' is 'false' or not set, operator reconciles all keeper resources. ",
						MarkdownDescription: "Suspend reconciliation of resources managed by a ClickHouse Keeper. Works as the following: - When 'suspend' is 'true' operator stops reconciling all keeper resources. - When 'suspend' is 'false' or not set, operator reconciles all keeper resources. ",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
