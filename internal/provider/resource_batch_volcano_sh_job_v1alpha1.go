...
type BatchVolcanoShJobV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*BatchVolcanoShJobV1Alpha1Resource)(nil)
)

type BatchVolcanoShJobV1Alpha1TerraformModel struct {
...
type BatchVolcanoShJobV1Alpha1GoModel struct {
	...
	Spec *struct {
		MaxRetry *int64 `tfsdk:"max_retry" yaml:"maxRetry,omitempty"`

		MinAvailable *int64 `tfsdk:"min_available" yaml:"minAvailable,omitempty"`

		MinSuccess *int64 `tfsdk:"min_success" yaml:"minSuccess,omitempty"`

		Plugins *map[string][]string `tfsdk:"plugins" yaml:"plugins,omitempty"`

		Policies *[]struct {
			Action *string `tfsdk:"action" yaml:"action,omitempty"`

			Event *string `tfsdk:"event" yaml:"event,omitempty"`

			Events *[]string `tfsdk:"events" yaml:"events,omitempty"`

			ExitCode *int64 `tfsdk:"exit_code" yaml:"exitCode,omitempty"`
		...
		RunningEstimate *string `tfsdk:"running_estimate" yaml:"runningEstimate,omitempty"`

		SchedulerName *string `tfsdk:"scheduler_name" yaml:"schedulerName,omitempty"`

		Tasks *[]struct {
			DependsOn *struct {
				Iteration *string `tfsdk:"iteration" yaml:"iteration,omitempty"`
			...
			TopologyPolicy *string `tfsdk:"topology_policy" yaml:"topologyPolicy,omitempty"`
		...
		Volumes *[]struct {
			...
			VolumeClaim *struct {
				...
				VolumeName *string `tfsdk:"volume_name" yaml:"volumeName,omitempty"`
			} `tfsdk:"volume_claim" yaml:"volumeClaim,omitempty"`
...
func NewBatchVolcanoShJobV1Alpha1Resource() resource.Resource {
	return &BatchVolcanoShJobV1Alpha1Resource{}
}

func (r *BatchVolcanoShJobV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_batch_volcano_sh_job_v1alpha1"
}

func (r *BatchVolcanoShJobV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "Job defines the volcano job.",
		MarkdownDescription: "Job defines the volcano job.",
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				...
				MarkdownDescription: "Specification of the desired behavior of the volcano job, including the minAvailable",
...
func (r *BatchVolcanoShJobV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_batch_volcano_sh_job_v1alpha1")

	var state BatchVolcanoShJobV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel BatchVolcanoShJobV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("batch.volcano.sh/v1alpha1")
...
func (r *BatchVolcanoShJobV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_batch_volcano_sh_job_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *BatchVolcanoShJobV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_batch_volcano_sh_job_v1alpha1")
...
func (r *BatchVolcanoShJobV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_batch_volcano_sh_job_v1alpha1")
