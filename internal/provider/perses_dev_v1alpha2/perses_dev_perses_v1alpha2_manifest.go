...
var (
	_ datasource.DataSource = &PersesDevPersesV1Alpha2Manifest{}
)

func NewPersesDevPersesV1Alpha2Manifest() datasource.DataSource {
	return &PersesDevPersesV1Alpha2Manifest{}
}

type PersesDevPersesV1Alpha2Manifest struct{}

type PersesDevPersesV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		Config *struct {
			...
			Dashboard  *struct {
				Custom_lint_rules *[]struct {
					Assertion *string `tfsdk:"assertion" json:"assertion,omitempty"`
					Disable   *bool   `tfsdk:"disable" json:"disable,omitempty"`
					Message   *string `tfsdk:"message" json:"message,omitempty"`
					Name      *string `tfsdk:"name" json:"name,omitempty"`
					Target    *string `tfsdk:"target" json:"target,omitempty"`
				} `tfsdk:"custom_lint_rules" json:"custom_lint_rules,omitempty"`
			...
			Datasource *struct {
				Disable_local *bool `tfsdk:"disable_local" json:"disable_local,omitempty"`
				Global        *struct {
					Disable   *bool `tfsdk:"disable" json:"disable,omitempty"`
					Discovery *[]struct {
						Http_sd *struct {
			...
			Frontend                              *struct {
				...
				Time_range  *struct {
					...
					Disable_zoom   *bool     `tfsdk:"disable_zoom" json:"disable_zoom,omitempty"`
			...
			Plugin *struct {
				Archive_path *string `tfsdk:"archive_path" json:"archive_path,omitempty"`
				Enable_dev   *bool   `tfsdk:"enable_dev" json:"enable_dev,omitempty"`
			...
			Security *struct {
				Authentication *struct {
					...
					Providers        *struct {
						...
						Oauth         *[]struct {
							...
							Device_auth_url       *string `tfsdk:"device_auth_url" json:"device_auth_url,omitempty"`
							Device_code           *struct {
								Client_id     *string   `tfsdk:"client_id" json:"client_id,omitempty"`
								Client_secret *string   `tfsdk:"client_secret" json:"client_secret,omitempty"`
								Scopes        *[]string `tfsdk:"scopes" json:"scopes,omitempty"`
							...
							Name           *string   `tfsdk:"name" json:"name,omitempty"`
							Redirect_uri   *string   `tfsdk:"redirect_uri" json:"redirect_uri,omitempty"`
							Scopes         *[]string `tfsdk:"scopes" json:"scopes,omitempty"`
							Slug_id        *string   `tfsdk:"slug_id" json:"slug_id,omitempty"`
							Token_url      *string   `tfsdk:"token_url" json:"token_url,omitempty"`
							User_infos_url *string   `tfsdk:"user_infos_url" json:"user_infos_url,omitempty"`
						} `tfsdk:"oauth" json:"oauth,omitempty"`
						Oidc *[]struct {
							Client_credentials *struct {
								Client_id     *string   `tfsdk:"client_id" json:"client_id,omitempty"`
							...
							Discovery_url *string `tfsdk:"discovery_url" json:"discovery_url,omitempty"`
							Http          *struct {
								Timeout    *string `tfsdk:"timeout" json:"timeout,omitempty"`
								Tls_config *struct {
									Ca                 *string `tfsdk:"ca" json:"ca,omitempty"`
				...
				Cors *struct {
					Allow_credentials *bool     `tfsdk:"allow_credentials" json:"allow_credentials,omitempty"`
					Allow_headers     *[]string `tfsdk:"allow_headers" json:"allow_headers,omitempty"`
					Allow_methods     *[]string `tfsdk:"allow_methods" json:"allow_methods,omitempty"`
					Allow_origins     *[]string `tfsdk:"allow_origins" json:"allow_origins,omitempty"`
					Enable            *bool     `tfsdk:"enable" json:"enable,omitempty"`
					Expose_headers    *[]string `tfsdk:"expose_headers" json:"expose_headers,omitempty"`
					Max_age           *int64    `tfsdk:"max_age" json:"max_age,omitempty"`
...
func (r *PersesDevPersesV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_perses_dev_perses_v1alpha2_manifest"
}

func (r *PersesDevPersesV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"dashboard": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Dashboard contains the configuration for the dashboard feature.",
								Attributes: map[string]schema.Attribute{
									"custom_lint_rules": schema.ListNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"assertion": schema.StringAttribute{
													Description:         "Assertion is a CEL expression that validates the extracted value. Refer to https://github.com/google/cel-spec/blob/master/doc/langdef.md for the syntax.",
													MarkdownDescription: "Assertion is a CEL expression that validates the extracted value. Refer to https://github.com/google/cel-spec/blob/master/doc/langdef.md for the syntax.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"disable": schema.BoolAttribute{
													...
													MarkdownDescription: "Disable is a flag to disable the rule.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"message": schema.StringAttribute{
													...
													MarkdownDescription: "Message is displayed if the assertion fails.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"target": schema.StringAttribute{
													Description:         "Target is a JSONPath expression to extract the relevant portion of the dashboard data. Refer to https://goessner.net/articles/JsonPath/ for the syntax.",
													MarkdownDescription: "Target is a JSONPath expression to extract the relevant portion of the dashboard data. Refer to https://goessner.net/articles/JsonPath/ for the syntax.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
							...
							"datasource": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Datasource contains the configuration for the datasource.",
								Attributes: map[string]schema.Attribute{
									"disable_local": schema.BoolAttribute{
										Description:         "DisableLocal when used is preventing the possibility to add a datasource directly in the dashboard spec. It will also disable the associated proxy.",
										MarkdownDescription: "DisableLocal when used is preventing the possibility to add a datasource directly in the dashboard spec. It will also disable the associated proxy.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"global": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"disable": schema.BoolAttribute{
												Description:         "Disable is used to disable the global datasource feature. It will also remove the associated proxy. Also, since the global variable depends on the global datasource, it will also disable the global variable feature.",
												MarkdownDescription: "Disable is used to disable the global datasource feature. It will also remove the associated proxy. Also, since the global variable depends on the global datasource, it will also disable the global variable feature.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},

											"discovery": schema.ListNestedAttribute{
												Description:         "Discovery is the configuration that helps to generate a list of global datasource based on the discovery chosen. Be careful: the data coming from the discovery will totally override what exists in the database. Note that this is an experimental feature. Behavior and config may change in the future.",
												MarkdownDescription: "Discovery is the configuration that helps to generate a list of global datasource based on the discovery chosen. Be careful: the data coming from the discovery will totally override what exists in the database. Note that this is an experimental feature. Behavior and config may change in the future.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
									...
									"project": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"disable": schema.BoolAttribute{
												Description:         "Disable is used to disable the project datasource feature. It will also remove the associated proxy.",
												MarkdownDescription: "Disable is used to disable the project datasource feature. It will also remove the associated proxy.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
								...
								Attributes: map[string]schema.Attribute{
									...
									"time_range": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"disable_zoom": schema.BoolAttribute{
												Description:         "",
												MarkdownDescription: "",
												Required:            true,
												Optional:            false,
							...
							"plugin": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Plugin contains the config for runtime plugins.",
								Attributes: map[string]schema.Attribute{
									"archive_path": schema.StringAttribute{
										Description:         "ArchivePath is the path to the directory containing the archived plugins When Perses is starting, it will extract the content of the archive in the folder specified in the 'folder' attribute.",
										MarkdownDescription: "ArchivePath is the path to the directory containing the archived plugins When Perses is starting, it will extract the content of the archive in the folder specified in the 'folder' attribute.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},

									"enable_dev": schema.BoolAttribute{
										Description:         "DevEnvironment is the configuration to use when developing a plugin",
										MarkdownDescription: "DevEnvironment is the configuration to use when developing a plugin",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"path": schema.StringAttribute{
										...
										MarkdownDescription: "Path is the path to the directory containing the runtime plugins",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"schemas": schema.SingleNestedAttribute{
								Description:         "Schemas contain the configuration to get access to the CUE schemas DEPRECATED. Please remove it from your config.",
								MarkdownDescription: "Schemas contain the configuration to get access to the CUE schemas DEPRECATED. Please remove it from your config.",
								Attributes: map[string]schema.Attribute{
							...
							"security": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
													...
													"oauth": schema.ListNestedAttribute{
														...
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																...
																"device_auth_url": schema.StringAttribute{
																	Description:         "",
																	MarkdownDescription: "",
																	Required:            true,
																	Optional:            false,
																...
																"user_infos_url": schema.StringAttribute{
																	Description:         "",
																	MarkdownDescription: "",
																	Required:            true,
																	Optional:            false,
									...
									"cors": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Configuration for the CORS middleware.",
										Attributes: map[string]schema.Attribute{
							...
							"variable": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Variable contains the configuration for the variable.",
								Attributes: map[string]schema.Attribute{
									"disable_local": schema.BoolAttribute{
										Description:         "DisableLocal when used is preventing the possibility to add a variable directly in the dashboard spec.",
										MarkdownDescription: "DisableLocal when used is preventing the possibility to add a variable directly in the dashboard spec.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"global": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"disable": schema.BoolAttribute{
												Description:         "Disable is used to disable the global variable feature. Note that if the global datasource is disabled, the global variable will also be disabled.",
												MarkdownDescription: "Disable is used to disable the global variable feature. Note that if the global datasource is disabled, the global variable will also be disabled.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
									...
									"project": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"disable": schema.BoolAttribute{
												Description:         "Disable is used to disable the project variable feature. Note that if the global datasource and the project datasource are disabled, then the project variable will also be disabled.",
												MarkdownDescription: "Disable is used to disable the project variable feature. Note that if the global datasource and the project datasource are disabled, then the project variable will also be disabled.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
					...
					"service_account_name": schema.StringAttribute{
						...
						MarkdownDescription: "ServiceAccountName is the name of the service account to use for the perses deployment or statefulset.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *PersesDevPersesV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_perses_dev_perses_v1alpha2_manifest")

	var model PersesDevPersesV1Alpha2ManifestData
