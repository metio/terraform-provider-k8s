...
var (
	_ datasource.DataSource = &PersesDevPersesDashboardV1Alpha2Manifest{}
)

func NewPersesDevPersesDashboardV1Alpha2Manifest() datasource.DataSource {
	return &PersesDevPersesDashboardV1Alpha2Manifest{}
}

type PersesDevPersesDashboardV1Alpha2Manifest struct{}

type PersesDevPersesDashboardV1Alpha2ManifestData struct {
...
func (r *PersesDevPersesDashboardV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_perses_dev_perses_dashboard_v1alpha2_manifest"
}

func (r *PersesDevPersesDashboardV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PersesDevPersesDashboardV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_perses_dev_perses_dashboard_v1alpha2_manifest")

	var model PersesDevPersesDashboardV1Alpha2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("perses.dev/v1alpha2")
