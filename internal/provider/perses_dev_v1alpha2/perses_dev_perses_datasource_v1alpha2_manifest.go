...
var (
	_ datasource.DataSource = &PersesDevPersesDatasourceV1Alpha2Manifest{}
)

func NewPersesDevPersesDatasourceV1Alpha2Manifest() datasource.DataSource {
	return &PersesDevPersesDatasourceV1Alpha2Manifest{}
}

type PersesDevPersesDatasourceV1Alpha2Manifest struct{}

type PersesDevPersesDatasourceV1Alpha2ManifestData struct {
...
func (r *PersesDevPersesDatasourceV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_perses_dev_perses_datasource_v1alpha2_manifest"
}

func (r *PersesDevPersesDatasourceV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PersesDevPersesDatasourceV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_perses_dev_perses_datasource_v1alpha2_manifest")

	var model PersesDevPersesDatasourceV1Alpha2ManifestData
