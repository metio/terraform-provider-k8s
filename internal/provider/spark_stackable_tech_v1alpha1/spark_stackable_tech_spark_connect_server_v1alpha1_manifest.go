...
type SparkStackableTechSparkConnectServerV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		ClusterConfig    *map[string]string `tfsdk:"cluster_config" json:"clusterConfig,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"cluster_config": schema.MapAttribute{
						Description:         "Global Spark Connect server configuration that applies to all roles. This was previously used to hold the listener configuration, which has since moved to the server configuration.",
						MarkdownDescription: "Global Spark Connect server configuration that applies to all roles. This was previously used to hold the listener configuration, which has since moved to the server configuration.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
							...
							"config": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"listener_class": schema.StringAttribute{
										...
										MarkdownDescription: "This field controls which [ListenerClass](https://docs.stackable.tech/home/nightly/listener-operator/listenerclass.html) is used to expose the Spark services.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
