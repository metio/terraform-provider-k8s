...
var (
	_ datasource.DataSource = &ClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1Manifest{}
)

func NewClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1Manifest() datasource.DataSource {
	return &ClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1Manifest{}
}
...
func (r *ClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_clustertemplate_openshift_io_cluster_template_instance_v1alpha1_manifest"
}
...
func (r *ClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Represents instance of a cluster",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "",
				Attributes: map[string]schema.Attribute{
					"cluster_template_ref": schema.StringAttribute{
						Description:         "A reference to ClusterTemplate which will be used for installing and setting up the cluster",
						MarkdownDescription: "A reference to ClusterTemplate which will be used for installing and setting up the cluster",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},

					"kubeconfig_secret_ref": schema.StringAttribute{
						...
						MarkdownDescription: "A reference to a secret which contains kubeconfig of the cluster. If specified day1 operation won't be executed.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"parameters": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Helm parameters to be passed to cluster installation or setup",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"cluster_setup": schema.StringAttribute{
									Description:         "Name of the application set to which parameter is applied",
									MarkdownDescription: "Name of the application set to which parameter is applied",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"name": schema.StringAttribute{
									...
									MarkdownDescription: "Name of the Helm parameter",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"value": schema.StringAttribute{
									...
									MarkdownDescription: "Value of the Helm parameter",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
...
func (r *ClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_clustertemplate_openshift_io_cluster_template_instance_v1alpha1_manifest")

	var model ClustertemplateOpenshiftIoClusterTemplateInstanceV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ClusterTemplateInstance")
