...
var (
	_ datasource.DataSource = &ClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1Manifest{}
)

func NewClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1Manifest() datasource.DataSource {
	return &ClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1Manifest{}
}
...
func (r *ClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_clustertemplate_openshift_io_cluster_template_setup_v1alpha1_manifest"
}
...
func (r *ClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Template of a cluster - post-install setup are defined as ArgoCD application set refs.",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"skip_cluster_registration": schema.BoolAttribute{
						...
						MarkdownDescription: "Skip the registeration of the cluster to the hub cluster",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_clustertemplate_openshift_io_cluster_template_setup_v1alpha1_manifest")

	var model ClustertemplateOpenshiftIoClusterTemplateSetupV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ClusterTemplateSetup")
