...
var (
	_ datasource.DataSource              = &MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource{}
)

func NewMapsK8SElasticCoElasticMapsServerV1Alpha1DataSource() datasource.DataSource {
	return &MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource{}
}

type MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MapsK8SElasticCoElasticMapsServerV1Alpha1DataSourceData struct {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_maps_k8s_elastic_co_elastic_maps_server_v1alpha1"
}

func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_maps_k8s_elastic_co_elastic_maps_server_v1alpha1")

	var data MapsK8SElasticCoElasticMapsServerV1Alpha1DataSourceData
	...
	var readResponse MapsK8SElasticCoElasticMapsServerV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("maps.k8s.elastic.co/v1alpha1")
	data.Kind = pointer.String("ElasticMapsServer")
