...
func TestMapsK8SElasticCoElasticMapsServerV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_maps_k8s_elastic_co_elastic_maps_server_v1alpha1_manifest", testCase)
		})
	}
}
