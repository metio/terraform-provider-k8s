...
var (
	_ datasource.DataSource = &MapsK8SElasticCoElasticMapsServerV1Alpha1Manifest{}
)

func NewMapsK8SElasticCoElasticMapsServerV1Alpha1Manifest() datasource.DataSource {
	return &MapsK8SElasticCoElasticMapsServerV1Alpha1Manifest{}
}

type MapsK8SElasticCoElasticMapsServerV1Alpha1Manifest struct{}

type MapsK8SElasticCoElasticMapsServerV1Alpha1ManifestData struct {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_maps_k8s_elastic_co_elastic_maps_server_v1alpha1_manifest"
}

func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_maps_k8s_elastic_co_elastic_maps_server_v1alpha1_manifest")

	var model MapsK8SElasticCoElasticMapsServerV1Alpha1ManifestData
