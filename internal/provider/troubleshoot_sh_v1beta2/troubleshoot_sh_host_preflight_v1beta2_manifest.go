...
var (
	_ datasource.DataSource = &TroubleshootShHostPreflightV1Beta2Manifest{}
)

func NewTroubleshootShHostPreflightV1Beta2Manifest() datasource.DataSource {
	return &TroubleshootShHostPreflightV1Beta2Manifest{}
}

type TroubleshootShHostPreflightV1Beta2Manifest struct{}

type TroubleshootShHostPreflightV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"remote_collectors" json:"remoteCollectors,omitempty"`
		Uri *string `tfsdk:"uri" json:"uri,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *TroubleshootShHostPreflightV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_troubleshoot_sh_host_preflight_v1beta2_manifest"
}

func (r *TroubleshootShHostPreflightV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "HostPreflight is the Schema for the hostpreflights API",
		MarkdownDescription: "HostPreflight is the Schema for the hostpreflights API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "HostPreflightSpec defines the desired state of HostPreflight",
				Attributes: map[string]schema.Attribute{
					...
					"remote_collectors": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *TroubleshootShHostPreflightV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_troubleshoot_sh_host_preflight_v1beta2_manifest")

	var model TroubleshootShHostPreflightV1Beta2ManifestData
	...
	model.Kind = pointer.String("HostPreflight")
