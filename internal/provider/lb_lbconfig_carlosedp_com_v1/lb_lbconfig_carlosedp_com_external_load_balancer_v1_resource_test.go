...
func TestLbLbconfigCarlosedpComExternalLoadBalancerV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_lb_lbconfig_carlosedp_com_external_load_balancer_v1", testCase)
		})
	}
}
