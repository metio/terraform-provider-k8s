...
package gateway_nginx_org_v1alpha2
...
var (
	_ datasource.DataSource = &GatewayNginxOrgNginxProxyV1Alpha2Manifest{}
)

func NewGatewayNginxOrgNginxProxyV1Alpha2Manifest() datasource.DataSource {
	return &GatewayNginxOrgNginxProxyV1Alpha2Manifest{}
}

type GatewayNginxOrgNginxProxyV1Alpha2Manifest struct{}

type GatewayNginxOrgNginxProxyV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		DisableSNIHostValidation *bool `tfsdk:"disable_sni_host_validation" json:"disableSNIHostValidation,omitempty"`
		DnsResolver              *struct {
			Addresses *[]struct {
				Type  *string `tfsdk:"type" json:"type,omitempty"`
				Value *string `tfsdk:"value" json:"value,omitempty"`
			} `tfsdk:"addresses" json:"addresses,omitempty"`
			CacheTTL    *string `tfsdk:"cache_ttl" json:"cacheTTL,omitempty"`
			DisableIPv6 *bool   `tfsdk:"disable_i_pv6" json:"disableIPv6,omitempty"`
			Timeout     *string `tfsdk:"timeout" json:"timeout,omitempty"`
		} `tfsdk:"dns_resolver" json:"dnsResolver,omitempty"`
		...
		Kubernetes *struct {
			DaemonSet *struct {
				Container *struct {
					...
					} `tfsdk:"host_ports" json:"hostPorts,omitempty"`
					Image *struct {
				...
				Autoscaling *struct {
					Behavior *struct {
						ScaleDown *struct {
							...
							Tolerance                  *string `tfsdk:"tolerance" json:"tolerance,omitempty"`
					...
					TargetMemoryUtilizationPercentage *int64 `tfsdk:"target_memory_utilization_percentage" json:"targetMemoryUtilizationPercentage,omitempty"`
			...
			Service *struct {
				...
				NodePorts                *[]struct {
					ListenerPort *int64 `tfsdk:"listener_port" json:"listenerPort,omitempty"`
					Port         *int64 `tfsdk:"port" json:"port,omitempty"`
				} `tfsdk:"node_ports" json:"nodePorts,omitempty"`
				Patches *[]struct {
					Type  *string            `tfsdk:"type" json:"type,omitempty"`
					Value *map[string]string `tfsdk:"value" json:"value,omitempty"`
				} `tfsdk:"patches" json:"patches,omitempty"`
		...
		Logging *struct {
			AgentLevel *string `tfsdk:"agent_level" json:"agentLevel,omitempty"`
		...
		WorkerConnections *int64 `tfsdk:"worker_connections" json:"workerConnections,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *GatewayNginxOrgNginxProxyV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_nginx_org_nginx_proxy_v1alpha2_manifest"
}

func (r *GatewayNginxOrgNginxProxyV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "NginxProxy is a configuration object that can be referenced from a GatewayClass parametersRef or a Gateway infrastructure.parametersRef. It provides a way to configure data plane settings. If referenced from a GatewayClass, the settings apply to all Gateways attached to the GatewayClass. If referenced from a Gateway, the settings apply to that Gateway alone. If both a Gateway and its GatewayClass reference an NginxProxy, the settings are merged. Settings specified on the Gateway NginxProxy override those set on the GatewayClass NginxProxy.",
		MarkdownDescription: "NginxProxy is a configuration object that can be referenced from a GatewayClass parametersRef or a Gateway infrastructure.parametersRef. It provides a way to configure data plane settings. If referenced from a GatewayClass, the settings apply to all Gateways attached to the GatewayClass. If referenced from a Gateway, the settings apply to that Gateway alone. If both a Gateway and its GatewayClass reference an NginxProxy, the settings are merged. Settings specified on the Gateway NginxProxy override those set on the GatewayClass NginxProxy.",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"disable_http2": schema.BoolAttribute{
						Description:         "DisableHTTP2 defines if http2 should be disabled for all servers. If not specified, or set to false, http2 will be enabled for all servers.",
						MarkdownDescription: "DisableHTTP2 defines if http2 should be disabled for all servers. If not specified, or set to false, http2 will be enabled for all servers.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"disable_sni_host_validation": schema.BoolAttribute{
						Description:         "DisableSNIHostValidation disables the validation that ensures the SNI hostname matches the Host header in HTTPS requests. When disabled, HTTPS connections can be reused for requests to different hostnames covered by the same certificate. This resolves HTTP/2 connection coalescing issues with wildcard certificates but introduces security risks as described in Gateway API GEP-3567. If not specified, defaults to false (validation enabled).",
						MarkdownDescription: "DisableSNIHostValidation disables the validation that ensures the SNI hostname matches the Host header in HTTPS requests. When disabled, HTTPS connections can be reused for requests to different hostnames covered by the same certificate. This resolves HTTP/2 connection coalescing issues with wildcard certificates but introduces security risks as described in Gateway API GEP-3567. If not specified, defaults to false (validation enabled).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"dns_resolver": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "DNSResolver specifies the DNS resolver configuration for external name resolution. This enables support for routing to ExternalName Services.",
						Attributes: map[string]schema.Attribute{
							"addresses": schema.ListNestedAttribute{
								Description:         "Addresses specifies the list of DNS server addresses. Each address can be an IP address or hostname. Example: [{'type': 'IPAddress', 'value': '8.8.8.8'}, {'type': 'Hostname', 'value': 'dns.google'}]",
								MarkdownDescription: "Addresses specifies the list of DNS server addresses. Each address can be an IP address or hostname. Example: [{'type': 'IPAddress', 'value': '8.8.8.8'}, {'type': 'Hostname', 'value': 'dns.google'}]",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"type": schema.StringAttribute{
											...
											Computed:            false,
											Validators: []validator.String{
												stringvalidator.OneOf("IPAddress", "Hostname"),
											},
										},

										"value": schema.StringAttribute{
											Description:         "Value specifies the address value. When Type is 'IPAddress', this must be a valid IPv4 or IPv6 address. When Type is 'Hostname', this must be a valid hostname.",
											MarkdownDescription: "Value specifies the address value. When Type is 'IPAddress', this must be a valid IPv4 or IPv6 address. When Type is 'Hostname', this must be a valid hostname.",
											Required:            true,
											Optional:            false,
											Computed:            false,
											Validators: []validator.String{
							...
							"cache_ttl": schema.StringAttribute{
								...
								MarkdownDescription: "CacheTTL specifies how long to cache DNS responses.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
							...
							"disable_i_pv6": schema.BoolAttribute{
								Description:         "DisableIPv6 disables IPv6 lookups. If not specified, or set to false, IPv6 lookups will be enabled.",
								MarkdownDescription: "DisableIPv6 disables IPv6 lookups. If not specified, or set to false, IPv6 lookups will be enabled.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"timeout": schema.StringAttribute{
								...
								MarkdownDescription: "Timeout specifies the timeout for name resolution.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
					...
					"kubernetes": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Kubernetes contains the configuration for the NGINX Deployment and Service Kubernetes objects.",
						Attributes: map[string]schema.Attribute{
							"daemon_set": schema.SingleNestedAttribute{
								Description:         "DaemonSet is the configuration for the NGINX DaemonSet.",
								MarkdownDescription: "DaemonSet is the configuration for the NGINX DaemonSet.",
								Attributes: map[string]schema.Attribute{
									"container": schema.SingleNestedAttribute{
										Description:         "Container defines container fields for the NGINX container.",
										MarkdownDescription: "Container defines container fields for the NGINX container.",
										Attributes: map[string]schema.Attribute{
											"debug": schema.BoolAttribute{
												Description:         "Debug enables debugging for NGINX by using the nginx-debug binary.",
												MarkdownDescription: "Debug enables debugging for NGINX by using the nginx-debug binary.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},

											"host_ports": schema.ListNestedAttribute{
												Description:         "HostPorts are the list of ports to expose on the host.",
												MarkdownDescription: "HostPorts are the list of ports to expose on the host.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"container_port": schema.Int64Attribute{
															Description:         "ContainerPort is the port on the nginx container to map to the HostPort.",
															MarkdownDescription: "ContainerPort is the port on the nginx container to map to the HostPort.",
															Required:            true,
															Optional:            false,
															Computed:            false,
														...
														"port": schema.Int64Attribute{
															...
															MarkdownDescription: "Port to expose on the host.",
															Required:            true,
															Optional:            false,
															Computed:            false,
															Validators: []validator.Int64{
											...
											"image": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "Image is the NGINX image to use.",
												Attributes: map[string]schema.Attribute{
													...
													"repository": schema.StringAttribute{
														Description:         "Repository is the image path. Default is ghcr.io/nginx/nginx-gateway-fabric/nginx.",
														MarkdownDescription: "Repository is the image path. Default is ghcr.io/nginx/nginx-gateway-fabric/nginx.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
													...
													"tag": schema.StringAttribute{
														...
														MarkdownDescription: "Tag is the image tag to use. Default matches the tag of the control plane.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
											...
											"readiness_probe": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "ReadinessProbe defines the readiness probe for the NGINX container.",
												Attributes: map[string]schema.Attribute{
													"initial_delay_seconds": schema.Int64Attribute{
														Description:         "InitialDelaySeconds is the number of seconds after the container has started before the readiness probe is initiated. If not specified, the default is 3 seconds.",
														MarkdownDescription: "InitialDelaySeconds is the number of seconds after the container has started before the readiness probe is initiated. If not specified, the default is 3 seconds.",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.Int64{
													...
													"port": schema.Int64Attribute{
														Description:         "Port is the port on which the readiness endpoint is exposed. If not specified, the default port is 8081.",
														MarkdownDescription: "Port is the port on which the readiness endpoint is exposed. If not specified, the default port is 8081.",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.Int64{
											...
											"volume_mounts": schema.ListNestedAttribute{
												...
												MarkdownDescription: "VolumeMounts describe the mounting of Volumes within a container.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
									...
									"patches": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Patches are custom patches to apply to the NGINX DaemonSet.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"type": schema.StringAttribute{
													Description:         "Type is the type of patch. Defaults to StrategicMerge.",
													MarkdownDescription: "Type is the type of patch. Defaults to StrategicMerge.",
													Required:            false,
													Optional:            true,
													Computed:            false,
													Validators: []validator.String{
														stringvalidator.OneOf("StrategicMerge", "Merge", "JSONPatch"),
													},
												},

												"value": schema.MapAttribute{
													Description:         "Value is the patch data as raw JSON. For StrategicMerge and Merge patches, this should be a JSON object. For JSONPatch patches, this should be a JSON array of patch operations.",
													MarkdownDescription: "Value is the patch data as raw JSON. For StrategicMerge and Merge patches, this should be a JSON object. For JSONPatch patches, this should be a JSON array of patch operations.",
													ElementType:         types.StringType,
													Required:            false,
													Optional:            true,
													Computed:            false,
									...
									"pod": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Pod defines Pod-specific fields.",
										Attributes: map[string]schema.Attribute{
											"affinity": schema.SingleNestedAttribute{
												Description:         "Affinity is the pod's scheduling constraints.",
												MarkdownDescription: "Affinity is the pod's scheduling constraints.",
												Attributes: map[string]schema.Attribute{
											...
											"termination_grace_period_seconds": schema.Int64Attribute{
												...
												MarkdownDescription: "TerminationGracePeriodSeconds is the optional duration in seconds the pod needs to terminate gracefully. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). If this value is nil, the default grace period will be used instead. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. Defaults to 30 seconds.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"tolerations": schema.ListNestedAttribute{
												...
												MarkdownDescription: "Tolerations allow the scheduler to schedule Pods with matching taints.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
											...
											"volumes": schema.ListNestedAttribute{
												...
												MarkdownDescription: "Volumes represents named volumes in a pod that may be accessed by any container in the pod.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														...
														"glusterfs": schema.SingleNestedAttribute{
															...
															MarkdownDescription: "glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. Deprecated: Glusterfs is deprecated and the in-tree glusterfs type is no longer supported.",
															Attributes: map[string]schema.Attribute{
														...
														"iscsi": schema.SingleNestedAttribute{
															...
															MarkdownDescription: "iscsi represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes/#iscsi",
															Attributes: map[string]schema.Attribute{
														...
														"rbd": schema.SingleNestedAttribute{
															...
															MarkdownDescription: "rbd represents a Rados Block Device mount on the host that shares a pod's lifetime. Deprecated: RBD is deprecated and the in-tree rbd type is no longer supported.",
															Attributes: map[string]schema.Attribute{
																"fs_type": schema.StringAttribute{
							...
							"deployment": schema.SingleNestedAttribute{
								Description:         "Deployment is the configuration for the NGINX Deployment. This is the default deployment option.",
								MarkdownDescription: "Deployment is the configuration for the NGINX Deployment. This is the default deployment option.",
								Attributes: map[string]schema.Attribute{
									"autoscaling": schema.SingleNestedAttribute{
										Description:         "Autoscaling defines the configuration for Horizontal Pod Autoscaling.",
										MarkdownDescription: "Autoscaling defines the configuration for Horizontal Pod Autoscaling.",
										Attributes: map[string]schema.Attribute{
													...
													"scale_down": schema.SingleNestedAttribute{
														...
														Attributes: map[string]schema.Attribute{
															"policies": schema.ListNestedAttribute{
																...
																MarkdownDescription: "policies is a list of potential scaling polices which can be used during scaling. If not set, use the default values: - For scale up: allow doubling the number of pods, or an absolute change of 4 pods in a 15s window. - For scale down: allow all pods to be removed in a 15s window.",
																NestedObject: schema.NestedAttributeObject{
																	Attributes: map[string]schema.Attribute{
															...
															"tolerance": schema.StringAttribute{
																Description:         "tolerance is the tolerance on the ratio between the current and desired metric value under which no updates are made to the desired number of replicas (e.g. 0.01 for 1%). Must be greater than or equal to zero. If not set, the default cluster-wide tolerance is applied (by default 10%). For example, if autoscaling is configured with a memory consumption target of 100Mi, and scale-down and scale-up tolerances of 5% and 1% respectively, scaling will be triggered when the actual consumption falls below 95Mi or exceeds 101Mi. This is an alpha field and requires enabling the HPAConfigurableTolerance feature gate.",
																MarkdownDescription: "tolerance is the tolerance on the ratio between the current and desired metric value under which no updates are made to the desired number of replicas (e.g. 0.01 for 1%). Must be greater than or equal to zero. If not set, the default cluster-wide tolerance is applied (by default 10%). For example, if autoscaling is configured with a memory consumption target of 100Mi, and scale-down and scale-up tolerances of 5% and 1% respectively, scaling will be triggered when the actual consumption falls below 95Mi or exceeds 101Mi. This is an alpha field and requires enabling the HPAConfigurableTolerance feature gate.",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
											...
											"enable": schema.BoolAttribute{
												...
												MarkdownDescription: "Enable or disable Horizontal Pod Autoscaler.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
											...
											"metrics": schema.ListNestedAttribute{
												...
												MarkdownDescription: "Metrics configures additional metrics options.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														...
														"type": schema.StringAttribute{
															...
															MarkdownDescription: "type is the type of metric source. It should be one of 'ContainerResource', 'External', 'Object', 'Pods' or 'Resource', each mapping to a matching field in the object.",
															Required:            true,
															Optional:            false,
															Computed:            false,
														},
											...
											"target_cpu_utilization_percentage": schema.Int64Attribute{
												...
												MarkdownDescription: "Target cpu utilization percentage of HPA.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.Int64{
											...
											"target_memory_utilization_percentage": schema.Int64Attribute{
												...
												MarkdownDescription: "Target memory utilization percentage of HPA.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.Int64{
									...
									"patches": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Patches are custom patches to apply to the NGINX Deployment.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"type": schema.StringAttribute{
													Description:         "Type is the type of patch. Defaults to StrategicMerge.",
									...
									"replicas": schema.Int64Attribute{
										...
										MarkdownDescription: "Number of desired Pods.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"service": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Service is the configuration for the NGINX Service.",
								Attributes: map[string]schema.Attribute{
									"external_traffic_policy": schema.StringAttribute{
										...
										MarkdownDescription: "ExternalTrafficPolicy describes how nodes distribute service traffic they receive on one of the Service's 'externally-facing' addresses (NodePorts, ExternalIPs, and LoadBalancer IPs.",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.String{
									...
									"load_balancer_class": schema.StringAttribute{
										Description:         "LoadBalancerClass is the class of the load balancer implementation this Service belongs to. Requires service type to be LoadBalancer.",
										MarkdownDescription: "LoadBalancerClass is the class of the load balancer implementation this Service belongs to. Requires service type to be LoadBalancer.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"load_balancer_ip": schema.StringAttribute{
										...
										MarkdownDescription: "LoadBalancerIP is a static IP address for the load balancer. Requires service type to be LoadBalancer.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"load_balancer_source_ranges": schema.ListAttribute{
										Description:         "LoadBalancerSourceRanges are the IP ranges (CIDR) that are allowed to access the load balancer. Requires service type to be LoadBalancer.",
										MarkdownDescription: "LoadBalancerSourceRanges are the IP ranges (CIDR) that are allowed to access the load balancer. Requires service type to be LoadBalancer.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"node_ports": schema.ListNestedAttribute{
										Description:         "NodePorts are the list of NodePorts to expose on the NGINX data plane service. Each NodePort MUST map to a Gateway listener port, otherwise it will be ignored. The default NodePort range enforced by Kubernetes is 30000-32767.",
										MarkdownDescription: "NodePorts are the list of NodePorts to expose on the NGINX data plane service. Each NodePort MUST map to a Gateway listener port, otherwise it will be ignored. The default NodePort range enforced by Kubernetes is 30000-32767.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"listener_port": schema.Int64Attribute{
													Description:         "ListenerPort is the Gateway listener port that this NodePort maps to.",
													MarkdownDescription: "ListenerPort is the Gateway listener port that this NodePort maps to.",
													Required:            true,
													Optional:            false,
													Computed:            false,
													Validators: []validator.Int64{
												...
												"port": schema.Int64Attribute{
													...
													MarkdownDescription: "Port is the NodePort to expose.",
													Required:            true,
													Optional:            false,
													Computed:            false,
													Validators: []validator.Int64{
									...
									"patches": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Patches are custom patches to apply to the NGINX Service.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"type": schema.StringAttribute{
													Description:         "Type is the type of patch. Defaults to StrategicMerge.",
									...
									"type": schema.StringAttribute{
										...
										MarkdownDescription: "ServiceType describes ingress method for the Service.",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("ClusterIP", "LoadBalancer", "NodePort"),
										},
									},
								},
								Required: false,
					...
					"logging": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"agent_level": schema.StringAttribute{
								Description:         "AgentLevel defines the log level of the NGINX agent process. Changing this value results in a re-roll of the NGINX deployment.",
								MarkdownDescription: "AgentLevel defines the log level of the NGINX agent process. Changing this value results in a re-roll of the NGINX deployment.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("debug", "info", "error", "panic", "fatal"),
								},
							},
					...
					"metrics": schema.SingleNestedAttribute{
						Description:         "Metrics defines the configuration for Prometheus scraping metrics. Changing this value results in a re-roll of the NGINX deployment.",
						MarkdownDescription: "Metrics defines the configuration for Prometheus scraping metrics. Changing this value results in a re-roll of the NGINX deployment.",
						Attributes: map[string]schema.Attribute{
							"disable": schema.BoolAttribute{
								Description:         "Disable serving Prometheus metrics on the listen port.",
								MarkdownDescription: "Disable serving Prometheus metrics on the listen port.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"port": schema.Int64Attribute{
								...
								MarkdownDescription: "Port where the Prometheus metrics are exposed.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
					...
					"telemetry": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"disabled_features": schema.ListAttribute{
								...
								MarkdownDescription: "DisabledFeatures specifies OpenTelemetry features to be disabled.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"worker_connections": schema.Int64Attribute{
						Description:         "WorkerConnections specifies the maximum number of simultaneous connections that can be opened by a worker process. Default is 1024.",
						MarkdownDescription: "WorkerConnections specifies the maximum number of simultaneous connections that can be opened by a worker process. Default is 1024.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.Int64{
...
func (r *GatewayNginxOrgNginxProxyV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_nginx_org_nginx_proxy_v1alpha2_manifest")

	var model GatewayNginxOrgNginxProxyV1Alpha2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("gateway.nginx.org/v1alpha2")
