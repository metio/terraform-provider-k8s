										...
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"listener_port": schema.Int64Attribute{
													Description:         "ListenerPort is the Gateway listener port that this NodePort maps to. kubebuilder:validation:Minimum=1 kubebuilder:validation:Maximum=65535",
													MarkdownDescription: "ListenerPort is the Gateway listener port that this NodePort maps to. kubebuilder:validation:Minimum=1 kubebuilder:validation:Maximum=65535",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"port": schema.Int64Attribute{
													Description:         "Port is the NodePort to expose. kubebuilder:validation:Minimum=1 kubebuilder:validation:Maximum=65535",
													MarkdownDescription: "Port is the NodePort to expose. kubebuilder:validation:Minimum=1 kubebuilder:validation:Maximum=65535",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
