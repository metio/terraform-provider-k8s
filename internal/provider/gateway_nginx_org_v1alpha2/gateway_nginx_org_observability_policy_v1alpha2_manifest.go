...
var (
	_ datasource.DataSource = &GatewayNginxOrgObservabilityPolicyV1Alpha2Manifest{}
)

func NewGatewayNginxOrgObservabilityPolicyV1Alpha2Manifest() datasource.DataSource {
	return &GatewayNginxOrgObservabilityPolicyV1Alpha2Manifest{}
}

type GatewayNginxOrgObservabilityPolicyV1Alpha2Manifest struct{}

type GatewayNginxOrgObservabilityPolicyV1Alpha2ManifestData struct {
...
func (r *GatewayNginxOrgObservabilityPolicyV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_nginx_org_observability_policy_v1alpha2_manifest"
}

func (r *GatewayNginxOrgObservabilityPolicyV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewayNginxOrgObservabilityPolicyV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_nginx_org_observability_policy_v1alpha2_manifest")

	var model GatewayNginxOrgObservabilityPolicyV1Alpha2ManifestData
