...
var (
	_ resource.Resource = (*AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource)(nil)
)

type AppRedislabsComRedisEnterpriseClusterV1Alpha1TerraformModel struct {
...
type AppRedislabsComRedisEnterpriseClusterV1Alpha1GoModel struct {
...
func (r *AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_app_redislabs_com_redis_enterprise_cluster_v1alpha1"
}

func (r *AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				...
				Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
					...
					"encrypt_pkeys": {
						Description:         "Private key encryption - in order to enable, first need to mount ${ephemeralconfdir}/secrets/pem/passphrase and add the passphrase and then set fields value to 'true' Possible values: true/false",
						MarkdownDescription: "Private key encryption - in order to enable, first need to mount ${ephemeralconfdir}/secrets/pem/passphrase and add the passphrase and then set fields value to 'true' Possible values: true/false",
...
func (r *AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_app_redislabs_com_redis_enterprise_cluster_v1alpha1")

	var state AppRedislabsComRedisEnterpriseClusterV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AppRedislabsComRedisEnterpriseClusterV1Alpha1GoModel
...
func (r *AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_app_redislabs_com_redis_enterprise_cluster_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AppRedislabsComRedisEnterpriseClusterV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
