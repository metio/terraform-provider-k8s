...
var (
	_ datasource.DataSource = &FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest{}
)

func NewFlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest() datasource.DataSource {
	return &FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest{}
}

type FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest struct{}

type FlowcontrolApiserverK8SIoFlowSchemaV1Beta2ManifestData struct {
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2_manifest"
}
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2_manifest")

	var model FlowcontrolApiserverK8SIoFlowSchemaV1Beta2ManifestData
