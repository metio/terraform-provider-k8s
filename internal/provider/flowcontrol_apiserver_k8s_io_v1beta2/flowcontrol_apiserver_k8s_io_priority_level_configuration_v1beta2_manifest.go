...
var (
	_ datasource.DataSource = &FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Manifest{}
)

func NewFlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Manifest() datasource.DataSource {
	return &FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Manifest{}
}
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta2_manifest"
}
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta2_manifest")

	var model FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2ManifestData
