...
func TestFlowcontrolApiserverK8SIoFlowSchemaV1Beta2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2_manifest", testCase)
		})
	}
}
