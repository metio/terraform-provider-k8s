...
var (
	_ datasource.DataSource              = &FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource{}
)

func NewFlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource() datasource.DataSource {
	return &FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource{}
}

type FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSourceData struct {
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2"
}

func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2")

	var data FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "flowcontrol.apiserver.k8s.io", Version: "v1beta2", Resource: "FlowSchema"}).
	...
	var readResponse FlowcontrolApiserverK8SIoFlowSchemaV1Beta2DataSourceData
	...
	data.ApiVersion = pointer.String("flowcontrol.apiserver.k8s.io/v1beta2")
