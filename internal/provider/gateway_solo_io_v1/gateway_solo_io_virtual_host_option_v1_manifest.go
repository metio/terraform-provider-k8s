...
var (
	_ datasource.DataSource = &GatewaySoloIoVirtualHostOptionV1Manifest{}
)

func NewGatewaySoloIoVirtualHostOptionV1Manifest() datasource.DataSource {
	return &GatewaySoloIoVirtualHostOptionV1Manifest{}
}

type GatewaySoloIoVirtualHostOptionV1Manifest struct{}

type GatewaySoloIoVirtualHostOptionV1ManifestData struct {
...
func (r *GatewaySoloIoVirtualHostOptionV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_solo_io_virtual_host_option_v1_manifest"
}

func (r *GatewaySoloIoVirtualHostOptionV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewaySoloIoVirtualHostOptionV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_solo_io_virtual_host_option_v1_manifest")

	var model GatewaySoloIoVirtualHostOptionV1ManifestData
