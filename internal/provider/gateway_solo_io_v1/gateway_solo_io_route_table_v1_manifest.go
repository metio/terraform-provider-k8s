...
var (
	_ datasource.DataSource = &GatewaySoloIoRouteTableV1Manifest{}
)

func NewGatewaySoloIoRouteTableV1Manifest() datasource.DataSource {
	return &GatewaySoloIoRouteTableV1Manifest{}
}

type GatewaySoloIoRouteTableV1Manifest struct{}

type GatewaySoloIoRouteTableV1ManifestData struct {
	...
	Spec *struct {
		...
		Routes *[]struct {
			...
			RedirectAction *struct {
				...
				PortRedirect  *int64  `tfsdk:"port_redirect" json:"portRedirect,omitempty"`
				PrefixRewrite *string `tfsdk:"prefix_rewrite" json:"prefixRewrite,omitempty"`
				RegexRewrite  *struct {
					Pattern *struct {
						GoogleRe2 *struct {
...
func (r *GatewaySoloIoRouteTableV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_solo_io_route_table_v1_manifest"
}

func (r *GatewaySoloIoRouteTableV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
							...
							Attributes: map[string]schema.Attribute{
								...
								"redirect_action": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"port_redirect": schema.Int64Attribute{
											Description:         "",
											MarkdownDescription: "",
											Required:            false,
											Optional:            true,
...
func (r *GatewaySoloIoRouteTableV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_solo_io_route_table_v1_manifest")

	var model GatewaySoloIoRouteTableV1ManifestData
