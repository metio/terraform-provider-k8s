...
var (
	_ datasource.DataSource = &GatewaySoloIoVirtualServiceV1Manifest{}
)

func NewGatewaySoloIoVirtualServiceV1Manifest() datasource.DataSource {
	return &GatewaySoloIoVirtualServiceV1Manifest{}
}

type GatewaySoloIoVirtualServiceV1Manifest struct{}

type GatewaySoloIoVirtualServiceV1ManifestData struct {
...
func (r *GatewaySoloIoVirtualServiceV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_solo_io_virtual_service_v1_manifest"
}

func (r *GatewaySoloIoVirtualServiceV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewaySoloIoVirtualServiceV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_solo_io_virtual_service_v1_manifest")

	var model GatewaySoloIoVirtualServiceV1ManifestData
