...
var (
	_ datasource.DataSource              = &GatewaySoloIoRouteTableV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GatewaySoloIoRouteTableV1DataSource{}
)

func NewGatewaySoloIoRouteTableV1DataSource() datasource.DataSource {
	return &GatewaySoloIoRouteTableV1DataSource{}
}

type GatewaySoloIoRouteTableV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GatewaySoloIoRouteTableV1DataSourceData struct {
...
func (r *GatewaySoloIoRouteTableV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_solo_io_route_table_v1"
}

func (r *GatewaySoloIoRouteTableV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewaySoloIoRouteTableV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GatewaySoloIoRouteTableV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_gateway_solo_io_route_table_v1")

	var data GatewaySoloIoRouteTableV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "gateway.solo.io", Version: "v1", Resource: "routetables"}).
	...
	var readResponse GatewaySoloIoRouteTableV1DataSourceData
