...
var (
	_ datasource.DataSource = &VirtVirtinkSmartxComVirtualMachineV1Alpha1Manifest{}
)

func NewVirtVirtinkSmartxComVirtualMachineV1Alpha1Manifest() datasource.DataSource {
	return &VirtVirtinkSmartxComVirtualMachineV1Alpha1Manifest{}
}

type VirtVirtinkSmartxComVirtualMachineV1Alpha1Manifest struct{}

type VirtVirtinkSmartxComVirtualMachineV1Alpha1ManifestData struct {
...
func (r *VirtVirtinkSmartxComVirtualMachineV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_virt_virtink_smartx_com_virtual_machine_v1alpha1_manifest"
}
...
func (r *VirtVirtinkSmartxComVirtualMachineV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_virt_virtink_smartx_com_virtual_machine_v1alpha1_manifest")

	var model VirtVirtinkSmartxComVirtualMachineV1Alpha1ManifestData
