...
var (
	_ datasource.DataSource = &VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1Manifest{}
)

func NewVirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1Manifest() datasource.DataSource {
	return &VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1Manifest{}
}

type VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1Manifest struct{}

type VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1ManifestData struct {
...
func (r *VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_virt_virtink_smartx_com_virtual_machine_migration_v1alpha1_manifest"
}
...
func (r *VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_virt_virtink_smartx_com_virtual_machine_migration_v1alpha1_manifest")

	var model VirtVirtinkSmartxComVirtualMachineMigrationV1Alpha1ManifestData
