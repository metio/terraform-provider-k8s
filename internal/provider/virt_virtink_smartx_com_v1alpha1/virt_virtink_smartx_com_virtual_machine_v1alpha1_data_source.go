...
var (
	_ datasource.DataSource              = &VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource{}
)

func NewVirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource() datasource.DataSource {
	return &VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource{}
}

type VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSourceData struct {
...
func (r *VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_virt_virtink_smartx_com_virtual_machine_v1alpha1"
}

func (r *VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_virt_virtink_smartx_com_virtual_machine_v1alpha1")

	var data VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSourceData
	...
	var readResponse VirtVirtinkSmartxComVirtualMachineV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("VirtualMachine")
