...
var (
	_ datasource.DataSource              = &ServingKubedlIoInferenceV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ServingKubedlIoInferenceV1Alpha1DataSource{}
)

func NewServingKubedlIoInferenceV1Alpha1DataSource() datasource.DataSource {
	return &ServingKubedlIoInferenceV1Alpha1DataSource{}
}

type ServingKubedlIoInferenceV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ServingKubedlIoInferenceV1Alpha1DataSourceData struct {
	...
	Spec *struct {
		...
		Predictors *[]struct {
			AutoScale *struct {
				...
				} `tfsdk:"auto_scaler" json:"autoScaler,omitempty"`
			...
			} `tfsdk:"auto_scale" json:"autoScale,omitempty"`
			Batching *struct {
				BatchSize      *int64 `tfsdk:"batch_size" json:"batchSize,omitempty"`
				TimeoutSeconds *int64 `tfsdk:"timeout_seconds" json:"timeoutSeconds,omitempty"`
			} `tfsdk:"batching" json:"batching,omitempty"`
			ModelPath    *string `tfsdk:"model_path" json:"modelPath,omitempty"`
			ModelVersion *string `tfsdk:"model_version" json:"modelVersion,omitempty"`
			Name         *string `tfsdk:"name" json:"name,omitempty"`
			...
			TrafficWeight *int64 `tfsdk:"traffic_weight" json:"trafficWeight,omitempty"`
		} `tfsdk:"predictors" json:"predictors,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *ServingKubedlIoInferenceV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_serving_kubedl_io_inference_v1alpha1"
}

func (r *ServingKubedlIoInferenceV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"predictors": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"auto_scale": schema.SingleNestedAttribute{
									...
									MarkdownDescription: "",
									Attributes: map[string]schema.Attribute{
										"auto_scaler": schema.SingleNestedAttribute{
											Description:         "",
											MarkdownDescription: "",
											Attributes: map[string]schema.Attribute{
								...
								"traffic_weight": schema.Int64Attribute{
									Description:         "",
									MarkdownDescription: "",
									Required:            false,
									Optional:            false,
...
func (r *ServingKubedlIoInferenceV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ServingKubedlIoInferenceV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_serving_kubedl_io_inference_v1alpha1")

	var data ServingKubedlIoInferenceV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "serving.kubedl.io", Version: "v1alpha1", Resource: "inferences"}).
	...
	var readResponse ServingKubedlIoInferenceV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("serving.kubedl.io/v1alpha1")
	data.Kind = pointer.String("Inference")
