...
var (
	_ datasource.DataSource = &ServingKubedlIoInferenceV1Alpha1Manifest{}
)

func NewServingKubedlIoInferenceV1Alpha1Manifest() datasource.DataSource {
	return &ServingKubedlIoInferenceV1Alpha1Manifest{}
}

type ServingKubedlIoInferenceV1Alpha1Manifest struct{}

type ServingKubedlIoInferenceV1Alpha1ManifestData struct {
...
func (r *ServingKubedlIoInferenceV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_serving_kubedl_io_inference_v1alpha1_manifest"
}

func (r *ServingKubedlIoInferenceV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ServingKubedlIoInferenceV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_serving_kubedl_io_inference_v1alpha1_manifest")

	var model ServingKubedlIoInferenceV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("serving.kubedl.io/v1alpha1")
	model.Kind = pointer.String("Inference")
