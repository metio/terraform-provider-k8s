			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"dataplane": schema.StringAttribute{
						Description:         "Dataplane defines the dataplane (stunnerd image, version, etc) for STUNner gatewaysusing this GatewayConfig.",
						MarkdownDescription: "Dataplane defines the dataplane (stunnerd image, version, etc) for STUNner gatewaysusing this GatewayConfig.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
