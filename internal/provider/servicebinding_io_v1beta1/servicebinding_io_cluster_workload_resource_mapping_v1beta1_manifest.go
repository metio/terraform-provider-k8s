...
var (
	_ datasource.DataSource = &ServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest{}
)

func NewServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest() datasource.DataSource {
	return &ServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest{}
}

type ServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest struct{}

type ServicebindingIoClusterWorkloadResourceMappingV1Beta1ManifestData struct {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_servicebinding_io_cluster_workload_resource_mapping_v1beta1_manifest"
}

func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_servicebinding_io_cluster_workload_resource_mapping_v1beta1_manifest")

	var model ServicebindingIoClusterWorkloadResourceMappingV1Beta1ManifestData
