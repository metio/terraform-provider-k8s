...
var (
	_ datasource.DataSource              = &ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource{}
)

func NewServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource() datasource.DataSource {
	return &ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource{}
}

type ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSourceData struct {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_servicebinding_io_cluster_workload_resource_mapping_v1beta1"
}

func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_servicebinding_io_cluster_workload_resource_mapping_v1beta1")

	var data ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSourceData
	...
	var readResponse ServicebindingIoClusterWorkloadResourceMappingV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("servicebinding.io/v1beta1")
