...
var (
	_ datasource.DataSource              = &ServicebindingIoServiceBindingV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ServicebindingIoServiceBindingV1Beta1DataSource{}
)

func NewServicebindingIoServiceBindingV1Beta1DataSource() datasource.DataSource {
	return &ServicebindingIoServiceBindingV1Beta1DataSource{}
}

type ServicebindingIoServiceBindingV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ServicebindingIoServiceBindingV1Beta1DataSourceData struct {
...
func (r *ServicebindingIoServiceBindingV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_servicebinding_io_service_binding_v1beta1"
}

func (r *ServicebindingIoServiceBindingV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ServicebindingIoServiceBindingV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ServicebindingIoServiceBindingV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_servicebinding_io_service_binding_v1beta1")

	var data ServicebindingIoServiceBindingV1Beta1DataSourceData
	...
	var readResponse ServicebindingIoServiceBindingV1Beta1DataSourceData
