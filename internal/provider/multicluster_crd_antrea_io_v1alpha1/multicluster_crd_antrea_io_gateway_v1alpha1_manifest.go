...
var (
	_ datasource.DataSource = &MulticlusterCrdAntreaIoGatewayV1Alpha1Manifest{}
)

func NewMulticlusterCrdAntreaIoGatewayV1Alpha1Manifest() datasource.DataSource {
	return &MulticlusterCrdAntreaIoGatewayV1Alpha1Manifest{}
}
...
func (r *MulticlusterCrdAntreaIoGatewayV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_multicluster_crd_antrea_io_gateway_v1alpha1_manifest"
}

func (r *MulticlusterCrdAntreaIoGatewayV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Gateway includes information of a Multi-cluster Gateway.",
		MarkdownDescription: "Gateway includes information of a Multi-cluster Gateway.",
		Attributes: map[string]schema.Attribute{
			...
			"gateway_ip": schema.StringAttribute{
				...
				MarkdownDescription: "Cross-cluster tunnel IP of the Gateway.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},
			...
			"internal_ip": schema.StringAttribute{
				...
				MarkdownDescription: "In-cluster tunnel IP of the Gateway.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},
			...
			"service_cidr": schema.StringAttribute{
				...
				MarkdownDescription: "Service CIDR of the local member cluster.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},
...
func (r *MulticlusterCrdAntreaIoGatewayV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_multicluster_crd_antrea_io_gateway_v1alpha1_manifest")

	var model MulticlusterCrdAntreaIoGatewayV1Alpha1ManifestData
