...
var (
	_ datasource.DataSource = &MulticlusterCrdAntreaIoClusterSetV1Alpha1Manifest{}
)

func NewMulticlusterCrdAntreaIoClusterSetV1Alpha1Manifest() datasource.DataSource {
	return &MulticlusterCrdAntreaIoClusterSetV1Alpha1Manifest{}
}
...
func (r *MulticlusterCrdAntreaIoClusterSetV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_multicluster_crd_antrea_io_cluster_set_v1alpha1_manifest"
}

func (r *MulticlusterCrdAntreaIoClusterSetV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"cluster_id": schema.StringAttribute{
									...
									MarkdownDescription: "Identify member cluster in ClusterSet.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"secret": schema.StringAttribute{
									...
									MarkdownDescription: "Secret name to access API server of the member from the leader cluster.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"server": schema.StringAttribute{
									...
									MarkdownDescription: "API server of the destination cluster.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"service_account": schema.StringAttribute{
									...
									MarkdownDescription: "ServiceAccount used by the member cluster to access into leader cluster.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
...
func (r *MulticlusterCrdAntreaIoClusterSetV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_multicluster_crd_antrea_io_cluster_set_v1alpha1_manifest")

	var model MulticlusterCrdAntreaIoClusterSetV1Alpha1ManifestData
