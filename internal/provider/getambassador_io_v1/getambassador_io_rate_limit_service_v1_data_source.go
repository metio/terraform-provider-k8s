...
var (
	_ datasource.DataSource              = &GetambassadorIoRateLimitServiceV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoRateLimitServiceV1DataSource{}
)

func NewGetambassadorIoRateLimitServiceV1DataSource() datasource.DataSource {
	return &GetambassadorIoRateLimitServiceV1DataSource{}
}

type GetambassadorIoRateLimitServiceV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoRateLimitServiceV1DataSourceData struct {
...
func (r *GetambassadorIoRateLimitServiceV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_rate_limit_service_v1"
}

func (r *GetambassadorIoRateLimitServiceV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoRateLimitServiceV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoRateLimitServiceV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_rate_limit_service_v1")

	var data GetambassadorIoRateLimitServiceV1DataSourceData
	...
	var readResponse GetambassadorIoRateLimitServiceV1DataSourceData
