...
var (
	_ datasource.DataSource = &GetambassadorIoConsulResolverV1Manifest{}
)

func NewGetambassadorIoConsulResolverV1Manifest() datasource.DataSource {
	return &GetambassadorIoConsulResolverV1Manifest{}
}
...
func (r *GetambassadorIoConsulResolverV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_consul_resolver_v1_manifest"
}

func (r *GetambassadorIoConsulResolverV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoConsulResolverV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_consul_resolver_v1_manifest")

	var model GetambassadorIoConsulResolverV1ManifestData
