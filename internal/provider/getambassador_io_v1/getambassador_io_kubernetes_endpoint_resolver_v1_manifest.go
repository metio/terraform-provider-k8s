...
var (
	_ datasource.DataSource = &GetambassadorIoKubernetesEndpointResolverV1Manifest{}
)

func NewGetambassadorIoKubernetesEndpointResolverV1Manifest() datasource.DataSource {
	return &GetambassadorIoKubernetesEndpointResolverV1Manifest{}
}
...
func (r *GetambassadorIoKubernetesEndpointResolverV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_kubernetes_endpoint_resolver_v1_manifest"
}

func (r *GetambassadorIoKubernetesEndpointResolverV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoKubernetesEndpointResolverV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_kubernetes_endpoint_resolver_v1_manifest")

	var model GetambassadorIoKubernetesEndpointResolverV1ManifestData
	...
	model.Kind = pointer.String("KubernetesEndpointResolver")
