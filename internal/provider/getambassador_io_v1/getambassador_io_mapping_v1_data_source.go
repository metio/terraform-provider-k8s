...
var (
	_ datasource.DataSource              = &GetambassadorIoMappingV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoMappingV1DataSource{}
)

func NewGetambassadorIoMappingV1DataSource() datasource.DataSource {
	return &GetambassadorIoMappingV1DataSource{}
}

type GetambassadorIoMappingV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoMappingV1DataSourceData struct {
...
func (r *GetambassadorIoMappingV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_mapping_v1"
}

func (r *GetambassadorIoMappingV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoMappingV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoMappingV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_mapping_v1")

	var data GetambassadorIoMappingV1DataSourceData
	...
	var readResponse GetambassadorIoMappingV1DataSourceData
	...
	data.Kind = pointer.String("Mapping")
