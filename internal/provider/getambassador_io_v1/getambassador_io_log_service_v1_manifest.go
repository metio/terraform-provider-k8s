...
var (
	_ datasource.DataSource = &GetambassadorIoLogServiceV1Manifest{}
)

func NewGetambassadorIoLogServiceV1Manifest() datasource.DataSource {
	return &GetambassadorIoLogServiceV1Manifest{}
}
...
func (r *GetambassadorIoLogServiceV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_log_service_v1_manifest"
}

func (r *GetambassadorIoLogServiceV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoLogServiceV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_log_service_v1_manifest")

	var model GetambassadorIoLogServiceV1ManifestData
