...
var (
	_ datasource.DataSource              = &GetambassadorIoDevPortalV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoDevPortalV1DataSource{}
)

func NewGetambassadorIoDevPortalV1DataSource() datasource.DataSource {
	return &GetambassadorIoDevPortalV1DataSource{}
}

type GetambassadorIoDevPortalV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoDevPortalV1DataSourceData struct {
...
func (r *GetambassadorIoDevPortalV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_dev_portal_v1"
}

func (r *GetambassadorIoDevPortalV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoDevPortalV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoDevPortalV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_dev_portal_v1")

	var data GetambassadorIoDevPortalV1DataSourceData
	...
	var readResponse GetambassadorIoDevPortalV1DataSourceData
