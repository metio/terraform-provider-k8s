...
var (
	_ datasource.DataSource              = &GetambassadorIoLogServiceV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoLogServiceV1DataSource{}
)

func NewGetambassadorIoLogServiceV1DataSource() datasource.DataSource {
	return &GetambassadorIoLogServiceV1DataSource{}
}

type GetambassadorIoLogServiceV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoLogServiceV1DataSourceData struct {
...
func (r *GetambassadorIoLogServiceV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_log_service_v1"
}

func (r *GetambassadorIoLogServiceV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoLogServiceV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoLogServiceV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_log_service_v1")

	var data GetambassadorIoLogServiceV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "getambassador.io", Version: "v1", Resource: "logservices"}).
	...
	var readResponse GetambassadorIoLogServiceV1DataSourceData
