...
var (
	_ datasource.DataSource              = &GetambassadorIoTracingServiceV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoTracingServiceV1DataSource{}
)

func NewGetambassadorIoTracingServiceV1DataSource() datasource.DataSource {
	return &GetambassadorIoTracingServiceV1DataSource{}
}

type GetambassadorIoTracingServiceV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoTracingServiceV1DataSourceData struct {
...
func (r *GetambassadorIoTracingServiceV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_tracing_service_v1"
}

func (r *GetambassadorIoTracingServiceV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoTracingServiceV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoTracingServiceV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_tracing_service_v1")

	var data GetambassadorIoTracingServiceV1DataSourceData
	...
	var readResponse GetambassadorIoTracingServiceV1DataSourceData
