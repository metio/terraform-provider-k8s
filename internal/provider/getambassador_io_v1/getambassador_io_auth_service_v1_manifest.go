...
var (
	_ datasource.DataSource = &GetambassadorIoAuthServiceV1Manifest{}
)

func NewGetambassadorIoAuthServiceV1Manifest() datasource.DataSource {
	return &GetambassadorIoAuthServiceV1Manifest{}
}
...
func (r *GetambassadorIoAuthServiceV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_auth_service_v1_manifest"
}

func (r *GetambassadorIoAuthServiceV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoAuthServiceV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_auth_service_v1_manifest")

	var model GetambassadorIoAuthServiceV1ManifestData
