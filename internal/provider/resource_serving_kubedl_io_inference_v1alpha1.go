...
type ServingKubedlIoInferenceV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*ServingKubedlIoInferenceV1Alpha1Resource)(nil)
)

type ServingKubedlIoInferenceV1Alpha1TerraformModel struct {
...
type ServingKubedlIoInferenceV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		Predictors *[]struct {
			AutoScale *struct {
				...
				} `tfsdk:"auto_scaler" yaml:"autoScaler,omitempty"`
			...
			} `tfsdk:"auto_scale" yaml:"autoScale,omitempty"`
			...
			} `tfsdk:"batching" yaml:"batching,omitempty"`

			ModelPath *string `tfsdk:"model_path" yaml:"modelPath,omitempty"`

			ModelVersion *string `tfsdk:"model_version" yaml:"modelVersion,omitempty"`
			...
			TrafficWeight *int64 `tfsdk:"traffic_weight" yaml:"trafficWeight,omitempty"`
		} `tfsdk:"predictors" yaml:"predictors,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewServingKubedlIoInferenceV1Alpha1Resource() resource.Resource {
	return &ServingKubedlIoInferenceV1Alpha1Resource{}
}

func (r *ServingKubedlIoInferenceV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_serving_kubedl_io_inference_v1alpha1"
}

func (r *ServingKubedlIoInferenceV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *ServingKubedlIoInferenceV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_serving_kubedl_io_inference_v1alpha1")

	var state ServingKubedlIoInferenceV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ServingKubedlIoInferenceV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("serving.kubedl.io/v1alpha1")
	goModel.Kind = utilities.Ptr("Inference")
...
func (r *ServingKubedlIoInferenceV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_serving_kubedl_io_inference_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *ServingKubedlIoInferenceV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_serving_kubedl_io_inference_v1alpha1")
...
func (r *ServingKubedlIoInferenceV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_serving_kubedl_io_inference_v1alpha1")
