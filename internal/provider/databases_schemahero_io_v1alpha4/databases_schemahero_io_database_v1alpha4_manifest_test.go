...
func TestDatabasesSchemaheroIoDatabaseV1Alpha4Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_databases_schemahero_io_database_v1alpha4_manifest", testCase)
		})
	}
}
