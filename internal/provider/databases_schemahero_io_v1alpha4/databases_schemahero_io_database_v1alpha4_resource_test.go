...
func TestDatabasesSchemaheroIoDatabaseV1Alpha4Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_databases_schemahero_io_database_v1alpha4", testCase)
		})
	}
}
