...
var (
	_ datasource.DataSource = &JetstreamNatsIoStreamV1Beta1Manifest{}
)

func NewJetstreamNatsIoStreamV1Beta1Manifest() datasource.DataSource {
	return &JetstreamNatsIoStreamV1Beta1Manifest{}
}

type JetstreamNatsIoStreamV1Beta1Manifest struct{}

type JetstreamNatsIoStreamV1Beta1ManifestData struct {
...
func (r *JetstreamNatsIoStreamV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_jetstream_nats_io_stream_v1beta1_manifest"
}

func (r *JetstreamNatsIoStreamV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"max_msgs_per_subject": schema.Int64Attribute{
						...
						MarkdownDescription: "The maximum of messages per subject.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *JetstreamNatsIoStreamV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_jetstream_nats_io_stream_v1beta1_manifest")

	var model JetstreamNatsIoStreamV1Beta1ManifestData
