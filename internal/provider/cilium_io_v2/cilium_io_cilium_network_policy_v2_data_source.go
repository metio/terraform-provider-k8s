...
var (
	_ datasource.DataSource              = &CiliumIoCiliumNetworkPolicyV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CiliumIoCiliumNetworkPolicyV2DataSource{}
)

func NewCiliumIoCiliumNetworkPolicyV2DataSource() datasource.DataSource {
	return &CiliumIoCiliumNetworkPolicyV2DataSource{}
}

type CiliumIoCiliumNetworkPolicyV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CiliumIoCiliumNetworkPolicyV2DataSourceData struct {
...
func (r *CiliumIoCiliumNetworkPolicyV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_network_policy_v2"
}

func (r *CiliumIoCiliumNetworkPolicyV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CiliumIoCiliumNetworkPolicyV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CiliumIoCiliumNetworkPolicyV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cilium_io_cilium_network_policy_v2")

	var data CiliumIoCiliumNetworkPolicyV2DataSourceData
	...
	var readResponse CiliumIoCiliumNetworkPolicyV2DataSourceData
	...
	data.Kind = pointer.String("CiliumNetworkPolicy")
