...
var (
	_ datasource.DataSource = &CiliumIoCiliumBgpclusterConfigV2Manifest{}
)

func NewCiliumIoCiliumBgpclusterConfigV2Manifest() datasource.DataSource {
	return &CiliumIoCiliumBgpclusterConfigV2Manifest{}
}

type CiliumIoCiliumBgpclusterConfigV2Manifest struct{}

type CiliumIoCiliumBgpclusterConfigV2ManifestData struct {
		...
		BgpInstances *[]struct {
			...
			Peers     *[]struct {
				AutoDiscovery *struct {
					...
					} `tfsdk:"default_gateway" json:"defaultGateway,omitempty"`
					Mode *string `tfsdk:"mode" json:"mode,omitempty"`
				} `tfsdk:"auto_discovery" json:"autoDiscovery,omitempty"`
				Name          *string `tfsdk:"name" json:"name,omitempty"`
...
func (r *CiliumIoCiliumBgpclusterConfigV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_bgp_cluster_config_v2_manifest"
}

func (r *CiliumIoCiliumBgpclusterConfigV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"peers": schema.ListNestedAttribute{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"auto_discovery": schema.SingleNestedAttribute{
												Description:         "AutoDiscovery is the configuration for auto-discovery of the peer address.",
												MarkdownDescription: "AutoDiscovery is the configuration for auto-discovery of the peer address.",
												Attributes: map[string]schema.Attribute{
													"default_gateway": schema.SingleNestedAttribute{
														Description:         "defaultGateway is the configuration for auto-discovery of the default gateway.",
														MarkdownDescription: "defaultGateway is the configuration for auto-discovery of the default gateway.",
														Attributes: map[string]schema.Attribute{
															"address_family": schema.StringAttribute{
																Description:         "addressFamily is the address family of the default gateway.",
																MarkdownDescription: "addressFamily is the address family of the default gateway.",
																Required:            true,
																Optional:            false,
																Computed:            false,
																Validators: []validator.String{
													...
													"mode": schema.StringAttribute{
														...
														MarkdownDescription: "mode is the mode of the auto-discovery.",
														Required:            true,
														Optional:            false,
														Computed:            false,
													},
...
func (r *CiliumIoCiliumBgpclusterConfigV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_bgp_cluster_config_v2_manifest")

	var model CiliumIoCiliumBgpclusterConfigV2ManifestData
