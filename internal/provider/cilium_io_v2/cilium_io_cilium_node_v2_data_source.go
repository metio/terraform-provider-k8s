...
var (
	_ datasource.DataSource              = &CiliumIoCiliumNodeV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CiliumIoCiliumNodeV2DataSource{}
)

func NewCiliumIoCiliumNodeV2DataSource() datasource.DataSource {
	return &CiliumIoCiliumNodeV2DataSource{}
}

type CiliumIoCiliumNodeV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CiliumIoCiliumNodeV2DataSourceData struct {
...
func (r *CiliumIoCiliumNodeV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_node_v2"
}

func (r *CiliumIoCiliumNodeV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CiliumIoCiliumNodeV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CiliumIoCiliumNodeV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cilium_io_cilium_node_v2")

	var data CiliumIoCiliumNodeV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "cilium.io", Version: "v2", Resource: "CiliumNode"}).
	...
	var readResponse CiliumIoCiliumNodeV2DataSourceData
	...
	data.Kind = pointer.String("CiliumNode")
