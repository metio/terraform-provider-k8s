											...
											"rules": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													...
													"kafka": schema.ListNestedAttribute{
														Description:         "Kafka-specific rules. Deprecated: This beta feature is deprecated and will be removed in a future release.",
														MarkdownDescription: "Kafka-specific rules. Deprecated: This beta feature is deprecated and will be removed in a future release.",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
