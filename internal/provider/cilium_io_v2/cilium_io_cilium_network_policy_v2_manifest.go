...
var (
	_ datasource.DataSource = &CiliumIoCiliumNetworkPolicyV2Manifest{}
)

func NewCiliumIoCiliumNetworkPolicyV2Manifest() datasource.DataSource {
	return &CiliumIoCiliumNetworkPolicyV2Manifest{}
}
...
func (r *CiliumIoCiliumNetworkPolicyV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_network_policy_v2_manifest"
}
...
func (r *CiliumIoCiliumNetworkPolicyV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_network_policy_v2_manifest")

	var model CiliumIoCiliumNetworkPolicyV2ManifestData
