...
func TestCiliumIoCiliumNodeV2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_cilium_io_cilium_node_v2_manifest", testCase)
		})
	}
}
