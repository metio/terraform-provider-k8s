...
var (
	_ datasource.DataSource = &CiliumIoCiliumBgpnodeConfigV2Manifest{}
)

func NewCiliumIoCiliumBgpnodeConfigV2Manifest() datasource.DataSource {
	return &CiliumIoCiliumBgpnodeConfigV2Manifest{}
}

type CiliumIoCiliumBgpnodeConfigV2Manifest struct{}

type CiliumIoCiliumBgpnodeConfigV2ManifestData struct {
...
func (r *CiliumIoCiliumBgpnodeConfigV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_bgp_node_config_v2_manifest"
}

func (r *CiliumIoCiliumBgpnodeConfigV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CiliumIoCiliumBgpnodeConfigV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_bgp_node_config_v2_manifest")

	var model CiliumIoCiliumBgpnodeConfigV2ManifestData
