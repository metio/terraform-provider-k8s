...
var (
	_ datasource.DataSource = &CiliumIoCiliumBgpnodeConfigOverrideV2Manifest{}
)

func NewCiliumIoCiliumBgpnodeConfigOverrideV2Manifest() datasource.DataSource {
	return &CiliumIoCiliumBgpnodeConfigOverrideV2Manifest{}
}

type CiliumIoCiliumBgpnodeConfigOverrideV2Manifest struct{}

type CiliumIoCiliumBgpnodeConfigOverrideV2ManifestData struct {
...
func (r *CiliumIoCiliumBgpnodeConfigOverrideV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_bgp_node_config_override_v2_manifest"
}

func (r *CiliumIoCiliumBgpnodeConfigOverrideV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CiliumIoCiliumBgpnodeConfigOverrideV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_bgp_node_config_override_v2_manifest")

	var model CiliumIoCiliumBgpnodeConfigOverrideV2ManifestData
