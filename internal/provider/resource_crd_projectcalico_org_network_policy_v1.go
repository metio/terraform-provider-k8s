...
var (
	_ resource.Resource = (*CrdProjectcalicoOrgNetworkPolicyV1Resource)(nil)
)

type CrdProjectcalicoOrgNetworkPolicyV1TerraformModel struct {
...
type CrdProjectcalicoOrgNetworkPolicyV1GoModel struct {
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_crd_projectcalico_org_network_policy_v1"
}

func (r *CrdProjectcalicoOrgNetworkPolicyV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_crd_projectcalico_org_network_policy_v1")

	var state CrdProjectcalicoOrgNetworkPolicyV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CrdProjectcalicoOrgNetworkPolicyV1GoModel
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_crd_projectcalico_org_network_policy_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *CrdProjectcalicoOrgNetworkPolicyV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
