...
package config_storageos_com_v1
...
var (
	_ datasource.DataSource = &ConfigStorageosComOperatorConfigV1Manifest{}
)

func NewConfigStorageosComOperatorConfigV1Manifest() datasource.DataSource {
	return &ConfigStorageosComOperatorConfigV1Manifest{}
}

type ConfigStorageosComOperatorConfigV1Manifest struct{}

type ConfigStorageosComOperatorConfigV1ManifestData struct {
	...
	SerialExecutionStrategy    *bool   `tfsdk:"serial_execution_strategy" json:"serialExecutionStrategy,omitempty"`
	SyncPeriod                 *string `tfsdk:"sync_period" json:"syncPeriod,omitempty"`
	ValidatingWebhookConfigRef *string `tfsdk:"validating_webhook_config_ref" json:"validatingWebhookConfigRef,omitempty"`
	Webhook                    *struct {
		CertDir *string `tfsdk:"cert_dir" json:"certDir,omitempty"`
		Host    *string `tfsdk:"host" json:"host,omitempty"`
		Port    *int64  `tfsdk:"port" json:"port,omitempty"`
	} `tfsdk:"webhook" json:"webhook,omitempty"`
	WebhookCertRefreshInterval *string `tfsdk:"webhook_cert_refresh_interval" json:"webhookCertRefreshInterval,omitempty"`
	WebhookSecretRef           *string `tfsdk:"webhook_secret_ref" json:"webhookSecretRef,omitempty"`
	WebhookServiceName         *string `tfsdk:"webhook_service_name" json:"webhookServiceName,omitempty"`
}
...
func (r *ConfigStorageosComOperatorConfigV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_config_storageos_com_operator_config_v1_manifest"
}
...
func (r *ConfigStorageosComOperatorConfigV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "OperatorConfig is the Schema for the operatorconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"serial_execution_strategy": schema.BoolAttribute{
				...
				MarkdownDescription: "SerialExecutionStrategy forces the operator to install components serially. Default behaviour is to install components in parallel.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},
			...
			"validating_webhook_config_ref": schema.StringAttribute{
				Description:         "ValidatingWebhookConfigRef is the reference of the validating webhook configuration.",
				MarkdownDescription: "ValidatingWebhookConfigRef is the reference of the validating webhook configuration.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},
			...
			"webhook_cert_refresh_interval": schema.StringAttribute{
				Description:         "WebhookCertRefreshInterval is the interval at which the webhook cert is refreshed.",
				MarkdownDescription: "WebhookCertRefreshInterval is the interval at which the webhook cert is refreshed.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},

			"webhook_secret_ref": schema.StringAttribute{
				Description:         "WebhookSecretRef is the secret reference that stores webhook secrets.",
				MarkdownDescription: "WebhookSecretRef is the secret reference that stores webhook secrets.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},

			"webhook_service_name": schema.StringAttribute{
				Description:         "WebhookServiceName is the service name of the webhook server.",
				MarkdownDescription: "WebhookServiceName is the service name of the webhook server.",
				Required:            false,
				Optional:            true,
				Computed:            false,
			},
...
func (r *ConfigStorageosComOperatorConfigV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_config_storageos_com_operator_config_v1_manifest")

	var model ConfigStorageosComOperatorConfigV1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("config.storageos.com/v1")
	model.Kind = pointer.String("OperatorConfig")
