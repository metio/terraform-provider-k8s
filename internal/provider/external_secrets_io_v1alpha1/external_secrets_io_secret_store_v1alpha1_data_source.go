...
var (
	_ datasource.DataSource              = &ExternalSecretsIoSecretStoreV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ExternalSecretsIoSecretStoreV1Alpha1DataSource{}
)

func NewExternalSecretsIoSecretStoreV1Alpha1DataSource() datasource.DataSource {
	return &ExternalSecretsIoSecretStoreV1Alpha1DataSource{}
}

type ExternalSecretsIoSecretStoreV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ExternalSecretsIoSecretStoreV1Alpha1DataSourceData struct {
...
func (r *ExternalSecretsIoSecretStoreV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_secret_store_v1alpha1"
}

func (r *ExternalSecretsIoSecretStoreV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExternalSecretsIoSecretStoreV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ExternalSecretsIoSecretStoreV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_external_secrets_io_secret_store_v1alpha1")

	var data ExternalSecretsIoSecretStoreV1Alpha1DataSourceData
	...
	var readResponse ExternalSecretsIoSecretStoreV1Alpha1DataSourceData
