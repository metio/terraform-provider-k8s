...
var (
	_ datasource.DataSource              = &ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource{}
)

func NewExternalSecretsIoClusterSecretStoreV1Alpha1DataSource() datasource.DataSource {
	return &ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource{}
}

type ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ExternalSecretsIoClusterSecretStoreV1Alpha1DataSourceData struct {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_cluster_secret_store_v1alpha1"
}

func (r *ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_external_secrets_io_cluster_secret_store_v1alpha1")

	var data ExternalSecretsIoClusterSecretStoreV1Alpha1DataSourceData
	...
	var readResponse ExternalSecretsIoClusterSecretStoreV1Alpha1DataSourceData
