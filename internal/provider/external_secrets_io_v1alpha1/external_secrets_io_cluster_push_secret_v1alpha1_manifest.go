...
var (
	_ datasource.DataSource = &ExternalSecretsIoClusterPushSecretV1Alpha1Manifest{}
)

func NewExternalSecretsIoClusterPushSecretV1Alpha1Manifest() datasource.DataSource {
	return &ExternalSecretsIoClusterPushSecretV1Alpha1Manifest{}
}

type ExternalSecretsIoClusterPushSecretV1Alpha1Manifest struct{}

type ExternalSecretsIoClusterPushSecretV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		PushSecretMetadata *struct {
			Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			Labels      *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		} `tfsdk:"push_secret_metadata" json:"pushSecretMetadata,omitempty"`
		PushSecretName *string `tfsdk:"push_secret_name" json:"pushSecretName,omitempty"`
		PushSecretSpec *struct {
			Data *[]struct {
		...
		} `tfsdk:"push_secret_spec" json:"pushSecretSpec,omitempty"`
		RefreshTime *string `tfsdk:"refresh_time" json:"refreshTime,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *ExternalSecretsIoClusterPushSecretV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_cluster_push_secret_v1alpha1_manifest"
}

func (r *ExternalSecretsIoClusterPushSecretV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"push_secret_metadata": schema.SingleNestedAttribute{
					...
					"push_secret_name": schema.StringAttribute{
						Description:         "The name of the push secrets to be created. Defaults to the name of the ClusterPushSecret",
						MarkdownDescription: "The name of the push secrets to be created. Defaults to the name of the ClusterPushSecret",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"push_secret_spec": schema.SingleNestedAttribute{
						Description:         "PushSecretSpec defines what to do with the secrets.",
						MarkdownDescription: "PushSecretSpec defines what to do with the secrets.",
						Attributes: map[string]schema.Attribute{
...
func (r *ExternalSecretsIoClusterPushSecretV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_external_secrets_io_cluster_push_secret_v1alpha1_manifest")

	var model ExternalSecretsIoClusterPushSecretV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ClusterPushSecret")
