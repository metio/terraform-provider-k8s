...
func TestResourcesTeleportDevTeleportOIDCConnectorV3Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_resources_teleport_dev_teleport_oidc_connector_v3", testCase)
		})
	}
}
