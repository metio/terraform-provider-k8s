...
var (
	_ datasource.DataSource              = &KubeviousIoWorkloadV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KubeviousIoWorkloadV1Alpha1DataSource{}
)

func NewKubeviousIoWorkloadV1Alpha1DataSource() datasource.DataSource {
	return &KubeviousIoWorkloadV1Alpha1DataSource{}
}

type KubeviousIoWorkloadV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KubeviousIoWorkloadV1Alpha1DataSourceData struct {
...
func (r *KubeviousIoWorkloadV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kubevious_io_workload_v1alpha1"
}

func (r *KubeviousIoWorkloadV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KubeviousIoWorkloadV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KubeviousIoWorkloadV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kubevious_io_workload_v1alpha1")

	var data KubeviousIoWorkloadV1Alpha1DataSourceData
	...
	var readResponse KubeviousIoWorkloadV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Workload")
