...
var (
	_ resource.Resource = (*AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource)(nil)
)

type AdmissionregistrationK8SIoMutatingWebhookConfigurationV1TerraformModel struct {
...
type AdmissionregistrationK8SIoMutatingWebhookConfigurationV1GoModel struct {
	...
	Webhooks *[]struct {
		...
		ReinvocationPolicy *string `tfsdk:"reinvocation_policy" yaml:"reinvocationPolicy,omitempty"`
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_admissionregistration_k8s_io_mutating_webhook_configuration_v1"
}

func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_admissionregistration_k8s_io_mutating_webhook_configuration_v1")

	var state AdmissionregistrationK8SIoMutatingWebhookConfigurationV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AdmissionregistrationK8SIoMutatingWebhookConfigurationV1GoModel
	...
	goModel.Kind = utilities.Ptr("MutatingWebhookConfiguration")
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_admissionregistration_k8s_io_mutating_webhook_configuration_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
