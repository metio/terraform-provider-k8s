...
type FluxcdControlplaneIoFluxInstanceV1ManifestData struct {
	...
	Spec *struct {
		Cluster *struct {
			...
			ObjectLevelWorkloadIdentity *bool   `tfsdk:"object_level_workload_identity" json:"objectLevelWorkloadIdentity,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cluster": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"multitenant": schema.BoolAttribute{
								...
								MarkdownDescription: "Multitenant enables the multitenancy lockdown. Defaults to false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"object_level_workload_identity": schema.BoolAttribute{
								Description:         "ObjectLevelWorkloadIdentity enables the feature gate required for object-level workload identity. This feature is only available in Flux v2.6.0 and later.",
								MarkdownDescription: "ObjectLevelWorkloadIdentity enables the feature gate required for object-level workload identity. This feature is only available in Flux v2.6.0 and later.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"size": schema.StringAttribute{
								Description:         "Size defines the vertical scaling profile of the Flux controllers. The size is used to determine the concurrency and CPU/Memory limits for the Flux controllers. Accepted values are: 'small', 'medium' and 'large'.",
								MarkdownDescription: "Size defines the vertical scaling profile of the Flux controllers. The size is used to determine the concurrency and CPU/Memory limits for the Flux controllers. Accepted values are: 'small', 'medium' and 'large'.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
					...
					"components": schema.ListAttribute{
						Description:         "Components is the list of controllers to install. Defaults to a commonly used subset.",
						MarkdownDescription: "Components is the list of controllers to install. Defaults to a commonly used subset.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"sharding": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"storage": schema.StringAttribute{
								Description:         "Storage defines if the source-controller shards should use an emptyDir or a persistent volume claim for storage. Accepted values are 'ephemeral' or 'persistent', defaults to 'ephemeral'. For 'persistent' to take effect, the '.spec.storage' field must be set.",
								MarkdownDescription: "Storage defines if the source-controller shards should use an emptyDir or a persistent volume claim for storage. Accepted values are 'ephemeral' or 'persistent', defaults to 'ephemeral'. For 'persistent' to take effect, the '.spec.storage' field must be set.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("ephemeral", "persistent"),
								},
							},
						},
						Required: false,
