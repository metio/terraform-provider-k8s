			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cluster": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Cluster is the version information of the Kubernetes cluster.",
						Attributes: map[string]schema.Attribute{
							"nodes": schema.Int64Attribute{
								Description:         "Nodes is the number of nodes in the Kubernetes cluster.",
								MarkdownDescription: "Nodes is the number of nodes in the Kubernetes cluster.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"platform": schema.StringAttribute{
								...
								MarkdownDescription: "Platform is the os/arch of the Kubernetes control plane.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"server_version": schema.StringAttribute{
								...
								MarkdownDescription: "ServerVersion is the version of the Kubernetes API server.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"operator": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Operator is the version information of the Flux Operator.",
						Attributes: map[string]schema.Attribute{
							"api_version": schema.StringAttribute{
								Description:         "APIVersion is the API version of the Flux Operator.",
								MarkdownDescription: "APIVersion is the API version of the Flux Operator.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"platform": schema.StringAttribute{
								...
								MarkdownDescription: "Platform is the os/arch of Flux Operator.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"version": schema.StringAttribute{
								...
								MarkdownDescription: "Version is the version number of Flux Operator.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
