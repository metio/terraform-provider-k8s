...
type FluxcdControlplaneIoResourceSetInputProviderV1ManifestData struct {
	...
	Spec *struct {
		...
		Filter        *struct {
			...
			ExcludeTag    *string   `tfsdk:"exclude_tag" json:"excludeTag,omitempty"`
			IncludeBranch *string   `tfsdk:"include_branch" json:"includeBranch,omitempty"`
			IncludeTag    *string   `tfsdk:"include_tag" json:"includeTag,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cert_secret_ref": schema.SingleNestedAttribute{
						Description:         "CertSecretRef specifies the Kubernetes Secret containing either or both of - a PEM-encoded CA certificate ('ca.crt') - a PEM-encoded client certificate ('tls.crt') and private key ('tls.key') When connecting to a Git or OCI provider that uses self-signed certificates, the CA certificate must be set in the Secret under the 'ca.crt' key to establish the trust relationship. When connecting to an OCI provider that supports client certificates (mTLS), the client certificate and private key must be set in the Secret under the 'tls.crt' and 'tls.key' keys, respectively.",
						MarkdownDescription: "CertSecretRef specifies the Kubernetes Secret containing either or both of - a PEM-encoded CA certificate ('ca.crt') - a PEM-encoded client certificate ('tls.crt') and private key ('tls.key') When connecting to a Git or OCI provider that uses self-signed certificates, the CA certificate must be set in the Secret under the 'ca.crt' key to establish the trust relationship. When connecting to an OCI provider that supports client certificates (mTLS), the client certificate and private key must be set in the Secret under the 'tls.crt' and 'tls.key' keys, respectively.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
					...
					"filter": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"exclude_tag": schema.StringAttribute{
								Description:         "ExcludeTag specifies the regular expression to filter the tags that the input provider should exclude.",
								MarkdownDescription: "ExcludeTag specifies the regular expression to filter the tags that the input provider should exclude.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"include_tag": schema.StringAttribute{
								Description:         "IncludeTag specifies the regular expression to filter the tags that the input provider should include.",
								MarkdownDescription: "IncludeTag specifies the regular expression to filter the tags that the input provider should include.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"semver": schema.StringAttribute{
								Description:         "Semver specifies a semantic version range to filter and sort the tags. If this field is not specified, the tags will be sorted in reverse alphabetical order. Supported only for tags at the moment.",
								MarkdownDescription: "Semver specifies a semantic version range to filter and sort the tags. If this field is not specified, the tags will be sorted in reverse alphabetical order. Supported only for tags at the moment.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"schedule": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Schedule defines the schedules for the input provider to run.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"cron": schema.StringAttribute{
									Description:         "Cron specifies the cron expression for the schedule.",
									MarkdownDescription: "Cron specifies the cron expression for the schedule.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"time_zone": schema.StringAttribute{
									...
									MarkdownDescription: "TimeZone specifies the time zone for the cron schedule. Defaults to UTC.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"window": schema.StringAttribute{
									Description:         "Window defines the time window during which the execution is allowed. Defaults to 0s, meaning no window is applied.",
									MarkdownDescription: "Window defines the time window during which the execution is allowed. Defaults to 0s, meaning no window is applied.",
									Required:            false,
									Optional:            true,
									Computed:            false,
									Validators: []validator.String{
					...
					"service_account_name": schema.StringAttribute{
						Description:         "ServiceAccountName specifies the name of the Kubernetes ServiceAccount used for authentication with AWS, Azure or GCP services through workload identity federation features. If not specified, the authentication for these cloud providers will use the ServiceAccount of the operator (or any other environment authentication configuration).",
						MarkdownDescription: "ServiceAccountName specifies the name of the Kubernetes ServiceAccount used for authentication with AWS, Azure or GCP services through workload identity federation features. If not specified, the authentication for these cloud providers will use the ServiceAccount of the operator (or any other environment authentication configuration).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"type": schema.StringAttribute{
						...
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("Static", "GitHubBranch", "GitHubTag", "GitHubPullRequest", "GitLabBranch", "GitLabTag", "GitLabMergeRequest", "AzureDevOpsBranch", "AzureDevOpsTag", "AzureDevOpsPullRequest", "OCIArtifactTag", "ACRArtifactTag", "ECRArtifactTag", "GARArtifactTag"),
						},
					},

					"url": schema.StringAttribute{
						Description:         "URL specifies the HTTP/S or OCI address of the input provider API. When connecting to a Git provider, the URL should point to the repository address. When connecting to an OCI provider, the URL should point to the OCI repository address.",
						MarkdownDescription: "URL specifies the HTTP/S or OCI address of the input provider API. When connecting to a Git provider, the URL should point to the repository address. When connecting to an OCI provider, the URL should point to the OCI repository address.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.RegexMatches(regexp.MustCompile(`^((http|https|oci)://.*){0,1}$`), ""),
						},
					},
				},
				Required: false,
