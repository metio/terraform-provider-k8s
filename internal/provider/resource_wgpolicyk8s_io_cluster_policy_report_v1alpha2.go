...
var (
	_ resource.Resource = (*Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource)(nil)
)

type Wgpolicyk8SIoClusterPolicyReportV1Alpha2TerraformModel struct {
...
type Wgpolicyk8SIoClusterPolicyReportV1Alpha2GoModel struct {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_wgpolicyk8s_io_cluster_policy_report_v1alpha2"
}

func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_wgpolicyk8s_io_cluster_policy_report_v1alpha2")

	var state Wgpolicyk8SIoClusterPolicyReportV1Alpha2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel Wgpolicyk8SIoClusterPolicyReportV1Alpha2GoModel
	...
	goModel.Kind = utilities.Ptr("ClusterPolicyReport")
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_wgpolicyk8s_io_cluster_policy_report_v1alpha2")
	// NO-OP: All data is already in Terraform state
}

func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
