...
var (
	_ resource.Resource = (*PkgCrossplaneIoProviderRevisionV1Resource)(nil)
)

type PkgCrossplaneIoProviderRevisionV1TerraformModel struct {
...
type PkgCrossplaneIoProviderRevisionV1GoModel struct {
...
func (r *PkgCrossplaneIoProviderRevisionV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_pkg_crossplane_io_provider_revision_v1"
}

func (r *PkgCrossplaneIoProviderRevisionV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *PkgCrossplaneIoProviderRevisionV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_pkg_crossplane_io_provider_revision_v1")

	var state PkgCrossplaneIoProviderRevisionV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel PkgCrossplaneIoProviderRevisionV1GoModel
	...
	goModel.Kind = utilities.Ptr("ProviderRevision")
...
func (r *PkgCrossplaneIoProviderRevisionV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_pkg_crossplane_io_provider_revision_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *PkgCrossplaneIoProviderRevisionV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *PkgCrossplaneIoProviderRevisionV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
