...
var (
	_ datasource.DataSource              = &MattermostComClusterInstallationV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MattermostComClusterInstallationV1Alpha1DataSource{}
)

func NewMattermostComClusterInstallationV1Alpha1DataSource() datasource.DataSource {
	return &MattermostComClusterInstallationV1Alpha1DataSource{}
}

type MattermostComClusterInstallationV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MattermostComClusterInstallationV1Alpha1DataSourceData struct {
	...
	Spec *struct {
		...
		BlueGreen *struct {
			...
			} `tfsdk:"blue" json:"blue,omitempty"`
			...
			Green  *struct {
				...
				ResourceLabels *map[string]string `tfsdk:"resource_labels" json:"resourceLabels,omitempty"`
				Version        *string            `tfsdk:"version" json:"version,omitempty"`
			} `tfsdk:"green" json:"green,omitempty"`
			ProductionDeployment *string `tfsdk:"production_deployment" json:"productionDeployment,omitempty"`
		} `tfsdk:"blue_green" json:"blueGreen,omitempty"`
		Canary *struct {
			Deployment *struct {
				Image          *string            `tfsdk:"image" json:"image,omitempty"`
				IngressName    *string            `tfsdk:"ingress_name" json:"ingressName,omitempty"`
		...
		MattermostLicenseSecret *string `tfsdk:"mattermost_license_secret" json:"mattermostLicenseSecret,omitempty"`
		Migrate                 *bool   `tfsdk:"migrate" json:"migrate,omitempty"`
		Minio                   *struct {
			ExternalBucket *string `tfsdk:"external_bucket" json:"externalBucket,omitempty"`
			...
			Secret      *string `tfsdk:"secret" json:"secret,omitempty"`
			StorageSize *string `tfsdk:"storage_size" json:"storageSize,omitempty"`
		} `tfsdk:"minio" json:"minio,omitempty"`
...
func (r *MattermostComClusterInstallationV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mattermost_com_cluster_installation_v1alpha1"
}

func (r *MattermostComClusterInstallationV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"blue_green": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"blue": schema.SingleNestedAttribute{
							...
							"green": schema.SingleNestedAttribute{
							...
							"production_deployment": schema.StringAttribute{
					...
					"mattermost_license_secret": schema.StringAttribute{
					...
					"minio": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"external_bucket": schema.StringAttribute{
...
func (r *MattermostComClusterInstallationV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MattermostComClusterInstallationV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mattermost_com_cluster_installation_v1alpha1")

	var data MattermostComClusterInstallationV1Alpha1DataSourceData
	...
	var readResponse MattermostComClusterInstallationV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("mattermost.com/v1alpha1")
	data.Kind = pointer.String("ClusterInstallation")
