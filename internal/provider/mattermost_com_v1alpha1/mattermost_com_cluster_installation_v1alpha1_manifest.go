...
var (
	_ datasource.DataSource = &MattermostComClusterInstallationV1Alpha1Manifest{}
)

func NewMattermostComClusterInstallationV1Alpha1Manifest() datasource.DataSource {
	return &MattermostComClusterInstallationV1Alpha1Manifest{}
}

type MattermostComClusterInstallationV1Alpha1Manifest struct{}

type MattermostComClusterInstallationV1Alpha1ManifestData struct {
...
func (r *MattermostComClusterInstallationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mattermost_com_cluster_installation_v1alpha1_manifest"
}
...
func (r *MattermostComClusterInstallationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mattermost_com_cluster_installation_v1alpha1_manifest")

	var model MattermostComClusterInstallationV1Alpha1ManifestData
