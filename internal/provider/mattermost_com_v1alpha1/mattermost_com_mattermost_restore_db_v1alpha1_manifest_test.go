...
func TestMattermostComMattermostRestoreDBV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_mattermost_com_mattermost_restore_db_v1alpha1_manifest", testCase)
		})
	}
}
