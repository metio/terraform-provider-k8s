...
func TestLerentisUploadfilter24EuBitwardenTemplateV1Beta4Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_lerentis_uploadfilter24_eu_bitwarden_template_v1beta4", testCase)
		})
	}
}
