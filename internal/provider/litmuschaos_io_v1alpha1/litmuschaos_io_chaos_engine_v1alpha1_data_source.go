...
var (
	_ datasource.DataSource              = &LitmuschaosIoChaosEngineV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &LitmuschaosIoChaosEngineV1Alpha1DataSource{}
)

func NewLitmuschaosIoChaosEngineV1Alpha1DataSource() datasource.DataSource {
	return &LitmuschaosIoChaosEngineV1Alpha1DataSource{}
}

type LitmuschaosIoChaosEngineV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LitmuschaosIoChaosEngineV1Alpha1DataSourceData struct {
...
func (r *LitmuschaosIoChaosEngineV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_litmuschaos_io_chaos_engine_v1alpha1"
}

func (r *LitmuschaosIoChaosEngineV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LitmuschaosIoChaosEngineV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LitmuschaosIoChaosEngineV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_litmuschaos_io_chaos_engine_v1alpha1")

	var data LitmuschaosIoChaosEngineV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "litmuschaos.io", Version: "v1alpha1", Resource: "chaosengines"}).
	...
	var readResponse LitmuschaosIoChaosEngineV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ChaosEngine")
