...
var (
	_ resource.Resource = (*AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource)(nil)
)

type AutoscalingK8SIoVerticalPodAutoscalerV1Beta2TerraformModel struct {
...
type AutoscalingK8SIoVerticalPodAutoscalerV1Beta2GoModel struct {
	...
	Spec *struct {
		ResourcePolicy *struct {
			ContainerPolicies *[]struct {
				...
				MaxAllowed *map[string]string `tfsdk:"max_allowed" yaml:"maxAllowed,omitempty"`

				MinAllowed *map[string]string `tfsdk:"min_allowed" yaml:"minAllowed,omitempty"`

				Mode *string `tfsdk:"mode" yaml:"mode,omitempty"`
			} `tfsdk:"container_policies" yaml:"containerPolicies,omitempty"`
		} `tfsdk:"resource_policy" yaml:"resourcePolicy,omitempty"`
		...
		UpdatePolicy *struct {
			UpdateMode *string `tfsdk:"update_mode" yaml:"updateMode,omitempty"`
		} `tfsdk:"update_policy" yaml:"updatePolicy,omitempty"`
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_autoscaling_k8s_io_vertical_pod_autoscaler_v1beta2"
}

func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_autoscaling_k8s_io_vertical_pod_autoscaler_v1beta2")

	var state AutoscalingK8SIoVerticalPodAutoscalerV1Beta2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AutoscalingK8SIoVerticalPodAutoscalerV1Beta2GoModel
	...
	goModel.ApiVersion = utilities.Ptr("autoscaling.k8s.io/v1beta2")
	goModel.Kind = utilities.Ptr("VerticalPodAutoscaler")
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_autoscaling_k8s_io_vertical_pod_autoscaler_v1beta2")
	// NO-OP: All data is already in Terraform state
}

func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
