...
var (
	_ datasource.DataSource              = &ExternalSecretsIoExternalSecretV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ExternalSecretsIoExternalSecretV1Beta1DataSource{}
)

func NewExternalSecretsIoExternalSecretV1Beta1DataSource() datasource.DataSource {
	return &ExternalSecretsIoExternalSecretV1Beta1DataSource{}
}

type ExternalSecretsIoExternalSecretV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ExternalSecretsIoExternalSecretV1Beta1DataSourceData struct {
...
func (r *ExternalSecretsIoExternalSecretV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_external_secret_v1beta1"
}

func (r *ExternalSecretsIoExternalSecretV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExternalSecretsIoExternalSecretV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ExternalSecretsIoExternalSecretV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_external_secrets_io_external_secret_v1beta1")

	var data ExternalSecretsIoExternalSecretV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "external-secrets.io", Version: "v1beta1", Resource: "externalsecrets"}).
	...
	var readResponse ExternalSecretsIoExternalSecretV1Beta1DataSourceData
