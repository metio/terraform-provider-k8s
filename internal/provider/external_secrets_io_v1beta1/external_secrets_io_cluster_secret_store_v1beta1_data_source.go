...
var (
	_ datasource.DataSource              = &ExternalSecretsIoClusterSecretStoreV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ExternalSecretsIoClusterSecretStoreV1Beta1DataSource{}
)

func NewExternalSecretsIoClusterSecretStoreV1Beta1DataSource() datasource.DataSource {
	return &ExternalSecretsIoClusterSecretStoreV1Beta1DataSource{}
}

type ExternalSecretsIoClusterSecretStoreV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ExternalSecretsIoClusterSecretStoreV1Beta1DataSourceData struct {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_cluster_secret_store_v1beta1"
}

func (r *ExternalSecretsIoClusterSecretStoreV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_external_secrets_io_cluster_secret_store_v1beta1")

	var data ExternalSecretsIoClusterSecretStoreV1Beta1DataSourceData
	...
	var readResponse ExternalSecretsIoClusterSecretStoreV1Beta1DataSourceData
	...
	data.Kind = pointer.String("ClusterSecretStore")
