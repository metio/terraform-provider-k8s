...
var (
	_ datasource.DataSource = &HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1Manifest{}
)

func NewHelmOpenshiftIoProjectHelmChartRepositoryV1Beta1Manifest() datasource.DataSource {
	return &HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1Manifest{}
}
...
type HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1ManifestData struct {
	...
	Spec *struct {
		ConnectionConfig *struct {
			...
			} `tfsdk:"basic_auth_config" json:"basicAuthConfig,omitempty"`
			Ca *struct {
				Name *string `tfsdk:"name" json:"name,omitempty"`
...
func (r *HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_helm_openshift_io_project_helm_chart_repository_v1beta1_manifest"
}

func (r *HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"connection_config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"basic_auth_config": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "basicAuthConfig is an optional reference to a secret by name that contains the basic authentication credentials to present when connecting to the server. The key 'username' is used locate the username. The key 'password' is used to locate the password. The namespace for this secret must be same as the namespace where the project helm chart repository is getting instantiated.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
							...
							"tls_client_config": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "tlsClientConfig is an optional reference to a secret by name that contains the PEM-encoded TLS client certificate and private key to present when connecting to the server. The key 'tls.crt' is used to locate the client certificate. The key 'tls.key' is used to locate the private key. The namespace for this secret must be same as the namespace where the project helm chart repository is getting instantiated.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "name is the metadata.name of the referenced secret",
										MarkdownDescription: "name is the metadata.name of the referenced secret",
					...
					"disabled": schema.BoolAttribute{
						...
						MarkdownDescription: "If set to true, disable the repo usage in the namespace",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_helm_openshift_io_project_helm_chart_repository_v1beta1_manifest")

	var model HelmOpenshiftIoProjectHelmChartRepositoryV1Beta1ManifestData
