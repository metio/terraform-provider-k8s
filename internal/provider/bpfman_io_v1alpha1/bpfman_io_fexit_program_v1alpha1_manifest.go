...
var (
	_ datasource.DataSource = &BpfmanIoFexitProgramV1Alpha1Manifest{}
)

func NewBpfmanIoFexitProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoFexitProgramV1Alpha1Manifest{}
}

type BpfmanIoFexitProgramV1Alpha1Manifest struct{}

type BpfmanIoFexitProgramV1Alpha1ManifestData struct {
...
func (r *BpfmanIoFexitProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_fexit_program_v1alpha1_manifest"
}
...
func (r *BpfmanIoFexitProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "FexitProgram is the Schema for the FexitPrograms API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "FexitProgramSpec defines the desired state of FexitProgram",
				Attributes: map[string]schema.Attribute{
					...
					"func_name": schema.StringAttribute{
						...
						MarkdownDescription: "Function to attach the fexit to.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *BpfmanIoFexitProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_fexit_program_v1alpha1_manifest")

	var model BpfmanIoFexitProgramV1Alpha1ManifestData
	...
	model.Kind = pointer.String("FexitProgram")
