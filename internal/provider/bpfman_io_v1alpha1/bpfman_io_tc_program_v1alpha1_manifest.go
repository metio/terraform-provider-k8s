...
var (
	_ datasource.DataSource = &BpfmanIoTcProgramV1Alpha1Manifest{}
)

func NewBpfmanIoTcProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoTcProgramV1Alpha1Manifest{}
}

type BpfmanIoTcProgramV1Alpha1Manifest struct{}

type BpfmanIoTcProgramV1Alpha1ManifestData struct {
...
func (r *BpfmanIoTcProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_tc_program_v1alpha1_manifest"
}
...
func (r *BpfmanIoTcProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "TcProgram is the Schema for the TcProgram API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TcProgramSpec defines the desired state of TcProgram",
				Attributes: map[string]schema.Attribute{
					...
					"direction": schema.StringAttribute{
						...
						MarkdownDescription: "Direction specifies the direction of traffic the tc program should attach to for a given network device.",
						Required:            true,
						Optional:            false,
						Computed:            false,
						Validators: []validator.String{
					...
					"priority": schema.Int64Attribute{
						...
						MarkdownDescription: "Priority specifies the priority of the tc program in relation to other programs of the same type with the same attach point. It is a value from 0 to 1000 where lower values have higher precedence.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					...
					"proceedon": schema.ListAttribute{
						...
						MarkdownDescription: "ProceedOn allows the user to call other tc programs in chain on this exit code. Multiple values are supported by repeating the parameter.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *BpfmanIoTcProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_tc_program_v1alpha1_manifest")

	var model BpfmanIoTcProgramV1Alpha1ManifestData
	...
	model.Kind = pointer.String("TcProgram")
