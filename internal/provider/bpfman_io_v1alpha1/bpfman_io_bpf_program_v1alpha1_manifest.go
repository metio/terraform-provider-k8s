...
var (
	_ datasource.DataSource = &BpfmanIoBpfProgramV1Alpha1Manifest{}
)

func NewBpfmanIoBpfProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoBpfProgramV1Alpha1Manifest{}
}

type BpfmanIoBpfProgramV1Alpha1Manifest struct{}

type BpfmanIoBpfProgramV1Alpha1ManifestData struct {
...
func (r *BpfmanIoBpfProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_bpf_program_v1alpha1_manifest"
}
...
func (r *BpfmanIoBpfProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "BpfProgram is the Schema for the Bpfprograms API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BpfProgramSpec defines the desired state of BpfProgram",
				Attributes: map[string]schema.Attribute{
					"type": schema.StringAttribute{
						Description:         "Type specifies the bpf program type",
						MarkdownDescription: "Type specifies the bpf program type",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *BpfmanIoBpfProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_bpf_program_v1alpha1_manifest")

	var model BpfmanIoBpfProgramV1Alpha1ManifestData
	...
	model.Kind = pointer.String("BpfProgram")
