...
var (
	_ datasource.DataSource = &BpfmanIoUprobeProgramV1Alpha1Manifest{}
)

func NewBpfmanIoUprobeProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoUprobeProgramV1Alpha1Manifest{}
}

type BpfmanIoUprobeProgramV1Alpha1Manifest struct{}

type BpfmanIoUprobeProgramV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Containers *struct {
			Containernames *[]string `tfsdk:"containernames" json:"containernames,omitempty"`
			Namespace      *string   `tfsdk:"namespace" json:"namespace,omitempty"`
			Pods           *struct {
...
func (r *BpfmanIoUprobeProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_uprobe_program_v1alpha1_manifest"
}
					...
					"containers": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"namespace": schema.StringAttribute{
								...
								MarkdownDescription: "Target namespaces.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"pods": schema.SingleNestedAttribute{
								Description:         "Target pods. This field must be specified, to select all pods use standard metav1.LabelSelector semantics and make it empty.",
								MarkdownDescription: "Target pods. This field must be specified, to select all pods use standard metav1.LabelSelector semantics and make it empty.",
								Attributes: map[string]schema.Attribute{
...
func (r *BpfmanIoUprobeProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_uprobe_program_v1alpha1_manifest")

	var model BpfmanIoUprobeProgramV1Alpha1ManifestData
