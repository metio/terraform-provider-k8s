...
var (
	_ datasource.DataSource = &BpfmanIoClusterBpfApplicationV1Alpha1Manifest{}
)

func NewBpfmanIoClusterBpfApplicationV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoClusterBpfApplicationV1Alpha1Manifest{}
}

type BpfmanIoClusterBpfApplicationV1Alpha1Manifest struct{}

type BpfmanIoClusterBpfApplicationV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Programs *[]struct {
			...
			} `tfsdk:"fentry" json:"fentry,omitempty"`
			Fexit *struct {
				Function *string `tfsdk:"function" json:"function,omitempty"`
				Links    *[]struct {
					Mode *string `tfsdk:"mode" json:"mode,omitempty"`
				} `tfsdk:"links" json:"links,omitempty"`
			} `tfsdk:"fexit" json:"fexit,omitempty"`
			Kprobe *struct {
				Links *[]struct {
					Function *string `tfsdk:"function" json:"function,omitempty"`
					Offset   *int64  `tfsdk:"offset" json:"offset,omitempty"`
				} `tfsdk:"links" json:"links,omitempty"`
			} `tfsdk:"kprobe" json:"kprobe,omitempty"`
			Kretprobe *struct {
				Links *[]struct {
					Function *string `tfsdk:"function" json:"function,omitempty"`
				} `tfsdk:"links" json:"links,omitempty"`
			} `tfsdk:"kretprobe" json:"kretprobe,omitempty"`
			Name *string `tfsdk:"name" json:"name,omitempty"`
			Tc   *struct {
				Links *[]struct {
			...
			} `tfsdk:"tracepoint" json:"tracepoint,omitempty"`
...
func (r *BpfmanIoClusterBpfApplicationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_cluster_bpf_application_v1alpha1_manifest"
}

func (r *BpfmanIoClusterBpfApplicationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ClusterBpfApplication is the schema for the cluster scoped BPF Applications API. This API allows applications to use bpfman to load and attach one or more eBPF programs on a Kubernetes cluster. The clusterBpfApplication.status field reports the overall status of the ClusterBpfApplication CRD. A given ClusterBpfApplication CRD can result in loading and attaching multiple eBPF programs on multiple nodes, so this status is just a summary. More granular per-node status details can be found in the corresponding ClusterBpfApplicationState CRD that bpfman creates for each node.",
		MarkdownDescription: "ClusterBpfApplication is the schema for the cluster scoped BPF Applications API. This API allows applications to use bpfman to load and attach one or more eBPF programs on a Kubernetes cluster. The clusterBpfApplication.status field reports the overall status of the ClusterBpfApplication CRD. A given ClusterBpfApplication CRD can result in loading and attaching multiple eBPF programs on multiple nodes, so this status is just a summary. More granular per-node status details can be found in the corresponding ClusterBpfApplicationState CRD that bpfman creates for each node.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "spec defines the desired state of the ClusterBpfApplication. The ClusterBpfApplication describes the set of one or more cluster scoped eBPF programs that should be loaded for a given application and attributes for how they should be loaded. eBPF programs that are grouped together under the same ClusterBpfApplication instance can share maps and global data between the eBPF programs loaded on the same Kubernetes Node.",
				...
				Attributes: map[string]schema.Attribute{
					...
					"programs": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"fentry": schema.SingleNestedAttribute{
									Description:         "fentry is an optional field, but required when the type field is set to FEntry. fentry defines the desired state of the application's FEntry programs. FEntry programs are attached to the entry of a Linux kernel function or to another eBPF program function. They are attached to the first instruction, before control passes to the function. FEntry programs are similar to KProbe programs, but have higher performance.",
									MarkdownDescription: "fentry is an optional field, but required when the type field is set to FEntry. fentry defines the desired state of the application's FEntry programs. FEntry programs are attached to the entry of a Linux kernel function or to another eBPF program function. They are attached to the first instruction, before control passes to the function. FEntry programs are similar to KProbe programs, but have higher performance.",
									Attributes: map[string]schema.Attribute{
										"function": schema.StringAttribute{
											Description:         "function is a required field and specifies the name of the Linux kernel function to attach the FEntry program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
											MarkdownDescription: "function is a required field and specifies the name of the Linux kernel function to attach the FEntry program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
											Required:            true,
											Optional:            false,
											Computed:            false,
											Validators: []validator.String{
										...
										"links": schema.ListNestedAttribute{
											Description:         "links is an optional field and is a flag to indicate if the FEntry program should be attached. The attachment point for a FEntry program is a Linux kernel function. Unlike other eBPF program types, an FEntry program must be provided with the target function at load time. The links field is optional, but unlike other program types where it represents a list of attachment points, for FEntry programs it contains at most one entry that determines whether the program should be attached to the specified function. To attach the program, add an entry to links with mode set to Attach. To detach it, remove the entry from links.",
											MarkdownDescription: "links is an optional field and is a flag to indicate if the FEntry program should be attached. The attachment point for a FEntry program is a Linux kernel function. Unlike other eBPF program types, an FEntry program must be provided with the target function at load time. The links field is optional, but unlike other program types where it represents a list of attachment points, for FEntry programs it contains at most one entry that determines whether the program should be attached to the specified function. To attach the program, add an entry to links with mode set to Attach. To detach it, remove the entry from links.",
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"mode": schema.StringAttribute{
														Description:         "mode is a required field. When set to Attach, the FEntry program will attempt to be attached. To detach the FEntry program, remove the link entry.",
														MarkdownDescription: "mode is a required field. When set to Attach, the FEntry program will attempt to be attached. To detach the FEntry program, remove the link entry.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
															stringvalidator.OneOf("Attach"),
														},
													},
												},
											},
								...
								"fexit": schema.SingleNestedAttribute{
									Description:         "fexit is an optional field, but required when the type field is set to FExit. fexit defines the desired state of the application's FExit programs. FExit programs are attached to the exit of a Linux kernel function or to another eBPF program function. The program is invoked when the function returns, independent of where in the function that occurs. FExit programs are similar to KRetProbe programs, but get invoked with the input arguments and the return values. They also have higher performance over KRetProbe programs.",
									MarkdownDescription: "fexit is an optional field, but required when the type field is set to FExit. fexit defines the desired state of the application's FExit programs. FExit programs are attached to the exit of a Linux kernel function or to another eBPF program function. The program is invoked when the function returns, independent of where in the function that occurs. FExit programs are similar to KRetProbe programs, but get invoked with the input arguments and the return values. They also have higher performance over KRetProbe programs.",
									Attributes: map[string]schema.Attribute{
										"function": schema.StringAttribute{
											Description:         "function is a required field and specifies the name of the Linux kernel function to attach the FExit program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
											MarkdownDescription: "function is a required field and specifies the name of the Linux kernel function to attach the FExit program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
											Required:            true,
											Optional:            false,
											Computed:            false,
											Validators: []validator.String{
										...
										"links": schema.ListNestedAttribute{
											Description:         "links is an optional field and is a flag to indicate if the FExit program should be attached. The attachment point for a FExit program is a Linux kernel function. Unlike other eBPF program types, an FExit program must be provided with the target function at load time. The links field is optional, but unlike other program types where it represents a list of attachment points, for FExit programs it contains at most one entry that determines whether the program should be attached to the specified function. To attach the program, add an entry to links with mode set to Attach. To detach it, remove the entry from links.",
											MarkdownDescription: "links is an optional field and is a flag to indicate if the FExit program should be attached. The attachment point for a FExit program is a Linux kernel function. Unlike other eBPF program types, an FExit program must be provided with the target function at load time. The links field is optional, but unlike other program types where it represents a list of attachment points, for FExit programs it contains at most one entry that determines whether the program should be attached to the specified function. To attach the program, add an entry to links with mode set to Attach. To detach it, remove the entry from links.",
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"mode": schema.StringAttribute{
														Description:         "mode is a required field. When set to Attach, the FExit program will attempt to be attached. To detach the FExit program, remove the link entry.",
														MarkdownDescription: "mode is a required field. When set to Attach, the FExit program will attempt to be attached. To detach the FExit program, remove the link entry.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
								...
								"kprobe": schema.SingleNestedAttribute{
									Description:         "kprobe is an optional field, but required when the type field is set to KProbe. kprobe defines the desired state of the application's Kprobe programs. KProbe programs are attached to a Linux kernel function. Unlike FEntry programs, which must always be attached at the entry point of a Linux kernel function, KProbe programs can be attached at any point in the function using the optional offset field. However, caution must be taken when using the offset, ensuring the offset is still in the function bytecode. FEntry programs have less overhead than KProbe programs.",
									MarkdownDescription: "kprobe is an optional field, but required when the type field is set to KProbe. kprobe defines the desired state of the application's Kprobe programs. KProbe programs are attached to a Linux kernel function. Unlike FEntry programs, which must always be attached at the entry point of a Linux kernel function, KProbe programs can be attached at any point in the function using the optional offset field. However, caution must be taken when using the offset, ensuring the offset is still in the function bytecode. FEntry programs have less overhead than KProbe programs.",
									Attributes: map[string]schema.Attribute{
										"links": schema.ListNestedAttribute{
											Description:         "links is an optional field and is the list of attachment points to which the KProbe program should be attached. The eBPF program is loaded in kernel memory when the BPF Application CRD is created and the selected Kubernetes nodes are active. The eBPF program will not be triggered until the program has also been attached to an attachment point described in this list. Items may be added or removed from the list at any point, causing the eBPF program to be attached or detached. The attachment point for a KProbe program is a Linux kernel function. By default, the eBPF program is triggered at the entry of the attachment point, but the attachment point can be adjusted using an optional offset.",
											MarkdownDescription: "links is an optional field and is the list of attachment points to which the KProbe program should be attached. The eBPF program is loaded in kernel memory when the BPF Application CRD is created and the selected Kubernetes nodes are active. The eBPF program will not be triggered until the program has also been attached to an attachment point described in this list. Items may be added or removed from the list at any point, causing the eBPF program to be attached or detached. The attachment point for a KProbe program is a Linux kernel function. By default, the eBPF program is triggered at the entry of the attachment point, but the attachment point can be adjusted using an optional offset.",
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"function": schema.StringAttribute{
														Description:         "function is a required field and specifies the name of the Linux kernel function to attach the KProbe program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
														MarkdownDescription: "function is a required field and specifies the name of the Linux kernel function to attach the KProbe program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
								...
								"kretprobe": schema.SingleNestedAttribute{
									Description:         "kretprobe is an optional field, but required when the type field is set to KRetProbe. kretprobe defines the desired state of the application's KRetProbe programs. KRetProbe programs are attached to the exit of a Linux kernel function. FExit programs have less overhead than KRetProbe programs and FExit programs have access to both the input arguments as well as the return values. KRetProbes only have access to the return values.",
									MarkdownDescription: "kretprobe is an optional field, but required when the type field is set to KRetProbe. kretprobe defines the desired state of the application's KRetProbe programs. KRetProbe programs are attached to the exit of a Linux kernel function. FExit programs have less overhead than KRetProbe programs and FExit programs have access to both the input arguments as well as the return values. KRetProbes only have access to the return values.",
									Attributes: map[string]schema.Attribute{
										"links": schema.ListNestedAttribute{
											Description:         "links is an optional field and is the list of attachment points to which the KRetProbe program should be attached. The eBPF program is loaded in kernel memory when the BPF Application CRD is created and the selected Kubernetes nodes are active. The eBPF program will not be triggered until the program has also been attached to an attachment point described in this list. Items may be added or removed from the list at any point, causing the eBPF program to be attached or detached. The attachment point for a KRetProbe program is a Linux kernel function.",
											MarkdownDescription: "links is an optional field and is the list of attachment points to which the KRetProbe program should be attached. The eBPF program is loaded in kernel memory when the BPF Application CRD is created and the selected Kubernetes nodes are active. The eBPF program will not be triggered until the program has also been attached to an attachment point described in this list. Items may be added or removed from the list at any point, causing the eBPF program to be attached or detached. The attachment point for a KRetProbe program is a Linux kernel function.",
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"function": schema.StringAttribute{
														Description:         "function is a required field and specifies the name of the Linux kernel function to attach the KRetProbe program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
														MarkdownDescription: "function is a required field and specifies the name of the Linux kernel function to attach the KRetProbe program. function must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													...
													"network_namespaces": schema.SingleNestedAttribute{
														Description:         "networkNamespaces is an optional field that identifies the set of network namespaces in which to attach the eBPF program. If networkNamespaces is not specified, the eBPF program will be attached in the root network namespace.",
														MarkdownDescription: "networkNamespaces is an optional field that identifies the set of network namespaces in which to attach the eBPF program. If networkNamespaces is not specified, the eBPF program will be attached in the root network namespace.",
														Attributes: map[string]schema.Attribute{
															"namespace": schema.StringAttribute{
																Description:         "namespace is an optional field and indicates the target network namespace. If not provided, the default network namespace is used.",
																MarkdownDescription: "namespace is an optional field and indicates the target network namespace. If not provided, the default network namespace is used.",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
								...
								"tracepoint": schema.SingleNestedAttribute{
									Description:         "tracepoint is an optional field, but required when the type field is set to Tracepoint. tracepoint defines the desired state of the application's Tracepoint programs. Whereas KProbes attach to dynamically to any Linux kernel function, Tracepoint programs are programs that can only be attached at predefined locations in the Linux kernel. Use the following command to see the available attachment points: 'sudo find /sys/kernel/debug/tracing/events -type d' While KProbes are more flexible in where in the kernel the probe can be attached, the functions and data structure rely on the kernel your system is running. Tracepoints tend to be more stable across kernel versions and are better for portability.",
									MarkdownDescription: "tracepoint is an optional field, but required when the type field is set to Tracepoint. tracepoint defines the desired state of the application's Tracepoint programs. Whereas KProbes attach to dynamically to any Linux kernel function, Tracepoint programs are programs that can only be attached at predefined locations in the Linux kernel. Use the following command to see the available attachment points: 'sudo find /sys/kernel/debug/tracing/events -type d' While KProbes are more flexible in where in the kernel the probe can be attached, the functions and data structure rely on the kernel your system is running. Tracepoints tend to be more stable across kernel versions and are better for portability.",
									Attributes: map[string]schema.Attribute{
										"links": schema.ListNestedAttribute{
											Description:         "links is an optional field and is the list of attachment points to which the Tracepoint program should be attached. The Tracepoint program is loaded in kernel memory when the BPF Application CRD is created and the selected Kubernetes nodes are active. The Tracepoint program will not be triggered until the program has also been attached to an attachment point described in this list. Items may be added or removed from the list at any point, causing the Tracepoint program to be attached or detached. The attachment point for a Tracepoint program is a one of a predefined set of Linux kernel functions.",
											MarkdownDescription: "links is an optional field and is the list of attachment points to which the Tracepoint program should be attached. The Tracepoint program is loaded in kernel memory when the BPF Application CRD is created and the selected Kubernetes nodes are active. The Tracepoint program will not be triggered until the program has also been attached to an attachment point described in this list. Items may be added or removed from the list at any point, causing the Tracepoint program to be attached or detached. The attachment point for a Tracepoint program is a one of a predefined set of Linux kernel functions.",
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"name": schema.StringAttribute{
														Description:         "name is a required field and specifies the name of the Linux kernel Tracepoint to attach the eBPF program. name must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
														MarkdownDescription: "name is a required field and specifies the name of the Linux kernel Tracepoint to attach the eBPF program. name must not be an empty string, must not exceed 64 characters in length, must start with alpha characters and must only contain alphanumeric characters.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
								...
								"type": schema.StringAttribute{
									...
									Computed:            false,
									Validators: []validator.String{
										stringvalidator.OneOf("XDP", "TC", "TCX", "FEntry", "FExit", "KProbe", "KRetProbe", "UProbe", "URetProbe", "TracePoint"),
									},
								},
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"containers": schema.SingleNestedAttribute{
														Description:         "containers is an optional field that identifies the set of containers in which to attach the UProbe or URetProbe program. If containers is not specified, the eBPF program will be attached in the bpfman container.",
														MarkdownDescription: "containers is an optional field that identifies the set of containers in which to attach the UProbe or URetProbe program. If containers is not specified, the eBPF program will be attached in the bpfman container.",
														Attributes: map[string]schema.Attribute{
															...
															"namespace": schema.StringAttribute{
																Description:         "namespace is an optional field and indicates the target Kubernetes namespace. If not provided, all Kubernetes namespaces are included.",
																MarkdownDescription: "namespace is an optional field and indicates the target Kubernetes namespace. If not provided, all Kubernetes namespaces are included.",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
													...
													"offset": schema.Int64Attribute{
														Description:         "offset is an optional field and the value is added to the address of the attachment point function.",
														MarkdownDescription: "offset is an optional field and the value is added to the address of the attachment point function.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
										...
										"links": schema.ListNestedAttribute{
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													...
													"network_namespaces": schema.SingleNestedAttribute{
														Description:         "networkNamespaces identifies the set of network namespaces in which to attach the eBPF program. If networkNamespaces is not specified, the eBPF program will be attached in the root network namespace.",
														MarkdownDescription: "networkNamespaces identifies the set of network namespaces in which to attach the eBPF program. If networkNamespaces is not specified, the eBPF program will be attached in the root network namespace.",
														Attributes: map[string]schema.Attribute{
															"namespace": schema.StringAttribute{
																Description:         "namespace is an optional field and indicates the target network namespace. If not provided, the default network namespace is used.",
																MarkdownDescription: "namespace is an optional field and indicates the target network namespace. If not provided, the default network namespace is used.",
...
func (r *BpfmanIoClusterBpfApplicationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_cluster_bpf_application_v1alpha1_manifest")

	var model BpfmanIoClusterBpfApplicationV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ClusterBpfApplication")
