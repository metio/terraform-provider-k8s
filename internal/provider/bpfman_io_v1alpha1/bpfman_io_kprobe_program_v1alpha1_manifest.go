...
var (
	_ datasource.DataSource = &BpfmanIoKprobeProgramV1Alpha1Manifest{}
)

func NewBpfmanIoKprobeProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoKprobeProgramV1Alpha1Manifest{}
}

type BpfmanIoKprobeProgramV1Alpha1Manifest struct{}

type BpfmanIoKprobeProgramV1Alpha1ManifestData struct {
...
func (r *BpfmanIoKprobeProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_kprobe_program_v1alpha1_manifest"
}
...
func (r *BpfmanIoKprobeProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "KprobeProgram is the Schema for the KprobePrograms API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "KprobeProgramSpec defines the desired state of KprobeProgram",
				Attributes: map[string]schema.Attribute{
					...
					"func_name": schema.StringAttribute{
						...
						MarkdownDescription: "Functions to attach the kprobe to.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"offset": schema.Int64Attribute{
						...
						MarkdownDescription: "Offset added to the address of the function for kprobe. Not allowed for kretprobes.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *BpfmanIoKprobeProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_kprobe_program_v1alpha1_manifest")

	var model BpfmanIoKprobeProgramV1Alpha1ManifestData
	...
	model.Kind = pointer.String("KprobeProgram")
