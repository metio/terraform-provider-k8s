...
var (
	_ datasource.DataSource = &BpfmanIoFentryProgramV1Alpha1Manifest{}
)

func NewBpfmanIoFentryProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfmanIoFentryProgramV1Alpha1Manifest{}
}

type BpfmanIoFentryProgramV1Alpha1Manifest struct{}

type BpfmanIoFentryProgramV1Alpha1ManifestData struct {
...
func (r *BpfmanIoFentryProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfman_io_fentry_program_v1alpha1_manifest"
}
...
func (r *BpfmanIoFentryProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "FentryProgram is the Schema for the FentryPrograms API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "FentryProgramSpec defines the desired state of FentryProgram",
				Attributes: map[string]schema.Attribute{
					...
					"func_name": schema.StringAttribute{
						...
						MarkdownDescription: "Function to attach the fentry to.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *BpfmanIoFentryProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfman_io_fentry_program_v1alpha1_manifest")

	var model BpfmanIoFentryProgramV1Alpha1ManifestData
	...
	model.Kind = pointer.String("FentryProgram")
