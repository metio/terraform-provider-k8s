...
var (
	_ resource.Resource = (*CephRookIoCephFilesystemMirrorV1Resource)(nil)
)

type CephRookIoCephFilesystemMirrorV1TerraformModel struct {
...
type CephRookIoCephFilesystemMirrorV1GoModel struct {
...
func (r *CephRookIoCephFilesystemMirrorV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ceph_rook_io_ceph_filesystem_mirror_v1"
}

func (r *CephRookIoCephFilesystemMirrorV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *CephRookIoCephFilesystemMirrorV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_ceph_rook_io_ceph_filesystem_mirror_v1")

	var state CephRookIoCephFilesystemMirrorV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CephRookIoCephFilesystemMirrorV1GoModel
	...
	goModel.Kind = utilities.Ptr("CephFilesystemMirror")
...
func (r *CephRookIoCephFilesystemMirrorV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ceph_rook_io_ceph_filesystem_mirror_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *CephRookIoCephFilesystemMirrorV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CephRookIoCephFilesystemMirrorV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
