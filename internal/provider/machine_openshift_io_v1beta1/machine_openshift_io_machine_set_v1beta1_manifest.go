...
var (
	_ datasource.DataSource = &MachineOpenshiftIoMachineSetV1Beta1Manifest{}
)

func NewMachineOpenshiftIoMachineSetV1Beta1Manifest() datasource.DataSource {
	return &MachineOpenshiftIoMachineSetV1Beta1Manifest{}
}

type MachineOpenshiftIoMachineSetV1Beta1Manifest struct{}

type MachineOpenshiftIoMachineSetV1Beta1ManifestData struct {
...
func (r *MachineOpenshiftIoMachineSetV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_machine_openshift_io_machine_set_v1beta1_manifest"
}

func (r *MachineOpenshiftIoMachineSetV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "MachineSet ensures that a specified number of machines replicas are running at any given time. Compatibility level 2: Stable within a major release for a minimum of 9 months or 3 minor releases (whichever is longer).",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Template is the object that describes the machine that will be created if insufficient replicas are detected.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
...
func (r *MachineOpenshiftIoMachineSetV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_machine_openshift_io_machine_set_v1beta1_manifest")

	var model MachineOpenshiftIoMachineSetV1Beta1ManifestData
