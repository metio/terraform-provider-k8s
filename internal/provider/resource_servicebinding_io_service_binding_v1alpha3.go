...
var (
	_ resource.Resource = (*ServicebindingIoServiceBindingV1Alpha3Resource)(nil)
)

type ServicebindingIoServiceBindingV1Alpha3TerraformModel struct {
...
type ServicebindingIoServiceBindingV1Alpha3GoModel struct {
...
func (r *ServicebindingIoServiceBindingV1Alpha3Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_servicebinding_io_service_binding_v1alpha3"
}

func (r *ServicebindingIoServiceBindingV1Alpha3Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ServicebindingIoServiceBindingV1Alpha3Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_servicebinding_io_service_binding_v1alpha3")

	var state ServicebindingIoServiceBindingV1Alpha3TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ServicebindingIoServiceBindingV1Alpha3GoModel
...
func (r *ServicebindingIoServiceBindingV1Alpha3Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_servicebinding_io_service_binding_v1alpha3")
	// NO-OP: All data is already in Terraform state
}

func (r *ServicebindingIoServiceBindingV1Alpha3Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ServicebindingIoServiceBindingV1Alpha3Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
