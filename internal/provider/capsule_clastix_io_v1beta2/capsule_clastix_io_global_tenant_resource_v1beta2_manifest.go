...
var (
	_ datasource.DataSource = &CapsuleClastixIoGlobalTenantResourceV1Beta2Manifest{}
)

func NewCapsuleClastixIoGlobalTenantResourceV1Beta2Manifest() datasource.DataSource {
	return &CapsuleClastixIoGlobalTenantResourceV1Beta2Manifest{}
}

type CapsuleClastixIoGlobalTenantResourceV1Beta2Manifest struct{}

type CapsuleClastixIoGlobalTenantResourceV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		TenantSelector *struct {
			...
			MatchLabels *map[string]string `tfsdk:"match_labels" json:"matchLabels,omitempty"`
		} `tfsdk:"tenant_selector" json:"tenantSelector,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *CapsuleClastixIoGlobalTenantResourceV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capsule_clastix_io_global_tenant_resource_v1beta2_manifest"
}

func (r *CapsuleClastixIoGlobalTenantResourceV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GlobalTenantResource allows to propagate resource replications to a specific subset of Tenant resources.",
		MarkdownDescription: "GlobalTenantResource allows to propagate resource replications to a specific subset of Tenant resources.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GlobalTenantResourceSpec defines the desired state of GlobalTenantResource.",
				Attributes: map[string]schema.Attribute{
					...
					"tenant_selector": schema.SingleNestedAttribute{
						Description:         "Defines the Tenant selector used target the tenants on which resources must be propagated.",
						MarkdownDescription: "Defines the Tenant selector used target the tenants on which resources must be propagated.",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
...
func (r *CapsuleClastixIoGlobalTenantResourceV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_capsule_clastix_io_global_tenant_resource_v1beta2_manifest")

	var model CapsuleClastixIoGlobalTenantResourceV1Beta2ManifestData
	...
	model.Kind = pointer.String("GlobalTenantResource")
