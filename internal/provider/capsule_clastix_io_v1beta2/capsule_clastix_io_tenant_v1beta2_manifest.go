...
var (
	_ datasource.DataSource = &CapsuleClastixIoTenantV1Beta2Manifest{}
)

func NewCapsuleClastixIoTenantV1Beta2Manifest() datasource.DataSource {
	return &CapsuleClastixIoTenantV1Beta2Manifest{}
}

type CapsuleClastixIoTenantV1Beta2Manifest struct{}

type CapsuleClastixIoTenantV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"gateway_options" json:"gatewayOptions,omitempty"`
...
func (r *CapsuleClastixIoTenantV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capsule_clastix_io_tenant_v1beta2_manifest"
}

func (r *CapsuleClastixIoTenantV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"gateway_options": schema.SingleNestedAttribute{
						Description:         "Specifies options for the GatewayClass resources.",
						MarkdownDescription: "Specifies options for the GatewayClass resources.",
						Attributes: map[string]schema.Attribute{
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"pod_selector": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "podSelector selects the pods to which this NetworkPolicy object applies. The array of rules is applied to any pods selected by this field. An empty selector matches all pods in the policy's namespace. Multiple network policies can select the same set of pods. In this case, the ingress rules for each are combined additively. This field is optional. If it is not specified, it defaults to an empty selector.",
											Attributes: map[string]schema.Attribute{
												"match_expressions": schema.ListNestedAttribute{
													Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
													MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
...
func (r *CapsuleClastixIoTenantV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_capsule_clastix_io_tenant_v1beta2_manifest")

	var model CapsuleClastixIoTenantV1Beta2ManifestData
