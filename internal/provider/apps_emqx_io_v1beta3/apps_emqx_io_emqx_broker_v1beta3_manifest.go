...
var (
	_ datasource.DataSource = &AppsEmqxIoEmqxBrokerV1Beta3Manifest{}
)

func NewAppsEmqxIoEmqxBrokerV1Beta3Manifest() datasource.DataSource {
	return &AppsEmqxIoEmqxBrokerV1Beta3Manifest{}
}

type AppsEmqxIoEmqxBrokerV1Beta3Manifest struct{}

type AppsEmqxIoEmqxBrokerV1Beta3ManifestData struct {
...
func (r *AppsEmqxIoEmqxBrokerV1Beta3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_emqx_io_emqx_broker_v1beta3_manifest"
}

func (r *AppsEmqxIoEmqxBrokerV1Beta3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsEmqxIoEmqxBrokerV1Beta3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_emqx_io_emqx_broker_v1beta3_manifest")

	var model AppsEmqxIoEmqxBrokerV1Beta3ManifestData
