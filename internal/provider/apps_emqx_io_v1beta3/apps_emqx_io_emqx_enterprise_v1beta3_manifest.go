...
var (
	_ datasource.DataSource = &AppsEmqxIoEmqxEnterpriseV1Beta3Manifest{}
)

func NewAppsEmqxIoEmqxEnterpriseV1Beta3Manifest() datasource.DataSource {
	return &AppsEmqxIoEmqxEnterpriseV1Beta3Manifest{}
}

type AppsEmqxIoEmqxEnterpriseV1Beta3Manifest struct{}

type AppsEmqxIoEmqxEnterpriseV1Beta3ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"emqx_template" json:"emqxTemplate,omitempty"`
		Env *[]struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Value     *string `tfsdk:"value" json:"value,omitempty"`
			ValueFrom *struct {
...
func (r *AppsEmqxIoEmqxEnterpriseV1Beta3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_emqx_io_emqx_enterprise_v1beta3_manifest"
}

func (r *AppsEmqxIoEmqxEnterpriseV1Beta3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"emqx_template": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
...
func (r *AppsEmqxIoEmqxEnterpriseV1Beta3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_emqx_io_emqx_enterprise_v1beta3_manifest")

	var model AppsEmqxIoEmqxEnterpriseV1Beta3ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("apps.emqx.io/v1beta3")
