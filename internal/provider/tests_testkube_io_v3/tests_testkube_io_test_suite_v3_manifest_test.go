...
func TestTestsTestkubeIoTestSuiteV3Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_tests_testkube_io_test_suite_v3_manifest", testCase)
		})
	}
}
