...
func TestSloKoordinatorShNodeSLOV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_slo_koordinator_sh_node_slo_v1alpha1", testCase)
		})
	}
}
