...
var (
	_ datasource.DataSource              = &SloKoordinatorShNodeMetricV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &SloKoordinatorShNodeMetricV1Alpha1DataSource{}
)

func NewSloKoordinatorShNodeMetricV1Alpha1DataSource() datasource.DataSource {
	return &SloKoordinatorShNodeMetricV1Alpha1DataSource{}
}

type SloKoordinatorShNodeMetricV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SloKoordinatorShNodeMetricV1Alpha1DataSourceData struct {
...
func (r *SloKoordinatorShNodeMetricV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_slo_koordinator_sh_node_metric_v1alpha1"
}

func (r *SloKoordinatorShNodeMetricV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SloKoordinatorShNodeMetricV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SloKoordinatorShNodeMetricV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_slo_koordinator_sh_node_metric_v1alpha1")

	var data SloKoordinatorShNodeMetricV1Alpha1DataSourceData
	...
	var readResponse SloKoordinatorShNodeMetricV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("NodeMetric")
