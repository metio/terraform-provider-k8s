...
package repo_manager_pulpproject_org_v1
...
var (
	_ datasource.DataSource = &RepoManagerPulpprojectOrgPulpV1Manifest{}
)

func NewRepoManagerPulpprojectOrgPulpV1Manifest() datasource.DataSource {
	return &RepoManagerPulpprojectOrgPulpV1Manifest{}
}

type RepoManagerPulpprojectOrgPulpV1Manifest struct{}

type RepoManagerPulpprojectOrgPulpV1ManifestData struct {
...
func (r *RepoManagerPulpprojectOrgPulpV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_repo_manager_pulpproject_org_pulp_v1_manifest"
}

func (r *RepoManagerPulpprojectOrgPulpV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"allowed_content_checksums": schema.ListAttribute{
						Description:         "List of allowed checksum algorithms used to verify repository's integrity. Valid options: ['md5','sha1','sha224','sha256','sha384','sha512'].",
						MarkdownDescription: "List of allowed checksum algorithms used to verify repository's integrity. Valid options: ['md5','sha1','sha224','sha256','sha384','sha512'].",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"content": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"replicas": schema.Int64Attribute{
								Description:         "Size is the size of number of pulp-content replicas. Default: 1",
								MarkdownDescription: "Size is the size of number of pulp-content replicas. Default: 1",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
					...
					"image_pull_policy": schema.StringAttribute{
						...
						MarkdownDescription: "Image pull policy for container image.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"worker": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"replicas": schema.Int64Attribute{
								Description:         "Size is the size of number of pulp-worker replicas. Default: 1",
								MarkdownDescription: "Size is the size of number of pulp-worker replicas. Default: 1",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
...
func (r *RepoManagerPulpprojectOrgPulpV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_repo_manager_pulpproject_org_pulp_v1_manifest")

	var model RepoManagerPulpprojectOrgPulpV1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("repo-manager.pulpproject.org/v1")
