...
var (
	_ datasource.DataSource = &RepoManagerPulpprojectOrgPulpBackupV1Manifest{}
)

func NewRepoManagerPulpprojectOrgPulpBackupV1Manifest() datasource.DataSource {
	return &RepoManagerPulpprojectOrgPulpBackupV1Manifest{}
}

type RepoManagerPulpprojectOrgPulpBackupV1Manifest struct{}

type RepoManagerPulpprojectOrgPulpBackupV1ManifestData struct {
...
func (r *RepoManagerPulpprojectOrgPulpBackupV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_repo_manager_pulpproject_org_pulp_backup_v1_manifest"
}

func (r *RepoManagerPulpprojectOrgPulpBackupV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"deployment_name": schema.StringAttribute{
						Description:         "Name of Pulp CR to be backed up",
						MarkdownDescription: "Name of Pulp CR to be backed up",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RepoManagerPulpprojectOrgPulpBackupV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_repo_manager_pulpproject_org_pulp_backup_v1_manifest")

	var model RepoManagerPulpprojectOrgPulpBackupV1ManifestData
