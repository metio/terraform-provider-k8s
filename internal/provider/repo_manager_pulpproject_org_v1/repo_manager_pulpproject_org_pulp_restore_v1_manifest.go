...
var (
	_ datasource.DataSource = &RepoManagerPulpprojectOrgPulpRestoreV1Manifest{}
)

func NewRepoManagerPulpprojectOrgPulpRestoreV1Manifest() datasource.DataSource {
	return &RepoManagerPulpprojectOrgPulpRestoreV1Manifest{}
}

type RepoManagerPulpprojectOrgPulpRestoreV1Manifest struct{}

type RepoManagerPulpprojectOrgPulpRestoreV1ManifestData struct {
...
func (r *RepoManagerPulpprojectOrgPulpRestoreV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_repo_manager_pulpproject_org_pulp_restore_v1_manifest"
}

func (r *RepoManagerPulpprojectOrgPulpRestoreV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"backup_name": schema.StringAttribute{
						Description:         "Name of PulpBackup CR",
						MarkdownDescription: "Name of PulpBackup CR",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"deployment_name": schema.StringAttribute{
						Description:         "Name of Pulp CR to be restored",
						MarkdownDescription: "Name of Pulp CR to be restored",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RepoManagerPulpprojectOrgPulpRestoreV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_repo_manager_pulpproject_org_pulp_restore_v1_manifest")

	var model RepoManagerPulpprojectOrgPulpRestoreV1ManifestData
