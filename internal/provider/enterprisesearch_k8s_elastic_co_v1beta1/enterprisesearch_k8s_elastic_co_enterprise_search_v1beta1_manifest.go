...
var (
	_ datasource.DataSource = &EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest{}
)

func NewEnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest() datasource.DataSource {
	return &EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest{}
}

type EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest struct{}

type EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1ManifestData struct {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_enterprisesearch_k8s_elastic_co_enterprise_search_v1beta1_manifest"
}

func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1beta1_manifest")

	var model EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1ManifestData
