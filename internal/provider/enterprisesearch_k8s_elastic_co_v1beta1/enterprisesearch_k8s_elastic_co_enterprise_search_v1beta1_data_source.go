...
var (
	_ datasource.DataSource              = &EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource{}
)

func NewEnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource() datasource.DataSource {
	return &EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource{}
}

type EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSourceData struct {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_enterprisesearch_k8s_elastic_co_enterprise_search_v1beta1"
}

func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1beta1")

	var data EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "enterprisesearch.k8s.elastic.co", Version: "v1beta1", Resource: "enterprisesearches"}).
	...
	var readResponse EnterprisesearchK8SElasticCoEnterpriseSearchV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("enterprisesearch.k8s.elastic.co/v1beta1")
	data.Kind = pointer.String("EnterpriseSearch")
