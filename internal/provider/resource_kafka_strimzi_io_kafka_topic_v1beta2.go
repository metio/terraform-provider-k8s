...
type KafkaStrimziIoKafkaTopicV1Beta2Resource struct{}

var (
	_ resource.Resource = (*KafkaStrimziIoKafkaTopicV1Beta2Resource)(nil)
)

type KafkaStrimziIoKafkaTopicV1Beta2TerraformModel struct {
...
type KafkaStrimziIoKafkaTopicV1Beta2GoModel struct {
...
func NewKafkaStrimziIoKafkaTopicV1Beta2Resource() resource.Resource {
	return &KafkaStrimziIoKafkaTopicV1Beta2Resource{}
}

func (r *KafkaStrimziIoKafkaTopicV1Beta2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kafka_strimzi_io_kafka_topic_v1beta2"
}

func (r *KafkaStrimziIoKafkaTopicV1Beta2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kafka_strimzi_io_kafka_topic_v1beta2")

	var state KafkaStrimziIoKafkaTopicV1Beta2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KafkaStrimziIoKafkaTopicV1Beta2GoModel
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_topic_v1beta2")
	// NO-OP: All data is already in Terraform state
}

func (r *KafkaStrimziIoKafkaTopicV1Beta2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_kafka_strimzi_io_kafka_topic_v1beta2")
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_kafka_strimzi_io_kafka_topic_v1beta2")
