...
var (
	_ datasource.DataSource = &KafkaStackableTechKafkaClusterV1Alpha1Manifest{}
)

func NewKafkaStackableTechKafkaClusterV1Alpha1Manifest() datasource.DataSource {
	return &KafkaStackableTechKafkaClusterV1Alpha1Manifest{}
}

type KafkaStackableTechKafkaClusterV1Alpha1Manifest struct{}

type KafkaStackableTechKafkaClusterV1Alpha1ManifestData struct {
			...
			Config       *struct {
				...
				Resources               *struct {
					...
					Storage *struct {
						...
						} `tfsdk:"log_dirs" json:"logDirs,omitempty"`
...
func (r *KafkaStackableTechKafkaClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_stackable_tech_kafka_cluster_v1alpha1_manifest"
}

func (r *KafkaStackableTechKafkaClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Auto-generated derived type for KafkaClusterSpec via 'CustomResource'",
		MarkdownDescription: "Auto-generated derived type for KafkaClusterSpec via 'CustomResource'",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "A Kafka cluster stacklet. This resource is managed by the Stackable operator for Apache Kafka. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/kafka/).",
				Attributes: map[string]schema.Attribute{
									...
									"resources": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"storage": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"log_dirs": schema.SingleNestedAttribute{
														Description:         "",
														MarkdownDescription: "",
														Attributes: map[string]schema.Attribute{
					...
					"cluster_config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"authorization": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Authorization settings for Kafka like OPA.",
								Attributes: map[string]schema.Attribute{
							...
							"tls": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "TLS encryption settings for Kafka (server, internal).",
								Attributes: map[string]schema.Attribute{
									...
									"server_secret_class": schema.StringAttribute{
										...
										MarkdownDescription: "The [SecretClass](https://docs.stackable.tech/home/nightly/secret-operator/secretclass.html) to use for client connections. This setting controls: - If TLS encryption is used at all - Which cert the servers should use to authenticate themselves against the client Defaults to 'tls'.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"zookeeper_config_map_name": schema.StringAttribute{
								Description:         "Kafka requires a ZooKeeper cluster connection to run. Provide the name of the ZooKeeper [discovery ConfigMap](https://docs.stackable.tech/home/nightly/concepts/service_discovery) here. When using the [Stackable operator for Apache ZooKeeper](https://docs.stackable.tech/home/nightly/zookeeper/) to deploy a ZooKeeper cluster, this will simply be the name of your ZookeeperCluster resource.",
								MarkdownDescription: "Kafka requires a ZooKeeper cluster connection to run. Provide the name of the ZooKeeper [discovery ConfigMap](https://docs.stackable.tech/home/nightly/concepts/service_discovery) here. When using the [Stackable operator for Apache ZooKeeper](https://docs.stackable.tech/home/nightly/zookeeper/) to deploy a ZooKeeper cluster, this will simply be the name of your ZookeeperCluster resource.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
...
func (r *KafkaStackableTechKafkaClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_stackable_tech_kafka_cluster_v1alpha1_manifest")

	var model KafkaStackableTechKafkaClusterV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("kafka.stackable.tech/v1alpha1")
	model.Kind = pointer.String("KafkaCluster")
