...
var (
	_ datasource.DataSource = &ExternaldataGatekeeperShProviderV1Alpha1Manifest{}
)

func NewExternaldataGatekeeperShProviderV1Alpha1Manifest() datasource.DataSource {
	return &ExternaldataGatekeeperShProviderV1Alpha1Manifest{}
}

type ExternaldataGatekeeperShProviderV1Alpha1Manifest struct{}

type ExternaldataGatekeeperShProviderV1Alpha1ManifestData struct {
...
func (r *ExternaldataGatekeeperShProviderV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_externaldata_gatekeeper_sh_provider_v1alpha1_manifest"
}
...
func (r *ExternaldataGatekeeperShProviderV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_externaldata_gatekeeper_sh_provider_v1alpha1_manifest")

	var model ExternaldataGatekeeperShProviderV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("externaldata.gatekeeper.sh/v1alpha1")
