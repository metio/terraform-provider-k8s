...
func TestMetal3IoBMCEventSubscriptionV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_metal3_io_bmc_event_subscription_v1alpha1_manifest", testCase)
		})
	}
}
