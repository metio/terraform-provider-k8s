...
var (
	_ datasource.DataSource              = &Metal3IoBareMetalHostV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &Metal3IoBareMetalHostV1Alpha1DataSource{}
)

func NewMetal3IoBareMetalHostV1Alpha1DataSource() datasource.DataSource {
	return &Metal3IoBareMetalHostV1Alpha1DataSource{}
}

type Metal3IoBareMetalHostV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type Metal3IoBareMetalHostV1Alpha1DataSourceData struct {
...
func (r *Metal3IoBareMetalHostV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_metal3_io_bare_metal_host_v1alpha1"
}

func (r *Metal3IoBareMetalHostV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Metal3IoBareMetalHostV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *Metal3IoBareMetalHostV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_metal3_io_bare_metal_host_v1alpha1")

	var data Metal3IoBareMetalHostV1Alpha1DataSourceData
	...
	var readResponse Metal3IoBareMetalHostV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("BareMetalHost")
