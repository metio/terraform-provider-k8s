...
type Metal3IoBMCEventSubscriptionV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		HttpHeadersRef *struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
		} `tfsdk:"http_headers_ref" json:"httpHeadersRef,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"context": schema.StringAttribute{
						...
						MarkdownDescription: "Arbitrary user-provided context for the event",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"destination": schema.StringAttribute{
						...
						MarkdownDescription: "A webhook URL to send events to",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"host_name": schema.StringAttribute{
						...
						MarkdownDescription: "A reference to a BareMetalHost",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"http_headers_ref": schema.SingleNestedAttribute{
						Description:         "A secret containing HTTP headers which should be passed along to the Destination when making a request",
						MarkdownDescription: "A secret containing HTTP headers which should be passed along to the Destination when making a request",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
...
func (r *Metal3IoBMCEventSubscriptionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	...
	model.Kind = pointer.String("BMCEventSubscription")
