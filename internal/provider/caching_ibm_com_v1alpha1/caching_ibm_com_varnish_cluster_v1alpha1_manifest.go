...
var (
	_ datasource.DataSource = &CachingIbmComVarnishClusterV1Alpha1Manifest{}
)

func NewCachingIbmComVarnishClusterV1Alpha1Manifest() datasource.DataSource {
	return &CachingIbmComVarnishClusterV1Alpha1Manifest{}
}

type CachingIbmComVarnishClusterV1Alpha1Manifest struct{}

type CachingIbmComVarnishClusterV1Alpha1ManifestData struct {
...
func (r *CachingIbmComVarnishClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_caching_ibm_com_varnish_cluster_v1alpha1_manifest"
}

func (r *CachingIbmComVarnishClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CachingIbmComVarnishClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_caching_ibm_com_varnish_cluster_v1alpha1_manifest")

	var model CachingIbmComVarnishClusterV1Alpha1ManifestData
