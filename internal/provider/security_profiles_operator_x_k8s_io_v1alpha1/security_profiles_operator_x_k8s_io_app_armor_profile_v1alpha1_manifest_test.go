...
func TestSecurityProfilesOperatorXK8SIoAppArmorProfileV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_security_profiles_operator_x_k8s_io_app_armor_profile_v1alpha1_manifest", testCase)
		})
	}
}
