...
var (
	_ datasource.DataSource = &IntegrationRock8SComPlugV1Beta1Manifest{}
)

func NewIntegrationRock8SComPlugV1Beta1Manifest() datasource.DataSource {
	return &IntegrationRock8SComPlugV1Beta1Manifest{}
}
...
func (r *IntegrationRock8SComPlugV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_integration_rock8s_com_plug_v1beta1_manifest"
}

func (r *IntegrationRock8SComPlugV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PlugSpec defines the desired state of Plug",
				Attributes: map[string]schema.Attribute{
...
func (r *IntegrationRock8SComPlugV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_integration_rock8s_com_plug_v1beta1_manifest")

	var model IntegrationRock8SComPlugV1Beta1ManifestData
