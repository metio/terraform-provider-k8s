...
var (
	_ datasource.DataSource              = &HiveOpenshiftIoClusterRelocateV1DataSource{}
	_ datasource.DataSourceWithConfigure = &HiveOpenshiftIoClusterRelocateV1DataSource{}
)

func NewHiveOpenshiftIoClusterRelocateV1DataSource() datasource.DataSource {
	return &HiveOpenshiftIoClusterRelocateV1DataSource{}
}

type HiveOpenshiftIoClusterRelocateV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type HiveOpenshiftIoClusterRelocateV1DataSourceData struct {
...
func (r *HiveOpenshiftIoClusterRelocateV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hive_openshift_io_cluster_relocate_v1"
}

func (r *HiveOpenshiftIoClusterRelocateV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HiveOpenshiftIoClusterRelocateV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HiveOpenshiftIoClusterRelocateV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_hive_openshift_io_cluster_relocate_v1")

	var data HiveOpenshiftIoClusterRelocateV1DataSourceData
	...
	var readResponse HiveOpenshiftIoClusterRelocateV1DataSourceData
	...
	data.Kind = pointer.String("ClusterRelocate")
