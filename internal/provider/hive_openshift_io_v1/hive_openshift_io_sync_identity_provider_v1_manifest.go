...
var (
	_ datasource.DataSource = &HiveOpenshiftIoSyncIdentityProviderV1Manifest{}
)

func NewHiveOpenshiftIoSyncIdentityProviderV1Manifest() datasource.DataSource {
	return &HiveOpenshiftIoSyncIdentityProviderV1Manifest{}
}
...
func (r *HiveOpenshiftIoSyncIdentityProviderV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hive_openshift_io_sync_identity_provider_v1_manifest"
}

func (r *HiveOpenshiftIoSyncIdentityProviderV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HiveOpenshiftIoSyncIdentityProviderV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hive_openshift_io_sync_identity_provider_v1_manifest")

	var model HiveOpenshiftIoSyncIdentityProviderV1ManifestData
