			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"customization_ref": schema.SingleNestedAttribute{
						Description:         "CustomizationRef refers to a ClusterDeploymentCustomization object whose InstallerManifestPatches should be applied to *all* ClusterDeployments created by this ClusterPool. This is in addition to any CDC from Inventory. The CDC must exist in the ClusterPool's namespace. It will be copied to the namespace of each ClusterDeployment generated by the ClusterPool.",
						MarkdownDescription: "CustomizationRef refers to a ClusterDeploymentCustomization object whose InstallerManifestPatches should be applied to *all* ClusterDeployments created by this ClusterPool. This is in addition to any CDC from Inventory. The CDC must exist in the ClusterPool's namespace. It will be copied to the namespace of each ClusterDeployment generated by the ClusterPool.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
