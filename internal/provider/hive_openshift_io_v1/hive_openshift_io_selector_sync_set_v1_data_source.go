...
var (
	_ datasource.DataSource              = &HiveOpenshiftIoSelectorSyncSetV1DataSource{}
	_ datasource.DataSourceWithConfigure = &HiveOpenshiftIoSelectorSyncSetV1DataSource{}
)

func NewHiveOpenshiftIoSelectorSyncSetV1DataSource() datasource.DataSource {
	return &HiveOpenshiftIoSelectorSyncSetV1DataSource{}
}

type HiveOpenshiftIoSelectorSyncSetV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type HiveOpenshiftIoSelectorSyncSetV1DataSourceData struct {
...
func (r *HiveOpenshiftIoSelectorSyncSetV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hive_openshift_io_selector_sync_set_v1"
}

func (r *HiveOpenshiftIoSelectorSyncSetV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HiveOpenshiftIoSelectorSyncSetV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HiveOpenshiftIoSelectorSyncSetV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_hive_openshift_io_selector_sync_set_v1")

	var data HiveOpenshiftIoSelectorSyncSetV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "hive.openshift.io", Version: "v1", Resource: "SelectorSyncSet"}).
	...
	var readResponse HiveOpenshiftIoSelectorSyncSetV1DataSourceData
	...
	data.Kind = pointer.String("SelectorSyncSet")
