...
var (
	_ datasource.DataSource              = &HiveOpenshiftIoHiveConfigV1DataSource{}
	_ datasource.DataSourceWithConfigure = &HiveOpenshiftIoHiveConfigV1DataSource{}
)

func NewHiveOpenshiftIoHiveConfigV1DataSource() datasource.DataSource {
	return &HiveOpenshiftIoHiveConfigV1DataSource{}
}

type HiveOpenshiftIoHiveConfigV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type HiveOpenshiftIoHiveConfigV1DataSourceData struct {
...
func (r *HiveOpenshiftIoHiveConfigV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hive_openshift_io_hive_config_v1"
}

func (r *HiveOpenshiftIoHiveConfigV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HiveOpenshiftIoHiveConfigV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HiveOpenshiftIoHiveConfigV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_hive_openshift_io_hive_config_v1")

	var data HiveOpenshiftIoHiveConfigV1DataSourceData
	...
	var readResponse HiveOpenshiftIoHiveConfigV1DataSourceData
	...
	data.Kind = pointer.String("HiveConfig")
