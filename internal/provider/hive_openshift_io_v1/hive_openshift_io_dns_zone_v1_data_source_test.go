...
func TestHiveOpenshiftIoDnszoneV1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_hive_openshift_io_dns_zone_v1", testCase)
		})
	}
}
...
func TestHiveOpenshiftIoDnszoneV1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_hive_openshift_io_dns_zone_v1", configuration)
}
