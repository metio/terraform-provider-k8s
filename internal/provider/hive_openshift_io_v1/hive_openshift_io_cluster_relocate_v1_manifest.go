...
var (
	_ datasource.DataSource = &HiveOpenshiftIoClusterRelocateV1Manifest{}
)

func NewHiveOpenshiftIoClusterRelocateV1Manifest() datasource.DataSource {
	return &HiveOpenshiftIoClusterRelocateV1Manifest{}
}
...
func (r *HiveOpenshiftIoClusterRelocateV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hive_openshift_io_cluster_relocate_v1_manifest"
}

func (r *HiveOpenshiftIoClusterRelocateV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HiveOpenshiftIoClusterRelocateV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hive_openshift_io_cluster_relocate_v1_manifest")

	var model HiveOpenshiftIoClusterRelocateV1ManifestData
