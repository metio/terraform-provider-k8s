...
var (
	_ resource.Resource = (*GatewaySoloIoVirtualServiceV1Resource)(nil)
)

type GatewaySoloIoVirtualServiceV1TerraformModel struct {
...
type GatewaySoloIoVirtualServiceV1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"virtual_host" yaml:"virtualHost,omitempty"`
...
func (r *GatewaySoloIoVirtualServiceV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_solo_io_virtual_service_v1"
}

func (r *GatewaySoloIoVirtualServiceV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *GatewaySoloIoVirtualServiceV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_gateway_solo_io_virtual_service_v1")

	var state GatewaySoloIoVirtualServiceV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GatewaySoloIoVirtualServiceV1GoModel
...
func (r *GatewaySoloIoVirtualServiceV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_solo_io_virtual_service_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *GatewaySoloIoVirtualServiceV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GatewaySoloIoVirtualServiceV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
