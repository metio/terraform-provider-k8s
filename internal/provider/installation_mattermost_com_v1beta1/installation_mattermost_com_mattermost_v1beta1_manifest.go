...
var (
	_ datasource.DataSource = &InstallationMattermostComMattermostV1Beta1Manifest{}
)

func NewInstallationMattermostComMattermostV1Beta1Manifest() datasource.DataSource {
	return &InstallationMattermostComMattermostV1Beta1Manifest{}
}

type InstallationMattermostComMattermostV1Beta1Manifest struct{}

type InstallationMattermostComMattermostV1Beta1ManifestData struct {
	...
	Spec *struct {
		AwsLoadBalancerController *struct {
			Annotations    *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			...
			InternetFacing   *bool   `tfsdk:"internet_facing" json:"internetFacing,omitempty"`
		} `tfsdk:"aws_load_balancer_controller" json:"awsLoadBalancerController,omitempty"`
		Database *struct {
			DisableReadinessCheck *bool `tfsdk:"disable_readiness_check" json:"disableReadinessCheck,omitempty"`
			External              *struct {
				Secret *string `tfsdk:"secret" json:"secret,omitempty"`
			} `tfsdk:"external" json:"external,omitempty"`
			OperatorManaged *struct {
				BackupRemoteDeletePolicy *string `tfsdk:"backup_remote_delete_policy" json:"backupRemoteDeletePolicy,omitempty"`
				BackupRestoreSecretName  *string `tfsdk:"backup_restore_secret_name" json:"backupRestoreSecretName,omitempty"`
				BackupSchedule           *string `tfsdk:"backup_schedule" json:"backupSchedule,omitempty"`
				BackupSecretName         *string `tfsdk:"backup_secret_name" json:"backupSecretName,omitempty"`
				BackupURL                *string `tfsdk:"backup_url" json:"backupURL,omitempty"`
			...
			} `tfsdk:"operator_managed" json:"operatorManaged,omitempty"`
		} `tfsdk:"database" json:"database,omitempty"`
		DeploymentTemplate *struct {
			DeploymentStrategyType *string `tfsdk:"deployment_strategy_type" json:"deploymentStrategyType,omitempty"`
			RevisionHistoryLimit   *int64  `tfsdk:"revision_history_limit" json:"revisionHistoryLimit,omitempty"`
		} `tfsdk:"deployment_template" json:"deploymentTemplate,omitempty"`
		DnsConfig *struct {
		...
		} `tfsdk:"elastic_search" json:"elasticSearch,omitempty"`
		FileStore *struct {
			External *struct {
		...
		} `tfsdk:"file_store" json:"fileStore,omitempty"`
		...
		JobServer          *struct {
			DedicatedJobServer *bool `tfsdk:"dedicated_job_server" json:"dedicatedJobServer,omitempty"`
		} `tfsdk:"job_server" json:"jobServer,omitempty"`
		LicenseSecret *string `tfsdk:"license_secret" json:"licenseSecret,omitempty"`
		...
		} `tfsdk:"mattermost_env" json:"mattermostEnv,omitempty"`
		PodExtensions *struct {
			...
			} `tfsdk:"container_ports" json:"containerPorts,omitempty"`
		...
		} `tfsdk:"resource_patch" json:"resourcePatch,omitempty"`
		Scheduling *struct {
			Affinity *struct {
				NodeAffinity *struct {
		...
		UseIngressTLS          *bool   `tfsdk:"use_ingress_tls" json:"useIngressTLS,omitempty"`
		UseServiceLoadBalancer *bool   `tfsdk:"use_service_load_balancer" json:"useServiceLoadBalancer,omitempty"`
		Version                *string `tfsdk:"version" json:"version,omitempty"`
		VolumeMounts           *[]struct {
			MountPath         *string `tfsdk:"mount_path" json:"mountPath,omitempty"`
			MountPropagation  *string `tfsdk:"mount_propagation" json:"mountPropagation,omitempty"`
...
func (r *InstallationMattermostComMattermostV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_installation_mattermost_com_mattermost_v1beta1_manifest"
}

func (r *InstallationMattermostComMattermostV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"aws_load_balancer_controller": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
							...
							"certificate_arn": schema.StringAttribute{
								...
								MarkdownDescription: "Certificate arn for the ALB, required if SSL enabled",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"enabled": schema.BoolAttribute{
								...
								MarkdownDescription: "An AWS ALB Ingress will be created instead of nginx",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"ingress_class_name": schema.StringAttribute{
								...
								MarkdownDescription: "IngressClassName for your ingress",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"internet_facing": schema.BoolAttribute{
								Description:         "Whether the Ingress will be internetfacing, default is false",
								MarkdownDescription: "Whether the Ingress will be internetfacing, default is false",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"database": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"disable_readiness_check": schema.BoolAttribute{
							...
							"operator_managed": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"backup_remote_delete_policy": schema.StringAttribute{
									...
									"backup_restore_secret_name": schema.StringAttribute{
									...
									"backup_secret_name": schema.StringAttribute{
									...
									"backup_url": schema.StringAttribute{
									...
									"version": schema.StringAttribute{
										...
										MarkdownDescription: "Defines the cluster version for the database to use",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
					...
					"deployment_template": schema.SingleNestedAttribute{
						Description:         "DeploymentTemplate defines configuration for the template for Mattermost deployment.",
						MarkdownDescription: "DeploymentTemplate defines configuration for the template for Mattermost deployment.",
						Attributes: map[string]schema.Attribute{
							"deployment_strategy_type": schema.StringAttribute{
								Description:         "Defines the deployment strategy type for the mattermost deployment. Accepted values are: 'Recreate' or 'RollingUpdate'. Default is RollingUpdate.",
								MarkdownDescription: "Defines the deployment strategy type for the mattermost deployment. Accepted values are: 'Recreate' or 'RollingUpdate'. Default is RollingUpdate.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"revision_history_limit": schema.Int64Attribute{
								...
								MarkdownDescription: "Defines the revision history limit for the mattermost deployment.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"elastic_search": schema.SingleNestedAttribute{
					...
					"file_store": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"external": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"use_service_account": schema.BoolAttribute{
										...
										MarkdownDescription: "Optionally use service account with IAM role to access AWS services, like S3.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"external_volume": schema.SingleNestedAttribute{
								Description:         "Defines the configuration of externally managed PVC backed storage.",
								MarkdownDescription: "Defines the configuration of externally managed PVC backed storage.",
								Attributes: map[string]schema.Attribute{
									"volume_claim_name": schema.StringAttribute{
										...
										MarkdownDescription: "The name of the matching volume claim for the externally managed volume.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
					...
					"job_server": schema.SingleNestedAttribute{
						Description:         "JobServer defines configuration for the Mattermost job server.",
						MarkdownDescription: "JobServer defines configuration for the Mattermost job server.",
						Attributes: map[string]schema.Attribute{
							"dedicated_job_server": schema.BoolAttribute{
								Description:         "Determines whether to create a dedicated Mattermost server deployment which is configured to run scheduled jobs. This deployment will recieve no user traffic and the primary Mattermost deployment will no longer be configured to run jobs.",
								MarkdownDescription: "Determines whether to create a dedicated Mattermost server deployment which is configured to run scheduled jobs. This deployment will recieve no user traffic and the primary Mattermost deployment will no longer be configured to run jobs.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"license_secret": schema.StringAttribute{
					...
					"mattermost_env": schema.ListNestedAttribute{
					...
					"pod_extensions": schema.SingleNestedAttribute{
					...
					"pod_template": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"command": schema.ListAttribute{
								Description:         "Defines a command override for Mattermost app server pods. The default command is 'mattermost'.",
								MarkdownDescription: "Defines a command override for Mattermost app server pods. The default command is 'mattermost'.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"resource_patch": schema.SingleNestedAttribute{
					...
					"use_ingress_tls": schema.BoolAttribute{
					...
					"use_service_load_balancer": schema.BoolAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
...
func (r *InstallationMattermostComMattermostV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_installation_mattermost_com_mattermost_v1beta1_manifest")

	var model InstallationMattermostComMattermostV1Beta1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("installation.mattermost.com/v1beta1")
	model.Kind = pointer.String("Mattermost")
