...
var (
	_ datasource.DataSource              = &InstallationMattermostComMattermostV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &InstallationMattermostComMattermostV1Beta1DataSource{}
)

func NewInstallationMattermostComMattermostV1Beta1DataSource() datasource.DataSource {
	return &InstallationMattermostComMattermostV1Beta1DataSource{}
}

type InstallationMattermostComMattermostV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type InstallationMattermostComMattermostV1Beta1DataSourceData struct {
...
func (r *InstallationMattermostComMattermostV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_installation_mattermost_com_mattermost_v1beta1"
}

func (r *InstallationMattermostComMattermostV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InstallationMattermostComMattermostV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InstallationMattermostComMattermostV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_installation_mattermost_com_mattermost_v1beta1")

	var data InstallationMattermostComMattermostV1Beta1DataSourceData
	...
	var readResponse InstallationMattermostComMattermostV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("installation.mattermost.com/v1beta1")
	data.Kind = pointer.String("Mattermost")
