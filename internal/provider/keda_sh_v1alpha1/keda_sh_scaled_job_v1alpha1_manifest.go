...
var (
	_ datasource.DataSource = &KedaShScaledJobV1Alpha1Manifest{}
)

func NewKedaShScaledJobV1Alpha1Manifest() datasource.DataSource {
	return &KedaShScaledJobV1Alpha1Manifest{}
}

type KedaShScaledJobV1Alpha1Manifest struct{}

type KedaShScaledJobV1Alpha1ManifestData struct {
...
func (r *KedaShScaledJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keda_sh_scaled_job_v1alpha1_manifest"
}

func (r *KedaShScaledJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KedaShScaledJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_keda_sh_scaled_job_v1alpha1_manifest")

	var model KedaShScaledJobV1Alpha1ManifestData
