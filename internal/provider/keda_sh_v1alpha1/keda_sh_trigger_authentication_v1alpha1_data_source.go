...
var (
	_ datasource.DataSource              = &KedaShTriggerAuthenticationV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KedaShTriggerAuthenticationV1Alpha1DataSource{}
)

func NewKedaShTriggerAuthenticationV1Alpha1DataSource() datasource.DataSource {
	return &KedaShTriggerAuthenticationV1Alpha1DataSource{}
}

type KedaShTriggerAuthenticationV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KedaShTriggerAuthenticationV1Alpha1DataSourceData struct {
...
func (r *KedaShTriggerAuthenticationV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keda_sh_trigger_authentication_v1alpha1"
}

func (r *KedaShTriggerAuthenticationV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KedaShTriggerAuthenticationV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KedaShTriggerAuthenticationV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_keda_sh_trigger_authentication_v1alpha1")

	var data KedaShTriggerAuthenticationV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "keda.sh", Version: "v1alpha1", Resource: "TriggerAuthentication"}).
	...
	var readResponse KedaShTriggerAuthenticationV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("TriggerAuthentication")
