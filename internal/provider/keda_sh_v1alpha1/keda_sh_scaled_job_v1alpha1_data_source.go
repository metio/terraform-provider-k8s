...
var (
	_ datasource.DataSource              = &KedaShScaledJobV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KedaShScaledJobV1Alpha1DataSource{}
)

func NewKedaShScaledJobV1Alpha1DataSource() datasource.DataSource {
	return &KedaShScaledJobV1Alpha1DataSource{}
}

type KedaShScaledJobV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KedaShScaledJobV1Alpha1DataSourceData struct {
...
func (r *KedaShScaledJobV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keda_sh_scaled_job_v1alpha1"
}

func (r *KedaShScaledJobV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KedaShScaledJobV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KedaShScaledJobV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_keda_sh_scaled_job_v1alpha1")

	var data KedaShScaledJobV1Alpha1DataSourceData
	...
	var readResponse KedaShScaledJobV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ScaledJob")
