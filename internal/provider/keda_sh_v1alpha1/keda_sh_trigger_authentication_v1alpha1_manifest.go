...
var (
	_ datasource.DataSource = &KedaShTriggerAuthenticationV1Alpha1Manifest{}
)

func NewKedaShTriggerAuthenticationV1Alpha1Manifest() datasource.DataSource {
	return &KedaShTriggerAuthenticationV1Alpha1Manifest{}
}

type KedaShTriggerAuthenticationV1Alpha1Manifest struct{}

type KedaShTriggerAuthenticationV1Alpha1ManifestData struct {
...
func (r *KedaShTriggerAuthenticationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keda_sh_trigger_authentication_v1alpha1_manifest"
}

func (r *KedaShTriggerAuthenticationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KedaShTriggerAuthenticationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_keda_sh_trigger_authentication_v1alpha1_manifest")

	var model KedaShTriggerAuthenticationV1Alpha1ManifestData
