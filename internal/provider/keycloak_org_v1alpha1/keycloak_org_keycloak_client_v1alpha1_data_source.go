...
var (
	_ datasource.DataSource              = &KeycloakOrgKeycloakClientV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KeycloakOrgKeycloakClientV1Alpha1DataSource{}
)

func NewKeycloakOrgKeycloakClientV1Alpha1DataSource() datasource.DataSource {
	return &KeycloakOrgKeycloakClientV1Alpha1DataSource{}
}

type KeycloakOrgKeycloakClientV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KeycloakOrgKeycloakClientV1Alpha1DataSourceData struct {
...
func (r *KeycloakOrgKeycloakClientV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keycloak_org_keycloak_client_v1alpha1"
}

func (r *KeycloakOrgKeycloakClientV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KeycloakOrgKeycloakClientV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KeycloakOrgKeycloakClientV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_keycloak_org_keycloak_client_v1alpha1")

	var data KeycloakOrgKeycloakClientV1Alpha1DataSourceData
	...
	var readResponse KeycloakOrgKeycloakClientV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("KeycloakClient")
