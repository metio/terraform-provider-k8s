...
var (
	_ datasource.DataSource              = &KeycloakOrgKeycloakRealmV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KeycloakOrgKeycloakRealmV1Alpha1DataSource{}
)

func NewKeycloakOrgKeycloakRealmV1Alpha1DataSource() datasource.DataSource {
	return &KeycloakOrgKeycloakRealmV1Alpha1DataSource{}
}

type KeycloakOrgKeycloakRealmV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KeycloakOrgKeycloakRealmV1Alpha1DataSourceData struct {
...
func (r *KeycloakOrgKeycloakRealmV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keycloak_org_keycloak_realm_v1alpha1"
}

func (r *KeycloakOrgKeycloakRealmV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KeycloakOrgKeycloakRealmV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KeycloakOrgKeycloakRealmV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_keycloak_org_keycloak_realm_v1alpha1")

	var data KeycloakOrgKeycloakRealmV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "keycloak.org", Version: "v1alpha1", Resource: "keycloakrealms"}).
	...
	var readResponse KeycloakOrgKeycloakRealmV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("KeycloakRealm")
