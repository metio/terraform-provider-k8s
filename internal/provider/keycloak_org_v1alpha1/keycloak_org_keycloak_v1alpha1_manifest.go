...
var (
	_ datasource.DataSource = &KeycloakOrgKeycloakV1Alpha1Manifest{}
)

func NewKeycloakOrgKeycloakV1Alpha1Manifest() datasource.DataSource {
	return &KeycloakOrgKeycloakV1Alpha1Manifest{}
}
...
func (r *KeycloakOrgKeycloakV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_keycloak_org_keycloak_v1alpha1_manifest"
}

func (r *KeycloakOrgKeycloakV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KeycloakOrgKeycloakV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_keycloak_org_keycloak_v1alpha1_manifest")

	var model KeycloakOrgKeycloakV1Alpha1ManifestData
