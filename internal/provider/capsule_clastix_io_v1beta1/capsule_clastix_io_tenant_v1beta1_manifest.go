...
var (
	_ datasource.DataSource = &CapsuleClastixIoTenantV1Beta1Manifest{}
)

func NewCapsuleClastixIoTenantV1Beta1Manifest() datasource.DataSource {
	return &CapsuleClastixIoTenantV1Beta1Manifest{}
}
...
func (r *CapsuleClastixIoTenantV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capsule_clastix_io_tenant_v1beta1_manifest"
}

func (r *CapsuleClastixIoTenantV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CapsuleClastixIoTenantV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_capsule_clastix_io_tenant_v1beta1_manifest")

	var model CapsuleClastixIoTenantV1Beta1ManifestData
