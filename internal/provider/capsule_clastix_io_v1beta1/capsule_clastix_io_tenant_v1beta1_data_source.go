...
var (
	_ datasource.DataSource              = &CapsuleClastixIoTenantV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &CapsuleClastixIoTenantV1Beta1DataSource{}
)

func NewCapsuleClastixIoTenantV1Beta1DataSource() datasource.DataSource {
	return &CapsuleClastixIoTenantV1Beta1DataSource{}
}

type CapsuleClastixIoTenantV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CapsuleClastixIoTenantV1Beta1DataSourceData struct {
...
func (r *CapsuleClastixIoTenantV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capsule_clastix_io_tenant_v1beta1"
}

func (r *CapsuleClastixIoTenantV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CapsuleClastixIoTenantV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CapsuleClastixIoTenantV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_capsule_clastix_io_tenant_v1beta1")

	var data CapsuleClastixIoTenantV1Beta1DataSourceData
	...
	var readResponse CapsuleClastixIoTenantV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("capsule.clastix.io/v1beta1")
