...
type KyvernoIoClusterPolicyV1Resource struct{}

var (
	_ resource.Resource = (*KyvernoIoClusterPolicyV1Resource)(nil)
)

type KyvernoIoClusterPolicyV1TerraformModel struct {
...
type KyvernoIoClusterPolicyV1GoModel struct {
...
func NewKyvernoIoClusterPolicyV1Resource() resource.Resource {
	return &KyvernoIoClusterPolicyV1Resource{}
}

func (r *KyvernoIoClusterPolicyV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kyverno_io_cluster_policy_v1"
}

func (r *KyvernoIoClusterPolicyV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *KyvernoIoClusterPolicyV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kyverno_io_cluster_policy_v1")

	var state KyvernoIoClusterPolicyV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KyvernoIoClusterPolicyV1GoModel
...
func (r *KyvernoIoClusterPolicyV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_policy_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *KyvernoIoClusterPolicyV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_kyverno_io_cluster_policy_v1")
...
func (r *KyvernoIoClusterPolicyV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_kyverno_io_cluster_policy_v1")
