...
type InferenceKubedlIoElasticBatchJobV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*InferenceKubedlIoElasticBatchJobV1Alpha1Resource)(nil)
)

type InferenceKubedlIoElasticBatchJobV1Alpha1TerraformModel struct {
...
type InferenceKubedlIoElasticBatchJobV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		ElasticBatchReplicaSpecs *struct {
		...
		} `tfsdk:"elastic_batch_replica_specs" yaml:"elasticBatchReplicaSpecs,omitempty"`
		...
		SuccessPolicy *string `tfsdk:"success_policy" yaml:"successPolicy,omitempty"`

		TtlSecondsAfterFinished *int64 `tfsdk:"ttl_seconds_after_finished" yaml:"ttlSecondsAfterFinished,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewInferenceKubedlIoElasticBatchJobV1Alpha1Resource() resource.Resource {
	return &InferenceKubedlIoElasticBatchJobV1Alpha1Resource{}
}

func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_inference_kubedl_io_elastic_batch_job_v1alpha1"
}

func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_inference_kubedl_io_elastic_batch_job_v1alpha1")

	var state InferenceKubedlIoElasticBatchJobV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel InferenceKubedlIoElasticBatchJobV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("inference.kubedl.io/v1alpha1")
	goModel.Kind = utilities.Ptr("ElasticBatchJob")
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_inference_kubedl_io_elastic_batch_job_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_inference_kubedl_io_elastic_batch_job_v1alpha1")
...
func (r *InferenceKubedlIoElasticBatchJobV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_inference_kubedl_io_elastic_batch_job_v1alpha1")
