...
package apiextensions_crossplane_io_v2
...
var (
	_ datasource.DataSource = &ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest{}
)

func NewApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest() datasource.DataSource {
	return &ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest{}
}

type ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest struct{}

type ApiextensionsCrossplaneIoCompositeResourceDefinitionV2ManifestData struct {
...
func (r *ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apiextensions_crossplane_io_composite_resource_definition_v2_manifest"
}

func (r *ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "A CompositeResourceDefinition defines the schema for a new custom Kubernetes API. Read the Crossplane documentation for [more information about CustomResourceDefinitions](https://docs.crossplane.io/latest/concepts/composite-resource-definitions).",
		MarkdownDescription: "A CompositeResourceDefinition defines the schema for a new custom Kubernetes API. Read the Crossplane documentation for [more information about CustomResourceDefinitions](https://docs.crossplane.io/latest/concepts/composite-resource-definitions).",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"connection_secret_keys": schema.ListAttribute{
						Description:         "ConnectionSecretKeys is the list of connection secret keys the defined XR can publish. If the list is empty, all keys will be published. If the list isn't empty, any connection secret keys that don't appear in the list will be filtered out. Only LegacyCluster XRs support connection secrets. Deprecated: XR connection secrets aren't supported in apiextensions.crossplane.io/v2. Compose a secret instead.",
					...
					"default_composite_delete_policy": schema.StringAttribute{
						Description:         "DefaultCompositeDeletePolicy is the policy used when deleting the Composite that is associated with the Claim if no policy has been specified. Deprecated: Claims aren't supported in apiextensions.crossplane.io/v2.",
						MarkdownDescription: "DefaultCompositeDeletePolicy is the policy used when deleting the Composite that is associated with the Claim if no policy has been specified. Deprecated: Claims aren't supported in apiextensions.crossplane.io/v2.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"scope": schema.StringAttribute{
						Description:         "Scope of the defined composite resource. Namespaced composite resources are scoped to a single namespace. Cluster scoped composite resource exist outside the scope of any namespace.",
						MarkdownDescription: "Scope of the defined composite resource. Namespaced composite resources are scoped to a single namespace. Cluster scoped composite resource exist outside the scope of any namespace.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("Namespaced", "Cluster"),
						},
					},
...
func (r *ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apiextensions_crossplane_io_composite_resource_definition_v2_manifest")

	var model ApiextensionsCrossplaneIoCompositeResourceDefinitionV2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("apiextensions.crossplane.io/v2")
