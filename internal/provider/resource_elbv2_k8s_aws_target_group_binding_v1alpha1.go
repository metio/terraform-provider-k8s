...
var (
	_ resource.Resource = (*Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource)(nil)
)

type Elbv2K8SAwsTargetGroupBindingV1Alpha1TerraformModel struct {
...
type Elbv2K8SAwsTargetGroupBindingV1Alpha1GoModel struct {
...
func (r *Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_elbv2_k8s_aws_target_group_binding_v1alpha1"
}

func (r *Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_elbv2_k8s_aws_target_group_binding_v1alpha1")

	var state Elbv2K8SAwsTargetGroupBindingV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel Elbv2K8SAwsTargetGroupBindingV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("elbv2.k8s.aws/v1alpha1")
...
func (r *Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_elbv2_k8s_aws_target_group_binding_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *Elbv2K8SAwsTargetGroupBindingV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
