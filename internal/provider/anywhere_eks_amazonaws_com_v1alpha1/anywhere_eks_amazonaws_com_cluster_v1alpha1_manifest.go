...
type AnywhereEksAmazonawsComClusterV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		ControlPlaneConfiguration *struct {
			...
			AuditPolicyContent *string            `tfsdk:"audit_policy_content" json:"auditPolicyContent,omitempty"`
				...
				Attributes: map[string]schema.Attribute{
					...
					"control_plane_configuration": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"audit_policy_content": schema.StringAttribute{
								Description:         "AuditPolicyContent defines the audit policy configuration as a string. If not specified, the default audit policy will be used.",
								MarkdownDescription: "AuditPolicyContent defines the audit policy configuration as a string. If not specified, the default audit policy will be used.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
