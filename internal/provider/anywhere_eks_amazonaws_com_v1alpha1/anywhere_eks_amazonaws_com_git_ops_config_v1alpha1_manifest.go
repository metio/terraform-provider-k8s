...
var (
	_ datasource.DataSource = &AnywhereEksAmazonawsComGitOpsConfigV1Alpha1Manifest{}
)

func NewAnywhereEksAmazonawsComGitOpsConfigV1Alpha1Manifest() datasource.DataSource {
	return &AnywhereEksAmazonawsComGitOpsConfigV1Alpha1Manifest{}
}
...
func (r *AnywhereEksAmazonawsComGitOpsConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_anywhere_eks_amazonaws_com_git_ops_config_v1alpha1_manifest"
}

func (r *AnywhereEksAmazonawsComGitOpsConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GitOps defines the configurations of GitOps Toolkit and Git repository it links to.",
				Attributes: map[string]schema.Attribute{
					"flux": schema.SingleNestedAttribute{
						Description:         "Flux defines the Git repository options for Flux v2.",
						MarkdownDescription: "Flux defines the Git repository options for Flux v2.",
						Attributes: map[string]schema.Attribute{
							"github": schema.SingleNestedAttribute{
								Description:         "github is the name of the Git Provider to host the Git repo.",
								MarkdownDescription: "github is the name of the Git Provider to host the Git repo.",
								Attributes: map[string]schema.Attribute{
									...
									"flux_system_namespace": schema.StringAttribute{
										Description:         "FluxSystemNamespace scope for this operation. Defaults to flux-system.",
										MarkdownDescription: "FluxSystemNamespace scope for this operation. Defaults to flux-system.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
...
func (r *AnywhereEksAmazonawsComGitOpsConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_anywhere_eks_amazonaws_com_git_ops_config_v1alpha1_manifest")

	var model AnywhereEksAmazonawsComGitOpsConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("GitOpsConfig")
