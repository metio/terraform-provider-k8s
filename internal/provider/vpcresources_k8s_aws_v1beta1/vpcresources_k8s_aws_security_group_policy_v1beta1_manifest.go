...
package vpcresources_k8s_aws_v1beta1
...
var (
	_ datasource.DataSource = &VpcresourcesK8SAwsSecurityGroupPolicyV1Beta1Manifest{}
)

func NewVpcresourcesK8SAwsSecurityGroupPolicyV1Beta1Manifest() datasource.DataSource {
	return &VpcresourcesK8SAwsSecurityGroupPolicyV1Beta1Manifest{}
}
...
func (r *VpcresourcesK8SAwsSecurityGroupPolicyV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_vpcresources_k8s_aws_security_group_policy_v1beta1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "SecurityGroupPolicySpec defines the desired state of SecurityGroupPolicy",
				Attributes: map[string]schema.Attribute{
					...
					"security_groups": schema.SingleNestedAttribute{
						Description:         "GroupIds contains the list of security groups that will be applied to the network interface of the pod matching the criteria.",
						MarkdownDescription: "GroupIds contains the list of security groups that will be applied to the network interface of the pod matching the criteria.",
						Attributes: map[string]schema.Attribute{
							"group_ids": schema.ListAttribute{
								Description:         "Groups is the list of EC2 Security Groups Ids that need to be applied to the ENI of a Pod.",
								MarkdownDescription: "Groups is the list of EC2 Security Groups Ids that need to be applied to the ENI of a Pod.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"service_account_selector": schema.SingleNestedAttribute{
						Description:         "A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.",
						MarkdownDescription: "A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
...
func (r *VpcresourcesK8SAwsSecurityGroupPolicyV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_vpcresources_k8s_aws_security_group_policy_v1beta1_manifest")

	var model VpcresourcesK8SAwsSecurityGroupPolicyV1Beta1ManifestData
