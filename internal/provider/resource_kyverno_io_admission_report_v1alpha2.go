...
type KyvernoIoAdmissionReportV1Alpha2Resource struct{}

var (
	_ resource.Resource = (*KyvernoIoAdmissionReportV1Alpha2Resource)(nil)
)

type KyvernoIoAdmissionReportV1Alpha2TerraformModel struct {
...
type KyvernoIoAdmissionReportV1Alpha2GoModel struct {
...
func NewKyvernoIoAdmissionReportV1Alpha2Resource() resource.Resource {
	return &KyvernoIoAdmissionReportV1Alpha2Resource{}
}

func (r *KyvernoIoAdmissionReportV1Alpha2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kyverno_io_admission_report_v1alpha2"
}

func (r *KyvernoIoAdmissionReportV1Alpha2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "AdmissionReport is the Schema for the AdmissionReports API",
		MarkdownDescription: "AdmissionReport is the Schema for the AdmissionReports API",
...
func (r *KyvernoIoAdmissionReportV1Alpha2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kyverno_io_admission_report_v1alpha2")

	var state KyvernoIoAdmissionReportV1Alpha2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KyvernoIoAdmissionReportV1Alpha2GoModel
	...
	goModel.Kind = utilities.Ptr("AdmissionReport")
...
func (r *KyvernoIoAdmissionReportV1Alpha2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_admission_report_v1alpha2")
	// NO-OP: All data is already in Terraform state
}

func (r *KyvernoIoAdmissionReportV1Alpha2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_kyverno_io_admission_report_v1alpha2")
...
func (r *KyvernoIoAdmissionReportV1Alpha2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_kyverno_io_admission_report_v1alpha2")
