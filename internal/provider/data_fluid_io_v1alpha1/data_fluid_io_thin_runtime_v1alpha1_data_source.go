...
var (
	_ datasource.DataSource              = &DataFluidIoThinRuntimeV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &DataFluidIoThinRuntimeV1Alpha1DataSource{}
)

func NewDataFluidIoThinRuntimeV1Alpha1DataSource() datasource.DataSource {
	return &DataFluidIoThinRuntimeV1Alpha1DataSource{}
}

type DataFluidIoThinRuntimeV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type DataFluidIoThinRuntimeV1Alpha1DataSourceData struct {
...
func (r *DataFluidIoThinRuntimeV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_data_fluid_io_thin_runtime_v1alpha1"
}

func (r *DataFluidIoThinRuntimeV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *DataFluidIoThinRuntimeV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *DataFluidIoThinRuntimeV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_data_fluid_io_thin_runtime_v1alpha1")

	var data DataFluidIoThinRuntimeV1Alpha1DataSourceData
	...
	var readResponse DataFluidIoThinRuntimeV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ThinRuntime")
