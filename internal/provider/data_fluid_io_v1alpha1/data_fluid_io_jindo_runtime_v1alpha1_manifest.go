...
var (
	_ datasource.DataSource = &DataFluidIoJindoRuntimeV1Alpha1Manifest{}
)

func NewDataFluidIoJindoRuntimeV1Alpha1Manifest() datasource.DataSource {
	return &DataFluidIoJindoRuntimeV1Alpha1Manifest{}
}

type DataFluidIoJindoRuntimeV1Alpha1Manifest struct{}

type DataFluidIoJindoRuntimeV1Alpha1ManifestData struct {
...
func (r *DataFluidIoJindoRuntimeV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_data_fluid_io_jindo_runtime_v1alpha1_manifest"
}

func (r *DataFluidIoJindoRuntimeV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"fuse": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"clean_policy": schema.StringAttribute{
								Description:         "CleanPolicy decides when to clean JindoFS Fuse pods.Currently Fluid supports two policies: OnDemand and OnRuntimeDeletedOnDemand cleans fuse pod once th fuse pod on some node is not neededOnRuntimeDeleted cleans fuse pod only when the cache runtime is deletedDefaults to OnRuntimeDeleted",
								MarkdownDescription: "CleanPolicy decides when to clean JindoFS Fuse pods.Currently Fluid supports two policies: OnDemand and OnRuntimeDeletedOnDemand cleans fuse pod once th fuse pod on some node is not neededOnRuntimeDeleted cleans fuse pod only when the cache runtime is deletedDefaults to OnRuntimeDeleted",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"resources": schema.SingleNestedAttribute{
								Description:         "Resources that will be requested by Jindo Fuse. <br><br>Resources are not allowed for ephemeral containers. Ephemeral containers use spare resourcesalready allocated to the pod.",
								MarkdownDescription: "Resources that will be requested by Jindo Fuse. <br><br>Resources are not allowed for ephemeral containers. Ephemeral containers use spare resourcesalready allocated to the pod.",
								Attributes: map[string]schema.Attribute{
					...
					"hadoop_config": schema.StringAttribute{
						Description:         "Name of the configMap used to support HDFS configurations when using HDFS as Jindo's UFS. The configMapmust be in the same namespace with the JindoRuntime. The configMap should contain user-specific HDFS conf files in it.For now, only 'hdfs-site.xml' and 'core-site.xml' are supported. It must take the filename of the conf file as the key and contentof the file as the value.",
					...
					"master": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"resources": schema.SingleNestedAttribute{
								Description:         "Resources that will be requested by the Jindo component. <br><br>Resources are not allowed for ephemeral containers. Ephemeral containers use spare resourcesalready allocated to the pod.",
								MarkdownDescription: "Resources that will be requested by the Jindo component. <br><br>Resources are not allowed for ephemeral containers. Ephemeral containers use spare resourcesalready allocated to the pod.",
								Attributes: map[string]schema.Attribute{
									"claims": schema.ListNestedAttribute{
										Description:         "Claims lists the names of resources, defined in spec.resourceClaims,that are used by this container.This is an alpha field and requires enabling theDynamicResourceAllocation feature gate.This field is immutable. It can only be set for containers.",
										MarkdownDescription: "Claims lists the names of resources, defined in spec.resourceClaims,that are used by this container.This is an alpha field and requires enabling theDynamicResourceAllocation feature gate.This field is immutable. It can only be set for containers.",
							...
							"volume_mounts": schema.ListNestedAttribute{
								...
								MarkdownDescription: "VolumeMounts specifies the volumes listed in '.spec.volumes' to mount into the jindo runtime component's filesystem.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
					...
					"volumes": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Volumes is the list of Kubernetes volumes that can be mounted by the jindo runtime components and/or fuses.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"aws_elastic_block_store": schema.SingleNestedAttribute{
									Description:         "awsElasticBlockStore represents an AWS Disk resource that is attached to akubelet's host machine and then exposed to the pod.More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore",
...
func (r *DataFluidIoJindoRuntimeV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_jindo_runtime_v1alpha1_manifest")

	var model DataFluidIoJindoRuntimeV1Alpha1ManifestData
