...
var (
	_ datasource.DataSource              = &DataFluidIoThinRuntimeProfileV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &DataFluidIoThinRuntimeProfileV1Alpha1DataSource{}
)

func NewDataFluidIoThinRuntimeProfileV1Alpha1DataSource() datasource.DataSource {
	return &DataFluidIoThinRuntimeProfileV1Alpha1DataSource{}
}

type DataFluidIoThinRuntimeProfileV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type DataFluidIoThinRuntimeProfileV1Alpha1DataSourceData struct {
...
func (r *DataFluidIoThinRuntimeProfileV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_data_fluid_io_thin_runtime_profile_v1alpha1"
}

func (r *DataFluidIoThinRuntimeProfileV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *DataFluidIoThinRuntimeProfileV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *DataFluidIoThinRuntimeProfileV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_data_fluid_io_thin_runtime_profile_v1alpha1")

	var data DataFluidIoThinRuntimeProfileV1Alpha1DataSourceData
	...
	var readResponse DataFluidIoThinRuntimeProfileV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ThinRuntimeProfile")
