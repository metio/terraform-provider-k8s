...
var (
	_ datasource.DataSource = &DataFluidIoAlluxioRuntimeV1Alpha1Manifest{}
)

func NewDataFluidIoAlluxioRuntimeV1Alpha1Manifest() datasource.DataSource {
	return &DataFluidIoAlluxioRuntimeV1Alpha1Manifest{}
}

type DataFluidIoAlluxioRuntimeV1Alpha1Manifest struct{}

type DataFluidIoAlluxioRuntimeV1Alpha1ManifestData struct {
...
func (r *DataFluidIoAlluxioRuntimeV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_data_fluid_io_alluxio_runtime_v1alpha1_manifest"
}

func (r *DataFluidIoAlluxioRuntimeV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *DataFluidIoAlluxioRuntimeV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_alluxio_runtime_v1alpha1_manifest")

	var model DataFluidIoAlluxioRuntimeV1Alpha1ManifestData
