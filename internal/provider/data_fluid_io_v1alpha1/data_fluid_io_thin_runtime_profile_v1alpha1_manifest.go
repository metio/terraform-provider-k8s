...
var (
	_ datasource.DataSource = &DataFluidIoThinRuntimeProfileV1Alpha1Manifest{}
)

func NewDataFluidIoThinRuntimeProfileV1Alpha1Manifest() datasource.DataSource {
	return &DataFluidIoThinRuntimeProfileV1Alpha1Manifest{}
}

type DataFluidIoThinRuntimeProfileV1Alpha1Manifest struct{}

type DataFluidIoThinRuntimeProfileV1Alpha1ManifestData struct {
...
func (r *DataFluidIoThinRuntimeProfileV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_data_fluid_io_thin_runtime_profile_v1alpha1_manifest"
}

func (r *DataFluidIoThinRuntimeProfileV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
					...
					"fuse": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"clean_policy": schema.StringAttribute{
								Description:         "CleanPolicy decides when to clean thinRuntime Fuse pods.Currently Fluid supports two policies: OnDemand and OnRuntimeDeletedOnDemand cleans fuse pod once the fuse pod on some node is not neededOnRuntimeDeleted cleans fuse pod only when the cache runtime is deletedDefaults to OnDemand",
...
func (r *DataFluidIoThinRuntimeProfileV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_thin_runtime_profile_v1alpha1_manifest")

	var model DataFluidIoThinRuntimeProfileV1Alpha1ManifestData
