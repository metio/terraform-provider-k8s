...
type DataFluidIoGooseFsruntimeV1Alpha1DataSourceData struct {
	...
	Spec *struct {
		...
		GoosefsVersion *struct {
			...
			ImagePullPolicy *string `tfsdk:"image_pull_policy" json:"imagePullPolicy,omitempty"`
			ImageTag        *string `tfsdk:"image_tag" json:"imageTag,omitempty"`
		} `tfsdk:"goosefs_version" json:"goosefsVersion,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"goosefs_version": schema.SingleNestedAttribute{
...
func (r *DataFluidIoGooseFsruntimeV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "data.fluid.io", Version: "v1alpha1", Resource: "goosefsruntimes"}).
	...
	data.Kind = pointer.String("GooseFSRuntime")
