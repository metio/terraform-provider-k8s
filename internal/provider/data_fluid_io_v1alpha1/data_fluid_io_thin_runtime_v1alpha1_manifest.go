			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"disable_prometheus": schema.BoolAttribute{
						Description:         "Disable monitoring for RuntimePrometheus is enabled by default",
						MarkdownDescription: "Disable monitoring for RuntimePrometheus is enabled by default",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
