...
var (
	_ datasource.DataSource              = &DataFluidIoJindoRuntimeV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &DataFluidIoJindoRuntimeV1Alpha1DataSource{}
)

func NewDataFluidIoJindoRuntimeV1Alpha1DataSource() datasource.DataSource {
	return &DataFluidIoJindoRuntimeV1Alpha1DataSource{}
}

type DataFluidIoJindoRuntimeV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type DataFluidIoJindoRuntimeV1Alpha1DataSourceData struct {
...
func (r *DataFluidIoJindoRuntimeV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_data_fluid_io_jindo_runtime_v1alpha1"
}

func (r *DataFluidIoJindoRuntimeV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *DataFluidIoJindoRuntimeV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *DataFluidIoJindoRuntimeV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_data_fluid_io_jindo_runtime_v1alpha1")

	var data DataFluidIoJindoRuntimeV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "data.fluid.io", Version: "v1alpha1", Resource: "jindoruntimes"}).
	...
	var readResponse DataFluidIoJindoRuntimeV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("JindoRuntime")
