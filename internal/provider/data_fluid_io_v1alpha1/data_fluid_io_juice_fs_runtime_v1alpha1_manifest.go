			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"disable_prometheus": schema.BoolAttribute{
						Description:         "Disable monitoring for JuiceFS RuntimePrometheus is enabled by default",
						MarkdownDescription: "Disable monitoring for JuiceFS RuntimePrometheus is enabled by default",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"fuse": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"clean_policy": schema.StringAttribute{
								Description:         "CleanPolicy decides when to clean Juicefs Fuse pods.Currently Fluid supports two policies: OnDemand and OnRuntimeDeletedOnDemand cleans fuse pod once th fuse pod on some node is not neededOnRuntimeDeleted cleans fuse pod only when the cache runtime is deletedDefaults to OnDemand",
								MarkdownDescription: "CleanPolicy decides when to clean Juicefs Fuse pods.Currently Fluid supports two policies: OnDemand and OnRuntimeDeletedOnDemand cleans fuse pod once th fuse pod on some node is not neededOnRuntimeDeleted cleans fuse pod only when the cache runtime is deletedDefaults to OnDemand",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"options": schema.MapAttribute{
								...
								MarkdownDescription: "Options mount options that fuse pod will use",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"juicefs_version": schema.SingleNestedAttribute{
...
func (r *DataFluidIoJuiceFsruntimeV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	...
	model.Kind = pointer.String("JuiceFSRuntime")
