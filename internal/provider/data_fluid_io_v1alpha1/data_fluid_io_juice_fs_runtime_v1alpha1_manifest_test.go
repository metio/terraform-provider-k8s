...
func TestDataFluidIoJuiceFSRuntimeV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_data_fluid_io_juice_fs_runtime_v1alpha1_manifest", testCase)
		})
	}
}
