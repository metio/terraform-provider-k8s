...
func TestDataFluidIoGooseFSRuntimeV1Alpha1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_data_fluid_io_goose_fs_runtime_v1alpha1", testCase)
		})
	}
}
...
func TestDataFluidIoGooseFSRuntimeV1Alpha1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_data_fluid_io_goose_fs_runtime_v1alpha1", configuration)
}
