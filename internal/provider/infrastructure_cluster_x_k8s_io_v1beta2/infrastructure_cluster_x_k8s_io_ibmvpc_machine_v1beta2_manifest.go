...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoIbmvpcmachineV1Beta2Manifest{}
)

func NewInfrastructureClusterXK8SIoIbmvpcmachineV1Beta2Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoIbmvpcmachineV1Beta2Manifest{}
}
...
func (r *InfrastructureClusterXK8SIoIbmvpcmachineV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_ibmvpc_machine_v1beta2_manifest"
}
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"additional_volumes": schema.ListNestedAttribute{
						Description:         "additionalVolumes is the list of additional volumes attached to the instance There is a hard limit of 12 volume attachments per instance: https://cloud.ibm.com/docs/vpc?topic=vpc-attaching-block-storage&interface=api#vol-attach-limits",
						MarkdownDescription: "additionalVolumes is the list of additional volumes attached to the instance There is a hard limit of 12 volume attachments per instance: https://cloud.ibm.com/docs/vpc?topic=vpc-attaching-block-storage&interface=api#vol-attach-limits",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"profile": schema.StringAttribute{
									Description:         "Profile is the volume profile for the disk, refer https://cloud.ibm.com/docs/vpc?topic=vpc-block-storage-profiles for more information. Default to general-purpose NOTE: If a profile other than custom is specified, the Iops and SizeGiB fields will be ignored",
									MarkdownDescription: "Profile is the volume profile for the disk, refer https://cloud.ibm.com/docs/vpc?topic=vpc-block-storage-profiles for more information. Default to general-purpose NOTE: If a profile other than custom is specified, the Iops and SizeGiB fields will be ignored",
									Required:            false,
									Optional:            true,
									Computed:            false,
									Validators: []validator.String{
								...
								"size_gi_b": schema.Int64Attribute{
									Description:         "SizeGiB is the size of the virtual server's disk in GiB. Default to the size of the image's 'minimum_provisioned_size'.",
									MarkdownDescription: "SizeGiB is the size of the virtual server's disk in GiB. Default to the size of the image's 'minimum_provisioned_size'.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
...
func (r *InfrastructureClusterXK8SIoIbmvpcmachineV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_ibmvpc_machine_v1beta2_manifest")

	var model InfrastructureClusterXK8SIoIbmvpcmachineV1Beta2ManifestData
