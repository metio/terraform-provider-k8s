...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoIbmpowerVsmachineTemplateV1Beta2Manifest{}
)

func NewInfrastructureClusterXK8SIoIbmpowerVsmachineTemplateV1Beta2Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoIbmpowerVsmachineTemplateV1Beta2Manifest{}
}
...
func (r *InfrastructureClusterXK8SIoIbmpowerVsmachineTemplateV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_ibm_power_vs_machine_template_v1beta2_manifest"
}
							...
							"spec": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"system_type": schema.StringAttribute{
										...
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("s922", "e980", "s1022", "e1050", "e1080", ""),
										},
									},
								},
								Required: true,
...
func (r *InfrastructureClusterXK8SIoIbmpowerVsmachineTemplateV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_ibm_power_vs_machine_template_v1beta2_manifest")

	var model InfrastructureClusterXK8SIoIbmpowerVsmachineTemplateV1Beta2ManifestData
