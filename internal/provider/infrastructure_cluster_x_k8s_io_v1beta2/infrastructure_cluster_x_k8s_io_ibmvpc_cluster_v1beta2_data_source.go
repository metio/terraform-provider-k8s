...
var (
	_ datasource.DataSource              = &InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource{}
)

func NewInfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource() datasource.DataSource {
	return &InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource{}
}

type InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSourceData struct {
...
func (r *InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_ibmvpc_cluster_v1beta2"
}

func (r *InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_infrastructure_cluster_x_k8s_io_ibmvpc_cluster_v1beta2")

	var data InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "infrastructure.cluster.x-k8s.io", Version: "v1beta2", Resource: "ibmvpcclusters"}).
	...
	var readResponse InfrastructureClusterXK8SIoIbmvpcclusterV1Beta2DataSourceData
