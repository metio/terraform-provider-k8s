...
var (
	_ datasource.DataSource = &IamServicesK8SAwsInstanceProfileV1Alpha1Manifest{}
)

func NewIamServicesK8SAwsInstanceProfileV1Alpha1Manifest() datasource.DataSource {
	return &IamServicesK8SAwsInstanceProfileV1Alpha1Manifest{}
}
...
func (r *IamServicesK8SAwsInstanceProfileV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_iam_services_k8s_aws_instance_profile_v1alpha1_manifest"
}
...
func (r *IamServicesK8SAwsInstanceProfileV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "InstanceProfile is the Schema for the InstanceProfiles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"name": schema.StringAttribute{
						Description:         "The name of the instance profile to create. This parameter allows (through its regex pattern (http://wikipedia.org/wiki/regex)) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@- Regex Pattern: '^[w+=,.@-]+$'",
						MarkdownDescription: "The name of the instance profile to create. This parameter allows (through its regex pattern (http://wikipedia.org/wiki/regex)) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@- Regex Pattern: '^[w+=,.@-]+$'",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"path": schema.StringAttribute{
						Description:         "The path to the instance profile. For more information about paths, see IAM Identifiers (https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html) in the IAM User Guide. This parameter is optional. If it is not included, it defaults to a slash (/). This parameter allows (through its regex pattern (http://wikipedia.org/wiki/regex)) a string of characters consisting of either a forward slash (/) by itself or a string that must begin and end with forward slashes. In addition, it can contain any ASCII character from the ! (u0021) through the DEL character (u007F), including most punctuation characters, digits, and upper and lowercased letters. Regex Pattern: '^(u002F)|(u002F[u0021-u007E]+u002F)$'",
...
func (r *IamServicesK8SAwsInstanceProfileV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_iam_services_k8s_aws_instance_profile_v1alpha1_manifest")

	var model IamServicesK8SAwsInstanceProfileV1Alpha1ManifestData
	...
	model.Kind = pointer.String("InstanceProfile")
