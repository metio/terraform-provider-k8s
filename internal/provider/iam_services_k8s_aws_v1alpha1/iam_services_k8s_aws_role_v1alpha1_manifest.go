			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"description": schema.StringAttribute{
						Description:         "A description of the role. Regex Pattern: '^[u0009u000Au000Du0020-u007Eu00A1-u00FF]*$'",
						MarkdownDescription: "A description of the role. Regex Pattern: '^[u0009u000Au000Du0020-u007Eu00A1-u00FF]*$'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"permissions_boundary": schema.StringAttribute{
						...
						MarkdownDescription: "The ARN of the managed policy that is used to set the permissions boundary for the role. A permissions boundary policy defines the maximum permissions that identity-based policies can grant to an entity, but does not grant permissions. Permissions boundaries do not define the maximum permissions that a resource-based policy can grant to an entity. To learn more, see Permissions boundaries for IAM entities (https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html) in the IAM User Guide. For more information about policy types, see Policy types (https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#access_policy-types) in the IAM User Guide.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
