...
var (
	_ datasource.DataSource = &IamServicesK8SAwsGroupV1Alpha1Manifest{}
)

func NewIamServicesK8SAwsGroupV1Alpha1Manifest() datasource.DataSource {
	return &IamServicesK8SAwsGroupV1Alpha1Manifest{}
}
...
func (r *IamServicesK8SAwsGroupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_iam_services_k8s_aws_group_v1alpha1_manifest"
}
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"name": schema.StringAttribute{
						Description:         "The name of the group to create. Do not include the path in this value. IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both 'MyResource' and 'myresource'. Regex Pattern: '^[w+=,.@-]+$'",
						MarkdownDescription: "The name of the group to create. Do not include the path in this value. IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both 'MyResource' and 'myresource'. Regex Pattern: '^[w+=,.@-]+$'",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *IamServicesK8SAwsGroupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_iam_services_k8s_aws_group_v1alpha1_manifest")

	var model IamServicesK8SAwsGroupV1Alpha1ManifestData
