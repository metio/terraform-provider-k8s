			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"code_signing_config_arn": schema.StringAttribute{
						Description:         "To enable code signing for this function, specify the ARN of a code-signing configuration. A code-signing configuration includes a set of signing profiles, which define the trusted publishers for this function. Regex Pattern: '^arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}((-gov)|(-iso(b?)))?-[a-z]+-d{1}:d{12}:code-signing-config:csc-[a-z0-9]{17}$'",
						MarkdownDescription: "To enable code signing for this function, specify the ARN of a code-signing configuration. A code-signing configuration includes a set of signing profiles, which define the trusted publishers for this function. Regex Pattern: '^arn:(aws[a-zA-Z-]*)?:lambda:[a-z]{2}((-gov)|(-iso(b?)))?-[a-z]+-d{1}:d{12}:code-signing-config:csc-[a-z0-9]{17}$'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"role": schema.StringAttribute{
						Description:         "The Amazon Resource Name (ARN) of the function's execution role. Regex Pattern: '^arn:(aws[a-zA-Z-]*)?:iam::d{12}:role/?[a-zA-Z_0-9+=,.@-_/]+$'",
						MarkdownDescription: "The Amazon Resource Name (ARN) of the function's execution role. Regex Pattern: '^arn:(aws[a-zA-Z-]*)?:iam::d{12}:role/?[a-zA-Z_0-9+=,.@-_/]+$'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
