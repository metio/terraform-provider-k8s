...
func TestLambdaServicesK8SAwsFunctionURLConfigV1Alpha1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_lambda_services_k8s_aws_function_url_config_v1alpha1", testCase)
		})
	}
}
...
func TestLambdaServicesK8SAwsFunctionURLConfigV1Alpha1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_lambda_services_k8s_aws_function_url_config_v1alpha1", configuration)
}
