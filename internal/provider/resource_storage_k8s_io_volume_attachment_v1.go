...
var (
	_ resource.Resource = (*StorageK8SIoVolumeAttachmentV1Resource)(nil)
)

type StorageK8SIoVolumeAttachmentV1TerraformModel struct {
...
type StorageK8SIoVolumeAttachmentV1GoModel struct {
	...
	Spec *struct {
		Attacher *string `tfsdk:"attacher" yaml:"attacher,omitempty"`
		...
		Source *struct {
			...
			} `tfsdk:"inline_volume_spec" yaml:"inlineVolumeSpec,omitempty"`

			PersistentVolumeName *string `tfsdk:"persistent_volume_name" yaml:"persistentVolumeName,omitempty"`
...
func (r *StorageK8SIoVolumeAttachmentV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_storage_k8s_io_volume_attachment_v1"
}

func (r *StorageK8SIoVolumeAttachmentV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *StorageK8SIoVolumeAttachmentV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_storage_k8s_io_volume_attachment_v1")

	var state StorageK8SIoVolumeAttachmentV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel StorageK8SIoVolumeAttachmentV1GoModel
	...
	goModel.Kind = utilities.Ptr("VolumeAttachment")
...
func (r *StorageK8SIoVolumeAttachmentV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_storage_k8s_io_volume_attachment_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *StorageK8SIoVolumeAttachmentV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *StorageK8SIoVolumeAttachmentV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
