...
var (
	_ datasource.DataSource = &KuadrantIoAuthPolicyV1Beta3Manifest{}
)

func NewKuadrantIoAuthPolicyV1Beta3Manifest() datasource.DataSource {
	return &KuadrantIoAuthPolicyV1Beta3Manifest{}
}

type KuadrantIoAuthPolicyV1Beta3Manifest struct{}

type KuadrantIoAuthPolicyV1Beta3ManifestData struct {
...
func (r *KuadrantIoAuthPolicyV1Beta3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuadrant_io_auth_policy_v1beta3_manifest"
}

func (r *KuadrantIoAuthPolicyV1Beta3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KuadrantIoAuthPolicyV1Beta3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuadrant_io_auth_policy_v1beta3_manifest")

	var model KuadrantIoAuthPolicyV1Beta3ManifestData
