...
var (
	_ datasource.DataSource = &FlowVolcanoShJobTemplateV1Alpha1Manifest{}
)

func NewFlowVolcanoShJobTemplateV1Alpha1Manifest() datasource.DataSource {
	return &FlowVolcanoShJobTemplateV1Alpha1Manifest{}
}

type FlowVolcanoShJobTemplateV1Alpha1Manifest struct{}

type FlowVolcanoShJobTemplateV1Alpha1ManifestData struct {
...
func (r *FlowVolcanoShJobTemplateV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_flow_volcano_sh_job_template_v1alpha1_manifest"
}

func (r *FlowVolcanoShJobTemplateV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *FlowVolcanoShJobTemplateV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_flow_volcano_sh_job_template_v1alpha1_manifest")

	var model FlowVolcanoShJobTemplateV1Alpha1ManifestData
