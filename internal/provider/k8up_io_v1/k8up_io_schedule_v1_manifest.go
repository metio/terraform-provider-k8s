					...
					"archive": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"restore_method": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "RestoreMethod contains how and where the restore should happen all the settings are mutual exclusive.",
								Attributes: map[string]schema.Attribute{
					...
					"backup": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"stats_url": schema.StringAttribute{
								Description:         "StatsURL sets an arbitrary URL where the restic container posts metrics and information about the snapshots to. This is in addition to the prometheus pushgateway.",
								MarkdownDescription: "StatsURL sets an arbitrary URL where the restic container posts metrics and information about the snapshots to. This is in addition to the prometheus pushgateway.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
