...
var (
	_ datasource.DataSource = &K8UpIoPreBackupPodV1Manifest{}
)

func NewK8UpIoPreBackupPodV1Manifest() datasource.DataSource {
	return &K8UpIoPreBackupPodV1Manifest{}
}

type K8UpIoPreBackupPodV1Manifest struct{}

type K8UpIoPreBackupPodV1ManifestData struct {
	...
	Spec *struct {
		BackupCommand *string `tfsdk:"backup_command" json:"backupCommand,omitempty"`
		FileExtension *string `tfsdk:"file_extension" json:"fileExtension,omitempty"`
		Pod           *struct {
...
func (r *K8UpIoPreBackupPodV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8up_io_pre_backup_pod_v1_manifest"
}

func (r *K8UpIoPreBackupPodV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "PreBackupPod is the Schema for the prebackuppods API",
		MarkdownDescription: "PreBackupPod is the Schema for the prebackuppods API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "PreBackupPodSpec define pods that will be launched during the backup. After the backup has finished (successfully or not), they should be removed again automatically by the operator.",
				MarkdownDescription: "PreBackupPodSpec define pods that will be launched during the backup. After the backup has finished (successfully or not), they should be removed again automatically by the operator.",
				Attributes: map[string]schema.Attribute{
					"backup_command": schema.StringAttribute{
						Description:         "BackupCommand will be added to the backupcommand annotation on the pod.",
						MarkdownDescription: "BackupCommand will be added to the backupcommand annotation on the pod.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"pod": schema.SingleNestedAttribute{
						Description:         "Pod is a dummy struct to fix some code generation issues.",
						MarkdownDescription: "Pod is a dummy struct to fix some code generation issues.",
						Attributes: map[string]schema.Attribute{
...
func (r *K8UpIoPreBackupPodV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8up_io_pre_backup_pod_v1_manifest")

	var model K8UpIoPreBackupPodV1ManifestData
	...
	model.Kind = pointer.String("PreBackupPod")
