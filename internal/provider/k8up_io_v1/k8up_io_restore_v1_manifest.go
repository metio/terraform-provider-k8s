...
var (
	_ datasource.DataSource = &K8UpIoRestoreV1Manifest{}
)

func NewK8UpIoRestoreV1Manifest() datasource.DataSource {
	return &K8UpIoRestoreV1Manifest{}
}

type K8UpIoRestoreV1Manifest struct{}

type K8UpIoRestoreV1ManifestData struct {
...
func (r *K8UpIoRestoreV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8up_io_restore_v1_manifest"
}

func (r *K8UpIoRestoreV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "RestoreSpec can either contain an S3 restore point or a local one. For the localone you need to define an existing PVC.",
				MarkdownDescription: "RestoreSpec can either contain an S3 restore point or a local one. For the localone you need to define an existing PVC.",
				Attributes: map[string]schema.Attribute{
...
func (r *K8UpIoRestoreV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8up_io_restore_v1_manifest")

	var model K8UpIoRestoreV1ManifestData
