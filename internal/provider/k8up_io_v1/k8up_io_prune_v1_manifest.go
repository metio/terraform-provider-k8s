...
var (
	_ datasource.DataSource = &K8UpIoPruneV1Manifest{}
)

func NewK8UpIoPruneV1Manifest() datasource.DataSource {
	return &K8UpIoPruneV1Manifest{}
}
...
func (r *K8UpIoPruneV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8up_io_prune_v1_manifest"
}

func (r *K8UpIoPruneV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "PruneSpec needs to contain the repository information as well as the desired retention policies.",
				MarkdownDescription: "PruneSpec needs to contain the repository information as well as the desired retention policies.",
				Attributes: map[string]schema.Attribute{
					...
					"retention": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"tags": schema.ListAttribute{
								Description:         "Tags is a filter on what tags the policy should be applied DO NOT CONFUSE THIS WITH KeepTags OR YOU'LL have a bad time",
								MarkdownDescription: "Tags is a filter on what tags the policy should be applied DO NOT CONFUSE THIS WITH KeepTags OR YOU'LL have a bad time",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
...
func (r *K8UpIoPruneV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8up_io_prune_v1_manifest")

	var model K8UpIoPruneV1ManifestData
