...
var (
	_ datasource.DataSource = &K8UpIoBackupV1Manifest{}
)

func NewK8UpIoBackupV1Manifest() datasource.DataSource {
	return &K8UpIoBackupV1Manifest{}
}

type K8UpIoBackupV1Manifest struct{}

type K8UpIoBackupV1ManifestData struct {
...
func (r *K8UpIoBackupV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8up_io_backup_v1_manifest"
}

func (r *K8UpIoBackupV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "BackupSpec defines a single backup. It must contain all information to connect to the backup repository when applied. If used with defaults or schedules the operator will ensure that the defaults are applied before creating the object on the API.",
				MarkdownDescription: "BackupSpec defines a single backup. It must contain all information to connect to the backup repository when applied. If used with defaults or schedules the operator will ensure that the defaults are applied before creating the object on the API.",
				Attributes: map[string]schema.Attribute{
...
func (r *K8UpIoBackupV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8up_io_backup_v1_manifest")

	var model K8UpIoBackupV1ManifestData
