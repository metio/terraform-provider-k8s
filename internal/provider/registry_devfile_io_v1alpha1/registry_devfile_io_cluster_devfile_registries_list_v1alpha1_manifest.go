...
var (
	_ datasource.DataSource = &RegistryDevfileIoClusterDevfileRegistriesListV1Alpha1Manifest{}
)

func NewRegistryDevfileIoClusterDevfileRegistriesListV1Alpha1Manifest() datasource.DataSource {
	return &RegistryDevfileIoClusterDevfileRegistriesListV1Alpha1Manifest{}
}
...
func (r *RegistryDevfileIoClusterDevfileRegistriesListV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_registry_devfile_io_cluster_devfile_registries_list_v1alpha1_manifest"
}

func (r *RegistryDevfileIoClusterDevfileRegistriesListV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RegistryDevfileIoClusterDevfileRegistriesListV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_registry_devfile_io_cluster_devfile_registries_list_v1alpha1_manifest")

	var model RegistryDevfileIoClusterDevfileRegistriesListV1Alpha1ManifestData
