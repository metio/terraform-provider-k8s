...
var (
	_ datasource.DataSource = &PostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest{}
)

func NewPostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest() datasource.DataSource {
	return &PostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest{}
}

type PostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest struct{}

type PostgresOperatorCrunchydataComPgupgradeV1Beta1ManifestData struct {
...
func (r *PostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_postgres_operator_crunchydata_com_pg_upgrade_v1beta1_manifest"
}

func (r *PostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "PGUpgrade is the Schema for the pgupgrades API",
		MarkdownDescription: "PGUpgrade is the Schema for the pgupgrades API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PGUpgradeSpec defines the desired state of PGUpgrade",
				Attributes: map[string]schema.Attribute{
					...
					"priority_class_name": schema.StringAttribute{
						...
						MarkdownDescription: "Priority class name for the PGUpgrade pod. Changing this value causes PGUpgrade pod to restart. More info: https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *PostgresOperatorCrunchydataComPgupgradeV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_postgres_operator_crunchydata_com_pg_upgrade_v1beta1_manifest")

	var model PostgresOperatorCrunchydataComPgupgradeV1Beta1ManifestData
	...
	model.Kind = pointer.String("PGUpgrade")
