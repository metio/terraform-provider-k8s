...
func TestPostgresOperatorCrunchydataComPostgresClusterV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_postgres_operator_crunchydata_com_postgres_cluster_v1beta1", testCase)
		})
	}
}
