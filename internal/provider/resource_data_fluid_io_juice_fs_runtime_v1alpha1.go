...
var (
	_ resource.Resource = (*DataFluidIoJuiceFSRuntimeV1Alpha1Resource)(nil)
)

type DataFluidIoJuiceFSRuntimeV1Alpha1TerraformModel struct {
...
type DataFluidIoJuiceFSRuntimeV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		JuicefsVersion *struct {
			Image *string `tfsdk:"image" yaml:"image,omitempty"`

			ImagePullPolicy *string `tfsdk:"image_pull_policy" yaml:"imagePullPolicy,omitempty"`

			ImageTag *string `tfsdk:"image_tag" yaml:"imageTag,omitempty"`
		} `tfsdk:"juicefs_version" yaml:"juicefsVersion,omitempty"`
...
func (r *DataFluidIoJuiceFSRuntimeV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_data_fluid_io_juice_fs_runtime_v1alpha1"
}

func (r *DataFluidIoJuiceFSRuntimeV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
			...
			"spec": {
				...
				Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
					...
					"disable_prometheus": {
						...
						MarkdownDescription: "Disable monitoring for JuiceFS Runtime Prometheus is enabled by default",
					...
					"fuse": {
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"env": {
								...
								MarkdownDescription: "Environment variables that will be used by JuiceFS Fuse",
							...
							"image": {
								...
								MarkdownDescription: "Image for JuiceFS fuse",
							...
							"pod_metadata": {
								...
								MarkdownDescription: "PodMetadata defines labels and annotations that will be propagated to JuiceFs's pods.",
							...
							"resources": {
								...
								MarkdownDescription: "Resources that will be requested by JuiceFS Fuse.",
					...
					"job_worker": {
						...
						MarkdownDescription: "The component spec of JuiceFS job Worker",
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"env": {
								...
								MarkdownDescription: "Environment variables that will be used by JuiceFS component.",
							...
							"ports": {
								...
								MarkdownDescription: "Ports used by JuiceFS",
							...
							"resources": {
								...
								MarkdownDescription: "Resources that will be requested by the JuiceFS component.",
					...
					"juicefs_version": {
						...
						MarkdownDescription: "The version information that instructs fluid to orchestrate a particular version of JuiceFS.",
					...
					"master": {
						...
						MarkdownDescription: "The component spec of JuiceFS master",
					...
					"run_as": {
						...
						MarkdownDescription: "Manage the user to run Juicefs Runtime",
					...
					"tieredstore": {
						...
						MarkdownDescription: "Tiered storage used by JuiceFS",
					...
					"worker": {
						...
						MarkdownDescription: "The component spec of JuiceFS worker",
...
func (r *DataFluidIoJuiceFSRuntimeV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_data_fluid_io_juice_fs_runtime_v1alpha1")

	var state DataFluidIoJuiceFSRuntimeV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel DataFluidIoJuiceFSRuntimeV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("JuiceFSRuntime")
...
func (r *DataFluidIoJuiceFSRuntimeV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_juice_fs_runtime_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *DataFluidIoJuiceFSRuntimeV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *DataFluidIoJuiceFSRuntimeV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
