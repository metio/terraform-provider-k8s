...
type AquasecurityGithubIoAquaStarboardV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*AquasecurityGithubIoAquaStarboardV1Alpha1Resource)(nil)
)

type AquasecurityGithubIoAquaStarboardV1Alpha1TerraformModel struct {
...
type AquasecurityGithubIoAquaStarboardV1Alpha1GoModel struct {
	...
	Spec *struct {
		AllowAnyVersion *bool `tfsdk:"allow_any_version" yaml:"allowAnyVersion,omitempty"`

		BatchDeleteDelay *string `tfsdk:"batch_delete_delay" yaml:"batchDeleteDelay,omitempty"`

		BatchDeleteLimit *string `tfsdk:"batch_delete_limit" yaml:"batchDeleteLimit,omitempty"`

		CisKubernetesBenchmarkEnabled *string `tfsdk:"cis_kubernetes_benchmark_enabled" yaml:"cisKubernetesBenchmarkEnabled,omitempty"`

		ConcurrentScanJobsLimit *string `tfsdk:"concurrent_scan_jobs_limit" yaml:"concurrentScanJobsLimit,omitempty"`

		Config *struct {
			ImagePullSecret *string `tfsdk:"image_pull_secret" yaml:"imagePullSecret,omitempty"`
		} `tfsdk:"config" yaml:"config,omitempty"`

		Config_map_checksum *string `tfsdk:"config_map_checksum" yaml:"config_map_checksum,omitempty"`
		...
		} `tfsdk:"deploy" yaml:"deploy,omitempty"`
		...
		Infra *struct {
			...
			Requirements *bool `tfsdk:"requirements" yaml:"requirements,omitempty"`

			ServiceAccount *string `tfsdk:"service_account" yaml:"serviceAccount,omitempty"`

			Version *string `tfsdk:"version" yaml:"version,omitempty"`
		} `tfsdk:"infra" yaml:"infra,omitempty"`

		Kube_enforcer_version *string `tfsdk:"kube_enforcer_version" yaml:"kube_enforcer_version,omitempty"`

		LogDevMode *bool `tfsdk:"log_dev_mode" yaml:"logDevMode,omitempty"`

		MetricsBindAddress *string `tfsdk:"metrics_bind_address" yaml:"metricsBindAddress,omitempty"`

		Operator_cluster_compliance_enabled *string `tfsdk:"operator_cluster_compliance_enabled" yaml:"operator_cluster_compliance_enabled,omitempty"`
		...
		ScanJobRetryAfter *string `tfsdk:"scan_job_retry_after" yaml:"scanJobRetryAfter,omitempty"`

		VulnerabilityScannerEnabled *string `tfsdk:"vulnerability_scanner_enabled" yaml:"vulnerabilityScannerEnabled,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewAquasecurityGithubIoAquaStarboardV1Alpha1Resource() resource.Resource {
	return &AquasecurityGithubIoAquaStarboardV1Alpha1Resource{}
}

func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_aquasecurity_github_io_aqua_starboard_v1alpha1"
}

func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "AquaStarboard is the Schema for the aquastarboards API",
		MarkdownDescription: "AquaStarboard is the Schema for the aquastarboards API",
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				Description:         "AquaStarboardSpec defines the desired state of AquaStarboard",
				MarkdownDescription: "AquaStarboardSpec defines the desired state of AquaStarboard",
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_aquasecurity_github_io_aqua_starboard_v1alpha1")

	var state AquasecurityGithubIoAquaStarboardV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AquasecurityGithubIoAquaStarboardV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("aquasecurity.github.io/v1alpha1")
	goModel.Kind = utilities.Ptr("AquaStarboard")
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_aquasecurity_github_io_aqua_starboard_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_aquasecurity_github_io_aqua_starboard_v1alpha1")
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_aquasecurity_github_io_aqua_starboard_v1alpha1")
