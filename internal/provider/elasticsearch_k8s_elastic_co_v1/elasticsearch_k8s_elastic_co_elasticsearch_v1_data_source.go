...
var (
	_ datasource.DataSource              = &ElasticsearchK8SElasticCoElasticsearchV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ElasticsearchK8SElasticCoElasticsearchV1DataSource{}
)

func NewElasticsearchK8SElasticCoElasticsearchV1DataSource() datasource.DataSource {
	return &ElasticsearchK8SElasticCoElasticsearchV1DataSource{}
}

type ElasticsearchK8SElasticCoElasticsearchV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ElasticsearchK8SElasticCoElasticsearchV1DataSourceData struct {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_elasticsearch_k8s_elastic_co_elasticsearch_v1"
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1")

	var data ElasticsearchK8SElasticCoElasticsearchV1DataSourceData
	...
	var readResponse ElasticsearchK8SElasticCoElasticsearchV1DataSourceData
	...
	data.ApiVersion = pointer.String("elasticsearch.k8s.elastic.co/v1")
