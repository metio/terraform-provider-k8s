					...
					"transport": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"tls": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"certificate": schema.SingleNestedAttribute{
										Description:         "Certificate is a reference to a Kubernetes secret that contains the CA certificateand private key for generating node certificates.The referenced secret should contain the following:- 'ca.crt': The CA certificate in PEM format.- 'ca.key': The private key for the CA certificate in PEM format.",
										MarkdownDescription: "Certificate is a reference to a Kubernetes secret that contains the CA certificateand private key for generating node certificates.The referenced secret should contain the following:- 'ca.crt': The CA certificate in PEM format.- 'ca.key': The private key for the CA certificate in PEM format.",
										Attributes: map[string]schema.Attribute{
											"secret_name": schema.StringAttribute{
												Description:         "SecretName is the name of the secret.",
												MarkdownDescription: "SecretName is the name of the secret.",
									...
									"certificate_authorities": schema.SingleNestedAttribute{
										Description:         "CertificateAuthorities is a reference to a config map that contains one or more x509 certificates fortrusted authorities in PEM format. The certificates need to be in a file called 'ca.crt'.",
										MarkdownDescription: "CertificateAuthorities is a reference to a config map that contains one or more x509 certificates fortrusted authorities in PEM format. The certificates need to be in a file called 'ca.crt'.",
										Attributes: map[string]schema.Attribute{
