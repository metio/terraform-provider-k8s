...
var (
	_ resource.Resource = (*ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource)(nil)
)

type ServicebindingIoClusterWorkloadResourceMappingV1Beta1TerraformModel struct {
...
type ServicebindingIoClusterWorkloadResourceMappingV1Beta1GoModel struct {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_servicebinding_io_cluster_workload_resource_mapping_v1beta1"
}

func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_servicebinding_io_cluster_workload_resource_mapping_v1beta1")

	var state ServicebindingIoClusterWorkloadResourceMappingV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ServicebindingIoClusterWorkloadResourceMappingV1Beta1GoModel
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_servicebinding_io_cluster_workload_resource_mapping_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ServicebindingIoClusterWorkloadResourceMappingV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
