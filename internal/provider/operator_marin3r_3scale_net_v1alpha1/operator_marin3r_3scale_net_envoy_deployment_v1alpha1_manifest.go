...
var (
	_ datasource.DataSource = &OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest{}
)

func NewOperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest() datasource.DataSource {
	return &OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest{}
}

type OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest struct{}

type OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1ManifestData struct {
	...
	Spec *struct {
		AdminAccessLogPath *string `tfsdk:"admin_access_log_path" json:"adminAccessLogPath,omitempty"`
		...
		DiscoveryServiceRef *string   `tfsdk:"discovery_service_ref" json:"discoveryServiceRef,omitempty"`
		Duration            *string   `tfsdk:"duration" json:"duration,omitempty"`
		EnvoyConfigRef      *string   `tfsdk:"envoy_config_ref" json:"envoyConfigRef,omitempty"`
		ExtraArgs           *[]string `tfsdk:"extra_args" json:"extraArgs,omitempty"`
		Image               *string   `tfsdk:"image" json:"image,omitempty"`
		InitManager         *struct {
			Image *string `tfsdk:"image" json:"image,omitempty"`
		} `tfsdk:"init_manager" json:"initManager,omitempty"`
		...
		Replicas *struct {
			...
			Static *int64 `tfsdk:"static" json:"static,omitempty"`
		...
		ShutdownManager *struct {
			DrainStrategy *string `tfsdk:"drain_strategy" json:"drainStrategy,omitempty"`
			DrainTime     *int64  `tfsdk:"drain_time" json:"drainTime,omitempty"`
			Image         *string `tfsdk:"image" json:"image,omitempty"`
			ServerPort    *int64  `tfsdk:"server_port" json:"serverPort,omitempty"`
		} `tfsdk:"shutdown_manager" json:"shutdownManager,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_marin3r_3scale_net_envoy_deployment_v1alpha1_manifest"
}

func (r *OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "EnvoyDeployment is a resource to deploy and manage a Kubernetes Deployment of Envoy Pods.",
		MarkdownDescription: "EnvoyDeployment is a resource to deploy and manage a Kubernetes Deployment of Envoy Pods.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "EnvoyDeploymentSpec defines the desired state of EnvoyDeployment",
				Attributes: map[string]schema.Attribute{
					"admin_access_log_path": schema.StringAttribute{
						Description:         "Configures envoy's admin access log path. Defaults to /dev/null.",
						MarkdownDescription: "Configures envoy's admin access log path. Defaults to /dev/null.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"admin_port": schema.Int64Attribute{
						...
						MarkdownDescription: "Configures envoy's admin port. Defaults to 9901.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"affinity": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Affinity configuration for the envoy pods",
						Attributes: map[string]schema.Attribute{
					...
					"cluster_id": schema.StringAttribute{
						...
						MarkdownDescription: "Defines the local service cluster name where Envoy is running. Defaults to the NodeID in the EnvoyConfig if unset",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"discovery_service_ref": schema.StringAttribute{
						Description:         "DiscoveryServiceRef points to a DiscoveryService in the same namespace",
						MarkdownDescription: "DiscoveryServiceRef points to a DiscoveryService in the same namespace",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"duration": schema.StringAttribute{
						...
						MarkdownDescription: "Defines the duration of the client certificate that is used to authenticate with the DiscoveryService",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"envoy_config_ref": schema.StringAttribute{
						...
						MarkdownDescription: "EnvoyConfigRef points to an EnvoyConfig in the same namespace that holds the envoy resources for this Deployment",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"extra_args": schema.ListAttribute{
						...
						MarkdownDescription: "Allows the user to define extra command line arguments for the Envoy process",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"image": schema.StringAttribute{
						...
						MarkdownDescription: "Image is the envoy image and tag to use",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"init_manager": schema.SingleNestedAttribute{
						Description:         "InitManager defines configuration for Envoy's init manager, which handles initialization for Envoy pods",
						MarkdownDescription: "InitManager defines configuration for Envoy's init manager, which handles initialization for Envoy pods",
						Attributes: map[string]schema.Attribute{
							"image": schema.StringAttribute{
								Description:         "Image is the init manager image and tag to use",
								MarkdownDescription: "Image is the init manager image and tag to use",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"liveness_probe": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Liveness probe for the envoy pods",
						Attributes: map[string]schema.Attribute{
					...
					"pod_disruption_budget": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Configures PodDisruptionBudget for the envoy Pods",
						Attributes: map[string]schema.Attribute{
					...
					"ports": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Ports exposed by the Envoy container",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
								...
								"port": schema.Int64Attribute{
									...
									MarkdownDescription: "Port value",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"protocol": schema.StringAttribute{
									...
									MarkdownDescription: "Protocol. Defaults to TCP.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"readiness_probe": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Readiness probe for the envoy pods",
						Attributes: map[string]schema.Attribute{
							"failure_threshold": schema.Int64Attribute{
								Description:         "Minimum consecutive failures for the probe to be considered failed after having succeeded",
								MarkdownDescription: "Minimum consecutive failures for the probe to be considered failed after having succeeded",
					...
					"replicas": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Replicas configures the number of replicas in the Deployment. One of 'static', 'dynamic' can be set. If both are set, static has precedence.",
						Attributes: map[string]schema.Attribute{
							"dynamic": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Configure a min and max value for the number of pods to autoscale dynamically.",
								Attributes: map[string]schema.Attribute{
							...
							"static": schema.Int64Attribute{
								...
								MarkdownDescription: "Configure a static number of replicas. Defaults to 1.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"resources": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Resources holds the resource requirements to use for the Envoy Deployment. Defaults to no resource requests nor limits.",
						Attributes: map[string]schema.Attribute{
					...
					"shutdown_manager": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ShutdownManager defines configuration for Envoy's shutdown manager, which handles graceful termination of Envoy pods",
						Attributes: map[string]schema.Attribute{
							"drain_strategy": schema.StringAttribute{
								...
								MarkdownDescription: "The drain strategy for the graceful shutdown. It also affects drain when listeners are modified or removed via LDS.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("gradual", "immediate"),
								},
							},

							"drain_time": schema.Int64Attribute{
								...
								MarkdownDescription: "The time in seconds that Envoy will drain connections during shutdown. It also affects drain behaviour when listeners are modified or removed via LDS.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"image": schema.StringAttribute{
								...
								MarkdownDescription: "Image is the shutdown manager image and tag to use",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"server_port": schema.Int64Attribute{
								...
								MarkdownDescription: "Configures the sutdown manager's server port. Defaults to 8090.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_marin3r_3scale_net_envoy_deployment_v1alpha1_manifest")

	var model OperatorMarin3R3ScaleNetEnvoyDeploymentV1Alpha1ManifestData
	...
	model.Kind = pointer.String("EnvoyDeployment")
