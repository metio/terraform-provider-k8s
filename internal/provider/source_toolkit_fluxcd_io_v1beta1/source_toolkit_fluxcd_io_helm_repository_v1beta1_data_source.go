...
var (
	_ datasource.DataSource              = &SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource{}
)

func NewSourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource() datasource.DataSource {
	return &SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource{}
}

type SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSourceData struct {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_source_toolkit_fluxcd_io_helm_repository_v1beta1"
}

func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_source_toolkit_fluxcd_io_helm_repository_v1beta1")

	var data SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "source.toolkit.fluxcd.io", Version: "v1beta1", Resource: "helmrepositories"}).
	...
	var readResponse SourceToolkitFluxcdIoHelmRepositoryV1Beta1DataSourceData
	...
	data.Kind = pointer.String("HelmRepository")
