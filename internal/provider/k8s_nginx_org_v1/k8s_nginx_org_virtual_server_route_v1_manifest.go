...
type K8SNginxOrgVirtualServerRouteV1ManifestData struct {
	...
	Spec *struct {
		...
		Upstreams *[]struct {
			...
			Busy_buffers_size    *string `tfsdk:"busy_buffers_size" json:"busy-buffers-size,omitempty"`
					...
					"upstreams": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"busy_buffers_size": schema.StringAttribute{
									...
									MarkdownDescription: "Sets the size of the buffers used for reading a response from the upstream server when the proxy_buffering is enabled. The default is set in the proxy-busy-buffers-size ConfigMap key.'",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
