			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"external_dns": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The externalDNS configuration for a VirtualServer.",
						Attributes: map[string]schema.Attribute{
							"enable": schema.BoolAttribute{
								Description:         "Enables ExternalDNS integration for a VirtualServer resource. The default is false.",
								MarkdownDescription: "Enables ExternalDNS integration for a VirtualServer resource. The default is false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"labels": schema.MapAttribute{
								...
								MarkdownDescription: "Configure labels to be applied to the Endpoint resources that will be consumed by ExternalDNS.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"provider_specific": schema.ListNestedAttribute{
								...
								MarkdownDescription: "Configure provider specific properties which holds the name and value of a configuration which is specific to individual DNS providers.",
							...
							"record_ttl": schema.Int64Attribute{
								...
								MarkdownDescription: "TTL for the DNS record. This defaults to 0 if not defined.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"record_type": schema.StringAttribute{
								...
								MarkdownDescription: "The record Type that should be created, e.g. “A”, “AAAA”, “CNAME”. This is automatically computed based on the external endpoints if not defined.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"gunzip": schema.BoolAttribute{
						...
						MarkdownDescription: "Enables or disables decompression of gzipped responses for clients. Allowed values “on”/“off”, “true”/“false” or “yes”/“no”. If the gunzip value is not set, it defaults to off.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"http_snippets": schema.StringAttribute{
						...
						MarkdownDescription: "Sets a custom snippet in the http context.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"listener": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"http": schema.StringAttribute{
								...
								MarkdownDescription: "The name of an HTTP listener defined in a GlobalConfiguration resource.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"https": schema.StringAttribute{
								...
								MarkdownDescription: "The name of an HTTPS listener defined in a GlobalConfiguration resource.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"policies": schema.ListNestedAttribute{
						...
						MarkdownDescription: "A list of policies.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
					...
					"routes": schema.ListNestedAttribute{
						...
						MarkdownDescription: "A list of routes.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"tls": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"cert_manager": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "The cert-manager configuration of the TLS for a VirtualServer.",
								Attributes: map[string]schema.Attribute{
									"cluster_issuer": schema.StringAttribute{
										...
										MarkdownDescription: "the name of a ClusterIssuer. A ClusterIssuer is a cert-manager resource which describes the certificate authority capable of signing certificates. It does not matter which namespace your VirtualServer resides, as ClusterIssuers are non-namespaced resources. Please note that one of issuer and cluster-issuer are required, but they are mutually exclusive - one and only one must be defined.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"common_name": schema.StringAttribute{
										...
										MarkdownDescription: "This field allows you to configure spec.commonName for the Certificate to be generated. This configuration adds a CN to the x509 certificate.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"duration": schema.StringAttribute{
										...
										MarkdownDescription: "This field allows you to configure spec.duration field for the Certificate to be generated. Must be specified using a Go time.Duration string format, which does not allow the d (days) suffix. You must specify these values using s, m, and h suffixes instead.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"issue_temp_cert": schema.BoolAttribute{
										...
										MarkdownDescription: "When true, ask cert-manager for a temporary self-signed certificate pending the issuance of the Certificate. This allows HTTPS-only servers to use ACME HTTP01 challenges when the TLS secret does not exist yet.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"issuer": schema.StringAttribute{
										...
										MarkdownDescription: "the name of an Issuer. An Issuer is a cert-manager resource which describes the certificate authority capable of signing certificates. The Issuer must be in the same namespace as the VirtualServer resource. Please note that one of issuer and cluster-issuer are required, but they are mutually exclusive - one and only one must be defined.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"issuer_group": schema.StringAttribute{
										...
										MarkdownDescription: "The API group of the external issuer controller, for example awspca.cert-manager.io. This is only necessary for out-of-tree issuers. This cannot be defined if cluster-issuer is also defined.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"issuer_kind": schema.StringAttribute{
										...
										MarkdownDescription: "The kind of the external issuer resource, for example AWSPCAIssuer. This is only necessary for out-of-tree issuers. This cannot be defined if cluster-issuer is also defined.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"renew_before": schema.StringAttribute{
										...
										MarkdownDescription: "this annotation allows you to configure spec.renewBefore field for the Certificate to be generated. Must be specified using a Go time.Duration string format, which does not allow the d (days) suffix. You must specify these values using s, m, and h suffixes instead.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"usages": schema.StringAttribute{
										...
										MarkdownDescription: "This field allows you to configure spec.usages field for the Certificate to be generated. Pass a string with comma-separated values i.e. key agreement,digital signature, server auth. An exhaustive list of supported key usages can be found in the the cert-manager api documentation.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"redirect": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "The redirect configuration of the TLS for a VirtualServer.",
								Attributes: map[string]schema.Attribute{
									"based_on": schema.StringAttribute{
										...
										MarkdownDescription: "The attribute of a request that NGINX will evaluate to send a redirect. The allowed values are scheme (the scheme of the request) or x-forwarded-proto (the X-Forwarded-Proto header of the request). The default is scheme.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"enable": schema.BoolAttribute{
										...
										MarkdownDescription: "Enables a TLS redirect for a VirtualServer. The default is False.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"secret": schema.StringAttribute{
								...
								MarkdownDescription: "The name of a secret with a TLS certificate and key. The secret must belong to the same namespace as the VirtualServer. The secret must be of the type kubernetes.io/tls and contain keys named tls.crt and tls.key that contain the certificate and private key as described here. If the secret doesn’t exist or is invalid, NGINX will break any attempt to establish a TLS connection to the host of the VirtualServer. If the secret is not specified but wildcard TLS secret is configured, NGINX will use the wildcard secret for TLS termination.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
