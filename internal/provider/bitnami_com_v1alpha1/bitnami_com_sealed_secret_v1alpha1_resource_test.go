...
func TestBitnamiComSealedSecretV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_bitnami_com_sealed_secret_v1alpha1", testCase)
		})
	}
}
