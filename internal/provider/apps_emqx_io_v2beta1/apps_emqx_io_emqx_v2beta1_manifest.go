...
var (
	_ datasource.DataSource = &AppsEmqxIoEmqxV2Beta1Manifest{}
)

func NewAppsEmqxIoEmqxV2Beta1Manifest() datasource.DataSource {
	return &AppsEmqxIoEmqxV2Beta1Manifest{}
}

type AppsEmqxIoEmqxV2Beta1Manifest struct{}

type AppsEmqxIoEmqxV2Beta1ManifestData struct {
	...
	Spec *struct {
		...
		CoreTemplate *struct {
			...
			Spec *struct {
				...
				ToleRations *[]struct {
					...
					Value             *string `tfsdk:"value" json:"value,omitempty"`
				} `tfsdk:"tole_rations" json:"toleRations,omitempty"`
				Tolerations *[]struct {
					Effect            *string `tfsdk:"effect" json:"effect,omitempty"`
					Key               *string `tfsdk:"key" json:"key,omitempty"`
					Operator          *string `tfsdk:"operator" json:"operator,omitempty"`
		...
		} `tfsdk:"core_template" json:"coreTemplate,omitempty"`
		DashboardServiceTemplate *struct {
		...
		} `tfsdk:"dashboard_service_template" json:"dashboardServiceTemplate,omitempty"`
		Image            *string `tfsdk:"image" json:"image,omitempty"`
		ImagePullPolicy  *string `tfsdk:"image_pull_policy" json:"imagePullPolicy,omitempty"`
		ImagePullSecrets *[]struct {
			Name *string `tfsdk:"name" json:"name,omitempty"`
		} `tfsdk:"image_pull_secrets" json:"imagePullSecrets,omitempty"`
		ListenersServiceTemplate *struct {
			Enabled  *bool `tfsdk:"enabled" json:"enabled,omitempty"`
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
				Finalizers  *[]string          `tfsdk:"finalizers" json:"finalizers,omitempty"`
		...
		} `tfsdk:"listeners_service_template" json:"listenersServiceTemplate,omitempty"`
		ReplicantTemplate *struct {
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
				Finalizers  *[]string          `tfsdk:"finalizers" json:"finalizers,omitempty"`
				Labels      *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		...
		} `tfsdk:"replicant_template" json:"replicantTemplate,omitempty"`
...
func (r *AppsEmqxIoEmqxV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_emqx_io_emqx_v2beta1_manifest"
}

func (r *AppsEmqxIoEmqxV2Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"core_template": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
							...
							"spec": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"tole_rations": schema.ListNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"volume_claim_templates": schema.SingleNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										Attributes: map[string]schema.Attribute{
											"access_modes": schema.ListAttribute{
					...
					"dashboard_service_template": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
					...
					"listeners_service_template": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
					...
					"replicant_template": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
					...
					"update_strategy": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"type": schema.StringAttribute{
								...
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("Recreate"),
								},
							},
						},
						Required: false,
...
func (r *AppsEmqxIoEmqxV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_emqx_io_emqx_v2beta1_manifest")

	var model AppsEmqxIoEmqxV2Beta1ManifestData
