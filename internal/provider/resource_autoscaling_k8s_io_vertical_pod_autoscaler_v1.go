...
var (
	_ resource.Resource = (*AutoscalingK8SIoVerticalPodAutoscalerV1Resource)(nil)
)

type AutoscalingK8SIoVerticalPodAutoscalerV1TerraformModel struct {
...
type AutoscalingK8SIoVerticalPodAutoscalerV1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"recommenders" yaml:"recommenders,omitempty"`

		ResourcePolicy *struct {
			ContainerPolicies *[]struct {
				ContainerName *string `tfsdk:"container_name" yaml:"containerName,omitempty"`

				ControlledResources *[]string `tfsdk:"controlled_resources" yaml:"controlledResources,omitempty"`

				ControlledValues *string `tfsdk:"controlled_values" yaml:"controlledValues,omitempty"`
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_autoscaling_k8s_io_vertical_pod_autoscaler_v1"
}

func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_autoscaling_k8s_io_vertical_pod_autoscaler_v1")

	var state AutoscalingK8SIoVerticalPodAutoscalerV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AutoscalingK8SIoVerticalPodAutoscalerV1GoModel
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_autoscaling_k8s_io_vertical_pod_autoscaler_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
