...
var (
	_ datasource.DataSource = &CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest{}
)

func NewCrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest() datasource.DataSource {
	return &CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest{}
}

type CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest struct{}

type CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1ManifestData struct {
...
func (r *CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_staged_global_network_policy_v1_manifest"
}

func (r *CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_crd_projectcalico_org_staged_global_network_policy_v1_manifest")

	var model CrdProjectcalicoOrgStagedGlobalNetworkPolicyV1ManifestData
	...
	model.Kind = pointer.String("StagedGlobalNetworkPolicy")
