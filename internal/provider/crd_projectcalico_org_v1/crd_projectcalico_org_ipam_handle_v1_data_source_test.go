...
func TestCrdProjectcalicoOrgIpamhandleV1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_crd_projectcalico_org_ipam_handle_v1", testCase)
		})
	}
}
...
func TestCrdProjectcalicoOrgIpamhandleV1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_crd_projectcalico_org_ipam_handle_v1", configuration)
}
