...
var (
	_ datasource.DataSource              = &CrdProjectcalicoOrgNetworkPolicyV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CrdProjectcalicoOrgNetworkPolicyV1DataSource{}
)

func NewCrdProjectcalicoOrgNetworkPolicyV1DataSource() datasource.DataSource {
	return &CrdProjectcalicoOrgNetworkPolicyV1DataSource{}
}

type CrdProjectcalicoOrgNetworkPolicyV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CrdProjectcalicoOrgNetworkPolicyV1DataSourceData struct {
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_network_policy_v1"
}

func (r *CrdProjectcalicoOrgNetworkPolicyV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CrdProjectcalicoOrgNetworkPolicyV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_crd_projectcalico_org_network_policy_v1")

	var data CrdProjectcalicoOrgNetworkPolicyV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "crd.projectcalico.org", Version: "v1", Resource: "networkpolicies"}).
	...
	var readResponse CrdProjectcalicoOrgNetworkPolicyV1DataSourceData
