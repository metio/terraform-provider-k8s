...
type CrdProjectcalicoOrgBgppeerV1ManifestData struct {
	...
	Spec *struct {
		...
		LocalASNumber            *int64    `tfsdk:"local_as_number" json:"localASNumber,omitempty"`
		...
		NextHopMode              *string   `tfsdk:"next_hop_mode" json:"nextHopMode,omitempty"`
		...
		ReversePeering *string `tfsdk:"reverse_peering" json:"reversePeering,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"next_hop_mode": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"reverse_peering": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
