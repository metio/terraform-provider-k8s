...
var (
	_ datasource.DataSource = &CrdProjectcalicoOrgNetworkSetV1Manifest{}
)

func NewCrdProjectcalicoOrgNetworkSetV1Manifest() datasource.DataSource {
	return &CrdProjectcalicoOrgNetworkSetV1Manifest{}
}
...
func (r *CrdProjectcalicoOrgNetworkSetV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_network_set_v1_manifest"
}
...
func (r *CrdProjectcalicoOrgNetworkSetV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_crd_projectcalico_org_network_set_v1_manifest")

	var model CrdProjectcalicoOrgNetworkSetV1ManifestData
