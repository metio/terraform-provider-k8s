...
func TestCrdProjectcalicoOrgBgpconfigurationV1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_crd_projectcalico_org_bgp_configuration_v1", testCase)
		})
	}
}
...
func TestCrdProjectcalicoOrgBgpconfigurationV1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_crd_projectcalico_org_bgp_configuration_v1", configuration)
}
