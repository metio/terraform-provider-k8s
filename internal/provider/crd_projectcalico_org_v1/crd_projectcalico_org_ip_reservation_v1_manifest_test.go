...
func TestCrdProjectcalicoOrgIPReservationV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_crd_projectcalico_org_ip_reservation_v1_manifest", testCase)
		})
	}
}
