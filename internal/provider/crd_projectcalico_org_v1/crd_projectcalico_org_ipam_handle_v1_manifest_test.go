...
func TestCrdProjectcalicoOrgIPAMHandleV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_crd_projectcalico_org_ipam_handle_v1_manifest", testCase)
		})
	}
}
