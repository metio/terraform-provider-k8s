...
var (
	_ datasource.DataSource              = &CrdProjectcalicoOrgCalicoNodeStatusV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CrdProjectcalicoOrgCalicoNodeStatusV1DataSource{}
)

func NewCrdProjectcalicoOrgCalicoNodeStatusV1DataSource() datasource.DataSource {
	return &CrdProjectcalicoOrgCalicoNodeStatusV1DataSource{}
}

type CrdProjectcalicoOrgCalicoNodeStatusV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CrdProjectcalicoOrgCalicoNodeStatusV1DataSourceData struct {
...
func (r *CrdProjectcalicoOrgCalicoNodeStatusV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_calico_node_status_v1"
}

func (r *CrdProjectcalicoOrgCalicoNodeStatusV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CrdProjectcalicoOrgCalicoNodeStatusV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CrdProjectcalicoOrgCalicoNodeStatusV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_crd_projectcalico_org_calico_node_status_v1")

	var data CrdProjectcalicoOrgCalicoNodeStatusV1DataSourceData
	...
	var readResponse CrdProjectcalicoOrgCalicoNodeStatusV1DataSourceData
	...
	data.Kind = pointer.String("CalicoNodeStatus")
