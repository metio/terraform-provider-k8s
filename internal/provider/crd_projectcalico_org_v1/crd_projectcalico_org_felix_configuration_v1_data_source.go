...
var (
	_ datasource.DataSource              = &CrdProjectcalicoOrgFelixConfigurationV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CrdProjectcalicoOrgFelixConfigurationV1DataSource{}
)

func NewCrdProjectcalicoOrgFelixConfigurationV1DataSource() datasource.DataSource {
	return &CrdProjectcalicoOrgFelixConfigurationV1DataSource{}
}

type CrdProjectcalicoOrgFelixConfigurationV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CrdProjectcalicoOrgFelixConfigurationV1DataSourceData struct {
...
func (r *CrdProjectcalicoOrgFelixConfigurationV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_felix_configuration_v1"
}

func (r *CrdProjectcalicoOrgFelixConfigurationV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CrdProjectcalicoOrgFelixConfigurationV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CrdProjectcalicoOrgFelixConfigurationV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_crd_projectcalico_org_felix_configuration_v1")

	var data CrdProjectcalicoOrgFelixConfigurationV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "crd.projectcalico.org", Version: "v1", Resource: "felixconfigurations"}).
	...
	var readResponse CrdProjectcalicoOrgFelixConfigurationV1DataSourceData
	...
	data.Kind = pointer.String("FelixConfiguration")
