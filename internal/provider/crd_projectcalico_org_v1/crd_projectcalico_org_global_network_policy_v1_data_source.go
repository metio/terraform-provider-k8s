...
var (
	_ datasource.DataSource              = &CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource{}
)

func NewCrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource() datasource.DataSource {
	return &CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource{}
}

type CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSourceData struct {
...
func (r *CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_global_network_policy_v1"
}

func (r *CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_crd_projectcalico_org_global_network_policy_v1")

	var data CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "crd.projectcalico.org", Version: "v1", Resource: "globalnetworkpolicies"}).
	...
	var readResponse CrdProjectcalicoOrgGlobalNetworkPolicyV1DataSourceData
	...
	data.Kind = pointer.String("GlobalNetworkPolicy")
