...
var (
	_ datasource.DataSource = &CrdProjectcalicoOrgGlobalNetworkSetV1Manifest{}
)

func NewCrdProjectcalicoOrgGlobalNetworkSetV1Manifest() datasource.DataSource {
	return &CrdProjectcalicoOrgGlobalNetworkSetV1Manifest{}
}
...
func (r *CrdProjectcalicoOrgGlobalNetworkSetV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_crd_projectcalico_org_global_network_set_v1_manifest"
}
...
func (r *CrdProjectcalicoOrgGlobalNetworkSetV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_crd_projectcalico_org_global_network_set_v1_manifest")

	var model CrdProjectcalicoOrgGlobalNetworkSetV1ManifestData
