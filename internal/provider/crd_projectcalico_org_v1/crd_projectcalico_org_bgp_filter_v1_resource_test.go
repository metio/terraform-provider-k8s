...
func TestCrdProjectcalicoOrgBGPFilterV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_crd_projectcalico_org_bgp_filter_v1", testCase)
		})
	}
}
