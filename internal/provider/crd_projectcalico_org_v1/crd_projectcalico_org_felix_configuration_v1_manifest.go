...
type CrdProjectcalicoOrgFelixConfigurationV1ManifestData struct {
	...
	Spec *struct {
		...
		ProgramRoutes                      *string   `tfsdk:"program_routes" json:"programRoutes,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"bpf_conntrack_mode": schema.StringAttribute{
						...
						MarkdownDescription: "BPFConntrackCleanupMode controls how BPF conntrack entries are cleaned up. 'Auto' will use a BPF program if supported, falling back to userspace if not. 'Userspace' will always use the userspace cleanup code. 'BPFProgram' will always use the BPF program (failing if not supported). [Default: Auto]",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"program_routes": schema.StringAttribute{
						...
						MarkdownDescription: "ProgramRoutes specifies whether Felix should program IPIP or unencapsulated routes instead of BIRD. Felix always programs VXLAN routes. [Default: Disabled]",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
