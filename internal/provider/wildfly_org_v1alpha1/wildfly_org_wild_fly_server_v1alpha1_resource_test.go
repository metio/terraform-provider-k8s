...
func TestWildflyOrgWildFlyServerV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_wildfly_org_wild_fly_server_v1alpha1", testCase)
		})
	}
}
