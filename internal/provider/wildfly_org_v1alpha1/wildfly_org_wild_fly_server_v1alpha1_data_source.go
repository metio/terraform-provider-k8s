...
var (
	_ datasource.DataSource              = &WildflyOrgWildFlyServerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &WildflyOrgWildFlyServerV1Alpha1DataSource{}
)

func NewWildflyOrgWildFlyServerV1Alpha1DataSource() datasource.DataSource {
	return &WildflyOrgWildFlyServerV1Alpha1DataSource{}
}

type WildflyOrgWildFlyServerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type WildflyOrgWildFlyServerV1Alpha1DataSourceData struct {
...
func (r *WildflyOrgWildFlyServerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wildfly_org_wild_fly_server_v1alpha1"
}

func (r *WildflyOrgWildFlyServerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WildflyOrgWildFlyServerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *WildflyOrgWildFlyServerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_wildfly_org_wild_fly_server_v1alpha1")

	var data WildflyOrgWildFlyServerV1Alpha1DataSourceData
	...
	var readResponse WildflyOrgWildFlyServerV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("wildfly.org/v1alpha1")
	data.Kind = pointer.String("WildFlyServer")
