...
var (
	_ datasource.DataSource = &WildflyOrgWildFlyServerV1Alpha1Manifest{}
)

func NewWildflyOrgWildFlyServerV1Alpha1Manifest() datasource.DataSource {
	return &WildflyOrgWildFlyServerV1Alpha1Manifest{}
}

type WildflyOrgWildFlyServerV1Alpha1Manifest struct{}

type WildflyOrgWildFlyServerV1Alpha1ManifestData struct {
...
func (r *WildflyOrgWildFlyServerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wildfly_org_wild_fly_server_v1alpha1_manifest"
}

func (r *WildflyOrgWildFlyServerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
					...
					"liveness_probe": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"failure_threshold": schema.Int64Attribute{
								...
								MarkdownDescription: "Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3 for liveness and readiness probes and 11 for startup probe. Minimum value is 1.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"initial_delay_seconds": schema.Int64Attribute{
								...
								MarkdownDescription: "Number of seconds after the container has started before probes are initiated. It defaults to 0 seconds for liveness and 10 seconds for readiness and startup probes. Minimum value is 0. Minimum value is 0.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
							...
							"period_seconds": schema.Int64Attribute{
								...
								MarkdownDescription: "How often (in seconds) to perform the probe. Default to 10 seconds for liveness, readiness and startup probes. Minimum value is 1.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
							...
							"success_threshold": schema.Int64Attribute{
								...
								MarkdownDescription: "Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1 for liveness, readiness and startup probes. Minimum value is 1.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
							...
							"timeout_seconds": schema.Int64Attribute{
								...
								MarkdownDescription: "Number of seconds after which the probe times out. Defaults to 1 second for liveness, readiness and startup probes. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
...
func (r *WildflyOrgWildFlyServerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_wildfly_org_wild_fly_server_v1alpha1_manifest")

	var model WildflyOrgWildFlyServerV1Alpha1ManifestData
