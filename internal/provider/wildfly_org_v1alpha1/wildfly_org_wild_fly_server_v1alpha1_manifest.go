					...
					"liveness_probe": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"failure_threshold": schema.Int64Attribute{
								...
								MarkdownDescription: "Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3 for liveness and readiness probes and 36 seconds for startup probe. Minimum value is 1.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"initial_delay_seconds": schema.Int64Attribute{
								...
								MarkdownDescription: "Number of seconds after the container has started before probes are initiated. It defaults to 0 seconds for liveness and readiness probes and 5 seconds for startup probe. Minimum value is 0. Minimum value is 0.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
							...
							"period_seconds": schema.Int64Attribute{
								...
								MarkdownDescription: "How often (in seconds) to perform the probe. Default to 10 seconds for liveness and readiness probes and 5 seconds for startup probe. Minimum value is 1.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
