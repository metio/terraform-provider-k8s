...
var (
	_ datasource.DataSource = &RcAppStacksRuntimeComponentV1Manifest{}
)

func NewRcAppStacksRuntimeComponentV1Manifest() datasource.DataSource {
	return &RcAppStacksRuntimeComponentV1Manifest{}
}
...
type RcAppStacksRuntimeComponentV1ManifestData struct {
	...
	Spec *struct {
		...
		ManageTLS  *bool `tfsdk:"manage_tls" json:"manageTLS,omitempty"`
		Monitoring *struct {
			Endpoints *[]struct {
		...
		NetworkPolicy *struct {
			...
			FromLabels      *map[string]string `tfsdk:"from_labels" json:"fromLabels,omitempty"`
		...
		ServiceAccount *struct {
			MountToken               *bool   `tfsdk:"mount_token" json:"mountToken,omitempty"`
			Name                     *string `tfsdk:"name" json:"name,omitempty"`
			SkipPullSecretValidation *bool   `tfsdk:"skip_pull_secret_validation" json:"skipPullSecretValidation,omitempty"`
		...
		TopologySpreadConstraints *struct {
			...
			DisableOperatorDefaults *bool `tfsdk:"disable_operator_defaults" json:"disableOperatorDefaults,omitempty"`
...
func (r *RcAppStacksRuntimeComponentV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rc_app_stacks_runtime_component_v1_manifest"
}

func (r *RcAppStacksRuntimeComponentV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"autoscaling": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"behavior": schema.SingleNestedAttribute{
								Description:         "Scaling behavior of the target. If not set, the default HPAScalingRules for scale up and scale down are used.",
								MarkdownDescription: "Scaling behavior of the target. If not set, the default HPAScalingRules for scale up and scale down are used.",
								Attributes: map[string]schema.Attribute{
							...
							"metrics": schema.ListNestedAttribute{
								...
								MarkdownDescription: "Specifications used for replica count calculation",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
							...
							"target_memory_utilization_percentage": schema.Int64Attribute{
								Description:         "Target average Memory utilization, represented as a percentage of requested memory, over all the pods.",
								MarkdownDescription: "Target average Memory utilization, represented as a percentage of requested memory, over all the pods.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"disable_service_links": schema.BoolAttribute{
						...
						MarkdownDescription: "Disable information about services being injected into the application pod's environment variables. Default to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"manage_tls": schema.BoolAttribute{
						Description:         "Enable management of TLS certificates. Defaults to true.",
						MarkdownDescription: "Enable management of TLS certificates. Defaults to true.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"network_policy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Defines the network policy",
						Attributes: map[string]schema.Attribute{
							"disable": schema.BoolAttribute{
								Description:         "Disable the creation of the network policy. Defaults to false.",
								MarkdownDescription: "Disable the creation of the network policy. Defaults to false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"from_labels": schema.MapAttribute{
								Description:         "Specify the labels of pod(s) that incoming traffic is allowed from.",
								MarkdownDescription: "Specify the labels of pod(s) that incoming traffic is allowed from.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"namespace_labels": schema.MapAttribute{
								...
								MarkdownDescription: "Specify the labels of namespaces that incoming traffic is allowed from.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"replicas": schema.Int64Attribute{
						...
						MarkdownDescription: "Number of pods to create. Defaults to 1. Not applicable when .spec.autoscaling or .spec.createKnativeService is specified.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"route": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"certificate_secret_ref": schema.StringAttribute{
								...
								MarkdownDescription: "A name of a secret that already contains TLS key, certificate and CA to be used in the route. It can also contain destination CA certificate. The following keys are valid in the secret: ca.crt, destCA.crt, tls.crt, and tls.key.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"security_context": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Security context for the application container.",
						Attributes: map[string]schema.Attribute{
							"allow_privilege_escalation": schema.BoolAttribute{
								Description:         "AllowPrivilegeEscalation controls whether a process can gain more privileges than its parent process. This bool directly controls if the no_new_privs flag will be set on the container process. AllowPrivilegeEscalation is true always when the container is: 1) run as Privileged 2) has CAP_SYS_ADMIN Note that this field cannot be set when spec.os.name is windows.",
								MarkdownDescription: "AllowPrivilegeEscalation controls whether a process can gain more privileges than its parent process. This bool directly controls if the no_new_privs flag will be set on the container process. AllowPrivilegeEscalation is true always when the container is: 1) run as Privileged 2) has CAP_SYS_ADMIN Note that this field cannot be set when spec.os.name is windows.",
					...
					"service": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"certificate": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Configure service certificate.",
								Attributes: map[string]schema.Attribute{
									"annotations": schema.MapAttribute{
										Description:         "Annotations to be added to the service certificate.",
										MarkdownDescription: "Annotations to be added to the service certificate.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
							...
							"certificate_secret_ref": schema.StringAttribute{
								...
								MarkdownDescription: "A name of a secret that already contains TLS key, certificate and CA to be mounted in the pod. The following keys are valid in the secret: ca.crt, tls.crt, and tls.key.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"session_affinity": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"config": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Configurations of session affinity.",
										Attributes: map[string]schema.Attribute{
									...
									"type": schema.StringAttribute{
										...
										MarkdownDescription: "Setting to maintain session affinity. Must be ClientIP or None. Defaults to None.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
					...
					"service_account": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The service account to use for deploying the application. A service account is automatically created if this is not specifed.",
						Attributes: map[string]schema.Attribute{
							"mount_token": schema.BoolAttribute{
								Description:         "Whether the Service Account token should be mounted into the application pods. Defaults to true.",
								MarkdownDescription: "Whether the Service Account token should be mounted into the application pods. Defaults to true.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"skip_pull_secret_validation": schema.BoolAttribute{
								Description:         "Skip verifying that the service account has a valid pull secret. Defaults to false.",
								MarkdownDescription: "Skip verifying that the service account has a valid pull secret. Defaults to false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"service_account_name": schema.StringAttribute{
						...
						MarkdownDescription: "Deprecated. .spec.serviceAccount.name should be used instead. If both are specified, .spec.serviceAccount.name will override this.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
							...
							"storage": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"class_name": schema.StringAttribute{
										...
										MarkdownDescription: "A convenient field to request the storage class of the persisted storage. The name can not be specified or updated after the storage is created.",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.String{
					...
					"topology_spread_constraints": schema.SingleNestedAttribute{
						Description:         "Defines the topology spread constraints",
						MarkdownDescription: "Defines the topology spread constraints",
						Attributes: map[string]schema.Attribute{
							"constraints": schema.ListNestedAttribute{
								Description:         "The list of TopologySpreadConstraints for the application pod.",
								MarkdownDescription: "The list of TopologySpreadConstraints for the application pod.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"label_selector": schema.SingleNestedAttribute{
							...
							"disable_operator_defaults": schema.BoolAttribute{
								Description:         "Whether the operator should disable its default set of TopologySpreadConstraints. Defaults to false.",
								MarkdownDescription: "Whether the operator should disable its default set of TopologySpreadConstraints. Defaults to false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *RcAppStacksRuntimeComponentV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rc_app_stacks_runtime_component_v1_manifest")

	var model RcAppStacksRuntimeComponentV1ManifestData
