...
var (
	_ datasource.DataSource = &NetworkingIstioIoGatewayV1Beta1Manifest{}
)

func NewNetworkingIstioIoGatewayV1Beta1Manifest() datasource.DataSource {
	return &NetworkingIstioIoGatewayV1Beta1Manifest{}
}

type NetworkingIstioIoGatewayV1Beta1Manifest struct{}

type NetworkingIstioIoGatewayV1Beta1ManifestData struct {
...
func (r *NetworkingIstioIoGatewayV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_gateway_v1beta1_manifest"
}

func (r *NetworkingIstioIoGatewayV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoGatewayV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_gateway_v1beta1_manifest")

	var model NetworkingIstioIoGatewayV1Beta1ManifestData
