...
var (
	_ datasource.DataSource              = &NetworkingIstioIoGatewayV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoGatewayV1Beta1DataSource{}
)

func NewNetworkingIstioIoGatewayV1Beta1DataSource() datasource.DataSource {
	return &NetworkingIstioIoGatewayV1Beta1DataSource{}
}

type NetworkingIstioIoGatewayV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoGatewayV1Beta1DataSourceData struct {
...
func (r *NetworkingIstioIoGatewayV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_gateway_v1beta1"
}

func (r *NetworkingIstioIoGatewayV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoGatewayV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoGatewayV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_gateway_v1beta1")

	var data NetworkingIstioIoGatewayV1Beta1DataSourceData
	...
	var readResponse NetworkingIstioIoGatewayV1Beta1DataSourceData
