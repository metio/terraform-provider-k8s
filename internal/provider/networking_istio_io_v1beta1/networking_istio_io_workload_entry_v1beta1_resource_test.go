...
func TestNetworkingIstioIoWorkloadEntryV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_networking_istio_io_workload_entry_v1beta1", testCase)
		})
	}
}
