...
var (
	_ datasource.DataSource              = &NetworkingIstioIoWorkloadGroupV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoWorkloadGroupV1Beta1DataSource{}
)

func NewNetworkingIstioIoWorkloadGroupV1Beta1DataSource() datasource.DataSource {
	return &NetworkingIstioIoWorkloadGroupV1Beta1DataSource{}
}

type NetworkingIstioIoWorkloadGroupV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoWorkloadGroupV1Beta1DataSourceData struct {
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_workload_group_v1beta1"
}

func (r *NetworkingIstioIoWorkloadGroupV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_workload_group_v1beta1")

	var data NetworkingIstioIoWorkloadGroupV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "networking.istio.io", Version: "v1beta1", Resource: "workloadgroups"}).
	...
	var readResponse NetworkingIstioIoWorkloadGroupV1Beta1DataSourceData
