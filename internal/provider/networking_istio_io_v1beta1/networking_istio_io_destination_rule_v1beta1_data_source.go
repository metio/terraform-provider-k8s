...
var (
	_ datasource.DataSource              = &NetworkingIstioIoDestinationRuleV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoDestinationRuleV1Beta1DataSource{}
)

func NewNetworkingIstioIoDestinationRuleV1Beta1DataSource() datasource.DataSource {
	return &NetworkingIstioIoDestinationRuleV1Beta1DataSource{}
}

type NetworkingIstioIoDestinationRuleV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoDestinationRuleV1Beta1DataSourceData struct {
...
func (r *NetworkingIstioIoDestinationRuleV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_destination_rule_v1beta1"
}

func (r *NetworkingIstioIoDestinationRuleV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoDestinationRuleV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoDestinationRuleV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_destination_rule_v1beta1")

	var data NetworkingIstioIoDestinationRuleV1Beta1DataSourceData
	...
	var readResponse NetworkingIstioIoDestinationRuleV1Beta1DataSourceData
