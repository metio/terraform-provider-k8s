...
var (
	_ datasource.DataSource = &NetworkingIstioIoDestinationRuleV1Beta1Manifest{}
)

func NewNetworkingIstioIoDestinationRuleV1Beta1Manifest() datasource.DataSource {
	return &NetworkingIstioIoDestinationRuleV1Beta1Manifest{}
}

type NetworkingIstioIoDestinationRuleV1Beta1Manifest struct{}

type NetworkingIstioIoDestinationRuleV1Beta1ManifestData struct {
...
func (r *NetworkingIstioIoDestinationRuleV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_destination_rule_v1beta1_manifest"
}

func (r *NetworkingIstioIoDestinationRuleV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoDestinationRuleV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_destination_rule_v1beta1_manifest")

	var model NetworkingIstioIoDestinationRuleV1Beta1ManifestData
