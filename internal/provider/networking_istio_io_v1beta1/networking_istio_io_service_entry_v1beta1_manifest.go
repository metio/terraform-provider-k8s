...
var (
	_ datasource.DataSource = &NetworkingIstioIoServiceEntryV1Beta1Manifest{}
)

func NewNetworkingIstioIoServiceEntryV1Beta1Manifest() datasource.DataSource {
	return &NetworkingIstioIoServiceEntryV1Beta1Manifest{}
}

type NetworkingIstioIoServiceEntryV1Beta1Manifest struct{}

type NetworkingIstioIoServiceEntryV1Beta1ManifestData struct {
...
func (r *NetworkingIstioIoServiceEntryV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_service_entry_v1beta1_manifest"
}

func (r *NetworkingIstioIoServiceEntryV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoServiceEntryV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_service_entry_v1beta1_manifest")

	var model NetworkingIstioIoServiceEntryV1Beta1ManifestData
