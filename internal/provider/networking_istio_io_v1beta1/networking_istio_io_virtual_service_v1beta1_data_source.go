...
var (
	_ datasource.DataSource              = &NetworkingIstioIoVirtualServiceV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoVirtualServiceV1Beta1DataSource{}
)

func NewNetworkingIstioIoVirtualServiceV1Beta1DataSource() datasource.DataSource {
	return &NetworkingIstioIoVirtualServiceV1Beta1DataSource{}
}

type NetworkingIstioIoVirtualServiceV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoVirtualServiceV1Beta1DataSourceData struct {
...
func (r *NetworkingIstioIoVirtualServiceV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_virtual_service_v1beta1"
}

func (r *NetworkingIstioIoVirtualServiceV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoVirtualServiceV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoVirtualServiceV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_virtual_service_v1beta1")

	var data NetworkingIstioIoVirtualServiceV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "networking.istio.io", Version: "v1beta1", Resource: "VirtualService"}).
	...
	var readResponse NetworkingIstioIoVirtualServiceV1Beta1DataSourceData
