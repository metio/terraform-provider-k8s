...
var (
	_ datasource.DataSource = &NetworkingIstioIoWorkloadEntryV1Beta1Manifest{}
)

func NewNetworkingIstioIoWorkloadEntryV1Beta1Manifest() datasource.DataSource {
	return &NetworkingIstioIoWorkloadEntryV1Beta1Manifest{}
}

type NetworkingIstioIoWorkloadEntryV1Beta1Manifest struct{}

type NetworkingIstioIoWorkloadEntryV1Beta1ManifestData struct {
...
func (r *NetworkingIstioIoWorkloadEntryV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_workload_entry_v1beta1_manifest"
}

func (r *NetworkingIstioIoWorkloadEntryV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoWorkloadEntryV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_workload_entry_v1beta1_manifest")

	var model NetworkingIstioIoWorkloadEntryV1Beta1ManifestData
