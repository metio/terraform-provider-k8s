...
var (
	_ datasource.DataSource = &NetworkingIstioIoWorkloadGroupV1Beta1Manifest{}
)

func NewNetworkingIstioIoWorkloadGroupV1Beta1Manifest() datasource.DataSource {
	return &NetworkingIstioIoWorkloadGroupV1Beta1Manifest{}
}

type NetworkingIstioIoWorkloadGroupV1Beta1Manifest struct{}

type NetworkingIstioIoWorkloadGroupV1Beta1ManifestData struct {
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_workload_group_v1beta1_manifest"
}

func (r *NetworkingIstioIoWorkloadGroupV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoWorkloadGroupV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_workload_group_v1beta1_manifest")

	var model NetworkingIstioIoWorkloadGroupV1Beta1ManifestData
