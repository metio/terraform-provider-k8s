...
var (
	_ datasource.DataSource              = &NetworkingIstioIoServiceEntryV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoServiceEntryV1Beta1DataSource{}
)

func NewNetworkingIstioIoServiceEntryV1Beta1DataSource() datasource.DataSource {
	return &NetworkingIstioIoServiceEntryV1Beta1DataSource{}
}

type NetworkingIstioIoServiceEntryV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoServiceEntryV1Beta1DataSourceData struct {
...
func (r *NetworkingIstioIoServiceEntryV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_service_entry_v1beta1"
}

func (r *NetworkingIstioIoServiceEntryV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoServiceEntryV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoServiceEntryV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_service_entry_v1beta1")

	var data NetworkingIstioIoServiceEntryV1Beta1DataSourceData
	...
	var readResponse NetworkingIstioIoServiceEntryV1Beta1DataSourceData
