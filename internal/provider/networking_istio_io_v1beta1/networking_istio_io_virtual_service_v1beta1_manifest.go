...
var (
	_ datasource.DataSource = &NetworkingIstioIoVirtualServiceV1Beta1Manifest{}
)

func NewNetworkingIstioIoVirtualServiceV1Beta1Manifest() datasource.DataSource {
	return &NetworkingIstioIoVirtualServiceV1Beta1Manifest{}
}

type NetworkingIstioIoVirtualServiceV1Beta1Manifest struct{}

type NetworkingIstioIoVirtualServiceV1Beta1ManifestData struct {
...
func (r *NetworkingIstioIoVirtualServiceV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_virtual_service_v1beta1_manifest"
}

func (r *NetworkingIstioIoVirtualServiceV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoVirtualServiceV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_virtual_service_v1beta1_manifest")

	var model NetworkingIstioIoVirtualServiceV1Beta1ManifestData
