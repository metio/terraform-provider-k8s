...
var (
	_ datasource.DataSource              = &PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource{}
)

func NewPolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource() datasource.DataSource {
	return &PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource{}
}

type PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSourceData struct {
...
func (r *PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_policy_networking_k8s_io_baseline_admin_network_policy_v1alpha1"
}

func (r *PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_policy_networking_k8s_io_baseline_admin_network_policy_v1alpha1")

	var data PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSourceData
	...
	var readResponse PolicyNetworkingK8SIoBaselineAdminNetworkPolicyV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("BaselineAdminNetworkPolicy")
