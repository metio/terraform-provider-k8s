...
var (
	_ datasource.DataSource = &TemplatesGatekeeperShConstraintTemplateV1Beta1Manifest{}
)

func NewTemplatesGatekeeperShConstraintTemplateV1Beta1Manifest() datasource.DataSource {
	return &TemplatesGatekeeperShConstraintTemplateV1Beta1Manifest{}
}
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_templates_gatekeeper_sh_constraint_template_v1beta1_manifest"
}

func (r *TemplatesGatekeeperShConstraintTemplateV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_templates_gatekeeper_sh_constraint_template_v1beta1_manifest")

	var model TemplatesGatekeeperShConstraintTemplateV1Beta1ManifestData
