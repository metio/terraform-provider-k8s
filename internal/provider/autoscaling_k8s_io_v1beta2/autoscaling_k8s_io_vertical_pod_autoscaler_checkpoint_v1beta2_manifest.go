...
var (
	_ datasource.DataSource = &AutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2Manifest{}
)

func NewAutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2Manifest() datasource.DataSource {
	return &AutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2Manifest{}
}
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_autoscaling_k8s_io_vertical_pod_autoscaler_checkpoint_v1beta2_manifest"
}

func (r *AutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_autoscaling_k8s_io_vertical_pod_autoscaler_checkpoint_v1beta2_manifest")

	var model AutoscalingK8SIoVerticalPodAutoscalerCheckpointV1Beta2ManifestData
