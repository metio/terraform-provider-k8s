...
func TestAutoscalingK8SIoVerticalPodAutoscalerV1Beta2Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_autoscaling_k8s_io_vertical_pod_autoscaler_v1beta2", testCase)
		})
	}
}
