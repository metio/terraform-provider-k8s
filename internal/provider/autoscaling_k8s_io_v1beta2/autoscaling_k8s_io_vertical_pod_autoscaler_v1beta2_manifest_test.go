...
func TestAutoscalingK8SIoVerticalPodAutoscalerV1Beta2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_autoscaling_k8s_io_vertical_pod_autoscaler_v1beta2_manifest", testCase)
		})
	}
}
