...
var (
	_ datasource.DataSource = &ApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1Manifest{}
)

func NewApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1Manifest() datasource.DataSource {
	return &ApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1Manifest{}
}
...
func (r *ApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_application_networking_k8s_aws_access_log_policy_v1alpha1_manifest"
}

func (r *ApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_application_networking_k8s_aws_access_log_policy_v1alpha1_manifest")

	var model ApplicationNetworkingK8SAwsAccessLogPolicyV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AccessLogPolicy")
