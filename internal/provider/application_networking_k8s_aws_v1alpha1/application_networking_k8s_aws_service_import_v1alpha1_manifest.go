...
var (
	_ datasource.DataSource = &ApplicationNetworkingK8SAwsServiceImportV1Alpha1Manifest{}
)

func NewApplicationNetworkingK8SAwsServiceImportV1Alpha1Manifest() datasource.DataSource {
	return &ApplicationNetworkingK8SAwsServiceImportV1Alpha1Manifest{}
}
...
func (r *ApplicationNetworkingK8SAwsServiceImportV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_application_networking_k8s_aws_service_import_v1alpha1_manifest"
}

func (r *ApplicationNetworkingK8SAwsServiceImportV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApplicationNetworkingK8SAwsServiceImportV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_application_networking_k8s_aws_service_import_v1alpha1_manifest")

	var model ApplicationNetworkingK8SAwsServiceImportV1Alpha1ManifestData
