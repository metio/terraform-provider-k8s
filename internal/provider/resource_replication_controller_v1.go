...
var (
	_ resource.Resource = (*ReplicationControllerV1Resource)(nil)
)

type ReplicationControllerV1TerraformModel struct {
...
type ReplicationControllerV1GoModel struct {
...
func (r *ReplicationControllerV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_replication_controller_v1"
}

func (r *ReplicationControllerV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ReplicationControllerV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_replication_controller_v1")

	var state ReplicationControllerV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ReplicationControllerV1GoModel
	...
	goModel.Kind = utilities.Ptr("ReplicationController")
...
func (r *ReplicationControllerV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_replication_controller_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *ReplicationControllerV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ReplicationControllerV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
