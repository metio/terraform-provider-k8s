...
var (
	_ resource.Resource = (*GatewaySoloIoRouteOptionV1Resource)(nil)
)

type GatewaySoloIoRouteOptionV1TerraformModel struct {
...
type GatewaySoloIoRouteOptionV1GoModel struct {
...
func (r *GatewaySoloIoRouteOptionV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_solo_io_route_option_v1"
}

func (r *GatewaySoloIoRouteOptionV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *GatewaySoloIoRouteOptionV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_gateway_solo_io_route_option_v1")

	var state GatewaySoloIoRouteOptionV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GatewaySoloIoRouteOptionV1GoModel
	...
	goModel.Kind = utilities.Ptr("RouteOption")
...
func (r *GatewaySoloIoRouteOptionV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_solo_io_route_option_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *GatewaySoloIoRouteOptionV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GatewaySoloIoRouteOptionV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
