...
var (
	_ resource.Resource = (*OperatorAquasecComAquaGatewayV1Alpha1Resource)(nil)
)

type OperatorAquasecComAquaGatewayV1Alpha1TerraformModel struct {
...
type OperatorAquasecComAquaGatewayV1Alpha1GoModel struct {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_aquasec_com_aqua_gateway_v1alpha1"
}

func (r *OperatorAquasecComAquaGatewayV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_aquasec_com_aqua_gateway_v1alpha1")

	var state OperatorAquasecComAquaGatewayV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorAquasecComAquaGatewayV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("AquaGateway")
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_gateway_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorAquasecComAquaGatewayV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
