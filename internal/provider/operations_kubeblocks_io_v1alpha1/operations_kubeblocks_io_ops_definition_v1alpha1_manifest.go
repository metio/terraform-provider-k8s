...
var (
	_ datasource.DataSource = &OperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest{}
)

func NewOperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest() datasource.DataSource {
	return &OperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest{}
}

type OperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest struct{}

type OperationsKubeblocksIoOpsDefinitionV1Alpha1ManifestData struct {
	...
	Spec *struct {
		Actions *[]struct {
			...
			ResourceModifier *struct {
				CompletionProbe *struct {
					InitialDelaySeconds *int64 `tfsdk:"initial_delay_seconds" json:"initialDelaySeconds,omitempty"`
					MatchExpressions    *struct {
						Failure *string `tfsdk:"failure" json:"failure,omitempty"`
						Success *string `tfsdk:"success" json:"success,omitempty"`
					} `tfsdk:"match_expressions" json:"matchExpressions,omitempty"`
					PeriodSeconds  *int64 `tfsdk:"period_seconds" json:"periodSeconds,omitempty"`
					TimeoutSeconds *int64 `tfsdk:"timeout_seconds" json:"timeoutSeconds,omitempty"`
				} `tfsdk:"completion_probe" json:"completionProbe,omitempty"`
				JsonPatches *[]struct {
		...
		ComponentInfos *[]struct {
			...
			} `tfsdk:"image_mappings" json:"imageMappings,omitempty"`
...
func (r *OperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operations_kubeblocks_io_ops_definition_v1alpha1_manifest"
}

func (r *OperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
										...
										"completion_probe": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"initial_delay_seconds": schema.Int64Attribute{
													...
													MarkdownDescription: "Specifies the number of seconds to wait after the resource has been patched before initiating completion probes. The default value is 5 seconds, with a minimum value of 1.",
													Required:            false,
													Optional:            true,
													Computed:            false,
													Validators: []validator.Int64{
												...
												"match_expressions": schema.SingleNestedAttribute{
													Description:         "Executes expressions regularly, based on the value of PeriodSeconds, to determine if the action has been completed.",
										...
										"resource": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"kind": schema.StringAttribute{
													...
													MarkdownDescription: "Specifies the type of resource being referenced.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"name": schema.StringAttribute{
													Description:         "Indicates the name of the resource being referenced.",
													MarkdownDescription: "Indicates the name of the resource being referenced.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"component_definition_name": schema.StringAttribute{
									...
									MarkdownDescription: "Specifies the name of the ComponentDefinition. The name can represent an exact name, a name prefix, or a regular expression pattern. For example: - 'mysql-8.0.30-v1alpha1': Matches the exact name 'mysql-8.0.30-v1alpha1' - 'mysql-8.0.30': Matches all names starting with 'mysql-8.0.30' - '^mysql-8.0.d{1,2}$': Matches all names starting with 'mysql-8.0.' followed by one or two digits.",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"image_mappings": schema.ListNestedAttribute{
									Description:         "ImageMappings specifies the mapping from service versions to image addresses.",
									MarkdownDescription: "ImageMappings specifies the mapping from service versions to image addresses.",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"images": schema.MapAttribute{
												Description:         "Images are the container image addresses to use for the matched service versions. Key is the container name, and value is the image address.",
												MarkdownDescription: "Images are the container image addresses to use for the matched service versions. Key is the container name, and value is the image address.",
												ElementType:         types.StringType,
												Required:            true,
												Optional:            false,
												Computed:            false,
											...
											"service_versions": schema.ListAttribute{
												Description:         "ServiceVersions is a list of service versions that this mapping applies to.",
												MarkdownDescription: "ServiceVersions is a list of service versions that this mapping applies to.",
												ElementType:         types.StringType,
												Required:            true,
												Optional:            false,
												Computed:            false,
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"optional": schema.BoolAttribute{
												...
												MarkdownDescription: "Specify whether the ENV must be defined.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
...
func (r *OperationsKubeblocksIoOpsDefinitionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operations_kubeblocks_io_ops_definition_v1alpha1_manifest")

	var model OperationsKubeblocksIoOpsDefinitionV1Alpha1ManifestData
	...
	model.Kind = pointer.String("OpsDefinition")
