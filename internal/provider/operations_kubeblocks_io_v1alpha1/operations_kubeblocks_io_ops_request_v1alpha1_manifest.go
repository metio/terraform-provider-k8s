	...
	Spec *struct {
		...
		HorizontalScaling *[]struct {
			...
			ScaleOut *struct {
				...
				} `tfsdk:"from_backup" json:"fromBackup,omitempty"`
				Instances *[]struct {
					Name           *string `tfsdk:"name" json:"name,omitempty"`
					ReplicaChanges *int64  `tfsdk:"replica_changes" json:"replicaChanges,omitempty"`
				} `tfsdk:"instances" json:"instances,omitempty"`
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"scale_out": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										"from_backup": schema.SingleNestedAttribute{
											Description:         "FromBackup specifies the configuration for creating new instances from an existing backup. This is only effective for non-sharding components. When specified, new instances will be created using data from the specified backup.",
											MarkdownDescription: "FromBackup specifies the configuration for creating new instances from an existing backup. This is only effective for non-sharding components. When specified, new instances will be created using data from the specified backup.",
											Attributes: map[string]schema.Attribute{
												"name": schema.StringAttribute{
													Description:         "Specifies the name of the Backup name.",
													MarkdownDescription: "Specifies the name of the Backup name.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"namespace": schema.StringAttribute{
													Description:         "Specifies the namespace of the Backup namespace. If not specified, the namespace of the OpsRequest will be used.",
													MarkdownDescription: "Specifies the namespace of the Backup namespace. If not specified, the namespace of the OpsRequest will be used.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
