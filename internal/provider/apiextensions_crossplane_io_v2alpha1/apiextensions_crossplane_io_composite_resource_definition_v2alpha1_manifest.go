...
var (
	_ datasource.DataSource = &ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest{}
)

func NewApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest() datasource.DataSource {
	return &ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest{}
}

type ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest struct{}

type ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1ManifestData struct {
...
func (r *ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apiextensions_crossplane_io_composite_resource_definition_v2alpha1_manifest"
}

func (r *ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apiextensions_crossplane_io_composite_resource_definition_v2alpha1_manifest")

	var model ApiextensionsCrossplaneIoCompositeResourceDefinitionV2Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("apiextensions.crossplane.io/v2alpha1")
