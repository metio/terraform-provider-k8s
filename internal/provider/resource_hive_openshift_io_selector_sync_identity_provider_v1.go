...
var (
	_ resource.Resource = (*HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource)(nil)
)

type HiveOpenshiftIoSelectorSyncIdentityProviderV1TerraformModel struct {
...
type HiveOpenshiftIoSelectorSyncIdentityProviderV1GoModel struct {
...
func (r *HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_hive_openshift_io_selector_sync_identity_provider_v1"
}

func (r *HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_hive_openshift_io_selector_sync_identity_provider_v1")

	var state HiveOpenshiftIoSelectorSyncIdentityProviderV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel HiveOpenshiftIoSelectorSyncIdentityProviderV1GoModel
	...
	goModel.Kind = utilities.Ptr("SelectorSyncIdentityProvider")
...
func (r *HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hive_openshift_io_selector_sync_identity_provider_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *HiveOpenshiftIoSelectorSyncIdentityProviderV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
