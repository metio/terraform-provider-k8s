...
var (
	_ datasource.DataSource = &SchedulingSigsK8SIoPodGroupV1Alpha1Manifest{}
)

func NewSchedulingSigsK8SIoPodGroupV1Alpha1Manifest() datasource.DataSource {
	return &SchedulingSigsK8SIoPodGroupV1Alpha1Manifest{}
}

type SchedulingSigsK8SIoPodGroupV1Alpha1Manifest struct{}

type SchedulingSigsK8SIoPodGroupV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		ScheduleTimeoutSeconds *int64             `tfsdk:"schedule_timeout_seconds" json:"scheduleTimeoutSeconds,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *SchedulingSigsK8SIoPodGroupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_scheduling_sigs_k8s_io_pod_group_v1alpha1_manifest"
}

func (r *SchedulingSigsK8SIoPodGroupV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"schedule_timeout_seconds": schema.Int64Attribute{
						Description:         "ScheduleTimeoutSeconds defines the maximal time of members/tasks to wait before run the pod group;",
						MarkdownDescription: "ScheduleTimeoutSeconds defines the maximal time of members/tasks to wait before run the pod group;",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *SchedulingSigsK8SIoPodGroupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_scheduling_sigs_k8s_io_pod_group_v1alpha1_manifest")

	var model SchedulingSigsK8SIoPodGroupV1Alpha1ManifestData
