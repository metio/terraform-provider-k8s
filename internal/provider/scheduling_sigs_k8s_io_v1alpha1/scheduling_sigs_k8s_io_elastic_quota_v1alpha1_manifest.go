...
var (
	_ datasource.DataSource = &SchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest{}
)

func NewSchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest() datasource.DataSource {
	return &SchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest{}
}
...
func (r *SchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_scheduling_sigs_k8s_io_elastic_quota_v1alpha1_manifest"
}

func (r *SchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_scheduling_sigs_k8s_io_elastic_quota_v1alpha1_manifest")

	var model SchedulingSigsK8SIoElasticQuotaV1Alpha1ManifestData
