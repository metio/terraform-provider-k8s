...
func TestSchedulingSigsK8SIoElasticQuotaV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_scheduling_sigs_k8s_io_elastic_quota_v1alpha1_manifest", testCase)
		})
	}
}
