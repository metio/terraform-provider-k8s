...
func TestSchedulingSigsK8SIoElasticQuotaV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_scheduling_sigs_k8s_io_elastic_quota_v1alpha1", testCase)
		})
	}
}
