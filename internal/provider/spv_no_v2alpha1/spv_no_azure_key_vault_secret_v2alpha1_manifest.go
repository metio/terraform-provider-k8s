...
var (
	_ datasource.DataSource = &SpvNoAzureKeyVaultSecretV2Alpha1Manifest{}
)

func NewSpvNoAzureKeyVaultSecretV2Alpha1Manifest() datasource.DataSource {
	return &SpvNoAzureKeyVaultSecretV2Alpha1Manifest{}
}

type SpvNoAzureKeyVaultSecretV2Alpha1Manifest struct{}

type SpvNoAzureKeyVaultSecretV2Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Vault *struct {
			AzureIdentity *struct {
				Name *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"azure_identity" json:"azureIdentity,omitempty"`
			Name   *string `tfsdk:"name" json:"name,omitempty"`
			Object *struct {
...
func (r *SpvNoAzureKeyVaultSecretV2Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_spv_no_azure_key_vault_secret_v2alpha1_manifest"
}

func (r *SpvNoAzureKeyVaultSecretV2Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"output": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "AzureKeyVaultOutput defines output sources, supports Secret and Configmap",
						Attributes: map[string]schema.Attribute{
							"config_map": schema.SingleNestedAttribute{
								Description:         "AzureKeyVaultOutputConfigMap has information needed to output a secret from Azure Key Vault to Kubernetes as a ConfigMap resource",
								MarkdownDescription: "AzureKeyVaultOutputConfigMap has information needed to output a secret from Azure Key Vault to Kubernetes as a ConfigMap resource",
								Attributes: map[string]schema.Attribute{
									"data_key": schema.StringAttribute{
										Description:         "The key to use in Kubernetes ConfigMap when setting the value from Azure Key Vault object data",
										MarkdownDescription: "The key to use in Kubernetes ConfigMap when setting the value from Azure Key Vault object data",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"name": schema.StringAttribute{
										...
										MarkdownDescription: "Name for Kubernetes ConfigMap",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
					...
					"vault": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"azure_identity": schema.SingleNestedAttribute{
								Description:         "AzureIdentity has information about the azure identity used for Azure Key Vault authentication",
								MarkdownDescription: "AzureIdentity has information about the azure identity used for Azure Key Vault authentication",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the azureIdentity to use for Azure Key Vault authentication",
										MarkdownDescription: "Name of the azureIdentity to use for Azure Key Vault authentication",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
...
func (r *SpvNoAzureKeyVaultSecretV2Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_spv_no_azure_key_vault_secret_v2alpha1_manifest")

	var model SpvNoAzureKeyVaultSecretV2Alpha1ManifestData
	...
	model.ApiVersion = pointer.String("spv.no/v2alpha1")
