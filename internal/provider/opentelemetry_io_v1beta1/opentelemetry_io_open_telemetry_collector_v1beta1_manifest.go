...
package opentelemetry_io_v1beta1
...
var (
	_ datasource.DataSource = &OpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest{}
)

func NewOpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest() datasource.DataSource {
	return &OpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest{}
}

type OpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest struct{}

type OpentelemetryIoOpenTelemetryCollectorV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		Config *struct {
			Connectors *map[string]string `tfsdk:"connectors" json:"connectors,omitempty"`
			Exporters  *map[string]string `tfsdk:"exporters" json:"exporters,omitempty"`
			...
			Receivers  *map[string]string `tfsdk:"receivers" json:"receivers,omitempty"`
			Service    *struct {
		...
		DaemonSetUpdateStrategy *struct {
			...
			Type *string `tfsdk:"type" json:"type,omitempty"`
		} `tfsdk:"daemon_set_update_strategy" json:"daemonSetUpdateStrategy,omitempty"`
		...
		TargetAllocator       *struct {
			...
			CollectorTargetReloadInterval *string `tfsdk:"collector_target_reload_interval" json:"collectorTargetReloadInterval,omitempty"`
			Enabled                       *bool   `tfsdk:"enabled" json:"enabled,omitempty"`
			Env                           *[]struct {
				Name      *string `tfsdk:"name" json:"name,omitempty"`
				Value     *string `tfsdk:"value" json:"value,omitempty"`
...
func (r *OpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_opentelemetry_io_open_telemetry_collector_v1beta1_manifest"
}

func (r *OpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"daemon_set_update_strategy": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
					...
					"target_allocator": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"collector_target_reload_interval": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"filter_strategy": schema.StringAttribute{
								...
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("", "relabel-config"),
								},
							},
...
func (r *OpentelemetryIoOpenTelemetryCollectorV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_opentelemetry_io_open_telemetry_collector_v1beta1_manifest")

	var model OpentelemetryIoOpenTelemetryCollectorV1Beta1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("opentelemetry.io/v1beta1")
