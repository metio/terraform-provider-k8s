...
var (
	_ datasource.DataSource              = &AsdbAerospikeComAerospikeClusterV1DataSource{}
	_ datasource.DataSourceWithConfigure = &AsdbAerospikeComAerospikeClusterV1DataSource{}
)

func NewAsdbAerospikeComAerospikeClusterV1DataSource() datasource.DataSource {
	return &AsdbAerospikeComAerospikeClusterV1DataSource{}
}

type AsdbAerospikeComAerospikeClusterV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AsdbAerospikeComAerospikeClusterV1DataSourceData struct {
...
func (r *AsdbAerospikeComAerospikeClusterV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_asdb_aerospike_com_aerospike_cluster_v1"
}

func (r *AsdbAerospikeComAerospikeClusterV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AsdbAerospikeComAerospikeClusterV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AsdbAerospikeComAerospikeClusterV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_asdb_aerospike_com_aerospike_cluster_v1")

	var data AsdbAerospikeComAerospikeClusterV1DataSourceData
	...
	var readResponse AsdbAerospikeComAerospikeClusterV1DataSourceData
	...
	data.ApiVersion = pointer.String("asdb.aerospike.com/v1")
