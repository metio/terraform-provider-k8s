...
package shipwright_io_v1alpha1
...
var (
	_ datasource.DataSource = &ShipwrightIoBuildV1Alpha1Manifest{}
)

func NewShipwrightIoBuildV1Alpha1Manifest() datasource.DataSource {
	return &ShipwrightIoBuildV1Alpha1Manifest{}
}

type ShipwrightIoBuildV1Alpha1Manifest struct{}

type ShipwrightIoBuildV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Dockerfile *string `tfsdk:"dockerfile" json:"dockerfile,omitempty"`
		Env        *[]struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
		...
		Source *struct {
			BundleContainer *struct {
				Image *string `tfsdk:"image" json:"image,omitempty"`
				Prune *string `tfsdk:"prune" json:"prune,omitempty"`
			} `tfsdk:"bundle_container" json:"bundleContainer,omitempty"`
...
func (r *ShipwrightIoBuildV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_build_v1alpha1_manifest"
}

func (r *ShipwrightIoBuildV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"builder": schema.SingleNestedAttribute{
						Description:         "Builder refers to the image containing the build tools inside which the source code would be built. NOTICE: Builder is deprecated, and will be removed in a future release. Build strategies which rely on 'builder' should provide an equivalent parameter instead.",
						MarkdownDescription: "Builder refers to the image containing the build tools inside which the source code would be built. NOTICE: Builder is deprecated, and will be removed in a future release. Build strategies which rely on 'builder' should provide an equivalent parameter instead.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
							...
							"credentials": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Credentials references a Secret that contains credentials to access the image registry.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
					...
					"dockerfile": schema.StringAttribute{
						Description:         "Dockerfile is the path to the Dockerfile to be used for build strategies which bank on the Dockerfile for building an image. NOTICE: Dockerfile is deprecated, and will be removed in a future release. Build strategies which rely on 'dockerfile' should provide an equivalent parameter instead.",
						MarkdownDescription: "Dockerfile is the path to the Dockerfile to be used for build strategies which bank on the Dockerfile for building an image. NOTICE: Dockerfile is deprecated, and will be removed in a future release. Build strategies which rely on 'dockerfile' should provide an equivalent parameter instead.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"source": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Source refers to the Git repository containing the source code to be built.",
						Attributes: map[string]schema.Attribute{
							"bundle_container": schema.SingleNestedAttribute{
								Description:         "BundleContainer",
								MarkdownDescription: "BundleContainer",
								Attributes: map[string]schema.Attribute{
									"image": schema.StringAttribute{
										Description:         "Image reference, i.e. quay.io/org/image:tag",
										MarkdownDescription: "Image reference, i.e. quay.io/org/image:tag",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"prune": schema.StringAttribute{
										Description:         "Prune specifies whether the image is suppose to be deleted. Allowed values are 'Never' (no deletion) and 'AfterPull' (removal after the image was successfully pulled from the registry). If not defined, it defaults to 'Never'.",
										MarkdownDescription: "Prune specifies whether the image is suppose to be deleted. Allowed values are 'Never' (no deletion) and 'AfterPull' (removal after the image was successfully pulled from the registry). If not defined, it defaults to 'Never'.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"context_dir": schema.StringAttribute{
								...
								MarkdownDescription: "ContextDir is a path to subfolder in the repo. Optional.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"credentials": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Credentials references a Secret that contains credentials to access the repository.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
										MarkdownDescription: "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
					...
					"sources": schema.ListNestedAttribute{
						Description:         "Sources slice of BuildSource, defining external build artifacts complementary to VCS ('.spec.source') data. NOTICE: Multiple sources in a build are deprecated. This feature will be removed in a future release.",
						MarkdownDescription: "Sources slice of BuildSource, defining external build artifacts complementary to VCS ('.spec.source') data. NOTICE: Multiple sources in a build are deprecated. This feature will be removed in a future release.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Name instance entry.",
									MarkdownDescription: "Name instance entry.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"timeout": schema.StringAttribute{
									...
									MarkdownDescription: "Timeout how long the BuildSource execution must take.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"type": schema.StringAttribute{
									...
									MarkdownDescription: "Type is the BuildSource qualifier, the type of the data-source.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"url": schema.StringAttribute{
									...
									MarkdownDescription: "URL remote artifact location.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"trigger": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"secret_ref": schema.SingleNestedAttribute{
								Description:         "SecretRef points to a local object carrying the secret token to validate webhook request.",
								MarkdownDescription: "SecretRef points to a local object carrying the secret token to validate webhook request.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
										MarkdownDescription: "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"description": schema.StringAttribute{
									Description:         "Description of the Build Volume NOTICE: Description is deprecated, and will be removed in a future release.",
									MarkdownDescription: "Description of the Build Volume NOTICE: Description is deprecated, and will be removed in a future release.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
...
func (r *ShipwrightIoBuildV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_build_v1alpha1_manifest")

	var model ShipwrightIoBuildV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("shipwright.io/v1alpha1")
