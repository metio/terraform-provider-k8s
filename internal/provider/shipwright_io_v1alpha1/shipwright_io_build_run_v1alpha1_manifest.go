...
var (
	_ datasource.DataSource = &ShipwrightIoBuildRunV1Alpha1Manifest{}
)

func NewShipwrightIoBuildRunV1Alpha1Manifest() datasource.DataSource {
	return &ShipwrightIoBuildRunV1Alpha1Manifest{}
}

type ShipwrightIoBuildRunV1Alpha1Manifest struct{}

type ShipwrightIoBuildRunV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"build_ref" json:"buildRef,omitempty"`
		BuildSpec *struct {
			Builder *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
				Credentials *struct {
		...
		} `tfsdk:"build_spec" json:"buildSpec,omitempty"`
		Env *[]struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Value     *string `tfsdk:"value" json:"value,omitempty"`
			ValueFrom *struct {
...
func (r *ShipwrightIoBuildRunV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_build_run_v1alpha1_manifest"
}

func (r *ShipwrightIoBuildRunV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"build_ref": schema.SingleNestedAttribute{
						Description:         "BuildRef refers to the Build",
						MarkdownDescription: "BuildRef refers to the Build",
						Attributes: map[string]schema.Attribute{
					...
					"build_spec": schema.SingleNestedAttribute{
						Description:         "BuildSpec refers to an embedded build specification",
						MarkdownDescription: "BuildSpec refers to an embedded build specification",
						Attributes: map[string]schema.Attribute{
					...
					"service_account": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"generate": schema.BoolAttribute{
								Description:         "If generates a new ServiceAccount for the build NOTICE: Generated ServiceAccounts are deprecated, and will be removed in a future release.",
								MarkdownDescription: "If generates a new ServiceAccount for the build NOTICE: Generated ServiceAccounts are deprecated, and will be removed in a future release.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"sources": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Sources slice of BuildSource, defining external build artifacts complementary to VCS ('.spec.source') data.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Name instance entry.",
...
func (r *ShipwrightIoBuildRunV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_build_run_v1alpha1_manifest")

	var model ShipwrightIoBuildRunV1Alpha1ManifestData
