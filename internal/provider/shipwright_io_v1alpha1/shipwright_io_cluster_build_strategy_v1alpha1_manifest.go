...
var (
	_ datasource.DataSource = &ShipwrightIoClusterBuildStrategyV1Alpha1Manifest{}
)

func NewShipwrightIoClusterBuildStrategyV1Alpha1Manifest() datasource.DataSource {
	return &ShipwrightIoClusterBuildStrategyV1Alpha1Manifest{}
}

type ShipwrightIoClusterBuildStrategyV1Alpha1Manifest struct{}

type ShipwrightIoClusterBuildStrategyV1Alpha1ManifestData struct {
...
func (r *ShipwrightIoClusterBuildStrategyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_cluster_build_strategy_v1alpha1_manifest"
}

func (r *ShipwrightIoClusterBuildStrategyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ShipwrightIoClusterBuildStrategyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_cluster_build_strategy_v1alpha1_manifest")

	var model ShipwrightIoClusterBuildStrategyV1Alpha1ManifestData
