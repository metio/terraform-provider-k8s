...
var (
	_ datasource.DataSource = &ShipwrightIoBuildStrategyV1Alpha1Manifest{}
)

func NewShipwrightIoBuildStrategyV1Alpha1Manifest() datasource.DataSource {
	return &ShipwrightIoBuildStrategyV1Alpha1Manifest{}
}

type ShipwrightIoBuildStrategyV1Alpha1Manifest struct{}

type ShipwrightIoBuildStrategyV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"build_steps" json:"buildSteps,omitempty"`
		Parameters *[]struct {
			Default     *string   `tfsdk:"default" json:"default,omitempty"`
			Defaults    *[]string `tfsdk:"defaults" json:"defaults,omitempty"`
		...
		Volumes *[]struct {
			...
			Overridable           *bool `tfsdk:"overridable" json:"overridable,omitempty"`
...
func (r *ShipwrightIoBuildStrategyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_build_strategy_v1alpha1_manifest"
}

func (r *ShipwrightIoBuildStrategyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "BuildStrategy is the Schema representing a strategy in the namespace scope to build images from source code.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BuildStrategySpec defines the desired state of BuildStrategy",
				Attributes: map[string]schema.Attribute{
					"build_steps": schema.ListNestedAttribute{
						Description:         "BuildSteps defines the steps of the strategy",
						MarkdownDescription: "BuildSteps defines the steps of the strategy",
					...
					"parameters": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Parameters defines the parameters of the strategy",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"default": schema.StringAttribute{
									Description:         "Default value for a string parameter",
									MarkdownDescription: "Default value for a string parameter",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"defaults": schema.ListAttribute{
									...
									MarkdownDescription: "Default values for an array parameter",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
								...
								"description": schema.StringAttribute{
									...
									MarkdownDescription: "Description on the parameter purpose",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"type": schema.StringAttribute{
									Description:         "Type of the parameter. The possible types are 'string' and 'array', and 'string' is the default.",
									MarkdownDescription: "Type of the parameter. The possible types are 'string' and 'array', and 'string' is the default.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"security_context": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "SecurityContext defines the default security context of all strategy steps",
						Attributes: map[string]schema.Attribute{
							"run_as_group": schema.Int64Attribute{
								Description:         "The GID to run the entrypoint of the container process. Defaults to group specified in image metadata if unspecified. Can be overwritten by the security context on the step level.",
								MarkdownDescription: "The GID to run the entrypoint of the container process. Defaults to group specified in image metadata if unspecified. Can be overwritten by the security context on the step level.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"run_as_user": schema.Int64Attribute{
								Description:         "The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. Can be overwritten by the security context on the step level.",
								MarkdownDescription: "The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. Can be overwritten by the security context on the step level.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"volumes": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Volumes defines the volumes of the strategy",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"description": schema.StringAttribute{
									Description:         "Description of the Build Volume",
									MarkdownDescription: "Description of the Build Volume",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"overridable": schema.BoolAttribute{
									Description:         "Indicates that this Volume can be overridden in a Build or BuildRun. Defaults to false",
									MarkdownDescription: "Indicates that this Volume can be overridden in a Build or BuildRun. Defaults to false",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
...
func (r *ShipwrightIoBuildStrategyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_build_strategy_v1alpha1_manifest")

	var model ShipwrightIoBuildStrategyV1Alpha1ManifestData
	...
	model.Kind = pointer.String("BuildStrategy")
