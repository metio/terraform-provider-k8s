...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaUserV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaUserV1Beta2DataSource{}
)

func NewKafkaStrimziIoKafkaUserV1Beta2DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaUserV1Beta2DataSource{}
}

type KafkaStrimziIoKafkaUserV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaUserV1Beta2DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaUserV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_user_v1beta2"
}

func (r *KafkaStrimziIoKafkaUserV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_user_v1beta2")

	var data KafkaStrimziIoKafkaUserV1Beta2DataSourceData
	...
	var readResponse KafkaStrimziIoKafkaUserV1Beta2DataSourceData
