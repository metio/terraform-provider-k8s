...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaV1Beta2DataSource{}
)

func NewKafkaStrimziIoKafkaV1Beta2DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaV1Beta2DataSource{}
}

type KafkaStrimziIoKafkaV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaV1Beta2DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_v1beta2"
}

func (r *KafkaStrimziIoKafkaV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_v1beta2")

	var data KafkaStrimziIoKafkaV1Beta2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "kafka.strimzi.io", Version: "v1beta2", Resource: "kafkas"}).
	...
	var readResponse KafkaStrimziIoKafkaV1Beta2DataSourceData
	...
	data.Kind = pointer.String("Kafka")
