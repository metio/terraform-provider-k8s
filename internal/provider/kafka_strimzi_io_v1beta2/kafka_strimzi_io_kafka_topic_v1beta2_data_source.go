...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaTopicV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaTopicV1Beta2DataSource{}
)

func NewKafkaStrimziIoKafkaTopicV1Beta2DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaTopicV1Beta2DataSource{}
}

type KafkaStrimziIoKafkaTopicV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaTopicV1Beta2DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_topic_v1beta2"
}

func (r *KafkaStrimziIoKafkaTopicV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_topic_v1beta2")

	var data KafkaStrimziIoKafkaTopicV1Beta2DataSourceData
	...
	var readResponse KafkaStrimziIoKafkaTopicV1Beta2DataSourceData
