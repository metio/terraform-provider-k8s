...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource{}
)

func NewKafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource{}
}

type KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_mirror_maker2_v1beta2"
}

func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_mirror_maker2_v1beta2")

	var data KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSourceData
	...
	var readResponse KafkaStrimziIoKafkaMirrorMaker2V1Beta2DataSourceData
	...
	data.Kind = pointer.String("KafkaMirrorMaker2")
