...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource{}
)

func NewKafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource{}
}

type KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_mirror_maker_v1beta2"
}

func (r *KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_mirror_maker_v1beta2")

	var data KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSourceData
	...
	var readResponse KafkaStrimziIoKafkaMirrorMakerV1Beta2DataSourceData
	...
	data.Kind = pointer.String("KafkaMirrorMaker")
