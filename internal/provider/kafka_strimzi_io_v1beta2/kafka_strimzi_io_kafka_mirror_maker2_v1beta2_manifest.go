...
var (
	_ datasource.DataSource = &KafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest{}
)

func NewKafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest() datasource.DataSource {
	return &KafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest{}
}

type KafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest struct{}

type KafkaStrimziIoKafkaMirrorMaker2V1Beta2ManifestData struct {
...
func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest"
}

func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"metrics_config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Metrics configuration. Only 'jmxPrometheusExporter' can be configured, as this component does not yet support 'strimziMetricsReporter'.",
						Attributes: map[string]schema.Attribute{
							"type": schema.StringAttribute{
					...
					"template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Template for Kafka Connect and Kafka MirrorMaker 2 resources. The template allows users to specify how the 'Pods', 'Service', and other services are generated.",
						Attributes: map[string]schema.Attribute{
...
func (r *KafkaStrimziIoKafkaMirrorMaker2V1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_mirror_maker2_v1beta2_manifest")

	var model KafkaStrimziIoKafkaMirrorMaker2V1Beta2ManifestData
