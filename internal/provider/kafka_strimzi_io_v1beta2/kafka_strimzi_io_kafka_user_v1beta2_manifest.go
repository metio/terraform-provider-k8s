...
var (
	_ datasource.DataSource = &KafkaStrimziIoKafkaUserV1Beta2Manifest{}
)

func NewKafkaStrimziIoKafkaUserV1Beta2Manifest() datasource.DataSource {
	return &KafkaStrimziIoKafkaUserV1Beta2Manifest{}
}

type KafkaStrimziIoKafkaUserV1Beta2Manifest struct{}

type KafkaStrimziIoKafkaUserV1Beta2ManifestData struct {
...
func (r *KafkaStrimziIoKafkaUserV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_user_v1beta2_manifest"
}

func (r *KafkaStrimziIoKafkaUserV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_user_v1beta2_manifest")

	var model KafkaStrimziIoKafkaUserV1Beta2ManifestData
