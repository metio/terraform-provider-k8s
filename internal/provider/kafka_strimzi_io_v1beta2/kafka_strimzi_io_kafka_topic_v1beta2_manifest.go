...
var (
	_ datasource.DataSource = &KafkaStrimziIoKafkaTopicV1Beta2Manifest{}
)

func NewKafkaStrimziIoKafkaTopicV1Beta2Manifest() datasource.DataSource {
	return &KafkaStrimziIoKafkaTopicV1Beta2Manifest{}
}

type KafkaStrimziIoKafkaTopicV1Beta2Manifest struct{}

type KafkaStrimziIoKafkaTopicV1Beta2ManifestData struct {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_topic_v1beta2_manifest"
}

func (r *KafkaStrimziIoKafkaTopicV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_topic_v1beta2_manifest")

	var model KafkaStrimziIoKafkaTopicV1Beta2ManifestData
