...
var (
	_ datasource.DataSource = &GeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest{}
)

func NewGeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest() datasource.DataSource {
	return &GeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest{}
}

type GeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest struct{}

type GeneratorsExternalSecretsIoGrafanaV1Alpha1ManifestData struct {
...
func (r *GeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_generators_external_secrets_io_grafana_v1alpha1_manifest"
}

func (r *GeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GeneratorsExternalSecretsIoGrafanaV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_generators_external_secrets_io_grafana_v1alpha1_manifest")

	var model GeneratorsExternalSecretsIoGrafanaV1Alpha1ManifestData
