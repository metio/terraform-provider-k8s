					...
					"generator": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"github_access_token_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"grafana_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"password_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"quay_access_token_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"sts_session_token_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"uuid_spec": schema.MapAttribute{
								...
								Computed:            false,
								Validators: []validator.Map{
									mapvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"vault_dynamic_secret_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"webhook_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec")),
								},
							},
						},
						Required: true,
