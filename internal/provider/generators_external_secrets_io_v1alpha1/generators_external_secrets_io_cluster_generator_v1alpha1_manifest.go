...
type GeneratorsExternalSecretsIoClusterGeneratorV1Alpha1ManifestData struct {
	...
	Spec *struct {
		Generator *struct {
			...
			} `tfsdk:"ssh_key_spec" json:"sshKeySpec,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
						...
						Attributes: map[string]schema.Attribute{
							"acr_access_token_spec": schema.SingleNestedAttribute{
								...
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"github_access_token_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"grafana_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"mfa_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"password_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"quay_access_token_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},

							"ssh_key_spec": schema.SingleNestedAttribute{
								Description:         "SSHKeySpec controls the behavior of the ssh key generator.",
								MarkdownDescription: "SSHKeySpec controls the behavior of the ssh key generator.",
								Attributes: map[string]schema.Attribute{
									"comment": schema.StringAttribute{
										Description:         "Comment specifies an optional comment for the SSH key",
										MarkdownDescription: "Comment specifies an optional comment for the SSH key",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"key_size": schema.Int64Attribute{
										Description:         "KeySize specifies the key size for RSA keys (default: 2048) For RSA keys: 2048, 3072, 4096 Ignored for ed25519 keys",
										MarkdownDescription: "KeySize specifies the key size for RSA keys (default: 2048) For RSA keys: 2048, 3072, 4096 Ignored for ed25519 keys",
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"key_type": schema.StringAttribute{
										...
										MarkdownDescription: "KeyType specifies the SSH key type (rsa, ed25519)",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.String{
							...
							"sts_session_token_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"uuid_spec": schema.MapAttribute{
								...
								Computed:            false,
								Validators: []validator.Map{
									mapvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"vault_dynamic_secret_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("webhook_spec")),
								},
							},
							...
							"webhook_spec": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("acr_access_token_spec"), path.MatchRelative().AtParent().AtName("ecr_authorization_token_spec"), path.MatchRelative().AtParent().AtName("fake_spec"), path.MatchRelative().AtParent().AtName("gcr_access_token_spec"), path.MatchRelative().AtParent().AtName("github_access_token_spec"), path.MatchRelative().AtParent().AtName("grafana_spec"), path.MatchRelative().AtParent().AtName("mfa_spec"), path.MatchRelative().AtParent().AtName("password_spec"), path.MatchRelative().AtParent().AtName("quay_access_token_spec"), path.MatchRelative().AtParent().AtName("ssh_key_spec"), path.MatchRelative().AtParent().AtName("sts_session_token_spec"), path.MatchRelative().AtParent().AtName("uuid_spec"), path.MatchRelative().AtParent().AtName("vault_dynamic_secret_spec")),
								},
							},
						},
						Required: true,
					...
					"kind": schema.StringAttribute{
						...
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("ACRAccessToken", "ECRAuthorizationToken", "Fake", "GCRAccessToken", "GithubAccessToken", "QuayAccessToken", "Password", "SSHKey", "STSSessionToken", "UUID", "VaultDynamicSecret", "Webhook", "Grafana"),
						},
					},
				},
				Required: false,
