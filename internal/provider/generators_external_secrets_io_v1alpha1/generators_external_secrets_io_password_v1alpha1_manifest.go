...
var (
	_ datasource.DataSource = &GeneratorsExternalSecretsIoPasswordV1Alpha1Manifest{}
)

func NewGeneratorsExternalSecretsIoPasswordV1Alpha1Manifest() datasource.DataSource {
	return &GeneratorsExternalSecretsIoPasswordV1Alpha1Manifest{}
}

type GeneratorsExternalSecretsIoPasswordV1Alpha1Manifest struct{}

type GeneratorsExternalSecretsIoPasswordV1Alpha1ManifestData struct {
...
func (r *GeneratorsExternalSecretsIoPasswordV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_generators_external_secrets_io_password_v1alpha1_manifest"
}

func (r *GeneratorsExternalSecretsIoPasswordV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Password generates a random password based on the configuration parameters in spec. You can specify the length, characterset and other attributes.",
...
func (r *GeneratorsExternalSecretsIoPasswordV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_generators_external_secrets_io_password_v1alpha1_manifest")

	var model GeneratorsExternalSecretsIoPasswordV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Password")
