...
var (
	_ datasource.DataSource = &SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Manifest{}
)

func NewSagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Manifest() datasource.DataSource {
	return &SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Manifest{}
}
...
func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1_manifest"
}

func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"job_definition_name": schema.StringAttribute{
						Description:         "The name of the bias job definition. The name must be unique within an Amazon Web Services Region in the Amazon Web Services account. Regex Pattern: '^[a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}$'",
						MarkdownDescription: "The name of the bias job definition. The name must be unique within an Amazon Web Services Region in the Amazon Web Services account. Regex Pattern: '^[a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}$'",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1_manifest")

	var model SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1ManifestData
