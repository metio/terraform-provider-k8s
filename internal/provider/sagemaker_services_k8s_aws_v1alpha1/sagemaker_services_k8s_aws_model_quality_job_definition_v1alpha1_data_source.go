...
var (
	_ datasource.DataSource              = &SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource{}
)

func NewSagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource() datasource.DataSource {
	return &SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource{}
}

type SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSourceData struct {
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_sagemaker_services_k8s_aws_model_quality_job_definition_v1alpha1"
}

func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_sagemaker_services_k8s_aws_model_quality_job_definition_v1alpha1")

	var data SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSourceData
	...
	var readResponse SagemakerServicesK8SAwsModelQualityJobDefinitionV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ModelQualityJobDefinition")
