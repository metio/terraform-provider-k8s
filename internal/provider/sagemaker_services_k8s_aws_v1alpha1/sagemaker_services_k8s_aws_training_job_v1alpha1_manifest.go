			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"infra_check_config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Contains information about the infrastructure health check configuration for the training job.",
						Attributes: map[string]schema.Attribute{
								...
								"data_source": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"s3_data_source": schema.SingleNestedAttribute{
											Description:         "Describes the S3 data source. Your input bucket must be in the same Amazon Web Services region as your training job.",
											MarkdownDescription: "Describes the S3 data source. Your input bucket must be in the same Amazon Web Services region as your training job.",
											Attributes: map[string]schema.Attribute{
					...
					"remote_debug_config": schema.SingleNestedAttribute{
						Description:         "Configuration for remote debugging. To learn more about the remote debugging functionality of SageMaker, see Access a training container through Amazon Web Services Systems Manager (SSM) for remote debugging (https://docs.aws.amazon.com/sagemaker/latest/dg/train-remote-debugging.html).",
						MarkdownDescription: "Configuration for remote debugging. To learn more about the remote debugging functionality of SageMaker, see Access a training container through Amazon Web Services Systems Manager (SSM) for remote debugging (https://docs.aws.amazon.com/sagemaker/latest/dg/train-remote-debugging.html).",
						Attributes: map[string]schema.Attribute{
					...
					"resource_config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"keep_alive_period_in_seconds": schema.Int64Attribute{
								Description:         "Optional. Customer requested period in seconds for which the Training cluster is kept alive after the job is finished.",
								MarkdownDescription: "Optional. Customer requested period in seconds for which the Training cluster is kept alive after the job is finished.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
