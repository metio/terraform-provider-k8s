...
type RdsServicesK8SAwsDbinstanceV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		DatabaseInsightsMode        *string `tfsdk:"database_insights_mode" json:"databaseInsightsMode,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"database_insights_mode": schema.StringAttribute{
						Description:         "Specifies the mode of Database Insights to enable for the instance.",
						MarkdownDescription: "Specifies the mode of Database Insights to enable for the instance.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
