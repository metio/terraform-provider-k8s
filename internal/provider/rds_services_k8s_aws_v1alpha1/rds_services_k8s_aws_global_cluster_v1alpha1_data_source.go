...
var (
	_ datasource.DataSource              = &RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource{}
)

func NewRdsServicesK8SAwsGlobalClusterV1Alpha1DataSource() datasource.DataSource {
	return &RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource{}
}

type RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type RdsServicesK8SAwsGlobalClusterV1Alpha1DataSourceData struct {
...
func (r *RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rds_services_k8s_aws_global_cluster_v1alpha1"
}

func (r *RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *RdsServicesK8SAwsGlobalClusterV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_rds_services_k8s_aws_global_cluster_v1alpha1")

	var data RdsServicesK8SAwsGlobalClusterV1Alpha1DataSourceData
	...
	var readResponse RdsServicesK8SAwsGlobalClusterV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("GlobalCluster")
