...
func TestRdsServicesK8SAwsDBSubnetGroupV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_rds_services_k8s_aws_db_subnet_group_v1alpha1_manifest", testCase)
		})
	}
}
