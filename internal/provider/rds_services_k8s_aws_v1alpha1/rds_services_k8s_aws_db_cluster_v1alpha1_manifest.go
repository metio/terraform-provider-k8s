			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"allocated_storage": schema.Int64Attribute{
						...
						MarkdownDescription: "The amount of storage in gibibytes (GiB) to allocate to each DB instance in the Multi-AZ DB cluster. Valid for Cluster Type: Multi-AZ DB clusters only This setting is required to create a Multi-AZ DB cluster.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"auto_minor_version_upgrade": schema.BoolAttribute{
						Description:         "Specifies whether minor engine upgrades are applied automatically to the DB cluster during the maintenance window. By default, minor engine upgrades are applied automatically. Valid for Cluster Type: Multi-AZ DB clusters only",
						MarkdownDescription: "Specifies whether minor engine upgrades are applied automatically to the DB cluster during the maintenance window. By default, minor engine upgrades are applied automatically. Valid for Cluster Type: Multi-AZ DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"availability_zones": schema.ListAttribute{
						...
						MarkdownDescription: "A list of Availability Zones (AZs) where you specifically want to create DB instances in the DB cluster. For information on AZs, see Availability Zones (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Concepts.RegionsAndAvailabilityZones.html#Concepts.RegionsAndAvailabilityZones.AvailabilityZones) in the Amazon Aurora User Guide. Valid for Cluster Type: Aurora DB clusters only Constraints: * Can't specify more than three AZs.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"backtrack_window": schema.Int64Attribute{
						...
						MarkdownDescription: "The target backtrack window, in seconds. To disable backtracking, set this value to 0. Valid for Cluster Type: Aurora MySQL DB clusters only Default: 0 Constraints: * If specified, this value must be set to a number from 0 to 259,200 (72 hours).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"backup_retention_period": schema.Int64Attribute{
						...
						MarkdownDescription: "The number of days for which automated backups are retained. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Default: 1 Constraints: * Must be a value from 1 to 35.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"character_set_name": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the character set (CharacterSet) to associate the DB cluster with. Valid for Cluster Type: Aurora DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"copy_tags_to_snapshot": schema.BoolAttribute{
						...
						MarkdownDescription: "Specifies whether to copy all tags from the DB cluster to snapshots of the DB cluster. The default is not to copy them. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"database_insights_mode": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the mode of Database Insights to enable for the cluster.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"database_name": schema.StringAttribute{
						...
						MarkdownDescription: "The name for your database of up to 64 alphanumeric characters. A database named postgres is always created. If this parameter is specified, an additional database with this name is created. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"db_cluster_identifier": schema.StringAttribute{
						Description:         "The identifier for this DB cluster. This parameter is stored as a lowercase string. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Constraints: * Must contain from 1 to 63 (for Aurora DB clusters) or 1 to 52 (for Multi-AZ DB clusters) letters, numbers, or hyphens. * First character must be a letter. * Can't end with a hyphen or contain two consecutive hyphens. Example: my-cluster1",
						MarkdownDescription: "The identifier for this DB cluster. This parameter is stored as a lowercase string. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Constraints: * Must contain from 1 to 63 (for Aurora DB clusters) or 1 to 52 (for Multi-AZ DB clusters) letters, numbers, or hyphens. * First character must be a letter. * Can't end with a hyphen or contain two consecutive hyphens. Example: my-cluster1",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"db_cluster_parameter_group_name": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the DB cluster parameter group to associate with this DB cluster. If you don't specify a value, then the default DB cluster parameter group for the specified DB engine and version is used. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Constraints: * If supplied, must match the name of an existing DB cluster parameter group.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"db_subnet_group_name": schema.StringAttribute{
						...
						MarkdownDescription: "A DB subnet group to associate with this DB cluster. This setting is required to create a Multi-AZ DB cluster. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Constraints: * Must match the name of an existing DB subnet group. Example: mydbsubnetgroup",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"deletion_protection": schema.BoolAttribute{
						...
						MarkdownDescription: "Specifies whether the DB cluster has deletion protection enabled. The database can't be deleted when deletion protection is enabled. By default, deletion protection isn't enabled. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"domain_iam_role_name": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the IAM role to use when making API calls to the Directory Service. Valid for Cluster Type: Aurora DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"enable_cloudwatch_logs_exports": schema.ListAttribute{
						...
						MarkdownDescription: "The list of log types that need to be enabled for exporting to CloudWatch Logs. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters The following values are valid for each DB engine: * Aurora MySQL - audit | error | general | slowquery * Aurora PostgreSQL - postgresql * RDS for MySQL - error | general | slowquery * RDS for PostgreSQL - postgresql | upgrade For more information about exporting CloudWatch Logs for Amazon RDS, see Publishing Database Logs to Amazon CloudWatch Logs (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch) in the Amazon RDS User Guide. For more information about exporting CloudWatch Logs for Amazon Aurora, see Publishing Database Logs to Amazon CloudWatch Logs (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_LogAccess.html#USER_LogAccess.Procedural.UploadtoCloudWatch) in the Amazon Aurora User Guide.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"enable_global_write_forwarding": schema.BoolAttribute{
						...
						MarkdownDescription: "Specifies whether to enable this DB cluster to forward write operations to the primary cluster of a global cluster (Aurora global database). By default, write operations are not allowed on Aurora DB clusters that are secondary clusters in an Aurora global database. You can set this value only on Aurora DB clusters that are members of an Aurora global database. With this parameter enabled, a secondary cluster can forward writes to the current primary cluster, and the resulting changes are replicated back to this cluster. For the primary DB cluster of an Aurora global database, this value is used immediately if the primary is demoted by a global cluster API operation, but it does nothing until then. Valid for Cluster Type: Aurora DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"enable_http_endpoint": schema.BoolAttribute{
						Description:         "Specifies whether to enable the HTTP endpoint for the DB cluster. By default, the HTTP endpoint isn't enabled. When enabled, the HTTP endpoint provides a connectionless web service API (RDS Data API) for running SQL queries on the DB cluster. You can also query your database from inside the RDS console with the RDS query editor. RDS Data API is supported with the following DB clusters: * Aurora PostgreSQL Serverless v2 and provisioned * Aurora PostgreSQL and Aurora MySQL Serverless v1 For more information, see Using RDS Data API (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/data-api.html) in the Amazon Aurora User Guide. Valid for Cluster Type: Aurora DB clusters only",
						MarkdownDescription: "Specifies whether to enable the HTTP endpoint for the DB cluster. By default, the HTTP endpoint isn't enabled. When enabled, the HTTP endpoint provides a connectionless web service API (RDS Data API) for running SQL queries on the DB cluster. You can also query your database from inside the RDS console with the RDS query editor. RDS Data API is supported with the following DB clusters: * Aurora PostgreSQL Serverless v2 and provisioned * Aurora PostgreSQL and Aurora MySQL Serverless v1 For more information, see Using RDS Data API (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/data-api.html) in the Amazon Aurora User Guide. Valid for Cluster Type: Aurora DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"enable_iam_database_authentication": schema.BoolAttribute{
						Description:         "Specifies whether to enable mapping of Amazon Web Services Identity and Access Management (IAM) accounts to database accounts. By default, mapping isn't enabled. For more information, see IAM Database Authentication (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.html) in the Amazon Aurora User Guide or IAM database authentication for MariaDB, MySQL, and PostgreSQL (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.html) in the Amazon RDS User Guide. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						MarkdownDescription: "Specifies whether to enable mapping of Amazon Web Services Identity and Access Management (IAM) accounts to database accounts. By default, mapping isn't enabled. For more information, see IAM Database Authentication (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.IAMDBAuth.html) in the Amazon Aurora User Guide or IAM database authentication for MariaDB, MySQL, and PostgreSQL (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.html) in the Amazon RDS User Guide. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"enable_performance_insights": schema.BoolAttribute{
						Description:         "Specifies whether to turn on Performance Insights for the DB cluster. For more information, see Using Amazon Performance Insights (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html) in the Amazon RDS User Guide. Valid for Cluster Type: Multi-AZ DB clusters only",
						MarkdownDescription: "Specifies whether to turn on Performance Insights for the DB cluster. For more information, see Using Amazon Performance Insights (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PerfInsights.html) in the Amazon RDS User Guide. Valid for Cluster Type: Multi-AZ DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"engine": schema.StringAttribute{
						Description:         "The database engine to use for this DB cluster. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: * aurora-mysql * aurora-postgresql * mysql * postgres * neptune - For information about using Amazon Neptune, see the Amazon Neptune User Guide (https://docs.aws.amazon.com/neptune/latest/userguide/intro.html).",
						MarkdownDescription: "The database engine to use for this DB cluster. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: * aurora-mysql * aurora-postgresql * mysql * postgres * neptune - For information about using Amazon Neptune, see the Amazon Neptune User Guide (https://docs.aws.amazon.com/neptune/latest/userguide/intro.html).",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"global_cluster_identifier": schema.StringAttribute{
						...
						MarkdownDescription: "The global cluster ID of an Aurora cluster that becomes the primary cluster in the new global database cluster. Valid for Cluster Type: Aurora DB clusters only",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"master_user_password": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The password for the master database user. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Constraints: * Must contain from 8 to 41 characters. * Can contain any printable ASCII character except '/', ''', or '@'. * Can't be specified if ManageMasterUserPassword is turned on.",
						Attributes: map[string]schema.Attribute{
					...
					"master_username": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the master user for the DB cluster. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Constraints: * Must be 1 to 16 letters or numbers. * First character must be a letter. * Can't be a reserved word for the chosen database engine.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"monitoring_interval": schema.Int64Attribute{
						...
						MarkdownDescription: "The interval, in seconds, between points when Enhanced Monitoring metrics are collected for the DB cluster. To turn off collecting Enhanced Monitoring metrics, specify 0. If MonitoringRoleArn is specified, also set MonitoringInterval to a value other than 0. Valid for Cluster Type: Multi-AZ DB clusters only Valid Values: 0 | 1 | 5 | 10 | 15 | 30 | 60 Default: 0",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"network_type": schema.StringAttribute{
						...
						MarkdownDescription: "The network type of the DB cluster. The network type is determined by the DBSubnetGroup specified for the DB cluster. A DBSubnetGroup can support only the IPv4 protocol or the IPv4 and the IPv6 protocols (DUAL). For more information, see Working with a DB instance in a VPC (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_VPC.WorkingWithRDSInstanceinaVPC.html) in the Amazon Aurora User Guide. Valid for Cluster Type: Aurora DB clusters only Valid Values: IPV4 | DUAL",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"option_group_name": schema.StringAttribute{
						...
						MarkdownDescription: "The option group to associate the DB cluster with. DB clusters are associated with a default option group that can't be modified.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"performance_insights_retention_period": schema.Int64Attribute{
						Description:         "The number of days to retain Performance Insights data. Valid for Cluster Type: Multi-AZ DB clusters only Valid Values: * 7 * month * 31, where month is a number of months from 1-23. Examples: 93 (3 months * 31), 341 (11 months * 31), 589 (19 months * 31) * 731 Default: 7 days If you specify a retention period that isn't valid, such as 94, Amazon RDS issues an error.",
						MarkdownDescription: "The number of days to retain Performance Insights data. Valid for Cluster Type: Multi-AZ DB clusters only Valid Values: * 7 * month * 31, where month is a number of months from 1-23. Examples: 93 (3 months * 31), 341 (11 months * 31), 589 (19 months * 31) * 731 Default: 7 days If you specify a retention period that isn't valid, such as 94, Amazon RDS issues an error.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"port": schema.Int64Attribute{
						...
						MarkdownDescription: "The port number on which the instances in the DB cluster accept connections. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: 1150-65535 Default: * RDS for MySQL and Aurora MySQL - 3306 * RDS for PostgreSQL and Aurora PostgreSQL - 5432",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"preferred_maintenance_window": schema.StringAttribute{
						...
						MarkdownDescription: "The weekly time range during which system maintenance can occur. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters The default is a 30-minute window selected at random from an 8-hour block of time for each Amazon Web Services Region, occurring on a random day of the week. To see the time blocks available, see Adjusting the Preferred DB Cluster Maintenance Window (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_UpgradeDBInstance.Maintenance.html#AdjustingTheMaintenanceWindow.Aurora) in the Amazon Aurora User Guide. Constraints: * Must be in the format ddd:hh24:mi-ddd:hh24:mi. * Days must be one of Mon | Tue | Wed | Thu | Fri | Sat | Sun. * Must be in Universal Coordinated Time (UTC). * Must be at least 30 minutes.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"replication_source_identifier": schema.StringAttribute{
						...
						MarkdownDescription: "The Amazon Resource Name (ARN) of the source DB instance or DB cluster if this DB cluster is created as a read replica. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"scaling_configuration": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "For DB clusters in serverless DB engine mode, the scaling properties of the DB cluster. Valid for Cluster Type: Aurora DB clusters only",
						Attributes: map[string]schema.Attribute{
					...
					"storage_encrypted": schema.BoolAttribute{
						...
						MarkdownDescription: "Specifies whether the DB cluster is encrypted. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"storage_type": schema.StringAttribute{
						...
						MarkdownDescription: "The storage type to associate with the DB cluster. For information on storage types for Aurora DB clusters, see Storage configurations for Amazon Aurora DB clusters (https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Aurora.Overview.StorageReliability.html#aurora-storage-type). For information on storage types for Multi-AZ DB clusters, see Settings for creating Multi-AZ DB clusters (https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/create-multi-az-db-cluster.html#create-multi-az-db-cluster-settings). This setting is required to create a Multi-AZ DB cluster. When specified for a Multi-AZ DB cluster, a value for the Iops parameter is required. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: * Aurora DB clusters - aurora | aurora-iopt1 * Multi-AZ DB clusters - io1 | io2 | gp3 Default: * Aurora DB clusters - aurora * Multi-AZ DB clusters - io1 When you create an Aurora DB cluster with the storage type set to aurora-iopt1, the storage type is returned in the response. The storage type isn't returned when you set it to aurora.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"tags": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Tags to assign to the DB cluster. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
					...
					"use_latest_restorable_time": schema.BoolAttribute{
						Description:         "Specifies whether to restore the DB cluster to the latest restorable backup time. By default, the DB cluster isn't restored to the latest restorable backup time. Constraints: Can't be specified if RestoreToTime parameter is provided. Valid for: Aurora DB clusters and Multi-AZ DB clusters",
						MarkdownDescription: "Specifies whether to restore the DB cluster to the latest restorable backup time. By default, the DB cluster isn't restored to the latest restorable backup time. Constraints: Can't be specified if RestoreToTime parameter is provided. Valid for: Aurora DB clusters and Multi-AZ DB clusters",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"vpc_security_group_i_ds": schema.ListAttribute{
						...
						MarkdownDescription: "A list of EC2 VPC security groups to associate with this DB cluster. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
