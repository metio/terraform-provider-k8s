...
var (
	_ datasource.DataSource = &AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Manifest{}
)

func NewAdmissionregistrationK8SIoMutatingWebhookConfigurationV1Manifest() datasource.DataSource {
	return &AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Manifest{}
}
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_admissionregistration_k8s_io_mutating_webhook_configuration_v1_manifest"
}
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_admissionregistration_k8s_io_mutating_webhook_configuration_v1_manifest")

	var model AdmissionregistrationK8SIoMutatingWebhookConfigurationV1ManifestData
