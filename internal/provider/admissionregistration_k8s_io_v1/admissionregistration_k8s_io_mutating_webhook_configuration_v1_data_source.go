...
var (
	_ datasource.DataSource              = &AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource{}
	_ datasource.DataSourceWithConfigure = &AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource{}
)

func NewAdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource() datasource.DataSource {
	return &AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource{}
}

type AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSourceData struct {
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_admissionregistration_k8s_io_mutating_webhook_configuration_v1"
}

func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_admissionregistration_k8s_io_mutating_webhook_configuration_v1")

	var data AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "admissionregistration.k8s.io", Version: "v1", Resource: "MutatingWebhookConfiguration"}).
	...
	var readResponse AdmissionregistrationK8SIoMutatingWebhookConfigurationV1DataSourceData
	...
	data.Kind = pointer.String("MutatingWebhookConfiguration")
