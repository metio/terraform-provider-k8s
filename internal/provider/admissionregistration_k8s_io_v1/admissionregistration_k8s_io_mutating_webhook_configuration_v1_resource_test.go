...
func TestAdmissionregistrationK8SIoMutatingWebhookConfigurationV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_admissionregistration_k8s_io_mutating_webhook_configuration_v1", testCase)
		})
	}
}
