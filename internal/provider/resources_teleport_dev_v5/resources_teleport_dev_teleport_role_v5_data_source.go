...
var (
	_ datasource.DataSource              = &ResourcesTeleportDevTeleportRoleV5DataSource{}
	_ datasource.DataSourceWithConfigure = &ResourcesTeleportDevTeleportRoleV5DataSource{}
)

func NewResourcesTeleportDevTeleportRoleV5DataSource() datasource.DataSource {
	return &ResourcesTeleportDevTeleportRoleV5DataSource{}
}

type ResourcesTeleportDevTeleportRoleV5DataSource struct {
	kubernetesClient dynamic.Interface
}

type ResourcesTeleportDevTeleportRoleV5DataSourceData struct {
...
func (r *ResourcesTeleportDevTeleportRoleV5DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_resources_teleport_dev_teleport_role_v5"
}

func (r *ResourcesTeleportDevTeleportRoleV5DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ResourcesTeleportDevTeleportRoleV5DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ResourcesTeleportDevTeleportRoleV5DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_resources_teleport_dev_teleport_role_v5")

	var data ResourcesTeleportDevTeleportRoleV5DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "resources.teleport.dev", Version: "v5", Resource: "teleportroles"}).
	...
	var readResponse ResourcesTeleportDevTeleportRoleV5DataSourceData
	...
	data.ApiVersion = pointer.String("resources.teleport.dev/v5")
	data.Kind = pointer.String("TeleportRole")
