...
var (
	_ datasource.DataSource = &ResourcesTeleportDevTeleportRoleV5Manifest{}
)

func NewResourcesTeleportDevTeleportRoleV5Manifest() datasource.DataSource {
	return &ResourcesTeleportDevTeleportRoleV5Manifest{}
}
...
func (r *ResourcesTeleportDevTeleportRoleV5Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_resources_teleport_dev_teleport_role_v5_manifest"
}

func (r *ResourcesTeleportDevTeleportRoleV5Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ResourcesTeleportDevTeleportRoleV5Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_resources_teleport_dev_teleport_role_v5_manifest")

	var model ResourcesTeleportDevTeleportRoleV5ManifestData
