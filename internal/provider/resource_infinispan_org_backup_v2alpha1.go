...
type InfinispanOrgBackupV2Alpha1Resource struct{}

var (
	_ resource.Resource = (*InfinispanOrgBackupV2Alpha1Resource)(nil)
)

type InfinispanOrgBackupV2Alpha1TerraformModel struct {
...
type InfinispanOrgBackupV2Alpha1GoModel struct {
...
func NewInfinispanOrgBackupV2Alpha1Resource() resource.Resource {
	return &InfinispanOrgBackupV2Alpha1Resource{}
}

func (r *InfinispanOrgBackupV2Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_infinispan_org_backup_v2alpha1"
}

func (r *InfinispanOrgBackupV2Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *InfinispanOrgBackupV2Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_infinispan_org_backup_v2alpha1")

	var state InfinispanOrgBackupV2Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel InfinispanOrgBackupV2Alpha1GoModel
...
func (r *InfinispanOrgBackupV2Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infinispan_org_backup_v2alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *InfinispanOrgBackupV2Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_infinispan_org_backup_v2alpha1")
...
func (r *InfinispanOrgBackupV2Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_infinispan_org_backup_v2alpha1")
