...
var (
	_ datasource.DataSource              = &HncXK8SIoHierarchyConfigurationV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &HncXK8SIoHierarchyConfigurationV1Alpha2DataSource{}
)

func NewHncXK8SIoHierarchyConfigurationV1Alpha2DataSource() datasource.DataSource {
	return &HncXK8SIoHierarchyConfigurationV1Alpha2DataSource{}
}

type HncXK8SIoHierarchyConfigurationV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type HncXK8SIoHierarchyConfigurationV1Alpha2DataSourceData struct {
...
func (r *HncXK8SIoHierarchyConfigurationV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hnc_x_k8s_io_hierarchy_configuration_v1alpha2"
}

func (r *HncXK8SIoHierarchyConfigurationV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HncXK8SIoHierarchyConfigurationV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HncXK8SIoHierarchyConfigurationV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_hnc_x_k8s_io_hierarchy_configuration_v1alpha2")

	var data HncXK8SIoHierarchyConfigurationV1Alpha2DataSourceData
	...
	var readResponse HncXK8SIoHierarchyConfigurationV1Alpha2DataSourceData
	...
	data.Kind = pointer.String("HierarchyConfiguration")
