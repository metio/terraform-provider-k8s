...
var (
	_ datasource.DataSource = &SchedulingKoordinatorShPodMigrationJobV1Alpha1Manifest{}
)

func NewSchedulingKoordinatorShPodMigrationJobV1Alpha1Manifest() datasource.DataSource {
	return &SchedulingKoordinatorShPodMigrationJobV1Alpha1Manifest{}
}
...
func (r *SchedulingKoordinatorShPodMigrationJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_scheduling_koordinator_sh_pod_migration_job_v1alpha1_manifest"
}

func (r *SchedulingKoordinatorShPodMigrationJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SchedulingKoordinatorShPodMigrationJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_scheduling_koordinator_sh_pod_migration_job_v1alpha1_manifest")

	var model SchedulingKoordinatorShPodMigrationJobV1Alpha1ManifestData
