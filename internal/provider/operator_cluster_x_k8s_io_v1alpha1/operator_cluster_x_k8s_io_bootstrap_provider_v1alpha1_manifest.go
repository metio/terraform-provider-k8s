...
var (
	_ datasource.DataSource = &OperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest{}
)

func NewOperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest() datasource.DataSource {
	return &OperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest{}
}

type OperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest struct{}

type OperatorClusterXK8SIoBootstrapProviderV1Alpha1ManifestData struct {
...
func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1_manifest"
}

func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "BootstrapProvider is the Schema for the bootstrapproviders API. Deprecated: This type will be removed in one of the next releases.",
		MarkdownDescription: "BootstrapProvider is the Schema for the bootstrapproviders API. Deprecated: This type will be removed in one of the next releases.",
...
func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1_manifest")

	var model OperatorClusterXK8SIoBootstrapProviderV1Alpha1ManifestData
