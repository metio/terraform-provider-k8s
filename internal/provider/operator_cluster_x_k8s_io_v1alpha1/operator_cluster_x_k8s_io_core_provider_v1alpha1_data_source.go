...
var (
	_ datasource.DataSource              = &OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource{}
)

func NewOperatorClusterXK8SIoCoreProviderV1Alpha1DataSource() datasource.DataSource {
	return &OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource{}
}

type OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorClusterXK8SIoCoreProviderV1Alpha1DataSourceData struct {
...
func (r *OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_core_provider_v1alpha1"
}

func (r *OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorClusterXK8SIoCoreProviderV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_cluster_x_k8s_io_core_provider_v1alpha1")

	var data OperatorClusterXK8SIoCoreProviderV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "operator.cluster.x-k8s.io", Version: "v1alpha1", Resource: "coreproviders"}).
	...
	var readResponse OperatorClusterXK8SIoCoreProviderV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("operator.cluster.x-k8s.io/v1alpha1")
	data.Kind = pointer.String("CoreProvider")
