...
var (
	_ datasource.DataSource = &OperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest{}
)

func NewOperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest() datasource.DataSource {
	return &OperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest{}
}

type OperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest struct{}

type OperatorClusterXK8SIoControlPlaneProviderV1Alpha1ManifestData struct {
...
func (r *OperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_control_plane_provider_v1alpha1_manifest"
}

func (r *OperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ControlPlaneProvider is the Schema for the controlplaneproviders API. Deprecated: This type will be removed in one of the next releases.",
		MarkdownDescription: "ControlPlaneProvider is the Schema for the controlplaneproviders API. Deprecated: This type will be removed in one of the next releases.",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
										...
										"image": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"name": schema.StringAttribute{
													...
													MarkdownDescription: "Name allows to specify a name for the image.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
												...
												"repository": schema.StringAttribute{
													Description:         "Repository sets the container registry to pull images from.",
													MarkdownDescription: "Repository sets the container registry to pull images from.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
												...
												"tag": schema.StringAttribute{
													...
													MarkdownDescription: "Tag allows to specify a tag for the image.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
					...
					"secret_name": schema.StringAttribute{
						Description:         "SecretName is the name of the Secret providing the configuration variables for the current provider instance, like e.g. credentials. Such configurations will be used when creating or upgrading provider components. The contents of the secret will be treated as immutable. If changes need to be made, a new object can be created and the name should be updated. The contents should be in the form of key:value. This secret must be in the same namespace as the provider.",
						MarkdownDescription: "SecretName is the name of the Secret providing the configuration variables for the current provider instance, like e.g. credentials. Such configurations will be used when creating or upgrading provider components. The contents of the secret will be treated as immutable. If changes need to be made, a new object can be created and the name should be updated. The contents should be in the form of key:value. This secret must be in the same namespace as the provider.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"secret_namespace": schema.StringAttribute{
						Description:         "SecretNamespace is the namespace of the Secret providing the configuration variables. If not specified, the namespace of the provider will be used.",
						MarkdownDescription: "SecretNamespace is the namespace of the Secret providing the configuration variables. If not specified, the namespace of the provider will be used.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *OperatorClusterXK8SIoControlPlaneProviderV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_cluster_x_k8s_io_control_plane_provider_v1alpha1_manifest")

	var model OperatorClusterXK8SIoControlPlaneProviderV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("operator.cluster.x-k8s.io/v1alpha1")
