...
var (
	_ datasource.DataSource              = &OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource{}
)

func NewOperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource() datasource.DataSource {
	return &OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource{}
}

type OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSourceData struct {
...
func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1"
}

func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1")

	var data OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSourceData
	...
	var readResponse OperatorClusterXK8SIoBootstrapProviderV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("BootstrapProvider")
