		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"name": schema.StringAttribute{
						Description:         "A friendly name that lets you easily find a rule in the Resolver dashboard in the Route 53 console. Regex Pattern: '^(?!^[0-9]+$)([a-zA-Z0-9-_' ']+)$'",
						MarkdownDescription: "A friendly name that lets you easily find a rule in the Resolver dashboard in the Route 53 console. Regex Pattern: '^(?!^[0-9]+$)([a-zA-Z0-9-_' ']+)$'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
