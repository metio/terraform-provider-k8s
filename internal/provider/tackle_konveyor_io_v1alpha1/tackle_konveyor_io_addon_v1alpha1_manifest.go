...
var (
	_ datasource.DataSource = &TackleKonveyorIoAddonV1Alpha1Manifest{}
)

func NewTackleKonveyorIoAddonV1Alpha1Manifest() datasource.DataSource {
	return &TackleKonveyorIoAddonV1Alpha1Manifest{}
}

type TackleKonveyorIoAddonV1Alpha1Manifest struct{}

type TackleKonveyorIoAddonV1Alpha1ManifestData struct {
...
func (r *TackleKonveyorIoAddonV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tackle_konveyor_io_addon_v1alpha1_manifest"
}

func (r *TackleKonveyorIoAddonV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"container": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Container defines the addon container.",
						Attributes: map[string]schema.Attribute{
					...
					"image": schema.StringAttribute{
						...
						MarkdownDescription: "Deprecated: Addon is deprecated.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"image_pull_policy": schema.StringAttribute{
						...
						MarkdownDescription: "Deprecated: ImagePullPolicy is deprecated.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"resources": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Deprecated: Resources is deprecated.",
						Attributes: map[string]schema.Attribute{
							"limits": schema.MapAttribute{
								Description:         "Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
								MarkdownDescription: "Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
					...
					"selector": schema.StringAttribute{
						...
						MarkdownDescription: "Selector defines criteria to be selected for a task.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"task": schema.StringAttribute{
						...
						MarkdownDescription: "Task declares task compatability.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *TackleKonveyorIoAddonV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tackle_konveyor_io_addon_v1alpha1_manifest")

	var model TackleKonveyorIoAddonV1Alpha1ManifestData
