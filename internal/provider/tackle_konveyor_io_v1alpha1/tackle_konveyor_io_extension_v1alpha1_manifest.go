...
package tackle_konveyor_io_v1alpha1
...
var (
	_ datasource.DataSource = &TackleKonveyorIoExtensionV1Alpha1Manifest{}
)

func NewTackleKonveyorIoExtensionV1Alpha1Manifest() datasource.DataSource {
	return &TackleKonveyorIoExtensionV1Alpha1Manifest{}
}

type TackleKonveyorIoExtensionV1Alpha1Manifest struct{}

type TackleKonveyorIoExtensionV1Alpha1ManifestData struct {
	...
	Spec *struct {
		Addon     *string `tfsdk:"addon" json:"addon,omitempty"`
		Container *struct {
...
func (r *TackleKonveyorIoExtensionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tackle_konveyor_io_extension_v1alpha1_manifest"
}

func (r *TackleKonveyorIoExtensionV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Extension defines an addon extension.",
		MarkdownDescription: "Extension defines an addon extension.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "pec defines the desired state of the resource.",
				Attributes: map[string]schema.Attribute{
					"addon": schema.StringAttribute{
						Description:         "Addon (name) declares addon compatibility.",
						MarkdownDescription: "Addon (name) declares addon compatibility.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"container": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Container defines the extension container.",
						Attributes: map[string]schema.Attribute{
					...
					"metadata": schema.MapAttribute{
						...
						MarkdownDescription: "Metadata details.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"selector": schema.StringAttribute{
						Description:         "Selector defines criteria to be included in the addon pod.",
						MarkdownDescription: "Selector defines criteria to be included in the addon pod.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *TackleKonveyorIoExtensionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tackle_konveyor_io_extension_v1alpha1_manifest")

	var model TackleKonveyorIoExtensionV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("tackle.konveyor.io/v1alpha1")
	model.Kind = pointer.String("Extension")
