...
package helm_toolkit_fluxcd_io_v2
...
var (
	_ datasource.DataSource = &HelmToolkitFluxcdIoHelmReleaseV2Manifest{}
)

func NewHelmToolkitFluxcdIoHelmReleaseV2Manifest() datasource.DataSource {
	return &HelmToolkitFluxcdIoHelmReleaseV2Manifest{}
}
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_helm_toolkit_fluxcd_io_helm_release_v2_manifest"
}
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_helm_toolkit_fluxcd_io_helm_release_v2_manifest")

	var model HelmToolkitFluxcdIoHelmReleaseV2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("helm.toolkit.fluxcd.io/v2")
