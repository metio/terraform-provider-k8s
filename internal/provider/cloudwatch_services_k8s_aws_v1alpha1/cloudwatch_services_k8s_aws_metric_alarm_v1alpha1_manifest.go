		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"namespace": schema.StringAttribute{
						Description:         "The namespace for the metric associated specified in MetricName. Regex Pattern: '^[^:]'",
						MarkdownDescription: "The namespace for the metric associated specified in MetricName. Regex Pattern: '^[^:]'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
