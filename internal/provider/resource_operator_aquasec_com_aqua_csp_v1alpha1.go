...
type OperatorAquasecComAquaCspV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*OperatorAquasecComAquaCspV1Alpha1Resource)(nil)
)

type OperatorAquasecComAquaCspV1Alpha1TerraformModel struct {
...
type OperatorAquasecComAquaCspV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		LicenseToken *string `tfsdk:"license_token" yaml:"licenseToken,omitempty"`

		Route *bool `tfsdk:"route" yaml:"route,omitempty"`

		ServerConfigMapData *map[string]string `tfsdk:"server_config_map_data" yaml:"serverConfigMapData,omitempty"`

		AdminPassword *string `tfsdk:"admin_password" yaml:"adminPassword,omitempty"`

		Enforcer *struct {
			EnforceMode *bool `tfsdk:"enforce_mode" yaml:"enforceMode,omitempty"`

			Gateway *string `tfsdk:"gateway" yaml:"gateway,omitempty"`

			Name *string `tfsdk:"name" yaml:"name,omitempty"`
		} `tfsdk:"enforcer" yaml:"enforcer,omitempty"`
		...
		} `tfsdk:"gateway_envs" yaml:"gatewayEnvs,omitempty"`
		...
		ExternalDb *struct {
			...
			Username *string `tfsdk:"username" yaml:"username,omitempty"`
		} `tfsdk:"external_db" yaml:"externalDb,omitempty"`

		KubeEnforcer *struct {
			Registry *string `tfsdk:"registry" yaml:"registry,omitempty"`

			Tag *string `tfsdk:"tag" yaml:"tag,omitempty"`
		} `tfsdk:"kube_enforcer" yaml:"kubeEnforcer,omitempty"`
		...
		} `tfsdk:"server_envs" yaml:"serverEnvs,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewOperatorAquasecComAquaCspV1Alpha1Resource() resource.Resource {
	return &OperatorAquasecComAquaCspV1Alpha1Resource{}
}

func (r *OperatorAquasecComAquaCspV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_aquasec_com_aqua_csp_v1alpha1"
}

func (r *OperatorAquasecComAquaCspV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorAquasecComAquaCspV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_aquasec_com_aqua_csp_v1alpha1")

	var state OperatorAquasecComAquaCspV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorAquasecComAquaCspV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("AquaCsp")
...
func (r *OperatorAquasecComAquaCspV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_csp_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorAquasecComAquaCspV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_operator_aquasec_com_aqua_csp_v1alpha1")
...
func (r *OperatorAquasecComAquaCspV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_operator_aquasec_com_aqua_csp_v1alpha1")
