...
var (
	_ resource.Resource = (*DataFluidIoGooseFSRuntimeV1Alpha1Resource)(nil)
)

type DataFluidIoGooseFSRuntimeV1Alpha1TerraformModel struct {
...
type DataFluidIoGooseFSRuntimeV1Alpha1GoModel struct {
	...
	Spec *struct {
		ApiGateway *struct {
			...
			JvmOptions *[]string `tfsdk:"jvm_options" yaml:"jvmOptions,omitempty"`
		...
		} `tfsdk:"api_gateway" yaml:"apiGateway,omitempty"`

		Data *struct {
			Pin *bool `tfsdk:"pin" yaml:"pin,omitempty"`
		...
		GoosefsVersion *struct {
			Image *string `tfsdk:"image" yaml:"image,omitempty"`

			ImagePullPolicy *string `tfsdk:"image_pull_policy" yaml:"imagePullPolicy,omitempty"`

			ImageTag *string `tfsdk:"image_tag" yaml:"imageTag,omitempty"`
		} `tfsdk:"goosefs_version" yaml:"goosefsVersion,omitempty"`

		HadoopConfig *string `tfsdk:"hadoop_config" yaml:"hadoopConfig,omitempty"`
		...
		} `tfsdk:"init_users" yaml:"initUsers,omitempty"`
		...
		} `tfsdk:"job_master" yaml:"jobMaster,omitempty"`
		...
		} `tfsdk:"job_worker" yaml:"jobWorker,omitempty"`
...
func (r *DataFluidIoGooseFSRuntimeV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_data_fluid_io_goose_fs_runtime_v1alpha1"
}

func (r *DataFluidIoGooseFSRuntimeV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				...
				MarkdownDescription: "GooseFSRuntimeSpec defines the desired state of GooseFSRuntime",

				Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{

					"api_gateway": {
						Description:         "The component spec of GooseFS API Gateway",
						MarkdownDescription: "The component spec of GooseFS API Gateway",
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"env": {
								...
								MarkdownDescription: "Environment variables that will be used by GooseFS component. <br>",
							...
							"ports": {
								...
								MarkdownDescription: "Ports used by GooseFS(e.g. rpc: 19998 for master)",
							...
							"properties": {
								...
								MarkdownDescription: "Configurable properties for the GOOSEFS component. <br> Refer to <a href='https://cloud.tencent.com/document/product/436/56415'>GOOSEFS Configuration Properties</a> for more info",
							...
							"resources": {
								...
								MarkdownDescription: "Resources that will be requested by the GooseFS component. <br> <br> Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod.",
					...
					"disable_prometheus": {
						...
						MarkdownDescription: "Disable monitoring for GooseFS Runtime Prometheus is enabled by default",
					...
					"fuse": {
						...
						MarkdownDescription: "The component spec of GooseFS Fuse",
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"args": {
								...
								MarkdownDescription: "Arguments that will be passed to GooseFS Fuse",
							...
							"env": {
								...
								MarkdownDescription: "Environment variables that will be used by GooseFS Fuse",
							...
							"image": {
								...
								MarkdownDescription: "Image for GooseFS Fuse(e.g. goosefs/goosefs-fuse)",
							...
							"image_tag": {
								...
								MarkdownDescription: "Image Tag for GooseFS Fuse(e.g. v1.0.1)",
							...
							"resources": {
								...
								MarkdownDescription: "Resources that will be requested by GooseFS Fuse. <br> <br> Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod.",
					...
					"goosefs_version": {
						...
						MarkdownDescription: "The version information that instructs fluid to orchestrate a particular version of GooseFS.",
					...
					"job_master": {
						...
						MarkdownDescription: "The component spec of GooseFS job master",
					...
					"job_worker": {
						...
						MarkdownDescription: "The component spec of GooseFS job Worker",
					...
					"master": {
						...
						MarkdownDescription: "The component spec of GooseFS master",
					...
					"run_as": {
						...
						MarkdownDescription: "Manage the user to run GooseFS Runtime GooseFS support POSIX-ACL and Apache Ranger to manager authorization TODO(chrisydxie@tencent.com) Support Apache Ranger.",
					...
					"tieredstore": {
						...
						MarkdownDescription: "Tiered storage used by GooseFS",
					...
					"worker": {
						...
						MarkdownDescription: "The component spec of GooseFS worker",
...
func (r *DataFluidIoGooseFSRuntimeV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_data_fluid_io_goose_fs_runtime_v1alpha1")

	var state DataFluidIoGooseFSRuntimeV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel DataFluidIoGooseFSRuntimeV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("GooseFSRuntime")
...
func (r *DataFluidIoGooseFSRuntimeV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_goose_fs_runtime_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *DataFluidIoGooseFSRuntimeV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *DataFluidIoGooseFSRuntimeV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
