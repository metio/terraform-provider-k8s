...
var (
	_ datasource.DataSource = &KmmSigsXK8SIoModuleV1Beta1Manifest{}
)

func NewKmmSigsXK8SIoModuleV1Beta1Manifest() datasource.DataSource {
	return &KmmSigsXK8SIoModuleV1Beta1Manifest{}
}

type KmmSigsXK8SIoModuleV1Beta1Manifest struct{}

type KmmSigsXK8SIoModuleV1Beta1ManifestData struct {
			...
			Container *struct {
				...
				KernelMappings        *[]struct {
					...
					RegistryTLS           *struct {
						Insecure              *bool `tfsdk:"insecure" json:"insecure,omitempty"`
						InsecureSkipTLSVerify *bool `tfsdk:"insecure_skip_tls_verify" json:"insecureSkipTLSVerify,omitempty"`
					} `tfsdk:"registry_tls" json:"registryTLS,omitempty"`
					Sign *struct {
						CertSecret *struct {
							Name *string `tfsdk:"name" json:"name,omitempty"`
						} `tfsdk:"cert_secret" json:"certSecret,omitempty"`
						FilesToSign *[]string `tfsdk:"files_to_sign" json:"filesToSign,omitempty"`
						KeySecret   *struct {
							Name *string `tfsdk:"name" json:"name,omitempty"`
						} `tfsdk:"key_secret" json:"keySecret,omitempty"`
						UnsignedImage            *string `tfsdk:"unsigned_image" json:"unsignedImage,omitempty"`
						UnsignedImageRegistryTLS *struct {
							Insecure              *bool `tfsdk:"insecure" json:"insecure,omitempty"`
							InsecureSkipTLSVerify *bool `tfsdk:"insecure_skip_tls_verify" json:"insecureSkipTLSVerify,omitempty"`
						} `tfsdk:"unsigned_image_registry_tls" json:"unsignedImageRegistryTLS,omitempty"`
					} `tfsdk:"sign" json:"sign,omitempty"`
				} `tfsdk:"kernel_mappings" json:"kernelMappings,omitempty"`
				Modprobe *struct {
					Args *struct {
...
func (r *KmmSigsXK8SIoModuleV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kmm_sigs_x_k8s_io_module_v1beta1_manifest"
}

func (r *KmmSigsXK8SIoModuleV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Module describes how to load a module on different kernel versions",
		MarkdownDescription: "Module describes how to load a module on different kernel versions",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "ModuleSpec describes how the KMM operator should deploy a Module on those nodes that need it.",
				MarkdownDescription: "ModuleSpec describes how the KMM operator should deploy a Module on those nodes that need it.",
				Attributes: map[string]schema.Attribute{
					"device_plugin": schema.SingleNestedAttribute{
						Description:         "DevicePlugin allows overriding some properties of the container that deploys the device plugin on the node. Name is ignored and is set automatically by the KMM Operator.",
						MarkdownDescription: "DevicePlugin allows overriding some properties of the container that deploys the device plugin on the node. Name is ignored and is set automatically by the KMM Operator.",
						Attributes: map[string]schema.Attribute{
					...
					"image_repo_secret": schema.SingleNestedAttribute{
						Description:         "ImageRepoSecret is an optional secret that is used to pull both the module loader and the device plugin, and to push the resulting image from the module loader build, if enabled.",
						MarkdownDescription: "ImageRepoSecret is an optional secret that is used to pull both the module loader and the device plugin, and to push the resulting image from the module loader build, if enabled.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
								Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
								MarkdownDescription: "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
					...
					"module_loader": schema.SingleNestedAttribute{
						Description:         "ModuleLoader allows overriding some properties of the container that loads the kernel module on the node. Name and image are ignored and are set automatically by the KMM Operator.",
						MarkdownDescription: "ModuleLoader allows overriding some properties of the container that loads the kernel module on the node. Name and image are ignored and are set automatically by the KMM Operator.",
						Attributes: map[string]schema.Attribute{
							"container": schema.SingleNestedAttribute{
								Description:         "Container holds the properties for the module loader container that runs modprobe.",
								MarkdownDescription: "Container holds the properties for the module loader container that runs modprobe.",
								Attributes: map[string]schema.Attribute{
									"build": schema.SingleNestedAttribute{
										Description:         "Build contains build instructions.",
										MarkdownDescription: "Build contains build instructions.",
										Attributes: map[string]schema.Attribute{
											"base_image_registry_tls": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "BaseImageRegistryTLS contains settings determining how to access registries of the base images in the build-process' Dockerfile.",
												Attributes: map[string]schema.Attribute{
													"insecure": schema.BoolAttribute{
														Description:         "If Insecure is true, the operator will be able to access a registry in an insecure (plain HTTP) protocol.",
														MarkdownDescription: "If Insecure is true, the operator will be able to access a registry in an insecure (plain HTTP) protocol.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
													...
													"insecure_skip_tls_verify": schema.BoolAttribute{
														...
														MarkdownDescription: "If InsecureSkipTLSVerify, the operator will accept any certificate provided by the registry.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
											...
											"build_args": schema.ListNestedAttribute{
												...
												MarkdownDescription: "BuildArgs is an array of build variables that are provided to the image building backend.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"name": schema.StringAttribute{
															Description:         "",
											...
											"dockerfile_config_map": schema.SingleNestedAttribute{
												Description:         "ConfigMap that holds Dockerfile contents",
												MarkdownDescription: "ConfigMap that holds Dockerfile contents",
												Attributes: map[string]schema.Attribute{
													"name": schema.StringAttribute{
														Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
														MarkdownDescription: "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
											...
											"kaniko_params": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "KanikoParams is used to customize the building process of the image.",
												Attributes: map[string]schema.Attribute{
													"tag": schema.StringAttribute{
														Description:         "Kaniko image tag to use when creating the build Pod",
														MarkdownDescription: "Kaniko image tag to use when creating the build Pod",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
											...
											"secrets": schema.ListNestedAttribute{
												Description:         "Secrets is an optional list of secrets to be made available to the build system. Those secrets should be used for private resources such as a private Github repo. For container registries auth use module.spec.imagePullSecret instead.",
												MarkdownDescription: "Secrets is an optional list of secrets to be made available to the build system. Those secrets should be used for private resources such as a private Github repo. For container registries auth use module.spec.imagePullSecret instead.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"name": schema.StringAttribute{
															Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
											...
											"selector": schema.MapAttribute{
												...
												MarkdownDescription: "Selector describes on which nodes will run the building process.",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
									...
									"container_image": schema.StringAttribute{
										...
										MarkdownDescription: "ContainerImage is a top-level field",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"in_tree_module_to_remove": schema.StringAttribute{
										Description:         "Deprecated: please use InTreeModulesToRemove. InTreeModuleToRemove specifies one in-tree kernel module that should be removed (if present) before loading the kernel module from the ContainerImage",
										MarkdownDescription: "Deprecated: please use InTreeModulesToRemove. InTreeModuleToRemove specifies one in-tree kernel module that should be removed (if present) before loading the kernel module from the ContainerImage",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"in_tree_modules_to_remove": schema.ListAttribute{
										...
										MarkdownDescription: "InTreeModulesToRemove specifies any number of in-tree kernel modules that should be removed (if present) before loading the kernel module from the ContainerImage",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"kernel_mappings": schema.ListNestedAttribute{
										Description:         "KernelMappings is a list of kernel mappings. When a node's labels match Selector, then the KMM Operator will look for the first mapping that matches its kernel version, and use the corresponding container image to run the DriverContainer.",
										MarkdownDescription: "KernelMappings is a list of kernel mappings. When a node's labels match Selector, then the KMM Operator will look for the first mapping that matches its kernel version, and use the corresponding container image to run the DriverContainer.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"build": schema.SingleNestedAttribute{
													Description:         "Build enables in-cluster builds for this mapping and allows overriding the Module's build settings.",
													MarkdownDescription: "Build enables in-cluster builds for this mapping and allows overriding the Module's build settings.",
													Attributes: map[string]schema.Attribute{
														"base_image_registry_tls": schema.SingleNestedAttribute{
															Description:         "BaseImageRegistryTLS contains settings determining how to access registries of the base images in the build-process' Dockerfile.",
															MarkdownDescription: "BaseImageRegistryTLS contains settings determining how to access registries of the base images in the build-process' Dockerfile.",
												...
												"container_image": schema.StringAttribute{
													Description:         "ContainerImage is the name of the DriverContainer image that should be used to deploy the module.",
													MarkdownDescription: "ContainerImage is the name of the DriverContainer image that should be used to deploy the module.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"literal": schema.StringAttribute{
													Description:         "Literal defines a literal target kernel version to be matched exactly against node kernels.",
													MarkdownDescription: "Literal defines a literal target kernel version to be matched exactly against node kernels.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
												...
												"regexp": schema.StringAttribute{
													Description:         "Regexp is a regular expression to be match against node kernels.",
													MarkdownDescription: "Regexp is a regular expression to be match against node kernels.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},

												"registry_tls": schema.SingleNestedAttribute{
													Description:         "RegistryTLS set the TLS configs for accessing the registry of the module-loader's image.",
													MarkdownDescription: "RegistryTLS set the TLS configs for accessing the registry of the module-loader's image.",
													Attributes: map[string]schema.Attribute{
														"insecure": schema.BoolAttribute{
															Description:         "If Insecure is true, the operator will be able to access a registry in an insecure (plain HTTP) protocol.",
															MarkdownDescription: "If Insecure is true, the operator will be able to access a registry in an insecure (plain HTTP) protocol.",
												...
												"sign": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "Sign enables in-cluster signing for this mapping",
													Attributes: map[string]schema.Attribute{
														"cert_secret": schema.SingleNestedAttribute{
															...
															MarkdownDescription: "a secret containing the public key used to sign kernel modules for secureboot",
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
																	MarkdownDescription: "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
														...
														"files_to_sign": schema.ListAttribute{
															Description:         "paths inside the image for the kernel modules to sign (if ommited all kmods are signed)",
															MarkdownDescription: "paths inside the image for the kernel modules to sign (if ommited all kmods are signed)",
															ElementType:         types.StringType,
															Required:            false,
															Optional:            true,
															Computed:            false,
														...
														"key_secret": schema.SingleNestedAttribute{
															...
															MarkdownDescription: "a secret containing the private key used to sign kernel modules for secureboot",
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	Description:         "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
																	MarkdownDescription: "Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
														...
														"unsigned_image": schema.StringAttribute{
															Description:         "Image to sign, ignored if a Build is present, required otherwise",
															MarkdownDescription: "Image to sign, ignored if a Build is present, required otherwise",
															Required:            false,
															Optional:            true,
															Computed:            false,
														},

														"unsigned_image_registry_tls": schema.SingleNestedAttribute{
															Description:         "UnsignedImageRegistryTLS contains settings determining how to access registries of the unsigned image.",
															MarkdownDescription: "UnsignedImageRegistryTLS contains settings determining how to access registries of the unsigned image.",
															Attributes: map[string]schema.Attribute{
																"insecure": schema.BoolAttribute{
																	Description:         "If Insecure is true, the operator will be able to access a registry in an insecure (plain HTTP) protocol.",
																	MarkdownDescription: "If Insecure is true, the operator will be able to access a registry in an insecure (plain HTTP) protocol.",
									...
									"modprobe": schema.SingleNestedAttribute{
										Description:         "Modprobe is a set of properties to customize which module modprobe loads and with which properties.",
										MarkdownDescription: "Modprobe is a set of properties to customize which module modprobe loads and with which properties.",
										Attributes: map[string]schema.Attribute{
											...
											"raw_args": schema.SingleNestedAttribute{
												Description:         "If RawArgs are specified, they are passed straight to the modprobe binary; all other properties in this object are ignored. The resulting commands will be: 'modprobe ${RawArgs}'.",
												MarkdownDescription: "If RawArgs are specified, they are passed straight to the modprobe binary; all other properties in this object are ignored. The resulting commands will be: 'modprobe ${RawArgs}'.",
												Attributes: map[string]schema.Attribute{
													"load": schema.ListAttribute{
														Description:         "Load is an optional list of arguments to be used when loading the kernel module.",
														MarkdownDescription: "Load is an optional list of arguments to be used when loading the kernel module.",
									...
									"sign": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Sign provides default kmod signing settings",
										Attributes: map[string]schema.Attribute{
											"cert_secret": schema.SingleNestedAttribute{
												Description:         "a secret containing the public key used to sign kernel modules for secureboot",
												MarkdownDescription: "a secret containing the public key used to sign kernel modules for secureboot",
									...
									"version": schema.StringAttribute{
										Description:         "Version defines the current version of the kernel module being used Used for upgrading the currently loaded kernel module to a new version",
										MarkdownDescription: "Version defines the current version of the kernel module being used Used for upgrading the currently loaded kernel module to a new version",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
					...
					"selector": schema.MapAttribute{
						Description:         "Selector describes on which nodes the Module should be loaded and optionally built.",
						MarkdownDescription: "Selector describes on which nodes the Module should be loaded and optionally built.",
						ElementType:         types.StringType,
						Required:            true,
						Optional:            false,
						Computed:            false,
...
func (r *KmmSigsXK8SIoModuleV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kmm_sigs_x_k8s_io_module_v1beta1_manifest")

	var model KmmSigsXK8SIoModuleV1Beta1ManifestData
