	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "NodeModulesConfigSpec describes the desired state of modules on the node More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
				MarkdownDescription: "NodeModulesConfigSpec describes the desired state of modules on the node More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
				Attributes: map[string]schema.Attribute{
					"modules": schema.ListNestedAttribute{
						Description:         "Modules list the spec of all the modules that need to be executed on the node",
						MarkdownDescription: "Modules list the spec of all the modules that need to be executed on the node",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"tolerations": schema.ListNestedAttribute{
									...
									MarkdownDescription: "tolerations define which tolerations should be added for every load/unload pod running on the node",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
