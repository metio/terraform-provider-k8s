...
var (
	_ datasource.DataSource              = &OrgEclipseCheCheClusterV1DataSource{}
	_ datasource.DataSourceWithConfigure = &OrgEclipseCheCheClusterV1DataSource{}
)

func NewOrgEclipseCheCheClusterV1DataSource() datasource.DataSource {
	return &OrgEclipseCheCheClusterV1DataSource{}
}

type OrgEclipseCheCheClusterV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OrgEclipseCheCheClusterV1DataSourceData struct {
...
func (r *OrgEclipseCheCheClusterV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_org_eclipse_che_che_cluster_v1"
}

func (r *OrgEclipseCheCheClusterV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OrgEclipseCheCheClusterV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OrgEclipseCheCheClusterV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_org_eclipse_che_che_cluster_v1")

	var data OrgEclipseCheCheClusterV1DataSourceData
	...
	var readResponse OrgEclipseCheCheClusterV1DataSourceData
	...
	data.ApiVersion = pointer.String("org.eclipse.che/v1")
	data.Kind = pointer.String("CheCluster")
