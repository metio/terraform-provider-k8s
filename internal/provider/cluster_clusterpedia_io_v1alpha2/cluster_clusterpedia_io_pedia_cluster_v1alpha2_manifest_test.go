...
func TestClusterClusterpediaIoPediaClusterV1Alpha2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_cluster_clusterpedia_io_pedia_cluster_v1alpha2_manifest", testCase)
		})
	}
}
