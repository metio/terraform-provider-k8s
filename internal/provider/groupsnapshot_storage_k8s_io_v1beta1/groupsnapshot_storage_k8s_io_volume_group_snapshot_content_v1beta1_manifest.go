...
var (
	_ datasource.DataSource = &GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest{}
)

func NewGroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest() datasource.DataSource {
	return &GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest{}
}

type GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest struct{}

type GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1ManifestData struct {
...
func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_groupsnapshot_storage_k8s_io_volume_group_snapshot_content_v1beta1_manifest"
}

func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_groupsnapshot_storage_k8s_io_volume_group_snapshot_content_v1beta1_manifest")

	var model GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta1ManifestData
