...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest{}
)

func NewInfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest{}
}

type InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest struct{}

type InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3ManifestData struct {
...
func (r *InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_ha_proxy_load_balancer_v1alpha3_manifest"
}

func (r *InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_ha_proxy_load_balancer_v1alpha3_manifest")

	var model InfrastructureClusterXK8SIoHaproxyLoadBalancerV1Alpha3ManifestData
