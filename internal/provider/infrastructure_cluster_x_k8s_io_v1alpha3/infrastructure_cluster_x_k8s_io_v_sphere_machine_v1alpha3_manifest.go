...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoVsphereMachineV1Alpha3Manifest{}
)

func NewInfrastructureClusterXK8SIoVsphereMachineV1Alpha3Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoVsphereMachineV1Alpha3Manifest{}
}
...
func (r *InfrastructureClusterXK8SIoVsphereMachineV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1alpha3_manifest"
}

func (r *InfrastructureClusterXK8SIoVsphereMachineV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoVsphereMachineV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1alpha3_manifest")

	var model InfrastructureClusterXK8SIoVsphereMachineV1Alpha3ManifestData
