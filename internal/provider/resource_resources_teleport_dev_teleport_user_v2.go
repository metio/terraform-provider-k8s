...
var (
	_ resource.Resource = (*ResourcesTeleportDevTeleportUserV2Resource)(nil)
)

type ResourcesTeleportDevTeleportUserV2TerraformModel struct {
...
type ResourcesTeleportDevTeleportUserV2GoModel struct {
	...
	Spec *struct {
		Github_identities *[]struct {
			Connector_id *string `tfsdk:"connector_id" yaml:"connector_id,omitempty"`

			Username *string `tfsdk:"username" yaml:"username,omitempty"`
		} `tfsdk:"github_identities" yaml:"github_identities,omitempty"`

		Oidc_identities *[]struct {
			Connector_id *string `tfsdk:"connector_id" yaml:"connector_id,omitempty"`

			Username *string `tfsdk:"username" yaml:"username,omitempty"`
		} `tfsdk:"oidc_identities" yaml:"oidc_identities,omitempty"`
		...
		Saml_identities *[]struct {
			...
			Username *string `tfsdk:"username" yaml:"username,omitempty"`
		} `tfsdk:"saml_identities" yaml:"saml_identities,omitempty"`

		Traits *map[string][]string `tfsdk:"traits" yaml:"traits,omitempty"`
...
func (r *ResourcesTeleportDevTeleportUserV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_resources_teleport_dev_teleport_user_v2"
}

func (r *ResourcesTeleportDevTeleportUserV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ResourcesTeleportDevTeleportUserV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_resources_teleport_dev_teleport_user_v2")

	var state ResourcesTeleportDevTeleportUserV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ResourcesTeleportDevTeleportUserV2GoModel
	...
	goModel.ApiVersion = utilities.Ptr("resources.teleport.dev/v2")
	goModel.Kind = utilities.Ptr("TeleportUser")
...
func (r *ResourcesTeleportDevTeleportUserV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_resources_teleport_dev_teleport_user_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *ResourcesTeleportDevTeleportUserV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ResourcesTeleportDevTeleportUserV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
