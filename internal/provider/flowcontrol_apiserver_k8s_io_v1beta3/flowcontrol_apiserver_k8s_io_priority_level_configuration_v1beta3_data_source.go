...
var (
	_ datasource.DataSource              = &FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource{}
	_ datasource.DataSourceWithConfigure = &FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource{}
)

func NewFlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource() datasource.DataSource {
	return &FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource{}
}

type FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource struct {
	kubernetesClient dynamic.Interface
}

type FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSourceData struct {
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta3"
}

func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta3")

	var data FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "flowcontrol.apiserver.k8s.io", Version: "v1beta3", Resource: "prioritylevelconfigurations"}).
	...
	var readResponse FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta3DataSourceData
	...
	data.Kind = pointer.String("PriorityLevelConfiguration")
