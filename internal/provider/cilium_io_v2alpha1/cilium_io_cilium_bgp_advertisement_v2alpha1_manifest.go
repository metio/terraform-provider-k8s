...
var (
	_ datasource.DataSource = &CiliumIoCiliumBgpadvertisementV2Alpha1Manifest{}
)

func NewCiliumIoCiliumBgpadvertisementV2Alpha1Manifest() datasource.DataSource {
	return &CiliumIoCiliumBgpadvertisementV2Alpha1Manifest{}
}

type CiliumIoCiliumBgpadvertisementV2Alpha1Manifest struct{}

type CiliumIoCiliumBgpadvertisementV2Alpha1ManifestData struct {
...
func (r *CiliumIoCiliumBgpadvertisementV2Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_bgp_advertisement_v2alpha1_manifest"
}

func (r *CiliumIoCiliumBgpadvertisementV2Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CiliumIoCiliumBgpadvertisementV2Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_bgp_advertisement_v2alpha1_manifest")

	var model CiliumIoCiliumBgpadvertisementV2Alpha1ManifestData
