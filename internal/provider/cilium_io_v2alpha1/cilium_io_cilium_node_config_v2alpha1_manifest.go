...
var (
	_ datasource.DataSource = &CiliumIoCiliumNodeConfigV2Alpha1Manifest{}
)

func NewCiliumIoCiliumNodeConfigV2Alpha1Manifest() datasource.DataSource {
	return &CiliumIoCiliumNodeConfigV2Alpha1Manifest{}
}
...
func (r *CiliumIoCiliumNodeConfigV2Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_node_config_v2alpha1_manifest"
}
...
func (r *CiliumIoCiliumNodeConfigV2Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_node_config_v2alpha1_manifest")

	var model CiliumIoCiliumNodeConfigV2Alpha1ManifestData
