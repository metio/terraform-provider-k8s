...
var (
	_ datasource.DataSource = &CiliumIoCiliumBgppeerConfigV2Alpha1Manifest{}
)

func NewCiliumIoCiliumBgppeerConfigV2Alpha1Manifest() datasource.DataSource {
	return &CiliumIoCiliumBgppeerConfigV2Alpha1Manifest{}
}

type CiliumIoCiliumBgppeerConfigV2Alpha1Manifest struct{}

type CiliumIoCiliumBgppeerConfigV2Alpha1ManifestData struct {
...
func (r *CiliumIoCiliumBgppeerConfigV2Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cilium_io_cilium_bgp_peer_config_v2alpha1_manifest"
}

func (r *CiliumIoCiliumBgppeerConfigV2Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
					...
					"transport": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"local_port": schema.Int64Attribute{
								Description:         "Deprecated LocalPort is the local port to be used for the BGP session. If not specified, ephemeral port will be picked to initiate a connection. This field is deprecated and will be removed in a future release. Local port configuration is unnecessary and is not recommended.",
								MarkdownDescription: "Deprecated LocalPort is the local port to be used for the BGP session. If not specified, ephemeral port will be picked to initiate a connection. This field is deprecated and will be removed in a future release. Local port configuration is unnecessary and is not recommended.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
...
func (r *CiliumIoCiliumBgppeerConfigV2Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_bgp_peer_config_v2alpha1_manifest")

	var model CiliumIoCiliumBgppeerConfigV2Alpha1ManifestData
