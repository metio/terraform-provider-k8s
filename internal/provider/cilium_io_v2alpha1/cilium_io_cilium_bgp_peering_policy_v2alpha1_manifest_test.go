...
func TestCiliumIoCiliumBGPPeeringPolicyV2Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_cilium_io_cilium_bgp_peering_policy_v2alpha1_manifest", testCase)
		})
	}
}
