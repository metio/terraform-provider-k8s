...
func TestExpansionGatekeeperShExpansionTemplateV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_expansion_gatekeeper_sh_expansion_template_v1alpha1_manifest", testCase)
		})
	}
}
