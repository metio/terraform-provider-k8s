...
var (
	_ resource.Resource = (*ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource)(nil)
)

type ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1TerraformModel struct {
...
type ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1GoModel struct {
	...
	Spec *struct {
		CacheParameterGroupFamily *string `tfsdk:"cache_parameter_group_family" yaml:"cacheParameterGroupFamily,omitempty"`
		...
		} `tfsdk:"parameter_name_values" yaml:"parameterNameValues,omitempty"`
...
func (r *ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_elasticache_services_k8s_aws_cache_parameter_group_v1alpha1"
}

func (r *ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_elasticache_services_k8s_aws_cache_parameter_group_v1alpha1")

	var state ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("CacheParameterGroup")
...
func (r *ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_elasticache_services_k8s_aws_cache_parameter_group_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ElasticacheServicesK8SAwsCacheParameterGroupV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
