	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "spec is the desired state of the ReplicationSource, including thereplication method to use and its configuration.",
				MarkdownDescription: "spec is the desired state of the ReplicationSource, including thereplication method to use and its configuration.",
				Attributes: map[string]schema.Attribute{
					...
					"rclone": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"copy_method": schema.StringAttribute{
								Description:         "copyMethod describes how a point-in-time (PiT) image of the source volumeshould be created.",
								MarkdownDescription: "copyMethod describes how a point-in-time (PiT) image of the source volumeshould be created.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
							...
							"storage_class_name": schema.StringAttribute{
								Description:         "storageClassName can be used to override the StorageClass of the PiTimage.",
								MarkdownDescription: "storageClassName can be used to override the StorageClass of the PiTimage.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"restic": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"unlock": schema.StringAttribute{
								Description:         "unlock is a string value that schedules an unlock on the restic repository duringthe next sync operation.Once a sync completes then status.restic.lastUnlocked is set to the same string value.To unlock a repository, set spec.restic.unlock to a known value and then wait forlastUnlocked to be updated by the operator to the same value,which means that the sync unlocked the repository by running a restic unlock command andthen ran a backup.Unlock will not be run again unless spec.restic.unlock is set to a different value.",
								MarkdownDescription: "unlock is a string value that schedules an unlock on the restic repository duringthe next sync operation.Once a sync completes then status.restic.lastUnlocked is set to the same string value.To unlock a repository, set spec.restic.unlock to a known value and then wait forlastUnlocked to be updated by the operator to the same value,which means that the sync unlocked the repository by running a restic unlock command andthen ran a backup.Unlock will not be run again unless spec.restic.unlock is set to a different value.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"introducer": schema.BoolAttribute{
											Description:         "A flag that determines whether this peer shouldintroduce us to other peers sharing this volume.It is HIGHLY recommended that two Syncthing peers do NOTset each other as introducers as you will have a difficult timedisconnecting the two.",
											MarkdownDescription: "A flag that determines whether this peer shouldintroduce us to other peers sharing this volume.It is HIGHLY recommended that two Syncthing peers do NOTset each other as introducers as you will have a difficult timedisconnecting the two.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
