...
var (
	_ datasource.DataSource = &KarpenterK8SAwsEc2NodeClassV1Manifest{}
)

func NewKarpenterK8SAwsEc2NodeClassV1Manifest() datasource.DataSource {
	return &KarpenterK8SAwsEc2NodeClassV1Manifest{}
}
...
func (r *KarpenterK8SAwsEc2NodeClassV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_karpenter_k8s_aws_ec2_node_class_v1_manifest"
}

func (r *KarpenterK8SAwsEc2NodeClassV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"role": schema.StringAttribute{
						Description:         "Role is the AWS identity that nodes use. This field is mutually exclusive from instanceProfile.",
						MarkdownDescription: "Role is the AWS identity that nodes use. This field is mutually exclusive from instanceProfile.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *KarpenterK8SAwsEc2NodeClassV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_karpenter_k8s_aws_ec2_node_class_v1_manifest")

	var model KarpenterK8SAwsEc2NodeClassV1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("karpenter.k8s.aws/v1")
