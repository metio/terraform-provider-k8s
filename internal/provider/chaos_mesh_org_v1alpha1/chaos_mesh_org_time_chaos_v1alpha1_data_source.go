...
var (
	_ datasource.DataSource              = &ChaosMeshOrgTimeChaosV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ChaosMeshOrgTimeChaosV1Alpha1DataSource{}
)

func NewChaosMeshOrgTimeChaosV1Alpha1DataSource() datasource.DataSource {
	return &ChaosMeshOrgTimeChaosV1Alpha1DataSource{}
}

type ChaosMeshOrgTimeChaosV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ChaosMeshOrgTimeChaosV1Alpha1DataSourceData struct {
...
func (r *ChaosMeshOrgTimeChaosV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chaos_mesh_org_time_chaos_v1alpha1"
}

func (r *ChaosMeshOrgTimeChaosV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ChaosMeshOrgTimeChaosV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ChaosMeshOrgTimeChaosV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_chaos_mesh_org_time_chaos_v1alpha1")

	var data ChaosMeshOrgTimeChaosV1Alpha1DataSourceData
	...
	var readResponse ChaosMeshOrgTimeChaosV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("TimeChaos")
