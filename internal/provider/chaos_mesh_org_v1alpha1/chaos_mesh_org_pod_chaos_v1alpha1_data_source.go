...
var (
	_ datasource.DataSource              = &ChaosMeshOrgPodChaosV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ChaosMeshOrgPodChaosV1Alpha1DataSource{}
)

func NewChaosMeshOrgPodChaosV1Alpha1DataSource() datasource.DataSource {
	return &ChaosMeshOrgPodChaosV1Alpha1DataSource{}
}

type ChaosMeshOrgPodChaosV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ChaosMeshOrgPodChaosV1Alpha1DataSourceData struct {
...
func (r *ChaosMeshOrgPodChaosV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chaos_mesh_org_pod_chaos_v1alpha1"
}

func (r *ChaosMeshOrgPodChaosV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ChaosMeshOrgPodChaosV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ChaosMeshOrgPodChaosV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_chaos_mesh_org_pod_chaos_v1alpha1")

	var data ChaosMeshOrgPodChaosV1Alpha1DataSourceData
	...
	var readResponse ChaosMeshOrgPodChaosV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("PodChaos")
