...
var (
	_ datasource.DataSource              = &ChaosMeshOrgWorkflowV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ChaosMeshOrgWorkflowV1Alpha1DataSource{}
)

func NewChaosMeshOrgWorkflowV1Alpha1DataSource() datasource.DataSource {
	return &ChaosMeshOrgWorkflowV1Alpha1DataSource{}
}

type ChaosMeshOrgWorkflowV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ChaosMeshOrgWorkflowV1Alpha1DataSourceData struct {
...
func (r *ChaosMeshOrgWorkflowV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chaos_mesh_org_workflow_v1alpha1"
}

func (r *ChaosMeshOrgWorkflowV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ChaosMeshOrgWorkflowV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ChaosMeshOrgWorkflowV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_chaos_mesh_org_workflow_v1alpha1")

	var data ChaosMeshOrgWorkflowV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "chaos-mesh.org", Version: "v1alpha1", Resource: "workflows"}).
	...
	var readResponse ChaosMeshOrgWorkflowV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Workflow")
