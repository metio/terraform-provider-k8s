...
func TestChaosMeshOrgJVMChaosV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_chaos_mesh_org_jvm_chaos_v1alpha1_manifest", testCase)
		})
	}
}
