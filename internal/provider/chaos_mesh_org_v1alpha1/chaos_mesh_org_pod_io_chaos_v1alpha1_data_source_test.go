...
func TestChaosMeshOrgPodIochaosV1Alpha1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_chaos_mesh_org_pod_io_chaos_v1alpha1", testCase)
		})
	}
}
...
func TestChaosMeshOrgPodIochaosV1Alpha1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_chaos_mesh_org_pod_io_chaos_v1alpha1", configuration)
}
