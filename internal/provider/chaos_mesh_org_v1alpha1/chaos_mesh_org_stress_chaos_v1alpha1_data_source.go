...
var (
	_ datasource.DataSource              = &ChaosMeshOrgStressChaosV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ChaosMeshOrgStressChaosV1Alpha1DataSource{}
)

func NewChaosMeshOrgStressChaosV1Alpha1DataSource() datasource.DataSource {
	return &ChaosMeshOrgStressChaosV1Alpha1DataSource{}
}

type ChaosMeshOrgStressChaosV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ChaosMeshOrgStressChaosV1Alpha1DataSourceData struct {
...
func (r *ChaosMeshOrgStressChaosV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chaos_mesh_org_stress_chaos_v1alpha1"
}

func (r *ChaosMeshOrgStressChaosV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ChaosMeshOrgStressChaosV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ChaosMeshOrgStressChaosV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_chaos_mesh_org_stress_chaos_v1alpha1")

	var data ChaosMeshOrgStressChaosV1Alpha1DataSourceData
	...
	var readResponse ChaosMeshOrgStressChaosV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("StressChaos")
