...
var (
	_ datasource.DataSource              = &ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource{}
)

func NewChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource() datasource.DataSource {
	return &ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource{}
}

type ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSourceData struct {
...
func (r *ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chaos_mesh_org_physical_machine_chaos_v1alpha1"
}

func (r *ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_chaos_mesh_org_physical_machine_chaos_v1alpha1")

	var data ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSourceData
	...
	var readResponse ChaosMeshOrgPhysicalMachineChaosV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("PhysicalMachineChaos")
