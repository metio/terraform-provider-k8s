...
var (
	_ datasource.DataSource              = &ChaosMeshOrgBlockChaosV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ChaosMeshOrgBlockChaosV1Alpha1DataSource{}
)

func NewChaosMeshOrgBlockChaosV1Alpha1DataSource() datasource.DataSource {
	return &ChaosMeshOrgBlockChaosV1Alpha1DataSource{}
}

type ChaosMeshOrgBlockChaosV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ChaosMeshOrgBlockChaosV1Alpha1DataSourceData struct {
...
func (r *ChaosMeshOrgBlockChaosV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chaos_mesh_org_block_chaos_v1alpha1"
}

func (r *ChaosMeshOrgBlockChaosV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "BlockChaos is the Schema for the blockchaos API",
		MarkdownDescription: "BlockChaos is the Schema for the blockchaos API",
...
func (r *ChaosMeshOrgBlockChaosV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ChaosMeshOrgBlockChaosV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_chaos_mesh_org_block_chaos_v1alpha1")

	var data ChaosMeshOrgBlockChaosV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "chaos-mesh.org", Version: "v1alpha1", Resource: "BlockChaos"}).
	...
	var readResponse ChaosMeshOrgBlockChaosV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("BlockChaos")
