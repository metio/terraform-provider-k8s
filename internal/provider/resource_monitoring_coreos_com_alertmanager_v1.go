...
type MonitoringCoreosComAlertmanagerV1Resource struct{}

var (
	_ resource.Resource = (*MonitoringCoreosComAlertmanagerV1Resource)(nil)
)

type MonitoringCoreosComAlertmanagerV1TerraformModel struct {
...
type MonitoringCoreosComAlertmanagerV1GoModel struct {
	...
	Spec *struct {
		AdditionalPeers *[]string `tfsdk:"additional_peers" yaml:"additionalPeers,omitempty"`
		...
		AlertmanagerConfigNamespaceSelector *struct {
			...
			MatchLabels *map[string]string `tfsdk:"match_labels" yaml:"matchLabels,omitempty"`
		} `tfsdk:"alertmanager_config_namespace_selector" yaml:"alertmanagerConfigNamespaceSelector,omitempty"`
		...
		AlertmanagerConfigSelector *struct {
			...
			MatchLabels *map[string]string `tfsdk:"match_labels" yaml:"matchLabels,omitempty"`
		} `tfsdk:"alertmanager_config_selector" yaml:"alertmanagerConfigSelector,omitempty"`
		...
		AlertmanagerConfiguration *struct {
			Global *struct {
				...
				ResolveTimeout *string `tfsdk:"resolve_timeout" yaml:"resolveTimeout,omitempty"`
		...
		ClusterAdvertiseAddress *string `tfsdk:"cluster_advertise_address" yaml:"clusterAdvertiseAddress,omitempty"`

		ClusterGossipInterval *string `tfsdk:"cluster_gossip_interval" yaml:"clusterGossipInterval,omitempty"`

		ClusterPeerTimeout *string `tfsdk:"cluster_peer_timeout" yaml:"clusterPeerTimeout,omitempty"`

		ClusterPushpullInterval *string `tfsdk:"cluster_pushpull_interval" yaml:"clusterPushpullInterval,omitempty"`

		ConfigMaps *[]string `tfsdk:"config_maps" yaml:"configMaps,omitempty"`

		ConfigSecret *string `tfsdk:"config_secret" yaml:"configSecret,omitempty"`
		...
		ForceEnableClusterMode *bool `tfsdk:"force_enable_cluster_mode" yaml:"forceEnableClusterMode,omitempty"`
...
func NewMonitoringCoreosComAlertmanagerV1Resource() resource.Resource {
	return &MonitoringCoreosComAlertmanagerV1Resource{}
}

func (r *MonitoringCoreosComAlertmanagerV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_monitoring_coreos_com_alertmanager_v1"
}

func (r *MonitoringCoreosComAlertmanagerV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *MonitoringCoreosComAlertmanagerV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_monitoring_coreos_com_alertmanager_v1")

	var state MonitoringCoreosComAlertmanagerV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel MonitoringCoreosComAlertmanagerV1GoModel
	...
	goModel.Kind = utilities.Ptr("Alertmanager")
...
func (r *MonitoringCoreosComAlertmanagerV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_monitoring_coreos_com_alertmanager_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *MonitoringCoreosComAlertmanagerV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_monitoring_coreos_com_alertmanager_v1")
...
func (r *MonitoringCoreosComAlertmanagerV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_monitoring_coreos_com_alertmanager_v1")
