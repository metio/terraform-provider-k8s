...
var (
	_ resource.Resource = (*FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource)(nil)
)

type FlowcontrolApiserverK8SIoFlowSchemaV1Beta2TerraformModel struct {
...
type FlowcontrolApiserverK8SIoFlowSchemaV1Beta2GoModel struct {
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2"
}

func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2")

	var state FlowcontrolApiserverK8SIoFlowSchemaV1Beta2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel FlowcontrolApiserverK8SIoFlowSchemaV1Beta2GoModel
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_flowcontrol_apiserver_k8s_io_flow_schema_v1beta2")
	// NO-OP: All data is already in Terraform state
}

func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *FlowcontrolApiserverK8SIoFlowSchemaV1Beta2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
