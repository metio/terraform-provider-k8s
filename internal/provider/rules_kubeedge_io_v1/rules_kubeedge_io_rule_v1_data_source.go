...
var (
	_ datasource.DataSource              = &RulesKubeedgeIoRuleV1DataSource{}
	_ datasource.DataSourceWithConfigure = &RulesKubeedgeIoRuleV1DataSource{}
)

func NewRulesKubeedgeIoRuleV1DataSource() datasource.DataSource {
	return &RulesKubeedgeIoRuleV1DataSource{}
}

type RulesKubeedgeIoRuleV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type RulesKubeedgeIoRuleV1DataSourceData struct {
...
func (r *RulesKubeedgeIoRuleV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_rules_kubeedge_io_rule_v1"
}

func (r *RulesKubeedgeIoRuleV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RulesKubeedgeIoRuleV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *RulesKubeedgeIoRuleV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_rules_kubeedge_io_rule_v1")

	var data RulesKubeedgeIoRuleV1DataSourceData
	...
	var readResponse RulesKubeedgeIoRuleV1DataSourceData
