...
var (
	_ datasource.DataSource = &VeleroIoServerStatusRequestV1Manifest{}
)

func NewVeleroIoServerStatusRequestV1Manifest() datasource.DataSource {
	return &VeleroIoServerStatusRequestV1Manifest{}
}
...
func (r *VeleroIoServerStatusRequestV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_velero_io_server_status_request_v1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.MapAttribute{
				...
				MarkdownDescription: "ServerStatusRequestSpec is the specification for a ServerStatusRequest.",
				ElementType:         types.StringType,
				Required:            false,
				Optional:            true,
				Computed:            false,
...
func (r *VeleroIoServerStatusRequestV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_velero_io_server_status_request_v1_manifest")

	var model VeleroIoServerStatusRequestV1ManifestData
	...
	model.Kind = pointer.String("ServerStatusRequest")
