...
var (
	_ datasource.DataSource = &VeleroIoPodVolumeRestoreV1Manifest{}
)

func NewVeleroIoPodVolumeRestoreV1Manifest() datasource.DataSource {
	return &VeleroIoPodVolumeRestoreV1Manifest{}
}
...
func (r *VeleroIoPodVolumeRestoreV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_velero_io_pod_volume_restore_v1_manifest"
}

func (r *VeleroIoPodVolumeRestoreV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PodVolumeRestoreSpec is the specification for a PodVolumeRestore.",
				Attributes: map[string]schema.Attribute{
					...
					"cancel": schema.BoolAttribute{
						Description:         "Cancel indicates request to cancel the ongoing PodVolumeRestore. It can be set when the PodVolumeRestore is in InProgress phase",
						MarkdownDescription: "Cancel indicates request to cancel the ongoing PodVolumeRestore. It can be set when the PodVolumeRestore is in InProgress phase",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"pod": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Pod is a reference to the pod containing the volume to be restored.",
						Attributes: map[string]schema.Attribute{
					...
					"snapshot_id": schema.StringAttribute{
						...
						MarkdownDescription: "SnapshotID is the ID of the volume snapshot to be restored.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"source_namespace": schema.StringAttribute{
						...
						MarkdownDescription: "SourceNamespace is the original namespace for namaspace mapping.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"volume": schema.StringAttribute{
						...
						MarkdownDescription: "Volume is the name of the volume within the Pod to be restored.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *VeleroIoPodVolumeRestoreV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_velero_io_pod_volume_restore_v1_manifest")

	var model VeleroIoPodVolumeRestoreV1ManifestData
	...
	model.Kind = pointer.String("PodVolumeRestore")
