			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"tags": schema.MapAttribute{
						Description:         "Tags are a map of key-value pairs that should be applied to thevolume backup as tags.",
						MarkdownDescription: "Tags are a map of key-value pairs that should be applied to thevolume backup as tags.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"uploader_settings": schema.MapAttribute{
						Description:         "UploaderSettings are a map of key-value pairs that should be applied to theuploader configuration.",
						MarkdownDescription: "UploaderSettings are a map of key-value pairs that should be applied to theuploader configuration.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"volume": schema.StringAttribute{
						Description:         "Volume is the name of the volume within the Pod to be backedup.",
						MarkdownDescription: "Volume is the name of the volume within the Pod to be backedup.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
