...
var (
	_ datasource.DataSource = &VeleroIoBackupV1Manifest{}
)

func NewVeleroIoBackupV1Manifest() datasource.DataSource {
	return &VeleroIoBackupV1Manifest{}
}
...
func (r *VeleroIoBackupV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_velero_io_backup_v1_manifest"
}

func (r *VeleroIoBackupV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Backup is a Velero resource that represents the capture of Kubernetescluster state at a point in time (API objects and associated volume state).",
		MarkdownDescription: "Backup is a Velero resource that represents the capture of Kubernetescluster state at a point in time (API objects and associated volume state).",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BackupSpec defines the specification for a Velero backup.",
				Attributes: map[string]schema.Attribute{
...
func (r *VeleroIoBackupV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_velero_io_backup_v1_manifest")

	var model VeleroIoBackupV1ManifestData
