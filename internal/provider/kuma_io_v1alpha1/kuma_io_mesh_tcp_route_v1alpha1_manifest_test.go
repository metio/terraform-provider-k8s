...
func TestKumaIoMeshTCPRouteV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_kuma_io_mesh_tcp_route_v1alpha1_manifest", testCase)
		})
	}
}
