...
var (
	_ datasource.DataSource = &KumaIoZoneEgressInsightV1Alpha1Manifest{}
)

func NewKumaIoZoneEgressInsightV1Alpha1Manifest() datasource.DataSource {
	return &KumaIoZoneEgressInsightV1Alpha1Manifest{}
}
...
func (r *KumaIoZoneEgressInsightV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuma_io_zone_egress_insight_v1alpha1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.MapAttribute{
				...
				MarkdownDescription: "Spec is the specification of the Kuma ZoneEgressInsight resource.",
				ElementType:         types.StringType,
				Required:            false,
				Optional:            true,
				Computed:            false,
...
func (r *KumaIoZoneEgressInsightV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuma_io_zone_egress_insight_v1alpha1_manifest")

	var model KumaIoZoneEgressInsightV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ZoneEgressInsight")
