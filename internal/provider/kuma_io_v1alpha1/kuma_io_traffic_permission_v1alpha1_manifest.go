...
var (
	_ datasource.DataSource = &KumaIoTrafficPermissionV1Alpha1Manifest{}
)

func NewKumaIoTrafficPermissionV1Alpha1Manifest() datasource.DataSource {
	return &KumaIoTrafficPermissionV1Alpha1Manifest{}
}
...
func (r *KumaIoTrafficPermissionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuma_io_traffic_permission_v1alpha1_manifest"
}
...
func (r *KumaIoTrafficPermissionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuma_io_traffic_permission_v1alpha1_manifest")

	var model KumaIoTrafficPermissionV1Alpha1ManifestData
	...
	model.Kind = pointer.String("TrafficPermission")
