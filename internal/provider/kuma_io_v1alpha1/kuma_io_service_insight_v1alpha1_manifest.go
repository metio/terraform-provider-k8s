...
var (
	_ datasource.DataSource = &KumaIoServiceInsightV1Alpha1Manifest{}
)

func NewKumaIoServiceInsightV1Alpha1Manifest() datasource.DataSource {
	return &KumaIoServiceInsightV1Alpha1Manifest{}
}
...
func (r *KumaIoServiceInsightV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuma_io_service_insight_v1alpha1_manifest"
}
...
func (r *KumaIoServiceInsightV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuma_io_service_insight_v1alpha1_manifest")

	var model KumaIoServiceInsightV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ServiceInsight")
