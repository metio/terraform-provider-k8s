...
var (
	_ datasource.DataSource = &KumaIoMeshGatewayV1Alpha1Manifest{}
)

func NewKumaIoMeshGatewayV1Alpha1Manifest() datasource.DataSource {
	return &KumaIoMeshGatewayV1Alpha1Manifest{}
}
...
func (r *KumaIoMeshGatewayV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuma_io_mesh_gateway_v1alpha1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.MapAttribute{
				...
				MarkdownDescription: "Spec is the specification of the Kuma MeshGateway resource.",
				ElementType:         types.StringType,
				Required:            false,
				Optional:            true,
				Computed:            false,
...
func (r *KumaIoMeshGatewayV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kuma_io_mesh_gateway_v1alpha1_manifest")

	var model KumaIoMeshGatewayV1Alpha1ManifestData
	...
	model.Kind = pointer.String("MeshGateway")
