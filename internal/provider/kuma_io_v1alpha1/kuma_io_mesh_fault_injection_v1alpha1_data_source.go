...
var (
	_ datasource.DataSource              = &KumaIoMeshFaultInjectionV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KumaIoMeshFaultInjectionV1Alpha1DataSource{}
)

func NewKumaIoMeshFaultInjectionV1Alpha1DataSource() datasource.DataSource {
	return &KumaIoMeshFaultInjectionV1Alpha1DataSource{}
}

type KumaIoMeshFaultInjectionV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KumaIoMeshFaultInjectionV1Alpha1DataSourceData struct {
...
func (r *KumaIoMeshFaultInjectionV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuma_io_mesh_fault_injection_v1alpha1"
}

func (r *KumaIoMeshFaultInjectionV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KumaIoMeshFaultInjectionV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KumaIoMeshFaultInjectionV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kuma_io_mesh_fault_injection_v1alpha1")

	var data KumaIoMeshFaultInjectionV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "kuma.io", Version: "v1alpha1", Resource: "MeshFaultInjection"}).
	...
	var readResponse KumaIoMeshFaultInjectionV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("MeshFaultInjection")
