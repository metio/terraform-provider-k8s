			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"tags": schema.MapAttribute{
						Description:         "Tags specifies the Kuma tags that are propagated to the managed dataplane proxies. These tags should not include 'kuma.io/service' tag since is auto-generated, and should match exactly one Gateway resource.",
						MarkdownDescription: "Tags specifies the Kuma tags that are propagated to the managed dataplane proxies. These tags should not include 'kuma.io/service' tag since is auto-generated, and should match exactly one Gateway resource.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
