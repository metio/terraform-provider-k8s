...
func TestKumaIoMeshGatewayInstanceV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_kuma_io_mesh_gateway_instance_v1alpha1", testCase)
		})
	}
}
