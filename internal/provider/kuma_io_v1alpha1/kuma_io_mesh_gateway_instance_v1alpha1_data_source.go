...
var (
	_ datasource.DataSource              = &KumaIoMeshGatewayInstanceV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KumaIoMeshGatewayInstanceV1Alpha1DataSource{}
)

func NewKumaIoMeshGatewayInstanceV1Alpha1DataSource() datasource.DataSource {
	return &KumaIoMeshGatewayInstanceV1Alpha1DataSource{}
}

type KumaIoMeshGatewayInstanceV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KumaIoMeshGatewayInstanceV1Alpha1DataSourceData struct {
...
func (r *KumaIoMeshGatewayInstanceV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kuma_io_mesh_gateway_instance_v1alpha1"
}

func (r *KumaIoMeshGatewayInstanceV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KumaIoMeshGatewayInstanceV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KumaIoMeshGatewayInstanceV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kuma_io_mesh_gateway_instance_v1alpha1")

	var data KumaIoMeshGatewayInstanceV1Alpha1DataSourceData
	...
	var readResponse KumaIoMeshGatewayInstanceV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("MeshGatewayInstance")
