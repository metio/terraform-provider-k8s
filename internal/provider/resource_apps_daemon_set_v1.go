...
var (
	_ resource.Resource = (*AppsDaemonSetV1Resource)(nil)
)

type AppsDaemonSetV1TerraformModel struct {
...
type AppsDaemonSetV1GoModel struct {
...
func (r *AppsDaemonSetV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_apps_daemon_set_v1"
}

func (r *AppsDaemonSetV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AppsDaemonSetV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_apps_daemon_set_v1")

	var state AppsDaemonSetV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AppsDaemonSetV1GoModel
	...
	goModel.Kind = utilities.Ptr("DaemonSet")
...
func (r *AppsDaemonSetV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_daemon_set_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *AppsDaemonSetV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AppsDaemonSetV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
