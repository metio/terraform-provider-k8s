...
var (
	_ datasource.DataSource = &SpvNoAzureKeyVaultSecretV2Beta1Manifest{}
)

func NewSpvNoAzureKeyVaultSecretV2Beta1Manifest() datasource.DataSource {
	return &SpvNoAzureKeyVaultSecretV2Beta1Manifest{}
}

type SpvNoAzureKeyVaultSecretV2Beta1Manifest struct{}

type SpvNoAzureKeyVaultSecretV2Beta1ManifestData struct {
...
func (r *SpvNoAzureKeyVaultSecretV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_spv_no_azure_key_vault_secret_v2beta1_manifest"
}

func (r *SpvNoAzureKeyVaultSecretV2Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SpvNoAzureKeyVaultSecretV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_spv_no_azure_key_vault_secret_v2beta1_manifest")

	var model SpvNoAzureKeyVaultSecretV2Beta1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("spv.no/v2beta1")
