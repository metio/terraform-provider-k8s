...
var (
	_ datasource.DataSource = &SonataflowOrgSonataFlowV1Alpha08Manifest{}
)

func NewSonataflowOrgSonataFlowV1Alpha08Manifest() datasource.DataSource {
	return &SonataflowOrgSonataFlowV1Alpha08Manifest{}
}
...
type SonataflowOrgSonataFlowV1Alpha08ManifestData struct {
	...
	Spec *struct {
		Flow *struct {
			...
			Auth            *map[string]string `tfsdk:"auth" json:"auth,omitempty"`
			AutoRetries     *bool              `tfsdk:"auto_retries" json:"autoRetries,omitempty"`
			Constants       *map[string]string `tfsdk:"constants" json:"constants,omitempty"`
			DataInputSchema *struct {
				FailOnValidationErrors *bool   `tfsdk:"fail_on_validation_errors" json:"failOnValidationErrors,omitempty"`
				Schema                 *string `tfsdk:"schema" json:"schema,omitempty"`
			} `tfsdk:"data_input_schema" json:"dataInputSchema,omitempty"`
			Errors *[]struct {
			...
			Events *[]struct {
				Correlation *[]struct {
					ContextAttributeName  *string `tfsdk:"context_attribute_name" json:"contextAttributeName,omitempty"`
					ContextAttributeValue *string `tfsdk:"context_attribute_value" json:"contextAttributeValue,omitempty"`
				} `tfsdk:"correlation" json:"correlation,omitempty"`
				DataOnly *bool   `tfsdk:"data_only" json:"dataOnly,omitempty"`
			...
			Functions *[]struct {
				AuthRef  *string `tfsdk:"auth_ref" json:"authRef,omitempty"`
				Metadata *struct {
				} `tfsdk:"metadata" json:"metadata,omitempty"`
				Name      *string `tfsdk:"name" json:"name,omitempty"`
			...
			KeepActive *bool              `tfsdk:"keep_active" json:"keepActive,omitempty"`
			Metadata   *map[string]string `tfsdk:"metadata" json:"metadata,omitempty"`
			Retries    *[]struct {
				Delay     *string `tfsdk:"delay" json:"delay,omitempty"`
				Increment *string `tfsdk:"increment" json:"increment,omitempty"`
				Jitter    *struct {
					FloatVal *float64 `tfsdk:"float_val" json:"floatVal,omitempty"`
					StrVal   *string  `tfsdk:"str_val" json:"strVal,omitempty"`
					Type     *int64   `tfsdk:"type" json:"type,omitempty"`
				} `tfsdk:"jitter" json:"jitter,omitempty"`
				MaxAttempts *string `tfsdk:"max_attempts" json:"maxAttempts,omitempty"`
				MaxDelay    *string `tfsdk:"max_delay" json:"maxDelay,omitempty"`
				Multiplier  *struct {
					FloatVal *float64 `tfsdk:"float_val" json:"floatVal,omitempty"`
					StrVal   *string  `tfsdk:"str_val" json:"strVal,omitempty"`
					Type     *int64   `tfsdk:"type" json:"type,omitempty"`
				} `tfsdk:"multiplier" json:"multiplier,omitempty"`
				Name *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"retries" json:"retries,omitempty"`
			Secrets  *[]string          `tfsdk:"secrets" json:"secrets,omitempty"`
			Start    *map[string]string `tfsdk:"start" json:"start,omitempty"`
			States   *map[string]string `tfsdk:"states" json:"states,omitempty"`
			Timeouts *struct {
				ActionExecTimeout *string `tfsdk:"action_exec_timeout" json:"actionExecTimeout,omitempty"`
				BranchExecTimeout *string `tfsdk:"branch_exec_timeout" json:"branchExecTimeout,omitempty"`
				EventTimeout      *string `tfsdk:"event_timeout" json:"eventTimeout,omitempty"`
				StateExecTimeout  *struct {
					Single *string `tfsdk:"single" json:"single,omitempty"`
					Total  *string `tfsdk:"total" json:"total,omitempty"`
				} `tfsdk:"state_exec_timeout" json:"stateExecTimeout,omitempty"`
				WorkflowExecTimeout *struct {
					Duration  *string `tfsdk:"duration" json:"duration,omitempty"`
					Interrupt *bool   `tfsdk:"interrupt" json:"interrupt,omitempty"`
					RunBefore *string `tfsdk:"run_before" json:"runBefore,omitempty"`
				} `tfsdk:"workflow_exec_timeout" json:"workflowExecTimeout,omitempty"`
		...
		Persistence *struct {
			Postgresql *struct {
				...
				SecretRef *struct {
					...
					UserKey     *string `tfsdk:"user_key" json:"userKey,omitempty"`
				} `tfsdk:"secret_ref" json:"secretRef,omitempty"`
				ServiceRef *struct {
					DatabaseName   *string `tfsdk:"database_name" json:"databaseName,omitempty"`
					DatabaseSchema *string `tfsdk:"database_schema" json:"databaseSchema,omitempty"`
					Name           *string `tfsdk:"name" json:"name,omitempty"`
		...
		Resources *struct {
			ConfigMaps *[]struct {
				...
				WorkflowPath *string `tfsdk:"workflow_path" json:"workflowPath,omitempty"`
...
func (r *SonataflowOrgSonataFlowV1Alpha08Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_sonataflow_org_sonata_flow_v1alpha08_manifest"
}

func (r *SonataflowOrgSonataFlowV1Alpha08Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "SonataFlowSpec defines the desired state of SonataFlow",
				Attributes: map[string]schema.Attribute{
					"flow": schema.SingleNestedAttribute{
						Description:         "Flow the workflow definition.",
						MarkdownDescription: "Flow the workflow definition.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.ListAttribute{
								Description:         "Annotations List of helpful terms describing the workflows intended purpose, subject areas, or other important qualities.",
								MarkdownDescription: "Annotations List of helpful terms describing the workflows intended purpose, subject areas, or other important qualities.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"auto_retries": schema.BoolAttribute{
								Description:         "AutoRetries If set to true, actions should automatically be retried on unchecked errors. Default is false",
								MarkdownDescription: "AutoRetries If set to true, actions should automatically be retried on unchecked errors. Default is false",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"constants": schema.MapAttribute{
								Description:         "Constants Workflow constants are used to define static, and immutable, data which is available to Workflow Expressions.",
								MarkdownDescription: "Constants Workflow constants are used to define static, and immutable, data which is available to Workflow Expressions.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"data_input_schema": schema.SingleNestedAttribute{
								Description:         "DataInputSchema URI of the JSON Schema used to validate the workflow data input",
								MarkdownDescription: "DataInputSchema URI of the JSON Schema used to validate the workflow data input",
								Attributes: map[string]schema.Attribute{
									"fail_on_validation_errors": schema.BoolAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            true,
										Optional:            false,
							...
							"errors": schema.ListNestedAttribute{
								Description:         "Defines checked errors that can be explicitly handled during workflow execution.",
								MarkdownDescription: "Defines checked errors that can be explicitly handled during workflow execution.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"code": schema.StringAttribute{
											Description:         "Code OnError code. Can be used in addition to the name to help runtimes resolve to technical errors/exceptions. Should not be defined if error is set to '*'.",
											MarkdownDescription: "Code OnError code. Can be used in addition to the name to help runtimes resolve to technical errors/exceptions. Should not be defined if error is set to '*'.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"description": schema.StringAttribute{
											...
											MarkdownDescription: "OnError description.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Name Domain-specific error name.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
							...
							"events": schema.ListNestedAttribute{
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"correlation": schema.ListNestedAttribute{
											Description:         "Define event correlation rules for this event. Only used for consumed events.",
											MarkdownDescription: "Define event correlation rules for this event. Only used for consumed events.",
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"context_attribute_name": schema.StringAttribute{
														Description:         "CloudEvent Extension Context Attribute name",
														MarkdownDescription: "CloudEvent Extension Context Attribute name",
														Required:            true,
														Optional:            false,
														Computed:            false,
													},

													"context_attribute_value": schema.StringAttribute{
														Description:         "CloudEvent Extension Context Attribute value",
														MarkdownDescription: "CloudEvent Extension Context Attribute value",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
										...
										"data_only": schema.BoolAttribute{
											Description:         "If 'true', only the Event payload is accessible to consuming Workflow states. If 'false', both event payload and context attributes should be accessible. Defaults to true.",
											MarkdownDescription: "If 'true', only the Event payload is accessible to consuming Workflow states. If 'false', both event payload and context attributes should be accessible. Defaults to true.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"kind": schema.StringAttribute{
											Description:         "Defines the CloudEvent as either 'consumed' or 'produced' by the workflow. Defaults to 'consumed'.",
											MarkdownDescription: "Defines the CloudEvent as either 'consumed' or 'produced' by the workflow. Defaults to 'consumed'.",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.String{
												stringvalidator.OneOf("consumed", "produced"),
											},
										},

										"metadata": schema.SingleNestedAttribute{
											Description:         "Metadata information",
											MarkdownDescription: "Metadata information",
											Attributes:          map[string]schema.Attribute{},
											Required:            false,
											Optional:            true,
											Computed:            false,
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Unique event name.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"source": schema.StringAttribute{
											...
											MarkdownDescription: "CloudEvent source.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"type": schema.StringAttribute{
											...
											MarkdownDescription: "CloudEvent type.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"auth_ref": schema.StringAttribute{
											...
											MarkdownDescription: "References an auth definition name to be used to access to resource defined in the operation parameter.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Unique function name",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"operation": schema.StringAttribute{
											Description:         "If type is 'rest', <path_to_openapi_definition>#<operation_id>. If type is 'rpc', <path_to_grpc_proto_file>#<service_name>#<service_method>. If type is 'expression', defines the workflow expression. If the type is 'custom', <path_to_custom_script>#<custom_service_method>.",
											MarkdownDescription: "If type is 'rest', <path_to_openapi_definition>#<operation_id>. If type is 'rpc', <path_to_grpc_proto_file>#<service_name>#<service_method>. If type is 'expression', defines the workflow expression. If the type is 'custom', <path_to_custom_script>#<custom_service_method>.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"type": schema.StringAttribute{
											Description:         "Defines the function type. Is either 'custom', 'rest', 'rpc', 'expression', 'graphql', 'odata' or 'asyncapi'. Default is 'rest'.",
											MarkdownDescription: "Defines the function type. Is either 'custom', 'rest', 'rpc', 'expression', 'graphql', 'odata' or 'asyncapi'. Default is 'rest'.",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.String{
												stringvalidator.OneOf("rest", "rpc", "expression", "graphql", "odata", "asyncapi", "custom"),
											},
										},
									},
								},
							...
							"keep_active": schema.BoolAttribute{
								...
								MarkdownDescription: "If 'true', workflow instances is not terminated when there are no active execution paths. Instance can be terminated with 'terminate end definition' or reaching defined 'workflowExecTimeout'",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"metadata": schema.MapAttribute{
								...
								MarkdownDescription: "Metadata custom information shared with the runtime.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"retries": schema.ListNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"delay": schema.StringAttribute{
											...
											MarkdownDescription: "Time delay between retry attempts (ISO 8601 duration format)",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"increment": schema.StringAttribute{
											Description:         "Static value by which the delay increases during each attempt (ISO 8601 time format)",
											MarkdownDescription: "Static value by which the delay increases during each attempt (ISO 8601 time format)",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"jitter": schema.SingleNestedAttribute{
											Description:         "If float type, maximum amount of random time added or subtracted from the delay between each retry relative to total delay (between 0 and 1). If string type, absolute maximum amount of random time added or subtracted from the delay between each retry (ISO 8601 duration format) TODO: make iso8601duration compatible this type",
											MarkdownDescription: "If float type, maximum amount of random time added or subtracted from the delay between each retry relative to total delay (between 0 and 1). If string type, absolute maximum amount of random time added or subtracted from the delay between each retry (ISO 8601 duration format) TODO: make iso8601duration compatible this type",
											Attributes: map[string]schema.Attribute{
												"float_val": schema.Float64Attribute{
													Description:         "",
													MarkdownDescription: "",
													Required:            false,
													Optional:            true,
												...
												"type": schema.Int64Attribute{
													...
													MarkdownDescription: "Type represents the stored type of Float32OrString.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
										...
										"max_delay": schema.StringAttribute{
											...
											MarkdownDescription: "Maximum time delay between retry attempts (ISO 8601 duration format)",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"multiplier": schema.SingleNestedAttribute{
											Description:         "Numeric value, if specified the delay between retries is multiplied by this value.",
											MarkdownDescription: "Numeric value, if specified the delay between retries is multiplied by this value.",
											Attributes: map[string]schema.Attribute{
												"float_val": schema.Float64Attribute{
													Description:         "",
													MarkdownDescription: "",
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Unique retry strategy name",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
							...
							"secrets": schema.ListAttribute{
								Description:         "Secrets allow you to access sensitive information, such as passwords, OAuth tokens, ssh keys, etc, inside your Workflow Expressions.",
								MarkdownDescription: "Secrets allow you to access sensitive information, such as passwords, OAuth tokens, ssh keys, etc, inside your Workflow Expressions.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"start": schema.MapAttribute{
								Description:         "Workflow start definition.",
								MarkdownDescription: "Workflow start definition.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"timeouts": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Defines the workflow default timeout settings.",
								Attributes: map[string]schema.Attribute{
									"action_exec_timeout": schema.StringAttribute{
										Description:         "ActionExecTimeout Single actions definition execution timeout duration (ISO 8601 duration format).",
										MarkdownDescription: "ActionExecTimeout Single actions definition execution timeout duration (ISO 8601 duration format).",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},

									"branch_exec_timeout": schema.StringAttribute{
										Description:         "BranchExecTimeout Single branch execution timeout duration (ISO 8601 duration format).",
										MarkdownDescription: "BranchExecTimeout Single branch execution timeout duration (ISO 8601 duration format).",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},

									"event_timeout": schema.StringAttribute{
										Description:         "EventTimeout Timeout duration to wait for consuming defined events (ISO 8601 duration format).",
										MarkdownDescription: "EventTimeout Timeout duration to wait for consuming defined events (ISO 8601 duration format).",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},

									"state_exec_timeout": schema.SingleNestedAttribute{
										Description:         "StateExecTimeout Total state execution timeout (including retries) (ISO 8601 duration format).",
										MarkdownDescription: "StateExecTimeout Total state execution timeout (including retries) (ISO 8601 duration format).",
										Attributes: map[string]schema.Attribute{
											"single": schema.StringAttribute{
												Description:         "Single state execution timeout, not including retries (ISO 8601 duration format)",
												MarkdownDescription: "Single state execution timeout, not including retries (ISO 8601 duration format)",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"total": schema.StringAttribute{
												...
												MarkdownDescription: "Total state execution timeout, including retries (ISO 8601 duration format)",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
									...
									"workflow_exec_timeout": schema.SingleNestedAttribute{
										Description:         "WorkflowExecTimeout Workflow execution timeout duration (ISO 8601 duration format). If not specified should be 'unlimited'.",
										MarkdownDescription: "WorkflowExecTimeout Workflow execution timeout duration (ISO 8601 duration format). If not specified should be 'unlimited'.",
										Attributes: map[string]schema.Attribute{
											"duration": schema.StringAttribute{
												Description:         "Workflow execution timeout duration (ISO 8601 duration format). If not specified should be 'unlimited'.",
												MarkdownDescription: "Workflow execution timeout duration (ISO 8601 duration format). If not specified should be 'unlimited'.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},

											"interrupt": schema.BoolAttribute{
												Description:         "If false, workflow instance is allowed to finish current execution. If true, current workflow execution is stopped immediately. Default is false.",
												MarkdownDescription: "If false, workflow instance is allowed to finish current execution. If true, current workflow execution is stopped immediately. Default is false.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},

											"run_before": schema.StringAttribute{
												Description:         "Name of a workflow state to be executed before workflow instance is terminated.",
												MarkdownDescription: "Name of a workflow state to be executed before workflow instance is terminated.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
							...
							"postgresql": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"jdbc_url": schema.StringAttribute{
										Description:         "PostgreSql JDBC URL. Mutually exclusive to serviceRef. e.g. 'jdbc:postgresql://host:port/database?currentSchema=data-index-service'",
										MarkdownDescription: "PostgreSql JDBC URL. Mutually exclusive to serviceRef. e.g. 'jdbc:postgresql://host:port/database?currentSchema=data-index-service'",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"secret_ref": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Secret reference to the database user credentials",
										Attributes: map[string]schema.Attribute{
											"name": schema.StringAttribute{
												Description:         "Name of the postgresql credentials secret.",
												MarkdownDescription: "Name of the postgresql credentials secret.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
											...
											"password_key": schema.StringAttribute{
												...
												MarkdownDescription: "Defaults to POSTGRESQL_PASSWORD",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"user_key": schema.StringAttribute{
												...
												MarkdownDescription: "Defaults to POSTGRESQL_USER",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									"service_ref": schema.SingleNestedAttribute{
										Description:         "Service reference to postgresql datasource. Mutually exclusive to jdbcUrl.",
										MarkdownDescription: "Service reference to postgresql datasource. Mutually exclusive to jdbcUrl.",
										Attributes: map[string]schema.Attribute{
											"database_name": schema.StringAttribute{
												Description:         "Name of postgresql database to be used. Defaults to 'sonataflow'",
												MarkdownDescription: "Name of postgresql database to be used. Defaults to 'sonataflow'",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},

											"database_schema": schema.StringAttribute{
												Description:         "Schema of postgresql database to be used. Defaults to 'data-index-service'",
												MarkdownDescription: "Schema of postgresql database to be used. Defaults to 'data-index-service'",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"name": schema.StringAttribute{
												...
												MarkdownDescription: "Name of the postgresql k8s service.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
											...
											"namespace": schema.StringAttribute{
												Description:         "Namespace of the postgresql k8s service. Defaults to the SonataFlowPlatform's local namespace.",
												MarkdownDescription: "Namespace of the postgresql k8s service. Defaults to the SonataFlowPlatform's local namespace.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"port": schema.Int64Attribute{
												Description:         "Port to use when connecting to the postgresql k8s service. Defaults to 5432.",
												MarkdownDescription: "Port to use when connecting to the postgresql k8s service. Defaults to 5432.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
					...
					"pod_template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "PodTemplate describes the deployment details of this SonataFlow instance.",
						Attributes: map[string]schema.Attribute{
							...
							"container": schema.SingleNestedAttribute{
								Description:         "Container is the Kubernetes container where the application should run. One can change this attribute in order to override the defaults provided by the operator.",
								MarkdownDescription: "Container is the Kubernetes container where the application should run. One can change this attribute in order to override the defaults provided by the operator.",
								Attributes: map[string]schema.Attribute{
					...
					"resources": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Resources workflow resources that are linked to this workflow definition. For example, a collection of OpenAPI specification files.",
						Attributes: map[string]schema.Attribute{
							"config_maps": schema.ListNestedAttribute{
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"config_map": schema.SingleNestedAttribute{
											Description:         "ConfigMap the given configMap name in the same workflow context to find the resource",
										...
										"workflow_path": schema.StringAttribute{
											Description:         "WorkflowPath path relative to the workflow application root file system within the pod (/<application path>/src/main/resources). Starting trailing slashes will be removed.",
											MarkdownDescription: "WorkflowPath path relative to the workflow application root file system within the pod (/<application path>/src/main/resources). Starting trailing slashes will be removed.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"sink": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Sink describes the sinkBinding details of this SonataFlow instance.",
						Attributes: map[string]schema.Attribute{
...
func (r *SonataflowOrgSonataFlowV1Alpha08Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sonataflow_org_sonata_flow_v1alpha08_manifest")

	var model SonataflowOrgSonataFlowV1Alpha08ManifestData
