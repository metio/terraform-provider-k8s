								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"jitter": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "If float type, maximum amount of random time added or subtracted from the delay between each retry relative to total delay (between 0 and 1). If string type, absolute maximum amount of random time added or subtracted from the delay between each retry (ISO 8601 duration format)",
											Attributes: map[string]schema.Attribute{
					...
					"sink": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"audience": schema.StringAttribute{
								...
								MarkdownDescription: "Audience is the OIDC audience. This need only be set, if the target is not an Addressable and thus the Audience can't be received from the Addressable itself. In case the Addressable specifies an Audience too, the Destinations Audience takes preference.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
