...
package workloads_kubeblocks_io_v1alpha1
...
var (
	_ datasource.DataSource = &WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest{}
)

func NewWorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest() datasource.DataSource {
	return &WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest{}
}

type WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest struct{}

type WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"alternative_services" json:"alternativeServices,omitempty"`
		Credential *struct {
			Password *struct {
		...
		NodeAssignment  *[]struct {
			...
			} `tfsdk:"node_spec" json:"nodeSpec,omitempty"`
...
func (r *WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_workloads_kubeblocks_io_replicated_state_machine_v1alpha1_manifest"
}

func (r *WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ReplicatedStateMachine is the Schema for the replicatedstatemachines API.",
		MarkdownDescription: "ReplicatedStateMachine is the Schema for the replicatedstatemachines API.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "Defines the desired state of the state machine. It includes the configuration details for the state machine.",
				MarkdownDescription: "Defines the desired state of the state machine. It includes the configuration details for the state machine.",
				Attributes: map[string]schema.Attribute{
					"alternative_services": schema.ListNestedAttribute{
						Description:         "Defines Alternative Services selector pattern specifier. Can be used for creating Readonly service.",
						MarkdownDescription: "Defines Alternative Services selector pattern specifier. Can be used for creating Readonly service.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"status": schema.SingleNestedAttribute{
									...
									MarkdownDescription: "Most recently observed status of the service. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
									Attributes: map[string]schema.Attribute{
										...
										"load_balancer": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "LoadBalancer contains the current status of the load-balancer, if one is present.",
											Attributes: map[string]schema.Attribute{
												"ingress": schema.ListNestedAttribute{
													Description:         "Ingress is a list containing ingress points for the load-balancer. Traffic intended for the service should be sent to these ingress points.",
													MarkdownDescription: "Ingress is a list containing ingress points for the load-balancer. Traffic intended for the service should be sent to these ingress points.",
													NestedObject: schema.NestedAttributeObject{
														Attributes: map[string]schema.Attribute{
															"hostname": schema.StringAttribute{
																Description:         "Hostname is set for load-balancer ingress points that are DNS based (typically AWS load-balancers)",
																MarkdownDescription: "Hostname is set for load-balancer ingress points that are DNS based (typically AWS load-balancers)",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
															...
															"ip": schema.StringAttribute{
																...
																MarkdownDescription: "IP is set for load-balancer ingress points that are IP based (typically GCE or OpenStack load-balancers)",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
															...
															"ports": schema.ListNestedAttribute{
																...
																MarkdownDescription: "Ports is a list of records of service ports If used, every port defined in the service should have an entry in it",
																NestedObject: schema.NestedAttributeObject{
																	Attributes: map[string]schema.Attribute{
																		"error": schema.StringAttribute{
																			Description:         "Error is to record the problem with the service port The format of the error shall comply with the following rules: - built-in error values shall be specified in this file and those shall use CamelCase names - cloud provider specific error values must have names that comply with the format foo.example.com/CamelCase. --- The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)",
																			MarkdownDescription: "Error is to record the problem with the service port The format of the error shall comply with the following rules: - built-in error values shall be specified in this file and those shall use CamelCase names - cloud provider specific error values must have names that comply with the format foo.example.com/CamelCase. --- The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)",
																			Required:            false,
																			Optional:            true,
																			Computed:            false,
																			Validators: []validator.String{
																		...
																		"port": schema.Int64Attribute{
																			...
																			MarkdownDescription: "Port is the port number of the service port of which status is recorded here",
																			Required:            true,
																			Optional:            false,
																			Computed:            false,
																		},
																		...
																		"protocol": schema.StringAttribute{
																			...
																			MarkdownDescription: "Protocol is the protocol of the service port of which status is recorded here The supported values are: 'TCP', 'UDP', 'SCTP'",
																			Required:            true,
																			Optional:            false,
																			Computed:            false,
																		},
					...
					"credential": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Credential used to connect to DB engine",
						Attributes: map[string]schema.Attribute{
							"password": schema.SingleNestedAttribute{
								Description:         "Represents the user's password for the credential. The corresponding environment variable will be KB_RSM_PASSWORD.",
								MarkdownDescription: "Represents the user's password for the credential. The corresponding environment variable will be KB_RSM_PASSWORD.",
								Attributes: map[string]schema.Attribute{
									"value": schema.StringAttribute{
										...
										MarkdownDescription: "Specifies the value of the environment variable. This field is optional and defaults to an empty string. The value can include variable references in the format $(VAR_NAME) which will be expanded using previously defined environment variables in the container and any service environment variables.  If a variable cannot be resolved, the reference in the input string will remain unchanged. Double $$ can be used to escape the $(VAR_NAME) syntax, resulting in a single $ and producing the string literal '$(VAR_NAME)'. Escaped references will not be expanded, regardless of whether the variable exists or not.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"value_from": schema.SingleNestedAttribute{
										Description:         "Defines the source for the environment variable's value. This field is optional and cannot be used if the 'Value' field is not empty.",
										MarkdownDescription: "Defines the source for the environment variable's value. This field is optional and cannot be used if the 'Value' field is not empty.",
										Attributes: map[string]schema.Attribute{
							...
							"username": schema.SingleNestedAttribute{
								Description:         "Defines the user's name for the credential. The corresponding environment variable will be KB_RSM_USERNAME.",
								MarkdownDescription: "Defines the user's name for the credential. The corresponding environment variable will be KB_RSM_USERNAME.",
								Attributes: map[string]schema.Attribute{
									"value": schema.StringAttribute{
										Description:         "Specifies the value of the environment variable. This field is optional and defaults to an empty string. The value can include variable references in the format $(VAR_NAME) which will be expanded using previously defined environment variables in the container and any service environment variables.  If a variable cannot be resolved, the reference in the input string will remain unchanged. Double $$ can be used to escape the $(VAR_NAME) syntax, resulting in a single $ and producing the string literal '$(VAR_NAME)'. Escaped references will not be expanded, regardless of whether the variable exists or not.",
										MarkdownDescription: "Specifies the value of the environment variable. This field is optional and defaults to an empty string. The value can include variable references in the format $(VAR_NAME) which will be expanded using previously defined environment variables in the container and any service environment variables.  If a variable cannot be resolved, the reference in the input string will remain unchanged. Double $$ can be used to escape the $(VAR_NAME) syntax, resulting in a single $ and producing the string literal '$(VAR_NAME)'. Escaped references will not be expanded, regardless of whether the variable exists or not.",
					...
					"membership_reconfiguration": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Provides actions to do membership dynamic reconfiguration.",
						Attributes: map[string]schema.Attribute{
					...
					"min_ready_seconds": schema.Int64Attribute{
						Description:         "Defines the minimum number of seconds a newly created pod should be ready without any of its container crashing to be considered available. Defaults to 0, meaning the pod will be considered available as soon as it is ready.",
						MarkdownDescription: "Defines the minimum number of seconds a newly created pod should be ready without any of its container crashing to be considered available. Defaults to 0, meaning the pod will be considered available as soon as it is ready.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.Int64{
					...
					"node_assignment": schema.ListNestedAttribute{
						Description:         "Defines the expected assignment of nodes.",
						MarkdownDescription: "Defines the expected assignment of nodes.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Specifies the identifier for the statefulSet requiring node allocation.",
									MarkdownDescription: "Specifies the identifier for the statefulSet requiring node allocation.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"node_spec": schema.SingleNestedAttribute{
									Description:         "Provides comprehensive details of the node to be assigned to the statefulSet.",
									MarkdownDescription: "Provides comprehensive details of the node to be assigned to the statefulSet.",
									Attributes: map[string]schema.Attribute{
										"node_name": schema.StringAttribute{
											Description:         "Represents the name of the node. This is a unique identifier within the cluster and is used to identify the specific node for scheduling, reporting, and other tasks.",
											MarkdownDescription: "Represents the name of the node. This is a unique identifier within the cluster and is used to identify the specific node for scheduling, reporting, and other tasks.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"paused": schema.BoolAttribute{
						Description:         "Indicates that the rsm is paused, meaning the reconciliation of this rsm object will be paused.",
						MarkdownDescription: "Indicates that the rsm is paused, meaning the reconciliation of this rsm object will be paused.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"replicas": schema.Int64Attribute{
						Description:         "Specifies the desired number of replicas of the given Template. These replicas are instantiations of the same Template, with each having a consistent identity. Defaults to 1 if unspecified.",
						MarkdownDescription: "Specifies the desired number of replicas of the given Template. These replicas are instantiations of the same Template, with each having a consistent identity. Defaults to 1 if unspecified.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.Int64{
					...
					"roles": schema.ListNestedAttribute{
						...
						MarkdownDescription: "A list of roles defined in the system.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"rsm_transform_policy": schema.StringAttribute{
						Description:         "Defines the policy to generate sts using rsm. Passed from cluster. ToSts: rsm transform to statefulSet ToPod: rsm transform to pod",
						MarkdownDescription: "Defines the policy to generate sts using rsm. Passed from cluster. ToSts: rsm transform to statefulSet ToPod: rsm transform to pod",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"selector": schema.SingleNestedAttribute{
						Description:         "Represents a label query over pods that should match the replica count. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors",
						MarkdownDescription: "Represents a label query over pods that should match the replica count. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors",
						Attributes: map[string]schema.Attribute{
					...
					"service": schema.SingleNestedAttribute{
						Description:         "Defines the behavior of a service spec. Provides read-write service. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
						MarkdownDescription: "Defines the behavior of a service spec. Provides read-write service. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
						Attributes: map[string]schema.Attribute{
							"api_version": schema.StringAttribute{
								Description:         "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources",
								MarkdownDescription: "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources",
					...
					"service_name": schema.StringAttribute{
						Description:         "Refers to the name of the service that governs this StatefulSet. This service must exist before the StatefulSet and is responsible for the network identity of the set. Pods get DNS/hostnames that follow a specific pattern.",
						MarkdownDescription: "Refers to the name of the service that governs this StatefulSet. This service must exist before the StatefulSet and is responsible for the network identity of the set. Pods get DNS/hostnames that follow a specific pattern.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"update_strategy": schema.SingleNestedAttribute{
						Description:         "Indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the RSM when a revision is made to Template. UpdateStrategy.Type will be set to appsv1.OnDeleteStatefulSetStrategyType if MemberUpdateStrategy is not nil",
						MarkdownDescription: "Indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the RSM when a revision is made to Template. UpdateStrategy.Type will be set to appsv1.OnDeleteStatefulSetStrategyType if MemberUpdateStrategy is not nil",
						Attributes: map[string]schema.Attribute{
...
func (r *WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_workloads_kubeblocks_io_replicated_state_machine_v1alpha1_manifest")

	var model WorkloadsKubeblocksIoReplicatedStateMachineV1Alpha1ManifestData
	...
	model.ApiVersion = pointer.String("workloads.kubeblocks.io/v1alpha1")
	model.Kind = pointer.String("ReplicatedStateMachine")
