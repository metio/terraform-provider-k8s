...
var (
	_ datasource.DataSource = &KafkaStrimziIoKafkaTopicV1Beta1Manifest{}
)

func NewKafkaStrimziIoKafkaTopicV1Beta1Manifest() datasource.DataSource {
	return &KafkaStrimziIoKafkaTopicV1Beta1Manifest{}
}

type KafkaStrimziIoKafkaTopicV1Beta1Manifest struct{}

type KafkaStrimziIoKafkaTopicV1Beta1ManifestData struct {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_topic_v1beta1_manifest"
}

func (r *KafkaStrimziIoKafkaTopicV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_topic_v1beta1_manifest")

	var model KafkaStrimziIoKafkaTopicV1Beta1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("kafka.strimzi.io/v1beta1")
