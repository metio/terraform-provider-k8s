...
var (
	_ datasource.DataSource = &KafkaStrimziIoKafkaUserV1Beta1Manifest{}
)

func NewKafkaStrimziIoKafkaUserV1Beta1Manifest() datasource.DataSource {
	return &KafkaStrimziIoKafkaUserV1Beta1Manifest{}
}

type KafkaStrimziIoKafkaUserV1Beta1Manifest struct{}

type KafkaStrimziIoKafkaUserV1Beta1ManifestData struct {
...
func (r *KafkaStrimziIoKafkaUserV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_user_v1beta1_manifest"
}

func (r *KafkaStrimziIoKafkaUserV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_user_v1beta1_manifest")

	var model KafkaStrimziIoKafkaUserV1Beta1ManifestData
