...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaTopicV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaTopicV1Beta1DataSource{}
)

func NewKafkaStrimziIoKafkaTopicV1Beta1DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaTopicV1Beta1DataSource{}
}

type KafkaStrimziIoKafkaTopicV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaTopicV1Beta1DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_topic_v1beta1"
}

func (r *KafkaStrimziIoKafkaTopicV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaTopicV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_topic_v1beta1")

	var data KafkaStrimziIoKafkaTopicV1Beta1DataSourceData
	...
	var readResponse KafkaStrimziIoKafkaTopicV1Beta1DataSourceData
