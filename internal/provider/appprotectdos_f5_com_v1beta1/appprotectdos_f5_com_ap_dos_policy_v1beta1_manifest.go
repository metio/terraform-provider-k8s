...
var (
	_ datasource.DataSource = &AppprotectdosF5ComApdosPolicyV1Beta1Manifest{}
)

func NewAppprotectdosF5ComApdosPolicyV1Beta1Manifest() datasource.DataSource {
	return &AppprotectdosF5ComApdosPolicyV1Beta1Manifest{}
}
...
func (r *AppprotectdosF5ComApdosPolicyV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_appprotectdos_f5_com_ap_dos_policy_v1beta1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "APDosPolicySpec defines the desired state of APDosPolicy",
				Attributes: map[string]schema.Attribute{
					"automation_tools_detection": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"mitigation_mode": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("standard", "conservative", "none"),
						},
					},
...
func (r *AppprotectdosF5ComApdosPolicyV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_appprotectdos_f5_com_ap_dos_policy_v1beta1_manifest")

	var model AppprotectdosF5ComApdosPolicyV1Beta1ManifestData
