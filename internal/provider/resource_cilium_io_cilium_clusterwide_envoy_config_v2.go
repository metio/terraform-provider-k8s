...
var (
	_ resource.Resource = (*CiliumIoCiliumClusterwideEnvoyConfigV2Resource)(nil)
)

type CiliumIoCiliumClusterwideEnvoyConfigV2TerraformModel struct {
...
type CiliumIoCiliumClusterwideEnvoyConfigV2GoModel struct {
...
func (r *CiliumIoCiliumClusterwideEnvoyConfigV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cilium_io_cilium_clusterwide_envoy_config_v2"
}

func (r *CiliumIoCiliumClusterwideEnvoyConfigV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *CiliumIoCiliumClusterwideEnvoyConfigV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_cilium_io_cilium_clusterwide_envoy_config_v2")

	var state CiliumIoCiliumClusterwideEnvoyConfigV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CiliumIoCiliumClusterwideEnvoyConfigV2GoModel
	...
	goModel.Kind = utilities.Ptr("CiliumClusterwideEnvoyConfig")
...
func (r *CiliumIoCiliumClusterwideEnvoyConfigV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cilium_io_cilium_clusterwide_envoy_config_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *CiliumIoCiliumClusterwideEnvoyConfigV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CiliumIoCiliumClusterwideEnvoyConfigV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
