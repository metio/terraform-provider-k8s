...
package reports_x_k8s_io_v1beta2
...
var (
	_ datasource.DataSource = &ReportsXK8SIoClusterPolicyReportV1Beta2Manifest{}
)

func NewReportsXK8SIoClusterPolicyReportV1Beta2Manifest() datasource.DataSource {
	return &ReportsXK8SIoClusterPolicyReportV1Beta2Manifest{}
}

type ReportsXK8SIoClusterPolicyReportV1Beta2Manifest struct{}

type ReportsXK8SIoClusterPolicyReportV1Beta2ManifestData struct {
...
func (r *ReportsXK8SIoClusterPolicyReportV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_reports_x_k8s_io_cluster_policy_report_v1beta2_manifest"
}

func (r *ReportsXK8SIoClusterPolicyReportV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ReportsXK8SIoClusterPolicyReportV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_reports_x_k8s_io_cluster_policy_report_v1beta2_manifest")

	var model ReportsXK8SIoClusterPolicyReportV1Beta2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("reports.x-k8s.io/v1beta2")
