...
var (
	_ datasource.DataSource = &GatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest{}
)

func NewGatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest() datasource.DataSource {
	return &GatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest{}
}

type GatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest struct{}

type GatewayNetworkingK8SIoGatewayClassV1Alpha2ManifestData struct {
...
func (r *GatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_networking_k8s_io_gateway_class_v1alpha2_manifest"
}

func (r *GatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewayNetworkingK8SIoGatewayClassV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_networking_k8s_io_gateway_class_v1alpha2_manifest")

	var model GatewayNetworkingK8SIoGatewayClassV1Alpha2ManifestData
