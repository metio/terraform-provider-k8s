...
var (
	_ datasource.DataSource = &GatewayNetworkingK8SIoGrpcrouteV1Alpha2Manifest{}
)

func NewGatewayNetworkingK8SIoGrpcrouteV1Alpha2Manifest() datasource.DataSource {
	return &GatewayNetworkingK8SIoGrpcrouteV1Alpha2Manifest{}
}
...
func (r *GatewayNetworkingK8SIoGrpcrouteV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_networking_k8s_io_grpc_route_v1alpha2_manifest"
}
...
func (r *GatewayNetworkingK8SIoGrpcrouteV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_networking_k8s_io_grpc_route_v1alpha2_manifest")

	var model GatewayNetworkingK8SIoGrpcrouteV1Alpha2ManifestData
