...
func TestGatewayNetworkingK8SIoTLSRouteV1Alpha2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_gateway_networking_k8s_io_tls_route_v1alpha2_manifest", testCase)
		})
	}
}
