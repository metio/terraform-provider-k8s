...
func TestGatewayNetworkingK8SIoTCPRouteV1Alpha2DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_gateway_networking_k8s_io_tcp_route_v1alpha2", testCase)
		})
	}
}
...
func TestGatewayNetworkingK8SIoTCPRouteV1Alpha2DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_gateway_networking_k8s_io_tcp_route_v1alpha2", configuration)
}
