...
var (
	_ datasource.DataSource = &GatewayNetworkingK8SIoReferenceGrantV1Alpha2Manifest{}
)

func NewGatewayNetworkingK8SIoReferenceGrantV1Alpha2Manifest() datasource.DataSource {
	return &GatewayNetworkingK8SIoReferenceGrantV1Alpha2Manifest{}
}

type GatewayNetworkingK8SIoReferenceGrantV1Alpha2Manifest struct{}

type GatewayNetworkingK8SIoReferenceGrantV1Alpha2ManifestData struct {
...
func (r *GatewayNetworkingK8SIoReferenceGrantV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_networking_k8s_io_reference_grant_v1alpha2_manifest"
}
...
func (r *GatewayNetworkingK8SIoReferenceGrantV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_networking_k8s_io_reference_grant_v1alpha2_manifest")

	var model GatewayNetworkingK8SIoReferenceGrantV1Alpha2ManifestData
