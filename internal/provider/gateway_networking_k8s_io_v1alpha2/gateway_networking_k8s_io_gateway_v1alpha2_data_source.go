...
var (
	_ datasource.DataSource              = &GatewayNetworkingK8SIoGatewayV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &GatewayNetworkingK8SIoGatewayV1Alpha2DataSource{}
)

func NewGatewayNetworkingK8SIoGatewayV1Alpha2DataSource() datasource.DataSource {
	return &GatewayNetworkingK8SIoGatewayV1Alpha2DataSource{}
}

type GatewayNetworkingK8SIoGatewayV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type GatewayNetworkingK8SIoGatewayV1Alpha2DataSourceData struct {
...
func (r *GatewayNetworkingK8SIoGatewayV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_networking_k8s_io_gateway_v1alpha2"
}

func (r *GatewayNetworkingK8SIoGatewayV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewayNetworkingK8SIoGatewayV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GatewayNetworkingK8SIoGatewayV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_gateway_networking_k8s_io_gateway_v1alpha2")

	var data GatewayNetworkingK8SIoGatewayV1Alpha2DataSourceData
	...
	var readResponse GatewayNetworkingK8SIoGatewayV1Alpha2DataSourceData
