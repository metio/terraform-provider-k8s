...
var (
	_ datasource.DataSource = &SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest{}
)

func NewSnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest() datasource.DataSource {
	return &SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest{}
}

type SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest struct{}

type SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1ManifestData struct {
...
func (r *SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_snapshot_storage_k8s_io_volume_snapshot_class_v1beta1_manifest"
}

func (r *SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_snapshot_storage_k8s_io_volume_snapshot_class_v1beta1_manifest")

	var model SnapshotStorageK8SIoVolumeSnapshotClassV1Beta1ManifestData
