...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4Manifest{}
)

func NewInfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4Manifest{}
}
...
func (r *InfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_v_sphere_deployment_zone_v1alpha4_manifest"
}

func (r *InfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_v_sphere_deployment_zone_v1alpha4_manifest")

	var model InfrastructureClusterXK8SIoVsphereDeploymentZoneV1Alpha4ManifestData
