...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4Manifest{}
)

func NewInfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4Manifest{}
}
...
func (r *InfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_v_sphere_machine_template_v1alpha4_manifest"
}

func (r *InfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "VSphereMachineTemplate is the Schema for the vspheremachinetemplates APIDeprecated: This type will be removed in one of the next releases.",
		MarkdownDescription: "VSphereMachineTemplate is the Schema for the vspheremachinetemplates APIDeprecated: This type will be removed in one of the next releases.",
...
func (r *InfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_template_v1alpha4_manifest")

	var model InfrastructureClusterXK8SIoVsphereMachineTemplateV1Alpha4ManifestData
