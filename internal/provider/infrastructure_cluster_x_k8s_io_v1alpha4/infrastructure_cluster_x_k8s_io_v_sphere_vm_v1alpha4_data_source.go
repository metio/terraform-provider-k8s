...
var (
	_ datasource.DataSource              = &InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource{}
	_ datasource.DataSourceWithConfigure = &InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource{}
)

func NewInfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource() datasource.DataSource {
	return &InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource{}
}

type InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource struct {
	kubernetesClient dynamic.Interface
}

type InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSourceData struct {
...
func (r *InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_v_sphere_vm_v1alpha4"
}

func (r *InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_infrastructure_cluster_x_k8s_io_v_sphere_vm_v1alpha4")

	var data InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSourceData
	...
	var readResponse InfrastructureClusterXK8SIoVsphereVmV1Alpha4DataSourceData
