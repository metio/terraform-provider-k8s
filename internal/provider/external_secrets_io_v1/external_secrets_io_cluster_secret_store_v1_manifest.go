...
var (
	_ datasource.DataSource = &ExternalSecretsIoClusterSecretStoreV1Manifest{}
)

func NewExternalSecretsIoClusterSecretStoreV1Manifest() datasource.DataSource {
	return &ExternalSecretsIoClusterSecretStoreV1Manifest{}
}

type ExternalSecretsIoClusterSecretStoreV1Manifest struct{}

type ExternalSecretsIoClusterSecretStoreV1ManifestData struct {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_cluster_secret_store_v1_manifest"
}

func (r *ExternalSecretsIoClusterSecretStoreV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_external_secrets_io_cluster_secret_store_v1_manifest")

	var model ExternalSecretsIoClusterSecretStoreV1ManifestData
