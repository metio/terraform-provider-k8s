...
var (
	_ datasource.DataSource = &ExternalSecretsIoClusterExternalSecretV1Manifest{}
)

func NewExternalSecretsIoClusterExternalSecretV1Manifest() datasource.DataSource {
	return &ExternalSecretsIoClusterExternalSecretV1Manifest{}
}

type ExternalSecretsIoClusterExternalSecretV1Manifest struct{}

type ExternalSecretsIoClusterExternalSecretV1ManifestData struct {
	...
	Spec *struct {
		...
		ExternalSecretSpec *struct {
			...
			DataFrom *[]struct {
				...
				Rewrite *[]struct {
					Merge *struct {
						ConflictPolicy *string   `tfsdk:"conflict_policy" json:"conflictPolicy,omitempty"`
						Into           *string   `tfsdk:"into" json:"into,omitempty"`
...
func (r *ExternalSecretsIoClusterExternalSecretV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_cluster_external_secret_v1_manifest"
}

func (r *ExternalSecretsIoClusterExternalSecretV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"merge": schema.SingleNestedAttribute{
														...
														MarkdownDescription: "Used to merge key/values in one single Secret The resulting key will contain all values from the specified secrets",
														Attributes: map[string]schema.Attribute{
															"conflict_policy": schema.StringAttribute{
																Description:         "Used to define the policy to use in conflict resolution.",
																MarkdownDescription: "Used to define the policy to use in conflict resolution.",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},

															"into": schema.StringAttribute{
																Description:         "Used to define the target key of the merge operation. Required if strategy is JSON. Ignored otherwise.",
																MarkdownDescription: "Used to define the target key of the merge operation. Required if strategy is JSON. Ignored otherwise.",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
															...
															"priority": schema.ListAttribute{
																...
																MarkdownDescription: "Used to define key priority in conflict resolution.",
																ElementType:         types.StringType,
																Required:            false,
																Optional:            true,
																Computed:            false,
															...
															"strategy": schema.StringAttribute{
																...
																MarkdownDescription: "Used to define the strategy to use in the merge operation.",
																Required:            false,
																Optional:            true,
																Computed:            false,
															},
														...
														Computed: false,
														Validators: []validator.Object{
															objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("regexp"), path.MatchRelative().AtParent().AtName("transform")),
														},
													},
													...
													"regexp": schema.SingleNestedAttribute{
														...
														Computed: false,
														Validators: []validator.Object{
															objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("merge"), path.MatchRelative().AtParent().AtName("transform")),
														},
													},
													...
													"transform": schema.SingleNestedAttribute{
														...
														Computed: false,
														Validators: []validator.Object{
															objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("merge"), path.MatchRelative().AtParent().AtName("regexp")),
														},
													},
												},
											},
...
func (r *ExternalSecretsIoClusterExternalSecretV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_external_secrets_io_cluster_external_secret_v1_manifest")

	var model ExternalSecretsIoClusterExternalSecretV1ManifestData
