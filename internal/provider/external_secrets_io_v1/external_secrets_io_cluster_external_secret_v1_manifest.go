												...
												"generator_ref": schema.SingleNestedAttribute{
													...
													Attributes: map[string]schema.Attribute{
														...
														"kind": schema.StringAttribute{
															...
															Computed:            false,
															Validators: []validator.String{
																stringvalidator.OneOf("ACRAccessToken", "ClusterGenerator", "ECRAuthorizationToken", "Fake", "GCRAccessToken", "GithubAccessToken", "QuayAccessToken", "Password", "STSSessionToken", "UUID", "VaultDynamicSecret", "Webhook", "Grafana", "MFA"),
															},
														},
