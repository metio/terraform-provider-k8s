...
package external_secrets_io_v1
...
var (
	_ datasource.DataSource = &ExternalSecretsIoSecretStoreV1Manifest{}
)

func NewExternalSecretsIoSecretStoreV1Manifest() datasource.DataSource {
	return &ExternalSecretsIoSecretStoreV1Manifest{}
}

type ExternalSecretsIoSecretStoreV1Manifest struct{}

type ExternalSecretsIoSecretStoreV1ManifestData struct {
	...
	Spec *struct {
		...
		Provider   *struct {
			...
			Fake *struct {
				...
				ValidationResult *int64 `tfsdk:"validation_result" json:"validationResult,omitempty"`
			...
			Infisical *struct {
				Auth *struct {
					AwsAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"identity_id" json:"identityId,omitempty"`
					} `tfsdk:"aws_auth_credentials" json:"awsAuthCredentials,omitempty"`
					AzureAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
					...
					} `tfsdk:"azure_auth_credentials" json:"azureAuthCredentials,omitempty"`
					GcpIamAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"identity_id" json:"identityId,omitempty"`
						ServiceAccountKeyFilePath *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"service_account_key_file_path" json:"serviceAccountKeyFilePath,omitempty"`
					} `tfsdk:"gcp_iam_auth_credentials" json:"gcpIamAuthCredentials,omitempty"`
					GcpIdTokenAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"identity_id" json:"identityId,omitempty"`
					} `tfsdk:"gcp_id_token_auth_credentials" json:"gcpIdTokenAuthCredentials,omitempty"`
					JwtAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
					...
					} `tfsdk:"jwt_auth_credentials" json:"jwtAuthCredentials,omitempty"`
					KubernetesAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"identity_id" json:"identityId,omitempty"`
						ServiceAccountTokenPath *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"service_account_token_path" json:"serviceAccountTokenPath,omitempty"`
					} `tfsdk:"kubernetes_auth_credentials" json:"kubernetesAuthCredentials,omitempty"`
					LdapAuthCredentials *struct {
						IdentityId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						...
						LdapPassword *struct {
							...
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"ldap_password" json:"ldapPassword,omitempty"`
						LdapUsername *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"ldap_username" json:"ldapUsername,omitempty"`
					} `tfsdk:"ldap_auth_credentials" json:"ldapAuthCredentials,omitempty"`
					OciAuthCredentials *struct {
						Fingerprint *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						...
						PrivateKeyPassphrase *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"private_key_passphrase" json:"privateKeyPassphrase,omitempty"`
						Region *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						...
						TenancyId *struct {
							...
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"tenancy_id" json:"tenancyId,omitempty"`
						UserId *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"user_id" json:"userId,omitempty"`
					} `tfsdk:"oci_auth_credentials" json:"ociAuthCredentials,omitempty"`
					TokenAuthCredentials *struct {
						AccessToken *struct {
							Key       *string `tfsdk:"key" json:"key,omitempty"`
							Name      *string `tfsdk:"name" json:"name,omitempty"`
							Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
						} `tfsdk:"access_token" json:"accessToken,omitempty"`
					} `tfsdk:"token_auth_credentials" json:"tokenAuthCredentials,omitempty"`
			...
			OnepasswordSDK *struct {
				...
				IntegrationInfo *struct {
					Name    *string `tfsdk:"name" json:"name,omitempty"`
					Version *string `tfsdk:"version" json:"version,omitempty"`
				} `tfsdk:"integration_info" json:"integrationInfo,omitempty"`
				Vault *string `tfsdk:"vault" json:"vault,omitempty"`
			} `tfsdk:"onepassword_sdk" json:"onepasswordSDK,omitempty"`
			Oracle *struct {
				Auth *struct {
					SecretRef *struct {
						Fingerprint *struct {
			...
			Yandexcertificatemanager *struct {
				...
				Fetching *struct {
					ByID   *map[string]string `tfsdk:"by_id" json:"byID,omitempty"`
					ByName *struct {
						FolderID *string `tfsdk:"folder_id" json:"folderID,omitempty"`
					} `tfsdk:"by_name" json:"byName,omitempty"`
				} `tfsdk:"fetching" json:"fetching,omitempty"`
...
func (r *ExternalSecretsIoSecretStoreV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_secret_store_v1_manifest"
}

func (r *ExternalSecretsIoSecretStoreV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
				...
				Attributes: map[string]schema.Attribute{
					...
					"provider": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"aws": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"prefix": schema.StringAttribute{
										...
										MarkdownDescription: "Prefix adds a prefix to all retrieved values.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"beyondtrust": schema.SingleNestedAttribute{
								Description:         "Beyondtrust configures this store to sync secrets using Password Safe provider.",
								MarkdownDescription: "Beyondtrust configures this store to sync secrets using Password Safe provider.",
								Attributes: map[string]schema.Attribute{
									"auth": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"certificate_key": schema.SingleNestedAttribute{
												Description:         "Certificate private key (key.pem). For use when authenticating with an OAuth client Id",
												MarkdownDescription: "Certificate private key (key.pem). For use when authenticating with an OAuth client Id",
												Attributes: map[string]schema.Attribute{
													"secret_ref": schema.SingleNestedAttribute{
														Description:         "SecretRef references a key in a secret that will be used as value.",
														MarkdownDescription: "SecretRef references a key in a secret that will be used as value.",
									...
									"server": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Auth configures how API server works.",
										Attributes: map[string]schema.Attribute{
											...
											"client_time_out_seconds": schema.Int64Attribute{
												...
												MarkdownDescription: "Timeout specifies a time limit for requests made by this Client. The timeout includes connection time, any redirects, and reading the response body. Defaults to 45 seconds.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},

											"retrieval_type": schema.StringAttribute{
												...
												MarkdownDescription: "The secret retrieval type. SECRET = Secrets Safe (credential, text, file). MANAGED_ACCOUNT = Password Safe account associated with a system.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"separator": schema.StringAttribute{
												...
												MarkdownDescription: "A character that separates the folder names.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
							...
							"bitwardensecretsmanager": schema.SingleNestedAttribute{
								Description:         "BitwardenSecretsManager configures this store to sync secrets using BitwardenSecretsManager provider",
								MarkdownDescription: "BitwardenSecretsManager configures this store to sync secrets using BitwardenSecretsManager provider",
								Attributes: map[string]schema.Attribute{
									"api_url": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
									...
									"auth": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"secret_ref": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "BitwardenSecretsManagerSecretRef contains the credential ref to the bitwarden instance.",
												Attributes: map[string]schema.Attribute{
									...
									"bitwarden_server_sdk_url": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
									...
									"organization_id": schema.StringAttribute{
										...
										MarkdownDescription: "OrganizationID determines which organization this secret store manages.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"project_id": schema.StringAttribute{
										...
										MarkdownDescription: "ProjectID determines which project this secret store manages.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
							...
							"fake": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"validation_result": schema.Int64Attribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
							...
							"infisical": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"auth": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"aws_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
														Description:         "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														MarkdownDescription: "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
											...
											"azure_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
											...
											"gcp_iam_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
													...
													"service_account_key_file_path": schema.SingleNestedAttribute{
														Description:         "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														MarkdownDescription: "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
											...
											"gcp_id_token_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
											...
											"jwt_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
											...
											"kubernetes_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
													...
													"service_account_token_path": schema.SingleNestedAttribute{
														Description:         "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														MarkdownDescription: "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
											...
											"ldap_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"identity_id": schema.SingleNestedAttribute{
													...
													"ldap_password": schema.SingleNestedAttribute{
														Description:         "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														MarkdownDescription: "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
													...
													"ldap_username": schema.SingleNestedAttribute{
														Description:         "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														MarkdownDescription: "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
											...
											"oci_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													...
													"tenancy_id": schema.SingleNestedAttribute{
														Description:         "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														MarkdownDescription: "A reference to a specific 'key' within a Secret resource. In some instances, 'key' is a required field.",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
											...
											"token_auth_credentials": schema.SingleNestedAttribute{
												Description:         "",
												MarkdownDescription: "",
												Attributes: map[string]schema.Attribute{
													"access_token": schema.SingleNestedAttribute{
							...
							"keepersecurity": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("akeyless"), path.MatchRelative().AtParent().AtName("alibaba"), path.MatchRelative().AtParent().AtName("aws"), path.MatchRelative().AtParent().AtName("azurekv"), path.MatchRelative().AtParent().AtName("beyondtrust"), path.MatchRelative().AtParent().AtName("bitwardensecretsmanager"), path.MatchRelative().AtParent().AtName("chef"), path.MatchRelative().AtParent().AtName("cloudrusm"), path.MatchRelative().AtParent().AtName("conjur"), path.MatchRelative().AtParent().AtName("delinea"), path.MatchRelative().AtParent().AtName("device42"), path.MatchRelative().AtParent().AtName("doppler"), path.MatchRelative().AtParent().AtName("fake"), path.MatchRelative().AtParent().AtName("fortanix"), path.MatchRelative().AtParent().AtName("gcpsm"), path.MatchRelative().AtParent().AtName("github"), path.MatchRelative().AtParent().AtName("gitlab"), path.MatchRelative().AtParent().AtName("ibm"), path.MatchRelative().AtParent().AtName("infisical"), path.MatchRelative().AtParent().AtName("kubernetes"), path.MatchRelative().AtParent().AtName("onboardbase"), path.MatchRelative().AtParent().AtName("onepassword"), path.MatchRelative().AtParent().AtName("onepassword_sdk"), path.MatchRelative().AtParent().AtName("oracle"), path.MatchRelative().AtParent().AtName("passbolt"), path.MatchRelative().AtParent().AtName("passworddepot"), path.MatchRelative().AtParent().AtName("previder"), path.MatchRelative().AtParent().AtName("pulumi"), path.MatchRelative().AtParent().AtName("scaleway"), path.MatchRelative().AtParent().AtName("secretserver"), path.MatchRelative().AtParent().AtName("senhasegura"), path.MatchRelative().AtParent().AtName("vault"), path.MatchRelative().AtParent().AtName("webhook"), path.MatchRelative().AtParent().AtName("yandexcertificatemanager"), path.MatchRelative().AtParent().AtName("yandexlockbox")),
								},
							},
							...
							"kubernetes": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("akeyless"), path.MatchRelative().AtParent().AtName("alibaba"), path.MatchRelative().AtParent().AtName("aws"), path.MatchRelative().AtParent().AtName("azurekv"), path.MatchRelative().AtParent().AtName("beyondtrust"), path.MatchRelative().AtParent().AtName("bitwardensecretsmanager"), path.MatchRelative().AtParent().AtName("chef"), path.MatchRelative().AtParent().AtName("cloudrusm"), path.MatchRelative().AtParent().AtName("conjur"), path.MatchRelative().AtParent().AtName("delinea"), path.MatchRelative().AtParent().AtName("device42"), path.MatchRelative().AtParent().AtName("doppler"), path.MatchRelative().AtParent().AtName("fake"), path.MatchRelative().AtParent().AtName("fortanix"), path.MatchRelative().AtParent().AtName("gcpsm"), path.MatchRelative().AtParent().AtName("github"), path.MatchRelative().AtParent().AtName("gitlab"), path.MatchRelative().AtParent().AtName("ibm"), path.MatchRelative().AtParent().AtName("infisical"), path.MatchRelative().AtParent().AtName("keepersecurity"), path.MatchRelative().AtParent().AtName("onboardbase"), path.MatchRelative().AtParent().AtName("onepassword"), path.MatchRelative().AtParent().AtName("onepassword_sdk"), path.MatchRelative().AtParent().AtName("oracle"), path.MatchRelative().AtParent().AtName("passbolt"), path.MatchRelative().AtParent().AtName("passworddepot"), path.MatchRelative().AtParent().AtName("previder"), path.MatchRelative().AtParent().AtName("pulumi"), path.MatchRelative().AtParent().AtName("scaleway"), path.MatchRelative().AtParent().AtName("secretserver"), path.MatchRelative().AtParent().AtName("senhasegura"), path.MatchRelative().AtParent().AtName("vault"), path.MatchRelative().AtParent().AtName("webhook"), path.MatchRelative().AtParent().AtName("yandexcertificatemanager"), path.MatchRelative().AtParent().AtName("yandexlockbox")),
								},
							},
							...
							"onboardbase": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("akeyless"), path.MatchRelative().AtParent().AtName("alibaba"), path.MatchRelative().AtParent().AtName("aws"), path.MatchRelative().AtParent().AtName("azurekv"), path.MatchRelative().AtParent().AtName("beyondtrust"), path.MatchRelative().AtParent().AtName("bitwardensecretsmanager"), path.MatchRelative().AtParent().AtName("chef"), path.MatchRelative().AtParent().AtName("cloudrusm"), path.MatchRelative().AtParent().AtName("conjur"), path.MatchRelative().AtParent().AtName("delinea"), path.MatchRelative().AtParent().AtName("device42"), path.MatchRelative().AtParent().AtName("doppler"), path.MatchRelative().AtParent().AtName("fake"), path.MatchRelative().AtParent().AtName("fortanix"), path.MatchRelative().AtParent().AtName("gcpsm"), path.MatchRelative().AtParent().AtName("github"), path.MatchRelative().AtParent().AtName("gitlab"), path.MatchRelative().AtParent().AtName("ibm"), path.MatchRelative().AtParent().AtName("infisical"), path.MatchRelative().AtParent().AtName("keepersecurity"), path.MatchRelative().AtParent().AtName("kubernetes"), path.MatchRelative().AtParent().AtName("onepassword"), path.MatchRelative().AtParent().AtName("onepassword_sdk"), path.MatchRelative().AtParent().AtName("oracle"), path.MatchRelative().AtParent().AtName("passbolt"), path.MatchRelative().AtParent().AtName("passworddepot"), path.MatchRelative().AtParent().AtName("previder"), path.MatchRelative().AtParent().AtName("pulumi"), path.MatchRelative().AtParent().AtName("scaleway"), path.MatchRelative().AtParent().AtName("secretserver"), path.MatchRelative().AtParent().AtName("senhasegura"), path.MatchRelative().AtParent().AtName("vault"), path.MatchRelative().AtParent().AtName("webhook"), path.MatchRelative().AtParent().AtName("yandexcertificatemanager"), path.MatchRelative().AtParent().AtName("yandexlockbox")),
								},
							},
							...
							"onepassword": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("akeyless"), path.MatchRelative().AtParent().AtName("alibaba"), path.MatchRelative().AtParent().AtName("aws"), path.MatchRelative().AtParent().AtName("azurekv"), path.MatchRelative().AtParent().AtName("beyondtrust"), path.MatchRelative().AtParent().AtName("bitwardensecretsmanager"), path.MatchRelative().AtParent().AtName("chef"), path.MatchRelative().AtParent().AtName("cloudrusm"), path.MatchRelative().AtParent().AtName("conjur"), path.MatchRelative().AtParent().AtName("delinea"), path.MatchRelative().AtParent().AtName("device42"), path.MatchRelative().AtParent().AtName("doppler"), path.MatchRelative().AtParent().AtName("fake"), path.MatchRelative().AtParent().AtName("fortanix"), path.MatchRelative().AtParent().AtName("gcpsm"), path.MatchRelative().AtParent().AtName("github"), path.MatchRelative().AtParent().AtName("gitlab"), path.MatchRelative().AtParent().AtName("ibm"), path.MatchRelative().AtParent().AtName("infisical"), path.MatchRelative().AtParent().AtName("keepersecurity"), path.MatchRelative().AtParent().AtName("kubernetes"), path.MatchRelative().AtParent().AtName("onboardbase"), path.MatchRelative().AtParent().AtName("onepassword_sdk"), path.MatchRelative().AtParent().AtName("oracle"), path.MatchRelative().AtParent().AtName("passbolt"), path.MatchRelative().AtParent().AtName("passworddepot"), path.MatchRelative().AtParent().AtName("previder"), path.MatchRelative().AtParent().AtName("pulumi"), path.MatchRelative().AtParent().AtName("scaleway"), path.MatchRelative().AtParent().AtName("secretserver"), path.MatchRelative().AtParent().AtName("senhasegura"), path.MatchRelative().AtParent().AtName("vault"), path.MatchRelative().AtParent().AtName("webhook"), path.MatchRelative().AtParent().AtName("yandexcertificatemanager"), path.MatchRelative().AtParent().AtName("yandexlockbox")),
								},
							},

							"onepassword_sdk": schema.SingleNestedAttribute{
								Description:         "OnePasswordSDK configures this store to use 1Password's new Go SDK to sync secrets.",
								MarkdownDescription: "OnePasswordSDK configures this store to use 1Password's new Go SDK to sync secrets.",
								Attributes: map[string]schema.Attribute{
									"auth": schema.SingleNestedAttribute{
										Description:         "Auth defines the information necessary to authenticate against OnePassword API.",
										MarkdownDescription: "Auth defines the information necessary to authenticate against OnePassword API.",
										Attributes: map[string]schema.Attribute{
											"service_account_secret_ref": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "ServiceAccountSecretRef points to the secret containing the token to access 1Password vault.",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "A key in the referenced Secret. Some instances of this field may be defaulted, in others it may be required.",
														MarkdownDescription: "A key in the referenced Secret. Some instances of this field may be defaulted, in others it may be required.",
									...
									"integration_info": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "IntegrationInfo specifies the name and version of the integration built using the 1Password Go SDK. If you don't know which name and version to use, use 'DefaultIntegrationName' and 'DefaultIntegrationVersion', respectively.",
										Attributes: map[string]schema.Attribute{
											"name": schema.StringAttribute{
												Description:         "Name defaults to '1Password SDK'.",
												MarkdownDescription: "Name defaults to '1Password SDK'.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"version": schema.StringAttribute{
												...
												MarkdownDescription: "Version defaults to 'v1.0.0'.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									"vault": schema.StringAttribute{
										...
										MarkdownDescription: "Vault defines the vault's name or uuid to access. Do NOT add op:// prefix. This will be done automatically.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
							...
							"oracle": schema.SingleNestedAttribute{
								...
								Computed: false,
								Validators: []validator.Object{
									objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("akeyless"), path.MatchRelative().AtParent().AtName("alibaba"), path.MatchRelative().AtParent().AtName("aws"), path.MatchRelative().AtParent().AtName("azurekv"), path.MatchRelative().AtParent().AtName("beyondtrust"), path.MatchRelative().AtParent().AtName("bitwardensecretsmanager"), path.MatchRelative().AtParent().AtName("chef"), path.MatchRelative().AtParent().AtName("cloudrusm"), path.MatchRelative().AtParent().AtName("conjur"), path.MatchRelative().AtParent().AtName("delinea"), path.MatchRelative().AtParent().AtName("device42"), path.MatchRelative().AtParent().AtName("doppler"), path.MatchRelative().AtParent().AtName("fake"), path.MatchRelative().AtParent().AtName("fortanix"), path.MatchRelative().AtParent().AtName("gcpsm"), path.MatchRelative().AtParent().AtName("github"), path.MatchRelative().AtParent().AtName("gitlab"), path.MatchRelative().AtParent().AtName("ibm"), path.MatchRelative().AtParent().AtName("infisical"), path.MatchRelative().AtParent().AtName("keepersecurity"), path.MatchRelative().AtParent().AtName("kubernetes"), path.MatchRelative().AtParent().AtName("onboardbase"), path.MatchRelative().AtParent().AtName("onepassword"), path.MatchRelative().AtParent().AtName("onepassword_sdk"), path.MatchRelative().AtParent().AtName("passbolt"), path.MatchRelative().AtParent().AtName("passworddepot"), path.MatchRelative().AtParent().AtName("previder"), path.MatchRelative().AtParent().AtName("pulumi"), path.MatchRelative().AtParent().AtName("scaleway"), path.MatchRelative().AtParent().AtName("secretserver"), path.MatchRelative().AtParent().AtName("senhasegura"), path.MatchRelative().AtParent().AtName("vault"), path.MatchRelative().AtParent().AtName("webhook"), path.MatchRelative().AtParent().AtName("yandexcertificatemanager"), path.MatchRelative().AtParent().AtName("yandexlockbox")),
								},
							},
							...
							"previder": schema.SingleNestedAttribute{
								Description:         "Previder configures this store to sync secrets using the Previder provider",
								MarkdownDescription: "Previder configures this store to sync secrets using the Previder provider",
								Attributes: map[string]schema.Attribute{
									"auth": schema.SingleNestedAttribute{
										Description:         "PreviderAuth contains a secretRef for credentials.",
										MarkdownDescription: "PreviderAuth contains a secretRef for credentials.",
										Attributes: map[string]schema.Attribute{
											"secret_ref": schema.SingleNestedAttribute{
												Description:         "PreviderAuthSecretRef holds secret references for Previder Vault credentials.",
												MarkdownDescription: "PreviderAuthSecretRef holds secret references for Previder Vault credentials.",
												Attributes: map[string]schema.Attribute{
													"access_token": schema.SingleNestedAttribute{
							...
							"pulumi": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"project": schema.StringAttribute{
										...
										MarkdownDescription: "Project is the name of the Pulumi ESC project the environment belongs to.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
							...
							"secretserver": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"password": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Password is the secret server account password.",
										Attributes: map[string]schema.Attribute{
											"secret_ref": schema.SingleNestedAttribute{
												Description:         "SecretRef references a key in a secret that will be used as value.",
												MarkdownDescription: "SecretRef references a key in a secret that will be used as value.",
									...
									"username": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Username is the secret server account username.",
										Attributes: map[string]schema.Attribute{
											"secret_ref": schema.SingleNestedAttribute{
												Description:         "SecretRef references a key in a secret that will be used as value.",
												MarkdownDescription: "SecretRef references a key in a secret that will be used as value.",
							...
							"yandexcertificatemanager": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"auth": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Auth defines the information necessary to authenticate against Yandex.Cloud",
										Attributes: map[string]schema.Attribute{
									...
									"fetching": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "FetchingPolicy configures the provider to interpret the 'data.secretKey.remoteRef.key' field in ExternalSecret as certificate ID or certificate name",
										Attributes: map[string]schema.Attribute{
											"by_id": schema.MapAttribute{
												...
												MarkdownDescription: "ByID configures the provider to interpret the 'data.secretKey.remoteRef.key' field in ExternalSecret as secret ID.",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.Map{
													mapvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("by_name")),
												},
											},
											...
											"by_name": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "ByName configures the provider to interpret the 'data.secretKey.remoteRef.key' field in ExternalSecret as secret name.",
												Attributes: map[string]schema.Attribute{
													"folder_id": schema.StringAttribute{
														Description:         "The folder to fetch secrets from",
														MarkdownDescription: "The folder to fetch secrets from",
														Required:            true,
														Optional:            false,
														Computed:            false,
													},
												...
												Computed: false,
												Validators: []validator.Object{
													objectvalidator.ExactlyOneOf(path.MatchRelative().AtParent().AtName("by_id")),
												},
											},
										},
										Required: false,
							...
							"yandexlockbox": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"fetching": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "FetchingPolicy configures the provider to interpret the 'data.secretKey.remoteRef.key' field in ExternalSecret as secret ID or secret name",
										Attributes: map[string]schema.Attribute{
											"by_id": schema.MapAttribute{
												Description:         "ByID configures the provider to interpret the 'data.secretKey.remoteRef.key' field in ExternalSecret as secret ID.",
												MarkdownDescription: "ByID configures the provider to interpret the 'data.secretKey.remoteRef.key' field in ExternalSecret as secret ID.",
...
func (r *ExternalSecretsIoSecretStoreV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_external_secrets_io_secret_store_v1_manifest")

	var model ExternalSecretsIoSecretStoreV1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("external-secrets.io/v1")
