...
var (
	_ datasource.DataSource = &ExternalSecretsIoExternalSecretV1Manifest{}
)

func NewExternalSecretsIoExternalSecretV1Manifest() datasource.DataSource {
	return &ExternalSecretsIoExternalSecretV1Manifest{}
}

type ExternalSecretsIoExternalSecretV1Manifest struct{}

type ExternalSecretsIoExternalSecretV1ManifestData struct {
...
func (r *ExternalSecretsIoExternalSecretV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_external_secrets_io_external_secret_v1_manifest"
}

func (r *ExternalSecretsIoExternalSecretV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExternalSecretsIoExternalSecretV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_external_secrets_io_external_secret_v1_manifest")

	var model ExternalSecretsIoExternalSecretV1ManifestData
