...
type JetstreamNatsIoStreamV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		AllowMsgTtl    *bool   `tfsdk:"allow_msg_ttl" json:"allowMsgTtl,omitempty"`
		...
		SubjectDeleteMarkerTtl *string `tfsdk:"subject_delete_marker_ttl" json:"subjectDeleteMarkerTtl,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"allow_msg_ttl": schema.BoolAttribute{
						Description:         "When true, allows header initiated per-message TTLs. If disabled, then the 'NATS-TTL' header will be ignored.",
						MarkdownDescription: "When true, allows header initiated per-message TTLs. If disabled, then the 'NATS-TTL' header will be ignored.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"js_domain": schema.StringAttribute{
						...
						MarkdownDescription: "The JetStream domain to use for the stream.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"subject_delete_marker_ttl": schema.StringAttribute{
						Description:         "Enables and sets a duration for adding server markers for delete, purge and max age limits.",
						MarkdownDescription: "Enables and sets a duration for adding server markers for delete, purge and max age limits.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
