			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"creds": schema.StringAttribute{
						...
						MarkdownDescription: "NATS user credentials for connecting to servers. Please make sure your controller has mounted the cerds on its path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"discard_per_subject": schema.BoolAttribute{
						...
						MarkdownDescription: "Allows to discard messages on a subject basis.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"republish": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"destination": schema.StringAttribute{
								...
								MarkdownDescription: "Messages will be additionally published to that subject.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"source": schema.StringAttribute{
								...
								MarkdownDescription: "Messages will be published from that subject to the destination subject.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
