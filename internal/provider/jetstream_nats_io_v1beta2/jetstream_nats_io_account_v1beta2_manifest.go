			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"token": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The token to be used to connect to the NATS Service.",
						Attributes: map[string]schema.Attribute{
							"secret": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										...
										MarkdownDescription: "Name of the secret with the token.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"token": schema.StringAttribute{
								...
								MarkdownDescription: "Key in the secret that contains the token.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"user": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The user and password to be used to connect to the NATS Service.",
						Attributes: map[string]schema.Attribute{
							"password": schema.StringAttribute{
								Description:         "Key in the secret that contains the password.",
								MarkdownDescription: "Key in the secret that contains the password.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"secret": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										...
										MarkdownDescription: "Name of the secret with the user and password.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"user": schema.StringAttribute{
								...
								MarkdownDescription: "Key in the secret that contains the user.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
