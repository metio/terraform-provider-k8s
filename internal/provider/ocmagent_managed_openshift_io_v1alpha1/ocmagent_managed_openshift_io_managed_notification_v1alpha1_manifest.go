...
var (
	_ datasource.DataSource = &OcmagentManagedOpenshiftIoManagedNotificationV1Alpha1Manifest{}
)

func NewOcmagentManagedOpenshiftIoManagedNotificationV1Alpha1Manifest() datasource.DataSource {
	return &OcmagentManagedOpenshiftIoManagedNotificationV1Alpha1Manifest{}
}
...
func (r *OcmagentManagedOpenshiftIoManagedNotificationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ocmagent_managed_openshift_io_managed_notification_v1alpha1_manifest"
}
...
func (r *OcmagentManagedOpenshiftIoManagedNotificationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "ManagedNotification is the Schema for the managednotifications API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ManagedNotificationSpec defines the desired state of ManagedNotification",
				Attributes: map[string]schema.Attribute{
					"notifications": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"active_body": schema.StringAttribute{
									Description:         "The body text of the Service Log notification when the alert is active",
									MarkdownDescription: "The body text of the Service Log notification when the alert is active",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"resend_wait": schema.Int64Attribute{
									...
									MarkdownDescription: "Measured in hours. The minimum time interval that must elapse between active Service Log notifications",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"resolved_body": schema.StringAttribute{
									...
									MarkdownDescription: "The body text of the Service Log notification when the alert is resolved",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"severity": schema.StringAttribute{
									...
									MarkdownDescription: "The severity of the Service Log notification",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"summary": schema.StringAttribute{
									...
									MarkdownDescription: "The summary line of the Service Log notification",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
...
func (r *OcmagentManagedOpenshiftIoManagedNotificationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ocmagent_managed_openshift_io_managed_notification_v1alpha1_manifest")

	var model OcmagentManagedOpenshiftIoManagedNotificationV1Alpha1ManifestData
	...
	model.Kind = pointer.String("ManagedNotification")
