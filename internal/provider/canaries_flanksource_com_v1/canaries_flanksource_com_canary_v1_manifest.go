...
type CanariesFlanksourceComCanaryV1ManifestData struct {
	...
	Spec *struct {
		Alertmanager *[]struct {
			...
			Relationships *map[string]string `tfsdk:"relationships" json:"relationships,omitempty"`
			Test          *struct {
				Expr       *string `tfsdk:"expr" json:"expr,omitempty"`
				Javascript *string `tfsdk:"javascript" json:"javascript,omitempty"`
				JsonPath   *string `tfsdk:"json_path" json:"jsonPath,omitempty"`
		...
		Exec *[]struct {
			...
			Connections *struct {
				...
				EksPodIdentity *bool   `tfsdk:"eks_pod_identity" json:"eksPodIdentity,omitempty"`
				FromConfigItem *string `tfsdk:"from_config_item" json:"fromConfigItem,omitempty"`
				Gcp            *struct {
					Connection  *string `tfsdk:"connection" json:"connection,omitempty"`
					Credentials *struct {
						Name      *string `tfsdk:"name" json:"name,omitempty"`
				...
				Kubernetes *struct {
					Cnrm *struct {
						ClusterResource          *string `tfsdk:"cluster_resource" json:"clusterResource,omitempty"`
						ClusterResourceNamespace *string `tfsdk:"cluster_resource_namespace" json:"clusterResourceNamespace,omitempty"`
						Gke                      *struct {
						...
						} `tfsdk:"gke" json:"gke,omitempty"`
					} `tfsdk:"cnrm" json:"cnrm,omitempty"`
					Connection *string `tfsdk:"connection" json:"connection,omitempty"`
					Eks        *struct {
						AccessKey *struct {
							Name      *string `tfsdk:"name" json:"name,omitempty"`
				...
				ServiceAccount *bool `tfsdk:"service_account" json:"serviceAccount,omitempty"`
		...
		Http *[]struct {
			...
			Crawl      *struct {
				...
				AllowedURLFilters    *[]string `tfsdk:"allowed_url_filters" json:"allowedURLFilters,omitempty"`
				Delay                *string   `tfsdk:"delay" json:"delay,omitempty"`
				Depth                *int64    `tfsdk:"depth" json:"depth,omitempty"`
				DisallowedDomains    *[]string `tfsdk:"disallowed_domains" json:"disallowedDomains,omitempty"`
				DisallowedURLFilters *[]string `tfsdk:"disallowed_url_filters" json:"disallowedURLFilters,omitempty"`
				Filters              *[]string `tfsdk:"filters" json:"filters,omitempty"`
				Parallelism          *int64    `tfsdk:"parallelism" json:"parallelism,omitempty"`
				RandomDelay          *string   `tfsdk:"random_delay" json:"randomDelay,omitempty"`
			} `tfsdk:"crawl" json:"crawl,omitempty"`
			Description *string `tfsdk:"description" json:"description,omitempty"`
			Display     *struct {
				Expr       *string `tfsdk:"expr" json:"expr,omitempty"`
				Javascript *string `tfsdk:"javascript" json:"javascript,omitempty"`
			...
			TlsConfig       *struct {
				...
				HandshakeTimeout   *string `tfsdk:"handshake_timeout" json:"handshakeTimeout,omitempty"`
					...
					"alertmanager": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"relationships": schema.MapAttribute{
									Description:         "",
									MarkdownDescription: "",
									ElementType:         types.StringType,
									Required:            false,
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"scope": schema.StringAttribute{
												Description:         "Scope is the reference for parent of the resource to select. For config items, the scope is the scraper id For checks, it's canaries and For components, it's topology. It can either be a uuid or namespace/name",
												MarkdownDescription: "Scope is the reference for parent of the resource to select. For config items, the scope is the scraper id For checks, it's canaries and For components, it's topology. It can either be a uuid or namespace/name",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
							...
							Attributes: map[string]schema.Attribute{
								...
								"checkout": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"type": schema.StringAttribute{
											Description:         "Type of connection e.g. github, gitlab",
											MarkdownDescription: "Type of connection e.g. github, gitlab",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
								...
								"connections": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"eks_pod_identity": schema.BoolAttribute{
											Description:         "EKSPodIdentity when enabled will allow access to AWS_* env vars",
											MarkdownDescription: "EKSPodIdentity when enabled will allow access to AWS_* env vars",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"from_config_item": schema.StringAttribute{
											Description:         "",
											MarkdownDescription: "",
											Required:            false,
											Optional:            true,
										...
										"kubernetes": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "",
											Attributes: map[string]schema.Attribute{
												"cnrm": schema.SingleNestedAttribute{
													Description:         "",
													MarkdownDescription: "",
													Attributes: map[string]schema.Attribute{
														"cluster_resource": schema.StringAttribute{
															Description:         "",
															MarkdownDescription: "",
															Required:            true,
															Optional:            false,
														...
														"cluster_resource_namespace": schema.StringAttribute{
															Description:         "",
															MarkdownDescription: "",
															Required:            true,
															Optional:            false,
												...
												"connection": schema.StringAttribute{
													...
													MarkdownDescription: "Connection name to populate kubeconfig",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},

												"eks": schema.SingleNestedAttribute{
													Description:         "",
													MarkdownDescription: "",
													Attributes: map[string]schema.Attribute{
														"access_key": schema.SingleNestedAttribute{
										...
										"service_account": schema.BoolAttribute{
											...
											MarkdownDescription: "ServiceAccount when enabled will allow access to KUBERNETES env vars",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"http": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"crawl": schema.SingleNestedAttribute{
									Description:         "Crawl site and verify links",
									MarkdownDescription: "Crawl site and verify links",
									Attributes: map[string]schema.Attribute{
										...
										"allowed_url_filters": schema.ListAttribute{
											Description:         "",
											MarkdownDescription: "",
											ElementType:         types.StringType,
											Required:            false,
										...
										"delay": schema.StringAttribute{
											Description:         "Delay is the duration to wait before creating a new request to the matching domains, defaults to 500ms",
											MarkdownDescription: "Delay is the duration to wait before creating a new request to the matching domains, defaults to 500ms",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"depth": schema.Int64Attribute{
											Description:         "Depth is the maximum number of links to follow.",
											MarkdownDescription: "Depth is the maximum number of links to follow.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"disallowed_domains": schema.ListAttribute{
											Description:         "",
											MarkdownDescription: "",
											ElementType:         types.StringType,
											Required:            false,
										...
										"disallowed_url_filters": schema.ListAttribute{
											Description:         "",
											MarkdownDescription: "",
											ElementType:         types.StringType,
											Required:            false,
										...
										"filters": schema.ListAttribute{
											Description:         "Filters is a list of regex filters to apply to the crawled links.",
											MarkdownDescription: "Filters is a list of regex filters to apply to the crawled links.",
											ElementType:         types.StringType,
											Required:            false,
											Optional:            true,
											Computed:            false,
										...
										"parallelism": schema.Int64Attribute{
											Description:         "Parallelism is the number of the maximum allowed concurrent requests, defaults to 2",
											MarkdownDescription: "Parallelism is the number of the maximum allowed concurrent requests, defaults to 2",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"random_delay": schema.StringAttribute{
											Description:         "RandomDelay is the extra randomized duration to wait added to Delay before creating a new request, defaults to 100ms",
											MarkdownDescription: "RandomDelay is the extra randomized duration to wait added to Delay before creating a new request, defaults to 100ms",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
								...
								"tls_config": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"handshake_timeout": schema.StringAttribute{
										...
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												...
												"scope": schema.SingleNestedAttribute{
													Description:         "Scope is the id of the parent of the resource to select. Example: For config items, the scope is the scraper id - for checks, it's canaries and - for components, it's topology. If left empty, the scope is the requester's scope. Use 'all' to disregard scope.",
													MarkdownDescription: "Scope is the id of the parent of the resource to select. Example: For config items, the scope is the scraper id - for checks, it's canaries and - for components, it's topology. If left empty, the scope is the requester's scope. Use 'all' to disregard scope.",
													Attributes: map[string]schema.Attribute{
														"expr": schema.StringAttribute{
															Description:         "",
															MarkdownDescription: "",
