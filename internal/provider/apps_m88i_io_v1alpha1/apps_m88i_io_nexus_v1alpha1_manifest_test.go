...
func TestAppsM88IIoNexusV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_apps_m88i_io_nexus_v1alpha1_manifest", testCase)
		})
	}
}
