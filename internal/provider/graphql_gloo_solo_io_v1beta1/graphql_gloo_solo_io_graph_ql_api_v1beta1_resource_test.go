...
func TestGraphqlGlooSoloIoGraphQLApiV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_graphql_gloo_solo_io_graph_ql_api_v1beta1", testCase)
		})
	}
}
