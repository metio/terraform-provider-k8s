...
var (
	_ datasource.DataSource              = &AppKiegroupOrgKogitoRuntimeV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppKiegroupOrgKogitoRuntimeV1Beta1DataSource{}
)

func NewAppKiegroupOrgKogitoRuntimeV1Beta1DataSource() datasource.DataSource {
	return &AppKiegroupOrgKogitoRuntimeV1Beta1DataSource{}
}

type AppKiegroupOrgKogitoRuntimeV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppKiegroupOrgKogitoRuntimeV1Beta1DataSourceData struct {
...
func (r *AppKiegroupOrgKogitoRuntimeV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_kiegroup_org_kogito_runtime_v1beta1"
}

func (r *AppKiegroupOrgKogitoRuntimeV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppKiegroupOrgKogitoRuntimeV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppKiegroupOrgKogitoRuntimeV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_app_kiegroup_org_kogito_runtime_v1beta1")

	var data AppKiegroupOrgKogitoRuntimeV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "app.kiegroup.org", Version: "v1beta1", Resource: "kogitoruntimes"}).
	...
	var readResponse AppKiegroupOrgKogitoRuntimeV1Beta1DataSourceData
	...
	data.Kind = pointer.String("KogitoRuntime")
