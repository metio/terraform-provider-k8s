...
var (
	_ datasource.DataSource              = &AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource{}
)

func NewAppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource() datasource.DataSource {
	return &AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource{}
}

type AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSourceData struct {
...
func (r *AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_kiegroup_org_kogito_supporting_service_v1beta1"
}

func (r *AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_app_kiegroup_org_kogito_supporting_service_v1beta1")

	var data AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSourceData
	...
	var readResponse AppKiegroupOrgKogitoSupportingServiceV1Beta1DataSourceData
	...
	data.Kind = pointer.String("KogitoSupportingService")
