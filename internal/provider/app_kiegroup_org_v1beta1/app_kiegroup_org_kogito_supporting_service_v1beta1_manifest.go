...
var (
	_ datasource.DataSource = &AppKiegroupOrgKogitoSupportingServiceV1Beta1Manifest{}
)

func NewAppKiegroupOrgKogitoSupportingServiceV1Beta1Manifest() datasource.DataSource {
	return &AppKiegroupOrgKogitoSupportingServiceV1Beta1Manifest{}
}

type AppKiegroupOrgKogitoSupportingServiceV1Beta1Manifest struct{}

type AppKiegroupOrgKogitoSupportingServiceV1Beta1ManifestData struct {
...
func (r *AppKiegroupOrgKogitoSupportingServiceV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_kiegroup_org_kogito_supporting_service_v1beta1_manifest"
}
...
func (r *AppKiegroupOrgKogitoSupportingServiceV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_app_kiegroup_org_kogito_supporting_service_v1beta1_manifest")

	var model AppKiegroupOrgKogitoSupportingServiceV1Beta1ManifestData
