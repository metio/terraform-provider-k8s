...
func TestAppKiegroupOrgKogitoSupportingServiceV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_app_kiegroup_org_kogito_supporting_service_v1beta1", testCase)
		})
	}
}
