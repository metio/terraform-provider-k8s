...
var (
	_ resource.Resource = (*DataFluidIoJindoRuntimeV1Alpha1Resource)(nil)
)

type DataFluidIoJindoRuntimeV1Alpha1TerraformModel struct {
...
type DataFluidIoJindoRuntimeV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		JindoVersion *struct {
			...
			ImageTag *string `tfsdk:"image_tag" yaml:"imageTag,omitempty"`
		} `tfsdk:"jindo_version" yaml:"jindoVersion,omitempty"`

		Labels *map[string]string `tfsdk:"labels" yaml:"labels,omitempty"`

		LogConfig *map[string]string `tfsdk:"log_config" yaml:"logConfig,omitempty"`
		...
		Networkmode *string `tfsdk:"networkmode" yaml:"networkmode,omitempty"`
...
func (r *DataFluidIoJindoRuntimeV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_data_fluid_io_jindo_runtime_v1alpha1"
}

func (r *DataFluidIoJindoRuntimeV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *DataFluidIoJindoRuntimeV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_data_fluid_io_jindo_runtime_v1alpha1")

	var state DataFluidIoJindoRuntimeV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel DataFluidIoJindoRuntimeV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("JindoRuntime")
...
func (r *DataFluidIoJindoRuntimeV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_data_fluid_io_jindo_runtime_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *DataFluidIoJindoRuntimeV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *DataFluidIoJindoRuntimeV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
