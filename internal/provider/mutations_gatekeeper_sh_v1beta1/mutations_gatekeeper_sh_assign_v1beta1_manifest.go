...
var (
	_ datasource.DataSource = &MutationsGatekeeperShAssignV1Beta1Manifest{}
)

func NewMutationsGatekeeperShAssignV1Beta1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShAssignV1Beta1Manifest{}
}

type MutationsGatekeeperShAssignV1Beta1Manifest struct{}

type MutationsGatekeeperShAssignV1Beta1ManifestData struct {
...
func (r *MutationsGatekeeperShAssignV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_v1beta1_manifest"
}

func (r *MutationsGatekeeperShAssignV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_v1beta1_manifest")

	var model MutationsGatekeeperShAssignV1Beta1ManifestData
