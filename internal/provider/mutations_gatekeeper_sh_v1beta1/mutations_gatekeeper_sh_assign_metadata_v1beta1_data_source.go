...
var (
	_ datasource.DataSource              = &MutationsGatekeeperShAssignMetadataV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &MutationsGatekeeperShAssignMetadataV1Beta1DataSource{}
)

func NewMutationsGatekeeperShAssignMetadataV1Beta1DataSource() datasource.DataSource {
	return &MutationsGatekeeperShAssignMetadataV1Beta1DataSource{}
}

type MutationsGatekeeperShAssignMetadataV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MutationsGatekeeperShAssignMetadataV1Beta1DataSourceData struct {
...
func (r *MutationsGatekeeperShAssignMetadataV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_metadata_v1beta1"
}

func (r *MutationsGatekeeperShAssignMetadataV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignMetadataV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MutationsGatekeeperShAssignMetadataV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mutations_gatekeeper_sh_assign_metadata_v1beta1")

	var data MutationsGatekeeperShAssignMetadataV1Beta1DataSourceData
	...
	var readResponse MutationsGatekeeperShAssignMetadataV1Beta1DataSourceData
