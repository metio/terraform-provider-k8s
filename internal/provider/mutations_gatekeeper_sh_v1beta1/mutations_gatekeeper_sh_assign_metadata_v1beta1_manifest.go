...
var (
	_ datasource.DataSource = &MutationsGatekeeperShAssignMetadataV1Beta1Manifest{}
)

func NewMutationsGatekeeperShAssignMetadataV1Beta1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShAssignMetadataV1Beta1Manifest{}
}

type MutationsGatekeeperShAssignMetadataV1Beta1Manifest struct{}

type MutationsGatekeeperShAssignMetadataV1Beta1ManifestData struct {
...
func (r *MutationsGatekeeperShAssignMetadataV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_metadata_v1beta1_manifest"
}

func (r *MutationsGatekeeperShAssignMetadataV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
									...
									"external_data": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"data_source": schema.StringAttribute{
												Description:         "DataSource specifies where to extract the data that will be sentto the external data provider as parameters.",
												MarkdownDescription: "DataSource specifies where to extract the data that will be sentto the external data provider as parameters.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
											...
											"default": schema.StringAttribute{
												Description:         "Default specifies the default value to use when the external dataprovider returns an error and the failure policy is set to 'UseDefault'.",
												MarkdownDescription: "Default specifies the default value to use when the external dataprovider returns an error and the failure policy is set to 'UseDefault'.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"failure_policy": schema.StringAttribute{
												Description:         "FailurePolicy specifies the policy to apply when the external dataprovider returns an error.",
												MarkdownDescription: "FailurePolicy specifies the policy to apply when the external dataprovider returns an error.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
...
func (r *MutationsGatekeeperShAssignMetadataV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_metadata_v1beta1_manifest")

	var model MutationsGatekeeperShAssignMetadataV1Beta1ManifestData
