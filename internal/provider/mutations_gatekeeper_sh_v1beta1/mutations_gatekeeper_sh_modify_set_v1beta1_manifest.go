...
var (
	_ datasource.DataSource = &MutationsGatekeeperShModifySetV1Beta1Manifest{}
)

func NewMutationsGatekeeperShModifySetV1Beta1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShModifySetV1Beta1Manifest{}
}

type MutationsGatekeeperShModifySetV1Beta1Manifest struct{}

type MutationsGatekeeperShModifySetV1Beta1ManifestData struct {
...
func (r *MutationsGatekeeperShModifySetV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_modify_set_v1beta1_manifest"
}

func (r *MutationsGatekeeperShModifySetV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShModifySetV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_modify_set_v1beta1_manifest")

	var model MutationsGatekeeperShModifySetV1Beta1ManifestData
