...
var (
	_ datasource.DataSource              = &MutationsGatekeeperShAssignV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &MutationsGatekeeperShAssignV1Beta1DataSource{}
)

func NewMutationsGatekeeperShAssignV1Beta1DataSource() datasource.DataSource {
	return &MutationsGatekeeperShAssignV1Beta1DataSource{}
}

type MutationsGatekeeperShAssignV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MutationsGatekeeperShAssignV1Beta1DataSourceData struct {
...
func (r *MutationsGatekeeperShAssignV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_v1beta1"
}

func (r *MutationsGatekeeperShAssignV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MutationsGatekeeperShAssignV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mutations_gatekeeper_sh_assign_v1beta1")

	var data MutationsGatekeeperShAssignV1Beta1DataSourceData
	...
	var readResponse MutationsGatekeeperShAssignV1Beta1DataSourceData
