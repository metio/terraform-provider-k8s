...
var (
	_ resource.Resource = (*KibanaK8SElasticCoKibanaV1Beta1Resource)(nil)
)

type KibanaK8SElasticCoKibanaV1Beta1TerraformModel struct {
...
type KibanaK8SElasticCoKibanaV1Beta1GoModel struct {
...
func (r *KibanaK8SElasticCoKibanaV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kibana_k8s_elastic_co_kibana_v1beta1"
}

func (r *KibanaK8SElasticCoKibanaV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *KibanaK8SElasticCoKibanaV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kibana_k8s_elastic_co_kibana_v1beta1")

	var state KibanaK8SElasticCoKibanaV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KibanaK8SElasticCoKibanaV1Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("kibana.k8s.elastic.co/v1beta1")
...
func (r *KibanaK8SElasticCoKibanaV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kibana_k8s_elastic_co_kibana_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *KibanaK8SElasticCoKibanaV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *KibanaK8SElasticCoKibanaV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
