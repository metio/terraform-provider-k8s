...
var (
	_ datasource.DataSource              = &KubeanIoClusterV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KubeanIoClusterV1Alpha1DataSource{}
)

func NewKubeanIoClusterV1Alpha1DataSource() datasource.DataSource {
	return &KubeanIoClusterV1Alpha1DataSource{}
}

type KubeanIoClusterV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KubeanIoClusterV1Alpha1DataSourceData struct {
...
func (r *KubeanIoClusterV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kubean_io_cluster_v1alpha1"
}

func (r *KubeanIoClusterV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KubeanIoClusterV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KubeanIoClusterV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kubean_io_cluster_v1alpha1")

	var data KubeanIoClusterV1Alpha1DataSourceData
	...
	var readResponse KubeanIoClusterV1Alpha1DataSourceData
