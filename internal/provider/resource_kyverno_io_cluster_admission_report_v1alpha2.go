...
var (
	_ resource.Resource = (*KyvernoIoClusterAdmissionReportV1Alpha2Resource)(nil)
)

type KyvernoIoClusterAdmissionReportV1Alpha2TerraformModel struct {
...
type KyvernoIoClusterAdmissionReportV1Alpha2GoModel struct {
...
func (r *KyvernoIoClusterAdmissionReportV1Alpha2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kyverno_io_cluster_admission_report_v1alpha2"
}

func (r *KyvernoIoClusterAdmissionReportV1Alpha2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *KyvernoIoClusterAdmissionReportV1Alpha2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kyverno_io_cluster_admission_report_v1alpha2")

	var state KyvernoIoClusterAdmissionReportV1Alpha2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KyvernoIoClusterAdmissionReportV1Alpha2GoModel
	...
	goModel.Kind = utilities.Ptr("ClusterAdmissionReport")
...
func (r *KyvernoIoClusterAdmissionReportV1Alpha2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_admission_report_v1alpha2")
	// NO-OP: All data is already in Terraform state
}

func (r *KyvernoIoClusterAdmissionReportV1Alpha2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *KyvernoIoClusterAdmissionReportV1Alpha2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
