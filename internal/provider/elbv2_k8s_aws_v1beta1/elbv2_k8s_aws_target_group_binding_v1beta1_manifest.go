...
var (
	_ datasource.DataSource = &Elbv2K8SAwsTargetGroupBindingV1Beta1Manifest{}
)

func NewElbv2K8SAwsTargetGroupBindingV1Beta1Manifest() datasource.DataSource {
	return &Elbv2K8SAwsTargetGroupBindingV1Beta1Manifest{}
}
...
type Elbv2K8SAwsTargetGroupBindingV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		TargetGroupProtocol *string `tfsdk:"target_group_protocol" json:"targetGroupProtocol,omitempty"`
		TargetType          *string `tfsdk:"target_type" json:"targetType,omitempty"`
		VpcID               *string `tfsdk:"vpc_id" json:"vpcID,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *Elbv2K8SAwsTargetGroupBindingV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_elbv2_k8s_aws_target_group_binding_v1beta1_manifest"
}

func (r *Elbv2K8SAwsTargetGroupBindingV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"target_group_protocol": schema.StringAttribute{
						Description:         "targetGroupProtocol is the Protocol of the TargetGroup. If unspecified, it will be automatically inferred.",
						MarkdownDescription: "targetGroupProtocol is the Protocol of the TargetGroup. If unspecified, it will be automatically inferred.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("HTTP", "HTTPS", "TCP", "TLS", "UDP", "TCP_UDP"),
						},
					},
...
func (r *Elbv2K8SAwsTargetGroupBindingV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_elbv2_k8s_aws_target_group_binding_v1beta1_manifest")

	var model Elbv2K8SAwsTargetGroupBindingV1Beta1ManifestData
