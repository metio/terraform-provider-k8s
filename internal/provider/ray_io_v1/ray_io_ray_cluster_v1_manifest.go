...
var (
	_ datasource.DataSource = &RayIoRayClusterV1Manifest{}
)

func NewRayIoRayClusterV1Manifest() datasource.DataSource {
	return &RayIoRayClusterV1Manifest{}
}

type RayIoRayClusterV1Manifest struct{}

type RayIoRayClusterV1ManifestData struct {
...
func (r *RayIoRayClusterV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ray_io_ray_cluster_v1_manifest"
}

func (r *RayIoRayClusterV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RayIoRayClusterV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ray_io_ray_cluster_v1_manifest")

	var model RayIoRayClusterV1ManifestData
