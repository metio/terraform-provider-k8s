...
var (
	_ datasource.DataSource = &RayIoRayServiceV1Manifest{}
)

func NewRayIoRayServiceV1Manifest() datasource.DataSource {
	return &RayIoRayServiceV1Manifest{}
}
...
type RayIoRayServiceV1ManifestData struct {
	...
	Spec *struct {
		DeploymentUnhealthySecondThreshold *int64 `tfsdk:"deployment_unhealthy_second_threshold" json:"deploymentUnhealthySecondThreshold,omitempty"`
		ExcludeHeadPodFromServeSvc         *bool  `tfsdk:"exclude_head_pod_from_serve_svc" json:"excludeHeadPodFromServeSvc,omitempty"`
		RayClusterConfig                   *struct {
			AutoscalerOptions *struct {
				...
				IdleTimeoutSeconds *int64  `tfsdk:"idle_timeout_seconds" json:"idleTimeoutSeconds,omitempty"`
			...
			GcsFaultToleranceOptions *struct {
				ExternalStorageNamespace *string `tfsdk:"external_storage_namespace" json:"externalStorageNamespace,omitempty"`
				RedisAddress             *string `tfsdk:"redis_address" json:"redisAddress,omitempty"`
				RedisPassword            *struct {
					Value     *string `tfsdk:"value" json:"value,omitempty"`
					ValueFrom *struct {
						ConfigMapKeyRef *struct {
							Key      *string `tfsdk:"key" json:"key,omitempty"`
				...
				} `tfsdk:"redis_password" json:"redisPassword,omitempty"`
				RedisUsername *struct {
					Value     *string `tfsdk:"value" json:"value,omitempty"`
					ValueFrom *struct {
						ConfigMapKeyRef *struct {
							Key      *string `tfsdk:"key" json:"key,omitempty"`
				...
				} `tfsdk:"redis_username" json:"redisUsername,omitempty"`
			} `tfsdk:"gcs_fault_tolerance_options" json:"gcsFaultToleranceOptions,omitempty"`
			HeadGroupSpec *struct {
				EnableIngress *bool `tfsdk:"enable_ingress" json:"enableIngress,omitempty"`
				HeadService   *struct {
					ApiVersion *string `tfsdk:"api_version" json:"apiVersion,omitempty"`
				...
				} `tfsdk:"head_service" json:"headService,omitempty"`
				RayStartParams *map[string]string `tfsdk:"ray_start_params" json:"rayStartParams,omitempty"`
			...
			} `tfsdk:"head_group_spec" json:"headGroupSpec,omitempty"`
			HeadServiceAnnotations *map[string]string `tfsdk:"head_service_annotations" json:"headServiceAnnotations,omitempty"`
			ManagedBy              *string            `tfsdk:"managed_by" json:"managedBy,omitempty"`
			RayVersion             *string            `tfsdk:"ray_version" json:"rayVersion,omitempty"`
			...
			WorkerGroupSpecs       *[]struct {
				...
				NumOfHosts         *int64             `tfsdk:"num_of_hosts" json:"numOfHosts,omitempty"`
				RayStartParams     *map[string]string `tfsdk:"ray_start_params" json:"rayStartParams,omitempty"`
				Replicas           *int64             `tfsdk:"replicas" json:"replicas,omitempty"`
				ScaleStrategy      *struct {
					WorkersToDelete *[]string `tfsdk:"workers_to_delete" json:"workersToDelete,omitempty"`
				} `tfsdk:"scale_strategy" json:"scaleStrategy,omitempty"`
				Suspend  *bool `tfsdk:"suspend" json:"suspend,omitempty"`
				Template *struct {
					Metadata *struct {
						Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			...
			} `tfsdk:"worker_group_specs" json:"workerGroupSpecs,omitempty"`
		} `tfsdk:"ray_cluster_config" json:"rayClusterConfig,omitempty"`
		RayClusterDeletionDelaySeconds *int64  `tfsdk:"ray_cluster_deletion_delay_seconds" json:"rayClusterDeletionDelaySeconds,omitempty"`
		ServeConfigV2                  *string `tfsdk:"serve_config_v2" json:"serveConfigV2,omitempty"`
		ServeService                   *struct {
			ApiVersion *string `tfsdk:"api_version" json:"apiVersion,omitempty"`
			Kind       *string `tfsdk:"kind" json:"kind,omitempty"`
			Metadata   *struct {
		...
		} `tfsdk:"serve_service" json:"serveService,omitempty"`
		ServiceUnhealthySecondThreshold *int64 `tfsdk:"service_unhealthy_second_threshold" json:"serviceUnhealthySecondThreshold,omitempty"`
		UpgradeStrategy                 *struct {
			Type *string `tfsdk:"type" json:"type,omitempty"`
		} `tfsdk:"upgrade_strategy" json:"upgradeStrategy,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RayIoRayServiceV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ray_io_ray_service_v1_manifest"
}

func (r *RayIoRayServiceV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "",
				Attributes: map[string]schema.Attribute{
					"deployment_unhealthy_second_threshold": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"exclude_head_pod_from_serve_svc": schema.BoolAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"ray_cluster_config": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"autoscaler_options": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									...
									"upscaling_mode": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("Default", "Aggressive", "Conservative"),
										},
									},
							...
							"enable_in_tree_autoscaling": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"gcs_fault_tolerance_options": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									"external_storage_namespace": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
									...
									"redis_address": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            true,
										Optional:            false,
									...
									"redis_password": schema.SingleNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										Attributes: map[string]schema.Attribute{
											"value": schema.StringAttribute{
									...
									"redis_username": schema.SingleNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										Attributes: map[string]schema.Attribute{
											"value": schema.StringAttribute{
							...
							"head_group_spec": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									"enable_ingress": schema.BoolAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
									...
									"head_service": schema.SingleNestedAttribute{
										Description:         "",
										MarkdownDescription: "",
										Attributes: map[string]schema.Attribute{
											"api_version": schema.StringAttribute{
									...
									"ray_start_params": schema.MapAttribute{
										Description:         "",
										MarkdownDescription: "",
										ElementType:         types.StringType,
										Required:            false,
							...
							"head_service_annotations": schema.MapAttribute{
								Description:         "",
								MarkdownDescription: "",
								ElementType:         types.StringType,
								Required:            false,
							...
							"worker_group_specs": schema.ListNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"scale_strategy": schema.SingleNestedAttribute{
											Description:         "",
											MarkdownDescription: "",
											Attributes: map[string]schema.Attribute{
												"workers_to_delete": schema.ListAttribute{
													Description:         "",
													MarkdownDescription: "",
													ElementType:         types.StringType,
													Required:            false,
					...
					"ray_cluster_deletion_delay_seconds": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"serve_config_v2": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"serve_service": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"api_version": schema.StringAttribute{
					...
					"service_unhealthy_second_threshold": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"upgrade_strategy": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"type": schema.StringAttribute{
...
func (r *RayIoRayServiceV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ray_io_ray_service_v1_manifest")

	var model RayIoRayServiceV1ManifestData
