...
var (
	_ datasource.DataSource              = &KyvernoIoPolicyV2Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoPolicyV2Beta1DataSource{}
)

func NewKyvernoIoPolicyV2Beta1DataSource() datasource.DataSource {
	return &KyvernoIoPolicyV2Beta1DataSource{}
}

type KyvernoIoPolicyV2Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoPolicyV2Beta1DataSourceData struct {
...
func (r *KyvernoIoPolicyV2Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_policy_v2beta1"
}

func (r *KyvernoIoPolicyV2Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoPolicyV2Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoPolicyV2Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_policy_v2beta1")

	var data KyvernoIoPolicyV2Beta1DataSourceData
	...
	var readResponse KyvernoIoPolicyV2Beta1DataSourceData
