...
var (
	_ datasource.DataSource = &KyvernoIoPolicyExceptionV2Beta1Manifest{}
)

func NewKyvernoIoPolicyExceptionV2Beta1Manifest() datasource.DataSource {
	return &KyvernoIoPolicyExceptionV2Beta1Manifest{}
}

type KyvernoIoPolicyExceptionV2Beta1Manifest struct{}

type KyvernoIoPolicyExceptionV2Beta1ManifestData struct {
...
func (r *KyvernoIoPolicyExceptionV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_policy_exception_v2beta1_manifest"
}

func (r *KyvernoIoPolicyExceptionV2Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoPolicyExceptionV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_policy_exception_v2beta1_manifest")

	var model KyvernoIoPolicyExceptionV2Beta1ManifestData
