...
var (
	_ datasource.DataSource = &KyvernoIoClusterCleanupPolicyV2Beta1Manifest{}
)

func NewKyvernoIoClusterCleanupPolicyV2Beta1Manifest() datasource.DataSource {
	return &KyvernoIoClusterCleanupPolicyV2Beta1Manifest{}
}

type KyvernoIoClusterCleanupPolicyV2Beta1Manifest struct{}

type KyvernoIoClusterCleanupPolicyV2Beta1ManifestData struct {
...
func (r *KyvernoIoClusterCleanupPolicyV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_cleanup_policy_v2beta1_manifest"
}

func (r *KyvernoIoClusterCleanupPolicyV2Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterCleanupPolicyV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_cleanup_policy_v2beta1_manifest")

	var model KyvernoIoClusterCleanupPolicyV2Beta1ManifestData
