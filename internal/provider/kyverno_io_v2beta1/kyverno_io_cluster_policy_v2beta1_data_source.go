...
var (
	_ datasource.DataSource              = &KyvernoIoClusterPolicyV2Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoClusterPolicyV2Beta1DataSource{}
)

func NewKyvernoIoClusterPolicyV2Beta1DataSource() datasource.DataSource {
	return &KyvernoIoClusterPolicyV2Beta1DataSource{}
}

type KyvernoIoClusterPolicyV2Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoClusterPolicyV2Beta1DataSourceData struct {
...
func (r *KyvernoIoClusterPolicyV2Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_policy_v2beta1"
}

func (r *KyvernoIoClusterPolicyV2Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterPolicyV2Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoClusterPolicyV2Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_cluster_policy_v2beta1")

	var data KyvernoIoClusterPolicyV2Beta1DataSourceData
	...
	var readResponse KyvernoIoClusterPolicyV2Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("kyverno.io/v2beta1")
	data.Kind = pointer.String("ClusterPolicy")
