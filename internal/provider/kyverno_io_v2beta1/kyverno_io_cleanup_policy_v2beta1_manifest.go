...
var (
	_ datasource.DataSource = &KyvernoIoCleanupPolicyV2Beta1Manifest{}
)

func NewKyvernoIoCleanupPolicyV2Beta1Manifest() datasource.DataSource {
	return &KyvernoIoCleanupPolicyV2Beta1Manifest{}
}

type KyvernoIoCleanupPolicyV2Beta1Manifest struct{}

type KyvernoIoCleanupPolicyV2Beta1ManifestData struct {
...
func (r *KyvernoIoCleanupPolicyV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cleanup_policy_v2beta1_manifest"
}

func (r *KyvernoIoCleanupPolicyV2Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoCleanupPolicyV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cleanup_policy_v2beta1_manifest")

	var model KyvernoIoCleanupPolicyV2Beta1ManifestData
