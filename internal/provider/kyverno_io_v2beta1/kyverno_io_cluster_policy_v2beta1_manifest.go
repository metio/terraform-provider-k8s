...
var (
	_ datasource.DataSource = &KyvernoIoClusterPolicyV2Beta1Manifest{}
)

func NewKyvernoIoClusterPolicyV2Beta1Manifest() datasource.DataSource {
	return &KyvernoIoClusterPolicyV2Beta1Manifest{}
}
...
func (r *KyvernoIoClusterPolicyV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_policy_v2beta1_manifest"
}

func (r *KyvernoIoClusterPolicyV2Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterPolicyV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_policy_v2beta1_manifest")

	var model KyvernoIoClusterPolicyV2Beta1ManifestData
