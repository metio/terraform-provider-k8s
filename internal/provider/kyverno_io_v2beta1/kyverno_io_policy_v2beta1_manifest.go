...
var (
	_ datasource.DataSource = &KyvernoIoPolicyV2Beta1Manifest{}
)

func NewKyvernoIoPolicyV2Beta1Manifest() datasource.DataSource {
	return &KyvernoIoPolicyV2Beta1Manifest{}
}

type KyvernoIoPolicyV2Beta1Manifest struct{}

type KyvernoIoPolicyV2Beta1ManifestData struct {
...
func (r *KyvernoIoPolicyV2Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_policy_v2beta1_manifest"
}
...
func (r *KyvernoIoPolicyV2Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_policy_v2beta1_manifest")

	var model KyvernoIoPolicyV2Beta1ManifestData
