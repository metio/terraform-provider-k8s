			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
							...
							"pdb": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"selector": schema.SingleNestedAttribute{
										Description:         "Label query over pods whose evictions are managed by the disruptionbudget.A null selector will match no pods, while an empty ({}) selector will selectall pods within the namespace.",
										MarkdownDescription: "Label query over pods whose evictions are managed by the disruptionbudget.A null selector will match no pods, while an empty ({}) selector will selectall pods within the namespace.",
										Attributes: map[string]schema.Attribute{
											"match_expressions": schema.ListNestedAttribute{
												Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
												MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"cache": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"pvc": schema.StringAttribute{
								Description:         "PersistenVolumeClaim name that will be used by Redis podsIf defined, the PVC must be provisioned by the user and the operator will onlyconfigure the deployment to use it",
								MarkdownDescription: "PersistenVolumeClaim name that will be used by Redis podsIf defined, the PVC must be provisioned by the user and the operator will onlyconfigure the deployment to use it",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"custom_pulp_settings": schema.StringAttribute{
						Description:         "Name of the ConfigMap to define Pulp configurations not availablethrough this CR.",
						MarkdownDescription: "Name of the ConfigMap to define Pulp configurations not availablethrough this CR.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"database": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"postgres_storage_requirements": schema.StringAttribute{
								Description:         "Temporarily modifying it as a string to avoid an issue with backup and json.Unmarshalwhen set as resource.Quantity and no value passed on pulp CR, during backup stepsjson.Unmarshal is settings it with '0'",
								MarkdownDescription: "Temporarily modifying it as a string to avoid an issue with backup and json.Unmarshalwhen set as resource.Quantity and no value passed on pulp CR, during backup stepsjson.Unmarshal is settings it with '0'",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"pvc": schema.StringAttribute{
								Description:         "PersistenVolumeClaim name that will be used by database podsIf defined, the PVC must be provisioned by the user and the operator will onlyconfigure the deployment to use it",
								MarkdownDescription: "PersistenVolumeClaim name that will be used by database podsIf defined, the PVC must be provisioned by the user and the operator will onlyconfigure the deployment to use it",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"disable_migrations": schema.BoolAttribute{
						Description:         "Disable database migrations. Useful for situations in which we don't wantto automatically run the database migrations, for example, during restore.",
						MarkdownDescription: "Disable database migrations. Useful for situations in which we don't wantto automatically run the database migrations, for example, during restore.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"enable_debugging": schema.BoolAttribute{
						Description:         "By default Pulp logs at INFO level, but enabling DEBUG logging can be ahelpful thing to get more insight when things don’t go as expected.Default: false",
						MarkdownDescription: "By default Pulp logs at INFO level, but enabling DEBUG logging can be ahelpful thing to get more insight when things don’t go as expected.Default: false",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"pulp_settings": schema.MapAttribute{
						Description:         "[DEPRECATED] Definition of /etc/pulp/settings.py config file.This field is deprecated and will be removed in the future, use thecustom_pulp_settings field instead.",
						MarkdownDescription: "[DEPRECATED] Definition of /etc/pulp/settings.py config file.This field is deprecated and will be removed in the future, use thecustom_pulp_settings field instead.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"pvc": schema.StringAttribute{
						Description:         "PersistenVolumeClaim name that will be used by Pulp pods.If defined, the PVC must be provisioned by the user and the operator will onlyconfigure the deployment to use it",
						MarkdownDescription: "PersistenVolumeClaim name that will be used by Pulp pods.If defined, the PVC must be provisioned by the user and the operator will onlyconfigure the deployment to use it",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"signing_scripts_configmap": schema.StringAttribute{
						Description:         "[DEPRECATED] ConfigMap where the signing scripts are stored.This field is deprecated and will be removed in the future, use thesigning_scripts field instead.",
						MarkdownDescription: "[DEPRECATED] ConfigMap where the signing scripts are stored.This field is deprecated and will be removed in the future, use thesigning_scripts field instead.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"telemetry": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"enabled": schema.BoolAttribute{
								Description:         "Enable Pulp TelemetryDefault: false",
								MarkdownDescription: "Enable Pulp TelemetryDefault: false",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"exporter_otlp_protocol": schema.StringAttribute{
								Description:         "Defines the protocol used by the instrumentator to comunicate with the collectorDefault: http/protobuf",
								MarkdownDescription: "Defines the protocol used by the instrumentator to comunicate with the collectorDefault: http/protobuf",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"web": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"tls_termination_mechanism": schema.StringAttribute{
								Description:         "The secure TLS termination mechanism to useDefault: 'edge'",
								MarkdownDescription: "The secure TLS termination mechanism to useDefault: 'edge'",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
