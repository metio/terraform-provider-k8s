					...
					"auth": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"password_key": schema.StringAttribute{
								Description:         "PasswordKey specifies the key within the Kubernetes secret that contains the password for authentication.",
								MarkdownDescription: "PasswordKey specifies the key within the Kubernetes secret that contains the password for authentication.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"username_key": schema.StringAttribute{
								Description:         "UsernameKey specifies the key within the Kubernetes secret that contains the username for authentication.",
								MarkdownDescription: "UsernameKey specifies the key within the Kubernetes secret that contains the username for authentication.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
