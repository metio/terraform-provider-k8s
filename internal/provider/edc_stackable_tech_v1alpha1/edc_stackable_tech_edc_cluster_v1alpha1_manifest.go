...
package edc_stackable_tech_v1alpha1
...
var (
	_ datasource.DataSource = &EdcStackableTechEdcclusterV1Alpha1Manifest{}
)

func NewEdcStackableTechEdcclusterV1Alpha1Manifest() datasource.DataSource {
	return &EdcStackableTechEdcclusterV1Alpha1Manifest{}
}

type EdcStackableTechEdcclusterV1Alpha1Manifest struct{}

type EdcStackableTechEdcclusterV1Alpha1ManifestData struct {
	...
	Spec *struct {
		ClusterConfig *struct {
			...
			} `tfsdk:"ionos" json:"ionos,omitempty"`
...
func (r *EdcStackableTechEdcclusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_edc_stackable_tech_edc_cluster_v1alpha1_manifest"
}

func (r *EdcStackableTechEdcclusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Auto-generated derived type for EDCClusterSpec via 'CustomResource'",
		MarkdownDescription: "Auto-generated derived type for EDCClusterSpec via 'CustomResource'",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cluster_config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "General Hive metastore cluster settings",
						Attributes: map[string]schema.Attribute{
							...
							"ionos": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
					...
					"connectors": schema.SingleNestedAttribute{
					...
					"image": schema.SingleNestedAttribute{
						Description:         "The image to use. In this example this will be an nginx image",
						MarkdownDescription: "The image to use. In this example this will be an nginx image",
						Attributes: map[string]schema.Attribute{
...
func (r *EdcStackableTechEdcclusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_edc_stackable_tech_edc_cluster_v1alpha1_manifest")

	var model EdcStackableTechEdcclusterV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("edc.stackable.tech/v1alpha1")
	model.Kind = pointer.String("EDCCluster")
