		...
		Bgp *struct {
			...
			Routers *[]struct {
				...
				Neighbors *[]struct {
					...
					DualStackAddressFamily *bool   `tfsdk:"dual_stack_address_family" json:"dualStackAddressFamily,omitempty"`
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													...
													"disable_mp": schema.BoolAttribute{
														Description:         "To set if we want to disable MP BGP that will separate IPv4 and IPv6 route exchanges into distinct BGP sessions. Deprecated: DisableMP is deprecated in favor of dualStackAddressFamily.",
														MarkdownDescription: "To set if we want to disable MP BGP that will separate IPv4 and IPv6 route exchanges into distinct BGP sessions. Deprecated: DisableMP is deprecated in favor of dualStackAddressFamily.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},

													"dual_stack_address_family": schema.BoolAttribute{
														Description:         "To set if we want to enable the neighbor not only for the ipfamily related to its session, but also the other one. This allows to advertise/receive IPv4 prefixes over IPv6 sessions and vice versa.",
														MarkdownDescription: "To set if we want to enable the neighbor not only for the ipfamily related to its session, but also the other one. This allows to advertise/receive IPv4 prefixes over IPv6 sessions and vice versa.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
