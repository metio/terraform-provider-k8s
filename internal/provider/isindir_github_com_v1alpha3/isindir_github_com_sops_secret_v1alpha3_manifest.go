...
package isindir_github_com_v1alpha3
...
var (
	_ datasource.DataSource = &IsindirGithubComSopsSecretV1Alpha3Manifest{}
)

func NewIsindirGithubComSopsSecretV1Alpha3Manifest() datasource.DataSource {
	return &IsindirGithubComSopsSecretV1Alpha3Manifest{}
}

type IsindirGithubComSopsSecretV1Alpha3Manifest struct{}

type IsindirGithubComSopsSecretV1Alpha3ManifestData struct {
...
func (r *IsindirGithubComSopsSecretV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_isindir_github_com_sops_secret_v1alpha3_manifest"
}

func (r *IsindirGithubComSopsSecretV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *IsindirGithubComSopsSecretV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_isindir_github_com_sops_secret_v1alpha3_manifest")

	var model IsindirGithubComSopsSecretV1Alpha3ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("isindir.github.com/v1alpha3")
