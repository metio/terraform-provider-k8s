...
var (
	_ resource.Resource = (*CephRookIoCephRBDMirrorV1Resource)(nil)
)

type CephRookIoCephRBDMirrorV1TerraformModel struct {
...
type CephRookIoCephRBDMirrorV1GoModel struct {
...
func (r *CephRookIoCephRBDMirrorV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ceph_rook_io_ceph_rbd_mirror_v1"
}

func (r *CephRookIoCephRBDMirrorV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				...
				MarkdownDescription: "RBDMirroringSpec represents the specification of an RBD mirror daemon",
				...
				Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
					...
					"count": {
						...
						MarkdownDescription: "Count represents the number of rbd mirror instance to run",
					...
					"priority_class_name": {
						...
						MarkdownDescription: "PriorityClassName sets priority class on the rbd mirror pods",
					...
					"resources": {
						...
						MarkdownDescription: "The resource requirements for the rbd mirror pods",
...
func (r *CephRookIoCephRBDMirrorV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_ceph_rook_io_ceph_rbd_mirror_v1")

	var state CephRookIoCephRBDMirrorV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CephRookIoCephRBDMirrorV1GoModel
	...
	goModel.Kind = utilities.Ptr("CephRBDMirror")
...
func (r *CephRookIoCephRBDMirrorV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ceph_rook_io_ceph_rbd_mirror_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *CephRookIoCephRBDMirrorV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CephRookIoCephRBDMirrorV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
