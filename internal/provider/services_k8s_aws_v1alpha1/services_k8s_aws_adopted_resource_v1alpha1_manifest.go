			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"aws": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"additional_keys": schema.MapAttribute{
								Description:         "AdditionalKeys represents any additional arbitrary identifiers used whendescribing the target resource.",
								MarkdownDescription: "AdditionalKeys represents any additional arbitrary identifiers used whendescribing the target resource.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"arn": schema.StringAttribute{
								Description:         "ARN is the AWS Resource Name for the resource. It is a globallyunique identifier.",
								MarkdownDescription: "ARN is the AWS Resource Name for the resource. It is a globallyunique identifier.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"name_or_id": schema.StringAttribute{
								Description:         "NameOrId is a user-supplied string identifier for the resource. It mayor may not be globally unique, depending on the type of resource.",
								MarkdownDescription: "NameOrId is a user-supplied string identifier for the resource. It mayor may not be globally unique, depending on the type of resource.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"kubernetes": schema.SingleNestedAttribute{
						Description:         "ResourceWithMetadata provides the values necessary to create aKubernetes resource and override any of its metadata values.",
						MarkdownDescription: "ResourceWithMetadata provides the values necessary to create aKubernetes resource and override any of its metadata values.",
						Attributes: map[string]schema.Attribute{
							...
							"metadata": schema.SingleNestedAttribute{
								Description:         "ObjectMeta is metadata that all persisted resources must have, which includes all objectsusers must create.It is not possible to use 'metav1.ObjectMeta' inside spec, as the controller-genautomatically converts this to an arbitrary string-string map.https://github.com/kubernetes-sigs/controller-tools/issues/385Active discussion about inclusion of this field in the spec is happening in this PR:https://github.com/kubernetes-sigs/controller-tools/pull/395Until this is allowed, or if it never is, we will produce a subset of the object metathat contains only the fields which the user is allowed to modify in the metadata.",
