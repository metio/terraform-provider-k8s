...
var (
	_ datasource.DataSource              = &StorageK8SIoVolumeAttachmentV1DataSource{}
	_ datasource.DataSourceWithConfigure = &StorageK8SIoVolumeAttachmentV1DataSource{}
)

func NewStorageK8SIoVolumeAttachmentV1DataSource() datasource.DataSource {
	return &StorageK8SIoVolumeAttachmentV1DataSource{}
}

type StorageK8SIoVolumeAttachmentV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type StorageK8SIoVolumeAttachmentV1DataSourceData struct {
...
func (r *StorageK8SIoVolumeAttachmentV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_storage_k8s_io_volume_attachment_v1"
}

func (r *StorageK8SIoVolumeAttachmentV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *StorageK8SIoVolumeAttachmentV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *StorageK8SIoVolumeAttachmentV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_storage_k8s_io_volume_attachment_v1")

	var data StorageK8SIoVolumeAttachmentV1DataSourceData
	...
	var readResponse StorageK8SIoVolumeAttachmentV1DataSourceData
