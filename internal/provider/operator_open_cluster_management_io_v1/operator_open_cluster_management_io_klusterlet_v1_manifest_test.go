...
func TestOperatorOpenClusterManagementIoKlusterletV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_operator_open_cluster_management_io_klusterlet_v1_manifest", testCase)
		})
	}
}
