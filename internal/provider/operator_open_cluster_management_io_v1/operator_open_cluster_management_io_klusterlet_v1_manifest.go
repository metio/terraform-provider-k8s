					...
					"registration_configuration": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"cluster_labels": schema.MapAttribute{
								Description:         "ClusterLabels is labels set on ManagedCluster when creating only, other actors can update it afterwards.",
								MarkdownDescription: "ClusterLabels is labels set on ManagedCluster when creating only, other actors can update it afterwards.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
