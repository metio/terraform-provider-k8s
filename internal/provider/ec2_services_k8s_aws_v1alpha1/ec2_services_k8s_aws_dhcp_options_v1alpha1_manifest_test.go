...
func TestEc2ServicesK8SAwsDHCPOptionsV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_ec2_services_k8s_aws_dhcp_options_v1alpha1_manifest", testCase)
		})
	}
}
