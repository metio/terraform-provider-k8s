...
var (
	_ datasource.DataSource              = &Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource{}
)

func NewEc2ServicesK8SAwsNatgatewayV1Alpha1DataSource() datasource.DataSource {
	return &Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource{}
}

type Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSourceData struct {
...
func (r *Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ec2_services_k8s_aws_nat_gateway_v1alpha1"
}

func (r *Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_ec2_services_k8s_aws_nat_gateway_v1alpha1")

	var data Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "ec2.services.k8s.aws", Version: "v1alpha1", Resource: "natgateways"}).
	...
	var readResponse Ec2ServicesK8SAwsNatgatewayV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("NATGateway")
