		...
		Reconcile *struct {
			Host *struct {
				Wait *struct {
					...
					Replicas *struct {
						All   *string `tfsdk:"all" json:"all,omitempty"`
						Delay *int64  `tfsdk:"delay" json:"delay,omitempty"`
						New   *string `tfsdk:"new" json:"new,omitempty"`
					...
					"clickhouse": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"addons": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Configuration addons specifies additional settings",
								Attributes: map[string]schema.Attribute{
														...
														"configuration": schema.SingleNestedAttribute{
															...
															Attributes: map[string]schema.Attribute{
																"files": schema.MapAttribute{
																	...
																	MarkdownDescription: "see same section from CR spec",
																	ElementType:         types.StringType,
																	Required:            false,
																	Optional:            true,
																	Computed:            false,
									...
									"wait": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"replicas": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "Whether the operator during reconcile procedure should wait for replicas to catch-up",
												Attributes: map[string]schema.Attribute{
													"all": schema.StringAttribute{
														...
														MarkdownDescription: "Whether the operator during reconcile procedure should wait for all replicas to catch-up",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.String{
													...
													"delay": schema.Int64Attribute{
														...
														MarkdownDescription: "replication max absolute delay to consider replica is not delayed",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
													...
													"new": schema.StringAttribute{
														...
														MarkdownDescription: "Whether the operator during reconcile procedure should wait for new replicas to catch-up",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.String{
