																		...
																		"templates": schema.SingleNestedAttribute{
																			...
																			Attributes: map[string]schema.Attribute{
																				...
																				"service_template": schema.StringAttribute{
																					...
																					MarkdownDescription: "optional, template name from chi.spec.templates.serviceTemplates, allows customization for one 'Service' resource which will created by 'clickhouse-operator' which cover all clusters in whole 'chi' resource",
																					Required:            false,
																					Optional:            true,
																					Computed:            false,
																				},
					...
					"defaults": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"replicas_use_fqdn": schema.StringAttribute{
								Description:         "define should replicas be specified by FQDN in '<host></host>'. In case of 'no' will use short hostname and clickhouse-server will use kubernetes default suffixes for DNS lookup 'yes' by default ",
								MarkdownDescription: "define should replicas be specified by FQDN in '<host></host>'. In case of 'no' will use short hostname and clickhouse-server will use kubernetes default suffixes for DNS lookup 'yes' by default ",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
