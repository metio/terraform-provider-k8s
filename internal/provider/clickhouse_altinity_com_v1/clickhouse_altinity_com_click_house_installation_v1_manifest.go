	...
	Spec *struct {
		...
		Reconciling            *struct {
			...
			Macros                      *struct {
				...
				} `tfsdk:"sections" json:"sections,omitempty"`
			} `tfsdk:"macros" json:"macros,omitempty"`
				...
				Attributes: map[string]schema.Attribute{
					"configuration": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"files": schema.MapAttribute{
								Description:         "allows define content of any setting file inside each 'Pod' during generate 'ConfigMap' which will mount in '/etc/clickhouse-server/config.d/' or '/etc/clickhouse-server/conf.d/' or '/etc/clickhouse-server/users.d/' every key in this object is the file name every value in this object is the file content you can use '!!binary |' and base64 for binary files, see details here https://yaml.org/type/binary.html each key could contains prefix like {common}, {users}, {hosts} or config.d, users.d, conf.d, wrong prefixes will be ignored, subfolders also will be ignored More details: https://github.com/Altinity/clickhouse-operator/blob/master/docs/chi-examples/05-settings-05-files-nested.yaml any key could contains 'valueFrom' with 'secretKeyRef' which allow pass values from kubernetes secrets secrets will mounted into pod as separate volume in /etc/clickhouse-server/secrets.d/ and will automatically update when update secret it useful for pass SSL certificates from cert-manager or similar tool look into https://github.com/Altinity/clickhouse-operator/blob/master/docs/chi-examples/05-settings-01-overview.yaml for examples ",
								MarkdownDescription: "allows define content of any setting file inside each 'Pod' during generate 'ConfigMap' which will mount in '/etc/clickhouse-server/config.d/' or '/etc/clickhouse-server/conf.d/' or '/etc/clickhouse-server/users.d/' every key in this object is the file name every value in this object is the file content you can use '!!binary |' and base64 for binary files, see details here https://yaml.org/type/binary.html each key could contains prefix like {common}, {users}, {hosts} or config.d, users.d, conf.d, wrong prefixes will be ignored, subfolders also will be ignored More details: https://github.com/Altinity/clickhouse-operator/blob/master/docs/chi-examples/05-settings-05-files-nested.yaml any key could contains 'valueFrom' with 'secretKeyRef' which allow pass values from kubernetes secrets secrets will mounted into pod as separate volume in /etc/clickhouse-server/secrets.d/ and will automatically update when update secret it useful for pass SSL certificates from cert-manager or similar tool look into https://github.com/Altinity/clickhouse-operator/blob/master/docs/chi-examples/05-settings-01-overview.yaml for examples ",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"reconciling": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"macros": schema.SingleNestedAttribute{
								Description:         "macros parameters",
								MarkdownDescription: "macros parameters",
								Attributes: map[string]schema.Attribute{
									"sections": schema.SingleNestedAttribute{
										Description:         "sections behaviour for macros",
										MarkdownDescription: "sections behaviour for macros",
										Attributes: map[string]schema.Attribute{
											"files": schema.SingleNestedAttribute{
												Description:         "sections behaviour for macros on files",
												MarkdownDescription: "sections behaviour for macros on files",
												Attributes: map[string]schema.Attribute{
											...
											"profiles": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "sections behaviour for macros on profiles",
												Attributes: map[string]schema.Attribute{
													"enabled": schema.StringAttribute{
														Description:         "enabled or not",
														MarkdownDescription: "enabled or not",
											...
											"quotas": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "sections behaviour for macros on quotas",
												Attributes: map[string]schema.Attribute{
													"enabled": schema.StringAttribute{
														Description:         "enabled or not",
														MarkdownDescription: "enabled or not",
											...
											"settings": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "sections behaviour for macros on settings",
												Attributes: map[string]schema.Attribute{
													"enabled": schema.StringAttribute{
														Description:         "enabled or not",
														MarkdownDescription: "enabled or not",
											...
											"users": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "sections behaviour for macros on users",
												Attributes: map[string]schema.Attribute{
													"enabled": schema.StringAttribute{
														Description:         "enabled or not",
														MarkdownDescription: "enabled or not",
