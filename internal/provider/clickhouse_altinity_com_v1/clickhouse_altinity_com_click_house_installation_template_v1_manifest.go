...
var (
	_ datasource.DataSource = &ClickhouseAltinityComClickHouseInstallationTemplateV1Manifest{}
)

func NewClickhouseAltinityComClickHouseInstallationTemplateV1Manifest() datasource.DataSource {
	return &ClickhouseAltinityComClickHouseInstallationTemplateV1Manifest{}
}

type ClickhouseAltinityComClickHouseInstallationTemplateV1Manifest struct{}

type ClickhouseAltinityComClickHouseInstallationTemplateV1ManifestData struct {
...
func (r *ClickhouseAltinityComClickHouseInstallationTemplateV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_clickhouse_altinity_com_click_house_installation_template_v1_manifest"
}

func (r *ClickhouseAltinityComClickHouseInstallationTemplateV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClickhouseAltinityComClickHouseInstallationTemplateV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_clickhouse_altinity_com_click_house_installation_template_v1_manifest")

	var model ClickhouseAltinityComClickHouseInstallationTemplateV1ManifestData
	...
	model.Kind = pointer.String("ClickHouseInstallationTemplate")
