...
var (
	_ datasource.DataSource              = &CapsuleClastixIoTenantV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &CapsuleClastixIoTenantV1Alpha1DataSource{}
)

func NewCapsuleClastixIoTenantV1Alpha1DataSource() datasource.DataSource {
	return &CapsuleClastixIoTenantV1Alpha1DataSource{}
}

type CapsuleClastixIoTenantV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CapsuleClastixIoTenantV1Alpha1DataSourceData struct {
...
func (r *CapsuleClastixIoTenantV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capsule_clastix_io_tenant_v1alpha1"
}

func (r *CapsuleClastixIoTenantV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CapsuleClastixIoTenantV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CapsuleClastixIoTenantV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_capsule_clastix_io_tenant_v1alpha1")

	var data CapsuleClastixIoTenantV1Alpha1DataSourceData
	...
	var readResponse CapsuleClastixIoTenantV1Alpha1DataSourceData
