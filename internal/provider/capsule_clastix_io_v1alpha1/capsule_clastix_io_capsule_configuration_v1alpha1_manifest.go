...
var (
	_ datasource.DataSource = &CapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest{}
)

func NewCapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest() datasource.DataSource {
	return &CapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest{}
}

type CapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest struct{}

type CapsuleClastixIoCapsuleConfigurationV1Alpha1ManifestData struct {
...
func (r *CapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capsule_clastix_io_capsule_configuration_v1alpha1_manifest"
}

func (r *CapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CapsuleClastixIoCapsuleConfigurationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_capsule_clastix_io_capsule_configuration_v1alpha1_manifest")

	var model CapsuleClastixIoCapsuleConfigurationV1Alpha1ManifestData
