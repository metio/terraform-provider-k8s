...
var (
	_ datasource.DataSource              = &KmsServicesK8SAwsKeyV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KmsServicesK8SAwsKeyV1Alpha1DataSource{}
)

func NewKmsServicesK8SAwsKeyV1Alpha1DataSource() datasource.DataSource {
	return &KmsServicesK8SAwsKeyV1Alpha1DataSource{}
}

type KmsServicesK8SAwsKeyV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KmsServicesK8SAwsKeyV1Alpha1DataSourceData struct {
...
func (r *KmsServicesK8SAwsKeyV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kms_services_k8s_aws_key_v1alpha1"
}

func (r *KmsServicesK8SAwsKeyV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KmsServicesK8SAwsKeyV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KmsServicesK8SAwsKeyV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kms_services_k8s_aws_key_v1alpha1")

	var data KmsServicesK8SAwsKeyV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "kms.services.k8s.aws", Version: "v1alpha1", Resource: "Key"}).
	...
	var readResponse KmsServicesK8SAwsKeyV1Alpha1DataSourceData
