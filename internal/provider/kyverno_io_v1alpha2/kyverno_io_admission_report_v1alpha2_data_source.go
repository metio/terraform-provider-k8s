...
var (
	_ datasource.DataSource              = &KyvernoIoAdmissionReportV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoAdmissionReportV1Alpha2DataSource{}
)

func NewKyvernoIoAdmissionReportV1Alpha2DataSource() datasource.DataSource {
	return &KyvernoIoAdmissionReportV1Alpha2DataSource{}
}

type KyvernoIoAdmissionReportV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoAdmissionReportV1Alpha2DataSourceData struct {
...
func (r *KyvernoIoAdmissionReportV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_admission_report_v1alpha2"
}

func (r *KyvernoIoAdmissionReportV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoAdmissionReportV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoAdmissionReportV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_admission_report_v1alpha2")

	var data KyvernoIoAdmissionReportV1Alpha2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "kyverno.io", Version: "v1alpha2", Resource: "admissionreports"}).
	...
	var readResponse KyvernoIoAdmissionReportV1Alpha2DataSourceData
	...
	data.Kind = pointer.String("AdmissionReport")
