...
var (
	_ datasource.DataSource = &KyvernoIoClusterBackgroundScanReportV1Alpha2Manifest{}
)

func NewKyvernoIoClusterBackgroundScanReportV1Alpha2Manifest() datasource.DataSource {
	return &KyvernoIoClusterBackgroundScanReportV1Alpha2Manifest{}
}

type KyvernoIoClusterBackgroundScanReportV1Alpha2Manifest struct{}

type KyvernoIoClusterBackgroundScanReportV1Alpha2ManifestData struct {
...
func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_background_scan_report_v1alpha2_manifest"
}

func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_background_scan_report_v1alpha2_manifest")

	var model KyvernoIoClusterBackgroundScanReportV1Alpha2ManifestData
