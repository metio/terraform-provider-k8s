...
var (
	_ datasource.DataSource = &KyvernoIoBackgroundScanReportV1Alpha2Manifest{}
)

func NewKyvernoIoBackgroundScanReportV1Alpha2Manifest() datasource.DataSource {
	return &KyvernoIoBackgroundScanReportV1Alpha2Manifest{}
}

type KyvernoIoBackgroundScanReportV1Alpha2Manifest struct{}

type KyvernoIoBackgroundScanReportV1Alpha2ManifestData struct {
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_background_scan_report_v1alpha2_manifest"
}

func (r *KyvernoIoBackgroundScanReportV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "BackgroundScanReport is the Schema for the BackgroundScanReports API",
		MarkdownDescription: "BackgroundScanReport is the Schema for the BackgroundScanReports API",
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_background_scan_report_v1alpha2_manifest")

	var model KyvernoIoBackgroundScanReportV1Alpha2ManifestData
	...
	model.Kind = pointer.String("BackgroundScanReport")
