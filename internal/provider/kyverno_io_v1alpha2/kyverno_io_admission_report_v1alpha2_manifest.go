...
var (
	_ datasource.DataSource = &KyvernoIoAdmissionReportV1Alpha2Manifest{}
)

func NewKyvernoIoAdmissionReportV1Alpha2Manifest() datasource.DataSource {
	return &KyvernoIoAdmissionReportV1Alpha2Manifest{}
}

type KyvernoIoAdmissionReportV1Alpha2Manifest struct{}

type KyvernoIoAdmissionReportV1Alpha2ManifestData struct {
...
func (r *KyvernoIoAdmissionReportV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_admission_report_v1alpha2_manifest"
}

func (r *KyvernoIoAdmissionReportV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoAdmissionReportV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_admission_report_v1alpha2_manifest")

	var model KyvernoIoAdmissionReportV1Alpha2ManifestData
