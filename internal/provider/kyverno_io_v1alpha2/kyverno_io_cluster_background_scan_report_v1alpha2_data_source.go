...
var (
	_ datasource.DataSource              = &KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource{}
)

func NewKyvernoIoClusterBackgroundScanReportV1Alpha2DataSource() datasource.DataSource {
	return &KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource{}
}

type KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoClusterBackgroundScanReportV1Alpha2DataSourceData struct {
...
func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_background_scan_report_v1alpha2"
}

func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoClusterBackgroundScanReportV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_cluster_background_scan_report_v1alpha2")

	var data KyvernoIoClusterBackgroundScanReportV1Alpha2DataSourceData
	...
	var readResponse KyvernoIoClusterBackgroundScanReportV1Alpha2DataSourceData
	...
	data.Kind = pointer.String("ClusterBackgroundScanReport")
