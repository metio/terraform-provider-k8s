...
var (
	_ datasource.DataSource              = &KyvernoIoBackgroundScanReportV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoBackgroundScanReportV1Alpha2DataSource{}
)

func NewKyvernoIoBackgroundScanReportV1Alpha2DataSource() datasource.DataSource {
	return &KyvernoIoBackgroundScanReportV1Alpha2DataSource{}
}

type KyvernoIoBackgroundScanReportV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoBackgroundScanReportV1Alpha2DataSourceData struct {
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_background_scan_report_v1alpha2"
}

func (r *KyvernoIoBackgroundScanReportV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_background_scan_report_v1alpha2")

	var data KyvernoIoBackgroundScanReportV1Alpha2DataSourceData
	...
	var readResponse KyvernoIoBackgroundScanReportV1Alpha2DataSourceData
	...
	data.Kind = pointer.String("BackgroundScanReport")
