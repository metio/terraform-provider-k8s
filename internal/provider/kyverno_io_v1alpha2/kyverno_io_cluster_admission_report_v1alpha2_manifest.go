...
var (
	_ datasource.DataSource = &KyvernoIoClusterAdmissionReportV1Alpha2Manifest{}
)

func NewKyvernoIoClusterAdmissionReportV1Alpha2Manifest() datasource.DataSource {
	return &KyvernoIoClusterAdmissionReportV1Alpha2Manifest{}
}
...
func (r *KyvernoIoClusterAdmissionReportV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_admission_report_v1alpha2_manifest"
}

func (r *KyvernoIoClusterAdmissionReportV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterAdmissionReportV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_admission_report_v1alpha2_manifest")

	var model KyvernoIoClusterAdmissionReportV1Alpha2ManifestData
