...
var (
	_ datasource.DataSource = &Wgpolicyk8SIoPolicyReportV1Alpha2Manifest{}
)

func NewWgpolicyk8SIoPolicyReportV1Alpha2Manifest() datasource.DataSource {
	return &Wgpolicyk8SIoPolicyReportV1Alpha2Manifest{}
}

type Wgpolicyk8SIoPolicyReportV1Alpha2Manifest struct{}

type Wgpolicyk8SIoPolicyReportV1Alpha2ManifestData struct {
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_policy_report_v1alpha2_manifest"
}

func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_wgpolicyk8s_io_policy_report_v1alpha2_manifest")

	var model Wgpolicyk8SIoPolicyReportV1Alpha2ManifestData
