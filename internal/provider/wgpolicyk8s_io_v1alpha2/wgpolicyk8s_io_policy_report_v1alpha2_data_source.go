...
var (
	_ datasource.DataSource              = &Wgpolicyk8SIoPolicyReportV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &Wgpolicyk8SIoPolicyReportV1Alpha2DataSource{}
)

func NewWgpolicyk8SIoPolicyReportV1Alpha2DataSource() datasource.DataSource {
	return &Wgpolicyk8SIoPolicyReportV1Alpha2DataSource{}
}

type Wgpolicyk8SIoPolicyReportV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type Wgpolicyk8SIoPolicyReportV1Alpha2DataSourceData struct {
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_policy_report_v1alpha2"
}

func (r *Wgpolicyk8SIoPolicyReportV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_wgpolicyk8s_io_policy_report_v1alpha2")

	var data Wgpolicyk8SIoPolicyReportV1Alpha2DataSourceData
	...
	var readResponse Wgpolicyk8SIoPolicyReportV1Alpha2DataSourceData
