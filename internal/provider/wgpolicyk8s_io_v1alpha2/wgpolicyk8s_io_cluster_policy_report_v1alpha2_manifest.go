...
var (
	_ datasource.DataSource = &Wgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest{}
)

func NewWgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest() datasource.DataSource {
	return &Wgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest{}
}

type Wgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest struct{}

type Wgpolicyk8SIoClusterPolicyReportV1Alpha2ManifestData struct {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_cluster_policy_report_v1alpha2_manifest"
}

func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_wgpolicyk8s_io_cluster_policy_report_v1alpha2_manifest")

	var model Wgpolicyk8SIoClusterPolicyReportV1Alpha2ManifestData
