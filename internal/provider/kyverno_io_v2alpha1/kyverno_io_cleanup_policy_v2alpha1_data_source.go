...
var (
	_ datasource.DataSource              = &KyvernoIoCleanupPolicyV2Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoCleanupPolicyV2Alpha1DataSource{}
)

func NewKyvernoIoCleanupPolicyV2Alpha1DataSource() datasource.DataSource {
	return &KyvernoIoCleanupPolicyV2Alpha1DataSource{}
}

type KyvernoIoCleanupPolicyV2Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoCleanupPolicyV2Alpha1DataSourceData struct {
...
func (r *KyvernoIoCleanupPolicyV2Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cleanup_policy_v2alpha1"
}

func (r *KyvernoIoCleanupPolicyV2Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoCleanupPolicyV2Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoCleanupPolicyV2Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_cleanup_policy_v2alpha1")

	var data KyvernoIoCleanupPolicyV2Alpha1DataSourceData
	...
	var readResponse KyvernoIoCleanupPolicyV2Alpha1DataSourceData
	...
	data.Kind = pointer.String("CleanupPolicy")
