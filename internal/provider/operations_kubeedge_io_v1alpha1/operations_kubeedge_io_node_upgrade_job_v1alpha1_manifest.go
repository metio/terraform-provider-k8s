...
var (
	_ datasource.DataSource = &OperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest{}
)

func NewOperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest() datasource.DataSource {
	return &OperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest{}
}

type OperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest struct{}

type OperationsKubeedgeIoNodeUpgradeJobV1Alpha1ManifestData struct {
...
func (r *OperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operations_kubeedge_io_node_upgrade_job_v1alpha1_manifest"
}

func (r *OperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperationsKubeedgeIoNodeUpgradeJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operations_kubeedge_io_node_upgrade_job_v1alpha1_manifest")

	var model OperationsKubeedgeIoNodeUpgradeJobV1Alpha1ManifestData
