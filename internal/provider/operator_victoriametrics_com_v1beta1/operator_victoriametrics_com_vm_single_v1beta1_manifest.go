...
type OperatorVictoriametricsComVmsingleV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		StreamAggrConfig *struct {
			...
			EnableWindows        *bool     `tfsdk:"enable_windows" json:"enableWindows,omitempty"`
			...
			Rules                *[]struct {
				...
				Enable_windows         *bool     `tfsdk:"enable_windows" json:"enable_windows,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"license": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "License allows to configure license key to be used for enterprise features. Using license key is supported starting from VictoriaMetrics v1.94.0. See [here](https://docs.victoriametrics.com/victoriametrics/enterprise/)",
						Attributes: map[string]schema.Attribute{
					...
					"retention_period": schema.StringAttribute{
						...
						MarkdownDescription: "RetentionPeriod defines how long to retain stored metrics, specified as a duration (e.g., '1d', '1w', '1m'). Data with timestamps outside the RetentionPeriod is automatically deleted. The minimum allowed value is 1d, or 24h. The default value is 1 (one month). See [retention](https://docs.victoriametrics.com/victoriametrics/single-server-victoriametrics/#retention) docs for details.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"storage": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Storage is the definition of how storage will be used by the VMSingle by default it's empty dir this option is ignored if storageDataPath is set",
						Attributes: map[string]schema.Attribute{
					...
					"storage_data_path": schema.StringAttribute{
						...
						MarkdownDescription: "StorageDataPath disables spec.storage option and overrides arg for victoria-metrics binary --storageDataPath, its users responsibility to mount proper device into given path. It requires to provide spec.volumes and spec.volumeMounts with at least 1 value",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"stream_aggr_config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"enable_windows": schema.BoolAttribute{
								Description:         "EnableWindows enables aggregating data in separate windows ( available from v0.54.0).",
								MarkdownDescription: "EnableWindows enables aggregating data in separate windows ( available from v0.54.0).",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"enable_windows": schema.BoolAttribute{
											...
											MarkdownDescription: "EnableWindows enables aggregating data in separate windows",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"vm_backup": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"accept_eula": schema.BoolAttribute{
								...
								MarkdownDescription: "AcceptEULA accepts enterprise feature usage, must be set to true. otherwise backupmanager cannot be added to single/cluster version. https://victoriametrics.com/legal/esa/ Deprecated: use license.key or license.keyRef instead",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"credentials_secret": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "CredentialsSecret is secret in the same namespace for access to remote storage The secret is mounted into /etc/vm/creds.",
								Attributes: map[string]schema.Attribute{
									"key": schema.StringAttribute{
										Description:         "The key of the secret to select from. Must be a valid secret key.",
										MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
							...
							"destination_disable_suffix_add": schema.BoolAttribute{
								...
								MarkdownDescription: "DestinationDisableSuffixAdd - disables suffix adding for cluster version backups each vmstorage backup must have unique backup folder so operator adds POD_NAME as suffix for backup destination folder.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"restore": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Restore Allows to enable restore options for pod Read [more](https://docs.victoriametrics.com/victoriametrics/vmbackupmanager/#restore-commands)",
								Attributes: map[string]schema.Attribute{
