	...
	Spec *struct {
		...
		Receivers *[]struct {
			Discord_configs *[]struct {
				Avatar_url  *string `tfsdk:"avatar_url" json:"avatar_url,omitempty"`
			...
			Jira_configs *[]struct {
				...
				Issue_type          *string            `tfsdk:"issue_type" json:"issue_type,omitempty"`
				...
				Reopen_duration     *string            `tfsdk:"reopen_duration" json:"reopen_duration,omitempty"`
				Reopen_transition   *string            `tfsdk:"reopen_transition" json:"reopen_transition,omitempty"`
				Resolve_transition  *string            `tfsdk:"resolve_transition" json:"resolve_transition,omitempty"`
				Send_resolved       *bool              `tfsdk:"send_resolved" json:"send_resolved,omitempty"`
				Summary             *string            `tfsdk:"summary" json:"summary,omitempty"`
				Wont_fix_resolution *string            `tfsdk:"wont_fix_resolution" json:"wont_fix_resolution,omitempty"`
			} `tfsdk:"jira_configs" json:"jira_configs,omitempty"`
			...
			} `tfsdk:"msteamsv2_configs" json:"msteamsv2_configs,omitempty"`
			Name             *string `tfsdk:"name" json:"name,omitempty"`
			...
			Rocketchat_configs *[]struct {
				...
				Token_id *struct {
					...
					Name     *string `tfsdk:"name" json:"name,omitempty"`
					Optional *bool   `tfsdk:"optional" json:"optional,omitempty"`
				} `tfsdk:"token_id" json:"token_id,omitempty"`
			} `tfsdk:"rocketchat_configs" json:"rocketchat_configs,omitempty"`
			...
			Telegram_configs *[]struct {
				...
				Http_config           *map[string]string `tfsdk:"http_config" json:"http_config,omitempty"`
				Message               *string            `tfsdk:"message" json:"message,omitempty"`
				Message_thread_id     *int64             `tfsdk:"message_thread_id" json:"message_thread_id,omitempty"`
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "VMAlertmanagerConfigSpec defines configuration for VMAlertmanagerConfig it must reference only locally defined objects",
				Attributes: map[string]schema.Attribute{
					"inhibit_rules": schema.ListNestedAttribute{
						...
						MarkdownDescription: "InhibitRules will only apply for alerts matching the resource's namespace.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"source_matchers": schema.ListAttribute{
									...
									MarkdownDescription: "SourceMatchers defines a list of matchers for which one or more alerts have to exist for the inhibition to take effect.",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
								...
								"target_matchers": schema.ListAttribute{
									...
									MarkdownDescription: "TargetMatchers defines a list of matchers that have to be fulfilled by the target alerts to be muted.",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
					...
					"receivers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Receivers defines alert receivers",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"avatar_url": schema.StringAttribute{
												...
												MarkdownDescription: "AvatarURL defines message avatar URL Available from operator v0.55.0 and alertmanager v0.28.0",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"content": schema.StringAttribute{
												...
												MarkdownDescription: "Content defines message content template Available from operator v0.55.0 and alertmanager v0.28.0",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
											...
											"http_config": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													...
													"basic_auth": schema.SingleNestedAttribute{
														...
														MarkdownDescription: "BasicAuth for the client.",
														Attributes: map[string]schema.Attribute{
													...
													"bearer_token_secret": schema.SingleNestedAttribute{
														...
														MarkdownDescription: "The secret's key that contains the bearer token It must be at them same namespace as CRD",
														Attributes: map[string]schema.Attribute{
															"key": schema.StringAttribute{
																Description:         "The key of the secret to select from. Must be a valid secret key.",
																MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
											...
											"username": schema.StringAttribute{
												...
												MarkdownDescription: "Username defines message username Available from operator v0.55.0 and alertmanager v0.28.0",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"webhook_url": schema.StringAttribute{
												...
												MarkdownDescription: "The discord webhook URL one of 'urlSecret' and 'url' must be defined.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"auth_secret": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "AuthSecret defines secret name and key at CRD namespace. It must contain the CRAM-MD5 secret.",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
											...
											"from": schema.StringAttribute{
												...
												MarkdownDescription: "The sender address. fallback to global setting if empty",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"smarthost": schema.StringAttribute{
												...
												MarkdownDescription: "The SMTP host through which emails are sent. fallback to global setting if empty",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"api_url": schema.StringAttribute{
												...
												MarkdownDescription: "The URL to send API requests to. The full API path must be included. Example: https://company.atlassian.net/rest/api/2/",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"custom_fields": schema.MapAttribute{
												...
												MarkdownDescription: "Other issue and custom fields. Jira issue field can have multiple types. Depends on the field type, the values must be provided differently. See https://developer.atlassian.com/server/jira/platform/jira-rest-api-examples/#setting-custom-field-data-for-other-field-types for further examples.",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
											...
											"description": schema.StringAttribute{
												...
												MarkdownDescription: "Issue description template.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"http_config": schema.MapAttribute{
												...
												MarkdownDescription: "The HTTP client's configuration. You must use this configuration to supply the personal access token (PAT) as part of the HTTP 'Authorization' header. For Jira Cloud, use basic_auth with the email address as the username and the PAT as the password. For Jira Data Center, use the 'authorization' field with 'credentials: <PAT value>'.",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
											...
											"issue_type": schema.StringAttribute{
												...
												MarkdownDescription: "Type of the issue (e.g. Bug)",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
											...
											"labels": schema.ListAttribute{
												...
												MarkdownDescription: "Labels to be added to the issue",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
											...
											"priority": schema.StringAttribute{
												...
												MarkdownDescription: "Priority of the issue",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"project": schema.StringAttribute{
												...
												MarkdownDescription: "The project key where issues are created",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
											...
											"reopen_duration": schema.StringAttribute{
												...
												MarkdownDescription: "If reopen_transition is defined, reopen the issue when it is not older than this value (rounded down to the nearest minute). The resolutiondate field is used to determine the age of the issue.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
											...
											"reopen_transition": schema.StringAttribute{
												...
												MarkdownDescription: "Name of the workflow transition to resolve an issue. The target status must have the category 'done'.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"resolve_transition": schema.StringAttribute{
												...
												MarkdownDescription: "Name of the workflow transition to reopen an issue. The target status should not have the category 'done'.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"summary": schema.StringAttribute{
												...
												MarkdownDescription: "Issue summary template",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"wont_fix_resolution": schema.StringAttribute{
												...
												MarkdownDescription: "If reopen_transition is defined, ignore issues with that resolution.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"webhook_url": schema.StringAttribute{
												...
												MarkdownDescription: "The incoming webhook URL one of 'urlSecret' and 'url' must be defined.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"webhook_url_secret": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "URLSecret defines secret name and key at the CRD namespace. It must contain the webhook URL. one of 'webhook_url' or 'webhook_url_secret' must be defined.",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"api_key": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The secret's key that contains the OpsGenie API key. It must be at them same namespace as CRD fallback to global setting if empty",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"routing_key": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The secret's key that contains the PagerDuty integration key (when using Events API v2). Either this field or 'serviceKey' needs to be defined. It must be at them same namespace as CRD",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
											...
											"service_key": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The secret's key that contains the PagerDuty service key (when using integration type 'Prometheus'). Either this field or 'routingKey' needs to be defined. It must be at them same namespace as CRD",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"channel": schema.StringAttribute{
												...
												MarkdownDescription: "RocketChat channel override, (like #other-channel or @username).",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"token_id": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The sender token and token_id See https://docs.rocket.chat/use-rocket.chat/user-guides/user-panel/my-account#personal-access-tokens",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"api_url": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The secret's key that contains the Slack webhook URL. It must be at them same namespace as CRD fallback to global setting if empty",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"phone_number": schema.StringAttribute{
												...
												MarkdownDescription: "Phone number if message is delivered via SMS Specify this, topic_arn or target_arn",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"target_arn": schema.StringAttribute{
												...
												MarkdownDescription: "Mobile platform endpoint ARN if message is delivered via mobile notifications Specify this, topic_arn or phone_number",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"bot_token": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "BotToken token for the bot https://core.telegram.org/bots/api",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
											...
											"message_thread_id": schema.Int64Attribute{
												...
												MarkdownDescription: "MessageThreadID defines ID of the message thread where to send the messages.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"api_key": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The secret's key that contains the API key to use when talking to the VictorOps API. It must be at them same namespace as CRD fallback to global setting if empty",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
											...
											"custom_fields": schema.MapAttribute{
												...
												MarkdownDescription: "Adds optional custom fields https://github.com/prometheus/alertmanager/blob/v0.24.0/config/notifiers.go#L537",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"timeout": schema.StringAttribute{
												...
												MarkdownDescription: "Timeout is the maximum time allowed to invoke the webhook available since v0.28.0 alertmanager version",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"api_secret": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "The secret's key that contains the WeChat API key. The secret needs to be in the same namespace as the AlertmanagerConfig fallback to global alertmanager setting if empty",
												Attributes: map[string]schema.Attribute{
													"key": schema.StringAttribute{
														Description:         "The key of the secret to select from. Must be a valid secret key.",
														MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
											...
											"api_url": schema.StringAttribute{
												...
												MarkdownDescription: "The WeChat API URL. fallback to global alertmanager setting if empty",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
											...
											"corp_id": schema.StringAttribute{
												...
												MarkdownDescription: "The corp id for authentication. fallback to global alertmanager setting if empty",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
					...
					"route": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"active_time_intervals": schema.ListAttribute{
								...
								MarkdownDescription: "ActiveTimeIntervals Times when the route should be active These must match the name at time_intervals",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"continue": schema.BoolAttribute{
								...
								MarkdownDescription: "Continue indicating whether an alert should continue matching subsequent sibling nodes. It will always be true for the first-level route if disableRouteContinueEnforce for vmalertmanager not set.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"matchers": schema.ListAttribute{
								...
								MarkdownDescription: "List of matchers that the alert’s labels should match. For the first level route, the operator adds a namespace: 'CRD_NS' matcher. https://prometheus.io/docs/alerting/latest/configuration/#matcher",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"mute_time_intervals": schema.ListAttribute{
								...
								MarkdownDescription: "MuteTimeIntervals is a list of interval names that will mute matched alert",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"time_intervals": schema.ListNestedAttribute{
						...
						MarkdownDescription: "TimeIntervals defines named interval for active/mute notifications interval See https://prometheus.io/docs/alerting/latest/configuration/#time_interval",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
