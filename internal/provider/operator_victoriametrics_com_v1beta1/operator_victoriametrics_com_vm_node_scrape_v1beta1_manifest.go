...
var (
	_ datasource.DataSource = &OperatorVictoriametricsComVmnodeScrapeV1Beta1Manifest{}
)

func NewOperatorVictoriametricsComVmnodeScrapeV1Beta1Manifest() datasource.DataSource {
	return &OperatorVictoriametricsComVmnodeScrapeV1Beta1Manifest{}
}
...
func (r *OperatorVictoriametricsComVmnodeScrapeV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_victoriametrics_com_vm_node_scrape_v1beta1_manifest"
}

func (r *OperatorVictoriametricsComVmnodeScrapeV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "VMNodeScrapeSpec defines specification for VMNodeScrape.",
				Attributes: map[string]schema.Attribute{
					...
					"port": schema.StringAttribute{
						...
						MarkdownDescription: "Name of the port exposed at Node.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"selector": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Selector to select kubernetes Nodes.",
						Attributes: map[string]schema.Attribute{
					...
					"target_labels": schema.ListAttribute{
						...
						MarkdownDescription: "TargetLabels transfers labels on the Kubernetes Node onto the target.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *OperatorVictoriametricsComVmnodeScrapeV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_victoriametrics_com_vm_node_scrape_v1beta1_manifest")

	var model OperatorVictoriametricsComVmnodeScrapeV1Beta1ManifestData
