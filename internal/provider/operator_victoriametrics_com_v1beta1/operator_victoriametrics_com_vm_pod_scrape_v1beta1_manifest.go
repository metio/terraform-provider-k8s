...
var (
	_ datasource.DataSource = &OperatorVictoriametricsComVmpodScrapeV1Beta1Manifest{}
)

func NewOperatorVictoriametricsComVmpodScrapeV1Beta1Manifest() datasource.DataSource {
	return &OperatorVictoriametricsComVmpodScrapeV1Beta1Manifest{}
}

type OperatorVictoriametricsComVmpodScrapeV1Beta1Manifest struct{}

type OperatorVictoriametricsComVmpodScrapeV1Beta1ManifestData struct {
...
func (r *OperatorVictoriametricsComVmpodScrapeV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_victoriametrics_com_vm_pod_scrape_v1beta1_manifest"
}

func (r *OperatorVictoriametricsComVmpodScrapeV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "VMPodScrape is scrape configuration for pods, it generates vmagent's config for scraping pod targets based on selectors.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "VMPodScrapeSpec defines the desired state of VMPodScrape",
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"filter_running": schema.BoolAttribute{
									...
									MarkdownDescription: "FilterRunning applies filter with pod status == running it prevents from scrapping metrics at failed or succeed state pods. enabled by default",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"port": schema.StringAttribute{
									...
									MarkdownDescription: "Name of the port exposed at Pod.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"port_number": schema.Int64Attribute{
									...
									MarkdownDescription: "PortNumber defines the 'Pod' port number which exposes the endpoint.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								...
								"target_port": schema.StringAttribute{
									...
									MarkdownDescription: "TargetPort defines name or number of the pod port this endpoint refers to. Mutually exclusive with Port and PortNumber.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"vm_scrape_params": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"disable_keep_alive": schema.BoolAttribute{
											Description:         "disable_keepalive allows disabling HTTP keep-alive when scraping targets. By default, HTTP keep-alive is enabled, so TCP connections to scrape targets could be reused. See https://docs.victoriametrics.com/vmagent#scrape_config-enhancements",
											MarkdownDescription: "disable_keepalive allows disabling HTTP keep-alive when scraping targets. By default, HTTP keep-alive is enabled, so TCP connections to scrape targets could be reused. See https://docs.victoriametrics.com/vmagent#scrape_config-enhancements",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
...
func (r *OperatorVictoriametricsComVmpodScrapeV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_victoriametrics_com_vm_pod_scrape_v1beta1_manifest")

	var model OperatorVictoriametricsComVmpodScrapeV1Beta1ManifestData
	...
	model.Kind = pointer.String("VMPodScrape")
