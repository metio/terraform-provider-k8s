...
var (
	_ resource.Resource = (*OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource)(nil)
)

type OperatorAquasecComAquaKubeEnforcerV1Alpha1TerraformModel struct {
...
type OperatorAquasecComAquaKubeEnforcerV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"starboard" yaml:"starboard,omitempty"`
		...
		Config *struct {
			Cluster_name *string `tfsdk:"cluster_name" yaml:"cluster_name,omitempty"`

			Gateway_address *string `tfsdk:"gateway_address" yaml:"gateway_address,omitempty"`
...
func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_aquasec_com_aqua_kube_enforcer_v1alpha1"
}

func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_aquasec_com_aqua_kube_enforcer_v1alpha1")

	var state OperatorAquasecComAquaKubeEnforcerV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorAquasecComAquaKubeEnforcerV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("AquaKubeEnforcer")
...
func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_kube_enforcer_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
