...
func TestAutoscalingKarmadaIoCronFederatedHPAV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_autoscaling_karmada_io_cron_federated_hpa_v1alpha1_manifest", testCase)
		})
	}
}
