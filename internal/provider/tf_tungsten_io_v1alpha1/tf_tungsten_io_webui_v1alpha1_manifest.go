...
var (
	_ datasource.DataSource = &TfTungstenIoWebuiV1Alpha1Manifest{}
)

func NewTfTungstenIoWebuiV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoWebuiV1Alpha1Manifest{}
}

type TfTungstenIoWebuiV1Alpha1Manifest struct{}

type TfTungstenIoWebuiV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoWebuiV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_webui_v1alpha1_manifest"
}

func (r *TfTungstenIoWebuiV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Webui is the Schema for the webuis API.",
		MarkdownDescription: "Webui is the Schema for the webuis API.",
...
func (r *TfTungstenIoWebuiV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_webui_v1alpha1_manifest")

	var model TfTungstenIoWebuiV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Webui")
