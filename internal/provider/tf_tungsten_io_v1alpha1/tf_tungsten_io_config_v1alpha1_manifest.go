...
var (
	_ datasource.DataSource = &TfTungstenIoConfigV1Alpha1Manifest{}
)

func NewTfTungstenIoConfigV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoConfigV1Alpha1Manifest{}
}

type TfTungstenIoConfigV1Alpha1Manifest struct{}

type TfTungstenIoConfigV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_config_v1alpha1_manifest"
}

func (r *TfTungstenIoConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TfTungstenIoConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_config_v1alpha1_manifest")

	var model TfTungstenIoConfigV1Alpha1ManifestData
