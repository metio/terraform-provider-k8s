...
var (
	_ datasource.DataSource = &TfTungstenIoKubemanagerV1Alpha1Manifest{}
)

func NewTfTungstenIoKubemanagerV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoKubemanagerV1Alpha1Manifest{}
}

type TfTungstenIoKubemanagerV1Alpha1Manifest struct{}

type TfTungstenIoKubemanagerV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoKubemanagerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_kubemanager_v1alpha1_manifest"
}

func (r *TfTungstenIoKubemanagerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Kubemanager is the Schema for the kubemanager API.",
		MarkdownDescription: "Kubemanager is the Schema for the kubemanager API.",
...
func (r *TfTungstenIoKubemanagerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_kubemanager_v1alpha1_manifest")

	var model TfTungstenIoKubemanagerV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Kubemanager")
