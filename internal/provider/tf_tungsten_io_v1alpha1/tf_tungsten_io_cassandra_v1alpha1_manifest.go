...
var (
	_ datasource.DataSource = &TfTungstenIoCassandraV1Alpha1Manifest{}
)

func NewTfTungstenIoCassandraV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoCassandraV1Alpha1Manifest{}
}

type TfTungstenIoCassandraV1Alpha1Manifest struct{}

type TfTungstenIoCassandraV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoCassandraV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_cassandra_v1alpha1_manifest"
}

func (r *TfTungstenIoCassandraV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Cassandra is the Schema for the cassandras API.",
		MarkdownDescription: "Cassandra is the Schema for the cassandras API.",
...
func (r *TfTungstenIoCassandraV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_cassandra_v1alpha1_manifest")

	var model TfTungstenIoCassandraV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Cassandra")
