...
var (
	_ datasource.DataSource = &TfTungstenIoAnalyticsSnmpV1Alpha1Manifest{}
)

func NewTfTungstenIoAnalyticsSnmpV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoAnalyticsSnmpV1Alpha1Manifest{}
}

type TfTungstenIoAnalyticsSnmpV1Alpha1Manifest struct{}

type TfTungstenIoAnalyticsSnmpV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoAnalyticsSnmpV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_analytics_snmp_v1alpha1_manifest"
}

func (r *TfTungstenIoAnalyticsSnmpV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AnalyticsSnmp is the Schema for the Analytics SNMP API.",
		MarkdownDescription: "AnalyticsSnmp is the Schema for the Analytics SNMP API.",
...
func (r *TfTungstenIoAnalyticsSnmpV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_analytics_snmp_v1alpha1_manifest")

	var model TfTungstenIoAnalyticsSnmpV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AnalyticsSnmp")
