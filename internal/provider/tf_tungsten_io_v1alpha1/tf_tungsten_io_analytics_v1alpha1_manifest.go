...
var (
	_ datasource.DataSource = &TfTungstenIoAnalyticsV1Alpha1Manifest{}
)

func NewTfTungstenIoAnalyticsV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoAnalyticsV1Alpha1Manifest{}
}

type TfTungstenIoAnalyticsV1Alpha1Manifest struct{}

type TfTungstenIoAnalyticsV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoAnalyticsV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_analytics_v1alpha1_manifest"
}

func (r *TfTungstenIoAnalyticsV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Analytics is the Schema for the analytics API.",
		MarkdownDescription: "Analytics is the Schema for the analytics API.",
...
func (r *TfTungstenIoAnalyticsV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_analytics_v1alpha1_manifest")

	var model TfTungstenIoAnalyticsV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Analytics")
