...
var (
	_ datasource.DataSource = &TfTungstenIoAnalyticsAlarmV1Alpha1Manifest{}
)

func NewTfTungstenIoAnalyticsAlarmV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoAnalyticsAlarmV1Alpha1Manifest{}
}

type TfTungstenIoAnalyticsAlarmV1Alpha1Manifest struct{}

type TfTungstenIoAnalyticsAlarmV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoAnalyticsAlarmV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_analytics_alarm_v1alpha1_manifest"
}

func (r *TfTungstenIoAnalyticsAlarmV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AnalyticsAlarm is the Schema for the Analytics Alarm API.",
		MarkdownDescription: "AnalyticsAlarm is the Schema for the Analytics Alarm API.",
...
func (r *TfTungstenIoAnalyticsAlarmV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_analytics_alarm_v1alpha1_manifest")

	var model TfTungstenIoAnalyticsAlarmV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AnalyticsAlarm")
