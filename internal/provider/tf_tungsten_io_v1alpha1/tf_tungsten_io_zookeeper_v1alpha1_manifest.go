...
var (
	_ datasource.DataSource = &TfTungstenIoZookeeperV1Alpha1Manifest{}
)

func NewTfTungstenIoZookeeperV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoZookeeperV1Alpha1Manifest{}
}

type TfTungstenIoZookeeperV1Alpha1Manifest struct{}

type TfTungstenIoZookeeperV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoZookeeperV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_zookeeper_v1alpha1_manifest"
}

func (r *TfTungstenIoZookeeperV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Zookeeper is the Schema for the zookeeper API.",
		MarkdownDescription: "Zookeeper is the Schema for the zookeeper API.",
...
func (r *TfTungstenIoZookeeperV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_zookeeper_v1alpha1_manifest")

	var model TfTungstenIoZookeeperV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Zookeeper")
