...
var (
	_ datasource.DataSource = &TfTungstenIoRedisV1Alpha1Manifest{}
)

func NewTfTungstenIoRedisV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoRedisV1Alpha1Manifest{}
}

type TfTungstenIoRedisV1Alpha1Manifest struct{}

type TfTungstenIoRedisV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoRedisV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_redis_v1alpha1_manifest"
}

func (r *TfTungstenIoRedisV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Redis is the Schema for the redis API.",
		MarkdownDescription: "Redis is the Schema for the redis API.",
...
func (r *TfTungstenIoRedisV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_redis_v1alpha1_manifest")

	var model TfTungstenIoRedisV1Alpha1ManifestData
	...
	model.Kind = pointer.String("Redis")
