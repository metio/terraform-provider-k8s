...
var (
	_ datasource.DataSource = &TfTungstenIoQueryEngineV1Alpha1Manifest{}
)

func NewTfTungstenIoQueryEngineV1Alpha1Manifest() datasource.DataSource {
	return &TfTungstenIoQueryEngineV1Alpha1Manifest{}
}

type TfTungstenIoQueryEngineV1Alpha1Manifest struct{}

type TfTungstenIoQueryEngineV1Alpha1ManifestData struct {
...
func (r *TfTungstenIoQueryEngineV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tf_tungsten_io_query_engine_v1alpha1_manifest"
}

func (r *TfTungstenIoQueryEngineV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "QueryEngine is the Schema for the analyticsdb query engine.",
		MarkdownDescription: "QueryEngine is the Schema for the analyticsdb query engine.",
...
func (r *TfTungstenIoQueryEngineV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_tf_tungsten_io_query_engine_v1alpha1_manifest")

	var model TfTungstenIoQueryEngineV1Alpha1ManifestData
	...
	model.Kind = pointer.String("QueryEngine")
