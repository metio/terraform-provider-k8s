...
var (
	_ datasource.DataSource = &LokiGrafanaComRulerConfigV1Manifest{}
)

func NewLokiGrafanaComRulerConfigV1Manifest() datasource.DataSource {
	return &LokiGrafanaComRulerConfigV1Manifest{}
}
...
func (r *LokiGrafanaComRulerConfigV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_ruler_config_v1_manifest"
}

func (r *LokiGrafanaComRulerConfigV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComRulerConfigV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_loki_grafana_com_ruler_config_v1_manifest")

	var model LokiGrafanaComRulerConfigV1ManifestData
