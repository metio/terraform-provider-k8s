...
var (
	_ datasource.DataSource              = &LokiGrafanaComRulerConfigV1DataSource{}
	_ datasource.DataSourceWithConfigure = &LokiGrafanaComRulerConfigV1DataSource{}
)

func NewLokiGrafanaComRulerConfigV1DataSource() datasource.DataSource {
	return &LokiGrafanaComRulerConfigV1DataSource{}
}

type LokiGrafanaComRulerConfigV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LokiGrafanaComRulerConfigV1DataSourceData struct {
...
func (r *LokiGrafanaComRulerConfigV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_ruler_config_v1"
}

func (r *LokiGrafanaComRulerConfigV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComRulerConfigV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LokiGrafanaComRulerConfigV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_loki_grafana_com_ruler_config_v1")

	var data LokiGrafanaComRulerConfigV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "loki.grafana.com", Version: "v1", Resource: "RulerConfig"}).
	...
	var readResponse LokiGrafanaComRulerConfigV1DataSourceData
