...
var (
	_ datasource.DataSource = &LokiGrafanaComRecordingRuleV1Manifest{}
)

func NewLokiGrafanaComRecordingRuleV1Manifest() datasource.DataSource {
	return &LokiGrafanaComRecordingRuleV1Manifest{}
}
...
func (r *LokiGrafanaComRecordingRuleV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_recording_rule_v1_manifest"
}

func (r *LokiGrafanaComRecordingRuleV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComRecordingRuleV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_loki_grafana_com_recording_rule_v1_manifest")

	var model LokiGrafanaComRecordingRuleV1ManifestData
