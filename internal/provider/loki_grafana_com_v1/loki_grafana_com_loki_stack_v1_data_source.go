...
var (
	_ datasource.DataSource              = &LokiGrafanaComLokiStackV1DataSource{}
	_ datasource.DataSourceWithConfigure = &LokiGrafanaComLokiStackV1DataSource{}
)

func NewLokiGrafanaComLokiStackV1DataSource() datasource.DataSource {
	return &LokiGrafanaComLokiStackV1DataSource{}
}

type LokiGrafanaComLokiStackV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LokiGrafanaComLokiStackV1DataSourceData struct {
...
func (r *LokiGrafanaComLokiStackV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_loki_stack_v1"
}

func (r *LokiGrafanaComLokiStackV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComLokiStackV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LokiGrafanaComLokiStackV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_loki_grafana_com_loki_stack_v1")

	var data LokiGrafanaComLokiStackV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "loki.grafana.com", Version: "v1", Resource: "lokistacks"}).
	...
	var readResponse LokiGrafanaComLokiStackV1DataSourceData
	...
	data.Kind = pointer.String("LokiStack")
