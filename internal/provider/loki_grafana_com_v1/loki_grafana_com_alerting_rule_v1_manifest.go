...
var (
	_ datasource.DataSource = &LokiGrafanaComAlertingRuleV1Manifest{}
)

func NewLokiGrafanaComAlertingRuleV1Manifest() datasource.DataSource {
	return &LokiGrafanaComAlertingRuleV1Manifest{}
}
...
func (r *LokiGrafanaComAlertingRuleV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_alerting_rule_v1_manifest"
}

func (r *LokiGrafanaComAlertingRuleV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComAlertingRuleV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_loki_grafana_com_alerting_rule_v1_manifest")

	var model LokiGrafanaComAlertingRuleV1ManifestData
