...
var (
	_ datasource.DataSource = &LokiGrafanaComLokiStackV1Manifest{}
)

func NewLokiGrafanaComLokiStackV1Manifest() datasource.DataSource {
	return &LokiGrafanaComLokiStackV1Manifest{}
}
...
func (r *LokiGrafanaComLokiStackV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_loki_stack_v1_manifest"
}

func (r *LokiGrafanaComLokiStackV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "LokiStack CR spec field.",
				Attributes: map[string]schema.Attribute{
					"hash_ring": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"memberlist": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"instance_addr_type": schema.StringAttribute{
										...
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("default", "podIP"),
										},
									},
								},
								Required: false,
							...
							"type": schema.StringAttribute{
								...
								MarkdownDescription: "Type of hash ring implementation that should be used",
								Required:            true,
								Optional:            false,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("memberlist"),
								},
							},
						},
						Required: false,
						...
						Attributes: map[string]schema.Attribute{
								...
								Attributes: map[string]schema.Attribute{
									"ingestion": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"per_stream_rate_limit": schema.Int64Attribute{
												Description:         "PerStreamRateLimit defines the maximum byte rate per second per stream. Units MB.",
												MarkdownDescription: "PerStreamRateLimit defines the maximum byte rate per second per stream. Units MB.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},

											"per_stream_rate_limit_burst": schema.Int64Attribute{
												Description:         "PerStreamRateLimitBurst defines the maximum burst bytes per stream. Units MB.",
												MarkdownDescription: "PerStreamRateLimitBurst defines the maximum burst bytes per stream. Units MB.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
									...
									"otlp": schema.SingleNestedAttribute{
										Description:         "OTLP to configure which resource, scope and log attributesto store as labels or structured metadata or drop them altogetherfor all tenants.",
										MarkdownDescription: "OTLP to configure which resource, scope and log attributesto store as labels or structured metadata or drop them altogetherfor all tenants.",
										Attributes: map[string]schema.Attribute{
											"indexed_resource_attributes": schema.ListAttribute{
												Description:         "IndexedResourceAttributes contains the global configuration for resource attributesto store them as index labels or structured metadata or drop them altogether.",
												MarkdownDescription: "IndexedResourceAttributes contains the global configuration for resource attributesto store them as index labels or structured metadata or drop them altogether.",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
											...
											"log_attributes": schema.ListNestedAttribute{
												Description:         "LogAttributes contains the configuration for log attributesto store them as index labels or structured metadata or drop them altogether.",
												MarkdownDescription: "LogAttributes contains the configuration for log attributesto store them as index labels or structured metadata or drop them altogether.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"action": schema.StringAttribute{
															Description:         "Action defines the indexing action for the selected attributes. Theycan be either added to structured metadata or drop altogether.",
															MarkdownDescription: "Action defines the indexing action for the selected attributes. Theycan be either added to structured metadata or drop altogether.",
															Required:            true,
															Optional:            false,
															Computed:            false,
															Validators: []validator.String{
											...
											"resource_attributes": schema.SingleNestedAttribute{
												Description:         "ResourceAttributes contains the configuration for resource attributesto store them as index labels or structured metadata or drop them altogether.",
												MarkdownDescription: "ResourceAttributes contains the configuration for resource attributesto store them as index labels or structured metadata or drop them altogether.",
												Attributes: map[string]schema.Attribute{
													"attributes": schema.ListNestedAttribute{
														Description:         "Attributes contains the configuration for resource attributesto store them as index labels or structured metadata or drop them altogether.",
														MarkdownDescription: "Attributes contains the configuration for resource attributesto store them as index labels or structured metadata or drop them altogether.",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"action": schema.StringAttribute{
																	Description:         "Action defines the indexing action for the selected resoure attributes. Theycan be either indexed as labels, added to structured metadata or drop altogether.",
																	MarkdownDescription: "Action defines the indexing action for the selected resoure attributes. Theycan be either indexed as labels, added to structured metadata or drop altogether.",
																	Required:            false,
																	Optional:            true,
																	Computed:            false,
																	Validators: []validator.String{
																...
																"attributes": schema.ListAttribute{
																	Description:         "Attributes is the list of attributes to configure indexing or drop themaltogether.",
																	MarkdownDescription: "Attributes is the list of attributes to configure indexing or drop themaltogether.",
																	ElementType:         types.StringType,
																	Required:            false,
																	Optional:            true,
																	Computed:            false,
													...
													"ignore_defaults": schema.BoolAttribute{
														Description:         "IgnoreDefaults controls whether to ignore the global configuration for resource attributesindexed as labels.If IgnoreDefaults is true, then this spec needs to contain at least one mapping to a index label.",
														MarkdownDescription: "IgnoreDefaults controls whether to ignore the global configuration for resource attributesindexed as labels.If IgnoreDefaults is true, then this spec needs to contain at least one mapping to a index label.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
											...
											"scope_attributes": schema.ListNestedAttribute{
												Description:         "ScopeAttributes contains the configuration for scope attributesto store them as index labels or structured metadata or drop them altogether.",
												MarkdownDescription: "ScopeAttributes contains the configuration for scope attributesto store them as index labels or structured metadata or drop them altogether.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"action": schema.StringAttribute{
															Description:         "Action defines the indexing action for the selected attributes. Theycan be either added to structured metadata or drop altogether.",
									...
									"retention": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Retention defines how long logs are kept in storage.",
										Attributes: map[string]schema.Attribute{
											"days": schema.Int64Attribute{
												Description:         "Days contains the number of days logs are kept.",
												MarkdownDescription: "Days contains the number of days logs are kept.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											...
											"streams": schema.ListNestedAttribute{
												...
												MarkdownDescription: "Stream defines the log stream.",
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"days": schema.Int64Attribute{
															Description:         "Days contains the number of days logs are kept.",
														...
														"priority": schema.Int64Attribute{
															Description:         "Priority defines the priority of this selector compared to other retention rules.",
															MarkdownDescription: "Priority defines the priority of this selector compared to other retention rules.",
															Required:            false,
															Optional:            true,
															Computed:            false,
														},
														...
														"selector": schema.StringAttribute{
															Description:         "Selector contains the LogQL query used to define the log stream.",
															MarkdownDescription: "Selector contains the LogQL query used to define the log stream.",
															Required:            true,
															Optional:            false,
															Computed:            false,
														},
							...
							"tenants": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"otlp": schema.SingleNestedAttribute{
										Description:         "OTLP to configure which resource, scope and log attributesto store as labels or structured metadata or drop them altogetherfor a single tenants.",
										MarkdownDescription: "OTLP to configure which resource, scope and log attributesto store as labels or structured metadata or drop them altogetherfor a single tenants.",
										Attributes: map[string]schema.Attribute{
											"log_attributes": schema.ListNestedAttribute{
												Description:         "LogAttributes contains the configuration for log attributesto store them as index labels or structured metadata or drop them altogether.",
												MarkdownDescription: "LogAttributes contains the configuration for log attributesto store them as index labels or structured metadata or drop them altogether.",
					...
					"proxy": schema.SingleNestedAttribute{
						Description:         "Proxy defines the spec for the object proxy to configure cluster proxy information.",
						MarkdownDescription: "Proxy defines the spec for the object proxy to configure cluster proxy information.",
						Attributes: map[string]schema.Attribute{
							"http_proxy": schema.StringAttribute{
								Description:         "HTTPProxy configures the HTTP_PROXY/http_proxy env variable.",
								MarkdownDescription: "HTTPProxy configures the HTTP_PROXY/http_proxy env variable.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"https_proxy": schema.StringAttribute{
								...
								MarkdownDescription: "HTTPSProxy configures the HTTPS_PROXY/https_proxy env variable.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"no_proxy": schema.StringAttribute{
								...
								MarkdownDescription: "NoProxy configures the NO_PROXY/no_proxy env variable.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"replication": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Replication defines the configuration for Loki data replication.",
						Attributes: map[string]schema.Attribute{
							"factor": schema.Int64Attribute{
								Description:         "Factor defines the policy for log stream replication.",
								MarkdownDescription: "Factor defines the policy for log stream replication.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"max_skew": schema.Int64Attribute{
											Description:         "MaxSkew describes the maximum degree to which Pods can be unevenly distributed.",
											MarkdownDescription: "MaxSkew describes the maximum degree to which Pods can be unevenly distributed.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"topology_key": schema.StringAttribute{
											Description:         "TopologyKey is the key that defines a topology in the Nodes' labels.",
											MarkdownDescription: "TopologyKey is the key that defines a topology in the Nodes' labels.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
							...
							"secret": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"type": schema.StringAttribute{
										...
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("azure", "gcs", "s3", "swift", "alibabacloud"),
										},
									},
								},
								Required: true,
					...
					"tenants": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"m_tls": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "TLSConfig defines the spec for the mTLS tenant's authentication.",
											Attributes: map[string]schema.Attribute{
										...
										"oidc": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"issuer_ca": schema.SingleNestedAttribute{
												...
												"secret": schema.SingleNestedAttribute{
													Description:         "Secret defines the spec for the clientID and clientSecret for tenant's authentication.",
													MarkdownDescription: "Secret defines the spec for the clientID and clientSecret for tenant's authentication.",
													Attributes: map[string]schema.Attribute{
														"name": schema.StringAttribute{
							...
							"mode": schema.StringAttribute{
								...
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("static", "dynamic", "openshift-logging", "openshift-network"),
								},
							},
...
func (r *LokiGrafanaComLokiStackV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_loki_grafana_com_loki_stack_v1_manifest")

	var model LokiGrafanaComLokiStackV1ManifestData
