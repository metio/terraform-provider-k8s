...
type CloudwatchAwsAmazonComAmazonCloudWatchAgentV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Prometheus        *struct {
			...
			Report_extra_scrape_metrics *bool              `tfsdk:"report_extra_scrape_metrics" json:"report_extra_scrape_metrics,omitempty"`
			Start_time_metric_regex     *string            `tfsdk:"start_time_metric_regex" json:"start_time_metric_regex,omitempty"`
			Target_allocator            *map[string]string `tfsdk:"target_allocator" json:"target_allocator,omitempty"`
			Trim_metric_suffixes        *bool              `tfsdk:"trim_metric_suffixes" json:"trim_metric_suffixes,omitempty"`
			Use_start_time_metric       *bool              `tfsdk:"use_start_time_metric" json:"use_start_time_metric,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"deployment_update_strategy": schema.SingleNestedAttribute{
						Description:         "UpdateStrategy represents the strategy the operator will take replacing existing Deployment pods with new pods https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/deployment-v1/#DeploymentSpec This is only applicable to Deployment mode.",
						MarkdownDescription: "UpdateStrategy represents the strategy the operator will take replacing existing Deployment pods with new pods https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/deployment-v1/#DeploymentSpec This is only applicable to Deployment mode.",
						Attributes: map[string]schema.Attribute{
					...
					"prometheus": schema.SingleNestedAttribute{
						Description:         "Prometheus is the raw YAML to be used as the collector's prometheus configuration.",
						MarkdownDescription: "Prometheus is the raw YAML to be used as the collector's prometheus configuration.",
						Attributes: map[string]schema.Attribute{
							"config": schema.MapAttribute{
								Description:         "AnyConfig represent parts of the config.",
								MarkdownDescription: "AnyConfig represent parts of the config.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"report_extra_scrape_metrics": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"start_time_metric_regex": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"target_allocator": schema.MapAttribute{
								Description:         "AnyConfig represent parts of the config.",
								MarkdownDescription: "AnyConfig represent parts of the config.",
								ElementType:         types.StringType,
								Required:            false,
							...
							"trim_metric_suffixes": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"use_start_time_metric": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
					...
					"target_allocator": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"allocation_strategy": schema.StringAttribute{
								Description:         "AllocationStrategy determines which strategy the target allocator should use for allocation. The current option is consistent-hashing.",
								MarkdownDescription: "AllocationStrategy determines which strategy the target allocator should use for allocation. The current option is consistent-hashing.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("consistent-hashing"),
								},
							},
							...
							"prometheus_cr": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"pod_monitor_selector": schema.MapAttribute{
										Description:         "PodMonitors to be selected for target discovery. This is a map of {key,value} pairs. Each {key,value} in the map is going to exactly match a label in a PodMonitor's meta labels. The requirements are ANDed.",
										MarkdownDescription: "PodMonitors to be selected for target discovery. This is a map of {key,value} pairs. Each {key,value} in the map is going to exactly match a label in a PodMonitor's meta labels. The requirements are ANDed.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"service_monitor_selector": schema.MapAttribute{
										Description:         "ServiceMonitors to be selected for target discovery. This is a map of {key,value} pairs. Each {key,value} in the map is going to exactly match a label in a ServiceMonitor's meta labels. The requirements are ANDed.",
										MarkdownDescription: "ServiceMonitors to be selected for target discovery. This is a map of {key,value} pairs. Each {key,value} in the map is going to exactly match a label in a ServiceMonitor's meta labels. The requirements are ANDed.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
							...
							"security_context": schema.SingleNestedAttribute{
								Description:         "SecurityContext configures the container security context for the target-allocator.",
								MarkdownDescription: "SecurityContext configures the container security context for the target-allocator.",
								Attributes: map[string]schema.Attribute{
									"fs_group": schema.Int64Attribute{
										Description:         "A special supplemental group that applies to all containers in a pod. Some volume types allow the Kubelet to change the ownership of that volume to be owned by the pod: 1. The owning GID will be the FSGroup 2. The setgid bit is set (new files created in the volume will be owned by FSGroup) 3. The permission bits are OR'd with rw-rw---- If unset, the Kubelet will not modify the ownership and permissions of any volume. Note that this field cannot be set when spec.os.name is windows.",
										MarkdownDescription: "A special supplemental group that applies to all containers in a pod. Some volume types allow the Kubelet to change the ownership of that volume to be owned by the pod: 1. The owning GID will be the FSGroup 2. The setgid bit is set (new files created in the volume will be owned by FSGroup) 3. The permission bits are OR'd with rw-rw---- If unset, the Kubelet will not modify the ownership and permissions of any volume. Note that this field cannot be set when spec.os.name is windows.",
							...
							"tolerations": schema.ListNestedAttribute{
								...
								MarkdownDescription: "Toleration embedded kubernetes pod configuration option, controls how pods can be scheduled with matching taints",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
