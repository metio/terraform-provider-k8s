...
var (
	_ datasource.DataSource = &CloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest{}
)

func NewCloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest() datasource.DataSource {
	return &CloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest{}
}

type CloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest struct{}

type CloudwatchAwsAmazonComInstrumentationV1Alpha1ManifestData struct {
...
func (r *CloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cloudwatch_aws_amazon_com_instrumentation_v1alpha1_manifest"
}

func (r *CloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"apache_httpd": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"attrs": schema.ListNestedAttribute{
								Description:         "Attrs defines Apache HTTPD agent specific attributes. The precedence is: 'agent default attributes' > 'instrument spec attributes' . Attributes are documented at https://github.com/open-telemetry/opentelemetry-cpp-contrib/tree/main/instrumentation/otel-webserver-module",
								MarkdownDescription: "Attrs defines Apache HTTPD agent specific attributes. The precedence is: 'agent default attributes' > 'instrument spec attributes' . Attributes are documented at https://github.com/open-telemetry/opentelemetry-cpp-contrib/tree/main/instrumentation/otel-webserver-module",
							...
							"env": schema.ListNestedAttribute{
								Description:         "Env defines Apache HTTPD specific env vars. There are four layers for env vars' definitions and the precedence order is: 'original container env vars' > 'language specific env vars' > 'common env vars' > 'instrument spec configs' vars'. If the former var had been defined, then the other vars would be ignored.",
								MarkdownDescription: "Env defines Apache HTTPD specific env vars. There are four layers for env vars' definitions and the precedence order is: 'original container env vars' > 'language specific env vars' > 'common env vars' > 'instrument spec configs' vars'. If the former var had been defined, then the other vars would be ignored.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
											Description:         "Name of the environment variable. Must be a C_IDENTIFIER.",
							...
							"volume_limit_size": schema.StringAttribute{
								...
								MarkdownDescription: "VolumeSizeLimit defines size limit for volume used for auto-instrumentation. The default size is 200Mi.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"go": schema.SingleNestedAttribute{
						Description:         "Go defines configuration for Go auto-instrumentation. When using Go auto-instrumentation you must provide a value for the OTEL_GO_AUTO_TARGET_EXE env var via the Instrumentation env vars or via the instrumentation.opentelemetry.io/otel-go-auto-target-exe pod annotation. Failure to set this value causes instrumentation injection to abort, leaving the original pod unchanged.",
						MarkdownDescription: "Go defines configuration for Go auto-instrumentation. When using Go auto-instrumentation you must provide a value for the OTEL_GO_AUTO_TARGET_EXE env var via the Instrumentation env vars or via the instrumentation.opentelemetry.io/otel-go-auto-target-exe pod annotation. Failure to set this value causes instrumentation injection to abort, leaving the original pod unchanged.",
						Attributes: map[string]schema.Attribute{
							"env": schema.ListNestedAttribute{
								Description:         "Env defines Go specific env vars. There are four layers for env vars' definitions and the precedence order is: 'original container env vars' > 'language specific env vars' > 'common env vars' > 'instrument spec configs' vars'. If the former var had been defined, then the other vars would be ignored.",
								MarkdownDescription: "Env defines Go specific env vars. There are four layers for env vars' definitions and the precedence order is: 'original container env vars' > 'language specific env vars' > 'common env vars' > 'instrument spec configs' vars'. If the former var had been defined, then the other vars would be ignored.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
											Description:         "Name of the environment variable. Must be a C_IDENTIFIER.",
					...
					"nginx": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"attrs": schema.ListNestedAttribute{
								Description:         "Attrs defines Nginx agent specific attributes. The precedence order is: 'agent default attributes' > 'instrument spec attributes' . Attributes are documented at https://github.com/open-telemetry/opentelemetry-cpp-contrib/tree/main/instrumentation/otel-webserver-module",
								MarkdownDescription: "Attrs defines Nginx agent specific attributes. The precedence order is: 'agent default attributes' > 'instrument spec attributes' . Attributes are documented at https://github.com/open-telemetry/opentelemetry-cpp-contrib/tree/main/instrumentation/otel-webserver-module",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
											Description:         "Name of the environment variable. Must be a C_IDENTIFIER.",
							...
							"env": schema.ListNestedAttribute{
								Description:         "Env defines Nginx specific env vars. There are four layers for env vars' definitions and the precedence order is: 'original container env vars' > 'language specific env vars' > 'common env vars' > 'instrument spec configs' vars'. If the former var had been defined, then the other vars would be ignored.",
								MarkdownDescription: "Env defines Nginx specific env vars. There are four layers for env vars' definitions and the precedence order is: 'original container env vars' > 'language specific env vars' > 'common env vars' > 'instrument spec configs' vars'. If the former var had been defined, then the other vars would be ignored.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
											Description:         "Name of the environment variable. Must be a C_IDENTIFIER.",
					...
					"sampler": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"argument": schema.StringAttribute{
								Description:         "Argument defines sampler argument. The value depends on the sampler type. For instance for parentbased_traceidratio sampler type it is a number in range [0..1] e.g. 0.25. The value will be set in the OTEL_TRACES_SAMPLER_ARG env var.",
								MarkdownDescription: "Argument defines sampler argument. The value depends on the sampler type. For instance for parentbased_traceidratio sampler type it is a number in range [0..1] e.g. 0.25. The value will be set in the OTEL_TRACES_SAMPLER_ARG env var.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *CloudwatchAwsAmazonComInstrumentationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cloudwatch_aws_amazon_com_instrumentation_v1alpha1_manifest")

	var model CloudwatchAwsAmazonComInstrumentationV1Alpha1ManifestData
