...
var (
	_ resource.Resource = (*CouchbaseComCouchbaseEphemeralBucketV2Resource)(nil)
)

type CouchbaseComCouchbaseEphemeralBucketV2TerraformModel struct {
...
type CouchbaseComCouchbaseEphemeralBucketV2GoModel struct {
...
func (r *CouchbaseComCouchbaseEphemeralBucketV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_couchbase_com_couchbase_ephemeral_bucket_v2"
}

func (r *CouchbaseComCouchbaseEphemeralBucketV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *CouchbaseComCouchbaseEphemeralBucketV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_couchbase_com_couchbase_ephemeral_bucket_v2")

	var state CouchbaseComCouchbaseEphemeralBucketV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CouchbaseComCouchbaseEphemeralBucketV2GoModel
	...
	goModel.Kind = utilities.Ptr("CouchbaseEphemeralBucket")
...
func (r *CouchbaseComCouchbaseEphemeralBucketV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_couchbase_com_couchbase_ephemeral_bucket_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *CouchbaseComCouchbaseEphemeralBucketV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CouchbaseComCouchbaseEphemeralBucketV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
