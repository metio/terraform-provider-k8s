...
var (
	_ datasource.DataSource = &PersistentVolumeV1Manifest{}
)

func NewPersistentVolumeV1Manifest() datasource.DataSource {
	return &PersistentVolumeV1Manifest{}
}

type PersistentVolumeV1Manifest struct{}

type PersistentVolumeV1ManifestData struct {
...
func (r *PersistentVolumeV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_persistent_volume_v1_manifest"
}

func (r *PersistentVolumeV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PersistentVolumeV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_persistent_volume_v1_manifest")

	var model PersistentVolumeV1ManifestData
