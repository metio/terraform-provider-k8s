...
var (
	_ datasource.DataSource = &ReplicationControllerV1Manifest{}
)

func NewReplicationControllerV1Manifest() datasource.DataSource {
	return &ReplicationControllerV1Manifest{}
}

type ReplicationControllerV1Manifest struct{}

type ReplicationControllerV1ManifestData struct {
...
func (r *ReplicationControllerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_replication_controller_v1_manifest"
}

func (r *ReplicationControllerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ReplicationControllerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_replication_controller_v1_manifest")

	var model ReplicationControllerV1ManifestData
