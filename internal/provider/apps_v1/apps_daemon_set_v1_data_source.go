...
var (
	_ datasource.DataSource              = &AppsDaemonSetV1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsDaemonSetV1DataSource{}
)

func NewAppsDaemonSetV1DataSource() datasource.DataSource {
	return &AppsDaemonSetV1DataSource{}
}

type AppsDaemonSetV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsDaemonSetV1DataSourceData struct {
...
func (r *AppsDaemonSetV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_daemon_set_v1"
}

func (r *AppsDaemonSetV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsDaemonSetV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsDaemonSetV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_daemon_set_v1")

	var data AppsDaemonSetV1DataSourceData
	...
	var readResponse AppsDaemonSetV1DataSourceData
	...
	data.Kind = pointer.String("DaemonSet")
