...
var (
	_ datasource.DataSource              = &AppsDeploymentV1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsDeploymentV1DataSource{}
)

func NewAppsDeploymentV1DataSource() datasource.DataSource {
	return &AppsDeploymentV1DataSource{}
}

type AppsDeploymentV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsDeploymentV1DataSourceData struct {
...
func (r *AppsDeploymentV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_deployment_v1"
}

func (r *AppsDeploymentV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsDeploymentV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsDeploymentV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_deployment_v1")

	var data AppsDeploymentV1DataSourceData
	...
	var readResponse AppsDeploymentV1DataSourceData
