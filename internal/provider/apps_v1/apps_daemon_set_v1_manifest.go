...
var (
	_ datasource.DataSource = &AppsDaemonSetV1Manifest{}
)

func NewAppsDaemonSetV1Manifest() datasource.DataSource {
	return &AppsDaemonSetV1Manifest{}
}
...
func (r *AppsDaemonSetV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_daemon_set_v1_manifest"
}

func (r *AppsDaemonSetV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsDaemonSetV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_daemon_set_v1_manifest")

	var model AppsDaemonSetV1ManifestData
