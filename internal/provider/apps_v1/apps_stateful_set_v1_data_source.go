...
var (
	_ datasource.DataSource              = &AppsStatefulSetV1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsStatefulSetV1DataSource{}
)

func NewAppsStatefulSetV1DataSource() datasource.DataSource {
	return &AppsStatefulSetV1DataSource{}
}

type AppsStatefulSetV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsStatefulSetV1DataSourceData struct {
...
func (r *AppsStatefulSetV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_stateful_set_v1"
}

func (r *AppsStatefulSetV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsStatefulSetV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsStatefulSetV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_stateful_set_v1")

	var data AppsStatefulSetV1DataSourceData
	...
	var readResponse AppsStatefulSetV1DataSourceData
	...
	data.ApiVersion = pointer.String("apps/v1")
	data.Kind = pointer.String("StatefulSet")
