...
var (
	_ datasource.DataSource = &AppsStatefulSetV1Manifest{}
)

func NewAppsStatefulSetV1Manifest() datasource.DataSource {
	return &AppsStatefulSetV1Manifest{}
}

type AppsStatefulSetV1Manifest struct{}

type AppsStatefulSetV1ManifestData struct {
...
func (r *AppsStatefulSetV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_stateful_set_v1_manifest"
}

func (r *AppsStatefulSetV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsStatefulSetV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_stateful_set_v1_manifest")

	var model AppsStatefulSetV1ManifestData
