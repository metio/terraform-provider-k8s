...
var (
	_ datasource.DataSource = &AppsReplicaSetV1Manifest{}
)

func NewAppsReplicaSetV1Manifest() datasource.DataSource {
	return &AppsReplicaSetV1Manifest{}
}

type AppsReplicaSetV1Manifest struct{}

type AppsReplicaSetV1ManifestData struct {
...
func (r *AppsReplicaSetV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_replica_set_v1_manifest"
}

func (r *AppsReplicaSetV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"replicas": schema.Int64Attribute{
						...
						MarkdownDescription: "Replicas is the number of desired pods. This is a pointer to distinguish between explicit zero and unspecified. Defaults to 1. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicaset",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.Int64{
...
func (r *AppsReplicaSetV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_replica_set_v1_manifest")

	var model AppsReplicaSetV1ManifestData
