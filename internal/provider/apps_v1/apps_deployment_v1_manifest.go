...
var (
	_ datasource.DataSource = &AppsDeploymentV1Manifest{}
)

func NewAppsDeploymentV1Manifest() datasource.DataSource {
	return &AppsDeploymentV1Manifest{}
}

type AppsDeploymentV1Manifest struct{}

type AppsDeploymentV1ManifestData struct {
...
func (r *AppsDeploymentV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_deployment_v1_manifest"
}

func (r *AppsDeploymentV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Deployment enables declarative updates for Pods and ReplicaSets.",
		MarkdownDescription: "Deployment enables declarative updates for Pods and ReplicaSets.",
							...
							"spec": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
														...
														"post_start": schema.SingleNestedAttribute{
															...
															Attributes: map[string]schema.Attribute{
																...
																"sleep": schema.SingleNestedAttribute{
																	...
																	MarkdownDescription: "SleepAction describes a 'sleep' action.",
																	Attributes: map[string]schema.Attribute{
									...
									"host_network": schema.BoolAttribute{
										...
										MarkdownDescription: "Host networking requested for this pod. Use the host's network namespace. Default to false.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
										...
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												...
												"image": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "ImageVolumeSource represents a image volume resource.",
													Attributes: map[string]schema.Attribute{
															...
															NestedObject: schema.NestedAttributeObject{
																Attributes: map[string]schema.Attribute{
																	"cluster_trust_bundle": schema.SingleNestedAttribute{
																		...
																		MarkdownDescription: "ClusterTrustBundleProjection describes how to select a set of ClusterTrustBundle objects and project their contents into the pod filesystem.",
																		Attributes: map[string]schema.Attribute{
																			"label_selector": schema.SingleNestedAttribute{
																				Description:         "A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.",
																				MarkdownDescription: "A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.",
...
func (r *AppsDeploymentV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_deployment_v1_manifest")

	var model AppsDeploymentV1ManifestData
	...
	model.Kind = pointer.String("Deployment")
