...
var (
	_ datasource.DataSource              = &AppsReplicaSetV1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppsReplicaSetV1DataSource{}
)

func NewAppsReplicaSetV1DataSource() datasource.DataSource {
	return &AppsReplicaSetV1DataSource{}
}

type AppsReplicaSetV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppsReplicaSetV1DataSourceData struct {
...
func (r *AppsReplicaSetV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_replica_set_v1"
}

func (r *AppsReplicaSetV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsReplicaSetV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppsReplicaSetV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apps_replica_set_v1")

	var data AppsReplicaSetV1DataSourceData
	...
	var readResponse AppsReplicaSetV1DataSourceData
	...
	data.Kind = pointer.String("ReplicaSet")
