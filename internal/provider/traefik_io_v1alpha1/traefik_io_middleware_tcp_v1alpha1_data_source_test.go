...
func TestTraefikIoMiddlewareTCPV1Alpha1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_traefik_io_middleware_tcp_v1alpha1", testCase)
		})
	}
}
...
func TestTraefikIoMiddlewareTCPV1Alpha1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_traefik_io_middleware_tcp_v1alpha1", configuration)
}
