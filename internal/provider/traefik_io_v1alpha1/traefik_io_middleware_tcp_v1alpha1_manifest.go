...
func (r *TraefikIoMiddlewareTcpV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "MiddlewareTCP is the CRD implementation of a Traefik TCP middleware. More info: https://doc.traefik.io/traefik/v3.4/middlewares/overview/",
		MarkdownDescription: "MiddlewareTCP is the CRD implementation of a Traefik TCP middleware. More info: https://doc.traefik.io/traefik/v3.4/middlewares/overview/",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"ip_allow_list": schema.SingleNestedAttribute{
						Description:         "IPAllowList defines the IPAllowList middleware configuration. This middleware accepts/refuses connections based on the client IP. More info: https://doc.traefik.io/traefik/v3.4/middlewares/tcp/ipallowlist/",
						MarkdownDescription: "IPAllowList defines the IPAllowList middleware configuration. This middleware accepts/refuses connections based on the client IP. More info: https://doc.traefik.io/traefik/v3.4/middlewares/tcp/ipallowlist/",
						Attributes: map[string]schema.Attribute{
					...
					"ip_white_list": schema.SingleNestedAttribute{
						Description:         "IPWhiteList defines the IPWhiteList middleware configuration. This middleware accepts/refuses connections based on the client IP. Deprecated: please use IPAllowList instead. More info: https://doc.traefik.io/traefik/v3.4/middlewares/tcp/ipwhitelist/",
						MarkdownDescription: "IPWhiteList defines the IPWhiteList middleware configuration. This middleware accepts/refuses connections based on the client IP. Deprecated: please use IPAllowList instead. More info: https://doc.traefik.io/traefik/v3.4/middlewares/tcp/ipwhitelist/",
						Attributes: map[string]schema.Attribute{
							"source_range": schema.ListAttribute{
								Description:         "SourceRange defines the allowed IPs (or ranges of allowed IPs by using CIDR notation).",
								MarkdownDescription: "SourceRange defines the allowed IPs (or ranges of allowed IPs by using CIDR notation).",
