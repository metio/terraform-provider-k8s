	...
	Spec *struct {
		...
		Routes      *[]struct {
			...
			Observability *struct {
				...
				TraceVerbosity *string `tfsdk:"trace_verbosity" json:"traceVerbosity,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"match": schema.StringAttribute{
									Description:         "Match defines the router's rule. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#rule",
									MarkdownDescription: "Match defines the router's rule. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#rule",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"middlewares": schema.ListNestedAttribute{
									Description:         "Middlewares defines the list of references to Middleware resources. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-middleware",
									MarkdownDescription: "Middlewares defines the list of references to Middleware resources. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-middleware",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"name": schema.StringAttribute{
								...
								"observability": schema.SingleNestedAttribute{
									Description:         "Observability defines the observability configuration for a router. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#observability",
									MarkdownDescription: "Observability defines the observability configuration for a router. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#observability",
									Attributes: map[string]schema.Attribute{
										"access_logs": schema.BoolAttribute{
											Description:         "AccessLogs enables access logs for this router.",
											MarkdownDescription: "AccessLogs enables access logs for this router.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"metrics": schema.BoolAttribute{
											...
											MarkdownDescription: "Metrics enables metrics for this router.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},

										"trace_verbosity": schema.StringAttribute{
											Description:         "TraceVerbosity defines the verbosity level of the tracing for this router.",
											MarkdownDescription: "TraceVerbosity defines the verbosity level of the tracing for this router.",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.String{
												stringvalidator.OneOf("minimal", "detailed"),
											},
										},

										"tracing": schema.BoolAttribute{
											Description:         "Tracing enables tracing for this router.",
											MarkdownDescription: "Tracing enables tracing for this router.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
								...
								"priority": schema.Int64Attribute{
									Description:         "Priority defines the router's priority. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#priority",
									MarkdownDescription: "Priority defines the router's priority. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#priority",
									Required:            false,
									Optional:            true,
									Computed:            false,
								...
								"syntax": schema.StringAttribute{
									Description:         "Syntax defines the router's rule syntax. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#rulesyntax Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.",
									MarkdownDescription: "Syntax defines the router's rule syntax. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#rulesyntax Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"tls": schema.SingleNestedAttribute{
						Description:         "TLS defines the TLS configuration. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#tls",
						MarkdownDescription: "TLS defines the TLS configuration. More info: https://doc.traefik.io/traefik/v3.5/routing/routers/#tls",
						Attributes: map[string]schema.Attribute{
							...
							"options": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name defines the name of the referenced TLSOption. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsoption",
										MarkdownDescription: "Name defines the name of the referenced TLSOption. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsoption",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"namespace": schema.StringAttribute{
										Description:         "Namespace defines the namespace of the referenced TLSOption. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsoption",
										MarkdownDescription: "Namespace defines the namespace of the referenced TLSOption. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsoption",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"store": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name defines the name of the referenced TLSStore. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsstore",
										MarkdownDescription: "Name defines the name of the referenced TLSStore. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsstore",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"namespace": schema.StringAttribute{
										Description:         "Namespace defines the namespace of the referenced TLSStore. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsstore",
										MarkdownDescription: "Namespace defines the namespace of the referenced TLSStore. More info: https://doc.traefik.io/traefik/v3.5/routing/providers/kubernetes-crd/#kind-tlsstore",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
