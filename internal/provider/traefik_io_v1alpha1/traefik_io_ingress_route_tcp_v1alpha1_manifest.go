			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"match": schema.StringAttribute{
									Description:         "Match defines the router's rule. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#rule_1",
									MarkdownDescription: "Match defines the router's rule. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#rule_1",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"priority": schema.Int64Attribute{
									Description:         "Priority defines the router's priority. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#priority_1",
									MarkdownDescription: "Priority defines the router's priority. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#priority_1",
									Required:            false,
									Optional:            true,
									Computed:            false,
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"proxy_protocol": schema.SingleNestedAttribute{
												Description:         "ProxyProtocol defines the PROXY protocol configuration. More info: https://doc.traefik.io/traefik/v3.4/routing/services/#proxy-protocol",
												MarkdownDescription: "ProxyProtocol defines the PROXY protocol configuration. More info: https://doc.traefik.io/traefik/v3.4/routing/services/#proxy-protocol",
												Attributes: map[string]schema.Attribute{
								...
								"syntax": schema.StringAttribute{
									Description:         "Syntax defines the router's rule syntax. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#rulesyntax_1 Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.",
									MarkdownDescription: "Syntax defines the router's rule syntax. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#rulesyntax_1 Deprecated: Please do not use this field and rewrite the router rules to use the v3 syntax.",
									Required:            false,
									Optional:            true,
									Computed:            false,
									Validators: []validator.String{
					...
					"tls": schema.SingleNestedAttribute{
						Description:         "TLS defines the TLS configuration on a layer 4 / TCP Route. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#tls_1",
						MarkdownDescription: "TLS defines the TLS configuration on a layer 4 / TCP Route. More info: https://doc.traefik.io/traefik/v3.4/routing/routers/#tls_1",
						Attributes: map[string]schema.Attribute{
