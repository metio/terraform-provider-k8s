...
func TestTraefikIoServersTransportTCPV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_traefik_io_servers_transport_tcp_v1alpha1_manifest", testCase)
		})
	}
}
