...
type GatewaySoloIoGatewayV1Resource struct{}

var (
	_ resource.Resource = (*GatewaySoloIoGatewayV1Resource)(nil)
)

type GatewaySoloIoGatewayV1TerraformModel struct {
...
type GatewaySoloIoGatewayV1GoModel struct {
	...
	Spec *struct {
		...
		HybridGateway *struct {
			DelegatedHttpGateways *struct {
				...
				PreventChildOverrides *bool `tfsdk:"prevent_child_overrides" yaml:"preventChildOverrides,omitempty"`
			...
			} `tfsdk:"delegated_http_gateways" yaml:"delegatedHttpGateways,omitempty"`
				...
				TcpGateway *struct {
					Options *struct {
						TcpProxySettings *struct {
							...
							MaxConnectAttempts *int64 `tfsdk:"max_connect_attempts" yaml:"maxConnectAttempts,omitempty"`
							...
							TunnelingConfig *struct {
								...
								} `tfsdk:"headers_to_add" yaml:"headersToAdd,omitempty"`

								Hostname *string `tfsdk:"hostname" yaml:"hostname,omitempty"`
							} `tfsdk:"tunneling_config" yaml:"tunnelingConfig,omitempty"`
						} `tfsdk:"tcp_proxy_settings" yaml:"tcpProxySettings,omitempty"`
					} `tfsdk:"options" yaml:"options,omitempty"`

					TcpHosts *[]struct {
						Destination *struct {
							ForwardSniClusterName *map[string]string `tfsdk:"forward_sni_cluster_name" yaml:"forwardSniClusterName,omitempty"`
					...
					} `tfsdk:"tcp_hosts" yaml:"tcpHosts,omitempty"`
				} `tfsdk:"tcp_gateway" yaml:"tcpGateway,omitempty"`
			} `tfsdk:"matched_gateways" yaml:"matchedGateways,omitempty"`
		} `tfsdk:"hybrid_gateway" yaml:"hybridGateway,omitempty"`
		...
		ProxyNames *[]string `tfsdk:"proxy_names" yaml:"proxyNames,omitempty"`
...
func NewGatewaySoloIoGatewayV1Resource() resource.Resource {
	return &GatewaySoloIoGatewayV1Resource{}
}

func (r *GatewaySoloIoGatewayV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_solo_io_gateway_v1"
}

func (r *GatewaySoloIoGatewayV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *GatewaySoloIoGatewayV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_gateway_solo_io_gateway_v1")

	var state GatewaySoloIoGatewayV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GatewaySoloIoGatewayV1GoModel
...
func (r *GatewaySoloIoGatewayV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_solo_io_gateway_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *GatewaySoloIoGatewayV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_gateway_solo_io_gateway_v1")
...
func (r *GatewaySoloIoGatewayV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_gateway_solo_io_gateway_v1")
