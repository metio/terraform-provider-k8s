...
type TrainingKubedlIoMarsJobV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*TrainingKubedlIoMarsJobV1Alpha1Resource)(nil)
)

type TrainingKubedlIoMarsJobV1Alpha1TerraformModel struct {
...
type TrainingKubedlIoMarsJobV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"mars_replica_specs" yaml:"marsReplicaSpecs,omitempty"`
		...
		WebHost *string `tfsdk:"web_host" yaml:"webHost,omitempty"`

		WorkerMemoryTuningPolicy *struct {
			LockFreeFileIO *bool `tfsdk:"lock_free_file_io" yaml:"lockFreeFileIO,omitempty"`

			PlasmaStore *string `tfsdk:"plasma_store" yaml:"plasmaStore,omitempty"`

			SpillDirs *[]string `tfsdk:"spill_dirs" yaml:"spillDirs,omitempty"`

			WorkerCachePercentage *int64 `tfsdk:"worker_cache_percentage" yaml:"workerCachePercentage,omitempty"`

			WorkerCacheSize utilities.IntOrString `tfsdk:"worker_cache_size" yaml:"workerCacheSize,omitempty"`
		} `tfsdk:"worker_memory_tuning_policy" yaml:"workerMemoryTuningPolicy,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewTrainingKubedlIoMarsJobV1Alpha1Resource() resource.Resource {
	return &TrainingKubedlIoMarsJobV1Alpha1Resource{}
}

func (r *TrainingKubedlIoMarsJobV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_training_kubedl_io_mars_job_v1alpha1"
}

func (r *TrainingKubedlIoMarsJobV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *TrainingKubedlIoMarsJobV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_training_kubedl_io_mars_job_v1alpha1")

	var state TrainingKubedlIoMarsJobV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel TrainingKubedlIoMarsJobV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("MarsJob")
...
func (r *TrainingKubedlIoMarsJobV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_mars_job_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *TrainingKubedlIoMarsJobV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_training_kubedl_io_mars_job_v1alpha1")
...
func (r *TrainingKubedlIoMarsJobV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_training_kubedl_io_mars_job_v1alpha1")
