...
var (
	_ datasource.DataSource              = &ResourcesTeleportDevTeleportRoleV6DataSource{}
	_ datasource.DataSourceWithConfigure = &ResourcesTeleportDevTeleportRoleV6DataSource{}
)

func NewResourcesTeleportDevTeleportRoleV6DataSource() datasource.DataSource {
	return &ResourcesTeleportDevTeleportRoleV6DataSource{}
}

type ResourcesTeleportDevTeleportRoleV6DataSource struct {
	kubernetesClient dynamic.Interface
}

type ResourcesTeleportDevTeleportRoleV6DataSourceData struct {
...
func (r *ResourcesTeleportDevTeleportRoleV6DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_resources_teleport_dev_teleport_role_v6"
}

func (r *ResourcesTeleportDevTeleportRoleV6DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ResourcesTeleportDevTeleportRoleV6DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ResourcesTeleportDevTeleportRoleV6DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_resources_teleport_dev_teleport_role_v6")

	var data ResourcesTeleportDevTeleportRoleV6DataSourceData
	...
	var readResponse ResourcesTeleportDevTeleportRoleV6DataSourceData
	...
	data.ApiVersion = pointer.String("resources.teleport.dev/v6")
