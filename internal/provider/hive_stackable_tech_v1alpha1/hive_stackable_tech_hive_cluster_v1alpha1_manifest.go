...
package hive_stackable_tech_v1alpha1
...
var (
	_ datasource.DataSource = &HiveStackableTechHiveClusterV1Alpha1Manifest{}
)

func NewHiveStackableTechHiveClusterV1Alpha1Manifest() datasource.DataSource {
	return &HiveStackableTechHiveClusterV1Alpha1Manifest{}
}

type HiveStackableTechHiveClusterV1Alpha1Manifest struct{}

type HiveStackableTechHiveClusterV1Alpha1ManifestData struct {
...
func (r *HiveStackableTechHiveClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hive_stackable_tech_hive_cluster_v1alpha1_manifest"
}

func (r *HiveStackableTechHiveClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Auto-generated derived type for HiveClusterSpec via 'CustomResource'",
		MarkdownDescription: "Auto-generated derived type for HiveClusterSpec via 'CustomResource'",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "A Hive cluster stacklet. This resource is managed by the Stackable operator for Apache Hive. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/hive/).",
				MarkdownDescription: "A Hive cluster stacklet. This resource is managed by the Stackable operator for Apache Hive. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/hive/).",
				Attributes: map[string]schema.Attribute{
					"cluster_config": schema.SingleNestedAttribute{
						Description:         "Hive metastore settings that affect all roles and role groups. The settings in the 'clusterConfig' are cluster wide settings that do not need to be configurable at role or role group level.",
						MarkdownDescription: "Hive metastore settings that affect all roles and role groups. The settings in the 'clusterConfig' are cluster wide settings that do not need to be configurable at role or role group level.",
						Attributes: map[string]schema.Attribute{
							"authentication": schema.SingleNestedAttribute{
								Description:         "Settings related to user [authentication](https://docs.stackable.tech/home/nightly/usage-guide/security).",
								MarkdownDescription: "Settings related to user [authentication](https://docs.stackable.tech/home/nightly/usage-guide/security).",
								Attributes: map[string]schema.Attribute{
									"kerberos": schema.SingleNestedAttribute{
										Description:         "Kerberos configuration.",
										MarkdownDescription: "Kerberos configuration.",
										Attributes: map[string]schema.Attribute{
											"secret_class": schema.StringAttribute{
												Description:         "Name of the SecretClass providing the keytab for the HBase services.",
												MarkdownDescription: "Name of the SecretClass providing the keytab for the HBase services.",
												Required:            true,
												Optional:            false,
												Computed:            false,
											},
							...
							"database": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Database connection specification for the metadata database.",
								Attributes: map[string]schema.Attribute{
									"conn_string": schema.StringAttribute{
										...
										MarkdownDescription: "A connection string for the database. For example: 'jdbc:postgresql://hivehdfs-postgresql:5432/hivehdfs'",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"db_type": schema.StringAttribute{
										...
										MarkdownDescription: "The type of database to connect to. Supported are: 'postgres', 'mysql', 'oracle', 'mssql' and 'derby'. This value is used to configure the jdbc driver class.",
										Required:            true,
										Optional:            false,
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("derby", "mysql", "postgres", "oracle", "mssql"),
										},
									},
								},
								Required: true,
							...
							"hdfs": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "HDFS connection specification.",
								Attributes: map[string]schema.Attribute{
									"config_map": schema.StringAttribute{
										Description:         "Name of the [discovery ConfigMap](https://docs.stackable.tech/home/nightly/concepts/service_discovery) providing information about the HDFS cluster. See also the [Stackable Operator for HDFS](https://docs.stackable.tech/home/nightly/hdfs/) to learn more about setting up an HDFS cluster.",
										MarkdownDescription: "Name of the [discovery ConfigMap](https://docs.stackable.tech/home/nightly/concepts/service_discovery) providing information about the HDFS cluster. See also the [Stackable Operator for HDFS](https://docs.stackable.tech/home/nightly/hdfs/) to learn more about setting up an HDFS cluster.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
							...
							"listener_class": schema.StringAttribute{
								Description:         "This field controls which type of Service the Operator creates for this HiveCluster: * cluster-internal: Use a ClusterIP service * external-unstable: Use a NodePort service * external-stable: Use a LoadBalancer service This is a temporary solution with the goal to keep yaml manifests forward compatible. In the future, this setting will control which [ListenerClass](https://docs.stackable.tech/home/nightly/listener-operator/listenerclass.html) will be used to expose the service, and ListenerClass names will stay the same, allowing for a non-breaking change.",
								MarkdownDescription: "This field controls which type of Service the Operator creates for this HiveCluster: * cluster-internal: Use a ClusterIP service * external-unstable: Use a NodePort service * external-stable: Use a LoadBalancer service This is a temporary solution with the goal to keep yaml manifests forward compatible. In the future, this setting will control which [ListenerClass](https://docs.stackable.tech/home/nightly/listener-operator/listenerclass.html) will be used to expose the service, and ListenerClass names will stay the same, allowing for a non-breaking change.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
						...
						Attributes: map[string]schema.Attribute{
							...
							"config": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
											...
											"storage": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													"data": schema.SingleNestedAttribute{
														...
														MarkdownDescription: "This field is deprecated. It was never used by Hive and will be removed in a future CRD version. The controller will warn if it's set to a non zero value.",
														Attributes: map[string]schema.Attribute{
									...
									"warehouse_dir": schema.StringAttribute{
										Description:         "The location of default database for the Hive warehouse. Maps to the 'hive.metastore.warehouse.dir' setting.",
										MarkdownDescription: "The location of default database for the Hive warehouse. Maps to the 'hive.metastore.warehouse.dir' setting.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
...
func (r *HiveStackableTechHiveClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hive_stackable_tech_hive_cluster_v1alpha1_manifest")

	var model HiveStackableTechHiveClusterV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("hive.stackable.tech/v1alpha1")
	model.Kind = pointer.String("HiveCluster")
