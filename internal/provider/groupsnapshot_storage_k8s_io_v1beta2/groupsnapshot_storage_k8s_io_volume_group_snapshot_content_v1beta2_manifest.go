...
package groupsnapshot_storage_k8s_io_v1beta2
...
var (
	_ datasource.DataSource = &GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest{}
)

func NewGroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest() datasource.DataSource {
	return &GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest{}
}

type GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest struct{}

type GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2ManifestData struct {
...
func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_groupsnapshot_storage_k8s_io_volume_group_snapshot_content_v1beta2_manifest"
}

func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_groupsnapshot_storage_k8s_io_volume_group_snapshot_content_v1beta2_manifest")

	var model GroupsnapshotStorageK8SIoVolumeGroupSnapshotContentV1Beta2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("groupsnapshot.storage.k8s.io/v1beta2")
