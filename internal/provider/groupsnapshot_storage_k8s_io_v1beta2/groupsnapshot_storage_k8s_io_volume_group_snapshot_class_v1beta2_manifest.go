...
var (
	_ datasource.DataSource = &GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest{}
)

func NewGroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest() datasource.DataSource {
	return &GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest{}
}

type GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest struct{}

type GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2ManifestData struct {
...
func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_groupsnapshot_storage_k8s_io_volume_group_snapshot_class_v1beta2_manifest"
}

func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_groupsnapshot_storage_k8s_io_volume_group_snapshot_class_v1beta2_manifest")

	var model GroupsnapshotStorageK8SIoVolumeGroupSnapshotClassV1Beta2ManifestData
