...
package hbase_stackable_tech_v1alpha1
...
var (
	_ datasource.DataSource = &HbaseStackableTechHbaseClusterV1Alpha1Manifest{}
)

func NewHbaseStackableTechHbaseClusterV1Alpha1Manifest() datasource.DataSource {
	return &HbaseStackableTechHbaseClusterV1Alpha1Manifest{}
}

type HbaseStackableTechHbaseClusterV1Alpha1Manifest struct{}

type HbaseStackableTechHbaseClusterV1Alpha1ManifestData struct {
...
func (r *HbaseStackableTechHbaseClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_hbase_stackable_tech_hbase_cluster_v1alpha1_manifest"
}

func (r *HbaseStackableTechHbaseClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Auto-generated derived type for HbaseClusterSpec via 'CustomResource'",
		MarkdownDescription: "Auto-generated derived type for HbaseClusterSpec via 'CustomResource'",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "An HBase cluster stacklet. This resource is managed by the Stackable operator for Apache HBase. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/hbase/). The CRD contains three roles: 'masters', 'regionServers' and 'restServers'.",
				MarkdownDescription: "An HBase cluster stacklet. This resource is managed by the Stackable operator for Apache HBase. Find more information on how to use it and the resources that the operator generates in the [operator documentation](https://docs.stackable.tech/home/nightly/hbase/). The CRD contains three roles: 'masters', 'regionServers' and 'restServers'.",
				Attributes: map[string]schema.Attribute{
					"cluster_config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Configuration that applies to all roles and role groups. This includes settings for logging, ZooKeeper and HDFS connection, among other things.",
						Attributes: map[string]schema.Attribute{
							"authentication": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"tls_secret_class": schema.StringAttribute{
										Description:         "Name of the SecretClass providing the tls certificates for the WebUIs.",
										MarkdownDescription: "Name of the SecretClass providing the tls certificates for the WebUIs.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"hdfs_config_map_name": schema.StringAttribute{
								...
								MarkdownDescription: "Name of the [discovery ConfigMap](https://docs.stackable.tech/home/nightly/concepts/service_discovery) for an HDFS cluster.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"zookeeper_config_map_name": schema.StringAttribute{
								...
								MarkdownDescription: "Name of the [discovery ConfigMap](https://docs.stackable.tech/home/nightly/concepts/service_discovery) for a ZooKeeper cluster.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"masters": schema.SingleNestedAttribute{
						Description:         "The HBase master process is responsible for assigning regions to region servers and manages the cluster.",
						MarkdownDescription: "The HBase master process is responsible for assigning regions to region servers and manages the cluster.",
						Attributes: map[string]schema.Attribute{
					...
					"region_servers": schema.SingleNestedAttribute{
						Description:         "Region servers hold the data and handle requests from clients for their region.",
						MarkdownDescription: "Region servers hold the data and handle requests from clients for their region.",
						Attributes: map[string]schema.Attribute{
							"cli_overrides": schema.MapAttribute{
								Description:         "",
								MarkdownDescription: "",
					...
					"rest_servers": schema.SingleNestedAttribute{
						Description:         "Rest servers provide a REST API to interact with.",
						MarkdownDescription: "Rest servers provide a REST API to interact with.",
						Attributes: map[string]schema.Attribute{
							"cli_overrides": schema.MapAttribute{
								Description:         "",
								MarkdownDescription: "",
...
func (r *HbaseStackableTechHbaseClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hbase_stackable_tech_hbase_cluster_v1alpha1_manifest")

	var model HbaseStackableTechHbaseClusterV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("hbase.stackable.tech/v1alpha1")
	model.Kind = pointer.String("HbaseCluster")
