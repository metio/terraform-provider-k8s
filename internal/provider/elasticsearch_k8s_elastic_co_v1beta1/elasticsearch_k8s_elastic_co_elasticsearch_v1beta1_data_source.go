...
var (
	_ datasource.DataSource              = &ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource{}
)

func NewElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource() datasource.DataSource {
	return &ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource{}
}

type ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSourceData struct {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1"
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1")

	var data ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSourceData
	...
	var readResponse ElasticsearchK8SElasticCoElasticsearchV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("elasticsearch.k8s.elastic.co/v1beta1")
	data.Kind = pointer.String("Elasticsearch")
