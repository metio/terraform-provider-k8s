...
func TestElasticsearchK8SElasticCoElasticsearchV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1", testCase)
		})
	}
}
