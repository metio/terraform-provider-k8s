...
func TestHyperfoilIoHyperfoilV1Alpha2Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_hyperfoil_io_hyperfoil_v1alpha2", testCase)
		})
	}
}
