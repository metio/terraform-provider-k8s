...
var (
	_ datasource.DataSource = &DataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest{}
)

func NewDataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest() datasource.DataSource {
	return &DataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest{}
}

type DataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest struct{}

type DataprotectionKubeblocksIoStorageProviderV1Alpha1ManifestData struct {
...
func (r *DataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_dataprotection_kubeblocks_io_storage_provider_v1alpha1_manifest"
}

func (r *DataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *DataprotectionKubeblocksIoStorageProviderV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_dataprotection_kubeblocks_io_storage_provider_v1alpha1_manifest")

	var model DataprotectionKubeblocksIoStorageProviderV1Alpha1ManifestData
