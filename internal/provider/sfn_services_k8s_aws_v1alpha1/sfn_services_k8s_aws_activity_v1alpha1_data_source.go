...
var (
	_ datasource.DataSource              = &SfnServicesK8SAwsActivityV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &SfnServicesK8SAwsActivityV1Alpha1DataSource{}
)

func NewSfnServicesK8SAwsActivityV1Alpha1DataSource() datasource.DataSource {
	return &SfnServicesK8SAwsActivityV1Alpha1DataSource{}
}

type SfnServicesK8SAwsActivityV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SfnServicesK8SAwsActivityV1Alpha1DataSourceData struct {
...
func (r *SfnServicesK8SAwsActivityV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_sfn_services_k8s_aws_activity_v1alpha1"
}

func (r *SfnServicesK8SAwsActivityV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SfnServicesK8SAwsActivityV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SfnServicesK8SAwsActivityV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_sfn_services_k8s_aws_activity_v1alpha1")

	var data SfnServicesK8SAwsActivityV1Alpha1DataSourceData
	...
	var readResponse SfnServicesK8SAwsActivityV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Activity")
