...
var (
	_ datasource.DataSource = &ImageregistryOperatorOpenshiftIoImagePrunerV1Manifest{}
)

func NewImageregistryOperatorOpenshiftIoImagePrunerV1Manifest() datasource.DataSource {
	return &ImageregistryOperatorOpenshiftIoImagePrunerV1Manifest{}
}
...
type ImageregistryOperatorOpenshiftIoImagePrunerV1ManifestData struct {
	...
	Spec *struct {
		...
		IgnoreInvalidImageReferences *bool              `tfsdk:"ignore_invalid_image_references" json:"ignoreInvalidImageReferences,omitempty"`
		KeepTagRevisions             *int64             `tfsdk:"keep_tag_revisions" json:"keepTagRevisions,omitempty"`
		KeepYoungerThan              *int64             `tfsdk:"keep_younger_than" json:"keepYoungerThan,omitempty"`
		KeepYoungerThanDuration      *string            `tfsdk:"keep_younger_than_duration" json:"keepYoungerThanDuration,omitempty"`
...
func (r *ImageregistryOperatorOpenshiftIoImagePrunerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_imageregistry_operator_openshift_io_image_pruner_v1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ImagePrunerSpec defines the specs for the running image pruner.",
				Attributes: map[string]schema.Attribute{
					"affinity": schema.SingleNestedAttribute{
						Description:         "affinity is a group of node affinity scheduling rules for the image pruner pod.",
						MarkdownDescription: "affinity is a group of node affinity scheduling rules for the image pruner pod.",
						Attributes: map[string]schema.Attribute{
					...
					"failed_jobs_history_limit": schema.Int64Attribute{
						...
						MarkdownDescription: "failedJobsHistoryLimit specifies how many failed image pruner jobs to retain. Defaults to 3 if not set.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"ignore_invalid_image_references": schema.BoolAttribute{
						Description:         "ignoreInvalidImageReferences indicates whether the pruner can ignore errors while parsing image references.",
						MarkdownDescription: "ignoreInvalidImageReferences indicates whether the pruner can ignore errors while parsing image references.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"keep_tag_revisions": schema.Int64Attribute{
						...
						MarkdownDescription: "keepTagRevisions specifies the number of image revisions for a tag in an image stream that will be preserved. Defaults to 3.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"keep_younger_than": schema.Int64Attribute{
						...
						MarkdownDescription: "keepYoungerThan specifies the minimum age in nanoseconds of an image and its referrers for it to be considered a candidate for pruning. DEPRECATED: This field is deprecated in favor of keepYoungerThanDuration. If both are set, this field is ignored and keepYoungerThanDuration takes precedence.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"keep_younger_than_duration": schema.StringAttribute{
						...
						MarkdownDescription: "keepYoungerThanDuration specifies the minimum age of an image and its referrers for it to be considered a candidate for pruning. Defaults to 60m (60 minutes).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"log_level": schema.StringAttribute{
						Description:         "logLevel sets the level of log output for the pruner job.  Valid values are: 'Normal', 'Debug', 'Trace', 'TraceAll'. Defaults to 'Normal'.",
						MarkdownDescription: "logLevel sets the level of log output for the pruner job.  Valid values are: 'Normal', 'Debug', 'Trace', 'TraceAll'. Defaults to 'Normal'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"node_selector": schema.MapAttribute{
						...
						MarkdownDescription: "nodeSelector defines the node selection constraints for the image pruner pod.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"resources": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "resources defines the resource requests and limits for the image pruner pod.",
						Attributes: map[string]schema.Attribute{
					...
					"schedule": schema.StringAttribute{
						...
						MarkdownDescription: "schedule specifies when to execute the job using standard cronjob syntax: https://wikipedia.org/wiki/Cron. Defaults to '0 0 * * *'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"successful_jobs_history_limit": schema.Int64Attribute{
						...
						MarkdownDescription: "successfulJobsHistoryLimit specifies how many successful image pruner jobs to retain. Defaults to 3 if not set.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"suspend": schema.BoolAttribute{
						...
						MarkdownDescription: "suspend specifies whether or not to suspend subsequent executions of this cronjob. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"tolerations": schema.ListNestedAttribute{
						...
						MarkdownDescription: "tolerations defines the node tolerations for the image pruner pod.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *ImageregistryOperatorOpenshiftIoImagePrunerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_imageregistry_operator_openshift_io_image_pruner_v1_manifest")

	var model ImageregistryOperatorOpenshiftIoImagePrunerV1ManifestData
