...
var (
	_ datasource.DataSource = &AppRedislabsComRedisEnterpriseClusterV1Manifest{}
)

func NewAppRedislabsComRedisEnterpriseClusterV1Manifest() datasource.DataSource {
	return &AppRedislabsComRedisEnterpriseClusterV1Manifest{}
}
...
func (r *AppRedislabsComRedisEnterpriseClusterV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_redislabs_com_redis_enterprise_cluster_v1_manifest"
}

func (r *AppRedislabsComRedisEnterpriseClusterV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
							...
							"call_home_client": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"proxy_secret_name": schema.StringAttribute{
										...
										MarkdownDescription: "if needed, add proxy details in secret. the name of the proxy secret in the secret, can send the following keys: proxy-url, proxy-username, proxy-password (the url includes the proxy port).",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
...
func (r *AppRedislabsComRedisEnterpriseClusterV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_app_redislabs_com_redis_enterprise_cluster_v1_manifest")

	var model AppRedislabsComRedisEnterpriseClusterV1ManifestData
