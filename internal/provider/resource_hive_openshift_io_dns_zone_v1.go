...
var (
	_ resource.Resource = (*HiveOpenshiftIoDNSZoneV1Resource)(nil)
)

type HiveOpenshiftIoDNSZoneV1TerraformModel struct {
...
type HiveOpenshiftIoDNSZoneV1GoModel struct {
	...
	Spec *struct {
		Aws *struct {
			...
			} `tfsdk:"additional_tags" yaml:"additionalTags,omitempty"`
		...
		LinkToParentDomain *bool `tfsdk:"link_to_parent_domain" yaml:"linkToParentDomain,omitempty"`
...
func (r *HiveOpenshiftIoDNSZoneV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_hive_openshift_io_dns_zone_v1"
}

func (r *HiveOpenshiftIoDNSZoneV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *HiveOpenshiftIoDNSZoneV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_hive_openshift_io_dns_zone_v1")

	var state HiveOpenshiftIoDNSZoneV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel HiveOpenshiftIoDNSZoneV1GoModel
	...
	goModel.Kind = utilities.Ptr("DNSZone")
...
func (r *HiveOpenshiftIoDNSZoneV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hive_openshift_io_dns_zone_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *HiveOpenshiftIoDNSZoneV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *HiveOpenshiftIoDNSZoneV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
