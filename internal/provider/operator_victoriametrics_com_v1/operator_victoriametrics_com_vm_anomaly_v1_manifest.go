							...
							"push": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"push_frequency": schema.StringAttribute{
										...
										MarkdownDescription: "PushFrequency defines push interval",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
					...
					"reader": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"datasource_url": schema.StringAttribute{
								...
								MarkdownDescription: "DatasourceURL address datasource must serve /api/v1/query and /api/v1/query_range APIs",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
