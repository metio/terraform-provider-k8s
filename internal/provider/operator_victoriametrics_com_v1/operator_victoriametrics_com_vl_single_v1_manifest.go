...
var (
	_ datasource.DataSource = &OperatorVictoriametricsComVlsingleV1Manifest{}
)

func NewOperatorVictoriametricsComVlsingleV1Manifest() datasource.DataSource {
	return &OperatorVictoriametricsComVlsingleV1Manifest{}
}

type OperatorVictoriametricsComVlsingleV1Manifest struct{}

type OperatorVictoriametricsComVlsingleV1ManifestData struct {
...
func (r *OperatorVictoriametricsComVlsingleV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_victoriametrics_com_vl_single_v1_manifest"
}

func (r *OperatorVictoriametricsComVlsingleV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "VLSingle is fast, cost-effective and scalable logs database. VLSingle is the Schema for the API",
		MarkdownDescription: "VLSingle is fast, cost-effective and scalable logs database. VLSingle is the Schema for the API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "VLSingleSpec defines the desired state of VLSingle",
				Attributes: map[string]schema.Attribute{
					...
					"log_format": schema.StringAttribute{
						...
						MarkdownDescription: "LogFormat for VLSingle to be configured with.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"pod_metadata": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "PodMetadata configures Labels and Annotations which are propagated to the VLSingle pods.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations",
								MarkdownDescription: "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations",
					...
					"service_scrape_spec": schema.MapAttribute{
						...
						MarkdownDescription: "ServiceScrapeSpec that will be added to vlsingle VMServiceScrape spec",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"service_spec": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ServiceSpec that will be added to vlsingle service spec",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
					...
					"storage": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Storage is the definition of how storage will be used by the VLSingle by default it's empty dir",
						Attributes: map[string]schema.Attribute{
					...
					"storage_metadata": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "StorageMeta defines annotations and labels attached to PVC for given vlsingle CR",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations",
								MarkdownDescription: "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations",
...
func (r *OperatorVictoriametricsComVlsingleV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_victoriametrics_com_vl_single_v1_manifest")

	var model OperatorVictoriametricsComVlsingleV1ManifestData
	...
	model.Kind = pointer.String("VLSingle")
