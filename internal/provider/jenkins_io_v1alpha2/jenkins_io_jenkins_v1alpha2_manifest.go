...
var (
	_ datasource.DataSource = &JenkinsIoJenkinsV1Alpha2Manifest{}
)

func NewJenkinsIoJenkinsV1Alpha2Manifest() datasource.DataSource {
	return &JenkinsIoJenkinsV1Alpha2Manifest{}
}

type JenkinsIoJenkinsV1Alpha2Manifest struct{}

type JenkinsIoJenkinsV1Alpha2ManifestData struct {
	...
	Spec *struct {
		Backup *struct {
			...
			MakeBackupBeforePodDeletion *bool   `tfsdk:"make_backup_before_pod_deletion" json:"makeBackupBeforePodDeletion,omitempty"`
		} `tfsdk:"backup" json:"backup,omitempty"`
		ConfigurationAsCode *struct {
		...
		} `tfsdk:"configuration_as_code" json:"configurationAsCode,omitempty"`
		GroovyScripts *struct {
			Configurations *[]struct {
				Name *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"configurations" json:"configurations,omitempty"`
			Secret *struct {
		...
		} `tfsdk:"groovy_scripts" json:"groovyScripts,omitempty"`
		JenkinsAPISettings *struct {
			AuthorizationStrategy *string `tfsdk:"authorization_strategy" json:"authorizationStrategy,omitempty"`
		} `tfsdk:"jenkins_api_settings" json:"jenkinsAPISettings,omitempty"`
		Master *struct {
			Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			BasePlugins *[]struct {
				DownloadURL *string `tfsdk:"download_url" json:"downloadURL,omitempty"`
				Name        *string `tfsdk:"name" json:"name,omitempty"`
				Version     *string `tfsdk:"version" json:"version,omitempty"`
			} `tfsdk:"base_plugins" json:"basePlugins,omitempty"`
			Containers *[]struct {
			...
			DisableCSRFProtection *bool `tfsdk:"disable_csrf_protection" json:"disableCSRFProtection,omitempty"`
			HostAliases           *[]struct {
			...
			Labels        *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
			LatestPlugins *bool              `tfsdk:"latest_plugins" json:"latestPlugins,omitempty"`
			...
			SkipPlugins                   *bool  `tfsdk:"skip_plugins" json:"skipPlugins,omitempty"`
			TerminationGracePeriodSeconds *int64 `tfsdk:"termination_grace_period_seconds" json:"terminationGracePeriodSeconds,omitempty"`
			Tolerations                   *[]struct {
		...
		Notifications *[]struct {
			Level   *string `tfsdk:"level" json:"level,omitempty"`
			Mailgun *struct {
				ApiKeySecretKeySelector *struct {
					Key    *string `tfsdk:"key" json:"key,omitempty"`
					Secret *struct {
						Name *string `tfsdk:"name" json:"name,omitempty"`
					} `tfsdk:"secret" json:"secret,omitempty"`
				} `tfsdk:"api_key_secret_key_selector" json:"apiKeySecretKeySelector,omitempty"`
			...
			} `tfsdk:"mailgun" json:"mailgun,omitempty"`
			Name  *string `tfsdk:"name" json:"name,omitempty"`
			Slack *struct {
				WebHookURLSecretKeySelector *struct {
					Key    *string `tfsdk:"key" json:"key,omitempty"`
					Secret *struct {
						Name *string `tfsdk:"name" json:"name,omitempty"`
					} `tfsdk:"secret" json:"secret,omitempty"`
				} `tfsdk:"web_hook_url_secret_key_selector" json:"webHookURLSecretKeySelector,omitempty"`
			} `tfsdk:"slack" json:"slack,omitempty"`
			Smtp *struct {
				From                      *string `tfsdk:"from" json:"from,omitempty"`
				PasswordSecretKeySelector *struct {
					Key    *string `tfsdk:"key" json:"key,omitempty"`
					Secret *struct {
						Name *string `tfsdk:"name" json:"name,omitempty"`
					} `tfsdk:"secret" json:"secret,omitempty"`
				} `tfsdk:"password_secret_key_selector" json:"passwordSecretKeySelector,omitempty"`
				Port                      *int64  `tfsdk:"port" json:"port,omitempty"`
				Server                    *string `tfsdk:"server" json:"server,omitempty"`
				TlsInsecureSkipVerify     *bool   `tfsdk:"tls_insecure_skip_verify" json:"tlsInsecureSkipVerify,omitempty"`
				To                        *string `tfsdk:"to" json:"to,omitempty"`
				UsernameSecretKeySelector *struct {
					Key    *string `tfsdk:"key" json:"key,omitempty"`
					Secret *struct {
						Name *string `tfsdk:"name" json:"name,omitempty"`
					} `tfsdk:"secret" json:"secret,omitempty"`
				} `tfsdk:"username_secret_key_selector" json:"usernameSecretKeySelector,omitempty"`
			...
			} `tfsdk:"teams" json:"teams,omitempty"`
		...
		Restore *struct {
			...
			ContainerName   *string `tfsdk:"container_name" json:"containerName,omitempty"`
			GetLatestAction *struct {
				Exec *struct {
					Command *[]string `tfsdk:"command" json:"command,omitempty"`
				} `tfsdk:"exec" json:"exec,omitempty"`
			} `tfsdk:"get_latest_action" json:"getLatestAction,omitempty"`
			RecoveryOnce *int64 `tfsdk:"recovery_once" json:"recoveryOnce,omitempty"`
		...
		SeedJobAgentImage *string `tfsdk:"seed_job_agent_image" json:"seedJobAgentImage,omitempty"`
		SeedJobs          *[]struct {
			AdditionalClasspath   *string `tfsdk:"additional_classpath" json:"additionalClasspath,omitempty"`
			BitbucketPushTrigger  *bool   `tfsdk:"bitbucket_push_trigger" json:"bitbucketPushTrigger,omitempty"`
			BuildPeriodically     *string `tfsdk:"build_periodically" json:"buildPeriodically,omitempty"`
			CredentialID          *string `tfsdk:"credential_id" json:"credentialID,omitempty"`
			CredentialType        *string `tfsdk:"credential_type" json:"credentialType,omitempty"`
			Description           *string `tfsdk:"description" json:"description,omitempty"`
			FailOnMissingPlugin   *bool   `tfsdk:"fail_on_missing_plugin" json:"failOnMissingPlugin,omitempty"`
			GithubPushTrigger     *bool   `tfsdk:"github_push_trigger" json:"githubPushTrigger,omitempty"`
			Id                    *string `tfsdk:"id" json:"id,omitempty"`
			IgnoreMissingFiles    *bool   `tfsdk:"ignore_missing_files" json:"ignoreMissingFiles,omitempty"`
			PollSCM               *string `tfsdk:"poll_scm" json:"pollSCM,omitempty"`
			RepositoryBranch      *string `tfsdk:"repository_branch" json:"repositoryBranch,omitempty"`
			...
			UnstableOnDeprecation *bool   `tfsdk:"unstable_on_deprecation" json:"unstableOnDeprecation,omitempty"`
		} `tfsdk:"seed_jobs" json:"seedJobs,omitempty"`
		Service *struct {
			Annotations              *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			Labels                   *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		...
		SlaveService *struct {
			...
			Port                     *int64             `tfsdk:"port" json:"port,omitempty"`
			Type                     *string            `tfsdk:"type" json:"type,omitempty"`
		} `tfsdk:"slave_service" json:"slaveService,omitempty"`
		ValidateSecurityWarnings *bool `tfsdk:"validate_security_warnings" json:"validateSecurityWarnings,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *JenkinsIoJenkinsV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_jenkins_io_jenkins_v1alpha2_manifest"
}

func (r *JenkinsIoJenkinsV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Jenkins is the Schema for the jenkins API",
		MarkdownDescription: "Jenkins is the Schema for the jenkins API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "Spec defines the desired state of the Jenkins",
				Attributes: map[string]schema.Attribute{
					"backup": schema.SingleNestedAttribute{
						Description:         "Backup defines configuration of Jenkins backup More info: https://jenkinsci.github.io/kubernetes-operator/docs/getting-started/latest/configuring-backup-and-restore/",
						MarkdownDescription: "Backup defines configuration of Jenkins backup More info: https://jenkinsci.github.io/kubernetes-operator/docs/getting-started/latest/configuring-backup-and-restore/",
						Attributes: map[string]schema.Attribute{
							"action": schema.SingleNestedAttribute{
								Description:         "Action defines action which performs backup in backup container sidecar",
								MarkdownDescription: "Action defines action which performs backup in backup container sidecar",
								Attributes: map[string]schema.Attribute{
							...
							"container_name": schema.StringAttribute{
								Description:         "ContainerName is the container name responsible for backup operation",
								MarkdownDescription: "ContainerName is the container name responsible for backup operation",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"interval": schema.Int64Attribute{
								Description:         "Interval tells how often make backup in seconds Defaults to 30.",
								MarkdownDescription: "Interval tells how often make backup in seconds Defaults to 30.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},

							"make_backup_before_pod_deletion": schema.BoolAttribute{
								Description:         "MakeBackupBeforePodDeletion tells operator to make backup before Jenkins master pod deletion",
								MarkdownDescription: "MakeBackupBeforePodDeletion tells operator to make backup before Jenkins master pod deletion",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"configuration_as_code": schema.SingleNestedAttribute{
						Description:         "ConfigurationAsCode defines configuration of Jenkins customization via Configuration as Code Jenkins plugin",
						MarkdownDescription: "ConfigurationAsCode defines configuration of Jenkins customization via Configuration as Code Jenkins plugin",
						Attributes: map[string]schema.Attribute{
							...
							"secret": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "SecretRef is reference to Kubernetes secret.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
					...
					"groovy_scripts": schema.SingleNestedAttribute{
						Description:         "GroovyScripts defines configuration of Jenkins customization via groovy scripts",
						MarkdownDescription: "GroovyScripts defines configuration of Jenkins customization via groovy scripts",
						Attributes: map[string]schema.Attribute{
							"configurations": schema.ListNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
					...
					"jenkins_api_settings": schema.SingleNestedAttribute{
						Description:         "JenkinsAPISettings defines configuration used by the operator to gain admin access to the Jenkins API",
						MarkdownDescription: "JenkinsAPISettings defines configuration used by the operator to gain admin access to the Jenkins API",
						Attributes: map[string]schema.Attribute{
							"authorization_strategy": schema.StringAttribute{
								Description:         "AuthorizationStrategy defines authorization strategy of the operator for the Jenkins API",
								MarkdownDescription: "AuthorizationStrategy defines authorization strategy of the operator for the Jenkins API",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"master": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Master represents Jenkins master pod properties and Jenkins plugins. Every single change here requires a pod restart.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
							...
							"base_plugins": schema.ListNestedAttribute{
								Description:         "BasePlugins contains plugins required by operator Defaults to : - name: configuration-as-code version: '1625.v27444588cc3d' - name: git version: '5.0.0' - name: job-dsl version: '1.83' - name: kubernetes version: '3909.v1f2c633e8590' - name: kubernetes-credentials-provider version: '1.211.vc236a_f5a_2f3c' - name: workflow-aggregator version: '596.v8c21c963d92d' - name: workflow-job version: '1289.vd1c337fd5354'",
								MarkdownDescription: "BasePlugins contains plugins required by operator Defaults to : - name: configuration-as-code version: '1625.v27444588cc3d' - name: git version: '5.0.0' - name: job-dsl version: '1.83' - name: kubernetes version: '3909.v1f2c633e8590' - name: kubernetes-credentials-provider version: '1.211.vc236a_f5a_2f3c' - name: workflow-aggregator version: '596.v8c21c963d92d' - name: workflow-job version: '1289.vd1c337fd5354'",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"download_url": schema.StringAttribute{
											Description:         "DownloadURL is the custom url from where plugin has to be downloaded.",
											MarkdownDescription: "DownloadURL is the custom url from where plugin has to be downloaded.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Name is the name of Jenkins plugin",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"version": schema.StringAttribute{
											...
											MarkdownDescription: "Version is the version of Jenkins plugin",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
							...
							"containers": schema.ListNestedAttribute{
								...
								MarkdownDescription: "List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Defaults to: - image: jenkins/jenkins:lts imagePullPolicy: Always livenessProbe: failureThreshold: 12 httpGet: path: /login port: http scheme: HTTP initialDelaySeconds: 80 periodSeconds: 10 successThreshold: 1 timeoutSeconds: 5 lifecycle: {} name: jenkins-master readinessProbe: failureThreshold: 3 httpGet: path: /login port: http scheme: HTTP initialDelaySeconds: 30 periodSeconds: 10 successThreshold: 1 timeoutSeconds: 1 resources: limits: cpu: 1500m memory: 3Gi requests: cpu: '1' memory: 600Mi",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"image_pull_policy": schema.StringAttribute{
											...
											MarkdownDescription: "Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"lifecycle": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "Actions that the management system should take in response to container lifecycle events.",
											Attributes: map[string]schema.Attribute{
										...
										"name": schema.StringAttribute{
											Description:         "Name of the container specified as a DNS_LABEL. Each container in a pod must have a unique name (DNS_LABEL).",
											MarkdownDescription: "Name of the container specified as a DNS_LABEL. Each container in a pod must have a unique name (DNS_LABEL).",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"resources": schema.SingleNestedAttribute{
											Description:         "Compute Resources required by this container. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/",
											MarkdownDescription: "Compute Resources required by this container. More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/",
											Attributes: map[string]schema.Attribute{
										...
										"working_dir": schema.StringAttribute{
											...
											MarkdownDescription: "Container's working directory. If not specified, the container runtime's default will be used, which might be configured in the container image.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
							...
							"disable_csrf_protection": schema.BoolAttribute{
								Description:         "DisableCSRFProtection allows you to toggle CSRF Protection on Jenkins",
								MarkdownDescription: "DisableCSRFProtection allows you to toggle CSRF Protection on Jenkins",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"host_aliases": schema.ListNestedAttribute{
								...
								MarkdownDescription: "HostAliases for Jenkins master pod and SeedJob agent",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
							...
							"latest_plugins": schema.BoolAttribute{
								Description:         "Allow to override jenkins-plugin-cli default behavior while downloading the plugin and dependencies see: https://github.com/jenkinsci/plugin-installation-manager-tool#cli-options",
								MarkdownDescription: "Allow to override jenkins-plugin-cli default behavior while downloading the plugin and dependencies see: https://github.com/jenkinsci/plugin-installation-manager-tool#cli-options",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"plugins": schema.ListNestedAttribute{
								...
								MarkdownDescription: "Plugins contains plugins required by user",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"download_url": schema.StringAttribute{
											Description:         "DownloadURL is the custom url from where plugin has to be downloaded.",
							...
							"priority_class_name": schema.StringAttribute{
								...
								MarkdownDescription: "PriorityClassName for Jenkins master pod",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"security_context": schema.SingleNestedAttribute{
								Description:         "SecurityContext that applies to all the containers of the Jenkins Master. As per kubernetes specification, it can be overridden for each container individually. Defaults to: runAsUser: 1000 fsGroup: 1000",
								MarkdownDescription: "SecurityContext that applies to all the containers of the Jenkins Master. As per kubernetes specification, it can be overridden for each container individually. Defaults to: runAsUser: 1000 fsGroup: 1000",
								Attributes: map[string]schema.Attribute{
									"app_armor_profile": schema.SingleNestedAttribute{
							...
							"skip_plugins": schema.BoolAttribute{
								...
								MarkdownDescription: "Allow to skip installation of both BasePlugins and Plugins. Requires using a custom image which includes the BasePlugins. Defaults to false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"termination_grace_period_seconds": schema.Int64Attribute{
								Description:         "The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. Defaults to 30 seconds.",
								MarkdownDescription: "The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. Defaults to 30 seconds.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"notifications": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Notifications defines list of a services which are used to inform about Jenkins status Can be used to integrate chat services like Slack, Microsoft Teams or Mailgun",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"level": schema.StringAttribute{
									Description:         "NotificationLevel defines the level of a Notification.",
									MarkdownDescription: "NotificationLevel defines the level of a Notification.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},

								"mailgun": schema.SingleNestedAttribute{
									Description:         "Mailgun is handler for Mailgun email service notification channel.",
									MarkdownDescription: "Mailgun is handler for Mailgun email service notification channel.",
									Attributes: map[string]schema.Attribute{
										"api_key_secret_key_selector": schema.SingleNestedAttribute{
								...
								"slack": schema.SingleNestedAttribute{
									...
									MarkdownDescription: "Slack is handler for Slack notification channel.",
									Attributes: map[string]schema.Attribute{
										"web_hook_url_secret_key_selector": schema.SingleNestedAttribute{
											Description:         "The web hook URL to Slack App",
											MarkdownDescription: "The web hook URL to Slack App",
											Attributes: map[string]schema.Attribute{
												"key": schema.StringAttribute{
													Description:         "The key of the secret to select from. Must be a valid secret key.",
													MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
								...
								"smtp": schema.SingleNestedAttribute{
									...
									MarkdownDescription: "SMTP is handler for sending emails via this protocol.",
									Attributes: map[string]schema.Attribute{
										"from": schema.StringAttribute{
											Description:         "",
											MarkdownDescription: "",
										...
										"password_secret_key_selector": schema.SingleNestedAttribute{
											Description:         "SecretKeySelector selects a key of a Secret.",
											MarkdownDescription: "SecretKeySelector selects a key of a Secret.",
											Attributes: map[string]schema.Attribute{
												"key": schema.StringAttribute{
										...
										"username_secret_key_selector": schema.SingleNestedAttribute{
											Description:         "SecretKeySelector selects a key of a Secret.",
											MarkdownDescription: "SecretKeySelector selects a key of a Secret.",
											Attributes: map[string]schema.Attribute{
												"key": schema.StringAttribute{
								...
								"teams": schema.SingleNestedAttribute{
									Description:         "MicrosoftTeams is handler for Microsoft MicrosoftTeams notification channel.",
									MarkdownDescription: "MicrosoftTeams is handler for Microsoft MicrosoftTeams notification channel.",
									Attributes: map[string]schema.Attribute{
										"web_hook_url_secret_key_selector": schema.SingleNestedAttribute{
											Description:         "The web hook URL to MicrosoftTeams App",
											MarkdownDescription: "The web hook URL to MicrosoftTeams App",
											Attributes: map[string]schema.Attribute{
												"key": schema.StringAttribute{
													Description:         "The key of the secret to select from. Must be a valid secret key.",
													MarkdownDescription: "The key of the secret to select from. Must be a valid secret key.",
					...
					"restore": schema.SingleNestedAttribute{
						Description:         "Backup defines configuration of Jenkins backup restore More info: https://jenkinsci.github.io/kubernetes-operator/docs/getting-started/latest/configuring-backup-and-restore/",
						MarkdownDescription: "Backup defines configuration of Jenkins backup restore More info: https://jenkinsci.github.io/kubernetes-operator/docs/getting-started/latest/configuring-backup-and-restore/",
						Attributes: map[string]schema.Attribute{
							"action": schema.SingleNestedAttribute{
								Description:         "Action defines action which performs restore backup in restore container sidecar",
								MarkdownDescription: "Action defines action which performs restore backup in restore container sidecar",
								Attributes: map[string]schema.Attribute{
									"exec": schema.SingleNestedAttribute{
										Description:         "Exec specifies the action to take.",
										MarkdownDescription: "Exec specifies the action to take.",
							...
							"container_name": schema.StringAttribute{
								Description:         "ContainerName is the container name responsible for restore backup operation",
								MarkdownDescription: "ContainerName is the container name responsible for restore backup operation",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},

							"get_latest_action": schema.SingleNestedAttribute{
								Description:         "GetLatestAction defines action which returns the latest backup number. If there is no backup '-1' should be returned.",
								MarkdownDescription: "GetLatestAction defines action which returns the latest backup number. If there is no backup '-1' should be returned.",
								Attributes: map[string]schema.Attribute{
									"exec": schema.SingleNestedAttribute{
										Description:         "Exec specifies the action to take.",
										MarkdownDescription: "Exec specifies the action to take.",
							...
							"recovery_once": schema.Int64Attribute{
								Description:         "RecoveryOnce if want to restore specific backup set this field and then Jenkins will be restarted and desired backup will be restored",
								MarkdownDescription: "RecoveryOnce if want to restore specific backup set this field and then Jenkins will be restarted and desired backup will be restored",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"roles": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Roles defines list of extra RBAC roles for the Jenkins Master pod service account",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"api_group": schema.StringAttribute{
					...
					"seed_job_agent_image": schema.StringAttribute{
						...
						MarkdownDescription: "SeedJobAgentImage defines the image that will be used by the seed job agent. If not defined jenkins/inbound-agent:4.9-1 will be used.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"seed_jobs": schema.ListNestedAttribute{
						Description:         "SeedJobs defines list of Jenkins Seed Job configurations More info: https://jenkinsci.github.io/kubernetes-operator/docs/getting-started/latest/configuring-seed-jobs-and-pipelines/",
						MarkdownDescription: "SeedJobs defines list of Jenkins Seed Job configurations More info: https://jenkinsci.github.io/kubernetes-operator/docs/getting-started/latest/configuring-seed-jobs-and-pipelines/",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"additional_classpath": schema.StringAttribute{
									Description:         "AdditionalClasspath is setting for Job DSL API plugin to set Additional Classpath",
									MarkdownDescription: "AdditionalClasspath is setting for Job DSL API plugin to set Additional Classpath",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"bitbucket_push_trigger": schema.BoolAttribute{
									Description:         "BitbucketPushTrigger is used for Bitbucket web hooks",
									MarkdownDescription: "BitbucketPushTrigger is used for Bitbucket web hooks",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"build_periodically": schema.StringAttribute{
									Description:         "BuildPeriodically is setting for scheduled trigger",
									MarkdownDescription: "BuildPeriodically is setting for scheduled trigger",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"credential_id": schema.StringAttribute{
									Description:         "CredentialID is the Kubernetes secret name which stores repository access credentials",
									MarkdownDescription: "CredentialID is the Kubernetes secret name which stores repository access credentials",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"credential_type": schema.StringAttribute{
									Description:         "JenkinsCredentialType is the https://jenkinsci.github.io/kubernetes-credentials-provider-plugin/ credential type",
									MarkdownDescription: "JenkinsCredentialType is the https://jenkinsci.github.io/kubernetes-credentials-provider-plugin/ credential type",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"description": schema.StringAttribute{
									...
									MarkdownDescription: "Description is the description of the seed job",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"fail_on_missing_plugin": schema.BoolAttribute{
									Description:         "FailOnMissingPlugin is setting for Job DSL API plugin that fails job if required plugin is missing",
									MarkdownDescription: "FailOnMissingPlugin is setting for Job DSL API plugin that fails job if required plugin is missing",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"github_push_trigger": schema.BoolAttribute{
									Description:         "GitHubPushTrigger is used for GitHub web hooks",
									MarkdownDescription: "GitHubPushTrigger is used for GitHub web hooks",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"id": schema.StringAttribute{
									...
									MarkdownDescription: "ID is the unique seed job name",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"ignore_missing_files": schema.BoolAttribute{
									Description:         "IgnoreMissingFiles is setting for Job DSL API plugin to ignore files that miss",
									MarkdownDescription: "IgnoreMissingFiles is setting for Job DSL API plugin to ignore files that miss",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"poll_scm": schema.StringAttribute{
									Description:         "PollSCM is setting for polling changes in SCM",
									MarkdownDescription: "PollSCM is setting for polling changes in SCM",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"repository_branch": schema.StringAttribute{
									Description:         "RepositoryBranch is the repository branch where are seed job definitions",
									MarkdownDescription: "RepositoryBranch is the repository branch where are seed job definitions",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"repository_url": schema.StringAttribute{
									Description:         "RepositoryURL is the repository access URL. Can be SSH or HTTPS.",
									MarkdownDescription: "RepositoryURL is the repository access URL. Can be SSH or HTTPS.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"targets": schema.StringAttribute{
									Description:         "Targets is the repository path where are seed job definitions",
									MarkdownDescription: "Targets is the repository path where are seed job definitions",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},

								"unstable_on_deprecation": schema.BoolAttribute{
									Description:         "UnstableOnDeprecation is setting for Job DSL API plugin that sets build status as unstable if build using deprecated features",
									MarkdownDescription: "UnstableOnDeprecation is setting for Job DSL API plugin that sets build status as unstable if build using deprecated features",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"service": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Service is Kubernetes service of Jenkins master HTTP pod Defaults to : port: 8080 type: ClusterIP",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations",
								MarkdownDescription: "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations",
							...
							"port": schema.Int64Attribute{
								Description:         "The port that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies",
								MarkdownDescription: "The port that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"service_account": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ServiceAccount defines Jenkins master service account attributes",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations",
								MarkdownDescription: "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations",
					...
					"slave_service": schema.SingleNestedAttribute{
						Description:         "Service is Kubernetes service of Jenkins slave pods Defaults to : port: 50000 type: ClusterIP",
						MarkdownDescription: "Service is Kubernetes service of Jenkins slave pods Defaults to : port: 50000 type: ClusterIP",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations",
								MarkdownDescription: "Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations",
					...
					"validate_security_warnings": schema.BoolAttribute{
						Description:         "ValidateSecurityWarnings enables or disables validating potential security warnings in Jenkins plugins via admission webhooks.",
						MarkdownDescription: "ValidateSecurityWarnings enables or disables validating potential security warnings in Jenkins plugins via admission webhooks.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *JenkinsIoJenkinsV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_jenkins_io_jenkins_v1alpha2_manifest")

	var model JenkinsIoJenkinsV1Alpha2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("jenkins.io/v1alpha2")
	model.Kind = pointer.String("Jenkins")
