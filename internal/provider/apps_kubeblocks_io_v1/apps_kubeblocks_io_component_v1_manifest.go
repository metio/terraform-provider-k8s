...
var (
	_ datasource.DataSource = &AppsKubeblocksIoComponentV1Manifest{}
)

func NewAppsKubeblocksIoComponentV1Manifest() datasource.DataSource {
	return &AppsKubeblocksIoComponentV1Manifest{}
}

type AppsKubeblocksIoComponentV1Manifest struct{}

type AppsKubeblocksIoComponentV1ManifestData struct {
	...
	Spec *struct {
		...
		EnableInstanceAPI *bool `tfsdk:"enable_instance_api" json:"enableInstanceAPI,omitempty"`
		Env               *[]struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Value     *string `tfsdk:"value" json:"value,omitempty"`
			ValueFrom *struct {
		...
		FlatInstanceOrdinal    *bool `tfsdk:"flat_instance_ordinal" json:"flatInstanceOrdinal,omitempty"`
		...
		Instances *[]struct {
			Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			Canary      *bool              `tfsdk:"canary" json:"canary,omitempty"`
			CompDef     *string            `tfsdk:"comp_def" json:"compDef,omitempty"`
			Env         *[]struct {
				Name      *string `tfsdk:"name" json:"name,omitempty"`
				Value     *string `tfsdk:"value" json:"value,omitempty"`
		...
		ServiceRefs        *[]struct {
			ClusterServiceSelector *struct {
				...
				} `tfsdk:"pod_fqd_ns" json:"podFQDNs,omitempty"`
				Service *struct {
					Component *string `tfsdk:"component" json:"component,omitempty"`
					Port      *string `tfsdk:"port" json:"port,omitempty"`
					Service   *string `tfsdk:"service" json:"service,omitempty"`
		...
		Sidecars *[]struct {
			...
			SidecarDef *string `tfsdk:"sidecar_def" json:"sidecarDef,omitempty"`
...
func (r *AppsKubeblocksIoComponentV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_kubeblocks_io_component_v1_manifest"
}

func (r *AppsKubeblocksIoComponentV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"external_managed": schema.BoolAttribute{
									Description:         "ExternalManaged indicates whether the configuration is managed by an external system. When set to true, the controller will use the user-provided template and reconfigure action, ignoring the default template and update behavior.",
									MarkdownDescription: "ExternalManaged indicates whether the configuration is managed by an external system. When set to true, the controller will use the user-provided template and reconfigure action, ignoring the default template and update behavior.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"variables": schema.MapAttribute{
									Description:         "Variables are key-value pairs for dynamic configuration values that can be provided by the user.",
									MarkdownDescription: "Variables are key-value pairs for dynamic configuration values that can be provided by the user.",
									ElementType:         types.StringType,
									Required:            false,
									Optional:            true,
									Computed:            false,
					...
					"enable_instance_api": schema.BoolAttribute{
						Description:         "Specifies whether to enable the new Instance API.",
						MarkdownDescription: "Specifies whether to enable the new Instance API.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"flat_instance_ordinal": schema.BoolAttribute{
						Description:         "flatInstanceOrdinal controls whether the naming of instances(pods) under this component uses a flattened, globally uniquely ordinal scheme, regardless of the instance template. Defaults to false.",
						MarkdownDescription: "flatInstanceOrdinal controls whether the naming of instances(pods) under this component uses a flattened, globally uniquely ordinal scheme, regardless of the instance template. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"instance_update_strategy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Provides fine-grained control over the spec update process of all instances.",
						Attributes: map[string]schema.Attribute{
							"rolling_update": schema.SingleNestedAttribute{
								Description:         "Specifies how the rolling update should be applied.",
								MarkdownDescription: "Specifies how the rolling update should be applied.",
								Attributes: map[string]schema.Attribute{
									"max_unavailable": schema.StringAttribute{
										Description:         "The maximum number of instances that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired instances (ex: 10%). Absolute number is calculated from percentage by rounding up. This can not be 0. Defaults to 1. The field applies to all instances. That means if there is any unavailable pod, it will be counted towards MaxUnavailable.",
										MarkdownDescription: "The maximum number of instances that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired instances (ex: 10%). Absolute number is calculated from percentage by rounding up. This can not be 0. Defaults to 1. The field applies to all instances. That means if there is any unavailable pod, it will be counted towards MaxUnavailable.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"replicas": schema.StringAttribute{
										Description:         "Indicates the number of instances that should be updated during a rolling update. The remaining instances will remain untouched. This is helpful in defining how many instances should participate in the update process. Value can be an absolute number (ex: 5) or a percentage of desired instances (ex: 10%). Absolute number is calculated from percentage by rounding up. The default value is ComponentSpec.Replicas (i.e., update all instances).",
										MarkdownDescription: "Indicates the number of instances that should be updated during a rolling update. The remaining instances will remain untouched. This is helpful in defining how many instances should participate in the update process. Value can be an absolute number (ex: 5) or a percentage of desired instances (ex: 10%). Absolute number is calculated from percentage by rounding up. The default value is ComponentSpec.Replicas (i.e., update all instances).",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"type": schema.StringAttribute{
								Description:         "Indicates the type of the update strategy. Default is RollingUpdate.",
								MarkdownDescription: "Indicates the type of the update strategy. Default is RollingUpdate.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
					...
					"instances": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"canary": schema.BoolAttribute{
									Description:         "Indicate whether the instances belonging to this template are canary instances.",
									MarkdownDescription: "Indicate whether the instances belonging to this template are canary instances.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"name": schema.StringAttribute{
									Description:         "Name specifies the unique name of the instance Pod created using this InstanceTemplate. This name is constructed by concatenating the Component's name, the template's name, and the instance's ordinal using the pattern: $(cluster.name)-$(component.name)-$(template.name)-$(ordinal). Ordinals start from 0. The name can't be empty.",
									MarkdownDescription: "Name specifies the unique name of the instance Pod created using this InstanceTemplate. This name is constructed by concatenating the Component's name, the template's name, and the instance's ordinal using the pattern: $(cluster.name)-$(component.name)-$(template.name)-$(ordinal). Ordinals start from 0. The name can't be empty.",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"ordinals": schema.SingleNestedAttribute{
									Description:         "Specifies the desired Ordinals of this InstanceTemplate. The Ordinals used to specify the ordinal of the instance (pod) names to be generated under this InstanceTemplate. If Ordinals are defined, their number must be equal to or more than the corresponding replicas. For example, if Ordinals is {ranges: [{start: 0, end: 1}], discrete: [7]}, then the instance names generated under this InstanceTemplate would be $(cluster.name)-$(component.name)-$(template.name)-0、$(cluster.name)-$(component.name)-$(template.name)-1 and $(cluster.name)-$(component.name)-$(template.name)-7",
								...
								"service_version": schema.StringAttribute{
									Description:         "ServiceVersion specifies the version of the Service expected to be provisioned by this InstanceTemplate. The version should follow the syntax and semantics of the 'Semantic Versioning' specification (http://semver.org/).",
									MarkdownDescription: "ServiceVersion specifies the version of the Service expected to be provisioned by this InstanceTemplate. The version should follow the syntax and semantics of the 'Semantic Versioning' specification (http://semver.org/).",
									Required:            false,
									Optional:            true,
									Computed:            false,
									Validators: []validator.String{
					...
					"network": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Defines the network configuration for the Component.",
						Attributes: map[string]schema.Attribute{
							"dns_config": schema.SingleNestedAttribute{
								Description:         "Specifies the DNS parameters of a pod.",
								MarkdownDescription: "Specifies the DNS parameters of a pod.",
								Attributes: map[string]schema.Attribute{
							...
							"dns_policy": schema.StringAttribute{
								Description:         "Set DNS policy for the pod. Defaults to 'ClusterFirst'. If the hostNetwork is enabled, the default policy will be set to 'ClusterFirstWithHostNet'.",
								MarkdownDescription: "Set DNS policy for the pod. Defaults to 'ClusterFirst'. If the hostNetwork is enabled, the default policy will be set to 'ClusterFirstWithHostNet'.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"persistent_volume_claim_retention_policy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "persistentVolumeClaimRetentionPolicy describes the lifecycle of persistent volume claims created from volumeClaimTemplates. By default, all persistent volume claims are created as needed and retained until manually deleted. This policy allows the lifecycle to be altered, for example by deleting persistent volume claims when their workload is deleted, or when their pod is scaled down.",
						Attributes: map[string]schema.Attribute{
							"when_deleted": schema.StringAttribute{
								Description:         "WhenDeleted specifies what happens to PVCs created from VolumeClaimTemplates when the workload is deleted. The 'Retain' policy causes PVCs to not be affected by workload deletion. The default policy of 'Delete' causes those PVCs to be deleted.",
								MarkdownDescription: "WhenDeleted specifies what happens to PVCs created from VolumeClaimTemplates when the workload is deleted. The 'Retain' policy causes PVCs to not be affected by workload deletion. The default policy of 'Delete' causes those PVCs to be deleted.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
							...
							"when_scaled": schema.StringAttribute{
								Description:         "WhenScaled specifies what happens to PVCs created from VolumeClaimTemplates when the workload is scaled down. The 'Retain' policy causes PVCs to not be affected by a scale down. The default policy of 'Delete' causes the associated PVCs for pods scaled down to be deleted.",
								MarkdownDescription: "WhenScaled specifies what happens to PVCs created from VolumeClaimTemplates when the workload is scaled down. The 'Retain' policy causes PVCs to not be affected by a scale down. The default policy of 'Delete' causes the associated PVCs for pods scaled down to be deleted.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
					...
					"pod_upgrade_policy": schema.StringAttribute{
						Description:         "PodUpgradePolicy indicates how pods should be updated when the component is upgraded. If not specified, the value of PodUpdatePolicy will be used.",
						MarkdownDescription: "PodUpgradePolicy indicates how pods should be updated when the component is upgraded. If not specified, the value of PodUpdatePolicy will be used.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"cluster_service_selector": schema.SingleNestedAttribute{
									Description:         "References a service provided by another KubeBlocks Cluster. It specifies the ClusterService and the account credentials needed for access. The 'ServiceKind' and 'ServiceVersion' specified in the service reference within the ClusterDefinition are not validated when using this approach. If both 'clusterServiceSelector' and 'serviceDescriptor' are specified, the 'clusterServiceSelector' takes precedence.",
									MarkdownDescription: "References a service provided by another KubeBlocks Cluster. It specifies the ClusterService and the account credentials needed for access. The 'ServiceKind' and 'ServiceVersion' specified in the service reference within the ClusterDefinition are not validated when using this approach. If both 'clusterServiceSelector' and 'serviceDescriptor' are specified, the 'clusterServiceSelector' takes precedence.",
									Attributes: map[string]schema.Attribute{
										...
										"pod_fqd_ns": schema.SingleNestedAttribute{
											Description:         "",
											MarkdownDescription: "",
											Attributes: map[string]schema.Attribute{
												"component": schema.StringAttribute{
													Description:         "The name of the Component where the pods reside in.",
													MarkdownDescription: "The name of the Component where the pods reside in.",
													Required:            true,
													Optional:            false,
													Computed:            false,
												},
												...
												"role": schema.StringAttribute{
													...
													MarkdownDescription: "The role of the pods to reference.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
					...
					"services": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Overrides Services defined in referenced ComponentDefinition.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"annotations": schema.MapAttribute{
					...
					"sidecars": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Specifies the sidecars to be injected into the Component.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Name specifies the unique name of the sidecar. The name will be used as the name of the sidecar container in the Pod.",
									MarkdownDescription: "Name specifies the unique name of the sidecar. The name will be used as the name of the sidecar container in the Pod.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"owner": schema.StringAttribute{
									Description:         "Specifies the exact component definition that the sidecar belongs to. A sidecar will be updated when the owner component definition is updated only.",
									MarkdownDescription: "Specifies the exact component definition that the sidecar belongs to. A sidecar will be updated when the owner component definition is updated only.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},

								"sidecar_def": schema.StringAttribute{
									Description:         "Specifies the sidecar definition CR to be used to create the sidecar.",
									MarkdownDescription: "Specifies the sidecar definition CR to be used to create the sidecar.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"disabled": schema.BoolAttribute{
									...
									MarkdownDescription: "Specifies whether the system account is disabled.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"secret_ref": schema.SingleNestedAttribute{
									Description:         "Refers to the secret from which data will be copied to create the new account. For user-specified passwords, the maximum length is limited to 64 bytes. This field is immutable once set.",
									MarkdownDescription: "Refers to the secret from which data will be copied to create the new account. For user-specified passwords, the maximum length is limited to 64 bytes. This field is immutable once set.",
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
										...
										"password": schema.StringAttribute{
											Description:         "The key in the secret data that contains the password.",
											MarkdownDescription: "The key in the secret data that contains the password.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
					...
					"termination_policy": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the behavior when a Component is deleted.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
								...
								Attributes: map[string]schema.Attribute{
									...
									"secret_ref": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"namespace": schema.StringAttribute{
												Description:         "The namespace where the secret is located. If not provided, the secret is assumed to be in the same namespace as the Cluster object.",
												MarkdownDescription: "The namespace where the secret is located. If not provided, the secret is assumed to be in the same namespace as the Cluster object.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
...
func (r *AppsKubeblocksIoComponentV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_kubeblocks_io_component_v1_manifest")

	var model AppsKubeblocksIoComponentV1ManifestData
