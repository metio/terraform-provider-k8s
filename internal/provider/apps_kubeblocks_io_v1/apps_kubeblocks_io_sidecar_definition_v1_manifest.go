...
var (
	_ datasource.DataSource = &AppsKubeblocksIoSidecarDefinitionV1Manifest{}
)

func NewAppsKubeblocksIoSidecarDefinitionV1Manifest() datasource.DataSource {
	return &AppsKubeblocksIoSidecarDefinitionV1Manifest{}
}

type AppsKubeblocksIoSidecarDefinitionV1Manifest struct{}

type AppsKubeblocksIoSidecarDefinitionV1ManifestData struct {
	...
	Spec *struct {
		...
		Selectors *[]string `tfsdk:"selectors" json:"selectors,omitempty"`
		Vars      *[]struct {
			...
			ValueFrom  *struct {
				...
				ServiceRefVarRef *struct {
					...
					Port     *string `tfsdk:"port" json:"port,omitempty"`
					Username *string `tfsdk:"username" json:"username,omitempty"`
				} `tfsdk:"service_ref_var_ref" json:"serviceRefVarRef,omitempty"`
...
func (r *AppsKubeblocksIoSidecarDefinitionV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_kubeblocks_io_sidecar_definition_v1_manifest"
}

func (r *AppsKubeblocksIoSidecarDefinitionV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "SidecarDefinition is the Schema for the sidecardefinitions API",
		MarkdownDescription: "SidecarDefinition is the Schema for the sidecardefinitions API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "SidecarDefinitionSpec defines the desired state of SidecarDefinition",
				Attributes: map[string]schema.Attribute{
					"configs": schema.ListNestedAttribute{
						Description:         "Specifies the configuration file templates used by the Sidecar. This field is immutable.",
						MarkdownDescription: "Specifies the configuration file templates used by the Sidecar. This field is immutable.",
					...
					"containers": schema.ListNestedAttribute{
						Description:         "List of containers for the sidecar. Cannot be updated.",
						MarkdownDescription: "List of containers for the sidecar. Cannot be updated.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"name": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the name of the sidecar.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"scripts": schema.ListNestedAttribute{
						Description:         "Specifies the scripts used by the Sidecar. This field is immutable.",
						MarkdownDescription: "Specifies the scripts used by the Sidecar. This field is immutable.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"default_mode": schema.Int64Attribute{
									Description:         "The operator attempts to set default file permissions (0444). Must be specified as an octal value between 0000 and 0777 (inclusive), or as a decimal value between 0 and 511 (inclusive). YAML supports both octal and decimal values for file permissions. Please note that this setting only affects the permissions of the files themselves. Directories within the specified path are not impacted by this setting. It's important to be aware that this setting might conflict with other options that influence the file mode, such as fsGroup. In such cases, the resulting file mode may have additional bits set. Refers to documents of k8s.ConfigMapVolumeSource.defaultMode for more information.",
					...
					"selectors": schema.ListAttribute{
						Description:         "Specifies the component definition of components that the sidecar along with. This field is immutable.",
						MarkdownDescription: "Specifies the component definition of components that the sidecar along with. This field is immutable.",
						ElementType:         types.StringType,
						Required:            true,
						Optional:            false,
						Computed:            false,
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"name": schema.StringAttribute{
									...
									MarkdownDescription: "Name of the variable. Must be a C_IDENTIFIER.",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
								...
								"value": schema.StringAttribute{
									...
									MarkdownDescription: "Variable references '$(VAR_NAME)' are expanded using the previously defined variables in the current context. If a variable cannot be resolved, the reference in the input string will be unchanged. Double '$$' are reduced to a single '$', which allows for escaping the '$(VAR_NAME)' syntax: i.e. - '$$(VAR_NAME)' will produce the string literal '$(VAR_NAME)'. Escaped references will never be expanded, regardless of whether the variable exists or not. Defaults to ''.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
									...
									Attributes: map[string]schema.Attribute{
										...
										"component_var_ref": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"pod_fqd_ns": schema.StringAttribute{
													Description:         "Reference to the pod FQDN list of the component. The value will be presented in the following format: FQDN1,FQDN2,...",
													MarkdownDescription: "Reference to the pod FQDN list of the component. The value will be presented in the following format: FQDN1,FQDN2,...",
													Required:            false,
													Optional:            true,
													Computed:            false,
													Validators: []validator.String{
										...
										"credential_var_ref": schema.SingleNestedAttribute{
										...
										"host_network_var_ref": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"container": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "ContainerVars defines the vars that can be referenced from a Container.",
													Attributes: map[string]schema.Attribute{
														"name": schema.StringAttribute{
														...
														"port": schema.SingleNestedAttribute{
															...
															MarkdownDescription: "Container port to reference.",
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	Description:         "",
																	MarkdownDescription: "",
										...
										"service_ref_var_ref": schema.SingleNestedAttribute{
										...
										"service_var_ref": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"port": schema.SingleNestedAttribute{
													Description:         "Port references a port or node-port defined in the service. If the referenced service is a pod-service, there will be multiple service objects matched, and the value will be presented in the following format: service1.name:port1,service2.name:port2...",
													MarkdownDescription: "Port references a port or node-port defined in the service. If the referenced service is a pod-service, there will be multiple service objects matched, and the value will be presented in the following format: service1.name:port1,service2.name:port2...",
													Attributes: map[string]schema.Attribute{
														"name": schema.StringAttribute{
															Description:         "",
															MarkdownDescription: "",
...
func (r *AppsKubeblocksIoSidecarDefinitionV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_kubeblocks_io_sidecar_definition_v1_manifest")

	var model AppsKubeblocksIoSidecarDefinitionV1ManifestData
	...
	model.Kind = pointer.String("SidecarDefinition")
