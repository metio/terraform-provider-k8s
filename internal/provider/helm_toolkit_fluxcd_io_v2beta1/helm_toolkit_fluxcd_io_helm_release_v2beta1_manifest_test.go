...
func TestHelmToolkitFluxcdIoHelmReleaseV2Beta1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_helm_toolkit_fluxcd_io_helm_release_v2beta1_manifest", testCase)
		})
	}
}
