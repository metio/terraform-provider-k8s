...
var (
	_ datasource.DataSource              = &HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource{}
)

func NewHelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource() datasource.DataSource {
	return &HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource{}
}

type HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSourceData struct {
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_helm_toolkit_fluxcd_io_helm_release_v2beta1"
}

func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_helm_toolkit_fluxcd_io_helm_release_v2beta1")

	var data HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "helm.toolkit.fluxcd.io", Version: "v2beta1", Resource: "helmreleases"}).
	...
	var readResponse HelmToolkitFluxcdIoHelmReleaseV2Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("helm.toolkit.fluxcd.io/v2beta1")
	data.Kind = pointer.String("HelmRelease")
