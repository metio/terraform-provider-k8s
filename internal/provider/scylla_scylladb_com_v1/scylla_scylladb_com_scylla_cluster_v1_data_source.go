...
var (
	_ datasource.DataSource              = &ScyllaScylladbComScyllaClusterV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ScyllaScylladbComScyllaClusterV1DataSource{}
)

func NewScyllaScylladbComScyllaClusterV1DataSource() datasource.DataSource {
	return &ScyllaScylladbComScyllaClusterV1DataSource{}
}

type ScyllaScylladbComScyllaClusterV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ScyllaScylladbComScyllaClusterV1DataSourceData struct {
...
func (r *ScyllaScylladbComScyllaClusterV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_scylla_scylladb_com_scylla_cluster_v1"
}

func (r *ScyllaScylladbComScyllaClusterV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ScyllaScylladbComScyllaClusterV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ScyllaScylladbComScyllaClusterV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_scylla_scylladb_com_scylla_cluster_v1")

	var data ScyllaScylladbComScyllaClusterV1DataSourceData
	...
	var readResponse ScyllaScylladbComScyllaClusterV1DataSourceData
	...
	data.ApiVersion = pointer.String("scylla.scylladb.com/v1")
	data.Kind = pointer.String("ScyllaCluster")
