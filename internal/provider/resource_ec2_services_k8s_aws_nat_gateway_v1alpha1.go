...
var (
	_ resource.Resource = (*Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource)(nil)
)

type Ec2ServicesK8SAwsNATGatewayV1Alpha1TerraformModel struct {
...
type Ec2ServicesK8SAwsNATGatewayV1Alpha1GoModel struct {
	...
	Spec *struct {
		AllocationID *string `tfsdk:"allocation_id" yaml:"allocationID,omitempty"`

		AllocationRef *struct {
			From *struct {
				Name *string `tfsdk:"name" yaml:"name,omitempty"`
			} `tfsdk:"from" yaml:"from,omitempty"`
		} `tfsdk:"allocation_ref" yaml:"allocationRef,omitempty"`

		ConnectivityType *string `tfsdk:"connectivity_type" yaml:"connectivityType,omitempty"`
		...
		} `tfsdk:"subnet_ref" yaml:"subnetRef,omitempty"`
...
func (r *Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ec2_services_k8s_aws_nat_gateway_v1alpha1"
}

func (r *Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_ec2_services_k8s_aws_nat_gateway_v1alpha1")

	var state Ec2ServicesK8SAwsNATGatewayV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel Ec2ServicesK8SAwsNATGatewayV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("NATGateway")
...
func (r *Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ec2_services_k8s_aws_nat_gateway_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *Ec2ServicesK8SAwsNATGatewayV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
