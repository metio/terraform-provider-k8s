...
var (
	_ datasource.DataSource = &DocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1Manifest{}
)

func NewDocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1Manifest() datasource.DataSource {
	return &DocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1Manifest{}
}
...
func (r *DocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_documentdb_services_k8s_aws_db_subnet_group_v1alpha1_manifest"
}

func (r *DocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"description": schema.StringAttribute{
						...
						MarkdownDescription: "The description for the subnet group.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"subnet_i_ds": schema.ListAttribute{
						...
						MarkdownDescription: "The Amazon EC2 subnet IDs for the subnet group.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"tags": schema.ListNestedAttribute{
						...
						MarkdownDescription: "The tags to be assigned to the subnet group.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *DocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_documentdb_services_k8s_aws_db_subnet_group_v1alpha1_manifest")

	var model DocumentdbServicesK8SAwsDbsubnetGroupV1Alpha1ManifestData
	...
	model.Kind = pointer.String("DBSubnetGroup")
