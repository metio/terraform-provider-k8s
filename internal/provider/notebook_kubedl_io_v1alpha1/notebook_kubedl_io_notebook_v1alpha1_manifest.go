...
var (
	_ datasource.DataSource = &NotebookKubedlIoNotebookV1Alpha1Manifest{}
)

func NewNotebookKubedlIoNotebookV1Alpha1Manifest() datasource.DataSource {
	return &NotebookKubedlIoNotebookV1Alpha1Manifest{}
}

type NotebookKubedlIoNotebookV1Alpha1Manifest struct{}

type NotebookKubedlIoNotebookV1Alpha1ManifestData struct {
...
func (r *NotebookKubedlIoNotebookV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notebook_kubedl_io_notebook_v1alpha1_manifest"
}

func (r *NotebookKubedlIoNotebookV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotebookKubedlIoNotebookV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_notebook_kubedl_io_notebook_v1alpha1_manifest")

	var model NotebookKubedlIoNotebookV1Alpha1ManifestData
