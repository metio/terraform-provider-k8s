...
var (
	_ datasource.DataSource              = &NotebookKubedlIoNotebookV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &NotebookKubedlIoNotebookV1Alpha1DataSource{}
)

func NewNotebookKubedlIoNotebookV1Alpha1DataSource() datasource.DataSource {
	return &NotebookKubedlIoNotebookV1Alpha1DataSource{}
}

type NotebookKubedlIoNotebookV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NotebookKubedlIoNotebookV1Alpha1DataSourceData struct {
...
func (r *NotebookKubedlIoNotebookV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notebook_kubedl_io_notebook_v1alpha1"
}

func (r *NotebookKubedlIoNotebookV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotebookKubedlIoNotebookV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NotebookKubedlIoNotebookV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_notebook_kubedl_io_notebook_v1alpha1")

	var data NotebookKubedlIoNotebookV1Alpha1DataSourceData
	...
	var readResponse NotebookKubedlIoNotebookV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("notebook.kubedl.io/v1alpha1")
	data.Kind = pointer.String("Notebook")
