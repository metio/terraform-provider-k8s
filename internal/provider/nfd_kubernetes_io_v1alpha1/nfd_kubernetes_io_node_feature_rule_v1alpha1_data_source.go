...
var (
	_ datasource.DataSource              = &NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource{}
)

func NewNfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource() datasource.DataSource {
	return &NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource{}
}

type NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSourceData struct {
...
func (r *NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_nfd_kubernetes_io_node_feature_rule_v1alpha1"
}

func (r *NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_nfd_kubernetes_io_node_feature_rule_v1alpha1")

	var data NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSourceData
	...
	var readResponse NfdKubernetesIoNodeFeatureRuleV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("nfd.kubernetes.io/v1alpha1")
