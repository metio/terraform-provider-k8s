...
var (
	_ resource.Resource = (*ApmK8SElasticCoApmServerV1Beta1Resource)(nil)
)

type ApmK8SElasticCoApmServerV1Beta1TerraformModel struct {
...
type ApmK8SElasticCoApmServerV1Beta1GoModel struct {
...
func (r *ApmK8SElasticCoApmServerV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_apm_k8s_elastic_co_apm_server_v1beta1"
}

func (r *ApmK8SElasticCoApmServerV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ApmK8SElasticCoApmServerV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_apm_k8s_elastic_co_apm_server_v1beta1")

	var state ApmK8SElasticCoApmServerV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ApmK8SElasticCoApmServerV1Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("apm.k8s.elastic.co/v1beta1")
...
func (r *ApmK8SElasticCoApmServerV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apm_k8s_elastic_co_apm_server_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *ApmK8SElasticCoApmServerV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ApmK8SElasticCoApmServerV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
