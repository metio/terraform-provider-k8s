...
var (
	_ datasource.DataSource = &SourceToolkitFluxcdIoOcirepositoryV1Manifest{}
)

func NewSourceToolkitFluxcdIoOcirepositoryV1Manifest() datasource.DataSource {
	return &SourceToolkitFluxcdIoOcirepositoryV1Manifest{}
}

type SourceToolkitFluxcdIoOcirepositoryV1Manifest struct{}

type SourceToolkitFluxcdIoOcirepositoryV1ManifestData struct {
...
func (r *SourceToolkitFluxcdIoOcirepositoryV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_source_toolkit_fluxcd_io_oci_repository_v1_manifest"
}

func (r *SourceToolkitFluxcdIoOcirepositoryV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SourceToolkitFluxcdIoOcirepositoryV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_source_toolkit_fluxcd_io_oci_repository_v1_manifest")

	var model SourceToolkitFluxcdIoOcirepositoryV1ManifestData
