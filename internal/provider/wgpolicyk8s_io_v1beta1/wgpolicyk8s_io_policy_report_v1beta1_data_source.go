...
var (
	_ datasource.DataSource              = &Wgpolicyk8SIoPolicyReportV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &Wgpolicyk8SIoPolicyReportV1Beta1DataSource{}
)

func NewWgpolicyk8SIoPolicyReportV1Beta1DataSource() datasource.DataSource {
	return &Wgpolicyk8SIoPolicyReportV1Beta1DataSource{}
}

type Wgpolicyk8SIoPolicyReportV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type Wgpolicyk8SIoPolicyReportV1Beta1DataSourceData struct {
...
func (r *Wgpolicyk8SIoPolicyReportV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_policy_report_v1beta1"
}

func (r *Wgpolicyk8SIoPolicyReportV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"configuration": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "Configuration is an optional field which can be used to specify a contract between PolicyReport generators and consumers",
				Attributes: map[string]schema.Attribute{
					"limits": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"max_results": schema.Int64Attribute{
								...
								MarkdownDescription: "MaxResults is the maximum number of results contained in the report",
								Required:            false,
								Optional:            false,
								Computed:            true,
							},
							...
							"status_filter": schema.ListAttribute{
								...
								MarkdownDescription: "StatusFilter indicates that the PolicyReport contains only those reports with statuses specified in this list",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            false,
								Computed:            true,
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"source": schema.StringAttribute{
							...
							MarkdownDescription: "Source is an identifier for the policy engine that manages this report If the Source is specified at this level, it will override the Source field set at the PolicyReport level",
							Required:            false,
							Optional:            false,
							Computed:            true,
						},
			...
			"source": schema.StringAttribute{
				...
				MarkdownDescription: "Source is an identifier for the source e.g. a policy engine that manages this report. Use this field if all the results are produced by a single policy engine. If the results are produced by multiple sources e.g. different engines or scanners, then use the Source field at the PolicyReportResult level.",
				Required:            false,
				Optional:            false,
				Computed:            true,
			},
...
func (r *Wgpolicyk8SIoPolicyReportV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *Wgpolicyk8SIoPolicyReportV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_wgpolicyk8s_io_policy_report_v1beta1")

	var data Wgpolicyk8SIoPolicyReportV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "wgpolicyk8s.io", Version: "v1beta1", Resource: "policyreports"}).
	...
	var readResponse Wgpolicyk8SIoPolicyReportV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("wgpolicyk8s.io/v1beta1")
	...
	data.Source = readResponse.Source
