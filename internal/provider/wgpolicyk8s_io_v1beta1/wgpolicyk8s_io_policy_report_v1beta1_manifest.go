...
var (
	_ datasource.DataSource = &Wgpolicyk8SIoPolicyReportV1Beta1Manifest{}
)

func NewWgpolicyk8SIoPolicyReportV1Beta1Manifest() datasource.DataSource {
	return &Wgpolicyk8SIoPolicyReportV1Beta1Manifest{}
}
...
func (r *Wgpolicyk8SIoPolicyReportV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_policy_report_v1beta1_manifest"
}

func (r *Wgpolicyk8SIoPolicyReportV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Wgpolicyk8SIoPolicyReportV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_wgpolicyk8s_io_policy_report_v1beta1_manifest")

	var model Wgpolicyk8SIoPolicyReportV1Beta1ManifestData
