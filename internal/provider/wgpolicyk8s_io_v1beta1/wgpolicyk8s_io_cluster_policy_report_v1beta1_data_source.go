...
var (
	_ datasource.DataSource              = &Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource{}
)

func NewWgpolicyk8SIoClusterPolicyReportV1Beta1DataSource() datasource.DataSource {
	return &Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource{}
}

type Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSourceData struct {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_cluster_policy_report_v1beta1"
}

func (r *Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_wgpolicyk8s_io_cluster_policy_report_v1beta1")

	var data Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSourceData
	...
	var readResponse Wgpolicyk8SIoClusterPolicyReportV1Beta1DataSourceData
