...
var (
	_ datasource.DataSource = &MemorydbServicesK8SAwsSubnetGroupV1Alpha1Manifest{}
)

func NewMemorydbServicesK8SAwsSubnetGroupV1Alpha1Manifest() datasource.DataSource {
	return &MemorydbServicesK8SAwsSubnetGroupV1Alpha1Manifest{}
}
...
func (r *MemorydbServicesK8SAwsSubnetGroupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_memorydb_services_k8s_aws_subnet_group_v1alpha1_manifest"
}

func (r *MemorydbServicesK8SAwsSubnetGroupV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "SubnetGroup is the Schema for the SubnetGroups API",
		MarkdownDescription: "SubnetGroup is the Schema for the SubnetGroups API",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"description": schema.StringAttribute{
						...
						MarkdownDescription: "A description for the subnet group.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"name": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the subnet group.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *MemorydbServicesK8SAwsSubnetGroupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_memorydb_services_k8s_aws_subnet_group_v1alpha1_manifest")

	var model MemorydbServicesK8SAwsSubnetGroupV1Alpha1ManifestData
	...
	model.Kind = pointer.String("SubnetGroup")
