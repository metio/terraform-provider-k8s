...
func (r *RuntimeClusterXK8SIoExtensionConfigV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ExtensionConfig is the Schema for the ExtensionConfig API. NOTE: This CRD can only be used if the RuntimeSDK feature gate is enabled.",
		MarkdownDescription: "ExtensionConfig is the Schema for the ExtensionConfig API. NOTE: This CRD can only be used if the RuntimeSDK feature gate is enabled.",
						...
						Attributes: map[string]schema.Attribute{
							"ca_bundle": schema.StringAttribute{
								...
								Validators: []validator.String{
									...
									stringvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("service"), path.MatchRelative().AtParent().AtName("url")),
								},
							},
							...
							"service": schema.SingleNestedAttribute{
								...
								Validators: []validator.Object{
									objectvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("ca_bundle"), path.MatchRelative().AtParent().AtName("url")),
								},
							},
							...
							"url": schema.StringAttribute{
								...
								Validators: []validator.String{
									stringvalidator.LengthAtLeast(1),
									stringvalidator.LengthAtMost(512),
									stringvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("ca_bundle"), path.MatchRelative().AtParent().AtName("service")),
								},
							},
						},
						Required: true,
