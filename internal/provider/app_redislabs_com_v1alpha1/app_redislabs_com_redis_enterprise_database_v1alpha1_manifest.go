...
var (
	_ datasource.DataSource = &AppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest{}
)

func NewAppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest() datasource.DataSource {
	return &AppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest{}
}

type AppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest struct{}

type AppRedislabsComRedisEnterpriseDatabaseV1Alpha1ManifestData struct {
...
func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_redislabs_com_redis_enterprise_database_v1alpha1_manifest"
}

func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_app_redislabs_com_redis_enterprise_database_v1alpha1_manifest")

	var model AppRedislabsComRedisEnterpriseDatabaseV1Alpha1ManifestData
