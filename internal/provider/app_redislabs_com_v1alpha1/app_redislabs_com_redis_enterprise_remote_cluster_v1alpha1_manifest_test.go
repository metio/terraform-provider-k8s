...
func TestAppRedislabsComRedisEnterpriseRemoteClusterV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_app_redislabs_com_redis_enterprise_remote_cluster_v1alpha1_manifest", testCase)
		})
	}
}
