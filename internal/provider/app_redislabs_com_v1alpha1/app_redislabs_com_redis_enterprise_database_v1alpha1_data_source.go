...
var (
	_ datasource.DataSource              = &AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource{}
)

func NewAppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource() datasource.DataSource {
	return &AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource{}
}

type AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSourceData struct {
...
func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_redislabs_com_redis_enterprise_database_v1alpha1"
}

func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_app_redislabs_com_redis_enterprise_database_v1alpha1")

	var data AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "app.redislabs.com", Version: "v1alpha1", Resource: "redisenterprisedatabases"}).
	...
	var readResponse AppRedislabsComRedisEnterpriseDatabaseV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("RedisEnterpriseDatabase")
