		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"name": schema.StringAttribute{
						Description:         "The name for the new rule groups namespace. Regex Pattern: '[0-9A-Za-z][-.0-9A-Z_a-z]*'",
						MarkdownDescription: "The name for the new rule groups namespace. Regex Pattern: '[0-9A-Za-z][-.0-9A-Z_a-z]*'",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"workspace_id": schema.StringAttribute{
						Description:         "The ID of the workspace to add the rule groups namespace. Regex Pattern: '[0-9A-Za-z][-.0-9A-Z_a-z]*'",
						MarkdownDescription: "The ID of the workspace to add the rule groups namespace. Regex Pattern: '[0-9A-Za-z][-.0-9A-Z_a-z]*'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
