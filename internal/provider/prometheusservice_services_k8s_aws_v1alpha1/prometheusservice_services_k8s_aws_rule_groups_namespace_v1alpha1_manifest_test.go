...
func TestPrometheusserviceServicesK8SAwsRuleGroupsNamespaceV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_prometheusservice_services_k8s_aws_rule_groups_namespace_v1alpha1_manifest", testCase)
		})
	}
}
