...
var (
	_ datasource.DataSource = &PrometheusserviceServicesK8SAwsAlertManagerDefinitionV1Alpha1Manifest{}
)

func NewPrometheusserviceServicesK8SAwsAlertManagerDefinitionV1Alpha1Manifest() datasource.DataSource {
	return &PrometheusserviceServicesK8SAwsAlertManagerDefinitionV1Alpha1Manifest{}
}
...
func (r *PrometheusserviceServicesK8SAwsAlertManagerDefinitionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_prometheusservice_services_k8s_aws_alert_manager_definition_v1alpha1_manifest"
}
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"workspace_id": schema.StringAttribute{
						...
						MarkdownDescription: "The ID of the workspace to add the alert manager definition to.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *PrometheusserviceServicesK8SAwsAlertManagerDefinitionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_prometheusservice_services_k8s_aws_alert_manager_definition_v1alpha1_manifest")

	var model PrometheusserviceServicesK8SAwsAlertManagerDefinitionV1Alpha1ManifestData
