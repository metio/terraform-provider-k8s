...
var (
	_ datasource.DataSource = &PrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1Manifest{}
)

func NewPrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1Manifest() datasource.DataSource {
	return &PrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1Manifest{}
}
...
func (r *PrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_prometheusservice_services_k8s_aws_logging_configuration_v1alpha1_manifest"
}
...
func (r *PrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "LoggingConfiguration is the Schema for the LoggingConfigurations API",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"log_group_arn": schema.StringAttribute{
						...
						MarkdownDescription: "The ARN of the CloudWatch log group to which the vended log data will be published. This log group must exist prior to calling this operation.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"workspace_id": schema.StringAttribute{
						...
						MarkdownDescription: "The ID of the workspace to create the logging configuration for.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *PrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_prometheusservice_services_k8s_aws_logging_configuration_v1alpha1_manifest")

	var model PrometheusserviceServicesK8SAwsLoggingConfigurationV1Alpha1ManifestData
	...
	model.Kind = pointer.String("LoggingConfiguration")
