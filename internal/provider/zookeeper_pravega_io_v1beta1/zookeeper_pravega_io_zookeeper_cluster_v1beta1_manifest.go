...
package zookeeper_pravega_io_v1beta1
...
var (
	_ datasource.DataSource = &ZookeeperPravegaIoZookeeperClusterV1Beta1Manifest{}
)

func NewZookeeperPravegaIoZookeeperClusterV1Beta1Manifest() datasource.DataSource {
	return &ZookeeperPravegaIoZookeeperClusterV1Beta1Manifest{}
}

type ZookeeperPravegaIoZookeeperClusterV1Beta1Manifest struct{}

type ZookeeperPravegaIoZookeeperClusterV1Beta1ManifestData struct {
	...
	Spec *struct {
		AdminServerService *struct {
			Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
			External    *bool              `tfsdk:"external" json:"external,omitempty"`
		} `tfsdk:"admin_server_service" json:"adminServerService,omitempty"`
		...
		Config *struct {
			...
			AutoPurgePurgeInterval   *int64             `tfsdk:"auto_purge_purge_interval" json:"autoPurgePurgeInterval,omitempty"`
			AutoPurgeSnapRetainCount *int64             `tfsdk:"auto_purge_snap_retain_count" json:"autoPurgeSnapRetainCount,omitempty"`
			CommitLogCount           *int64             `tfsdk:"commit_log_count" json:"commitLogCount,omitempty"`
			GlobalOutstandingLimit   *int64             `tfsdk:"global_outstanding_limit" json:"globalOutstandingLimit,omitempty"`
			InitLimit                *int64             `tfsdk:"init_limit" json:"initLimit,omitempty"`
			MaxClientCnxns           *int64             `tfsdk:"max_client_cnxns" json:"maxClientCnxns,omitempty"`
			MaxCnxns                 *int64             `tfsdk:"max_cnxns" json:"maxCnxns,omitempty"`
			MaxSessionTimeout        *int64             `tfsdk:"max_session_timeout" json:"maxSessionTimeout,omitempty"`
			MinSessionTimeout        *int64             `tfsdk:"min_session_timeout" json:"minSessionTimeout,omitempty"`
			PreAllocSize             *int64             `tfsdk:"pre_alloc_size" json:"preAllocSize,omitempty"`
			QuorumListenOnAllIPs     *bool              `tfsdk:"quorum_listen_on_all_i_ps" json:"quorumListenOnAllIPs,omitempty"`
			SnapCount                *int64             `tfsdk:"snap_count" json:"snapCount,omitempty"`
			SnapSizeLimitInKb        *int64             `tfsdk:"snap_size_limit_in_kb" json:"snapSizeLimitInKb,omitempty"`
		...
		Ephemeral  *struct {
			...
			} `tfsdk:"emptydirvolumesource" json:"emptydirvolumesource,omitempty"`
		...
		KubernetesClusterDomain *string            `tfsdk:"kubernetes_cluster_domain" json:"kubernetesClusterDomain,omitempty"`
		Labels                  *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		MaxUnavailableReplicas  *int64             `tfsdk:"max_unavailable_replicas" json:"maxUnavailableReplicas,omitempty"`
		Persistence             *struct {
			Annotations   *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
		...
		TriggerRollingRestart *bool   `tfsdk:"trigger_rolling_restart" json:"triggerRollingRestart,omitempty"`
		VolumeMounts          *[]struct {
			MountPath        *string `tfsdk:"mount_path" json:"mountPath,omitempty"`
			MountPropagation *string `tfsdk:"mount_propagation" json:"mountPropagation,omitempty"`
			Name             *string `tfsdk:"name" json:"name,omitempty"`
...
func (r *ZookeeperPravegaIoZookeeperClusterV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_zookeeper_pravega_io_zookeeper_cluster_v1beta1_manifest"
}

func (r *ZookeeperPravegaIoZookeeperClusterV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ZookeeperCluster is the Schema for the zookeeperclusters API",
		MarkdownDescription: "ZookeeperCluster is the Schema for the zookeeperclusters API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ZookeeperClusterSpec defines the desired state of ZookeeperCluster",
				Attributes: map[string]schema.Attribute{
					"admin_server_service": schema.SingleNestedAttribute{
						Description:         "AdminServerService defines the policy to create AdminServer Service for the zookeeper cluster.",
						MarkdownDescription: "AdminServerService defines the policy to create AdminServer Service for the zookeeper cluster.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations specifies the annotations to attach to AdminServer service the operator creates.",
								MarkdownDescription: "Annotations specifies the annotations to attach to AdminServer service the operator creates.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"client_service": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ClientService defines the policy to create client Service for the zookeeper cluster.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations specifies the annotations to attach to client service the operator creates.",
								MarkdownDescription: "Annotations specifies the annotations to attach to client service the operator creates.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Conf is the zookeeper configuration, which will be used to generate the static zookeeper configuration. If no configuration is provided required default values will be provided, and optional values will be excluded.",
						Attributes: map[string]schema.Attribute{
							"additional_config": schema.MapAttribute{
								Description:         "key-value map of additional zookeeper configuration parameters",
								MarkdownDescription: "key-value map of additional zookeeper configuration parameters",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"auto_purge_purge_interval": schema.Int64Attribute{
								Description:         "The time interval in hours for which the purge task has to be triggered  Disabled by default",
								MarkdownDescription: "The time interval in hours for which the purge task has to be triggered  Disabled by default",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"auto_purge_snap_retain_count": schema.Int64Attribute{
								Description:         "Retain the snapshots according to retain count  The default value is 3",
								MarkdownDescription: "Retain the snapshots according to retain count  The default value is 3",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"commit_log_count": schema.Int64Attribute{
								Description:         "Zookeeper maintains an in-memory list of last committed requests for fast synchronization with followers  The default value is 500",
								MarkdownDescription: "Zookeeper maintains an in-memory list of last committed requests for fast synchronization with followers  The default value is 500",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"global_outstanding_limit": schema.Int64Attribute{
								Description:         "Clients can submit requests faster than ZooKeeper can process them, especially if there are a lot of clients. Zookeeper will throttle Clients so that requests won't exceed global outstanding limit.  The default value is 1000",
								MarkdownDescription: "Clients can submit requests faster than ZooKeeper can process them, especially if there are a lot of clients. Zookeeper will throttle Clients so that requests won't exceed global outstanding limit.  The default value is 1000",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"init_limit": schema.Int64Attribute{
								Description:         "InitLimit is the amount of time, in ticks, to allow followers to connect and sync to a leader.  Default value is 10.",
								MarkdownDescription: "InitLimit is the amount of time, in ticks, to allow followers to connect and sync to a leader.  Default value is 10.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"max_client_cnxns": schema.Int64Attribute{
								Description:         "Limits the number of concurrent connections that a single client, identified by IP address, may make to a single member of the ZooKeeper ensemble.  The default value is 60",
								MarkdownDescription: "Limits the number of concurrent connections that a single client, identified by IP address, may make to a single member of the ZooKeeper ensemble.  The default value is 60",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"max_cnxns": schema.Int64Attribute{
								Description:         "Limits the total number of concurrent connections that can be made to a zookeeper server  The defult value is 0, indicating no limit",
								MarkdownDescription: "Limits the total number of concurrent connections that can be made to a zookeeper server  The defult value is 0, indicating no limit",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"max_session_timeout": schema.Int64Attribute{
								Description:         "The maximum session timeout in milliseconds that the server will allow the client to negotiate.  The default value is 40000",
								MarkdownDescription: "The maximum session timeout in milliseconds that the server will allow the client to negotiate.  The default value is 40000",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"min_session_timeout": schema.Int64Attribute{
								Description:         "The minimum session timeout in milliseconds that the server will allow the client to negotiate  The default value is 4000",
								MarkdownDescription: "The minimum session timeout in milliseconds that the server will allow the client to negotiate  The default value is 4000",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"pre_alloc_size": schema.Int64Attribute{
								Description:         "To avoid seeks ZooKeeper allocates space in the transaction log file in blocks of preAllocSize kilobytes  The default value is 64M",
								MarkdownDescription: "To avoid seeks ZooKeeper allocates space in the transaction log file in blocks of preAllocSize kilobytes  The default value is 64M",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"quorum_listen_on_all_i_ps": schema.BoolAttribute{
								...
								MarkdownDescription: "QuorumListenOnAllIPs when set to true the ZooKeeper server will listen for connections from its peers on all available IP addresses, and not only the address configured in the server list of the configuration file. It affects the connections handling the ZAB protocol and the Fast Leader Election protocol.  The default value is false.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"snap_count": schema.Int64Attribute{
								Description:         "ZooKeeper records its transactions using snapshots and a transaction log The number of transactions recorded in the transaction log before a snapshot can be taken is determined by snapCount  The default value is 100,000",
								MarkdownDescription: "ZooKeeper records its transactions using snapshots and a transaction log The number of transactions recorded in the transaction log before a snapshot can be taken is determined by snapCount  The default value is 100,000",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"snap_size_limit_in_kb": schema.Int64Attribute{
								Description:         "Snapshot size limit in Kb  The defult value is 4GB",
								MarkdownDescription: "Snapshot size limit in Kb  The defult value is 4GB",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"sync_limit": schema.Int64Attribute{
								Description:         "SyncLimit is the amount of time, in ticks, to allow followers to sync with Zookeeper.  The default value is 2.",
								MarkdownDescription: "SyncLimit is the amount of time, in ticks, to allow followers to sync with Zookeeper.  The default value is 2.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"tick_time": schema.Int64Attribute{
								Description:         "TickTime is the length of a single tick, which is the basic time unit used by Zookeeper, as measured in milliseconds  The default value is 2000.",
								MarkdownDescription: "TickTime is the length of a single tick, which is the basic time unit used by Zookeeper, as measured in milliseconds  The default value is 2000.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"containers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Containers defines to support multi containers",
					...
					"domain_name": schema.StringAttribute{
						...
						MarkdownDescription: "External host name appended for dns annotation",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"ephemeral": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Ephemeral is the configuration which helps create ephemeral storage At anypoint only one of Persistence or Ephemeral should be present in the manifest",
						Attributes: map[string]schema.Attribute{
							"emptydirvolumesource": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "EmptyDirVolumeSource is optional and this will create the emptydir volume It has two parameters Medium and SizeLimit which are optional as well Medium specifies What type of storage medium should back this directory. SizeLimit specifies Total amount of local storage required for this EmptyDir volume.",
								Attributes: map[string]schema.Attribute{
					...
					"headless_service": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "HeadlessService defines the policy to create headless Service for the zookeeper cluster.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations specifies the annotations to attach to headless service the operator creates.",
								MarkdownDescription: "Annotations specifies the annotations to attach to headless service the operator creates.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
					...
					"image": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Image is the  container image. default is zookeeper:0.2.10",
						Attributes: map[string]schema.Attribute{
					...
					"init_containers": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Init containers to support initialization",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"args": schema.ListAttribute{
									Description:         "Arguments to the entrypoint. The container image's CMD is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. Double $$ are reduced to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e. '$$(VAR_NAME)' will produce the string literal '$(VAR_NAME)'. Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell",
					...
					"kubernetes_cluster_domain": schema.StringAttribute{
						Description:         "Domain of the kubernetes cluster, defaults to cluster.local",
						MarkdownDescription: "Domain of the kubernetes cluster, defaults to cluster.local",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"labels": schema.MapAttribute{
						...
						MarkdownDescription: "Labels specifies the labels to attach to all resources the operator creates for the zookeeper cluster, including StatefulSet, Pod, PersistentVolumeClaim, Service, ConfigMap, et al.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"max_unavailable_replicas": schema.Int64Attribute{
						Description:         "MaxUnavailableReplicas defines the MaxUnavailable Replicas in pdb. Default is 1.",
						MarkdownDescription: "MaxUnavailableReplicas defines the MaxUnavailable Replicas in pdb. Default is 1.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"persistence": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Persistence is the configuration for zookeeper persistent layer. PersistentVolumeClaimSpec and VolumeReclaimPolicy can be specified in here.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations specifies the annotations to attach to pvc the operator creates.",
								MarkdownDescription: "Annotations specifies the annotations to attach to pvc the operator creates.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"reclaim_policy": schema.StringAttribute{
								...
								MarkdownDescription: "VolumeReclaimPolicy is a zookeeper operator configuration. If it's set to Delete, the corresponding PVCs will be deleted by the operator when zookeeper cluster is deleted. The default value is Retain.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
							...
							"spec": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "PersistentVolumeClaimSpec is the spec to describe PVC for the container This field is optional. If no PVC is specified default persistentvolume will get created.",
								Attributes: map[string]schema.Attribute{
					...
					"pod": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Pod defines the policy to create pod for the zookeeper cluster. Updating the Pod does not take effect on any existing pods.",
						Attributes: map[string]schema.Attribute{
							"affinity": schema.SingleNestedAttribute{
								Description:         "The scheduling constraints on pods.",
								MarkdownDescription: "The scheduling constraints on pods.",
								Attributes: map[string]schema.Attribute{
							...
							"annotations": schema.MapAttribute{
								...
								MarkdownDescription: "Annotations specifies the annotations to attach to pods the operator creates.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"env": schema.ListNestedAttribute{
								...
								MarkdownDescription: "List of environment variables to set in the container. This field cannot be updated.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
											Description:         "Name of the environment variable. Must be a C_IDENTIFIER.",
							...
							"image_pull_secrets": schema.ListNestedAttribute{
								...
								MarkdownDescription: "ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"name": schema.StringAttribute{
											Description:         "Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?",
							...
							"labels": schema.MapAttribute{
								...
								MarkdownDescription: "Labels specifies the labels to attach to pods the operator creates for the zookeeper cluster. Overrides any values specified in Spec.Labels.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"node_selector": schema.MapAttribute{
								...
								MarkdownDescription: "NodeSelector specifies a map of key-value pairs. For the pod to be eligible to run on a node, the node must have each of the indicated key-value pairs as labels.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"resources": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Resources is the resource requirements for the container. This field cannot be updated once the cluster is created.",
								Attributes: map[string]schema.Attribute{
									"claims": schema.ListNestedAttribute{
										Description:         "Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable. It can only be set for containers.",
										MarkdownDescription: "Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable. It can only be set for containers.",
							...
							"security_context": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "SecurityContext specifies the security context for the entire pod More info: https://kubernetes.io/docs/tasks/configure-pod-container/security-context",
								Attributes: map[string]schema.Attribute{
							...
							"service_account_name": schema.StringAttribute{
								...
								MarkdownDescription: "Service Account to be used in pods",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"termination_grace_period_seconds": schema.Int64Attribute{
								...
								MarkdownDescription: "TerminationGracePeriodSeconds is the amount of time that kubernetes will give for a pod instance to shutdown normally. The default value is 30.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"tolerations": schema.ListNestedAttribute{
								...
								MarkdownDescription: "Tolerations specifies the pod's tolerations.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
							...
							"topology_spread_constraints": schema.ListNestedAttribute{
								...
								MarkdownDescription: "TopologySpreadConstraints to apply to the pods",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"label_selector": schema.SingleNestedAttribute{
					...
					"probes": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Probes specifies the timeout values for the Readiness and Liveness Probes for the zookeeper pods.",
						Attributes: map[string]schema.Attribute{
							"liveness_probe": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
					...
					"replicas": schema.Int64Attribute{
						Description:         "Replicas is the expected size of the zookeeper cluster. The pravega-operator will eventually make the size of the running cluster equal to the expected size.  The valid range of size is from 1 to 7.",
						MarkdownDescription: "Replicas is the expected size of the zookeeper cluster. The pravega-operator will eventually make the size of the running cluster equal to the expected size.  The valid range of size is from 1 to 7.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.Int64{
					...
					"storage_type": schema.StringAttribute{
						...
						MarkdownDescription: "StorageType is used to tell which type of storage we will be using It can take either Ephemeral or persistence Default StorageType is Persistence storage",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"trigger_rolling_restart": schema.BoolAttribute{
						...
						MarkdownDescription: "TriggerRollingRestart if set to true will instruct operator to restart all the pods in the zookeeper cluster, after which this value will be set to false",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"volume_mounts": schema.ListNestedAttribute{
						...
						MarkdownDescription: "VolumeMounts defines to support customized volumeMounts",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"mount_path": schema.StringAttribute{
									Description:         "Path within the container at which the volume should be mounted.  Must not contain ':'.",
					...
					"volumes": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Volumes defines to support customized volumes",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *ZookeeperPravegaIoZookeeperClusterV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_zookeeper_pravega_io_zookeeper_cluster_v1beta1_manifest")

	var model ZookeeperPravegaIoZookeeperClusterV1Beta1ManifestData
	...
	model.ApiVersion = pointer.String("zookeeper.pravega.io/v1beta1")
