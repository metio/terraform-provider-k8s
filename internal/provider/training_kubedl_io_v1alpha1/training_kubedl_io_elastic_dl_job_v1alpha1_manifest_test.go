...
func TestTrainingKubedlIoElasticDLJobV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_training_kubedl_io_elastic_dl_job_v1alpha1_manifest", testCase)
		})
	}
}
