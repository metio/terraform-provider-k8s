...
var (
	_ datasource.DataSource              = &TrainingKubedlIoMarsJobV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &TrainingKubedlIoMarsJobV1Alpha1DataSource{}
)

func NewTrainingKubedlIoMarsJobV1Alpha1DataSource() datasource.DataSource {
	return &TrainingKubedlIoMarsJobV1Alpha1DataSource{}
}

type TrainingKubedlIoMarsJobV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type TrainingKubedlIoMarsJobV1Alpha1DataSourceData struct {
...
func (r *TrainingKubedlIoMarsJobV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_training_kubedl_io_mars_job_v1alpha1"
}

func (r *TrainingKubedlIoMarsJobV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TrainingKubedlIoMarsJobV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *TrainingKubedlIoMarsJobV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_training_kubedl_io_mars_job_v1alpha1")

	var data TrainingKubedlIoMarsJobV1Alpha1DataSourceData
	...
	var readResponse TrainingKubedlIoMarsJobV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("MarsJob")
