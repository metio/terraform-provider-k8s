...
var (
	_ datasource.DataSource              = &TrainingKubedlIoPyTorchJobV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &TrainingKubedlIoPyTorchJobV1Alpha1DataSource{}
)

func NewTrainingKubedlIoPyTorchJobV1Alpha1DataSource() datasource.DataSource {
	return &TrainingKubedlIoPyTorchJobV1Alpha1DataSource{}
}

type TrainingKubedlIoPyTorchJobV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type TrainingKubedlIoPyTorchJobV1Alpha1DataSourceData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"pytorch_replica_specs" json:"pytorchReplicaSpecs,omitempty"`
...
func (r *TrainingKubedlIoPyTorchJobV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_training_kubedl_io_py_torch_job_v1alpha1"
}

func (r *TrainingKubedlIoPyTorchJobV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"pytorch_replica_specs": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"replicas": schema.Int64Attribute{
...
func (r *TrainingKubedlIoPyTorchJobV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *TrainingKubedlIoPyTorchJobV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_training_kubedl_io_py_torch_job_v1alpha1")

	var data TrainingKubedlIoPyTorchJobV1Alpha1DataSourceData
	...
	var readResponse TrainingKubedlIoPyTorchJobV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("PyTorchJob")
