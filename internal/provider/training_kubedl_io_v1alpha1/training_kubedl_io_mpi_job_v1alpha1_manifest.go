...
var (
	_ datasource.DataSource = &TrainingKubedlIoMpijobV1Alpha1Manifest{}
)

func NewTrainingKubedlIoMpijobV1Alpha1Manifest() datasource.DataSource {
	return &TrainingKubedlIoMpijobV1Alpha1Manifest{}
}

type TrainingKubedlIoMpijobV1Alpha1Manifest struct{}

type TrainingKubedlIoMpijobV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Gpus             *int64  `tfsdk:"gpus" json:"gpus,omitempty"`
		GpusPerNode      *int64  `tfsdk:"gpus_per_node" json:"gpusPerNode,omitempty"`
		LauncherOnMaster *bool   `tfsdk:"launcher_on_master" json:"launcherOnMaster,omitempty"`
		MainContainer    *string `tfsdk:"main_container" json:"mainContainer,omitempty"`
		MpiDistribution  *string `tfsdk:"mpi_distribution" json:"mpiDistribution,omitempty"`
		MpiReplicaSpecs  *struct {
		...
		} `tfsdk:"mpi_replica_specs" json:"mpiReplicaSpecs,omitempty"`
		ProcessingResourceType *string `tfsdk:"processing_resource_type" json:"processingResourceType,omitempty"`
		ProcessingUnits        *int64  `tfsdk:"processing_units" json:"processingUnits,omitempty"`
		ProcessingUnitsPerNode *int64  `tfsdk:"processing_units_per_node" json:"processingUnitsPerNode,omitempty"`
		Replicas               *int64  `tfsdk:"replicas" json:"replicas,omitempty"`
		RunPolicy              *struct {
			ActiveDeadlineSeconds *int64  `tfsdk:"active_deadline_seconds" json:"activeDeadlineSeconds,omitempty"`
			BackoffLimit          *int64  `tfsdk:"backoff_limit" json:"backoffLimit,omitempty"`
		...
		} `tfsdk:"run_policy" json:"runPolicy,omitempty"`
		SchedulingPolicy *struct {
			MinAvailable      *int64  `tfsdk:"min_available" json:"minAvailable,omitempty"`
			Priority          *int64  `tfsdk:"priority" json:"priority,omitempty"`
			PriorityClassName *string `tfsdk:"priority_class_name" json:"priorityClassName,omitempty"`
		...
		SlotsPerWorker *int64 `tfsdk:"slots_per_worker" json:"slotsPerWorker,omitempty"`
		Template       *struct {
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
				Finalizers  *[]string          `tfsdk:"finalizers" json:"finalizers,omitempty"`
...
func (r *TrainingKubedlIoMpijobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_training_kubedl_io_mpi_job_v1alpha1_manifest"
}

func (r *TrainingKubedlIoMpijobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"gpus_per_node": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"launcher_on_master": schema.BoolAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"main_container": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"mpi_distribution": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"mpi_replica_specs": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
					...
					"processing_resource_type": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"processing_units": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"processing_units_per_node": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"run_policy": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"active_deadline_seconds": schema.Int64Attribute{
					...
					"slots_per_worker": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
...
func (r *TrainingKubedlIoMpijobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_mpi_job_v1alpha1_manifest")

	var model TrainingKubedlIoMpijobV1Alpha1ManifestData
	...
	model.Kind = pointer.String("MPIJob")
