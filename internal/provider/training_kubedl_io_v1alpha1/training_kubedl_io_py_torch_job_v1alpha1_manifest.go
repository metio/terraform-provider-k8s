...
var (
	_ datasource.DataSource = &TrainingKubedlIoPyTorchJobV1Alpha1Manifest{}
)

func NewTrainingKubedlIoPyTorchJobV1Alpha1Manifest() datasource.DataSource {
	return &TrainingKubedlIoPyTorchJobV1Alpha1Manifest{}
}

type TrainingKubedlIoPyTorchJobV1Alpha1Manifest struct{}

type TrainingKubedlIoPyTorchJobV1Alpha1ManifestData struct {
...
func (r *TrainingKubedlIoPyTorchJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_training_kubedl_io_py_torch_job_v1alpha1_manifest"
}

func (r *TrainingKubedlIoPyTorchJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TrainingKubedlIoPyTorchJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_py_torch_job_v1alpha1_manifest")

	var model TrainingKubedlIoPyTorchJobV1Alpha1ManifestData
	...
	model.Kind = pointer.String("PyTorchJob")
