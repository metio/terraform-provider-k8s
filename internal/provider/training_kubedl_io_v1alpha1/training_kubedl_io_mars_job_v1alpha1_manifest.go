...
var (
	_ datasource.DataSource = &TrainingKubedlIoMarsJobV1Alpha1Manifest{}
)

func NewTrainingKubedlIoMarsJobV1Alpha1Manifest() datasource.DataSource {
	return &TrainingKubedlIoMarsJobV1Alpha1Manifest{}
}

type TrainingKubedlIoMarsJobV1Alpha1Manifest struct{}

type TrainingKubedlIoMarsJobV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"mars_replica_specs" json:"marsReplicaSpecs,omitempty"`
		...
		WebHost                  *string `tfsdk:"web_host" json:"webHost,omitempty"`
		WorkerMemoryTuningPolicy *struct {
			LockFreeFileIO        *bool     `tfsdk:"lock_free_file_io" json:"lockFreeFileIO,omitempty"`
			PlasmaStore           *string   `tfsdk:"plasma_store" json:"plasmaStore,omitempty"`
			SpillDirs             *[]string `tfsdk:"spill_dirs" json:"spillDirs,omitempty"`
			WorkerCachePercentage *int64    `tfsdk:"worker_cache_percentage" json:"workerCachePercentage,omitempty"`
			WorkerCacheSize       *string   `tfsdk:"worker_cache_size" json:"workerCacheSize,omitempty"`
		} `tfsdk:"worker_memory_tuning_policy" json:"workerMemoryTuningPolicy,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *TrainingKubedlIoMarsJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_training_kubedl_io_mars_job_v1alpha1_manifest"
}

func (r *TrainingKubedlIoMarsJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"mars_replica_specs": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
					...
					"web_host": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"worker_memory_tuning_policy": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"lock_free_file_io": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"plasma_store": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"spill_dirs": schema.ListAttribute{
								Description:         "",
								MarkdownDescription: "",
								ElementType:         types.StringType,
								Required:            false,
							...
							"worker_cache_percentage": schema.Int64Attribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"worker_cache_size": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
...
func (r *TrainingKubedlIoMarsJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_mars_job_v1alpha1_manifest")

	var model TrainingKubedlIoMarsJobV1Alpha1ManifestData
	...
	model.Kind = pointer.String("MarsJob")
