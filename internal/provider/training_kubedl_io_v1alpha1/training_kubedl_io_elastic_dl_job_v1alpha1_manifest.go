...
var (
	_ datasource.DataSource = &TrainingKubedlIoElasticDljobV1Alpha1Manifest{}
)

func NewTrainingKubedlIoElasticDljobV1Alpha1Manifest() datasource.DataSource {
	return &TrainingKubedlIoElasticDljobV1Alpha1Manifest{}
}

type TrainingKubedlIoElasticDljobV1Alpha1Manifest struct{}

type TrainingKubedlIoElasticDljobV1Alpha1ManifestData struct {
...
func (r *TrainingKubedlIoElasticDljobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_training_kubedl_io_elastic_dl_job_v1alpha1_manifest"
}

func (r *TrainingKubedlIoElasticDljobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TrainingKubedlIoElasticDljobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_elastic_dl_job_v1alpha1_manifest")

	var model TrainingKubedlIoElasticDljobV1Alpha1ManifestData
