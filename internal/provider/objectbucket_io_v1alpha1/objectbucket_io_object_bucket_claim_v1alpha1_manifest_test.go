...
func TestObjectbucketIoObjectBucketClaimV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_objectbucket_io_object_bucket_claim_v1alpha1_manifest", testCase)
		})
	}
}
