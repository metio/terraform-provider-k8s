...
var (
	_ datasource.DataSource = &SecurityIstioIoPeerAuthenticationV1Beta1Manifest{}
)

func NewSecurityIstioIoPeerAuthenticationV1Beta1Manifest() datasource.DataSource {
	return &SecurityIstioIoPeerAuthenticationV1Beta1Manifest{}
}

type SecurityIstioIoPeerAuthenticationV1Beta1Manifest struct{}

type SecurityIstioIoPeerAuthenticationV1Beta1ManifestData struct {
...
func (r *SecurityIstioIoPeerAuthenticationV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_security_istio_io_peer_authentication_v1beta1_manifest"
}
...
func (r *SecurityIstioIoPeerAuthenticationV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_security_istio_io_peer_authentication_v1beta1_manifest")

	var model SecurityIstioIoPeerAuthenticationV1Beta1ManifestData
