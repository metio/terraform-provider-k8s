...
var (
	_ datasource.DataSource              = &SecurityIstioIoRequestAuthenticationV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &SecurityIstioIoRequestAuthenticationV1Beta1DataSource{}
)

func NewSecurityIstioIoRequestAuthenticationV1Beta1DataSource() datasource.DataSource {
	return &SecurityIstioIoRequestAuthenticationV1Beta1DataSource{}
}

type SecurityIstioIoRequestAuthenticationV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SecurityIstioIoRequestAuthenticationV1Beta1DataSourceData struct {
...
func (r *SecurityIstioIoRequestAuthenticationV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_security_istio_io_request_authentication_v1beta1"
}

func (r *SecurityIstioIoRequestAuthenticationV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SecurityIstioIoRequestAuthenticationV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SecurityIstioIoRequestAuthenticationV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_security_istio_io_request_authentication_v1beta1")

	var data SecurityIstioIoRequestAuthenticationV1Beta1DataSourceData
	...
	var readResponse SecurityIstioIoRequestAuthenticationV1Beta1DataSourceData
