...
var (
	_ datasource.DataSource              = &TestsTestkubeIoTestV1DataSource{}
	_ datasource.DataSourceWithConfigure = &TestsTestkubeIoTestV1DataSource{}
)

func NewTestsTestkubeIoTestV1DataSource() datasource.DataSource {
	return &TestsTestkubeIoTestV1DataSource{}
}

type TestsTestkubeIoTestV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type TestsTestkubeIoTestV1DataSourceData struct {
...
func (r *TestsTestkubeIoTestV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_tests_testkube_io_test_v1"
}

func (r *TestsTestkubeIoTestV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TestsTestkubeIoTestV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *TestsTestkubeIoTestV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_tests_testkube_io_test_v1")

	var data TestsTestkubeIoTestV1DataSourceData
	...
	var readResponse TestsTestkubeIoTestV1DataSourceData
