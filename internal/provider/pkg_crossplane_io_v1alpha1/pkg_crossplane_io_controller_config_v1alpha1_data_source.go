...
var (
	_ datasource.DataSource              = &PkgCrossplaneIoControllerConfigV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &PkgCrossplaneIoControllerConfigV1Alpha1DataSource{}
)

func NewPkgCrossplaneIoControllerConfigV1Alpha1DataSource() datasource.DataSource {
	return &PkgCrossplaneIoControllerConfigV1Alpha1DataSource{}
}

type PkgCrossplaneIoControllerConfigV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PkgCrossplaneIoControllerConfigV1Alpha1DataSourceData struct {
...
func (r *PkgCrossplaneIoControllerConfigV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_pkg_crossplane_io_controller_config_v1alpha1"
}

func (r *PkgCrossplaneIoControllerConfigV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PkgCrossplaneIoControllerConfigV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PkgCrossplaneIoControllerConfigV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_pkg_crossplane_io_controller_config_v1alpha1")

	var data PkgCrossplaneIoControllerConfigV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "pkg.crossplane.io", Version: "v1alpha1", Resource: "ControllerConfig"}).
	...
	var readResponse PkgCrossplaneIoControllerConfigV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("pkg.crossplane.io/v1alpha1")
	data.Kind = pointer.String("ControllerConfig")
