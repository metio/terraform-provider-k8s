...
var (
	_ datasource.DataSource              = &DynamodbServicesK8SAwsTableV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &DynamodbServicesK8SAwsTableV1Alpha1DataSource{}
)

func NewDynamodbServicesK8SAwsTableV1Alpha1DataSource() datasource.DataSource {
	return &DynamodbServicesK8SAwsTableV1Alpha1DataSource{}
}

type DynamodbServicesK8SAwsTableV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type DynamodbServicesK8SAwsTableV1Alpha1DataSourceData struct {
...
func (r *DynamodbServicesK8SAwsTableV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_dynamodb_services_k8s_aws_table_v1alpha1"
}

func (r *DynamodbServicesK8SAwsTableV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *DynamodbServicesK8SAwsTableV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *DynamodbServicesK8SAwsTableV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_dynamodb_services_k8s_aws_table_v1alpha1")

	var data DynamodbServicesK8SAwsTableV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "dynamodb.services.k8s.aws", Version: "v1alpha1", Resource: "tables"}).
	...
	var readResponse DynamodbServicesK8SAwsTableV1Alpha1DataSourceData
