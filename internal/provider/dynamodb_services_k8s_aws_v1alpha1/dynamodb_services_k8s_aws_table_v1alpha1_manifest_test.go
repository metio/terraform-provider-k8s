...
func TestDynamodbServicesK8SAwsTableV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_dynamodb_services_k8s_aws_table_v1alpha1_manifest", testCase)
		})
	}
}
