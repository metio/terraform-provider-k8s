...
func TestAcmeCertManagerIoOrderV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_acme_cert_manager_io_order_v1", testCase)
		})
	}
}
