...
var (
	_ datasource.DataSource              = &SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource{}
)

func NewSourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource() datasource.DataSource {
	return &SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource{}
}

type SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSourceData struct {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_source_toolkit_fluxcd_io_helm_repository_v1beta2"
}

func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_source_toolkit_fluxcd_io_helm_repository_v1beta2")

	var data SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSourceData
	...
	var readResponse SourceToolkitFluxcdIoHelmRepositoryV1Beta2DataSourceData
