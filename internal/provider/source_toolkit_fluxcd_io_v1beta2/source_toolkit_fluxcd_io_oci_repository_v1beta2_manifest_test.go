...
func TestSourceToolkitFluxcdIoOCIRepositoryV1Beta2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_source_toolkit_fluxcd_io_oci_repository_v1beta2_manifest", testCase)
		})
	}
}
