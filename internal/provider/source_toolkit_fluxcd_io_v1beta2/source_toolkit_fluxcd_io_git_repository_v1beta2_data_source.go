...
var (
	_ datasource.DataSource              = &SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource{}
)

func NewSourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource() datasource.DataSource {
	return &SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource{}
}

type SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSourceData struct {
...
func (r *SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_source_toolkit_fluxcd_io_git_repository_v1beta2"
}

func (r *SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_source_toolkit_fluxcd_io_git_repository_v1beta2")

	var data SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "source.toolkit.fluxcd.io", Version: "v1beta2", Resource: "gitrepositories"}).
	...
	var readResponse SourceToolkitFluxcdIoGitRepositoryV1Beta2DataSourceData
