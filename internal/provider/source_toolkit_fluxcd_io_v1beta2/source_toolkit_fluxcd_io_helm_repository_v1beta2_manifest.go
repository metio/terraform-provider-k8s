...
var (
	_ datasource.DataSource = &SourceToolkitFluxcdIoHelmRepositoryV1Beta2Manifest{}
)

func NewSourceToolkitFluxcdIoHelmRepositoryV1Beta2Manifest() datasource.DataSource {
	return &SourceToolkitFluxcdIoHelmRepositoryV1Beta2Manifest{}
}
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_source_toolkit_fluxcd_io_helm_repository_v1beta2_manifest"
}

func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SourceToolkitFluxcdIoHelmRepositoryV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_source_toolkit_fluxcd_io_helm_repository_v1beta2_manifest")

	var model SourceToolkitFluxcdIoHelmRepositoryV1Beta2ManifestData
