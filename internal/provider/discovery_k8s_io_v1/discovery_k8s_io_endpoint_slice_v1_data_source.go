...
var (
	_ datasource.DataSource              = &DiscoveryK8SIoEndpointSliceV1DataSource{}
	_ datasource.DataSourceWithConfigure = &DiscoveryK8SIoEndpointSliceV1DataSource{}
)

func NewDiscoveryK8SIoEndpointSliceV1DataSource() datasource.DataSource {
	return &DiscoveryK8SIoEndpointSliceV1DataSource{}
}

type DiscoveryK8SIoEndpointSliceV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type DiscoveryK8SIoEndpointSliceV1DataSourceData struct {
...
func (r *DiscoveryK8SIoEndpointSliceV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_discovery_k8s_io_endpoint_slice_v1"
}

func (r *DiscoveryK8SIoEndpointSliceV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
						...
						"conditions": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"serving": schema.BoolAttribute{
									...
									MarkdownDescription: "serving is identical to ready except that it is set regardless of the terminating state of endpoints. This condition should be set to true for a ready endpoint that is terminating. If nil, consumers should defer to the ready condition. This field can be enabled with the EndpointSliceTerminatingCondition feature gate.",
									Required:            false,
									Optional:            false,
									Computed:            true,
								},
								...
								"terminating": schema.BoolAttribute{
									...
									MarkdownDescription: "terminating indicates that this endpoint is terminating. A nil value indicates an unknown state. Consumers should interpret this unknown state to mean that the endpoint is not terminating. This field can be enabled with the EndpointSliceTerminatingCondition feature gate.",
									Required:            false,
									Optional:            false,
									Computed:            true,
								},
...
func (r *DiscoveryK8SIoEndpointSliceV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *DiscoveryK8SIoEndpointSliceV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_discovery_k8s_io_endpoint_slice_v1")

	var data DiscoveryK8SIoEndpointSliceV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "discovery.k8s.io", Version: "v1", Resource: "EndpointSlice"}).
	...
	var readResponse DiscoveryK8SIoEndpointSliceV1DataSourceData
	...
	data.ApiVersion = pointer.String("discovery.k8s.io/v1")
	data.Kind = pointer.String("EndpointSlice")
