...
var (
	_ datasource.DataSource = &RayIoRayServiceV1Alpha1Manifest{}
)

func NewRayIoRayServiceV1Alpha1Manifest() datasource.DataSource {
	return &RayIoRayServiceV1Alpha1Manifest{}
}

type RayIoRayServiceV1Alpha1Manifest struct{}

type RayIoRayServiceV1Alpha1ManifestData struct {
...
func (r *RayIoRayServiceV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ray_io_ray_service_v1alpha1_manifest"
}

func (r *RayIoRayServiceV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RayIoRayServiceV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ray_io_ray_service_v1alpha1_manifest")

	var model RayIoRayServiceV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("ray.io/v1alpha1")
