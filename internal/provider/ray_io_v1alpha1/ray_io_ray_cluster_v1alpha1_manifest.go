...
var (
	_ datasource.DataSource = &RayIoRayClusterV1Alpha1Manifest{}
)

func NewRayIoRayClusterV1Alpha1Manifest() datasource.DataSource {
	return &RayIoRayClusterV1Alpha1Manifest{}
}

type RayIoRayClusterV1Alpha1Manifest struct{}

type RayIoRayClusterV1Alpha1ManifestData struct {
...
func (r *RayIoRayClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ray_io_ray_cluster_v1alpha1_manifest"
}

func (r *RayIoRayClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RayIoRayClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ray_io_ray_cluster_v1alpha1_manifest")

	var model RayIoRayClusterV1Alpha1ManifestData
	...
	model.Kind = pointer.String("RayCluster")
