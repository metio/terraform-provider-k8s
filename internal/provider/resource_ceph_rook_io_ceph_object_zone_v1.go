...
type CephRookIoCephObjectZoneV1Resource struct{}

var (
	_ resource.Resource = (*CephRookIoCephObjectZoneV1Resource)(nil)
)

type CephRookIoCephObjectZoneV1TerraformModel struct {
...
type CephRookIoCephObjectZoneV1GoModel struct {
	...
	Spec *struct {
		CustomEndpoints *[]string `tfsdk:"custom_endpoints" yaml:"customEndpoints,omitempty"`
		...
		} `tfsdk:"data_pool" yaml:"dataPool,omitempty"`
		...
		ZoneGroup *string `tfsdk:"zone_group" yaml:"zoneGroup,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewCephRookIoCephObjectZoneV1Resource() resource.Resource {
	return &CephRookIoCephObjectZoneV1Resource{}
}

func (r *CephRookIoCephObjectZoneV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ceph_rook_io_ceph_object_zone_v1"
}

func (r *CephRookIoCephObjectZoneV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *CephRookIoCephObjectZoneV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_ceph_rook_io_ceph_object_zone_v1")

	var state CephRookIoCephObjectZoneV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CephRookIoCephObjectZoneV1GoModel
	...
	goModel.Kind = utilities.Ptr("CephObjectZone")
...
func (r *CephRookIoCephObjectZoneV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ceph_rook_io_ceph_object_zone_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *CephRookIoCephObjectZoneV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_ceph_rook_io_ceph_object_zone_v1")
...
func (r *CephRookIoCephObjectZoneV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_ceph_rook_io_ceph_object_zone_v1")
