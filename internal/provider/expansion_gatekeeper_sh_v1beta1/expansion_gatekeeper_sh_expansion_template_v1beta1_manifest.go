...
var (
	_ datasource.DataSource = &ExpansionGatekeeperShExpansionTemplateV1Beta1Manifest{}
)

func NewExpansionGatekeeperShExpansionTemplateV1Beta1Manifest() datasource.DataSource {
	return &ExpansionGatekeeperShExpansionTemplateV1Beta1Manifest{}
}

type ExpansionGatekeeperShExpansionTemplateV1Beta1Manifest struct{}

type ExpansionGatekeeperShExpansionTemplateV1Beta1ManifestData struct {
...
func (r *ExpansionGatekeeperShExpansionTemplateV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_expansion_gatekeeper_sh_expansion_template_v1beta1_manifest"
}

func (r *ExpansionGatekeeperShExpansionTemplateV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ExpansionGatekeeperShExpansionTemplateV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_expansion_gatekeeper_sh_expansion_template_v1beta1_manifest")

	var model ExpansionGatekeeperShExpansionTemplateV1Beta1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("expansion.gatekeeper.sh/v1beta1")
