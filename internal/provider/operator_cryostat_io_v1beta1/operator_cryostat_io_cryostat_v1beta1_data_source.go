...
var (
	_ datasource.DataSource              = &OperatorCryostatIoCryostatV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorCryostatIoCryostatV1Beta1DataSource{}
)

func NewOperatorCryostatIoCryostatV1Beta1DataSource() datasource.DataSource {
	return &OperatorCryostatIoCryostatV1Beta1DataSource{}
}

type OperatorCryostatIoCryostatV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorCryostatIoCryostatV1Beta1DataSourceData struct {
...
func (r *OperatorCryostatIoCryostatV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_cryostat_io_cryostat_v1beta1"
}

func (r *OperatorCryostatIoCryostatV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorCryostatIoCryostatV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorCryostatIoCryostatV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_cryostat_io_cryostat_v1beta1")

	var data OperatorCryostatIoCryostatV1Beta1DataSourceData
	...
	var readResponse OperatorCryostatIoCryostatV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("operator.cryostat.io/v1beta1")
	data.Kind = pointer.String("Cryostat")
