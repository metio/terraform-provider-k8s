...
func TestOperatorCryostatIoCryostatV1Beta1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_operator_cryostat_io_cryostat_v1beta1_manifest", testCase)
		})
	}
}
