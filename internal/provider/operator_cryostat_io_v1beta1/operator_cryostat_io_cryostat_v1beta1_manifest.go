...
func (r *OperatorCryostatIoCryostatV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Cryostat allows you to install Cryostat for a single namespace.It contains configuration options for controlling the Deployment of the Cryostatapplication and its related components.A Cryostat instance must be created to instruct the operatorto deploy the Cryostat application.",
		MarkdownDescription: "Cryostat allows you to install Cryostat for a single namespace.It contains configuration options for controlling the Deployment of the Cryostatapplication and its related components.A Cryostat instance must be created to instruct the operatorto deploy the Cryostat application.",
					...
					"service_options": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"storage_config": schema.SingleNestedAttribute{
								Description:         "Specification for the service responsible for the Cryostat storage container.",
								MarkdownDescription: "Specification for the service responsible for the Cryostat storage container.",
								Attributes: map[string]schema.Attribute{
									"annotations": schema.MapAttribute{
										Description:         "Annotations to add to the service during its creation.",
										MarkdownDescription: "Annotations to add to the service during its creation.",
									...
									"http_port": schema.Int64Attribute{
										Description:         "HTTP port number for the cryostat storage service.Defaults to 8333",
										MarkdownDescription: "HTTP port number for the cryostat storage service.Defaults to 8333",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
