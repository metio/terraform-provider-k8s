...
var (
	_ datasource.DataSource = &MonitoringCoreosComPrometheusAgentV1Alpha1Manifest{}
)

func NewMonitoringCoreosComPrometheusAgentV1Alpha1Manifest() datasource.DataSource {
	return &MonitoringCoreosComPrometheusAgentV1Alpha1Manifest{}
}

type MonitoringCoreosComPrometheusAgentV1Alpha1Manifest struct{}

type MonitoringCoreosComPrometheusAgentV1Alpha1ManifestData struct {
...
func (r *MonitoringCoreosComPrometheusAgentV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_prometheus_agent_v1alpha1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "Specification of the desired behavior of the Prometheus agent. More info:https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
				Attributes: map[string]schema.Attribute{
					...
					"apiserver_config": schema.SingleNestedAttribute{
						Description:         "APIServerConfig allows specifying a host and auth methods to access theKuberntees API server.If null, Prometheus is assumed to run inside of the cluster: it willdiscover the API servers automatically and use the Pod's CA certificateand bearer token file at /var/run/secrets/kubernetes.io/serviceaccount/.",
						MarkdownDescription: "APIServerConfig allows specifying a host and auth methods to access theKuberntees API server.If null, Prometheus is assumed to run inside of the cluster: it willdiscover the API servers automatically and use the Pod's CA certificateand bearer token file at /var/run/secrets/kubernetes.io/serviceaccount/.",
						Attributes: map[string]schema.Attribute{
							...
							"bearer_token": schema.StringAttribute{
								Description:         "*Warning: this field shouldn't be used because the token value appearsin clear-text. Prefer using 'authorization'.*Deprecated: this will be removed in a future release.",
								MarkdownDescription: "*Warning: this field shouldn't be used because the token value appearsin clear-text. Prefer using 'authorization'.*Deprecated: this will be removed in a future release.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"host": schema.StringAttribute{
								Description:         "Kubernetes API address consisting of a hostname or IP address followedby an optional port number.",
								MarkdownDescription: "Kubernetes API address consisting of a hostname or IP address followedby an optional port number.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"config_maps": schema.ListAttribute{
						Description:         "ConfigMaps is a list of ConfigMaps in the same namespace as the Prometheusobject, which shall be mounted into the Prometheus Pods.Each ConfigMap is added to the StatefulSet definition as a volume named 'configmap-<configmap-name>'.The ConfigMaps are mounted into /etc/prometheus/configmaps/<configmap-name> in the 'prometheus' container.",
						MarkdownDescription: "ConfigMaps is a list of ConfigMaps in the same namespace as the Prometheusobject, which shall be mounted into the Prometheus Pods.Each ConfigMap is added to the StatefulSet definition as a volume named 'configmap-<configmap-name>'.The ConfigMaps are mounted into /etc/prometheus/configmaps/<configmap-name> in the 'prometheus' container.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"containers": schema.ListNestedAttribute{
						Description:         "Containers allows injecting additional containers or modifying operatorgenerated containers. This can be used to allow adding an authenticationproxy to the Pods or to change the behavior of an operator generatedcontainer. Containers described here modify an operator generatedcontainer if they share the same name and modifications are done via astrategic merge patch.The names of containers managed by the operator are:* 'prometheus'* 'config-reloader'* 'thanos-sidecar'Overriding containers is entirely outside the scope of what themaintainers will support and by doing so, you accept that this behaviourmay break at any time without notice.",
					...
					"enable_remote_write_receiver": schema.BoolAttribute{
						Description:         "Enable Prometheus to be used as a receiver for the Prometheus remotewrite protocol.WARNING: This is not considered an efficient way of ingesting samples.Use it with caution for specific low-volume use cases.It is not suitable for replacing the ingestion via scraping and turningPrometheus into a push-based metrics collection system.For more information see https://prometheus.io/docs/prometheus/latest/querying/api/#remote-write-receiverIt requires Prometheus >= v2.33.0.",
						MarkdownDescription: "Enable Prometheus to be used as a receiver for the Prometheus remotewrite protocol.WARNING: This is not considered an efficient way of ingesting samples.Use it with caution for specific low-volume use cases.It is not suitable for replacing the ingestion via scraping and turningPrometheus into a push-based metrics collection system.For more information see https://prometheus.io/docs/prometheus/latest/querying/api/#remote-write-receiverIt requires Prometheus >= v2.33.0.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"excluded_from_enforcement": schema.ListNestedAttribute{
						Description:         "List of references to PodMonitor, ServiceMonitor, Probe and PrometheusRule objectsto be excluded from enforcing a namespace label of origin.It is only applicable if 'spec.enforcedNamespaceLabel' set to true.",
						MarkdownDescription: "List of references to PodMonitor, ServiceMonitor, Probe and PrometheusRule objectsto be excluded from enforcing a namespace label of origin.It is only applicable if 'spec.enforcedNamespaceLabel' set to true.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"external_labels": schema.MapAttribute{
						Description:         "The labels to add to any time series or alerts when communicating withexternal systems (federation, remote storage, Alertmanager).Labels defined by 'spec.replicaExternalLabelName' and'spec.prometheusExternalLabelName' take precedence over this list.",
						MarkdownDescription: "The labels to add to any time series or alerts when communicating withexternal systems (federation, remote storage, Alertmanager).Labels defined by 'spec.replicaExternalLabelName' and'spec.prometheusExternalLabelName' take precedence over this list.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"external_url": schema.StringAttribute{
						Description:         "The external URL under which the Prometheus service is externallyavailable. This is necessary to generate correct URLs (for instance ifPrometheus is accessible behind an Ingress resource).",
						MarkdownDescription: "The external URL under which the Prometheus service is externallyavailable. This is necessary to generate correct URLs (for instance ifPrometheus is accessible behind an Ingress resource).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"host_aliases": schema.ListNestedAttribute{
						Description:         "Optional list of hosts and IPs that will be injected into the Pod'shosts file if specified.",
						MarkdownDescription: "Optional list of hosts and IPs that will be injected into the Pod'shosts file if specified.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"host_network": schema.BoolAttribute{
						Description:         "Use the host's network namespace if true.Make sure to understand the security implications if you want to enableit (https://kubernetes.io/docs/concepts/configuration/overview/).When hostNetwork is enabled, this will set the DNS policy to'ClusterFirstWithHostNet' automatically.",
						MarkdownDescription: "Use the host's network namespace if true.Make sure to understand the security implications if you want to enableit (https://kubernetes.io/docs/concepts/configuration/overview/).When hostNetwork is enabled, this will set the DNS policy to'ClusterFirstWithHostNet' automatically.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"ignore_namespace_selectors": schema.BoolAttribute{
						Description:         "When true, 'spec.namespaceSelector' from all PodMonitor, ServiceMonitorand Probe objects will be ignored. They will only discover targetswithin the namespace of the PodMonitor, ServiceMonitor and Probeobject.",
						MarkdownDescription: "When true, 'spec.namespaceSelector' from all PodMonitor, ServiceMonitorand Probe objects will be ignored. They will only discover targetswithin the namespace of the PodMonitor, ServiceMonitor and Probeobject.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"image": schema.StringAttribute{
						Description:         "Container image name for Prometheus. If specified, it takes precedenceover the 'spec.baseImage', 'spec.tag' and 'spec.sha' fields.Specifying 'spec.version' is still necessary to ensure the PrometheusOperator knows which version of Prometheus is being configured.If neither 'spec.image' nor 'spec.baseImage' are defined, the operatorwill use the latest upstream version of Prometheus available at the timewhen the operator was released.",
						MarkdownDescription: "Container image name for Prometheus. If specified, it takes precedenceover the 'spec.baseImage', 'spec.tag' and 'spec.sha' fields.Specifying 'spec.version' is still necessary to ensure the PrometheusOperator knows which version of Prometheus is being configured.If neither 'spec.image' nor 'spec.baseImage' are defined, the operatorwill use the latest upstream version of Prometheus available at the timewhen the operator was released.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"image_pull_secrets": schema.ListNestedAttribute{
						Description:         "An optional list of references to Secrets in the same namespaceto use for pulling images from registries.See http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod",
						MarkdownDescription: "An optional list of references to Secrets in the same namespaceto use for pulling images from registries.See http://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									Description:         "Name of the referent.This field is effectively required, but due to backwards compatibility isallowed to be empty. Instances of this type with an empty value here arealmost certainly wrong.More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
					...
					"init_containers": schema.ListNestedAttribute{
						Description:         "InitContainers allows injecting initContainers to the Pod definition. Thosecan be used to e.g.  fetch secrets for injection into the Prometheusconfiguration from external sources. Any errors during the execution ofan initContainer will lead to a restart of the Pod. More info:https://kubernetes.io/docs/concepts/workloads/pods/init-containers/InitContainers described here modify an operator generated initcontainers if they share the same name and modifications are done via astrategic merge patch.The names of init container name managed by the operator are:* 'init-config-reloader'.Overriding init containers is entirely outside the scope of what themaintainers will support and by doing so, you accept that this behaviourmay break at any time without notice.",
					...
					"listen_local": schema.BoolAttribute{
						Description:         "When true, the Prometheus server listens on the loopback addressinstead of the Pod IP's address.",
						MarkdownDescription: "When true, the Prometheus server listens on the loopback addressinstead of the Pod IP's address.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"min_ready_seconds": schema.Int64Attribute{
						Description:         "Minimum number of seconds for which a newly created Pod should be readywithout any of its container crashing for it to be considered available.Defaults to 0 (pod will be considered available as soon as it is ready)This is an alpha field from kubernetes 1.22 until 1.24 which requiresenabling the StatefulSetMinReadySeconds feature gate.",
						MarkdownDescription: "Minimum number of seconds for which a newly created Pod should be readywithout any of its container crashing for it to be considered available.Defaults to 0 (pod will be considered available as soon as it is ready)This is an alpha field from kubernetes 1.22 until 1.24 which requiresenabling the StatefulSetMinReadySeconds feature gate.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"override_honor_timestamps": schema.BoolAttribute{
						Description:         "When true, Prometheus ignores the timestamps for all the targets createdfrom service and pod monitors.Otherwise the HonorTimestamps field of the service or pod monitor applies.",
						MarkdownDescription: "When true, Prometheus ignores the timestamps for all the targets createdfrom service and pod monitors.Otherwise the HonorTimestamps field of the service or pod monitor applies.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"paused": schema.BoolAttribute{
						Description:         "When a Prometheus deployment is paused, no actions except for deletionwill be performed on the underlying objects.",
						MarkdownDescription: "When a Prometheus deployment is paused, no actions except for deletionwill be performed on the underlying objects.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"persistent_volume_claim_retention_policy": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"when_deleted": schema.StringAttribute{
								Description:         "WhenDeleted specifies what happens to PVCs created from StatefulSetVolumeClaimTemplates when the StatefulSet is deleted. The default policyof 'Retain' causes PVCs to not be affected by StatefulSet deletion. The'Delete' policy causes those PVCs to be deleted.",
								MarkdownDescription: "WhenDeleted specifies what happens to PVCs created from StatefulSetVolumeClaimTemplates when the StatefulSet is deleted. The default policyof 'Retain' causes PVCs to not be affected by StatefulSet deletion. The'Delete' policy causes those PVCs to be deleted.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"pod_monitor_selector": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "PodMonitors to be selected for target discovery. An empty label selectormatches all objects. A null label selector matches no objects.If 'spec.serviceMonitorSelector', 'spec.podMonitorSelector', 'spec.probeSelector'and 'spec.scrapeConfigSelector' are null, the Prometheus configuration is unmanaged.The Prometheus operator will ensure that the Prometheus configuration'sSecret exists, but it is the responsibility of the user to provide the rawgzipped Prometheus configuration under the 'prometheus.yaml.gz' key.This behavior is *deprecated* and will be removed in the next major versionof the custom resource definition. It is recommended to use'spec.additionalScrapeConfigs' instead.",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"pod_target_labels": schema.ListAttribute{
						Description:         "PodTargetLabels are appended to the 'spec.podTargetLabels' field of allPodMonitor and ServiceMonitor objects.",
						MarkdownDescription: "PodTargetLabels are appended to the 'spec.podTargetLabels' field of allPodMonitor and ServiceMonitor objects.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"probe_namespace_selector": schema.SingleNestedAttribute{
						Description:         "Namespaces to match for Probe discovery. An empty labelselector matches all namespaces. A null label selector matches thecurrent namespace only.",
						MarkdownDescription: "Namespaces to match for Probe discovery. An empty labelselector matches all namespaces. A null label selector matches thecurrent namespace only.",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"probe_selector": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Probes to be selected for target discovery. An empty label selectormatches all objects. A null label selector matches no objects.If 'spec.serviceMonitorSelector', 'spec.podMonitorSelector', 'spec.probeSelector'and 'spec.scrapeConfigSelector' are null, the Prometheus configuration is unmanaged.The Prometheus operator will ensure that the Prometheus configuration'sSecret exists, but it is the responsibility of the user to provide the rawgzipped Prometheus configuration under the 'prometheus.yaml.gz' key.This behavior is *deprecated* and will be removed in the next major versionof the custom resource definition. It is recommended to use'spec.additionalScrapeConfigs' instead.",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"prometheus_external_label_name": schema.StringAttribute{
						Description:         "Name of Prometheus external label used to denote the Prometheus instancename. The external label will _not_ be added when the field is set tothe empty string ('''').Default: 'prometheus'",
						MarkdownDescription: "Name of Prometheus external label used to denote the Prometheus instancename. The external label will _not_ be added when the field is set tothe empty string ('''').Default: 'prometheus'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"queue_config": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"capacity": schema.Int64Attribute{
											Description:         "Capacity is the number of samples to buffer per shard before we startdropping them.",
											MarkdownDescription: "Capacity is the number of samples to buffer per shard before we startdropping them.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"retry_on_rate_limit": schema.BoolAttribute{
											Description:         "Retry upon receiving a 429 status code from the remote-write storage.This is an *experimental feature*, it may change in any upcoming releasein a breaking way.",
											MarkdownDescription: "Retry upon receiving a 429 status code from the remote-write storage.This is an *experimental feature*, it may change in any upcoming releasein a breaking way.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
								...
								"send_exemplars": schema.BoolAttribute{
									Description:         "Enables sending of exemplars over remote write. Note thatexemplar-storage itself must be enabled using the 'spec.enableFeature'option for exemplars to be scraped in the first place.It requires Prometheus >= v2.27.0.",
									MarkdownDescription: "Enables sending of exemplars over remote write. Note thatexemplar-storage itself must be enabled using the 'spec.enableFeature'option for exemplars to be scraped in the first place.It requires Prometheus >= v2.27.0.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
								...
								"send_native_histograms": schema.BoolAttribute{
									Description:         "Enables sending of native histograms, also known as sparse histogramsover remote write.It requires Prometheus >= v2.40.0.",
									MarkdownDescription: "Enables sending of native histograms, also known as sparse histogramsover remote write.It requires Prometheus >= v2.40.0.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
					...
					"replica_external_label_name": schema.StringAttribute{
						Description:         "Name of Prometheus external label used to denote the replica name.The external label will _not_ be added when the field is set to theempty string ('''').Default: 'prometheus_replica'",
						MarkdownDescription: "Name of Prometheus external label used to denote the replica name.The external label will _not_ be added when the field is set to theempty string ('''').Default: 'prometheus_replica'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"replicas": schema.Int64Attribute{
						Description:         "Number of replicas of each shard to deploy for a Prometheus deployment.'spec.replicas' multiplied by 'spec.shards' is the total number of Podscreated.Default: 1",
						MarkdownDescription: "Number of replicas of each shard to deploy for a Prometheus deployment.'spec.replicas' multiplied by 'spec.shards' is the total number of Podscreated.Default: 1",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"route_prefix": schema.StringAttribute{
						Description:         "The route prefix Prometheus registers HTTP handlers for.This is useful when using 'spec.externalURL', and a proxy is rewritingHTTP routes of a request, and the actual ExternalURL is still true, butthe server serves requests under a different route prefix. For examplefor use with 'kubectl proxy'.",
						MarkdownDescription: "The route prefix Prometheus registers HTTP handlers for.This is useful when using 'spec.externalURL', and a proxy is rewritingHTTP routes of a request, and the actual ExternalURL is still true, butthe server serves requests under a different route prefix. For examplefor use with 'kubectl proxy'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"scrape_classes": schema.ListNestedAttribute{
						Description:         "List of scrape classes to expose to scraping objects such asPodMonitors, ServiceMonitors, Probes and ScrapeConfigs.This is an *experimental feature*, it may change in any upcoming releasein a breaking way.",
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"relabelings": schema.ListNestedAttribute{
									Description:         "Relabelings configures the relabeling rules to apply to all scrape targets.The Operator automatically adds relabelings for a few standard Kubernetes fieldslike '__meta_kubernetes_namespace' and '__meta_kubernetes_service_name'.Then the Operator adds the scrape class relabelings defined here.Then the Operator adds the target-specific relabelings defined in the scrape object.More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config",
									MarkdownDescription: "Relabelings configures the relabeling rules to apply to all scrape targets.The Operator automatically adds relabelings for a few standard Kubernetes fieldslike '__meta_kubernetes_namespace' and '__meta_kubernetes_service_name'.Then the Operator adds the scrape class relabelings defined here.Then the Operator adds the target-specific relabelings defined in the scrape object.More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"action": schema.StringAttribute{
												Description:         "Action to perform based on the regex matching.'Uppercase' and 'Lowercase' actions require Prometheus >= v2.36.0.'DropEqual' and 'KeepEqual' actions require Prometheus >= v2.41.0.Default: 'Replace'",
					...
					"scrape_config_namespace_selector": schema.SingleNestedAttribute{
						Description:         "Namespaces to match for ScrapeConfig discovery. An empty label selectormatches all namespaces. A null label selector matches the currentnamespace only.Note that the ScrapeConfig custom resource definition is currently at Alpha level.",
						MarkdownDescription: "Namespaces to match for ScrapeConfig discovery. An empty label selectormatches all namespaces. A null label selector matches the currentnamespace only.Note that the ScrapeConfig custom resource definition is currently at Alpha level.",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"secrets": schema.ListAttribute{
						Description:         "Secrets is a list of Secrets in the same namespace as the Prometheusobject, which shall be mounted into the Prometheus Pods.Each Secret is added to the StatefulSet definition as a volume named 'secret-<secret-name>'.The Secrets are mounted into /etc/prometheus/secrets/<secret-name> in the 'prometheus' container.",
						MarkdownDescription: "Secrets is a list of Secrets in the same namespace as the Prometheusobject, which shall be mounted into the Prometheus Pods.Each Secret is added to the StatefulSet definition as a volume named 'secret-<secret-name>'.The Secrets are mounted into /etc/prometheus/secrets/<secret-name> in the 'prometheus' container.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"service_account_name": schema.StringAttribute{
						Description:         "ServiceAccountName is the name of the ServiceAccount to use to run thePrometheus Pods.",
						MarkdownDescription: "ServiceAccountName is the name of the ServiceAccount to use to run thePrometheus Pods.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"service_discovery_role": schema.StringAttribute{
						Description:         "Defines the service discovery role used to discover targets from'ServiceMonitor' objects and Alertmanager endpoints.If set, the value should be either 'Endpoints' or 'EndpointSlice'.If unset, the operator assumes the 'Endpoints' role.",
						MarkdownDescription: "Defines the service discovery role used to discover targets from'ServiceMonitor' objects and Alertmanager endpoints.If set, the value should be either 'Endpoints' or 'EndpointSlice'.If unset, the operator assumes the 'Endpoints' role.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"storage": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"volume_claim_template": schema.SingleNestedAttribute{
								Description:         "Defines the PVC spec to be used by the Prometheus StatefulSets.The easiest way to use a volume that cannot be automatically provisionedis to use a label selector alongside manually created PersistentVolumes.",
								MarkdownDescription: "Defines the PVC spec to be used by the Prometheus StatefulSets.The easiest way to use a volume that cannot be automatically provisionedis to use a label selector alongside manually created PersistentVolumes.",
								Attributes: map[string]schema.Attribute{
									"api_version": schema.StringAttribute{
									...
									"status": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"current_volume_attributes_class_name": schema.StringAttribute{
												Description:         "currentVolumeAttributesClassName is the current name of the VolumeAttributesClass the PVC is using.When unset, there is no VolumeAttributeClass applied to this PersistentVolumeClaimThis is a beta field and requires enabling VolumeAttributesClass feature (off by default).",
												MarkdownDescription: "currentVolumeAttributesClassName is the current name of the VolumeAttributesClass the PVC is using.When unset, there is no VolumeAttributeClass applied to this PersistentVolumeClaimThis is a beta field and requires enabling VolumeAttributesClass feature (off by default).",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
					...
					"tracing_config": schema.SingleNestedAttribute{
						Description:         "TracingConfig configures tracing in Prometheus.This is an *experimental feature*, it may change in any upcoming releasein a breaking way.",
						MarkdownDescription: "TracingConfig configures tracing in Prometheus.This is an *experimental feature*, it may change in any upcoming releasein a breaking way.",
						Attributes: map[string]schema.Attribute{
					...
					"tsdb": schema.SingleNestedAttribute{
						Description:         "Defines the runtime reloadable configuration of the timeseries database(TSDB).It requires Prometheus >= v2.39.0 or PrometheusAgent >= v2.54.0.",
						MarkdownDescription: "Defines the runtime reloadable configuration of the timeseries database(TSDB).It requires Prometheus >= v2.39.0 or PrometheusAgent >= v2.54.0.",
						Attributes: map[string]schema.Attribute{
							"out_of_order_time_window": schema.StringAttribute{
								Description:         "Configures how old an out-of-order/out-of-bounds sample can be withrespect to the TSDB max time.An out-of-order/out-of-bounds sample is ingested into the TSDB as long asthe timestamp of the sample is >= (TSDB.MaxTime - outOfOrderTimeWindow).This is an *experimental feature*, it may change in any upcoming releasein a breaking way.It requires Prometheus >= v2.39.0 or PrometheusAgent >= v2.54.0.",
								MarkdownDescription: "Configures how old an out-of-order/out-of-bounds sample can be withrespect to the TSDB max time.An out-of-order/out-of-bounds sample is ingested into the TSDB as long asthe timestamp of the sample is >= (TSDB.MaxTime - outOfOrderTimeWindow).This is an *experimental feature*, it may change in any upcoming releasein a breaking way.It requires Prometheus >= v2.39.0 or PrometheusAgent >= v2.54.0.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
					...
					"version": schema.StringAttribute{
						Description:         "Version of Prometheus being deployed. The operator uses this informationto generate the Prometheus StatefulSet + configuration files.If not specified, the operator assumes the latest upstream version ofPrometheus available at the time when the version of the operator wasreleased.",
						MarkdownDescription: "Version of Prometheus being deployed. The operator uses this informationto generate the Prometheus StatefulSet + configuration files.If not specified, the operator assumes the latest upstream version ofPrometheus available at the time when the version of the operator wasreleased.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"volumes": schema.ListNestedAttribute{
						Description:         "Volumes allows the configuration of additional volumes on the outputStatefulSet definition. Volumes specified will be appended to othervolumes that are generated as a result of StorageSpec objects.",
						MarkdownDescription: "Volumes allows the configuration of additional volumes on the outputStatefulSet definition. Volumes specified will be appended to othervolumes that are generated as a result of StorageSpec objects.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"wal_compression": schema.BoolAttribute{
						Description:         "Configures compression of the write-ahead log (WAL) using Snappy.WAL compression is enabled by default for Prometheus >= 2.20.0Requires Prometheus v2.11.0 and above.",
						MarkdownDescription: "Configures compression of the write-ahead log (WAL) using Snappy.WAL compression is enabled by default for Prometheus >= 2.20.0Requires Prometheus v2.11.0 and above.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"web": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"max_connections": schema.Int64Attribute{
								Description:         "Defines the maximum number of simultaneous connectionsA zero value means that Prometheus doesn't accept any incoming connection.",
								MarkdownDescription: "Defines the maximum number of simultaneous connectionsA zero value means that Prometheus doesn't accept any incoming connection.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
							...
							"tls_config": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"cipher_suites": schema.ListAttribute{
										Description:         "List of supported cipher suites for TLS versions up to TLS 1.2. If empty,Go default cipher suites are used. Available cipher suites are documentedin the go documentation: https://golang.org/pkg/crypto/tls/#pkg-constants",
										MarkdownDescription: "List of supported cipher suites for TLS versions up to TLS 1.2. If empty,Go default cipher suites are used. Available cipher suites are documentedin the go documentation: https://golang.org/pkg/crypto/tls/#pkg-constants",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"curve_preferences": schema.ListAttribute{
										Description:         "Elliptic curves that will be used in an ECDHE handshake, in preferenceorder. Available curves are documented in the go documentation:https://golang.org/pkg/crypto/tls/#CurveID",
										MarkdownDescription: "Elliptic curves that will be used in an ECDHE handshake, in preferenceorder. Available curves are documented in the go documentation:https://golang.org/pkg/crypto/tls/#CurveID",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"prefer_server_cipher_suites": schema.BoolAttribute{
										Description:         "Controls whether the server selects theclient's most preferred cipher suite, or the server's most preferredcipher suite. If true then the server's preference, as expressed inthe order of elements in cipherSuites, is used.",
										MarkdownDescription: "Controls whether the server selects theclient's most preferred cipher suite, or the server's most preferredcipher suite. If true then the server's preference, as expressed inthe order of elements in cipherSuites, is used.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
...
func (r *MonitoringCoreosComPrometheusAgentV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_monitoring_coreos_com_prometheus_agent_v1alpha1_manifest")

	var model MonitoringCoreosComPrometheusAgentV1Alpha1ManifestData
	...
	model.Kind = pointer.String("PrometheusAgent")
