...
var (
	_ datasource.DataSource              = &MonitoringCoreosComPrometheusAgentV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MonitoringCoreosComPrometheusAgentV1Alpha1DataSource{}
)

func NewMonitoringCoreosComPrometheusAgentV1Alpha1DataSource() datasource.DataSource {
	return &MonitoringCoreosComPrometheusAgentV1Alpha1DataSource{}
}

type MonitoringCoreosComPrometheusAgentV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MonitoringCoreosComPrometheusAgentV1Alpha1DataSourceData struct {
...
func (r *MonitoringCoreosComPrometheusAgentV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_prometheus_agent_v1alpha1"
}

func (r *MonitoringCoreosComPrometheusAgentV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MonitoringCoreosComPrometheusAgentV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MonitoringCoreosComPrometheusAgentV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_monitoring_coreos_com_prometheus_agent_v1alpha1")

	var data MonitoringCoreosComPrometheusAgentV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "monitoring.coreos.com", Version: "v1alpha1", Resource: "prometheusagents"}).
	...
	var readResponse MonitoringCoreosComPrometheusAgentV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("monitoring.coreos.com/v1alpha1")
	data.Kind = pointer.String("PrometheusAgent")
