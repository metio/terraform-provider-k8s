...
var (
	_ resource.Resource = (*CephRookIoCephObjectStoreV1Resource)(nil)
)

type CephRookIoCephObjectStoreV1TerraformModel struct {
...
type CephRookIoCephObjectStoreV1GoModel struct {
	...
	Spec *struct {
		...
		Gateway *struct {
			...
			CaBundleRef *string `tfsdk:"ca_bundle_ref" yaml:"caBundleRef,omitempty"`
			...
			SecurePort *int64 `tfsdk:"secure_port" yaml:"securePort,omitempty"`

			Service *struct {
				Annotations *map[string]string `tfsdk:"annotations" yaml:"annotations,omitempty"`
			} `tfsdk:"service" yaml:"service,omitempty"`

			SslCertificateRef *string `tfsdk:"ssl_certificate_ref" yaml:"sslCertificateRef,omitempty"`
		...
		Zone *struct {
			Name *string `tfsdk:"name" yaml:"name,omitempty"`
		} `tfsdk:"zone" yaml:"zone,omitempty"`
...
func (r *CephRookIoCephObjectStoreV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ceph_rook_io_ceph_object_store_v1"
}

func (r *CephRookIoCephObjectStoreV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *CephRookIoCephObjectStoreV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_ceph_rook_io_ceph_object_store_v1")

	var state CephRookIoCephObjectStoreV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel CephRookIoCephObjectStoreV1GoModel
	...
	goModel.Kind = utilities.Ptr("CephObjectStore")
...
func (r *CephRookIoCephObjectStoreV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ceph_rook_io_ceph_object_store_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *CephRookIoCephObjectStoreV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *CephRookIoCephObjectStoreV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
