...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource{}
)

func NewLoggingBanzaicloudIoClusterOutputV1Alpha1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource{}
}

type LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoClusterOutputV1Alpha1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_cluster_output_v1alpha1"
}

func (r *LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoClusterOutputV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_cluster_output_v1alpha1")

	var data LoggingBanzaicloudIoClusterOutputV1Alpha1DataSourceData
	...
	var readResponse LoggingBanzaicloudIoClusterOutputV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ClusterOutput")
