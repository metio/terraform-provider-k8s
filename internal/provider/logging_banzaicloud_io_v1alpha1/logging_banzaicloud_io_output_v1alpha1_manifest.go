...
type LoggingBanzaicloudIoOutputV1Alpha1ManifestData struct {
	...
	Spec *struct {
		AwsElasticsearch *struct {
			...
			Data_stream_template_use_index_patterns_wildcard *bool   `tfsdk:"data_stream_template_use_index_patterns_wildcard" json:"data_stream_template_use_index_patterns_wildcard,omitempty"`
