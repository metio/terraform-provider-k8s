...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoFlowV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoFlowV1Alpha1DataSource{}
)

func NewLoggingBanzaicloudIoFlowV1Alpha1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoFlowV1Alpha1DataSource{}
}

type LoggingBanzaicloudIoFlowV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoFlowV1Alpha1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoFlowV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_flow_v1alpha1"
}

func (r *LoggingBanzaicloudIoFlowV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoFlowV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoFlowV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_flow_v1alpha1")

	var data LoggingBanzaicloudIoFlowV1Alpha1DataSourceData
	...
	var readResponse LoggingBanzaicloudIoFlowV1Alpha1DataSourceData
