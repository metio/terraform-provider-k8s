...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoOutputV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoOutputV1Alpha1DataSource{}
)

func NewLoggingBanzaicloudIoOutputV1Alpha1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoOutputV1Alpha1DataSource{}
}

type LoggingBanzaicloudIoOutputV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoOutputV1Alpha1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoOutputV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_output_v1alpha1"
}

func (r *LoggingBanzaicloudIoOutputV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoOutputV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoOutputV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_output_v1alpha1")

	var data LoggingBanzaicloudIoOutputV1Alpha1DataSourceData
	...
	var readResponse LoggingBanzaicloudIoOutputV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Output")
