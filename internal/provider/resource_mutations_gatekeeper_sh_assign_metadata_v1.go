...
type MutationsGatekeeperShAssignMetadataV1Resource struct{}

var (
	_ resource.Resource = (*MutationsGatekeeperShAssignMetadataV1Resource)(nil)
)

type MutationsGatekeeperShAssignMetadataV1TerraformModel struct {
...
type MutationsGatekeeperShAssignMetadataV1GoModel struct {
...
func NewMutationsGatekeeperShAssignMetadataV1Resource() resource.Resource {
	return &MutationsGatekeeperShAssignMetadataV1Resource{}
}

func (r *MutationsGatekeeperShAssignMetadataV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mutations_gatekeeper_sh_assign_metadata_v1"
}

func (r *MutationsGatekeeperShAssignMetadataV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *MutationsGatekeeperShAssignMetadataV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_mutations_gatekeeper_sh_assign_metadata_v1")

	var state MutationsGatekeeperShAssignMetadataV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel MutationsGatekeeperShAssignMetadataV1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("mutations.gatekeeper.sh/v1")
...
func (r *MutationsGatekeeperShAssignMetadataV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_metadata_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *MutationsGatekeeperShAssignMetadataV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_mutations_gatekeeper_sh_assign_metadata_v1")
...
func (r *MutationsGatekeeperShAssignMetadataV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_mutations_gatekeeper_sh_assign_metadata_v1")
