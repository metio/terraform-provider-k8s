...
var (
	_ datasource.DataSource = &GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest{}
)

func NewGrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest() datasource.DataSource {
	return &GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest{}
}

type GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest struct{}

type GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		DisableResolveMessage     *bool `tfsdk:"disable_resolve_message" json:"disableResolveMessage,omitempty"`
...
func (r *GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_grafana_integreatly_org_grafana_contact_point_v1beta1_manifest"
}

func (r *GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GrafanaContactPoint is the Schema for the grafanacontactpoints API",
		MarkdownDescription: "GrafanaContactPoint is the Schema for the grafanacontactpoints API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GrafanaContactPointSpec defines the desired state of GrafanaContactPoint",
				Attributes: map[string]schema.Attribute{
					...
					"disable_resolve_message": schema.BoolAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"uid": schema.StringAttribute{
						...
						MarkdownDescription: "Manually specify the UID the Contact Point is created with. Can be any string consisting of alphanumeric characters, - and _ with a maximum length of 40",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_grafana_integreatly_org_grafana_contact_point_v1beta1_manifest")

	var model GrafanaIntegreatlyOrgGrafanaContactPointV1Beta1ManifestData
	...
	model.Kind = pointer.String("GrafanaContactPoint")
