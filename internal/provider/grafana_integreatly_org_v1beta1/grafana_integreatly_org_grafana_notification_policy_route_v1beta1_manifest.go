...
var (
	_ datasource.DataSource = &GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest{}
)

func NewGrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest() datasource.DataSource {
	return &GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest{}
}

type GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest struct{}

type GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1ManifestData struct {
...
func (r *GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_grafana_integreatly_org_grafana_notification_policy_route_v1beta1_manifest"
}

func (r *GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GrafanaNotificationPolicyRoute is the Schema for the grafananotificationpolicyroutes API",
		MarkdownDescription: "GrafanaNotificationPolicyRoute is the Schema for the grafananotificationpolicyroutes API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GrafanaNotificationPolicyRouteSpec defines the desired state of GrafanaNotificationPolicyRoute",
				Attributes: map[string]schema.Attribute{
...
func (r *GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_grafana_integreatly_org_grafana_notification_policy_route_v1beta1_manifest")

	var model GrafanaIntegreatlyOrgGrafanaNotificationPolicyRouteV1Beta1ManifestData
	...
	model.Kind = pointer.String("GrafanaNotificationPolicyRoute")
