...
var (
	_ datasource.DataSource = &GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest{}
)

func NewGrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest() datasource.DataSource {
	return &GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest{}
}

type GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest struct{}

type GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1ManifestData struct {
...
func (r *GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_grafana_integreatly_org_grafana_library_panel_v1beta1_manifest"
}

func (r *GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GrafanaLibraryPanel is the Schema for the grafanalibrarypanels API",
		MarkdownDescription: "GrafanaLibraryPanel is the Schema for the grafanalibrarypanels API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GrafanaLibraryPanelSpec defines the desired state of GrafanaLibraryPanel",
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"version": schema.StringAttribute{
									...
									Computed:            false,
									Validators: []validator.String{
										stringvalidator.RegexMatches(regexp.MustCompile(`^((0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?|latest)$`), ""),
									},
								},
							},
						},
...
func (r *GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_grafana_integreatly_org_grafana_library_panel_v1beta1_manifest")

	var model GrafanaIntegreatlyOrgGrafanaLibraryPanelV1Beta1ManifestData
	...
	model.Kind = pointer.String("GrafanaLibraryPanel")
