...
package kom_kaiso_github_io_v1alpha1
...
var (
	_ datasource.DataSource = &KomKaisoGithubIoMicroserviceV1Alpha1Manifest{}
)

func NewKomKaisoGithubIoMicroserviceV1Alpha1Manifest() datasource.DataSource {
	return &KomKaisoGithubIoMicroserviceV1Alpha1Manifest{}
}

type KomKaisoGithubIoMicroserviceV1Alpha1Manifest struct{}

type KomKaisoGithubIoMicroserviceV1Alpha1ManifestData struct {
	...
	Spec *struct {
		Autoscaling *struct {
			...
			} `tfsdk:"scaler" json:"scaler,omitempty"`
		...
		Container *struct {
			...
			} `tfsdk:"routing" json:"routing,omitempty"`
			VolumeMounts *[]struct {
...
func (r *KomKaisoGithubIoMicroserviceV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kom_kaiso_github_io_microservice_v1alpha1_manifest"
}

func (r *KomKaisoGithubIoMicroserviceV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Microservice is the Schema for the microservices API",
		MarkdownDescription: "Microservice is the Schema for the microservices API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "MicroserviceSpec defines the desired state of Microservice",
				Attributes: map[string]schema.Attribute{
					"autoscaling": schema.SingleNestedAttribute{
						Description:         "MicroservicesAutoscaling defines the autoscaling strategy configuration",
						MarkdownDescription: "MicroservicesAutoscaling defines the autoscaling strategy configuration",
						Attributes: map[string]schema.Attribute{
							...
							"scaler": schema.ListNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"resource": schema.StringAttribute{
											Description:         "Resource defines the resouce targeted by a Scaler",
											MarkdownDescription: "Resource defines the resouce targeted by a Scaler",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"type": schema.StringAttribute{
											Description:         "ScalerType represents whether the metric type is Utilization, Value, or AverageValue",
											MarkdownDescription: "ScalerType represents whether the metric type is Utilization, Value, or AverageValue",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
					...
					"container": schema.SingleNestedAttribute{
						Description:         "Container the container that will run the microservice",
						MarkdownDescription: "Container the container that will run the microservice",
						Attributes: map[string]schema.Attribute{
							...
							"routing": schema.SingleNestedAttribute{
								Description:         "Routing define router rules",
								MarkdownDescription: "Routing define router rules",
								Attributes: map[string]schema.Attribute{
										...
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"port": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "ContainerPort represents a network port in a single container.",
													Attributes: map[string]schema.Attribute{
...
func (r *KomKaisoGithubIoMicroserviceV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kom_kaiso_github_io_microservice_v1alpha1_manifest")

	var model KomKaisoGithubIoMicroserviceV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("kom.kaiso.github.io/v1alpha1")
	model.Kind = pointer.String("Microservice")
