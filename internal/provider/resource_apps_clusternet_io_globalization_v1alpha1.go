...
var (
	_ resource.Resource = (*AppsClusternetIoGlobalizationV1Alpha1Resource)(nil)
)

type AppsClusternetIoGlobalizationV1Alpha1TerraformModel struct {
...
type AppsClusternetIoGlobalizationV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"feed" yaml:"feed,omitempty"`

		OverridePolicy *string `tfsdk:"override_policy" yaml:"overridePolicy,omitempty"`

		Overrides *[]struct {
			Name *string `tfsdk:"name" yaml:"name,omitempty"`

			OverrideChart *bool `tfsdk:"override_chart" yaml:"overrideChart,omitempty"`
...
func (r *AppsClusternetIoGlobalizationV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_apps_clusternet_io_globalization_v1alpha1"
}

func (r *AppsClusternetIoGlobalizationV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AppsClusternetIoGlobalizationV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_apps_clusternet_io_globalization_v1alpha1")

	var state AppsClusternetIoGlobalizationV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AppsClusternetIoGlobalizationV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("Globalization")
...
func (r *AppsClusternetIoGlobalizationV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_clusternet_io_globalization_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *AppsClusternetIoGlobalizationV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AppsClusternetIoGlobalizationV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
