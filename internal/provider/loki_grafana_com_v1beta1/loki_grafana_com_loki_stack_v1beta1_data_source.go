...
var (
	_ datasource.DataSource              = &LokiGrafanaComLokiStackV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LokiGrafanaComLokiStackV1Beta1DataSource{}
)

func NewLokiGrafanaComLokiStackV1Beta1DataSource() datasource.DataSource {
	return &LokiGrafanaComLokiStackV1Beta1DataSource{}
}

type LokiGrafanaComLokiStackV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LokiGrafanaComLokiStackV1Beta1DataSourceData struct {
...
func (r *LokiGrafanaComLokiStackV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_loki_stack_v1beta1"
}

func (r *LokiGrafanaComLokiStackV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComLokiStackV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LokiGrafanaComLokiStackV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_loki_grafana_com_loki_stack_v1beta1")

	var data LokiGrafanaComLokiStackV1Beta1DataSourceData
	...
	var readResponse LokiGrafanaComLokiStackV1Beta1DataSourceData
