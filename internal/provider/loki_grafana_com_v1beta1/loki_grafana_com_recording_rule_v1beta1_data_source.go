...
var (
	_ datasource.DataSource              = &LokiGrafanaComRecordingRuleV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LokiGrafanaComRecordingRuleV1Beta1DataSource{}
)

func NewLokiGrafanaComRecordingRuleV1Beta1DataSource() datasource.DataSource {
	return &LokiGrafanaComRecordingRuleV1Beta1DataSource{}
}

type LokiGrafanaComRecordingRuleV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LokiGrafanaComRecordingRuleV1Beta1DataSourceData struct {
...
func (r *LokiGrafanaComRecordingRuleV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_recording_rule_v1beta1"
}

func (r *LokiGrafanaComRecordingRuleV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComRecordingRuleV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LokiGrafanaComRecordingRuleV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_loki_grafana_com_recording_rule_v1beta1")

	var data LokiGrafanaComRecordingRuleV1Beta1DataSourceData
	...
	var readResponse LokiGrafanaComRecordingRuleV1Beta1DataSourceData
