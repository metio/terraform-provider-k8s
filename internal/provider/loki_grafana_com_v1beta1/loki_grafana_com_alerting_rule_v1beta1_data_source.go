...
var (
	_ datasource.DataSource              = &LokiGrafanaComAlertingRuleV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LokiGrafanaComAlertingRuleV1Beta1DataSource{}
)

func NewLokiGrafanaComAlertingRuleV1Beta1DataSource() datasource.DataSource {
	return &LokiGrafanaComAlertingRuleV1Beta1DataSource{}
}

type LokiGrafanaComAlertingRuleV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LokiGrafanaComAlertingRuleV1Beta1DataSourceData struct {
...
func (r *LokiGrafanaComAlertingRuleV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_loki_grafana_com_alerting_rule_v1beta1"
}

func (r *LokiGrafanaComAlertingRuleV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LokiGrafanaComAlertingRuleV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LokiGrafanaComAlertingRuleV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_loki_grafana_com_alerting_rule_v1beta1")

	var data LokiGrafanaComAlertingRuleV1Beta1DataSourceData
	...
	var readResponse LokiGrafanaComAlertingRuleV1Beta1DataSourceData
