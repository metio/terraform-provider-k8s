...
var (
	_ datasource.DataSource              = &TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource{}
)

func NewTemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource() datasource.DataSource {
	return &TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource{}
}

type TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSourceData struct {
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_templates_gatekeeper_sh_constraint_template_v1alpha1"
}

func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_templates_gatekeeper_sh_constraint_template_v1alpha1")

	var data TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSourceData
	...
	var readResponse TemplatesGatekeeperShConstraintTemplateV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("templates.gatekeeper.sh/v1alpha1")
