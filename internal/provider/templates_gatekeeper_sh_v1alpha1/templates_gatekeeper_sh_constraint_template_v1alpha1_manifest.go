...
var (
	_ datasource.DataSource = &TemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest{}
)

func NewTemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest() datasource.DataSource {
	return &TemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest{}
}

type TemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest struct{}

type TemplatesGatekeeperShConstraintTemplateV1Alpha1ManifestData struct {
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_templates_gatekeeper_sh_constraint_template_v1alpha1_manifest"
}

func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TemplatesGatekeeperShConstraintTemplateV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_templates_gatekeeper_sh_constraint_template_v1alpha1_manifest")

	var model TemplatesGatekeeperShConstraintTemplateV1Alpha1ManifestData
