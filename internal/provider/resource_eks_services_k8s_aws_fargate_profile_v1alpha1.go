...
var (
	_ resource.Resource = (*EksServicesK8SAwsFargateProfileV1Alpha1Resource)(nil)
)

type EksServicesK8SAwsFargateProfileV1Alpha1TerraformModel struct {
...
type EksServicesK8SAwsFargateProfileV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		PodExecutionRoleARN *string `tfsdk:"pod_execution_role_arn" yaml:"podExecutionRoleARN,omitempty"`

		PodExecutionRoleRef *struct {
			From *struct {
				Name *string `tfsdk:"name" yaml:"name,omitempty"`
			} `tfsdk:"from" yaml:"from,omitempty"`
		} `tfsdk:"pod_execution_role_ref" yaml:"podExecutionRoleRef,omitempty"`
...
func (r *EksServicesK8SAwsFargateProfileV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_eks_services_k8s_aws_fargate_profile_v1alpha1"
}

func (r *EksServicesK8SAwsFargateProfileV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *EksServicesK8SAwsFargateProfileV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_eks_services_k8s_aws_fargate_profile_v1alpha1")

	var state EksServicesK8SAwsFargateProfileV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel EksServicesK8SAwsFargateProfileV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("FargateProfile")
...
func (r *EksServicesK8SAwsFargateProfileV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_eks_services_k8s_aws_fargate_profile_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *EksServicesK8SAwsFargateProfileV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *EksServicesK8SAwsFargateProfileV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
