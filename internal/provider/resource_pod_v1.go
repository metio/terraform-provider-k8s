...
type PodV1Resource struct{}

var (
	_ resource.Resource = (*PodV1Resource)(nil)
)

type PodV1TerraformModel struct {
...
func NewPodV1Resource() resource.Resource {
	return &PodV1Resource{}
}

func (r *PodV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_pod_v1"
}

func (r *PodV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *PodV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_pod_v1")

	var state PodV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel PodV1GoModel
	...
	goModel.Kind = utilities.Ptr("Pod")
...
func (r *PodV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_pod_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *PodV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_pod_v1")
...
func (r *PodV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_pod_v1")
