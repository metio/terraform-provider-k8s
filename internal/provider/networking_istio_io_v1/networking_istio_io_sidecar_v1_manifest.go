...
var (
	_ datasource.DataSource = &NetworkingIstioIoSidecarV1Manifest{}
)

func NewNetworkingIstioIoSidecarV1Manifest() datasource.DataSource {
	return &NetworkingIstioIoSidecarV1Manifest{}
}

type NetworkingIstioIoSidecarV1Manifest struct{}

type NetworkingIstioIoSidecarV1ManifestData struct {
...
func (r *NetworkingIstioIoSidecarV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_sidecar_v1_manifest"
}

func (r *NetworkingIstioIoSidecarV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoSidecarV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_sidecar_v1_manifest")

	var model NetworkingIstioIoSidecarV1ManifestData
