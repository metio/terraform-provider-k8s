...
var (
	_ datasource.DataSource = &NetworkingIstioIoVirtualServiceV1Manifest{}
)

func NewNetworkingIstioIoVirtualServiceV1Manifest() datasource.DataSource {
	return &NetworkingIstioIoVirtualServiceV1Manifest{}
}

type NetworkingIstioIoVirtualServiceV1Manifest struct{}

type NetworkingIstioIoVirtualServiceV1ManifestData struct {
...
func (r *NetworkingIstioIoVirtualServiceV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_virtual_service_v1_manifest"
}

func (r *NetworkingIstioIoVirtualServiceV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoVirtualServiceV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_virtual_service_v1_manifest")

	var model NetworkingIstioIoVirtualServiceV1ManifestData
