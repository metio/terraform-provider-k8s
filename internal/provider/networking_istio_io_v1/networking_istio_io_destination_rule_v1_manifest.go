...
var (
	_ datasource.DataSource = &NetworkingIstioIoDestinationRuleV1Manifest{}
)

func NewNetworkingIstioIoDestinationRuleV1Manifest() datasource.DataSource {
	return &NetworkingIstioIoDestinationRuleV1Manifest{}
}

type NetworkingIstioIoDestinationRuleV1Manifest struct{}

type NetworkingIstioIoDestinationRuleV1ManifestData struct {
...
func (r *NetworkingIstioIoDestinationRuleV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_destination_rule_v1_manifest"
}

func (r *NetworkingIstioIoDestinationRuleV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoDestinationRuleV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_destination_rule_v1_manifest")

	var model NetworkingIstioIoDestinationRuleV1ManifestData
