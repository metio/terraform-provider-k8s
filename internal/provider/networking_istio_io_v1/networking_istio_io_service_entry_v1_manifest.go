...
var (
	_ datasource.DataSource = &NetworkingIstioIoServiceEntryV1Manifest{}
)

func NewNetworkingIstioIoServiceEntryV1Manifest() datasource.DataSource {
	return &NetworkingIstioIoServiceEntryV1Manifest{}
}

type NetworkingIstioIoServiceEntryV1Manifest struct{}

type NetworkingIstioIoServiceEntryV1ManifestData struct {
...
func (r *NetworkingIstioIoServiceEntryV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_service_entry_v1_manifest"
}

func (r *NetworkingIstioIoServiceEntryV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoServiceEntryV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_service_entry_v1_manifest")

	var model NetworkingIstioIoServiceEntryV1ManifestData
