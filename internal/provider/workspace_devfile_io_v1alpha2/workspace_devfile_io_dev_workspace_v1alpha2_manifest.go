...
var (
	_ datasource.DataSource = &WorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest{}
)

func NewWorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest() datasource.DataSource {
	return &WorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest{}
}

type WorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest struct{}

type WorkspaceDevfileIoDevWorkspaceV1Alpha2ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"contributions" json:"contributions,omitempty"`
...
func (r *WorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_workspace_devfile_io_dev_workspace_v1alpha2_manifest"
}

func (r *WorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"contributions": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
...
func (r *WorkspaceDevfileIoDevWorkspaceV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_workspace_devfile_io_dev_workspace_v1alpha2_manifest")

	var model WorkspaceDevfileIoDevWorkspaceV1Alpha2ManifestData
