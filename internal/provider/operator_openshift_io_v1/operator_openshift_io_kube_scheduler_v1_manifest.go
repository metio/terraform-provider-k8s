...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoKubeSchedulerV1Manifest{}
)

func NewOperatorOpenshiftIoKubeSchedulerV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoKubeSchedulerV1Manifest{}
}
...
func (r *OperatorOpenshiftIoKubeSchedulerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_kube_scheduler_v1_manifest"
}

func (r *OperatorOpenshiftIoKubeSchedulerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "KubeScheduler provides information to configure an operator to manage scheduler.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "spec is the specification of the desired behavior of the Kubernetes Scheduler",
				Attributes: map[string]schema.Attribute{
...
func (r *OperatorOpenshiftIoKubeSchedulerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_kube_scheduler_v1_manifest")

	var model OperatorOpenshiftIoKubeSchedulerV1ManifestData
	...
	model.Kind = pointer.String("KubeScheduler")
