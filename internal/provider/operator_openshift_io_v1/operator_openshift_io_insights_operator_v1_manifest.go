...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoInsightsOperatorV1Manifest{}
)

func NewOperatorOpenshiftIoInsightsOperatorV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoInsightsOperatorV1Manifest{}
}
...
func (r *OperatorOpenshiftIoInsightsOperatorV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_insights_operator_v1_manifest"
}

func (r *OperatorOpenshiftIoInsightsOperatorV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "InsightsOperator holds cluster-wide information about the Insights Operator.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "spec is the specification of the desired behavior of the Insights.",
				Attributes: map[string]schema.Attribute{
...
func (r *OperatorOpenshiftIoInsightsOperatorV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_insights_operator_v1_manifest")

	var model OperatorOpenshiftIoInsightsOperatorV1ManifestData
	...
	model.Kind = pointer.String("InsightsOperator")
