...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoKubeStorageVersionMigratorV1Manifest{}
)

func NewOperatorOpenshiftIoKubeStorageVersionMigratorV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoKubeStorageVersionMigratorV1Manifest{}
}
...
func (r *OperatorOpenshiftIoKubeStorageVersionMigratorV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_kube_storage_version_migrator_v1_manifest"
}

func (r *OperatorOpenshiftIoKubeStorageVersionMigratorV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "KubeStorageVersionMigrator provides information to configure an operator to manage kube-storage-version-migrator.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
...
func (r *OperatorOpenshiftIoKubeStorageVersionMigratorV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_kube_storage_version_migrator_v1_manifest")

	var model OperatorOpenshiftIoKubeStorageVersionMigratorV1ManifestData
	...
	model.Kind = pointer.String("KubeStorageVersionMigrator")
