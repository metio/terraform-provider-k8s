...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoOpenShiftControllerManagerV1Manifest{}
)

func NewOperatorOpenshiftIoOpenShiftControllerManagerV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoOpenShiftControllerManagerV1Manifest{}
}
...
func (r *OperatorOpenshiftIoOpenShiftControllerManagerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_open_shift_controller_manager_v1_manifest"
}

func (r *OperatorOpenshiftIoOpenShiftControllerManagerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "OpenShiftControllerManager provides information to configure an operator to manage openshift-controller-manager.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
...
func (r *OperatorOpenshiftIoOpenShiftControllerManagerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_open_shift_controller_manager_v1_manifest")

	var model OperatorOpenshiftIoOpenShiftControllerManagerV1ManifestData
	...
	model.Kind = pointer.String("OpenShiftControllerManager")
