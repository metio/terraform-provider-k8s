...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoOpenShiftApiserverV1Manifest{}
)

func NewOperatorOpenshiftIoOpenShiftApiserverV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoOpenShiftApiserverV1Manifest{}
}
...
func (r *OperatorOpenshiftIoOpenShiftApiserverV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_open_shift_api_server_v1_manifest"
}

func (r *OperatorOpenshiftIoOpenShiftApiserverV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "OpenShiftAPIServer provides information to configure an operator to manage openshift-apiserver.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "spec is the specification of the desired behavior of the OpenShift API Server.",
				Attributes: map[string]schema.Attribute{
...
func (r *OperatorOpenshiftIoOpenShiftApiserverV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_open_shift_api_server_v1_manifest")

	var model OperatorOpenshiftIoOpenShiftApiserverV1ManifestData
	...
	model.Kind = pointer.String("OpenShiftAPIServer")
