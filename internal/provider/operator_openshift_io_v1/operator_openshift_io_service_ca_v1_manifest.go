...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoServiceCaV1Manifest{}
)

func NewOperatorOpenshiftIoServiceCaV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoServiceCaV1Manifest{}
}
...
func (r *OperatorOpenshiftIoServiceCaV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_service_ca_v1_manifest"
}

func (r *OperatorOpenshiftIoServiceCaV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "ServiceCA provides information to configure an operator to manage the service cert controllers  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
...
func (r *OperatorOpenshiftIoServiceCaV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_service_ca_v1_manifest")

	var model OperatorOpenshiftIoServiceCaV1ManifestData
	...
	model.Kind = pointer.String("ServiceCA")
