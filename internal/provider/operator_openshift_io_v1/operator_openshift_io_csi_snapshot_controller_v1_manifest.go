...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoCsisnapshotControllerV1Manifest{}
)

func NewOperatorOpenshiftIoCsisnapshotControllerV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoCsisnapshotControllerV1Manifest{}
}
...
func (r *OperatorOpenshiftIoCsisnapshotControllerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_csi_snapshot_controller_v1_manifest"
}

func (r *OperatorOpenshiftIoCsisnapshotControllerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "CSISnapshotController provides a means to configure an operator to manage the CSI snapshots. 'cluster' is the canonical name.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
...
func (r *OperatorOpenshiftIoCsisnapshotControllerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_csi_snapshot_controller_v1_manifest")

	var model OperatorOpenshiftIoCsisnapshotControllerV1ManifestData
	...
	model.Kind = pointer.String("CSISnapshotController")
