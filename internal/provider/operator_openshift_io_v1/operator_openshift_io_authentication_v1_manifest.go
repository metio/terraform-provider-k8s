...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoAuthenticationV1Manifest{}
)

func NewOperatorOpenshiftIoAuthenticationV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoAuthenticationV1Manifest{}
}
...
func (r *OperatorOpenshiftIoAuthenticationV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_authentication_v1_manifest"
}

func (r *OperatorOpenshiftIoAuthenticationV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Authentication provides information to configure an operator to manage authentication.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
...
func (r *OperatorOpenshiftIoAuthenticationV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_authentication_v1_manifest")

	var model OperatorOpenshiftIoAuthenticationV1ManifestData
