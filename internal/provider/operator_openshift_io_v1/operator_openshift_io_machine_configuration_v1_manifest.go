...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoMachineConfigurationV1Manifest{}
)

func NewOperatorOpenshiftIoMachineConfigurationV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoMachineConfigurationV1Manifest{}
}
...
func (r *OperatorOpenshiftIoMachineConfigurationV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_machine_configuration_v1_manifest"
}

func (r *OperatorOpenshiftIoMachineConfigurationV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "spec is the specification of the desired behavior of the Machine Config Operator",
				Attributes: map[string]schema.Attribute{
...
func (r *OperatorOpenshiftIoMachineConfigurationV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_machine_configuration_v1_manifest")

	var model OperatorOpenshiftIoMachineConfigurationV1ManifestData
