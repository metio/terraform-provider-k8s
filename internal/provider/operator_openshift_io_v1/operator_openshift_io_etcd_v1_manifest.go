...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoEtcdV1Manifest{}
)

func NewOperatorOpenshiftIoEtcdV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoEtcdV1Manifest{}
}
...
func (r *OperatorOpenshiftIoEtcdV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_etcd_v1_manifest"
}

func (r *OperatorOpenshiftIoEtcdV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "Etcd provides information to configure an operator to manage etcd.  Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases (whichever is longer).",
...
func (r *OperatorOpenshiftIoEtcdV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_etcd_v1_manifest")

	var model OperatorOpenshiftIoEtcdV1ManifestData
	...
	model.Kind = pointer.String("Etcd")
