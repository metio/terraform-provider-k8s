...
var (
	_ datasource.DataSource = &OperatorOpenshiftIoStorageV1Manifest{}
)

func NewOperatorOpenshiftIoStorageV1Manifest() datasource.DataSource {
	return &OperatorOpenshiftIoStorageV1Manifest{}
}
...
func (r *OperatorOpenshiftIoStorageV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_openshift_io_storage_v1_manifest"
}

func (r *OperatorOpenshiftIoStorageV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"vsphere_storage_driver": schema.StringAttribute{
						...
						MarkdownDescription: "VSphereStorageDriver indicates the storage driver to use on VSphere clusters. Once this field is set to CSIWithMigrationDriver, it can not be changed. If this is empty, the platform will choose a good default, which may change over time without notice. The current default is CSIWithMigrationDriver and may not be changed. DEPRECATED: This field will be removed in a future release.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("", "LegacyDeprecatedInTreeDriver", "CSIWithMigrationDriver"),
						},
					},
				},
				Required: true,
...
func (r *OperatorOpenshiftIoStorageV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_openshift_io_storage_v1_manifest")

	var model OperatorOpenshiftIoStorageV1ManifestData
