...
var (
	_ datasource.DataSource = &ActionsGithubComEphemeralRunnerV1Alpha1Manifest{}
)

func NewActionsGithubComEphemeralRunnerV1Alpha1Manifest() datasource.DataSource {
	return &ActionsGithubComEphemeralRunnerV1Alpha1Manifest{}
}

type ActionsGithubComEphemeralRunnerV1Alpha1Manifest struct{}

type ActionsGithubComEphemeralRunnerV1Alpha1ManifestData struct {
...
func (r *ActionsGithubComEphemeralRunnerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_github_com_ephemeral_runner_v1alpha1_manifest"
}

func (r *ActionsGithubComEphemeralRunnerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "EphemeralRunner is the Schema for the ephemeralrunners API",
		MarkdownDescription: "EphemeralRunner is the Schema for the ephemeralrunners API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "EphemeralRunnerSpec defines the desired state of EphemeralRunner",
				Attributes: map[string]schema.Attribute{
...
func (r *ActionsGithubComEphemeralRunnerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_github_com_ephemeral_runner_v1alpha1_manifest")

	var model ActionsGithubComEphemeralRunnerV1Alpha1ManifestData
	...
	model.Kind = pointer.String("EphemeralRunner")
