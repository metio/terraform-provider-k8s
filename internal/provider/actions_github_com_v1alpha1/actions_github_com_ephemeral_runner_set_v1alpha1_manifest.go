...
var (
	_ datasource.DataSource = &ActionsGithubComEphemeralRunnerSetV1Alpha1Manifest{}
)

func NewActionsGithubComEphemeralRunnerSetV1Alpha1Manifest() datasource.DataSource {
	return &ActionsGithubComEphemeralRunnerSetV1Alpha1Manifest{}
}
...
type ActionsGithubComEphemeralRunnerSetV1Alpha1ManifestData struct {
	...
	Spec *struct {
		EphemeralRunnerSpec *struct {
			...
			ProxySecretRef   *string `tfsdk:"proxy_secret_ref" json:"proxySecretRef,omitempty"`
		...
		} `tfsdk:"ephemeral_runner_spec" json:"ephemeralRunnerSpec,omitempty"`
		PatchID  *int64 `tfsdk:"patch_id" json:"patchID,omitempty"`
		Replicas *int64 `tfsdk:"replicas" json:"replicas,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *ActionsGithubComEphemeralRunnerSetV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_github_com_ephemeral_runner_set_v1alpha1_manifest"
}

func (r *ActionsGithubComEphemeralRunnerSetV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "EphemeralRunnerSetSpec defines the desired state of EphemeralRunnerSet",
				Attributes: map[string]schema.Attribute{
					"ephemeral_runner_spec": schema.SingleNestedAttribute{
						Description:         "EphemeralRunnerSpec is the spec of the ephemeral runner",
						MarkdownDescription: "EphemeralRunnerSpec is the spec of the ephemeral runner",
						Attributes: map[string]schema.Attribute{
							...
							"proxy_secret_ref": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
					...
					"patch_id": schema.Int64Attribute{
						Description:         "PatchID is the unique identifier for the patch issued by the listener app",
						MarkdownDescription: "PatchID is the unique identifier for the patch issued by the listener app",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"replicas": schema.Int64Attribute{
						...
						MarkdownDescription: "Replicas is the number of desired EphemeralRunner resources in the k8s namespace.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ActionsGithubComEphemeralRunnerSetV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_github_com_ephemeral_runner_set_v1alpha1_manifest")

	var model ActionsGithubComEphemeralRunnerSetV1Alpha1ManifestData
