...
var (
	_ datasource.DataSource = &ActionsGithubComAutoscalingListenerV1Alpha1Manifest{}
)

func NewActionsGithubComAutoscalingListenerV1Alpha1Manifest() datasource.DataSource {
	return &ActionsGithubComAutoscalingListenerV1Alpha1Manifest{}
}

type ActionsGithubComAutoscalingListenerV1Alpha1Manifest struct{}

type ActionsGithubComAutoscalingListenerV1Alpha1ManifestData struct {
	...
	Spec *struct {
		AutoscalingRunnerSetName      *string `tfsdk:"autoscaling_runner_set_name" json:"autoscalingRunnerSetName,omitempty"`
		AutoscalingRunnerSetNamespace *string `tfsdk:"autoscaling_runner_set_namespace" json:"autoscalingRunnerSetNamespace,omitempty"`
		EphemeralRunnerSetName        *string `tfsdk:"ephemeral_runner_set_name" json:"ephemeralRunnerSetName,omitempty"`
		GithubConfigSecret            *string `tfsdk:"github_config_secret" json:"githubConfigSecret,omitempty"`
		GithubConfigUrl               *string `tfsdk:"github_config_url" json:"githubConfigUrl,omitempty"`
		GithubServerTLS               *struct {
			CertificateFrom *struct {
				ConfigMapKeyRef *struct {
					Key      *string `tfsdk:"key" json:"key,omitempty"`
					Name     *string `tfsdk:"name" json:"name,omitempty"`
					Optional *bool   `tfsdk:"optional" json:"optional,omitempty"`
				} `tfsdk:"config_map_key_ref" json:"configMapKeyRef,omitempty"`
			} `tfsdk:"certificate_from" json:"certificateFrom,omitempty"`
		} `tfsdk:"github_server_tls" json:"githubServerTLS,omitempty"`
		Image            *string `tfsdk:"image" json:"image,omitempty"`
		ImagePullSecrets *[]struct {
			Name *string `tfsdk:"name" json:"name,omitempty"`
		} `tfsdk:"image_pull_secrets" json:"imagePullSecrets,omitempty"`
		MaxRunners *int64 `tfsdk:"max_runners" json:"maxRunners,omitempty"`
		Metrics    *struct {
			Counters *struct {
			...
			Gauges *struct {
				Labels *[]string `tfsdk:"labels" json:"labels,omitempty"`
			} `tfsdk:"gauges" json:"gauges,omitempty"`
			Histograms *struct {
				Buckets *[]string `tfsdk:"buckets" json:"buckets,omitempty"`
				Labels  *[]string `tfsdk:"labels" json:"labels,omitempty"`
			} `tfsdk:"histograms" json:"histograms,omitempty"`
		} `tfsdk:"metrics" json:"metrics,omitempty"`
		MinRunners *int64 `tfsdk:"min_runners" json:"minRunners,omitempty"`
		Proxy      *struct {
			Http *struct {
				CredentialSecretRef *string `tfsdk:"credential_secret_ref" json:"credentialSecretRef,omitempty"`
		...
		RunnerScaleSetId *int64 `tfsdk:"runner_scale_set_id" json:"runnerScaleSetId,omitempty"`
		Template         *struct {
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
		...
		VaultConfig *struct {
			...
			Type *string `tfsdk:"type" json:"type,omitempty"`
		} `tfsdk:"vault_config" json:"vaultConfig,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *ActionsGithubComAutoscalingListenerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_github_com_autoscaling_listener_v1alpha1_manifest"
}

func (r *ActionsGithubComAutoscalingListenerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AutoscalingListener is the Schema for the autoscalinglisteners API",
		MarkdownDescription: "AutoscalingListener is the Schema for the autoscalinglisteners API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "AutoscalingListenerSpec defines the desired state of AutoscalingListener",
				Attributes: map[string]schema.Attribute{
					"autoscaling_runner_set_name": schema.StringAttribute{
					...
					"autoscaling_runner_set_namespace": schema.StringAttribute{
						Description:         "Required",
						MarkdownDescription: "Required",
						Required:            false,
						Optional:            true,
					...
					"ephemeral_runner_set_name": schema.StringAttribute{
						Description:         "Required",
						MarkdownDescription: "Required",
						Required:            false,
						Optional:            true,
					...
					"github_config_secret": schema.StringAttribute{
						Description:         "Required",
						MarkdownDescription: "Required",
						Required:            false,
						Optional:            true,
					...
					"github_server_tls": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"certificate_from": schema.SingleNestedAttribute{
								Description:         "Required",
								MarkdownDescription: "Required",
								Attributes: map[string]schema.Attribute{
					...
					"metrics": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "MetricsConfig holds configuration parameters for each metric type",
						Attributes: map[string]schema.Attribute{
							...
							"gauges": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									"labels": schema.ListAttribute{
							...
							"histograms": schema.SingleNestedAttribute{
								Description:         "",
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
					...
					"proxy": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"http": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "",
								Attributes: map[string]schema.Attribute{
									"credential_secret_ref": schema.StringAttribute{
										Description:         "",
										MarkdownDescription: "",
										Required:            false,
										Optional:            true,
					...
					"runner_scale_set_id": schema.Int64Attribute{
						Description:         "Required",
						MarkdownDescription: "Required",
						Required:            false,
						Optional:            true,
					...
					"vault_config": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"type": schema.StringAttribute{
								Description:         "VaultType represents the type of vault that can be used in the application. It is used to identify which vault integration should be used to resolve secrets.",
								MarkdownDescription: "VaultType represents the type of vault that can be used in the application. It is used to identify which vault integration should be used to resolve secrets.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *ActionsGithubComAutoscalingListenerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_github_com_autoscaling_listener_v1alpha1_manifest")

	var model ActionsGithubComAutoscalingListenerV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AutoscalingListener")
