...
var (
	_ datasource.DataSource = &Marin3R3ScaleNetEnvoyConfigRevisionV1Alpha1Manifest{}
)

func NewMarin3R3ScaleNetEnvoyConfigRevisionV1Alpha1Manifest() datasource.DataSource {
	return &Marin3R3ScaleNetEnvoyConfigRevisionV1Alpha1Manifest{}
}
...
func (r *Marin3R3ScaleNetEnvoyConfigRevisionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_marin3r_3scale_net_envoy_config_revision_v1alpha1_manifest"
}

func (r *Marin3R3ScaleNetEnvoyConfigRevisionV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "EnvoyConfigRevision is an internal resource that stores a specific version of an EnvoyConfig resource. EnvoyConfigRevisions are automatically created and deleted by the EnvoyConfig controller and are not intended to be directly used. Use EnvoyConfig objects instead.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "EnvoyConfigRevisionSpec defines the desired state of EnvoyConfigRevision",
				Attributes: map[string]schema.Attribute{
					...
					"envoy_resources": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "EnvoyResources holds the different types of resources suported by the envoy discovery service",
						Attributes: map[string]schema.Attribute{
					...
					"serialization": schema.StringAttribute{
						...
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("json", "b64json", "yaml"),
						},
					},

					"version": schema.StringAttribute{
						Description:         "Version is a hash of the EnvoyResources field",
						MarkdownDescription: "Version is a hash of the EnvoyResources field",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *Marin3R3ScaleNetEnvoyConfigRevisionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_marin3r_3scale_net_envoy_config_revision_v1alpha1_manifest")

	var model Marin3R3ScaleNetEnvoyConfigRevisionV1Alpha1ManifestData
	...
	model.Kind = pointer.String("EnvoyConfigRevision")
