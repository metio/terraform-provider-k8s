...
type RcAppStacksRuntimeComponentV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		Service *struct {
			...
			SessionAffinity *map[string]string `tfsdk:"session_affinity" json:"sessionAffinity,omitempty"`
				...
				Attributes: map[string]schema.Attribute{
					...
					"service": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"session_affinity": schema.MapAttribute{
								Description:         "Configure service session affinity.",
								MarkdownDescription: "Configure service session affinity.",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
