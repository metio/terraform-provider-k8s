...
var (
	_ datasource.DataSource = &Pgv2PerconaComPerconaPgrestoreV2Manifest{}
)

func NewPgv2PerconaComPerconaPgrestoreV2Manifest() datasource.DataSource {
	return &Pgv2PerconaComPerconaPgrestoreV2Manifest{}
}

type Pgv2PerconaComPerconaPgrestoreV2Manifest struct{}

type Pgv2PerconaComPerconaPgrestoreV2ManifestData struct {
...
func (r *Pgv2PerconaComPerconaPgrestoreV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_pgv2_percona_com_percona_pg_restore_v2_manifest"
}

func (r *Pgv2PerconaComPerconaPgrestoreV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "PerconaPGRestore is the CRD that defines a Percona PostgreSQL Restore",
		MarkdownDescription: "PerconaPGRestore is the CRD that defines a Percona PostgreSQL Restore",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"pg_cluster": schema.StringAttribute{
						...
						MarkdownDescription: "The name of the PerconaPGCluster to perform restore.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *Pgv2PerconaComPerconaPgrestoreV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_pgv2_percona_com_percona_pg_restore_v2_manifest")

	var model Pgv2PerconaComPerconaPgrestoreV2ManifestData
	...
	model.Kind = pointer.String("PerconaPGRestore")
