...
var (
	_ datasource.DataSource = &AddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest{}
)

func NewAddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest{}
}

type AddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest struct{}

type AddonsClusterXK8SIoClusterResourceSetV1Beta2ManifestData struct {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_v1beta2_manifest"
}

func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_addons_cluster_x_k8s_io_cluster_resource_set_v1beta2_manifest")

	var model AddonsClusterXK8SIoClusterResourceSetV1Beta2ManifestData
