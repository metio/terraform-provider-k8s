...
package addons_cluster_x_k8s_io_v1beta2
...
var (
	_ datasource.DataSource = &AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest{}
)

func NewAddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest{}
}

type AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest struct{}

type AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2ManifestData struct {
...
func (r *AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_binding_v1beta2_manifest"
}

func (r *AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"cluster_name": schema.StringAttribute{
						...
						MarkdownDescription: "clusterName is the name of the Cluster this binding applies to.",
						Required:            true,
						Optional:            false,
						Computed:            false,
						Validators: []validator.String{
...
func (r *AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_addons_cluster_x_k8s_io_cluster_resource_set_binding_v1beta2_manifest")

	var model AddonsClusterXK8SIoClusterResourceSetBindingV1Beta2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("addons.cluster.x-k8s.io/v1beta2")
