...
var (
	_ resource.Resource = (*NotebookKubedlIoNotebookV1Alpha1Resource)(nil)
)

type NotebookKubedlIoNotebookV1Alpha1TerraformModel struct {
...
type NotebookKubedlIoNotebookV1Alpha1GoModel struct {
...
func (r *NotebookKubedlIoNotebookV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_notebook_kubedl_io_notebook_v1alpha1"
}

func (r *NotebookKubedlIoNotebookV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *NotebookKubedlIoNotebookV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_notebook_kubedl_io_notebook_v1alpha1")

	var state NotebookKubedlIoNotebookV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel NotebookKubedlIoNotebookV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("notebook.kubedl.io/v1alpha1")
	goModel.Kind = utilities.Ptr("Notebook")
...
func (r *NotebookKubedlIoNotebookV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_notebook_kubedl_io_notebook_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *NotebookKubedlIoNotebookV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *NotebookKubedlIoNotebookV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
