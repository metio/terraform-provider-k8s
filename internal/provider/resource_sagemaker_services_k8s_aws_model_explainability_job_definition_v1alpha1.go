...
var (
	_ resource.Resource = (*SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource)(nil)
)

type SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1TerraformModel struct {
...
type SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"model_explainability_app_specification" yaml:"modelExplainabilityAppSpecification,omitempty"`
		...
		} `tfsdk:"model_explainability_baseline_config" yaml:"modelExplainabilityBaselineConfig,omitempty"`
		...
		} `tfsdk:"model_explainability_job_input" yaml:"modelExplainabilityJobInput,omitempty"`
		...
		} `tfsdk:"model_explainability_job_output_config" yaml:"modelExplainabilityJobOutputConfig,omitempty"`
...
func (r *SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sagemaker_services_k8s_aws_model_explainability_job_definition_v1alpha1"
}

func (r *SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_sagemaker_services_k8s_aws_model_explainability_job_definition_v1alpha1")

	var state SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("ModelExplainabilityJobDefinition")
...
func (r *SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sagemaker_services_k8s_aws_model_explainability_job_definition_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *SagemakerServicesK8SAwsModelExplainabilityJobDefinitionV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
