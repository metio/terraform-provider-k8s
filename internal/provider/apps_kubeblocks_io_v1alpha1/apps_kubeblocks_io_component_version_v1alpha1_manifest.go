...
var (
	_ datasource.DataSource = &AppsKubeblocksIoComponentVersionV1Alpha1Manifest{}
)

func NewAppsKubeblocksIoComponentVersionV1Alpha1Manifest() datasource.DataSource {
	return &AppsKubeblocksIoComponentVersionV1Alpha1Manifest{}
}

type AppsKubeblocksIoComponentVersionV1Alpha1Manifest struct{}

type AppsKubeblocksIoComponentVersionV1Alpha1ManifestData struct {
...
func (r *AppsKubeblocksIoComponentVersionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_kubeblocks_io_component_version_v1alpha1_manifest"
}

func (r *AppsKubeblocksIoComponentVersionV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppsKubeblocksIoComponentVersionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_kubeblocks_io_component_version_v1alpha1_manifest")

	var model AppsKubeblocksIoComponentVersionV1Alpha1ManifestData
