...
var (
	_ datasource.DataSource = &AppsKubeblocksIoOpsDefinitionV1Alpha1Manifest{}
)

func NewAppsKubeblocksIoOpsDefinitionV1Alpha1Manifest() datasource.DataSource {
	return &AppsKubeblocksIoOpsDefinitionV1Alpha1Manifest{}
}

type AppsKubeblocksIoOpsDefinitionV1Alpha1Manifest struct{}

type AppsKubeblocksIoOpsDefinitionV1Alpha1ManifestData struct {
...
func (r *AppsKubeblocksIoOpsDefinitionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_kubeblocks_io_ops_definition_v1alpha1_manifest"
}
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"pod_info_extractors": schema.ListNestedAttribute{
						Description:         "Specifies a list of PodInfoExtractor, each designed to select a specific Pod and extract selected runtime infofrom its PodSpec.The extracted information, such as environment variables, volumes and tolerations, are then injected intoJobs or Pods that execute the OpsActions defined in 'actions'.",
						MarkdownDescription: "Specifies a list of PodInfoExtractor, each designed to select a specific Pod and extract selected runtime infofrom its PodSpec.The extracted information, such as environment variables, volumes and tolerations, are then injected intoJobs or Pods that execute the OpsActions defined in 'actions'.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"env": schema.ListNestedAttribute{
...
func (r *AppsKubeblocksIoOpsDefinitionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_kubeblocks_io_ops_definition_v1alpha1_manifest")

	var model AppsKubeblocksIoOpsDefinitionV1Alpha1ManifestData
