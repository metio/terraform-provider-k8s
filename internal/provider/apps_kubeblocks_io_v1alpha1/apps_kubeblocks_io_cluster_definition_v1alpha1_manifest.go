...
var (
	_ datasource.DataSource = &AppsKubeblocksIoClusterDefinitionV1Alpha1Manifest{}
)

func NewAppsKubeblocksIoClusterDefinitionV1Alpha1Manifest() datasource.DataSource {
	return &AppsKubeblocksIoClusterDefinitionV1Alpha1Manifest{}
}
...
func (r *AppsKubeblocksIoClusterDefinitionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_kubeblocks_io_cluster_definition_v1alpha1_manifest"
}
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"component_def_ref": schema.ListNestedAttribute{
									Description:         "Used to inject values from other components into the current component. Values will be saved and updated in a configmap and mounted to the current component.",
									MarkdownDescription: "Used to inject values from other components into the current component. Values will be saved and updated in a configmap and mounted to the current component.",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
								...
								"consensus_spec": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"ll_update_strategy": schema.SingleNestedAttribute{
											Description:         "Specifies the low-level StatefulSetUpdateStrategy to be used when updating Pods in the StatefulSet upon a revision to the Template. 'UpdateStrategy' will be ignored if this is provided.",
											MarkdownDescription: "Specifies the low-level StatefulSetUpdateStrategy to be used when updating Pods in the StatefulSet upon a revision to the Template. 'UpdateStrategy' will be ignored if this is provided.",
											Attributes: map[string]schema.Attribute{
								...
								"name": schema.StringAttribute{
									Description:         "This name could be used as default name of 'cluster.spec.componentSpecs.name', and needs to conform with same validation rules as 'cluster.spec.componentSpecs.name', currently complying with IANA Service Naming rule. This name will apply to cluster objects as the value of label 'apps.kubeblocks.io/component-name'.",
									MarkdownDescription: "This name could be used as default name of 'cluster.spec.componentSpecs.name', and needs to conform with same validation rules as 'cluster.spec.componentSpecs.name', currently complying with IANA Service Naming rule. This name will apply to cluster objects as the value of label 'apps.kubeblocks.io/component-name'.",
									Required:            true,
									Optional:            false,
									Computed:            false,
									Validators: []validator.String{
								...
								"post_start_spec": schema.SingleNestedAttribute{
									Description:         "Defines the command to be executed when the component is ready, and the command will only be executed once after the component becomes ready.",
									MarkdownDescription: "Defines the command to be executed when the component is ready, and the command will only be executed once after the component becomes ready.",
									Attributes: map[string]schema.Attribute{
										...
										"ports": schema.ListNestedAttribute{
											...
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													...
													"name": schema.StringAttribute{
														Description:         "The name of this port within the service. This must be a DNS_LABEL. All ports within a ServiceSpec must have unique names. When considering the endpoints for a Service, this must match the 'name' field in the EndpointPort.",
														MarkdownDescription: "The name of this port within the service. This must be a DNS_LABEL. All ports within a ServiceSpec must have unique names. When considering the endpoints for a Service, this must match the 'name' field in the EndpointPort.",
														Required:            false,
														Optional:            true,
														Computed:            false,
													},
								...
								"switchover_spec": schema.SingleNestedAttribute{
									Description:         "Defines command to do switchover. In particular, when workloadType=Replication, the command defined in switchoverSpec will only be executed under the condition of cluster.componentSpecs[x].SwitchPolicy.type=Noop.",
									MarkdownDescription: "Defines command to do switchover. In particular, when workloadType=Replication, the command defined in switchoverSpec will only be executed under the condition of cluster.componentSpecs[x].SwitchPolicy.type=Noop.",
									Attributes: map[string]schema.Attribute{
								...
								"volume_protection_spec": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										"high_watermark": schema.Int64Attribute{
											Description:         "The high watermark threshold for volume space usage. If there is any specified volumes who's space usage is over the threshold, the pre-defined 'LOCK' action will be triggered to degrade the service to protect volume from space exhaustion, such as to set the instance as read-only. And after that, if all volumes' space usage drops under the threshold later, the pre-defined 'UNLOCK' action will be performed to recover the service normally.",
											MarkdownDescription: "The high watermark threshold for volume space usage. If there is any specified volumes who's space usage is over the threshold, the pre-defined 'LOCK' action will be triggered to degrade the service to protect volume from space exhaustion, such as to set the instance as read-only. And after that, if all volumes' space usage drops under the threshold later, the pre-defined 'UNLOCK' action will be performed to recover the service normally.",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.Int64{
...
func (r *AppsKubeblocksIoClusterDefinitionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_kubeblocks_io_cluster_definition_v1alpha1_manifest")

	var model AppsKubeblocksIoClusterDefinitionV1Alpha1ManifestData
