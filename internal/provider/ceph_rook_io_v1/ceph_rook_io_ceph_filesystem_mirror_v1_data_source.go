...
var (
	_ datasource.DataSource              = &CephRookIoCephFilesystemMirrorV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CephRookIoCephFilesystemMirrorV1DataSource{}
)

func NewCephRookIoCephFilesystemMirrorV1DataSource() datasource.DataSource {
	return &CephRookIoCephFilesystemMirrorV1DataSource{}
}

type CephRookIoCephFilesystemMirrorV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CephRookIoCephFilesystemMirrorV1DataSourceData struct {
...
func (r *CephRookIoCephFilesystemMirrorV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ceph_rook_io_ceph_filesystem_mirror_v1"
}

func (r *CephRookIoCephFilesystemMirrorV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CephRookIoCephFilesystemMirrorV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CephRookIoCephFilesystemMirrorV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_ceph_rook_io_ceph_filesystem_mirror_v1")

	var data CephRookIoCephFilesystemMirrorV1DataSourceData
	...
	var readResponse CephRookIoCephFilesystemMirrorV1DataSourceData
	...
	data.Kind = pointer.String("CephFilesystemMirror")
