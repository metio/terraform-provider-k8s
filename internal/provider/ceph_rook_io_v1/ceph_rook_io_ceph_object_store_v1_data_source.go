...
var (
	_ datasource.DataSource              = &CephRookIoCephObjectStoreV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CephRookIoCephObjectStoreV1DataSource{}
)

func NewCephRookIoCephObjectStoreV1DataSource() datasource.DataSource {
	return &CephRookIoCephObjectStoreV1DataSource{}
}

type CephRookIoCephObjectStoreV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CephRookIoCephObjectStoreV1DataSourceData struct {
...
func (r *CephRookIoCephObjectStoreV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ceph_rook_io_ceph_object_store_v1"
}

func (r *CephRookIoCephObjectStoreV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CephRookIoCephObjectStoreV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CephRookIoCephObjectStoreV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_ceph_rook_io_ceph_object_store_v1")

	var data CephRookIoCephObjectStoreV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "ceph.rook.io", Version: "v1", Resource: "cephobjectstores"}).
	...
	var readResponse CephRookIoCephObjectStoreV1DataSourceData
	...
	data.Kind = pointer.String("CephObjectStore")
