...
var (
	_ datasource.DataSource              = &CephRookIoCephObjectZoneV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CephRookIoCephObjectZoneV1DataSource{}
)

func NewCephRookIoCephObjectZoneV1DataSource() datasource.DataSource {
	return &CephRookIoCephObjectZoneV1DataSource{}
}

type CephRookIoCephObjectZoneV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CephRookIoCephObjectZoneV1DataSourceData struct {
...
func (r *CephRookIoCephObjectZoneV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ceph_rook_io_ceph_object_zone_v1"
}

func (r *CephRookIoCephObjectZoneV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CephRookIoCephObjectZoneV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CephRookIoCephObjectZoneV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_ceph_rook_io_ceph_object_zone_v1")

	var data CephRookIoCephObjectZoneV1DataSourceData
	...
	var readResponse CephRookIoCephObjectZoneV1DataSourceData
	...
	data.Kind = pointer.String("CephObjectZone")
