...
var (
	_ resource.Resource = (*RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource)(nil)
)

type RdsServicesK8SAwsDBParameterGroupV1Alpha1TerraformModel struct {
...
type RdsServicesK8SAwsDBParameterGroupV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		ParameterOverrides *map[string]string `tfsdk:"parameter_overrides" yaml:"parameterOverrides,omitempty"`
...
func (r *RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_rds_services_k8s_aws_db_parameter_group_v1alpha1"
}

func (r *RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_rds_services_k8s_aws_db_parameter_group_v1alpha1")

	var state RdsServicesK8SAwsDBParameterGroupV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel RdsServicesK8SAwsDBParameterGroupV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("DBParameterGroup")
...
func (r *RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rds_services_k8s_aws_db_parameter_group_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *RdsServicesK8SAwsDBParameterGroupV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
