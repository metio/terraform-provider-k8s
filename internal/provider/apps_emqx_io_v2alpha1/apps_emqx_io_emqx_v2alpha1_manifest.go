...
var (
	_ datasource.DataSource = &AppsEmqxIoEmqxV2Alpha1Manifest{}
)

func NewAppsEmqxIoEmqxV2Alpha1Manifest() datasource.DataSource {
	return &AppsEmqxIoEmqxV2Alpha1Manifest{}
}
...
type AppsEmqxIoEmqxV2Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		BootstrapConfig *string `tfsdk:"bootstrap_config" json:"bootstrapConfig,omitempty"`
		CoreTemplate    *struct {
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
...
func (r *AppsEmqxIoEmqxV2Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apps_emqx_io_emqx_v2alpha1_manifest"
}

func (r *AppsEmqxIoEmqxV2Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"bootstrap_config": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
...
func (r *AppsEmqxIoEmqxV2Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_emqx_io_emqx_v2alpha1_manifest")

	var model AppsEmqxIoEmqxV2Alpha1ManifestData
