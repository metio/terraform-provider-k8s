...
var (
	_ datasource.DataSource              = &CertManagerIoIssuerV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CertManagerIoIssuerV1DataSource{}
)

func NewCertManagerIoIssuerV1DataSource() datasource.DataSource {
	return &CertManagerIoIssuerV1DataSource{}
}

type CertManagerIoIssuerV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CertManagerIoIssuerV1DataSourceData struct {
...
func (r *CertManagerIoIssuerV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cert_manager_io_issuer_v1"
}

func (r *CertManagerIoIssuerV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CertManagerIoIssuerV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CertManagerIoIssuerV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cert_manager_io_issuer_v1")

	var data CertManagerIoIssuerV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "cert-manager.io", Version: "v1", Resource: "issuers"}).
	...
	var readResponse CertManagerIoIssuerV1DataSourceData
	...
	data.Kind = pointer.String("Issuer")
