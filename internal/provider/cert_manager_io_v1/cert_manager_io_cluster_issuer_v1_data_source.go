...
var (
	_ datasource.DataSource              = &CertManagerIoClusterIssuerV1DataSource{}
	_ datasource.DataSourceWithConfigure = &CertManagerIoClusterIssuerV1DataSource{}
)

func NewCertManagerIoClusterIssuerV1DataSource() datasource.DataSource {
	return &CertManagerIoClusterIssuerV1DataSource{}
}

type CertManagerIoClusterIssuerV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type CertManagerIoClusterIssuerV1DataSourceData struct {
...
func (r *CertManagerIoClusterIssuerV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cert_manager_io_cluster_issuer_v1"
}

func (r *CertManagerIoClusterIssuerV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CertManagerIoClusterIssuerV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CertManagerIoClusterIssuerV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cert_manager_io_cluster_issuer_v1")

	var data CertManagerIoClusterIssuerV1DataSourceData
	...
	var readResponse CertManagerIoClusterIssuerV1DataSourceData
	...
	data.Kind = pointer.String("ClusterIssuer")
