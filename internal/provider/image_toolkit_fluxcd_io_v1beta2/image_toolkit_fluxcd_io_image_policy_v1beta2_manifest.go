...
var (
	_ datasource.DataSource = &ImageToolkitFluxcdIoImagePolicyV1Beta2Manifest{}
)

func NewImageToolkitFluxcdIoImagePolicyV1Beta2Manifest() datasource.DataSource {
	return &ImageToolkitFluxcdIoImagePolicyV1Beta2Manifest{}
}

type ImageToolkitFluxcdIoImagePolicyV1Beta2Manifest struct{}

type ImageToolkitFluxcdIoImagePolicyV1Beta2ManifestData struct {
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_image_toolkit_fluxcd_io_image_policy_v1beta2_manifest"
}

func (r *ImageToolkitFluxcdIoImagePolicyV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"suspend": schema.BoolAttribute{
						Description:         "This flag tells the controller to suspend subsequent policy reconciliations. It does not apply to already started reconciliations. Defaults to false.",
						MarkdownDescription: "This flag tells the controller to suspend subsequent policy reconciliations. It does not apply to already started reconciliations. Defaults to false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_image_toolkit_fluxcd_io_image_policy_v1beta2_manifest")

	var model ImageToolkitFluxcdIoImagePolicyV1Beta2ManifestData
