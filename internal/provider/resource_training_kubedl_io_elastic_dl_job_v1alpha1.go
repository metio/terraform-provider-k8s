...
type TrainingKubedlIoElasticDLJobV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*TrainingKubedlIoElasticDLJobV1Alpha1Resource)(nil)
)

type TrainingKubedlIoElasticDLJobV1Alpha1TerraformModel struct {
...
type TrainingKubedlIoElasticDLJobV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"elasticdl_replica_specs" yaml:"elasticdlReplicaSpecs,omitempty"`
...
func NewTrainingKubedlIoElasticDLJobV1Alpha1Resource() resource.Resource {
	return &TrainingKubedlIoElasticDLJobV1Alpha1Resource{}
}

func (r *TrainingKubedlIoElasticDLJobV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_training_kubedl_io_elastic_dl_job_v1alpha1"
}

func (r *TrainingKubedlIoElasticDLJobV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *TrainingKubedlIoElasticDLJobV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_training_kubedl_io_elastic_dl_job_v1alpha1")

	var state TrainingKubedlIoElasticDLJobV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel TrainingKubedlIoElasticDLJobV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("ElasticDLJob")
...
func (r *TrainingKubedlIoElasticDLJobV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_elastic_dl_job_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *TrainingKubedlIoElasticDLJobV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_training_kubedl_io_elastic_dl_job_v1alpha1")
...
func (r *TrainingKubedlIoElasticDLJobV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_training_kubedl_io_elastic_dl_job_v1alpha1")
