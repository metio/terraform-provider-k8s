...
var (
	_ datasource.DataSource = &SecurityIstioIoAuthorizationPolicyV1Manifest{}
)

func NewSecurityIstioIoAuthorizationPolicyV1Manifest() datasource.DataSource {
	return &SecurityIstioIoAuthorizationPolicyV1Manifest{}
}

type SecurityIstioIoAuthorizationPolicyV1Manifest struct{}

type SecurityIstioIoAuthorizationPolicyV1ManifestData struct {
...
func (r *SecurityIstioIoAuthorizationPolicyV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_security_istio_io_authorization_policy_v1_manifest"
}

func (r *SecurityIstioIoAuthorizationPolicyV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SecurityIstioIoAuthorizationPolicyV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_security_istio_io_authorization_policy_v1_manifest")

	var model SecurityIstioIoAuthorizationPolicyV1ManifestData
