...
var (
	_ datasource.DataSource              = &SecurityIstioIoAuthorizationPolicyV1DataSource{}
	_ datasource.DataSourceWithConfigure = &SecurityIstioIoAuthorizationPolicyV1DataSource{}
)

func NewSecurityIstioIoAuthorizationPolicyV1DataSource() datasource.DataSource {
	return &SecurityIstioIoAuthorizationPolicyV1DataSource{}
}

type SecurityIstioIoAuthorizationPolicyV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type SecurityIstioIoAuthorizationPolicyV1DataSourceData struct {
...
func (r *SecurityIstioIoAuthorizationPolicyV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_security_istio_io_authorization_policy_v1"
}

func (r *SecurityIstioIoAuthorizationPolicyV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SecurityIstioIoAuthorizationPolicyV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *SecurityIstioIoAuthorizationPolicyV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_security_istio_io_authorization_policy_v1")

	var data SecurityIstioIoAuthorizationPolicyV1DataSourceData
	...
	var readResponse SecurityIstioIoAuthorizationPolicyV1DataSourceData
