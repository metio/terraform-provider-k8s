...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoClusterFlowV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoClusterFlowV1Beta1DataSource{}
)

func NewLoggingBanzaicloudIoClusterFlowV1Beta1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoClusterFlowV1Beta1DataSource{}
}

type LoggingBanzaicloudIoClusterFlowV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoClusterFlowV1Beta1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoClusterFlowV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_cluster_flow_v1beta1"
}

func (r *LoggingBanzaicloudIoClusterFlowV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoClusterFlowV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoClusterFlowV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_cluster_flow_v1beta1")

	var data LoggingBanzaicloudIoClusterFlowV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "logging.banzaicloud.io", Version: "v1beta1", Resource: "ClusterFlow"}).
	...
	var readResponse LoggingBanzaicloudIoClusterFlowV1Beta1DataSourceData
