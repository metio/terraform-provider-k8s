...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoFlowV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoFlowV1Beta1DataSource{}
)

func NewLoggingBanzaicloudIoFlowV1Beta1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoFlowV1Beta1DataSource{}
}

type LoggingBanzaicloudIoFlowV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoFlowV1Beta1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoFlowV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_flow_v1beta1"
}

func (r *LoggingBanzaicloudIoFlowV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoFlowV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoFlowV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_flow_v1beta1")

	var data LoggingBanzaicloudIoFlowV1Beta1DataSourceData
	...
	var readResponse LoggingBanzaicloudIoFlowV1Beta1DataSourceData
