...
var (
	_ datasource.DataSource = &LoggingBanzaicloudIoClusterFlowV1Beta1Manifest{}
)

func NewLoggingBanzaicloudIoClusterFlowV1Beta1Manifest() datasource.DataSource {
	return &LoggingBanzaicloudIoClusterFlowV1Beta1Manifest{}
}
...
func (r *LoggingBanzaicloudIoClusterFlowV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_cluster_flow_v1beta1_manifest"
}

func (r *LoggingBanzaicloudIoClusterFlowV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoClusterFlowV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_logging_banzaicloud_io_cluster_flow_v1beta1_manifest")

	var model LoggingBanzaicloudIoClusterFlowV1Beta1ManifestData
