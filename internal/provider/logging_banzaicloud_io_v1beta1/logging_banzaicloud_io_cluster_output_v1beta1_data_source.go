...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoClusterOutputV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoClusterOutputV1Beta1DataSource{}
)

func NewLoggingBanzaicloudIoClusterOutputV1Beta1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoClusterOutputV1Beta1DataSource{}
}

type LoggingBanzaicloudIoClusterOutputV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoClusterOutputV1Beta1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoClusterOutputV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_cluster_output_v1beta1"
}

func (r *LoggingBanzaicloudIoClusterOutputV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoClusterOutputV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoClusterOutputV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_cluster_output_v1beta1")

	var data LoggingBanzaicloudIoClusterOutputV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "logging.banzaicloud.io", Version: "v1beta1", Resource: "clusteroutputs"}).
	...
	var readResponse LoggingBanzaicloudIoClusterOutputV1Beta1DataSourceData
