...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoOutputV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoOutputV1Beta1DataSource{}
)

func NewLoggingBanzaicloudIoOutputV1Beta1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoOutputV1Beta1DataSource{}
}

type LoggingBanzaicloudIoOutputV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoOutputV1Beta1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoOutputV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_output_v1beta1"
}

func (r *LoggingBanzaicloudIoOutputV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoOutputV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoOutputV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_output_v1beta1")

	var data LoggingBanzaicloudIoOutputV1Beta1DataSourceData
	...
	var readResponse LoggingBanzaicloudIoOutputV1Beta1DataSourceData
