...
var (
	_ datasource.DataSource = &LoggingBanzaicloudIoOutputV1Beta1Manifest{}
)

func NewLoggingBanzaicloudIoOutputV1Beta1Manifest() datasource.DataSource {
	return &LoggingBanzaicloudIoOutputV1Beta1Manifest{}
}
...
func (r *LoggingBanzaicloudIoOutputV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_output_v1beta1_manifest"
}

func (r *LoggingBanzaicloudIoOutputV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoOutputV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_logging_banzaicloud_io_output_v1beta1_manifest")

	var model LoggingBanzaicloudIoOutputV1Beta1ManifestData
