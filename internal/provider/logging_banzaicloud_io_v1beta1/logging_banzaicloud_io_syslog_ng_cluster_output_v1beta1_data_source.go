...
var (
	_ datasource.DataSource              = &LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource{}
)

func NewLoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource() datasource.DataSource {
	return &LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource{}
}

type LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSourceData struct {
...
func (r *LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_banzaicloud_io_syslog_ng_cluster_output_v1beta1"
}

func (r *LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_logging_banzaicloud_io_syslog_ng_cluster_output_v1beta1")

	var data LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "logging.banzaicloud.io", Version: "v1beta1", Resource: "syslogngclusteroutputs"}).
	...
	var readResponse LoggingBanzaicloudIoSyslogNgclusterOutputV1Beta1DataSourceData
	...
	data.Kind = pointer.String("SyslogNGClusterOutput")
