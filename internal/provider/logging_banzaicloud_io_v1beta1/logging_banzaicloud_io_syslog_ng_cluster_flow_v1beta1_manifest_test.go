...
func TestLoggingBanzaicloudIoSyslogNGClusterFlowV1Beta1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_logging_banzaicloud_io_syslog_ng_cluster_flow_v1beta1_manifest", testCase)
		})
	}
}
