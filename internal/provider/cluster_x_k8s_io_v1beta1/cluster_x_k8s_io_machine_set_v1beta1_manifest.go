...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineSetV1Beta1Manifest{}
)

func NewClusterXK8SIoMachineSetV1Beta1Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineSetV1Beta1Manifest{}
}
...
func (r *ClusterXK8SIoMachineSetV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_set_v1beta1_manifest"
}

func (r *ClusterXK8SIoMachineSetV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachineSetV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_set_v1beta1_manifest")

	var model ClusterXK8SIoMachineSetV1Beta1ManifestData
