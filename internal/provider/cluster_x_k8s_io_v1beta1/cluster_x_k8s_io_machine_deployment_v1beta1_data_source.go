...
var (
	_ datasource.DataSource              = &ClusterXK8SIoMachineDeploymentV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ClusterXK8SIoMachineDeploymentV1Beta1DataSource{}
)

func NewClusterXK8SIoMachineDeploymentV1Beta1DataSource() datasource.DataSource {
	return &ClusterXK8SIoMachineDeploymentV1Beta1DataSource{}
}

type ClusterXK8SIoMachineDeploymentV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ClusterXK8SIoMachineDeploymentV1Beta1DataSourceData struct {
...
func (r *ClusterXK8SIoMachineDeploymentV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_deployment_v1beta1"
}

func (r *ClusterXK8SIoMachineDeploymentV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachineDeploymentV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ClusterXK8SIoMachineDeploymentV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cluster_x_k8s_io_machine_deployment_v1beta1")

	var data ClusterXK8SIoMachineDeploymentV1Beta1DataSourceData
	...
	var readResponse ClusterXK8SIoMachineDeploymentV1Beta1DataSourceData
