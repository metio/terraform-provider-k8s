...
var (
	_ datasource.DataSource              = &ClusterXK8SIoMachinePoolV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ClusterXK8SIoMachinePoolV1Beta1DataSource{}
)

func NewClusterXK8SIoMachinePoolV1Beta1DataSource() datasource.DataSource {
	return &ClusterXK8SIoMachinePoolV1Beta1DataSource{}
}

type ClusterXK8SIoMachinePoolV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ClusterXK8SIoMachinePoolV1Beta1DataSourceData struct {
...
func (r *ClusterXK8SIoMachinePoolV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_pool_v1beta1"
}

func (r *ClusterXK8SIoMachinePoolV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"min_ready_seconds": schema.Int64Attribute{
						...
						MarkdownDescription: "Minimum number of seconds for which a newly created machine instances should be ready. Defaults to 0 (machine instance will be considered available as soon as it is ready) NOTE: No logic is implemented for this field and it currently has no behaviour.",
						Required:            false,
						Optional:            false,
						Computed:            true,
					},
...
func (r *ClusterXK8SIoMachinePoolV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ClusterXK8SIoMachinePoolV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_cluster_x_k8s_io_machine_pool_v1beta1")

	var data ClusterXK8SIoMachinePoolV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "cluster.x-k8s.io", Version: "v1beta1", Resource: "machinepools"}).
	...
	var readResponse ClusterXK8SIoMachinePoolV1Beta1DataSourceData
