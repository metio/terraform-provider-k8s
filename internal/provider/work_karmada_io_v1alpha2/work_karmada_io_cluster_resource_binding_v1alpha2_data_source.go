...
var (
	_ datasource.DataSource              = &WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource{}
)

func NewWorkKarmadaIoClusterResourceBindingV1Alpha2DataSource() datasource.DataSource {
	return &WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource{}
}

type WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type WorkKarmadaIoClusterResourceBindingV1Alpha2DataSourceData struct {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_work_karmada_io_cluster_resource_binding_v1alpha2"
}

func (r *WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_work_karmada_io_cluster_resource_binding_v1alpha2")

	var data WorkKarmadaIoClusterResourceBindingV1Alpha2DataSourceData
	...
	var readResponse WorkKarmadaIoClusterResourceBindingV1Alpha2DataSourceData
