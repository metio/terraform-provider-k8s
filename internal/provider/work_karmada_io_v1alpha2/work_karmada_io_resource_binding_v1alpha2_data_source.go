...
var (
	_ datasource.DataSource              = &WorkKarmadaIoResourceBindingV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &WorkKarmadaIoResourceBindingV1Alpha2DataSource{}
)

func NewWorkKarmadaIoResourceBindingV1Alpha2DataSource() datasource.DataSource {
	return &WorkKarmadaIoResourceBindingV1Alpha2DataSource{}
}

type WorkKarmadaIoResourceBindingV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type WorkKarmadaIoResourceBindingV1Alpha2DataSourceData struct {
...
func (r *WorkKarmadaIoResourceBindingV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_work_karmada_io_resource_binding_v1alpha2"
}

func (r *WorkKarmadaIoResourceBindingV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WorkKarmadaIoResourceBindingV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *WorkKarmadaIoResourceBindingV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_work_karmada_io_resource_binding_v1alpha2")

	var data WorkKarmadaIoResourceBindingV1Alpha2DataSourceData
	...
	var readResponse WorkKarmadaIoResourceBindingV1Alpha2DataSourceData
	...
	data.ApiVersion = pointer.String("work.karmada.io/v1alpha2")
	data.Kind = pointer.String("ResourceBinding")
