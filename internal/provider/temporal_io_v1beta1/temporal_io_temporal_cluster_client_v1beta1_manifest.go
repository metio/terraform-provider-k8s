...
var (
	_ datasource.DataSource = &TemporalIoTemporalClusterClientV1Beta1Manifest{}
)

func NewTemporalIoTemporalClusterClientV1Beta1Manifest() datasource.DataSource {
	return &TemporalIoTemporalClusterClientV1Beta1Manifest{}
}
...
func (r *TemporalIoTemporalClusterClientV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_temporal_io_temporal_cluster_client_v1beta1_manifest"
}

func (r *TemporalIoTemporalClusterClientV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "A TemporalClusterClient creates a new mTLS client in the targeted temporal cluster.",
		MarkdownDescription: "A TemporalClusterClient creates a new mTLS client in the targeted temporal cluster.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TemporalClusterClientSpec defines the desired state of ClusterClient.",
				Attributes: map[string]schema.Attribute{
...
func (r *TemporalIoTemporalClusterClientV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_temporal_io_temporal_cluster_client_v1beta1_manifest")

	var model TemporalIoTemporalClusterClientV1Beta1ManifestData
	...
	model.Kind = pointer.String("TemporalClusterClient")
