...
func TestChartsHelmK8SIoSnykMonitorV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_charts_helm_k8s_io_snyk_monitor_v1alpha1_manifest", testCase)
		})
	}
}
