...
var (
	_ datasource.DataSource              = &PodV1DataSource{}
	_ datasource.DataSourceWithConfigure = &PodV1DataSource{}
)

func NewPodV1DataSource() datasource.DataSource {
	return &PodV1DataSource{}
}

type PodV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PodV1DataSourceData struct {
...
func (r *PodV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_pod_v1"
}

func (r *PodV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PodV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PodV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_pod_v1")

	var data PodV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "", Version: "v1", Resource: "pods"}).
	...
	var readResponse PodV1DataSourceData
