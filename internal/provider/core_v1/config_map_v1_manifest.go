...
var (
	_ datasource.DataSource = &ConfigMapV1Manifest{}
)

func NewConfigMapV1Manifest() datasource.DataSource {
	return &ConfigMapV1Manifest{}
}

type ConfigMapV1Manifest struct{}

type ConfigMapV1ManifestData struct {
...
func (r *ConfigMapV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_config_map_v1_manifest"
}

func (r *ConfigMapV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ConfigMapV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_config_map_v1_manifest")

	var model ConfigMapV1ManifestData
