...
func TestPersistentVolumeClaimV1Resource_ValidateSchema(t *testing.T) {
	...
	core_v1.NewPersistentVolumeClaimV1Resource().Schema(ctx, schemaRequest, schemaResponse)
...
func TestPersistentVolumeClaimV1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_persistent_volume_claim_v1", testCase)
		})
	}
}
