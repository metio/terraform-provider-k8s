...
var (
	_ datasource.DataSource = &PodV1Manifest{}
)

func NewPodV1Manifest() datasource.DataSource {
	return &PodV1Manifest{}
}

type PodV1Manifest struct{}

type PodV1ManifestData struct {
...
func (r *PodV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_pod_v1_manifest"
}

func (r *PodV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Pod is a collection of containers that can run on a host. This resource is created by clients and scheduled onto hosts.",
		MarkdownDescription: "Pod is a collection of containers that can run on a host. This resource is created by clients and scheduled onto hosts.",
...
func (r *PodV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_pod_v1_manifest")

	var model PodV1ManifestData
