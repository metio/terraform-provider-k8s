...
var (
	_ datasource.DataSource              = &ServiceV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ServiceV1DataSource{}
)

func NewServiceV1DataSource() datasource.DataSource {
	return &ServiceV1DataSource{}
}

type ServiceV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ServiceV1DataSourceData struct {
...
func (r *ServiceV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_service_v1"
}

func (r *ServiceV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ServiceV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ServiceV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_service_v1")

	var data ServiceV1DataSourceData
	...
	var readResponse ServiceV1DataSourceData
	...
	data.Kind = pointer.String("Service")
