...
var (
	_ datasource.DataSource              = &ReplicationControllerV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ReplicationControllerV1DataSource{}
)

func NewReplicationControllerV1DataSource() datasource.DataSource {
	return &ReplicationControllerV1DataSource{}
}

type ReplicationControllerV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ReplicationControllerV1DataSourceData struct {
...
func (r *ReplicationControllerV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_replication_controller_v1"
}

func (r *ReplicationControllerV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ReplicationControllerV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ReplicationControllerV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_replication_controller_v1")

	var data ReplicationControllerV1DataSourceData
	...
	var readResponse ReplicationControllerV1DataSourceData
	...
	data.Kind = pointer.String("ReplicationController")
