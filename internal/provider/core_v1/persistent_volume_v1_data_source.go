...
var (
	_ datasource.DataSource              = &PersistentVolumeV1DataSource{}
	_ datasource.DataSourceWithConfigure = &PersistentVolumeV1DataSource{}
)

func NewPersistentVolumeV1DataSource() datasource.DataSource {
	return &PersistentVolumeV1DataSource{}
}

type PersistentVolumeV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PersistentVolumeV1DataSourceData struct {
...
func (r *PersistentVolumeV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_persistent_volume_v1"
}

func (r *PersistentVolumeV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PersistentVolumeV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PersistentVolumeV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_persistent_volume_v1")

	var data PersistentVolumeV1DataSourceData
	...
	var readResponse PersistentVolumeV1DataSourceData
	...
	data.Kind = pointer.String("PersistentVolume")
