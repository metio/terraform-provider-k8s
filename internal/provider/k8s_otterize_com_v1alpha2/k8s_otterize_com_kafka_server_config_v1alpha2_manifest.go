...
var (
	_ datasource.DataSource = &K8SOtterizeComKafkaServerConfigV1Alpha2Manifest{}
)

func NewK8SOtterizeComKafkaServerConfigV1Alpha2Manifest() datasource.DataSource {
	return &K8SOtterizeComKafkaServerConfigV1Alpha2Manifest{}
}
...
func (r *K8SOtterizeComKafkaServerConfigV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8s_otterize_com_kafka_server_config_v1alpha2_manifest"
}
...
func (r *K8SOtterizeComKafkaServerConfigV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8s_otterize_com_kafka_server_config_v1alpha2_manifest")

	var model K8SOtterizeComKafkaServerConfigV1Alpha2ManifestData
