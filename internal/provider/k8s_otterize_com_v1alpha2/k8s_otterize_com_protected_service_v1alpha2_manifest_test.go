...
func TestK8SOtterizeComProtectedServiceV1Alpha2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_k8s_otterize_com_protected_service_v1alpha2_manifest", testCase)
		})
	}
}
