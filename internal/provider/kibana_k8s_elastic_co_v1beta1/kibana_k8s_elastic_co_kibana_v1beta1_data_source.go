...
var (
	_ datasource.DataSource              = &KibanaK8SElasticCoKibanaV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &KibanaK8SElasticCoKibanaV1Beta1DataSource{}
)

func NewKibanaK8SElasticCoKibanaV1Beta1DataSource() datasource.DataSource {
	return &KibanaK8SElasticCoKibanaV1Beta1DataSource{}
}

type KibanaK8SElasticCoKibanaV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KibanaK8SElasticCoKibanaV1Beta1DataSourceData struct {
...
func (r *KibanaK8SElasticCoKibanaV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kibana_k8s_elastic_co_kibana_v1beta1"
}

func (r *KibanaK8SElasticCoKibanaV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KibanaK8SElasticCoKibanaV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KibanaK8SElasticCoKibanaV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kibana_k8s_elastic_co_kibana_v1beta1")

	var data KibanaK8SElasticCoKibanaV1Beta1DataSourceData
	...
	var readResponse KibanaK8SElasticCoKibanaV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("kibana.k8s.elastic.co/v1beta1")
	data.Kind = pointer.String("Kibana")
