...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest{}
}

type RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest struct{}

type RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		VhostTopics *[]struct {
			Topics *[]struct {
				Permissions *struct {
					Configure *string `tfsdk:"configure" json:"configure,omitempty"`
					Read      *string `tfsdk:"read" json:"read,omitempty"`
					Write     *string `tfsdk:"write" json:"write,omitempty"`
			...
			VhostName *string `tfsdk:"vhost_name" json:"vhostName,omitempty"`
		} `tfsdk:"vhost_topics" json:"vhostTopics,omitempty"`
		Vhosts *[]struct {
			Permissions *struct {
				Configure *string `tfsdk:"configure" json:"configure,omitempty"`
				Read      *string `tfsdk:"read" json:"read,omitempty"`
			...
			VhostName *string `tfsdk:"vhost_name" json:"vhostName,omitempty"`
		} `tfsdk:"vhosts" json:"vhosts,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_rabbit_mq_secret_engine_role_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "RabbitMQSecretEngineRole is the Schema for the rabbitmqsecretengineroles API",
		MarkdownDescription: "RabbitMQSecretEngineRole is the Schema for the rabbitmqsecretengineroles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "RabbitMQSecretEngineRoleSpec defines the desired state of RabbitMQSecretEngineRole",
				MarkdownDescription: "RabbitMQSecretEngineRoleSpec defines the desired state of RabbitMQSecretEngineRole",
				Attributes: map[string]schema.Attribute{
					"authentication": schema.SingleNestedAttribute{
						Description:         "Authentication is the k8s auth configuration to be used to execute this request",
						MarkdownDescription: "Authentication is the k8s auth configuration to be used to execute this request",
						Attributes: map[string]schema.Attribute{
							"namespace": schema.StringAttribute{
					...
					"tags": schema.StringAttribute{
						Description:         "Comma-separated RabbitMQ permissions tags to associate with the user. This determines the level of access to the RabbitMQ management UI granted to the user. Omitting this field will lead to a user than can still connect to the cluster through messaging protocols, but cannot perform any management actions.",
						MarkdownDescription: "Comma-separated RabbitMQ permissions tags to associate with the user. This determines the level of access to the RabbitMQ management UI granted to the user. Omitting this field will lead to a user than can still connect to the cluster through messaging protocols, but cannot perform any management actions.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"vhost_topics": schema.ListNestedAttribute{
						Description:         "This option requires RabbitMQ 3.7.0 or later.",
						MarkdownDescription: "This option requires RabbitMQ 3.7.0 or later.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"topics": schema.ListNestedAttribute{
									Description:         "List of topics to provide",
									MarkdownDescription: "List of topics to provide",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"permissions": schema.SingleNestedAttribute{
												Description:         "Permissions to grant to the user in the specific vhost",
												MarkdownDescription: "Permissions to grant to the user in the specific vhost",
												Attributes: map[string]schema.Attribute{
											...
											"topic_name": schema.StringAttribute{
												Description:         "Name of an existing topic.",
												MarkdownDescription: "Name of an existing topic.",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
								...
								"vhost_name": schema.StringAttribute{
									Description:         "Name of an existing vhost.",
									MarkdownDescription: "Name of an existing vhost.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
...
func (r *RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_rabbit_mq_secret_engine_role_v1alpha1_manifest")

	var model RedhatcopRedhatIoRabbitMqsecretEngineRoleV1Alpha1ManifestData
	...
	model.Kind = pointer.String("RabbitMQSecretEngineRole")
