...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest{}
}

type RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest struct{}

type RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1ManifestData struct {
	...
	Spec *struct {
		ApplicationID  *int64 `tfsdk:"application_id" json:"applicationID,omitempty"`
		...
		GitHubAPIBaseURL *string `tfsdk:"git_hub_api_base_url" json:"gitHubAPIBaseURL,omitempty"`
		Path             *string `tfsdk:"path" json:"path,omitempty"`
		SSHKeyReference  *struct {
			Secret *struct {
				Name *string `tfsdk:"name" json:"name,omitempty"`
		...
		} `tfsdk:"s_sh_key_reference" json:"sSHKeyReference,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_git_hub_secret_engine_config_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GitHubSecretEngineConfig is the Schema for the githubsecretengineconfigs API",
		MarkdownDescription: "GitHubSecretEngineConfig is the Schema for the githubsecretengineconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "GitHubSecretEngineConfigSpec defines the desired state of GitHubSecretEngineConfig",
				MarkdownDescription: "GitHubSecretEngineConfigSpec defines the desired state of GitHubSecretEngineConfig",
				Attributes: map[string]schema.Attribute{
					"application_id": schema.Int64Attribute{
						Description:         "ApplicationID the Application ID of the GitHub App.",
						MarkdownDescription: "ApplicationID the Application ID of the GitHub App.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"git_hub_api_base_url": schema.StringAttribute{
						Description:         "GitHubAPIBaseURL the base URL for API requests (defaults to the public GitHub API).",
						MarkdownDescription: "GitHubAPIBaseURL the base URL for API requests (defaults to the public GitHub API).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"path": schema.StringAttribute{
						Description:         "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/config. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						MarkdownDescription: "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/config. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"s_sh_key_reference": schema.SingleNestedAttribute{
						Description:         "SSHKeyReference allows ofr options to retrieve the ssh key. For security reasons it is never displayed.",
						MarkdownDescription: "SSHKeyReference allows ofr options to retrieve the ssh key. For security reasons it is never displayed.",
						Attributes: map[string]schema.Attribute{
							"secret": schema.SingleNestedAttribute{
								Description:         "Secret retrieves the ssh key from a Kubernetes secret. The secret must be of ssh type (https://kubernetes.io/docs/concepts/configuration/secret/#ssh-authentication-secrets).",
								MarkdownDescription: "Secret retrieves the ssh key from a Kubernetes secret. The secret must be of ssh type (https://kubernetes.io/docs/concepts/configuration/secret/#ssh-authentication-secrets).",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?",
										MarkdownDescription: "Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?",
							...
							"vault_secret": schema.SingleNestedAttribute{
								Description:         "VaultSecret retrieves the sshkey from a Vault secret. The sshkey will be retrieve at the key 'key' (pun intented).",
								MarkdownDescription: "VaultSecret retrieves the sshkey from a Vault secret. The sshkey will be retrieve at the key 'key' (pun intented).",
								Attributes: map[string]schema.Attribute{
									"path": schema.StringAttribute{
...
func (r *RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_git_hub_secret_engine_config_v1alpha1_manifest")

	var model RedhatcopRedhatIoGitHubSecretEngineConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("GitHubSecretEngineConfig")
