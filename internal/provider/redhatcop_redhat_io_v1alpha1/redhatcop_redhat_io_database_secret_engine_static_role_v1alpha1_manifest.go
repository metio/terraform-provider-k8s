...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest{}
}

type RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest struct{}

type RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Name                     *string `tfsdk:"name" json:"name,omitempty"`
		PasswordCredentialConfig *struct {
			PasswordPolicy *string `tfsdk:"password_policy" json:"passwordPolicy,omitempty"`
		} `tfsdk:"password_credential_config" json:"passwordCredentialConfig,omitempty"`
		Path                          *string   `tfsdk:"path" json:"path,omitempty"`
		RotationPeriod                *int64    `tfsdk:"rotation_period" json:"rotationPeriod,omitempty"`
		RotationStatements            *[]string `tfsdk:"rotation_statements" json:"rotationStatements,omitempty"`
		RsaPrivateKeyCredentialConfig *struct {
			Format  *string `tfsdk:"format" json:"format,omitempty"`
			KeyBits *int64  `tfsdk:"key_bits" json:"keyBits,omitempty"`
		} `tfsdk:"rsa_private_key_credential_config" json:"rsaPrivateKeyCredentialConfig,omitempty"`
		Username *string `tfsdk:"username" json:"username,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_database_secret_engine_static_role_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "DatabaseSecretEngineStaticRole is the Schema for the databasesecretenginestaticroles API",
		MarkdownDescription: "DatabaseSecretEngineStaticRole is the Schema for the databasesecretenginestaticroles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "DatabaseSecretEngineStaticRoleSpec defines the desired state of DatabaseSecretEngineStaticRole",
				Attributes: map[string]schema.Attribute{
					...
					"credential_type": schema.StringAttribute{
						...
						MarkdownDescription: "CredentialType Specifies the type of credential that will be generated for the role. Options include: password, rsa_private_key. See the plugin's API page for credential types supported by individual databases.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("password", "rsa_private_key"),
						},
					},
					...
					"password_credential_config": schema.SingleNestedAttribute{
						Description:         "PasswordCredentialConfig specifies the configuraiton when the password credential type is chosen.",
						MarkdownDescription: "PasswordCredentialConfig specifies the configuraiton when the password credential type is chosen.",
						Attributes: map[string]schema.Attribute{
							"password_policy": schema.StringAttribute{
								...
								MarkdownDescription: "PasswordPolicy The policy used for password generation. If not provided, defaults to the password policy of the database configuration",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"rotation_period": schema.Int64Attribute{
						...
						MarkdownDescription: "RotationPeriod Specifies the amount of time Vault should wait before rotating the password. The minimum is 5 seconds.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"rsa_private_key_credential_config": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"format": schema.StringAttribute{
								...
								MarkdownDescription: "Format The output format of the generated private key credential. The private key will be returned from the API in PEM encoding. Options include: pkcs8",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
									stringvalidator.OneOf("pkcs8"),
								},
							},

							"key_bits": schema.Int64Attribute{
								Description:         "KeyBits The bit size of the RSA key to generate. Options include: 2048, 3072, 4096.",
								MarkdownDescription: "KeyBits The bit size of the RSA key to generate. Options include: 2048, 3072, 4096.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
					...
					"username": schema.StringAttribute{
						...
						MarkdownDescription: "Username Specifies the database username that this Vault role corresponds to.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_database_secret_engine_static_role_v1alpha1_manifest")

	var model RedhatcopRedhatIoDatabaseSecretEngineStaticRoleV1Alpha1ManifestData
	...
	model.Kind = pointer.String("DatabaseSecretEngineStaticRole")
