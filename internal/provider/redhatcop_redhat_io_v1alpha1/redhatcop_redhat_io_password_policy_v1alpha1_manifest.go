...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest{}
}

type RedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest struct{}

type RedhatcopRedhatIoPasswordPolicyV1Alpha1ManifestData struct {
...
func (r *RedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_password_policy_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "PasswordPolicy is the Schema for the passwordpolicies API",
		MarkdownDescription: "PasswordPolicy is the Schema for the passwordpolicies API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PasswordPolicySpec defines the desired state of PasswordPolicy",
				Attributes: map[string]schema.Attribute{
					...
					"password_policy": schema.StringAttribute{
						Description:         "PasswordPolicy is a Vault password policy (https://www.vaultproject.io/docs/concepts/password-policies) expressed in HCL language.",
						MarkdownDescription: "PasswordPolicy is a Vault password policy (https://www.vaultproject.io/docs/concepts/password-policies) expressed in HCL language.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoPasswordPolicyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_password_policy_v1alpha1_manifest")

	var model RedhatcopRedhatIoPasswordPolicyV1Alpha1ManifestData
	...
	model.Kind = pointer.String("PasswordPolicy")
