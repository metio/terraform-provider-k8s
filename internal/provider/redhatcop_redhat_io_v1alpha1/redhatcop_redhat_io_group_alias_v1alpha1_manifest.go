...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoGroupAliasV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoGroupAliasV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoGroupAliasV1Alpha1Manifest{}
}

type RedhatcopRedhatIoGroupAliasV1Alpha1Manifest struct{}

type RedhatcopRedhatIoGroupAliasV1Alpha1ManifestData struct {
	...
	Spec *struct {
		AuthEngineMountPath *string `tfsdk:"auth_engine_mount_path" json:"authEngineMountPath,omitempty"`
...
func (r *RedhatcopRedhatIoGroupAliasV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_group_alias_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoGroupAliasV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GroupAlias is the Schema for the groupaliases API",
		MarkdownDescription: "GroupAlias is the Schema for the groupaliases API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "GroupAliasSpec defines the desired state of GroupAlias",
				MarkdownDescription: "GroupAliasSpec defines the desired state of GroupAlias",
				Attributes: map[string]schema.Attribute{
					"auth_engine_mount_path": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
...
func (r *RedhatcopRedhatIoGroupAliasV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_group_alias_v1alpha1_manifest")

	var model RedhatcopRedhatIoGroupAliasV1Alpha1ManifestData
	...
	model.Kind = pointer.String("GroupAlias")
