...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoGroupV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoGroupV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoGroupV1Alpha1Manifest{}
}

type RedhatcopRedhatIoGroupV1Alpha1Manifest struct{}

type RedhatcopRedhatIoGroupV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		MemberEntityIDs *[]string          `tfsdk:"member_entity_i_ds" json:"memberEntityIDs,omitempty"`
		MemberGroupIDs  *[]string          `tfsdk:"member_group_i_ds" json:"memberGroupIDs,omitempty"`
...
func (r *RedhatcopRedhatIoGroupV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_group_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoGroupV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GroupSpec defines the desired state of Group",
				Attributes: map[string]schema.Attribute{
					...
					"member_entity_i_ds": schema.ListAttribute{
						Description:         "MemberEntityIDs Entity IDs to be assigned as group members. kubebuilder:validation:UniqueItems=true",
						MarkdownDescription: "MemberEntityIDs Entity IDs to be assigned as group members. kubebuilder:validation:UniqueItems=true",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"member_group_i_ds": schema.ListAttribute{
						Description:         "MemberGroupIDs Group IDs to be assigned as group members. kubebuilder:validation:UniqueItems=true",
						MarkdownDescription: "MemberGroupIDs Group IDs to be assigned as group members. kubebuilder:validation:UniqueItems=true",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"metadata": schema.MapAttribute{
						Description:         "Metadata Metadata to be associated with the group.",
						MarkdownDescription: "Metadata Metadata to be associated with the group.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"policies": schema.ListAttribute{
						...
						MarkdownDescription: "Policies Policies to be tied to the group. kubebuilder:validation:UniqueItems=true",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"type": schema.StringAttribute{
						Description:         "Type Type of the group, internal or external. Defaults to internal",
						MarkdownDescription: "Type Type of the group, internal or external. Defaults to internal",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *RedhatcopRedhatIoGroupV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_group_v1alpha1_manifest")

	var model RedhatcopRedhatIoGroupV1Alpha1ManifestData
