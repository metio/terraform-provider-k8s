...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest{}
}

type RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest struct{}

type RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		CreateRepositories *bool              `tfsdk:"create_repositories" json:"createRepositories,omitempty"`
		DefaultPermission  *string            `tfsdk:"default_permission" json:"defaultPermission,omitempty"`
		MaxTTL             *string            `tfsdk:"max_ttl" json:"maxTTL,omitempty"`
		Name               *string            `tfsdk:"name" json:"name,omitempty"`
		NamespaceName      *string            `tfsdk:"namespace_name" json:"namespaceName,omitempty"`
		NamespaceType      *string            `tfsdk:"namespace_type" json:"namespaceType,omitempty"`
		Path               *string            `tfsdk:"path" json:"path,omitempty"`
		Repositories       *map[string]string `tfsdk:"repositories" json:"repositories,omitempty"`
		Teams              *map[string]string `tfsdk:"teams" json:"teams,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_quay_secret_engine_role_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "QuaySecretEngineRole is the Schema for the quaysecretengineroles API",
		MarkdownDescription: "QuaySecretEngineRole is the Schema for the quaysecretengineroles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "QuaySecretEngineRoleSpec defines the desired state of QuaySecretEngineRole",
				MarkdownDescription: "QuaySecretEngineRoleSpec defines the desired state of QuaySecretEngineRole",
				Attributes: map[string]schema.Attribute{
					"ttl": schema.StringAttribute{
						Description:         "TTL Time-to-Live for the credential",
						MarkdownDescription: "TTL Time-to-Live for the credential",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"create_repositories": schema.BoolAttribute{
						Description:         "CreateRepositories Access to create Quay repositories.",
						MarkdownDescription: "CreateRepositories Access to create Quay repositories.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"default_permission": schema.StringAttribute{
						Description:         "DefaultPermission Permissions granted to the Robot Account in newly created repositories",
						MarkdownDescription: "DefaultPermission Permissions granted to the Robot Account in newly created repositories",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"max_ttl": schema.StringAttribute{
						Description:         "MaxTTL Maximum Time-to-Live for the credential",
						MarkdownDescription: "MaxTTL Maximum Time-to-Live for the credential",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"namespace_name": schema.StringAttribute{
						...
						MarkdownDescription: "NamespaceName Name of the Quay account.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"namespace_type": schema.StringAttribute{
						Description:         "NamespaceType Type of account namespace to manage.",
						MarkdownDescription: "NamespaceType Type of account namespace to manage.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("organization", "user"),
						},
					},

					"path": schema.StringAttribute{
						Description:         "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/roles/{metadata.name}. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						MarkdownDescription: "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/roles/{metadata.name}. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"repositories": schema.MapAttribute{
						Description:         "Teams Permissions granted to the Robot Account to Repositories.",
						MarkdownDescription: "Teams Permissions granted to the Robot Account to Repositories.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"teams": schema.MapAttribute{
						Description:         "Teams Permissions granted to the Robot Account to Teams.",
						MarkdownDescription: "Teams Permissions granted to the Robot Account to Teams.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_quay_secret_engine_role_v1alpha1_manifest")

	var model RedhatcopRedhatIoQuaySecretEngineRoleV1Alpha1ManifestData
	...
	model.Kind = pointer.String("QuaySecretEngineRole")
