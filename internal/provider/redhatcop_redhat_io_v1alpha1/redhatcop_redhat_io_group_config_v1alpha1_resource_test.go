...
func TestRedhatcopRedhatIoGroupConfigV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_redhatcop_redhat_io_group_config_v1alpha1", testCase)
		})
	}
}
