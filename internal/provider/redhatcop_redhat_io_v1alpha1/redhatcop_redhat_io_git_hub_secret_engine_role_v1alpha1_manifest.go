...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest{}
}

type RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest struct{}

type RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		RepositoriesIDs  *[]string          `tfsdk:"repositories_i_ds" json:"repositoriesIDs,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_git_hub_secret_engine_role_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "GitHubSecretEngineRole is the Schema for the githubsecretengineroles API",
		MarkdownDescription: "GitHubSecretEngineRole is the Schema for the githubsecretengineroles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "GitHubSecretEngineRoleSpec defines the desired state of GitHubSecretEngineRole",
				Attributes: map[string]schema.Attribute{
					...
					"installation_id": schema.Int64Attribute{
						Description:         " InstallationID the ID of the app installation. Note the Installation ID from the URL of this page (usually: https://github.com/settings/installations/<installation id>) if you wish to configure using the installation ID directly. Only one of installationID or organizationName is required. If both are provided, installationID takes precedence.",
						MarkdownDescription: " InstallationID the ID of the app installation. Note the Installation ID from the URL of this page (usually: https://github.com/settings/installations/<installation id>) if you wish to configure using the installation ID directly. Only one of installationID or organizationName is required. If both are provided, installationID takes precedence.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"organization_name": schema.StringAttribute{
						Description:         "OrganizationName the name of the organization with the GitHub App installation. Only one of installationID or organizationName is required. If both are provided, installationID takes precedence.",
						MarkdownDescription: "OrganizationName the name of the organization with the GitHub App installation. Only one of installationID or organizationName is required. If both are provided, installationID takes precedence.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"path": schema.StringAttribute{
						Description:         "Path at which to create the role. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/permissionset/{metadata.name}. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						MarkdownDescription: "Path at which to create the role. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/permissionset/{metadata.name}. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"permissions": schema.MapAttribute{
						Description:         "Permissions a key value map of permission names to their access type (read or write). See [GitHub’s documentation](https://developer.github.com/v3/apps/permissions) on permission names and access types.",
						MarkdownDescription: "Permissions a key value map of permission names to their access type (read or write). See [GitHub’s documentation](https://developer.github.com/v3/apps/permissions) on permission names and access types.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"repositories": schema.ListAttribute{
						Description:         "Repositories a list of the names of the repositories within the organisation that the installation token can access",
						MarkdownDescription: "Repositories a list of the names of the repositories within the organisation that the installation token can access",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"repositories_i_ds": schema.ListAttribute{
						Description:         "Repositories a list of the IDs of the repositories that the installation token can access. See [this StackOverflow](https://stackoverflow.com/a/47223479) post for the quickest way to find a repository ID",
						MarkdownDescription: "Repositories a list of the IDs of the repositories that the installation token can access. See [this StackOverflow](https://stackoverflow.com/a/47223479) post for the quickest way to find a repository ID",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_git_hub_secret_engine_role_v1alpha1_manifest")

	var model RedhatcopRedhatIoGitHubSecretEngineRoleV1Alpha1ManifestData
	...
	model.Kind = pointer.String("GitHubSecretEngineRole")
