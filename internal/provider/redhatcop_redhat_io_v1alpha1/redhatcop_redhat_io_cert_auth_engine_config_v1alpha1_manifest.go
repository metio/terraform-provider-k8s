...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest{}
}

type RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest struct{}

type RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		DisableBinding              *bool   `tfsdk:"disable_binding" json:"disableBinding,omitempty"`
		EnableIdentityAliasMetadata *bool   `tfsdk:"enable_identity_alias_metadata" json:"enableIdentityAliasMetadata,omitempty"`
		Name                        *string `tfsdk:"name" json:"name,omitempty"`
		OcspCacheSize               *int64  `tfsdk:"ocsp_cache_size" json:"ocspCacheSize,omitempty"`
		Path                        *string `tfsdk:"path" json:"path,omitempty"`
		RoleCacheSize               *int64  `tfsdk:"role_cache_size" json:"roleCacheSize,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_cert_auth_engine_config_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "CertAuthEngineConfig is the Schema for the certauthengineconfigs API",
		MarkdownDescription: "CertAuthEngineConfig is the Schema for the certauthengineconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "CertAuthEngineConfigSpec defines the desired state of CertAuthEngineConfig",
				MarkdownDescription: "CertAuthEngineConfigSpec defines the desired state of CertAuthEngineConfig",
				Attributes: map[string]schema.Attribute{
					...
					"disable_binding": schema.BoolAttribute{
						...
						MarkdownDescription: "If set, during renewal, skips the matching of presented client identity with the client identity used during login.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"enable_identity_alias_metadata": schema.BoolAttribute{
						Description:         "If set, metadata of the certificate including the metadata corresponding to allowedMetadataExtensions will be stored in the alias.",
						MarkdownDescription: "If set, metadata of the certificate including the metadata corresponding to allowedMetadataExtensions will be stored in the alias.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"ocsp_cache_size": schema.Int64Attribute{
						Description:         "The size of the OCSP response LRU cache. Note that this cache is used for all configured certificates.",
						MarkdownDescription: "The size of the OCSP response LRU cache. Note that this cache is used for all configured certificates.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"path": schema.StringAttribute{
						Description:         "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/auth/{spec.path}/{metadata.name}/config. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						MarkdownDescription: "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/auth/{spec.path}/{metadata.name}/config. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"role_cache_size": schema.Int64Attribute{
						Description:         "The size of the role cache. Use -1 to disable role caching.",
						MarkdownDescription: "The size of the role cache. Use -1 to disable role caching.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_cert_auth_engine_config_v1alpha1_manifest")

	var model RedhatcopRedhatIoCertAuthEngineConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("CertAuthEngineConfig")
