...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest{}
}

type RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest struct{}

type RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		ApplicationObjectID *string `tfsdk:"application_object_id" json:"applicationObjectID,omitempty"`
		...
		AzureGroups *string `tfsdk:"azure_groups" json:"azureGroups,omitempty"`
		...
		Name              *string `tfsdk:"name" json:"name,omitempty"`
		Path              *string `tfsdk:"path" json:"path,omitempty"`
		PermanentlyDelete *string `tfsdk:"permanently_delete" json:"permanentlyDelete,omitempty"`
		PersistApp        *bool   `tfsdk:"persist_app" json:"persistApp,omitempty"`
		SignInAudience    *string `tfsdk:"sign_in_audience" json:"signInAudience,omitempty"`
		Tags              *string `tfsdk:"tags" json:"tags,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_azure_secret_engine_role_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AzureSecretEngineRole is the Schema for the azuresecretengineroles API",
		MarkdownDescription: "AzureSecretEngineRole is the Schema for the azuresecretengineroles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "AzureSecretEngineRoleSpec defines the desired state of AzureSecretEngineRole",
				MarkdownDescription: "AzureSecretEngineRoleSpec defines the desired state of AzureSecretEngineRole",
				Attributes: map[string]schema.Attribute{
					"ttl": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the default TTL for service principals generated using this role. Accepts time suffixed strings ('1h') or an integer number of seconds. Defaults to the system/engine default TTL time.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"application_object_id": schema.StringAttribute{
						Description:         "Application Object ID for an existing service principal that will be used instead of creating dynamic service principals. If present, azure_roles will be ignored. See roles docs for details on role definition.",
						MarkdownDescription: "Application Object ID for an existing service principal that will be used instead of creating dynamic service principals. If present, azure_roles will be ignored. See roles docs for details on role definition.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"azure_groups": schema.StringAttribute{
						Description:         "List of Azure groups that the generated service principal will be assigned to. The array must be in JSON format, properly escaped as a string. See groups docs for more details.",
						MarkdownDescription: "List of Azure groups that the generated service principal will be assigned to. The array must be in JSON format, properly escaped as a string. See groups docs for more details.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"azure_roles": schema.StringAttribute{
						Description:         "List of Azure roles to be assigned to the generated service principal. The array must be in JSON format, properly escaped as a string. See roles docs for details on role definition.",
						MarkdownDescription: "List of Azure roles to be assigned to the generated service principal. The array must be in JSON format, properly escaped as a string. See roles docs for details on role definition.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"max_ttl": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the maximum TTL for service principals generated using this role. Accepts time suffixed strings ('1h') or an integer number of seconds. Defaults to the system/engine max TTL time.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"permanently_delete": schema.StringAttribute{
						Description:         "Specifies whether to permanently delete Applications and Service Principals that are dynamically created by Vault. If application_object_id is present, permanently_delete must be false.",
						MarkdownDescription: "Specifies whether to permanently delete Applications and Service Principals that are dynamically created by Vault. If application_object_id is present, permanently_delete must be false.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"persist_app": schema.BoolAttribute{
						Description:         "If set to true, persists the created service principal and application for the lifetime of the role. Useful for when the Service Principal needs to maintain ownership of objects it creates",
						MarkdownDescription: "If set to true, persists the created service principal and application for the lifetime of the role. Useful for when the Service Principal needs to maintain ownership of objects it creates",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"sign_in_audience": schema.StringAttribute{
						...
						MarkdownDescription: "Specifies the security principal types that are allowed to sign in to the application. Valid values are: AzureADMyOrg, AzureADMultipleOrgs, AzureADandPersonalMicrosoftAccount, PersonalMicrosoftAccount.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"tags": schema.StringAttribute{
						Description:         "A comma-separated string of Azure tags to attach to an application.",
						MarkdownDescription: "A comma-separated string of Azure tags to attach to an application.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_azure_secret_engine_role_v1alpha1_manifest")

	var model RedhatcopRedhatIoAzureSecretEngineRoleV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AzureSecretEngineRole")
