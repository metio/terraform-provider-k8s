...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest{}
}

type RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest struct{}

type RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		DisableSslVerification *bool   `tfsdk:"disable_ssl_verification" json:"disableSslVerification,omitempty"`
		Path                   *string `tfsdk:"path" json:"path,omitempty"`
...
func (r *RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_quay_secret_engine_config_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "QuaySecretEngineConfig is the Schema for the quaysecretengineconfigs API",
		MarkdownDescription: "QuaySecretEngineConfig is the Schema for the quaysecretengineconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "QuaySecretEngineConfigSpec defines the desired state of QuaySecretEngineConfig",
				MarkdownDescription: "QuaySecretEngineConfigSpec defines the desired state of QuaySecretEngineConfig",
				Attributes: map[string]schema.Attribute{
					...
					"ca_certificate": schema.StringAttribute{
						Description:         "CACertertificate PEM encoded CA cert for use by the TLS client used to communicate with Quay.",
						MarkdownDescription: "CACertertificate PEM encoded CA cert for use by the TLS client used to communicate with Quay.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"disable_ssl_verification": schema.BoolAttribute{
						Description:         "DisableSslVerification Disable SSL verification when communicating with Quay.",
						MarkdownDescription: "DisableSslVerification Disable SSL verification when communicating with Quay.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"root_credentials": schema.SingleNestedAttribute{
						Description:         "RootCredentials specifies how to retrieve the credentials for this Quay connection.",
						MarkdownDescription: "RootCredentials specifies how to retrieve the credentials for this Quay connection.",
						Attributes: map[string]schema.Attribute{
					...
					"url": schema.StringAttribute{
						Description:         "url Specifies the location of the Quay instance",
						MarkdownDescription: "url Specifies the location of the Quay instance",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_quay_secret_engine_config_v1alpha1_manifest")

	var model RedhatcopRedhatIoQuaySecretEngineConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("QuaySecretEngineConfig")
