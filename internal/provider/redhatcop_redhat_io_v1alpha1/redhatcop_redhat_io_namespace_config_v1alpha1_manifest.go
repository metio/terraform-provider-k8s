...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoNamespaceConfigV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoNamespaceConfigV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoNamespaceConfigV1Alpha1Manifest{}
}
...
func (r *RedhatcopRedhatIoNamespaceConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_namespace_config_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoNamespaceConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *RedhatcopRedhatIoNamespaceConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_namespace_config_v1alpha1_manifest")

	var model RedhatcopRedhatIoNamespaceConfigV1Alpha1ManifestData
