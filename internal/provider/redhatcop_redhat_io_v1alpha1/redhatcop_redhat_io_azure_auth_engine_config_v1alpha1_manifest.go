...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest{}
}

type RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest struct{}

type RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		MaxRetries    *int64  `tfsdk:"max_retries" json:"maxRetries,omitempty"`
		MaxRetryDelay *int64  `tfsdk:"max_retry_delay" json:"maxRetryDelay,omitempty"`
		Path          *string `tfsdk:"path" json:"path,omitempty"`
		Resource      *string `tfsdk:"resource" json:"resource,omitempty"`
		RetryDelay    *int64  `tfsdk:"retry_delay" json:"retryDelay,omitempty"`
		TenantID      *string `tfsdk:"tenant_id" json:"tenantID,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_azure_auth_engine_config_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AzureAuthEngineConfig is the Schema for the azureauthengineconfigs API",
		MarkdownDescription: "AzureAuthEngineConfig is the Schema for the azureauthengineconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "AzureAuthEngineConfigSpec defines the desired state of AzureAuthEngineConfig",
				MarkdownDescription: "AzureAuthEngineConfigSpec defines the desired state of AzureAuthEngineConfig",
				Attributes: map[string]schema.Attribute{
					...
					"max_retries": schema.Int64Attribute{
						...
						MarkdownDescription: "The maximum number of attempts a failed operation will be retried before producing an error.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"max_retry_delay": schema.Int64Attribute{
						Description:         "The maximum delay, in seconds, allowed before retrying an operation",
						MarkdownDescription: "The maximum delay, in seconds, allowed before retrying an operation",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"resource": schema.StringAttribute{
						Description:         "The resource URL for the application registered in Azure Active Directory. The value is expected to match the audience (aud claim) of the JWT provided to the login API. See the resource parameter for how the audience is set when requesting a JWT access token from the Azure Instance Metadata Service (IMDS) endpoint. This value can also be provided with the AZURE_AD_RESOURCE environment variable.",
						MarkdownDescription: "The resource URL for the application registered in Azure Active Directory. The value is expected to match the audience (aud claim) of the JWT provided to the login API. See the resource parameter for how the audience is set when requesting a JWT access token from the Azure Instance Metadata Service (IMDS) endpoint. This value can also be provided with the AZURE_AD_RESOURCE environment variable.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"retry_delay": schema.Int64Attribute{
						Description:         "The initial amount of delay, in seconds, to use before retrying an operation. Increases exponentially",
						MarkdownDescription: "The initial amount of delay, in seconds, to use before retrying an operation. Increases exponentially",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_azure_auth_engine_config_v1alpha1_manifest")

	var model RedhatcopRedhatIoAzureAuthEngineConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AzureAuthEngineConfig")
