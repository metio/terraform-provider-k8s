...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest{}
}

type RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest struct{}

type RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		ConnectionURI   *string `tfsdk:"connection_uri" json:"connectionURI,omitempty"`
		LeaseMaxTTL     *int64  `tfsdk:"lease_max_ttl" json:"leaseMaxTTL,omitempty"`
		LeaseTTL        *int64  `tfsdk:"lease_ttl" json:"leaseTTL,omitempty"`
		...
		UsernameTemplate *string `tfsdk:"username_template" json:"usernameTemplate,omitempty"`
		VerifyConnection *bool   `tfsdk:"verify_connection" json:"verifyConnection,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_rabbit_mq_secret_engine_config_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "RabbitMQSecretEngineConfig is the Schema for the rabbitmqsecretengineconfigs API",
		MarkdownDescription: "RabbitMQSecretEngineConfig is the Schema for the rabbitmqsecretengineconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "RabbitMQSecretEngineConfigSpec defines the desired state of RabbitMQSecretEngineConfig",
				Attributes: map[string]schema.Attribute{
					...
					"connection_uri": schema.StringAttribute{
						...
						MarkdownDescription: "ConnectionURL Specifies the connection string used to connect to the RabbitMQ cluster.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"lease_max_ttl": schema.Int64Attribute{
						Description:         "Lease maximum TTL for generated credentials in seconds.",
						MarkdownDescription: "Lease maximum TTL for generated credentials in seconds.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"lease_ttl": schema.Int64Attribute{
						Description:         "Lease TTL for generated credentials in seconds.",
						MarkdownDescription: "Lease TTL for generated credentials in seconds.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"password_policy": schema.StringAttribute{
						...
						MarkdownDescription: "PasswordPolicy The name of the password policy to use when generating passwords for this engine. Defaults to generating an alphanumeric password if not set.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"path": schema.StringAttribute{
						Description:         "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/{metadata.name}/config/connection. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						MarkdownDescription: "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/{metadata.name}/config/connection. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"root_credentials": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "RootCredentials specifies how to retrieve the credentials for this RabbitMQEngine connection.",
						Attributes: map[string]schema.Attribute{
					...
					"username": schema.StringAttribute{
						...
						MarkdownDescription: "Username Specifies the name of the user to use as the 'administrator' user when connecting to the RabbitMQ cluster. This 'administrator' user is used to create/update/delete users, so you will need to ensure that this user has permissions to manipulate users. If management plugin is used, this user need to have 'administrator' tag, no additional permissions necessary. If username is provided it takes precedence over the username retrieved from the referenced secrets",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"username_template": schema.StringAttribute{
						...
						MarkdownDescription: "UsernameTemplate Vault username template describing how dynamic usernames are generated.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_rabbit_mq_secret_engine_config_v1alpha1_manifest")

	var model RedhatcopRedhatIoRabbitMqsecretEngineConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("RabbitMQSecretEngineConfig")
