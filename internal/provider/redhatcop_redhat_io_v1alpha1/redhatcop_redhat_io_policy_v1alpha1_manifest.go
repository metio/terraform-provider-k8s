...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoPolicyV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoPolicyV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoPolicyV1Alpha1Manifest{}
}

type RedhatcopRedhatIoPolicyV1Alpha1Manifest struct{}

type RedhatcopRedhatIoPolicyV1Alpha1ManifestData struct {
...
func (r *RedhatcopRedhatIoPolicyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_policy_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoPolicyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PolicySpec defines the desired state of Policy",
				Attributes: map[string]schema.Attribute{
					...
					"policy": schema.StringAttribute{
						...
						MarkdownDescription: "Policy is a Vault policy expressed in HCL language.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"type": schema.StringAttribute{
						Description:         "Type represents the policy type, currently the only supported policy type is 'acl', but in the future rgp and egp might be supported. If not specified a policy will be created at /sys/policies/<name>, if specified (the recommended approach) a policy will be created at /sys/policies/acl/<name>",
						MarkdownDescription: "Type represents the policy type, currently the only supported policy type is 'acl', but in the future rgp and egp might be supported. If not specified a policy will be created at /sys/policies/<name>, if specified (the recommended approach) a policy will be created at /sys/policies/acl/<name>",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("acl"),
						},
					},
				},
				Required: false,
...
func (r *RedhatcopRedhatIoPolicyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_policy_v1alpha1_manifest")

	var model RedhatcopRedhatIoPolicyV1Alpha1ManifestData
