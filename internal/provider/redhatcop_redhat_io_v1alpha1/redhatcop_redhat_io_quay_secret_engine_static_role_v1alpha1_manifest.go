...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest{}
}

type RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest struct{}

type RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1ManifestData struct {
...
func (r *RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_quay_secret_engine_static_role_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "QuaySecretEngineStaticRole is the Schema for the quaysecretenginestaticroles API",
		MarkdownDescription: "QuaySecretEngineStaticRole is the Schema for the quaysecretenginestaticroles API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "QuaySecretEngineStaticRoleSpec defines the desired state of QuaySecretEngineStaticRole",
				MarkdownDescription: "QuaySecretEngineStaticRoleSpec defines the desired state of QuaySecretEngineStaticRole",
				Attributes: map[string]schema.Attribute{
					...
					"path": schema.StringAttribute{
						Description:         "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/static-roles/{metadata.name}. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						MarkdownDescription: "Path at which to make the configuration. The final path in Vault will be {[spec.authentication.namespace]}/{spec.path}/static-roles/{metadata.name}. The authentication role must have the following capabilities = [ 'create', 'read', 'update', 'delete'] on that path.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_quay_secret_engine_static_role_v1alpha1_manifest")

	var model RedhatcopRedhatIoQuaySecretEngineStaticRoleV1Alpha1ManifestData
	...
	model.Kind = pointer.String("QuaySecretEngineStaticRole")
