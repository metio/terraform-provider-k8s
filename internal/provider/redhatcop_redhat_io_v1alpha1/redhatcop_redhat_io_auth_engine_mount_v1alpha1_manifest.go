...
var (
	_ datasource.DataSource = &RedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest{}
)

func NewRedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest() datasource.DataSource {
	return &RedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest{}
}

type RedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest struct{}

type RedhatcopRedhatIoAuthEngineMountV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Name        *string `tfsdk:"name" json:"name,omitempty"`
		Path        *string `tfsdk:"path" json:"path,omitempty"`
		Sealwrap    *bool   `tfsdk:"sealwrap" json:"sealwrap,omitempty"`
		Type        *string `tfsdk:"type" json:"type,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *RedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_redhatcop_redhat_io_auth_engine_mount_v1alpha1_manifest"
}

func (r *RedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AuthEngineMount is the Schema for the authenginemounts API",
		MarkdownDescription: "AuthEngineMount is the Schema for the authenginemounts API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "AuthEngineMountSpec defines the desired state of AuthEngineMount",
				Attributes: map[string]schema.Attribute{
					...
					"config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Config Specifies configuration options for this auth method.",
						Attributes: map[string]schema.Attribute{
							...
							"description": schema.StringAttribute{
								...
								MarkdownDescription: "Description another description...",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"options": schema.MapAttribute{
								...
								MarkdownDescription: "Options undocumented",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"token_type": schema.StringAttribute{
								...
								MarkdownDescription: "TokenType undocumented",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"description": schema.StringAttribute{
						...
						MarkdownDescription: "Description Specifies a human-friendly description of the auth method.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"local": schema.BoolAttribute{
						...
						MarkdownDescription: "Local Specifies if the auth method is local only. Local auth methods are not replicated nor (if a secondary) removed by replication. Logins via local auth methods do not make use of identity, i.e. no entity or groups will be attached to the token.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"type": schema.StringAttribute{
						...
						MarkdownDescription: "Type Specifies the name of the authentication method type, such as 'github' or 'token'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *RedhatcopRedhatIoAuthEngineMountV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_redhatcop_redhat_io_auth_engine_mount_v1alpha1_manifest")

	var model RedhatcopRedhatIoAuthEngineMountV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AuthEngineMount")
