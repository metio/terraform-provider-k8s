					...
					"sso": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"keycloak": schema.SingleNestedAttribute{
								Description:         "Keycloak contains the configuration for Argo CD keycloak authentication Removed: This field is no longer supported and the related functionality has been removed.",
								MarkdownDescription: "Keycloak contains the configuration for Argo CD keycloak authentication Removed: This field is no longer supported and the related functionality has been removed.",
								Attributes: map[string]schema.Attribute{
									"host": schema.StringAttribute{
										Description:         "Host is the hostname to use for Ingress/Route resources.",
										MarkdownDescription: "Host is the hostname to use for Ingress/Route resources.",
