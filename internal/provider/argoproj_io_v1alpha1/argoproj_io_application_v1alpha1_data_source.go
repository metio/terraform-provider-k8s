...
var (
	_ datasource.DataSource              = &ArgoprojIoApplicationV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ArgoprojIoApplicationV1Alpha1DataSource{}
)

func NewArgoprojIoApplicationV1Alpha1DataSource() datasource.DataSource {
	return &ArgoprojIoApplicationV1Alpha1DataSource{}
}

type ArgoprojIoApplicationV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ArgoprojIoApplicationV1Alpha1DataSourceData struct {
...
func (r *ArgoprojIoApplicationV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_argoproj_io_application_v1alpha1"
}

func (r *ArgoprojIoApplicationV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ArgoprojIoApplicationV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ArgoprojIoApplicationV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_argoproj_io_application_v1alpha1")

	var data ArgoprojIoApplicationV1Alpha1DataSourceData
	...
	var readResponse ArgoprojIoApplicationV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("Application")
