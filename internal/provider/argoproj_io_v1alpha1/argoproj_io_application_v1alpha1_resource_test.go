...
func TestArgoprojIoApplicationV1Alpha1Resource_ValidateSchema(t *testing.T) {
	ctx := context.Background()
	schemaRequest := fwresource.SchemaRequest{}
	schemaResponse := &fwresource.SchemaResponse{}

	argoproj_io_v1alpha1.NewArgoprojIoApplicationV1Alpha1Resource().Schema(ctx, schemaRequest, schemaResponse)
