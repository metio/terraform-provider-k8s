...
func TestHiveinternalOpenshiftIoClusterSyncLeaseV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_hiveinternal_openshift_io_cluster_sync_lease_v1alpha1_manifest", testCase)
		})
	}
}
