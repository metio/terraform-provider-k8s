...
func TestExternaldnsK8SIoDNSEndpointV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_externaldns_k8s_io_dns_endpoint_v1alpha1_manifest", testCase)
		})
	}
}
