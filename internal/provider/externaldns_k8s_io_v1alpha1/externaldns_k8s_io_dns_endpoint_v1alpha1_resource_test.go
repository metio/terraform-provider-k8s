...
func TestExternaldnsK8SIoDNSEndpointV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_externaldns_k8s_io_dns_endpoint_v1alpha1", testCase)
		})
	}
}
