...
var (
	_ resource.Resource = (*ExternalSecretsIoClusterSecretStoreV1Beta1Resource)(nil)
)

type ExternalSecretsIoClusterSecretStoreV1Beta1TerraformModel struct {
...
type ExternalSecretsIoClusterSecretStoreV1Beta1GoModel struct {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_external_secrets_io_cluster_secret_store_v1beta1"
}

func (r *ExternalSecretsIoClusterSecretStoreV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_external_secrets_io_cluster_secret_store_v1beta1")

	var state ExternalSecretsIoClusterSecretStoreV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ExternalSecretsIoClusterSecretStoreV1Beta1GoModel
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_external_secrets_io_cluster_secret_store_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *ExternalSecretsIoClusterSecretStoreV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ExternalSecretsIoClusterSecretStoreV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
