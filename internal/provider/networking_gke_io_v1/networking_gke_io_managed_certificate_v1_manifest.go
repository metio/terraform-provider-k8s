...
var (
	_ datasource.DataSource = &NetworkingGkeIoManagedCertificateV1Manifest{}
)

func NewNetworkingGkeIoManagedCertificateV1Manifest() datasource.DataSource {
	return &NetworkingGkeIoManagedCertificateV1Manifest{}
}

type NetworkingGkeIoManagedCertificateV1Manifest struct{}

type NetworkingGkeIoManagedCertificateV1ManifestData struct {
...
func (r *NetworkingGkeIoManagedCertificateV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_gke_io_managed_certificate_v1_manifest"
}
...
func (r *NetworkingGkeIoManagedCertificateV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_gke_io_managed_certificate_v1_manifest")

	var model NetworkingGkeIoManagedCertificateV1ManifestData
	...
	model.Kind = pointer.String("ManagedCertificate")
