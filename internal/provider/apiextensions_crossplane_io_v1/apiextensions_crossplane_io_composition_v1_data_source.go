...
var (
	_ datasource.DataSource              = &ApiextensionsCrossplaneIoCompositionV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ApiextensionsCrossplaneIoCompositionV1DataSource{}
)

func NewApiextensionsCrossplaneIoCompositionV1DataSource() datasource.DataSource {
	return &ApiextensionsCrossplaneIoCompositionV1DataSource{}
}

type ApiextensionsCrossplaneIoCompositionV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ApiextensionsCrossplaneIoCompositionV1DataSourceData struct {
...
func (r *ApiextensionsCrossplaneIoCompositionV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apiextensions_crossplane_io_composition_v1"
}

func (r *ApiextensionsCrossplaneIoCompositionV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apiextensions_crossplane_io_composition_v1")

	var data ApiextensionsCrossplaneIoCompositionV1DataSourceData
	...
	var readResponse ApiextensionsCrossplaneIoCompositionV1DataSourceData
	...
	data.Kind = pointer.String("Composition")
