...
var (
	_ datasource.DataSource              = &ApiextensionsCrossplaneIoCompositionRevisionV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ApiextensionsCrossplaneIoCompositionRevisionV1DataSource{}
)

func NewApiextensionsCrossplaneIoCompositionRevisionV1DataSource() datasource.DataSource {
	return &ApiextensionsCrossplaneIoCompositionRevisionV1DataSource{}
}

type ApiextensionsCrossplaneIoCompositionRevisionV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ApiextensionsCrossplaneIoCompositionRevisionV1DataSourceData struct {
...
func (r *ApiextensionsCrossplaneIoCompositionRevisionV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apiextensions_crossplane_io_composition_revision_v1"
}

func (r *ApiextensionsCrossplaneIoCompositionRevisionV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionRevisionV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionRevisionV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apiextensions_crossplane_io_composition_revision_v1")

	var data ApiextensionsCrossplaneIoCompositionRevisionV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "apiextensions.crossplane.io", Version: "v1", Resource: "CompositionRevision"}).
	...
	var readResponse ApiextensionsCrossplaneIoCompositionRevisionV1DataSourceData
	...
	data.Kind = pointer.String("CompositionRevision")
