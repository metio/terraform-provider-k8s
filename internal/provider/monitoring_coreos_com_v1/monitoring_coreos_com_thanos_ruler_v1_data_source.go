...
var (
	_ datasource.DataSource              = &MonitoringCoreosComThanosRulerV1DataSource{}
	_ datasource.DataSourceWithConfigure = &MonitoringCoreosComThanosRulerV1DataSource{}
)

func NewMonitoringCoreosComThanosRulerV1DataSource() datasource.DataSource {
	return &MonitoringCoreosComThanosRulerV1DataSource{}
}

type MonitoringCoreosComThanosRulerV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MonitoringCoreosComThanosRulerV1DataSourceData struct {
...
func (r *MonitoringCoreosComThanosRulerV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_thanos_ruler_v1"
}

func (r *MonitoringCoreosComThanosRulerV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MonitoringCoreosComThanosRulerV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MonitoringCoreosComThanosRulerV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_monitoring_coreos_com_thanos_ruler_v1")

	var data MonitoringCoreosComThanosRulerV1DataSourceData
	...
	var readResponse MonitoringCoreosComThanosRulerV1DataSourceData
	...
	data.Kind = pointer.String("ThanosRuler")
