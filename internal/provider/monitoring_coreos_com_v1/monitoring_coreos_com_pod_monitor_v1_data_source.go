...
var (
	_ datasource.DataSource              = &MonitoringCoreosComPodMonitorV1DataSource{}
	_ datasource.DataSourceWithConfigure = &MonitoringCoreosComPodMonitorV1DataSource{}
)

func NewMonitoringCoreosComPodMonitorV1DataSource() datasource.DataSource {
	return &MonitoringCoreosComPodMonitorV1DataSource{}
}

type MonitoringCoreosComPodMonitorV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MonitoringCoreosComPodMonitorV1DataSourceData struct {
...
func (r *MonitoringCoreosComPodMonitorV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_pod_monitor_v1"
}

func (r *MonitoringCoreosComPodMonitorV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MonitoringCoreosComPodMonitorV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MonitoringCoreosComPodMonitorV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_monitoring_coreos_com_pod_monitor_v1")

	var data MonitoringCoreosComPodMonitorV1DataSourceData
	...
	var readResponse MonitoringCoreosComPodMonitorV1DataSourceData
	...
	data.Kind = pointer.String("PodMonitor")
