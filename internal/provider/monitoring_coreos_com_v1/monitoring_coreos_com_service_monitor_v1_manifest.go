...
var (
	_ datasource.DataSource = &MonitoringCoreosComServiceMonitorV1Manifest{}
)

func NewMonitoringCoreosComServiceMonitorV1Manifest() datasource.DataSource {
	return &MonitoringCoreosComServiceMonitorV1Manifest{}
}

type MonitoringCoreosComServiceMonitorV1Manifest struct{}

type MonitoringCoreosComServiceMonitorV1ManifestData struct {
...
func (r *MonitoringCoreosComServiceMonitorV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_service_monitor_v1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "Specification of desired Service selection for target discovery byPrometheus.",
				MarkdownDescription: "Specification of desired Service selection for target discovery byPrometheus.",
				Attributes: map[string]schema.Attribute{
...
func (r *MonitoringCoreosComServiceMonitorV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_monitoring_coreos_com_service_monitor_v1_manifest")

	var model MonitoringCoreosComServiceMonitorV1ManifestData
	...
	model.Kind = pointer.String("ServiceMonitor")
