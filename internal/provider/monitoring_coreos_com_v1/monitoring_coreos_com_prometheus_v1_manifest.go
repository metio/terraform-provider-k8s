...
var (
	_ datasource.DataSource = &MonitoringCoreosComPrometheusV1Manifest{}
)

func NewMonitoringCoreosComPrometheusV1Manifest() datasource.DataSource {
	return &MonitoringCoreosComPrometheusV1Manifest{}
}

type MonitoringCoreosComPrometheusV1Manifest struct{}

type MonitoringCoreosComPrometheusV1ManifestData struct {
...
func (r *MonitoringCoreosComPrometheusV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_prometheus_v1_manifest"
}

func (r *MonitoringCoreosComPrometheusV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MonitoringCoreosComPrometheusV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_monitoring_coreos_com_prometheus_v1_manifest")

	var model MonitoringCoreosComPrometheusV1ManifestData
