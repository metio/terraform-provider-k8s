...
var (
	_ datasource.DataSource              = &MonitoringCoreosComAlertmanagerV1DataSource{}
	_ datasource.DataSourceWithConfigure = &MonitoringCoreosComAlertmanagerV1DataSource{}
)

func NewMonitoringCoreosComAlertmanagerV1DataSource() datasource.DataSource {
	return &MonitoringCoreosComAlertmanagerV1DataSource{}
}

type MonitoringCoreosComAlertmanagerV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MonitoringCoreosComAlertmanagerV1DataSourceData struct {
...
func (r *MonitoringCoreosComAlertmanagerV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_alertmanager_v1"
}

func (r *MonitoringCoreosComAlertmanagerV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"alertmanager_configuration": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "EXPERIMENTAL: alertmanagerConfiguration specifies the configuration of Alertmanager. If defined, it takes precedence over the 'configSecret' field. This field may change in future releases.",
						Attributes: map[string]schema.Attribute{
...
func (r *MonitoringCoreosComAlertmanagerV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MonitoringCoreosComAlertmanagerV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_monitoring_coreos_com_alertmanager_v1")

	var data MonitoringCoreosComAlertmanagerV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "monitoring.coreos.com", Version: "v1", Resource: "Alertmanager"}).
	...
	var readResponse MonitoringCoreosComAlertmanagerV1DataSourceData
	...
	data.Kind = pointer.String("Alertmanager")
