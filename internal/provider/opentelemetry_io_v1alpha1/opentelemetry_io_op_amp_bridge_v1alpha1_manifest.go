...
var (
	_ datasource.DataSource = &OpentelemetryIoOpAmpbridgeV1Alpha1Manifest{}
)

func NewOpentelemetryIoOpAmpbridgeV1Alpha1Manifest() datasource.DataSource {
	return &OpentelemetryIoOpAmpbridgeV1Alpha1Manifest{}
}

type OpentelemetryIoOpAmpbridgeV1Alpha1Manifest struct{}

type OpentelemetryIoOpAmpbridgeV1Alpha1ManifestData struct {
...
func (r *OpentelemetryIoOpAmpbridgeV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_opentelemetry_io_op_amp_bridge_v1alpha1_manifest"
}

func (r *OpentelemetryIoOpAmpbridgeV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"components_allowed": schema.MapAttribute{
						Description:         "",
						MarkdownDescription: "",
...
func (r *OpentelemetryIoOpAmpbridgeV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_opentelemetry_io_op_amp_bridge_v1alpha1_manifest")

	var model OpentelemetryIoOpAmpbridgeV1Alpha1ManifestData
	...
	model.Kind = pointer.String("OpAMPBridge")
