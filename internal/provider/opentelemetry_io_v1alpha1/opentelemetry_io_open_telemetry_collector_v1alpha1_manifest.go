...
var (
	_ datasource.DataSource = &OpentelemetryIoOpenTelemetryCollectorV1Alpha1Manifest{}
)

func NewOpentelemetryIoOpenTelemetryCollectorV1Alpha1Manifest() datasource.DataSource {
	return &OpentelemetryIoOpenTelemetryCollectorV1Alpha1Manifest{}
}

type OpentelemetryIoOpenTelemetryCollectorV1Alpha1Manifest struct{}

type OpentelemetryIoOpenTelemetryCollectorV1Alpha1ManifestData struct {
...
func (r *OpentelemetryIoOpenTelemetryCollectorV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_opentelemetry_io_open_telemetry_collector_v1alpha1_manifest"
}
...
func (r *OpentelemetryIoOpenTelemetryCollectorV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_opentelemetry_io_open_telemetry_collector_v1alpha1_manifest")

	var model OpentelemetryIoOpenTelemetryCollectorV1Alpha1ManifestData
