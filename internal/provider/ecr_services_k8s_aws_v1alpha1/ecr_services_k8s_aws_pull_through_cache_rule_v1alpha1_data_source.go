...
var (
	_ datasource.DataSource              = &EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource{}
)

func NewEcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource() datasource.DataSource {
	return &EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource{}
}

type EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSourceData struct {
...
func (r *EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ecr_services_k8s_aws_pull_through_cache_rule_v1alpha1"
}

func (r *EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_ecr_services_k8s_aws_pull_through_cache_rule_v1alpha1")

	var data EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSourceData
	...
	var readResponse EcrServicesK8SAwsPullThroughCacheRuleV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("PullThroughCacheRule")
