...
type SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource)(nil)
)

type SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1TerraformModel struct {
...
type SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		ModelBiasAppSpecification *struct {
			ConfigURI *string `tfsdk:"config_uri" yaml:"configURI,omitempty"`
		...
		} `tfsdk:"model_bias_app_specification" yaml:"modelBiasAppSpecification,omitempty"`
		...
		} `tfsdk:"model_bias_baseline_config" yaml:"modelBiasBaselineConfig,omitempty"`
		...
		} `tfsdk:"model_bias_job_input" yaml:"modelBiasJobInput,omitempty"`
		...
		} `tfsdk:"model_bias_job_output_config" yaml:"modelBiasJobOutputConfig,omitempty"`
...
func NewSagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource() resource.Resource {
	return &SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource{}
}

func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1"
}

func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1")

	var state SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("ModelBiasJobDefinition")
...
func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1")
...
func (r *SagemakerServicesK8SAwsModelBiasJobDefinitionV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_sagemaker_services_k8s_aws_model_bias_job_definition_v1alpha1")
