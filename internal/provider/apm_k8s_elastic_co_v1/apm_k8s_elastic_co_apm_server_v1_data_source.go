...
var (
	_ datasource.DataSource              = &ApmK8SElasticCoApmServerV1DataSource{}
	_ datasource.DataSourceWithConfigure = &ApmK8SElasticCoApmServerV1DataSource{}
)

func NewApmK8SElasticCoApmServerV1DataSource() datasource.DataSource {
	return &ApmK8SElasticCoApmServerV1DataSource{}
}

type ApmK8SElasticCoApmServerV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ApmK8SElasticCoApmServerV1DataSourceData struct {
...
func (r *ApmK8SElasticCoApmServerV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apm_k8s_elastic_co_apm_server_v1"
}

func (r *ApmK8SElasticCoApmServerV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApmK8SElasticCoApmServerV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ApmK8SElasticCoApmServerV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apm_k8s_elastic_co_apm_server_v1")

	var data ApmK8SElasticCoApmServerV1DataSourceData
	...
	var readResponse ApmK8SElasticCoApmServerV1DataSourceData
	...
	data.ApiVersion = pointer.String("apm.k8s.elastic.co/v1")
