...
func TestApmK8SElasticCoApmServerV1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_apm_k8s_elastic_co_apm_server_v1_manifest", testCase)
		})
	}
}
