...
var (
	_ datasource.DataSource = &ApmK8SElasticCoApmServerV1Manifest{}
)

func NewApmK8SElasticCoApmServerV1Manifest() datasource.DataSource {
	return &ApmK8SElasticCoApmServerV1Manifest{}
}
...
func (r *ApmK8SElasticCoApmServerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apm_k8s_elastic_co_apm_server_v1_manifest"
}

func (r *ApmK8SElasticCoApmServerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApmK8SElasticCoApmServerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apm_k8s_elastic_co_apm_server_v1_manifest")

	var model ApmK8SElasticCoApmServerV1ManifestData
