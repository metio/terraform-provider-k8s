...
var (
	_ datasource.DataSource = &JobsmanagerRaczyloComManagedJobV1Beta1Manifest{}
)

func NewJobsmanagerRaczyloComManagedJobV1Beta1Manifest() datasource.DataSource {
	return &JobsmanagerRaczyloComManagedJobV1Beta1Manifest{}
}
...
func (r *JobsmanagerRaczyloComManagedJobV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_jobsmanager_raczylo_com_managed_job_v1beta1_manifest"
}

func (r *JobsmanagerRaczyloComManagedJobV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *JobsmanagerRaczyloComManagedJobV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_jobsmanager_raczylo_com_managed_job_v1beta1_manifest")

	var model JobsmanagerRaczyloComManagedJobV1Beta1ManifestData
