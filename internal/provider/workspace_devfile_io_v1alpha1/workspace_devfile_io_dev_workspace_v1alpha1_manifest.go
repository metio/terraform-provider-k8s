...
var (
	_ datasource.DataSource = &WorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest{}
)

func NewWorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest() datasource.DataSource {
	return &WorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest{}
}

type WorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest struct{}

type WorkspaceDevfileIoDevWorkspaceV1Alpha1ManifestData struct {
	...
	Spec *struct {
		RoutingClass *string `tfsdk:"routing_class" json:"routingClass,omitempty"`
		...
		Template     *struct {
			Commands *[]struct {
				...
				} `tfsdk:"vscode_launch" json:"vscodeLaunch,omitempty"`
				VscodeTask *struct {
					Attributes *map[string]string `tfsdk:"attributes" json:"attributes,omitempty"`
					Group      *struct {
						IsDefault *bool   `tfsdk:"is_default" json:"isDefault,omitempty"`
					...
					LocationType *string `tfsdk:"location_type" json:"locationType,omitempty"`
					Uri          *string `tfsdk:"uri" json:"uri,omitempty"`
				} `tfsdk:"vscode_task" json:"vscodeTask,omitempty"`
			...
			Parent *struct {
				...
				Projects *[]struct {
					...
					Git *struct {
						...
						SparseCheckoutDir *string            `tfsdk:"sparse_checkout_dir" json:"sparseCheckoutDir,omitempty"`
...
func (r *WorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_workspace_devfile_io_dev_workspace_v1alpha1_manifest"
}

func (r *WorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"routing_class": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
												...
												"group": schema.SingleNestedAttribute{
													...
													Attributes: map[string]schema.Attribute{
														...
														"kind": schema.StringAttribute{
															...
															Computed:            false,
															Validators: []validator.String{
																stringvalidator.OneOf("build", "run", "test", "debug"),
															},
														},
													},
													Required: false,
										...
										"command_type": schema.StringAttribute{
											...
											MarkdownDescription: "Type of workspace command",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.String{
												stringvalidator.OneOf("Exec", "Apply", "VscodeTask", "VscodeLaunch", "Composite", "Custom"),
											},
										},
										...
										"exec": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"command_line": schema.StringAttribute{
													Description:         "The actual command-line string Special variables that can be used: - '$PROJECTS_ROOT': A path where projects sources are mounted - '$PROJECT_SOURCE': A path to a project source ($PROJECTS_ROOT/<project-name>). If there are multiple projects, this will point to the directory of the first one.",
													MarkdownDescription: "The actual command-line string Special variables that can be used: - '$PROJECTS_ROOT': A path where projects sources are mounted - '$PROJECT_SOURCE': A path to a project source ($PROJECTS_ROOT/<project-name>). If there are multiple projects, this will point to the directory of the first one.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
										...
										"vscode_launch": schema.SingleNestedAttribute{
											Description:         "Command providing the definition of a VsCode launch action Deprecated; removed in v1alpha2",
											MarkdownDescription: "Command providing the definition of a VsCode launch action Deprecated; removed in v1alpha2",
											Attributes: map[string]schema.Attribute{
												"attributes": schema.MapAttribute{
													Description:         "Optional map of free-form additional command attributes",
													MarkdownDescription: "Optional map of free-form additional command attributes",
												...
												"location_type": schema.StringAttribute{
													...
													MarkdownDescription: "Type of Vscode configuration command location",
													Required:            false,
													Optional:            true,
													Computed:            false,
													Validators: []validator.String{
										...
										"vscode_task": schema.SingleNestedAttribute{
											Description:         "Command providing the definition of a VsCode Task Deprecated; removed in v1alpha2",
											MarkdownDescription: "Command providing the definition of a VsCode Task Deprecated; removed in v1alpha2",
											Attributes: map[string]schema.Attribute{
												"attributes": schema.MapAttribute{
													Description:         "Optional map of free-form additional command attributes",
													MarkdownDescription: "Optional map of free-form additional command attributes",
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"component_type": schema.StringAttribute{
											...
											Computed:            false,
											Validators: []validator.String{
												stringvalidator.OneOf("Container", "Kubernetes", "Openshift", "Volume", "Plugin", "Custom"),
											},
										},
													...
													NestedObject: schema.NestedAttributeObject{
														Attributes: map[string]schema.Attribute{
															"component_type": schema.StringAttribute{
																...
																MarkdownDescription: "Type of component override for a plugin",
																Required:            false,
																Optional:            true,
																Computed:            false,
																Validators: []validator.String{
																	stringvalidator.OneOf("Container", "Kubernetes", "Openshift", "Volume"),
																},
															},
							...
							"parent": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
											...
											Attributes: map[string]schema.Attribute{
												...
												"git": schema.SingleNestedAttribute{
													...
													Attributes: map[string]schema.Attribute{
														...
														"sparse_checkout_dir": schema.StringAttribute{
												...
												"source_type": schema.StringAttribute{
													...
													Computed:            false,
													Validators: []validator.String{
														stringvalidator.OneOf("Git", "Github", "Zip", "Custom"),
													},
												},
									...
									"starter_projects": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Overrides of starter projects encapsulated in a parent devfile Overriding is done using a strategic merge patch.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"clone_path": schema.StringAttribute{
													Description:         "Path relative to the root of the projects to which this project should be cloned into. This is a unix-style relative path (i.e. uses forward slashes). The path is invalid if it is absolute or tries to escape the project root through the usage of '..'. If not specified, defaults to the project name.",
...
func (r *WorkspaceDevfileIoDevWorkspaceV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_workspace_devfile_io_dev_workspace_v1alpha1_manifest")

	var model WorkspaceDevfileIoDevWorkspaceV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("workspace.devfile.io/v1alpha1")
	model.Kind = pointer.String("DevWorkspace")
