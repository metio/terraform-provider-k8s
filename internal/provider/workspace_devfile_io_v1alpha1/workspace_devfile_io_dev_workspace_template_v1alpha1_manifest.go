...
var (
	_ datasource.DataSource = &WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest{}
)

func NewWorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest() datasource.DataSource {
	return &WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest{}
}

type WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest struct{}

type WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1ManifestData struct {
...
func (r *WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_workspace_devfile_io_dev_workspace_template_v1alpha1_manifest"
}

func (r *WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_workspace_devfile_io_dev_workspace_template_v1alpha1_manifest")

	var model WorkspaceDevfileIoDevWorkspaceTemplateV1Alpha1ManifestData
