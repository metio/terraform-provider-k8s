...
var (
	_ resource.Resource = (*HazelcastComManagementCenterV1Alpha1Resource)(nil)
)

type HazelcastComManagementCenterV1Alpha1TerraformModel struct {
...
type HazelcastComManagementCenterV1Alpha1GoModel struct {
...
func (r *HazelcastComManagementCenterV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_hazelcast_com_management_center_v1alpha1"
}

func (r *HazelcastComManagementCenterV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		...
		Attributes: map[string]tfsdk.Attribute{
			...
			"spec": {
				...
				MarkdownDescription: "ManagementCenterSpec defines the desired state of ManagementCenter.",
...
func (r *HazelcastComManagementCenterV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_hazelcast_com_management_center_v1alpha1")

	var state HazelcastComManagementCenterV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel HazelcastComManagementCenterV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("ManagementCenter")
...
func (r *HazelcastComManagementCenterV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_hazelcast_com_management_center_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *HazelcastComManagementCenterV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *HazelcastComManagementCenterV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
