...
var (
	_ datasource.DataSource = &LeaksignalComLeaksignalIstioV1Manifest{}
)

func NewLeaksignalComLeaksignalIstioV1Manifest() datasource.DataSource {
	return &LeaksignalComLeaksignalIstioV1Manifest{}
}

type LeaksignalComLeaksignalIstioV1Manifest struct{}

type LeaksignalComLeaksignalIstioV1ManifestData struct {
	...
	Spec *struct {
		...
		IstioName                *string `tfsdk:"istio_name" json:"istioName,omitempty"`
...
func (r *LeaksignalComLeaksignalIstioV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_leaksignal_com_leaksignal_istio_v1_manifest"
}

func (r *LeaksignalComLeaksignalIstioV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Deploy LeakSignal Proxy in a specific namespace.",
		MarkdownDescription: "Deploy LeakSignal Proxy in a specific namespace.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"istio_name": schema.StringAttribute{
						Description:         "If set, use an alternate name for created EnvoyFilter objects, to allow multiple LeaksignalIstio objects in one namespace.",
						MarkdownDescription: "If set, use an alternate name for created EnvoyFilter objects, to allow multiple LeaksignalIstio objects in one namespace.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"proxy_pull_location": schema.StringAttribute{
						Description:         "Format 'https?://domain(:port)?/'. Defaults to being based on 'upstreamLocation', 'upstreamPort', 'tls', and 'proxyPrefix'.",
						MarkdownDescription: "Format 'https?://domain(:port)?/'. Defaults to being based on 'upstreamLocation', 'upstreamPort', 'tls', and 'proxyPrefix'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *LeaksignalComLeaksignalIstioV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_leaksignal_com_leaksignal_istio_v1_manifest")

	var model LeaksignalComLeaksignalIstioV1ManifestData
	...
	model.Kind = pointer.String("LeaksignalIstio")
