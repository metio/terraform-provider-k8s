...
var (
	_ datasource.DataSource = &ShipwrightIoBuildV1Beta1Manifest{}
)

func NewShipwrightIoBuildV1Beta1Manifest() datasource.DataSource {
	return &ShipwrightIoBuildV1Beta1Manifest{}
}

type ShipwrightIoBuildV1Beta1Manifest struct{}

type ShipwrightIoBuildV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		Output       *struct {
			...
			VulnerabilityScan *struct {
				...
				FailOnFinding *bool `tfsdk:"fail_on_finding" json:"failOnFinding,omitempty"`
				Ignore        *struct {
					Id       *[]string `tfsdk:"id" json:"id,omitempty"`
					Severity *string   `tfsdk:"severity" json:"severity,omitempty"`
					Unfixed  *bool     `tfsdk:"unfixed" json:"unfixed,omitempty"`
				} `tfsdk:"ignore" json:"ignore,omitempty"`
			} `tfsdk:"vulnerability_scan" json:"vulnerabilityScan,omitempty"`
		} `tfsdk:"output" json:"output,omitempty"`
		ParamValues *[]struct {
			ConfigMapValue *struct {
				Format *string `tfsdk:"format" json:"format,omitempty"`
				Key    *string `tfsdk:"key" json:"key,omitempty"`
				Name   *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"config_map_value" json:"configMapValue,omitempty"`
			Name        *string `tfsdk:"name" json:"name,omitempty"`
			SecretValue *struct {
				Format *string `tfsdk:"format" json:"format,omitempty"`
				Key    *string `tfsdk:"key" json:"key,omitempty"`
				Name   *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"secret_value" json:"secretValue,omitempty"`
			Value  *string `tfsdk:"value" json:"value,omitempty"`
			Values *[]struct {
				ConfigMapValue *struct {
					Format *string `tfsdk:"format" json:"format,omitempty"`
		...
		} `tfsdk:"param_values" json:"paramValues,omitempty"`
		Retention *struct {
			AtBuildDeletion   *bool   `tfsdk:"at_build_deletion" json:"atBuildDeletion,omitempty"`
			FailedLimit       *int64  `tfsdk:"failed_limit" json:"failedLimit,omitempty"`
			SucceededLimit    *int64  `tfsdk:"succeeded_limit" json:"succeededLimit,omitempty"`
			TtlAfterFailed    *string `tfsdk:"ttl_after_failed" json:"ttlAfterFailed,omitempty"`
			TtlAfterSucceeded *string `tfsdk:"ttl_after_succeeded" json:"ttlAfterSucceeded,omitempty"`
		} `tfsdk:"retention" json:"retention,omitempty"`
		SchedulerName *string `tfsdk:"scheduler_name" json:"schedulerName,omitempty"`
		Source        *struct {
			ContextDir *string `tfsdk:"context_dir" json:"contextDir,omitempty"`
			Git        *struct {
				CloneSecret *string `tfsdk:"clone_secret" json:"cloneSecret,omitempty"`
			...
			OciArtifact *struct {
				Image      *string `tfsdk:"image" json:"image,omitempty"`
				Prune      *string `tfsdk:"prune" json:"prune,omitempty"`
				PullSecret *string `tfsdk:"pull_secret" json:"pullSecret,omitempty"`
			} `tfsdk:"oci_artifact" json:"ociArtifact,omitempty"`
		...
		Trigger *struct {
			TriggerSecret *string `tfsdk:"trigger_secret" json:"triggerSecret,omitempty"`
			When          *[]struct {
				Github *struct {
				...
				} `tfsdk:"object_ref" json:"objectRef,omitempty"`
				Type *string `tfsdk:"type" json:"type,omitempty"`
...
func (r *ShipwrightIoBuildV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_build_v1beta1_manifest"
}

func (r *ShipwrightIoBuildV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Build is the Schema representing a Build definition",
		MarkdownDescription: "Build is the Schema representing a Build definition",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BuildSpec defines the desired state of Build",
				Attributes: map[string]schema.Attribute{
					"env": schema.ListNestedAttribute{
						Description:         "Env contains additional environment variables that should be passed to the build container",
						MarkdownDescription: "Env contains additional environment variables that should be passed to the build container",
					...
					"output": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Output refers to the location where the built image would be pushed.",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations references the additional annotations to be applied on the image",
								MarkdownDescription: "Annotations references the additional annotations to be applied on the image",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"image": schema.StringAttribute{
								...
								MarkdownDescription: "Image is the reference of the image.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
							...
							"insecure": schema.BoolAttribute{
								...
								MarkdownDescription: "Insecure defines whether the registry is not secure",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"labels": schema.MapAttribute{
								...
								MarkdownDescription: "Labels references the additional labels to be applied on the image",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"push_secret": schema.StringAttribute{
								...
								MarkdownDescription: "Describes the secret name for pushing a container image.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"timestamp": schema.StringAttribute{
								Description:         "Timestamp references the optional image timestamp to be set, valid values are: - 'Zero', to set 00:00:00 UTC on 1 January 1970 - 'SourceTimestamp', to set the source timestamp dereived from the input source - 'BuildTimestamp', to set the timestamp of the current build itself - Parsable integer number defined as the epoch seconds - or nil/empty to not set any specific timestamp",
								MarkdownDescription: "Timestamp references the optional image timestamp to be set, valid values are: - 'Zero', to set 00:00:00 UTC on 1 January 1970 - 'SourceTimestamp', to set the source timestamp dereived from the input source - 'BuildTimestamp', to set the timestamp of the current build itself - Parsable integer number defined as the epoch seconds - or nil/empty to not set any specific timestamp",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"vulnerability_scan": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "VulnerabilityScan provides configurations about running a scan for your generated image",
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
										Description:         "Enabled indicates whether to run vulnerability scan for image",
										MarkdownDescription: "Enabled indicates whether to run vulnerability scan for image",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},

									"fail_on_finding": schema.BoolAttribute{
										Description:         "FailOnFinding indicates whether to fail the build run if the vulnerability scan results in vulnerabilities",
										MarkdownDescription: "FailOnFinding indicates whether to fail the build run if the vulnerability scan results in vulnerabilities",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"ignore": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Ignore refers to ignore options for vulnerability scan",
										Attributes: map[string]schema.Attribute{
											"id": schema.ListAttribute{
												Description:         "ID references the security issues to be ignored in vulnerability scan",
												MarkdownDescription: "ID references the security issues to be ignored in vulnerability scan",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
											...
											"severity": schema.StringAttribute{
												Description:         "Severity denotes the severity levels of security issues to be ignored, valid values are: - 'low': it will exclude low severity vulnerabilities, displaying only medium, high and critical vulnerabilities - 'medium': it will exclude low and medium severity vulnerabilities, displaying only high and critical vulnerabilities - 'high': it will exclude low, medium and high severity vulnerabilities, displaying only the critical vulnerabilities",
												MarkdownDescription: "Severity denotes the severity levels of security issues to be ignored, valid values are: - 'low': it will exclude low severity vulnerabilities, displaying only medium, high and critical vulnerabilities - 'medium': it will exclude low and medium severity vulnerabilities, displaying only high and critical vulnerabilities - 'high': it will exclude low, medium and high severity vulnerabilities, displaying only the critical vulnerabilities",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
											...
											"unfixed": schema.BoolAttribute{
												Description:         "Unfixed indicates to ignore vulnerabilities for which no fix exists",
												MarkdownDescription: "Unfixed indicates to ignore vulnerabilities for which no fix exists",
												Required:            false,
												Optional:            true,
												Computed:            false,
											},
					...
					"param_values": schema.ListNestedAttribute{
						Description:         "Params is a list of key/value that could be used to set strategy parameters",
						MarkdownDescription: "Params is a list of key/value that could be used to set strategy parameters",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"config_map_value": schema.SingleNestedAttribute{
									Description:         "The ConfigMap value of the parameter",
									MarkdownDescription: "The ConfigMap value of the parameter",
									Attributes: map[string]schema.Attribute{
										"format": schema.StringAttribute{
											...
											MarkdownDescription: "An optional format to add pre- or suffix to the object value. For example 'KEY=${SECRET_VALUE}' or 'KEY=${CONFIGMAP_VALUE}' depending on the context.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"key": schema.StringAttribute{
											...
											MarkdownDescription: "Key inside the object",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
								...
								"secret_value": schema.SingleNestedAttribute{
									...
									MarkdownDescription: "The secret value of the parameter",
									Attributes: map[string]schema.Attribute{
										"format": schema.StringAttribute{
											Description:         "An optional format to add pre- or suffix to the object value. For example 'KEY=${SECRET_VALUE}' or 'KEY=${CONFIGMAP_VALUE}' depending on the context.",
											MarkdownDescription: "An optional format to add pre- or suffix to the object value. For example 'KEY=${SECRET_VALUE}' or 'KEY=${CONFIGMAP_VALUE}' depending on the context.",
								...
								"values": schema.ListNestedAttribute{
									...
									MarkdownDescription: "Values of an array parameter",
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"config_map_value": schema.SingleNestedAttribute{
												Description:         "The ConfigMap value of the parameter",
					...
					"retention": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Contains information about retention params",
						Attributes: map[string]schema.Attribute{
							"at_build_deletion": schema.BoolAttribute{
								Description:         "AtBuildDeletion defines if related BuildRuns should be deleted when deleting the Build.",
								MarkdownDescription: "AtBuildDeletion defines if related BuildRuns should be deleted when deleting the Build.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"failed_limit": schema.Int64Attribute{
								Description:         "FailedLimit defines the maximum number of failed buildruns that should exist.",
								MarkdownDescription: "FailedLimit defines the maximum number of failed buildruns that should exist.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"succeeded_limit": schema.Int64Attribute{
								Description:         "SucceededLimit defines the maximum number of succeeded buildruns that should exist.",
								MarkdownDescription: "SucceededLimit defines the maximum number of succeeded buildruns that should exist.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
							...
							"ttl_after_failed": schema.StringAttribute{
								Description:         "TTLAfterFailed defines the maximum duration of time the failed buildrun should exist.",
								MarkdownDescription: "TTLAfterFailed defines the maximum duration of time the failed buildrun should exist.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"ttl_after_succeeded": schema.StringAttribute{
								Description:         "TTLAfterSucceeded defines the maximum duration of time the succeeded buildrun should exist.",
								MarkdownDescription: "TTLAfterSucceeded defines the maximum duration of time the succeeded buildrun should exist.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"scheduler_name": schema.StringAttribute{
						...
						MarkdownDescription: "SchedulerName specifies the scheduler to be used to dispatch the Pod",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"source": schema.SingleNestedAttribute{
						Description:         "Source refers to the location where the source code is, this could be a git repository, a local source or an oci artifact",
						MarkdownDescription: "Source refers to the location where the source code is, this could be a git repository, a local source or an oci artifact",
						Attributes: map[string]schema.Attribute{
							"context_dir": schema.StringAttribute{
								Description:         "ContextDir is a path to a subdirectory within the source code that should be used as the build root directory. Optional.",
								MarkdownDescription: "ContextDir is a path to a subdirectory within the source code that should be used as the build root directory. Optional.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"git": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Git contains the details for obtaining source code from a git repository.",
								Attributes: map[string]schema.Attribute{
									"clone_secret": schema.StringAttribute{
										Description:         "CloneSecret references a Secret that contains credentials to access the repository.",
										MarkdownDescription: "CloneSecret references a Secret that contains credentials to access the repository.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"depth": schema.Int64Attribute{
										Description:         "Depth specifies the depth of the shallow clone. If not specified the default is set to 1. Values greater than 1 will create a clone with the specified depth. If value is 0, it will create a full git history clone.",
										MarkdownDescription: "Depth specifies the depth of the shallow clone. If not specified the default is set to 1. Values greater than 1 will create a clone with the specified depth. If value is 0, it will create a full git history clone.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"revision": schema.StringAttribute{
										Description:         "Revision describes the Git revision (e.g., branch, tag, commit SHA, etc.) to fetch. If not defined, it will fallback to the repository's default branch.",
										MarkdownDescription: "Revision describes the Git revision (e.g., branch, tag, commit SHA, etc.) to fetch. If not defined, it will fallback to the repository's default branch.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"url": schema.StringAttribute{
										...
										MarkdownDescription: "URL describes the URL of the Git repository.",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
							...
							"local": schema.SingleNestedAttribute{
								Description:         "Local contains the details for obtaining source code that is streamed in from a remote machine's local directory.",
								MarkdownDescription: "Local contains the details for obtaining source code that is streamed in from a remote machine's local directory.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the local step",
										MarkdownDescription: "Name of the local step",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"timeout": schema.StringAttribute{
										Description:         "Timeout is the maximum duration the build should wait for source code to be streamed in from a remote machine's local directory.",
										MarkdownDescription: "Timeout is the maximum duration the build should wait for source code to be streamed in from a remote machine's local directory.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"oci_artifact": schema.SingleNestedAttribute{
								Description:         "OCIArtifact contains the details for obtaining source code from a container image, also known as an OCI artifact.",
								MarkdownDescription: "OCIArtifact contains the details for obtaining source code from a container image, also known as an OCI artifact.",
								Attributes: map[string]schema.Attribute{
									"image": schema.StringAttribute{
										Description:         "Image is a reference to a container image to be pulled from a container registry. For example, quay.io/org/image:tag",
										MarkdownDescription: "Image is a reference to a container image to be pulled from a container registry. For example, quay.io/org/image:tag",
										Required:            true,
										Optional:            false,
										Computed:            false,
									},
									...
									"prune": schema.StringAttribute{
										Description:         "Prune specifies whether the image containing the source code should be deleted. Allowed values are 'Never' (no deletion) and 'AfterPull' (removal after the image was successfully pulled from the registry). If not defined, it defaults to 'Never'.",
										MarkdownDescription: "Prune specifies whether the image containing the source code should be deleted. Allowed values are 'Never' (no deletion) and 'AfterPull' (removal after the image was successfully pulled from the registry). If not defined, it defaults to 'Never'.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"pull_secret": schema.StringAttribute{
										Description:         "PullSecret references a Secret that contains credentials to access the container image.",
										MarkdownDescription: "PullSecret references a Secret that contains credentials to access the container image.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"type": schema.StringAttribute{
								Description:         "Type is the type of source code used as input for the build. Allowed values are 'Git', 'OCI', and 'Local'.",
								MarkdownDescription: "Type is the type of source code used as input for the build. Allowed values are 'Git', 'OCI', and 'Local'.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"strategy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Strategy references the BuildStrategy to use to build the container image.",
						Attributes: map[string]schema.Attribute{
							"kind": schema.StringAttribute{
								Description:         "BuildStrategyKind indicates the kind of the buildstrategy, namespaced or cluster scoped.",
								MarkdownDescription: "BuildStrategyKind indicates the kind of the buildstrategy, namespaced or cluster scoped.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"timeout": schema.StringAttribute{
						...
						MarkdownDescription: "Timeout defines the maximum amount of time the Build should take to execute.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"trigger": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Trigger defines the scenarios where a new build should be triggered.",
						Attributes: map[string]schema.Attribute{
							"trigger_secret": schema.StringAttribute{
								...
								MarkdownDescription: "TriggerSecret points to a local object carrying the secret token to validate webhook request.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"when": schema.ListNestedAttribute{
								...
								MarkdownDescription: "When the list of scenarios when a new build should take place.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"github": schema.SingleNestedAttribute{
											Description:         "GitHub describes how to trigger builds based on GitHub (SCM) events.",
											MarkdownDescription: "GitHub describes how to trigger builds based on GitHub (SCM) events.",
											Attributes: map[string]schema.Attribute{
												"branches": schema.ListAttribute{
													Description:         "Branches slice of branch names where the event applies.",
													MarkdownDescription: "Branches slice of branch names where the event applies.",
													ElementType:         types.StringType,
													Required:            false,
													Optional:            true,
													Computed:            false,
												...
												"events": schema.ListAttribute{
													...
													MarkdownDescription: "Events GitHub event names.",
													ElementType:         types.StringType,
													Required:            false,
													Optional:            true,
													Computed:            false,
										...
										"image": schema.SingleNestedAttribute{
											Description:         "Image slice of image names where the event applies.",
											MarkdownDescription: "Image slice of image names where the event applies.",
											Attributes: map[string]schema.Attribute{
												"names": schema.ListAttribute{
													Description:         "Names fully qualified image names.",
													MarkdownDescription: "Names fully qualified image names.",
													ElementType:         types.StringType,
													Required:            false,
													Optional:            true,
													Computed:            false,
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Name name or the short description of the trigger condition.",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
										...
										"object_ref": schema.SingleNestedAttribute{
											Description:         "ObjectRef describes how to match a foreign resource, either using the name or the label selector, plus the current resource status.",
											MarkdownDescription: "ObjectRef describes how to match a foreign resource, either using the name or the label selector, plus the current resource status.",
											Attributes: map[string]schema.Attribute{
												"name": schema.StringAttribute{
													Description:         "Name target object name.",
													MarkdownDescription: "Name target object name.",
													Required:            false,
													Optional:            true,
													Computed:            false,
												},
												...
												"selector": schema.MapAttribute{
													...
													MarkdownDescription: "Selector label selector.",
													ElementType:         types.StringType,
													Required:            false,
													Optional:            true,
													Computed:            false,
												...
												"status": schema.ListAttribute{
													...
													MarkdownDescription: "Status object status.",
													ElementType:         types.StringType,
													Required:            false,
													Optional:            true,
													Computed:            false,
										...
										"type": schema.StringAttribute{
											...
											MarkdownDescription: "Type the event type",
											Required:            true,
											Optional:            false,
											Computed:            false,
										},
					...
					"volumes": schema.ListNestedAttribute{
						Description:         "Volumes contains volume Overrides of the BuildStrategy volumes in case those are allowed to be overridden. Must only contain volumes that exist in the corresponding BuildStrategy",
						MarkdownDescription: "Volumes contains volume Overrides of the BuildStrategy volumes in case those are allowed to be overridden. Must only contain volumes that exist in the corresponding BuildStrategy",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"name": schema.StringAttribute{
									...
									MarkdownDescription: "Name of the Build Volume",
									Required:            true,
									Optional:            false,
									Computed:            false,
								},
...
func (r *ShipwrightIoBuildV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_build_v1beta1_manifest")

	var model ShipwrightIoBuildV1Beta1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("shipwright.io/v1beta1")
