...
var (
	_ datasource.DataSource = &ShipwrightIoBuildRunV1Beta1Manifest{}
)

func NewShipwrightIoBuildRunV1Beta1Manifest() datasource.DataSource {
	return &ShipwrightIoBuildRunV1Beta1Manifest{}
}

type ShipwrightIoBuildRunV1Beta1Manifest struct{}

type ShipwrightIoBuildRunV1Beta1ManifestData struct {
...
func (r *ShipwrightIoBuildRunV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_build_run_v1beta1_manifest"
}

func (r *ShipwrightIoBuildRunV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "BuildRun is the Schema representing an instance of build execution",
		MarkdownDescription: "BuildRun is the Schema representing an instance of build execution",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BuildRunSpec defines the desired state of BuildRun",
				Attributes: map[string]schema.Attribute{
					"build": schema.SingleNestedAttribute{
						Description:         "Build refers to an embedded build specification This field is mandatory",
						MarkdownDescription: "Build refers to an embedded build specification This field is mandatory",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
							...
							"spec": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Spec refers to an embedded build specification",
								Attributes: map[string]schema.Attribute{
					...
					"output": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Output refers to the location where the generated image would be pushed to. It will overwrite the output image in build spec",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "Annotations references the additional annotations to be applied on the image",
								MarkdownDescription: "Annotations references the additional annotations to be applied on the image",
					...
					"service_account": schema.StringAttribute{
						...
						MarkdownDescription: "ServiceAccount refers to the kubernetes serviceaccount which is used for resource control. Default serviceaccount will be set if it is empty",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"source": schema.SingleNestedAttribute{
						Description:         "Source overrides where the source code is obtained for the BuildRun. This can only be used to obtain source code from a remote machine's local directory, instead of the value defined in the build.",
						MarkdownDescription: "Source overrides where the source code is obtained for the BuildRun. This can only be used to obtain source code from a remote machine's local directory, instead of the value defined in the build.",
						Attributes: map[string]schema.Attribute{
							"local": schema.SingleNestedAttribute{
								Description:         "Local contains the details for the source of type Local",
								MarkdownDescription: "Local contains the details for the source of type Local",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the local step",
										MarkdownDescription: "Name of the local step",
							...
							"type": schema.StringAttribute{
								Description:         "Type is the BuildRunSource qualifier, the type of the source. Only 'Local' is supported.",
								MarkdownDescription: "Type is the BuildRunSource qualifier, the type of the source. Only 'Local' is supported.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"state": schema.StringAttribute{
						...
						MarkdownDescription: "State is used for canceling a buildrun (and maybe more later on).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"timeout": schema.StringAttribute{
						...
						MarkdownDescription: "Timeout defines the maximum run time of this BuildRun.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ShipwrightIoBuildRunV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_build_run_v1beta1_manifest")

	var model ShipwrightIoBuildRunV1Beta1ManifestData
	...
	model.Kind = pointer.String("BuildRun")
