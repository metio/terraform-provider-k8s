...
var (
	_ datasource.DataSource = &ShipwrightIoClusterBuildStrategyV1Beta1Manifest{}
)

func NewShipwrightIoClusterBuildStrategyV1Beta1Manifest() datasource.DataSource {
	return &ShipwrightIoClusterBuildStrategyV1Beta1Manifest{}
}

type ShipwrightIoClusterBuildStrategyV1Beta1Manifest struct{}

type ShipwrightIoClusterBuildStrategyV1Beta1ManifestData struct {
...
func (r *ShipwrightIoClusterBuildStrategyV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_cluster_build_strategy_v1beta1_manifest"
}

func (r *ShipwrightIoClusterBuildStrategyV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "ClusterBuildStrategy is the Schema representing a strategy in the cluster scope to build images from source code.",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"steps": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Steps defines the steps of the strategy",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *ShipwrightIoClusterBuildStrategyV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_cluster_build_strategy_v1beta1_manifest")

	var model ShipwrightIoClusterBuildStrategyV1Beta1ManifestData
	...
	model.Kind = pointer.String("ClusterBuildStrategy")
