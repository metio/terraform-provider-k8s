...
var (
	_ datasource.DataSource = &ShipwrightIoBuildStrategyV1Beta1Manifest{}
)

func NewShipwrightIoBuildStrategyV1Beta1Manifest() datasource.DataSource {
	return &ShipwrightIoBuildStrategyV1Beta1Manifest{}
}

type ShipwrightIoBuildStrategyV1Beta1Manifest struct{}

type ShipwrightIoBuildStrategyV1Beta1ManifestData struct {
...
func (r *ShipwrightIoBuildStrategyV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_shipwright_io_build_strategy_v1beta1_manifest"
}

func (r *ShipwrightIoBuildStrategyV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ShipwrightIoBuildStrategyV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_shipwright_io_build_strategy_v1beta1_manifest")

	var model ShipwrightIoBuildStrategyV1Beta1ManifestData
