...
type ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource struct{}

var (
	_ resource.Resource = (*ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource)(nil)
)

type ElasticsearchK8SElasticCoElasticsearchV1Beta1TerraformModel struct {
...
type ElasticsearchK8SElasticCoElasticsearchV1Beta1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"node_sets" yaml:"nodeSets,omitempty"`
		...
		UpdateStrategy *struct {
			ChangeBudget *struct {
				MaxSurge *int64 `tfsdk:"max_surge" yaml:"maxSurge,omitempty"`

				MaxUnavailable *int64 `tfsdk:"max_unavailable" yaml:"maxUnavailable,omitempty"`
			} `tfsdk:"change_budget" yaml:"changeBudget,omitempty"`
...
func NewElasticsearchK8SElasticCoElasticsearchV1Beta1Resource() resource.Resource {
	return &ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource{}
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1"
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
							...
							"spec": {
								...
								Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
									...
									"selector": {
										...
										MarkdownDescription: "Label query over pods whose evictions are managed by the disruption budget. A null selector selects no pods. An empty selector ({}) also selects no pods, which differs from standard behavior of selecting all pods. In policy/v1, an empty selector will select all pods in the namespace.",
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1")

	var state ElasticsearchK8SElasticCoElasticsearchV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ElasticsearchK8SElasticCoElasticsearchV1Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("elasticsearch.k8s.elastic.co/v1beta1")
	goModel.Kind = utilities.Ptr("Elasticsearch")
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1")
...
func (r *ElasticsearchK8SElasticCoElasticsearchV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_elasticsearch_k8s_elastic_co_elasticsearch_v1beta1")
