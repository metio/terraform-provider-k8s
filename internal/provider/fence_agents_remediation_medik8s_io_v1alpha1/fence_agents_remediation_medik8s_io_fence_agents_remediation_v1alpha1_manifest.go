...
var (
	_ datasource.DataSource = &FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest{}
)

func NewFenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest() datasource.DataSource {
	return &FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest{}
}

type FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest struct{}

type FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		NodeSecretNames     *map[string]string            `tfsdk:"node_secret_names" json:"nodeSecretNames,omitempty"`
...
func (r *FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fence_agents_remediation_medik8s_io_fence_agents_remediation_v1alpha1_manifest"
}

func (r *FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "FenceAgentsRemediation is the Schema for the fenceagentsremediations API",
		MarkdownDescription: "FenceAgentsRemediation is the Schema for the fenceagentsremediations API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"node_secret_names": schema.MapAttribute{
...
func (r *FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fence_agents_remediation_medik8s_io_fence_agents_remediation_v1alpha1_manifest")

	var model FenceAgentsRemediationMedik8SIoFenceAgentsRemediationV1Alpha1ManifestData
	...
	model.Kind = pointer.String("FenceAgentsRemediation")
