...
type AppsDeploymentV1Resource struct{}

var (
	_ resource.Resource = (*AppsDeploymentV1Resource)(nil)
)

type AppsDeploymentV1TerraformModel struct {
...
type AppsDeploymentV1GoModel struct {
...
func NewAppsDeploymentV1Resource() resource.Resource {
	return &AppsDeploymentV1Resource{}
}

func (r *AppsDeploymentV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_apps_deployment_v1"
}

func (r *AppsDeploymentV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AppsDeploymentV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_apps_deployment_v1")

	var state AppsDeploymentV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AppsDeploymentV1GoModel
...
func (r *AppsDeploymentV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_deployment_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *AppsDeploymentV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_apps_deployment_v1")
...
func (r *AppsDeploymentV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_apps_deployment_v1")
