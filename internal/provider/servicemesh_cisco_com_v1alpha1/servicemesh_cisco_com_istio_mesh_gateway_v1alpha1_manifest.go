...
var (
	_ datasource.DataSource = &ServicemeshCiscoComIstioMeshGatewayV1Alpha1Manifest{}
)

func NewServicemeshCiscoComIstioMeshGatewayV1Alpha1Manifest() datasource.DataSource {
	return &ServicemeshCiscoComIstioMeshGatewayV1Alpha1Manifest{}
}

type ServicemeshCiscoComIstioMeshGatewayV1Alpha1Manifest struct{}

type ServicemeshCiscoComIstioMeshGatewayV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		IstioControlPlane *struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Namespace *string `tfsdk:"namespace" json:"namespace,omitempty"`
		} `tfsdk:"istio_control_plane" json:"istioControlPlane,omitempty"`
...
func (r *ServicemeshCiscoComIstioMeshGatewayV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_servicemesh_cisco_com_istio_mesh_gateway_v1alpha1_manifest"
}
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"istio_control_plane": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
...
func (r *ServicemeshCiscoComIstioMeshGatewayV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_servicemesh_cisco_com_istio_mesh_gateway_v1alpha1_manifest")

	var model ServicemeshCiscoComIstioMeshGatewayV1Alpha1ManifestData
	...
	model.Kind = pointer.String("IstioMeshGateway")
