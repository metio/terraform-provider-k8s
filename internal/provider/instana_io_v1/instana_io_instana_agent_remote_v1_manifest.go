...
var (
	_ datasource.DataSource = &InstanaIoInstanaAgentRemoteV1Manifest{}
)

func NewInstanaIoInstanaAgentRemoteV1Manifest() datasource.DataSource {
	return &InstanaIoInstanaAgentRemoteV1Manifest{}
}

type InstanaIoInstanaAgentRemoteV1Manifest struct{}

type InstanaIoInstanaAgentRemoteV1ManifestData struct {
	...
	Spec *struct {
		Agent *struct {
			...
			AgentReleaseRepoMirrorPassword *string            `tfsdk:"agent_release_repo_mirror_password" json:"agentReleaseRepoMirrorPassword,omitempty"`
			AgentReleaseRepoMirrorUrl      *string            `tfsdk:"agent_release_repo_mirror_url" json:"agentReleaseRepoMirrorUrl,omitempty"`
			AgentReleaseRepoMirrorUsername *string            `tfsdk:"agent_release_repo_mirror_username" json:"agentReleaseRepoMirrorUsername,omitempty"`
			...
			InstanaMvnRepoFeaturesPath      *string `tfsdk:"instana_mvn_repo_features_path" json:"instanaMvnRepoFeaturesPath,omitempty"`
			InstanaMvnRepoSharedPath        *string `tfsdk:"instana_mvn_repo_shared_path" json:"instanaMvnRepoSharedPath,omitempty"`
			InstanaMvnRepoUrl               *string `tfsdk:"instana_mvn_repo_url" json:"instanaMvnRepoUrl,omitempty"`
			InstanaSharedRepoMirrorPassword *string `tfsdk:"instana_shared_repo_mirror_password" json:"instanaSharedRepoMirrorPassword,omitempty"`
			InstanaSharedRepoMirrorUrl      *string `tfsdk:"instana_shared_repo_mirror_url" json:"instanaSharedRepoMirrorUrl,omitempty"`
			InstanaSharedRepoMirrorUsername *string `tfsdk:"instana_shared_repo_mirror_username" json:"instanaSharedRepoMirrorUsername,omitempty"`
			Key                             *string `tfsdk:"key" json:"key,omitempty"`
			...
			} `tfsdk:"service_mesh" json:"serviceMesh,omitempty"`
			Tls *struct {
...
func (r *InstanaIoInstanaAgentRemoteV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_instana_io_instana_agent_remote_v1_manifest"
}

func (r *InstanaIoInstanaAgentRemoteV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				Description:         "InstanaAgentRemoteSpec defines the desired state of the Instana Agent Remote",
				MarkdownDescription: "InstanaAgentRemoteSpec defines the desired state of the Instana Agent Remote",
				Attributes: map[string]schema.Attribute{
					"agent": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"agent_release_repo_mirror_password": schema.StringAttribute{
								Description:         "Sets the AGENT_RELEASE_REPOSITORY_MIRROR_PASSWORD environment variable",
								MarkdownDescription: "Sets the AGENT_RELEASE_REPOSITORY_MIRROR_PASSWORD environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"agent_release_repo_mirror_url": schema.StringAttribute{
								Description:         "Sets the AGENT_RELEASE_REPOSITORY_MIRROR_URL environment variable",
								MarkdownDescription: "Sets the AGENT_RELEASE_REPOSITORY_MIRROR_URL environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"agent_release_repo_mirror_username": schema.StringAttribute{
								Description:         "Sets the AGENT_RELEASE_REPOSITORY_MIRROR_USERNAME environment variable",
								MarkdownDescription: "Sets the AGENT_RELEASE_REPOSITORY_MIRROR_USERNAME environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"instana_mvn_repo_features_path": schema.StringAttribute{
								Description:         "Sets the INSTANA_MVN_REPOSITORY_FEATURES_PATH environment variable",
								MarkdownDescription: "Sets the INSTANA_MVN_REPOSITORY_FEATURES_PATH environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"instana_mvn_repo_shared_path": schema.StringAttribute{
								Description:         "Sets the INSTANA_MVN_REPOSITORY_SHARED_PATH environment variable",
								MarkdownDescription: "Sets the INSTANA_MVN_REPOSITORY_SHARED_PATH environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"instana_shared_repo_mirror_password": schema.StringAttribute{
								Description:         "Sets the INSTANA_SHARED_REPOSITORY_MIRROR_PASSWORD environment variable",
								MarkdownDescription: "Sets the INSTANA_SHARED_REPOSITORY_MIRROR_PASSWORD environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"instana_shared_repo_mirror_url": schema.StringAttribute{
								Description:         "Sets the INSTANA_SHARED_REPOSITORY_MIRROR_URL environment variable",
								MarkdownDescription: "Sets the INSTANA_SHARED_REPOSITORY_MIRROR_URL environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"instana_shared_repo_mirror_username": schema.StringAttribute{
								Description:         "Sets the INSTANA_SHARED_REPOSITORY_MIRROR_USERNAME environment variable",
								MarkdownDescription: "Sets the INSTANA_SHARED_REPOSITORY_MIRROR_USERNAME environment variable",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"pod": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"env": schema.ListNestedAttribute{
										Description:         "Set additional environment variables for the agent pod.",
										MarkdownDescription: "Set additional environment variables for the agent pod.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"name": schema.StringAttribute{
									...
									"volume_mounts": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set additional volume mounts for the agent pod.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
									...
									"volumes": schema.ListNestedAttribute{
										...
										MarkdownDescription: "Set additional volumes for the agent pod.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
							...
							"service_mesh": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "ServiceMesh sets the ENABLE_AGENT_SOCKET environment variable.",
								Attributes: map[string]schema.Attribute{
					...
					"service_account": schema.SingleNestedAttribute{
						Description:         "Specifies whether a ServiceAccount should be created (default 'true').",
						MarkdownDescription: "Specifies whether a ServiceAccount should be created (default 'true').",
						Attributes: map[string]schema.Attribute{
							"annotations": schema.MapAttribute{
								Description:         "",
								MarkdownDescription: "",
					...
					"zone": schema.SingleNestedAttribute{
						Description:         "Name of the zone in which the host(s) will be displayed on the map. Required as we do not set cluster name.",
						MarkdownDescription: "Name of the zone in which the host(s) will be displayed on the map. Required as we do not set cluster name.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
...
func (r *InstanaIoInstanaAgentRemoteV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_instana_io_instana_agent_remote_v1_manifest")

	var model InstanaIoInstanaAgentRemoteV1ManifestData
	...
	model.Kind = pointer.String("InstanaAgentRemote")
