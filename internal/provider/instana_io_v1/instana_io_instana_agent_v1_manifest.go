			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"k8s_sensor": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"pod_disruption_budget": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Toggles the PDB for the K8s Sensor",
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
										Description:         "",
										MarkdownDescription: "",
					...
					"openshift": schema.BoolAttribute{
						Description:         "Set to 'True' to indicate the Operator is being deployed in a OpenShift cluster. Provides a hint so that RBAC etc is configured correctly. Will attempt to auto-detect if unset.",
						MarkdownDescription: "Set to 'True' to indicate the Operator is being deployed in a OpenShift cluster. Provides a hint so that RBAC etc is configured correctly. Will attempt to auto-detect if unset.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"opentelemetry": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"grpc": schema.SingleNestedAttribute{
								Description:         "Specify whether GRPC is enabled (default is true).",
								MarkdownDescription: "Specify whether GRPC is enabled (default is true).",
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
										Description:         "Explicitly enable",
										MarkdownDescription: "Explicitly enable",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"port": schema.Int64Attribute{
										...
										MarkdownDescription: "Specify the port",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"http": schema.SingleNestedAttribute{
								Description:         "Specify whether HTTP is enabled (default is true).",
								MarkdownDescription: "Specify whether HTTP is enabled (default is true).",
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
										Description:         "Explicitly enable",
										MarkdownDescription: "Explicitly enable",
					...
					"zones": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Zones can be used to specify agents in multiple zones split across different nodes in the cluster",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"affinity": schema.SingleNestedAttribute{
