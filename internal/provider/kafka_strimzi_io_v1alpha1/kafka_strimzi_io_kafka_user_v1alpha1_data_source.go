...
var (
	_ datasource.DataSource              = &KafkaStrimziIoKafkaUserV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &KafkaStrimziIoKafkaUserV1Alpha1DataSource{}
)

func NewKafkaStrimziIoKafkaUserV1Alpha1DataSource() datasource.DataSource {
	return &KafkaStrimziIoKafkaUserV1Alpha1DataSource{}
}

type KafkaStrimziIoKafkaUserV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KafkaStrimziIoKafkaUserV1Alpha1DataSourceData struct {
...
func (r *KafkaStrimziIoKafkaUserV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kafka_strimzi_io_kafka_user_v1alpha1"
}

func (r *KafkaStrimziIoKafkaUserV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kafka_strimzi_io_kafka_user_v1alpha1")

	var data KafkaStrimziIoKafkaUserV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "kafka.strimzi.io", Version: "v1alpha1", Resource: "KafkaUser"}).
	...
	var readResponse KafkaStrimziIoKafkaUserV1Alpha1DataSourceData
