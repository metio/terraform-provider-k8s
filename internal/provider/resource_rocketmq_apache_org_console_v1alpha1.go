...
var (
	_ resource.Resource = (*RocketmqApacheOrgConsoleV1Alpha1Resource)(nil)
)

type RocketmqApacheOrgConsoleV1Alpha1TerraformModel struct {
...
type RocketmqApacheOrgConsoleV1Alpha1GoModel struct {
	...
	Spec *struct {
		ConsoleDeployment *struct {
			...
			Status *struct {
				AvailableReplicas *int64 `tfsdk:"available_replicas" yaml:"availableReplicas,omitempty"`

				CollisionCount *int64 `tfsdk:"collision_count" yaml:"collisionCount,omitempty"`

				Conditions *[]struct {
					LastTransitionTime *string `tfsdk:"last_transition_time" yaml:"lastTransitionTime,omitempty"`

					LastUpdateTime *string `tfsdk:"last_update_time" yaml:"lastUpdateTime,omitempty"`
				...
				ObservedGeneration *int64 `tfsdk:"observed_generation" yaml:"observedGeneration,omitempty"`

				ReadyReplicas *int64 `tfsdk:"ready_replicas" yaml:"readyReplicas,omitempty"`

				Replicas *int64 `tfsdk:"replicas" yaml:"replicas,omitempty"`

				UnavailableReplicas *int64 `tfsdk:"unavailable_replicas" yaml:"unavailableReplicas,omitempty"`

				UpdatedReplicas *int64 `tfsdk:"updated_replicas" yaml:"updatedReplicas,omitempty"`
			} `tfsdk:"status" yaml:"status,omitempty"`
		} `tfsdk:"console_deployment" yaml:"consoleDeployment,omitempty"`
...
func (r *RocketmqApacheOrgConsoleV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_rocketmq_apache_org_console_v1alpha1"
}

func (r *RocketmqApacheOrgConsoleV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *RocketmqApacheOrgConsoleV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_rocketmq_apache_org_console_v1alpha1")

	var state RocketmqApacheOrgConsoleV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel RocketmqApacheOrgConsoleV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("Console")
...
func (r *RocketmqApacheOrgConsoleV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_rocketmq_apache_org_console_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *RocketmqApacheOrgConsoleV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *RocketmqApacheOrgConsoleV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
