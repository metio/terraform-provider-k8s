...
type PolicyLinkerdIoHTTPRouteV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*PolicyLinkerdIoHTTPRouteV1Alpha1Resource)(nil)
)

type PolicyLinkerdIoHTTPRouteV1Alpha1TerraformModel struct {
...
type PolicyLinkerdIoHTTPRouteV1Alpha1GoModel struct {
...
func NewPolicyLinkerdIoHTTPRouteV1Alpha1Resource() resource.Resource {
	return &PolicyLinkerdIoHTTPRouteV1Alpha1Resource{}
}

func (r *PolicyLinkerdIoHTTPRouteV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_policy_linkerd_io_http_route_v1alpha1"
}

func (r *PolicyLinkerdIoHTTPRouteV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
						...
						Attributes: tfsdk.ListNestedAttributes(map[string]tfsdk.Attribute{
							...
							"filters": {
								...
								Attributes: tfsdk.ListNestedAttributes(map[string]tfsdk.Attribute{
									...
									"type": {
										Description:         "Type identifies the type of filter to apply. As with other API fields, types are classified into three conformance levels:  - Core: Filter types and their corresponding configuration defined by   'Support: Core' in this package, e.g. 'RequestHeaderModifier'. All   implementations must support core filters.  ",
...
func (r *PolicyLinkerdIoHTTPRouteV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_policy_linkerd_io_http_route_v1alpha1")

	var state PolicyLinkerdIoHTTPRouteV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel PolicyLinkerdIoHTTPRouteV1Alpha1GoModel
...
func (r *PolicyLinkerdIoHTTPRouteV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_policy_linkerd_io_http_route_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *PolicyLinkerdIoHTTPRouteV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_policy_linkerd_io_http_route_v1alpha1")
...
func (r *PolicyLinkerdIoHTTPRouteV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_policy_linkerd_io_http_route_v1alpha1")
