...
var (
	_ resource.Resource = (*ConfigGatekeeperShConfigV1Alpha1Resource)(nil)
)

type ConfigGatekeeperShConfigV1Alpha1TerraformModel struct {
...
type ConfigGatekeeperShConfigV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		Readiness *struct {
			StatsEnabled *bool `tfsdk:"stats_enabled" yaml:"statsEnabled,omitempty"`
		...
		Sync *struct {
			...
			} `tfsdk:"sync_only" yaml:"syncOnly,omitempty"`
...
func (r *ConfigGatekeeperShConfigV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_config_gatekeeper_sh_config_v1alpha1"
}

func (r *ConfigGatekeeperShConfigV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ConfigGatekeeperShConfigV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_config_gatekeeper_sh_config_v1alpha1")

	var state ConfigGatekeeperShConfigV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ConfigGatekeeperShConfigV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("config.gatekeeper.sh/v1alpha1")
	goModel.Kind = utilities.Ptr("Config")
...
func (r *ConfigGatekeeperShConfigV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_config_gatekeeper_sh_config_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *ConfigGatekeeperShConfigV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *ConfigGatekeeperShConfigV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
