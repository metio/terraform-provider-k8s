...
type ChaosMeshOrgTimeChaosV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*ChaosMeshOrgTimeChaosV1Alpha1Resource)(nil)
)

type ChaosMeshOrgTimeChaosV1Alpha1TerraformModel struct {
...
type ChaosMeshOrgTimeChaosV1Alpha1GoModel struct {
...
func NewChaosMeshOrgTimeChaosV1Alpha1Resource() resource.Resource {
	return &ChaosMeshOrgTimeChaosV1Alpha1Resource{}
}

func (r *ChaosMeshOrgTimeChaosV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_chaos_mesh_org_time_chaos_v1alpha1"
}

func (r *ChaosMeshOrgTimeChaosV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "TimeChaos is the Schema for the timechaos API",
		MarkdownDescription: "TimeChaos is the Schema for the timechaos API",
...
func (r *ChaosMeshOrgTimeChaosV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_chaos_mesh_org_time_chaos_v1alpha1")

	var state ChaosMeshOrgTimeChaosV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ChaosMeshOrgTimeChaosV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("TimeChaos")
...
func (r *ChaosMeshOrgTimeChaosV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_chaos_mesh_org_time_chaos_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *ChaosMeshOrgTimeChaosV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_chaos_mesh_org_time_chaos_v1alpha1")
...
func (r *ChaosMeshOrgTimeChaosV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_chaos_mesh_org_time_chaos_v1alpha1")
