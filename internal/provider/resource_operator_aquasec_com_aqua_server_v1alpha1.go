...
var (
	_ resource.Resource = (*OperatorAquasecComAquaServerV1Alpha1Resource)(nil)
)

type OperatorAquasecComAquaServerV1Alpha1TerraformModel struct {
...
type OperatorAquasecComAquaServerV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		ConfigMapData *map[string]string `tfsdk:"config_map_data" yaml:"configMapData,omitempty"`
...
func (r *OperatorAquasecComAquaServerV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_aquasec_com_aqua_server_v1alpha1"
}

func (r *OperatorAquasecComAquaServerV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorAquasecComAquaServerV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_aquasec_com_aqua_server_v1alpha1")

	var state OperatorAquasecComAquaServerV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorAquasecComAquaServerV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("AquaServer")
...
func (r *OperatorAquasecComAquaServerV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_server_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorAquasecComAquaServerV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *OperatorAquasecComAquaServerV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
