									...
									"agent": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"extra_args": schema.ListAttribute{
												Description:         "ExtraArgs allows adding additional arguments to said component.WARNING - This option can override existing konnectivityparameters and cause konnectivity components to misbehave inunxpected ways. Only modify if you know what you are doing.",
												MarkdownDescription: "ExtraArgs allows adding additional arguments to said component.WARNING - This option can override existing konnectivityparameters and cause konnectivity components to misbehave inunxpected ways. Only modify if you know what you are doing.",
												ElementType:         types.StringType,
												Required:            false,
												Optional:            true,
												Computed:            false,
							...
							"deployment": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"extra_args": schema.SingleNestedAttribute{
										Description:         "ExtraArgs allows adding additional arguments to the Control Plane components,such as kube-apiserver, controller-manager, and scheduler. WARNING - This optioncan override existing parameters and cause components to misbehave in unxpected ways.Only modify if you know what you are doing.",
										MarkdownDescription: "ExtraArgs allows adding additional arguments to the Control Plane components,such as kube-apiserver, controller-manager, and scheduler. WARNING - This optioncan override existing parameters and cause components to misbehave in unxpected ways.Only modify if you know what you are doing.",
										Attributes: map[string]schema.Attribute{
									...
									"topology_spread_constraints": schema.ListNestedAttribute{
										Description:         "TopologySpreadConstraints describes how the Tenant Control Plane pods ought to spread across topologydomains. Scheduler will schedule pods in a way which abides by the constraints.In case of nil underlying LabelSelector, the Kamaji one for the given Tenant Control Plane will be used.All topologySpreadConstraints are ANDed.",
										MarkdownDescription: "TopologySpreadConstraints describes how the Tenant Control Plane pods ought to spread across topologydomains. Scheduler will schedule pods in a way which abides by the constraints.In case of nil underlying LabelSelector, the Kamaji one for the given Tenant Control Plane will be used.All topologySpreadConstraints are ANDed.",
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"label_selector": schema.SingleNestedAttribute{
							...
							"kubelet": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"cgroupfs": schema.StringAttribute{
										Description:         "CGroupFS defines the  cgroup driver for Kubelethttps://kubernetes.io/docs/tasks/administer-cluster/kubeadm/configure-cgroup-driver/",
										MarkdownDescription: "CGroupFS defines the  cgroup driver for Kubelethttps://kubernetes.io/docs/tasks/administer-cluster/kubeadm/configure-cgroup-driver/",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.String{
					...
					"network_profile": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"allow_address_as_external_ip": schema.BoolAttribute{
								Description:         "AllowAddressAsExternalIP will include tenantControlPlane.Spec.NetworkProfile.Address in the section ofExternalIPs of the Kubernetes Service (only ClusterIP or NodePort)",
								MarkdownDescription: "AllowAddressAsExternalIP will include tenantControlPlane.Spec.NetworkProfile.Address in the section ofExternalIPs of the Kubernetes Service (only ClusterIP or NodePort)",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
