...
var (
	_ datasource.DataSource              = &MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource{}
)

func NewMetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource() datasource.DataSource {
	return &MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource{}
}

type MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSourceData struct {
...
func (r *MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_metacontroller_k8s_io_decorator_controller_v1alpha1"
}

func (r *MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_metacontroller_k8s_io_decorator_controller_v1alpha1")

	var data MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSourceData
	...
	var readResponse MetacontrollerK8SIoDecoratorControllerV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("DecoratorController")
