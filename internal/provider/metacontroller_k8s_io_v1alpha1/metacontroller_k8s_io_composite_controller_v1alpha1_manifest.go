...
var (
	_ datasource.DataSource = &MetacontrollerK8SIoCompositeControllerV1Alpha1Manifest{}
)

func NewMetacontrollerK8SIoCompositeControllerV1Alpha1Manifest() datasource.DataSource {
	return &MetacontrollerK8SIoCompositeControllerV1Alpha1Manifest{}
}
...
func (r *MetacontrollerK8SIoCompositeControllerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_metacontroller_k8s_io_composite_controller_v1alpha1_manifest"
}

func (r *MetacontrollerK8SIoCompositeControllerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MetacontrollerK8SIoCompositeControllerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_metacontroller_k8s_io_composite_controller_v1alpha1_manifest")

	var model MetacontrollerK8SIoCompositeControllerV1Alpha1ManifestData
