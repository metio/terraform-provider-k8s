...
var (
	_ datasource.DataSource = &CsiCephIoOperatorConfigV1Alpha1Manifest{}
)

func NewCsiCephIoOperatorConfigV1Alpha1Manifest() datasource.DataSource {
	return &CsiCephIoOperatorConfigV1Alpha1Manifest{}
}

type CsiCephIoOperatorConfigV1Alpha1Manifest struct{}

type CsiCephIoOperatorConfigV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"driver_spec_defaults" json:"driverSpecDefaults,omitempty"`
		Log *struct {
			Verbosity *int64 `tfsdk:"verbosity" json:"verbosity,omitempty"`
		} `tfsdk:"log" json:"log,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
...
func (r *CsiCephIoOperatorConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_csi_ceph_io_operator_config_v1alpha1_manifest"
}

func (r *CsiCephIoOperatorConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "OperatorConfigSpec defines the desired state of OperatorConfig",
				Attributes: map[string]schema.Attribute{
					"driver_spec_defaults": schema.SingleNestedAttribute{
						Description:         "Allow overwrite of hardcoded defaults for any driver managed by this operator",
						MarkdownDescription: "Allow overwrite of hardcoded defaults for any driver managed by this operator",
						Attributes: map[string]schema.Attribute{
					...
					"log": schema.SingleNestedAttribute{
						Description:         "OperatorLogSpec provide log related settings for the operator",
						MarkdownDescription: "OperatorLogSpec provide log related settings for the operator",
						Attributes: map[string]schema.Attribute{
							"verbosity": schema.Int64Attribute{
								Description:         "Operator's log level",
								MarkdownDescription: "Operator's log level",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.Int64{
...
func (r *CsiCephIoOperatorConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_csi_ceph_io_operator_config_v1alpha1_manifest")

	var model CsiCephIoOperatorConfigV1Alpha1ManifestData
