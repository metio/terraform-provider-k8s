...
var (
	_ datasource.DataSource = &CsiCephIoClientProfileV1Alpha1Manifest{}
)

func NewCsiCephIoClientProfileV1Alpha1Manifest() datasource.DataSource {
	return &CsiCephIoClientProfileV1Alpha1Manifest{}
}

type CsiCephIoClientProfileV1Alpha1Manifest struct{}

type CsiCephIoClientProfileV1Alpha1ManifestData struct {
...
func (r *CsiCephIoClientProfileV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_csi_ceph_io_client_profile_v1alpha1_manifest"
}

func (r *CsiCephIoClientProfileV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CsiCephIoClientProfileV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_csi_ceph_io_client_profile_v1alpha1_manifest")

	var model CsiCephIoClientProfileV1Alpha1ManifestData
