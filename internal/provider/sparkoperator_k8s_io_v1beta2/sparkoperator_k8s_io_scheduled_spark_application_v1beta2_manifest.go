...
var (
	_ datasource.DataSource = &SparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest{}
)

func NewSparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest() datasource.DataSource {
	return &SparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest{}
}

type SparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest struct{}

type SparkoperatorK8SIoScheduledSparkApplicationV1Beta2ManifestData struct {
...
func (r *SparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_sparkoperator_k8s_io_scheduled_spark_application_v1beta2_manifest"
}

func (r *SparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sparkoperator_k8s_io_scheduled_spark_application_v1beta2_manifest")

	var model SparkoperatorK8SIoScheduledSparkApplicationV1Beta2ManifestData
