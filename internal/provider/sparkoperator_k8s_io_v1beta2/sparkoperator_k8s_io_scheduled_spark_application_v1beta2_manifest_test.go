...
func TestSparkoperatorK8SIoScheduledSparkApplicationV1Beta2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_sparkoperator_k8s_io_scheduled_spark_application_v1beta2_manifest", testCase)
		})
	}
}
