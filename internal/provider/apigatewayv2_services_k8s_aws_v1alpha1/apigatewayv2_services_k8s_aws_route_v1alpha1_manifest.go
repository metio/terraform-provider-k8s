...
var (
	_ datasource.DataSource = &Apigatewayv2ServicesK8SAwsRouteV1Alpha1Manifest{}
)

func NewApigatewayv2ServicesK8SAwsRouteV1Alpha1Manifest() datasource.DataSource {
	return &Apigatewayv2ServicesK8SAwsRouteV1Alpha1Manifest{}
}
...
func (r *Apigatewayv2ServicesK8SAwsRouteV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apigatewayv2_services_k8s_aws_route_v1alpha1_manifest"
}

func (r *Apigatewayv2ServicesK8SAwsRouteV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"route_key": schema.StringAttribute{
						...
						MarkdownDescription: "The route key for the route.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *Apigatewayv2ServicesK8SAwsRouteV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apigatewayv2_services_k8s_aws_route_v1alpha1_manifest")

	var model Apigatewayv2ServicesK8SAwsRouteV1Alpha1ManifestData
