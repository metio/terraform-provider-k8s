...
func TestApigatewayv2ServicesK8SAwsAPIV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_apigatewayv2_services_k8s_aws_api_v1alpha1", testCase)
		})
	}
}
