...
var (
	_ resource.Resource = (*GetambassadorIoDevPortalV2Resource)(nil)
)

type GetambassadorIoDevPortalV2TerraformModel struct {
...
type GetambassadorIoDevPortalV2GoModel struct {
...
func (r *GetambassadorIoDevPortalV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_getambassador_io_dev_portal_v2"
}

func (r *GetambassadorIoDevPortalV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *GetambassadorIoDevPortalV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_getambassador_io_dev_portal_v2")

	var state GetambassadorIoDevPortalV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GetambassadorIoDevPortalV2GoModel
...
func (r *GetambassadorIoDevPortalV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_dev_portal_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *GetambassadorIoDevPortalV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GetambassadorIoDevPortalV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
