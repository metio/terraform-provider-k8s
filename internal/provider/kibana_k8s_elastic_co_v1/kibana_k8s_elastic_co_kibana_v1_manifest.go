...
var (
	_ datasource.DataSource = &KibanaK8SElasticCoKibanaV1Manifest{}
)

func NewKibanaK8SElasticCoKibanaV1Manifest() datasource.DataSource {
	return &KibanaK8SElasticCoKibanaV1Manifest{}
}

type KibanaK8SElasticCoKibanaV1Manifest struct{}

type KibanaK8SElasticCoKibanaV1ManifestData struct {
...
func (r *KibanaK8SElasticCoKibanaV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kibana_k8s_elastic_co_kibana_v1_manifest"
}

func (r *KibanaK8SElasticCoKibanaV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KibanaK8SElasticCoKibanaV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kibana_k8s_elastic_co_kibana_v1_manifest")

	var model KibanaK8SElasticCoKibanaV1ManifestData
