...
var (
	_ datasource.DataSource              = &OperatorTigeraIoInstallationV1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorTigeraIoInstallationV1DataSource{}
)

func NewOperatorTigeraIoInstallationV1DataSource() datasource.DataSource {
	return &OperatorTigeraIoInstallationV1DataSource{}
}

type OperatorTigeraIoInstallationV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorTigeraIoInstallationV1DataSourceData struct {
...
func (r *OperatorTigeraIoInstallationV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_tigera_io_installation_v1"
}

func (r *OperatorTigeraIoInstallationV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
														...
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	...
																	MarkdownDescription: "Name is an enum which identifies the csi-node-driver DaemonSet container by name.",
																	Required:            false,
																	Optional:            false,
																	Computed:            true,
																},
...
func (r *OperatorTigeraIoInstallationV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorTigeraIoInstallationV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_tigera_io_installation_v1")

	var data OperatorTigeraIoInstallationV1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "operator.tigera.io", Version: "v1", Resource: "installations"}).
	...
	var readResponse OperatorTigeraIoInstallationV1DataSourceData
	...
	data.Kind = pointer.String("Installation")
