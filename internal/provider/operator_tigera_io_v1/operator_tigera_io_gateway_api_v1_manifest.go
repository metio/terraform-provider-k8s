			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"gateway_certgen_job": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Allow optional customization of the gateway certgen job.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
								Description:         "Metadata contains the standard Kubernetes labels and annotations fields.",
								MarkdownDescription: "Metadata contains the standard Kubernetes labels and annotations fields.",
								Attributes: map[string]schema.Attribute{
									"annotations": schema.MapAttribute{
							...
							"spec": schema.SingleNestedAttribute{
								Description:         "GatewayCertgenJobSpec allows customization of the gateway certgen job spec. For customization of the job template see GatewayCertgenJobPodTemplate.",
								MarkdownDescription: "GatewayCertgenJobSpec allows customization of the gateway certgen job spec. For customization of the job template see GatewayCertgenJobPodTemplate.",
								Attributes: map[string]schema.Attribute{
									"template": schema.SingleNestedAttribute{
										Description:         "GatewayCertgenJobPodTemplate allows customization of the gateway certgen job's pod template. If GatewayCertgenJob.Spec.Template.Metadata is non-nil, non-clashing labels and annotations from that metadata are added into the job's pod template. For customization of the pod template spec see GatewayCertgenJobPodSpec.",
										MarkdownDescription: "GatewayCertgenJobPodTemplate allows customization of the gateway certgen job's pod template. If GatewayCertgenJob.Spec.Template.Metadata is non-nil, non-clashing labels and annotations from that metadata are added into the job's pod template. For customization of the pod template spec see GatewayCertgenJobPodSpec.",
										Attributes: map[string]schema.Attribute{
											"metadata": schema.SingleNestedAttribute{
												Description:         "Metadata contains the standard Kubernetes labels and annotations fields.",
												MarkdownDescription: "Metadata contains the standard Kubernetes labels and annotations fields.",
											...
											"spec": schema.SingleNestedAttribute{
												Description:         "GatewayCertgenJobPodSpec allows customization of the gateway certgen job's pod spec. If GatewayCertgenJob.Spec.Template.Spec.Affinity is non-nil, it sets the affinity field of the job's pod template. If GatewayCertgenJob.Spec.Template.Spec.NodeSelector is non-nil, it sets a node selector for where job pods may be scheduled. If GatewayCertgenJob.Spec.Template.Spec.Tolerations is non-nil, it sets the tolerations field of the job's pod template. For customization of job container resources see GatewayCertgenJobContainer.",
												MarkdownDescription: "GatewayCertgenJobPodSpec allows customization of the gateway certgen job's pod spec. If GatewayCertgenJob.Spec.Template.Spec.Affinity is non-nil, it sets the affinity field of the job's pod template. If GatewayCertgenJob.Spec.Template.Spec.NodeSelector is non-nil, it sets a node selector for where job pods may be scheduled. If GatewayCertgenJob.Spec.Template.Spec.Tolerations is non-nil, it sets the tolerations field of the job's pod template. For customization of job container resources see GatewayCertgenJobContainer.",
												Attributes: map[string]schema.Attribute{
					...
					"gateway_controller_deployment": schema.SingleNestedAttribute{
						Description:         "Allow optional customization of the gateway controller deployment.",
						MarkdownDescription: "Allow optional customization of the gateway controller deployment.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
								Description:         "Metadata contains the standard Kubernetes labels and annotations fields.",
								MarkdownDescription: "Metadata contains the standard Kubernetes labels and annotations fields.",
							...
							"spec": schema.SingleNestedAttribute{
								Description:         "GatewayControllerDeploymentSpec allows customization of the gateway controller deployment spec. If GatewayControllerDeployment.Spec.MinReadySeconds is non-nil, it sets the minReadySeconds field for the deployment. For customization of the pod template see GatewayControllerDeploymentPodTemplate.",
								MarkdownDescription: "GatewayControllerDeploymentSpec allows customization of the gateway controller deployment spec. If GatewayControllerDeployment.Spec.MinReadySeconds is non-nil, it sets the minReadySeconds field for the deployment. For customization of the pod template see GatewayControllerDeploymentPodTemplate.",
								Attributes: map[string]schema.Attribute{
									...
									"template": schema.SingleNestedAttribute{
										Description:         "GatewayControllerDeploymentPodTemplate allows customization of the gateway controller deployment pod template. If GatewayControllerDeployment.Spec.Template.Metadata is non-nil, non-clashing labels and annotations from that metadata are added into the deployment's pod template. For customization of the pod template spec see GatewayControllerDeploymentPodSpec.",
										MarkdownDescription: "GatewayControllerDeploymentPodTemplate allows customization of the gateway controller deployment pod template. If GatewayControllerDeployment.Spec.Template.Metadata is non-nil, non-clashing labels and annotations from that metadata are added into the deployment's pod template. For customization of the pod template spec see GatewayControllerDeploymentPodSpec.",
										Attributes: map[string]schema.Attribute{
											"metadata": schema.SingleNestedAttribute{
												Description:         "Metadata contains the standard Kubernetes labels and annotations fields.",
												MarkdownDescription: "Metadata contains the standard Kubernetes labels and annotations fields.",
											...
											"spec": schema.SingleNestedAttribute{
												Description:         "GatewayControllerDeploymentPodSpec allows customization of the gateway controller deployment pod spec. If GatewayControllerDeployment.Spec.Template.Spec.Affinity is non-nil, it sets the affinity field of the deployment's pod template. If GatewayControllerDeployment.Spec.Template.Spec.NodeSelector is non-nil, it sets a node selector for where controller pods may be scheduled. If GatewayControllerDeployment.Spec.Template.Spec.Tolerations is non-nil, it sets the tolerations field of the deployment's pod template. For customization of container resources see GatewayControllerDeploymentContainer.",
												MarkdownDescription: "GatewayControllerDeploymentPodSpec allows customization of the gateway controller deployment pod spec. If GatewayControllerDeployment.Spec.Template.Spec.Affinity is non-nil, it sets the affinity field of the deployment's pod template. If GatewayControllerDeployment.Spec.Template.Spec.NodeSelector is non-nil, it sets a node selector for where controller pods may be scheduled. If GatewayControllerDeployment.Spec.Template.Spec.Tolerations is non-nil, it sets the tolerations field of the deployment's pod template. For customization of container resources see GatewayControllerDeploymentContainer.",
												Attributes: map[string]schema.Attribute{
													"affinity": schema.SingleNestedAttribute{
														Description:         "Affinity is a group of affinity scheduling rules.",
														MarkdownDescription: "Affinity is a group of affinity scheduling rules.",
					...
					"gateway_deployment": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Allow optional customization of gateway deployments.",
						Attributes: map[string]schema.Attribute{
							"spec": schema.SingleNestedAttribute{
								Description:         "GatewayDeploymentSpec allows customization of the spec of gateway deployments. For customization of the pod template see GatewayDeploymentPodTemplate. For customization of the deployment strategy see GatewayDeploymentStrategy.",
								MarkdownDescription: "GatewayDeploymentSpec allows customization of the spec of gateway deployments. For customization of the pod template see GatewayDeploymentPodTemplate. For customization of the deployment strategy see GatewayDeploymentStrategy.",
								Attributes: map[string]schema.Attribute{
									...
									"template": schema.SingleNestedAttribute{
										Description:         "GatewayDeploymentPodTemplate allows customization of the pod template of gateway deployments. If GatewayDeployment.Spec.Template.Metadata is non-nil, non-clashing labels and annotations from that metadata are added into each deployment's pod template. For customization of the pod template spec see GatewayDeploymentPodSpec.",
										MarkdownDescription: "GatewayDeploymentPodTemplate allows customization of the pod template of gateway deployments. If GatewayDeployment.Spec.Template.Metadata is non-nil, non-clashing labels and annotations from that metadata are added into each deployment's pod template. For customization of the pod template spec see GatewayDeploymentPodSpec.",
										Attributes: map[string]schema.Attribute{
											"metadata": schema.SingleNestedAttribute{
												Description:         "Metadata contains the standard Kubernetes labels and annotations fields.",
												MarkdownDescription: "Metadata contains the standard Kubernetes labels and annotations fields.",
											...
											"spec": schema.SingleNestedAttribute{
												Description:         "GatewayDeploymentPodSpec allows customization of the pod spec of gateway deployments. If GatewayDeployment.Spec.Template.Spec.Affinity is non-nil, it sets the affinity field of each deployment's pod template. If GatewayDeployment.Spec.Template.Spec.NodeSelector is non-nil, it sets a node selector for where gateway pods may be scheduled. If GatewayDeployment.Spec.Template.Spec.Tolerations is non-nil, it sets the tolerations field of each deployment's pod template. If GatewayDeployment.Spec.Template.Spec.TopologySpreadConstraints is non-nil, it sets the topology spread constraints of each deployment's pod template. For customization of container resources see GatewayControllerDeploymentContainer.",
												MarkdownDescription: "GatewayDeploymentPodSpec allows customization of the pod spec of gateway deployments. If GatewayDeployment.Spec.Template.Spec.Affinity is non-nil, it sets the affinity field of each deployment's pod template. If GatewayDeployment.Spec.Template.Spec.NodeSelector is non-nil, it sets a node selector for where gateway pods may be scheduled. If GatewayDeployment.Spec.Template.Spec.Tolerations is non-nil, it sets the tolerations field of each deployment's pod template. If GatewayDeployment.Spec.Template.Spec.TopologySpreadConstraints is non-nil, it sets the topology spread constraints of each deployment's pod template. For customization of container resources see GatewayControllerDeploymentContainer.",
												Attributes: map[string]schema.Attribute{
													"affinity": schema.SingleNestedAttribute{
														Description:         "Affinity is a group of affinity scheduling rules.",
														MarkdownDescription: "Affinity is a group of affinity scheduling rules.",
