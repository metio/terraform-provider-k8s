...
var (
	_ datasource.DataSource = &OperatorTigeraIoGoldmaneV1Manifest{}
)

func NewOperatorTigeraIoGoldmaneV1Manifest() datasource.DataSource {
	return &OperatorTigeraIoGoldmaneV1Manifest{}
}

type OperatorTigeraIoGoldmaneV1Manifest struct{}

type OperatorTigeraIoGoldmaneV1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"goldmane_deployment" json:"goldmaneDeployment,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *OperatorTigeraIoGoldmaneV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_tigera_io_goldmane_v1_manifest"
}

func (r *OperatorTigeraIoGoldmaneV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "",
				Attributes: map[string]schema.Attribute{
					"goldmane_deployment": schema.SingleNestedAttribute{
						Description:         "GoldmaneDeployment is the configuration for the goldmane Deployment.",
						MarkdownDescription: "GoldmaneDeployment is the configuration for the goldmane Deployment.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
							...
							"spec": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Spec is the specification of the goldmane Deployment.",
								Attributes: map[string]schema.Attribute{
									...
									"template": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Template describes the goldmane Deployment pod that will be created.",
										Attributes: map[string]schema.Attribute{
											"metadata": schema.SingleNestedAttribute{
											...
											"spec": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "Spec is the goldmane Deployment's PodSpec.",
												Attributes: map[string]schema.Attribute{
													"affinity": schema.SingleNestedAttribute{
														Description:         "Affinity is a group of affinity scheduling rules for the goldmane pods.",
														MarkdownDescription: "Affinity is a group of affinity scheduling rules for the goldmane pods.",
														Attributes: map[string]schema.Attribute{
													...
													"containers": schema.ListNestedAttribute{
														Description:         "Containers is a list of goldmane containers. If specified, this overrides the specified EGW Deployment containers. If omitted, the goldmane Deployment will use its default values for its containers.",
														MarkdownDescription: "Containers is a list of goldmane containers. If specified, this overrides the specified EGW Deployment containers. If omitted, the goldmane Deployment will use its default values for its containers.",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	Description:         "",
																	...
																	Computed:            false,
																	Validators: []validator.String{
																		stringvalidator.OneOf("goldmane"),
																	},
																},
													...
													"node_selector": schema.MapAttribute{
														...
														MarkdownDescription: "NodeSelector gives more control over the nodes where the goldmane pods will run on.",
														ElementType:         types.StringType,
														Required:            false,
														Optional:            true,
														Computed:            false,
													...
													"termination_grace_period_seconds": schema.Int64Attribute{
														...
														MarkdownDescription: "TerminationGracePeriodSeconds defines the termination grace period of the goldmane pods in seconds.",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.Int64{
													...
													"tolerations": schema.ListNestedAttribute{
														Description:         "Tolerations is the goldmane pod's tolerations. If specified, this overrides any tolerations that may be set on the goldmane Deployment. If omitted, the goldmane Deployment will use its default value for tolerations.",
														MarkdownDescription: "Tolerations is the goldmane pod's tolerations. If specified, this overrides any tolerations that may be set on the goldmane Deployment. If omitted, the goldmane Deployment will use its default value for tolerations.",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
...
func (r *OperatorTigeraIoGoldmaneV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_tigera_io_goldmane_v1_manifest")

	var model OperatorTigeraIoGoldmaneV1ManifestData
	...
	model.Kind = pointer.String("Goldmane")
