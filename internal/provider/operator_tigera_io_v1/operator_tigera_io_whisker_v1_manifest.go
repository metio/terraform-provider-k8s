...
var (
	_ datasource.DataSource = &OperatorTigeraIoWhiskerV1Manifest{}
)

func NewOperatorTigeraIoWhiskerV1Manifest() datasource.DataSource {
	return &OperatorTigeraIoWhiskerV1Manifest{}
}

type OperatorTigeraIoWhiskerV1Manifest struct{}

type OperatorTigeraIoWhiskerV1ManifestData struct {
	...
	Spec *struct {
		Notifications     *string `tfsdk:"notifications" json:"notifications,omitempty"`
		WhiskerDeployment *struct {
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
				Labels      *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		...
		} `tfsdk:"whisker_deployment" json:"whiskerDeployment,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *OperatorTigeraIoWhiskerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_tigera_io_whisker_v1_manifest"
}

func (r *OperatorTigeraIoWhiskerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"notifications": schema.StringAttribute{
						Description:         "Default: Enabled This setting enables calls to an external API to retrieve notification banner text in the Whisker UI. Allowed values are Enabled or Disabled. Defaults to Enabled.",
						MarkdownDescription: "Default: Enabled This setting enables calls to an external API to retrieve notification banner text in the Whisker UI. Allowed values are Enabled or Disabled. Defaults to Enabled.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"whisker_deployment": schema.SingleNestedAttribute{
						Description:         "WhiskerDeployment is the configuration for the whisker Deployment.",
						MarkdownDescription: "WhiskerDeployment is the configuration for the whisker Deployment.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
							...
							"spec": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Spec is the specification of the whisker Deployment.",
								Attributes: map[string]schema.Attribute{
									...
									"template": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Template describes the whisker Deployment pod that will be created.",
										Attributes: map[string]schema.Attribute{
											"metadata": schema.SingleNestedAttribute{
											...
											"spec": schema.SingleNestedAttribute{
												...
												MarkdownDescription: "Spec is the whisker Deployment's PodSpec.",
												Attributes: map[string]schema.Attribute{
													"affinity": schema.SingleNestedAttribute{
														Description:         "Affinity is a group of affinity scheduling rules for the whisker pods.",
														MarkdownDescription: "Affinity is a group of affinity scheduling rules for the whisker pods.",
														Attributes: map[string]schema.Attribute{
													...
													"containers": schema.ListNestedAttribute{
														Description:         "Containers is a list of whisker containers. If specified, this overrides the specified EGW Deployment containers. If omitted, the whisker Deployment will use its default values for its containers.",
														MarkdownDescription: "Containers is a list of whisker containers. If specified, this overrides the specified EGW Deployment containers. If omitted, the whisker Deployment will use its default values for its containers.",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	Description:         "",
																	...
																	Computed:            false,
																	Validators: []validator.String{
																		stringvalidator.OneOf("whisker", "whisker-backend"),
																	},
																},
													...
													"node_selector": schema.MapAttribute{
														...
														MarkdownDescription: "NodeSelector gives more control over the nodes where the whisker pods will run on.",
														ElementType:         types.StringType,
														Required:            false,
														Optional:            true,
														Computed:            false,
													...
													"termination_grace_period_seconds": schema.Int64Attribute{
														...
														MarkdownDescription: "TerminationGracePeriodSeconds defines the termination grace period of the whisker pods in seconds.",
														Required:            false,
														Optional:            true,
														Computed:            false,
														Validators: []validator.Int64{
													...
													"tolerations": schema.ListNestedAttribute{
														Description:         "Tolerations is the whisker pod's tolerations. If specified, this overrides any tolerations that may be set on the whisker Deployment. If omitted, the whisker Deployment will use its default value for tolerations.",
														MarkdownDescription: "Tolerations is the whisker pod's tolerations. If specified, this overrides any tolerations that may be set on the whisker Deployment. If omitted, the whisker Deployment will use its default value for tolerations.",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
...
func (r *OperatorTigeraIoWhiskerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_tigera_io_whisker_v1_manifest")

	var model OperatorTigeraIoWhiskerV1ManifestData
	...
	model.Kind = pointer.String("Whisker")
