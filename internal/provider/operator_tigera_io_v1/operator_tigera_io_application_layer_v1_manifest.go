												...
												Attributes: map[string]schema.Attribute{
													"containers": schema.ListNestedAttribute{
														...
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"name": schema.StringAttribute{
																	Description:         "Name is an enum which identifies the L7LogCollector DaemonSet container by name.",
																	MarkdownDescription: "Name is an enum which identifies the L7LogCollector DaemonSet container by name.",
																	Required:            true,
																	Optional:            false,
																	Computed:            false,
																	Validators: []validator.String{
