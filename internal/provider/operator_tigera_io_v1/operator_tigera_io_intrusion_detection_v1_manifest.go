...
type OperatorTigeraIoIntrusionDetectionV1ManifestData struct {
	...
	Spec *struct {
		...
		DeepPacketInspectionDaemonset *struct {
			Spec *struct {
				Template *struct {
					Spec *struct {
		...
		} `tfsdk:"deep_packet_inspection_daemonset" json:"deepPacketInspectionDaemonset,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"deep_packet_inspection_daemonset": schema.SingleNestedAttribute{
						Description:         "DeepPacketInspectionDaemonset configures the DPI Daemonset",
						MarkdownDescription: "DeepPacketInspectionDaemonset configures the DPI Daemonset",
						Attributes: map[string]schema.Attribute{
							"spec": schema.SingleNestedAttribute{
								Description:         "DPIDaemonsetSpec configures the DPI Daemonset",
								MarkdownDescription: "DPIDaemonsetSpec configures the DPI Daemonset",
								Attributes: map[string]schema.Attribute{
									"template": schema.SingleNestedAttribute{
										Description:         "Template specifies DPI Daemonset Template",
										MarkdownDescription: "Template specifies DPI Daemonset Template",
										Attributes: map[string]schema.Attribute{
											"spec": schema.SingleNestedAttribute{
												Description:         "Spec specifies DPI Daemonset Template Spec",
												MarkdownDescription: "Spec specifies DPI Daemonset Template Spec",
												Attributes: map[string]schema.Attribute{
													"init_containers": schema.ListNestedAttribute{
														Description:         "List of DPI Daemonset Init containers definitions",
														MarkdownDescription: "List of DPI Daemonset Init containers definitions",
														NestedObject: schema.NestedAttributeObject{
															Attributes: map[string]schema.Attribute{
																"image": schema.StringAttribute{
																	Description:         "Image name for the init container",
																	MarkdownDescription: "Image name for the init container",
																	Required:            true,
																	Optional:            false,
																	Computed:            false,
																},
																...
																"name": schema.StringAttribute{
																	Description:         "Name is an enum that identifies the init container by its name.",
																	MarkdownDescription: "Name is an enum that identifies the init container by its name.",
																	Required:            true,
																	Optional:            false,
																	Computed:            false,
																	Validators: []validator.String{
																		stringvalidator.OneOf("snort-rules"),
																	},
																},

																"resources": schema.SingleNestedAttribute{
																	Description:         "Resources allows customization of limits and requests for compute resources such as cpu and memory. If specified, this overrides the init container's resources. If omitted, the default values will be used for the init container's resources.",
																	MarkdownDescription: "Resources allows customization of limits and requests for compute resources such as cpu and memory. If specified, this overrides the init container's resources. If omitted, the default values will be used for the init container's resources.",
																	Attributes: map[string]schema.Attribute{
																		"claims": schema.ListNestedAttribute{
																			Description:         "Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. This field is immutable. It can only be set for containers.",
																			MarkdownDescription: "Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. This field is immutable. It can only be set for containers.",
