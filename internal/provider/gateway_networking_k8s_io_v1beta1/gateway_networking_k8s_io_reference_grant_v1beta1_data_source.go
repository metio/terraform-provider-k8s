...
var (
	_ datasource.DataSource              = &GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource{}
)

func NewGatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource() datasource.DataSource {
	return &GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource{}
}

type GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSourceData struct {
...
func (r *GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_networking_k8s_io_reference_grant_v1beta1"
}

func (r *GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_gateway_networking_k8s_io_reference_grant_v1beta1")

	var data GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSourceData
	...
	var readResponse GatewayNetworkingK8SIoReferenceGrantV1Beta1DataSourceData
