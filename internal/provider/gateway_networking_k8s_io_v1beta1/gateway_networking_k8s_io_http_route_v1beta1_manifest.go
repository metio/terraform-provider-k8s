								...
								"retry": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"codes": schema.ListAttribute{
											Description:         "Codes defines the HTTP response status codes for which a backend request should be retried. Support: Extended",
											MarkdownDescription: "Codes defines the HTTP response status codes for which a backend request should be retried. Support: Extended",
											ElementType:         types.StringType,
											Required:            false,
											Optional:            true,
											Computed:            false,
