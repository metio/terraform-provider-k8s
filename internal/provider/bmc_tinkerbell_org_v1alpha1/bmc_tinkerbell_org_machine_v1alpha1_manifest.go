...
var (
	_ datasource.DataSource = &BmcTinkerbellOrgMachineV1Alpha1Manifest{}
)

func NewBmcTinkerbellOrgMachineV1Alpha1Manifest() datasource.DataSource {
	return &BmcTinkerbellOrgMachineV1Alpha1Manifest{}
}
...
func (r *BmcTinkerbellOrgMachineV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bmc_tinkerbell_org_machine_v1alpha1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "MachineSpec defines desired machine state.",
				Attributes: map[string]schema.Attribute{
...
func (r *BmcTinkerbellOrgMachineV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bmc_tinkerbell_org_machine_v1alpha1_manifest")

	var model BmcTinkerbellOrgMachineV1Alpha1ManifestData
