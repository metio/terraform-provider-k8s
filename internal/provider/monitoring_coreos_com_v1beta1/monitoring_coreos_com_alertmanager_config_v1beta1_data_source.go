...
var (
	_ datasource.DataSource              = &MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource{}
)

func NewMonitoringCoreosComAlertmanagerConfigV1Beta1DataSource() datasource.DataSource {
	return &MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource{}
}

type MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MonitoringCoreosComAlertmanagerConfigV1Beta1DataSourceData struct {
...
func (r *MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_monitoring_coreos_com_alertmanager_config_v1beta1"
}

func (r *MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MonitoringCoreosComAlertmanagerConfigV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_monitoring_coreos_com_alertmanager_config_v1beta1")

	var data MonitoringCoreosComAlertmanagerConfigV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "monitoring.coreos.com", Version: "v1beta1", Resource: "alertmanagerconfigs"}).
	...
	var readResponse MonitoringCoreosComAlertmanagerConfigV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("monitoring.coreos.com/v1beta1")
