...
var (
	_ datasource.DataSource = &CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest{}
)

func NewCoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest() datasource.DataSource {
	return &CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest{}
}

type CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest struct{}

type CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1ManifestData struct {
...
func (r *CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_core_kubeadmiral_io_cluster_propagation_policy_v1alpha1_manifest"
}

func (r *CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ClusterPropagationPolicy describes the scheduling rules for a resource.",
		MarkdownDescription: "ClusterPropagationPolicy describes the scheduling rules for a resource.",
...
func (r *CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_core_kubeadmiral_io_cluster_propagation_policy_v1alpha1_manifest")

	var model CoreKubeadmiralIoClusterPropagationPolicyV1Alpha1ManifestData
