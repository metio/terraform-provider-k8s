...
var (
	_ datasource.DataSource = &CoreKubeadmiralIoClusterFederatedObjectV1Alpha1Manifest{}
)

func NewCoreKubeadmiralIoClusterFederatedObjectV1Alpha1Manifest() datasource.DataSource {
	return &CoreKubeadmiralIoClusterFederatedObjectV1Alpha1Manifest{}
}
...
func (r *CoreKubeadmiralIoClusterFederatedObjectV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_core_kubeadmiral_io_cluster_federated_object_v1alpha1_manifest"
}

func (r *CoreKubeadmiralIoClusterFederatedObjectV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CoreKubeadmiralIoClusterFederatedObjectV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_core_kubeadmiral_io_cluster_federated_object_v1alpha1_manifest")

	var model CoreKubeadmiralIoClusterFederatedObjectV1Alpha1ManifestData
