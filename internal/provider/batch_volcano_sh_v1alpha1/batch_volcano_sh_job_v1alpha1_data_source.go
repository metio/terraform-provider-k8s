...
var (
	_ datasource.DataSource              = &BatchVolcanoShJobV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &BatchVolcanoShJobV1Alpha1DataSource{}
)

func NewBatchVolcanoShJobV1Alpha1DataSource() datasource.DataSource {
	return &BatchVolcanoShJobV1Alpha1DataSource{}
}

type BatchVolcanoShJobV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type BatchVolcanoShJobV1Alpha1DataSourceData struct {
...
func (r *BatchVolcanoShJobV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_batch_volcano_sh_job_v1alpha1"
}

func (r *BatchVolcanoShJobV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BatchVolcanoShJobV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *BatchVolcanoShJobV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_batch_volcano_sh_job_v1alpha1")

	var data BatchVolcanoShJobV1Alpha1DataSourceData
	...
	var readResponse BatchVolcanoShJobV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("batch.volcano.sh/v1alpha1")
