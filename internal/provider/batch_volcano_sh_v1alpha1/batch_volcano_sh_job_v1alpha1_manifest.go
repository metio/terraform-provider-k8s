...
var (
	_ datasource.DataSource = &BatchVolcanoShJobV1Alpha1Manifest{}
)

func NewBatchVolcanoShJobV1Alpha1Manifest() datasource.DataSource {
	return &BatchVolcanoShJobV1Alpha1Manifest{}
}

type BatchVolcanoShJobV1Alpha1Manifest struct{}

type BatchVolcanoShJobV1Alpha1ManifestData struct {
...
func (r *BatchVolcanoShJobV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_batch_volcano_sh_job_v1alpha1_manifest"
}

func (r *BatchVolcanoShJobV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BatchVolcanoShJobV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_batch_volcano_sh_job_v1alpha1_manifest")

	var model BatchVolcanoShJobV1Alpha1ManifestData
	...
	model.ApiVersion = pointer.String("batch.volcano.sh/v1alpha1")
