...
var (
	_ datasource.DataSource              = &ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource{}
)

func NewApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource() datasource.DataSource {
	return &ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource{}
}

type ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSourceData struct {
...
func (r *ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_apiextensions_crossplane_io_composition_revision_v1beta1"
}

func (r *ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_apiextensions_crossplane_io_composition_revision_v1beta1")

	var data ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSourceData
	...
	var readResponse ApiextensionsCrossplaneIoCompositionRevisionV1Beta1DataSourceData
	...
	data.ApiVersion = pointer.String("apiextensions.crossplane.io/v1beta1")
