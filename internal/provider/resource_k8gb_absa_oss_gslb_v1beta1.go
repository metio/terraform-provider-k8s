...
type K8GbAbsaOssGslbV1Beta1Resource struct{}

var (
	_ resource.Resource = (*K8GbAbsaOssGslbV1Beta1Resource)(nil)
)

type K8GbAbsaOssGslbV1Beta1TerraformModel struct {
...
type K8GbAbsaOssGslbV1Beta1GoModel struct {
	...
	Spec *struct {
		...
		Strategy *struct {
			DnsTtlSeconds *int64 `tfsdk:"dns_ttl_seconds" yaml:"dnsTtlSeconds,omitempty"`

			PrimaryGeoTag *string `tfsdk:"primary_geo_tag" yaml:"primaryGeoTag,omitempty"`

			SplitBrainThresholdSeconds *int64 `tfsdk:"split_brain_threshold_seconds" yaml:"splitBrainThresholdSeconds,omitempty"`

			Type *string `tfsdk:"type" yaml:"type,omitempty"`

			Weight *map[string]string `tfsdk:"weight" yaml:"weight,omitempty"`
		} `tfsdk:"strategy" yaml:"strategy,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}

func NewK8GbAbsaOssGslbV1Beta1Resource() resource.Resource {
	return &K8GbAbsaOssGslbV1Beta1Resource{}
}

func (r *K8GbAbsaOssGslbV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_k8gb_absa_oss_gslb_v1beta1"
}

func (r *K8GbAbsaOssGslbV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *K8GbAbsaOssGslbV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_k8gb_absa_oss_gslb_v1beta1")

	var state K8GbAbsaOssGslbV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel K8GbAbsaOssGslbV1Beta1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("k8gb.absa.oss/v1beta1")
	goModel.Kind = utilities.Ptr("Gslb")
...
func (r *K8GbAbsaOssGslbV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8gb_absa_oss_gslb_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *K8GbAbsaOssGslbV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_k8gb_absa_oss_gslb_v1beta1")
...
func (r *K8GbAbsaOssGslbV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_k8gb_absa_oss_gslb_v1beta1")
