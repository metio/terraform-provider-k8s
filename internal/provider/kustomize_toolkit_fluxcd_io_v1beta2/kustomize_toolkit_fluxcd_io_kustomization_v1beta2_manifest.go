...
var (
	_ datasource.DataSource = &KustomizeToolkitFluxcdIoKustomizationV1Beta2Manifest{}
)

func NewKustomizeToolkitFluxcdIoKustomizationV1Beta2Manifest() datasource.DataSource {
	return &KustomizeToolkitFluxcdIoKustomizationV1Beta2Manifest{}
}

type KustomizeToolkitFluxcdIoKustomizationV1Beta2Manifest struct{}

type KustomizeToolkitFluxcdIoKustomizationV1Beta2ManifestData struct {
...
func (r *KustomizeToolkitFluxcdIoKustomizationV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kustomize_toolkit_fluxcd_io_kustomization_v1beta2_manifest"
}
...
func (r *KustomizeToolkitFluxcdIoKustomizationV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kustomize_toolkit_fluxcd_io_kustomization_v1beta2_manifest")

	var model KustomizeToolkitFluxcdIoKustomizationV1Beta2ManifestData
