...
var (
	_ datasource.DataSource              = &KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource{}
	_ datasource.DataSourceWithConfigure = &KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource{}
)

func NewKustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource() datasource.DataSource {
	return &KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource{}
}

type KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource struct {
	kubernetesClient dynamic.Interface
}

type KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSourceData struct {
...
func (r *KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kustomize_toolkit_fluxcd_io_kustomization_v1beta2"
}

func (r *KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kustomize_toolkit_fluxcd_io_kustomization_v1beta2")

	var data KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSourceData
	...
	var readResponse KustomizeToolkitFluxcdIoKustomizationV1Beta2DataSourceData
	...
	data.ApiVersion = pointer.String("kustomize.toolkit.fluxcd.io/v1beta2")
