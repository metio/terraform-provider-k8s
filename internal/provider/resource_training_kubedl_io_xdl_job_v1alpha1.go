...
var (
	_ resource.Resource = (*TrainingKubedlIoXDLJobV1Alpha1Resource)(nil)
)

type TrainingKubedlIoXDLJobV1Alpha1TerraformModel struct {
...
type TrainingKubedlIoXDLJobV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		MinFinishWorkNum *int64 `tfsdk:"min_finish_work_num" yaml:"minFinishWorkNum,omitempty"`

		MinFinishWorkRate *int64 `tfsdk:"min_finish_work_rate" yaml:"minFinishWorkRate,omitempty"`
		...
		} `tfsdk:"xdl_replica_specs" yaml:"xdlReplicaSpecs,omitempty"`
	} `tfsdk:"spec" yaml:"spec,omitempty"`
}
...
func (r *TrainingKubedlIoXDLJobV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_training_kubedl_io_xdl_job_v1alpha1"
}

func (r *TrainingKubedlIoXDLJobV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *TrainingKubedlIoXDLJobV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_training_kubedl_io_xdl_job_v1alpha1")

	var state TrainingKubedlIoXDLJobV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel TrainingKubedlIoXDLJobV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("XDLJob")
...
func (r *TrainingKubedlIoXDLJobV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_xdl_job_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *TrainingKubedlIoXDLJobV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *TrainingKubedlIoXDLJobV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
