...
var (
	_ datasource.DataSource = &Capabilities3ScaleNetProxyConfigPromoteV1Beta1Manifest{}
)

func NewCapabilities3ScaleNetProxyConfigPromoteV1Beta1Manifest() datasource.DataSource {
	return &Capabilities3ScaleNetProxyConfigPromoteV1Beta1Manifest{}
}
...
func (r *Capabilities3ScaleNetProxyConfigPromoteV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capabilities_3scale_net_proxy_config_promote_v1beta1_manifest"
}

func (r *Capabilities3ScaleNetProxyConfigPromoteV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ProxyConfigPromote is the Schema for the proxyconfigpromotes API",
		MarkdownDescription: "ProxyConfigPromote is the Schema for the proxyconfigpromotes API",
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"production": schema.BoolAttribute{
						...
						MarkdownDescription: "Environment you wish to promote to, if not present defaults to staging and if set to true promotes to production",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *Capabilities3ScaleNetProxyConfigPromoteV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_capabilities_3scale_net_proxy_config_promote_v1beta1_manifest")

	var model Capabilities3ScaleNetProxyConfigPromoteV1Beta1ManifestData
	...
	model.Kind = pointer.String("ProxyConfigPromote")
