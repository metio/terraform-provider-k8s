...
var (
	_ datasource.DataSource = &Capabilities3ScaleNetActiveDocV1Beta1Manifest{}
)

func NewCapabilities3ScaleNetActiveDocV1Beta1Manifest() datasource.DataSource {
	return &Capabilities3ScaleNetActiveDocV1Beta1Manifest{}
}
...
func (r *Capabilities3ScaleNetActiveDocV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_capabilities_3scale_net_active_doc_v1beta1_manifest"
}

func (r *Capabilities3ScaleNetActiveDocV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ActiveDoc is the Schema for the activedocs API",
		MarkdownDescription: "ActiveDoc is the Schema for the activedocs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ActiveDocSpec defines the desired state of ActiveDoc",
				Attributes: map[string]schema.Attribute{
					"active_doc_open_api_ref": schema.SingleNestedAttribute{
						Description:         "ActiveDocOpenAPIRef Reference to the OpenAPI Specification",
						MarkdownDescription: "ActiveDocOpenAPIRef Reference to the OpenAPI Specification",
						Attributes: map[string]schema.Attribute{
					...
					"description": schema.StringAttribute{
						...
						MarkdownDescription: "Description is a human readable text of the activedoc",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"name": schema.StringAttribute{
						...
						MarkdownDescription: "Name is human readable name for the activedoc",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"product_system_name": schema.StringAttribute{
						...
						MarkdownDescription: "ProductSystemName identifies uniquely the product",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"published": schema.BoolAttribute{
						...
						MarkdownDescription: "Published switch to publish the activedoc",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"skip_swagger_validations": schema.BoolAttribute{
						Description:         "SkipSwaggerValidations switch to skip OpenAPI validation",
						MarkdownDescription: "SkipSwaggerValidations switch to skip OpenAPI validation",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"system_name": schema.StringAttribute{
						Description:         "SystemName identifies uniquely the activedoc within the account provider Default value will be sanitized Name",
						MarkdownDescription: "SystemName identifies uniquely the activedoc within the account provider Default value will be sanitized Name",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *Capabilities3ScaleNetActiveDocV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_capabilities_3scale_net_active_doc_v1beta1_manifest")

	var model Capabilities3ScaleNetActiveDocV1Beta1ManifestData
	...
	model.Kind = pointer.String("ActiveDoc")
