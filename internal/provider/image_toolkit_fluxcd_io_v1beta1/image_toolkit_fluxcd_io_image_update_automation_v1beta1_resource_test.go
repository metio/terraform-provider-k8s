...
func TestImageToolkitFluxcdIoImageUpdateAutomationV1Beta1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_image_toolkit_fluxcd_io_image_update_automation_v1beta1", testCase)
		})
	}
}
