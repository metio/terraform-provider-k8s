...
var (
	_ datasource.DataSource              = &ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource{}
)

func NewImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource() datasource.DataSource {
	return &ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource{}
}

type ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSourceData struct {
...
func (r *ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_image_toolkit_fluxcd_io_image_repository_v1beta1"
}

func (r *ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_image_toolkit_fluxcd_io_image_repository_v1beta1")

	var data ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSourceData
	...
	var readResponse ImageToolkitFluxcdIoImageRepositoryV1Beta1DataSourceData
