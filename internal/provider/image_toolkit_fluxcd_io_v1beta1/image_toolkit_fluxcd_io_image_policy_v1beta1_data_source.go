...
var (
	_ datasource.DataSource              = &ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource{}
)

func NewImageToolkitFluxcdIoImagePolicyV1Beta1DataSource() datasource.DataSource {
	return &ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource{}
}

type ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ImageToolkitFluxcdIoImagePolicyV1Beta1DataSourceData struct {
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_image_toolkit_fluxcd_io_image_policy_v1beta1"
}

func (r *ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_image_toolkit_fluxcd_io_image_policy_v1beta1")

	var data ImageToolkitFluxcdIoImagePolicyV1Beta1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "image.toolkit.fluxcd.io", Version: "v1beta1", Resource: "imagepolicies"}).
	...
	var readResponse ImageToolkitFluxcdIoImagePolicyV1Beta1DataSourceData
