...
var (
	_ datasource.DataSource              = &OperatorAquasecComAquaServerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorAquasecComAquaServerV1Alpha1DataSource{}
)

func NewOperatorAquasecComAquaServerV1Alpha1DataSource() datasource.DataSource {
	return &OperatorAquasecComAquaServerV1Alpha1DataSource{}
}

type OperatorAquasecComAquaServerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorAquasecComAquaServerV1Alpha1DataSourceData struct {
...
func (r *OperatorAquasecComAquaServerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_server_v1alpha1"
}

func (r *OperatorAquasecComAquaServerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaServerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorAquasecComAquaServerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_aquasec_com_aqua_server_v1alpha1")

	var data OperatorAquasecComAquaServerV1Alpha1DataSourceData
	...
	var readResponse OperatorAquasecComAquaServerV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("AquaServer")
