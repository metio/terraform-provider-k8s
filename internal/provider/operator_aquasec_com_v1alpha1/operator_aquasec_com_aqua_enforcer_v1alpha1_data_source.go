...
var (
	_ datasource.DataSource              = &OperatorAquasecComAquaEnforcerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorAquasecComAquaEnforcerV1Alpha1DataSource{}
)

func NewOperatorAquasecComAquaEnforcerV1Alpha1DataSource() datasource.DataSource {
	return &OperatorAquasecComAquaEnforcerV1Alpha1DataSource{}
}

type OperatorAquasecComAquaEnforcerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorAquasecComAquaEnforcerV1Alpha1DataSourceData struct {
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_enforcer_v1alpha1"
}

func (r *OperatorAquasecComAquaEnforcerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_aquasec_com_aqua_enforcer_v1alpha1")

	var data OperatorAquasecComAquaEnforcerV1Alpha1DataSourceData
	...
	var readResponse OperatorAquasecComAquaEnforcerV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("AquaEnforcer")
