...
var (
	_ datasource.DataSource = &OperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest{}
)

func NewOperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest() datasource.DataSource {
	return &OperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest{}
}

type OperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest struct{}

type OperatorAquasecComAquaKubeEnforcerV1Alpha1ManifestData struct {
...
func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_kube_enforcer_v1alpha1_manifest"
}

func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaKubeEnforcerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_kube_enforcer_v1alpha1_manifest")

	var model OperatorAquasecComAquaKubeEnforcerV1Alpha1ManifestData
