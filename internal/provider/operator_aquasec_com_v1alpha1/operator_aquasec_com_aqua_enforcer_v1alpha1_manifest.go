...
var (
	_ datasource.DataSource = &OperatorAquasecComAquaEnforcerV1Alpha1Manifest{}
)

func NewOperatorAquasecComAquaEnforcerV1Alpha1Manifest() datasource.DataSource {
	return &OperatorAquasecComAquaEnforcerV1Alpha1Manifest{}
}

type OperatorAquasecComAquaEnforcerV1Alpha1Manifest struct{}

type OperatorAquasecComAquaEnforcerV1Alpha1ManifestData struct {
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_enforcer_v1alpha1_manifest"
}

func (r *OperatorAquasecComAquaEnforcerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaEnforcerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_enforcer_v1alpha1_manifest")

	var model OperatorAquasecComAquaEnforcerV1Alpha1ManifestData
