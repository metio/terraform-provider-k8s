...
var (
	_ datasource.DataSource              = &OperatorAquasecComAquaCspV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorAquasecComAquaCspV1Alpha1DataSource{}
)

func NewOperatorAquasecComAquaCspV1Alpha1DataSource() datasource.DataSource {
	return &OperatorAquasecComAquaCspV1Alpha1DataSource{}
}

type OperatorAquasecComAquaCspV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorAquasecComAquaCspV1Alpha1DataSourceData struct {
...
func (r *OperatorAquasecComAquaCspV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_csp_v1alpha1"
}

func (r *OperatorAquasecComAquaCspV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaCspV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorAquasecComAquaCspV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_aquasec_com_aqua_csp_v1alpha1")

	var data OperatorAquasecComAquaCspV1Alpha1DataSourceData
	...
	var readResponse OperatorAquasecComAquaCspV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("AquaCsp")
