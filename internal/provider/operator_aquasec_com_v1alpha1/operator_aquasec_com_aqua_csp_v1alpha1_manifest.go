...
var (
	_ datasource.DataSource = &OperatorAquasecComAquaCspV1Alpha1Manifest{}
)

func NewOperatorAquasecComAquaCspV1Alpha1Manifest() datasource.DataSource {
	return &OperatorAquasecComAquaCspV1Alpha1Manifest{}
}

type OperatorAquasecComAquaCspV1Alpha1Manifest struct{}

type OperatorAquasecComAquaCspV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"gateway_envs" json:"gatewayEnvs,omitempty"`
		Infra *struct {
		...
		KubeEnforcer *struct {
			Registry *string `tfsdk:"registry" json:"registry,omitempty"`
			Tag      *string `tfsdk:"tag" json:"tag,omitempty"`
		} `tfsdk:"kube_enforcer" json:"kubeEnforcer,omitempty"`
		...
		ServerConfigMapData *map[string]string `tfsdk:"server_config_map_data" json:"serverConfigMapData,omitempty"`
		ServerEnvs          *[]struct {
			Name      *string `tfsdk:"name" json:"name,omitempty"`
			Value     *string `tfsdk:"value" json:"value,omitempty"`
			ValueFrom *struct {
		...
		} `tfsdk:"server_envs" json:"serverEnvs,omitempty"`
		UpdateEnforcer *bool `tfsdk:"update_enforcer" json:"updateEnforcer,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *OperatorAquasecComAquaCspV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_csp_v1alpha1_manifest"
}

func (r *OperatorAquasecComAquaCspV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "AquaCsp is the Schema for the aquacsps API",
		MarkdownDescription: "AquaCsp is the Schema for the aquacsps API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "AquaCspSpec defines the desired state of AquaCsp",
				Attributes: map[string]schema.Attribute{
					...
					"gateway_envs": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"kube_enforcer": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"registry": schema.StringAttribute{
					...
					"server_config_map_data": schema.MapAttribute{
						Description:         "",
						MarkdownDescription: "",
						ElementType:         types.StringType,
						Required:            false,
					...
					"server_envs": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *OperatorAquasecComAquaCspV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_csp_v1alpha1_manifest")

	var model OperatorAquasecComAquaCspV1Alpha1ManifestData
	...
	model.Kind = pointer.String("AquaCsp")
