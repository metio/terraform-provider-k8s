...
var (
	_ datasource.DataSource              = &OperatorAquasecComAquaGatewayV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorAquasecComAquaGatewayV1Alpha1DataSource{}
)

func NewOperatorAquasecComAquaGatewayV1Alpha1DataSource() datasource.DataSource {
	return &OperatorAquasecComAquaGatewayV1Alpha1DataSource{}
}

type OperatorAquasecComAquaGatewayV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorAquasecComAquaGatewayV1Alpha1DataSourceData struct {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_gateway_v1alpha1"
}

func (r *OperatorAquasecComAquaGatewayV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_aquasec_com_aqua_gateway_v1alpha1")

	var data OperatorAquasecComAquaGatewayV1Alpha1DataSourceData
	...
	var readResponse OperatorAquasecComAquaGatewayV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("AquaGateway")
