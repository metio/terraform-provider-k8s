...
var (
	_ datasource.DataSource = &OperatorAquasecComAquaServerV1Alpha1Manifest{}
)

func NewOperatorAquasecComAquaServerV1Alpha1Manifest() datasource.DataSource {
	return &OperatorAquasecComAquaServerV1Alpha1Manifest{}
}

type OperatorAquasecComAquaServerV1Alpha1Manifest struct{}

type OperatorAquasecComAquaServerV1Alpha1ManifestData struct {
...
func (r *OperatorAquasecComAquaServerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_server_v1alpha1_manifest"
}

func (r *OperatorAquasecComAquaServerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaServerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_server_v1alpha1_manifest")

	var model OperatorAquasecComAquaServerV1Alpha1ManifestData
