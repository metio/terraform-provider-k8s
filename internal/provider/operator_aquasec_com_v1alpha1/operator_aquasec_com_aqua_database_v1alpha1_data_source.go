...
var (
	_ datasource.DataSource              = &OperatorAquasecComAquaDatabaseV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorAquasecComAquaDatabaseV1Alpha1DataSource{}
)

func NewOperatorAquasecComAquaDatabaseV1Alpha1DataSource() datasource.DataSource {
	return &OperatorAquasecComAquaDatabaseV1Alpha1DataSource{}
}

type OperatorAquasecComAquaDatabaseV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorAquasecComAquaDatabaseV1Alpha1DataSourceData struct {
...
func (r *OperatorAquasecComAquaDatabaseV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_database_v1alpha1"
}

func (r *OperatorAquasecComAquaDatabaseV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaDatabaseV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorAquasecComAquaDatabaseV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_aquasec_com_aqua_database_v1alpha1")

	var data OperatorAquasecComAquaDatabaseV1Alpha1DataSourceData
	...
	var readResponse OperatorAquasecComAquaDatabaseV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("AquaDatabase")
