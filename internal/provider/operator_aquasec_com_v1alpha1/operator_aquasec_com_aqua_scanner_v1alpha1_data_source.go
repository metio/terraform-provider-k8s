...
var (
	_ datasource.DataSource              = &OperatorAquasecComAquaScannerV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &OperatorAquasecComAquaScannerV1Alpha1DataSource{}
)

func NewOperatorAquasecComAquaScannerV1Alpha1DataSource() datasource.DataSource {
	return &OperatorAquasecComAquaScannerV1Alpha1DataSource{}
}

type OperatorAquasecComAquaScannerV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type OperatorAquasecComAquaScannerV1Alpha1DataSourceData struct {
...
func (r *OperatorAquasecComAquaScannerV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_scanner_v1alpha1"
}

func (r *OperatorAquasecComAquaScannerV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaScannerV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OperatorAquasecComAquaScannerV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_operator_aquasec_com_aqua_scanner_v1alpha1")

	var data OperatorAquasecComAquaScannerV1Alpha1DataSourceData
	...
	var readResponse OperatorAquasecComAquaScannerV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("AquaScanner")
