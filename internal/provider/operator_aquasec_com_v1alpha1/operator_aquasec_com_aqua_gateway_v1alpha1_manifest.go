...
var (
	_ datasource.DataSource = &OperatorAquasecComAquaGatewayV1Alpha1Manifest{}
)

func NewOperatorAquasecComAquaGatewayV1Alpha1Manifest() datasource.DataSource {
	return &OperatorAquasecComAquaGatewayV1Alpha1Manifest{}
}

type OperatorAquasecComAquaGatewayV1Alpha1Manifest struct{}

type OperatorAquasecComAquaGatewayV1Alpha1ManifestData struct {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_gateway_v1alpha1_manifest"
}

func (r *OperatorAquasecComAquaGatewayV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaGatewayV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_gateway_v1alpha1_manifest")

	var model OperatorAquasecComAquaGatewayV1Alpha1ManifestData
