...
var (
	_ datasource.DataSource = &OperatorAquasecComAquaScannerV1Alpha1Manifest{}
)

func NewOperatorAquasecComAquaScannerV1Alpha1Manifest() datasource.DataSource {
	return &OperatorAquasecComAquaScannerV1Alpha1Manifest{}
}

type OperatorAquasecComAquaScannerV1Alpha1Manifest struct{}

type OperatorAquasecComAquaScannerV1Alpha1ManifestData struct {
...
func (r *OperatorAquasecComAquaScannerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_operator_aquasec_com_aqua_scanner_v1alpha1_manifest"
}

func (r *OperatorAquasecComAquaScannerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OperatorAquasecComAquaScannerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_aquasec_com_aqua_scanner_v1alpha1_manifest")

	var model OperatorAquasecComAquaScannerV1Alpha1ManifestData
