...
var (
	_ datasource.DataSource = &ActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest{}
)

func NewActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest() datasource.DataSource {
	return &ActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest{}
}

type ActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest struct{}

type ActionsSummerwindDevRunnerDeploymentV1Alpha1ManifestData struct {
...
func (r *ActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_summerwind_dev_runner_deployment_v1alpha1_manifest"
}

func (r *ActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "RunnerDeployment is the Schema for the runnerdeployments API",
		MarkdownDescription: "RunnerDeployment is the Schema for the runnerdeployments API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "RunnerDeploymentSpec defines the desired state of RunnerDeployment",
				Attributes: map[string]schema.Attribute{
					"effective_time": schema.StringAttribute{
						...
						MarkdownDescription: "EffectiveTime is the time the upstream controller requested to sync Replicas. It is usually populated by the webhook-based autoscaler via HRA. The value is inherited to RunnerReplicaSet(s) and used to prevent ephemeral runners from unnecessarily recreated.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *ActionsSummerwindDevRunnerDeploymentV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_summerwind_dev_runner_deployment_v1alpha1_manifest")

	var model ActionsSummerwindDevRunnerDeploymentV1Alpha1ManifestData
	...
	model.Kind = pointer.String("RunnerDeployment")
