...
var (
	_ datasource.DataSource = &ActionsSummerwindDevRunnerV1Alpha1Manifest{}
)

func NewActionsSummerwindDevRunnerV1Alpha1Manifest() datasource.DataSource {
	return &ActionsSummerwindDevRunnerV1Alpha1Manifest{}
}

type ActionsSummerwindDevRunnerV1Alpha1Manifest struct{}

type ActionsSummerwindDevRunnerV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"docker_env" json:"dockerEnv,omitempty"`
		...
		DockerVolumeMounts          *[]struct {
			...
			SubPath          *string `tfsdk:"sub_path" json:"subPath,omitempty"`
			SubPathExpr      *string `tfsdk:"sub_path_expr" json:"subPathExpr,omitempty"`
		} `tfsdk:"docker_volume_mounts" json:"dockerVolumeMounts,omitempty"`
		DockerdContainerResources *struct {
			Claims *[]struct {
				Name *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"claims" json:"claims,omitempty"`
			Limits   *map[string]string `tfsdk:"limits" json:"limits,omitempty"`
			Requests *map[string]string `tfsdk:"requests" json:"requests,omitempty"`
		} `tfsdk:"dockerd_container_resources" json:"dockerdContainerResources,omitempty"`
...
func (r *ActionsSummerwindDevRunnerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_summerwind_dev_runner_v1alpha1_manifest"
}

func (r *ActionsSummerwindDevRunnerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Runner is the Schema for the runners API",
		MarkdownDescription: "Runner is the Schema for the runners API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "RunnerSpec defines the desired state of Runner",
				Attributes: map[string]schema.Attribute{
					...
					"dns_config": schema.SingleNestedAttribute{
						Description:         "PodDNSConfig defines the DNS parameters of a pod in addition tothose generated from DNSPolicy.",
						MarkdownDescription: "PodDNSConfig defines the DNS parameters of a pod in addition tothose generated from DNSPolicy.",
						Attributes: map[string]schema.Attribute{
					...
					"docker_env": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"docker_volume_mounts": schema.ListNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"dockerd_container_resources": schema.SingleNestedAttribute{
					...
					"runtime_class_name": schema.StringAttribute{
						...
						MarkdownDescription: "RuntimeClassName is the container runtime configuration that containers should run under.More info: https://kubernetes.io/docs/concepts/containers/runtime-class",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"security_context": schema.SingleNestedAttribute{
						Description:         "PodSecurityContext holds pod-level security attributes and common container settings.Some fields are also present in container.securityContext.  Field values ofcontainer.securityContext take precedence over field values of PodSecurityContext.",
						MarkdownDescription: "PodSecurityContext holds pod-level security attributes and common container settings.Some fields are also present in container.securityContext.  Field values ofcontainer.securityContext take precedence over field values of PodSecurityContext.",
						Attributes: map[string]schema.Attribute{
...
func (r *ActionsSummerwindDevRunnerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_summerwind_dev_runner_v1alpha1_manifest")

	var model ActionsSummerwindDevRunnerV1Alpha1ManifestData
