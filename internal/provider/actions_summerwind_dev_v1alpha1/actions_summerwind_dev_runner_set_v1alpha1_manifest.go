			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"ordinals": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ordinals controls the numbering of replica indices in a StatefulSet. The default ordinals behavior assigns a '0' index to the first replica and increments the index by one for each additional replica requested.",
						Attributes: map[string]schema.Attribute{
					...
					"update_strategy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.",
						Attributes: map[string]schema.Attribute{
