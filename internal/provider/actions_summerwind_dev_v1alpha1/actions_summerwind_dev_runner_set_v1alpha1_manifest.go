			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"ordinals": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "ordinals controls the numbering of replica indices in a StatefulSet. The default ordinals behavior assigns a '0' index to the first replica and increments the index by one for each additional replica requested. Using the ordinals field requires the StatefulSetStartOrdinal feature gate to be enabled, which is beta.",
						Attributes: map[string]schema.Attribute{
					...
					"replicas": schema.Int64Attribute{
						...
						MarkdownDescription: "replicas is the desired number of replicas of the given Template. These are replicas in the sense that they are instantiations of the same Template, but individual replicas also have a consistent identity. If unspecified, defaults to 1. TODO: Consider a rename of this field.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
