...
var (
	_ datasource.DataSource = &ActionsSummerwindDevRunnerSetV1Alpha1Manifest{}
)

func NewActionsSummerwindDevRunnerSetV1Alpha1Manifest() datasource.DataSource {
	return &ActionsSummerwindDevRunnerSetV1Alpha1Manifest{}
}

type ActionsSummerwindDevRunnerSetV1Alpha1Manifest struct{}

type ActionsSummerwindDevRunnerSetV1Alpha1ManifestData struct {
	...
	Spec *struct {
		ContainerMode                *string `tfsdk:"container_mode" json:"containerMode,omitempty"`
		DockerEnabled                *bool   `tfsdk:"docker_enabled" json:"dockerEnabled,omitempty"`
		DockerMTU                    *int64  `tfsdk:"docker_mtu" json:"dockerMTU,omitempty"`
		DockerRegistryMirror         *string `tfsdk:"docker_registry_mirror" json:"dockerRegistryMirror,omitempty"`
		DockerVarRunVolumeSizeLimit  *string `tfsdk:"docker_var_run_volume_size_limit" json:"dockerVarRunVolumeSizeLimit,omitempty"`
		DockerdWithinRunnerContainer *bool   `tfsdk:"dockerd_within_runner_container" json:"dockerdWithinRunnerContainer,omitempty"`
		EffectiveTime                *string `tfsdk:"effective_time" json:"effectiveTime,omitempty"`
		Enterprise                   *string `tfsdk:"enterprise" json:"enterprise,omitempty"`
		...
		VolumeSizeLimit         *string `tfsdk:"volume_size_limit" json:"volumeSizeLimit,omitempty"`
		VolumeStorageMedium     *string `tfsdk:"volume_storage_medium" json:"volumeStorageMedium,omitempty"`
		WorkDir                 *string `tfsdk:"work_dir" json:"workDir,omitempty"`
		WorkVolumeClaimTemplate *struct {
			AccessModes *[]string `tfsdk:"access_modes" json:"accessModes,omitempty"`
			Resources   *struct {
				Claims *[]struct {
					Name *string `tfsdk:"name" json:"name,omitempty"`
			...
			StorageClassName *string `tfsdk:"storage_class_name" json:"storageClassName,omitempty"`
		} `tfsdk:"work_volume_claim_template" json:"workVolumeClaimTemplate,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *ActionsSummerwindDevRunnerSetV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_summerwind_dev_runner_set_v1alpha1_manifest"
}

func (r *ActionsSummerwindDevRunnerSetV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "RunnerSet is the Schema for the runnersets API",
		MarkdownDescription: "RunnerSet is the Schema for the runnersets API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "RunnerSetSpec defines the desired state of RunnerSet",
				Attributes: map[string]schema.Attribute{
					...
					"docker_enabled": schema.BoolAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"docker_mtu": schema.Int64Attribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"docker_registry_mirror": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"docker_var_run_volume_size_limit": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"dockerd_within_runner_container": schema.BoolAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"effective_time": schema.StringAttribute{
						...
						MarkdownDescription: "EffectiveTime is the time the upstream controller requested to sync Replicas.It is usually populated by the webhook-based autoscaler via HRA.It is used to prevent ephemeral runners from unnecessarily recreated.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"min_ready_seconds": schema.Int64Attribute{
						Description:         "Minimum number of seconds for which a newly created pod should be readywithout any of its container crashing for it to be considered available.Defaults to 0 (pod will be considered available as soon as it is ready)",
						MarkdownDescription: "Minimum number of seconds for which a newly created pod should be readywithout any of its container crashing for it to be considered available.Defaults to 0 (pod will be considered available as soon as it is ready)",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"ordinals": schema.SingleNestedAttribute{
						Description:         "ordinals controls the numbering of replica indices in a StatefulSet. Thedefault ordinals behavior assigns a '0' index to the first replica andincrements the index by one for each additional replica requested. Usingthe ordinals field requires the StatefulSetStartOrdinal feature gate to beenabled, which is beta.",
						MarkdownDescription: "ordinals controls the numbering of replica indices in a StatefulSet. Thedefault ordinals behavior assigns a '0' index to the first replica andincrements the index by one for each additional replica requested. Usingthe ordinals field requires the StatefulSetStartOrdinal feature gate to beenabled, which is beta.",
						Attributes: map[string]schema.Attribute{
							"start": schema.Int64Attribute{
								Description:         "start is the number representing the first replica's index. It may be usedto number replicas from an alternate index (eg: 1-indexed) over the default0-indexed names, or to orchestrate progressive movement of replicas fromone StatefulSet to another.If set, replica indices will be in the range:  [.spec.ordinals.start, .spec.ordinals.start + .spec.replicas).If unset, defaults to 0. Replica indices will be in the range:  [0, .spec.replicas).",
								MarkdownDescription: "start is the number representing the first replica's index. It may be usedto number replicas from an alternate index (eg: 1-indexed) over the default0-indexed names, or to orchestrate progressive movement of replicas fromone StatefulSet to another.If set, replica indices will be in the range:  [.spec.ordinals.start, .spec.ordinals.start + .spec.replicas).If unset, defaults to 0. Replica indices will be in the range:  [0, .spec.replicas).",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"persistent_volume_claim_retention_policy": schema.SingleNestedAttribute{
						Description:         "persistentVolumeClaimRetentionPolicy describes the lifecycle of persistentvolume claims created from volumeClaimTemplates. By default, all persistentvolume claims are created as needed and retained until manually deleted. Thispolicy allows the lifecycle to be altered, for example by deleting persistentvolume claims when their stateful set is deleted, or when their pod is scaleddown. This requires the StatefulSetAutoDeletePVC feature gate to be enabled,which is alpha.  +optional",
					...
					"pod_management_policy": schema.StringAttribute{
						Description:         "podManagementPolicy controls how pods are created during initial scale up,when replacing pods on nodes, or when scaling down. The default policy is'OrderedReady', where pods are created in increasing order (pod-0, thenpod-1, etc) and the controller will wait until each pod is ready beforecontinuing. When scaling down, the pods are removed in the opposite order.The alternative policy is 'Parallel' which will create pods in parallelto match the desired scale without waiting, and on scale down will deleteall pods at once.",
					...
					"replicas": schema.Int64Attribute{
						Description:         "replicas is the desired number of replicas of the given Template.These are replicas in the sense that they are instantiations of thesame Template, but individual replicas also have a consistent identity.If unspecified, defaults to 1.TODO: Consider a rename of this field.",
						MarkdownDescription: "replicas is the desired number of replicas of the given Template.These are replicas in the sense that they are instantiations of thesame Template, but individual replicas also have a consistent identity.If unspecified, defaults to 1.TODO: Consider a rename of this field.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"revision_history_limit": schema.Int64Attribute{
						Description:         "revisionHistoryLimit is the maximum number of revisions that willbe maintained in the StatefulSet's revision history. The revision historyconsists of all revisions not represented by a currently appliedStatefulSetSpec version. The default value is 10.",
						MarkdownDescription: "revisionHistoryLimit is the maximum number of revisions that willbe maintained in the StatefulSet's revision history. The revision historyconsists of all revisions not represented by a currently appliedStatefulSetSpec version. The default value is 10.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"selector": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "selector is a label query over pods that should match the replica count.It must match the pod template's labels.More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors",
						Attributes: map[string]schema.Attribute{
					...
					"service_name": schema.StringAttribute{
						Description:         "serviceName is the name of the service that governs this StatefulSet.This service must exist before the StatefulSet, and is responsible forthe network identity of the set. Pods get DNS/hostnames that follow thepattern: pod-specific-string.serviceName.default.svc.cluster.localwhere 'pod-specific-string' is managed by the StatefulSet controller.",
					...
					"template": schema.SingleNestedAttribute{
						Description:         "template is the object that describes the pod that will be created ifinsufficient replicas are detected. Each pod stamped out by the StatefulSetwill fulfill this Template, but have a unique identity from the restof the StatefulSet. Each pod will be named with the format<statefulsetname>-<podindex>. For example, a pod in a StatefulSet named'web' with index number '3' would be named 'web-3'.The only allowed template.spec.restartPolicy value is 'Always'.",
						MarkdownDescription: "template is the object that describes the pod that will be created ifinsufficient replicas are detected. Each pod stamped out by the StatefulSetwill fulfill this Template, but have a unique identity from the restof the StatefulSet. Each pod will be named with the format<statefulsetname>-<podindex>. For example, a pod in a StatefulSet named'web' with index number '3' would be named 'web-3'.The only allowed template.spec.restartPolicy value is 'Always'.",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
					...
					"update_strategy": schema.SingleNestedAttribute{
						Description:         "updateStrategy indicates the StatefulSetUpdateStrategy that will beemployed to update Pods in the StatefulSet when a revision is made toTemplate.",
						MarkdownDescription: "updateStrategy indicates the StatefulSetUpdateStrategy that will beemployed to update Pods in the StatefulSet when a revision is made toTemplate.",
						Attributes: map[string]schema.Attribute{
					...
					"volume_claim_templates": schema.ListNestedAttribute{
						Description:         "volumeClaimTemplates is a list of claims that pods are allowed to reference.The StatefulSet controller is responsible for mapping network identities toclaims in a way that maintains the identity of a pod. Every claim inthis list must have at least one matching (by name) volumeMount in onecontainer in the template. A claim in this list takes precedence overany volumes in the template, with the same name.TODO: Define the behavior if a claim already exists with the same name.",
					...
					"volume_size_limit": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"volume_storage_medium": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"work_volume_claim_template": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"access_modes": schema.ListAttribute{
...
func (r *ActionsSummerwindDevRunnerSetV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_summerwind_dev_runner_set_v1alpha1_manifest")

	var model ActionsSummerwindDevRunnerSetV1Alpha1ManifestData
	...
	model.Kind = pointer.String("RunnerSet")
