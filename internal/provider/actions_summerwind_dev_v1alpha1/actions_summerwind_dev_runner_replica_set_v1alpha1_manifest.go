...
var (
	_ datasource.DataSource = &ActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest{}
)

func NewActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest() datasource.DataSource {
	return &ActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest{}
}

type ActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest struct{}

type ActionsSummerwindDevRunnerReplicaSetV1Alpha1ManifestData struct {
...
func (r *ActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_actions_summerwind_dev_runner_replica_set_v1alpha1_manifest"
}

func (r *ActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "RunnerReplicaSet is the Schema for the runnerreplicasets API",
		MarkdownDescription: "RunnerReplicaSet is the Schema for the runnerreplicasets API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "RunnerReplicaSetSpec defines the desired state of RunnerReplicaSet",
				Attributes: map[string]schema.Attribute{
					"effective_time": schema.StringAttribute{
						...
						MarkdownDescription: "EffectiveTime is the time the upstream controller requested to sync Replicas.It is usually populated by the webhook-based autoscaler via HRA and RunnerDeployment.The value is used to prevent runnerreplicaset controller from unnecessarily recreating ephemeral runnersbased on potentially outdated Replicas value.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *ActionsSummerwindDevRunnerReplicaSetV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_actions_summerwind_dev_runner_replica_set_v1alpha1_manifest")

	var model ActionsSummerwindDevRunnerReplicaSetV1Alpha1ManifestData
	...
	model.Kind = pointer.String("RunnerReplicaSet")
