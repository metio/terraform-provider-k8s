...
var (
	_ datasource.DataSource              = &JobsetXK8SIoJobSetV1Alpha2DataSource{}
	_ datasource.DataSourceWithConfigure = &JobsetXK8SIoJobSetV1Alpha2DataSource{}
)

func NewJobsetXK8SIoJobSetV1Alpha2DataSource() datasource.DataSource {
	return &JobsetXK8SIoJobSetV1Alpha2DataSource{}
}

type JobsetXK8SIoJobSetV1Alpha2DataSource struct {
	kubernetesClient dynamic.Interface
}

type JobsetXK8SIoJobSetV1Alpha2DataSourceData struct {
...
func (r *JobsetXK8SIoJobSetV1Alpha2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_jobset_x_k8s_io_job_set_v1alpha2"
}

func (r *JobsetXK8SIoJobSetV1Alpha2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"failure_policy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "FailurePolicy, if set, configures when to declare the JobSet as failed. The JobSet is always declared failed if all jobs in the set finished with status failed.",
						Attributes: map[string]schema.Attribute{
...
func (r *JobsetXK8SIoJobSetV1Alpha2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *JobsetXK8SIoJobSetV1Alpha2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_jobset_x_k8s_io_job_set_v1alpha2")

	var data JobsetXK8SIoJobSetV1Alpha2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "jobset.x-k8s.io", Version: "v1alpha2", Resource: "jobsets"}).
	...
	var readResponse JobsetXK8SIoJobSetV1Alpha2DataSourceData
	...
	data.ApiVersion = pointer.String("jobset.x-k8s.io/v1alpha2")
	data.Kind = pointer.String("JobSet")
