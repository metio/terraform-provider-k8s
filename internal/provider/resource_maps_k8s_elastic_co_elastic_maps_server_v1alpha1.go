...
var (
	_ resource.Resource = (*MapsK8SElasticCoElasticMapsServerV1Alpha1Resource)(nil)
)

type MapsK8SElasticCoElasticMapsServerV1Alpha1TerraformModel struct {
...
type MapsK8SElasticCoElasticMapsServerV1Alpha1GoModel struct {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_maps_k8s_elastic_co_elastic_maps_server_v1alpha1"
}

func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_maps_k8s_elastic_co_elastic_maps_server_v1alpha1")

	var state MapsK8SElasticCoElasticMapsServerV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel MapsK8SElasticCoElasticMapsServerV1Alpha1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("maps.k8s.elastic.co/v1alpha1")
	goModel.Kind = utilities.Ptr("ElasticMapsServer")
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_maps_k8s_elastic_co_elastic_maps_server_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *MapsK8SElasticCoElasticMapsServerV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
