...
var (
	_ datasource.DataSource = &PsmdbPerconaComPerconaServerMongoDbbackupV1Manifest{}
)

func NewPsmdbPerconaComPerconaServerMongoDbbackupV1Manifest() datasource.DataSource {
	return &PsmdbPerconaComPerconaServerMongoDbbackupV1Manifest{}
}

type PsmdbPerconaComPerconaServerMongoDbbackupV1Manifest struct{}

type PsmdbPerconaComPerconaServerMongoDbbackupV1ManifestData struct {
...
func (r *PsmdbPerconaComPerconaServerMongoDbbackupV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_psmdb_percona_com_percona_server_mongo_db_backup_v1_manifest"
}
...
func (r *PsmdbPerconaComPerconaServerMongoDbbackupV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_psmdb_percona_com_percona_server_mongo_db_backup_v1_manifest")

	var model PsmdbPerconaComPerconaServerMongoDbbackupV1ManifestData
	...
	model.Kind = pointer.String("PerconaServerMongoDBBackup")
