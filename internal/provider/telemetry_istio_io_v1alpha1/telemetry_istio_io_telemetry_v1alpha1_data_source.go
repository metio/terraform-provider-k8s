...
var (
	_ datasource.DataSource              = &TelemetryIstioIoTelemetryV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &TelemetryIstioIoTelemetryV1Alpha1DataSource{}
)

func NewTelemetryIstioIoTelemetryV1Alpha1DataSource() datasource.DataSource {
	return &TelemetryIstioIoTelemetryV1Alpha1DataSource{}
}

type TelemetryIstioIoTelemetryV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type TelemetryIstioIoTelemetryV1Alpha1DataSourceData struct {
...
func (r *TelemetryIstioIoTelemetryV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_telemetry_istio_io_telemetry_v1alpha1"
}

func (r *TelemetryIstioIoTelemetryV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *TelemetryIstioIoTelemetryV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *TelemetryIstioIoTelemetryV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_telemetry_istio_io_telemetry_v1alpha1")

	var data TelemetryIstioIoTelemetryV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "telemetry.istio.io", Version: "v1alpha1", Resource: "telemetries"}).
	...
	var readResponse TelemetryIstioIoTelemetryV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("telemetry.istio.io/v1alpha1")
	data.Kind = pointer.String("Telemetry")
