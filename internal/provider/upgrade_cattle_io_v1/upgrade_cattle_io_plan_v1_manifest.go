					...
					"drain": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"timeout": schema.StringAttribute{
								Description:         "If a string, this is passed through directly to the 'kubectl drain' command. If an int, this represents the duration as a count of nanoseconds, and will be converted to a duration string when passed to the 'kubectl drain' command.",
								MarkdownDescription: "If a string, this is passed through directly to the 'kubectl drain' command. If an int, this represents the duration as a count of nanoseconds, and will be converted to a duration string when passed to the 'kubectl drain' command.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
