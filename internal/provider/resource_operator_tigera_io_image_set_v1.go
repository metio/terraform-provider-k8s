...
var (
	_ resource.Resource = (*OperatorTigeraIoImageSetV1Resource)(nil)
)

type OperatorTigeraIoImageSetV1TerraformModel struct {
...
type OperatorTigeraIoImageSetV1GoModel struct {
...
func (r *OperatorTigeraIoImageSetV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_tigera_io_image_set_v1"
}

func (r *OperatorTigeraIoImageSetV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorTigeraIoImageSetV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_tigera_io_image_set_v1")

	var state OperatorTigeraIoImageSetV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorTigeraIoImageSetV1GoModel
	...
	goModel.Kind = utilities.Ptr("ImageSet")
...
func (r *OperatorTigeraIoImageSetV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_tigera_io_image_set_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorTigeraIoImageSetV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *OperatorTigeraIoImageSetV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
