...
var (
	_ datasource.DataSource              = &GlooSoloIoSettingsV1DataSource{}
	_ datasource.DataSourceWithConfigure = &GlooSoloIoSettingsV1DataSource{}
)

func NewGlooSoloIoSettingsV1DataSource() datasource.DataSource {
	return &GlooSoloIoSettingsV1DataSource{}
}

type GlooSoloIoSettingsV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type GlooSoloIoSettingsV1DataSourceData struct {
...
func (r *GlooSoloIoSettingsV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gloo_solo_io_settings_v1"
}

func (r *GlooSoloIoSettingsV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GlooSoloIoSettingsV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GlooSoloIoSettingsV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_gloo_solo_io_settings_v1")

	var data GlooSoloIoSettingsV1DataSourceData
	...
	var readResponse GlooSoloIoSettingsV1DataSourceData
	...
	data.Kind = pointer.String("Settings")
