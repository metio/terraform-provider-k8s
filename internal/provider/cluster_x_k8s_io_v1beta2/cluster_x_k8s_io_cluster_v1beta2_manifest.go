					...
					"topology": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"class_namespace": schema.StringAttribute{
								...
								MarkdownDescription: "classNamespace is the namespace of the ClusterClass object to create the topology. If the namespace is empty or not set, it is defaulted to the namespace of the cluster object. Value must follow the DNS1123Subdomain syntax.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
