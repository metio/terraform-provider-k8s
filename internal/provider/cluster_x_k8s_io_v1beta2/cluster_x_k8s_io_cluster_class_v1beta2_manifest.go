...
type ClusterXK8SIoClusterClassV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		ControlPlane *struct {
			...
			} `tfsdk:"naming" json:"naming,omitempty"`
					...
					"control_plane": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"deletion": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"node_deletion_timeout_seconds": schema.Int64Attribute{
										...
										MarkdownDescription: "nodeDeletionTimeoutSeconds defines how long the controller will attempt to delete the Node that the Machine hosts after the Machine is marked for deletion. A duration of 0 will retry deletion indefinitely. Defaults to 10 seconds. NOTE: This value can be overridden while defining a Cluster.Topology.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"node_drain_timeout_seconds": schema.Int64Attribute{
										...
										MarkdownDescription: "nodeDrainTimeoutSeconds is the total amount of time that the controller will spend on draining a node. The default value is 0, meaning that the node can be drained without any time limitations. NOTE: nodeDrainTimeoutSeconds is different from 'kubectl drain --timeout' NOTE: This value can be overridden while defining a Cluster.Topology.",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.Int64{
									...
									"node_volume_detach_timeout_seconds": schema.Int64Attribute{
										...
										MarkdownDescription: "nodeVolumeDetachTimeoutSeconds is the total amount of time that the controller will spend on waiting for all volumes to be detached. The default value is 0, meaning that the volumes can be detached without any time limitations. NOTE: This value can be overridden while defining a Cluster.Topology.",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.Int64{
							...
							"health_check": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "healthCheck defines a MachineHealthCheck for this ControlPlaneClass. This field is supported if and only if the ControlPlane provider template referenced above is Machine based and supports setting replicas.",
								Attributes: map[string]schema.Attribute{
									"checks": schema.SingleNestedAttribute{
										...
										Validators: []validator.Object{
											objectvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("remediation")),
										},
									},
									...
									"remediation": schema.SingleNestedAttribute{
										...
										Computed: false,
										Validators: []validator.Object{
											objectvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("checks")),
										},
									},
								},
								Required: false,
							...
							"machine_infrastructure": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"template_ref": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "templateRef is a required reference to the template for a MachineInfrastructure of a ControlPlane.",
										Attributes: map[string]schema.Attribute{
											"api_version": schema.StringAttribute{
												Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
												MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
												Required:            true,
												Optional:            false,
												Computed:            false,
												Validators: []validator.String{
											...
											"kind": schema.StringAttribute{
												...
												MarkdownDescription: "kind of the template. kind must consist of alphanumeric characters or '-', start with an alphabetic character, and end with an alphanumeric character.",
												Required:            true,
												Optional:            false,
												Computed:            false,
												Validators: []validator.String{
											...
											"name": schema.StringAttribute{
												...
												MarkdownDescription: "name of the template. name must consist of lower case alphanumeric characters, '-' or '.', and must start and end with an alphanumeric character.",
												Required:            true,
												Optional:            false,
												Computed:            false,
												Validators: []validator.String{
							...
							"naming": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "naming allows changing the naming pattern used when creating the control plane provider object.",
								Attributes: map[string]schema.Attribute{
							...
							"template_ref": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "templateRef contains the reference to a provider-specific control plane template.",
								Attributes: map[string]schema.Attribute{
									"api_version": schema.StringAttribute{
										Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
										MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
					...
					"infrastructure": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"naming": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "naming allows changing the naming pattern used when creating the infrastructure cluster object.",
								Attributes: map[string]schema.Attribute{
									"template": schema.StringAttribute{
							...
							"template_ref": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "templateRef contains the reference to a provider-specific infrastructure cluster template.",
								Attributes: map[string]schema.Attribute{
									"api_version": schema.StringAttribute{
										Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
										MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
											...
											"selector": schema.SingleNestedAttribute{
												...
												Attributes: map[string]schema.Attribute{
													"api_version": schema.StringAttribute{
														...
														MarkdownDescription: "apiVersion filters templates by apiVersion. apiVersion must be fully qualified domain name followed by / and a version.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
													...
													"kind": schema.StringAttribute{
														...
														MarkdownDescription: "kind filters templates by kind. kind must consist of alphanumeric characters or '-', start with an alphabetic character, and end with an alphanumeric character.",
														Required:            true,
														Optional:            false,
														Computed:            false,
														Validators: []validator.String{
														...
														Attributes: map[string]schema.Attribute{
															"control_plane": schema.BoolAttribute{
																...
																Validators: []validator.Bool{
																	boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("infrastructure_cluster"), path.MatchRelative().AtParent().AtName("machine_deployment_class"), path.MatchRelative().AtParent().AtName("machine_pool_class")),
																},
															},
															...
															"infrastructure_cluster": schema.BoolAttribute{
																...
																Computed:            false,
																Validators: []validator.Bool{
																	boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("control_plane"), path.MatchRelative().AtParent().AtName("machine_deployment_class"), path.MatchRelative().AtParent().AtName("machine_pool_class")),
																},
															},
															...
															"machine_deployment_class": schema.SingleNestedAttribute{
																...
																Computed: false,
																Validators: []validator.Object{
																	objectvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("control_plane"), path.MatchRelative().AtParent().AtName("infrastructure_cluster"), path.MatchRelative().AtParent().AtName("machine_pool_class")),
																},
															},
															...
															"machine_pool_class": schema.SingleNestedAttribute{
																...
																Computed: false,
																Validators: []validator.Object{
																	objectvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("control_plane"), path.MatchRelative().AtParent().AtName("infrastructure_cluster"), path.MatchRelative().AtParent().AtName("machine_deployment_class")),
																},
															},
														},
														Required: true,
										...
										"open_apiv3_schema": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"additional_properties": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"all_of": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"any_of": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"default": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"description": schema.StringAttribute{
													...
													Validators: []validator.String{
														...
														stringvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"enum": schema.ListAttribute{
													...
													Computed:            false,
													Validators: []validator.List{
														listvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"example": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"exclusive_maximum": schema.BoolAttribute{
													...
													Computed:            false,
													Validators: []validator.Bool{
														boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"exclusive_minimum": schema.BoolAttribute{
													...
													Computed:            false,
													Validators: []validator.Bool{
														boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"format": schema.StringAttribute{
													...
													Validators: []validator.String{
														stringvalidator.LengthAtLeast(1),
														stringvalidator.LengthAtMost(32),
														stringvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"items": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"max_items": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"max_length": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"max_properties": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"maximum": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"min_items": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"min_length": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"min_properties": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"minimum": schema.Int64Attribute{
													...
													Computed:            false,
													Validators: []validator.Int64{
														int64validator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"not": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"one_of": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"pattern": schema.StringAttribute{
													...
													Validators: []validator.String{
														stringvalidator.LengthAtLeast(1),
														stringvalidator.LengthAtMost(512),
														stringvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"properties": schema.MapAttribute{
													...
													Computed:            false,
													Validators: []validator.Map{
														mapvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"required": schema.ListAttribute{
													...
													Computed:            false,
													Validators: []validator.List{
														listvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"type": schema.StringAttribute{
													...
													Validators: []validator.String{
														...
														stringvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"unique_items": schema.BoolAttribute{
													...
													Computed:            false,
													Validators: []validator.Bool{
														boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"x_kubernetes_int_or_string": schema.BoolAttribute{
													...
													Computed:            false,
													Validators: []validator.Bool{
														boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"x_kubernetes_preserve_unknown_fields": schema.BoolAttribute{
													...
													Computed:            false,
													Validators: []validator.Bool{
														boolvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"x_kubernetes_validations": schema.ListNestedAttribute{
													...
													Computed: false,
													Validators: []validator.List{
														listvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_metadata")),
													},
												},
												...
												"x_metadata": schema.SingleNestedAttribute{
													...
													Computed: false,
													Validators: []validator.Object{
														objectvalidator.AtLeastOneOf(path.MatchRelative().AtParent().AtName("additional_properties"), path.MatchRelative().AtParent().AtName("all_of"), path.MatchRelative().AtParent().AtName("any_of"), path.MatchRelative().AtParent().AtName("default"), path.MatchRelative().AtParent().AtName("description"), path.MatchRelative().AtParent().AtName("enum"), path.MatchRelative().AtParent().AtName("example"), path.MatchRelative().AtParent().AtName("exclusive_maximum"), path.MatchRelative().AtParent().AtName("exclusive_minimum"), path.MatchRelative().AtParent().AtName("format"), path.MatchRelative().AtParent().AtName("items"), path.MatchRelative().AtParent().AtName("max_items"), path.MatchRelative().AtParent().AtName("max_length"), path.MatchRelative().AtParent().AtName("max_properties"), path.MatchRelative().AtParent().AtName("maximum"), path.MatchRelative().AtParent().AtName("min_items"), path.MatchRelative().AtParent().AtName("min_length"), path.MatchRelative().AtParent().AtName("min_properties"), path.MatchRelative().AtParent().AtName("minimum"), path.MatchRelative().AtParent().AtName("not"), path.MatchRelative().AtParent().AtName("one_of"), path.MatchRelative().AtParent().AtName("pattern"), path.MatchRelative().AtParent().AtName("properties"), path.MatchRelative().AtParent().AtName("required"), path.MatchRelative().AtParent().AtName("type"), path.MatchRelative().AtParent().AtName("unique_items"), path.MatchRelative().AtParent().AtName("x_kubernetes_int_or_string"), path.MatchRelative().AtParent().AtName("x_kubernetes_preserve_unknown_fields"), path.MatchRelative().AtParent().AtName("x_kubernetes_validations")),
													},
												},
											},
											Required: true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"bootstrap": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"template_ref": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "templateRef is a required reference to the BootstrapTemplate for a MachineDeployment.",
													Attributes: map[string]schema.Attribute{
														"api_version": schema.StringAttribute{
															Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
															MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
										...
										"failure_domain": schema.StringAttribute{
											...
											MarkdownDescription: "failureDomain is the failure domain the machines will be created in. Must match the name of a FailureDomain from the Cluster status. NOTE: This value can be overridden while defining a Cluster.Topology using this MachineDeploymentClass.",
											Required:            false,
											Optional:            true,
											Computed:            false,
											Validators: []validator.String{
										...
										"health_check": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "healthCheck defines a MachineHealthCheck for this MachineDeploymentClass.",
											Attributes: map[string]schema.Attribute{
												"checks": schema.SingleNestedAttribute{
													Description:         "checks are the checks that are used to evaluate if a Machine is healthy. Independent of this configuration the MachineHealthCheck controller will always flag Machines with 'cluster.x-k8s.io/remediate-machine' annotation and Machines with deleted Nodes as unhealthy. Furthermore, if checks.nodeStartupTimeoutSeconds is not set it is defaulted to 10 minutes and evaluated accordingly.",
													MarkdownDescription: "checks are the checks that are used to evaluate if a Machine is healthy. Independent of this configuration the MachineHealthCheck controller will always flag Machines with 'cluster.x-k8s.io/remediate-machine' annotation and Machines with deleted Nodes as unhealthy. Furthermore, if checks.nodeStartupTimeoutSeconds is not set it is defaulted to 10 minutes and evaluated accordingly.",
										...
										"infrastructure": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"template_ref": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "templateRef is a required reference to the InfrastructureTemplate for a MachineDeployment.",
													Attributes: map[string]schema.Attribute{
														"api_version": schema.StringAttribute{
															Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
															MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
										...
										"naming": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "naming allows changing the naming pattern used when creating the MachineDeployment.",
											Attributes: map[string]schema.Attribute{
												"template": schema.StringAttribute{
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"bootstrap": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"template_ref": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "templateRef is a required reference to the BootstrapTemplate for a MachinePool.",
													Attributes: map[string]schema.Attribute{
														"api_version": schema.StringAttribute{
															Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
															MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
										...
										"infrastructure": schema.SingleNestedAttribute{
											...
											Attributes: map[string]schema.Attribute{
												"template_ref": schema.SingleNestedAttribute{
													...
													MarkdownDescription: "templateRef is a required reference to the InfrastructureTemplate for a MachinePool.",
													Attributes: map[string]schema.Attribute{
														"api_version": schema.StringAttribute{
															Description:         "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
															MarkdownDescription: "apiVersion of the template. apiVersion must be fully qualified domain name followed by / and a version.",
										...
										"naming": schema.SingleNestedAttribute{
											...
											MarkdownDescription: "naming allows changing the naming pattern used when creating the MachinePool.",
											Attributes: map[string]schema.Attribute{
												"template": schema.StringAttribute{
