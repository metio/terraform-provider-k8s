...
var (
	_ datasource.DataSource = &ClusterXK8SIoMachineV1Beta2Manifest{}
)

func NewClusterXK8SIoMachineV1Beta2Manifest() datasource.DataSource {
	return &ClusterXK8SIoMachineV1Beta2Manifest{}
}

type ClusterXK8SIoMachineV1Beta2Manifest struct{}

type ClusterXK8SIoMachineV1Beta2ManifestData struct {
...
func (r *ClusterXK8SIoMachineV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_cluster_x_k8s_io_machine_v1beta2_manifest"
}

func (r *ClusterXK8SIoMachineV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ClusterXK8SIoMachineV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_cluster_x_k8s_io_machine_v1beta2_manifest")

	var model ClusterXK8SIoMachineV1Beta2ManifestData
