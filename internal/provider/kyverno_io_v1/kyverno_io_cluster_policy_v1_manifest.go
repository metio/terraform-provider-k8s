...
var (
	_ datasource.DataSource = &KyvernoIoClusterPolicyV1Manifest{}
)

func NewKyvernoIoClusterPolicyV1Manifest() datasource.DataSource {
	return &KyvernoIoClusterPolicyV1Manifest{}
}

type KyvernoIoClusterPolicyV1Manifest struct{}

type KyvernoIoClusterPolicyV1ManifestData struct {
...
func (r *KyvernoIoClusterPolicyV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_policy_v1_manifest"
}

func (r *KyvernoIoClusterPolicyV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
								...
								"verify_images": schema.ListNestedAttribute{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"type": schema.StringAttribute{
												Description:         "Type specifies the method of signature validation. The allowed options are Cosign, Sigstore Bundle and Notary. By default Cosign is used if a type is not specified.",
												MarkdownDescription: "Type specifies the method of signature validation. The allowed options are Cosign, Sigstore Bundle and Notary. By default Cosign is used if a type is not specified.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
...
func (r *KyvernoIoClusterPolicyV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_cluster_policy_v1_manifest")

	var model KyvernoIoClusterPolicyV1ManifestData
