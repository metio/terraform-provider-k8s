...
var (
	_ datasource.DataSource              = &KyvernoIoPolicyV1DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoPolicyV1DataSource{}
)

func NewKyvernoIoPolicyV1DataSource() datasource.DataSource {
	return &KyvernoIoPolicyV1DataSource{}
}

type KyvernoIoPolicyV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoPolicyV1DataSourceData struct {
...
func (r *KyvernoIoPolicyV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_policy_v1"
}

func (r *KyvernoIoPolicyV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoPolicyV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoPolicyV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_policy_v1")

	var data KyvernoIoPolicyV1DataSourceData
	...
	var readResponse KyvernoIoPolicyV1DataSourceData
