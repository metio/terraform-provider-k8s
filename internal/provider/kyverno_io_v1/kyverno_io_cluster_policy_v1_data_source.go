...
var (
	_ datasource.DataSource              = &KyvernoIoClusterPolicyV1DataSource{}
	_ datasource.DataSourceWithConfigure = &KyvernoIoClusterPolicyV1DataSource{}
)

func NewKyvernoIoClusterPolicyV1DataSource() datasource.DataSource {
	return &KyvernoIoClusterPolicyV1DataSource{}
}

type KyvernoIoClusterPolicyV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type KyvernoIoClusterPolicyV1DataSourceData struct {
...
func (r *KyvernoIoClusterPolicyV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kyverno_io_cluster_policy_v1"
}

func (r *KyvernoIoClusterPolicyV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KyvernoIoClusterPolicyV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *KyvernoIoClusterPolicyV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_kyverno_io_cluster_policy_v1")

	var data KyvernoIoClusterPolicyV1DataSourceData
	...
	var readResponse KyvernoIoClusterPolicyV1DataSourceData
	...
	data.ApiVersion = pointer.String("kyverno.io/v1")
