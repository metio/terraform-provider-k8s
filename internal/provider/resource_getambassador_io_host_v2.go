...
var (
	_ resource.Resource = (*GetambassadorIoHostV2Resource)(nil)
)

type GetambassadorIoHostV2TerraformModel struct {
...
type GetambassadorIoHostV2GoModel struct {
...
func (r *GetambassadorIoHostV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_getambassador_io_host_v2"
}

func (r *GetambassadorIoHostV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *GetambassadorIoHostV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_getambassador_io_host_v2")

	var state GetambassadorIoHostV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GetambassadorIoHostV2GoModel
...
func (r *GetambassadorIoHostV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_host_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *GetambassadorIoHostV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GetambassadorIoHostV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
