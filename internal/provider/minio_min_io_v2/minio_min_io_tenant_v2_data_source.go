...
var (
	_ datasource.DataSource              = &MinioMinIoTenantV2DataSource{}
	_ datasource.DataSourceWithConfigure = &MinioMinIoTenantV2DataSource{}
)

func NewMinioMinIoTenantV2DataSource() datasource.DataSource {
	return &MinioMinIoTenantV2DataSource{}
}

type MinioMinIoTenantV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type MinioMinIoTenantV2DataSourceData struct {
...
func (r *MinioMinIoTenantV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_minio_min_io_tenant_v2"
}

func (r *MinioMinIoTenantV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MinioMinIoTenantV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MinioMinIoTenantV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_minio_min_io_tenant_v2")

	var data MinioMinIoTenantV2DataSourceData
	...
	var readResponse MinioMinIoTenantV2DataSourceData
	...
	data.ApiVersion = pointer.String("minio.min.io/v2")
