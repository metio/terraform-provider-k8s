...
package helm_toolkit_fluxcd_io_v2beta2
...
var (
	_ datasource.DataSource = &HelmToolkitFluxcdIoHelmReleaseV2Beta2Manifest{}
)

func NewHelmToolkitFluxcdIoHelmReleaseV2Beta2Manifest() datasource.DataSource {
	return &HelmToolkitFluxcdIoHelmReleaseV2Beta2Manifest{}
}
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_helm_toolkit_fluxcd_io_helm_release_v2beta2_manifest"
}

func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
							...
							"spec": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"source_ref": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "The name and namespace of the v1.Source the chart is available at.",
										Attributes: map[string]schema.Attribute{
					...
					"chart_ref": schema.SingleNestedAttribute{
						Description:         "ChartRef holds a reference to a source controller resource containing the Helm chart artifact. Note: this field is provisional to the v2 API, and not actively used by v2beta2 HelmReleases.",
						MarkdownDescription: "ChartRef holds a reference to a source controller resource containing the Helm chart artifact. Note: this field is provisional to the v2 API, and not actively used by v2beta2 HelmReleases.",
						Attributes: map[string]schema.Attribute{
							"api_version": schema.StringAttribute{
								Description:         "APIVersion of the referent.",
								MarkdownDescription: "APIVersion of the referent.",
					...
					"test": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"filters": schema.ListNestedAttribute{
								...
								MarkdownDescription: "Filters is a list of tests to run or exclude from running.",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										"exclude": schema.BoolAttribute{
											Description:         "Exclude specifies whether the named test should be excluded.",
											MarkdownDescription: "Exclude specifies whether the named test should be excluded.",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
										...
										"name": schema.StringAttribute{
											...
											MarkdownDescription: "Name is the name of the test.",
											Required:            true,
											Optional:            false,
											Computed:            false,
											Validators: []validator.String{
...
func (r *HelmToolkitFluxcdIoHelmReleaseV2Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_helm_toolkit_fluxcd_io_helm_release_v2beta2_manifest")

	var model HelmToolkitFluxcdIoHelmReleaseV2Beta2ManifestData
