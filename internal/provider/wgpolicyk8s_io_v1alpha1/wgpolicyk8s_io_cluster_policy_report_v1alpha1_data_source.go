...
var (
	_ datasource.DataSource              = &Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource{}
)

func NewWgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource() datasource.DataSource {
	return &Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource{}
}

type Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSourceData struct {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_wgpolicyk8s_io_cluster_policy_report_v1alpha1"
}

func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_wgpolicyk8s_io_cluster_policy_report_v1alpha1")

	var data Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSourceData
	...
	var readResponse Wgpolicyk8SIoClusterPolicyReportV1Alpha1DataSourceData
