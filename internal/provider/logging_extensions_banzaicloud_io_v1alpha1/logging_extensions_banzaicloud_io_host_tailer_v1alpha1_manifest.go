...
var (
	_ datasource.DataSource = &LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest{}
)

func NewLoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest() datasource.DataSource {
	return &LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest{}
}

type LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest struct{}

type LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1ManifestData struct {
...
func (r *LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_logging_extensions_banzaicloud_io_host_tailer_v1alpha1_manifest"
}

func (r *LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_logging_extensions_banzaicloud_io_host_tailer_v1alpha1_manifest")

	var model LoggingExtensionsBanzaicloudIoHostTailerV1Alpha1ManifestData
