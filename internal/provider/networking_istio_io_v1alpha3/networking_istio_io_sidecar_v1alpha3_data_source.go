...
var (
	_ datasource.DataSource              = &NetworkingIstioIoSidecarV1Alpha3DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoSidecarV1Alpha3DataSource{}
)

func NewNetworkingIstioIoSidecarV1Alpha3DataSource() datasource.DataSource {
	return &NetworkingIstioIoSidecarV1Alpha3DataSource{}
}

type NetworkingIstioIoSidecarV1Alpha3DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoSidecarV1Alpha3DataSourceData struct {
...
func (r *NetworkingIstioIoSidecarV1Alpha3DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_sidecar_v1alpha3"
}

func (r *NetworkingIstioIoSidecarV1Alpha3DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoSidecarV1Alpha3DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoSidecarV1Alpha3DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_sidecar_v1alpha3")

	var data NetworkingIstioIoSidecarV1Alpha3DataSourceData
	...
	var readResponse NetworkingIstioIoSidecarV1Alpha3DataSourceData
