...
func TestNetworkingIstioIoGatewayV1Alpha3Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_networking_istio_io_gateway_v1alpha3_manifest", testCase)
		})
	}
}
