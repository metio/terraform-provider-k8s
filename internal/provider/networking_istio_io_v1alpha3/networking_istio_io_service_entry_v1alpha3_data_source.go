...
var (
	_ datasource.DataSource              = &NetworkingIstioIoServiceEntryV1Alpha3DataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkingIstioIoServiceEntryV1Alpha3DataSource{}
)

func NewNetworkingIstioIoServiceEntryV1Alpha3DataSource() datasource.DataSource {
	return &NetworkingIstioIoServiceEntryV1Alpha3DataSource{}
}

type NetworkingIstioIoServiceEntryV1Alpha3DataSource struct {
	kubernetesClient dynamic.Interface
}

type NetworkingIstioIoServiceEntryV1Alpha3DataSourceData struct {
...
func (r *NetworkingIstioIoServiceEntryV1Alpha3DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_service_entry_v1alpha3"
}

func (r *NetworkingIstioIoServiceEntryV1Alpha3DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoServiceEntryV1Alpha3DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NetworkingIstioIoServiceEntryV1Alpha3DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_networking_istio_io_service_entry_v1alpha3")

	var data NetworkingIstioIoServiceEntryV1Alpha3DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "networking.istio.io", Version: "v1alpha3", Resource: "serviceentries"}).
	...
	var readResponse NetworkingIstioIoServiceEntryV1Alpha3DataSourceData
	...
	data.Kind = pointer.String("ServiceEntry")
