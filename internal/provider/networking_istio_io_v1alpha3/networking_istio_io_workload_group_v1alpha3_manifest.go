...
var (
	_ datasource.DataSource = &NetworkingIstioIoWorkloadGroupV1Alpha3Manifest{}
)

func NewNetworkingIstioIoWorkloadGroupV1Alpha3Manifest() datasource.DataSource {
	return &NetworkingIstioIoWorkloadGroupV1Alpha3Manifest{}
}
...
func (r *NetworkingIstioIoWorkloadGroupV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_networking_istio_io_workload_group_v1alpha3_manifest"
}

func (r *NetworkingIstioIoWorkloadGroupV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NetworkingIstioIoWorkloadGroupV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_networking_istio_io_workload_group_v1alpha3_manifest")

	var model NetworkingIstioIoWorkloadGroupV1Alpha3ManifestData
