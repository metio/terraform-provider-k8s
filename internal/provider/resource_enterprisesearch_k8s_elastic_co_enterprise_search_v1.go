...
var (
	_ resource.Resource = (*EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource)(nil)
)

type EnterprisesearchK8SElasticCoEnterpriseSearchV1TerraformModel struct {
...
type EnterprisesearchK8SElasticCoEnterpriseSearchV1GoModel struct {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_enterprisesearch_k8s_elastic_co_enterprise_search_v1"
}

func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1")

	var state EnterprisesearchK8SElasticCoEnterpriseSearchV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel EnterprisesearchK8SElasticCoEnterpriseSearchV1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("enterprisesearch.k8s.elastic.co/v1")
	goModel.Kind = utilities.Ptr("EnterpriseSearch")
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_enterprisesearch_k8s_elastic_co_enterprise_search_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *EnterprisesearchK8SElasticCoEnterpriseSearchV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
