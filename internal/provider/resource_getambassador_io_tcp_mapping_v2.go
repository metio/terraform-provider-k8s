...
var (
	_ resource.Resource = (*GetambassadorIoTCPMappingV2Resource)(nil)
)

type GetambassadorIoTCPMappingV2TerraformModel struct {
...
type GetambassadorIoTCPMappingV2GoModel struct {
...
func (r *GetambassadorIoTCPMappingV2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_getambassador_io_tcp_mapping_v2"
}

func (r *GetambassadorIoTCPMappingV2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *GetambassadorIoTCPMappingV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_getambassador_io_tcp_mapping_v2")

	var state GetambassadorIoTCPMappingV2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel GetambassadorIoTCPMappingV2GoModel
...
func (r *GetambassadorIoTCPMappingV2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_tcp_mapping_v2")
	// NO-OP: All data is already in Terraform state
}

func (r *GetambassadorIoTCPMappingV2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *GetambassadorIoTCPMappingV2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
