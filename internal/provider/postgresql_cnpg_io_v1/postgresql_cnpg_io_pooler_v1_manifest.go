...
var (
	_ datasource.DataSource = &PostgresqlCnpgIoPoolerV1Manifest{}
)

func NewPostgresqlCnpgIoPoolerV1Manifest() datasource.DataSource {
	return &PostgresqlCnpgIoPoolerV1Manifest{}
}

type PostgresqlCnpgIoPoolerV1Manifest struct{}

type PostgresqlCnpgIoPoolerV1ManifestData struct {
	...
	Spec *struct {
		...
		Pgbouncer *struct {
			AuthQuery       *string `tfsdk:"auth_query" json:"authQuery,omitempty"`
			AuthQuerySecret *struct {
				Name *string `tfsdk:"name" json:"name,omitempty"`
			} `tfsdk:"auth_query_secret" json:"authQuerySecret,omitempty"`
			...
			PoolMode   *string            `tfsdk:"pool_mode" json:"poolMode,omitempty"`
		} `tfsdk:"pgbouncer" json:"pgbouncer,omitempty"`
...
func (r *PostgresqlCnpgIoPoolerV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_postgresql_cnpg_io_pooler_v1_manifest"
}

func (r *PostgresqlCnpgIoPoolerV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Pooler is the Schema for the poolers API",
		MarkdownDescription: "Pooler is the Schema for the poolers API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "Specification of the desired behavior of the Pooler.More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
				Attributes: map[string]schema.Attribute{
					"cluster": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "This is the cluster reference on which the Pooler will work.Pooler name should never match with any cluster name within the same namespace.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
					...
					"deployment_strategy": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The deployment strategy to use for pgbouncer to replace existing pods with new ones",
						Attributes: map[string]schema.Attribute{
					...
					"instances": schema.Int64Attribute{
						...
						MarkdownDescription: "The number of replicas we want. Default: 1.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"monitoring": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The configuration of the monitoring infrastructure of this pooler.",
						Attributes: map[string]schema.Attribute{
					...
					"pgbouncer": schema.SingleNestedAttribute{
						Description:         "The PgBouncer configuration",
						MarkdownDescription: "The PgBouncer configuration",
						Attributes: map[string]schema.Attribute{
							"auth_query": schema.StringAttribute{
								Description:         "The query that will be used to download the hash of the passwordof a certain user. Default: 'SELECT usename, passwd FROM public.user_search($1)'.In case it is specified, also an AuthQuerySecret has to be specified andno automatic CNPG Cluster integration will be triggered.",
								MarkdownDescription: "The query that will be used to download the hash of the passwordof a certain user. Default: 'SELECT usename, passwd FROM public.user_search($1)'.In case it is specified, also an AuthQuerySecret has to be specified andno automatic CNPG Cluster integration will be triggered.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},

							"auth_query_secret": schema.SingleNestedAttribute{
								Description:         "The credentials of the user that need to be used for the authenticationquery. In case it is specified, also an AuthQuery(e.g. 'SELECT usename, passwd FROM pg_catalog.pg_shadow WHERE usename=$1')has to be specified and no automatic CNPG Cluster integration will be triggered.",
								MarkdownDescription: "The credentials of the user that need to be used for the authenticationquery. In case it is specified, also an AuthQuery(e.g. 'SELECT usename, passwd FROM pg_catalog.pg_shadow WHERE usename=$1')has to be specified and no automatic CNPG Cluster integration will be triggered.",
								Attributes: map[string]schema.Attribute{
									"name": schema.StringAttribute{
										Description:         "Name of the referent.",
										MarkdownDescription: "Name of the referent.",
							...
							"parameters": schema.MapAttribute{
								Description:         "Additional parameters to be passed to PgBouncer - please checkthe CNPG documentation for a list of options you can configure",
								MarkdownDescription: "Additional parameters to be passed to PgBouncer - please checkthe CNPG documentation for a list of options you can configure",
								ElementType:         types.StringType,
								Required:            false,
								Optional:            true,
								Computed:            false,
							...
							"paused": schema.BoolAttribute{
								Description:         "When set to 'true', PgBouncer will disconnect from the PostgreSQLserver, first waiting for all queries to complete, and pause all newclient connections until this value is set to 'false' (default). Internally,the operator calls PgBouncer's 'PAUSE' and 'RESUME' commands.",
								MarkdownDescription: "When set to 'true', PgBouncer will disconnect from the PostgreSQLserver, first waiting for all queries to complete, and pause all newclient connections until this value is set to 'false' (default). Internally,the operator calls PgBouncer's 'PAUSE' and 'RESUME' commands.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"pool_mode": schema.StringAttribute{
								...
								MarkdownDescription: "The pool mode. Default: 'session'.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
					...
					"service_template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Template for the Service to be created",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
					...
					"template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "The template of the Pod to be created",
						Attributes: map[string]schema.Attribute{
							"metadata": schema.SingleNestedAttribute{
								Description:         "Standard object's metadata.More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
								MarkdownDescription: "Standard object's metadata.More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
					...
					"type": schema.StringAttribute{
						...
						MarkdownDescription: "Type of service to forward traffic to. Default: 'rw'.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
...
func (r *PostgresqlCnpgIoPoolerV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_postgresql_cnpg_io_pooler_v1_manifest")

	var model PostgresqlCnpgIoPoolerV1ManifestData
	...
	model.Kind = pointer.String("Pooler")
