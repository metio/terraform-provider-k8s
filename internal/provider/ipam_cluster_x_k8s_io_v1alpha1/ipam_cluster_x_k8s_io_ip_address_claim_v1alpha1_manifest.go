...
var (
	_ datasource.DataSource = &IpamClusterXK8SIoIpaddressClaimV1Alpha1Manifest{}
)

func NewIpamClusterXK8SIoIpaddressClaimV1Alpha1Manifest() datasource.DataSource {
	return &IpamClusterXK8SIoIpaddressClaimV1Alpha1Manifest{}
}
...
func (r *IpamClusterXK8SIoIpaddressClaimV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_ipam_cluster_x_k8s_io_ip_address_claim_v1alpha1_manifest"
}
...
func (r *IpamClusterXK8SIoIpaddressClaimV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_ipam_cluster_x_k8s_io_ip_address_claim_v1alpha1_manifest")

	var model IpamClusterXK8SIoIpaddressClaimV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("ipam.cluster.x-k8s.io/v1alpha1")
