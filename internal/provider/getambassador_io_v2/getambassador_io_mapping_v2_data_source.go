...
var (
	_ datasource.DataSource              = &GetambassadorIoMappingV2DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoMappingV2DataSource{}
)

func NewGetambassadorIoMappingV2DataSource() datasource.DataSource {
	return &GetambassadorIoMappingV2DataSource{}
}

type GetambassadorIoMappingV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoMappingV2DataSourceData struct {
...
func (r *GetambassadorIoMappingV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_mapping_v2"
}

func (r *GetambassadorIoMappingV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoMappingV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoMappingV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_mapping_v2")

	var data GetambassadorIoMappingV2DataSourceData
	...
	var readResponse GetambassadorIoMappingV2DataSourceData
