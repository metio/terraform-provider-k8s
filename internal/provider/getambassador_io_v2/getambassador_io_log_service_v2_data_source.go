...
var (
	_ datasource.DataSource              = &GetambassadorIoLogServiceV2DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoLogServiceV2DataSource{}
)

func NewGetambassadorIoLogServiceV2DataSource() datasource.DataSource {
	return &GetambassadorIoLogServiceV2DataSource{}
}

type GetambassadorIoLogServiceV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoLogServiceV2DataSourceData struct {
...
func (r *GetambassadorIoLogServiceV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_log_service_v2"
}

func (r *GetambassadorIoLogServiceV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"v3_protocol_version": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            false,
...
func (r *GetambassadorIoLogServiceV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoLogServiceV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_log_service_v2")

	var data GetambassadorIoLogServiceV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "getambassador.io", Version: "v2", Resource: "logservices"}).
	...
	var readResponse GetambassadorIoLogServiceV2DataSourceData
