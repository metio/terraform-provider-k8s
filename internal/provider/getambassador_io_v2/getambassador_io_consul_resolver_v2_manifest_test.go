...
func TestGetambassadorIoConsulResolverV2Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_getambassador_io_consul_resolver_v2_manifest", testCase)
		})
	}
}
