...
var (
	_ datasource.DataSource = &GetambassadorIoConsulResolverV2Manifest{}
)

func NewGetambassadorIoConsulResolverV2Manifest() datasource.DataSource {
	return &GetambassadorIoConsulResolverV2Manifest{}
}
...
func (r *GetambassadorIoConsulResolverV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_consul_resolver_v2_manifest"
}

func (r *GetambassadorIoConsulResolverV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoConsulResolverV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_consul_resolver_v2_manifest")

	var model GetambassadorIoConsulResolverV2ManifestData
