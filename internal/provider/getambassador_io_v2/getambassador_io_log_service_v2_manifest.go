...
var (
	_ datasource.DataSource = &GetambassadorIoLogServiceV2Manifest{}
)

func NewGetambassadorIoLogServiceV2Manifest() datasource.DataSource {
	return &GetambassadorIoLogServiceV2Manifest{}
}
...
func (r *GetambassadorIoLogServiceV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_log_service_v2_manifest"
}

func (r *GetambassadorIoLogServiceV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoLogServiceV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_log_service_v2_manifest")

	var model GetambassadorIoLogServiceV2ManifestData
