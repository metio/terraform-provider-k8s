...
var (
	_ datasource.DataSource              = &GetambassadorIoHostV2DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoHostV2DataSource{}
)

func NewGetambassadorIoHostV2DataSource() datasource.DataSource {
	return &GetambassadorIoHostV2DataSource{}
}

type GetambassadorIoHostV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoHostV2DataSourceData struct {
...
func (r *GetambassadorIoHostV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_host_v2"
}

func (r *GetambassadorIoHostV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoHostV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoHostV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_host_v2")

	var data GetambassadorIoHostV2DataSourceData
	...
	var readResponse GetambassadorIoHostV2DataSourceData
