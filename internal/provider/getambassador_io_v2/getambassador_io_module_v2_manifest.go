...
var (
	_ datasource.DataSource = &GetambassadorIoModuleV2Manifest{}
)

func NewGetambassadorIoModuleV2Manifest() datasource.DataSource {
	return &GetambassadorIoModuleV2Manifest{}
}
...
func (r *GetambassadorIoModuleV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_module_v2_manifest"
}

func (r *GetambassadorIoModuleV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoModuleV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_module_v2_manifest")

	var model GetambassadorIoModuleV2ManifestData
