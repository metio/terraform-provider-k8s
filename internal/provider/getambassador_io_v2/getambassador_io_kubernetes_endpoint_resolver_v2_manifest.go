...
var (
	_ datasource.DataSource = &GetambassadorIoKubernetesEndpointResolverV2Manifest{}
)

func NewGetambassadorIoKubernetesEndpointResolverV2Manifest() datasource.DataSource {
	return &GetambassadorIoKubernetesEndpointResolverV2Manifest{}
}
...
func (r *GetambassadorIoKubernetesEndpointResolverV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_kubernetes_endpoint_resolver_v2_manifest"
}

func (r *GetambassadorIoKubernetesEndpointResolverV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoKubernetesEndpointResolverV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_kubernetes_endpoint_resolver_v2_manifest")

	var model GetambassadorIoKubernetesEndpointResolverV2ManifestData
