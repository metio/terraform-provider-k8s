...
var (
	_ datasource.DataSource = &GetambassadorIoRateLimitServiceV2Manifest{}
)

func NewGetambassadorIoRateLimitServiceV2Manifest() datasource.DataSource {
	return &GetambassadorIoRateLimitServiceV2Manifest{}
}
...
func (r *GetambassadorIoRateLimitServiceV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_rate_limit_service_v2_manifest"
}

func (r *GetambassadorIoRateLimitServiceV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoRateLimitServiceV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_rate_limit_service_v2_manifest")

	var model GetambassadorIoRateLimitServiceV2ManifestData
