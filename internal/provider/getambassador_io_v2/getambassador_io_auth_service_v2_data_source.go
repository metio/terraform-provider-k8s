...
var (
	_ datasource.DataSource              = &GetambassadorIoAuthServiceV2DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoAuthServiceV2DataSource{}
)

func NewGetambassadorIoAuthServiceV2DataSource() datasource.DataSource {
	return &GetambassadorIoAuthServiceV2DataSource{}
}

type GetambassadorIoAuthServiceV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoAuthServiceV2DataSourceData struct {
...
func (r *GetambassadorIoAuthServiceV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_auth_service_v2"
}

func (r *GetambassadorIoAuthServiceV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoAuthServiceV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoAuthServiceV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_auth_service_v2")

	var data GetambassadorIoAuthServiceV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "getambassador.io", Version: "v2", Resource: "authservices"}).
	...
	var readResponse GetambassadorIoAuthServiceV2DataSourceData
