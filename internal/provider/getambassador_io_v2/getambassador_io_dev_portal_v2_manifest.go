...
var (
	_ datasource.DataSource = &GetambassadorIoDevPortalV2Manifest{}
)

func NewGetambassadorIoDevPortalV2Manifest() datasource.DataSource {
	return &GetambassadorIoDevPortalV2Manifest{}
}
...
func (r *GetambassadorIoDevPortalV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_dev_portal_v2_manifest"
}
...
func (r *GetambassadorIoDevPortalV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_dev_portal_v2_manifest")

	var model GetambassadorIoDevPortalV2ManifestData
