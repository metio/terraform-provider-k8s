...
var (
	_ datasource.DataSource = &GetambassadorIoMappingV2Manifest{}
)

func NewGetambassadorIoMappingV2Manifest() datasource.DataSource {
	return &GetambassadorIoMappingV2Manifest{}
}
...
func (r *GetambassadorIoMappingV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_mapping_v2_manifest"
}

func (r *GetambassadorIoMappingV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoMappingV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_mapping_v2_manifest")

	var model GetambassadorIoMappingV2ManifestData
