...
var (
	_ datasource.DataSource = &GetambassadorIoTracingServiceV2Manifest{}
)

func NewGetambassadorIoTracingServiceV2Manifest() datasource.DataSource {
	return &GetambassadorIoTracingServiceV2Manifest{}
}
...
func (r *GetambassadorIoTracingServiceV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_tracing_service_v2_manifest"
}

func (r *GetambassadorIoTracingServiceV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoTracingServiceV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_tracing_service_v2_manifest")

	var model GetambassadorIoTracingServiceV2ManifestData
