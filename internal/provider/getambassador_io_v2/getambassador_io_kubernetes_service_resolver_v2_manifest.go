...
var (
	_ datasource.DataSource = &GetambassadorIoKubernetesServiceResolverV2Manifest{}
)

func NewGetambassadorIoKubernetesServiceResolverV2Manifest() datasource.DataSource {
	return &GetambassadorIoKubernetesServiceResolverV2Manifest{}
}
...
func (r *GetambassadorIoKubernetesServiceResolverV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_kubernetes_service_resolver_v2_manifest"
}

func (r *GetambassadorIoKubernetesServiceResolverV2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoKubernetesServiceResolverV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_getambassador_io_kubernetes_service_resolver_v2_manifest")

	var model GetambassadorIoKubernetesServiceResolverV2ManifestData
