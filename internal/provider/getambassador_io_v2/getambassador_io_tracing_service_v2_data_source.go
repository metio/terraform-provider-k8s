...
var (
	_ datasource.DataSource              = &GetambassadorIoTracingServiceV2DataSource{}
	_ datasource.DataSourceWithConfigure = &GetambassadorIoTracingServiceV2DataSource{}
)

func NewGetambassadorIoTracingServiceV2DataSource() datasource.DataSource {
	return &GetambassadorIoTracingServiceV2DataSource{}
}

type GetambassadorIoTracingServiceV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type GetambassadorIoTracingServiceV2DataSourceData struct {
...
func (r *GetambassadorIoTracingServiceV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_getambassador_io_tracing_service_v2"
}

func (r *GetambassadorIoTracingServiceV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *GetambassadorIoTracingServiceV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *GetambassadorIoTracingServiceV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_getambassador_io_tracing_service_v2")

	var data GetambassadorIoTracingServiceV2DataSourceData
	...
	var readResponse GetambassadorIoTracingServiceV2DataSourceData
