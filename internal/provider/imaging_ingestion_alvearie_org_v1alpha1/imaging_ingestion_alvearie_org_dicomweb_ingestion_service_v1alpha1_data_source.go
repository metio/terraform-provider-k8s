...
var (
	_ datasource.DataSource              = &ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource{}
)

func NewImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource() datasource.DataSource {
	return &ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource{}
}

type ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSourceData struct {
...
func (r *ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_imaging_ingestion_alvearie_org_dicomweb_ingestion_service_v1alpha1"
}

func (r *ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_imaging_ingestion_alvearie_org_dicomweb_ingestion_service_v1alpha1")

	var data ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSourceData
	...
	var readResponse ImagingIngestionAlvearieOrgDicomwebIngestionServiceV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("DicomwebIngestionService")
