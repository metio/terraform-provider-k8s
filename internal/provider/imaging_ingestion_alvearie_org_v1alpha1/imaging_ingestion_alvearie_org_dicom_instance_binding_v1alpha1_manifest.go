...
var (
	_ datasource.DataSource = &ImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1Manifest{}
)

func NewImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1Manifest() datasource.DataSource {
	return &ImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1Manifest{}
}
...
func (r *ImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_imaging_ingestion_alvearie_org_dicom_instance_binding_v1alpha1_manifest"
}

func (r *ImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_imaging_ingestion_alvearie_org_dicom_instance_binding_v1alpha1_manifest")

	var model ImagingIngestionAlvearieOrgDicomInstanceBindingV1Alpha1ManifestData
	...
	model.Kind = pointer.String("DicomInstanceBinding")
