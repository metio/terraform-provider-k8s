...
var (
	_ datasource.DataSource              = &ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource{}
)

func NewImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource() datasource.DataSource {
	return &ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource{}
}

type ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSourceData struct {
...
func (r *ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_imaging_ingestion_alvearie_org_dimse_ingestion_service_v1alpha1"
}

func (r *ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_imaging_ingestion_alvearie_org_dimse_ingestion_service_v1alpha1")

	var data ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSourceData
	...
	var readResponse ImagingIngestionAlvearieOrgDimseIngestionServiceV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("DimseIngestionService")
