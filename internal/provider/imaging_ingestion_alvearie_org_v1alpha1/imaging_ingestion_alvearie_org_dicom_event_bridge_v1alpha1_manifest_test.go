...
func TestImagingIngestionAlvearieOrgDicomEventBridgeV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_imaging_ingestion_alvearie_org_dicom_event_bridge_v1alpha1_manifest", testCase)
		})
	}
}
