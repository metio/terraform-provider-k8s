...
package slinky_slurm_net_v1alpha1
...
var (
	_ datasource.DataSource = &SlinkySlurmNetNodeSetV1Alpha1Manifest{}
)

func NewSlinkySlurmNetNodeSetV1Alpha1Manifest() datasource.DataSource {
	return &SlinkySlurmNetNodeSetV1Alpha1Manifest{}
}

type SlinkySlurmNetNodeSetV1Alpha1Manifest struct{}

type SlinkySlurmNetNodeSetV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		} `tfsdk:"controller_ref" json:"controllerRef,omitempty"`
		MinReadySeconds *int64 `tfsdk:"min_ready_seconds" json:"minReadySeconds,omitempty"`
		Partition       *struct {
			Config  *string `tfsdk:"config" json:"config,omitempty"`
			Enabled *bool   `tfsdk:"enabled" json:"enabled,omitempty"`
		} `tfsdk:"partition" json:"partition,omitempty"`
		...
		Template             *struct {
			...
			ExtraConf        *string `tfsdk:"extra_conf" json:"extraConf,omitempty"`
			...
			} `tfsdk:"logfile" json:"logfile,omitempty"`
			Metadata *struct {
				Annotations *map[string]string `tfsdk:"annotations" json:"annotations,omitempty"`
				Labels      *map[string]string `tfsdk:"labels" json:"labels,omitempty"`
		...
		VolumeClaimTemplates *map[string]string `tfsdk:"volume_claim_templates" json:"volumeClaimTemplates,omitempty"`
	} `tfsdk:"spec" json:"spec,omitempty"`
}

func (r *SlinkySlurmNetNodeSetV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_slinky_slurm_net_node_set_v1alpha1_manifest"
}

func (r *SlinkySlurmNetNodeSetV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "NodeSet is the Schema for the nodesets API",
		MarkdownDescription: "NodeSet is the Schema for the nodesets API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "NodeSetSpec defines the desired state of NodeSet",
				Attributes: map[string]schema.Attribute{
					"controller_ref": schema.SingleNestedAttribute{
						Description:         "controllerRef is a reference to the Controller CR to which this has membership.",
						MarkdownDescription: "controllerRef is a reference to the Controller CR to which this has membership.",
						Attributes: map[string]schema.Attribute{
							"name": schema.StringAttribute{
					...
					"min_ready_seconds": schema.Int64Attribute{
						Description:         "minReadySeconds is the minimum number of seconds for which a newly created NodeSet Pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready).",
						MarkdownDescription: "minReadySeconds is the minimum number of seconds for which a newly created NodeSet Pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"partition": schema.SingleNestedAttribute{
						Description:         "Partition defines the Slurm partition configuration for this NodeSet.",
						MarkdownDescription: "Partition defines the Slurm partition configuration for this NodeSet.",
						Attributes: map[string]schema.Attribute{
							"config": schema.StringAttribute{
								Description:         "Config is added to the NodeSet's partition line. Ref: https://slurm.schedmd.com/slurmd.html#OPT_conf-%3Cnode-parameters%3E",
								MarkdownDescription: "Config is added to the NodeSet's partition line. Ref: https://slurm.schedmd.com/slurmd.html#OPT_conf-%3Cnode-parameters%3E",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"enabled": schema.BoolAttribute{
								Description:         "Enabled will create a partition for this NodeSet.",
								MarkdownDescription: "Enabled will create a partition for this NodeSet.",
								Required:            true,
								Optional:            false,
								Computed:            false,
							},
					...
					"persistent_volume_claim_retention_policy": schema.SingleNestedAttribute{
						Description:         "PersistentVolumeClaimRetentionPolicy describes the policy used for PVCs created from the NodeSet VolumeClaimTemplates. This requires the NodeSetAutoDeletePVC feature gate to be enabled, which is alpha.",
						MarkdownDescription: "PersistentVolumeClaimRetentionPolicy describes the policy used for PVCs created from the NodeSet VolumeClaimTemplates. This requires the NodeSetAutoDeletePVC feature gate to be enabled, which is alpha.",
						Attributes: map[string]schema.Attribute{
							"when_deleted": schema.StringAttribute{
								Description:         "WhenDeleted specifies what happens to PVCs created from NodeSet VolumeClaimTemplates when the NodeSet is deleted. The default policy of 'Retain' causes PVCs to not be affected by NodeSet deletion. The 'Delete' policy causes those PVCs to be deleted.",
								MarkdownDescription: "WhenDeleted specifies what happens to PVCs created from NodeSet VolumeClaimTemplates when the NodeSet is deleted. The default policy of 'Retain' causes PVCs to not be affected by NodeSet deletion. The 'Delete' policy causes those PVCs to be deleted.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"when_scaled": schema.StringAttribute{
								Description:         "WhenScaled specifies what happens to PVCs created from NodeSet VolumeClaimTemplates when the NodeSet is scaled down. The default policy of 'Retain' causes PVCs to not be affected by a scaledown. The 'Delete' policy causes the associated PVCs for any excess pods to be deleted.",
								MarkdownDescription: "WhenScaled specifies what happens to PVCs created from NodeSet VolumeClaimTemplates when the NodeSet is scaled down. The default policy of 'Retain' causes PVCs to not be affected by a scaledown. The 'Delete' policy causes the associated PVCs for any excess pods to be deleted.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"revision_history_limit": schema.Int64Attribute{
						Description:         "revisionHistoryLimit is the maximum number of revisions that will be maintained in the NodeSet's revision history. The revision history consists of all revisions not represented by a currently applied NodeSetSpec version. The default value is 0.",
						MarkdownDescription: "revisionHistoryLimit is the maximum number of revisions that will be maintained in the NodeSet's revision history. The revision history consists of all revisions not represented by a currently applied NodeSetSpec version. The default value is 0.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"template": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Template is the object that describes the pod that will be created if insufficient replicas are detected. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller#pod-template",
						Attributes: map[string]schema.Attribute{
							...
							"container": schema.SingleNestedAttribute{
								Description:         "Container defines the main container.",
								MarkdownDescription: "Container defines the main container.",
								Attributes: map[string]schema.Attribute{
									...
									"image": schema.StringAttribute{
										Description:         "Image URI. More info: https://kubernetes.io/docs/concepts/containers/images",
										MarkdownDescription: "Image URI. More info: https://kubernetes.io/docs/concepts/containers/images",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"image_pull_policy": schema.StringAttribute{
										...
										MarkdownDescription: "Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
									...
									"resources": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "Compute Resources required by this container. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
										Attributes: map[string]schema.Attribute{
							...
							"extra_conf": schema.StringAttribute{
								Description:         "ExtraConf is added to the slurmd args as '--conf <extraConf>'. Ref: https://slurm.schedmd.com/slurmd.html#OPT_conf-%3Cnode-parameters%3E",
								MarkdownDescription: "ExtraConf is added to the slurmd args as '--conf <extraConf>'. Ref: https://slurm.schedmd.com/slurmd.html#OPT_conf-%3Cnode-parameters%3E",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
							...
							"logfile": schema.SingleNestedAttribute{
								Description:         "The logfile sidecar configuration.",
								MarkdownDescription: "The logfile sidecar configuration.",
								Attributes: map[string]schema.Attribute{
									"image": schema.StringAttribute{
										Description:         "Image URI. More info: https://kubernetes.io/docs/concepts/containers/images",
										MarkdownDescription: "Image URI. More info: https://kubernetes.io/docs/concepts/containers/images",
							...
							"tolerations": schema.ListNestedAttribute{
								Description:         "If specified, the pod's tolerations. More info: https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/",
								MarkdownDescription: "If specified, the pod's tolerations. More info: https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/",
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
					...
					"update_strategy": schema.SingleNestedAttribute{
						Description:         "updateStrategy indicates the NodeSetUpdateStrategy that will be employed to update Pods in the NodeSet when a revision is made to Template.",
						MarkdownDescription: "updateStrategy indicates the NodeSetUpdateStrategy that will be employed to update Pods in the NodeSet when a revision is made to Template.",
						Attributes: map[string]schema.Attribute{
							"rolling_update": schema.SingleNestedAttribute{
								Description:         "RollingUpdate is used to communicate parameters when Type is RollingUpdateNodeSetStrategyType.",
								MarkdownDescription: "RollingUpdate is used to communicate parameters when Type is RollingUpdateNodeSetStrategyType.",
								Attributes: map[string]schema.Attribute{
									"max_unavailable": schema.StringAttribute{
										Description:         "The maximum number of pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). Absolute number is calculated from percentage by rounding up. This can not be 0. Defaults to 1.",
										MarkdownDescription: "The maximum number of pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). Absolute number is calculated from percentage by rounding up. This can not be 0. Defaults to 1.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
							...
							"type": schema.StringAttribute{
								Description:         "Type indicates the type of the NodeSetUpdateStrategy. Default is RollingUpdate.",
								MarkdownDescription: "Type indicates the type of the NodeSetUpdateStrategy. Default is RollingUpdate.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
					...
					"volume_claim_templates": schema.MapAttribute{
...
func (r *SlinkySlurmNetNodeSetV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_slinky_slurm_net_node_set_v1alpha1_manifest")

	var model SlinkySlurmNetNodeSetV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("slinky.slurm.net/v1alpha1")
	model.Kind = pointer.String("NodeSet")
