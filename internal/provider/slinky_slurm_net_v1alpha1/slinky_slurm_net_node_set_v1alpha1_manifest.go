			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cluster_name": schema.StringAttribute{
						Description:         "clusterName is the name of the Slurm cluster to which this NodeSet belongs to. This will be matched with the name in Cluster CRD.",
						MarkdownDescription: "clusterName is the name of the Slurm cluster to which this NodeSet belongs to. This will be matched with the name in Cluster CRD.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
					...
					"selector": schema.SingleNestedAttribute{
						Description:         "selector is a label query over pods that should match the replica count. It must match the pod template's labels. If empty, defaulted to labels on Pod Template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors",
						MarkdownDescription: "selector is a label query over pods that should match the replica count. It must match the pod template's labels. If empty, defaulted to labels on Pod Template. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors",
						Attributes: map[string]schema.Attribute{
					...
					"service_name": schema.StringAttribute{
						Description:         "serviceName is the name of the service that governs this NodeSet. This service must exist before the NodeSet, and is responsible for the network identity of the NodeSet. Pods get DNS/hostnames that follow the pattern: pod-specific-string.serviceName.default.svc.cluster.local where 'pod-specific-string' is managed by the NodeSet controller.",
						MarkdownDescription: "serviceName is the name of the service that governs this NodeSet. This service must exist before the NodeSet, and is responsible for the network identity of the NodeSet. Pods get DNS/hostnames that follow the pattern: pod-specific-string.serviceName.default.svc.cluster.local where 'pod-specific-string' is managed by the NodeSet controller.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
