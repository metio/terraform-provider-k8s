...
var (
	_ datasource.DataSource = &NetchecksIoNetworkAssertionV1Manifest{}
)

func NewNetchecksIoNetworkAssertionV1Manifest() datasource.DataSource {
	return &NetchecksIoNetworkAssertionV1Manifest{}
}

type NetchecksIoNetworkAssertionV1Manifest struct{}

type NetchecksIoNetworkAssertionV1ManifestData struct {
...
func (r *NetchecksIoNetworkAssertionV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_netchecks_io_network_assertion_v1_manifest"
}
...
func (r *NetchecksIoNetworkAssertionV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		MarkdownDescription: "NetworkAssertion is the Schema for the networkassertions API",
...
func (r *NetchecksIoNetworkAssertionV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_netchecks_io_network_assertion_v1_manifest")

	var model NetchecksIoNetworkAssertionV1ManifestData
	...
	model.ApiVersion = pointer.String("netchecks.io/v1")
	model.Kind = pointer.String("NetworkAssertion")
