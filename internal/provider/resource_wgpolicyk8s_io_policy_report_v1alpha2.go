...
type Wgpolicyk8SIoPolicyReportV1Alpha2Resource struct{}

var (
	_ resource.Resource = (*Wgpolicyk8SIoPolicyReportV1Alpha2Resource)(nil)
)

type Wgpolicyk8SIoPolicyReportV1Alpha2TerraformModel struct {
	...
	ScopeSelector types.Object `tfsdk:"scope_selector"`
	Summary       types.Object `tfsdk:"summary"`
}

type Wgpolicyk8SIoPolicyReportV1Alpha2GoModel struct {
	...
	Scope *struct {
		...
		Uid *string `tfsdk:"uid" yaml:"uid,omitempty"`
	} `tfsdk:"scope" yaml:"scope,omitempty"`
...
func NewWgpolicyk8SIoPolicyReportV1Alpha2Resource() resource.Resource {
	return &Wgpolicyk8SIoPolicyReportV1Alpha2Resource{}
}

func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_wgpolicyk8s_io_policy_report_v1alpha2"
}

func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_wgpolicyk8s_io_policy_report_v1alpha2")

	var state Wgpolicyk8SIoPolicyReportV1Alpha2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel Wgpolicyk8SIoPolicyReportV1Alpha2GoModel
	...
	goModel.ApiVersion = utilities.Ptr("wgpolicyk8s.io/v1alpha2")
	goModel.Kind = utilities.Ptr("PolicyReport")
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_wgpolicyk8s_io_policy_report_v1alpha2")
	// NO-OP: All data is already in Terraform state
}

func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_wgpolicyk8s_io_policy_report_v1alpha2")
...
func (r *Wgpolicyk8SIoPolicyReportV1Alpha2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_wgpolicyk8s_io_policy_report_v1alpha2")
