...
type TrainingKubedlIoMPIJobV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*TrainingKubedlIoMPIJobV1Alpha1Resource)(nil)
)

type TrainingKubedlIoMPIJobV1Alpha1TerraformModel struct {
...
type TrainingKubedlIoMPIJobV1Alpha1GoModel struct {
	...
	Spec *struct {
		...
		Gpus *int64 `tfsdk:"gpus" yaml:"gpus,omitempty"`

		GpusPerNode *int64 `tfsdk:"gpus_per_node" yaml:"gpusPerNode,omitempty"`

		LauncherOnMaster *bool `tfsdk:"launcher_on_master" yaml:"launcherOnMaster,omitempty"`

		MainContainer *string `tfsdk:"main_container" yaml:"mainContainer,omitempty"`

		MpiDistribution *string `tfsdk:"mpi_distribution" yaml:"mpiDistribution,omitempty"`
		...
		} `tfsdk:"mpi_replica_specs" yaml:"mpiReplicaSpecs,omitempty"`

		ProcessingResourceType *string `tfsdk:"processing_resource_type" yaml:"processingResourceType,omitempty"`

		ProcessingUnits *int64 `tfsdk:"processing_units" yaml:"processingUnits,omitempty"`

		ProcessingUnitsPerNode *int64 `tfsdk:"processing_units_per_node" yaml:"processingUnitsPerNode,omitempty"`
		...
		} `tfsdk:"run_policy" yaml:"runPolicy,omitempty"`
		...
		SlotsPerWorker *int64 `tfsdk:"slots_per_worker" yaml:"slotsPerWorker,omitempty"`
...
func NewTrainingKubedlIoMPIJobV1Alpha1Resource() resource.Resource {
	return &TrainingKubedlIoMPIJobV1Alpha1Resource{}
}

func (r *TrainingKubedlIoMPIJobV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_training_kubedl_io_mpi_job_v1alpha1"
}

func (r *TrainingKubedlIoMPIJobV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *TrainingKubedlIoMPIJobV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_training_kubedl_io_mpi_job_v1alpha1")

	var state TrainingKubedlIoMPIJobV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel TrainingKubedlIoMPIJobV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("MPIJob")
...
func (r *TrainingKubedlIoMPIJobV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_training_kubedl_io_mpi_job_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *TrainingKubedlIoMPIJobV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_training_kubedl_io_mpi_job_v1alpha1")
...
func (r *TrainingKubedlIoMPIJobV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_training_kubedl_io_mpi_job_v1alpha1")
