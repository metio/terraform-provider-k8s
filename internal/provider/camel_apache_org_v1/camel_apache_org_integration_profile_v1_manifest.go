...
var (
	_ datasource.DataSource = &CamelApacheOrgIntegrationProfileV1Manifest{}
)

func NewCamelApacheOrgIntegrationProfileV1Manifest() datasource.DataSource {
	return &CamelApacheOrgIntegrationProfileV1Manifest{}
}
...
func (r *CamelApacheOrgIntegrationProfileV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_camel_apache_org_integration_profile_v1_manifest"
}
	...
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "IntegrationProfileSpec applies user defined settings to the IntegrationProfile.",
				Attributes: map[string]schema.Attribute{
					...
					"kamelet": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "configuration to be executed to all Kamelets controlled by this IntegrationProfile",
						Attributes: map[string]schema.Attribute{
					...
					"traits": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "list of traits to be executed for all the Integration/IntegrationKits built from this IntegrationProfile",
						Attributes: map[string]schema.Attribute{
...
func (r *CamelApacheOrgIntegrationProfileV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_camel_apache_org_integration_profile_v1_manifest")

	var model CamelApacheOrgIntegrationProfileV1ManifestData
	...
	model.Kind = pointer.String("IntegrationProfile")
