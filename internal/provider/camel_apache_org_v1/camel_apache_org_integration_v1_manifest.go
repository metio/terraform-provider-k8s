...
var (
	_ datasource.DataSource = &CamelApacheOrgIntegrationV1Manifest{}
)

func NewCamelApacheOrgIntegrationV1Manifest() datasource.DataSource {
	return &CamelApacheOrgIntegrationV1Manifest{}
}
...
func (r *CamelApacheOrgIntegrationV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_camel_apache_org_integration_v1_manifest"
}

func (r *CamelApacheOrgIntegrationV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CamelApacheOrgIntegrationV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_camel_apache_org_integration_v1_manifest")

	var model CamelApacheOrgIntegrationV1ManifestData
