			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"dependencies": schema.ListAttribute{
						Description:         "the list of Camel or Maven dependencies required by the Pipe",
						MarkdownDescription: "the list of Camel or Maven dependencies required by the Pipe",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"integration": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Integration is an optional integration used to specify custom parameters Deprecated don't use this. Use trait annotations if you need to change any cluster configuration.",
						Attributes: map[string]schema.Attribute{
