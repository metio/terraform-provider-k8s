...
var (
	_ datasource.DataSource = &CamelApacheOrgPipeV1Manifest{}
)

func NewCamelApacheOrgPipeV1Manifest() datasource.DataSource {
	return &CamelApacheOrgPipeV1Manifest{}
}
...
func (r *CamelApacheOrgPipeV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_camel_apache_org_pipe_v1_manifest"
}

func (r *CamelApacheOrgPipeV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Pipe is the Schema for the Pipe API.",
		MarkdownDescription: "Pipe is the Schema for the Pipe API.",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "the specification of a Pipe",
				Attributes: map[string]schema.Attribute{
					...
					"integration": schema.SingleNestedAttribute{
						Description:         "Integration is an optional integration used to specify custom parametersDeprecated don't use this. Use trait annotations if you need to change any cluster configuration.",
						MarkdownDescription: "Integration is an optional integration used to specify custom parametersDeprecated don't use this. Use trait annotations if you need to change any cluster configuration.",
						Attributes: map[string]schema.Attribute{
							"configuration": schema.ListNestedAttribute{
								Description:         "Deprecated:Use camel trait (camel.properties) to manage propertiesUse mount trait (mount.configs) to manage configsUse mount trait (mount.resources) to manage resourcesUse mount trait (mount.volumes) to manage volumes",
								MarkdownDescription: "Deprecated:Use camel trait (camel.properties) to manage propertiesUse mount trait (mount.configs) to manage configsUse mount trait (mount.resources) to manage resourcesUse mount trait (mount.volumes) to manage volumes",
					...
					"replicas": schema.Int64Attribute{
						...
						MarkdownDescription: "Replicas is the number of desired replicas for the Pipe",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"service_account_name": schema.StringAttribute{
						...
						MarkdownDescription: "Custom SA to use for the Pipe",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"sink": schema.SingleNestedAttribute{
						Description:         "Sink is the destination of the integration defined by this Pipe",
						MarkdownDescription: "Sink is the destination of the integration defined by this Pipe",
						Attributes: map[string]schema.Attribute{
					...
					"source": schema.SingleNestedAttribute{
						Description:         "Source is the starting point of the integration defined by this Pipe",
						MarkdownDescription: "Source is the starting point of the integration defined by this Pipe",
						Attributes: map[string]schema.Attribute{
							"data_types": schema.SingleNestedAttribute{
								Description:         "DataTypes defines the data type of the data produced/consumed by the endpoint and references a given data type specification.",
								MarkdownDescription: "DataTypes defines the data type of the data produced/consumed by the endpoint and references a given data type specification.",
...
func (r *CamelApacheOrgPipeV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_camel_apache_org_pipe_v1_manifest")

	var model CamelApacheOrgPipeV1ManifestData
