...
var (
	_ datasource.DataSource = &K8SMariadbComRestoreV1Alpha1Manifest{}
)

func NewK8SMariadbComRestoreV1Alpha1Manifest() datasource.DataSource {
	return &K8SMariadbComRestoreV1Alpha1Manifest{}
}

type K8SMariadbComRestoreV1Alpha1Manifest struct{}

type K8SMariadbComRestoreV1Alpha1ManifestData struct {
...
func (r *K8SMariadbComRestoreV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_k8s_mariadb_com_restore_v1alpha1_manifest"
}

func (r *K8SMariadbComRestoreV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"database": schema.StringAttribute{
						...
						MarkdownDescription: "Database defines the logical database to be restored. If not provided, all databases available in the backup are restored.IMPORTANT: The database must previously exist.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *K8SMariadbComRestoreV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_k8s_mariadb_com_restore_v1alpha1_manifest")

	var model K8SMariadbComRestoreV1Alpha1ManifestData
