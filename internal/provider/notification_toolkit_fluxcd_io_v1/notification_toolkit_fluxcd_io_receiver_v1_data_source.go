...
var (
	_ datasource.DataSource              = &NotificationToolkitFluxcdIoReceiverV1DataSource{}
	_ datasource.DataSourceWithConfigure = &NotificationToolkitFluxcdIoReceiverV1DataSource{}
)

func NewNotificationToolkitFluxcdIoReceiverV1DataSource() datasource.DataSource {
	return &NotificationToolkitFluxcdIoReceiverV1DataSource{}
}

type NotificationToolkitFluxcdIoReceiverV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NotificationToolkitFluxcdIoReceiverV1DataSourceData struct {
...
func (r *NotificationToolkitFluxcdIoReceiverV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_receiver_v1"
}

func (r *NotificationToolkitFluxcdIoReceiverV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotificationToolkitFluxcdIoReceiverV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NotificationToolkitFluxcdIoReceiverV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_notification_toolkit_fluxcd_io_receiver_v1")

	var data NotificationToolkitFluxcdIoReceiverV1DataSourceData
	...
	var readResponse NotificationToolkitFluxcdIoReceiverV1DataSourceData
	...
	data.ApiVersion = pointer.String("notification.toolkit.fluxcd.io/v1")
