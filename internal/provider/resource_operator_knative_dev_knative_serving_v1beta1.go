...
var (
	_ resource.Resource = (*OperatorKnativeDevKnativeServingV1Beta1Resource)(nil)
)

type OperatorKnativeDevKnativeServingV1Beta1TerraformModel struct {
...
type OperatorKnativeDevKnativeServingV1Beta1GoModel struct {
	...
	Spec *struct {
		...
		} `tfsdk:"controller_custom_certs" yaml:"controller-custom-certs,omitempty"`
		...
		Ingress *struct {
			...
			Istio *struct {
				...
				} `tfsdk:"knative_ingress_gateway" yaml:"knative-ingress-gateway,omitempty"`
				...
				} `tfsdk:"knative_local_gateway" yaml:"knative-local-gateway,omitempty"`
			} `tfsdk:"istio" yaml:"istio,omitempty"`

			Kourier *struct {
				Bootstrap_configmap *string `tfsdk:"bootstrap_configmap" yaml:"bootstrap-configmap,omitempty"`

				Enabled *bool `tfsdk:"enabled" yaml:"enabled,omitempty"`

				Service_type *string `tfsdk:"service_type" yaml:"service-type,omitempty"`
...
func (r *OperatorKnativeDevKnativeServingV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_operator_knative_dev_knative_serving_v1beta1"
}

func (r *OperatorKnativeDevKnativeServingV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *OperatorKnativeDevKnativeServingV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_operator_knative_dev_knative_serving_v1beta1")

	var state OperatorKnativeDevKnativeServingV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel OperatorKnativeDevKnativeServingV1Beta1GoModel
	...
	goModel.Kind = utilities.Ptr("KnativeServing")
...
func (r *OperatorKnativeDevKnativeServingV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_operator_knative_dev_knative_serving_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *OperatorKnativeDevKnativeServingV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *OperatorKnativeDevKnativeServingV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
