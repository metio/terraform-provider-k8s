...
func TestEmrcontainersServicesK8SAwsVirtualClusterV1Alpha1Resource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "resource", "k8s_emrcontainers_services_k8s_aws_virtual_cluster_v1alpha1", testCase)
		})
	}
}
