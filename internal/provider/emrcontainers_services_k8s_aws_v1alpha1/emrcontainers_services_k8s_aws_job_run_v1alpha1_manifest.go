...
var (
	_ datasource.DataSource = &EmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest{}
)

func NewEmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest() datasource.DataSource {
	return &EmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest{}
}

type EmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest struct{}

type EmrcontainersServicesK8SAwsJobRunV1Alpha1ManifestData struct {
...
func (r *EmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_emrcontainers_services_k8s_aws_job_run_v1alpha1_manifest"
}

func (r *EmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *EmrcontainersServicesK8SAwsJobRunV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_emrcontainers_services_k8s_aws_job_run_v1alpha1_manifest")

	var model EmrcontainersServicesK8SAwsJobRunV1Alpha1ManifestData
