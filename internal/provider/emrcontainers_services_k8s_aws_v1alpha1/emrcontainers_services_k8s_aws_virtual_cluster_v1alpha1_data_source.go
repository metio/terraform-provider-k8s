...
var (
	_ datasource.DataSource              = &EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource{}
)

func NewEmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource() datasource.DataSource {
	return &EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource{}
}

type EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSourceData struct {
...
func (r *EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_emrcontainers_services_k8s_aws_virtual_cluster_v1alpha1"
}

func (r *EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_emrcontainers_services_k8s_aws_virtual_cluster_v1alpha1")

	var data EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSourceData
	...
	var readResponse EmrcontainersServicesK8SAwsVirtualClusterV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("VirtualCluster")
