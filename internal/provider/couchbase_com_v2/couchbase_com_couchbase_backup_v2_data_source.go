...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseBackupV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseBackupV2DataSource{}
)

func NewCouchbaseComCouchbaseBackupV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseBackupV2DataSource{}
}

type CouchbaseComCouchbaseBackupV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseBackupV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseBackupV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_backup_v2"
}

func (r *CouchbaseComCouchbaseBackupV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseBackupV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseBackupV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_backup_v2")

	var data CouchbaseComCouchbaseBackupV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "couchbase.com", Version: "v2", Resource: "CouchbaseBackup"}).
	...
	var readResponse CouchbaseComCouchbaseBackupV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseBackup")
