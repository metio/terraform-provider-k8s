...
var (
	_ datasource.DataSource = &CouchbaseComCouchbaseClusterV2Manifest{}
)

func NewCouchbaseComCouchbaseClusterV2Manifest() datasource.DataSource {
	return &CouchbaseComCouchbaseClusterV2Manifest{}
}
	...
	Spec *struct {
		...
		Cluster *struct {
			...
			Data                                   *struct {
				...
				MinReplicasCount *int64 `tfsdk:"min_replicas_count" json:"minReplicasCount,omitempty"`
			...
			Query *struct {
				...
				CboEnabled                   *bool   `tfsdk:"cbo_enabled" json:"cboEnabled,omitempty"`
				CleanupClientAttemptsEnabled *bool   `tfsdk:"cleanup_client_attempts_enabled" json:"cleanupClientAttemptsEnabled,omitempty"`
				CleanupLostAttemptsEnabled   *bool   `tfsdk:"cleanup_lost_attempts_enabled" json:"cleanupLostAttemptsEnabled,omitempty"`
				CleanupWindow                *string `tfsdk:"cleanup_window" json:"cleanupWindow,omitempty"`
				CompletedLimit               *int64  `tfsdk:"completed_limit" json:"completedLimit,omitempty"`
				CompletedMaxPlanSize         *string `tfsdk:"completed_max_plan_size" json:"completedMaxPlanSize,omitempty"`
				CompletedTrackingAllRequests *bool   `tfsdk:"completed_tracking_all_requests" json:"completedTrackingAllRequests,omitempty"`
				CompletedTrackingEnabled     *bool   `tfsdk:"completed_tracking_enabled" json:"completedTrackingEnabled,omitempty"`
				CompletedTrackingThreshold   *string `tfsdk:"completed_tracking_threshold" json:"completedTrackingThreshold,omitempty"`
				LogLevel                     *string `tfsdk:"log_level" json:"logLevel,omitempty"`
				MaxParallelism               *int64  `tfsdk:"max_parallelism" json:"maxParallelism,omitempty"`
				MemoryQuota                  *string `tfsdk:"memory_quota" json:"memoryQuota,omitempty"`
				NodeQuotaValPercent          *int64  `tfsdk:"node_quota_val_percent" json:"nodeQuotaValPercent,omitempty"`
				NumActiveTransactionRecords  *int64  `tfsdk:"num_active_transaction_records" json:"numActiveTransactionRecords,omitempty"`
				NumCpus                      *int64  `tfsdk:"num_cpus" json:"numCpus,omitempty"`
				PipelineBatch                *int64  `tfsdk:"pipeline_batch" json:"pipelineBatch,omitempty"`
				PipelineCap                  *int64  `tfsdk:"pipeline_cap" json:"pipelineCap,omitempty"`
				PreparedLimit                *int64  `tfsdk:"prepared_limit" json:"preparedLimit,omitempty"`
				ScanCap                      *int64  `tfsdk:"scan_cap" json:"scanCap,omitempty"`
				...
				TxTimeout                    *string `tfsdk:"tx_timeout" json:"txTimeout,omitempty"`
				UseReplica                   *bool   `tfsdk:"use_replica" json:"useReplica,omitempty"`
		...
		Logging                     *struct {
			Audit *struct {
				...
				Rotation *struct {
					Interval *string `tfsdk:"interval" json:"interval,omitempty"`
					PruneAge *string `tfsdk:"prune_age" json:"pruneAge,omitempty"`
					Size     *string `tfsdk:"size" json:"size,omitempty"`
		...
		Migration *struct {
			...
			MigrationOrderOverride  *struct {
				MigrationOrderOverrideStrategy *string   `tfsdk:"migration_order_override_strategy" json:"migrationOrderOverrideStrategy,omitempty"`
				NodeOrder                      *[]string `tfsdk:"node_order" json:"nodeOrder,omitempty"`
				ServerClassOrder               *[]string `tfsdk:"server_class_order" json:"serverClassOrder,omitempty"`
				ServerGroupOrder               *[]string `tfsdk:"server_group_order" json:"serverGroupOrder,omitempty"`
			} `tfsdk:"migration_order_override" json:"migrationOrderOverride,omitempty"`
		...
		Security *struct {
			...
			Ldap        *struct {
				...
				MiddleboxCompMode     *bool     `tfsdk:"middlebox_comp_mode" json:"middleboxCompMode,omitempty"`
		...
		UpgradeProcess              *string `tfsdk:"upgrade_process" json:"upgradeProcess,omitempty"`
...
func (r *CouchbaseComCouchbaseClusterV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_cluster_v2_manifest"
}
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
							...
							"auto_compaction": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"database_fragmentation_threshold": schema.SingleNestedAttribute{
										Description:         "DatabaseFragmentationThreshold defines the default database fragmentation level to determine the point when compaction is triggered for buckets with a couchstore storage backend.",
										MarkdownDescription: "DatabaseFragmentationThreshold defines the default database fragmentation level to determine the point when compaction is triggered for buckets with a couchstore storage backend.",
										Attributes: map[string]schema.Attribute{
							...
							"query": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"log_level": schema.StringAttribute{
										...
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("debug", "trace", "info", "warn", "error", "severe", "none"),
										},
									},
						...
						Attributes: map[string]schema.Attribute{
							...
							"migration_order_override": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"server_class_order": schema.ListAttribute{
										Description:         "ServerClassOrder defines the order of server classes for migration.",
										MarkdownDescription: "ServerClassOrder defines the order of server classes for migration.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
									...
									"server_group_order": schema.ListAttribute{
										Description:         "ServerGroupOrder defines the order of server groups for migration.",
										MarkdownDescription: "ServerGroupOrder defines the order of server groups for migration.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
							...
							"cloud_native_gateway": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"log_level": schema.StringAttribute{
										...
										Computed:            false,
										Validators: []validator.String{
											stringvalidator.OneOf("fatal", "panic", "dpanic", "error", "warn", "info", "debug"),
										},
									},
					...
					"upgrade_process": schema.StringAttribute{
						...
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("SwapRebalance", "DeltaRecovery", "InPlaceUpgrade"),
						},
					},
...
func (r *CouchbaseComCouchbaseClusterV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_couchbase_com_couchbase_cluster_v2_manifest")

	var model CouchbaseComCouchbaseClusterV2ManifestData
