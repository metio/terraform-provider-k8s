...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseCollectionGroupV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseCollectionGroupV2DataSource{}
)

func NewCouchbaseComCouchbaseCollectionGroupV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseCollectionGroupV2DataSource{}
}

type CouchbaseComCouchbaseCollectionGroupV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseCollectionGroupV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseCollectionGroupV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_collection_group_v2"
}

func (r *CouchbaseComCouchbaseCollectionGroupV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseCollectionGroupV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseCollectionGroupV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_collection_group_v2")

	var data CouchbaseComCouchbaseCollectionGroupV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "couchbase.com", Version: "v2", Resource: "couchbasecollectiongroups"}).
	...
	var readResponse CouchbaseComCouchbaseCollectionGroupV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseCollectionGroup")
