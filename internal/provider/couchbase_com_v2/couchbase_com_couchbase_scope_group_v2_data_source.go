...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseScopeGroupV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseScopeGroupV2DataSource{}
)

func NewCouchbaseComCouchbaseScopeGroupV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseScopeGroupV2DataSource{}
}

type CouchbaseComCouchbaseScopeGroupV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseScopeGroupV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseScopeGroupV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_scope_group_v2"
}

func (r *CouchbaseComCouchbaseScopeGroupV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseScopeGroupV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseScopeGroupV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_scope_group_v2")

	var data CouchbaseComCouchbaseScopeGroupV2DataSourceData
	...
	var readResponse CouchbaseComCouchbaseScopeGroupV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseScopeGroup")
