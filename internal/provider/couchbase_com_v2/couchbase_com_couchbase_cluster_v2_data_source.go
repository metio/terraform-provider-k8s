...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseClusterV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseClusterV2DataSource{}
)

func NewCouchbaseComCouchbaseClusterV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseClusterV2DataSource{}
}

type CouchbaseComCouchbaseClusterV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseClusterV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseClusterV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_cluster_v2"
}

func (r *CouchbaseComCouchbaseClusterV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseClusterV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseClusterV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_cluster_v2")

	var data CouchbaseComCouchbaseClusterV2DataSourceData
	...
	var readResponse CouchbaseComCouchbaseClusterV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseCluster")
