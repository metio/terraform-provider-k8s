...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseBucketV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseBucketV2DataSource{}
)

func NewCouchbaseComCouchbaseBucketV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseBucketV2DataSource{}
}

type CouchbaseComCouchbaseBucketV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseBucketV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseBucketV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_bucket_v2"
}

func (r *CouchbaseComCouchbaseBucketV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseBucketV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseBucketV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_bucket_v2")

	var data CouchbaseComCouchbaseBucketV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "couchbase.com", Version: "v2", Resource: "CouchbaseBucket"}).
	...
	var readResponse CouchbaseComCouchbaseBucketV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseBucket")
