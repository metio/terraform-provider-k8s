			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"auto_compaction": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"database_fragmentation_threshold": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"percent": schema.Int64Attribute{
										Description:         "Percent specifies the level of view fragmentation that must be reached for View compaction to be automatically triggered. This field must be in the range 0-100, defaulting to the cluster level value.",
										MarkdownDescription: "Percent specifies the level of view fragmentation that must be reached for View compaction to be automatically triggered. This field must be in the range 0-100, defaulting to the cluster level value.",
										Required:            false,
										Optional:            true,
										Computed:            false,
							...
							"view_fragmentation_threshold": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"percent": schema.Int64Attribute{
										Description:         "Percent specifies the percentage level of View fragmentation that must be reached for View compaction to be automatically triggered on the bucket This field must be in the range 0-100, defaulting to the cluster level value.",
										MarkdownDescription: "Percent specifies the percentage level of View fragmentation that must be reached for View compaction to be automatically triggered on the bucket This field must be in the range 0-100, defaulting to the cluster level value.",
										Required:            false,
										Optional:            true,
										Computed:            false,
										Validators: []validator.Int64{
					...
					"scopes": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"selector": schema.SingleNestedAttribute{
								...
								MarkdownDescription: "Selector allows resources to be implicitly considered for inclusion in this bucket. More info: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#labelselector-v1-meta",
								Attributes: map[string]schema.Attribute{
					...
					"storage_backend": schema.StringAttribute{
						Description:         "StorageBackend to be assigned to and used by the bucket. Only valid for Couchbase Server 7.0.0 onward. Two different backend storage mechanisms can be used - 'couchstore' or 'magma', defaulting to 'couchstore'. Note: 'magma' is only valid for Couchbase Server 7.1.0 onward.",
						MarkdownDescription: "StorageBackend to be assigned to and used by the bucket. Only valid for Couchbase Server 7.0.0 onward. Two different backend storage mechanisms can be used - 'couchstore' or 'magma', defaulting to 'couchstore'. Note: 'magma' is only valid for Couchbase Server 7.1.0 onward.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
