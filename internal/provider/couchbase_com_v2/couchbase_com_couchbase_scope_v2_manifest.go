...
var (
	_ datasource.DataSource = &CouchbaseComCouchbaseScopeV2Manifest{}
)

func NewCouchbaseComCouchbaseScopeV2Manifest() datasource.DataSource {
	return &CouchbaseComCouchbaseScopeV2Manifest{}
}

type CouchbaseComCouchbaseScopeV2Manifest struct{}

type CouchbaseComCouchbaseScopeV2ManifestData struct {
...
func (r *CouchbaseComCouchbaseScopeV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_scope_v2_manifest"
}
...
func (r *CouchbaseComCouchbaseScopeV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_couchbase_com_couchbase_scope_v2_manifest")

	var model CouchbaseComCouchbaseScopeV2ManifestData
