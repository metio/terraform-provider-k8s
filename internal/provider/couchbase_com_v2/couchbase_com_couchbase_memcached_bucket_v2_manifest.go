...
var (
	_ datasource.DataSource = &CouchbaseComCouchbaseMemcachedBucketV2Manifest{}
)

func NewCouchbaseComCouchbaseMemcachedBucketV2Manifest() datasource.DataSource {
	return &CouchbaseComCouchbaseMemcachedBucketV2Manifest{}
}
...
func (r *CouchbaseComCouchbaseMemcachedBucketV2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_memcached_bucket_v2_manifest"
}
...
func (r *CouchbaseComCouchbaseMemcachedBucketV2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_couchbase_com_couchbase_memcached_bucket_v2_manifest")

	var model CouchbaseComCouchbaseMemcachedBucketV2ManifestData
