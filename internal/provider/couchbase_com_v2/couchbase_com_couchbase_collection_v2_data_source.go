...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseCollectionV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseCollectionV2DataSource{}
)

func NewCouchbaseComCouchbaseCollectionV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseCollectionV2DataSource{}
}

type CouchbaseComCouchbaseCollectionV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseCollectionV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseCollectionV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_collection_v2"
}

func (r *CouchbaseComCouchbaseCollectionV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseCollectionV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseCollectionV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_collection_v2")

	var data CouchbaseComCouchbaseCollectionV2DataSourceData
	...
	var readResponse CouchbaseComCouchbaseCollectionV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseCollection")
