...
var (
	_ datasource.DataSource              = &CouchbaseComCouchbaseBackupRestoreV2DataSource{}
	_ datasource.DataSourceWithConfigure = &CouchbaseComCouchbaseBackupRestoreV2DataSource{}
)

func NewCouchbaseComCouchbaseBackupRestoreV2DataSource() datasource.DataSource {
	return &CouchbaseComCouchbaseBackupRestoreV2DataSource{}
}

type CouchbaseComCouchbaseBackupRestoreV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type CouchbaseComCouchbaseBackupRestoreV2DataSourceData struct {
...
func (r *CouchbaseComCouchbaseBackupRestoreV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_couchbase_com_couchbase_backup_restore_v2"
}

func (r *CouchbaseComCouchbaseBackupRestoreV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CouchbaseComCouchbaseBackupRestoreV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *CouchbaseComCouchbaseBackupRestoreV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_couchbase_com_couchbase_backup_restore_v2")

	var data CouchbaseComCouchbaseBackupRestoreV2DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "couchbase.com", Version: "v2", Resource: "CouchbaseBackupRestore"}).
	...
	var readResponse CouchbaseComCouchbaseBackupRestoreV2DataSourceData
	...
	data.Kind = pointer.String("CouchbaseBackupRestore")
