					...
					"services": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"users": schema.BoolAttribute{
								Description:         "Users restores cluster level users, including their roles and permissions. This is only available for Couchbase Server 7.6 and later. This field defaults to 'false'.",
								MarkdownDescription: "Users restores cluster level users, including their roles and permissions. This is only available for Couchbase Server 7.6 and later. This field defaults to 'false'.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
