...
var (
	_ datasource.DataSource              = &InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource{}
)

func NewInfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource() datasource.DataSource {
	return &InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource{}
}

type InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSourceData struct {
...
func (r *InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1beta1"
}

func (r *InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1beta1")

	var data InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSourceData
	...
	var readResponse InfrastructureClusterXK8SIoVsphereMachineV1Beta1DataSourceData
