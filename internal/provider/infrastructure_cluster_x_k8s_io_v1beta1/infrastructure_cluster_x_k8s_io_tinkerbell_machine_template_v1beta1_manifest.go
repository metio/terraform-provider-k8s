									...
									"boot_options": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											"boot_mode": schema.StringAttribute{
												Description:         "BootMode is the type of booting that will be done. Must be one of 'none', 'netboot', 'iso', or 'isoboot'.",
												MarkdownDescription: "BootMode is the type of booting that will be done. Must be one of 'none', 'netboot', 'iso', or 'isoboot'.",
												Required:            false,
												Optional:            true,
												Computed:            false,
												Validators: []validator.String{
													stringvalidator.OneOf("none", "netboot", "iso", "isoboot"),
												},
											},
