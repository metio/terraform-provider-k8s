...
var (
	_ datasource.DataSource = &InfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1Manifest{}
)

func NewInfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1Manifest() datasource.DataSource {
	return &InfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1Manifest{}
}
...
func (r *InfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_ibm_power_vs_machine_v1beta1_manifest"
}

func (r *InfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_infrastructure_cluster_x_k8s_io_ibm_power_vs_machine_v1beta1_manifest")

	var model InfrastructureClusterXK8SIoIbmpowerVsmachineV1Beta1ManifestData
