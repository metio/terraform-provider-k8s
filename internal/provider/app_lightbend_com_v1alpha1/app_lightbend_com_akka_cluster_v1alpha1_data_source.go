...
var (
	_ datasource.DataSource              = &AppLightbendComAkkaClusterV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &AppLightbendComAkkaClusterV1Alpha1DataSource{}
)

func NewAppLightbendComAkkaClusterV1Alpha1DataSource() datasource.DataSource {
	return &AppLightbendComAkkaClusterV1Alpha1DataSource{}
}

type AppLightbendComAkkaClusterV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AppLightbendComAkkaClusterV1Alpha1DataSourceData struct {
...
func (r *AppLightbendComAkkaClusterV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_lightbend_com_akka_cluster_v1alpha1"
}

func (r *AppLightbendComAkkaClusterV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppLightbendComAkkaClusterV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AppLightbendComAkkaClusterV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_app_lightbend_com_akka_cluster_v1alpha1")

	var data AppLightbendComAkkaClusterV1Alpha1DataSourceData
	...
	var readResponse AppLightbendComAkkaClusterV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("app.lightbend.com/v1alpha1")
	data.Kind = pointer.String("AkkaCluster")
