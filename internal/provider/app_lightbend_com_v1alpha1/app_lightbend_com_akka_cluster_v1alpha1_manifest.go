...
var (
	_ datasource.DataSource = &AppLightbendComAkkaClusterV1Alpha1Manifest{}
)

func NewAppLightbendComAkkaClusterV1Alpha1Manifest() datasource.DataSource {
	return &AppLightbendComAkkaClusterV1Alpha1Manifest{}
}

type AppLightbendComAkkaClusterV1Alpha1Manifest struct{}

type AppLightbendComAkkaClusterV1Alpha1ManifestData struct {
...
func (r *AppLightbendComAkkaClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_app_lightbend_com_akka_cluster_v1alpha1_manifest"
}

func (r *AppLightbendComAkkaClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AppLightbendComAkkaClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_app_lightbend_com_akka_cluster_v1alpha1_manifest")

	var model AppLightbendComAkkaClusterV1Alpha1ManifestData
