...
func TestGatewayNginxOrgNginxGatewayV1Alpha1Manifest_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_gateway_nginx_org_nginx_gateway_v1alpha1_manifest", testCase)
		})
	}
}
