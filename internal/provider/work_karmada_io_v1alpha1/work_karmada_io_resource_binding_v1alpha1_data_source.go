...
var (
	_ datasource.DataSource              = &WorkKarmadaIoResourceBindingV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &WorkKarmadaIoResourceBindingV1Alpha1DataSource{}
)

func NewWorkKarmadaIoResourceBindingV1Alpha1DataSource() datasource.DataSource {
	return &WorkKarmadaIoResourceBindingV1Alpha1DataSource{}
}

type WorkKarmadaIoResourceBindingV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type WorkKarmadaIoResourceBindingV1Alpha1DataSourceData struct {
...
func (r *WorkKarmadaIoResourceBindingV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_work_karmada_io_resource_binding_v1alpha1"
}

func (r *WorkKarmadaIoResourceBindingV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WorkKarmadaIoResourceBindingV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *WorkKarmadaIoResourceBindingV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_work_karmada_io_resource_binding_v1alpha1")

	var data WorkKarmadaIoResourceBindingV1Alpha1DataSourceData
	...
	var readResponse WorkKarmadaIoResourceBindingV1Alpha1DataSourceData
