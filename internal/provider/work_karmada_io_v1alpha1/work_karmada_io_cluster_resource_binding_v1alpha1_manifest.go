...
var (
	_ datasource.DataSource = &WorkKarmadaIoClusterResourceBindingV1Alpha1Manifest{}
)

func NewWorkKarmadaIoClusterResourceBindingV1Alpha1Manifest() datasource.DataSource {
	return &WorkKarmadaIoClusterResourceBindingV1Alpha1Manifest{}
}

type WorkKarmadaIoClusterResourceBindingV1Alpha1Manifest struct{}

type WorkKarmadaIoClusterResourceBindingV1Alpha1ManifestData struct {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_work_karmada_io_cluster_resource_binding_v1alpha1_manifest"
}

func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_work_karmada_io_cluster_resource_binding_v1alpha1_manifest")

	var model WorkKarmadaIoClusterResourceBindingV1Alpha1ManifestData
