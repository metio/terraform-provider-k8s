...
var (
	_ datasource.DataSource              = &WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource{}
)

func NewWorkKarmadaIoClusterResourceBindingV1Alpha1DataSource() datasource.DataSource {
	return &WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource{}
}

type WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type WorkKarmadaIoClusterResourceBindingV1Alpha1DataSourceData struct {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_work_karmada_io_cluster_resource_binding_v1alpha1"
}

func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *WorkKarmadaIoClusterResourceBindingV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_work_karmada_io_cluster_resource_binding_v1alpha1")

	var data WorkKarmadaIoClusterResourceBindingV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "work.karmada.io", Version: "v1alpha1", Resource: "clusterresourcebindings"}).
	...
	var readResponse WorkKarmadaIoClusterResourceBindingV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ClusterResourceBinding")
