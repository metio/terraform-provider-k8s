...
type LokiGrafanaComLokiStackV1Resource struct{}

var (
	_ resource.Resource = (*LokiGrafanaComLokiStackV1Resource)(nil)
)

type LokiGrafanaComLokiStackV1TerraformModel struct {
...
type LokiGrafanaComLokiStackV1GoModel struct {
	...
	Spec *struct {
		Limits *struct {
			Global *struct {
				...
				} `tfsdk:"retention" yaml:"retention,omitempty"`
		...
		Storage *struct {
			...
			Tls *struct {
				CaKey *string `tfsdk:"ca_key" yaml:"caKey,omitempty"`
...
func NewLokiGrafanaComLokiStackV1Resource() resource.Resource {
	return &LokiGrafanaComLokiStackV1Resource{}
}

func (r *LokiGrafanaComLokiStackV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_loki_grafana_com_loki_stack_v1"
}

func (r *LokiGrafanaComLokiStackV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
						...
						Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
							...
							"tls": {
								...
								Attributes: tfsdk.SingleNestedAttributes(map[string]tfsdk.Attribute{
									...
									"ca_key": {
										Description:         "Key is the data key of a ConfigMap containing a CA certificate. It needs to be in the same namespace as the LokiStack custom resource.",
										MarkdownDescription: "Key is the data key of a ConfigMap containing a CA certificate. It needs to be in the same namespace as the LokiStack custom resource.",
...
func (r *LokiGrafanaComLokiStackV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_loki_grafana_com_loki_stack_v1")

	var state LokiGrafanaComLokiStackV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel LokiGrafanaComLokiStackV1GoModel
	...
	goModel.ApiVersion = utilities.Ptr("loki.grafana.com/v1")
...
func (r *LokiGrafanaComLokiStackV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_loki_grafana_com_loki_stack_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *LokiGrafanaComLokiStackV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_loki_grafana_com_loki_stack_v1")
...
func (r *LokiGrafanaComLokiStackV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_loki_grafana_com_loki_stack_v1")
