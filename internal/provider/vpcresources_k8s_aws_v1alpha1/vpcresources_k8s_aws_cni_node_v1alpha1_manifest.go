...
package vpcresources_k8s_aws_v1alpha1
...
var (
	_ datasource.DataSource = &VpcresourcesK8SAwsCninodeV1Alpha1Manifest{}
)

func NewVpcresourcesK8SAwsCninodeV1Alpha1Manifest() datasource.DataSource {
	return &VpcresourcesK8SAwsCninodeV1Alpha1Manifest{}
}

type VpcresourcesK8SAwsCninodeV1Alpha1Manifest struct{}

type VpcresourcesK8SAwsCninodeV1Alpha1ManifestData struct {
...
func (r *VpcresourcesK8SAwsCninodeV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_vpcresources_k8s_aws_cni_node_v1alpha1_manifest"
}
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
									...
									MarkdownDescription: "FeatureName is a type of feature name supported by AWS VPC CNI. It can be Security Group for Pods, custom networking, or others",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
...
func (r *VpcresourcesK8SAwsCninodeV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_vpcresources_k8s_aws_cni_node_v1alpha1_manifest")

	var model VpcresourcesK8SAwsCninodeV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("vpcresources.k8s.aws/v1alpha1")
	model.Kind = pointer.String("CNINode")
