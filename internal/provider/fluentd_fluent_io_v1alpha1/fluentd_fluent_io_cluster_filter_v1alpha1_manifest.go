...
var (
	_ datasource.DataSource = &FluentdFluentIoClusterFilterV1Alpha1Manifest{}
)

func NewFluentdFluentIoClusterFilterV1Alpha1Manifest() datasource.DataSource {
	return &FluentdFluentIoClusterFilterV1Alpha1Manifest{}
}
...
func (r *FluentdFluentIoClusterFilterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentd_fluent_io_cluster_filter_v1alpha1_manifest"
}

func (r *FluentdFluentIoClusterFilterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ClusterFilter is the Schema for the clusterfilters API",
		MarkdownDescription: "ClusterFilter is the Schema for the clusterfilters API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ClusterFilterSpec defines the desired state of ClusterFilter",
				Attributes: map[string]schema.Attribute{
...
func (r *FluentdFluentIoClusterFilterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentd_fluent_io_cluster_filter_v1alpha1_manifest")

	var model FluentdFluentIoClusterFilterV1Alpha1ManifestData
