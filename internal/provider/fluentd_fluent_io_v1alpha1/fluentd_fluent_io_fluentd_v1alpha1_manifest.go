			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"env_from": schema.ListNestedAttribute{
						Description:         "EnvFrom represent environment variables that can be passed to fluentd pods directly from secret or configmap",
						MarkdownDescription: "EnvFrom represent environment variables that can be passed to fluentd pods directly from secret or configmap",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
					...
					"replicas": schema.Int64Attribute{
						Description:         "Numbers of the Fluentd instance Applicable when the mode is 'collector', and will be ignored when the mode is 'agent'",
						MarkdownDescription: "Numbers of the Fluentd instance Applicable when the mode is 'collector', and will be ignored when the mode is 'agent'",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"service": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"type": schema.StringAttribute{
								...
								MarkdownDescription: "Type is the service type to deploy.",
								Required:            false,
								Optional:            true,
								Computed:            false,
								Validators: []validator.String{
