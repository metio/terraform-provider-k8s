...
var (
	_ datasource.DataSource = &FluentdFluentIoOutputV1Alpha1Manifest{}
)

func NewFluentdFluentIoOutputV1Alpha1Manifest() datasource.DataSource {
	return &FluentdFluentIoOutputV1Alpha1Manifest{}
}
...
func (r *FluentdFluentIoOutputV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentd_fluent_io_output_v1alpha1_manifest"
}

func (r *FluentdFluentIoOutputV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "Output is the Schema for the outputs API",
		MarkdownDescription: "Output is the Schema for the outputs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "OutputSpec defines the desired state of Output",
				Attributes: map[string]schema.Attribute{
								...
								"loki": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										"bearer_token_file": schema.StringAttribute{
											Description:         "Set path to file with bearer authentication token Can be used as alterntative to HTTP basic authentication",
											MarkdownDescription: "Set path to file with bearer authentication token Can be used as alterntative to HTTP basic authentication",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
...
func (r *FluentdFluentIoOutputV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentd_fluent_io_output_v1alpha1_manifest")

	var model FluentdFluentIoOutputV1Alpha1ManifestData
