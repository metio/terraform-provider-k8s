...
var (
	_ datasource.DataSource = &FluentdFluentIoFluentdConfigV1Alpha1Manifest{}
)

func NewFluentdFluentIoFluentdConfigV1Alpha1Manifest() datasource.DataSource {
	return &FluentdFluentIoFluentdConfigV1Alpha1Manifest{}
}
...
func (r *FluentdFluentIoFluentdConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentd_fluent_io_fluentd_config_v1alpha1_manifest"
}

func (r *FluentdFluentIoFluentdConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "FluentdConfig is the Schema for the fluentdconfigs API",
		MarkdownDescription: "FluentdConfig is the Schema for the fluentdconfigs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "FluentdConfigSpec defines the desired state of FluentdConfig",
				Attributes: map[string]schema.Attribute{
					"cluster_filter_selector": schema.SingleNestedAttribute{
						Description:         "Select cluster filter plugins",
						MarkdownDescription: "Select cluster filter plugins",
						Attributes: map[string]schema.Attribute{
					...
					"cluster_input_selector": schema.SingleNestedAttribute{
						Description:         "Select cluster input plugins",
						MarkdownDescription: "Select cluster input plugins",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"cluster_output_selector": schema.SingleNestedAttribute{
						Description:         "Select cluster output plugins",
						MarkdownDescription: "Select cluster output plugins",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"output_selector": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Select namespaced output plugins",
						Attributes: map[string]schema.Attribute{
							"match_expressions": schema.ListNestedAttribute{
								Description:         "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
								MarkdownDescription: "matchExpressions is a list of label selector requirements. The requirements are ANDed.",
					...
					"watched_constainers": schema.ListAttribute{
						Description:         "A set of container names. Ignored if left empty.",
						MarkdownDescription: "A set of container names. Ignored if left empty.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"watched_hosts": schema.ListAttribute{
						Description:         "A set of hosts. Ignored if left empty.",
						MarkdownDescription: "A set of hosts. Ignored if left empty.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"watched_labels": schema.MapAttribute{
						Description:         "Use this field to filter the logs, will make no effect if EnableFilterKubernetes is set false.",
						MarkdownDescription: "Use this field to filter the logs, will make no effect if EnableFilterKubernetes is set false.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *FluentdFluentIoFluentdConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentd_fluent_io_fluentd_config_v1alpha1_manifest")

	var model FluentdFluentIoFluentdConfigV1Alpha1ManifestData
	...
	model.Kind = pointer.String("FluentdConfig")
