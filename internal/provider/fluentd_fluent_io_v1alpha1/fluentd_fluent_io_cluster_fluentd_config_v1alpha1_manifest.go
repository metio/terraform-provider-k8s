...
var (
	_ datasource.DataSource = &FluentdFluentIoClusterFluentdConfigV1Alpha1Manifest{}
)

func NewFluentdFluentIoClusterFluentdConfigV1Alpha1Manifest() datasource.DataSource {
	return &FluentdFluentIoClusterFluentdConfigV1Alpha1Manifest{}
}
...
func (r *FluentdFluentIoClusterFluentdConfigV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentd_fluent_io_cluster_fluentd_config_v1alpha1_manifest"
}

func (r *FluentdFluentIoClusterFluentdConfigV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ClusterFluentdConfigSpec defines the desired state of ClusterFluentdConfig",
				Attributes: map[string]schema.Attribute{
					...
					"watched_namespaces": schema.ListAttribute{
						Description:         "A set of namespaces. The whole namespaces would be watched if left empty.",
						MarkdownDescription: "A set of namespaces. The whole namespaces would be watched if left empty.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *FluentdFluentIoClusterFluentdConfigV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentd_fluent_io_cluster_fluentd_config_v1alpha1_manifest")

	var model FluentdFluentIoClusterFluentdConfigV1Alpha1ManifestData
