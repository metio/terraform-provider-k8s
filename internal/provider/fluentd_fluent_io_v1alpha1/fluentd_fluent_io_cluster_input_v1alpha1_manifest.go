...
var (
	_ datasource.DataSource = &FluentdFluentIoClusterInputV1Alpha1Manifest{}
)

func NewFluentdFluentIoClusterInputV1Alpha1Manifest() datasource.DataSource {
	return &FluentdFluentIoClusterInputV1Alpha1Manifest{}
}
...
func (r *FluentdFluentIoClusterInputV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_fluentd_fluent_io_cluster_input_v1alpha1_manifest"
}

func (r *FluentdFluentIoClusterInputV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "ClusterInput is the Schema for the clusterinputs API",
		MarkdownDescription: "ClusterInput is the Schema for the clusterinputs API",
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ClusterInputSpec defines the desired state of ClusterInput",
				Attributes: map[string]schema.Attribute{
...
func (r *FluentdFluentIoClusterInputV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_fluentd_fluent_io_cluster_input_v1alpha1_manifest")

	var model FluentdFluentIoClusterInputV1Alpha1ManifestData
