			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"addon_version": schema.StringAttribute{
						Description:         "The version of the add-on. The version must match one of the versions returnedby DescribeAddonVersions (https://docs.aws.amazon.com/eks/latest/APIReference/API_DescribeAddonVersions.html).",
						MarkdownDescription: "The version of the add-on. The version must match one of the versions returnedby DescribeAddonVersions (https://docs.aws.amazon.com/eks/latest/APIReference/API_DescribeAddonVersions.html).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"configuration_values": schema.StringAttribute{
						Description:         "The set of configuration values for the add-on that's created. The valuesthat you provide are validated against the schema returned by DescribeAddonConfiguration.",
						MarkdownDescription: "The set of configuration values for the add-on that's created. The valuesthat you provide are validated against the schema returned by DescribeAddonConfiguration.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"name": schema.StringAttribute{
						Description:         "The name of the add-on. The name must match one of the names returned byDescribeAddonVersions.",
						MarkdownDescription: "The name of the add-on. The name must match one of the names returned byDescribeAddonVersions.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
