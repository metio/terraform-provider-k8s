...
var (
	_ datasource.DataSource = &ChainsawKyvernoIoConfigurationV1Alpha1Manifest{}
)

func NewChainsawKyvernoIoConfigurationV1Alpha1Manifest() datasource.DataSource {
	return &ChainsawKyvernoIoConfigurationV1Alpha1Manifest{}
}
...
func (r *ChainsawKyvernoIoConfigurationV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chainsaw_kyverno_io_configuration_v1alpha1_manifest"
}

func (r *ChainsawKyvernoIoConfigurationV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"deletion_propagation_policy": schema.StringAttribute{
						Description:         "DeletionPropagationPolicy decides if a deletion will propagate to the dependents of the object, and how the garbage collector will handle the propagation.",
						MarkdownDescription: "DeletionPropagationPolicy decides if a deletion will propagate to the dependents of the object, and how the garbage collector will handle the propagation.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"namespace": schema.StringAttribute{
						...
						MarkdownDescription: "Namespace defines the namespace to use for tests. If not specified, every test will execute in a random ephemeral namespace unless the namespace is overridden in a the test spec.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"report_format": schema.StringAttribute{
						...
						MarkdownDescription: "ReportFormat determines test report format (JSON|XML|nil) nil == no report. maps to report.Type, however we don't want generated.deepcopy to have reference to it.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"report_path": schema.StringAttribute{
					...
					"skip_delete": schema.BoolAttribute{
						...
						MarkdownDescription: "If set, do not delete the resources after running the tests (implies SkipClusterDelete).",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
...
func (r *ChainsawKyvernoIoConfigurationV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_chainsaw_kyverno_io_configuration_v1alpha1_manifest")

	var model ChainsawKyvernoIoConfigurationV1Alpha1ManifestData
