...
var (
	_ datasource.DataSource = &CsiCephIoOperatorConfigV1Manifest{}
)

func NewCsiCephIoOperatorConfigV1Manifest() datasource.DataSource {
	return &CsiCephIoOperatorConfigV1Manifest{}
}

type CsiCephIoOperatorConfigV1Manifest struct{}

type CsiCephIoOperatorConfigV1ManifestData struct {
	...
	Spec *struct {
		DriverSpecDefaults *struct {
			...
			EnableFencing   *bool `tfsdk:"enable_fencing" json:"enableFencing,omitempty"`
...
func (r *CsiCephIoOperatorConfigV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_csi_ceph_io_operator_config_v1_manifest"
}

func (r *CsiCephIoOperatorConfigV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
				...
				Attributes: map[string]schema.Attribute{
					"driver_spec_defaults": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"enable_fencing": schema.BoolAttribute{
								Description:         "Set to true to enable fencing for the driver. Fencing is a feature that allows the driver to fence a node when it is tainted with node.kubernetes.io/out-of-service.",
								MarkdownDescription: "Set to true to enable fencing for the driver. Fencing is a feature that allows the driver to fence a node when it is tainted with node.kubernetes.io/out-of-service.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *CsiCephIoOperatorConfigV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_csi_ceph_io_operator_config_v1_manifest")

	var model CsiCephIoOperatorConfigV1ManifestData
