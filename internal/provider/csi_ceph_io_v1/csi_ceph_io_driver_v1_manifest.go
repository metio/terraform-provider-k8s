...
var (
	_ datasource.DataSource = &CsiCephIoDriverV1Manifest{}
)

func NewCsiCephIoDriverV1Manifest() datasource.DataSource {
	return &CsiCephIoDriverV1Manifest{}
}

type CsiCephIoDriverV1Manifest struct{}

type CsiCephIoDriverV1ManifestData struct {
...
func (r *CsiCephIoDriverV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_csi_ceph_io_driver_v1_manifest"
}

func (r *CsiCephIoDriverV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *CsiCephIoDriverV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_csi_ceph_io_driver_v1_manifest")

	var model CsiCephIoDriverV1ManifestData
