...
var (
	_ datasource.DataSource              = &AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource{}
	_ datasource.DataSourceWithConfigure = &AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource{}
)

func NewAddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource{}
}

type AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource struct {
	kubernetesClient dynamic.Interface
}

type AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSourceData struct {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_v1alpha4"
}

func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_addons_cluster_x_k8s_io_cluster_resource_set_v1alpha4")

	var data AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSourceData
	...
	var readResponse AddonsClusterXK8SIoClusterResourceSetV1Alpha4DataSourceData
