...
var (
	_ datasource.DataSource = &AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4Manifest{}
)

func NewAddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4Manifest() datasource.DataSource {
	return &AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4Manifest{}
}

type AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4Manifest struct{}

type AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4ManifestData struct {
...
func (r *AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_addons_cluster_x_k8s_io_cluster_resource_set_binding_v1alpha4_manifest"
}
...
func (r *AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_addons_cluster_x_k8s_io_cluster_resource_set_binding_v1alpha4_manifest")

	var model AddonsClusterXK8SIoClusterResourceSetBindingV1Alpha4ManifestData
