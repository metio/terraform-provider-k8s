...
var (
	_ datasource.DataSource = &ChainsawKyvernoIoTestV1Alpha2Manifest{}
)

func NewChainsawKyvernoIoTestV1Alpha2Manifest() datasource.DataSource {
	return &ChainsawKyvernoIoTestV1Alpha2Manifest{}
}

type ChainsawKyvernoIoTestV1Alpha2Manifest struct{}

type ChainsawKyvernoIoTestV1Alpha2ManifestData struct {
...
func (r *ChainsawKyvernoIoTestV1Alpha2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_chainsaw_kyverno_io_test_v1alpha2_manifest"
}
					...
					"execution": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"termination_grace_period": schema.StringAttribute{
								...
								MarkdownDescription: "TerminationGracePeriod forces the termination grace period on pods, statefulsets, daemonsets and deployments.",
								Required:            false,
								Optional:            true,
								Computed:            false,
							},
...
func (r *ChainsawKyvernoIoTestV1Alpha2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_chainsaw_kyverno_io_test_v1alpha2_manifest")

	var model ChainsawKyvernoIoTestV1Alpha2ManifestData
