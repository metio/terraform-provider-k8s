...
var (
	_ resource.Resource = (*FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource)(nil)
)

type FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2TerraformModel struct {
...
type FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2GoModel struct {
	...
	Spec *struct {
		Limited *struct {
			AssuredConcurrencyShares *int64 `tfsdk:"assured_concurrency_shares" yaml:"assuredConcurrencyShares,omitempty"`

			BorrowingLimitPercent *int64 `tfsdk:"borrowing_limit_percent" yaml:"borrowingLimitPercent,omitempty"`

			LendablePercent *int64 `tfsdk:"lendable_percent" yaml:"lendablePercent,omitempty"`
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta2"
}

func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta2")

	var state FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2GoModel
	...
	goModel.ApiVersion = utilities.Ptr("flowcontrol.apiserver.k8s.io/v1beta2")
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_flowcontrol_apiserver_k8s_io_priority_level_configuration_v1beta2")
	// NO-OP: All data is already in Terraform state
}

func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *FlowcontrolApiserverK8SIoPriorityLevelConfigurationV1Beta2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
