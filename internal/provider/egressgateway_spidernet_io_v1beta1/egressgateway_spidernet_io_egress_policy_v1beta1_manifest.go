...
var (
	_ datasource.DataSource = &EgressgatewaySpidernetIoEgressPolicyV1Beta1Manifest{}
)

func NewEgressgatewaySpidernetIoEgressPolicyV1Beta1Manifest() datasource.DataSource {
	return &EgressgatewaySpidernetIoEgressPolicyV1Beta1Manifest{}
}
...
func (r *EgressgatewaySpidernetIoEgressPolicyV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_egressgateway_spidernet_io_egress_policy_v1beta1_manifest"
}

func (r *EgressgatewaySpidernetIoEgressPolicyV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "EgressPolicy represents a single egress gateway policy",
		MarkdownDescription: "EgressPolicy represents a single egress gateway policy",
				...
				Attributes: map[string]schema.Attribute{
					"applied_to": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"pod_subnet": schema.ListAttribute{
								Description:         "",
								MarkdownDescription: "",
								ElementType:         types.StringType,
								Required:            false,
					...
					"dest_subnet": schema.ListAttribute{
						Description:         "",
						MarkdownDescription: "",
						ElementType:         types.StringType,
						Required:            false,
					...
					"egress_gateway_name": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"egress_ip": schema.SingleNestedAttribute{
						Description:         "",
						MarkdownDescription: "",
						Attributes: map[string]schema.Attribute{
							"allocator_policy": schema.StringAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
							...
							"use_node_ip": schema.BoolAttribute{
								Description:         "",
								MarkdownDescription: "",
								Required:            false,
								Optional:            true,
...
func (r *EgressgatewaySpidernetIoEgressPolicyV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_egressgateway_spidernet_io_egress_policy_v1beta1_manifest")

	var model EgressgatewaySpidernetIoEgressPolicyV1Beta1ManifestData
	...
	model.Kind = pointer.String("EgressPolicy")
