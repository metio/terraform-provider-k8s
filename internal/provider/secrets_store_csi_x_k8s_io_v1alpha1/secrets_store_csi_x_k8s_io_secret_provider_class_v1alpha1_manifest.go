...
package secrets_store_csi_x_k8s_io_v1alpha1
...
var (
	_ datasource.DataSource = &SecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1Manifest{}
)

func NewSecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1Manifest() datasource.DataSource {
	return &SecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1Manifest{}
}
...
func (r *SecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_secrets_store_csi_x_k8s_io_secret_provider_class_v1alpha1_manifest"
}

func (r *SecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *SecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_secrets_store_csi_x_k8s_io_secret_provider_class_v1alpha1_manifest")

	var model SecretsStoreCsiXK8SIoSecretProviderClassV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("secrets-store.csi.x-k8s.io/v1alpha1")
