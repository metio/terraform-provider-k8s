			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"datacenter": schema.SingleNestedAttribute{
						Description:         "Which datacenter this task is targeting. Note, this must be a datacenter which the current cass-operator can access",
						MarkdownDescription: "Which datacenter this task is targeting. Note, this must be a datacenter which the current cass-operator can access",
						Attributes: map[string]schema.Attribute{
