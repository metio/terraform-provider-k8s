...
type FlowsNetobservIoFlowCollectorV1Beta2ManifestData struct {
	...
	Spec *struct {
		...
		Loki *struct {
			Advanced *struct {
				ExcludeLabels   *[]string          `tfsdk:"exclude_labels" json:"excludeLabels,omitempty"`
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
							...
							"ebpf": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"advanced": schema.SingleNestedAttribute{
										...
										MarkdownDescription: "'advanced' allows setting some aspects of the internal configuration of the eBPF agent. This section is aimed mostly for debugging and fine-grained performance optimizations, such as 'GOGC' and 'GOMAXPROCS' environment variables. Set these values at your own risk. You can also override the default Linux capabilities from there.",
										Attributes: map[string]schema.Attribute{
					...
					"console_plugin": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"advanced": schema.SingleNestedAttribute{
								Description:         "'advanced' allows setting some aspects of the internal configuration of the console plugin. This section is aimed mostly for debugging and fine-grained performance optimizations, such as 'GOGC' and 'GOMAXPROCS' environment variables. Set these values at your own risk.",
								MarkdownDescription: "'advanced' allows setting some aspects of the internal configuration of the console plugin. This section is aimed mostly for debugging and fine-grained performance optimizations, such as 'GOGC' and 'GOMAXPROCS' environment variables. Set these values at your own risk.",
								Attributes: map[string]schema.Attribute{
					...
					"loki": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"advanced": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									"exclude_labels": schema.ListAttribute{
										Description:         "'excludeLabels' is a list of field to be excluded from the list of Loki labels.",
										MarkdownDescription: "'excludeLabels' is a list of field to be excluded from the list of Loki labels.",
										ElementType:         types.StringType,
										Required:            false,
										Optional:            true,
										Computed:            false,
					...
					"processor": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"advanced": schema.SingleNestedAttribute{
								Description:         "'advanced' allows setting some aspects of the internal configuration of the flow processor. This section is aimed mostly for debugging and fine-grained performance optimizations, such as 'GOGC' and 'GOMAXPROCS' environment variables. Set these values at your own risk.",
								MarkdownDescription: "'advanced' allows setting some aspects of the internal configuration of the flow processor. This section is aimed mostly for debugging and fine-grained performance optimizations, such as 'GOGC' and 'GOMAXPROCS' environment variables. Set these values at your own risk.",
								Attributes: map[string]schema.Attribute{
