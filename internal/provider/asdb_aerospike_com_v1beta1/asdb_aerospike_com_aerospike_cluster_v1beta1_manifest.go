...
var (
	_ datasource.DataSource = &AsdbAerospikeComAerospikeClusterV1Beta1Manifest{}
)

func NewAsdbAerospikeComAerospikeClusterV1Beta1Manifest() datasource.DataSource {
	return &AsdbAerospikeComAerospikeClusterV1Beta1Manifest{}
}

type AsdbAerospikeComAerospikeClusterV1Beta1Manifest struct{}

type AsdbAerospikeComAerospikeClusterV1Beta1ManifestData struct {
...
func (r *AsdbAerospikeComAerospikeClusterV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_asdb_aerospike_com_aerospike_cluster_v1beta1_manifest"
}

func (r *AsdbAerospikeComAerospikeClusterV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AsdbAerospikeComAerospikeClusterV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_asdb_aerospike_com_aerospike_cluster_v1beta1_manifest")

	var model AsdbAerospikeComAerospikeClusterV1Beta1ManifestData
