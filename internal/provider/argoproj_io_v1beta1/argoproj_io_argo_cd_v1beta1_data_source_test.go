...
func TestArgoprojIoArgoCDV1Beta1DataSource_ConfigurationErrors(t *testing.T) {
	...
	for name, testCase := range testCases {
		t.Run(name, func(t *testing.T) {
			testutilities.VerifyConfigurationErrors(t, "data", "k8s_argoproj_io_argo_cd_v1beta1", testCase)
		})
	}
}
...
func TestArgoprojIoArgoCDV1Beta1DataSource_OfflineUsage(t *testing.T) {
	...
	`
	testutilities.VerifyCannotBeUsedOffline(t, "data", "k8s_argoproj_io_argo_cd_v1beta1", configuration)
}
