...
func (r *ArgoprojIoArgoCdV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "argoproj.io", Version: "v1beta1", Resource: "argocds"}).
	...
	data.ApiVersion = pointer.String("argoproj.io/v1beta1")
	data.Kind = pointer.String("ArgoCD")
