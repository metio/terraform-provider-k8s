...
var (
	_ datasource.DataSource = &ReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest{}
)

func NewReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest() datasource.DataSource {
	return &ReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest{}
}

type ReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest struct{}

type ReliablesyncsKubeedgeIoObjectSyncV1Alpha1ManifestData struct {
...
func (r *ReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_reliablesyncs_kubeedge_io_object_sync_v1alpha1_manifest"
}

func (r *ReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *ReliablesyncsKubeedgeIoObjectSyncV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_reliablesyncs_kubeedge_io_object_sync_v1alpha1_manifest")

	var model ReliablesyncsKubeedgeIoObjectSyncV1Alpha1ManifestData
