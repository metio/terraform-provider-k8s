...
var (
	_ datasource.DataSource = &GatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest{}
)

func NewGatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest() datasource.DataSource {
	return &GatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest{}
}

type GatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest struct{}

type GatewayNetworkingK8SIoTlsrouteV1Alpha3ManifestData struct {
...
func (r *GatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_gateway_networking_k8s_io_tls_route_v1alpha3_manifest"
}

func (r *GatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"rules": schema.ListNestedAttribute{
						...
						MarkdownDescription: "Rules are a list of actions.",
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
...
func (r *GatewayNetworkingK8SIoTlsrouteV1Alpha3Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_gateway_networking_k8s_io_tls_route_v1alpha3_manifest")

	var model GatewayNetworkingK8SIoTlsrouteV1Alpha3ManifestData
