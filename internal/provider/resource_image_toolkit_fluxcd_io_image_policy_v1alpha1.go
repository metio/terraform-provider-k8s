...
type ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource struct{}

var (
	_ resource.Resource = (*ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource)(nil)
)

type ImageToolkitFluxcdIoImagePolicyV1Alpha1TerraformModel struct {
...
type ImageToolkitFluxcdIoImagePolicyV1Alpha1GoModel struct {
...
func NewImageToolkitFluxcdIoImagePolicyV1Alpha1Resource() resource.Resource {
	return &ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource{}
}

func (r *ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_image_toolkit_fluxcd_io_image_policy_v1alpha1"
}

func (r *ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_image_toolkit_fluxcd_io_image_policy_v1alpha1")

	var state ImageToolkitFluxcdIoImagePolicyV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel ImageToolkitFluxcdIoImagePolicyV1Alpha1GoModel
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_image_toolkit_fluxcd_io_image_policy_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_image_toolkit_fluxcd_io_image_policy_v1alpha1")
...
func (r *ImageToolkitFluxcdIoImagePolicyV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_image_toolkit_fluxcd_io_image_policy_v1alpha1")
