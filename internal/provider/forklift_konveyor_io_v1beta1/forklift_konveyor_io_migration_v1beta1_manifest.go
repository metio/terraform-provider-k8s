...
var (
	_ datasource.DataSource = &ForkliftKonveyorIoMigrationV1Beta1Manifest{}
)

func NewForkliftKonveyorIoMigrationV1Beta1Manifest() datasource.DataSource {
	return &ForkliftKonveyorIoMigrationV1Beta1Manifest{}
}
...
func (r *ForkliftKonveyorIoMigrationV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_forklift_konveyor_io_migration_v1beta1_manifest"
}

func (r *ForkliftKonveyorIoMigrationV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"cancel": schema.ListNestedAttribute{
						Description:         "List of VMs which will have their imports canceled.",
						MarkdownDescription: "List of VMs which will have their imports canceled.",
					...
					"cutover": schema.StringAttribute{
						Description:         "Date and time to finalize a warm migration. If present, this will override the value set on the Plan.",
						MarkdownDescription: "Date and time to finalize a warm migration. If present, this will override the value set on the Plan.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"plan": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Reference to the associated Plan.",
						Attributes: map[string]schema.Attribute{
...
func (r *ForkliftKonveyorIoMigrationV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_forklift_konveyor_io_migration_v1beta1_manifest")

	var model ForkliftKonveyorIoMigrationV1Beta1ManifestData
