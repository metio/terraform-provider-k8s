...
var (
	_ datasource.DataSource = &ForkliftKonveyorIoNetworkMapV1Beta1Manifest{}
)

func NewForkliftKonveyorIoNetworkMapV1Beta1Manifest() datasource.DataSource {
	return &ForkliftKonveyorIoNetworkMapV1Beta1Manifest{}
}
...
func (r *ForkliftKonveyorIoNetworkMapV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_forklift_konveyor_io_network_map_v1beta1_manifest"
}

func (r *ForkliftKonveyorIoNetworkMapV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "Network map spec.",
				Attributes: map[string]schema.Attribute{
								...
								"destination": schema.SingleNestedAttribute{
									...
									Attributes: map[string]schema.Attribute{
										...
										"namespace": schema.StringAttribute{
											...
											MarkdownDescription: "The namespace (multus only).",
											Required:            false,
											Optional:            true,
											Computed:            false,
										},
...
func (r *ForkliftKonveyorIoNetworkMapV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_forklift_konveyor_io_network_map_v1beta1_manifest")

	var model ForkliftKonveyorIoNetworkMapV1Beta1ManifestData
	...
	model.Kind = pointer.String("NetworkMap")
