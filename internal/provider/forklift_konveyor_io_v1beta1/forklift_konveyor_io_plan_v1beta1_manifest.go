...
type ForkliftKonveyorIoPlanV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		DeleteVmOnFailMigration  *bool   `tfsdk:"delete_vm_on_fail_migration" json:"deleteVmOnFailMigration,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"delete_vm_on_fail_migration": schema.BoolAttribute{
						Description:         "DeleteVmOnFailMigration controls whether the target VM created by this Plan is deleted when a migration fails. When true and the migration fails after the target VM has been created, the controller will delete the target VM (and related target-side resources) during failed-migration cleanup and when the Plan is deleted. When false (default), the target VM is preserved to aid troubleshooting. The source VM is never modified. Note: If the Plan-level option is set to true, the VM-level option will be ignored.",
						MarkdownDescription: "DeleteVmOnFailMigration controls whether the target VM created by this Plan is deleted when a migration fails. When true and the migration fails after the target VM has been created, the controller will delete the target VM (and related target-side resources) during failed-migration cleanup and when the Plan is deleted. When false (default), the target VM is preserved to aid troubleshooting. The source VM is never modified. Note: If the Plan-level option is set to true, the VM-level option will be ignored.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"type": schema.StringAttribute{
						Description:         "Migration type. e.g. 'cold', 'warm', 'live', 'conversion'. Supersedes the 'warm' boolean if set.",
						MarkdownDescription: "Migration type. e.g. 'cold', 'warm', 'live', 'conversion'. Supersedes the 'warm' boolean if set.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("cold", "warm", "live", "conversion"),
						},
					},
