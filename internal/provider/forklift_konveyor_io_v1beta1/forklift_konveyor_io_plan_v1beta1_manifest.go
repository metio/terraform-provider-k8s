...
type ForkliftKonveyorIoPlanV1Beta1ManifestData struct {
	...
	Spec *struct {
		...
		InstallLegacyDrivers     *bool   `tfsdk:"install_legacy_drivers" json:"installLegacyDrivers,omitempty"`
		Map                      *struct {
			Network *struct {
		...
		SkipGuestConversion            *bool   `tfsdk:"skip_guest_conversion" json:"skipGuestConversion,omitempty"`
		TargetAffinity                 *struct {
			NodeAffinity *struct {
		...
		} `tfsdk:"target_affinity" json:"targetAffinity,omitempty"`
		TargetLabels       *map[string]string `tfsdk:"target_labels" json:"targetLabels,omitempty"`
		TargetNamespace    *string            `tfsdk:"target_namespace" json:"targetNamespace,omitempty"`
		TargetNodeSelector *map[string]string `tfsdk:"target_node_selector" json:"targetNodeSelector,omitempty"`
		TargetPowerState   *string            `tfsdk:"target_power_state" json:"targetPowerState,omitempty"`
		...
		UseCompatibilityMode *bool   `tfsdk:"use_compatibility_mode" json:"useCompatibilityMode,omitempty"`
		Vms                  *[]struct {
			Hooks *[]struct {
				Hook *struct {
					ApiVersion      *string `tfsdk:"api_version" json:"apiVersion,omitempty"`
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"skip_guest_conversion": schema.BoolAttribute{
						Description:         "Determines if the plan should skip the guest conversion.",
						MarkdownDescription: "Determines if the plan should skip the guest conversion.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},

					"target_affinity": schema.SingleNestedAttribute{
						Description:         "TargetAffinity allows specifying hard- and soft-affinity for VMs. it is possible to write matching rules against workloads (VMs and Pods) and Nodes. Since VMs are a workload type based on Pods, Pod-affinity affects VMs as well. See virtual machine instance Affinity documentation for more details, https://kubevirt.io/user-guide/compute/node_assignment/#affinity-and-anti-affinity",
						MarkdownDescription: "TargetAffinity allows specifying hard- and soft-affinity for VMs. it is possible to write matching rules against workloads (VMs and Pods) and Nodes. Since VMs are a workload type based on Pods, Pod-affinity affects VMs as well. See virtual machine instance Affinity documentation for more details, https://kubevirt.io/user-guide/compute/node_assignment/#affinity-and-anti-affinity",
						Attributes: map[string]schema.Attribute{
					...
					"target_labels": schema.MapAttribute{
						Description:         "TargetLabels are labels that should be applied to the target virtual machines. See Pod Labels documentation for more details, https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#labels",
						MarkdownDescription: "TargetLabels are labels that should be applied to the target virtual machines. See Pod Labels documentation for more details, https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#labels",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"target_node_selector": schema.MapAttribute{
						Description:         "TargetNodeSelector, constrains the scheduler to only schedule VMs on nodes, which contain the specified labels. See virtual machine instance NodeSelector documentation for more details, https://kubevirt.io/user-guide/compute/node_assignment/#nodeselector",
						MarkdownDescription: "TargetNodeSelector, constrains the scheduler to only schedule VMs on nodes, which contain the specified labels. See virtual machine instance NodeSelector documentation for more details, https://kubevirt.io/user-guide/compute/node_assignment/#nodeselector",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"target_power_state": schema.StringAttribute{
						Description:         "TargetPowerState specifies the desired power state of the target VM after migration. - 'on': Target VM will be powered on after migration - 'off': Target VM will be powered off after migration - 'auto' or nil (default): Target VM will match the source VM's power state",
						MarkdownDescription: "TargetPowerState specifies the desired power state of the target VM after migration. - 'on': Target VM will be powered on after migration - 'off': Target VM will be powered off after migration - 'auto' or nil (default): Target VM will match the source VM's power state",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
					...
					"type": schema.StringAttribute{
						Description:         "Migration type. e.g. 'cold', 'warm', 'live'. Supersedes the 'warm' boolean if set.",
						MarkdownDescription: "Migration type. e.g. 'cold', 'warm', 'live'. Supersedes the 'warm' boolean if set.",
						Required:            false,
						Optional:            true,
						Computed:            false,
						Validators: []validator.String{
							stringvalidator.OneOf("cold", "warm", "live"),
						},
					},

					"use_compatibility_mode": schema.BoolAttribute{
						Description:         "useCompatibilityMode controls whether to use VirtIO devices when skipGuestConversion is true (Raw Copy mode). This setting has no effect when skipGuestConversion is false (V2V Conversion always uses VirtIO). - true (default): Use compatibility devices (SATA bus, E1000E NIC) to ensure bootability - false: Use high-performance VirtIO devices (requires VirtIO drivers already installed in source VM)",
						MarkdownDescription: "useCompatibilityMode controls whether to use VirtIO devices when skipGuestConversion is true (Raw Copy mode). This setting has no effect when skipGuestConversion is false (V2V Conversion always uses VirtIO). - true (default): Use compatibility devices (SATA bus, E1000E NIC) to ensure bootability - false: Use high-performance VirtIO devices (requires VirtIO drivers already installed in source VM)",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
					...
					"vms": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"luks": schema.SingleNestedAttribute{
									Description:         "Disk decryption LUKS keys",
									MarkdownDescription: "Disk decryption LUKS keys",
									Attributes: map[string]schema.Attribute{
										"api_version": schema.StringAttribute{
											Description:         "API version of the referent.",
											MarkdownDescription: "API version of the referent.",
					...
					"warm": schema.BoolAttribute{
						Description:         "Whether this is a warm migration. Deprecated: this field will be deprecated in 2.10. Use Type instead.",
						MarkdownDescription: "Whether this is a warm migration. Deprecated: this field will be deprecated in 2.10. Use Type instead.",
						Required:            false,
						Optional:            true,
						Computed:            false,
					},
