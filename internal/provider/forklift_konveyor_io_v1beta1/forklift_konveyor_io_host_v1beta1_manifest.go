...
var (
	_ datasource.DataSource = &ForkliftKonveyorIoHostV1Beta1Manifest{}
)

func NewForkliftKonveyorIoHostV1Beta1Manifest() datasource.DataSource {
	return &ForkliftKonveyorIoHostV1Beta1Manifest{}
}
...
func (r *ForkliftKonveyorIoHostV1Beta1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_forklift_konveyor_io_host_v1beta1_manifest"
}

func (r *ForkliftKonveyorIoHostV1Beta1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"ip_address": schema.StringAttribute{
						...
						MarkdownDescription: "IP address used for disk transfer.",
						Required:            true,
						Optional:            false,
						Computed:            false,
					},
...
func (r *ForkliftKonveyorIoHostV1Beta1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_forklift_konveyor_io_host_v1beta1_manifest")

	var model ForkliftKonveyorIoHostV1Beta1ManifestData
