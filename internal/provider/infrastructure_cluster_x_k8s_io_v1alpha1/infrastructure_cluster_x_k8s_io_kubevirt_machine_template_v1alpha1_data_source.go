...
var (
	_ datasource.DataSource              = &InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource{}
)

func NewInfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource() datasource.DataSource {
	return &InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource{}
}

type InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSourceData struct {
...
func (r *InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_kubevirt_machine_template_v1alpha1"
}

func (r *InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_infrastructure_cluster_x_k8s_io_kubevirt_machine_template_v1alpha1")

	var data InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSourceData
	...
	var readResponse InfrastructureClusterXK8SIoKubevirtMachineTemplateV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("KubevirtMachineTemplate")
