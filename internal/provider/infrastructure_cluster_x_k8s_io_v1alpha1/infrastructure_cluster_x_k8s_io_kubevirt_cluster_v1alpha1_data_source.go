...
var (
	_ datasource.DataSource              = &InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource{}
)

func NewInfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource() datasource.DataSource {
	return &InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource{}
}

type InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSourceData struct {
...
func (r *InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_infrastructure_cluster_x_k8s_io_kubevirt_cluster_v1alpha1"
}

func (r *InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
	response.Schema = schema.Schema{
		Description:         "KubevirtCluster is the Schema for the kubevirtclusters API.",
		MarkdownDescription: "KubevirtCluster is the Schema for the kubevirtclusters API.",
...
func (r *InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_infrastructure_cluster_x_k8s_io_kubevirt_cluster_v1alpha1")

	var data InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "infrastructure.cluster.x-k8s.io", Version: "v1alpha1", Resource: "kubevirtclusters"}).
	...
	var readResponse InfrastructureClusterXK8SIoKubevirtClusterV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("KubevirtCluster")
