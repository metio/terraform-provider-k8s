...
type TelemetryIstioIoTelemetryV1ManifestData struct {
	...
	Spec *struct {
		...
		Tracing *[]struct {
			...
			EnableIstioTags      *bool `tfsdk:"enable_istio_tags" json:"enableIstioTags,omitempty"`
			Match                *struct {
				Mode *string `tfsdk:"mode" json:"mode,omitempty"`
			} `tfsdk:"match" json:"match,omitempty"`
			Providers *[]struct {
					...
					"tracing": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"enable_istio_tags": schema.BoolAttribute{
									Description:         "Determines whether or not trace spans generated by Envoy will include Istio specific tags.",
									MarkdownDescription: "Determines whether or not trace spans generated by Envoy will include Istio specific tags.",
									Required:            false,
									Optional:            true,
									Computed:            false,
								},
