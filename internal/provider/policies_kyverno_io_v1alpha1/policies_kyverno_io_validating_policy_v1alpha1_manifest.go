...
var (
	_ datasource.DataSource = &PoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest{}
)

func NewPoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest() datasource.DataSource {
	return &PoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest{}
}

type PoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest struct{}

type PoliciesKyvernoIoValidatingPolicyV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Autogen *struct {
			...
			ValidatingAdmissionPolicy *struct {
				Enabled *bool `tfsdk:"enabled" json:"enabled,omitempty"`
			} `tfsdk:"validating_admission_policy" json:"validatingAdmissionPolicy,omitempty"`
...
func (r *PoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_policies_kyverno_io_validating_policy_v1alpha1_manifest"
}

func (r *PoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
				...
				Attributes: map[string]schema.Attribute{
					...
					"autogen": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"validating_admission_policy": schema.SingleNestedAttribute{
								Description:         "ValidatingAdmissionPolicy specifies whether to generate a Kubernetes ValidatingAdmissionPolicy.",
								MarkdownDescription: "ValidatingAdmissionPolicy specifies whether to generate a Kubernetes ValidatingAdmissionPolicy.",
								Attributes: map[string]schema.Attribute{
									"enabled": schema.BoolAttribute{
										Description:         "Enabled specifies whether to generate a Kubernetes ValidatingAdmissionPolicy. Optional. Defaults to 'false' if not specified.",
										MarkdownDescription: "Enabled specifies whether to generate a Kubernetes ValidatingAdmissionPolicy. Optional. Defaults to 'false' if not specified.",
										Required:            false,
										Optional:            true,
										Computed:            false,
									},
					...
					"match_constraints": schema.SingleNestedAttribute{
						Description:         "MatchConstraints specifies what resources this policy is designed to validate. The AdmissionPolicy cares about a request if it matches _all_ Constraints. Required.",
						MarkdownDescription: "MatchConstraints specifies what resources this policy is designed to validate. The AdmissionPolicy cares about a request if it matches _all_ Constraints. Required.",
						Attributes: map[string]schema.Attribute{
...
func (r *PoliciesKyvernoIoValidatingPolicyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_policies_kyverno_io_validating_policy_v1alpha1_manifest")

	var model PoliciesKyvernoIoValidatingPolicyV1Alpha1ManifestData
