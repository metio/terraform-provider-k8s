...
var (
	_ datasource.DataSource = &PoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest{}
)

func NewPoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest() datasource.DataSource {
	return &PoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest{}
}

type PoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest struct{}

type PoliciesKyvernoIoPolicyExceptionV1Alpha1ManifestData struct {
...
func (r *PoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_policies_kyverno_io_policy_exception_v1alpha1_manifest"
}

func (r *PoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"allowed_values": schema.ListAttribute{
						Description:         "AllowedValues specifies values that can be used in CEL expressions to bypass policy checks. These values can be referenced in CEL expressions via 'exceptions.allowedValues'.",
						MarkdownDescription: "AllowedValues specifies values that can be used in CEL expressions to bypass policy checks. These values can be referenced in CEL expressions via 'exceptions.allowedValues'.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
					...
					"images": schema.ListAttribute{
						Description:         "Images specifies container images to be excluded from policy evaluation. These excluded images can be referenced in CEL expressions via 'exceptions.allowedImages'.",
						MarkdownDescription: "Images specifies container images to be excluded from policy evaluation. These excluded images can be referenced in CEL expressions via 'exceptions.allowedImages'.",
						ElementType:         types.StringType,
						Required:            false,
						Optional:            true,
						Computed:            false,
...
func (r *PoliciesKyvernoIoPolicyExceptionV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_policies_kyverno_io_policy_exception_v1alpha1_manifest")

	var model PoliciesKyvernoIoPolicyExceptionV1Alpha1ManifestData
