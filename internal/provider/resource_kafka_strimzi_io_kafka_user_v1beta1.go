...
var (
	_ resource.Resource = (*KafkaStrimziIoKafkaUserV1Beta1Resource)(nil)
)

type KafkaStrimziIoKafkaUserV1Beta1TerraformModel struct {
...
type KafkaStrimziIoKafkaUserV1Beta1GoModel struct {
...
func (r *KafkaStrimziIoKafkaUserV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kafka_strimzi_io_kafka_user_v1beta1"
}

func (r *KafkaStrimziIoKafkaUserV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description:         "",
		MarkdownDescription: "",
...
func (r *KafkaStrimziIoKafkaUserV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kafka_strimzi_io_kafka_user_v1beta1")

	var state KafkaStrimziIoKafkaUserV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KafkaStrimziIoKafkaUserV1Beta1GoModel
...
func (r *KafkaStrimziIoKafkaUserV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kafka_strimzi_io_kafka_user_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *KafkaStrimziIoKafkaUserV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *KafkaStrimziIoKafkaUserV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
