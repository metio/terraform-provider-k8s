...
var (
	_ datasource.DataSource              = &NotificationToolkitFluxcdIoProviderV1Beta1DataSource{}
	_ datasource.DataSourceWithConfigure = &NotificationToolkitFluxcdIoProviderV1Beta1DataSource{}
)

func NewNotificationToolkitFluxcdIoProviderV1Beta1DataSource() datasource.DataSource {
	return &NotificationToolkitFluxcdIoProviderV1Beta1DataSource{}
}

type NotificationToolkitFluxcdIoProviderV1Beta1DataSource struct {
	kubernetesClient dynamic.Interface
}

type NotificationToolkitFluxcdIoProviderV1Beta1DataSourceData struct {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_notification_toolkit_fluxcd_io_provider_v1beta1"
}

func (r *NotificationToolkitFluxcdIoProviderV1Beta1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *NotificationToolkitFluxcdIoProviderV1Beta1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_notification_toolkit_fluxcd_io_provider_v1beta1")

	var data NotificationToolkitFluxcdIoProviderV1Beta1DataSourceData
	...
	var readResponse NotificationToolkitFluxcdIoProviderV1Beta1DataSourceData
