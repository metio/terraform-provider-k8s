...
var (
	_ resource.Resource = (*AppsClusternetIoFeedInventoryV1Alpha1Resource)(nil)
)

type AppsClusternetIoFeedInventoryV1Alpha1TerraformModel struct {
...
type AppsClusternetIoFeedInventoryV1Alpha1GoModel struct {
	...
	Spec *struct {
		Feeds *[]struct {
			...
			DesiredReplicas *int64 `tfsdk:"desired_replicas" yaml:"desiredReplicas,omitempty"`
			...
			ReplicaJsonPath *string `tfsdk:"replica_json_path" yaml:"replicaJsonPath,omitempty"`
			...
			} `tfsdk:"replica_requirements" yaml:"replicaRequirements,omitempty"`
...
func (r *AppsClusternetIoFeedInventoryV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_apps_clusternet_io_feed_inventory_v1alpha1"
}

func (r *AppsClusternetIoFeedInventoryV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *AppsClusternetIoFeedInventoryV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_apps_clusternet_io_feed_inventory_v1alpha1")

	var state AppsClusternetIoFeedInventoryV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel AppsClusternetIoFeedInventoryV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("FeedInventory")
...
func (r *AppsClusternetIoFeedInventoryV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_apps_clusternet_io_feed_inventory_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *AppsClusternetIoFeedInventoryV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *AppsClusternetIoFeedInventoryV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
