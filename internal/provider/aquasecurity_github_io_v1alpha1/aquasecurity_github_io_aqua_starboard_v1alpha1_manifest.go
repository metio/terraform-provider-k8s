...
package aquasecurity_github_io_v1alpha1
...
var (
	_ datasource.DataSource = &AquasecurityGithubIoAquaStarboardV1Alpha1Manifest{}
)

func NewAquasecurityGithubIoAquaStarboardV1Alpha1Manifest() datasource.DataSource {
	return &AquasecurityGithubIoAquaStarboardV1Alpha1Manifest{}
}

type AquasecurityGithubIoAquaStarboardV1Alpha1Manifest struct{}

type AquasecurityGithubIoAquaStarboardV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Kube_enforcer_version               *string `tfsdk:"kube_enforcer_version" json:"kube_enforcer_version,omitempty"`
		...
		Operator_cluster_compliance_enabled *string `tfsdk:"operator_cluster_compliance_enabled" json:"operator_cluster_compliance_enabled,omitempty"`
		Registry                            *struct {
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_aquasecurity_github_io_aqua_starboard_v1alpha1_manifest"
}

func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"kube_enforcer_version": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            false,
						Optional:            true,
					...
					"operator_cluster_compliance_enabled": schema.StringAttribute{
						Description:         "",
						MarkdownDescription: "",
						Required:            true,
						Optional:            false,
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_aquasecurity_github_io_aqua_starboard_v1alpha1_manifest")

	var model AquasecurityGithubIoAquaStarboardV1Alpha1ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("aquasecurity.github.io/v1alpha1")
	model.Kind = pointer.String("AquaStarboard")
