...
var (
	_ datasource.DataSource              = &AquasecurityGithubIoAquaStarboardV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &AquasecurityGithubIoAquaStarboardV1Alpha1DataSource{}
)

func NewAquasecurityGithubIoAquaStarboardV1Alpha1DataSource() datasource.DataSource {
	return &AquasecurityGithubIoAquaStarboardV1Alpha1DataSource{}
}

type AquasecurityGithubIoAquaStarboardV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type AquasecurityGithubIoAquaStarboardV1Alpha1DataSourceData struct {
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_aquasecurity_github_io_aqua_starboard_v1alpha1"
}

func (r *AquasecurityGithubIoAquaStarboardV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *AquasecurityGithubIoAquaStarboardV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_aquasecurity_github_io_aqua_starboard_v1alpha1")

	var data AquasecurityGithubIoAquaStarboardV1Alpha1DataSourceData
	...
	var readResponse AquasecurityGithubIoAquaStarboardV1Alpha1DataSourceData
	...
	data.ApiVersion = pointer.String("aquasecurity.github.io/v1alpha1")
	data.Kind = pointer.String("AquaStarboard")
