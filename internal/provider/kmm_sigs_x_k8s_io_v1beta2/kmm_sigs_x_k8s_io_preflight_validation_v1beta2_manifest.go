...
package kmm_sigs_x_k8s_io_v1beta2
...
var (
	_ datasource.DataSource = &KmmSigsXK8SIoPreflightValidationV1Beta2Manifest{}
)

func NewKmmSigsXK8SIoPreflightValidationV1Beta2Manifest() datasource.DataSource {
	return &KmmSigsXK8SIoPreflightValidationV1Beta2Manifest{}
}

type KmmSigsXK8SIoPreflightValidationV1Beta2Manifest struct{}

type KmmSigsXK8SIoPreflightValidationV1Beta2ManifestData struct {
...
func (r *KmmSigsXK8SIoPreflightValidationV1Beta2Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kmm_sigs_x_k8s_io_preflight_validation_v1beta2_manifest"
}

func (r *KmmSigsXK8SIoPreflightValidationV1Beta2Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KmmSigsXK8SIoPreflightValidationV1Beta2Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kmm_sigs_x_k8s_io_preflight_validation_v1beta2_manifest")

	var model KmmSigsXK8SIoPreflightValidationV1Beta2ManifestData
	response.Diagnostics.Append(request.Config.Get(ctx, &model)...)
	if response.Diagnostics.HasError() {
		return
	}

	model.ApiVersion = pointer.String("kmm.sigs.x-k8s.io/v1beta2")
