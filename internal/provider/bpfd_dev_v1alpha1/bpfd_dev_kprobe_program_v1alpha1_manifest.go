...
var (
	_ datasource.DataSource = &BpfdDevKprobeProgramV1Alpha1Manifest{}
)

func NewBpfdDevKprobeProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfdDevKprobeProgramV1Alpha1Manifest{}
}

type BpfdDevKprobeProgramV1Alpha1Manifest struct{}

type BpfdDevKprobeProgramV1Alpha1ManifestData struct {
	...
	Spec *struct {
		...
		Func_names       *[]string          `tfsdk:"func_names" json:"func_names,omitempty"`
...
func (r *BpfdDevKprobeProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfd_dev_kprobe_program_v1alpha1_manifest"
}

func (r *BpfdDevKprobeProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			...
			"spec": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"func_names": schema.ListAttribute{
...
func (r *BpfdDevKprobeProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfd_dev_kprobe_program_v1alpha1_manifest")

	var model BpfdDevKprobeProgramV1Alpha1ManifestData
