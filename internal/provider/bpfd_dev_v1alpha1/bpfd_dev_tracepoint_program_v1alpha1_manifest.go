...
var (
	_ datasource.DataSource = &BpfdDevTracepointProgramV1Alpha1Manifest{}
)

func NewBpfdDevTracepointProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfdDevTracepointProgramV1Alpha1Manifest{}
}

type BpfdDevTracepointProgramV1Alpha1Manifest struct{}

type BpfdDevTracepointProgramV1Alpha1ManifestData struct {
...
func (r *BpfdDevTracepointProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfd_dev_tracepoint_program_v1alpha1_manifest"
}

func (r *BpfdDevTracepointProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BpfdDevTracepointProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfd_dev_tracepoint_program_v1alpha1_manifest")

	var model BpfdDevTracepointProgramV1Alpha1ManifestData
