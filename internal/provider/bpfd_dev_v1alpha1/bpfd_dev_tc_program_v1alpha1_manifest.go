...
var (
	_ datasource.DataSource = &BpfdDevTcProgramV1Alpha1Manifest{}
)

func NewBpfdDevTcProgramV1Alpha1Manifest() datasource.DataSource {
	return &BpfdDevTcProgramV1Alpha1Manifest{}
}

type BpfdDevTcProgramV1Alpha1Manifest struct{}

type BpfdDevTcProgramV1Alpha1ManifestData struct {
...
func (r *BpfdDevTcProgramV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_bpfd_dev_tc_program_v1alpha1_manifest"
}

func (r *BpfdDevTcProgramV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *BpfdDevTcProgramV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_bpfd_dev_tc_program_v1alpha1_manifest")

	var model BpfdDevTcProgramV1Alpha1ManifestData
