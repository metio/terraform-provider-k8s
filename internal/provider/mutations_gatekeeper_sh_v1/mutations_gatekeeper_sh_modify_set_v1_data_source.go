...
var (
	_ datasource.DataSource              = &MutationsGatekeeperShModifySetV1DataSource{}
	_ datasource.DataSourceWithConfigure = &MutationsGatekeeperShModifySetV1DataSource{}
)

func NewMutationsGatekeeperShModifySetV1DataSource() datasource.DataSource {
	return &MutationsGatekeeperShModifySetV1DataSource{}
}

type MutationsGatekeeperShModifySetV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MutationsGatekeeperShModifySetV1DataSourceData struct {
...
func (r *MutationsGatekeeperShModifySetV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_modify_set_v1"
}

func (r *MutationsGatekeeperShModifySetV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShModifySetV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MutationsGatekeeperShModifySetV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mutations_gatekeeper_sh_modify_set_v1")

	var data MutationsGatekeeperShModifySetV1DataSourceData
	...
	var readResponse MutationsGatekeeperShModifySetV1DataSourceData
