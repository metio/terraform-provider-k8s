...
var (
	_ datasource.DataSource              = &MutationsGatekeeperShAssignV1DataSource{}
	_ datasource.DataSourceWithConfigure = &MutationsGatekeeperShAssignV1DataSource{}
)

func NewMutationsGatekeeperShAssignV1DataSource() datasource.DataSource {
	return &MutationsGatekeeperShAssignV1DataSource{}
}

type MutationsGatekeeperShAssignV1DataSource struct {
	kubernetesClient dynamic.Interface
}

type MutationsGatekeeperShAssignV1DataSourceData struct {
...
func (r *MutationsGatekeeperShAssignV1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_v1"
}

func (r *MutationsGatekeeperShAssignV1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignV1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *MutationsGatekeeperShAssignV1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_mutations_gatekeeper_sh_assign_v1")

	var data MutationsGatekeeperShAssignV1DataSourceData
	...
	var readResponse MutationsGatekeeperShAssignV1DataSourceData
	...
	data.Kind = pointer.String("Assign")
