...
var (
	_ datasource.DataSource = &MutationsGatekeeperShAssignV1Manifest{}
)

func NewMutationsGatekeeperShAssignV1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShAssignV1Manifest{}
}
...
func (r *MutationsGatekeeperShAssignV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_v1_manifest"
}

func (r *MutationsGatekeeperShAssignV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_v1_manifest")

	var model MutationsGatekeeperShAssignV1ManifestData
