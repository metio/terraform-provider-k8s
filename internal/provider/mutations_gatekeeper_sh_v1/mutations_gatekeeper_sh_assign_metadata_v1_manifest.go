...
var (
	_ datasource.DataSource = &MutationsGatekeeperShAssignMetadataV1Manifest{}
)

func NewMutationsGatekeeperShAssignMetadataV1Manifest() datasource.DataSource {
	return &MutationsGatekeeperShAssignMetadataV1Manifest{}
}

type MutationsGatekeeperShAssignMetadataV1Manifest struct{}

type MutationsGatekeeperShAssignMetadataV1ManifestData struct {
...
func (r *MutationsGatekeeperShAssignMetadataV1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_mutations_gatekeeper_sh_assign_metadata_v1_manifest"
}

func (r *MutationsGatekeeperShAssignMetadataV1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *MutationsGatekeeperShAssignMetadataV1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_mutations_gatekeeper_sh_assign_metadata_v1_manifest")

	var model MutationsGatekeeperShAssignMetadataV1ManifestData
