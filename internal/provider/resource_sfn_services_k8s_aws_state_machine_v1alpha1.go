...
var (
	_ resource.Resource = (*SfnServicesK8SAwsStateMachineV1Alpha1Resource)(nil)
)

type SfnServicesK8SAwsStateMachineV1Alpha1TerraformModel struct {
...
type SfnServicesK8SAwsStateMachineV1Alpha1GoModel struct {
	...
	Spec *struct {
		Definition *string `tfsdk:"definition" yaml:"definition,omitempty"`

		LoggingConfiguration *struct {
			Destinations *[]struct {
				CloudWatchLogsLogGroup *struct {
					LogGroupARN *string `tfsdk:"log_group_arn" yaml:"logGroupARN,omitempty"`
				} `tfsdk:"cloud_watch_logs_log_group" yaml:"cloudWatchLogsLogGroup,omitempty"`
			} `tfsdk:"destinations" yaml:"destinations,omitempty"`

			IncludeExecutionData *bool `tfsdk:"include_execution_data" yaml:"includeExecutionData,omitempty"`

			Level *string `tfsdk:"level" yaml:"level,omitempty"`
		} `tfsdk:"logging_configuration" yaml:"loggingConfiguration,omitempty"`
		...
		} `tfsdk:"tracing_configuration" yaml:"tracingConfiguration,omitempty"`
...
func (r *SfnServicesK8SAwsStateMachineV1Alpha1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sfn_services_k8s_aws_state_machine_v1alpha1"
}

func (r *SfnServicesK8SAwsStateMachineV1Alpha1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *SfnServicesK8SAwsStateMachineV1Alpha1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_sfn_services_k8s_aws_state_machine_v1alpha1")

	var state SfnServicesK8SAwsStateMachineV1Alpha1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel SfnServicesK8SAwsStateMachineV1Alpha1GoModel
	...
	goModel.Kind = utilities.Ptr("StateMachine")
...
func (r *SfnServicesK8SAwsStateMachineV1Alpha1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_sfn_services_k8s_aws_state_machine_v1alpha1")
	// NO-OP: All data is already in Terraform state
}

func (r *SfnServicesK8SAwsStateMachineV1Alpha1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *SfnServicesK8SAwsStateMachineV1Alpha1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
