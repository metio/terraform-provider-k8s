...
var (
	_ resource.Resource = (*LokiGrafanaComRecordingRuleV1Beta1Resource)(nil)
)

type LokiGrafanaComRecordingRuleV1Beta1TerraformModel struct {
...
type LokiGrafanaComRecordingRuleV1Beta1GoModel struct {
...
func (r *LokiGrafanaComRecordingRuleV1Beta1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_loki_grafana_com_recording_rule_v1beta1"
}

func (r *LokiGrafanaComRecordingRuleV1Beta1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *LokiGrafanaComRecordingRuleV1Beta1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_loki_grafana_com_recording_rule_v1beta1")

	var state LokiGrafanaComRecordingRuleV1Beta1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel LokiGrafanaComRecordingRuleV1Beta1GoModel
	...
	goModel.Kind = utilities.Ptr("RecordingRule")
...
func (r *LokiGrafanaComRecordingRuleV1Beta1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_loki_grafana_com_recording_rule_v1beta1")
	// NO-OP: All data is already in Terraform state
}

func (r *LokiGrafanaComRecordingRuleV1Beta1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *LokiGrafanaComRecordingRuleV1Beta1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
