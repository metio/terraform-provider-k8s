...
var (
	_ resource.Resource = (*SchedulingK8SIoPriorityClassV1Resource)(nil)
)

type SchedulingK8SIoPriorityClassV1TerraformModel struct {
...
type SchedulingK8SIoPriorityClassV1GoModel struct {
	...
	GlobalDefault *bool `tfsdk:"global_default" yaml:"globalDefault,omitempty"`
...
func (r *SchedulingK8SIoPriorityClassV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_scheduling_k8s_io_priority_class_v1"
}

func (r *SchedulingK8SIoPriorityClassV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *SchedulingK8SIoPriorityClassV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_scheduling_k8s_io_priority_class_v1")

	var state SchedulingK8SIoPriorityClassV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel SchedulingK8SIoPriorityClassV1GoModel
...
func (r *SchedulingK8SIoPriorityClassV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_scheduling_k8s_io_priority_class_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *SchedulingK8SIoPriorityClassV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *SchedulingK8SIoPriorityClassV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
