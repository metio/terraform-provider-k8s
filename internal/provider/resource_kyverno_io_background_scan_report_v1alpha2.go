...
var (
	_ resource.Resource = (*KyvernoIoBackgroundScanReportV1Alpha2Resource)(nil)
)

type KyvernoIoBackgroundScanReportV1Alpha2TerraformModel struct {
...
type KyvernoIoBackgroundScanReportV1Alpha2GoModel struct {
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kyverno_io_background_scan_report_v1alpha2"
}

func (r *KyvernoIoBackgroundScanReportV1Alpha2Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_kyverno_io_background_scan_report_v1alpha2")

	var state KyvernoIoBackgroundScanReportV1Alpha2TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel KyvernoIoBackgroundScanReportV1Alpha2GoModel
	...
	goModel.Kind = utilities.Ptr("BackgroundScanReport")
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_kyverno_io_background_scan_report_v1alpha2")
	// NO-OP: All data is already in Terraform state
}

func (r *KyvernoIoBackgroundScanReportV1Alpha2Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *KyvernoIoBackgroundScanReportV1Alpha2Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
