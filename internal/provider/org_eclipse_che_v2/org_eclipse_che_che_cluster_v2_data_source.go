...
var (
	_ datasource.DataSource              = &OrgEclipseCheCheClusterV2DataSource{}
	_ datasource.DataSourceWithConfigure = &OrgEclipseCheCheClusterV2DataSource{}
)

func NewOrgEclipseCheCheClusterV2DataSource() datasource.DataSource {
	return &OrgEclipseCheCheClusterV2DataSource{}
}

type OrgEclipseCheCheClusterV2DataSource struct {
	kubernetesClient dynamic.Interface
}

type OrgEclipseCheCheClusterV2DataSourceData struct {
...
func (r *OrgEclipseCheCheClusterV2DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_org_eclipse_che_che_cluster_v2"
}

func (r *OrgEclipseCheCheClusterV2DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *OrgEclipseCheCheClusterV2DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *OrgEclipseCheCheClusterV2DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_org_eclipse_che_che_cluster_v2")

	var data OrgEclipseCheCheClusterV2DataSourceData
	...
	var readResponse OrgEclipseCheCheClusterV2DataSourceData
	...
	data.ApiVersion = pointer.String("org.eclipse.che/v2")
