...
var (
	_ datasource.DataSource = &KueueXK8SIoMultiKueueClusterV1Alpha1Manifest{}
)

func NewKueueXK8SIoMultiKueueClusterV1Alpha1Manifest() datasource.DataSource {
	return &KueueXK8SIoMultiKueueClusterV1Alpha1Manifest{}
}

type KueueXK8SIoMultiKueueClusterV1Alpha1Manifest struct{}

type KueueXK8SIoMultiKueueClusterV1Alpha1ManifestData struct {
...
func (r *KueueXK8SIoMultiKueueClusterV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_kueue_x_k8s_io_multi_kueue_cluster_v1alpha1_manifest"
}

func (r *KueueXK8SIoMultiKueueClusterV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *KueueXK8SIoMultiKueueClusterV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
