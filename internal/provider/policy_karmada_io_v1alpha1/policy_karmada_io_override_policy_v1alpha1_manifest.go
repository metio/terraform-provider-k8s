...
var (
	_ datasource.DataSource = &PolicyKarmadaIoOverridePolicyV1Alpha1Manifest{}
)

func NewPolicyKarmadaIoOverridePolicyV1Alpha1Manifest() datasource.DataSource {
	return &PolicyKarmadaIoOverridePolicyV1Alpha1Manifest{}
}
...
func (r *PolicyKarmadaIoOverridePolicyV1Alpha1Manifest) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_policy_karmada_io_override_policy_v1alpha1_manifest"
}

func (r *PolicyKarmadaIoOverridePolicyV1Alpha1Manifest) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PolicyKarmadaIoOverridePolicyV1Alpha1Manifest) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_policy_karmada_io_override_policy_v1alpha1_manifest")

	var model PolicyKarmadaIoOverridePolicyV1Alpha1ManifestData
