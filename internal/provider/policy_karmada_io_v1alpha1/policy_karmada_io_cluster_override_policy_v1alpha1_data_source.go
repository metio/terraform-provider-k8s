...
var (
	_ datasource.DataSource              = &PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource{}
)

func NewPolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource() datasource.DataSource {
	return &PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource{}
}

type PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSourceData struct {
...
func (r *PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_policy_karmada_io_cluster_override_policy_v1alpha1"
}

func (r *PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_policy_karmada_io_cluster_override_policy_v1alpha1")

	var data PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSourceData
	...
	var readResponse PolicyKarmadaIoClusterOverridePolicyV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("ClusterOverridePolicy")
