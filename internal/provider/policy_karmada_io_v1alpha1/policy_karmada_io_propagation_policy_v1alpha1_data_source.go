...
var (
	_ datasource.DataSource              = &PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource{}
	_ datasource.DataSourceWithConfigure = &PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource{}
)

func NewPolicyKarmadaIoPropagationPolicyV1Alpha1DataSource() datasource.DataSource {
	return &PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource{}
}

type PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource struct {
	kubernetesClient dynamic.Interface
}

type PolicyKarmadaIoPropagationPolicyV1Alpha1DataSourceData struct {
...
func (r *PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
	response.TypeName = request.ProviderTypeName + "_policy_karmada_io_propagation_policy_v1alpha1"
}

func (r *PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, response *datasource.SchemaResponse) {
...
func (r *PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource) Configure(_ context.Context, request datasource.ConfigureRequest, response *datasource.ConfigureResponse) {
...
func (r *PolicyKarmadaIoPropagationPolicyV1Alpha1DataSource) Read(ctx context.Context, request datasource.ReadRequest, response *datasource.ReadResponse) {
	tflog.Debug(ctx, "Read data source k8s_policy_karmada_io_propagation_policy_v1alpha1")

	var data PolicyKarmadaIoPropagationPolicyV1Alpha1DataSourceData
	...
	getResponse, err := r.kubernetesClient.
		Resource(k8sSchema.GroupVersionResource{Group: "policy.karmada.io", Version: "v1alpha1", Resource: "propagationpolicies"}).
	...
	var readResponse PolicyKarmadaIoPropagationPolicyV1Alpha1DataSourceData
	...
	data.Kind = pointer.String("PropagationPolicy")
