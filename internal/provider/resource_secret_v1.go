...
type SecretV1Resource struct{}

var (
	_ resource.Resource = (*SecretV1Resource)(nil)
)

type SecretV1TerraformModel struct {
...
type SecretV1GoModel struct {
	...
	StringData *map[string]string `tfsdk:"string_data" yaml:"stringData,omitempty"`

	Type *string `tfsdk:"type" yaml:"type,omitempty"`
}

func NewSecretV1Resource() resource.Resource {
	return &SecretV1Resource{}
}

func (r *SecretV1Resource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_secret_v1"
}

func (r *SecretV1Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (r *SecretV1Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	tflog.Debug(ctx, "Create resource k8s_secret_v1")

	var state SecretV1TerraformModel
	diags := req.Config.Get(ctx, &state)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
	var goModel SecretV1GoModel
	...
	goModel.Kind = utilities.Ptr("Secret")
...
func (r *SecretV1Resource) Read(ctx context.Context, _ resource.ReadRequest, _ *resource.ReadResponse) {
	tflog.Debug(ctx, "Read resource k8s_secret_v1")
	// NO-OP: All data is already in Terraform state
}

func (r *SecretV1Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	tflog.Debug(ctx, "Update resource k8s_secret_v1")
...
func (r *SecretV1Resource) Delete(ctx context.Context, _ resource.DeleteRequest, _ *resource.DeleteResponse) {
	tflog.Debug(ctx, "Delete resource k8s_secret_v1")
