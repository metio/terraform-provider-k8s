...
page_title: "k8s_fluentd_fluent_io_input_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "fluentd.fluent.io"
description: |-
  Input is the Schema for the inputs API
---

# k8s_fluentd_fluent_io_input_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_fluentd_fluent_io_input_v1alpha1_manifest" "example" {
  metadata = {
    name      = "some-name"
...
- `spec` (Attributes) InputSpec defines the desired state of Input (see [below for nested schema](#nestedatt--spec))
