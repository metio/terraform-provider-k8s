...
page_title: "k8s_crd_projectcalico_org_bgp_configuration_v1 Data Source - terraform-provider-k8s"
subcategory: "crd.projectcalico.org"
description: |-
  BGPConfiguration contains the configuration for any BGP routing.
---

# k8s_crd_projectcalico_org_bgp_configuration_v1 (Data Source)
