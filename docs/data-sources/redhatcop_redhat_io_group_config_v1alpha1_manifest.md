...
page_title: "k8s_redhatcop_redhat_io_group_config_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "redhatcop.redhat.io"
description: |-
  GroupConfig is the Schema for the groupconfigs API
---

# k8s_redhatcop_redhat_io_group_config_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_redhatcop_redhat_io_group_config_v1alpha1_manifest" "example" {
  metadata = {
    name = "some-name"
