...
page_title: "k8s_tf_tungsten_io_config_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "tf.tungsten.io"
description: |-
  Config is the Schema for the configs API.
---

# k8s_tf_tungsten_io_config_v1alpha1_manifest (Data Source)
...
- `spec` (Attributes) ConfigSpec is the Spec for the Config API. (see [below for nested schema](#nestedatt--spec))
...
- `service_configuration` (Attributes) ConfigConfiguration is the Spec for the Config API. (see [below for nested schema](#nestedatt--spec--service_configuration))
...
- `linklocal_service_config` (Attributes) LinklocalServiceConfig is the Spec for link local coniguration (see [below for nested schema](#nestedatt--spec--service_configuration--linklocal_service_config))
...
<a id="nestedatt--spec--service_configuration--linklocal_service_config"></a>
### Nested Schema for `spec.service_configuration.linklocal_service_config`
