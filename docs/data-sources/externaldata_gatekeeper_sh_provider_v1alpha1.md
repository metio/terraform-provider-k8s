...
page_title: "k8s_externaldata_gatekeeper_sh_provider_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "externaldata.gatekeeper.sh"
description: |-
  Provider is the Schema for the Provider API
---

# k8s_externaldata_gatekeeper_sh_provider_v1alpha1 (Data Source)
