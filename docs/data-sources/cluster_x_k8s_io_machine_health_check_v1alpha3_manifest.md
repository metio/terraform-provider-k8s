...
page_title: "k8s_cluster_x_k8s_io_machine_health_check_v1alpha3_manifest Data Source - terraform-provider-k8s"
...
# k8s_cluster_x_k8s_io_machine_health_check_v1alpha3_manifest (Data Source)
...
```terraform
data "k8s_cluster_x_k8s_io_machine_health_check_v1alpha3_manifest" "example" {
  metadata = {
    name      = "some-name"
...
- `node_startup_timeout` (String) Machines older than this duration without a node will be considered to havefailed and will be remediated.
