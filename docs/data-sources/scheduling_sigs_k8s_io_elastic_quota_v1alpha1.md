...
page_title: "k8s_scheduling_sigs_k8s_io_elastic_quota_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "scheduling.sigs.k8s.io"
description: |-
  ElasticQuota sets elastic quota restrictions per namespace
---

# k8s_scheduling_sigs_k8s_io_elastic_quota_v1alpha1 (Data Source)
