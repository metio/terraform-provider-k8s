...
- `config_map` (Attributes) ConfigMap references an existing ConfigMap with the configuration file content. (see [below for nested schema](#nestedatt--spec--features--cspm--host_benchmarks--config_map))

<a id="nestedatt--spec--features--cspm--host_benchmarks--config_map"></a>
### Nested Schema for `spec.features.cspm.host_benchmarks.config_map`

Optional:

- `items` (Attributes List) Items maps a ConfigMap data 'key' to a file 'path' mount. (see [below for nested schema](#nestedatt--spec--features--cspm--host_benchmarks--config_map--items))
- `name` (String) Name is the name of the ConfigMap.

<a id="nestedatt--spec--features--cspm--host_benchmarks--config_map--items"></a>
### Nested Schema for `spec.features.cspm.host_benchmarks.config_map.items`
...
- `config_data` (String) ConfigData corresponds to the configuration file content.
- `config_map` (Attributes) ConfigMap references an existing ConfigMap with the configuration file content. (see [below for nested schema](#nestedatt--spec--features--cws--syscall_monitor_enabled--config_map))

<a id="nestedatt--spec--features--cws--syscall_monitor_enabled--config_map"></a>
### Nested Schema for `spec.features.cws.syscall_monitor_enabled.config_map`

Optional:

- `items` (Attributes List) Items maps a ConfigMap data 'key' to a file 'path' mount. (see [below for nested schema](#nestedatt--spec--features--cws--syscall_monitor_enabled--config_map--items))
- `name` (String) Name is the name of the ConfigMap.

<a id="nestedatt--spec--features--cws--syscall_monitor_enabled--config_map--items"></a>
### Nested Schema for `spec.features.cws.syscall_monitor_enabled.config_map.items`
...
- `config_data` (String) ConfigData corresponds to the configuration file content.
- `config_map` (Attributes) ConfigMap references an existing ConfigMap with the configuration file content. (see [below for nested schema](#nestedatt--spec--features--dogstatsd--unix_domain_socket_config--config_map))

<a id="nestedatt--spec--features--dogstatsd--unix_domain_socket_config--config_map"></a>
### Nested Schema for `spec.features.dogstatsd.unix_domain_socket_config.config_map`

Optional:

- `items` (Attributes List) Items maps a ConfigMap data 'key' to a file 'path' mount. (see [below for nested schema](#nestedatt--spec--features--dogstatsd--unix_domain_socket_config--config_map--items))
- `name` (String) Name is the name of the ConfigMap.

<a id="nestedatt--spec--features--dogstatsd--unix_domain_socket_config--config_map--items"></a>
### Nested Schema for `spec.features.dogstatsd.unix_domain_socket_config.config_map.items`
...
- `credentials` (Attributes) Credentials defines the Datadog credentials used to submit data to/query data from Datadog. (see [below for nested schema](#nestedatt--spec--features--external_metrics_server--wpa_controller--credentials))
- `url` (String) URL defines the endpoint URL.

<a id="nestedatt--spec--features--external_metrics_server--wpa_controller--credentials"></a>
### Nested Schema for `spec.features.external_metrics_server.wpa_controller.credentials`

Optional:

- `api_key` (String) APIKey configures your Datadog API key. See also: https://app.datadoghq.com/account/settings#agent/kubernetes
- `api_secret` (Attributes) APISecret references an existing Secret which stores the API key instead of creating a new one. If set, this parameter takes precedence over 'APIKey'. (see [below for nested schema](#nestedatt--spec--features--external_metrics_server--wpa_controller--credentials--api_secret))
...
- `app_secret` (Attributes) AppSecret references an existing Secret which stores the application key instead of creating a new one. If set, this parameter takes precedence over 'AppKey'. (see [below for nested schema](#nestedatt--spec--features--external_metrics_server--wpa_controller--credentials--app_secret))

<a id="nestedatt--spec--features--external_metrics_server--wpa_controller--credentials--api_secret"></a>
### Nested Schema for `spec.features.external_metrics_server.wpa_controller.credentials.api_secret`
...
<a id="nestedatt--spec--features--external_metrics_server--wpa_controller--credentials--app_secret"></a>
### Nested Schema for `spec.features.external_metrics_server.wpa_controller.credentials.app_secret`
...
- `config_data` (String) ConfigData corresponds to the configuration file content.
- `config_map` (Attributes) ConfigMap references an existing ConfigMap with the configuration file content. (see [below for nested schema](#nestedatt--spec--features--kube_state_metrics_core--enabled--config_map))
...
- `items` (Attributes List) Items maps a ConfigMap data 'key' to a file 'path' mount. (see [below for nested schema](#nestedatt--spec--features--kube_state_metrics_core--enabled--config_map--items))
- `name` (String) Name is the name of the ConfigMap.

<a id="nestedatt--spec--features--kube_state_metrics_core--enabled--config_map--items"></a>
### Nested Schema for `spec.features.kube_state_metrics_core.enabled.config_map.items`
...
- `config_data` (String) ConfigData corresponds to the configuration file content.
- `config_map` (Attributes) ConfigMap references an existing ConfigMap with the configuration file content. (see [below for nested schema](#nestedatt--spec--features--orchestrator_explorer--scrub_containers--config_map))

<a id="nestedatt--spec--features--orchestrator_explorer--scrub_containers--config_map"></a>
### Nested Schema for `spec.features.orchestrator_explorer.scrub_containers.config_map`

Optional:

- `items` (Attributes List) Items maps a ConfigMap data 'key' to a file 'path' mount. (see [below for nested schema](#nestedatt--spec--features--orchestrator_explorer--scrub_containers--config_map--items))
- `name` (String) Name is the name of the ConfigMap.

<a id="nestedatt--spec--features--orchestrator_explorer--scrub_containers--config_map--items"></a>
### Nested Schema for `spec.features.orchestrator_explorer.scrub_containers.config_map.items`
...
- `api_key` (String) APIKey configures your Datadog API key. See also: https://app.datadoghq.com/account/settings#agent/kubernetes
- `api_secret` (Attributes) APISecret references an existing Secret which stores the API key instead of creating a new one. If set, this parameter takes precedence over 'APIKey'. (see [below for nested schema](#nestedatt--spec--global--endpoint--url--api_secret))
- `app_key` (String) AppKey configures your Datadog application key. If you are using features.externalMetricsServer.enabled = true, you must set a Datadog application key for read access to your metrics.
- `app_secret` (Attributes) AppSecret references an existing Secret which stores the application key instead of creating a new one. If set, this parameter takes precedence over 'AppKey'. (see [below for nested schema](#nestedatt--spec--global--endpoint--url--app_secret))

<a id="nestedatt--spec--global--endpoint--url--api_secret"></a>
### Nested Schema for `spec.global.endpoint.url.api_secret`
...
<a id="nestedatt--spec--global--endpoint--url--app_secret"></a>
### Nested Schema for `spec.global.endpoint.url.app_secret`
...
- `config_map_key_ref` (Attributes) Selects a key of a ConfigMap. (see [below for nested schema](#nestedatt--spec--global--kubelet--tls_verify--config_map_key_ref))
- `field_ref` (Attributes) Selects a field of the pod: supports metadata.name, metadata.namespace, 'metadata.labels['<KEY>']', 'metadata.annotations['<KEY>']', spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs. (see [below for nested schema](#nestedatt--spec--global--kubelet--tls_verify--field_ref))
- `resource_field_ref` (Attributes) Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported. (see [below for nested schema](#nestedatt--spec--global--kubelet--tls_verify--resource_field_ref))
- `secret_key_ref` (Attributes) Selects a key of a secret in the pod's namespace (see [below for nested schema](#nestedatt--spec--global--kubelet--tls_verify--secret_key_ref))

<a id="nestedatt--spec--global--kubelet--tls_verify--config_map_key_ref"></a>
### Nested Schema for `spec.global.kubelet.tls_verify.config_map_key_ref`
...
<a id="nestedatt--spec--global--kubelet--tls_verify--field_ref"></a>
### Nested Schema for `spec.global.kubelet.tls_verify.field_ref`
...
<a id="nestedatt--spec--global--kubelet--tls_verify--resource_field_ref"></a>
### Nested Schema for `spec.global.kubelet.tls_verify.resource_field_ref`
...
<a id="nestedatt--spec--global--kubelet--tls_verify--secret_key_ref"></a>
### Nested Schema for `spec.global.kubelet.tls_verify.secret_key_ref`
...
- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--global--network_policy--flavor--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--global--network_policy--flavor--match_expressions"></a>
### Nested Schema for `spec.global.network_policy.flavor.match_expressions`
...
- `preference` (Attributes) A node selector term, associated with the corresponding weight. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--preference))
- `weight` (Number) Weight associated with matching the corresponding nodeSelectorTerm, in the range 1-100.

<a id="nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--preference"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.preference`

Optional:

- `match_expressions` (Attributes List) A list of node selector requirements by node's labels. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--match_expressions))
- `match_fields` (Attributes List) A list of node selector requirements by node's fields. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--match_fields))

<a id="nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--match_expressions"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.weight.match_expressions`
...
<a id="nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--match_fields"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.weight.match_fields`
...
- `node_selector_terms` (Attributes List) Required. A list of node selector terms. The terms are ORed. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms))

<a id="nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms`

Optional:

- `match_expressions` (Attributes List) A list of node selector requirements by node's labels. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions))
- `match_fields` (Attributes List) A list of node selector requirements by node's fields. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields))

<a id="nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_expressions`
...
<a id="nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_fields`
...
- `label_selector` (Attributes) A label query over a set of resources, in this case pods. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--label_selector))
...
<a id="nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--label_selector"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.weight.label_selector`

Optional:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--namespaces--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--namespaces--match_expressions"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.weight.namespaces.match_expressions`
...
<a id="nestedatt--spec--override--affinity--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution--weight--namespace_selector"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.preferred_during_scheduling_ignored_during_execution.weight.namespace_selector`
...
- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--override--affinity--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions"></a>
### Nested Schema for `spec.override.affinity.pod_anti_affinity.required_during_scheduling_ignored_during_execution.namespaces.match_expressions`
...
- `value_from` (Attributes) Source for the environment variable's value. Cannot be used if value is not empty. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--value_from))

<a id="nestedatt--spec--override--containers--volume_mounts--value_from"></a>
### Nested Schema for `spec.override.containers.volume_mounts.value_from`

Optional:

- `config_map_key_ref` (Attributes) Selects a key of a ConfigMap. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--value_from--config_map_key_ref))
- `field_ref` (Attributes) Selects a field of the pod: supports metadata.name, metadata.namespace, 'metadata.labels['<KEY>']', 'metadata.annotations['<KEY>']', spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--value_from--field_ref))
- `resource_field_ref` (Attributes) Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--value_from--resource_field_ref))
- `secret_key_ref` (Attributes) Selects a key of a secret in the pod's namespace (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--value_from--secret_key_ref))

<a id="nestedatt--spec--override--containers--volume_mounts--value_from--config_map_key_ref"></a>
### Nested Schema for `spec.override.containers.volume_mounts.value_from.config_map_key_ref`
...
<a id="nestedatt--spec--override--containers--volume_mounts--value_from--field_ref"></a>
### Nested Schema for `spec.override.containers.volume_mounts.value_from.field_ref`
...
<a id="nestedatt--spec--override--containers--volume_mounts--value_from--resource_field_ref"></a>
### Nested Schema for `spec.override.containers.volume_mounts.value_from.resource_field_ref`
...
<a id="nestedatt--spec--override--containers--volume_mounts--value_from--secret_key_ref"></a>
### Nested Schema for `spec.override.containers.volume_mounts.value_from.secret_key_ref`
...
- `exec` (Attributes) Exec specifies the action to take. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--exec))
...
- `grpc` (Attributes) GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--grpc))
- `http_get` (Attributes) HTTPGet specifies the http request to perform. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--http_get))
...
- `tcp_socket` (Attributes) TCPSocket specifies an action involving a TCP port. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--tcp_socket))
...
<a id="nestedatt--spec--override--containers--volume_mounts--exec"></a>
### Nested Schema for `spec.override.containers.volume_mounts.exec`
...
<a id="nestedatt--spec--override--containers--volume_mounts--grpc"></a>
### Nested Schema for `spec.override.containers.volume_mounts.grpc`
...
<a id="nestedatt--spec--override--containers--volume_mounts--http_get"></a>
### Nested Schema for `spec.override.containers.volume_mounts.http_get`
...
- `http_headers` (Attributes List) Custom headers to set in the request. HTTP allows repeated headers. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--http_get--http_headers))
- `path` (String) Path to access on the HTTP server.
- `scheme` (String) Scheme to use for connecting to the host. Defaults to HTTP.

<a id="nestedatt--spec--override--containers--volume_mounts--http_get--http_headers"></a>
### Nested Schema for `spec.override.containers.volume_mounts.http_get.http_headers`
...
<a id="nestedatt--spec--override--containers--volume_mounts--tcp_socket"></a>
### Nested Schema for `spec.override.containers.volume_mounts.tcp_socket`
...
- `custom_profile` (Attributes) CustomProfile specifies a ConfigMap containing a custom Seccomp Profile. ConfigMap data must either have the key 'system-probe-seccomp.json' or CustomProfile.Items must include a corev1.KeytoPath that maps the key to the path 'system-probe-seccomp.json'. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--custom_profile))
- `custom_root_path` (String) CustomRootPath specifies a custom Seccomp Profile root location.

<a id="nestedatt--spec--override--containers--volume_mounts--custom_profile"></a>
### Nested Schema for `spec.override.containers.volume_mounts.custom_profile`

Optional:

- `config_data` (String) ConfigData corresponds to the configuration file content.
- `config_map` (Attributes) ConfigMap references an existing ConfigMap with the configuration file content. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--custom_profile--config_map))

<a id="nestedatt--spec--override--containers--volume_mounts--custom_profile--config_map"></a>
### Nested Schema for `spec.override.containers.volume_mounts.custom_profile.config_map`

Optional:

- `items` (Attributes List) Items maps a ConfigMap data 'key' to a file 'path' mount. (see [below for nested schema](#nestedatt--spec--override--containers--volume_mounts--custom_profile--config_map--items))
- `name` (String) Name is the name of the ConfigMap.

<a id="nestedatt--spec--override--containers--volume_mounts--custom_profile--config_map--items"></a>
### Nested Schema for `spec.override.containers.volume_mounts.custom_profile.config_map.items`
...
<a id="nestedatt--spec--override--containers--volume_mounts--se_linux_options"></a>
### Nested Schema for `spec.override.containers.volume_mounts.se_linux_options`
...
<a id="nestedatt--spec--override--containers--volume_mounts--seccomp_profile"></a>
### Nested Schema for `spec.override.containers.volume_mounts.seccomp_profile`
...
<a id="nestedatt--spec--override--containers--volume_mounts--windows_options"></a>
### Nested Schema for `spec.override.containers.volume_mounts.windows_options`
...
- `secret_ref` (Attributes) Optional: SecretRef is reference to the authentication secret for User, default is empty. More info: https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--secret_ref))
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--secret_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.secret_ref`
...
- `secret_ref` (Attributes) Optional: points to a secret object containing parameters used to connect to OpenStack. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--secret_ref))
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--node_publish_secret_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.node_publish_secret_ref`
...
- `items` (Attributes List) Items is a list of downward API volume file (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--items))
...
- `field_ref` (Attributes) Required: Selects a field of the pod: only annotations, labels, name and namespace are supported. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--items--field_ref))
- `mode` (Number) Optional: mode bits used to set permissions on this file, must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. If not specified, the volume defaultMode will be used. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.
- `resource_field_ref` (Attributes) Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--items--resource_field_ref))

<a id="nestedatt--spec--override--volumes--vsphere_volume--items--field_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.items.field_ref`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--items--resource_field_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.items.resource_field_ref`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--spec"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.volume_claim_template.spec`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--metadata--data_source"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.volume_claim_template.metadata.data_source`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--metadata--data_source_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.volume_claim_template.metadata.data_source_ref`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--metadata--resources"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.volume_claim_template.metadata.resources`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--metadata--selector"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.volume_claim_template.metadata.selector`

Optional:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--metadata--volume_name--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--override--volumes--vsphere_volume--volume_claim_template--metadata--volume_name--match_expressions"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.volume_claim_template.metadata.volume_name.match_expressions`
...
- `secret_ref` (Attributes) CHAP Secret for iSCSI target and initiator authentication (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--secret_ref))
...
- `sources` (Attributes List) list of volume projections (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources))

<a id="nestedatt--spec--override--volumes--vsphere_volume--sources"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources`

Optional:

- `config_map` (Attributes) information about the configMap data to project (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--config_map))
- `downward_api` (Attributes) information about the downwardAPI data to project (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--downward_api))
- `secret` (Attributes) information about the secret data to project (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--secret))
- `service_account_token` (Attributes) information about the serviceAccountToken data to project (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token))

<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--config_map"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.config_map`

Optional:

- `items` (Attributes List) If unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the ConfigMap, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items))
- `name` (String) Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?
- `optional` (Boolean) Specify whether the ConfigMap or its keys must be defined

<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.service_account_token.items`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--downward_api"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.downward_api`

Optional:

- `items` (Attributes List) Items is a list of DownwardAPIVolume file (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items))
...
- `field_ref` (Attributes) Required: Selects a field of the pod: only annotations, labels, name and namespace are supported. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items--field_ref))
- `mode` (Number) Optional: mode bits used to set permissions on this file, must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. If not specified, the volume defaultMode will be used. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.
- `resource_field_ref` (Attributes) Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items--resource_field_ref))

<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items--field_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.service_account_token.items.field_ref`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token--items--resource_field_ref"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.service_account_token.items.resource_field_ref`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--secret"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.secret`
...
<a id="nestedatt--spec--override--volumes--vsphere_volume--sources--service_account_token"></a>
### Nested Schema for `spec.override.volumes.vsphere_volume.sources.service_account_token`
...
- `secret_ref` (Attributes) SecretRef is name of the authentication secret for RBDUser. If provided overrides keyring. Default is nil. More info: https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--secret_ref))
...
- `secret_ref` (Attributes) SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--secret_ref))
...
- `fs_type` (String) Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. 'ext4', 'xfs', 'ntfs'. Implicitly inferred to be 'ext4' if unspecified.
- `read_only` (Boolean) Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
- `secret_ref` (Attributes) SecretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted. (see [below for nested schema](#nestedatt--spec--override--volumes--vsphere_volume--secret_ref))
