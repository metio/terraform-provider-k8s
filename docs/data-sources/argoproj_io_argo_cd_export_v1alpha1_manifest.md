...
page_title: "k8s_argoproj_io_argo_cd_export_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "argoproj.io"
description: |-
  ArgoCDExport is the Schema for the argocdexports API
---

# k8s_argoproj_io_argo_cd_export_v1alpha1_manifest (Data Source)
...
- `selector` (Attributes) selector is a label query over volumes to consider for binding. (see [below for nested schema](#nestedatt--spec--storage--pvc--selector))
