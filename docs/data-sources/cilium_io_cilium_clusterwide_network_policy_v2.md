...
page_title: "k8s_cilium_io_cilium_clusterwide_network_policy_v2 Data Source - terraform-provider-k8s"
...
# k8s_cilium_io_cilium_clusterwide_network_policy_v2 (Data Source)
