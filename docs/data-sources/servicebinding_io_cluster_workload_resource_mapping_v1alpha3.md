...
page_title: "k8s_servicebinding_io_cluster_workload_resource_mapping_v1alpha3 Data Source - terraform-provider-k8s"
subcategory: "servicebinding.io"
description: |-
  ClusterWorkloadResourceMapping is the Schema for the clusterworkloadresourcemappings API
---

# k8s_servicebinding_io_cluster_workload_resource_mapping_v1alpha3 (Data Source)
