...
page_title: "k8s_bpfd_dev_kprobe_program_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "bpfd.dev"
description: |-
  KprobeProgram is the Schema for the KprobePrograms API
---

# k8s_bpfd_dev_kprobe_program_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_bpfd_dev_kprobe_program_v1alpha1_manifest" "example" {
  metadata = {
    name = "some-name"
...
- `func_names` (List of String) Functions to attach the kprobe to.
