...
page_title: "k8s_infrastructure_cluster_x_k8s_io_v_sphere_cluster_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  VSphereCluster is the Schema for the vsphereclusters API
---

# k8s_infrastructure_cluster_x_k8s_io_v_sphere_cluster_v1beta1 (Data Source)
...
- `cluster_modules` (Attributes List) ClusterModules hosts information regarding the anti-affinity vSphere constructs for each of the objects responsible for creation of VM objects belonging to the cluster. (see [below for nested schema](#nestedatt--spec--cluster_modules))
...
<a id="nestedatt--spec--cluster_modules"></a>
### Nested Schema for `spec.cluster_modules`
...
<a id="nestedatt--spec--failure_domain_selector"></a>
### Nested Schema for `spec.failure_domain_selector`

Read-Only:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--failure_domain_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--failure_domain_selector--match_expressions"></a>
### Nested Schema for `spec.failure_domain_selector.match_expressions`
