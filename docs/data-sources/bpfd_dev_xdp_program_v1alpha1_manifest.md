...
page_title: "k8s_bpfd_dev_xdp_program_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "bpfd.dev"
description: |-
  XdpProgram is the Schema for the XdpPrograms API
---

# k8s_bpfd_dev_xdp_program_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_bpfd_dev_xdp_program_v1alpha1_manifest" "example" {
  metadata = {
    name = "some-name"
