...
page_title: "k8s_kyverno_io_cluster_policy_v1 Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  ClusterPolicy declares validation, mutation, and generation behaviors for matching resources.
---

# k8s_kyverno_io_cluster_policy_v1 (Data Source)
...
```terraform
data "k8s_kyverno_io_cluster_policy_v1" "example" {
  metadata = {
    name = "some-name"
