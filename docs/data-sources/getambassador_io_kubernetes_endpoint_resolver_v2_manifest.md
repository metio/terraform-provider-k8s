...
page_title: "k8s_getambassador_io_kubernetes_endpoint_resolver_v2_manifest Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  KubernetesEndpointResolver is the Schema for the kubernetesendpointresolver API
---

# k8s_getambassador_io_kubernetes_endpoint_resolver_v2_manifest (Data Source)
...
```terraform
data "k8s_getambassador_io_kubernetes_endpoint_resolver_v2_manifest" "example" {
  metadata = {
    name      = "some-name"
