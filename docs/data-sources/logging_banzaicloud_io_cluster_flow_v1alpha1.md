...
page_title: "k8s_logging_banzaicloud_io_cluster_flow_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "logging.banzaicloud.io"
description: |-
  
---

# k8s_logging_banzaicloud_io_cluster_flow_v1alpha1 (Data Source)
...
```terraform
data "k8s_logging_banzaicloud_io_cluster_flow_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
