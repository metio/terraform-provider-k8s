...
page_title: "k8s_kyverno_io_cluster_admission_report_v2_manifest Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  ClusterAdmissionReport is the Schema for the ClusterAdmissionReports API
---

# k8s_kyverno_io_cluster_admission_report_v2_manifest (Data Source)
