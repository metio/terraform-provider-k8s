...
page_title: "k8s_rc_app_stacks_runtime_component_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "rc.app.stacks"
description: |-
  Represents the deployment of a runtime component
---

# k8s_rc_app_stacks_runtime_component_v1_manifest (Data Source)
...
- `manage_tls` (Boolean) Enable management of TLS certificates. Defaults to true.
- `monitoring` (Attributes) Specifies parameters for Service Monitor. (see [below for nested schema](#nestedatt--spec--monitoring))
- `network_policy` (Attributes) Defines the network policy (see [below for nested schema](#nestedatt--spec--network_policy))
...
- `replicas` (Number) Number of pods to create. Defaults to 1. Not applicable when .spec.autoscaling or .spec.createKnativeService is specified.
...
- `security_context` (Attributes) Security context for the application container. (see [below for nested schema](#nestedatt--spec--security_context))
...
- `service_account` (Attributes) The service account to use for deploying the application. A service account is automatically created if this is not specifed. (see [below for nested schema](#nestedatt--spec--service_account))
...
- `basic_auth` (Attributes) BasicAuth allow an endpoint to authenticate over basic authentication More info: https://prometheus.io/docs/operating/configuration/#endpoints (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--basic_auth))
- `bearer_token_file` (String) File to read bearer token for scraping targets.
- `bearer_token_secret` (Attributes) Secret to mount to read bearer token for scraping targets. The secret needs to be in the same namespace as the service monitor and accessible by the Prometheus Operator. (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--bearer_token_secret))
...
- `credentials` (Attributes) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--tls_config--credentials))
- `type` (String) Set the authentication type. Defaults to Bearer, Basic will cause an error

<a id="nestedatt--spec--monitoring--endpoints--tls_config--credentials"></a>
### Nested Schema for `spec.monitoring.endpoints.tls_config.credentials`
...
- `password` (Attributes) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--tls_config--password))
- `username` (Attributes) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--tls_config--username))

<a id="nestedatt--spec--monitoring--endpoints--tls_config--password"></a>
### Nested Schema for `spec.monitoring.endpoints.tls_config.password`
...
<a id="nestedatt--spec--monitoring--endpoints--tls_config--username"></a>
### Nested Schema for `spec.monitoring.endpoints.tls_config.username`
...
- `client_id` (Attributes) The secret or configmap containing the OAuth2 client id (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--tls_config--client_id))
- `client_secret` (Attributes) The secret containing the OAuth2 client secret (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--tls_config--client_secret))
...
<a id="nestedatt--spec--monitoring--endpoints--tls_config--client_id"></a>
### Nested Schema for `spec.monitoring.endpoints.tls_config.client_id`

Optional:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--monitoring--endpoints--tls_config--client_id--config_map))
...
<a id="nestedatt--spec--monitoring--endpoints--tls_config--client_id--secret"></a>
...
<a id="nestedatt--spec--monitoring--endpoints--tls_config--client_secret"></a>
### Nested Schema for `spec.monitoring.endpoints.tls_config.client_secret`
...
- `disable` (Boolean) Disable the creation of the network policy. Defaults to false.
- `from_labels` (Map of String) Specify the labels of pod(s) that incoming traffic is allowed from.
- `namespace_labels` (Map of String) Specify the labels of namespaces that incoming traffic is allowed from.
...
- `host` (String) Host name to connect to, defaults to the pod IP. You probably want to set 'Host' in httpHeaders instead.
- `http_headers` (Attributes List) Custom headers to set in the request. HTTP allows repeated headers. (see [below for nested schema](#nestedatt--spec--probes--liveness--timeout_seconds--http_headers))
- `path` (String) Path to access on the HTTP server.
- `scheme` (String) Scheme to use for connecting to the host. Defaults to HTTP.

<a id="nestedatt--spec--probes--liveness--timeout_seconds--http_headers"></a>
### Nested Schema for `spec.probes.liveness.timeout_seconds.http_headers`
...
- `host` (String) Host name to connect to, defaults to the pod IP. You probably want to set 'Host' in httpHeaders instead.
- `http_headers` (Attributes List) Custom headers to set in the request. HTTP allows repeated headers. (see [below for nested schema](#nestedatt--spec--probes--readiness--timeout_seconds--http_headers))
- `path` (String) Path to access on the HTTP server.
- `scheme` (String) Scheme to use for connecting to the host. Defaults to HTTP.

<a id="nestedatt--spec--probes--readiness--timeout_seconds--http_headers"></a>
### Nested Schema for `spec.probes.readiness.timeout_seconds.http_headers`
...
<a id="nestedatt--spec--probes--startup"></a>
### Nested Schema for `spec.probes.startup`
...
- `period_seconds` (Number) How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1.
- `success_threshold` (Number) Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1.
- `tcp_socket` (Attributes) TCPSocket specifies an action involving a TCP port. (see [below for nested schema](#nestedatt--spec--probes--startup--tcp_socket))
- `termination_grace_period_seconds` (Number) Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.
- `timeout_seconds` (Number) Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
...
- `host` (String) Host name to connect to, defaults to the pod IP. You probably want to set 'Host' in httpHeaders instead.
- `http_headers` (Attributes List) Custom headers to set in the request. HTTP allows repeated headers. (see [below for nested schema](#nestedatt--spec--probes--startup--timeout_seconds--http_headers))
- `path` (String) Path to access on the HTTP server.
- `scheme` (String) Scheme to use for connecting to the host. Defaults to HTTP.

<a id="nestedatt--spec--probes--startup--timeout_seconds--http_headers"></a>
### Nested Schema for `spec.probes.startup.timeout_seconds.http_headers`
...
- `annotations` (Map of String) Annotations to be added to the Route.
- `certificate_secret_ref` (String) A name of a secret that already contains TLS key, certificate and CA to be used in the route. It can also contain destination CA certificate. The following keys are valid in the secret: ca.crt, destCA.crt, tls.crt, and tls.key.
- `host` (String) Hostname to be used for the Route.
- `insecure_edge_termination_policy` (String) HTTP traffic policy with TLS enabled. Can be one of Allow, Redirect and None.
- `path` (String) Path to be used for Route.
- `path_type` (String) Path type to be used for Ingress.
- `termination` (String) TLS termination policy. Can be one of edge, reencrypt and passthrough.
...
- `annotations` (Map of String) Annotations to be added to the service.
- `bindable` (Boolean) Expose the application as a bindable service. Defaults to false.
- `certificate` (Attributes) Configure service certificate. (see [below for nested schema](#nestedatt--spec--service--certificate))
- `certificate_secret_ref` (String) A name of a secret that already contains TLS key, certificate and CA to be mounted in the pod. The following keys are valid in the secret: ca.crt, tls.crt, and tls.key.
- `node_port` (Number) Node proxies this port into your service.
- `port` (Number) The port exposed by the container.
- `port_name` (String) The name for the port exposed by the container.
- `ports` (Attributes List) An array consisting of service ports. (see [below for nested schema](#nestedatt--spec--service--ports))
- `target_port` (Number) The port that the operator assigns to containers inside pods. Defaults to the value of .spec.service.port.
- `type` (String) Service Type string describes ingress methods for a service

<a id="nestedatt--spec--service--certificate"></a>
### Nested Schema for `spec.service.certificate`

Optional:

- `annotations` (Map of String) Annotations to be added to the service certificate.
...
- `mount_token` (Boolean) Whether the Service Account token should be mounted into the application pods. Defaults to true.
- `name` (String) Name of the service account to use for deploying the application. A service account is automatically created if it's not specified.
...
- `annotations` (Map of String) Annotations to be added only to the StatefulSet and resources owned by the StatefulSet.
- `storage` (Attributes) Defines settings of persisted storage for StatefulSets. (see [below for nested schema](#nestedatt--spec--stateful_set--storage))
- `update_strategy` (Attributes) Specifies the strategy to replace old statefulSet pods with new pods. (see [below for nested schema](#nestedatt--spec--stateful_set--update_strategy))

<a id="nestedatt--spec--stateful_set--storage"></a>
### Nested Schema for `spec.stateful_set.storage`

Optional:

- `class_name` (String) A convenient field to request the storage class of the persisted storage. The name can not be specified or updated after the storage is created.
- `mount_path` (String) The directory inside the container where this persisted storage will be bound to.
- `size` (String) A convenient field to set the size of the persisted storage.
- `volume_claim_template` (Attributes) A YAML object that represents a volumeClaimTemplate component of a StatefulSet. (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template))

<a id="nestedatt--spec--stateful_set--storage--volume_claim_template"></a>
### Nested Schema for `spec.stateful_set.storage.volume_claim_template`

Optional:

- `api_version` (String) APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
- `kind` (String) Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
- `metadata` (Attributes) Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template--metadata))
- `spec` (Attributes) spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template--spec))
- `status` (Attributes) status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template--status))

<a id="nestedatt--spec--stateful_set--storage--volume_claim_template--metadata"></a>
### Nested Schema for `spec.stateful_set.storage.volume_claim_template.metadata`
...
<a id="nestedatt--spec--stateful_set--storage--volume_claim_template--spec"></a>
### Nested Schema for `spec.stateful_set.storage.volume_claim_template.spec`
...
- `claims` (Attributes List) Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable. It can only be set for containers. (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template--spec--volume_name--claims))
- `limits` (Map of String) Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
- `requests` (Map of String) Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/

<a id="nestedatt--spec--stateful_set--storage--volume_claim_template--spec--volume_name--claims"></a>
### Nested Schema for `spec.stateful_set.storage.volume_claim_template.spec.volume_name.claims`
...
- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template--spec--volume_name--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.
...
<a id="nestedatt--spec--stateful_set--storage--volume_claim_template--status"></a>
### Nested Schema for `spec.stateful_set.storage.volume_claim_template.status`
...
- `conditions` (Attributes List) conditions is the current Condition of persistent volume claim. If underlying persistent volume is being resized then the Condition will be set to 'ResizeStarted'. (see [below for nested schema](#nestedatt--spec--stateful_set--storage--volume_claim_template--status--conditions))
...
<a id="nestedatt--spec--stateful_set--update_strategy"></a>
### Nested Schema for `spec.stateful_set.update_strategy`

Optional:

- `rolling_update` (Attributes) RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType. (see [below for nested schema](#nestedatt--spec--stateful_set--update_strategy--rolling_update))
...
- `constraints` (Attributes List) The list of TopologySpreadConstraints for the application pod. (see [below for nested schema](#nestedatt--spec--topology_spread_constraints--constraints))
- `disable_operator_defaults` (Boolean) Whether the operator should disable its default set of TopologySpreadConstraints. Defaults to false.

<a id="nestedatt--spec--topology_spread_constraints--constraints"></a>
### Nested Schema for `spec.topology_spread_constraints.constraints`
...
- `label_selector` (Attributes) LabelSelector is used to find matching pods. Pods that match this label selector are counted to determine the number of pods in their corresponding topology domain. (see [below for nested schema](#nestedatt--spec--topology_spread_constraints--constraints--label_selector))
...
<a id="nestedatt--spec--topology_spread_constraints--constraints--label_selector"></a>
### Nested Schema for `spec.topology_spread_constraints.constraints.label_selector`

Optional:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--topology_spread_constraints--constraints--node_taints_policy--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--topology_spread_constraints--constraints--node_taints_policy--match_expressions"></a>
### Nested Schema for `spec.topology_spread_constraints.constraints.node_taints_policy.match_expressions`
