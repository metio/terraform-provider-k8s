...
page_title: "k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_template_v1alpha3 Data Source - terraform-provider-k8s"
...
# k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_template_v1alpha3 (Data Source)
...
```terraform
data "k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_template_v1alpha3" "example" {
  metadata = {
    name      = "some-name"
