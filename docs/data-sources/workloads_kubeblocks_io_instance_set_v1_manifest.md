...
page_title: "k8s_workloads_kubeblocks_io_instance_set_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "workloads.kubeblocks.io"
description: |-
  InstanceSet is the Schema for the instancesets API.
---

# k8s_workloads_kubeblocks_io_instance_set_v1_manifest (Data Source)
