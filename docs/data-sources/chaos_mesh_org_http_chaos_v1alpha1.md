...
page_title: "k8s_chaos_mesh_org_http_chaos_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "chaos-mesh.org"
description: |-
  HTTPChaos is the Schema for the HTTPchaos API
---

# k8s_chaos_mesh_org_http_chaos_v1alpha1 (Data Source)
...
```terraform
data "k8s_chaos_mesh_org_http_chaos_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
