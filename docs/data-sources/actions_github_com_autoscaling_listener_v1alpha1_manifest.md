...
page_title: "k8s_actions_github_com_autoscaling_listener_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "actions.github.com"
description: |-
  AutoscalingListener is the Schema for the autoscalinglisteners API
---

# k8s_actions_github_com_autoscaling_listener_v1alpha1_manifest (Data Source)
...
- `spec` (Attributes) AutoscalingListenerSpec defines the desired state of AutoscalingListener (see [below for nested schema](#nestedatt--spec))
...
- `autoscaling_runner_set_name` (String) Required
- `autoscaling_runner_set_namespace` (String) Required
- `ephemeral_runner_set_name` (String) Required
...
- `image_pull_secrets` (Attributes List) Required (see [below for nested schema](#nestedatt--spec--image_pull_secrets))
- `max_runners` (Number) Required
- `min_runners` (Number) Required
- `proxy` (Attributes) (see [below for nested schema](#nestedatt--spec--proxy))
- `runner_scale_set_id` (Number) Required
