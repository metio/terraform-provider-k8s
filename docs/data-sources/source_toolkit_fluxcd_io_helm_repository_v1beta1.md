...
page_title: "k8s_source_toolkit_fluxcd_io_helm_repository_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "source.toolkit.fluxcd.io"
description: |-
  HelmRepository is the Schema for the helmrepositories API
---

# k8s_source_toolkit_fluxcd_io_helm_repository_v1beta1 (Data Source)
