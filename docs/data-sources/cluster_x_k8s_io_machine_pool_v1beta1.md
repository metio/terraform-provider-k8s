...
page_title: "k8s_cluster_x_k8s_io_machine_pool_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "cluster.x-k8s.io"
description: |-
  MachinePool is the Schema for the machinepools API.
---

# k8s_cluster_x_k8s_io_machine_pool_v1beta1 (Data Source)
...
- `min_ready_seconds` (Number) Minimum number of seconds for which a newly created machine instances should be ready. Defaults to 0 (machine instance will be considered available as soon as it is ready) NOTE: No logic is implemented for this field and it currently has no behaviour.
