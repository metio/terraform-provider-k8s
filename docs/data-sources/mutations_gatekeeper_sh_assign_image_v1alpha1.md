...
page_title: "k8s_mutations_gatekeeper_sh_assign_image_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "mutations.gatekeeper.sh"
description: |-
  AssignImage is the Schema for the assignimage API.
---

# k8s_mutations_gatekeeper_sh_assign_image_v1alpha1 (Data Source)
...
```terraform
data "k8s_mutations_gatekeeper_sh_assign_image_v1alpha1" "example" {
  metadata = {
    name = "some-name"
