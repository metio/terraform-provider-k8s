...
page_title: "k8s_operator_cluster_x_k8s_io_infrastructure_provider_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "operator.cluster.x-k8s.io"
description: |-
  InfrastructureProvider is the Schema for the infrastructureproviders API.Deprecated: This type will be removed in one of the next releases.
---

# k8s_operator_cluster_x_k8s_io_infrastructure_provider_v1alpha1_manifest (Data Source)
