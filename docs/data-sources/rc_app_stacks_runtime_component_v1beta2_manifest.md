...
- `certificate_secret_ref` (String) A name of a secret that already contains TLS key, certificate and CA to be used in the route. Also can contain destination CA certificate.
...
- `certificate_secret_ref` (String) A name of a secret that already contains TLS key, certificate and CA to be mounted in the pod.
