...
page_title: "k8s_sfn_services_k8s_aws_activity_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "sfn.services.k8s.aws"
description: |-
  Activity is the Schema for the Activities API
---

# k8s_sfn_services_k8s_aws_activity_v1alpha1 (Data Source)
...
```terraform
data "k8s_sfn_services_k8s_aws_activity_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
