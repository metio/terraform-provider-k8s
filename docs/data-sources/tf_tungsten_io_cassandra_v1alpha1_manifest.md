...
page_title: "k8s_tf_tungsten_io_cassandra_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "tf.tungsten.io"
description: |-
  Cassandra is the Schema for the cassandras API.
---

# k8s_tf_tungsten_io_cassandra_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_tf_tungsten_io_cassandra_v1alpha1_manifest" "example" {
  metadata = {
    name      = "some-name"
...
- `spec` (Attributes) CassandraSpec is the Spec for the cassandras API. (see [below for nested schema](#nestedatt--spec))
...
- `service_configuration` (Attributes) CassandraConfiguration is the Spec for the cassandras API. (see [below for nested schema](#nestedatt--spec--service_configuration))
...
- `cassandra_parameters` (Attributes) CassandraConfigParameters defines additional parameters for Cassandra confgiuration (see [below for nested schema](#nestedatt--spec--service_configuration--cassandra_parameters))
...
<a id="nestedatt--spec--service_configuration--cassandra_parameters"></a>
### Nested Schema for `spec.service_configuration.cassandra_parameters`
