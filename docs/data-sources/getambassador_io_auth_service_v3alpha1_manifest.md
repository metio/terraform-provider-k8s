...
page_title: "k8s_getambassador_io_auth_service_v3alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  AuthService is the Schema for the authservices API
---

# k8s_getambassador_io_auth_service_v3alpha1_manifest (Data Source)
