...
page_title: "k8s_helm_toolkit_fluxcd_io_helm_release_v2beta1 Data Source - terraform-provider-k8s"
subcategory: "helm.toolkit.fluxcd.io"
description: |-
  HelmRelease is the Schema for the helmreleases API
---

# k8s_helm_toolkit_fluxcd_io_helm_release_v2beta1 (Data Source)
