...
page_title: "k8s_apps_kubeblocks_io_component_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_apps_kubeblocks_io_component_v1_manifest (Data Source)
...
- `pod_fqd_ns` (Attributes) (see [below for nested schema](#nestedatt--spec--service_refs--cluster_service_selector--pod_fqd_ns))
...
<a id="nestedatt--spec--service_refs--cluster_service_selector--pod_fqd_ns"></a>
### Nested Schema for `spec.service_refs.cluster_service_selector.pod_fqd_ns`

Required:

- `component` (String) The name of the Component where the pods reside in.
