...
page_title: "k8s_monitoring_coreos_com_thanos_ruler_v1 Data Source - terraform-provider-k8s"
subcategory: "monitoring.coreos.com"
description: |-
  ThanosRuler defines a ThanosRuler deployment.
---

# k8s_monitoring_coreos_com_thanos_ruler_v1 (Data Source)
...
- `ca` (Attributes) Certificate authority used when verifying server certificates. (see [below for nested schema](#nestedatt--spec--grpc_server_tls_config--ca))
- `ca_file` (String) Path to the CA cert in the Prometheus container to use for the targets.
- `cert` (Attributes) Client certificate to present when doing client-authentication. (see [below for nested schema](#nestedatt--spec--grpc_server_tls_config--cert))
