...
page_title: "k8s_infrastructure_cluster_x_k8s_io_ibmvpc_machine_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  IBMVPCMachine is the Schema for the ibmvpcmachines API.
---

# k8s_infrastructure_cluster_x_k8s_io_ibmvpc_machine_v1beta1 (Data Source)
