...
page_title: "k8s_kyverno_io_policy_exception_v2alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  PolicyException declares resources to be excluded from specified policies.
---

# k8s_kyverno_io_policy_exception_v2alpha1_manifest (Data Source)
