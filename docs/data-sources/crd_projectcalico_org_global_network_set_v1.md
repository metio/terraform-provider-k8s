...
page_title: "k8s_crd_projectcalico_org_global_network_set_v1 Data Source - terraform-provider-k8s"
...
# k8s_crd_projectcalico_org_global_network_set_v1 (Data Source)
...
```terraform
data "k8s_crd_projectcalico_org_global_network_set_v1" "example" {
  metadata = {
    name = "some-name"
