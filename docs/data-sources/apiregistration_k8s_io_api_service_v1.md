...
page_title: "k8s_apiregistration_k8s_io_api_service_v1 Data Source - terraform-provider-k8s"
subcategory: "apiregistration.k8s.io"
description: |-
  APIService represents a server for a particular GroupVersion. Name must be 'version.group'.
---

# k8s_apiregistration_k8s_io_api_service_v1 (Data Source)
...
```terraform
data "k8s_apiregistration_k8s_io_api_service_v1" "example" {
  metadata = {
    name = "some-name"
