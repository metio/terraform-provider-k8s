...
page_title: "k8s_bpfman_io_xdp_program_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "bpfman.io"
description: |-
  XdpProgram is the Schema for the XdpPrograms API
---

# k8s_bpfman_io_xdp_program_v1alpha1_manifest (Data Source)
...
- `spec` (Attributes) XdpProgramSpec defines the desired state of XdpProgram (see [below for nested schema](#nestedatt--spec))
