...
page_title: "k8s_operator_knative_dev_knative_serving_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "operator.knative.dev"
description: |-
  Schema for the knativeservings API
---

# k8s_operator_knative_dev_knative_serving_v1beta1 (Data Source)
