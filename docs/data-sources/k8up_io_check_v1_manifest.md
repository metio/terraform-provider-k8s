...
page_title: "k8s_k8up_io_check_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "k8up.io"
description: |-
  Check is the Schema for the checks API
---

# k8s_k8up_io_check_v1_manifest (Data Source)
...
```terraform
data "k8s_k8up_io_check_v1_manifest" "example" {
  metadata = {
    name      = "some-name"
...
- `spec` (Attributes) CheckSpec defines the desired state of Check. It needs to contain the repository information. (see [below for nested schema](#nestedatt--spec))
