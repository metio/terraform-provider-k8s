...
page_title: "k8s_data_fluid_io_dataset_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "data.fluid.io"
description: |-
  Dataset is the Schema for the datasets API
---

# k8s_data_fluid_io_dataset_v1alpha1 (Data Source)
...
```terraform
data "k8s_data_fluid_io_dataset_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
