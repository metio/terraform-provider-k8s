...
page_title: "k8s_rds_services_k8s_aws_db_cluster_parameter_group_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "rds.services.k8s.aws"
description: |-
  DBClusterParameterGroup is the Schema for the DBClusterParameterGroups API
---

# k8s_rds_services_k8s_aws_db_cluster_parameter_group_v1alpha1 (Data Source)
...
```terraform
data "k8s_rds_services_k8s_aws_db_cluster_parameter_group_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
