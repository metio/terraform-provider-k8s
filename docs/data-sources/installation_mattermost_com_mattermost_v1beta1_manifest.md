...
- `container_ports` (Attributes List) Additional Container Ports injected to pod's main container. The setting does not override ContainerPorts defined by the Operator. (see [below for nested schema](#nestedatt--spec--pod_extensions--container_ports))
- `init_containers` (Attributes List) Additional InitContainers injected to pods. The setting does not override InitContainers defined by the Operator. (see [below for nested schema](#nestedatt--spec--pod_extensions--init_containers))
