...
### Nested Schema for `spec.jaegerui.resources.requests`
...
### Nested Schema for `spec.multitenancy.resources.requests`
...
### Nested Schema for `spec.observability.grafana.data_source.instance_selector.match_labels`
...
### Nested Schema for `spec.storage.traces.size`
