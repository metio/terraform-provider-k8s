...
page_title: "k8s_externaldata_gatekeeper_sh_provider_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "externaldata.gatekeeper.sh"
description: |-
  Provider is the Schema for the providers API
---

# k8s_externaldata_gatekeeper_sh_provider_v1beta1_manifest (Data Source)
...
```terraform
data "k8s_externaldata_gatekeeper_sh_provider_v1beta1_manifest" "example" {
  metadata = {
    name = "some-name"
