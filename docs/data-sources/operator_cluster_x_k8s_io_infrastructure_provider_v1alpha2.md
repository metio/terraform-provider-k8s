...
page_title: "k8s_operator_cluster_x_k8s_io_infrastructure_provider_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "operator.cluster.x-k8s.io"
description: |-
  InfrastructureProvider is the Schema for the infrastructureproviders API.
---

# k8s_operator_cluster_x_k8s_io_infrastructure_provider_v1alpha2 (Data Source)
