...
page_title: "k8s_apigatewayv2_services_k8s_aws_stage_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "apigatewayv2.services.k8s.aws"
description: |-
  Stage is the Schema for the Stages API
---

# k8s_apigatewayv2_services_k8s_aws_stage_v1alpha1 (Data Source)
