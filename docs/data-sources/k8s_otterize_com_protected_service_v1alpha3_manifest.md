...
page_title: "k8s_k8s_otterize_com_protected_service_v1alpha3_manifest Data Source - terraform-provider-k8s"
subcategory: "k8s.otterize.com"
description: |-
  ProtectedService is the Schema for the protectedservice API
---

# k8s_k8s_otterize_com_protected_service_v1alpha3_manifest (Data Source)
