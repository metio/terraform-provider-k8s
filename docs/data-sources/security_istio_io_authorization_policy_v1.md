...
page_title: "k8s_security_istio_io_authorization_policy_v1 Data Source - terraform-provider-k8s"
subcategory: "security.istio.io"
description: |-
  
---

# k8s_security_istio_io_authorization_policy_v1 (Data Source)
...
```terraform
data "k8s_security_istio_io_authorization_policy_v1" "example" {
  metadata = {
    name      = "some-name"
