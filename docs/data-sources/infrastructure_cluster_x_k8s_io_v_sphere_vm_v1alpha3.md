...
page_title: "k8s_infrastructure_cluster_x_k8s_io_v_sphere_vm_v1alpha3 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  VSphereVM is the Schema for the vspherevms API  Deprecated: This type will be removed in one of the next releases.
---

# k8s_infrastructure_cluster_x_k8s_io_v_sphere_vm_v1alpha3 (Data Source)
...
```terraform
data "k8s_infrastructure_cluster_x_k8s_io_v_sphere_vm_v1alpha3" "example" {
  metadata = {
    name      = "some-name"
