...
### Nested Schema for `spec.predictors.template.metadata`
...
### Nested Schema for `spec.predictors.template.spec.containers.env`
...
### Nested Schema for `spec.predictors.template.spec.containers.env_from`
...
### Nested Schema for `spec.predictors.template.spec.containers.lifecycle`
...
### Nested Schema for `spec.predictors.template.spec.containers.liveness_probe`
...
### Nested Schema for `spec.predictors.template.spec.containers.ports`
...
### Nested Schema for `spec.predictors.template.spec.containers.readiness_probe`
...
### Nested Schema for `spec.predictors.template.spec.containers.resources`
...
### Nested Schema for `spec.predictors.template.spec.containers.security_context`
...
### Nested Schema for `spec.predictors.template.spec.containers.startup_probe`
...
### Nested Schema for `spec.predictors.template.spec.containers.volume_devices`
...
### Nested Schema for `spec.predictors.template.spec.containers.volume_mounts`
...
### Nested Schema for `spec.predictors.template.spec.affinity.node_affinity`
...
### Nested Schema for `spec.predictors.template.spec.affinity.pod_affinity`
...
### Nested Schema for `spec.predictors.template.spec.dns_config.options`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.env`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.env_from`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.lifecycle`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.liveness_probe`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.ports`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.readiness_probe`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.resources`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.security_context`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.startup_probe`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.volume_devices`
...
### Nested Schema for `spec.predictors.template.spec.ephemeral_containers.volume_mounts`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.env`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.env_from`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.lifecycle`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.liveness_probe`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.ports`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.readiness_probe`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.resources`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.security_context`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.startup_probe`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.volume_devices`
...
### Nested Schema for `spec.predictors.template.spec.init_containers.volume_mounts`
...
### Nested Schema for `spec.predictors.template.spec.security_context.se_linux_options`
...
### Nested Schema for `spec.predictors.template.spec.security_context.seccomp_profile`
...
### Nested Schema for `spec.predictors.template.spec.security_context.sysctls`
...
### Nested Schema for `spec.predictors.template.spec.topology_spread_constraints.label_selector.match_expressions`
...
### Nested Schema for `spec.predictors.template.spec.volumes.aws_elastic_block_store`
...
### Nested Schema for `spec.predictors.template.spec.volumes.azure_disk`
...
### Nested Schema for `spec.predictors.template.spec.volumes.azure_file`
...
### Nested Schema for `spec.predictors.template.spec.volumes.cephfs`
...
### Nested Schema for `spec.predictors.template.spec.volumes.cinder`
...
### Nested Schema for `spec.predictors.template.spec.volumes.config_map`
...
### Nested Schema for `spec.predictors.template.spec.volumes.csi`
...
### Nested Schema for `spec.predictors.template.spec.volumes.downward_api`
...
### Nested Schema for `spec.predictors.template.spec.volumes.empty_dir`
...
### Nested Schema for `spec.predictors.template.spec.volumes.ephemeral`
...
### Nested Schema for `spec.predictors.template.spec.volumes.fc`
...
### Nested Schema for `spec.predictors.template.spec.volumes.flex_volume`
...
### Nested Schema for `spec.predictors.template.spec.volumes.flocker`
...
### Nested Schema for `spec.predictors.template.spec.volumes.gce_persistent_disk`
...
### Nested Schema for `spec.predictors.template.spec.volumes.git_repo`
...
### Nested Schema for `spec.predictors.template.spec.volumes.glusterfs`
...
### Nested Schema for `spec.predictors.template.spec.volumes.host_path`
...
### Nested Schema for `spec.predictors.template.spec.volumes.iscsi`
...
### Nested Schema for `spec.predictors.template.spec.volumes.nfs`
...
### Nested Schema for `spec.predictors.template.spec.volumes.persistent_volume_claim`
...
### Nested Schema for `spec.predictors.template.spec.volumes.photon_persistent_disk`
...
### Nested Schema for `spec.predictors.template.spec.volumes.portworx_volume`
...
### Nested Schema for `spec.predictors.template.spec.volumes.projected`
...
### Nested Schema for `spec.predictors.template.spec.volumes.quobyte`
...
### Nested Schema for `spec.predictors.template.spec.volumes.rbd`
...
### Nested Schema for `spec.predictors.template.spec.volumes.scale_io`
...
### Nested Schema for `spec.predictors.template.spec.volumes.secret`
...
### Nested Schema for `spec.predictors.template.spec.volumes.storageos`
...
### Nested Schema for `spec.predictors.auto_scale.auto_scaler`
