...
page_title: "k8s_gateway_networking_k8s_io_gateway_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "gateway.networking.k8s.io"
description: |-
  Gateway represents an instance of a service-traffic handling infrastructure by binding Listeners to a set of IP addresses.
---

# k8s_gateway_networking_k8s_io_gateway_v1alpha2 (Data Source)
