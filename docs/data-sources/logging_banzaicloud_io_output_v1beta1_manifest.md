...
### Nested Schema for `spec.http.tls_private_key_path.mount_from`
...
### Nested Schema for `spec.kafka.keytab.mount_from`
...
### Nested Schema for `spec.kafka.password.mount_from`
...
### Nested Schema for `spec.kafka.ssl_ca_cert.mount_from`
...
### Nested Schema for `spec.kafka.ssl_client_cert.mount_from`
...
### Nested Schema for `spec.kafka.ssl_client_cert_chain.mount_from`
...
### Nested Schema for `spec.kafka.ssl_client_cert_key.mount_from`
...
### Nested Schema for `spec.kafka.username.mount_from`
...
### Nested Schema for `spec.kinesis_firehose.aws_key_id.mount_from`
...
### Nested Schema for `spec.kinesis_firehose.aws_sec_key.mount_from`
...
### Nested Schema for `spec.kinesis_firehose.aws_ses_token.mount_from`
...
### Nested Schema for `spec.kinesis_stream.aws_key_id.mount_from`
...
### Nested Schema for `spec.kinesis_stream.aws_sec_key.mount_from`
...
### Nested Schema for `spec.kinesis_stream.aws_ses_token.mount_from`
...
### Nested Schema for `spec.logz.endpoint.token`
...
### Nested Schema for `spec.loki.ca_cert.mount_from`
...
### Nested Schema for `spec.loki.cert.mount_from`
...
### Nested Schema for `spec.loki.key.mount_from`
...
### Nested Schema for `spec.loki.password.mount_from`
...
### Nested Schema for `spec.loki.username.mount_from`
...
<a id="nestedatt--spec--mattermost"></a>
### Nested Schema for `spec.mattermost`

Required:

- `webhook_url` (Attributes) (see [below for nested schema](#nestedatt--spec--mattermost--webhook_url))

Optional:

- `ca_path` (Attributes) (see [below for nested schema](#nestedatt--spec--mattermost--ca_path))
- `channel_id` (String)
- `enable_tls` (Boolean)
- `message` (String)
...
<a id="nestedatt--spec--mattermost--webhook_url"></a>
### Nested Schema for `spec.mattermost.webhook_url`

Optional:

- `mount_from` (Attributes) (see [below for nested schema](#nestedatt--spec--mattermost--webhook_url--mount_from))
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--mattermost--webhook_url--value_from))

<a id="nestedatt--spec--mattermost--webhook_url--mount_from"></a>
### Nested Schema for `spec.mattermost.webhook_url.mount_from`
...
<a id="nestedatt--spec--mattermost--webhook_url--value_from"></a>
### Nested Schema for `spec.mattermost.webhook_url.value_from`
...
<a id="nestedatt--spec--mattermost--ca_path"></a>
### Nested Schema for `spec.mattermost.ca_path`

Optional:

- `mount_from` (Attributes) (see [below for nested schema](#nestedatt--spec--mattermost--ca_path--mount_from))
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--mattermost--ca_path--value_from))

<a id="nestedatt--spec--mattermost--ca_path--mount_from"></a>
### Nested Schema for `spec.mattermost.ca_path.mount_from`
...
<a id="nestedatt--spec--mattermost--ca_path--value_from"></a>
### Nested Schema for `spec.mattermost.ca_path.value_from`
...
### Nested Schema for `spec.newrelic.api_key.mount_from`
...
### Nested Schema for `spec.newrelic.license_key.mount_from`
...
### Nested Schema for `spec.opensearch.ca_file.mount_from`
...
### Nested Schema for `spec.opensearch.client_cert.mount_from`
...
### Nested Schema for `spec.opensearch.client_key.mount_from`
...
### Nested Schema for `spec.opensearch.client_key_pass.mount_from`
...
### Nested Schema for `spec.opensearch.endpoint.access_key_id`
...
### Nested Schema for `spec.opensearch.endpoint.assume_role_arn`
...
### Nested Schema for `spec.opensearch.endpoint.assume_role_session_name`
...
### Nested Schema for `spec.opensearch.endpoint.assume_role_web_identity_token_file`
...
### Nested Schema for `spec.opensearch.endpoint.ecs_container_credentials_relative_uri`
...
### Nested Schema for `spec.opensearch.endpoint.secret_access_key`
...
### Nested Schema for `spec.opensearch.password.mount_from`
...
### Nested Schema for `spec.opensearch.template_file.mount_from`
...
### Nested Schema for `spec.oss.access_key_id.mount_from`
...
### Nested Schema for `spec.oss.access_key_secret.mount_from`
...
### Nested Schema for `spec.redis.password.mount_from`
...
### Nested Schema for `spec.s3.aws_key_id.mount_from`
...
### Nested Schema for `spec.s3.aws_sec_key.mount_from`
...
### Nested Schema for `spec.splunk_hec.hec_token.mount_from`
...
### Nested Schema for `spec.splunk_hec.ca_file.mount_from`
...
### Nested Schema for `spec.splunk_hec.ca_path.mount_from`
...
### Nested Schema for `spec.splunk_hec.client_cert.mount_from`
...
### Nested Schema for `spec.splunk_hec.client_key.mount_from`
...
### Nested Schema for `spec.sqs.aws_key_id.mount_from`
...
### Nested Schema for `spec.sqs.aws_sec_key.mount_from`
...
### Nested Schema for `spec.sumologic.endpoint.mount_from`
...
### Nested Schema for `spec.syslog.client_cert_path.mount_from`
...
### Nested Schema for `spec.syslog.private_key_passphrase.mount_from`
...
### Nested Schema for `spec.syslog.private_key_path.mount_from`
...
### Nested Schema for `spec.syslog.trusted_ca_path.mount_from`
...
### Nested Schema for `spec.vmware_log_insight.ca_file.mount_from`
...
### Nested Schema for `spec.vmware_log_insight.password.mount_from`
...
### Nested Schema for `spec.vmware_log_insight.username.mount_from`
...
### Nested Schema for `spec.vmware_log_intelligence.headers.authorization`
