...
<a id="nestedatt--spec--options--ai--prompt_guard--request--custom_response"></a>
...
<a id="nestedatt--spec--options--ai--prompt_guard--request--regex"></a>
...
<a id="nestedatt--spec--options--ai--prompt_guard--request--webhook"></a>
...
<a id="nestedatt--spec--options--ai--prompt_guard--request--webhook--headers"></a>
...
<a id="nestedatt--spec--options--ai--prompt_guard--response--regex"></a>
...
<a id="nestedatt--spec--options--ai--prompt_guard--response--webhook"></a>
...
<a id="nestedatt--spec--options--ai--prompt_guard--response--webhook--headers"></a>
...
<a id="nestedatt--spec--options--ai--rag--embedding--azure_openai--auth_token--secret_ref"></a>
...
- `weaviate` (Attributes) (see [below for nested schema](#nestedatt--spec--options--ai--semantic_cache--datastore--weaviate))
...
<a id="nestedatt--spec--options--ai--semantic_cache--datastore--weaviate"></a>
### Nested Schema for `spec.options.ai.semantic_cache.datastore.weaviate`
...
<a id="nestedatt--spec--options--jwt_providers_staged--before_ext_auth--providers--jwks--local"></a>
...
<a id="nestedatt--spec--options--jwt_providers_staged--before_ext_auth--providers--token_source--headers"></a>
...
<a id="nestedatt--spec--options--staged_transformations--post_routing--request_transforms--matcher--headers"></a>
...
<a id="nestedatt--spec--options--staged_transformations--post_routing--request_transforms--response_transformation--transformation_template--body"></a>
...
<a id="nestedatt--spec--options--staged_transformations--post_routing--response_transforms--response_transformation--header_body_transform"></a>
...
### Nested Schema for `spec.options.staged_transformations.post_routing.response_transforms.response_transformation.xslt_transformation`
