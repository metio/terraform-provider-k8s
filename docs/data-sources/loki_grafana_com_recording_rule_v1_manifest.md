...
page_title: "k8s_loki_grafana_com_recording_rule_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "loki.grafana.com"
description: |-
  RecordingRule is the Schema for the recordingrules API
---

# k8s_loki_grafana_com_recording_rule_v1_manifest (Data Source)
