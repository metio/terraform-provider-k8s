...
page_title: "k8s_bpfman_io_tracepoint_program_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "bpfman.io"
description: |-
  TracepointProgram is the Schema for the TracepointPrograms API
---

# k8s_bpfman_io_tracepoint_program_v1alpha1_manifest (Data Source)
