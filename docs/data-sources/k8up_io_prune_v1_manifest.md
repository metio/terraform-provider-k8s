...
- `spec` (Attributes) PruneSpec needs to contain the repository information as well as the desired retention policies. (see [below for nested schema](#nestedatt--spec))
