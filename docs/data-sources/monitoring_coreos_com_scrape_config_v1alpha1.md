...
page_title: "k8s_monitoring_coreos_com_scrape_config_v1alpha1 Data Source - terraform-provider-k8s"
...
# k8s_monitoring_coreos_com_scrape_config_v1alpha1 (Data Source)
...
### Nested Schema for `spec.consul_sd_configs.oauth2.token_url`

Read-Only:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--consul_sd_configs--oauth2--token_url--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--consul_sd_configs--oauth2--token_url--secret))

<a id="nestedatt--spec--consul_sd_configs--oauth2--token_url--config_map"></a>
### Nested Schema for `spec.consul_sd_configs.oauth2.token_url.config_map`
...
<a id="nestedatt--spec--consul_sd_configs--oauth2--token_url--secret"></a>
### Nested Schema for `spec.consul_sd_configs.oauth2.token_url.secret`
