...
page_title: "k8s_operator_openshift_io_kube_scheduler_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_operator_openshift_io_kube_scheduler_v1_manifest (Data Source)
...
- `spec` (Attributes) spec is the specification of the desired behavior of the Kubernetes Scheduler (see [below for nested schema](#nestedatt--spec))
