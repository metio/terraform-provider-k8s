...
page_title: "k8s_mutations_gatekeeper_sh_modify_set_v1alpha1 Data Source - terraform-provider-k8s"
...
# k8s_mutations_gatekeeper_sh_modify_set_v1alpha1 (Data Source)
...
```terraform
data "k8s_mutations_gatekeeper_sh_modify_set_v1alpha1" "example" {
  metadata = {
    name = "some-name"
