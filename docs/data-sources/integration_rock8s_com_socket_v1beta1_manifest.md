...
page_title: "k8s_integration_rock8s_com_socket_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "integration.rock8s.com"
description: |-
  Socket is the Schema for the sockets API
---

# k8s_integration_rock8s_com_socket_v1beta1_manifest (Data Source)
...
- `spec` (Attributes) SocketSpec defines the desired state of Socket (see [below for nested schema](#nestedatt--spec))
...
- `interface` (Attributes) interface (see [below for nested schema](#nestedatt--spec--interface))
- `limit` (Number) limit
...
- `validation` (Attributes) validation (see [below for nested schema](#nestedatt--spec--validation))
...
<a id="nestedatt--spec--interface"></a>
### Nested Schema for `spec.interface`

Optional:

- `config` (Attributes) config interface (see [below for nested schema](#nestedatt--spec--interface--config))
- `result` (Attributes) result interface (see [below for nested schema](#nestedatt--spec--interface--result))

<a id="nestedatt--spec--interface--config"></a>
### Nested Schema for `spec.interface.config`

Optional:

- `plug` (Attributes) plug config properties (see [below for nested schema](#nestedatt--spec--interface--config--plug))
...
<a id="nestedatt--spec--interface--config--socket"></a>
...
<a id="nestedatt--spec--interface--result"></a>
### Nested Schema for `spec.interface.result`

Optional:

- `plug` (Attributes) plug result properties (see [below for nested schema](#nestedatt--spec--interface--result--plug))
...
<a id="nestedatt--spec--interface--result--socket"></a>
...
- `namespace_blacklist` (List of String) namespace blacklist
- `namespace_whitelist` (List of String) namespace whitelist
