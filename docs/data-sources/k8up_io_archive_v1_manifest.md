...
page_title: "k8s_k8up_io_archive_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "k8up.io"
description: |-
  Archive is the Schema for the archives API
---

# k8s_k8up_io_archive_v1_manifest (Data Source)
...
- `spec` (Attributes) ArchiveSpec defines the desired state of Archive. (see [below for nested schema](#nestedatt--spec))
...
- `restore_method` (Attributes) RestoreMethod contains how and where the restore should happen all the settings are mutual exclusive. (see [below for nested schema](#nestedatt--spec--restore_method))
- `snapshot` (String)
