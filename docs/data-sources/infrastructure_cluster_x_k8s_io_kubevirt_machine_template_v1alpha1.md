...
- `registry` (Attributes) DataVolumeSourceRegistry provides the parameters to create a Data Volume from an registry source (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--status--storage--registry))
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--ssh_public_key--source--qemu_guest_agent"></a>
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--node_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions"></a>
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--pod_affinity--preferred_during_scheduling_ignored_during_execution"></a>
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--chassis"></a>
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--clock--utc--hpet"></a>
...
- `sound` (Attributes) Whether to emulate a sound device. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--devices--sound))
...
- `custom` (Attributes) CustomBlockSize represents the desired logical and physical block size for a VM disk. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--devices--watchdog--tag--custom))
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--acpi"></a>
...
- `vapic` (Attributes) VAPIC improves the paravirtualized handling of interrupts. Defaults to the machine type setting. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--vapic))
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--relaxed"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--reset"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--runtime"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--spinlocks"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--synic"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--synictimer"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`

Read-Only:

- `direct` (Attributes) Represents if a feature is enabled or disabled. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--vpindex--direct))
- `enabled` (Boolean)

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--vpindex--direct"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex.enabled`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--tlbflush"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--vapic"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--vendorid"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm--vpindex"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm.vpindex`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--kvm"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--pvspinlock"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--features--smm"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.features.smm`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.firmware`

Read-Only:

- `bootloader` (Attributes) Settings to control the bootloader that is used. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--bootloader))
- `kernel_boot` (Attributes) Settings to set the kernel for booting. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--kernel_boot))
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--bootloader"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.firmware.uuid`

Read-Only:

- `bios` (Attributes) If set (default), BIOS will be used. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--uuid--bios))
- `efi` (Attributes) If set, EFI will be used instead of BIOS. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--uuid--efi))

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--uuid--bios"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.firmware.uuid.efi`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--uuid--efi"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.firmware.uuid.efi`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--kernel_boot"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.firmware.uuid`

Read-Only:

- `container` (Attributes) Container defines the container that containes kernel artifacts (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--uuid--container))
- `kernel_args` (String) Arguments to be passed to the kernel at boot time

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--firmware--uuid--container"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.firmware.uuid.kernel_args`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--launch_security"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.launch_security`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--machine"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.machine`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--memory"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.memory`
...
- `hugepages` (Attributes) Hugepages allow to use hugepages for the VirtualMachineInstance instead of regular memory. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--memory--hugepages))

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--memory--hugepages"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.memory.hugepages`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--resources"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.resources`
...
- `http_get` (Attributes) HTTPGet specifies the http request to perform. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--http_get))
...
- `tcp_socket` (Attributes) TCPSocket specifies an action involving a TCP port. TCP hooks not yet supported TODO: implement a realistic TCP lifecycle hook (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--tcp_socket))
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--exec"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.exec`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--http_get"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.http_get`

Read-Only:

- `host` (String) Host name to connect to, defaults to the pod IP. You probably want to set 'Host' in httpHeaders instead.
- `http_headers` (Attributes List) Custom headers to set in the request. HTTP allows repeated headers. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--http_get--http_headers))
- `path` (String) Path to access on the HTTP server.
- `port` (String) Name or number of the port to access on the container. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME.
- `scheme` (String) Scheme to use for connecting to the host. Defaults to HTTP.

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--http_get--http_headers"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.http_get.scheme`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--tcp_socket"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.tcp_socket`
...
- `multus` (Attributes) Represents the multus cni network. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--multus))
...
- `pod` (Attributes) Represents the stock pod network interface. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--pod))

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--multus"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.multus`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--pod"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.pod`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--label_selector"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.label_selector`

Read-Only:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--label_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--label_selector--match_expressions"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.label_selector.match_labels`
...
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.cloud_init_config_drive.user_data_base64`
...
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.cloud_init_no_cloud.user_data_base64`
...
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.downward_api.volume_label`

Read-Only:

- `field_ref` (Attributes) Required: Selects a field of the pod: only annotations, labels, name and namespace are supported. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--downward_api--volume_label--field_ref))
...
- `resource_field_ref` (Attributes) Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported. (see [below for nested schema](#nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--downward_api--volume_label--resource_field_ref))

<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--downward_api--volume_label--field_ref"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.downward_api.volume_label.resource_field_ref`
...
<a id="nestedatt--spec--template--spec--virtual_machine_template--spec--template--spec--volumes--downward_api--volume_label--resource_field_ref"></a>
### Nested Schema for `spec.template.spec.virtual_machine_template.spec.template.spec.volumes.downward_api.volume_label.resource_field_ref`
