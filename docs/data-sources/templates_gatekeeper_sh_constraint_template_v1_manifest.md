...
page_title: "k8s_templates_gatekeeper_sh_constraint_template_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "templates.gatekeeper.sh"
description: |-
  ConstraintTemplate is the Schema for the constrainttemplates API
---

# k8s_templates_gatekeeper_sh_constraint_template_v1_manifest (Data Source)
...
```terraform
data "k8s_templates_gatekeeper_sh_constraint_template_v1_manifest" "example" {
  metadata = {
    name = "some-name"
