...
<a id="nestedatt--spec--deployment--spec--template--spec--volumes--vsphere_volume--secret_ref"></a>
### Nested Schema for `spec.deployment.spec.template.spec.volumes.vsphere_volume.target_portal`
...
### Nested Schema for `spec.ingress.spec.tls.http.paths.path_type`

Read-Only:

- `resource` (Attributes) (see [below for nested schema](#nestedatt--spec--ingress--spec--tls--http--paths--path_type--resource))
- `service` (Attributes) (see [below for nested schema](#nestedatt--spec--ingress--spec--tls--http--paths--path_type--service))

<a id="nestedatt--spec--ingress--spec--tls--http--paths--path_type--resource"></a>
### Nested Schema for `spec.ingress.spec.tls.http.paths.path_type.service`
...
<a id="nestedatt--spec--ingress--spec--tls--http--paths--path_type--service"></a>
### Nested Schema for `spec.ingress.spec.tls.http.paths.path_type.service`

Read-Only:

- `name` (String)
- `port` (Attributes) (see [below for nested schema](#nestedatt--spec--ingress--spec--tls--http--paths--path_type--service--port))

<a id="nestedatt--spec--ingress--spec--tls--http--paths--path_type--service--port"></a>
### Nested Schema for `spec.ingress.spec.tls.http.paths.path_type.service.port`
