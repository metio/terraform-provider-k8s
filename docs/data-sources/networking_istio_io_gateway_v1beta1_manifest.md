...
page_title: "k8s_networking_istio_io_gateway_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "networking.istio.io"
description: |-
  
---

# k8s_networking_istio_io_gateway_v1beta1_manifest (Data Source)
...
```terraform
data "k8s_networking_istio_io_gateway_v1beta1_manifest" "example" {
  metadata = {
    name      = "some-name"
