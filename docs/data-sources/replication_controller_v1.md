...
page_title: "k8s_replication_controller_v1 Data Source - terraform-provider-k8s"
subcategory: "core"
description: |-
  ReplicationController represents the configuration of a replication controller.
---

# k8s_replication_controller_v1 (Data Source)
...
```terraform
data "k8s_replication_controller_v1" "example" {
  metadata = {
    name      = "some-name"
