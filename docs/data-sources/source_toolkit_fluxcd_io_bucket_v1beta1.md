...
page_title: "k8s_source_toolkit_fluxcd_io_bucket_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "source.toolkit.fluxcd.io"
description: |-
  Bucket is the Schema for the buckets API
---

# k8s_source_toolkit_fluxcd_io_bucket_v1beta1 (Data Source)
...
```terraform
data "k8s_source_toolkit_fluxcd_io_bucket_v1beta1" "example" {
  metadata = {
    name      = "some-name"
