...
page_title: "k8s_apps_kubeblocks_io_cluster_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_apps_kubeblocks_io_cluster_v1_manifest (Data Source)
...
- `pod_fqd_ns` (Attributes) (see [below for nested schema](#nestedatt--spec--component_specs--service_refs--cluster_service_selector--pod_fqd_ns))
...
<a id="nestedatt--spec--component_specs--service_refs--cluster_service_selector--pod_fqd_ns"></a>
### Nested Schema for `spec.component_specs.service_refs.cluster_service_selector.pod_fqd_ns`
