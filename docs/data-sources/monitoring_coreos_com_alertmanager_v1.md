...
page_title: "k8s_monitoring_coreos_com_alertmanager_v1 Data Source - terraform-provider-k8s"
subcategory: "monitoring.coreos.com"
description: |-
  Alertmanager describes an Alertmanager cluster.
---

# k8s_monitoring_coreos_com_alertmanager_v1 (Data Source)
...
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.token_url`

Read-Only:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--token_url--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--token_url--secret))

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--token_url--config_map"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.token_url.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--token_url--secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.token_url.secret`
