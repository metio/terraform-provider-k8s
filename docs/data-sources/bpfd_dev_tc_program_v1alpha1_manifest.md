...
page_title: "k8s_bpfd_dev_tc_program_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "bpfd.dev"
description: |-
  TcProgram is the Schema for the TcProgram API
---

# k8s_bpfd_dev_tc_program_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_bpfd_dev_tc_program_v1alpha1_manifest" "example" {
  metadata = {
    name = "some-name"
