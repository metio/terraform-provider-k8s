...
page_title: "k8s_app_kiegroup_org_kogito_supporting_service_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "app.kiegroup.org"
description: |-
  KogitoSupportingService deploys the Supporting service in the given namespace.
---

# k8s_app_kiegroup_org_kogito_supporting_service_v1beta1 (Data Source)
...
- `spec` (Attributes) KogitoSupportingServiceSpec defines the desired state of KogitoSupportingService. (see [below for nested schema](#nestedatt--spec))
...
- `service_type` (String) Defines the type for the supporting service, eg: DataIndex, JobsService Default value: JobsService
