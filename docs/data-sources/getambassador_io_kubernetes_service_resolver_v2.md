...
page_title: "k8s_getambassador_io_kubernetes_service_resolver_v2 Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  KubernetesServiceResolver is the Schema for the kubernetesserviceresolver API
---

# k8s_getambassador_io_kubernetes_service_resolver_v2 (Data Source)
