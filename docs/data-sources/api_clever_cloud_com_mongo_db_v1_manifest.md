...
page_title: "k8s_api_clever_cloud_com_mongo_db_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "api.clever-cloud.com"
description: |-
  Auto-generated derived type for Spec via 'CustomResource'
---

# k8s_api_clever_cloud_com_mongo_db_v1_manifest (Data Source)
...
```terraform
data "k8s_api_clever_cloud_com_mongo_db_v1_manifest" "example" {
  metadata = {
    name      = "some-name"
