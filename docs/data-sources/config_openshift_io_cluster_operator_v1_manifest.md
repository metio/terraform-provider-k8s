...
page_title: "k8s_config_openshift_io_cluster_operator_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_config_openshift_io_cluster_operator_v1_manifest (Data Source)
...
```terraform
data "k8s_config_openshift_io_cluster_operator_v1_manifest" "example" {
  metadata = {
    name = "some-name"
...
- `spec` (Map of String) spec holds configuration that could apply to any operator.
