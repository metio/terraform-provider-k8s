...
page_title: "k8s_operator_openshift_io_storage_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_operator_openshift_io_storage_v1_manifest (Data Source)
...
```terraform
data "k8s_operator_openshift_io_storage_v1_manifest" "example" {
  metadata = {
    name = "some-name"
