...
page_title: "k8s_core_openfeature_dev_feature_flag_configuration_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "core.openfeature.dev"
description: |-
  FeatureFlagConfiguration is the Schema for the featureflagconfigurations API
---

# k8s_core_openfeature_dev_feature_flag_configuration_v1alpha2 (Data Source)
