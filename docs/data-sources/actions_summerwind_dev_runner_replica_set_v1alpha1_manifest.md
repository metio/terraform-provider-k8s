...
page_title: "k8s_actions_summerwind_dev_runner_replica_set_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "actions.summerwind.dev"
description: |-
  RunnerReplicaSet is the Schema for the runnerreplicasets API
---

# k8s_actions_summerwind_dev_runner_replica_set_v1alpha1_manifest (Data Source)
...
- `spec` (Attributes) RunnerReplicaSetSpec defines the desired state of RunnerReplicaSet (see [below for nested schema](#nestedatt--spec))
