...
page_title: "k8s_kyverno_io_cluster_background_scan_report_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  ClusterBackgroundScanReport is the Schema for the ClusterBackgroundScanReports API
---

# k8s_kyverno_io_cluster_background_scan_report_v1alpha2 (Data Source)
