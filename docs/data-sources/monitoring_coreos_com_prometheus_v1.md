...
### Nested Schema for `spec.remote_read.oauth2.token_url`

Read-Only:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--remote_read--oauth2--token_url--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--remote_read--oauth2--token_url--secret))

<a id="nestedatt--spec--remote_read--oauth2--token_url--config_map"></a>
### Nested Schema for `spec.remote_read.oauth2.token_url.config_map`
...
<a id="nestedatt--spec--remote_read--oauth2--token_url--secret"></a>
### Nested Schema for `spec.remote_read.oauth2.token_url.secret`
...
### Nested Schema for `spec.remote_write.oauth2.token_url`

Read-Only:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--remote_write--oauth2--token_url--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--remote_write--oauth2--token_url--secret))

<a id="nestedatt--spec--remote_write--oauth2--token_url--config_map"></a>
### Nested Schema for `spec.remote_write.oauth2.token_url.config_map`
...
<a id="nestedatt--spec--remote_write--oauth2--token_url--secret"></a>
### Nested Schema for `spec.remote_write.oauth2.token_url.secret`
...
- `tag` (String) *Deprecated: use 'image' instead. The image's tag can be specified as part of the image name.*
