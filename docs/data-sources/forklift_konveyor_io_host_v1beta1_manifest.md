...
page_title: "k8s_forklift_konveyor_io_host_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "forklift.konveyor.io"
description: |-
  
---

# k8s_forklift_konveyor_io_host_v1beta1_manifest (Data Source)
...
```terraform
data "k8s_forklift_konveyor_io_host_v1beta1_manifest" "example" {
  metadata = {
    name      = "some-name"
...
- `ip_address` (String) IP address used for disk transfer.
- `provider` (Attributes) Provider (see [below for nested schema](#nestedatt--spec--provider))
- `secret` (Attributes) Credentials. (see [below for nested schema](#nestedatt--spec--secret))
