...
page_title: "k8s_hive_openshift_io_sync_identity_provider_v1 Data Source - terraform-provider-k8s"
subcategory: "hive.openshift.io"
description: |-
  SyncIdentityProvider is the Schema for the SyncIdentityProvider API
---

# k8s_hive_openshift_io_sync_identity_provider_v1 (Data Source)
