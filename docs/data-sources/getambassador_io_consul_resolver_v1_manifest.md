...
page_title: "k8s_getambassador_io_consul_resolver_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  ConsulResolver is the Schema for the ConsulResolver API
---

# k8s_getambassador_io_consul_resolver_v1_manifest (Data Source)
...
```terraform
data "k8s_getambassador_io_consul_resolver_v1_manifest" "example" {
  metadata = {
    name      = "some-name"
