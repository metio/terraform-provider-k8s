...
page_title: "k8s_mutations_gatekeeper_sh_assign_metadata_v1 Data Source - terraform-provider-k8s"
subcategory: "mutations.gatekeeper.sh"
description: |-
  AssignMetadata is the Schema for the assignmetadata API.
---

# k8s_mutations_gatekeeper_sh_assign_metadata_v1 (Data Source)
