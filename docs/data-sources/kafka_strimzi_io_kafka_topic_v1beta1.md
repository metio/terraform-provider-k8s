...
page_title: "k8s_kafka_strimzi_io_kafka_topic_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "kafka.strimzi.io"
description: |-
  
---

# k8s_kafka_strimzi_io_kafka_topic_v1beta1 (Data Source)
...
```terraform
data "k8s_kafka_strimzi_io_kafka_topic_v1beta1" "example" {
  metadata = {
    name      = "some-name"
