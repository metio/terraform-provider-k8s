...
page_title: "k8s_infrastructure_cluster_x_k8s_io_v_sphere_deployment_zone_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  VSphereDeploymentZone is the Schema for the vspheredeploymentzones API
---

# k8s_infrastructure_cluster_x_k8s_io_v_sphere_deployment_zone_v1beta1 (Data Source)
...
```terraform
data "k8s_infrastructure_cluster_x_k8s_io_v_sphere_deployment_zone_v1beta1" "example" {
  metadata = {
    name = "some-name"
