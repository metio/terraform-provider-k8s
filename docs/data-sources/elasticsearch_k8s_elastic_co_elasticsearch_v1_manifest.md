...
<a id="nestedatt--spec--node_sets--pod_template--spec--volumes--image"></a>
### Nested Schema for `spec.node_sets.pod_template.spec.volumes.image`
...
- `sources` (Attributes List) sources is the list of volume projections. Each entry in this listhandles one source. (see [below for nested schema](#nestedatt--spec--node_sets--pod_template--spec--volumes--projected--sources))
