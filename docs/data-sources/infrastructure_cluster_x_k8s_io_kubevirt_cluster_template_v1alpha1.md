...
page_title: "k8s_infrastructure_cluster_x_k8s_io_kubevirt_cluster_template_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  KubevirtClusterTemplate is the Schema for the kubevirtclustertemplates API.
---

# k8s_infrastructure_cluster_x_k8s_io_kubevirt_cluster_template_v1alpha1 (Data Source)
