...
page_title: "k8s_apigatewayv2_services_k8s_aws_vpc_link_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "apigatewayv2.services.k8s.aws"
description: |-
  VPCLink is the Schema for the VPCLinks API
---

# k8s_apigatewayv2_services_k8s_aws_vpc_link_v1alpha1_manifest (Data Source)
