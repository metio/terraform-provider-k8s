...
- `name` (String) Name is an enum which identifies the IntrusionDetectionController Deployment container by name.
...
### Nested Schema for `spec.intrusion_detection_controller_deployment.spec.template.spec.init_containers.resources.requests`
...
- `name` (String) Name is an enum which identifies the IntrusionDetectionController Deployment init container by name.
