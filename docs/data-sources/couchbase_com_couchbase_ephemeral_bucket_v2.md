...
page_title: "k8s_couchbase_com_couchbase_ephemeral_bucket_v2 Data Source - terraform-provider-k8s"
...
# k8s_couchbase_com_couchbase_ephemeral_bucket_v2 (Data Source)
