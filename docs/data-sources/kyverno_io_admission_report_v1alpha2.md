...
page_title: "k8s_kyverno_io_admission_report_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  AdmissionReport is the Schema for the AdmissionReports API
---

# k8s_kyverno_io_admission_report_v1alpha2 (Data Source)
...
```terraform
data "k8s_kyverno_io_admission_report_v1alpha2" "example" {
  metadata = {
    name      = "some-name"
