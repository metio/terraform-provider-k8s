...
page_title: "k8s_getambassador_io_tracing_service_v2 Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  TracingService is the Schema for the tracingservices API
---

# k8s_getambassador_io_tracing_service_v2 (Data Source)
...
```terraform
data "k8s_getambassador_io_tracing_service_v2" "example" {
  metadata = {
    name      = "some-name"
