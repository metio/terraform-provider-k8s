...
page_title: "k8s_opentelemetry_io_instrumentation_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "opentelemetry.io"
description: |-
  Instrumentation is the spec for OpenTelemetry instrumentation.
---

# k8s_opentelemetry_io_instrumentation_v1alpha1 (Data Source)
...
```terraform
data "k8s_opentelemetry_io_instrumentation_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
