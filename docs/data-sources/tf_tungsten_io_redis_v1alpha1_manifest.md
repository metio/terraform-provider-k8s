...
page_title: "k8s_tf_tungsten_io_redis_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "tf.tungsten.io"
description: |-
  Redis is the Schema for the redis API.
---

# k8s_tf_tungsten_io_redis_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_tf_tungsten_io_redis_v1alpha1_manifest" "example" {
  metadata = {
    name      = "some-name"
...
- `spec` (Attributes) RedisSpec is the Spec for the redis API. (see [below for nested schema](#nestedatt--spec))
...
- `service_configuration` (Attributes) RedisConfiguration is the Spec for the redis API. (see [below for nested schema](#nestedatt--spec--service_configuration))
