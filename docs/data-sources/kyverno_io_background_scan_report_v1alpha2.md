...
page_title: "k8s_kyverno_io_background_scan_report_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  BackgroundScanReport is the Schema for the BackgroundScanReports API
---

# k8s_kyverno_io_background_scan_report_v1alpha2 (Data Source)
