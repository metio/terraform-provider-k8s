...
page_title: "k8s_cluster_x_k8s_io_machine_set_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "cluster.x-k8s.io"
description: |-
  MachineSet is the Schema for the machinesets API.
---

# k8s_cluster_x_k8s_io_machine_set_v1beta1_manifest (Data Source)
...
```terraform
data "k8s_cluster_x_k8s_io_machine_set_v1beta1_manifest" "example" {
  metadata = {
    name      = "some-name"
