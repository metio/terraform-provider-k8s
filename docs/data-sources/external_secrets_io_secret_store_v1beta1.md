...
page_title: "k8s_external_secrets_io_secret_store_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "external-secrets.io"
description: |-
  SecretStore represents a secure external location for storing secrets, which can be referenced as part of 'storeRef' fields.
---

# k8s_external_secrets_io_secret_store_v1beta1 (Data Source)
...
### Nested Schema for `spec.provider.conjur.url`

Read-Only:

- `apikey` (Attributes) (see [below for nested schema](#nestedatt--spec--provider--conjur--url--apikey))

<a id="nestedatt--spec--provider--conjur--url--apikey"></a>
### Nested Schema for `spec.provider.conjur.url.apikey`

Read-Only:

- `account` (String)
- `api_key_ref` (Attributes) A reference to a specific 'key' within a Secret resource, In some instances, 'key' is a required field. (see [below for nested schema](#nestedatt--spec--provider--conjur--url--apikey--api_key_ref))
- `user_ref` (Attributes) A reference to a specific 'key' within a Secret resource, In some instances, 'key' is a required field. (see [below for nested schema](#nestedatt--spec--provider--conjur--url--apikey--user_ref))

<a id="nestedatt--spec--provider--conjur--url--apikey--api_key_ref"></a>
### Nested Schema for `spec.provider.conjur.url.apikey.user_ref`
...
<a id="nestedatt--spec--provider--conjur--url--apikey--user_ref"></a>
### Nested Schema for `spec.provider.conjur.url.apikey.user_ref`
...
### Nested Schema for `spec.provider.senhasegura.url`

Read-Only:

- `client_id` (String)
- `client_secret_secret_ref` (Attributes) A reference to a specific 'key' within a Secret resource, In some instances, 'key' is a required field. (see [below for nested schema](#nestedatt--spec--provider--senhasegura--url--client_secret_secret_ref))

<a id="nestedatt--spec--provider--senhasegura--url--client_secret_secret_ref"></a>
### Nested Schema for `spec.provider.senhasegura.url.client_secret_secret_ref`
...
### Nested Schema for `spec.provider.vault.version.iam.vault_role`

Read-Only:

- `service_account_ref` (Attributes) A reference to a ServiceAccount resource. (see [below for nested schema](#nestedatt--spec--provider--vault--version--iam--vault_role--service_account_ref))

<a id="nestedatt--spec--provider--vault--version--iam--vault_role--service_account_ref"></a>
### Nested Schema for `spec.provider.vault.version.iam.vault_role.service_account_ref`
...
- `access_key_id_secret_ref` (Attributes) The AccessKeyID is used for authentication (see [below for nested schema](#nestedatt--spec--provider--vault--version--iam--vault_role--access_key_id_secret_ref))
- `secret_access_key_secret_ref` (Attributes) The SecretAccessKey is used for authentication (see [below for nested schema](#nestedatt--spec--provider--vault--version--iam--vault_role--secret_access_key_secret_ref))
- `session_token_secret_ref` (Attributes) The SessionToken used for authentication This must be defined if AccessKeyID and SecretAccessKey are temporary credentials see: https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html (see [below for nested schema](#nestedatt--spec--provider--vault--version--iam--vault_role--session_token_secret_ref))

<a id="nestedatt--spec--provider--vault--version--iam--vault_role--access_key_id_secret_ref"></a>
### Nested Schema for `spec.provider.vault.version.iam.vault_role.session_token_secret_ref`
...
<a id="nestedatt--spec--provider--vault--version--iam--vault_role--secret_access_key_secret_ref"></a>
### Nested Schema for `spec.provider.vault.version.iam.vault_role.session_token_secret_ref`
...
<a id="nestedatt--spec--provider--vault--version--iam--vault_role--session_token_secret_ref"></a>
### Nested Schema for `spec.provider.vault.version.iam.vault_role.session_token_secret_ref`
...
### Nested Schema for `spec.provider.vault.version.user_pass.username`
