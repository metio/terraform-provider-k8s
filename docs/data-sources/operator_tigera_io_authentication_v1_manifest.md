...
- `name` (String) Name is an enum which identifies the Dex Deployment container by name.
...
### Nested Schema for `spec.dex_deployment.spec.template.spec.init_containers.resources.requests`
...
- `name` (String) Name is an enum which identifies the Dex Deployment init container by name.
...
### Nested Schema for `spec.ldap.group_search.filter`
