...
page_title: "k8s_kuma_io_zone_egress_insight_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "kuma.io"
description: |-
  
---

# k8s_kuma_io_zone_egress_insight_v1alpha1 (Data Source)
...
```terraform
data "k8s_kuma_io_zone_egress_insight_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
