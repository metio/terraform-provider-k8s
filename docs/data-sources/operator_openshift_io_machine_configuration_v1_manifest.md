...
page_title: "k8s_operator_openshift_io_machine_configuration_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_operator_openshift_io_machine_configuration_v1_manifest (Data Source)
...
```terraform
data "k8s_operator_openshift_io_machine_configuration_v1_manifest" "example" {
  metadata = {
    name = "some-name"
...
- `spec` (Attributes) spec is the specification of the desired behavior of the Machine Config Operator (see [below for nested schema](#nestedatt--spec))
