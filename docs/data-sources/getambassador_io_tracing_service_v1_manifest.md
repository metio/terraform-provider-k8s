...
page_title: "k8s_getambassador_io_tracing_service_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  TracingService is the Schema for the tracingservices API
---

# k8s_getambassador_io_tracing_service_v1_manifest (Data Source)
