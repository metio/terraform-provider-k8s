...
page_title: "k8s_operator_cluster_x_k8s_io_core_provider_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "operator.cluster.x-k8s.io"
description: |-
  CoreProvider is the Schema for the coreproviders API.
---

# k8s_operator_cluster_x_k8s_io_core_provider_v1alpha1 (Data Source)
