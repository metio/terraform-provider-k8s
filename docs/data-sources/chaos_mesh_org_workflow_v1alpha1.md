...
page_title: "k8s_chaos_mesh_org_workflow_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "chaos-mesh.org"
description: |-
  
---

# k8s_chaos_mesh_org_workflow_v1alpha1 (Data Source)
...
### Nested Schema for `spec.templates.block_chaos.volume_name`
...
- `expression_selectors` (Attributes List) a slice of label selector expressions that can be used to select objects. A list of selectors based on set-based label expressions. (see [below for nested schema](#nestedatt--spec--templates--block_chaos--volume_name--expression_selectors))
...
<a id="nestedatt--spec--templates--block_chaos--volume_name--expression_selectors"></a>
### Nested Schema for `spec.templates.block_chaos.volume_name.expression_selectors`
...
### Nested Schema for `spec.templates.io_chaos.volume_path`

Read-Only:

- `atime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--templates--io_chaos--volume_path--atime))
- `blocks` (Number)
- `ctime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--templates--io_chaos--volume_path--ctime))
- `gid` (Number)
- `ino` (Number)
- `kind` (String) FileType represents type of file
- `mtime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--templates--io_chaos--volume_path--mtime))
- `nlink` (Number)
- `perm` (Number)
- `rdev` (Number)
- `size` (Number)
...
<a id="nestedatt--spec--templates--io_chaos--volume_path--atime"></a>
### Nested Schema for `spec.templates.io_chaos.volume_path.atime`
...
<a id="nestedatt--spec--templates--io_chaos--volume_path--ctime"></a>
### Nested Schema for `spec.templates.io_chaos.volume_path.ctime`
...
<a id="nestedatt--spec--templates--io_chaos--volume_path--mtime"></a>
### Nested Schema for `spec.templates.io_chaos.volume_path.mtime`
...
- `annotation_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on annotations.
- `expression_selectors` (Attributes List) a slice of label selector expressions that can be used to select objects. A list of selectors based on set-based label expressions. (see [below for nested schema](#nestedatt--spec--templates--io_chaos--volume_path--expression_selectors))
- `field_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on fields.
- `label_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on labels.
- `namespaces` (List of String) Namespaces is a set of namespace to which objects belong.
- `node_selectors` (Map of String) Map of string keys and values that can be used to select nodes. Selector which must match a node's labels, and objects must belong to these selected nodes.
...
<a id="nestedatt--spec--templates--io_chaos--volume_path--expression_selectors"></a>
### Nested Schema for `spec.templates.io_chaos.volume_path.expression_selectors`
...
### Nested Schema for `spec.templates.schedule.type`
...
- `action` (String) Action defines the specific block chaos action. Supported action: delay
- `container_names` (List of String) ContainerNames indicates list of the name of affected container. If not set, the first container will be injected
- `delay` (Attributes) Delay defines the delay distribution. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--delay))
- `duration` (String) Duration represents the duration of the chaos action.
- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `remote_cluster` (String) RemoteCluster represents the remote cluster where the chaos will be deployed
- `selector` (Attributes) Selector is used to select pods that are used to inject chaos action. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--selector))
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of pods to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of pods the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action
- `volume_name` (String)

<a id="nestedatt--spec--templates--schedule--type--delay"></a>
### Nested Schema for `spec.templates.schedule.type.delay`
...
<a id="nestedatt--spec--templates--schedule--type--selector"></a>
### Nested Schema for `spec.templates.schedule.type.selector`

Read-Only:

- `annotation_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on annotations.
- `expression_selectors` (Attributes List) a slice of label selector expressions that can be used to select objects. A list of selectors based on set-based label expressions. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--selector--expression_selectors))
- `field_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on fields.
- `label_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on labels.
- `namespaces` (List of String) Namespaces is a set of namespace to which objects belong.
- `node_selectors` (Map of String) Map of string keys and values that can be used to select nodes. Selector which must match a node's labels, and objects must belong to these selected nodes.
...
<a id="nestedatt--spec--templates--schedule--type--selector--expression_selectors"></a>
### Nested Schema for `spec.templates.schedule.type.selector.pods`
...
- `method` (String) Method is a rule to select target by http method in request.
- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `patch` (Attributes) Patch is a rule to patch some contents in target. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--patch))
- `path` (String) Path is a rule to select target by uri path in http request.
- `port` (Number) Port represents the target port to be proxy of.
- `remote_cluster` (String) RemoteCluster represents the remote cluster where the chaos will be deployed
- `replace` (Attributes) Replace is a rule to replace some contents in target. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--replace))
- `request_headers` (Map of String) RequestHeaders is a rule to select target by http headers in request. The key-value pairs represent header name and header value pairs.
- `response_headers` (Map of String) ResponseHeaders is a rule to select target by http headers in response. The key-value pairs represent header name and header value pairs.
- `selector` (Attributes) Selector is used to select pods that are used to inject chaos action. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--selector))
- `target` (String) Target is the object to be selected and injected.
- `tls` (Attributes) TLS is the tls config, will override PodHttpChaos if there are multiple HTTPChaos experiments are applied (see [below for nested schema](#nestedatt--spec--templates--schedule--type--tls))
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of pods to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of pods the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action

<a id="nestedatt--spec--templates--schedule--type--patch"></a>
### Nested Schema for `spec.templates.schedule.type.patch`

Read-Only:

- `body` (Attributes) Body is a rule to patch message body of target. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--patch--body))
- `headers` (List of String) Headers is a rule to append http headers of target. For example: '[['Set-Cookie', '<one cookie>'], ['Set-Cookie', '<another cookie>']]'.
- `queries` (List of String) Queries is a rule to append uri queries of target(Request only). For example: '[['foo', 'bar'], ['foo', 'unknown']]'.

<a id="nestedatt--spec--templates--schedule--type--patch--body"></a>
### Nested Schema for `spec.templates.schedule.type.patch.queries`
...
<a id="nestedatt--spec--templates--schedule--type--replace"></a>
### Nested Schema for `spec.templates.schedule.type.replace`
...
<a id="nestedatt--spec--templates--schedule--type--tls"></a>
### Nested Schema for `spec.templates.schedule.type.tls`
...
- `action` (String) Action defines the specific pod chaos action. Supported action: latency / fault / attrOverride / mistake
- `attr` (Attributes) Attr defines the overrided attribution (see [below for nested schema](#nestedatt--spec--templates--schedule--type--attr))
- `container_names` (List of String) ContainerNames indicates list of the name of affected container. If not set, the first container will be injected
- `delay` (String) Delay defines the value of I/O chaos action delay. A delay string is a possibly signed sequence of decimal numbers, each with optional fraction and a unit suffix, such as '300ms'. Valid time units are 'ns', 'us' (or 'µs'), 'ms', 's', 'm', 'h'.
- `duration` (String) Duration represents the duration of the chaos action. It is required when the action is 'PodFailureAction'. A duration string is a possibly signed sequence of decimal numbers, each with optional fraction and a unit suffix, such as '300ms', '-1.5h' or '2h45m'. Valid time units are 'ns', 'us' (or 'µs'), 'ms', 's', 'm', 'h'.
- `errno` (Number) Errno defines the error code that returned by I/O action. refer to: https://www-numi.fnal.gov/offline_software/srt_public_context/WebDocs/Errors/unix_system_errors.html
- `methods` (List of String) Methods defines the I/O methods for injecting I/O chaos action. default: all I/O methods.
- `mistake` (Attributes) Mistake defines what types of incorrectness are injected to IO operations (see [below for nested schema](#nestedatt--spec--templates--schedule--type--mistake))
- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `path` (String) Path defines the path of files for injecting I/O chaos action.
- `percent` (Number) Percent defines the percentage of injection errors and provides a number from 0-100. default: 100.
- `remote_cluster` (String) RemoteCluster represents the remote cluster where the chaos will be deployed
...
<a id="nestedatt--spec--templates--schedule--type--attr"></a>
### Nested Schema for `spec.templates.schedule.type.attr`

Read-Only:

- `atime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--templates--schedule--type--attr--atime))
- `blocks` (Number)
- `ctime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--templates--schedule--type--attr--ctime))
- `gid` (Number)
- `ino` (Number)
- `kind` (String) FileType represents type of file
- `mtime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--templates--schedule--type--attr--mtime))
- `nlink` (Number)
- `perm` (Number)
- `rdev` (Number)
- `size` (Number)
...
<a id="nestedatt--spec--templates--schedule--type--attr--atime"></a>
### Nested Schema for `spec.templates.schedule.type.attr.uid`
...
<a id="nestedatt--spec--templates--schedule--type--attr--ctime"></a>
### Nested Schema for `spec.templates.schedule.type.attr.uid`
...
<a id="nestedatt--spec--templates--schedule--type--attr--mtime"></a>
### Nested Schema for `spec.templates.schedule.type.attr.uid`
...
<a id="nestedatt--spec--templates--schedule--type--mistake"></a>
### Nested Schema for `spec.templates.schedule.type.mistake`
...
- `container_names` (List of String) ContainerNames indicates list of the name of affected container. If not set, the first container will be injected
- `duration` (String) Duration represents the duration of the chaos action
- `fail_kern_request` (Attributes) FailKernRequest defines the request of kernel injection (see [below for nested schema](#nestedatt--spec--templates--schedule--type--fail_kern_request))
- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `remote_cluster` (String) RemoteCluster represents the remote cluster where the chaos will be deployed
- `selector` (Attributes) Selector is used to select pods that are used to inject chaos action. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--selector))
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of pods to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of pods the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action

<a id="nestedatt--spec--templates--schedule--type--fail_kern_request"></a>
### Nested Schema for `spec.templates.schedule.type.fail_kern_request`

Read-Only:

- `callchain` (Attributes List) Callchain indicate a special call chain, such as:     ext4_mount       -> mount_subtree          -> ...             -> should_failslab With an optional set of predicates and an optional set of parameters, which used with predicates. You can read call chan and predicate examples from https://github.com/chaos-mesh/bpfki/tree/develop/examples to learn more. If no special call chain, just keep Callchain empty, which means it will fail at any call chain with slab alloc (eg: kmalloc). (see [below for nested schema](#nestedatt--spec--templates--schedule--type--fail_kern_request--callchain))
- `failtype` (Number) FailType indicates what to fail, can be set to '0' / '1' / '2' If '0', indicates slab to fail (should_failslab) If '1', indicates alloc_page to fail (should_fail_alloc_page) If '2', indicates bio to fail (should_fail_bio) You can read:   1. https://www.kernel.org/doc/html/latest/fault-injection/fault-injection.html   2. http://github.com/iovisor/bcc/blob/master/tools/inject_example.txt to learn more
- `headers` (List of String) Headers indicates the appropriate kernel headers you need. Eg: 'linux/mmzone.h', 'linux/blkdev.h' and so on
- `probability` (Number) Probability indicates the fails with probability. If you want 1%, please set this field with 1.
- `times` (Number) Times indicates the max times of fails.

<a id="nestedatt--spec--templates--schedule--type--fail_kern_request--callchain"></a>
### Nested Schema for `spec.templates.schedule.type.fail_kern_request.times`
...
- `action` (String) Action defines the specific network chaos action. Supported action: partition, netem, delay, loss, duplicate, corrupt Default action: delay
- `bandwidth` (Attributes) Bandwidth represents the detail about bandwidth control action (see [below for nested schema](#nestedatt--spec--templates--schedule--type--bandwidth))
- `corrupt` (Attributes) Corrupt represents the detail about corrupt action (see [below for nested schema](#nestedatt--spec--templates--schedule--type--corrupt))
- `delay` (Attributes) Delay represents the detail about delay action (see [below for nested schema](#nestedatt--spec--templates--schedule--type--delay))
- `device` (String) Device represents the network device to be affected.
- `direction` (String) Direction represents the direction, this applies on netem and network partition action
- `duplicate` (Attributes) DuplicateSpec represents the detail about loss action (see [below for nested schema](#nestedatt--spec--templates--schedule--type--duplicate))
- `duration` (String) Duration represents the duration of the chaos action
- `external_targets` (List of String) ExternalTargets represents network targets outside k8s
- `loss` (Attributes) Loss represents the detail about loss action (see [below for nested schema](#nestedatt--spec--templates--schedule--type--loss))
- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `remote_cluster` (String) RemoteCluster represents the remote cluster where the chaos will be deployed
- `selector` (Attributes) Selector is used to select pods that are used to inject chaos action. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--selector))
- `target` (Attributes) Target represents network target, this applies on netem and network partition action (see [below for nested schema](#nestedatt--spec--templates--schedule--type--target))
- `target_device` (String) TargetDevice represents the network device to be affected in target scope.
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of pods to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of pods the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action

<a id="nestedatt--spec--templates--schedule--type--bandwidth"></a>
### Nested Schema for `spec.templates.schedule.type.bandwidth`
...
<a id="nestedatt--spec--templates--schedule--type--corrupt"></a>
### Nested Schema for `spec.templates.schedule.type.corrupt`
...
- `jitter` (String)
- `latency` (String)
- `reorder` (Attributes) ReorderSpec defines details of packet reorder. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--delay--reorder))

<a id="nestedatt--spec--templates--schedule--type--delay--reorder"></a>
### Nested Schema for `spec.templates.schedule.type.delay.reorder`
...
<a id="nestedatt--spec--templates--schedule--type--duplicate"></a>
### Nested Schema for `spec.templates.schedule.type.duplicate`
...
<a id="nestedatt--spec--templates--schedule--type--loss"></a>
### Nested Schema for `spec.templates.schedule.type.loss`
...
<a id="nestedatt--spec--templates--schedule--type--target"></a>
### Nested Schema for `spec.templates.schedule.type.target`

Read-Only:

- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `selector` (Attributes) Selector is used to select pods that are used to inject chaos action. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--target--selector))
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of pods to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of pods the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action

<a id="nestedatt--spec--templates--schedule--type--target--selector"></a>
### Nested Schema for `spec.templates.schedule.type.target.value`

Read-Only:

- `annotation_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on annotations.
- `expression_selectors` (Attributes List) a slice of label selector expressions that can be used to select objects. A list of selectors based on set-based label expressions. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--target--value--expression_selectors))
- `field_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on fields.
- `label_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on labels.
- `namespaces` (List of String) Namespaces is a set of namespace to which objects belong.
- `node_selectors` (Map of String) Map of string keys and values that can be used to select nodes. Selector which must match a node's labels, and objects must belong to these selected nodes.
...
<a id="nestedatt--spec--templates--schedule--type--target--value--expression_selectors"></a>
### Nested Schema for `spec.templates.schedule.type.target.value.pods`
...
- `action` (String) the subAction, generate automatically
- `address` (List of String) DEPRECATED: Use Selector instead. Only one of Address and Selector could be specified.
- `clock` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--clock))
- `disk_fill` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--disk_fill))
- `disk_read_payload` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--disk_read_payload))
- `disk_write_payload` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--disk_write_payload))
- `duration` (String) Duration represents the duration of the chaos action
- `file_append` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--file_append))
- `file_create` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--file_create))
- `file_delete` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--file_delete))
- `file_modify` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--file_modify))
- `file_rename` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--file_rename))
- `file_replace` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--file_replace))
- `http_abort` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--http_abort))
- `http_config` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--http_config))
- `http_delay` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--http_delay))
- `http_request` (Attributes) used for HTTP request, now only support GET (see [below for nested schema](#nestedatt--spec--templates--schedule--type--http_request))
- `jvm_exception` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_exception))
- `jvm_gc` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_gc))
- `jvm_latency` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_latency))
- `jvm_mysql` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_mysql))
- `jvm_return` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_return))
- `jvm_rule_data` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_rule_data))
- `jvm_stress` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--jvm_stress))
- `kafka_fill` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--kafka_fill))
- `kafka_flood` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--kafka_flood))
- `kafka_io` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--kafka_io))
- `mode` (String) Mode defines the mode to run chaos action. Supported mode: one / all / fixed / fixed-percent / random-max-percent
- `network_bandwidth` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_bandwidth))
- `network_corrupt` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_corrupt))
- `network_delay` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_delay))
- `network_dns` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_dns))
- `network_down` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_down))
- `network_duplicate` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_duplicate))
- `network_flood` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_flood))
- `network_loss` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_loss))
- `network_partition` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--network_partition))
- `process` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--process))
- `redis_cache_limit` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--redis_cache_limit))
- `redis_expiration` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--redis_expiration))
- `redis_penetration` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--redis_penetration))
- `redis_restart` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--redis_restart))
- `redis_stop` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--redis_stop))
- `remote_cluster` (String) RemoteCluster represents the remote cluster where the chaos will be deployed
- `selector` (Attributes) Selector is used to select physical machines that are used to inject chaos action. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--selector))
- `stress_cpu` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--stress_cpu))
- `stress_mem` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--stress_mem))
- `uid` (String) the experiment ID
- `user_defined` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--user_defined))
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of physical machines to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of physical machines the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action
- `vm` (Attributes) (see [below for nested schema](#nestedatt--spec--templates--schedule--type--vm))

<a id="nestedatt--spec--templates--schedule--type--clock"></a>
### Nested Schema for `spec.templates.schedule.type.clock`
...
<a id="nestedatt--spec--templates--schedule--type--disk_fill"></a>
### Nested Schema for `spec.templates.schedule.type.disk_fill`
...
<a id="nestedatt--spec--templates--schedule--type--disk_read_payload"></a>
### Nested Schema for `spec.templates.schedule.type.disk_read_payload`
...
<a id="nestedatt--spec--templates--schedule--type--disk_write_payload"></a>
### Nested Schema for `spec.templates.schedule.type.disk_write_payload`
...
<a id="nestedatt--spec--templates--schedule--type--file_append"></a>
### Nested Schema for `spec.templates.schedule.type.file_append`
...
<a id="nestedatt--spec--templates--schedule--type--file_create"></a>
### Nested Schema for `spec.templates.schedule.type.file_create`
...
<a id="nestedatt--spec--templates--schedule--type--file_delete"></a>
### Nested Schema for `spec.templates.schedule.type.file_delete`
...
<a id="nestedatt--spec--templates--schedule--type--file_modify"></a>
### Nested Schema for `spec.templates.schedule.type.file_modify`
...
<a id="nestedatt--spec--templates--schedule--type--file_rename"></a>
### Nested Schema for `spec.templates.schedule.type.file_rename`
...
<a id="nestedatt--spec--templates--schedule--type--file_replace"></a>
### Nested Schema for `spec.templates.schedule.type.file_replace`
...
<a id="nestedatt--spec--templates--schedule--type--http_abort"></a>
### Nested Schema for `spec.templates.schedule.type.http_abort`
...
<a id="nestedatt--spec--templates--schedule--type--http_config"></a>
### Nested Schema for `spec.templates.schedule.type.http_config`
...
<a id="nestedatt--spec--templates--schedule--type--http_delay"></a>
### Nested Schema for `spec.templates.schedule.type.http_delay`
...
<a id="nestedatt--spec--templates--schedule--type--http_request"></a>
### Nested Schema for `spec.templates.schedule.type.http_request`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_exception"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_exception`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_gc"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_gc`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_latency"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_latency`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_mysql"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_mysql`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_return"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_return`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_rule_data"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_rule_data`
...
<a id="nestedatt--spec--templates--schedule--type--jvm_stress"></a>
### Nested Schema for `spec.templates.schedule.type.jvm_stress`
...
<a id="nestedatt--spec--templates--schedule--type--kafka_fill"></a>
### Nested Schema for `spec.templates.schedule.type.kafka_fill`
...
<a id="nestedatt--spec--templates--schedule--type--kafka_flood"></a>
### Nested Schema for `spec.templates.schedule.type.kafka_flood`
...
<a id="nestedatt--spec--templates--schedule--type--kafka_io"></a>
### Nested Schema for `spec.templates.schedule.type.kafka_io`
...
<a id="nestedatt--spec--templates--schedule--type--network_bandwidth"></a>
### Nested Schema for `spec.templates.schedule.type.network_bandwidth`
...
<a id="nestedatt--spec--templates--schedule--type--network_corrupt"></a>
### Nested Schema for `spec.templates.schedule.type.network_corrupt`
...
<a id="nestedatt--spec--templates--schedule--type--network_delay"></a>
### Nested Schema for `spec.templates.schedule.type.network_delay`
...
<a id="nestedatt--spec--templates--schedule--type--network_dns"></a>
### Nested Schema for `spec.templates.schedule.type.network_dns`
...
<a id="nestedatt--spec--templates--schedule--type--network_down"></a>
### Nested Schema for `spec.templates.schedule.type.network_down`
...
<a id="nestedatt--spec--templates--schedule--type--network_duplicate"></a>
### Nested Schema for `spec.templates.schedule.type.network_duplicate`
...
<a id="nestedatt--spec--templates--schedule--type--network_flood"></a>
### Nested Schema for `spec.templates.schedule.type.network_flood`
...
<a id="nestedatt--spec--templates--schedule--type--network_loss"></a>
### Nested Schema for `spec.templates.schedule.type.network_loss`
...
<a id="nestedatt--spec--templates--schedule--type--network_partition"></a>
### Nested Schema for `spec.templates.schedule.type.network_partition`
...
<a id="nestedatt--spec--templates--schedule--type--process"></a>
### Nested Schema for `spec.templates.schedule.type.process`
...
<a id="nestedatt--spec--templates--schedule--type--redis_cache_limit"></a>
### Nested Schema for `spec.templates.schedule.type.redis_cache_limit`
...
<a id="nestedatt--spec--templates--schedule--type--redis_expiration"></a>
### Nested Schema for `spec.templates.schedule.type.redis_expiration`
...
<a id="nestedatt--spec--templates--schedule--type--redis_penetration"></a>
### Nested Schema for `spec.templates.schedule.type.redis_penetration`
...
<a id="nestedatt--spec--templates--schedule--type--redis_restart"></a>
### Nested Schema for `spec.templates.schedule.type.redis_restart`
...
<a id="nestedatt--spec--templates--schedule--type--redis_stop"></a>
### Nested Schema for `spec.templates.schedule.type.redis_stop`
...
<a id="nestedatt--spec--templates--schedule--type--selector--expression_selectors"></a>
### Nested Schema for `spec.templates.schedule.type.selector.physical_machines`
...
<a id="nestedatt--spec--templates--schedule--type--stress_cpu"></a>
### Nested Schema for `spec.templates.schedule.type.stress_cpu`
...
<a id="nestedatt--spec--templates--schedule--type--stress_mem"></a>
### Nested Schema for `spec.templates.schedule.type.stress_mem`
...
<a id="nestedatt--spec--templates--schedule--type--user_defined"></a>
### Nested Schema for `spec.templates.schedule.type.user_defined`
...
<a id="nestedatt--spec--templates--schedule--type--vm"></a>
### Nested Schema for `spec.templates.schedule.type.vm`
...
- `stressors` (Attributes) Stressors defines plenty of stressors supported to stress system components out. You can use one or more of them to make up various kinds of stresses. At least one of the stressors should be specified. (see [below for nested schema](#nestedatt--spec--templates--schedule--type--stressors))
- `value` (String) Value is required when the mode is set to 'FixedMode' / 'FixedPercentMode' / 'RandomMaxPercentMode'. If 'FixedMode', provide an integer of pods to do chaos action. If 'FixedPercentMode', provide a number from 0-100 to specify the percent of pods the server can do chaos action. IF 'RandomMaxPercentMode',  provide a number from 0-100 to specify the max percent of pods to do chaos action
...
<a id="nestedatt--spec--templates--schedule--type--stressors"></a>
### Nested Schema for `spec.templates.schedule.type.stressors`

Read-Only:

- `cpu` (Attributes) CPUStressor stresses CPU out (see [below for nested schema](#nestedatt--spec--templates--schedule--type--stressors--cpu))
- `memory` (Attributes) MemoryStressor stresses virtual memory out (see [below for nested schema](#nestedatt--spec--templates--schedule--type--stressors--memory))

<a id="nestedatt--spec--templates--schedule--type--stressors--cpu"></a>
### Nested Schema for `spec.templates.schedule.type.stressors.memory`
...
<a id="nestedatt--spec--templates--schedule--type--stressors--memory"></a>
### Nested Schema for `spec.templates.schedule.type.stressors.memory`
...
### Nested Schema for `spec.templates.status_check.type`

Read-Only:

- `body` (String)
- `criteria` (Attributes) Criteria defines how to determine the result of the status check. (see [below for nested schema](#nestedatt--spec--templates--status_check--type--criteria))
...
<a id="nestedatt--spec--templates--status_check--type--criteria"></a>
### Nested Schema for `spec.templates.status_check.type.criteria`
...
- `resize_policy` (Attributes List) Resources resize policy for the container. (see [below for nested schema](#nestedatt--spec--templates--task--volumes--resize_policy))
...
- `grpc` (Attributes) GRPC specifies an action involving a GRPC port. (see [below for nested schema](#nestedatt--spec--templates--task--volumes--liveness_probe--grpc))
...
- `failure_threshold` (Number) Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1.
- `grpc` (Attributes) GRPC specifies an action involving a GRPC port. (see [below for nested schema](#nestedatt--spec--templates--task--volumes--readiness_probe--grpc))
...
<a id="nestedatt--spec--templates--task--volumes--resize_policy"></a>
### Nested Schema for `spec.templates.task.volumes.resize_policy`
...
- `failure_threshold` (Number) Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1.
- `grpc` (Attributes) GRPC specifies an action involving a GRPC port. (see [below for nested schema](#nestedatt--spec--templates--task--volumes--startup_probe--grpc))
...
### Nested Schema for `spec.templates.task.volumes.cinder.volume_id`
...
### Nested Schema for `spec.templates.task.volumes.ephemeral.volume_claim_template.spec.volume_name`
...
- `claims` (Attributes List) Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable. It can only be set for containers. (see [below for nested schema](#nestedatt--spec--templates--task--volumes--ephemeral--volume_claim_template--spec--volume_name--claims))
- `limits` (Map of String) Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
- `requests` (Map of String) Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. Requests cannot exceed Limits. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/

<a id="nestedatt--spec--templates--task--volumes--ephemeral--volume_claim_template--spec--volume_name--claims"></a>
### Nested Schema for `spec.templates.task.volumes.ephemeral.volume_claim_template.spec.volume_name.claims`
...
- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--templates--task--volumes--ephemeral--volume_claim_template--spec--volume_name--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--templates--task--volumes--ephemeral--volume_claim_template--spec--volume_name--match_expressions"></a>
### Nested Schema for `spec.templates.task.volumes.ephemeral.volume_claim_template.spec.volume_name.match_expressions`
...
### Nested Schema for `spec.templates.task.volumes.iscsi.target_portal`
