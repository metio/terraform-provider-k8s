...
page_title: "k8s_pkg_crossplane_io_configuration_revision_v1 Data Source - terraform-provider-k8s"
subcategory: "pkg.crossplane.io"
description: |-
  A ConfigurationRevision that has been added to Crossplane.
---

# k8s_pkg_crossplane_io_configuration_revision_v1 (Data Source)
...
```terraform
data "k8s_pkg_crossplane_io_configuration_revision_v1" "example" {
  metadata = {
    name = "some-name"
