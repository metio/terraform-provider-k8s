...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--target_allocator--prometheus_cr--service_monitor_selector--match_expressions))
- `match_labels` (Map of String)
