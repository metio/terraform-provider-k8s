...
page_title: "k8s_wgpolicyk8s_io_cluster_policy_report_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "wgpolicyk8s.io"
description: |-
  ClusterPolicyReport is the Schema for the clusterpolicyreports API
---

# k8s_wgpolicyk8s_io_cluster_policy_report_v1alpha2 (Data Source)
