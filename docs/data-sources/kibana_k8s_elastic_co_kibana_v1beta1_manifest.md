...
page_title: "k8s_kibana_k8s_elastic_co_kibana_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "kibana.k8s.elastic.co"
description: |-
  Kibana represents a Kibana resource in a Kubernetes cluster.
---

# k8s_kibana_k8s_elastic_co_kibana_v1beta1_manifest (Data Source)
...
```terraform
data "k8s_kibana_k8s_elastic_co_kibana_v1beta1_manifest" "example" {
  metadata = {
    name      = "some-name"
