...
page_title: "k8s_operator_openshift_io_kube_storage_version_migrator_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_operator_openshift_io_kube_storage_version_migrator_v1_manifest (Data Source)
...
```terraform
data "k8s_operator_openshift_io_kube_storage_version_migrator_v1_manifest" "example" {
  metadata = {
    name = "some-name"
