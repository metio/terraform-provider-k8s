...
page_title: "k8s_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "operator.cluster.x-k8s.io"
description: |-
  BootstrapProvider is the Schema for the bootstrapproviders API.
---

# k8s_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1 (Data Source)
...
```terraform
data "k8s_operator_cluster_x_k8s_io_bootstrap_provider_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
