...
page_title: "k8s_wgpolicyk8s_io_policy_report_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "wgpolicyk8s.io"
description: |-
  PolicyReport is the Schema for the policyreports API
---

# k8s_wgpolicyk8s_io_policy_report_v1beta1_manifest (Data Source)
