...
page_title: "k8s_k8s_mariadb_com_database_v1alpha1_manifest Data Source - terraform-provider-k8s"
...
# k8s_k8s_mariadb_com_database_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_k8s_mariadb_com_database_v1alpha1_manifest" "example" {
  metadata = {
    name      = "some-name"
