...
page_title: "k8s_capsule_clastix_io_capsule_configuration_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "capsule.clastix.io"
description: |-
  CapsuleConfiguration is the Schema for the Capsule configuration API.
---

# k8s_capsule_clastix_io_capsule_configuration_v1alpha1 (Data Source)
