...
page_title: "k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1alpha4 Data Source - terraform-provider-k8s"
...
# k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1alpha4 (Data Source)
...
```terraform
data "k8s_infrastructure_cluster_x_k8s_io_v_sphere_machine_v1alpha4" "example" {
  metadata = {
    name      = "some-name"
