...
page_title: "k8s_mariadb_mmontes_io_restore_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "mariadb.mmontes.io"
description: |-
  Restore is the Schema for the restores API
---

# k8s_mariadb_mmontes_io_restore_v1alpha1 (Data Source)
...
### Nested Schema for `spec.volume.cinder.volume_id`
...
### Nested Schema for `spec.volume.iscsi.target_portal`
