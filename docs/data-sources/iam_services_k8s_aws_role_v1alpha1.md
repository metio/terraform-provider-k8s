...
page_title: "k8s_iam_services_k8s_aws_role_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "iam.services.k8s.aws"
description: |-
  Role is the Schema for the Roles API
---

# k8s_iam_services_k8s_aws_role_v1alpha1 (Data Source)
...
```terraform
data "k8s_iam_services_k8s_aws_role_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
