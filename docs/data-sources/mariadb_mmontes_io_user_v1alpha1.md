...
page_title: "k8s_mariadb_mmontes_io_user_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "mariadb.mmontes.io"
description: |-
  User is the Schema for the users API
---

# k8s_mariadb_mmontes_io_user_v1alpha1 (Data Source)
...
```terraform
data "k8s_mariadb_mmontes_io_user_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
