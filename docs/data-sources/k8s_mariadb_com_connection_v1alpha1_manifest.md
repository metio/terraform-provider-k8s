...
page_title: "k8s_k8s_mariadb_com_connection_v1alpha1_manifest Data Source - terraform-provider-k8s"
...
# k8s_k8s_mariadb_com_connection_v1alpha1_manifest (Data Source)
...
- `metadata` (Attributes) Metadata to be added to the Secret object. (see [below for nested schema](#nestedatt--spec--secret_template--metadata))
...
<a id="nestedatt--spec--secret_template--metadata"></a>
### Nested Schema for `spec.secret_template.metadata`
