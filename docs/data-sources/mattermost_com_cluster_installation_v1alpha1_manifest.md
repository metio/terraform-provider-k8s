...
page_title: "k8s_mattermost_com_cluster_installation_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "mattermost.com"
description: |-
  ClusterInstallation is the Schema for the clusterinstallations API
---

# k8s_mattermost_com_cluster_installation_v1alpha1_manifest (Data Source)
...
### Nested Schema for `spec.database.resources.claims`
...
### Nested Schema for `spec.minio.resources.claims`
