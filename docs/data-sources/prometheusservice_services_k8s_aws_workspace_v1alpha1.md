...
page_title: "k8s_prometheusservice_services_k8s_aws_workspace_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "prometheusservice.services.k8s.aws"
description: |-
  Workspace is the Schema for the Workspaces API
---

# k8s_prometheusservice_services_k8s_aws_workspace_v1alpha1 (Data Source)
