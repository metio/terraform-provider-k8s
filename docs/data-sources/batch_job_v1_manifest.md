...
page_title: "k8s_batch_job_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "batch"
description: |-
  Job represents the configuration of a single job.
---

# k8s_batch_job_v1_manifest (Data Source)
...
- `spec` (Attributes) JobSpec describes how the job execution will look like. (see [below for nested schema](#nestedatt--spec))
...
- `pod_failure_policy` (Attributes) PodFailurePolicy describes how failed pods influence the backoffLimit. (see [below for nested schema](#nestedatt--spec--pod_failure_policy))
...
- `success_policy` (Attributes) SuccessPolicy describes when a Job can be declared as succeeded based on the success of some indexes. (see [below for nested schema](#nestedatt--spec--success_policy))
...
<a id="nestedatt--spec--pod_failure_policy--rules--on_pod_conditions"></a>
### Nested Schema for `spec.pod_failure_policy.rules.on_pod_conditions`
