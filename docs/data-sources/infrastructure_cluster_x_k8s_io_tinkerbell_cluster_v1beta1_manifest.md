...
- `control_plane_endpoint` (Attributes) ControlPlaneEndpoint is a required field by ClusterAPI v1beta1.See https://cluster-api.sigs.k8s.io/developer/architecture/controllers/cluster.htmlfor more details. (see [below for nested schema](#nestedatt--spec--control_plane_endpoint))
