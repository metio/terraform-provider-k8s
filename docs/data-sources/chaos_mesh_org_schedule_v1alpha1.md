...
page_title: "k8s_chaos_mesh_org_schedule_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "chaos-mesh.org"
description: |-
  Schedule is the cronly schedule object
---

# k8s_chaos_mesh_org_schedule_v1alpha1 (Data Source)
...
### Nested Schema for `spec.workflow.templates.time_chaos.block_chaos.volume_name`
...
- `annotation_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on annotations.
- `expression_selectors` (Attributes List) a slice of label selector expressions that can be used to select objects. A list of selectors based on set-based label expressions. (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--block_chaos--volume_name--expression_selectors))
- `field_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on fields.
- `label_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on labels.
- `namespaces` (List of String) Namespaces is a set of namespace to which objects belong.
- `node_selectors` (Map of String) Map of string keys and values that can be used to select nodes. Selector which must match a node's labels, and objects must belong to these selected nodes.
...
<a id="nestedatt--spec--workflow--templates--time_chaos--block_chaos--volume_name--expression_selectors"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.block_chaos.volume_name.pods`
...
### Nested Schema for `spec.workflow.templates.time_chaos.io_chaos.volume_path`

Read-Only:

- `atime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--atime))
- `blocks` (Number)
- `ctime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--ctime))
- `gid` (Number)
- `ino` (Number)
- `kind` (String) FileType represents type of file
- `mtime` (Attributes) Timespec represents a time (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--mtime))
- `nlink` (Number)
- `perm` (Number)
- `rdev` (Number)
- `size` (Number)
...
<a id="nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--atime"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.io_chaos.volume_path.uid`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--ctime"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.io_chaos.volume_path.uid`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--mtime"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.io_chaos.volume_path.uid`
...
- `annotation_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on annotations.
- `expression_selectors` (Attributes List) a slice of label selector expressions that can be used to select objects. A list of selectors based on set-based label expressions. (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--expression_selectors))
- `field_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on fields.
- `label_selectors` (Map of String) Map of string keys and values that can be used to select objects. A selector based on labels.
- `namespaces` (List of String) Namespaces is a set of namespace to which objects belong.
- `node_selectors` (Map of String) Map of string keys and values that can be used to select nodes. Selector which must match a node's labels, and objects must belong to these selected nodes.
...
<a id="nestedatt--spec--workflow--templates--time_chaos--io_chaos--volume_path--expression_selectors"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.io_chaos.volume_path.pods`
...
### Nested Schema for `spec.workflow.templates.time_chaos.http.url`
...
- `resize_policy` (Attributes List) Resources resize policy for the container. (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--container--resize_policy))
...
- `grpc` (Attributes) GRPC specifies an action involving a GRPC port. (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--container--working_dir--grpc))
...
<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--secret_ref"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_id`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--data_source"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_claim_template.spec.data_source`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--data_source_ref"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_claim_template.spec.data_source_ref`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--resources"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_claim_template.spec.resources`

Read-Only:

- `claims` (Attributes List) Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable. It can only be set for containers. (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--resources--claims))
- `limits` (Map of String) Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
- `requests` (Map of String) Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. Requests cannot exceed Limits. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/

<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--resources--claims"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_claim_template.spec.resources.requests`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--selector"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_claim_template.spec.selector`

Read-Only:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--volume_claim_template--spec--selector--match_expressions"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.volume_claim_template.spec.selector.match_labels`
...
<a id="nestedatt--spec--workflow--templates--time_chaos--volumes--vsphere_volume--secret_ref"></a>
### Nested Schema for `spec.workflow.templates.time_chaos.volumes.vsphere_volume.target_portal`
