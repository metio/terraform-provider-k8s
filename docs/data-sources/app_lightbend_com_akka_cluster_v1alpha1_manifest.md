...
page_title: "k8s_app_lightbend_com_akka_cluster_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "app.lightbend.com"
description: |-
  AkkaCluster is the Schema for the akkaclusters API
---

# k8s_app_lightbend_com_akka_cluster_v1alpha1_manifest (Data Source)
...
### Nested Schema for `spec.template.spec.volumes.projected.default_mode.config_map`
...
### Nested Schema for `spec.template.spec.volumes.projected.default_mode.downward_api`
...
### Nested Schema for `spec.template.spec.volumes.projected.default_mode.secret`
