...
page_title: "k8s_apps_deployment_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "apps"
description: |-
  Deployment enables declarative updates for Pods and ReplicaSets.
---

# k8s_apps_deployment_v1_manifest (Data Source)
...
- `strategy` (Attributes) DeploymentStrategy describes how to replace existing pods with new ones. (see [below for nested schema](#nestedatt--spec--strategy))
...
- `rolling_update` (Attributes) Spec to control the desired behavior of rolling update. (see [below for nested schema](#nestedatt--spec--strategy--rolling_update))
...
- `max_surge` (String) IntOrString is a type that can hold an int32 or a string. When used in JSON or YAML marshalling and unmarshalling, it produces or consumes the inner type. This allows you to have, for example, a JSON field that can accept a name or number.
