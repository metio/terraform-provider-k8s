...
page_title: "k8s_kustomize_toolkit_fluxcd_io_kustomization_v1 Data Source - terraform-provider-k8s"
subcategory: "kustomize.toolkit.fluxcd.io"
description: |-
  Kustomization is the Schema for the kustomizations API.
---

# k8s_kustomize_toolkit_fluxcd_io_kustomization_v1 (Data Source)
