...
page_title: "k8s_kyverno_io_update_request_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  UpdateRequest is a request to process mutate and generate rules in background.
---

# k8s_kyverno_io_update_request_v1beta1 (Data Source)
...
```terraform
data "k8s_kyverno_io_update_request_v1beta1" "example" {
  metadata = {
    name      = "some-name"
