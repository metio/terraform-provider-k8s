...
page_title: "k8s_forklift_konveyor_io_network_map_v1beta1_manifest Data Source - terraform-provider-k8s"
subcategory: "forklift.konveyor.io"
description: |-
  
---

# k8s_forklift_konveyor_io_network_map_v1beta1_manifest (Data Source)
...
- `spec` (Attributes) Network map spec. (see [below for nested schema](#nestedatt--spec))
...
- `destination` (Attributes) Destination network. (see [below for nested schema](#nestedatt--spec--map--destination))
- `source` (Attributes) Source network. (see [below for nested schema](#nestedatt--spec--map--source))
...
- `namespace` (String) The namespace (multus only).
