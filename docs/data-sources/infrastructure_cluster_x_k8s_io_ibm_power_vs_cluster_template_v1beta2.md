...
page_title: "k8s_infrastructure_cluster_x_k8s_io_ibm_power_vs_cluster_template_v1beta2 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  IBMPowerVSClusterTemplate is the schema for IBM Power VS Kubernetes Cluster Templates.
---

# k8s_infrastructure_cluster_x_k8s_io_ibm_power_vs_cluster_template_v1beta2 (Data Source)
