...
page_title: "k8s_bpfd_dev_uprobe_program_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "bpfd.dev"
description: |-
  UprobeProgram is the Schema for the UprobePrograms API
---

# k8s_bpfd_dev_uprobe_program_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_bpfd_dev_uprobe_program_v1alpha1_manifest" "example" {
  metadata = {
    name = "some-name"
...
- `target` (List of String) Library name or the absolute path to a binary or library.
