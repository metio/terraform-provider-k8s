...
page_title: "k8s_mutations_gatekeeper_sh_assign_v1_manifest Data Source - terraform-provider-k8s"
subcategory: "mutations.gatekeeper.sh"
description: |-
  Assign is the Schema for the assign API.
---

# k8s_mutations_gatekeeper_sh_assign_v1_manifest (Data Source)
