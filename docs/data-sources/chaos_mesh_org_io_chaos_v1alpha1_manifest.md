...
page_title: "k8s_chaos_mesh_org_io_chaos_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "chaos-mesh.org"
description: |-
  IOChaos is the Schema for the iochaos API
---

# k8s_chaos_mesh_org_io_chaos_v1alpha1_manifest (Data Source)
...
```terraform
data "k8s_chaos_mesh_org_io_chaos_v1alpha1_manifest" "example" {
  metadata = {
    name      = "some-name"
