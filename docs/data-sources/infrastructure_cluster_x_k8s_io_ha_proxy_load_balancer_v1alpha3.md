...
page_title: "k8s_infrastructure_cluster_x_k8s_io_ha_proxy_load_balancer_v1alpha3 Data Source - terraform-provider-k8s"
...
# k8s_infrastructure_cluster_x_k8s_io_ha_proxy_load_balancer_v1alpha3 (Data Source)
...
- `spec` (Attributes) HAProxyLoadBalancerSpec defines the desired state of HAProxyLoadBalancer. (see [below for nested schema](#nestedatt--spec))
...
- `user` (Attributes) SSHUser specifies the name of a user that is granted remote access to the deployed VM. (see [below for nested schema](#nestedatt--spec--user))
- `virtual_machine_configuration` (Attributes) VirtualMachineConfiguration is information used to deploy a load balancer VM. (see [below for nested schema](#nestedatt--spec--virtual_machine_configuration))
...
- `authorized_keys` (List of String) AuthorizedKeys is one or more public SSH keys that grant remote access.
- `name` (String) Name is the name of the SSH user.


<a id="nestedatt--spec--virtual_machine_configuration"></a>
### Nested Schema for `spec.virtual_machine_configuration`
...
- `network` (Attributes) Network is the network configuration for this machine's VM. (see [below for nested schema](#nestedatt--spec--virtual_machine_configuration--network))
...
<a id="nestedatt--spec--virtual_machine_configuration--network"></a>
### Nested Schema for `spec.virtual_machine_configuration.network`

Read-Only:

- `devices` (Attributes List) Devices is the list of network devices used by the virtual machine. TODO(akutz) Make sure at least one network matches the ClusterSpec.CloudProviderConfiguration.Network.Name (see [below for nested schema](#nestedatt--spec--virtual_machine_configuration--network--devices))
...
- `routes` (Attributes List) Routes is a list of optional, static routes applied to the virtual machine. (see [below for nested schema](#nestedatt--spec--virtual_machine_configuration--network--routes))

<a id="nestedatt--spec--virtual_machine_configuration--network--devices"></a>
### Nested Schema for `spec.virtual_machine_configuration.network.routes`
...
- `routes` (Attributes List) Routes is a list of optional, static routes applied to the device. (see [below for nested schema](#nestedatt--spec--virtual_machine_configuration--network--routes--routes))
- `search_domains` (List of String) SearchDomains is a list of search domains used when resolving IP addresses with DNS.

<a id="nestedatt--spec--virtual_machine_configuration--network--routes--routes"></a>
### Nested Schema for `spec.virtual_machine_configuration.network.routes.routes`
...
<a id="nestedatt--spec--virtual_machine_configuration--network--routes"></a>
### Nested Schema for `spec.virtual_machine_configuration.network.routes`
