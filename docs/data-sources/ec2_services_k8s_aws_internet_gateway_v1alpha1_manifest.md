...
page_title: "k8s_ec2_services_k8s_aws_internet_gateway_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "ec2.services.k8s.aws"
description: |-
  InternetGateway is the Schema for the InternetGateways API
---

# k8s_ec2_services_k8s_aws_internet_gateway_v1alpha1_manifest (Data Source)
