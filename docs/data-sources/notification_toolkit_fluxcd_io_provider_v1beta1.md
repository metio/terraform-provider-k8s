...
page_title: "k8s_notification_toolkit_fluxcd_io_provider_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "notification.toolkit.fluxcd.io"
description: |-
  Provider is the Schema for the providers API
---

# k8s_notification_toolkit_fluxcd_io_provider_v1beta1 (Data Source)
