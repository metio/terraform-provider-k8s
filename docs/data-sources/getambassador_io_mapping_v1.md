...
page_title: "k8s_getambassador_io_mapping_v1 Data Source - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  Mapping is the Schema for the mappings API
---

# k8s_getambassador_io_mapping_v1 (Data Source)
...
```terraform
data "k8s_getambassador_io_mapping_v1" "example" {
  metadata = {
    name      = "some-name"
