...
- `spec` (Attributes) RestoreSpec can either contain an S3 restore point or a local one. For the local one you need to define an existing PVC. (see [below for nested schema](#nestedatt--spec))
