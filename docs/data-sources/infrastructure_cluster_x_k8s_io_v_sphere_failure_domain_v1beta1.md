...
page_title: "k8s_infrastructure_cluster_x_k8s_io_v_sphere_failure_domain_v1beta1 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  VSphereFailureDomain is the Schema for the vspherefailuredomains API
---

# k8s_infrastructure_cluster_x_k8s_io_v_sphere_failure_domain_v1beta1 (Data Source)
