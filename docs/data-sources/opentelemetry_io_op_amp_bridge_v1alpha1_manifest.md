...
page_title: "k8s_opentelemetry_io_op_amp_bridge_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "opentelemetry.io"
description: |-
  
---

# k8s_opentelemetry_io_op_amp_bridge_v1alpha1_manifest (Data Source)
...
<a id="nestedatt--spec--pod_dns_config"></a>
### Nested Schema for `spec.pod_dns_config`

Optional:

- `nameservers` (List of String)
- `options` (Attributes List) (see [below for nested schema](#nestedatt--spec--pod_dns_config--options))
- `searches` (List of String)

<a id="nestedatt--spec--pod_dns_config--options"></a>
### Nested Schema for `spec.pod_dns_config.options`
