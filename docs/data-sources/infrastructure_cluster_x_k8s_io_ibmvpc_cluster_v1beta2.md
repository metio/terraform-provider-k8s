...
page_title: "k8s_infrastructure_cluster_x_k8s_io_ibmvpc_cluster_v1beta2 Data Source - terraform-provider-k8s"
subcategory: "infrastructure.cluster.x-k8s.io"
description: |-
  IBMVPCCluster is the Schema for the ibmvpcclusters API.
---

# k8s_infrastructure_cluster_x_k8s_io_ibmvpc_cluster_v1beta2 (Data Source)
