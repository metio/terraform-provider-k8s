...
page_title: "k8s_operator_openshift_io_insights_operator_v1_manifest Data Source - terraform-provider-k8s"
...
# k8s_operator_openshift_io_insights_operator_v1_manifest (Data Source)
...
```terraform
data "k8s_operator_openshift_io_insights_operator_v1_manifest" "example" {
  metadata = {
    name = "some-name"
...
- `spec` (Attributes) spec is the specification of the desired behavior of the Insights. (see [below for nested schema](#nestedatt--spec))
