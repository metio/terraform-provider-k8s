...
page_title: "k8s_rocketmq_apache_org_name_service_v1alpha1 Data Source - terraform-provider-k8s"
subcategory: "rocketmq.apache.org"
description: |-
  NameService is the Schema for the nameservices API
---

# k8s_rocketmq_apache_org_name_service_v1alpha1 (Data Source)
...
```terraform
data "k8s_rocketmq_apache_org_name_service_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
