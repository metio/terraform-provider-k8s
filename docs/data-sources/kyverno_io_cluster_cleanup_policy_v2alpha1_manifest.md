...
page_title: "k8s_kyverno_io_cluster_cleanup_policy_v2alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  ClusterCleanupPolicy defines rule for resource cleanup.
---

# k8s_kyverno_io_cluster_cleanup_policy_v2alpha1_manifest (Data Source)
