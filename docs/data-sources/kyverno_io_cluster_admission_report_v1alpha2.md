...
page_title: "k8s_kyverno_io_cluster_admission_report_v1alpha2 Data Source - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  ClusterAdmissionReport is the Schema for the ClusterAdmissionReports API
---

# k8s_kyverno_io_cluster_admission_report_v1alpha2 (Data Source)
