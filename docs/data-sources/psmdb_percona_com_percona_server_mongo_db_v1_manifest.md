...
- `node_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--advanced--node_affinity))
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--spec"></a>
...
- `photon_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--photon_persistent_disk))
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--iscsi"></a>
...
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.env_from`

Optional:

- `config_map_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--env_from--config_map_ref))
- `prefix` (String)
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--env_from--secret_ref"></a>
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.lifecycle`

Optional:

- `post_start` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--post_start))
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--pre_stop--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--pre_stop--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--pre_stop--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--pre_stop--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--pre_stop--tcp_socket"></a>
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--lifecycle--pre_stop"></a>
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--liveness_probe"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.liveness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--liveness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--liveness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--liveness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--liveness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--liveness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--ports"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.ports`
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--readiness_probe"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.readiness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--readiness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--readiness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--readiness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--readiness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--readiness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--resize_policy"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.resize_policy`
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--resources"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.resources`

Optional:

- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--resources--claims))
- `limits` (Map of String)
- `requests` (Map of String)
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--security_context"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.security_context`
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--security_context--windows_options"></a>
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--startup_probe"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.startup_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--startup_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--startup_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--startup_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--startup_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--arbiter--topology_spread_constraints--startup_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--volume_devices"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.volume_devices`
...
<a id="nestedatt--spec--replsets--arbiter--topology_spread_constraints--volume_mounts"></a>
### Nested Schema for `spec.replsets.arbiter.topology_spread_constraints.volume_mounts`
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--liveness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)

<a id="nestedatt--spec--replsets--liveness_probe--timeout_seconds--http_headers"></a>
### Nested Schema for `spec.replsets.liveness_probe.timeout_seconds.http_headers`
...
- `advanced` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced))
- `anti_affinity_topology_key` (String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced`

Optional:

- `node_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--node_affinity))
- `pod_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_affinity))
...
- `preferred_during_scheduling_ignored_during_execution` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution))
...
- `preference` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference))
- `weight` (Number)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_expressions))
- `match_fields` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_fields))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_expressions"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.match_expressions`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_fields"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.match_fields`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution"></a>
...
- `node_selector_terms` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions))
- `match_fields` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_expressions`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_fields`
...
- `pod_affinity_term` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term))
- `weight` (Number)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector))
- `namespaces` (List of String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.namespace_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector--match_expressions))
- `match_labels` (Map of String)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespace_selector))
- `namespaces` (List of String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.namespaces.match_expressions`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--advanced--pod_anti_affinity"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--seccomp_profile"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.seccomp_profile`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--windows_options"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.windows_options`
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `startup_delay_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--exec"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.exec`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--grpc"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.grpc`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--http_get"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.http_get`
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--http_get--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--tcp_socket"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.tcp_socket`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--sysctls"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.sysctls`
...
- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--claims))
- `limits` (Map of String)
- `requests` (Map of String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--claims"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.claims`
...
- `kind` (String)
- `metadata` (Map of String)
- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--spec))
- `status` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--status))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--spec"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.spec`

Optional:

- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--spec--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--spec--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--spec--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--spec--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--spec--volume_name--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--status"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.status`
...
- `allocated_resources` (Map of String)
- `capacity` (Map of String)
- `conditions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--status--conditions))
- `current_volume_attributes_class_name` (String)
- `modify_volume_status` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--status--modify_volume_status))
- `phase` (String)
...
- `aws_elastic_block_store` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--aws_elastic_block_store))
- `azure_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--azure_disk))
- `azure_file` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--azure_file))
- `cephfs` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--cephfs))
- `cinder` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--cinder))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--config_map))
- `csi` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--csi))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--downward_api))
- `empty_dir` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--empty_dir))
- `ephemeral` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral))
- `fc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--fc))
- `flex_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--flex_volume))
- `flocker` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--flocker))
- `gce_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--gce_persistent_disk))
- `git_repo` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--git_repo))
- `glusterfs` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--glusterfs))
- `host_path` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--host_path))
- `iscsi` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--iscsi))
- `nfs` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--nfs))
...
- `photon_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--photon_persistent_disk))
- `portworx_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--portworx_volume))
- `projected` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected))
- `quobyte` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--quobyte))
- `rbd` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--rbd))
- `scale_io` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--scale_io))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--secret))
- `storageos` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--storageos))
- `vsphere_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--vsphere_volume))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--aws_elastic_block_store"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.aws_elastic_block_store`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--azure_disk"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.azure_disk`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--azure_file"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.azure_file`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--cephfs"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.cephfs`
...
- `read_only` (Boolean)
- `secret_file` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--cephfs--secret_ref))
- `user` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--cinder"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.cinder`
...
- `fs_type` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--cinder--secret_ref))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--cinder--secret_ref"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.cinder.secret_ref`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--config_map"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.config_map`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--config_map--items))
- `name` (String)
- `optional` (Boolean)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--csi"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.csi`
...
- `fs_type` (String)
- `node_publish_secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--csi--node_publish_secret_ref))
- `read_only` (Boolean)
- `volume_attributes` (Map of String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--downward_api"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.downward_api`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--downward_api--items))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--downward_api--items"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.downward_api.items`
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--downward_api--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--downward_api--items--resource_field_ref"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.ephemeral`

Optional:

- `volume_claim_template` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.ephemeral.volume_claim_template`

Required:

- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--spec))
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--metadata--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--metadata--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--metadata--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--metadata--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--metadata--volume_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--ephemeral--volume_claim_template--metadata--volume_name--match_expressions"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.ephemeral.volume_claim_template.metadata.volume_name.match_expressions`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--fc"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.fc`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--flex_volume"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.flex_volume`
...
- `options` (Map of String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--flex_volume--secret_ref))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--flex_volume--secret_ref"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.flex_volume.secret_ref`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--flocker"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.flocker`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--gce_persistent_disk"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.gce_persistent_disk`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--git_repo"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.git_repo`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--glusterfs"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.glusterfs`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--iscsi"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.iscsi`
...
- `portals` (List of String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--iscsi--secret_ref))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--iscsi--secret_ref"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.iscsi.secret_ref`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--nfs"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.nfs`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--photon_persistent_disk"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.photon_persistent_disk`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--portworx_volume"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.portworx_volume`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--projected"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.projected`

Optional:

- `default_mode` (Number)
- `sources` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.projected.sources`

Optional:

- `cluster_trust_bundle` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--cluster_trust_bundle))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--config_map))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--downward_api))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--secret))
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--label_selector))
- `name` (String)
- `optional` (Boolean)
- `signer_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--signer_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--signer_name--match_expressions"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.projected.sources.service_account_token.signer_name.match_expressions`
...
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--items))
- `name` (String)
- `optional` (Boolean)
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--items--field_ref))
- `mode` (Number)
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--items--resource_field_ref))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--items--field_ref"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.projected.sources.service_account_token.items.field_ref`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token--items--resource_field_ref"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.projected.sources.service_account_token.items.resource_field_ref`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--projected--sources--service_account_token"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--quobyte"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.quobyte`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--rbd"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.rbd`
...
- `pool` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--rbd--secret_ref))
- `user` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--scale_io"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.scale_io`

Required:

- `gateway` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--scale_io--secret_ref))
- `system` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--secret"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.secret`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--secret--items))
- `optional` (Boolean)
- `secret_name` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--storageos"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.storageos`

Optional:

- `fs_type` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--storageos--secret_ref))
- `volume_name` (String)
- `volume_namespace` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--vsphere_volume"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.vsphere_volume`
...
- `args` (List of String)
- `command` (List of String)
- `env` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env))
- `env_from` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env_from))
- `image` (String)
- `image_pull_policy` (String)
- `lifecycle` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle))
- `liveness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe))
- `ports` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--ports))
- `readiness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe))
- `resize_policy` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--resize_policy))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--resources))
- `restart_policy` (String)
- `security_context` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--security_context))
- `startup_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe))
- `stdin` (Boolean)
- `stdin_once` (Boolean)
- `termination_message_path` (String)
- `termination_message_policy` (String)
- `tty` (Boolean)
- `volume_devices` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--volume_devices))
- `volume_mounts` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--volume_mounts))
- `working_dir` (String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--env"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.env`
...
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env--value_from))

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--env--value_from"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.env.value_from`

Optional:

- `config_map_key_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env--value_from--config_map_key_ref))
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env--value_from--field_ref))
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env--value_from--resource_field_ref))
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--env--value_from--secret_key_ref"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--env_from"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.env_from`

Optional:

- `config_map_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--env_from--config_map_ref))
- `prefix` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--env_from--secret_ref"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.lifecycle`

Optional:

- `post_start` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--post_start))
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--pre_stop--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--pre_stop--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--pre_stop--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--pre_stop--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--pre_stop--tcp_socket"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--lifecycle--pre_stop"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.liveness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--liveness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--ports"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.ports`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.readiness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--readiness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--resize_policy"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.resize_policy`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--resources"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.resources`

Optional:

- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--resources--claims))
- `limits` (Map of String)
- `requests` (Map of String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--security_context"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.security_context`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--security_context--windows_options"></a>
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.startup_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--startup_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--volume_devices"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.volume_devices`
...
<a id="nestedatt--spec--replsets--nonvoting--volume_spec--volume_mounts"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.volume_mounts`
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--label_selector))
- `match_label_keys` (List of String)
- `min_domains` (Number)
- `node_affinity_policy` (String)
- `node_taints_policy` (String)

<a id="nestedatt--spec--replsets--nonvoting--volume_spec--label_selector"></a>
### Nested Schema for `spec.replsets.nonvoting.volume_spec.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--label_selector--match_expressions))
- `match_labels` (Map of String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--nonvoting--volume_spec--persistent_volume_claim--volume_name--match_expressions))
- `match_labels` (Map of String)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--readiness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)

<a id="nestedatt--spec--replsets--readiness_probe--timeout_seconds--http_headers"></a>
### Nested Schema for `spec.replsets.readiness_probe.timeout_seconds.http_headers`
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_pv_cs--status--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_pv_cs--status--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_pv_cs--status--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_pv_cs--status--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)

<a id="nestedatt--spec--replsets--sidecar_pv_cs--status--data_source"></a>
### Nested Schema for `spec.replsets.sidecar_pv_cs.status.data_source`
...
<a id="nestedatt--spec--replsets--sidecar_pv_cs--status--data_source_ref"></a>
### Nested Schema for `spec.replsets.sidecar_pv_cs.status.data_source_ref`
...
<a id="nestedatt--spec--replsets--sidecar_pv_cs--status--resources"></a>
### Nested Schema for `spec.replsets.sidecar_pv_cs.status.resources`
...
<a id="nestedatt--spec--replsets--sidecar_pv_cs--status--selector"></a>
### Nested Schema for `spec.replsets.sidecar_pv_cs.status.selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_pv_cs--status--selector--match_expressions))
- `match_labels` (Map of String)
...
- `read_only` (Boolean)
- `secret_file` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--secret_ref))
- `user` (String)

<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--secret_ref"></a>
### Nested Schema for `spec.replsets.sidecar_volumes.vsphere_volume.secret_ref`
...
- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--items))
- `name` (String)
- `optional` (Boolean)

<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--items"></a>
### Nested Schema for `spec.replsets.sidecar_volumes.vsphere_volume.items`
...
- `fs_type` (String)
- `node_publish_secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--node_publish_secret_ref))
- `read_only` (Boolean)
- `volume_attributes` (Map of String)

<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--node_publish_secret_ref"></a>
### Nested Schema for `spec.replsets.sidecar_volumes.vsphere_volume.node_publish_secret_ref`
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--items--resource_field_ref"></a>
...
- `volume_claim_template` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template))

<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template"></a>
### Nested Schema for `spec.replsets.sidecar_volumes.vsphere_volume.volume_claim_template`

Required:

- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template--spec))
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--volume_name--match_expressions))
- `match_labels` (Map of String)
...
- `default_mode` (Number)
- `sources` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources))

<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources"></a>
### Nested Schema for `spec.replsets.sidecar_volumes.vsphere_volume.sources`

Optional:

- `cluster_trust_bundle` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--cluster_trust_bundle))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--config_map))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--downward_api))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--secret))
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--service_account_token--label_selector))
- `name` (String)
- `optional` (Boolean)
- `signer_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--service_account_token--signer_name--match_expressions))
- `match_labels` (Map of String)
...
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--service_account_token--items))
- `name` (String)
- `optional` (Boolean)
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--service_account_token--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--service_account_token--items--resource_field_ref"></a>
...
<a id="nestedatt--spec--replsets--sidecar_volumes--vsphere_volume--sources--service_account_token"></a>
...
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--value_from))

<a id="nestedatt--spec--replsets--sidecars--working_dir--value_from"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.value_from`

Optional:

- `config_map_key_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--value_from--config_map_key_ref))
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--value_from--field_ref))
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--value_from--resource_field_ref))
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--value_from--secret_key_ref"></a>
...
- `config_map_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--config_map_ref))
- `prefix` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--secret_ref))

<a id="nestedatt--spec--replsets--sidecars--working_dir--config_map_ref"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.config_map_ref`
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--secret_ref"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.secret_ref`
...
- `post_start` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--post_start))
- `pre_stop` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--pre_stop))

<a id="nestedatt--spec--replsets--sidecars--working_dir--post_start"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.post_start`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--post_start--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--post_start--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--post_start--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--post_start--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--post_start--tcp_socket"></a>
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--pre_stop"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.pre_stop`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--pre_stop--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--pre_stop--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--pre_stop--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--pre_stop--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--pre_stop--tcp_socket"></a>
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)

<a id="nestedatt--spec--replsets--sidecars--working_dir--exec"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.exec`
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--grpc"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.grpc`
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--http_get"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.http_get`
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--http_get--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--tcp_socket"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.tcp_socket`
...
- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--sidecars--working_dir--claims))
- `limits` (Map of String)
- `requests` (Map of String)

<a id="nestedatt--spec--replsets--sidecars--working_dir--claims"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.claims`
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--se_linux_options"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.se_linux_options`
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--seccomp_profile"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.seccomp_profile`
...
<a id="nestedatt--spec--replsets--sidecars--working_dir--windows_options"></a>
### Nested Schema for `spec.replsets.sidecars.working_dir.windows_options`
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--replsets--topology_spread_constraints--node_taints_policy--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--replsets--topology_spread_constraints--node_taints_policy--match_expressions"></a>
### Nested Schema for `spec.replsets.topology_spread_constraints.node_taints_policy.match_expressions`
...
- `advanced` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced))
- `anti_affinity_topology_key` (String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced`

Optional:

- `node_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--node_affinity))
- `pod_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_affinity))
...
- `preferred_during_scheduling_ignored_during_execution` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution))
...
- `preference` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference))
- `weight` (Number)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_expressions))
- `match_fields` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_fields))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_expressions"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.match_expressions`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_fields"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.match_fields`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution"></a>
...
- `node_selector_terms` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions))
- `match_fields` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_expressions`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_fields`
...
- `pod_affinity_term` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term))
- `weight` (Number)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector))
- `namespaces` (List of String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.namespace_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector--match_expressions))
- `match_labels` (Map of String)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespace_selector))
- `namespaces` (List of String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.namespaces.match_expressions`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--advanced--pod_anti_affinity"></a>
...
- `affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity))
- `annotations` (Map of String)
- `labels` (Map of String)
- `node_selector` (Map of String)
- `pod_disruption_budget` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_disruption_budget))
- `priority_class_name` (String)
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resources))
- `runtime_class_name` (String)
- `service_account_name` (String)
- `sidecar_pv_cs` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs))
- `sidecar_volumes` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes))
- `sidecars` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars))
- `termination_grace_period_seconds` (Number)
- `tolerations` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--tolerations))
- `topology_spread_constraints` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--topology_spread_constraints))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.affinity`

Optional:

- `advanced` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--advanced))
- `anti_affinity_topology_key` (String)
...
- `node_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--node_affinity))
- `pod_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_affinity))
...
- `preferred_during_scheduling_ignored_during_execution` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution))
...
- `preference` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference))
- `weight` (Number)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.affinity.anti_affinity_topology_key.pod_anti_affinity.required_during_scheduling_ignored_during_execution.preference`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference--match_expressions))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference--match_fields"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution"></a>
...
- `node_selector_terms` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.affinity.anti_affinity_topology_key.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields"></a>
...
- `pod_affinity_term` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term))
- `weight` (Number)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.affinity.anti_affinity_topology_key.pod_anti_affinity.required_during_scheduling_ignored_during_execution.pod_affinity_term`
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term--namespace_selector))
- `namespaces` (List of String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term--namespaces--match_expressions))
- `match_labels` (Map of String)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespace_selector))
- `namespaces` (List of String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--label_selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.affinity.anti_affinity_topology_key.pod_anti_affinity.required_during_scheduling_ignored_during_execution.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--label_selector--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespace_selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.affinity.anti_affinity_topology_key.pod_anti_affinity.required_during_scheduling_ignored_during_execution.namespace_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespace_selector--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--affinity--anti_affinity_topology_key--pod_anti_affinity"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_disruption_budget"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.pod_disruption_budget`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resources"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.resources`

Optional:

- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resources--claims))
- `limits` (Map of String)
- `requests` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_pv_cs`
...
- `kind` (String)
- `metadata` (Map of String)
- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--spec))
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--volume_name--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status"></a>
...
- `allocated_resources` (Map of String)
- `capacity` (Map of String)
- `conditions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--conditions))
- `current_volume_attributes_class_name` (String)
- `modify_volume_status` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs--status--modify_volume_status))
- `phase` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes`
...
- `aws_elastic_block_store` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--aws_elastic_block_store))
- `azure_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--azure_disk))
- `azure_file` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--azure_file))
- `cephfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--cephfs))
- `cinder` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--cinder))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--config_map))
- `csi` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--csi))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--downward_api))
- `empty_dir` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--empty_dir))
- `ephemeral` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--ephemeral))
- `fc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--fc))
- `flex_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--flex_volume))
- `flocker` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--flocker))
- `gce_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--gce_persistent_disk))
- `git_repo` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--git_repo))
- `glusterfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--glusterfs))
- `host_path` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--host_path))
- `iscsi` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--iscsi))
- `nfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--nfs))
- `persistent_volume_claim` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--persistent_volume_claim))
- `photon_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--photon_persistent_disk))
- `portworx_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--portworx_volume))
- `projected` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--projected))
- `quobyte` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--quobyte))
- `rbd` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--rbd))
- `scale_io` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--scale_io))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--secret))
- `storageos` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--storageos))
...
- `read_only` (Boolean)
- `secret_file` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--secret_ref))
- `user` (String)
...
- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--items))
- `name` (String)
- `optional` (Boolean)
...
- `fs_type` (String)
- `node_publish_secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--node_publish_secret_ref))
- `read_only` (Boolean)
- `volume_attributes` (Map of String)
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--items--resource_field_ref"></a>
...
- `volume_claim_template` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.volume_claim_template`

Required:

- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--spec))
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--data_source"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.volume_claim_template.metadata.data_source`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--data_source_ref"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.volume_claim_template.metadata.data_source_ref`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--resources"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.volume_claim_template.metadata.resources`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.volume_claim_template.metadata.selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--volume_claim_template--metadata--selector--match_expressions))
- `match_labels` (Map of String)
...
- `default_mode` (Number)
- `sources` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.sources`

Optional:

- `cluster_trust_bundle` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--cluster_trust_bundle))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--config_map))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--downward_api))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--secret))
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--label_selector))
- `name` (String)
- `optional` (Boolean)
- `signer_name` (String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--label_selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.sources.service_account_token.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--label_selector--match_expressions))
- `match_labels` (Map of String)
...
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--items))
- `name` (String)
- `optional` (Boolean)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--items"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecar_volumes.vsphere_volume.sources.service_account_token.items`
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token--items--resource_field_ref"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume--sources--service_account_token"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_volumes--vsphere_volume"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecars`
...
- `args` (List of String)
- `command` (List of String)
- `env` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--env))
- `env_from` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--env_from))
- `image` (String)
- `image_pull_policy` (String)
- `lifecycle` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--lifecycle))
- `liveness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--liveness_probe))
- `ports` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--ports))
- `readiness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--readiness_probe))
- `resize_policy` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--resize_policy))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--resources))
- `restart_policy` (String)
- `security_context` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--security_context))
- `startup_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--startup_probe))
- `stdin` (Boolean)
- `stdin_once` (Boolean)
- `termination_message_path` (String)
- `termination_message_policy` (String)
- `tty` (Boolean)
- `volume_devices` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--volume_devices))
- `volume_mounts` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--volume_mounts))
- `working_dir` (String)
...
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--value_from))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--value_from"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecars.working_dir.value_from`

Optional:

- `config_map_key_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--value_from--config_map_key_ref))
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--value_from--field_ref))
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--value_from--resource_field_ref))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--value_from--secret_key_ref"></a>
...
- `config_map_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--config_map_ref))
- `prefix` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--secret_ref"></a>
...
- `post_start` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--post_start))
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop--tcp_socket--http_headers"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sidecars.working_dir.pre_stop.tcp_socket.http_headers`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop--tcp_socket"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--pre_stop"></a>
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--claims))
- `limits` (Map of String)
- `requests` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecars--working_dir--windows_options"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--tolerations"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.tolerations`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--topology_spread_constraints"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.topology_spread_constraints`
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--topology_spread_constraints--label_selector))
- `match_label_keys` (List of String)
- `min_domains` (Number)
- `node_affinity_policy` (String)
- `node_taints_policy` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--topology_spread_constraints--node_taints_policy--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--seccomp_profile"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.seccomp_profile`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--windows_options"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.windows_options`
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `startup_delay_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--exec"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.exec`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--grpc"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.grpc`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--http_get"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.http_get`
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--http_get--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--tcp_socket"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.tcp_socket`
...
- `annotations` (Map of String)
- `configuration` (String)
- `container_security_context` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--container_security_context))
- `labels` (Map of String)
- `liveness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe))
- `node_selector` (Map of String)
- `pod_disruption_budget` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_disruption_budget))
- `pod_security_context` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_security_context))
- `priority_class_name` (String)
- `readiness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resources))
- `runtime_class_name` (String)
- `service_account_name` (String)
- `sidecar_pv_cs` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sidecar_pv_cs))
...
- `tolerations` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--tolerations))
- `topology_spread_constraints` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--topology_spread_constraints))
- `volume_spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--container_security_context"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.container_security_context`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--container_security_context--windows_options"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.liveness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `startup_delay_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_security_context"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.pod_security_context`
...
- `run_as_non_root` (Boolean)
- `run_as_user` (Number)
- `se_linux_options` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_security_context--se_linux_options))
- `seccomp_profile` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_security_context--seccomp_profile))
- `supplemental_groups` (List of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--pod_security_context--windows_options"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.readiness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.volume_spec`

Optional:

- `empty_dir` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--empty_dir))
- `host_path` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--host_path))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--persistent_volume_claim"></a>
...
- `access_modes` (List of String)
- `annotations` (Map of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--persistent_volume_claim--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--persistent_volume_claim--data_source_ref))
- `labels` (Map of String)
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--persistent_volume_claim--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--persistent_volume_claim--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_spec--persistent_volume_claim--volume_name--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--sysctls"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.sysctls`
...
- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--claims))
- `limits` (Map of String)
- `requests` (Map of String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--claims"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.claims`
...
- `kind` (String)
- `metadata` (Map of String)
- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec))
- `status` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--status))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.spec`

Optional:

- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--spec--volume_name--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--status"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.status`
...
- `allocated_resources` (Map of String)
- `capacity` (Map of String)
- `conditions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--status--conditions))
- `current_volume_attributes_class_name` (String)
- `modify_volume_status` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--status--modify_volume_status))
- `phase` (String)
...
- `aws_elastic_block_store` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--aws_elastic_block_store))
- `azure_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--azure_disk))
- `azure_file` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--azure_file))
- `cephfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cephfs))
- `cinder` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cinder))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--config_map))
- `csi` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--csi))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--downward_api))
- `empty_dir` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--empty_dir))
- `ephemeral` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral))
- `fc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--fc))
- `flex_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--flex_volume))
- `flocker` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--flocker))
- `gce_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--gce_persistent_disk))
- `git_repo` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--git_repo))
- `glusterfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--glusterfs))
- `host_path` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--host_path))
- `iscsi` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--iscsi))
- `nfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--nfs))
...
- `photon_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--photon_persistent_disk))
- `portworx_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--portworx_volume))
- `projected` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected))
- `quobyte` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--quobyte))
- `rbd` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--rbd))
- `scale_io` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--scale_io))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--secret))
- `storageos` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--storageos))
- `vsphere_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--vsphere_volume))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--aws_elastic_block_store"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.aws_elastic_block_store`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--azure_disk"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.azure_disk`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--azure_file"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.azure_file`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cephfs"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.cephfs`
...
- `read_only` (Boolean)
- `secret_file` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cephfs--secret_ref))
- `user` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cinder"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.cinder`
...
- `fs_type` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cinder--secret_ref))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--cinder--secret_ref"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.cinder.secret_ref`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--config_map"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.config_map`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--config_map--items))
- `name` (String)
- `optional` (Boolean)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--csi"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.csi`
...
- `fs_type` (String)
- `node_publish_secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--csi--node_publish_secret_ref))
- `read_only` (Boolean)
- `volume_attributes` (Map of String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--downward_api"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.downward_api`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--downward_api--items))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--downward_api--items"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.downward_api.items`
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--downward_api--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--downward_api--items--resource_field_ref"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.ephemeral`

Optional:

- `volume_claim_template` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.ephemeral.volume_claim_template`

Required:

- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--spec))
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--metadata--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--metadata--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--metadata--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--metadata--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--metadata--volume_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ephemeral--volume_claim_template--metadata--volume_name--match_expressions"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.ephemeral.volume_claim_template.metadata.volume_name.match_expressions`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--fc"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.fc`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--flex_volume"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.flex_volume`
...
- `options` (Map of String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--flex_volume--secret_ref))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--flex_volume--secret_ref"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.flex_volume.secret_ref`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--flocker"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.flocker`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--gce_persistent_disk"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.gce_persistent_disk`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--git_repo"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.git_repo`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--glusterfs"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.glusterfs`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--iscsi"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.iscsi`
...
- `portals` (List of String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--iscsi--secret_ref))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--iscsi--secret_ref"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.iscsi.secret_ref`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--nfs"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.nfs`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--photon_persistent_disk"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.photon_persistent_disk`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--portworx_volume"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.portworx_volume`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.projected`

Optional:

- `default_mode` (Number)
- `sources` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.projected.sources`

Optional:

- `cluster_trust_bundle` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--cluster_trust_bundle))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--config_map))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--downward_api))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--secret))
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--label_selector))
- `name` (String)
- `optional` (Boolean)
- `signer_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--signer_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--signer_name--match_expressions"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.projected.sources.service_account_token.signer_name.match_expressions`
...
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--items))
- `name` (String)
- `optional` (Boolean)
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--items--field_ref))
- `mode` (Number)
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--items--resource_field_ref))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--items--field_ref"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.projected.sources.service_account_token.items.field_ref`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token--items--resource_field_ref"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.projected.sources.service_account_token.items.resource_field_ref`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--projected--sources--service_account_token"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--quobyte"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.quobyte`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--rbd"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.rbd`
...
- `pool` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--rbd--secret_ref))
- `user` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--scale_io"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.scale_io`

Required:

- `gateway` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--scale_io--secret_ref))
- `system` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--secret"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.secret`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--secret--items))
- `optional` (Boolean)
- `secret_name` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--storageos"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.storageos`

Optional:

- `fs_type` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--storageos--secret_ref))
- `volume_name` (String)
- `volume_namespace` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--vsphere_volume"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.vsphere_volume`
...
- `args` (List of String)
- `command` (List of String)
- `env` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env))
- `env_from` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env_from))
- `image` (String)
- `image_pull_policy` (String)
- `lifecycle` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle))
- `liveness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--liveness_probe))
- `ports` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ports))
- `readiness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--readiness_probe))
- `resize_policy` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resize_policy))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resources))
- `restart_policy` (String)
- `security_context` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--security_context))
- `startup_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe))
- `stdin` (Boolean)
- `stdin_once` (Boolean)
- `termination_message_path` (String)
- `termination_message_policy` (String)
- `tty` (Boolean)
- `volume_devices` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_devices))
- `volume_mounts` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_mounts))
- `working_dir` (String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.env`
...
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env--value_from))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env--value_from"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.env.value_from`

Optional:

- `config_map_key_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env--value_from--config_map_key_ref))
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env--value_from--field_ref))
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env--value_from--resource_field_ref))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env--value_from--secret_key_ref"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env_from"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.env_from`

Optional:

- `config_map_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env_from--config_map_ref))
- `prefix` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--env_from--secret_ref"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.lifecycle`

Optional:

- `post_start` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--post_start))
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--pre_stop--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--pre_stop--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--pre_stop--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--pre_stop--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--pre_stop--tcp_socket"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--lifecycle--pre_stop"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--ports"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.ports`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--resize_policy"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.resize_policy`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--security_context"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.security_context`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--security_context--windows_options"></a>
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.startup_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--startup_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_devices"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.volume_devices`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--volume_mounts"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.volume_mounts`
...
- `directory_per_db` (Boolean)
- `engine` (String)
- `in_memory` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--in_memory))
- `mmapv1` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--mmapv1))
- `sync_period_secs` (Number)
- `wired_tiger` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--wired_tiger))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--in_memory"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.in_memory`

Optional:

- `engine_config` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--in_memory--engine_config))

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--in_memory--engine_config"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.in_memory.engine_config`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--mmapv1"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.mmapv1`
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--wired_tiger"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.wired_tiger`

Optional:

- `collection_config` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--wired_tiger--collection_config))
- `engine_config` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--wired_tiger--engine_config))
...
<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--wired_tiger--index_config"></a>
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--label_selector))
- `match_label_keys` (List of String)
- `min_domains` (Number)
- `node_affinity_policy` (String)
- `node_taints_policy` (String)

<a id="nestedatt--spec--sharding--configsvr_repl_set--volume_spec--label_selector"></a>
### Nested Schema for `spec.sharding.configsvr_repl_set.volume_spec.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--label_selector--match_expressions))
- `match_labels` (Map of String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--configsvr_repl_set--volume_spec--persistent_volume_claim--volume_name--match_expressions))
- `match_labels` (Map of String)
...
- `advanced` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced))
- `anti_affinity_topology_key` (String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced`

Optional:

- `node_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--node_affinity))
- `pod_affinity` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_affinity))
...
- `preferred_during_scheduling_ignored_during_execution` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--preferred_during_scheduling_ignored_during_execution))
...
- `preference` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--preference))
- `weight` (Number)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_expressions))
- `match_fields` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_fields))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_expressions"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.match_expressions`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--match_fields"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.match_fields`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution"></a>
...
- `node_selector_terms` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions))
- `match_fields` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_expressions"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_expressions`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--node_selector_terms--match_fields"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.node_selector_terms.match_fields`
...
- `pod_affinity_term` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term))
- `weight` (Number)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector))
- `namespaces` (List of String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.label_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--label_selector--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.weight.namespace_selector`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--weight--namespace_selector--match_expressions))
- `match_labels` (Map of String)
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--label_selector))
- `match_label_keys` (List of String)
- `mismatch_label_keys` (List of String)
- `namespace_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespace_selector))
- `namespaces` (List of String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity--required_during_scheduling_ignored_during_execution--namespaces--match_expressions"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.advanced.pod_anti_affinity.required_during_scheduling_ignored_during_execution.namespaces.match_expressions`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--advanced--pod_anti_affinity"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--seccomp_profile"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.seccomp_profile`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--windows_options"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.windows_options`
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `startup_delay_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--exec"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.exec`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--grpc"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.grpc`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--http_get"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.http_get`
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--http_get--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--tcp_socket"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.tcp_socket`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--sysctls"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.sysctls`
...
- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--claims))
- `limits` (Map of String)
- `requests` (Map of String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--claims"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.claims`
...
- `kind` (String)
- `metadata` (Map of String)
- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--spec))
- `status` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--status))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--spec"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.spec`

Optional:

- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--spec--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--spec--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--spec--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--spec--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--spec--volume_name--match_expressions))
- `match_labels` (Map of String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--status"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.status`
...
- `allocated_resources` (Map of String)
- `capacity` (Map of String)
- `conditions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--status--conditions))
- `current_volume_attributes_class_name` (String)
- `modify_volume_status` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--status--modify_volume_status))
- `phase` (String)
...
- `aws_elastic_block_store` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--aws_elastic_block_store))
- `azure_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--azure_disk))
- `azure_file` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--azure_file))
- `cephfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--cephfs))
- `cinder` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--cinder))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--config_map))
- `csi` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--csi))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--downward_api))
- `empty_dir` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--empty_dir))
- `ephemeral` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral))
- `fc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--fc))
- `flex_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--flex_volume))
- `flocker` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--flocker))
- `gce_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--gce_persistent_disk))
- `git_repo` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--git_repo))
- `glusterfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--glusterfs))
- `host_path` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--host_path))
- `iscsi` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--iscsi))
- `nfs` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--nfs))
- `persistent_volume_claim` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--persistent_volume_claim))
- `photon_persistent_disk` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--photon_persistent_disk))
- `portworx_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--portworx_volume))
- `projected` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected))
- `quobyte` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--quobyte))
- `rbd` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--rbd))
- `scale_io` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--scale_io))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--secret))
- `storageos` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--storageos))
- `vsphere_volume` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--vsphere_volume))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--aws_elastic_block_store"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.aws_elastic_block_store`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--azure_disk"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.azure_disk`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--azure_file"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.azure_file`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--cephfs"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.cephfs`
...
- `read_only` (Boolean)
- `secret_file` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--cephfs--secret_ref))
- `user` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--cinder"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.cinder`
...
- `fs_type` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--cinder--secret_ref))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--cinder--secret_ref"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.cinder.secret_ref`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--config_map"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.config_map`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--config_map--items))
- `name` (String)
- `optional` (Boolean)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--csi"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.csi`
...
- `fs_type` (String)
- `node_publish_secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--csi--node_publish_secret_ref))
- `read_only` (Boolean)
- `volume_attributes` (Map of String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--downward_api"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.downward_api`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--downward_api--items))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--downward_api--items"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.downward_api.items`
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--downward_api--items--field_ref))
- `mode` (Number)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--downward_api--items--resource_field_ref"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--empty_dir"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.empty_dir`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.ephemeral`

Optional:

- `volume_claim_template` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.ephemeral.volume_claim_template`

Required:

- `spec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--spec))
...
- `access_modes` (List of String)
- `data_source` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--metadata--data_source))
- `data_source_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--metadata--data_source_ref))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--metadata--resources))
- `selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--metadata--selector))
- `storage_class_name` (String)
- `volume_attributes_class_name` (String)
- `volume_mode` (String)
- `volume_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--metadata--volume_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--ephemeral--volume_claim_template--metadata--volume_name--match_expressions"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.ephemeral.volume_claim_template.metadata.volume_name.match_expressions`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--fc"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.fc`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--flex_volume"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.flex_volume`
...
- `options` (Map of String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--flex_volume--secret_ref))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--flex_volume--secret_ref"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.flex_volume.secret_ref`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--flocker"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.flocker`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--gce_persistent_disk"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.gce_persistent_disk`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--git_repo"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.git_repo`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--glusterfs"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.glusterfs`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--host_path"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.host_path`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--iscsi"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.iscsi`
...
- `portals` (List of String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--iscsi--secret_ref))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--iscsi--secret_ref"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.iscsi.secret_ref`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--nfs"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.nfs`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--persistent_volume_claim"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.persistent_volume_claim`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--photon_persistent_disk"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.photon_persistent_disk`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--portworx_volume"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.portworx_volume`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--projected"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.projected`

Optional:

- `default_mode` (Number)
- `sources` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.projected.sources`

Optional:

- `cluster_trust_bundle` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--cluster_trust_bundle))
- `config_map` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--config_map))
- `downward_api` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--downward_api))
- `secret` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--secret))
...
- `label_selector` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--label_selector))
- `name` (String)
- `optional` (Boolean)
- `signer_name` (String)
...
- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--signer_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--signer_name--match_expressions"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.projected.sources.service_account_token.signer_name.match_expressions`
...
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--items))
- `name` (String)
- `optional` (Boolean)
...
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--items--field_ref))
- `mode` (Number)
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--items--resource_field_ref))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--items--field_ref"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.projected.sources.service_account_token.items.field_ref`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token--items--resource_field_ref"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.projected.sources.service_account_token.items.resource_field_ref`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--projected--sources--service_account_token"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--quobyte"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.quobyte`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--rbd"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.rbd`
...
- `pool` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--rbd--secret_ref))
- `user` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--scale_io"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.scale_io`

Required:

- `gateway` (String)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--scale_io--secret_ref))
- `system` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--secret"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.secret`

Optional:

- `default_mode` (Number)
- `items` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--secret--items))
- `optional` (Boolean)
- `secret_name` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--storageos"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.storageos`

Optional:

- `fs_type` (String)
- `read_only` (Boolean)
- `secret_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--storageos--secret_ref))
- `volume_name` (String)
- `volume_namespace` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--vsphere_volume"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.vsphere_volume`
...
- `args` (List of String)
- `command` (List of String)
- `env` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env))
- `env_from` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env_from))
- `image` (String)
- `image_pull_policy` (String)
- `lifecycle` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle))
- `liveness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe))
- `ports` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--ports))
- `readiness_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe))
- `resize_policy` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--resize_policy))
- `resources` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--resources))
- `restart_policy` (String)
- `security_context` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--security_context))
- `startup_probe` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe))
- `stdin` (Boolean)
- `stdin_once` (Boolean)
- `termination_message_path` (String)
- `termination_message_policy` (String)
- `tty` (Boolean)
- `volume_devices` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--volume_devices))
- `volume_mounts` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--volume_mounts))
- `working_dir` (String)

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--env"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.env`
...
- `value` (String)
- `value_from` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env--value_from))

<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--env--value_from"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.env.value_from`

Optional:

- `config_map_key_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env--value_from--config_map_key_ref))
- `field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env--value_from--field_ref))
- `resource_field_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env--value_from--resource_field_ref))
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--env--value_from--secret_key_ref"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--env_from"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.env_from`

Optional:

- `config_map_ref` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--env_from--config_map_ref))
- `prefix` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--env_from--secret_ref"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.lifecycle`

Optional:

- `post_start` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--post_start))
...
- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--pre_stop--exec))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--pre_stop--http_get))
- `sleep` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--pre_stop--sleep))
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--pre_stop--tcp_socket--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--pre_stop--tcp_socket"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--lifecycle--pre_stop"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.liveness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--liveness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--ports"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.ports`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.readiness_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--readiness_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--resize_policy"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.resize_policy`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--resources"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.resources`

Optional:

- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--resources--claims))
- `limits` (Map of String)
- `requests` (Map of String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--security_context"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.security_context`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--security_context--windows_options"></a>
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.startup_probe`

Optional:

- `exec` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe--exec))
- `failure_threshold` (Number)
- `grpc` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe--grpc))
- `http_get` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe--http_get))
- `initial_delay_seconds` (Number)
- `period_seconds` (Number)
- `success_threshold` (Number)
- `tcp_socket` (Attributes) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe--tcp_socket))
- `termination_grace_period_seconds` (Number)
- `timeout_seconds` (Number)
...
- `host` (String)
- `http_headers` (Attributes List) (see [below for nested schema](#nestedatt--spec--sharding--mongos--topology_spread_constraints--startup_probe--timeout_seconds--http_headers))
- `path` (String)
- `scheme` (String)
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--volume_devices"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.volume_devices`
...
<a id="nestedatt--spec--sharding--mongos--topology_spread_constraints--volume_mounts"></a>
### Nested Schema for `spec.sharding.mongos.topology_spread_constraints.volume_mounts`
