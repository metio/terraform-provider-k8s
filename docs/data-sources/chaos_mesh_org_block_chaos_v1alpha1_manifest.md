...
page_title: "k8s_chaos_mesh_org_block_chaos_v1alpha1_manifest Data Source - terraform-provider-k8s"
subcategory: "chaos-mesh.org"
description: |-
  BlockChaos is the Schema for the blockchaos API
---

# k8s_chaos_mesh_org_block_chaos_v1alpha1_manifest (Data Source)
