...
```terraform
resource "k8s_hive_openshift_io_selector_sync_identity_provider_v1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_hive_openshift_io_selector_sync_identity_provider_v1/import.sh"}}
