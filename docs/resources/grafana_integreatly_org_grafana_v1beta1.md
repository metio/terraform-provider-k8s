...
page_title: "k8s_grafana_integreatly_org_grafana_v1beta1 Resource - terraform-provider-k8s"
subcategory: "grafana.integreatly.org"
description: |-
  
---

# k8s_grafana_integreatly_org_grafana_v1beta1 (Resource)
...
```terraform
resource "k8s_grafana_integreatly_org_grafana_v1beta1" "example" {
  metadata = {
    name      = "some-name"
...
- `claims` (Attributes List) (see [below for nested schema](#nestedatt--spec--deployment--spec--template--spec--volumes--vsphere_volume--volume_claim_template--spec--volume_name--claims))
- `limits` (Map of String)
- `requests` (Map of String)

<a id="nestedatt--spec--deployment--spec--template--spec--volumes--vsphere_volume--volume_claim_template--spec--volume_name--claims"></a>
### Nested Schema for `spec.deployment.spec.template.spec.volumes.vsphere_volume.volume_claim_template.spec.volume_name.requests`
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_grafana_integreatly_org_grafana_v1beta1/import.sh"}}
