...
page_title: "k8s_kustomize_toolkit_fluxcd_io_kustomization_v1 Resource - terraform-provider-k8s"
subcategory: "kustomize.toolkit.fluxcd.io"
description: |-
  Kustomization is the Schema for the kustomizations API.
---

# k8s_kustomize_toolkit_fluxcd_io_kustomization_v1 (Resource)
...
- `interval` (String) The interval at which to reconcile the Kustomization. This interval is approximate and may be subject to jitter to ensure efficient use of resources.
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_kustomize_toolkit_fluxcd_io_kustomization_v1/import.sh"}}
