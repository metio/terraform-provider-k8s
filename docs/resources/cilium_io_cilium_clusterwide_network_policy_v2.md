...
page_title: "k8s_cilium_io_cilium_clusterwide_network_policy_v2 Resource - terraform-provider-k8s"
...
# k8s_cilium_io_cilium_clusterwide_network_policy_v2 (Resource)
...
- `egress_deny` (Attributes List) EgressDeny is a list of EgressDenyRule which are enforced at egress. Any rule inserted here will by denied regardless of the allowed egress rules in the 'egress' field. If omitted or empty, this rule does not apply at egress. (see [below for nested schema](#nestedatt--spec--egress_deny))
