...
page_title: "k8s_rocketmq_apache_org_name_service_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "rocketmq.apache.org"
description: |-
  NameService is the Schema for the nameservices API
---

# k8s_rocketmq_apache_org_name_service_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_rocketmq_apache_org_name_service_v1alpha1/import.sh"}}
