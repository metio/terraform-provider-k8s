...
page_title: "k8s_hazelcast_com_hot_backup_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "hazelcast.com"
description: |-
  HotBackup is the Schema for the hot backup API
---

# k8s_hazelcast_com_hot_backup_v1alpha1 (Resource)
...
```terraform
resource "k8s_hazelcast_com_hot_backup_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_hazelcast_com_hot_backup_v1alpha1/import.sh"}}
