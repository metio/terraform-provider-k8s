...
page_title: "k8s_longhorn_io_recurring_job_v1beta2 Resource - terraform-provider-k8s"
subcategory: "longhorn.io"
description: |-
  RecurringJob is where Longhorn stores recurring job object.
---

# k8s_longhorn_io_recurring_job_v1beta2 (Resource)
...
```terraform
resource "k8s_longhorn_io_recurring_job_v1beta2" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_longhorn_io_recurring_job_v1beta2/import.sh"}}
