...
```terraform
resource "k8s_networking_istio_io_workload_group_v1alpha3" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_networking_istio_io_workload_group_v1alpha3/import.sh"}}
