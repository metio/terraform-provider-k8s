...
page_title: "k8s_keda_sh_trigger_authentication_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "keda.sh"
description: |-
  TriggerAuthentication defines how a trigger can authenticate
---

# k8s_keda_sh_trigger_authentication_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_keda_sh_trigger_authentication_v1alpha1/import.sh"}}
