...
page_title: "k8s_mutations_gatekeeper_sh_assign_v1beta1 Resource - terraform-provider-k8s"
subcategory: "mutations.gatekeeper.sh"
description: |-
  Assign is the Schema for the assign API.
---

# k8s_mutations_gatekeeper_sh_assign_v1beta1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mutations_gatekeeper_sh_assign_v1beta1/import.sh"}}
