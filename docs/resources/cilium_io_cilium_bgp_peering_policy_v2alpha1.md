...
```terraform
resource "k8s_cilium_io_cilium_bgp_peering_policy_v2alpha1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_cilium_io_cilium_bgp_peering_policy_v2alpha1/import.sh"}}
