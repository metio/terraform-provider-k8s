...
page_title: "k8s_security_istio_io_authorization_policy_v1 Resource - terraform-provider-k8s"
subcategory: "security.istio.io"
description: |-
  
---

# k8s_security_istio_io_authorization_policy_v1 (Resource)
...
```terraform
resource "k8s_security_istio_io_authorization_policy_v1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_security_istio_io_authorization_policy_v1/import.sh"}}
