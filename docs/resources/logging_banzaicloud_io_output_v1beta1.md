...
page_title: "k8s_logging_banzaicloud_io_output_v1beta1 Resource - terraform-provider-k8s"
subcategory: "logging.banzaicloud.io"
description: |-
  
---

# k8s_logging_banzaicloud_io_output_v1beta1 (Resource)
...
```terraform
resource "k8s_logging_banzaicloud_io_output_v1beta1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_logging_banzaicloud_io_output_v1beta1/import.sh"}}
