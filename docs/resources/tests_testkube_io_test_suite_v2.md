...
page_title: "k8s_tests_testkube_io_test_suite_v2 Resource - terraform-provider-k8s"
subcategory: "tests.testkube.io"
description: |-
  TestSuite is the Schema for the testsuites API
---

# k8s_tests_testkube_io_test_suite_v2 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_tests_testkube_io_test_suite_v2/import.sh"}}
