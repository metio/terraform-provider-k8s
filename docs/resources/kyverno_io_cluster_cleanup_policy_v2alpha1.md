...
page_title: "k8s_kyverno_io_cluster_cleanup_policy_v2alpha1 Resource - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  ClusterCleanupPolicy defines rule for resource cleanup.
---

# k8s_kyverno_io_cluster_cleanup_policy_v2alpha1 (Resource)
...
```terraform
resource "k8s_kyverno_io_cluster_cleanup_policy_v2alpha1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_kyverno_io_cluster_cleanup_policy_v2alpha1/import.sh"}}
