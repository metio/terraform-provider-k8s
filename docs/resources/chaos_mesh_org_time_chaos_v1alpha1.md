...
page_title: "k8s_chaos_mesh_org_time_chaos_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "chaos-mesh.org"
description: |-
  TimeChaos is the Schema for the timechaos API
---

# k8s_chaos_mesh_org_time_chaos_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_chaos_mesh_org_time_chaos_v1alpha1/import.sh"}}
