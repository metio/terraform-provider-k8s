...
page_title: "k8s_getambassador_io_kubernetes_endpoint_resolver_v3alpha1 Resource - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  KubernetesEndpointResolver is the Schema for the kubernetesendpointresolver API
---

# k8s_getambassador_io_kubernetes_endpoint_resolver_v3alpha1 (Resource)
...
```terraform
resource "k8s_getambassador_io_kubernetes_endpoint_resolver_v3alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_getambassador_io_kubernetes_endpoint_resolver_v3alpha1/import.sh"}}
