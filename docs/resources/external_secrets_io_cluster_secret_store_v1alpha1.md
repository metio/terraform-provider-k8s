...
page_title: "k8s_external_secrets_io_cluster_secret_store_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "external-secrets.io/v1alpha1"
description: |-
  ClusterSecretStore represents a secure external location for storing secrets, which can be referenced as part of 'storeRef' fields.
---

# k8s_external_secrets_io_cluster_secret_store_v1alpha1 (Resource)
...
### Nested Schema for `spec.provider.alibaba.endpoint`

Required:

- `secret_ref` (Attributes) AlibabaAuthSecretRef holds secret references for Alibaba credentials. (see [below for nested schema](#nestedatt--spec--provider--alibaba--endpoint--secret_ref))

<a id="nestedatt--spec--provider--alibaba--endpoint--secret_ref"></a>
### Nested Schema for `spec.provider.alibaba.endpoint.secret_ref`

Required:

- `access_key_id_secret_ref` (Attributes) The AccessKeyID is used for authentication (see [below for nested schema](#nestedatt--spec--provider--alibaba--endpoint--secret_ref--access_key_id_secret_ref))
- `access_key_secret_secret_ref` (Attributes) The AccessKeySecret is used for authentication (see [below for nested schema](#nestedatt--spec--provider--alibaba--endpoint--secret_ref--access_key_secret_secret_ref))

<a id="nestedatt--spec--provider--alibaba--endpoint--secret_ref--access_key_id_secret_ref"></a>
### Nested Schema for `spec.provider.alibaba.endpoint.secret_ref.access_key_secret_secret_ref`
...
<a id="nestedatt--spec--provider--alibaba--endpoint--secret_ref--access_key_secret_secret_ref"></a>
### Nested Schema for `spec.provider.alibaba.endpoint.secret_ref.access_key_secret_secret_ref`
