...
```terraform
resource "k8s_crd_projectcalico_org_calico_node_status_v1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_crd_projectcalico_org_calico_node_status_v1/import.sh"}}
