...
page_title: "k8s_monitoring_coreos_com_probe_v1 Resource - terraform-provider-k8s"
subcategory: "monitoring.coreos.com"
description: |-
  Probe defines monitoring for a set of static targets or ingresses.
---

# k8s_monitoring_coreos_com_probe_v1 (Resource)
...
- `scrape_timeout` (String) Timeout for scraping metrics from the Prometheus exporter. If not specified, the Prometheus global scrape interval is used.
...
- `credentials` (Attributes) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedatt--spec--authorization--credentials))
...
- `ca` (Attributes) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedatt--spec--tls_config--ca))
