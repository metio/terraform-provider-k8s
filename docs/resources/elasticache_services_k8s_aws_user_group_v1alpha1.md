...
page_title: "k8s_elasticache_services_k8s_aws_user_group_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "elasticache.services.k8s.aws"
description: |-
  UserGroup is the Schema for the UserGroups API
---

# k8s_elasticache_services_k8s_aws_user_group_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_elasticache_services_k8s_aws_user_group_v1alpha1/import.sh"}}
