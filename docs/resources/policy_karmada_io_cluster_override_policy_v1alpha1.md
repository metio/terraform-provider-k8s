...
page_title: "k8s_policy_karmada_io_cluster_override_policy_v1alpha1 Resource - terraform-provider-k8s"
...
# k8s_policy_karmada_io_cluster_override_policy_v1alpha1 (Resource)
...
```terraform
resource "k8s_policy_karmada_io_cluster_override_policy_v1alpha1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_policy_karmada_io_cluster_override_policy_v1alpha1/import.sh"}}
