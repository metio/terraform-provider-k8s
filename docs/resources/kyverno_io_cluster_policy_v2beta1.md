...
page_title: "k8s_kyverno_io_cluster_policy_v2beta1 Resource - terraform-provider-k8s"
subcategory: "kyverno.io/v2beta1"
description: |-
  ClusterPolicy declares validation, mutation, and generation behaviors for matching resources.
---

# k8s_kyverno_io_cluster_policy_v2beta1 (Resource)
...
- `conditions` (Attributes) Multiple conditions can be declared under an 'any' or 'all' statement. A direct list of conditions (without 'any' or 'all' statements) is also supported for backwards compatibility See: https://kyverno.io/docs/writing-policies/validate/#deny-rules (see [below for nested schema](#nestedatt--spec--rules--validate--pod_security--conditions))
