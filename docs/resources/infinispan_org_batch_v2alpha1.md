...
page_title: "k8s_infinispan_org_batch_v2alpha1 Resource - terraform-provider-k8s"
subcategory: "infinispan.org"
description: |-
  Batch is the Schema for the batches API
---

# k8s_infinispan_org_batch_v2alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_infinispan_org_batch_v2alpha1/import.sh"}}
