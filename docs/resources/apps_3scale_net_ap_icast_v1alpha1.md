...
subcategory: "apps.3scale.net/v1alpha1"
description: |-
...
- `open_tracing` (Attributes) OpenTracingSpec contains the OpenTracing integration configuration with APIcast. (see [below for nested schema](#nestedatt--spec--open_tracing))
