...
page_title: "k8s_apm_k8s_elastic_co_apm_server_v1beta1 Resource - terraform-provider-k8s"
subcategory: "apm.k8s.elastic.co/v1beta1"
description: |-
  ApmServer represents an APM Server resource in a Kubernetes cluster.
---

# k8s_apm_k8s_elastic_co_apm_server_v1beta1 (Resource)
...
- `config` (Dynamic) Config holds the APM Server configuration. See: https://www.elastic.co/guide/en/apm/server/current/configuring-howto-apm-server.html
