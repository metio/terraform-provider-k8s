...
page_title: "k8s_getambassador_io_rate_limit_service_v1 Resource - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  RateLimitService is the Schema for the ratelimitservices API
---

# k8s_getambassador_io_rate_limit_service_v1 (Resource)
...
```terraform
resource "k8s_getambassador_io_rate_limit_service_v1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_getambassador_io_rate_limit_service_v1/import.sh"}}
