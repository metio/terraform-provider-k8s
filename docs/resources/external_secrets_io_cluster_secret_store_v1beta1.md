...
```terraform
resource "k8s_external_secrets_io_cluster_secret_store_v1beta1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_external_secrets_io_cluster_secret_store_v1beta1/import.sh"}}
