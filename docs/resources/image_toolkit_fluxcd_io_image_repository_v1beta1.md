...
page_title: "k8s_image_toolkit_fluxcd_io_image_repository_v1beta1 Resource - terraform-provider-k8s"
subcategory: "image.toolkit.fluxcd.io"
description: |-
  ImageRepository is the Schema for the imagerepositories API
---

# k8s_image_toolkit_fluxcd_io_image_repository_v1beta1 (Resource)
...
```terraform
resource "k8s_image_toolkit_fluxcd_io_image_repository_v1beta1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_image_toolkit_fluxcd_io_image_repository_v1beta1/import.sh"}}
