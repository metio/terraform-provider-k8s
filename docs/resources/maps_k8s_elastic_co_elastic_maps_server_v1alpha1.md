...
subcategory: "maps.k8s.elastic.co/v1alpha1"
description: |-
...
- `config` (Dynamic) Config holds the ElasticMapsServer configuration. See: https://www.elastic.co/guide/en/kibana/current/maps-connect-to-ems.html#elastic-maps-server-configuration
