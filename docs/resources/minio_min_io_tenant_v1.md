...
<a id="nestedatt--spec--log--db--topology_spread_constraints--metadata"></a>
...
<a id="nestedatt--spec--log--db--topology_spread_constraints--pod_anti_affinity--required_during_scheduling_ignored_during_execution--pod_affinity_term"></a>
...
<a id="nestedatt--spec--log--security_context"></a>
...
<a id="nestedatt--spec--prometheus--affinity--pod_anti_affinity"></a>
### Nested Schema for `spec.prometheus.affinity.pod_anti_affinity`
...
### Nested Schema for `spec.prometheus.env.value_from.resource_field_ref`
...
### Nested Schema for `spec.prometheus.env.value_from.secret_key_ref`
...
<a id="nestedatt--spec--prometheus--resources"></a>
### Nested Schema for `spec.prometheus.resources`
...
<a id="nestedatt--spec--prometheus--security_context"></a>
### Nested Schema for `spec.prometheus.security_context`
...
- `run_as_non_root` (Boolean)
- `run_as_user` (Number)
- `se_linux_options` (Attributes) (see [below for nested schema](#nestedatt--spec--prometheus--security_context--se_linux_options))
- `seccomp_profile` (Attributes) (see [below for nested schema](#nestedatt--spec--prometheus--security_context--seccomp_profile))
- `supplemental_groups` (List of String)
- `sysctls` (Attributes List) (see [below for nested schema](#nestedatt--spec--prometheus--security_context--sysctls))
- `windows_options` (Attributes) (see [below for nested schema](#nestedatt--spec--prometheus--security_context--windows_options))

<a id="nestedatt--spec--prometheus--security_context--se_linux_options"></a>
### Nested Schema for `spec.prometheus.security_context.windows_options`
...
<a id="nestedatt--spec--prometheus--security_context--seccomp_profile"></a>
### Nested Schema for `spec.prometheus.security_context.windows_options`
...
<a id="nestedatt--spec--prometheus--security_context--sysctls"></a>
### Nested Schema for `spec.prometheus.security_context.windows_options`
...
<a id="nestedatt--spec--prometheus--security_context--windows_options"></a>
### Nested Schema for `spec.prometheus.security_context.windows_options`
...
<a id="nestedatt--spec--prometheus--tolerations"></a>
### Nested Schema for `spec.prometheus.tolerations`
...
<a id="nestedatt--spec--prometheus--topology_spread_constraints"></a>
### Nested Schema for `spec.prometheus.topology_spread_constraints`
...
### Nested Schema for `spec.side_cars.volumes.vsphere_volume.volume_claim_template.metadata`
...
<a id="nestedatt--spec--side_cars--volumes--vsphere_volume--volume_claim_template--metadata--resources"></a>
### Nested Schema for `spec.side_cars.volumes.vsphere_volume.volume_claim_template.metadata.volume_name`
...
<a id="nestedatt--spec--side_cars--volumes--vsphere_volume--volume_claim_template--metadata--selector"></a>
### Nested Schema for `spec.side_cars.volumes.vsphere_volume.volume_claim_template.metadata.volume_name`

Optional:

- `match_expressions` (Attributes List) (see [below for nested schema](#nestedatt--spec--side_cars--volumes--vsphere_volume--volume_claim_template--metadata--volume_name--match_expressions))
- `match_labels` (Map of String)

<a id="nestedatt--spec--side_cars--volumes--vsphere_volume--volume_claim_template--metadata--volume_name--match_expressions"></a>
### Nested Schema for `spec.side_cars.volumes.vsphere_volume.volume_claim_template.metadata.volume_name.match_labels`
