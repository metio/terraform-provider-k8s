...
page_title: "k8s_mariadb_mmontes_io_restore_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "mariadb.mmontes.io"
description: |-
  Restore is the Schema for the restores API
---

# k8s_mariadb_mmontes_io_restore_v1alpha1 (Resource)
...
```terraform
resource "k8s_mariadb_mmontes_io_restore_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
- `backup_ref` (Attributes) LocalObjectReference contains enough information to let you locate the referenced object inside the same namespace. (see [below for nested schema](#nestedatt--spec--backup_ref))
- `file_name` (String)
...
- `volume` (Attributes) Represents the source of a volume to mount. Only one of its members may be specified. (see [below for nested schema](#nestedatt--spec--volume))
...
### Nested Schema for `spec.volume.cephfs.user`
...
### Nested Schema for `spec.volume.rbd.user`
...
### Nested Schema for `spec.volume.scale_io.volume_name`
...
### Nested Schema for `spec.volume.storageos.volume_namespace`
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mariadb_mmontes_io_restore_v1alpha1/import.sh"}}
