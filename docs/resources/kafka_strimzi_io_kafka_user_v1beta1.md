...
```terraform
resource "k8s_kafka_strimzi_io_kafka_user_v1beta1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_kafka_strimzi_io_kafka_user_v1beta1/import.sh"}}
