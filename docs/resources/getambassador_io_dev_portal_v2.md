...
page_title: "k8s_getambassador_io_dev_portal_v2 Resource - terraform-provider-k8s"
...
# k8s_getambassador_io_dev_portal_v2 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_getambassador_io_dev_portal_v2/import.sh"}}
