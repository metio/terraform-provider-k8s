...
```terraform
resource "k8s_prometheusservice_services_k8s_aws_alert_manager_definition_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_prometheusservice_services_k8s_aws_alert_manager_definition_v1alpha1/import.sh"}}
