...
page_title: "k8s_apiextensions_crossplane_io_composition_revision_v1alpha1 Resource - terraform-provider-k8s"
...
# k8s_apiextensions_crossplane_io_composition_revision_v1alpha1 (Resource)
...
```terraform
resource "k8s_apiextensions_crossplane_io_composition_revision_v1alpha1" "minimal" {
  metadata = {
    name = "test"
  }
}
