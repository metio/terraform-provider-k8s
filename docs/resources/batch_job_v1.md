...
page_title: "k8s_batch_job_v1 Resource - terraform-provider-k8s"
subcategory: "batch"
description: |-
  Job represents the configuration of a single job.
---

# k8s_batch_job_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_batch_job_v1/import.sh"}}
