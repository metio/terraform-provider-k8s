...
page_title: "k8s_image_toolkit_fluxcd_io_image_repository_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "image.toolkit.fluxcd.io/v1alpha1"
description: |-
  ImageRepository is the Schema for the imagerepositories API
---

# k8s_image_toolkit_fluxcd_io_image_repository_v1alpha1 (Resource)
