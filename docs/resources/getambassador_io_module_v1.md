...
page_title: "k8s_getambassador_io_module_v1 Resource - terraform-provider-k8s"
...
# k8s_getambassador_io_module_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_getambassador_io_module_v1/import.sh"}}
