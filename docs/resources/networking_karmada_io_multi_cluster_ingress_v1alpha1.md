...
page_title: "k8s_networking_karmada_io_multi_cluster_ingress_v1alpha1 Resource - terraform-provider-k8s"
...
# k8s_networking_karmada_io_multi_cluster_ingress_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_networking_karmada_io_multi_cluster_ingress_v1alpha1/import.sh"}}
