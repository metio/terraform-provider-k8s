...
page_title: "k8s_tests_testkube_io_test_execution_v1 Resource - terraform-provider-k8s"
subcategory: "tests.testkube.io"
description: |-
  TestExecution is the Schema for the testexecutions API
---

# k8s_tests_testkube_io_test_execution_v1 (Resource)
...
```terraform
resource "k8s_tests_testkube_io_test_execution_v1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_tests_testkube_io_test_execution_v1/import.sh"}}
