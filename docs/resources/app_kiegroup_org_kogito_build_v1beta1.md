...
page_title: "k8s_app_kiegroup_org_kogito_build_v1beta1 Resource - terraform-provider-k8s"
subcategory: "app.kiegroup.org"
description: |-
  KogitoBuild handles how to build a custom Kogito service in a Kubernetes/OpenShift cluster.
---

# k8s_app_kiegroup_org_kogito_build_v1beta1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_app_kiegroup_org_kogito_build_v1beta1/import.sh"}}
