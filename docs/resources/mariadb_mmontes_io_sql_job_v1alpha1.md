...
page_title: "k8s_mariadb_mmontes_io_sql_job_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "mariadb.mmontes.io"
description: |-
  SqlJob is the Schema for the sqljobs API
---

# k8s_mariadb_mmontes_io_sql_job_v1alpha1 (Resource)
...
```terraform
resource "k8s_mariadb_mmontes_io_sql_job_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mariadb_mmontes_io_sql_job_v1alpha1/import.sh"}}
