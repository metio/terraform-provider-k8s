...
page_title: "k8s_cilium_io_cilium_pod_ip_pool_v2alpha1 Resource - terraform-provider-k8s"
subcategory: "cilium.io"
description: |-
  CiliumPodIPPool defines an IP pool that can be used for pooled IPAM (i.e. the multi-pool IPAM mode).
---

# k8s_cilium_io_cilium_pod_ip_pool_v2alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_cilium_io_cilium_pod_ip_pool_v2alpha1/import.sh"}}
