...
page_title: "k8s_work_karmada_io_cluster_resource_binding_v1alpha2 Resource - terraform-provider-k8s"
...
# k8s_work_karmada_io_cluster_resource_binding_v1alpha2 (Resource)
...
```terraform
resource "k8s_work_karmada_io_cluster_resource_binding_v1alpha2" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_work_karmada_io_cluster_resource_binding_v1alpha2/import.sh"}}
