...
page_title: "k8s_kyverno_io_admission_report_v1alpha2 Resource - terraform-provider-k8s"
subcategory: "kyverno.io"
description: |-
  AdmissionReport is the Schema for the AdmissionReports API
---

# k8s_kyverno_io_admission_report_v1alpha2 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_kyverno_io_admission_report_v1alpha2/import.sh"}}
