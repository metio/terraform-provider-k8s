...
page_title: "k8s_installation_mattermost_com_mattermost_v1beta1 Resource - terraform-provider-k8s"
subcategory: "installation.mattermost.com/v1beta1"
description: |-
  Mattermost is the Schema for the mattermosts API
---

# k8s_installation_mattermost_com_mattermost_v1beta1 (Resource)
...
```terraform
resource "k8s_installation_mattermost_com_mattermost_v1beta1" "minimal" {
  metadata = {
    name = "test"
  }
}
...
### Nested Schema for `spec.database.operator_managed.type`
...
- `grpc` (Attributes) GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate. (see [below for nested schema](#nestedatt--spec--pod_extensions--init_containers--working_dir--grpc))
