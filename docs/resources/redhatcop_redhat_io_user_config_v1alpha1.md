...
page_title: "k8s_redhatcop_redhat_io_user_config_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "redhatcop.redhat.io"
description: |-
  UserConfig is the Schema for the userconfigs API
---

# k8s_redhatcop_redhat_io_user_config_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_redhatcop_redhat_io_user_config_v1alpha1/import.sh"}}
