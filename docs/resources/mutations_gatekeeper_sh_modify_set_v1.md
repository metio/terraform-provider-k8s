...
page_title: "k8s_mutations_gatekeeper_sh_modify_set_v1 Resource - terraform-provider-k8s"
...
# k8s_mutations_gatekeeper_sh_modify_set_v1 (Resource)
...
```terraform
resource "k8s_mutations_gatekeeper_sh_modify_set_v1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mutations_gatekeeper_sh_modify_set_v1/import.sh"}}
