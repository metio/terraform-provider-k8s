...
page_title: "k8s_getambassador_io_tracing_service_v1 Resource - terraform-provider-k8s"
subcategory: "getambassador.io"
description: |-
  TracingService is the Schema for the tracingservices API
---

# k8s_getambassador_io_tracing_service_v1 (Resource)
...
```terraform
resource "k8s_getambassador_io_tracing_service_v1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_getambassador_io_tracing_service_v1/import.sh"}}
