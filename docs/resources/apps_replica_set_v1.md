...
page_title: "k8s_apps_replica_set_v1 Resource - terraform-provider-k8s"
subcategory: "apps"
description: |-
  ReplicaSet ensures that a specified number of pod replicas are running at any given time.
---

# k8s_apps_replica_set_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_apps_replica_set_v1/import.sh"}}
