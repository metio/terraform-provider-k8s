...
page_title: "k8s_rds_services_k8s_aws_global_cluster_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "rds.services.k8s.aws"
description: |-
  GlobalCluster is the Schema for the GlobalClusters API
---

# k8s_rds_services_k8s_aws_global_cluster_v1alpha1 (Resource)
...
```terraform
resource "k8s_rds_services_k8s_aws_global_cluster_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_rds_services_k8s_aws_global_cluster_v1alpha1/import.sh"}}
