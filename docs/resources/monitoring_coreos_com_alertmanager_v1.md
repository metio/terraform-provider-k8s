...
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout`

Optional:

- `authorization` (Attributes) Authorization header configuration for the client. This is mutually exclusive with BasicAuth and is only available starting from Alertmanager v0.22+. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--authorization))
- `basic_auth` (Attributes) BasicAuth for the client. This is mutually exclusive with Authorization. If both are defined, BasicAuth takes precedence. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--basic_auth))
- `bearer_token_secret` (Attributes) The secret's key that contains the bearer token to be used by the client for authentication. The secret needs to be in the same namespace as the Alertmanager object and accessible by the Prometheus Operator. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--bearer_token_secret))
- `follow_redirects` (Boolean) FollowRedirects specifies whether the client should follow HTTP 3xx redirects.
- `oauth2` (Attributes) OAuth2 client credentials used to fetch a token for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2))
- `proxy_url` (String) Optional proxy URL.
- `tls_config` (Attributes) TLS configuration for the client. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config))

<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--authorization"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.authorization`

Optional:

- `credentials` (Attributes) The secret's key that contains the credentials of the request (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--authorization--credentials))
- `type` (String) Set the authentication type. Defaults to Bearer, Basic will cause an error

<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--authorization--credentials"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.authorization.type`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--basic_auth"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.basic_auth`

Optional:

- `password` (Attributes) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--basic_auth--password))
- `username` (Attributes) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--basic_auth--username))

<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--basic_auth--password"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.basic_auth.username`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--basic_auth--username"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.basic_auth.username`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--bearer_token_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.bearer_token_secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.oauth2`

Required:

- `client_id` (Attributes) The secret or configmap containing the OAuth2 client id (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--client_id))
- `client_secret` (Attributes) The secret containing the OAuth2 client secret (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--client_secret))
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--client_id"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.oauth2.scopes`

Optional:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--scopes--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--scopes--secret))

<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--scopes--config_map"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.oauth2.scopes.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--scopes--secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.oauth2.scopes.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--oauth2--client_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.oauth2.scopes`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.tls_config`

Optional:

- `ca` (Attributes) Struct containing the CA cert to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--ca))
- `cert` (Attributes) Struct containing the client cert file for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--cert))
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_secret` (Attributes) Secret containing the client key file for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--key_secret))
- `server_name` (String) Used to verify the hostname for the targets.

<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--ca"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.tls_config.server_name`

Optional:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--server_name--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--server_name--secret))

<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--server_name--config_map"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.tls_config.server_name.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--server_name--secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.tls_config.server_name.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--cert"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.tls_config.server_name`
...
<a id="nestedatt--spec--alertmanager_configuration--global--resolve_timeout--tls_config--key_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.resolve_timeout.tls_config.server_name`
