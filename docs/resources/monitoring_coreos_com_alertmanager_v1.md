...
page_title: "k8s_monitoring_coreos_com_alertmanager_v1 Resource - terraform-provider-k8s"
subcategory: "monitoring.coreos.com"
description: |-
  Alertmanager describes an Alertmanager cluster.
---

# k8s_monitoring_coreos_com_alertmanager_v1 (Resource)
...
- `spec` (Attributes) Specification of the desired behavior of the Alertmanager cluster. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status (see [below for nested schema](#nestedatt--spec))
...
- `alertmanager_config_namespace_selector` (Attributes) Namespaces to be selected for AlertmanagerConfig discovery. If nil, only check own namespace. (see [below for nested schema](#nestedatt--spec--alertmanager_config_namespace_selector))
...
- `alertmanager_configuration` (Attributes) EXPERIMENTAL: alertmanagerConfiguration specifies the configuration of Alertmanager. If defined, it takes precedence over the 'configSecret' field. This field may change in future releases. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration))
- `automount_service_account_token` (Boolean) AutomountServiceAccountToken indicates whether a service account token should be automatically mounted in the pod. If the service account has 'automountServiceAccountToken: true', set the field to 'false' to opt out of automounting API credentials.
- `base_image` (String) Base image that is used to deploy pods, without tag. Deprecated: use 'image' instead
...
- `image_pull_policy` (String) Image pull policy for the 'alertmanager', 'init-config-reloader' and 'config-reloader' containers. See https://kubernetes.io/docs/concepts/containers/images/#image-pull-policy for more details.
...
- `listen_local` (Boolean) ListenLocal makes the Alertmanager server listen on loopback, so that it does not bind against the Pod IP. Note this is only for the Alertmanager UI, not the gossip communication.
- `log_format` (String) Log format for Alertmanager to be configured with.
- `log_level` (String) Log level for Alertmanager to be configured with.
...
- `paused` (Boolean) If set to true all actions on the underlying managed objects are not goint to be performed, except for delete actions.
...
- `port_name` (String) Port name used for the pods and governing service. Defaults to 'web'.
- `priority_class_name` (String) Priority class assigned to the Pods
- `replicas` (Number) Size is the expected size of the alertmanager cluster. The controller will eventually make the size of the running cluster equal to the expected size.
...
- `storage` (Attributes) Storage is the definition of how storage will be used by the Alertmanager instances. (see [below for nested schema](#nestedatt--spec--storage))
...
- `web` (Attributes) Defines the web command line flags when starting Alertmanager. (see [below for nested schema](#nestedatt--spec--web))
...
<a id="nestedatt--spec--alertmanager_config_matcher_strategy"></a>
### Nested Schema for `spec.alertmanager_config_matcher_strategy`
...
- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--alertmanager_config_namespace_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--alertmanager_config_namespace_selector--match_expressions"></a>
...
<a id="nestedatt--spec--alertmanager_config_selector"></a>
### Nested Schema for `spec.alertmanager_config_selector`

Optional:

- `match_expressions` (Attributes List) matchExpressions is a list of label selector requirements. The requirements are ANDed. (see [below for nested schema](#nestedatt--spec--alertmanager_config_selector--match_expressions))
- `match_labels` (Map of String) matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'. The requirements are ANDed.

<a id="nestedatt--spec--alertmanager_config_selector--match_expressions"></a>
...
<a id="nestedatt--spec--alertmanager_configuration"></a>
### Nested Schema for `spec.alertmanager_configuration`
...
- `http_config` (Attributes) HTTP client configuration. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--http_config))
- `ops_genie_api_key` (Attributes) The default OpsGenie API Key. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--ops_genie_api_key))
- `ops_genie_api_url` (Attributes) The default OpsGenie API URL. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--ops_genie_api_url))
...
- `slack_api_url` (Attributes) The default Slack API URL. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--slack_api_url))
- `smtp` (Attributes) Configures global SMTP parameters. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp))

<a id="nestedatt--spec--alertmanager_configuration--global--http_config"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp`

Optional:

- `authorization` (Attributes) Authorization header configuration for the client. This is mutually exclusive with BasicAuth and is only available starting from Alertmanager v0.22+. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--authorization))
- `basic_auth` (Attributes) BasicAuth for the client. This is mutually exclusive with Authorization. If both are defined, BasicAuth takes precedence. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--basic_auth))
- `bearer_token_secret` (Attributes) The secret's key that contains the bearer token to be used by the client for authentication. The secret needs to be in the same namespace as the Alertmanager object and accessible by the Prometheus Operator. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--bearer_token_secret))
- `follow_redirects` (Boolean) FollowRedirects specifies whether the client should follow HTTP 3xx redirects.
- `oauth2` (Attributes) OAuth2 client credentials used to fetch a token for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2))
- `proxy_url` (String) Optional proxy URL.
- `tls_config` (Attributes) TLS configuration for the client. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--tls_config))

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--authorization"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.authorization`

Optional:

- `credentials` (Attributes) Selects a key of a Secret in the namespace that contains the credentials for authentication. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--authorization--credentials))
- `type` (String) Defines the authentication type. The value is case-insensitive.  'Basic' is not a supported value.  Default: 'Bearer'

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--authorization--credentials"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.authorization.type`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--basic_auth"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.basic_auth`

Optional:

- `password` (Attributes) The secret in the service monitor namespace that contains the password for authentication. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--basic_auth--password))
- `username` (Attributes) The secret in the service monitor namespace that contains the username for authentication. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--basic_auth--username))

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--basic_auth--password"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.basic_auth.username`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--basic_auth--username"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.basic_auth.username`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--bearer_token_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.bearer_token_secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2`

Required:

- `client_id` (Attributes) The secret or configmap containing the OAuth2 client id (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--client_id))
- `client_secret` (Attributes) The secret containing the OAuth2 client secret (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--client_secret))
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--client_id"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.scopes`

Optional:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--scopes--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--scopes--secret))

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--scopes--config_map"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.scopes.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--scopes--secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.scopes.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--oauth2--client_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.oauth2.scopes`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--tls_config"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.tls_config`

Optional:

- `ca` (Attributes) Certificate authority used when verifying server certificates. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--ca))
- `cert` (Attributes) Client certificate to present when doing client-authentication. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--cert))
- `insecure_skip_verify` (Boolean) Disable target certificate validation.
- `key_secret` (Attributes) Secret containing the client key file for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--key_secret))
- `server_name` (String) Used to verify the hostname for the targets.

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--ca"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.tls_config.server_name`

Optional:

- `config_map` (Attributes) ConfigMap containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--server_name--config_map))
- `secret` (Attributes) Secret containing data to use for the targets. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--server_name--secret))

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--server_name--config_map"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.tls_config.server_name.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--server_name--secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.tls_config.server_name.secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--cert"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.tls_config.server_name`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--tls_config--key_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.tls_config.server_name`
...
<a id="nestedatt--spec--alertmanager_configuration--global--ops_genie_api_key"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp`
...
<a id="nestedatt--spec--alertmanager_configuration--global--ops_genie_api_url"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp`
...
<a id="nestedatt--spec--alertmanager_configuration--global--slack_api_url"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp`

Optional:

- `auth_identity` (String) SMTP Auth using PLAIN
- `auth_password` (Attributes) SMTP Auth using LOGIN and PLAIN. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--auth_password))
- `auth_secret` (Attributes) SMTP Auth using CRAM-MD5. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--auth_secret))
...
- `smart_host` (Attributes) The default SMTP smarthost used for sending emails. (see [below for nested schema](#nestedatt--spec--alertmanager_configuration--global--smtp--smart_host))

<a id="nestedatt--spec--alertmanager_configuration--global--smtp--auth_password"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.auth_password`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--auth_secret"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.auth_secret`
...
<a id="nestedatt--spec--alertmanager_configuration--global--smtp--smart_host"></a>
### Nested Schema for `spec.alertmanager_configuration.global.smtp.smart_host`
...
- `get_concurrency` (Number) Maximum number of GET requests processed concurrently. This corresponds to the Alertmanager's '--web.get-concurrency' flag.
- `http_config` (Attributes) Defines HTTP parameters for web server. (see [below for nested schema](#nestedatt--spec--web--http_config))
- `timeout` (Number) Timeout for HTTP requests. This corresponds to the Alertmanager's '--web.timeout' flag.
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_monitoring_coreos_com_alertmanager_v1/import.sh"}}
