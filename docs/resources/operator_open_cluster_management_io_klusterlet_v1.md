...
```terraform
resource "k8s_operator_open_cluster_management_io_klusterlet_v1" "example" {
  metadata = {
    name = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_operator_open_cluster_management_io_klusterlet_v1/import.sh"}}
