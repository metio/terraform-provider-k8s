...
page_title: "k8s_apm_k8s_elastic_co_apm_server_v1 Resource - terraform-provider-k8s"
subcategory: "apm.k8s.elastic.co"
description: |-
  ApmServer represents an APM Server resource in a Kubernetes cluster.
---

# k8s_apm_k8s_elastic_co_apm_server_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_apm_k8s_elastic_co_apm_server_v1/import.sh"}}
