...
page_title: "k8s_pkg_crossplane_io_provider_revision_v1 Resource - terraform-provider-k8s"
subcategory: "pkg.crossplane.io"
description: |-
  A ProviderRevision that has been added to Crossplane.
---

# k8s_pkg_crossplane_io_provider_revision_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_pkg_crossplane_io_provider_revision_v1/import.sh"}}
