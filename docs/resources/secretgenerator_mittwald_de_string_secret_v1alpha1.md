...
page_title: "k8s_secretgenerator_mittwald_de_string_secret_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "secretgenerator.mittwald.de"
description: |-
  StringSecret is the Schema for the stringsecrets API
---

# k8s_secretgenerator_mittwald_de_string_secret_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_secretgenerator_mittwald_de_string_secret_v1alpha1/import.sh"}}
