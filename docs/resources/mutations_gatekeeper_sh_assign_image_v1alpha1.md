...
page_title: "k8s_mutations_gatekeeper_sh_assign_image_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "mutations.gatekeeper.sh"
description: |-
  AssignImage is the Schema for the assignimage API.
---

# k8s_mutations_gatekeeper_sh_assign_image_v1alpha1 (Resource)
...
```terraform
resource "k8s_mutations_gatekeeper_sh_assign_image_v1alpha1" "example" {
  metadata = {
    name = "some-name"
...
- `assign_domain` (String) AssignDomain sets the domain component on an image string. The trailing slash should not be included.
- `assign_path` (String) AssignPath sets the domain component on an image string.
- `assign_tag` (String) AssignImage sets the image component on an image string. It must start with a ':' or '@'.
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mutations_gatekeeper_sh_assign_image_v1alpha1/import.sh"}}
