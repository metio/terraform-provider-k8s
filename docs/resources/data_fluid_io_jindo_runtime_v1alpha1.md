...
page_title: "k8s_data_fluid_io_jindo_runtime_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "data.fluid.io"
description: |-
  JindoRuntime is the Schema for the jindoruntimes API
---

# k8s_data_fluid_io_jindo_runtime_v1alpha1 (Resource)
...
```terraform
resource "k8s_data_fluid_io_jindo_runtime_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_data_fluid_io_jindo_runtime_v1alpha1/import.sh"}}
