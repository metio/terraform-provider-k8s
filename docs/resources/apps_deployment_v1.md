...
page_title: "k8s_apps_deployment_v1 Resource - terraform-provider-k8s"
subcategory: "apps"
description: |-
  Deployment enables declarative updates for Pods and ReplicaSets.
---

# k8s_apps_deployment_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_apps_deployment_v1/import.sh"}}
