...
page_title: "k8s_resources_teleport_dev_teleport_oidc_connector_v3 Resource - terraform-provider-k8s"
subcategory: "resources.teleport.dev"
description: |-
  OIDCConnector is the Schema for the oidcconnectors API
---

# k8s_resources_teleport_dev_teleport_oidc_connector_v3 (Resource)
...
```terraform
resource "k8s_resources_teleport_dev_teleport_oidc_connector_v3" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_resources_teleport_dev_teleport_oidc_connector_v3/import.sh"}}
