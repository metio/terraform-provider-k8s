...
```terraform
resource "k8s_wildfly_org_wild_fly_server_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_wildfly_org_wild_fly_server_v1alpha1/import.sh"}}
