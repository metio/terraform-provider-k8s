...
page_title: "k8s_rules_kubeedge_io_rule_endpoint_v1 Resource - terraform-provider-k8s"
subcategory: "rules.kubeedge.io"
description: |-
  
---

# k8s_rules_kubeedge_io_rule_endpoint_v1 (Resource)
...
```terraform
resource "k8s_rules_kubeedge_io_rule_endpoint_v1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_rules_kubeedge_io_rule_endpoint_v1/import.sh"}}
