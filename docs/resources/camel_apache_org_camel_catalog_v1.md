...
```terraform
resource "k8s_camel_apache_org_camel_catalog_v1" "minimal" {
  metadata = {
    name = "test"
  }
}
...
- `metadata` (Map of String) Deprecated: never used a set of general metadata for various purposes
- `version` (String) Maven Version
...
### Nested Schema for `spec.runtime.capabilities.metadata`
