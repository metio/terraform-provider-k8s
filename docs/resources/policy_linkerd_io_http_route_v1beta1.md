...
page_title: "k8s_policy_linkerd_io_http_route_v1beta1 Resource - terraform-provider-k8s"
...
# k8s_policy_linkerd_io_http_route_v1beta1 (Resource)
...
- `type` (String) Type identifies the type of filter to apply. As with other API fields, types are classified into three conformance levels:  - Core: Filter types and their corresponding configuration defined by   'Support: Core' in this package, e.g. 'RequestHeaderModifier'.
