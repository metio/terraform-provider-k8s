...
page_title: "k8s_data_fluid_io_thin_runtime_profile_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "data.fluid.io"
description: |-
  ThinRuntimeProfile is the Schema for the ThinRuntimeProfiles API
---

# k8s_data_fluid_io_thin_runtime_profile_v1alpha1 (Resource)
...
```terraform
resource "k8s_data_fluid_io_thin_runtime_profile_v1alpha1" "minimal" {
  metadata = {
    name = "test"
  }
}
...
- `version` (Attributes) The version information that instructs fluid to orchestrate a particular version, (see [below for nested schema](#nestedatt--spec--version))
...
<a id="nestedatt--spec--version"></a>
### Nested Schema for `spec.version`
