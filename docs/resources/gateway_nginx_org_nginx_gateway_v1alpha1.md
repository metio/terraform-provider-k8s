...
page_title: "k8s_gateway_nginx_org_nginx_gateway_v1alpha1 Resource - terraform-provider-k8s"
...
# k8s_gateway_nginx_org_nginx_gateway_v1alpha1 (Resource)
...
```terraform
resource "k8s_gateway_nginx_org_nginx_gateway_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_gateway_nginx_org_nginx_gateway_v1alpha1/import.sh"}}
