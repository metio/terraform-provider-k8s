...
page_title: "k8s_mutations_gatekeeper_sh_assign_metadata_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "mutations.gatekeeper.sh"
description: |-
  AssignMetadata is the Schema for the assignmetadata API.
---

# k8s_mutations_gatekeeper_sh_assign_metadata_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mutations_gatekeeper_sh_assign_metadata_v1alpha1/import.sh"}}
