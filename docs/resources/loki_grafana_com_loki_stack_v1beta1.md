...
```terraform
resource "k8s_loki_grafana_com_loki_stack_v1beta1" "minimal" {
  metadata = {
    name = "test"
  }
}
...
- `max_query_series` (Number) MaxQuerySeries defines the the maximum of unique series that is returned by a metric query.
