...
page_title: "k8s_loki_grafana_com_loki_stack_v1beta1 Resource - terraform-provider-k8s"
subcategory: "loki.grafana.com"
description: |-
  LokiStack is the Schema for the lokistacks API
---

# k8s_loki_grafana_com_loki_stack_v1beta1 (Resource)
...
```terraform
resource "k8s_loki_grafana_com_loki_stack_v1beta1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_loki_grafana_com_loki_stack_v1beta1/import.sh"}}
