...
page_title: "k8s_kuma_io_mesh_rate_limit_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "kuma.io"
description: |-
  
---

# k8s_kuma_io_mesh_rate_limit_v1alpha1 (Resource)
...
```terraform
resource "k8s_kuma_io_mesh_rate_limit_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_kuma_io_mesh_rate_limit_v1alpha1/import.sh"}}
