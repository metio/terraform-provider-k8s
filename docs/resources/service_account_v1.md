...
page_title: "k8s_service_account_v1 Resource - terraform-provider-k8s"
subcategory: "core"
description: |-
  ServiceAccount binds together: * a name, understood by users, and perhaps by peripheral systems, for an identity * a principal that can be authenticated and authorized * a set of secrets
---

# k8s_service_account_v1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_service_account_v1/import.sh"}}
