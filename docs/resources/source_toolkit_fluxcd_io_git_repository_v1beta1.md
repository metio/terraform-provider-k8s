...
```terraform
resource "k8s_source_toolkit_fluxcd_io_git_repository_v1beta1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_source_toolkit_fluxcd_io_git_repository_v1beta1/import.sh"}}
