...
page_title: "k8s_virt_virtink_smartx_com_virtual_machine_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "virt.virtink.smartx.com"
description: |-
  VirtualMachine is a specification for a VirtualMachine resource
---

# k8s_virt_virtink_smartx_com_virtual_machine_v1alpha1 (Resource)
...
```terraform
resource "k8s_virt_virtink_smartx_com_virtual_machine_v1alpha1" "example" {
  metadata = {
    name      = "some-name"
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_virt_virtink_smartx_com_virtual_machine_v1alpha1/import.sh"}}
