...
page_title: "k8s_mariadb_mmontes_io_database_v1alpha1 Resource - terraform-provider-k8s"
subcategory: "mariadb.mmontes.io"
description: |-
  Database is the Schema for the databases API
---

# k8s_mariadb_mmontes_io_database_v1alpha1 (Resource)
...
{{codefile "shell" "/var/home/seb/git/metio/terraform-provider-k8s/development/examples/resources/k8s_mariadb_mmontes_io_database_v1alpha1/import.sh"}}
