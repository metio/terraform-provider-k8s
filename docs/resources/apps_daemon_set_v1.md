...
page_title: "k8s_apps_daemon_set_v1 Resource - terraform-provider-k8s"
subcategory: "apps"
description: |-
  DaemonSet represents the configuration of a daemon set.
---

# k8s_apps_daemon_set_v1 (Resource)
...
- `rolling_update` (Attributes) Spec to control the desired behavior of daemon set rolling update. (see [below for nested schema](#nestedatt--spec--update_strategy--rolling_update))
...
- `max_surge` (Dynamic) IntOrString is a type that can hold an int32 or a string.  When used in JSON or YAML marshalling and unmarshalling, it produces or consumes the inner type.  This allows you to have, for example, a JSON field that can accept a name or number.
- `max_unavailable` (Dynamic) IntOrString is a type that can hold an int32 or a string.  When used in JSON or YAML marshalling and unmarshalling, it produces or consumes the inner type.  This allows you to have, for example, a JSON field that can accept a name or number.
