...
var CRDv1Sources = []UpstreamSource{
	...
	},
	{
		...
		License:     apacheV2,
		URLs: []string{
			"https://github.com/clusterpedia-io/clusterpedia/blob/main/deploy/crds/cluster.clusterpedia.io_clustersyncresources.yaml",
			"https://github.com/clusterpedia-io/clusterpedia/blob/main/deploy/crds/cluster.clusterpedia.io_pediaclusters.yaml",
			"https://github.com/clusterpedia-io/clusterpedia/blob/main/deploy/crds/policy.clusterpedia.io_clusterimportpolicies.yaml",
			"https://github.com/clusterpedia-io/clusterpedia/blob/main/deploy/crds/policy.clusterpedia.io_pediaclusterlifecycles.yaml",
		},
	},
	{
	...
	},
	{
		...
		License:     apacheV2,
		URLs: []string{
			"https://github.com/gravitational/teleport/blob/master/operator/config/crd/bases/resources.teleport.dev_roles.yaml",
			"https://github.com/gravitational/teleport/blob/master/operator/config/crd/bases/resources.teleport.dev_users.yaml",
		},
	},
	{
	...
	{
		ProjectName: "prometheus-community/helm-charts",
		License:     apacheV2,
		URLs: []string{
	...
	},
	{
		...
		License:     apacheV2,
		URLs: []string{
			"https://github.com/volcano-sh/volcano/blob/master/config/crd/bases/batch.volcano.sh_jobs.yaml",
			"https://github.com/volcano-sh/volcano/blob/master/config/crd/bases/bus.volcano.sh_commands.yaml",
			"https://github.com/volcano-sh/volcano/blob/master/config/crd/bases/nodeinfo.volcano.sh_numatopologies.yaml",
			"https://github.com/volcano-sh/volcano/blob/master/config/crd/bases/scheduling.volcano.sh_podgroups.yaml",
			"https://github.com/volcano-sh/volcano/blob/master/config/crd/bases/scheduling.volcano.sh_queues.yaml",
		},
	},
	{
